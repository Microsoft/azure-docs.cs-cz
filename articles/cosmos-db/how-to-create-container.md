...
### <a id="portal-mongodb"></a>Rozhraní MongoDB API
...
![Rozhraní MongoDB API vytvoří kolekci](./media/how-to-create-container/partitioned-collection-create-mongodb.png)
...
### <a id="cli-sql"></a>Rozhraní SQL (Core) API
...
### <a id="cli-mongodb"></a>Rozhraní MongoDB API
...
### <a id="dotnet-mongodb"></a>Rozhraní MongoDB API

...
* Až budou přispěvatelé přiřazeni k prostředku Azure, budou muset provést migraci, aby mohli získat přístup k aplikacím. V opačném případě nebudou mít přístup k vytváření aplikací.

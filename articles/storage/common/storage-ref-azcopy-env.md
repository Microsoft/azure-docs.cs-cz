...
ms.locfileid: "107503486"
---
# <a name="azcopy-env"></a>azcopy env

Zobrazuje proměnné prostředí, které můžou konfigurovat chování AzCopy. Úplný seznam proměnných prostředí najdete v tématu [nastavení konfigurace AzCopy v10 za účelem (Azure Storage)](storage-ref-azcopy-configuration-settings.md).

...
> * [Jednotné přihlašování](./workplacebyfacebook-tutorial.md) k pracovní ploše na Facebooku (doporučeno)
...
3. Určete, jaká data se mají [mapovat mezi Azure AD a na pracovišti pomocí Facebooku](../app-provisioning/customize-application-attributes.md).

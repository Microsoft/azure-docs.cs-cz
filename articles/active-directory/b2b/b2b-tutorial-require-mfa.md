...
> * Create a Conditional Access policy that requires MFA for access to a cloud app in your environment. V tomto kurzu budeme k znázornění procesu používat aplikaci Microsoft Azure Management.

...
Pro App Service ve Windows můžete také dynamicky omezit IP adresy konfigurací souboru Web. config. Další informace najdete v tématu [dynamické zabezpečení protokolu IP](https://docs.microsoft.com/iis/configuration/system.webServer/security/dynamicIpSecurity/).

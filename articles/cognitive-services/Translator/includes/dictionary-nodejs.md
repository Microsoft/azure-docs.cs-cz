...
Vytvořte nový projekt pomocí oblíbeného rozhraní IDE nebo editoru nebo vytvořte novou složku na ploše. Zkopírujte tento fragment kódu do projektu nebo složky do souboru s názvem `alt-translations.js`.

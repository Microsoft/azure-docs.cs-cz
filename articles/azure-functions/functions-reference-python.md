...
Chcete-li nasadit aplikaci Function App Pythonu do Azure, můžete použít [Travis CI pro vlastní skripty](https://docs.travis-ci.com/user/deployment/script/) s úložišti GitHub. Tady je příklad `.travis.yaml` skript pro proces sestavení a publikování.

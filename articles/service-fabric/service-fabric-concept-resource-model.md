...
* Řízení přístupu na základě role: Správa přístupu ke clusterům i k aplikacím nasazeným v clusteru se dá provádět přes stejnou šablonu Správce prostředků.
...
1) Získat ID prostředku pro aplikaci pomocí příkazu [Get-AzResource](https://docs.microsoft.com/powershell/module/az.resources/get-azresource?view=azps-2.5.0)  

    #### <a name="get-resource-id-for-application"></a>Získat ID prostředku pro aplikaci
    ```
...
2) Odstraňte prostředky aplikace pomocí [Remove-AzResource](https://docs.microsoft.com/powershell/module/az.resources/remove-azresource?view=azps-2.5.0) .  
    ...
    #### <a name="delete-application-resource-using-its-resource-id"></a>Odstranit prostředek aplikace pomocí jeho ID prostředku
    ```
...
* [Osvědčené postupy](https://docs.microsoft.com/en-us/azure/service-fabric/service-fabric-best-practices-infrastructure-as-code)
* [Správa aplikací a služeb jako prostředků Azure](https://docs.microsoft.com/en-us/azure/service-fabric/service-fabric-best-practices-infrastructure-as-code)

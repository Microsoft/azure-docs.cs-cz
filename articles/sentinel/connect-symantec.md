...
7. V části **cíl Azure**postupujte takto: 
    ...
    - **Název vlastního protokolu**: zadejte název vlastního protokolu v pracovním prostoru portál Microsoft Azure Log Analytics, do kterého chcete události přesměrovat. Výchozí hodnota je SymantecICDx. Toto pole je povinné.

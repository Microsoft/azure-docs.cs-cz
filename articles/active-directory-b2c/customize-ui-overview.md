...
Důležitým bodem je, že je hostitelem obsahu veřejně dostupného koncového bodu HTTPS s povoleným CORS. Při zadání v obsahu je nutné použít absolutní adresu URL.

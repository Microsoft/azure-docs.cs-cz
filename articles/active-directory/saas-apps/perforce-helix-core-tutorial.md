...
Když kliknete na dlaždici Perforce Helix Core-Helix Authentication Service na přístupovém panelu, měli byste se automaticky přihlásit ke službě Perforce Helix Core-Helix Authentication, pro kterou jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).
...
- [Jak chránit Perforce Helix Core-Helix Authentication Service s pokročilou viditelností a ovládacími prvky](/cloud-app-security/proxy-intro-aad)
---
title: Služby Azure FedRAMP a ministerstva obrany USA SRG auditu rozsahu
description: Tento článek obsahuje tabulky pro veřejný Azure a Azure Government, které demonstrují, jaké FedRAMP (střední vs. Vysoká) a rozsah auditu DoD SRG (úroveň dopadu 2, 4 nebo 5) bylo dosaženo dané služby.
author: davib
ms.author: davib
ms.date: 5/17/2019
ms.topic: article
...
Cloudové služby Microsoftu pro státní správu splnit náročné požadavky služby nám Federal Risk and Authorization Management Program (FedRAMP) a ministerstva obrany USA, od úrovně dopadu informace 2 až 5. Nasazení chráněných služby včetně Azure Government, Office 365 US Státní správy a Dynamics 365 Government, Federální a obrana instituce můžou využívat řadu využijí služby.

Tento článek obsahuje podrobný seznam služeb v oboru cloudu v Azure a Azure Government pro FedRAMP a ministerstva obrany USA kopie SRG nabídek dodržování předpisů.

#### <a name="terminologysymbols-used"></a>Terminologie/symboly použité

* DoD CC SRG = Department of Defense Cloud computingu Security Requirements Guide
* IIL = úroveň dopadu informace
* FedRAMP = Federal Risk and Authorization Management Program  
* : heavy_check_mark: = označuje služby bylo dosaženo tohoto oboru auditu.

## <a name="azure-public-services-by-audit-scope"></a>Veřejné služby Azure podle rozsahu auditu
| _Poslední aktualizace: 2019 dne_ |

| Služba Azure| DoD CC SRG IIL 2 | FedRAMP Moderate | FedRAMP High | Plánované 2019 |
| ------------ |:---------------:|:----------------:|:------------:|:------------:|
...
| [Azure Active Directory (Free a Basic)](https://azure.microsoft.com/services/active-directory/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Cognitive Services: Rozpoznávání tváře](https://azure.microsoft.com/services/cognitive-services/face/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Síť pro doručování obsahu](https://azure.microsoft.com/services/cdn/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Rozšířená ochrana před internetovými útoky v programu Defender](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/microsoft-defender-advanced-threat-protection) |  | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Služby Machine Learning](https://azure.microsoft.com/services/machine-learning-service/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Ve službě Machine Learning Studio](https://azure.microsoft.com/services/machine-learning-studio/) |  |  |  | :heavy_check_mark: |
...
| [Analýza provozu sledovací proces sítě](https://docs.microsoft.com/azure/network-watcher/traffic-analytics) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Úložiště: Objekty BLOB](https://azure.microsoft.com/services/storage/blobs/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Úložiště: Disky (včetně spravované disky)](https://azure.microsoft.com/services/storage/disks/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Úložiště: Soubory](https://azure.microsoft.com/services/storage/files/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Úložiště: fronty](https://azure.microsoft.com/services/storage/queues/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Úložiště: Tabulky](https://azure.microsoft.com/services/storage/tables/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Virtuální počítače (včetně rezervované instance)](https://azure.microsoft.com/services/virtual-machines/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Webové aplikace (App Service)](https://azure.microsoft.com/services/app-service/web/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |


## <a name="azure-government-services-by-audit-scope"></a>Služby Azure government oborem auditu
| _Poslední aktualizace: 2019 dne_ |

| Služba Azure | DoD CC SRG IIL 2 | DoD CC SRG IIL 4 | DoD CC SRG IIL 5 | FedRAMP High | Plánované 2019
| ------------- |:---------------:|:---------------:|:---------------:|:------------:|:------------:
...
| [Automation](https://azure.microsoft.com/services/automation/) | :heavy_check_mark: | :heavy_check_mark: |  | :heavy_check_mark: |
| [Azure Active Directory (Free a Basic)](https://azure.microsoft.com/services/active-directory/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
...
| [Cognitive Services: Rozpoznávání tváře](https://azure.microsoft.com/services/cognitive-services/face/)  |  |  |  |  | :heavy_check_mark:
...
| [Rozšířené ochrany před internetovými útoky v programu Defender Microsoft](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/microsoft-defender-advanced-threat-protection)  |  |  |  |  | :heavy_check_mark:
...
| [Úložiště: Objekty BLOB](https://azure.microsoft.com/services/storage/blobs/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
| [Úložiště: Disky (včetně spravované disky)](https://azure.microsoft.com/services/storage/disks/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
| [Úložiště: Soubory](https://azure.microsoft.com/services/storage/files/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
| [Úložiště: fronty](https://azure.microsoft.com/services/storage/queues/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
| [Úložiště: Tabulky](https://azure.microsoft.com/services/storage/tables/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
...
| [Webové aplikace (App Service)](https://azure.microsoft.com/services/app-service/web/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |

**&ast;** Některé služby, jako je Azure Resource Manageru a webu Azure portal neukládají ani proces amerického ministerstva obrany kopie SRG IIL 5 obsahu, ale stále dědit IIL5 sada ovládacích prvků.

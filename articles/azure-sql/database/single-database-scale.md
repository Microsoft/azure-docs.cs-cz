...
>
> Pokud chcete zjistit, jestli databáze používá úložiště PFS, spusťte v kontextu databáze následující dotaz. Pokud je hodnota ve sloupci AccountType `PremiumFileStorage` , databáze používá úložiště PFS.

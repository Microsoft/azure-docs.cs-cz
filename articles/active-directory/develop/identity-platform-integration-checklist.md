...
| ![prvku](./media/active-directory-integration-checklist/checkbox-two.svg) | Nepovolujte podporu pro [tok implicitního udělení OAuth2](v2-oauth2-implicit-grant-flow.md) , pokud je explicitně nepožadujete. [Tady](v2-oauth2-implicit-grant-flow.md#suitable-scenarios-for-the-oauth2-implicit-grant)najdete informace o platném scénáři. |

...
description: Zjistěte, jak odpojit datový disk od virtuálního počítače v Azure pomocí CLI 2.0 nebo na webu Azure portal.
...
## <a name="detach-a-data-disk-using-cli-20"></a>Odpojení datového disku pomocí CLI 2.0

...
3. **Připojte se k partnerské virtuální síti.** Pokyny najdete v tématu [propojení sítě testovacího prostředí s partnerskými virtuálními sítěmi](./how-to-connect-peer-virtual-network.md).

---
title: 'Kurz: Integrace Azure Active Directory se službou IriusRisk | Dokumentace Microsoftu'
...
ms.locfileid: "39052580"
---
# <a name="tutorial-azure-active-directory-integration-with-iriusrisk"></a>Kurz: Integrace Azure Active Directory se službou IriusRisk
...
3. **[Vytvoření zkušebního uživatele IriusRisk](#create-a-iriusrisk-test-user)**  – Pokud chcete mít protějšek Britta Simon IriusRisk, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **IriusRisk domény a adresy URL** části, proveďte následující kroky:
...
6. Ke konfiguraci jednotného přihlašování na **IriusRisk** straně, je nutné odeslat na stažený **soubor XML s metadaty** k [tým podpory IriusRisk](mailto:info@continuumsecurity.net). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

...
Xamarin umožňuje vývojářům používat sdílený základ kódu jazyka C# k vytváření aplikací pro iOS, Android a Windows Store s nativními uživatelskými rozhraními. V tomto kurzu se dozvíte, jak používat úložiště objektů BLOB v Azure s aplikací Xamarin. Pokud se chcete dozvědět více o Azure Storage před začnete do kódu, přečtěte si téma [Úvod do Microsoft Azure Storage](../common/storage-introduction.md?toc=%2fazure%2fstorage%2fblobs%2ftoc.json).
...
2. Otevřete Visual Studio a vytvořte prázdnou aplikaci (nativní přenosná): **File > New > Project > pro různé platformy > prázdné aplikace (nativní přenosná)**.
...
Nezapomeňte nahradit text "your_account_name_here" a "your_account_key_here" skutečným názvem účtu a klíčem účtu.

...
3. **[Vytvoření zkušebního uživatele Form.com](#create-a-formcom-test-user)**  – Pokud chcete mít protějšek Britta Simon Form.com, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **Form.com domény a adresy URL** části, proveďte následující kroky:
...
6. Na **Form.com konfigurace** klikněte na tlačítko **nakonfigurovat Form.com** otevřete **nakonfigurovat přihlašování** okna. Kopírovat **SAML jednotné přihlašování – adresa URL služby** z **Stručná referenční příručka oddílu.**

    ![Konfigurace Form.com](./media/formcom-tutorial/tutorial_form.com_configure.png) 

7. Ke konfiguraci jednotného přihlašování na **Form.com** straně, je nutné odeslat na stažený **certifikát (Base64)**, **adresa Url federačních metadat aplikace**, a **SAML Jednotné přihlašování – adresa URL služby** k [tým podpory Form.com](https://form.com/about/company/contact-us/). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

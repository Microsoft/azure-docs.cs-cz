...
> [Přidání ověřování do existující webové aplikace – ukázka kódu na GitHubu >](https://github.com/AzureAD/microsoft-authentication-library-for-js/tree/dev/samples/msal-node-samples/auth-code)

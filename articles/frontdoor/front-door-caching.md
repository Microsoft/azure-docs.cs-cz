...
</br>Po doručení bloku dat do prostředí front dveří je tato část ukládána do mezipaměti a okamžitě se jí dodrží uživateli. Přední dveře potom předem načítají další blok. Toto předběžné načtení zajišťuje, že obsah zůstane jeden blok před uživatelem, což snižuje latenci. Tento proces pokračuje, dokud se nestáhne celý soubor (Pokud se požaduje), nebo když klient připojení ukončí.
...
Přední dvířka můžou dynamicky Komprimovat obsah na hranici, což má za následek menší a rychlejší odezvu na vaše klienty. Všechny soubory mají nárok na kompresi. Soubor ale musí být typu MIME, aby měl nárok na kompresi. V současné době přední dveře neumožňují změnu tohoto seznamu. Aktuální seznam je:</br>
- "Application/EOT"
- "Application/Font"

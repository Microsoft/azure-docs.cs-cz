---
title: Uložit ověřovací token do mezipaměti
...
Importujte balíček NuGet **Microsoft. IdentityModel. clients. Active** , který se používá k získání tokenu. Dále pomocí následujícího kódu Získejte `AuthenticationResult`a použijte hodnoty ověřování, které jste dostali při [vytváření prostředku pro moderní čtečku](./how-to-create-immersive-reader.md).
...
Vlastnost `expires_on` je datum a čas, kdy vyprší platnost tokenu, vyjádřený jako počet sekund od 1. ledna 1970 UTC. Tuto hodnotu použijte k určení, jestli vypršela platnost tokenu, než se pokusí získat nový.

...
| range            | Rozsah buněk v daném listu pro vyhledání selektivních dat, například `A3:H5` (tabulka z a3 do H5), `A3` (tabulka začínající z buňky A3) ( `A3:A3` jedna buňka). Pokud není zadaný, ADF načte z celého listu jako tabulku. | Ne       |

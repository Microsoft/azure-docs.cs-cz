...
Následující článek podrobně popisuje, jak Azure Policy definice předdefinovaného dodržování legislativních předpisů namapuje na domény a **ovládací prvky** **dodržování předpisů** v CIS Microsoft Azure Foundation test 1.1.0.

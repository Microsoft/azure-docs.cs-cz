...
Když kopírujete data ze zdrojového úložiště dat do úložiště dat jímky, můžete použít úložiště objektů BLOB jako dočasné pracovní úložiště. [Další informace](copy-activity-performance-features.md#staged-copy).

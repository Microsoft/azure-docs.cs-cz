---
title: Co je Azure SQL Database Edge? | Microsoft Docs
...
SQL Database Edge je k dispozici se třemi různými edicemi nebo softwarovými plány. Tyto edice mají stejné sady funkcí a liší se jenom v souvislosti s jejich právy na používání a množstvím procesorů a paměti, které podporují.
   ...
   |**Plánování**  |**Popis**  |
   |---------|---------|
   |Developer  |  Pouze vývoj SKU se stejnými limity omezení, které jsou uvedeny ve standardní SKU uvedené níže. |
   |Úroveň Standard   |  Plán Standard podporuje až 4 PROCESORy a až 32 GB paměti pro kontejner SQL Database Edge. |
   |Premium    |  SKU úrovně Premium podporuje až 8 jader a až 64 GB paměti pro kontejner SQL Database Edge. |

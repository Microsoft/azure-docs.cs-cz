...
---
# <a name="tutorial-connect-to-a-web-app-using-an-azure-private-endpoint"></a>Kurz: Připojení k webové aplikaci s využitím privátního koncového bodu Azure
...
1. V nabídce na levé straně vyberte **vytvořit**  >    >  **webovou aplikaci** úložiště prostředků nebo ve vyhledávacím poli vyhledejte **webovou aplikaci** .
...
10. Ověřte, že se zobrazí stránka **403** . Tato stránka indikuje, že webová aplikace není dostupná externě.
    ...
    :::image type="content" source="./media/tutorial-private-endpoint-webapp-portal/web-app-ext-403.png" alt-text="Stránka 403 pro adresu externí webové aplikace" border="true":::
...
13. Ověřte, že obdržíte výchozí stránku webové aplikace.
    ...
    :::image type="content" source="./media/tutorial-private-endpoint-webapp-portal/web-app-default-page.png" alt-text="Výchozí stránka webové aplikace" border="true":::

...
Otevřete okno konzoly a proveďte ověření pomocí svých přihlašovacích údajů. Další informace najdete v tématu [přihlaste k Azure z rozhraní příkazového řádku Azure](/cli/azure/authenticate-azure-cli)

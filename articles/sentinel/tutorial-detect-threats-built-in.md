...
- **Syntéza** založená na technologii Fusion, Pokročilá detekce útoků s více fázemi v Azure Sentinel používá škálovatelné algoritmy strojového učení, které mohou korelovat mnoho výstrah a událostí s nízkou kvalitou v různých produktech na vysokou věrnost a možné akce. incidenty. Fusion je ve výchozím nastavení povolená. Vzhledem k tomu, že je logika skrytá, nemůžete ji použít jako šablonu k vytvoření více než jednoho pravidla.

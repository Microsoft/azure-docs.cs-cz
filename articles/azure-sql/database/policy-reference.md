...
## <a name="azure-sql-database--sql-managed-instance"></a>Azure SQL Database & spravované instance SQL 

[!INCLUDE [azure-policy-reference-service-sqldatabase](../../../includes/policy/reference/byrp/microsoft.sql.md)]

## <a name="limitations"></a>Omezení
- Při použití T-SQL nebo SSMS se neuplatní Azure Policy použitelné pro vytváření Azure SQL Database. 

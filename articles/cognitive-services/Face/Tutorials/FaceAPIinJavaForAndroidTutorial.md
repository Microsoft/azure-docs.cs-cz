...
V tomto kurzu vytvoříte aplikaci pro Android, která využívá službu Azure Face prostřednictvím sady Java SDK k detekci lidských plošek v obraze. Aplikace zobrazí vybraný obrázek a nakreslí rámeček kolem každé zjištěné plochy.
...
- [Android Studio](https://developer.android.com/studio/) s rozhraním API Level 22 nebo novějším.
...
## <a name="draw-face-rectangles"></a>Kreslení obdélníků obličeje
...
V tomto kurzu jste zjistili, jak pomocí sady SDK pro obličej Java vytvořit aplikaci pro detekci a orámování plošek v imagi. V dalším kroku se dozvíte více o podrobnostech detekce obličeje.

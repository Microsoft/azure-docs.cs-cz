...
- [Upravit podrobnosti předplatného](https://portal.azure.com)
...
- Přečtěte si [Nejčastější dotazy týkající se cost management a fakturace](../cost-management-billing-faq.yml) pro otázky týkající se vlastnictví předplatného EA.
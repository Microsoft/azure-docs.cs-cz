...
1. V prohlížeči přejděte do uživatelského rozhraní správce Ranger na `https://CLUSTERNAME.azurehdinsight.net/Ranger/`, kde název_clusteru je název vašeho clusteru.

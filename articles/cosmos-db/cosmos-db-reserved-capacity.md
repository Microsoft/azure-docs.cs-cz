...
Z [Azure Portal](https://portal.azure.com)můžete koupit Azure Cosmos DB rezervovanou kapacitu. Platíte za rezervaci [předem nebo s měsíčními platbami](../billing/billing-monthly-payments-reservations.md). Zakoupení rezervované kapacity:

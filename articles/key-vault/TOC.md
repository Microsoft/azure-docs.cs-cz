...
## [Čtení ze služby Key Vault – Node.js](quick-create-node.md)
# Kurzy
...
## Node.js
### [Správa trezoru](https://docs.microsoft.com/javascript/api/azure-arm-keyvault/)
### [Klientská knihovna trezoru](https://docs.microsoft.com/javascript/api/azure-keyvault/)
## Vývoj

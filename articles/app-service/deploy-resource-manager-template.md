...
* Další informace o syntaxi JSON a vlastnosti pro typy prostředků v šablonách najdete v tématu [referenčními informacemi k šablonám Azure Resource Manageru](/azure/templates/).

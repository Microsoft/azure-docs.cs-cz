...
![RBAC prostředí PowerShell-Get AzureRmRoleDefinition – snímek obrazovky](./media/role-assignments-powershell/1-get-azure-rm-role-definition1.png)
...
![RBAC prostředí PowerShell-Get AzureRmRoleDefinition pro určité role – snímek obrazovky](./media/role-assignments-powershell/1-get-azure-rm-role-definition2.png)
...
![RBAC prostředí PowerShell - Get-AzureRmRoleAssignment pro skupinu prostředků – snímek obrazovky](./media/role-assignments-powershell/4-get-azure-rm-role-assignment1.png)
...
![RBAC prostředí PowerShell - Get-AzureRmRoleAssignment pro uživatele – snímek obrazovky](./media/role-assignments-powershell/4-get-azure-rm-role-assignment2.png)
...
![RBAC prostředí PowerShell - nové-AzureRmRoleAssignment – snímek obrazovky](./media/role-assignments-powershell/2-new-azure-rm-role-assignment2.png)
...
![RBAC prostředí PowerShell - nové-AzureRmRoleAssignment – snímek obrazovky](./media/role-assignments-powershell/2-new-azure-rm-role-assignment3.png)
...
![RBAC prostředí PowerShell - nové-AzureRmRoleAssignment – snímek obrazovky](./media/role-assignments-powershell/2-new-azure-rm-role-assignment4.png)
...
![RBAC prostředí PowerShell - Remove-AzureRmRoleAssignment – snímek obrazovky](./media/role-assignments-powershell/3-remove-azure-rm-role-assignment.png)
...
Pokud používáte PowerShell můžete vytvořit vlastní roli, můžete začít úplně od začátku nebo použijte jednu z [předdefinované role](built-in-roles.md) jako výchozí bod. Příklad v této části začíná předdefinovaná role a pak ho přizpůsobí s další oprávnění. Upravit atributy, které se přidat *akce*, *notActions*, nebo *obory* a potom uložte změny jako novou roli.
...
![RBAC prostředí PowerShell-Get AzureRmRoleDefinition – snímek obrazovky](./media/role-assignments-powershell/2-new-azurermroledefinition.png)
...
![RBAC prostředí PowerShell - Set-AzureRmRoleDefinition – snímek obrazovky](./media/role-assignments-powershell/3-set-azurermroledefinition-1.png)
...
![RBAC prostředí PowerShell - Set-AzureRmRoleDefinition – snímek obrazovky](./media/role-assignments-powershell/3-set-azurermroledefinition-2.png)
...
![RBAC prostředí PowerShell - Remove-AzureRmRoleDefinition – snímek obrazovky](./media/role-assignments-powershell/4-remove-azurermroledefinition.png)
...
![RBAC prostředí PowerShell-Get AzureRmRoleDefinition – snímek obrazovky](./media/role-assignments-powershell/5-get-azurermroledefinition-1.png)
...
![RBAC prostředí PowerShell-Get AzureRmRoleDefinition – snímek obrazovky](./media/role-assignments-powershell/5-get-azurermroledefinition2.png)

## <a name="see-also"></a>Další informace najdete v tématech
* [Použití Azure PowerShell s Azure Resource Manager](../azure-resource-manager/powershell-azure-resource-manager.md)

...
> * [Rozšíření Visual Studio Code](https://code.visualstudio.com/tutorials/static-website/getting-started)
...
Pokud například změníte úroveň veřejného přístupu kontejneru **$Web** z **privátního (bez anonymního přístupu)** do **objektu BLOB (anonymní přístup pro čtení jenom pro objekty BLOB)** , pak úroveň veřejného přístupu na primární koncový bod `https://contosoblobaccount.z22.web.core.windows.net/index.html`statickéhowebunemění se.

...
ms.date: 04/02/2021
ms.topic: sample
ms.openlocfilehash: a6f184e0446e311da54bcec3906667865c665bc7
ms.sourcegitcommit: 77d7639e83c6d8eb6c2ce805b6130ff9c73e5d29
ms.translationtype: MT
ms.contentlocale: cs-CZ
ms.lasthandoff: 04/05/2021
ms.locfileid: "106386920"
---
...
> [!NOTE]
> Tato ukázka podrobného plánu je k dispozici ve službě Azure Government.

## <a name="control-mapping"></a>Mapování kontrol

Oddíl mapování kontrol poskytuje podrobné informace o zásadách zahrnutých v tomto podrobném plánu a o tom, jak tyto zásady řeší různé kontroly v rámci standardu DoD Impact Level 4. Prostředky při přiřazení k architektuře vyhodnocuje Azure Policy a zjišťuje případné nedodržení přiřazených zásad. Další informace najdete v tématu [Azure Policy](../../../policy/overview.md).

## <a name="next-steps"></a>Další kroky

Prošli jste si přehled ukázky podrobného plánu DoD Impact Level 4. Jako další si projděte následující články, ve kterých se dozvíte víc o mapování kontrol a o postupu nasazení této ukázky:

> [!div class="nextstepaction"]
> [Podrobný plán DoD Impact Level 4 – mapování kontrol](./control-mapping.md)
> [Podrobný plán DoD Impact Level 4 – kroky nasazení](./deploy.md)

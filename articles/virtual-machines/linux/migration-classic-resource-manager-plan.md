...
4. Které scénáře podporuje rozhraní API pro migraci?  Přečtěte si o [nepodporovaných funkcích a konfiguracích](migration-classic-resource-manager-overview.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json#unsupported-features-and-configurations).
...
- Předpokládá se, že rozhraní API pro migraci podporované platformou bude pohlížet na všechny scénáře. Přečtěte si [nepodporované funkce a konfigurace](migration-classic-resource-manager-overview.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json#unsupported-features-and-configurations) , které vám pomohou pochopit podporované scénáře.

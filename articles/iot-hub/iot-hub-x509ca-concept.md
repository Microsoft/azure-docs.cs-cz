...
![Tok pro generování certifikátů pro X509CA](./media/iot-hub-x509ca-concept/csr-flow.png)
...
![Řetěz certifikátů z certifikátů jedna společnost na certifikáty z jiné firmy](./media/iot-hub-x509ca-concept/cert-mfr-chain.png)
...
![Tok z jednoho certifikátu na jiný, pop výzvu z centra](./media/iot-hub-x509ca-concept/device-pop-flow.png)

...
* Můžete řídit ve službě Azure AD, který má přístup k Folloze.
* Můžete povolit uživatelům být automaticky přihlášeni k Folloze (Single Sign-On) s jejich účty Azure AD.
...
Konfigurace integrace Azure AD s Folloze, potřebujete následující položky:

* Předplatné služby Azure AD. Pokud nemáte prostředí Azure AD, můžete získat měsíční zkušební verze [zde](https://azure.microsoft.com/pricing/free-trial/)
* Folloze jednotného přihlašování povolená předplatného
...
Konfigurace integrace Folloze do služby Azure AD, budete muset přidat Folloze z Galerie na váš seznam spravovaných aplikací SaaS.

**Chcete-li přidat Folloze z galerie, postupujte následovně:**
...
4. Do vyhledávacího pole zadejte **Folloze**vyberte **Folloze** z panelu výsledků klikněte **přidat** tlačítko pro přidání aplikace.

     ![Folloze v seznamu výsledků](common/search_new_app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurace a otestování služby Azure AD jednotného přihlašování

V této části je konfigurace a testování Azure AD jednotné přihlašování pomocí Folloze podle testovacího uživatele volá **Britta Simon**.
Pro jednotné přihlašování pro práci je potřeba navázat vztah odkazu mezi uživatele služby Azure AD a související uživatelské v Folloze.

Nakonfigurovat a otestovat Azure AD jednotné přihlašování s Folloze, které potřebujete k dokončení následujících stavebních bloků:
...
Ke konfiguraci Azure AD jednotné přihlašování s Folloze, proveďte následující kroky:

1. V [webu Azure portal](https://portal.azure.com/)na **Folloze** integrace stránce aplikace vyberte **jednotného přihlašování**.
...
4. Na **základní konfiguraci SAML** oddílu, uživatel nebude muset provést libovolný krok, protože aplikace je už předem integrováno s Azure.
    ...
    ![Folloze domény a adresy URL jednotného přihlašování – informace](common/preintegrated.png)
...
8. Na **nastavení Folloze** tématu, zkopírujte příslušné adresy URL podle vašich požadavků.
...
### <a name="configure-folloze-single-sign-on"></a>Konfigurace Folloze jednotné přihlašování

Ke konfiguraci jednotného přihlašování na **Folloze** straně, je nutné odeslat na stažený **certifikát (Base64)** a vhodné zkopírovaný adresy URL z webu Azure portal [tým podpory Folloze](mailto:support@folloze.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.
...
V této části je povolit Britta Simon k udělení přístupu k Folloze použití Azure jednotného přihlašování.

1. Na webu Azure Portal, vyberte **podnikové aplikace**vyberte **všechny aplikace**a pak vyberte **Folloze**.
...
### <a name="create-folloze-test-user"></a>Vytvoření Folloze testovacího uživatele
...
Po kliknutí na dlaždici Folloze na přístupovém panelu, můžete by měl být automaticky přihlášeni k Folloze, u kterého nastavíte jednotné přihlašování. Další informace o přístupovém panelu, naleznete v tématu [Úvod k přístupovému panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

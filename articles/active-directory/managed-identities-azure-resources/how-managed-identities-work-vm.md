...
* [Použít spravovanou identitu přiřazenou systémem Linux pro přístup k Správce prostředků,](tutorial-linux-vm-access-arm.md) jak spravovaná-identity – Work-VM

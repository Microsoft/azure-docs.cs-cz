...
|  --------------------    | ----------                   | ---------------                                                                   |
| Název nabídky               |  Vysoká      | Přesné nebo blízko úplné shody s vyhledávacím dotazem bude poskytovat vysoké hodnocení.                       |
| Název vydavatele           |  Vysoká      | Přesné nebo blízko úplné shody s vyhledávacím dotazem bude poskytovat vysoké hodnocení.                       |

...
+ *Jeden index na tenanta:* Každý tenant má svůj vlastní index v rámci vyhledávací služby, která je sdílená s ostatními klienty.

+ *Jedna služba na tenanta:* Každý tenant má svou vlastní vyhrazenou službu Azure Kognitivní hledání, která nabízí nejvyšší úroveň dat a oddělení úloh.

+ *Kombinace obou:* Větším, více aktivním klientům se přiřazují vyhrazené služby, zatímco v rámci sdílených služeb jsou v menších klientech přiřazeny jednotlivé indexy.

## <a name="model-1-one-index-per-tenant"></a>Model 1: jeden index na tenanta
...
## <a name="model-2-once-service-per-tenant"></a>Model 2: jednou službou na tenanta
...
## <a name="model-3-hybrid"></a>Model 3: hybridní

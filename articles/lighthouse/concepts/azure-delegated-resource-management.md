...
> [!NOTE]
> Správu delegovaných prostředků Azure je možné použít i v rámci podniku, který má více tenantů Azure AD vlastní pro zjednodušení správy mezi klienty.

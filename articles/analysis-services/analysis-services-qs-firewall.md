...
- Server služby Analysis Services v předplatném. Další informace najdete v tématu [rychlý Start: Vytvoření serveru portálu](analysis-services-create-server.md) nebo [rychlého startu: Vytvoření serveru – PowerShell](analysis-services-create-powershell.md)

...
## <a name="configure-and-test-azure-ad-single-sign-on-for-cisco-anyconnect"></a>Konfigurace a testování jednotného přihlašování Azure AD pro Cisco AnyConnect
...
Pokud chcete nakonfigurovat a otestovat jednotné přihlašování Azure AD pomocí Cisco AnyConnect, dokončete následující stavební bloky:
...
1. V [Azure Portal](https://portal.azure.com/)na stránce integrace aplikací **Cisco AnyConnect** Najděte oddíl **Spravovat** a vyberte **jednotné přihlašování**.
...
Když na přístupovém panelu kliknete na dlaždici Cisco AnyConnect, měli byste se automaticky přihlásit k Cisco AnyConnect, pro který jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Vyzkoušejte Cisco AnyConnect s Azure AD](https://aad.portal.azure.com/)

- [Co je řízení relace v Microsoft Cloud App Security?](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)

- [Jak chránit Cisco AnyConnect pomocí pokročilých viditelností a ovládacích prvků](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)

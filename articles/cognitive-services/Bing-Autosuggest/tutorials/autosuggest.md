...
Vytvořte formulář HTML s textovým polem. Zpracování `oninput` události a volání `bingAutosuggest()` funkce, předání obsahu textového pole a rozhraní API pro automatické návrhy Binguho klíče.

...
1. V Průzkumníku dat rozbalte databázi **Tasks**, rozbalte kolekci **Items**, klikněte na **Dokumenty** a pak klikněte na **Nové dokumenty**.

   ![Vytváření nových dokumentů v Průzkumníku dat na portálu Azure Portal](./media/create-sql-api-xamarin-dotnet/azure-cosmosdb-data-explorer-new-document.png)
...
3. Po přidání formátu json na kartu **Dokumenty** klikněte na **Uložit**.
    ...
    ![Zkopírujte data json a v Průzkumníku dat na webu Azure Portal klikněte na Uložit.](./media/create-sql-api-xamarin-dotnet/azure-cosmosdb-data-explorer-save-document.png)
...
3. Pak v sadě Visual Studio otevřete soubor ToDoItems.sln ze složky samples/xamarin/ToDoItems.

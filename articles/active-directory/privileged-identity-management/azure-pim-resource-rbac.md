...
1. Jako **typ auditu**vyberte **aktivovat (přiřazeno + aktivované)** .
    ...
    [![Seznam auditu prostředků filtrovaný podle typu aktivovat typ auditu](media/azure-pim-resource-rbac/rbac-audit-activity.png "Seznam auditu prostředků filtrovaný podle aktivace")](media/azure-pim-resource-rbac/rbac-audit-activity.png) ![seznamu auditu prostředků, který je filtrovaný pomocí typu aktivovat typ auditu](media/azure-pim-resource-rbac/rbac-audit-activity.png)

...
3. [Vytvořte klíč obsahu a přidružte ho k zakódovanému prostředku] Media-Services-Protected-with-AES128. MD # create_contentkey). Ve službě Media Services obsahuje klíč obsahu šifrovací klíč prostředku.

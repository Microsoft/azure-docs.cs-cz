...
1. Manifest vyžaduje identifikátor GUID. Identifikátor GUID můžete vygenerovat pomocí příkazu PowerShellu `[guid]::NewGuid()` nebo rutiny `New-GUID`. Další možností je použít web generátoru GUID.

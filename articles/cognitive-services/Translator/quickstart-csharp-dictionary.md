---
title: 'Rychlý start: Vyhledávání slov s využitím dvojjazyčného slovníku C# – Translator Text API'
...
Přidat `PrettyPrint` formátovat odpověď JSON:
```csharp

...
3. **[Vytvoření zkušebního uživatele ArcGIS Online](#create-a-arcgis-online-test-user)**  – Pokud chcete mít protějšek Britta Simon ArcGIS online, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **ArcGIS Online domény a adresy URL** části, proveďte následující kroky:
...
6. V okně jiné webové prohlížeče přihlaste jako správce webu ArcGIS společnosti.
...
9. V části **podnikové přihlašovací údaje**, klikněte na tlačítko **nastavit zprostředkovatele IDENTITY**.

    ![Podnikové přihlašovací údaje](./media/arcgis-tutorial/ic784744.png "podnikové přihlašovací údaje")

10. Na **nastavit zprostředkovatele Identity** konfigurační stránce, proveďte následující kroky:

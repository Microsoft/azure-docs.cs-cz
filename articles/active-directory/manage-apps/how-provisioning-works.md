...
2. Filtrování vrácených uživatelů a skupin pomocí všech nakonfigurovaných [přiřazení](assign-user-or-group-access-portal.md) nebo [filtrů rozsahů založených na atributech](define-conditional-rules-for-provisioning-user-accounts.md).
...
Služba zřizování Azure AD odstraní uživatele v aplikaci, když aplikace suupports Soft odstraní (žádost o aktualizaci s aktivní = false) a dojde k jakékoli z následujících událostí:
...
[Naplánování automatického nasazení zřizování uživatelů](plan-auto-user-provisioning.md)

[Konfigurace zřizování pro aplikaci Galerie](configure-automatic-user-provisioning-portal.md)

[Vytvoření koncového bodu SCIM a konfigurace zřizování při vytváření vlastní aplikace](use-scim-to-provision-users-and-groups.md)

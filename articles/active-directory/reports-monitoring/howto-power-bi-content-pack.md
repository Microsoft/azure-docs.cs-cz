...
**Zahrnutí dalších polí**: Pole můžete do sestavy přidat nebo ho z ní odebrat výběrem vizuálu, do kterého chcete pole přidat nebo z kterého ho chcete odebrat. Můžete například přidat pole "stav přihlášení" do zobrazení tabulky, jak je znázorněno níže. 
 
![Balíček obsahu Azure Active Directory Power BI Content Pack](./media/howto-power-bi-content-pack/11.png) 

**Připnutí vizualizace na řídicí panel**: zahrnutím vlastní vizualizace do sestavy a Připnutí na řídicí panel můžete přizpůsobit řídicí panel. 

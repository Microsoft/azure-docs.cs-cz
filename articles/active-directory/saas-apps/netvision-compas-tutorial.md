...
1. Při definování profilu uživatele se ujistěte, že je **e-mailová adresa uživatele (osobní)** shodná s uživatelským jménem Azure username@companydomain.extensionAD:. Například, `B.Simon@contoso.com`.
...
Když na přístupovém panelu kliknete na dlaždici Netvision COMPAS, měli byste být automaticky přihlášeni k Netvision COMPAS, pro kterou jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

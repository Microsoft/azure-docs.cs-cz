...
Na tomto hraničním zařízení nejsou žádné vlastní moduly. Můžete přidat vlastní nebo předem sestavený modul. Informace o tom, jak vytvořit vlastní modul, najdete v tématu [vývoj modulu C# pro vaše zařízení data box Edge](data-box-edge-create-iot-edge-module.md).

...
4. Do souboru bez názvu-1 zadejte následující kód:
    ...
    Skript vytvoří soubor oddělení. csv s některými daty zahrnutými do složky/Output.
...
3. Vyberte účet, databázi a schéma, které chcete. Nastavení se uloží do konfiguračního souboru xxx_settings. JSON.
...
3. Soubor xxx_settings. JSON je otevřený s následujícími vlastnostmi:
...
**Registrace pomocí příkazu ADL: Register Assembly**
1.  Kliknutím na CTRL + SHIFT + P otevřete paletu příkazů.
...
**Registrace pomocí příkazu ADL: Register Assembly (rozšířené)**
1.  Kliknutím na CTRL + SHIFT + P otevřete paletu příkazů.
...
**Vytvoření skriptu pro extrakci pomocí příkazu**
...
**Výpis účtů Azure Data Lake Analytics v rámci předplatného Azure**
...
**Výpis cesty úložiště pomocí palety příkazů**
...
**Výpis cesty úložiště v místní nabídce**
...
**Stažení souboru pomocí příkazu ADL: Download File (rozšířené)**
...
**Stažení souboru pomocí příkazu ADL: Download File**
...
2. Zvolte složku v seznamu nebo vyberte možnost **zadat cestu** nebo **Přejít z kořenové cesty**. (Jako příklad používáme **cestu ENTER** .) 
3. Vyberte účet Data Lake Analytics. 
4. Vyhledejte nebo zadejte cestu ke složce úložiště (například složku/Output/) a potom vyberte soubor, který chcete stáhnout.

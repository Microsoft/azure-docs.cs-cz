...
* [Konec podpory](/sql/sql-server/end-of-support/sql-server-end-of-life-overview) & [rozšířených aktualizací zabezpečení](/sql/sql-server/end-of-support/sql-server-extended-security-updates)
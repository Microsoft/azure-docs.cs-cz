...
### <a name="q-what-is-a-hardware-security-module-hsm"></a>DOTAZ: Co je modulu hardwarového zabezpečení (HSM)?
...
### <a name="q-what-is-the-azure-dedicated-hsm-offering"></a>DOTAZ: Co je nabídka Azure vyhrazené HSM?
...
### <a name="q-what-hardware-is-used-for-dedicated-hsm"></a>DOTAZ: Jaký hardware se používá pro vyhrazené HSM?
...
### <a name="q-what-is-an-hsm-used-for"></a>DOTAZ: K čemu se HSM používá?
...
### <a name="q-how-does-dedicated-hsm-work"></a>DOTAZ: Jak služba Rezervované HSM funguje?
...
### <a name="q-does-azure-dedicated-hsm-offer-password-based-and-ped-based-authentication"></a>DOTAZ: Nabízí vyhrazený modulu hardwarového zabezpečení Azure založené na heslech a na základě PED ověřování?
...
### <a name="q-how-does-my-application-connect-to-a-dedicated-hsm"></a>DOTAZ: Jak aplikaci připojit k modulu hardwarového zabezpečení vyhrazené?
...
### <a name="q-can-an-application-connect-to-dedicated-hsm-from-a-different-vnet-in-or-across-regions"></a>DOTAZ: Můžete aplikaci připojit k vyhrazené modulu hardwarového zabezpečení z jiné virtuální síti v nebo víc oblastech?
...
### <a name="q-can-i-synchronize-dedicated-hsm-with-on-premises-hsms"></a>DOTAZ: Můžete synchronizovat vyhrazené HSM s místním HSM?
...
### <a name="q-can-i-encrypt-data-used-by-other-azure-services-using-keys-stored-in-dedicated-hsm"></a>DOTAZ: Můžete šifrovat data používaná dalšími službami Azure, pomocí klíčů uložených v HSM vyhrazený?

Ne. Azure vyhrazené moduly Hms jsou pouze dostupné z uvnitř virtuální sítě.

### <a name="q-can-i-import-keys-from-an-existing-on-premises-hsm-to-dedicated-hsm"></a>DOTAZ: Můžu import klíče z existujícího místního modulu HSM do modulu hardwarového zabezpečení vyhrazené?
...
### <a name="q-what-operating-systems-are-supported-by-dedicated-hsm-client-software"></a>DOTAZ: Jaké operační systémy podporují HSM vyhrazený klientský software?

* Windows, Linux, Solaris, AIX, HP-UX, FreeBSD
* Virtuální: VMware, hyperv, Xen, KVM

### <a name="q-how-do-i-configure-my-client-application-to-create-a-high-availability-configuration-with-multiple-partitions-from-multiple-hsms"></a>DOTAZ: Jak nakonfigurovat Moje klientská aplikace pro vytvoření konfigurace vysoké dostupnosti s více oddílů z více modulů hardwarového zabezpečení?
...
### <a name="q-what-authentication-mechanisms-are-supported-by-dedicated-hsm"></a>DOTAZ: Jaké ověřovací mechanismy, které podporují vyhrazené HSM?

Azure vyhrazené HSM používá 7 HSM SafeNet síťových zařízení (model A790) a podporují ověřování pomocí hesla.

### <a name="q-what-sdks-apis-client-software-is-available-to-use-with-dedicated-hsm"></a>DOTAZ: Jaký software klienta sady SDK, rozhraní API, je k dispozici pro použití s vyhrazené HSM?

PKCS č. 11, Java (JCA/balíčku JCE), Microsoft CAPI a CNG, OpenSSL

### <a name="q-can-i-importmigrate-keys-from-luna-56-hsms-to-azure-dedicated-hsms"></a>DOTAZ: Můžu importovat nebo migrovat klíče z Luna 5/6 HSM do modulů HSM služby Azure vyhrazené?

Ano. Najdete v Průvodci migrací Gemalto. 

## <a name="using-your-hsm"></a>Pomocí vašeho HSM

### <a name="q-how-do-i-decide-whether-to-use-azure-key-vault-or-azure-dedicated-hsm"></a>DOTAZ: Jak se rozhodnout, jestli chcete používat Azure Key Vault nebo Azure vyhrazené HSM?
...
### <a name="q-what-usage-scenarios-best-suit-azure-dedicated-hsm"></a>DOTAZ: Co nejlepší využití scénáře podle vyhrazených modulu hardwarového zabezpečení Azure?
...
### <a name="q-can-dedicated-hsm-be-used-with-office-365-customer-key-azure-information-protection-azure-data-lake-store-disk-encryption-azure-storage-encryption-azure-sql-tde"></a>DOTAZ: Je možné používat Rezervované HSM společně s klíčem zákazníka Office 365, službami Azure Information Protection, Azure Data Lake Store, Disk Encryption, šifrováním služby Azure Storage nebo transparentním šifrováním dat Azure SQL?
...
### <a name="q-does-the-customer-get-full-exclusive-control-over-the-hsms-with-dedicated-hsms"></a>DOTAZ: Zákazník získat úplné výhradní kontrolu nad moduly hardwarového zabezpečení pomocí vyhrazené HSM?
...
### <a name="q-what-level-of-access-does-microsoft-have-to-my-hsm"></a>DOTAZ: Jakou úroveň přístupu má Microsoft nějaké Moje HSM?
...
### <a name="q-can-microsoft-or-anyone-at-microsoft-access-keys-in-my-dedicated-hsm"></a>DOTAZ: Může společnost Microsoft ani nikomu v Microsoft přístupových klíčů v mé vyhrazené HSM?

Ne. Microsoft nemá přístup k klíčů uložených v zákazníka přidělené vyhrazené modulu hardwarového zabezpečení.

### <a name="q-can-i-upgrade-softwarefirmware-on-hsms-allocated-to-me"></a>DOTAZ: Můžete upgradovat software a firmware na moduly hardwarového zabezpečení přidělené pro mě?
...
### <a name="q-how-do-i-manage-dedicated-hsm"></a>DOTAZ: Jak můžu spravovat vyhrazené HSM?

Vyhrazené moduly hardwarového zabezpečení můžete spravovat přístup k nim pomocí protokolu SSH.

### <a name="q-how-do-i-manage-partitions-on-the-dedicated-hsm"></a>DOTAZ: Jak můžu spravovat oddíly na vyhrazené HSM?

Klientský software Gemalto HSM se používá ke správě modulů hardwarového zabezpečení a oddíly.

### <a name="q-how-do-i-monitor-my-hsm"></a>DOTAZ: Jak můžu monitorovat Moje HSM?
...
### <a name="q-can-i-get-full-access-log-of-all-hsm-operations-from-dedicated-hsm"></a>DOTAZ: Můžete získat plný přístup protokolu všech operací modulu hardwarového zabezpečení z vyhrazené HSM?

Ano. Odeslání protokolů z modulu hardwarového zabezpečení zařízení na syslog server

## <a name="high-availability"></a>Vysoká dostupnost

### <a name="q-is-it-possible-to-configure-high-availability-in-the-same-region-or-across-multiple-regions"></a>DOTAZ: Je možné ke konfiguraci vysoké dostupnosti ve stejné oblasti nebo v několika oblastech?
...
### <a name="q-how-many-hsms-can-i-add-to-the-same-high-availability-configuration-from-one-single-application"></a>DOTAZ: Kolik modulů hardwarového zabezpečení je možné přidat do stejné konfigurace vysoké dostupnosti z jednoho jednu aplikaci?

16.

## <a name="support"></a>Podpora

### <a name="q-what-is-the-sla-for-dedicated-hsm-service"></a>DOTAZ: Co je smlouva SLA pro službu vyhrazené HSM?
...
### <a name="q-how-are-the-hsms-used-in-azure-dedicated-hsm-protected"></a>DOTAZ: Jak se používají moduly hardwarového zabezpečení v Azure vyhrazená chráněné HSM?
...
### <a name="q-what-happens-if-there-is-a-security-breach-or-hardware-tampering-event"></a>DOTAZ: Co se stane, pokud dojde k porušení zabezpečení nebo hardware manipulaci události?
...
### <a name="q-how-do-i-ensure-that-keys-in-my-dedicated-hsms-are-not-lost-due-to-error-or-a-malicious-insider-attack"></a>DOTAZ: Jak zajistit, že klíče v modulech HSM Moje vyhrazené neztratily z důvodu chyby nebo útok zlými úmysly?
...
### <a name="q-how-do-i-get-support-for-dedicated-hsm"></a>DOTAZ: Jak získám podporu pro vyhrazené HSM?
...
### <a name="q-how-do-i-get-access-to-dedicated-hsm-client-software-documentation-firmware-images"></a>DOTAZ: Jak získám přístup k modulu hardwarového zabezpečení vyhrazené klientský software, dokumentaci, imagích firmwaru?
...
### <a name="q-if-there-is-a-security-vulnerability-found-and-a-patch-is-released-by-gemalto-who-is-responsible-for-upgradingpatching-osfirmware"></a>DOTAZ: Pokud není nalezena ohrožení zabezpečení a opravy vydání podle Gemalto, který je zodpovědný za upgradu nebo opravy operačního systému/firmwaru?
...
### <a name="q-is-it-safe-to-store-encryption-keys-for-my-most-important-data-in-dedicated-hsm"></a>DOTAZ: Je bezpečné ukládání šifrovacích klíčů pro nejdůležitější data ve vyhrazené HSM?

Ano, vyhrazené HSM zřídí 7 HSM SafeNet síťových zařízení, že ověřených modulů HSM s FIPS 140-2 úrovně 3 použití. 

### <a name="q-what-cryptographic-keys-and-algorithms-are-supported-by-dedicated-hsm"></a>DOTAZ: Jaké kryptografických klíčů a algoritmy podporuje vyhrazené HSM?
...
### <a name="q-what-do-i-need-to-do-to-make-sure-i-operate-dedicated-hsm-in-fips-140-2-level-3-validated-mode"></a>DOTAZ: Co musím udělat pro Ujistěte se, že můžu pracovat vyhrazené modulu hardwarového zabezpečení v FIPS 140-2 Level 3 ověření režimu?
...
### <a name="q-how-many-cryptographic-operations-are-supported-per-second-with-dedicated-hsm"></a>DOTAZ: Kolik kryptografické operace jsou podporovány za sekundu s vyhrazené HSM?
...
### <a name="q-how-many-partitions-can-be-created-in-dedicated-hsm"></a>DOTAZ: Počet oddílů je možné vytvořit v vyhrazené HSM?

Podle konkrétní model HSM používá, existují 10 oddíly, které jsou k dispozici.

### <a name="q-how-many-keys-can-be-supported-in-dedicated-hsm"></a>DOTAZ: Kolik klíčů se může v modulu hardwarového zabezpečení vyhrazené podporovaný?

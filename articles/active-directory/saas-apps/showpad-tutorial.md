---
title: 'Kurz: Integrace Azure Active Directory se službou Showpad | Dokumentace Microsoftu'
...
ms.locfileid: "39050755"
---
# <a name="tutorial-azure-active-directory-integration-with-showpad"></a>Kurz: Integrace Azure Active Directory se službou Showpad
...
5. Na panelu výsledků vyberte **Showpad**a potom klikněte na tlačítko **přidat** tlačítko pro přidání aplikace.
...
3. **[Vytvoření zkušebního uživatele Showpad](#creating-a-showpad-test-user)**  – Pokud chcete mít protějšek Britta Simon Showpad, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **Showpad domény a adresy URL** části, proveďte následující kroky:
...
6. Přihlašování k vašemu tenantovi Showpad jako správce.
...
8. Přejděte na "**Single Sign-On**"a klikněte na tlačítko"**povolit**."
   
    ![Konfigurace jednotného přihlašování na straně aplikace](./media/showpad-tutorial/tutorial_showpad_002.png)

9. Na **přidání služby SAML 2.0** dialogového okna, proveďte následující kroky:

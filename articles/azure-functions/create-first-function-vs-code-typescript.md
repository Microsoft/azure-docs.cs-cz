---
title: Vytvoření funkce TypeScript pomocí Visual Studio Code-Azure Functions
...
K dispozici je také verze tohoto článku [na bázi CLI](create-first-function-cli-typescript.md) .

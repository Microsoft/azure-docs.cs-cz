...
| [Maximální velikost vlákna zařízení](../articles/iot-hub/iot-hub-devguide-device-twins.md#device-twin-size) <br/> (značky, ohlášené vlastnosti a požadované vlastnosti) | 8 kB |
...
| Operace nahrávání souborů |83,33 oznámení o nahrání souborů za sekundu/jednotku (5000/min/jednotku) (pro S3), 1,67 oznámení o nahrávání souborů/s/jednotku (100/min/jednotku) (pro S1 a S2) <br/> 10 000 identifikátorů URI SAS může být v jednom okamžiku pro účet Azure Storage.<br/> Najednou může existovat 10 identifikátorů URI SAS/zařízení. |

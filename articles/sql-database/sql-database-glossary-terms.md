...
|Služba COMPUTE úrovně|Bez serveru (preview)|[úroveň výpočetní prostředí](sql-database-serverless.md)
...
|Objekty serveru|Databáze SQL server nebo databázový server|[Databázový server](sql-database-servers.md)|

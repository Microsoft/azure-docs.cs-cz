...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/accredible-tutorial/tutorial_accredible_samlbase.png)

3. Na **Accredible domény a adresy URL** část, proveďte následující kroky:

    ![Accredible domény a adresy URL jednotné přihlašování informace](./media/accredible-tutorial/tutorial_accredible_url.png)
...
5. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/accredible-tutorial/tutorial_general_400.png)
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/accredible-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **Accredible**.
    ...
    ![V seznamu aplikací na Accredible odkaz](./media/accredible-tutorial/tutorial_accredible_app.png)  

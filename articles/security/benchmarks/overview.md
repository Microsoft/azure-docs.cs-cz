...
Uvítáme vaši podrobnou zpětnou vazbu a aktivní účast v úsilí Azure Security test. Pokud chcete poskytnout přímý vstup benchmarkového týmu, vyplňte prosím formulář na [https://aka.ms/AzSecBenchmark](https://aka.ms/AzSecBenchmark).

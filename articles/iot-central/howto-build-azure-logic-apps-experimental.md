...
1. Po úspěšném vytvoření aplikace logiky se automaticky přejde na návrháře pro Logic Apps. Vyberte **prázdná aplikace logiky**. 
...
Můžete vždy začněte vytvářet pracovního postupu pomocí IoT Central konektor v Logic Apps na webu Azure Portal. Pak můžete vybrat která aplikace IoT Central a pravidlo, které se připojit k a stále funguje stejným způsobem. Není nutné spustit pokaždé, když ze stránky pravidla IoT Central.
...
Při vytváření pracovního postupu ve vaší aplikaci logiky, můžete přidat akci s použitím konektoru IoT Central. Jsou k dispozici akce **vytvoření zařízení**, **aktualizovat zařízení**, a **odstranit zařízení**.
...
Teď, když jste zjistili, jak používat Microsoft Flow k vytváření pracovních postupů, navrhované dalším krokem je [spravovat zařízení](howto-manage-devices-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json).

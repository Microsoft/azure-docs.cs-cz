---
title: Srovnávacích testů COMPUTE pro virtuální počítače Azure s Linuxem | Dokumentace Microsoftu
description: Porovnejte výsledky srovnávacích CoreMark výpočetní pro virtuální počítače Azure s Linuxem.
...
ms.locfileid: "67668148"
---
# <a name="compute-benchmark-scores-for-linux-vms"></a>Srovnávacích testů COMPUTE pro virtuální počítače s Linuxem
Následující srovnávacích CoreMark zobrazit výpočetní výkon pro vysoce výkonné produktové řadě virtuálního počítače Azure s Ubuntu. Výpočetní srovnávacích jsou také k dispozici pro [virtuální počítače s Windows](../windows/compute-benchmark-scores.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).

## <a name="av2---general-compute"></a>Av2 - obecné výpočetní
(3/15/2019 12:06:55 AM pbi 3897709)

| Velikost virtuálního počítače | Procesor | virtuální procesory | Uzly NUMA | Memory(GiB) | Průměrné skóre | StdDev | StdDev% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
...
## <a name="b---burstable"></a>B - zvládáním výkonových špiček
...
## <a name="dsv3---general-compute--premium-storage"></a>DSv3 - obecné Compute a Storage úrovně Premium
...
## <a name="dv3---general-compute"></a>Dv3 - obecné výpočetní
...
## <a name="dsv2---storage-optimized"></a>DSv2 - optimalizované z hlediska úložiště
...
## <a name="dv2---general-compute"></a>Řada Dv2 - obecné výpočetní
...
## <a name="eisv3---memory-opt--premium-storage-isolated"></a>Eisv3 - paměti Opt + Storage úrovně Premium (izolovaný režim)
...
## <a name="eiv3---memory-optimized-isolated"></a>Eiv3 - paměťově optimalizováno (izolovaný režim)
...
## <a name="fsv2---compute--storage-optimized"></a>Fsv2 – výpočetní + optimalizované z hlediska úložiště
(3/12/2019 6:51:35 PM pbi 3897709)

| Velikost virtuálního počítače | Procesor | virtuální procesory | Uzly NUMA | Memory(GiB) | Průměrné skóre | StdDev | StdDev% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_F2s_v2 | Intel(R) Xeon(R) CPU Platinum 8168 @ 2.70GHz | 2 | 1 | 3.9 | 28,219 | 1,843 | 6.53% | 700 |
| Standard_F4s_v2 | Intel(R) Xeon(R) CPU Platinum 8168 @ 2.70GHz | 4 | 1 | 7.8 | 53,911 | 1,002 | 1.86% | 707 |
| Standard_F8s_v2 | Intel(R) Xeon(R) CPU Platinum 8168 @ 2.70GHz | 8 | 1 | 15.7 | 106,467 | 1,101 | 1.03% | 707 |
| Standard_F16s_v2 | Intel(R) Xeon(R) CPU Platinum 8168 @ 2.70GHz | 16 | 1 | 31.4 | 211,311 | 1,724 | 0.82% | 707 |
| Standard_F32s_v2 | Intel(R) Xeon(R) CPU Platinum 8168 @ 2.70GHz | 32 | 1 | 62.9 | 423,175 | 4,346 | 1.03% | 707 |
| Standard_F64s_v2 | Intel(R) Xeon(R) CPU Platinum 8168 @ 2.70GHz | 64 | 2 | 125.9 | 829,537 | 21,574 | 2.60% | 707 |
| Standard_F72s_v2 | Intel(R) Xeon(R) CPU Platinum 8168 @ 2.70GHz | 72 | 2 | 141.7 | 933,800 | 26,783 | 2.87% | 707 |

## <a name="fs---compute-and-storage-optimized"></a>Služba FS – výpočetní prostředky a optimalizované pro úložiště
...
## <a name="gs---storage-optimized"></a>GS – optimalizované z hlediska úložiště
(3/12/2019 pbi 3897709 22:22:33: 00)
...
## <a name="lv2---storage-optimized"></a>Lv2 – optimalizované z hlediska úložiště
(3/14/2019 5:49:04 PM pbi 3897709)

| Velikost virtuálního počítače | Procesor | virtuální procesory | Uzly NUMA | Memory(GiB) | Průměrné skóre | StdDev | StdDev% | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_L8s_v2 | Procesor AMD EPYC 7551 32 jádry | 8 | 1 | 62.9 | 80,528 | 404 | 0.50% | 119 |
| Standard_L16s_v2 | Procesor AMD EPYC 7551 32 jádry | 16 | 2 | 125.9 | 154,829 | 3,708 | 2.40% | 119 |
| Standard_L32s_v2 | Procesor AMD EPYC 7551 32 jádry | 32 | 4 | 251.9 | 310,811 | 7,751 | 2.49% | 119 |
| Standard_L64s_v2 | Procesor AMD EPYC 7551 32 jádry | 64 | 8 | 503.9 | 595,140 | 14,572 | 2.45% | 112 |
| Standard_L80s_v2 | Procesor AMD EPYC 7551 32 jádry | 80 | 10 | 629.9 | 773,171 | 19,559 | 2.53% | 119 |

## <a name="ls---storage-optimized"></a>Ls - optimalizované z hlediska úložiště
...
## <a name="ncsv3---gpu-enabled"></a>NCSv3 – s podporou grafického procesoru
...
## <a name="ncsv2---gpu-enabled"></a>NCSv2 – s podporou grafického procesoru
...
## <a name="nc---gpu-enabled"></a>NC - s podporou grafického procesoru
...
## <a name="nds--gpu-enabled"></a>S podporou grafického procesoru NDs-
...
## <a name="nv---gpu-enabled"></a>NV - s podporou grafického procesoru
...
## <a name="about-coremark"></a>About CoreMark
Linux čísla byly vypočítané spuštěním [CoreMark](https://www.eembc.org/coremark/faq.php) na Ubuntu. CoreMark byl nakonfigurován s počtem vláken, nastavte počet virtuálních procesorů a souběžnosti nastavte PThreads. Cílový počet iterací byla upravena podle očekávaný výkon poskytnout runtime aspoň 20 sekund (obvykle mnohem déle). Konečný výsledek představuje počet iterací dokončit vydělí počtem sekund, po které trvalo spuštění testu. Každý test spustil alespoň sedminásobně na každém virtuálním počítači. Testovací běh data uvedené výše. Testy spuštěny na několika virtuálních počítačů ve veřejných oblastech Azure, virtuálního počítače byla podporována v datu spustit. Základní řady a a B (zvládáním výkonových špiček) není zobrazen, protože proměnná je výkon. Řada N nezobrazují, protože jde o GPU na střed a Coremark nebude měřit výkon GPU.

## <a name="next-steps"></a>Další postup
* Kapacity úložiště, podrobných informací o discích a další faktory pro výběr mezi velikostmi virtuálních počítačů najdete v tématu [velikosti virtuálních počítačů](sizes.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
* Spouštění skriptů CoreMark na virtuální počítače s Linuxem, stáhněte si [CoreMark skript pack](https://download.microsoft.com/download/3/0/5/305A3707-4D3A-4599-9670-AAEB423B4663/AzureCoreMarkScriptPack.zip).

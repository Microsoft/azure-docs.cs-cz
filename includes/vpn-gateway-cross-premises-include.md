...
| **Podporované protokoly** |Protokol SSTP (Secure Sockets Tunneling Protocol), OpenVPN a IPsec |Protokol IPsec |Přímé připojení přes sítě VLAN, technologie VPN od poskytovatelů síťových služeb (MPLS, VPLS…) |
...
| **Technická dokumentace** |[Dokumentace služby VPN Gateway](https://azure.microsoft.com/documentation/services/vpn-gateway/) |[Dokumentace služby VPN Gateway](https://azure.microsoft.com/documentation/services/vpn-gateway/) |[Dokumentace ke službě ExpressRoute](https://azure.microsoft.com/documentation/services/expressroute/) |

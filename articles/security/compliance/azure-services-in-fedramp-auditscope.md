...
| _Poslední aktualizace: Červenec 2019_ |
...
| [Rozšířená ochrana před internetovými útoky Azure](https://azure.microsoft.com/features/azure-advanced-threat-protection/) |  | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Průzkumník dat Azure](https://azure.microsoft.com/en-us/services/data-explorer/) | |  |  | :heavy_check_mark: |
...
| [Rozšířená ochrana před internetovými útoky v Defenderu](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/microsoft-defender-advanced-threat-protection) |  | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Tok](https://docs.microsoft.com/flow/getting-started) |  | :heavy_check_mark: | :heavy_check_mark: |  |
...
## <a name="azure-government-services-by-audit-scope"></a>Služby Azure pro státní správu podle oboru auditu
| _Poslední aktualizace: Červenec 2019_ |
...
| [Databox Edge Azure](https://azure.microsoft.com/en-us/services/databox/edge/) |  |  |  |  | :heavy_check_mark:
...
| [Cognitive Services: Plochy](https://azure.microsoft.com/services/cognitive-services/face/)  |  |  |  |  | :heavy_check_mark:
...
| [Cognitive Services: Analýza textu](https://azure.microsoft.com/services/cognitive-services/text-analytics/)  |  |  |  |  | :heavy_check_mark:
...
| [Rozšířená ochrana před internetovými útoky v programu Microsoft Defender](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/microsoft-defender-advanced-threat-protection)  |  |  |  |  | :heavy_check_mark:

---
title: Nejčastější dotazy týkající se zálohování SQL Server databází na virtuálních počítačích Azure s využitím Azure Backup
...
Tento článek obsahuje odpovědi na běžné dotazy týkající se zálohování SQL Server databází, které běží na virtuálních počítačích Azure a využívají službu [Azure Backup](backup-overview.md) .
...
4. V SQL Server instance otevřete **Správce úloh**. Restartujte službu **AzureWLBackupCoordinatorSvc** .<br/> <br/>
 I když tato metoda pomáhá, pokud zálohovací aplikace spotřebovává spoustu prostředků, je SQL Server [Správce zdrojů](https://docs.microsoft.com/sql/relational-databases/resource-governor/resource-governor?view=sql-server-2017) obecnější způsob, jak určit omezení pro velikost procesoru, fyzickou v/v a paměť, kterou můžou příchozí žádosti o aplikace použít.
...
V případě omezení pro SQL můžete spustit kopírování pouze úplné zálohy na sekundární replice; Úplné zálohování se ale nepovoluje.
...
Znovu pojmenovaná databáze se považuje za novou databázi. Proto se služba bude považovat za tuto situaci, jako kdyby nebyla nalezena databáze a selhala zálohování.

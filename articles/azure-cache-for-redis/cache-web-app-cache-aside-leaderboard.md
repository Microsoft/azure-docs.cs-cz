...
1. `using`Do **TeamsController. cs** přidejte následující dva příkazy:
...
1. Posuňte se do dolní části souboru **index. cshtml** a přidejte následující `tr` element tak, aby byl posledním řádkem poslední tabulky v souboru:

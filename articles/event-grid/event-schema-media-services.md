---
title: Mediální služby Azure jako zdroj mřížky událostí
...
---
# <a name="azure-media-services-as-an-event-grid-source"></a>Mediální služby Azure jako zdroj mřížky událostí
...
Kódy výsledků chyb najdete v [kódech chyb živých událostí](../media-services/latest/live-event-error-codes.md).
...
[Registrovat se pro události změny stavu úlohy](../media-services/latest/job-state-events-cli-how-to.md)

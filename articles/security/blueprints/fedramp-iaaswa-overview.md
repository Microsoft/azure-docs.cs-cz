...
![alternativní text](images/fedramp-iaaswa-architecture.png?raw=true "zabezpečení Azure a dodržování předpisů plán, podle kterého - FedRAMP webové aplikace automatizace")

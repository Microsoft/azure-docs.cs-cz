...
V trezoru můžete chránit až 2000 zdrojů dat a položek napříč všemi úlohami (IaaS VM, SQL, AFS atd.).
...
### <a name="if-a-backup-is-kept-for-a-long-time-does-it-take-more-time-to-recover-an-older-data-point"></a>Pokud je zálohování po dlouhou dobu zachované, trvá obnovení staršího datového bodu déle?
...
Architektura úložiště Azure Backup nabízí to nejlepší z obou světů – optimální ukládání dat pro rychlé obnovení a nízké poplatky za úložiště. Tím zajistíte efektivní využití šířky pásma příchozího a odchozího přenosu dat. Velikost úložiště dat a čas potřebný k obnovení dat se uchovávají minimálně. Přečtěte si další informace o [přírůstkových zálohách](https://azure.microsoft.com/blog/microsoft-azure-backup-save-on-long-term-storage/).

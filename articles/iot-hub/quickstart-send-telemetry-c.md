...
V této části použijete Azure Cloud Shell s [rozšířením IoT](/cli/azure/ext/azure-iot/iot?view=azure-cli-latest&preserve-view=true) , abyste mohli monitorovat zprávy zařízení odesílané simulovaným zařízením.

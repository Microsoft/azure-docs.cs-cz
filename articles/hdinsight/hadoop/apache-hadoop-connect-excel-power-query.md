...
1. Proveďte následující kroky v závislosti na verzi aplikace Excel:
   ...
   * Excel 2016
     ...
     * **Z Azure HDInsight (HDFS)** vyberte > **data** > **z Azure** > **získat data** > .

       ![HDI. PowerQuery. SelectHdiSource. 2016](./media/apache-hadoop-connect-excel-power-query/powerquery-selecthdisource-excel2016.png)

   * Excel 2013/2010

     * **Ze Microsoft Azure HDInsight**vyberte **Power Query** > **ze služby Azure** > .

       ![HDI.PowerQuery.SelectHdiSource](./media/apache-hadoop-connect-excel-power-query/powerquery-selecthdisource.png)

       **Poznámka:** Pokud nevidíte nabídku **Power Query** , přejděte na **soubor** > **Možnosti** > **Doplňky**a v rozevíracím seznamu **Spravovat** v dolní části stránky vyberte **Doplňky modelu COM** . Vyberte tlačítko **Přejít do...** a ověřte, že je zaškrtnuté políčko pro doplněk Power Query pro Excel.

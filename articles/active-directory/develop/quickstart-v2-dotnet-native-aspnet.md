...
### <a name="configure-the-service-and-client-projects-to-match-the-registered-web-api"></a>Konfigurace projektů služby a klienta tak, aby odpovídaly zaregistrovanému webovému rozhraní API 

...
Získat [přehled upozornění protokolu aktivit](monitoring-overview-alerts.md) a zjistěte, jak nechte se upozornit,  
Další informace o [rychlosti SMS](monitoring-alerts-rate-limiting.md)  

...
| Parametr | Požadováno | Typ | Popis |
|:--- |:--- |:--- |:--- |
| valueToConvert |Ano | Vše |Hodnota, která má být převedena na řetězec. Jakýkoli typ hodnoty lze převést, včetně objektů a polí. |

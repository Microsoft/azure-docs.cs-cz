...
1. Ve webovém prohlížeči zkopírujte předchozí řetězec a `region`nahraďte, `appId`, `luisKey` `bingKey` a vlastními hodnotami. Pokud se liší od [oblasti](luis-reference-regions.md)publikování, nezapomeňte použít oblast koncového bodu.

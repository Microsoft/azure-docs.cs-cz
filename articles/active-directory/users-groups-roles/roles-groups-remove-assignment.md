...
1. Vyberte role **a**  >  ***název role***správců.

1. Vyberte skupinu, ze které chcete odebrat přiřazení role, a vyberte **odebrat přiřazení**.

   ![Odebere přiřazení role z vybrané skupiny.](./media/roles-groups-remove-assignment/remove-assignment.png)

...
1. Do vyhledávacího pole zadejte **ContractWorks**vyberte **ContractWorks** z panelu výsledků klikněte **přidat** tlačítko pro přidání aplikace.
...
1. **[Vytvoření zkušebního uživatele ContractWorks](#create-a-contractworks-test-user)**  – Pokud chcete mít protějšek Britta Simon ContractWorks, který je propojený s Azure AD reprezentace uživatele.
...
1. Na **ContractWorks domény a adresy URL** části, proveďte následující kroky, pokud chcete nakonfigurovat aplikace v **IDP** iniciované režimu:
...
1. ContractWorks aplikace očekává, že kontrolní výrazy SAML v určitém formátu. Nakonfigurujte následující deklarace identity pro tuto aplikaci. Můžete spravovat hodnotami těchto atributů z **atributy uživatele** části na stránce aplikací pro integraci. Následující snímek obrazovky ukazuje příklad pro tuto.
...
1. Ke konfiguraci jednotného přihlašování na **ContractWorks** straně, je nutné odeslat generované **adresa Url federačních metadat aplikace** k [tým podpory ContractWorks](mailto:support@contractworks.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.
...
1. V seznamu aplikací vyberte **ContractWorks**.

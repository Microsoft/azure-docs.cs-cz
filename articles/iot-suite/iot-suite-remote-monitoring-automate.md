...
![Stránka pravidla a akce](media/iot-suite-remote-monitoring-automate/rulesactions_v2.png)

Chcete-li zobrazit pouze pravidla, která se týkají **chladič** zařízení, použít filtr:

![Filtrovat seznam pravidel](media/iot-suite-remote-monitoring-automate/rulesactionsfilter_v2.png)

Můžete zobrazit další informace o pravidlo a upravit ho, když ji vyberete v seznamu:

![Zobrazení podrobností pravidla](media/iot-suite-remote-monitoring-automate/rulesactionsdetail_v2.png)

K zakázání, povolení nebo odstranění jednoho nebo více pravidel, vyberte v seznamu více pravidel:

![Vyberte více pravidel](media/iot-suite-remote-monitoring-automate/rulesactionsmultiselect_v2.png)
...
![Vytvořit pravidlo](media/iot-suite-remote-monitoring-automate/rulesactionsnewrule_v2.png)
...
![Vytvoření pravidla mult](media/iot-suite-remote-monitoring-automate/rulesactionsnewrule_mult_v2.png)
...
| Úroveň Serverity  | Kritická                              |

Pokud chcete přidat druhou podmínku, klikněte na "+ Přidat podmínku".

![Vytvořit podmínku 2](media/iot-suite-remote-monitoring-automate/rulesactionsnewrule_mult_cond2_v2.png)
...
![Upravit pravidlo](media/iot-suite-remote-monitoring-automate/rulesactionsedit_v2.png)

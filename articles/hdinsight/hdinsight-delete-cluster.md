...
V následujícím kódu nahraďte `CLUSTERNAME` názvem vašeho clusteru HDInsight. Z příkazového řádku PowerShellu zadejte následující příkaz pro odstranění clusteru:

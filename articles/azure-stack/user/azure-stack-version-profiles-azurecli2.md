...
1. Zaregistrovat vaším prostředím Azure Stack spuštěním `az cloud register` příkazu.
    ...
    Registrace prostředí tak, že zadáte název. Zadejte název prostředí po `-n` přepnout. Použití `AzureStackUser` pro uživatelské prostředí. Pokud operátor, zadat `AzureStackAdmin`.
...
2. Registrace prostředí tak, že zadáte název. Zadejte název prostředí po `-n` přepnout. Použití `AzureStackUser` pro uživatelské prostředí. Pokud operátor, zadat `AzureStackAdmin`.

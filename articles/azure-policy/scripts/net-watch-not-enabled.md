---
title: Ukázka kódu JSON pro Azure Policy – Provedení auditu, pokud oblast nemá povolenou službu Network Watcher | Microsoft Docs
description: Tato ukázková zásada JSON provede audit, pokud pro zadanou oblast není povolena služba Network Watcher.
...
ms.locfileid: "34602563"
---
# <a name="audit-if-network-watcher-is-not-enabled-for-region"></a>Provedení auditu, pokud oblast nemá povolenou službu Network Watcher

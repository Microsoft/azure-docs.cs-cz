...
2. **[Konfigurace jednotného přihlašování QUESTETRA BPM Suite](#configure-questetra-bpm-suite-single-sign-on)** – ke konfiguraci nastavení jednotného přihlašování na straně aplikace
...
### <a name="configure-questetra-bpm-suite-single-sign-on"></a>Konfigurace jednotného přihlašování Questetra BPM Suite

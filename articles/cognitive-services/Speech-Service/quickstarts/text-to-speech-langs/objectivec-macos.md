...
1. Vyberte adresář projektu.
    1. Vyberte adresář, do kterého se má projekt umístit. Tím se vytvoří adresář `helloworld` v domovském adresáři, který obsahuje všechny soubory projektu Xcode.

...
| `addr` | řetězec | IP adresa nebo název hostitele a pravděpodobně port připojení klienta, které spustilo událost. Tato hodnota je RemoteAddr ze standardního požadavku HTTP. |

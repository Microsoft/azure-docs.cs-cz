...
1. Vyberte adresář projektu.
    1. Zvolte svůj domovský adresář, do kterého se projekt umístí. Tím se vytvoří adresář `helloworld` v domovském adresáři, který obsahuje všechny soubory projektu Xcode.

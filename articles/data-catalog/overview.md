...
Azure Data Catalog je plně spravovaná Cloudová služba. Umožňuje uživatelům zjišťovat data zdroje, které potřebují a porozumět zdrojům dat, které se vyskytnout. Zároveň Data Catalog pomáhá organizacím vytěžit více z jejich stávajících investic.
...
* Uživatelé nemusí vědět, že zdrojem dat existuje, ledaže styku jako součástí jiného procesu. Žádné centrální umístění, kde jsou zdroje dat registrovány, neexistuje.
...
* Pokud mají uživatelé dotazy týkající se informačního prostředku, musí vyhledat odborníka nebo tým odpovědný za příslušná data a zapojit tyto odborníky offline. Neexistuje žádné explicitní spojení mezi daty a odborníky, které mají perspektivy na jejich použití.
...
* Vytváření dokumentace pro zdroje dat je také často ztráta času. Synchronizování dokumentace se zdroji dat je neustávající odpovědnost. Uživatelé mohou nemají důvěru v dokumentaci, která je vnímané jako zastaralé.

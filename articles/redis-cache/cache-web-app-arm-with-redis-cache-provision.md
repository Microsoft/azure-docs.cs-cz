...
Pro úplnou šablonu, najdete v části [webové aplikace s Redis Cache šablony](https://github.com/Azure/azure-quickstart-templates/blob/master/201-web-app-with-redis-cache/azuredeploy.json).
...
Tato šablona používá proměnné vytvořit názvy pro prostředky. Použije [uniqueString](../azure-resource-manager/resource-group-template-functions-string.md#uniquestring) funkce vytvořit hodnotu podle id skupiny prostředků.
...
Vytvoří Azure Redis Cache, která se používá s webovou aplikaci. Název mezipaměti je zadán v **cacheName** proměnné.

Šablona vytvoří mezipaměti ve stejném umístění jako pro skupinu prostředků.
...
Vytvoří webovou aplikaci s názvem zadaným v **zadaným hodnotám webSiteName** proměnné.

Všimněte si, že webová aplikace nakonfigurovaná s vlastností nastavení aplikace, které umožňují ho na spolupráci s Redis Cache. Tuto aplikaci, které nastavení se vytvářejí dynamicky podle hodnoty poskytnuté během nasazení.

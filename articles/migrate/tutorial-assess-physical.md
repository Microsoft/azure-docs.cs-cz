...
1. Na stránce **servery** > **serverech se systémem Windows a Linux**klikněte na možnost **zhodnotit a migrovat servery**.
   ...
   ![Umístění tlačítka pro posouzení a migraci serverů](./media/tutorial-assess-physical/assess.png)

2. V **Azure Migrate: vyhodnocování serveru**klikněte na **vyhodnotit**.

    ![Umístění tlačítka pro vyhodnocení](./media/tutorial-assess-physical/assess-servers.png)
...
6. Kliknutím na **Zobrazit vše** zobrazíte vlastnosti posouzení.
    ...
    ![Umístění tlačítka Zobrazit vše pro kontrolu vlastností posouzení](./media/tutorial-assess-physical/assessment-name.png)
...
10. Pokud provedete změny, klikněte na **Uložit** .
    ...
    ![Vlastnosti posouzení](./media/tutorial-assess-physical/assessment-properties.png)

...
Na stránce **seznam nabídek** v části **Podrobnosti o Marketplace**proveďte následující kroky. Další informace o těchto požadovaných podrobnostech najdete v tématu věnovaném [podrobnostem o seznamu nabídek](plan-saas-offer.md#offer-listing-details).
...
## <a name="add-links-to-supplemental-online-documentation-optional"></a>Přidat odkazy na dodatečnou online dokumentaci (volitelné)

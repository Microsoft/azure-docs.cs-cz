...
description: Přečtěte si o nejběžnějších chybách a omezeních, ke kterým dochází během migrace prostředků IaaS ze správy služeb Azure do zásobníku služby Azure Resource Manager.
author: tanmaygore
manager: vashan

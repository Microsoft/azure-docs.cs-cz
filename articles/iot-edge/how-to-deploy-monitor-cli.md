...
* **--Deployment-ID** – název nasazení, které se vytvoří ve službě IoT Hub. Zadejte jedinečný název, který je malá písmena až 128 vašeho nasazení. Vyhněte se mezerám a následujícími neplatnými znaky: `& ^ [ ] { } \ | " < > /`.

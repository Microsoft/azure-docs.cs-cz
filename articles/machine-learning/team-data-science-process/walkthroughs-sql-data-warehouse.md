...
[Použití SQL Data Warehouse návod](sqldw-walkthrough.md) ukazuje, jak vytvářet a nasazovat strojového učení klasifikačních a regresních modelů pomocí SQL Data Warehouse (SQL data Warehouse) pro veřejně dostupné NYC taxi cesty a tarif datové sady.

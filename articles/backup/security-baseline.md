...
- [Pro správu Azure Backup bodů obnovení použít Access Control na základě rolí](./backup-rbac-rs-vault.md)
...
- [Porozumění ovládacím prvkům zabezpečení dostupným pro Azure Backup](./backup-security-controls.md)

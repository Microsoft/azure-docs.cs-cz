...
- Základní [Architektura a topologie virtuálních počítačů](./workloads/hpc/hbv3-series-overview.md)
- [Podporovaný softwarový zásobník](./workloads/hpc/hbv3-series-overview.md#software-specifications) , včetně PODPOROVANÉHO operačního systému

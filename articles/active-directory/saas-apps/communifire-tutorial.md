---
title: 'Kurz: Integrace Azure Active Directory se službou Communifire | Dokumentace Microsoftu'
...
ms.locfileid: "39053803"
---
# <a name="tutorial-azure-active-directory-integration-with-communifire"></a>Kurz: Integrace Azure Active Directory se službou Communifire
...
3. **[Vytvoření zkušebního uživatele Communifire](#create-a-communifire-test-user)**  – Pokud chcete mít protějšek Britta Simon Communifire, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **Communifire domény a adresy URL** části, proveďte následující kroky, pokud chcete nakonfigurovat aplikace v režimu iniciované zprostředkovatele identity:

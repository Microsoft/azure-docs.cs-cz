...
3. **[Vytvoření zkušebního uživatele Zwayam](#create-a-zwayam-test-user)**  – Pokud chcete mít protějšek Britta Simon Zwayam, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **Zwayam domény a adresy URL** části, proveďte následující kroky:
...
6. Na **Zwayam konfigurace** klikněte na tlačítko **nakonfigurovat Zwayam** otevřete **nakonfigurovat přihlašování** okna. Kopírování **SAML Entity ID** z **části Stručná referenční příručka** a vložte **SAML Entity ID** hodnota v **přihlašovací adresa URL** textového pole v  **Zwayam domény a adresy URL** oddílu.

    ![Konfigurace Zwayam](./media/zwayam-tutorial/tutorial_Zwayam_configure.png) 

7. Ke konfiguraci jednotného přihlašování na **Zwayam** straně, je nutné odeslat na stažený **soubor XML s metadaty** k [tým podpory Zwayam](mailto:opendoors@zwayam.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

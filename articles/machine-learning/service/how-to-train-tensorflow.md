...
Abyste mohli začít se službou Azure Machine Learning, [dokončení tohoto rychlého startu](quickstart-run-cloud-notebook.md). Jakmile budete hotovi, budete mít [pracovního prostoru Azure Machine Learning](concept-workspace.md) a všechny naše [ukázkové poznámkové bloky](https://github.com/Azure/MachineLearningNotebooks/tree/master/how-to-use-azureml) včetně těch, které pro dopředné trénování TensorFlow a Keras.

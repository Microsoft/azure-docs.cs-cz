---
title: Připojte se k systémům souborů v místním prostředí – Azure Logic Apps
...
1. Pod triggerem zvolte **další krok**. Do vyhledávacího pole zadejte jako filtr "systém souborů". Ze seznamu akcí vyberte tuto akci: **Vytvoření souboru**
...
1. Jakmile budete hotoví, vyberte **Vytvořit**.
   ...
   Logic Apps nakonfiguruje a otestuje připojení, ujistěte se, že připojení funguje správně. Pokud je připojení správně nastavené, zobrazí se možnosti pro akci, kterou jste dříve vybrali.

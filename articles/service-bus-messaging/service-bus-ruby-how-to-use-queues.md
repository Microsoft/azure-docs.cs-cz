...
Objekt **Azure:: ServiceBusService** vám umožní pracovat s frontami. Chcete-li vytvořit frontu, `create_queue()` použijte metodu. Následující příklad vytvoří frontu nebo vypíše všechny chyby.

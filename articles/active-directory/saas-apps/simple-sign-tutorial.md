...
2. **[Nakonfigurujte jednoduché přihlášení jednotného](#configure-simple-sign-single-sign-on)** přihlášení – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
...
### <a name="configure-simple-sign-single-sign-on"></a>Konfigurace jednoduchého jednotného přihlašování pro jednotné přihlašování

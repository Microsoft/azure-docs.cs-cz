---
title: Partneři pro správu dat
description: Seznam partnerů pro správu dat třetích stran s řešeními, která podporují Azure synapse Analytics.
...
| ![Redpoint globální](./media/sql-data-warehouse-partner-data-management/redpoint-global-logo.png) |**RedPoint Správa dat**<br>RedPoint Správa dat umožňuje pracovníky marketingu použít všechna svá data pro zajištění zapojení mezi různými kanály pro zákazníky při provádění strukturovaných a nestrukturovaných správ dat. Pomocí RedPoint můžete maximalizovat hodnotu vašich strukturovaných a nestrukturovaných dat a zajistit tak přizpůsobené kontextové interakce, které jsou potřeba k zapojení dnešního zákazníka z Omni kanálu. Rozhraní přetažení usnadňuje navrhování a provádění procesů správy dat. |[Stránka produktu](https://www.redpointglobal.com/customer-data-management)<br> [Azure Marketplace](https://azuremarketplace.microsoft.com/marketplace/apps/redpoint-global.redpoint-rpdm)<br> |
| ![Sentry – jeden](./media/sql-data-warehouse-partner-data-management/sql-sentry-logo.png) |**SentryOne (DW Sentry)**<br>Pomocí řídicího panelu a kalendáře událostí inteligentního přesunu dat vždy přesně víte, co má vliv na vaše zatížení. Je navržený tak, aby vám poskytl přehled o vašich dotazech a úlohách, které běží na načítání, zálohování a obnovování dat, a nikdy se nemusíte starat o většinu prostředků Azure. |[Stránka produktu](https://sentryone.com/platform/azure-sql-dw-performance-monitoring/)<br>[Azure Marketplace](https://sentryone.com/platform/azure-sql-dw-performance-monitoring/)<br> |
...
| ![Tamr](./media/sql-data-warehouse-partner-data-management/tamr-logo.png) |**Tamr**<br>Díky tamr můžou organizace poskytovat Azure synapse se základními daty, což jim umožní získat z Azure Synapsey analytické možnosti. Cloudová řešení pro hlavní data v cloudu (tamr) využívají strojové učení k tomu, aby bylo těžké se odjímat o kombinování, čištění a kategorizaci dat, a to díky intuitivním pracovním postupům pro lidskou zpětnou vazbu, které přemostění mezi daty a Tamr se integruje s datovými službami Azure, včetně Azure synapse Analytics, Azure Databricks, Azure HDInsight, Azure Data Catalog, Azure Data Lake Storage a Azure Data Factory. Umožňuje vytváření dat ve velkém měřítku s nižšími náklady na vlastnictví s využitím flexibility a škálování Azure. |[Stránka produktu](https://www.tamr.com/tamr-partners/microsoft-azure/)<br> [Azure Marketplace](https://azuremarketplace.microsoft.com/marketplace/apps/tamrinc.unify_v_2019?tab=Overview) |
| ![Teleran](./media/sql-data-warehouse-partner-data-management/teleran-logo.jpg) |**Teleran**<br>Ovládací prvek dotazu Teleran zabraňuje nevhodným a špatně vytvořeným dotazům v dosahování synapse a plýtvání výpočetních prostředků. Odesílá inteligentní zprávy uživatelům s analýzou, aby je mohli efektivněji pracovat s daty. Cílem je zajistit dobré obchodní výsledky, aniž byste museli zbytečně náklady na Azure. Analýza využití Teleran zajišťuje analýzu aktivity uživatelů, aplikací, dotazů a využití dat. Umožňuje vždy mít celý přehled o tom, co se chystá. Umožňuje zdokonalit službu, zvýšit produktivitu firmy a optimalizovat náklady na synapse spotřebu. |[Stránka produktu](https://teleran.com/azure-synapse-optimization-cost-control/)<br>|

## <a name="next-steps"></a>Další kroky
Další informace o dalších partnerech najdete v tématech [partneři Business Intelligence](sql-data-warehouse-partner-business-intelligence.md), [partneři pro integraci dat](sql-data-warehouse-partner-data-integration.md)a [Machine Learning a AI](sql-data-warehouse-partner-machine-learning-ai.md).

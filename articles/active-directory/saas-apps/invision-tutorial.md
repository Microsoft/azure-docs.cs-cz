...
1. Na stránce **jednotného přihlašování** proveďte následující kroky:
    ...
    b. Do textového pole **název** zadejte název například jako `azureadsso`.
    ...
    f. Z rozevíracího seznamu pro **algoritmus hash**vyberte **SHA-256** .

    g. Zadejte vhodný název **popisku tlačítka jednotného přihlašování**.

    h. Zajistěte, aby **se povolilo zřizování za běhu** .

...
1. Chcete-li přidat skutečné zařízení, přejděte na **Device Explorer**, zvolte šablonu zařízení a vyberte **+ nový > skutečné**:
    ...
    - Zadejte **název zařízení** nebo použijte navrhovaný název.
      ...
      ![Přidání zařízení](media/concepts-connectivity-experimental/add-device.png)
...
Zaregistrovat velký počet zařízení s vaší aplikací IoT Central, použijte soubor CSV a [importovat ID zařízení a názvy zařízení](howto-manage-devices-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json#import-devices).
...
1. V aplikaci IoT Central _přidat a ověřit dočasná nebo kořenový certifikát X.509_ používáte k vytvoření certifikátů zařízení:
    ...
    - Přejděte do **správy > připojení zařízení > Certifikáty (X.509)** a přidejte X.509 kořenový nebo zprostředkující certifikát, které používáte k vytvoření certifikátů zařízení typu list.
      ...
      ![Nastavení připojení](media/concepts-connectivity-experimental/connection-settings.png)
...
![Nastavení připojení](media/concepts-connectivity-experimental/device-connection-flow.png)
...
1. Konfigurace nastavení připojení:
    ...
    ![Nastavení připojení SAS](media/concepts-connectivity-experimental/connection-settings-sas.png)
...
- [Připojte Raspberry Pi zařízení do aplikace Azure IoT Central](howto-connect-raspberry-pi-python.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)
- [Připojte zařízení za kit DevDiv do aplikace Azure IoT Central](howto-connect-devkit-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json).
...
- [Příprava a připojte zařízení za DevKit](howto-connect-devkit-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)

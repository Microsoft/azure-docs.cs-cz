...
V tomto článku se dozvíte, jak nasadit aplikaci s duálním zásobníkem (IPv4 + IPv6) pomocí Standard Load Balancer v Azure, která zahrnuje virtuální síť s duálním zásobníkem a podsíť, Standard Load Balancer s duálními konfiguracemi (IPv4 + IPv6), virtuální počítače se síťovými kartami, které mají konfiguraci s duálními IP adresami, skupina zabezpečení sítě a veřejné IP adresy.
...
Pomocí [Add-AzLoadBalancerProbeConfig](/powershell/module/az.network/add-azloadbalancerprobeconfig) vytvořte sondu stavu pro monitorování stavu virtuálních počítačů.
```azurepowershell

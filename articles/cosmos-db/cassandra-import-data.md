...
* **Povolit TLS:** Azure Cosmos DB má přísné požadavky na zabezpečení a standardy. Při interakci s účtem nezapomeňte povolit TLS. Při použití CQL s SSH, máte možnost poskytnout informace TLS.

...
Tento rychlý start ukazuje použití [Node.js](https://nodejs.org/en/) k vytvoření programu pro připojení k databázi SQL Azure a použití příkazů jazyka Transact-SQL k dotazování dat.

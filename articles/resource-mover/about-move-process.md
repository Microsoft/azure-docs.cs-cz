...
| **Krok 6: odstranění zdroje** | Po potvrzení přesunu a ověření prostředků v cílové oblasti můžete odstranit zdrojový prostředek. | Po potvrzení se stav prostředku přesune na čeká se na *odstranění zdroje*. Pak můžete vybrat zdrojový prostředek a odstranit ho.<br/><br/> -Odstranit lze pouze prostředky ve stavu *odstraňování čekají na zdroj* . <br/><br/>Odstranění skupiny prostředků nebo SQL Server na portálu Resource stěhovací není podporované. Tyto prostředky lze odstranit pouze ze stránky vlastností prostředku. |

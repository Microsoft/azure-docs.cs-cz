...
3. **[Vytvoření zkušebního uživatele Yonyx interaktivní vodítka](#create-a-yonyx-interactive-guides-test-user)**  – Pokud chcete mít protějšek Britta Simon Yonyx interaktivní průvodce, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **Yonyx interaktivní vodítka domény a adresy URL** části, proveďte následující kroky:

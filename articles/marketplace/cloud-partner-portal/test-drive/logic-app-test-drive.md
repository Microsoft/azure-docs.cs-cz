...
- **Oblast** - *[povinné pole]* oblast, kterou jste vybrali, je místo, kde můžete vybrat, kde budou prostředky aplikace logiky testu nasazeny v nástroji.
...
- **Doba trvání testovacích jednotek (hodiny) –** *[povinné pole]* doba trvání, jak dlouho má testovací jednotka zůstat aktivní \# , v hodinách. Testovací jednotka se po skončení tohoto časového období ukončí automaticky.
...
**ID tenanta Azure AD** *[povinné pole]* Pokud máte ID tenanta, které už máte k dispozici, najdete ho níže v ID\> adresáře Properties (vlastnosti).
...
1. Klikněte na kartu **přiřazení rolí** .  ![Azure Active Directory, přidání nového objektu zabezpečení Access Control](./media/azure-resource-manager-test-drive/SetupSub7_1.jpg)
...
1. Zadejte název aplikace Azure AD a vyberte aplikaci, pro kterou chcete roli přiřadit.
    ![Azure Active Directory oprávnění](./media/azure-resource-manager-test-drive/SetupSub7_2.jpg)

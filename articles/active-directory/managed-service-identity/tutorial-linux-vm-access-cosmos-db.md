...
V tomto kurzu se dozvíte, jak pomocí spravované identity přiřazené systémem pro virtuální počítač s Linuxem získat přístup k Azure Cosmos DB. Získáte informace o těchto tématech:

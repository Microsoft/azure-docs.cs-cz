...
| **Typ nabídky** | **Stránka pro společný prodej k dispozici v partnerském centru** |
|    -----------------------    |    -----------------------------  |
| Software jako služba (SaaS) |     Obecná dostupnost v 2020. února      |
| Dynamics 365 pro Customer Engagement & PowerApps      |     Nově dostupné      |
| Dynamics 365 for Operations     |     Nově dostupné       |
| Dynamics 365 Business Central      |  Obecná dostupnost v 2020. února     |
| Azure Application     |     Obecná dostupnost v 2020. února     |
| Virtuální počítače Azure      |     Oznámí se       |
| Kontejner Azure     |     Oznámí se       |
| Konzultační služba      |     Oznámí se       |
| Modul IoT Edge      |     Oznámí se       |
| Aplikace služby Power BI     |     Oznámí se       |
|  |
...
| IP (aplikace) | Aplikace nebo jiný chráněný materiál licencovaný na používání zákazníka. Například: program CRM, který je možné licencovat a nainstalovat místně. |

...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/greenhouse-tutorial/tutorial_greenhouse_samlbase.png)

3. Na **skleníkových domény a adresy URL** část, proveďte následující kroky:

    ![Skleníkových domény a adresy URL jednotné přihlašování informace](./media/greenhouse-tutorial/tutorial_greenhouse_url.png)
...
5. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/greenhouse-tutorial/tutorial_general_400.png)
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/greenhouse-tutorial/create_aaduser_02.png)
...
4. V **přidat nové uživatele** část, proveďte následující kroky:
   ...
   ![Přidání nového uživatele](./media/greenhouse-tutorial/ic790793.png "přidat nového uživatele")
...
2. V seznamu aplikací vyberte **skleníkových**.
    ...
    ![V seznamu aplikací na skleníkových odkaz](./media/greenhouse-tutorial/tutorial_greenhouse_app.png)  

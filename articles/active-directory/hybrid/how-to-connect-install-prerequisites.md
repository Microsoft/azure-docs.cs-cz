...
* Pokud použijete vlastní instalační cestu nastavení, máte k dispozici další možnosti, viz [Účty ve službě Active Directory.](reference-connect-accounts-permissions.md#custom-installation-settings)

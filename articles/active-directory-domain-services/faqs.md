...
Odkazovat [Průvodce odstraňováním potíží](troubleshoot.md) pro řešení běžných potíží s konfigurací nebo Správa služby Azure AD Domain Services.
...
Ano. Zobrazit, jak můžete zajistit [Azure AD Domain Services v předplatných Azure CSP](csp.md).
...
Ano. Zobrazit [jak povolit Azure AD Domain Services pomocí prostředí PowerShell](powershell-create-instance.md).
...
Ne, není v tuto chvíli možné si povolit Azure AD Domain Services pomocí šablony. Místo toho prostředí PowerShell, najdete v tématu [jak povolit Azure AD Domain Services pomocí prostředí PowerShell](powershell-create-instance.md).

...
description: Úroveň služby Premium RS pro Azure SQL Database se vyřadí a její podpora se ukončí – viz možnosti migrace.
...
- vCore úrovně služeb
  ...
  Úrovně služeb **pro obecné účely** a **pro důležité obchodní informace** v [modelu nákupu založeném na Vcore](service-tiers-vcore.md). Tyto dvě úrovně služeb jsou všeobecně dostupné. Nákupní model založený na vCoreech taky nabízí úroveň služby s technologií **škálování** , která se přizpůsobí požadavkům vašich úloh díky automatickému škálování až na 100 TB na databázi. Úroveň služby pro škálování na úrovni služeb poskytuje vstupně-výstupní výkon srovnatelný s úrovní služeb Premium v [modelu nákupu na základě DTU](service-tiers-dtu.md) za cenu, která se blíží úrovni služby Premium RS.
...
- Ceny Zvýhodněné hybridní využití Azure a rezervované kapacity
  ...
  [Ceny zvýhodněné hybridní využití Azure a rezervované kapacity](https://azure.microsoft.com/pricing/details/sql-database/) poskytují úsporu až 80% oproti sazbám zahrnutým v licencích. Další informace o těchto možnostech najdete v tématu [zvýhodněné hybridní využití Azure pro SQL Server](https://azure.microsoft.com/pricing/hybrid-benefit/) a [Azure SQL Database rezervovanou kapacitu](reserved-capacity-overview.md).
...
Naše úrovně služeb v rámci nákupního modelu založeného na vCore mají nárok na speciální nabídky, které vám můžou ušetřit až 80% oproti licenční ceně. Využijte licence SQL Server Standard nebo Enterprise Edition s aktivním Software Assurance a Ušetřete až 55% oproti licencím, které jsou v [zvýhodněné hybridní využití Azure](https://azure.microsoft.com/pricing/hybrid-benefit/) pro SQL Server k dispozici. Zvýhodněné hybridní využití můžete kombinovat s [Azure SQL Databasemi cenami za rezervované kapacity](reserved-capacity-overview.md) a ušetřit až 80%, když se potvrdíte dopředu na jeden nebo tři roky.  Aktivujte si obě výhody ještě dnes z Azure Portal.
...
- Podrobnosti o specifických velikostech výpočtů a možnostech velikosti úložiště, které jsou dostupné pro izolovanou databázi, najdete v tématu [SQL Database omezení prostředků na základě Vcore pro jednotlivé](resource-limits-vcore-single-databases.md) databáze.
- Podrobnosti o specifických velikostech výpočtů a možnostech velikosti úložiště dostupných pro elastické fondy najdete v tématu [SQL Database omezení prostředků na základě Vcore pro elastické fondy](resource-limits-vcore-elastic-pools.md).

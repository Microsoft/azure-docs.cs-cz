...
| **Události zařízení** | Ano, směrování zpráv může hlásit dvojčete změny a události životního cyklu zařízení. | Ano, můžete sestavy služby Event Grid, když zařízení jsou vytvořit, odstranit, připojení a odpojení ze služby IoT Hub |
...
| **Latence** | Nízký: Téměř v reálném čase. | Nízký: Téměř v reálném čase. |

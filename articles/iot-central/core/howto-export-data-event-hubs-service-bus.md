...
2. Vyberte předplatné. 
    ...
    > [!Note] 
    > Nyní můžete exportovat data do jiných předplatných, která nejsou stejná jako ta pro standardní IoT Central aplikaci. V tomto případě se připojíte pomocí připojovacího řetězce.

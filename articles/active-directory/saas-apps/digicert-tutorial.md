...
2. **[Nakonfigurujte jednotné přihlašování DigiCert](#configure-digicert-single-sign-on)** – ke konfiguraci nastavení jediného Sign-On na straně aplikace.
...
### <a name="configure-digicert-single-sign-on"></a>Nakonfigurovat DigiCert jednu Sign-On
...
Když na přístupovém panelu kliknete na dlaždici DigiCert, měli byste se automaticky přihlásit k DigiCert, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).

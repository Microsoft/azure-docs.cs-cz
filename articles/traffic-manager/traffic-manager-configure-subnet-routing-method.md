...
Přidejte dva virtuální počítače, na kterých běží servery IIS – *myIISVMEastUS* & *myIISVMWEurope* , ke směrování provozu uživatelů na základě podsítě dotazu uživatele.

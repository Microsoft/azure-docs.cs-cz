...
Tento příklad ukazuje, jak určit stav [operace nasazení pro nasazení prostředků](/rest/api/resources/resources/deployments/createorupdate) do Azure. Počáteční žádost má následující formát:

---
title: 'Kurz: Integrace Azure Active Directory se službou Panopto | Dokumentace Microsoftu'
...
ms.locfileid: "39051444"
---
# <a name="tutorial-azure-active-directory-integration-with-panopto"></a>Kurz: Integrace Azure Active Directory se službou Panopto
...
5. Na panelu výsledků vyberte **Panopto**a potom klikněte na tlačítko **přidat** tlačítko pro přidání aplikace.
...
3. **[Vytvoření zkušebního uživatele Panopto](#creating-a-panopto-test-user)**  – Pokud chcete mít protějšek Britta Simon Panopto, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **Panopto domény a adresy URL** části, proveďte následující kroky:
...
6. Na **Panopto konfigurace** klikněte na tlačítko **nakonfigurovat Panopto** otevřete **nakonfigurovat přihlašování** okna. Kopírovat **SAML Entity ID a SAML jednotné přihlašování – adresa URL služby** z **Stručná referenční příručka oddílu.**

    ![Konfigurace jednotného přihlašování](./media/panopto-tutorial/tutorial_panopto_configure.png) 

7. V okně jiné webové prohlížeče Přihlaste se k webu společnosti Panopto jako správce.

8. Na panelu nástrojů na levé straně klikněte na tlačítko **systému**a potom klikněte na tlačítko **zprostředkovatelé Identity**.
   
   ![Systém](./media/panopto-tutorial/ic777670.png "systému")
9. Klikněte na tlačítko **přidat poskytovatele**.
   
   ![Zprostředkovatelé identity](./media/panopto-tutorial/ic777671.png "zprostředkovatelů Identity")
   
10. V části SAML zprostředkovatele proveďte následující kroky:

...
V současné době je ve verzi Preview podporována pouze nepřímo připojený režim. 
...
|**Zálohování a obnovení**|Prostředí zákazníka – > zákaznická prostředí|Povinné|Ne|Přímá nebo nepřímá|Služba zálohování a obnovení může být nakonfigurovaná tak, aby odkazovala na místní třídy úložiště. |
...
- [Rozhraní API pro Azure Resource Manager](#azure-resource-manager-apis)
...
### <a name="azure-resource-manager-apis"></a>Rozhraní API pro Azure Resource Manager

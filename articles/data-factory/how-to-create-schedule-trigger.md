...
| **vzorec** | Objekt | Yes | Žádná | Objekt opakování | `"recurrence" : { "frequency" : "monthly", "interval" : 1 }` |
...
| **CXL** | Objekt | No | Žádná | Objekt plánu | `"schedule" : { "minute" : [30], "hour" : [8,17] }` |

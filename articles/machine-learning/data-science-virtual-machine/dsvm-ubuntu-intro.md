...
1. V dalším okně vyberte **vytvořit**.
   ...
   [![](media/dsvm-ubuntu-intro/create-linux.png "Tlačítko pro vytvoření počítače s Ubuntu")](media/dsvm-ubuntu-intro/create-linux-expanded.png#lightbox)

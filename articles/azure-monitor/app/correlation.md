...
Přidejte následující konfiguraci:
  ...
  ```
> [!IMPORTANT] 
> Pokud chcete zobrazit všechny konfigurace potřebné k povolení korelace, přečtěte si [dokumentaci k korelaci JavaScriptu](/azure/azure-monitor/app/javascript#enable-correlation).

...
Další informace o Microsoft Partner Network najdete v tématu [připojení k Microsoft Partner Network](https://partner.microsoft.com/membership) na webu partnera. Další informace o výhodách ISV v Microsoft Partner Network najdete v [Centru zdrojů ISV](https://partner.microsoft.com/isv-resource-hub).  

...
Po kliknutí na dlaždici řešení Timetabling na přístupovém panelu byste měli být automaticky přihlášeni k řešení Timetabling, pro která jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).
...
- [Jak chránit Timetabling řešení pomocí pokročilých viditelností a ovládacích prvků](/cloud-app-security/proxy-intro-aad)
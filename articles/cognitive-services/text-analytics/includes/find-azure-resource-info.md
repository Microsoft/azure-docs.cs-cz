...
ms.locfileid: "84140695"
---
> [!IMPORTANT]
> Přejděte na web Azure Portal. Pokud se prostředek Analýza textu, který jste vytvořili v části **předpoklady** , se úspěšně nasadil, klikněte v části **Další kroky**na tlačítko **Přejít k prostředku** . Klíč a koncový bod můžete najít na stránce **klíč a koncový bod** prostředku v části **Správa prostředků**. 
>

...
- Rozhraní [Json.NET](https://www.newtonsoft.com/json), k dispozici jako balíček NuGet. Chcete-li nainstalovat balíček NuGet v sadě Visual Studio:

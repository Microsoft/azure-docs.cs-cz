...
1. Vytvořte definici zásady pomocí jednoho z následujících volání:
   ...
   Další informace o struktuře dotazu najdete v tématu [definice Azure Policy – vytvoření nebo aktualizace](/rest/api/policy/policydefinitions/createorupdate) a [definice zásad – vytvoření nebo aktualizace ve skupině pro správu](/rest/api/policy/policydefinitions/createorupdateatmanagementgroup) .

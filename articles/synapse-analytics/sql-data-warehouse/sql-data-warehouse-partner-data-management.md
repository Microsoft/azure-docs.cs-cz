...
description: Seznamy partnerů třetích stran pro správu dat s řešeními, která podporují Azure Synapse Analytics.
...
Chcete-li vytvořit řešení datového skladu pomocí funkce Fondu synapse SQL v Azure Synapse, máte na výběr z široké škály špičkových nástrojů. Tento článek upozorňuje na partnerské společnosti Microsoft s nástroji pro správu dat a řešeními podporujícími Azure Synapse.

## <a name="data-management-partners"></a>Partneři pro správu dat
| Partner | Popis | Odkaz na web/produkt |
| ------- | ----------- | -------------------- |
| ![Coffing Datové skladové](./media/sql-data-warehouse-partner-data-management/coffing-data-warehousing-logo.png) |**Coffing Datové skladové**<br>Coffing Data Warehousing poskytuje Nexus Chameleon, nástroj s 10 let designu věnovaný dotazování systémů. Nexus je k dispozici jako dotazovací nástroj pro fond SQL Azure Synapse. Nexus slouží k dotazování interních a cloudových počítačů a připojování dat na různých platformách. Point-Click-Report! |[Stránka produktu](https://www.coffingdw.com/software/nexus/)<br> |
| ![Inbrein](./media/sql-data-warehouse-partner-data-management/inbrein-logo.png) |**Inbrein MicroERD**<br>Inbrein MicroERD poskytuje nástroje, které potřebujete k vytvoření přesného datového modelu, snížení redundance dat, zvýšení produktivity a dodržování standardů. Pomocí uživatelského rozhraní, které bylo vyvinuto na základě rozsáhlých uživatelských zkušeností, může modelář snadno a pohodlně pracovat na modelech DB. Můžete neustále využívat nové a vylepšené funkce MicroERD prostřednictvím rychlých funkčních vylepšení a aktualizací. |[Stránka produktu](http://microerd.com/)<br> |
| ![Infolibrarian](./media/sql-data-warehouse-partner-data-management/infolibrarian-logo.png) |**Infolibrarian (Server pro správu metadat)**<br>InfoLibrarian katalogy, ukládá a spravuje metadata, které vám pomohou vyřešit klíčové bolesti body správy dat. Infolibrarian navíc poskytuje softwarová řešení pro správu metadat, správu dat a správu majetku pro správu a publikování metadat z různých nástrojů a technologií. |[Stránka produktu](http://www.infolibcorp.com/metadata-management/software-tools)<br> [Azure Marketplace](https://azure.microsoft.com/marketplace/partners/infolibrarian/infolibrarian-metadata-management-server/)<br> |

...
ms.locfileid: "34669794"
---
Tento článek obsahuje informace o starší generace velikostí virtuálních počítačů. Tyto velikosti, je možné použít, ale nejsou k dispozici novější generace.
...
## <a name="ds-series---memory-optimized"></a>DS-series - paměťově optimalizované
...
## <a name="d-series---memory-optimized"></a>D-series - paměťově optimalizované

...
Chcete-li tento problém vyřešit, odstraňte následující klíč registru a restartujte `HealthService` a zkuste to `Add-HybridRunbookWorker` rutinu znovu:

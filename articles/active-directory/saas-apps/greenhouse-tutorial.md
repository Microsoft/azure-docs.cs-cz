...
1. Ke konfiguraci jednotného přihlašování na **skleníkových** straně, je nutné odeslat na stažený **soubor XML s metadaty** k [tým podpory skleníkových](http://www.greenhouse.io/contact).

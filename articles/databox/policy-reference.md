...
ms.locfileid: "107505951"
---
# <a name="azure-policy-built-in-definitions-for-azure-data-box"></a>Azure Policy předdefinované definice pro Azure Data Box

Tato stránka je indexem [Azure Policy](../governance/policy/overview.md) integrovaných definic zásad pro Azure Data box. Další Azure Policy integrovaných pro jiné služby najdete v tématu [Azure Policy předdefinované definice](../governance/policy/samples/built-in-policies.md).

...
description: Seznamte se s CloudSimple virtuálními počítači a jejich výhodami. Virtuální počítače VMware můžete spravovat z Azure Portal.
author: sharaths-cs
ms.author: dikamath
ms.date: 08/20/2019
ms.topic: article

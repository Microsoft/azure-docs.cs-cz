...
| Kontejner | Container Registry / Repository / Image Name |
|-----------|------------|
...
In this article, you learned concepts and workflow for downloading, installing, and running Computer Vision containers. Souhrn:

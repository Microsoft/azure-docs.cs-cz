...
![Využití a odhadované náklady](media/data-usage/usage-estimated-cost-dashboard-01.png)<br>
...
![Zobrazení protokolů](media/data-usage/logs.png)<br>
...
Tyto dotazy používejte opatrně, jsou náročné ke spuštění kontrol napříč typres dat data. Tento dotaz nahrazuje starý způsob dotazování to s datovým typem využití. 

...
3. Vytvoření odchozího pravidla na Load Balancer pro odchozí připojení
4. Nastavte pravidla NSG pro podsíť nebo virtuální počítače, které by se měly zdržet z/na Internet.
...
Stáhněte si skript migrace z [Galerie prostředí PowerShell](https://www.powershellgallery.com/packages/AzurePublicLBUpgrade/1.0).
...
Pokud byste chtěli upustit od připojení k virtuálním počítačům z Internetu, můžete vytvořit [pravidlo NSG](https://docs.microsoft.com/azure/virtual-network/manage-network-security-group) na síťovém rozhraní virtuálních počítačů.

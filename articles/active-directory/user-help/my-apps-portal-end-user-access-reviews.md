...
## <a name="using-myappsmicrosoftcom"></a>Použití myapps.microsoft.com
...
## <a name="using-myapplicationsmicrosoftcom"></a>Použití myapplications.microsoft.com
...
>[!Note]
>Pokud nevidíte dlaždici kontroly **přístupu** , může to znamenat, že nemáte oprávnění k provádění kontrol přístupu nebo že nemáte žádné čekající recenze, které čekají na vaše schválení. Pokud se domníváte, že byste měli mít přístup k této dlaždici, požádejte o pomoc svoji technickou podporu.

## <a name="to-perform-access-reviews"></a>Provedení kontrol přístupu

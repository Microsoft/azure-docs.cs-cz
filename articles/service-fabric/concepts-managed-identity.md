---
title: Přehled spravované identity Service Fabric
description: Tento článek představuje přehled spravované identity a jejích aplikací do Azure Service Fabric.
ms.topic: conceptual
ms.date: 12/09/2019

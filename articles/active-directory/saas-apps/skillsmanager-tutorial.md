...
Po kliknutí na dlaždici manažera dovedností na přístupovém panelu byste měli být automaticky přihlášení ke Správci dovedností, pro který jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).

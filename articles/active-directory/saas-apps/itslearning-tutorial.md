---
title: 'Kurz: Integrace Azure Active Directory se službou itslearning | Dokumentace Microsoftu'
...
ms.locfileid: "39042798"
---
# <a name="tutorial-azure-active-directory-integration-with-itslearning"></a>Kurz: Integrace Azure Active Directory se službou itslearning
...
5. Na panelu výsledků vyberte **itslearning**a potom klikněte na tlačítko **přidat** tlačítko pro přidání aplikace.
...
3. **[Vytváří se testovací uživatelské jméno itslearning](#creating-an-itslearning-test-user)**  – Pokud chcete mít protějšek Britta Simon v itslearning, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **itslearning domény a adresy URL** části, proveďte následující kroky:
...
6. Ke konfiguraci jednotného přihlašování na **itslearning** straně, je nutné odeslat na stažený **soubor XML s metadaty** k [tým podpory itslearning](mailto:support@itslearning.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

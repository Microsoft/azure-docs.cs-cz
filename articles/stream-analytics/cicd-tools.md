...
> [!NOTE]
> `Script`Hodnota v souboru vygenerovaného **testConfig.js** je určena pouze pro poskytování kontextu. Nepoužívá se v logice testování. 
...
> [!NOTE]
> V současné době jediná povolená hodnota pro `ScriptType` element je `InputMock` , což je také výchozí hodnota. Pokud je nastavená na jinou hodnotu, ignoruje se a použije se výchozí hodnota ( `InputMock` ). 

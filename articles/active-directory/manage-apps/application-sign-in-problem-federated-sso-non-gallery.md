...
*Chyba AADSTS70001: aplikace s identifikátorem nebyla `https://contoso.com` v adresáři nalezena*.
...
*Chyba AADSTS50011: adresa příjemce neodpovídá `https://contoso.com` adresám odpovědí nakonfigurovaným pro aplikaci.* 
...
8. Po načtení aplikace otevřete **základní konfiguraci SAML**. Ověřte nebo aktualizujte hodnotu v textovém poli adresy URL odpovědi tak, aby odpovídala `AssertionConsumerServiceURL` hodnotě v požadavku SAML.    
...
*Chyba AADSTS50105: přihlášený uživatel není `brian\@contoso.com` přiřazen k roli pro aplikaci.*

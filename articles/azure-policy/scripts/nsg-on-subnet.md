---
title: Ukázka kódu JSON pro Azure Policy – NSG x ve všech podsítích | Microsoft Docs
description: Tato ukázková zásada JSON vyžaduje, aby se ve všech virtuálních podsítích používala konkrétní skupina zabezpečení sítě.

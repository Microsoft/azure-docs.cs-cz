---
title: 'Kurz: Integrace Azure Active Directory s BenefitHub | Dokumentace Microsoftu'
...
* Můžete povolit uživatelům být automaticky přihlášeni k BenefitHub (Single Sign-On) s jejich účty Azure AD.
...
* Podporuje BenefitHub **IDP** jednotné přihlašování zahájené pomocí
...
4. Do vyhledávacího pole zadejte **BenefitHub**vyberte **BenefitHub** z panelu výsledků klikněte **přidat** tlačítko pro přidání aplikace.

     ![BenefitHub v seznamu výsledků](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurace a otestování služby Azure AD jednotného přihlašování

V této části je konfigurace a testování Azure AD jednotné přihlašování pomocí BenefitHub podle testovacího uživatele volá **Britta Simon**.
Pro jednotné přihlašování pro práci je potřeba navázat vztah odkazu mezi uživatele služby Azure AD a související uživatelské v BenefitHub.
...
2. **[Konfigurace BenefitHub Single Sign-On](#configure-benefithub-single-sign-on)**  – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
3. **[Vytvořit testovacího uživatele Azure AD](#create-an-azure-ad-test-user)**  – Pokud chcete otestovat Azure AD jednotné přihlašování s Britta Simon.
4. **[Přiřadit uživatele Azure AD](#assign-the-azure-ad-test-user)**  – Pokud chcete povolit Britta Simon používat Azure AD jednotného přihlašování.
5. **[Vytvořit testovacího uživatele BenefitHub](#create-benefithub-test-user)**  – Pokud chcete mít protějšek Britta Simon BenefitHub, který je propojený s Azure AD reprezentace uživatele.
...
1. V [webu Azure portal](https://portal.azure.com/)na **BenefitHub** integrace stránce aplikace vyberte **jednotného přihlašování**.
...
4. Na **nastavte si jednotné přihlašování pomocí SAML** stránce, proveďte následující kroky:
    ...
    ![BenefitHub domény a adresy URL jednotného přihlašování – informace](common/idp-intiated.png)

    a. V **identifikátor** textové pole, zadejte hodnotu: `urn:benefithub:passport`

    b. V **adresy URL odpovědi** textové pole, zadejte hodnotu: `https://passport.benefithub.info/saml/post/ac`

5. BenefitHub aplikace očekává, že kontrolní výrazy SAML v určitém formátu. Nakonfigurujte následující deklarace identity pro tuto aplikaci. Můžete spravovat hodnotami těchto atributů z **atributy uživatele** části na stránce aplikací pro integraci. Na **nastavte si jednotné přihlašování pomocí SAML** klikněte na **upravit** tlačítko Otevřít **atributy uživatele** dialogového okna.
...
8. Na **nastavení BenefitHub** tématu, zkopírujte příslušné adresy URL podle vašich požadavků.
...
### <a name="configure-benefithub-single-sign-on"></a>Konfigurace BenefitHub jednotné přihlašování

Ke konfiguraci jednotného přihlašování na **BenefitHub** straně, je nutné odeslat na stažený **kód XML metadat federace** a vhodné zkopírovaný adresy URL z webu Azure portal [tým podpory BenefitHub](https://www.benefithub.com/Home/ContactUs). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.
...
1. Na webu Azure Portal, vyberte **podnikové aplikace**vyberte **všechny aplikace**a pak vyberte **BenefitHub**.
...
### <a name="create-benefithub-test-user"></a>Vytvoření BenefitHub testovacího uživatele
...
Po kliknutí na dlaždici BenefitHub na přístupovém panelu, můžete by měl být automaticky přihlášeni k BenefitHub, u kterého nastavíte jednotné přihlašování. Další informace o přístupovém panelu, naleznete v tématu [Úvod k přístupovému panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

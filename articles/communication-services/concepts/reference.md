...
ms.locfileid: "93327216"
---
# <a name="reference-documentation-overview"></a>Referenční dokumentace – přehled
...
| Oblast           | JavaScript | .NET | Python | Java SE | iOS | Android | Ostatní                          |
| -------------- | ---------- | ---- | ------ | ---- | -------------- | -------------- | ------------------------------ |

...
| --- | --- |
| HDInsight v systému Linux a optimalizace | - [informace o použití HDInsight v systému Linux](hdinsight-hadoop-linux-information.md)<br>[řešení potíží s - Apache Hadoop paměti a výkonu](hdinsight-hadoop-stack-trace-error-messages.md)<br>[výkon dotazů - Apache Hive](https://web.archive.org/web/20190217214250/https://blogs.msdn.microsoft.com/bigdatasupport/2015/08/13/troubleshooting-hive-query-performance-in-hdinsight-hadoop-cluster/) |
| Protokoly a výpisy | [přístup k protokolům aplikace - Apache HADOOP přízi v systému Linux](hdinsight-hadoop-access-yarn-app-logs-linux.md)<br>- [Povolit výpisy haldy pro služby Apache Hadoop v systému Linux](hdinsight-hadoop-collect-debug-heap-dump-linux.md)<br>- [analyzovat protokoly HDInsight](hdinsight-debug-jobs.md)|

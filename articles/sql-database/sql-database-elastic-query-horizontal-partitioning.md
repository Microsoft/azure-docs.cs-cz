...
Následující dotaz provádí třícestný spojení mezi datovými sklady, řádky objednávek a objednávkami a používá několik agregací a selektivního filtru. Předpokládá, že (1) horizontální dělení (horizontálního dělení) a (2) tyto sklady, objednávky a řádky objednávky jsou horizontálně dělené ve sloupci ID skladu a že elastický dotaz může společně vyhledat spojení na horizontálních oddílů a zpracovat nákladný podíl dotazu na horizontálních oddílů paralelně.

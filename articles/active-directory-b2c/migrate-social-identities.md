...
Tento článek je pokračováním článku Migrace uživatelů a zaměřuje se na migraci sociální identity. Než začnete, přečtěte si [migraci uživatelů](user-migration.md).
...
Další informace, jak používat ukázkovou aplikaci, najdete v tématu [Azure Active Directory B2C: Migrace uživatelů.](user-migration.md)

...
| **Uvedené** | Zajistěte, aby byly binární soubory zakódovány, pokud obsahují citlivé informace, jako jsou obchodní tajemství, citlivá obchodní logika, která by neměla být reverzní. Účelem je zastavit zpětnou inženýraci sestavení. `CryptoObfuscator`Pro tento účel se můžou použít nástroje, jako je. |
...
| **Uvedené** | Generované binární soubory (sestavení v rámci APK) by měly být zakódovány pro zastavení zpětné analýzy sestavení. `CryptoObfuscator`Pro tento účel se můžou použít nástroje, jako je. |

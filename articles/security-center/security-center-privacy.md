...
Protokoly auditu v [protokolech aktivit Azure](../azure-monitor/platform/activity-logs-overview.md)se uchovávají v protokolech auditování zabezpečení, za běhu a výstrahy.

...
Tradiční nástroj dtexec se dodává s SQL Server. Další informace najdete v tématu [dtexec Utility](/sql/integration-services/packages/dtexec-utility). Je často vyvolána orchestrací nebo plánovači třetích stran, jako jsou ActiveBatch a Control-M, ke spouštění balíčků SSIS v místním prostředí. 
...
Vyvolání AzureDTExec nabízí podobné možnosti jako vyvolání DTExec. Další informace najdete v tématu [dtexec Utility](/sql/integration-services/packages/dtexec-utility). Tady jsou aktuálně podporované možnosti:

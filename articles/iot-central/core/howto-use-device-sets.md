...
1. V levém podokně vyberte **sady zařízení** .
...
Analýza v sadách zařízení je stejná jako hlavní karta Analytics v levém podokně. Další informace o analýzách najdete v článku o [tom, jak vytvářet analýzy](howto-use-device-sets.md).

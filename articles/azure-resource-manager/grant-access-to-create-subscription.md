...
## <a name="grant-subscription-creation-access-to-a-user-or-group"></a>Udělit přístup k předplatnému vytváření uživatele nebo skupiny

Vytvářet předplatná v rámci registrace účtu, uživatelé musí mít [role RBAC vlastníka](../role-based-access-control/built-in-roles.md#owner) na tento účet. Můžete udělit uživateli nebo skupině uživatelů role RBAC vlastníka účtu registrace pomocí následujících kroků:

### <a name="1-get-the-object-id-of-the-enrollment-account-you-want-to-grant-access-to"></a>1. Získání ID objektu, který chcete udělit přístup k registračnímu účtu
...
### <a name="2-get-object-id-of-the-user-or-group-you-want-to-give-the-rbac-owner-role-to"></a>2. Získání ID objektu uživatele nebo skupiny, kterou chcete přidělit roli RBAC vlastníka
...
### <a name="3-grant-the-user-or-group-the-rbac-owner-role-on-the-enrollment-account"></a>3. Udělit uživateli nebo skupině role RBAC vlastníka na účet pro zápis

...
![snímku Azure AD Connect Health odstranění serveru](./media/how-to-connect-health-operations/DeleteServer2.png)
...
![snímku Azure AD Connect Health odstranění služby](./media/how-to-connect-health-operations/DeleteServer.png)
3. Potvrďte zadáním názvu služby do potvrzovacího pole (například: sts.contoso.com).
4. Klikněte na **Odstranit**.
   <br><br>

[//]: # (Začátek oddílu RBAC)
## <a name="manage-access-with-role-based-access-control"></a>Správa přístupu pomocí Access Control založeného na rolích
...
1. V části **Konfigurace** klikněte na možnost **Uživatelé**.<br>
   ![snímek obrazovky Azure AD Connect Health bočního panelu prostředků](./media/how-to-connect-health-operations/startRBAC.png)
2. Vyberte **Přidat**.
3. V podokně **Vybrat roli** vyberte roli (například **vlastník**).<br>
   ![snímek obrazovky Azure AD Connect Health okně uživatelů RBAC](./media/how-to-connect-health-operations/RBAC_add.png)
4. Zadejte název nebo identifikátor cílového uživatele nebo skupiny. Můžete vybrat jednoho nebo více uživatelů nebo skupin současně. Klikněte na **Vybrat**.
   ![snímek obrazovky Azure AD Connect Health okně uživatelů RBAC](./media/how-to-connect-health-operations/RBAC_select_users.png)
5. Vyberte **OK**.<br>
6. Po dokončení přiřazení role se uživatelé a skupiny zobrazí v seznamu.<br>
   ![snímku Azure AD Connect Health okna uživatelé RBAC se zvýrazněnými novými uživateli](./media/how-to-connect-health-operations/RBAC_user_list.png)
...
2. V okně může uživatel připnout okno nebo jiné jeho části na řídicí panel. Jednoduše klikněte na ikonu **Připnout na řídicí panel** .<br>
   ![snímku okna Azure AD Connect Health pro PIN kód RBAC se zvýrazněnou ikonou PIN](./media/how-to-connect-health-operations/RBAC_pin_blade.png)
...
![snímku Azure AD Connect Health okna uživatelé RBAC s odebráním zvýrazněné](./media/how-to-connect-health-operations/RBAC_remove.png)

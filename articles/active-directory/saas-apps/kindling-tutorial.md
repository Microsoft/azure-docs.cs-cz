...
2. **[Konfigurace jednotného přihlašování](#configure-kindling-single-sign-on)** – pro konfiguraci nastavení jednotného přihlašování na straně aplikace
...
### <a name="configure-kindling-single-sign-on"></a>Konfigurace jednotného přihlašování
...
Po kliknutí na dlaždici pro podávání na přístupovém panelu byste se měli automaticky přihlášeni k způsobu, jakým jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

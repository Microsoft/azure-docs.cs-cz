...
4. Do vyhledávacího pole zadejte **EverBridge**.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/everbridge-tutorial/tutorial_everbridge_search.png)

5. Na panelu výsledků vyberte **EverBridge**a potom klikněte na **přidat** tlačítko Přidat aplikaci.

    ![Vytváření testovacího uživatele Azure AD](./media/everbridge-tutorial/tutorial_everbridge_addfromgallery.png)
...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Konfigurovat jednotné přihlašování](./media/everbridge-tutorial/tutorial_everbridge_samlbase.png)

3. Na **EverBridge domény a adresy URL** část, proveďte následující kroky:

    ![Konfigurovat jednotné přihlašování](./media/everbridge-tutorial/tutorial_everbridge_url.png)
...
4. Na **SAML podpisový certifikát** klikněte na tlačítko **soubor XML s metadaty** a potom uložte soubor metadat ve vašem počítači.
    ...
    ![Konfigurovat jednotné přihlašování](./media/everbridge-tutorial/tutorial_everbridge_certificate.png) 

5. Klikněte na tlačítko **Uložit** tlačítko.

    ![Konfigurovat jednotné přihlašování](./media/everbridge-tutorial/tutorial_general_400.png)
...
6. Na **EverBridge konfigurace** klikněte na tlačítko **konfigurace EverBridge** otevřete **konfigurovat přihlášení** okno. Kopírování **SAML jeden přihlašování adresa URL služby** z **Stručná referenční příručka části.**
    ...
    ![Konfigurovat jednotné přihlašování](./media/everbridge-tutorial/tutorial_everbridge_configure.png) 
...
7. V nabídce v horní části, klikněte **nastavení** a vyberte **jednotné přihlašování** pod **zabezpečení**.
    ...
    ![Konfigurovat jednotné přihlašování](./media/everbridge-tutorial/tutorial_everbridge_002.png)
    ...
    ![Konfigurovat jednotné přihlašování](./media/everbridge-tutorial/tutorial_everbridge_003.png)
...
1. V **portál Azure**, v levém navigačním podokně klikněte na tlačítko **Azure Active Directory** ikonu.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/everbridge-tutorial/create_aaduser_01.png) 

2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin** a klikněte na tlačítko **všichni uživatelé**.
    
    ![Vytváření testovacího uživatele Azure AD](./media/everbridge-tutorial/create_aaduser_02.png) 

3. Chcete-li otevřít **uživatele** dialogové okno, klikněte na tlačítko **přidat** horní dialogové okno.
 
    ![Vytváření testovacího uživatele Azure AD](./media/everbridge-tutorial/create_aaduser_03.png) 

4. Na **uživatele** dialogové okno stránky, proveďte následující kroky:
 
    ![Vytváření testovacího uživatele Azure AD](./media/everbridge-tutorial/create_aaduser_04.png) 
...
2. V seznamu aplikací vyberte **EverBridge**.
    ...
    ![Konfigurovat jednotné přihlašování](./media/everbridge-tutorial/tutorial_everbridge_app.png) 

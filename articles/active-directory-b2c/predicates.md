...
| Minimum | Yes | Minimální počet znaků, které je třeba zadat. |
...
| Minimum | Yes | Nejnižší možné datum, které lze zadat. Formát data následuje po `yyyy-mm-dd` konvenci nebo `Today` .|

---
title: 'Kurz: Konfigurace analyzovatelné pro Automatické zřizování uživatelů s Azure Active Directory | Microsoft Docs'
description: Přečtěte si, jak automaticky zřídit a zrušit zřízení uživatelských účtů z Azure AD, které se mají analyzovat.
...
Tento kurz popisuje kroky, které je třeba provést v analyzovatelné i Azure Active Directory (Azure AD) ke konfiguraci automatického zřizování uživatelů. Po nakonfigurování Azure AD automaticky zřídí a odzřídí uživatele a skupiny, které se mají [analyzovat](https://www.parsable.com/) pomocí služby zřizování Azure AD. Důležité podrobnosti o tom, co tato služba dělá a jak funguje, a odpovědi na nejčastější dotazy najdete v tématu [Automatizace zřizování a rušení zřízení uživatelů pro aplikace SaaS ve službě Azure Active Directory](../manage-apps/user-provisioning.md). 
...
* Tenanta, který je možné analyzovat (tým).
* Uživatelský účet v analyzovatelné s oprávněními správce.
...
3. Určete, jaká data se mají [mapovat mezi Azure AD a analyzovatelné](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 

## <a name="step-2-configure-parsable-to-support-provisioning-with-azure-ad"></a>Krok 2. Konfigurace analyzovatelné pro podporu zřizování pomocí Azure AD

1. Pokud se chcete přihlásit k této předběžné verzi, obraťte se na zástupce analyzovat úspěšnost zákazníků.
2. Budou vám dál pomáhat při vyvolávání lístku podpory pro získání potřebného **tokenu nosiče** (tajného tokenu).
3. Zkopírujte a uložte **token nosiče**. Tato hodnota se zadá do pole **tajný token** * na kartě zřizování aplikace analyzovatelné v Azure Portal.

## <a name="step-3-add-parsable-from-the-azure-ad-application-gallery"></a>Krok 3. Přidat analyzovatelné z Galerie aplikací Azure AD

Přidejte analyzovatelné z Galerie aplikací Azure AD, abyste mohli začít spravovat zřizování pro analyzovatelné. Pokud jste již dříve nastavili možnost analyzovat pro jednotné přihlašování, můžete použít stejnou aplikaci. Pro účely počátečního testování integrace však doporučujeme vytvořit samostatnou aplikaci. Další informace o přidání aplikace z galerie najdete [tady](https://docs.microsoft.com/azure/active-directory/manage-apps/add-gallery-app). 
...
* Při přiřazování uživatelů a skupin k analyzovat je nutné vybrat jinou roli než **výchozí přístup**. Uživatelé s rolí Výchozí přístup jsou vyloučeni ze zřizování a v protokolech zřizování se označí příznakem neplatného nároku. Pokud je v aplikaci k dispozici pouze role Výchozí přístup, můžete [aktualizovat manifest aplikace](https://docs.microsoft.com/azure/active-directory/develop/howto-add-app-roles-in-azure-ad-apps) a přidat další role. 

* Začněte v malém. Než se pustíte do zavádění pro všechny, proveďte testování s malou skupinou uživatelů a skupin. Pokud je rozsah zřizování nastavený na přiřazené uživatele a skupiny, můžete testování provést tak, že k aplikaci přiřadíte jednoho nebo dva uživatele nebo skupiny. Pokud je rozsah nastavený na všechny uživatele a skupiny, můžete určit [filtr rozsahu na základě atributů](https://docs.microsoft.com/azure/active-directory/manage-apps/define-conditional-rules-for-provisioning-user-accounts). 


## <a name="step-5-configure-automatic-user-provisioning-to-parsable"></a>Krok 5. Konfigurace automatického zřizování uživatelů pro analyzovatelné 

V této části se seznámíte s postupem konfigurace služby zřizování Azure AD k vytváření, aktualizaci a zakázání uživatelů nebo skupin v TestApp na základě přiřazení uživatelů nebo skupin ve službě Azure AD.

### <a name="to-configure-automatic-user-provisioning-for-parsable-in-azure-ad"></a>Konfigurace automatického zřizování uživatelů pro možnost analyzovat v Azure AD:

1. Přihlaste se k webu [Azure Portal](https://portal.azure.com). Vyberte **Podnikové aplikace** a pak vyberte **Všechny aplikace**.

    ![Okno Podnikové aplikace](common/enterprise-applications.png)

2. V seznamu aplikace vyberte možnost **analyzovatelné**.

    ![Odkaz analyzovat v seznamu aplikací](common/all-applications.png)
...
5. V části **přihlašovací údaje správce** zadejte adresu URL klienta s možností analyzovat a tajný token. Klikněte na **Test připojení** a ujistěte se, že se služba Azure AD může připojit k analyzovatelné. Pokud se připojení nepovede, ujistěte se, že váš účet analyzovat má oprávnění správce, a zkuste to znovu.

---
title: 'Kurz: Integrace Azure Active Directory se službou skleníkových | Dokumentace Microsoftu'
...
ms.locfileid: "39042907"
---
# <a name="tutorial-azure-active-directory-integration-with-greenhouse"></a>Kurz: Integrace Azure Active Directory se službou skleníkových
...
3. **[Vytvoření zkušebního uživatele skleníkových](#create-a-greenhouse-test-user)**  – Pokud chcete mít protějšek Britta Simon skleníkových, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **skleníkových domény a adresy URL** části, proveďte následující kroky:
...
6. Ke konfiguraci jednotného přihlašování na **skleníkových** straně, je nutné odeslat na stažený **soubor XML s metadaty** k [tým podpory skleníkových](http://www.greenhouse.io/contact).

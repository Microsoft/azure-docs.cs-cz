...
[Přihlaste se k Azure](/cli/azure/reference-index#az_login).
...
[Vytvoří nový cluster](/cli/azure/hdinsight#az_hdinsight_create).
...
[Vytvořte aplikaci pro cluster HDInsight](/cli/azure/hdinsight/application#az_hdinsight_application_create).
...
### <a name="create-an-application-with-a-script-uri-and-specified-edge-node-size"></a>Vytvoření aplikace s identifikátorem URI skriptu a zadanou velikostí hraničního uzlu
...
[Spustí akce skriptu v zadaném clusteru HDInsight](/cli/azure/hdinsight/script-action#az_hdinsight_script_action_execute).

...
1. V jiném okně webového prohlížeče se přihlaste k MyWorkDrive jako správce zabezpečení.

2. Na serveru MyWorkDrive na panelu pro správu klikněte na **Enterprise** a proveďte následující kroky:

...
- [Migrujte na MSAL. Svém](migrate-android-adal-msal.md)
- [Migrace na MSAL. iOS/macOS](migrate-objc-adal-msal.md)
- [Migrace na MSAL Python](migrate-python-adal-msal.md)
- [Migrace na MSAL pro Java](migrate-adal-msal-java.md)

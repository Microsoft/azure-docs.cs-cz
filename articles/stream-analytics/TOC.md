...
## Měřítko
### [Škálování s jednotkami streamování](stream-analytics-streaming-unit-consumption.md)
### [Škálování s využitím paralelizace dotazů](stream-analytics-parallelization.md)
#### [Zvýšení prostupnosti](stream-analytics-scale-jobs.md)
### [Škálování s využitím funkcí ML](stream-analytics-scale-with-machine-learning-functions.md)

## Automatizace
### [Pomocí sady .NET SDK](stream-analytics-dotnet-management-sdk.md)
### [Použití Azure PowerShellu](https://github.com/Azure/azure-stream-analytics/tree/master/Samples/ASAOneClick)
...
### [Příkaz SELECT INTO](stream-analytics-select-into.md)
### [Přijímače centra událostí](stream-analytics-event-hub-consumer-groups.md)

## Integrace se strojovým učením
### [Analýza subjektivního hodnocení s využitím modelů ML](stream-analytics-machine-learning-integration-tutorial.md)
...
## [Videa](https://azure.microsoft.com/resources/videos/index/?services=stream-analytics&sort=newest)

...
2. **[Nakonfigurujte jednotné přihlašování GreenOrbit](#configure-greenorbit-single-sign-on)** – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
...
### <a name="configure-greenorbit-single-sign-on"></a>Konfigurace jednotného přihlašování GreenOrbit
...
Když na přístupovém panelu kliknete na dlaždici GreenOrbit, měli byste se automaticky přihlásit k GreenOrbit, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

...
Pokud chcete nakonfigurovat jednotné přihlašování na straně **SafetyNet** , musíte odeslat **adresu URL federačních metadat aplikace** [týmu podpory SafetyNet](mailto:dev@predictivesolutions.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.
...
V této části vytvoříte uživatele s názvem Britta Simon v SafetyNet. Pokud chcete přidat uživatele na platformě SafetyNet, pracujte s [týmem podpory SafetyNet](mailto:dev@predictivesolutions.com) . Uživatelé musí vytvořit a aktivovat, než použití jednotného přihlašování.

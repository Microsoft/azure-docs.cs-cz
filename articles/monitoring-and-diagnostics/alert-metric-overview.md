...
- Časová agregace (Statistika, která se spouští nad nezpracované hodnoty metrik. Podporuje času agregace jsou Min, Max, Avg, celkem): průměr
...
- [Zjistěte, jak vytvořit, zobrazit a spravovat upozornění metrik v Azure](alert-metric.md)
- [Zjistěte, jak nasadit upozornění na metriku pomocí šablony Azure Resource Manageru](monitoring-create-metric-alerts-with-templates.md)

---
title: 'Rychlý start: Vyhledávání videí Bingu sady SDK, Java'
...
ms.locfileid: "55168686"
---
# <a name="quickstart-bing-video-search-sdk-java"></a>Rychlý start: Java SDK pro vyhledávání videí Bingu
...
Nainstalujte si závislosti sady SDK Vyhledávání videí Bingu pomocí systému Maven, Gradle nebo jiného systému správy závislostí. Soubor POM Mavenu vyžaduje deklaraci:
```
  <dependencies>
    <dependency>

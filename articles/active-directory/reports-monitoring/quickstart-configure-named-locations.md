...
- Detekce falešných poplachů při [detekci rizik](concept-risk-events.md). Přihlášení z důvěryhodného umístění snižuje riziko při přihlášení uživatele.   
- Konfigurace [podmíněného přístupu založeného na poloze](../conditional-access/location-condition.md).
...
2. V levém podokně vyberte **Azure Active Directory**a v části **Zabezpečení** vyberte **Podmíněný přístup.**

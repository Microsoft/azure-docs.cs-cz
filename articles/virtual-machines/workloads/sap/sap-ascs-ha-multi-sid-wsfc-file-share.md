...
Vytvořte doménu doménové skupiny ** \<> \ SAP_\<SID2>_GlobalAdmin**, například pomocí \<SID2> = PR2. Název skupiny domén je \<> doména \ SAP_PR2_GlobalAdmin.
...
* Skupina uživatelů domény **\<SAP_>_GlobalAdmin SID**

...
ms.locfileid: "104609085"
---
# <a name="iot-central-operator-guide"></a>Průvodce operátorem IoT Central

Tento článek poskytuje přehled role operátora v IoT Central. Operátor spravuje zařízení připojená k aplikaci.

_Operátor_ spravuje zařízení připojená k aplikaci.

Jako operátor můžete:
...
:::image type="content" source="media/overview-iot-central-tour/iot-central-homepage.png" alt-text="Snímek obrazovky IoT Central domovské stránky":::
...
1. V pravém podokně stránky **zařízení** se zobrazí seznam zařízení vytvořených z této šablony zařízení. Vyberte individuální zařízení, na kterém se zobrazí stránka s podrobnostmi o zařízení pro toto zařízení:
    ...
    ![Obrazovka stránky s podrobnostmi o zařízení](./media/overview-iot-central-operator/device-list.png)
...
1. Vyberte **Importovat**.
    ...
    ![Snímek obrazovky akce importu](./media/overview-iot-central-operator/bulk-import-1-a.png)
...
1. Po dokončení importu se na panelu operace zařízení zobrazí zpráva o úspěchu.
    ...
    ![Snímek obrazovky s úspěšným importem](./media/overview-iot-central-operator/bulk-import-3-a.png)
...
1. Na levém panelu vyberte **všechna zařízení**:
    ...
    ![Snímek obrazovky nepřidružených zařízení](./media/overview-iot-central-operator/unassociated-devices-2-a.png)
...
1. Vyberte **migrovat**:
    ...
    ![Snímek obrazovky přidružit zařízení](./media/overview-iot-central-operator/unassociated-devices-1-a.png)
...
1. Vyberte zařízení, která chcete exportovat, a pak vyberte akci **exportovat** .
    ...
    ![Snímek obrazovky s exportem](./media/overview-iot-central-operator/export-1-a.png)
...
1. Vyberte odkaz **Stáhnout soubor** a Stáhněte soubor do místní složky na disku.
    ...
    ![Snímek obrazovky s úspěšností exportu](./media/overview-iot-central-operator/export-2-a.png)

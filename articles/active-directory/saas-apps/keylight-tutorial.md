...
2. **[Nakonfigurujte LockPath jednotné přihlašování](#configure-lockpath-keylight-single-sign-on)** – pro konfiguraci nastavení jednotného přihlašování na straně aplikace.
...
### <a name="configure-lockpath-keylight-single-sign-on"></a>Nakonfigurovat LockPath pro jednotné přihlašování

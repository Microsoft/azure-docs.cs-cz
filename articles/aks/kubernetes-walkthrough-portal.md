...
> [!NOTE]
> Pokud chcete tyto operace provést v instalaci místního prostředí, musíte nejdřív ověřit, že je nainstalovaná platforma Azure CLI, a pak se pomocí příkazu připojit k Azure `az login` .

...
description: V tomto rychlém startu se dozvíte, jak pomocí Translator Text REST API přepínat text z jednoho skriptu na jiný. V této ukázce se provádí transkripce z japonštiny do latinky.

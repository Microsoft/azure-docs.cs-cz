...
description: Vypíše Azure Policy předdefinované definice zásad pro Data Factory. Tyto integrované definice zásad poskytují běžné přístupy ke správě prostředků Azure.
ms.author: lle
author: lrtoyou1223
...
ms.locfileid: "105038039"
---
# <a name="azure-policy-built-in-definitions-for-data-factory-preview"></a>Azure Policy předdefinované definice pro Data Factory (Preview)
[!INCLUDE[appliesto-adf-xxx-md](includes/appliesto-adf-xxx-md.md)]

Tato stránka je indexem [Azure Policy](../governance/policy/overview.md) integrovaných definic zásad pro Data Factory. Další Azure Policy integrovaných pro jiné služby najdete v tématu [Azure Policy předdefinované definice](../governance/policy/samples/built-in-policies.md).

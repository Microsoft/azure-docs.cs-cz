...
- **[Klíče spravované zákazníkem](../logs/customer-managed-keys.md)** – Šifrujte data clusteru pomocí klíčů, které jsou k dispozici a kontrolovány zákazníkem.
- **[Bezpečnostní modul](../logs/customer-managed-keys.md#customer-lockbox-preview)** – zákazníci můžou řídit žádostem o data přístup inženýrům podpory Microsoftu.
...
- Chybové zprávy
  ...
  -  400 – KeyVaultProperties není prázdný, ale má špatný formát. Viz [aktualizace identifikátoru klíče](../logs/customer-managed-keys.md#update-cluster-with-key-identifier-details).
  -  400 – nepovedlo se ověřit klíč v Key Vault. Příčinou může být nedostatečná oprávnění nebo pokud klíč neexistuje. Ověřte, že jste [nastavili zásady klíče a přístupu](../logs/customer-managed-keys.md#grant-key-vault-permissions) v Key Vault.

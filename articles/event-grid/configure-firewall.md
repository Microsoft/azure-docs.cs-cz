...
### <a name="create-topic-with-inbound-ip-rules"></a>Vytvořit téma s pravidly příchozí IP adresy
Následující ukázkový příkaz CLI vytvoří v jednom kroku téma Event Grid s pravidly příchozího přenosu IP adres. 
...
### <a name="create-topic-first-and-then-add-inbound-ip-rules"></a>Nejdřív vytvořte téma a pak přidejte pravidla příchozí IP adresy.

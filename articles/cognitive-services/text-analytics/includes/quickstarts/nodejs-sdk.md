...
Můžete také použít operaci analyzovat ke zjištění PII, rozpoznávání propojených entit a extrakci klíčových frází. Podívejte se na téma Analýza ukázek pro [JavaScript](https://github.com/Azure/azure-sdk-for-js/tree/master/sdk/textanalytics/ai-text-analytics/samples/v5/javascript) a [TypeScript](https://github.com/Azure/azure-sdk-for-js/tree/master/sdk/textanalytics/ai-text-analytics/samples/v5/typescript/src) na GitHubu.

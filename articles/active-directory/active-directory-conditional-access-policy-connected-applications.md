...
- **[Zařízení připojená k Azure AD](device-management-introduction.md#azure-ad-joined-devices)**  – Pokud chcete získat organizační zařízení Windows 10, který není připojený k Azure AD registrované s Azure AD, které jsou registrované na místě. 

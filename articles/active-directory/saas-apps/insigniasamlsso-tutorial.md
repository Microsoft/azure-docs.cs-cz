...
2. **[Nakonfigurujte jednotné přihlašování Insignia SAML SSO](#configure-insignia-saml-sso-single-sign-on)** – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.

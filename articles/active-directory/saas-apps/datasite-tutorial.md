...
1. V části **základní konfigurace SAML** zadejte hodnoty pro následující pole:
    ...
    Do textového pole **přihlašovací adresa URL** zadejte adresu URL:  `https://auth.datasite.com/sp/ACS.saml2`
...
Po kliknutí na dlaždici s datovou lokalitou na přístupovém panelu byste měli být automaticky přihlášeni k dataweb, pro který jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).
...
- [Jak chránit DataSite pomocí pokročilých viditelností a ovládacích prvků](/cloud-app-security/proxy-intro-aad)
...
5. Vyberte nebo zadejte platnou **e-mailovou adresu**, zadejte **název produktu** , který se zobrazí `b2clogin.com` uživatelům, zadejte v **autorizovaných doménách**a pak klikněte na **Uložit**.

...
3. Přidat Zscalerem Beta, klikněte na tlačítko **novou aplikaci** tlačítko v horní části dialogového okna.

    ![Tlačítko nové aplikace][3]

4. Do vyhledávacího pole zadejte **Zscalerem Beta**.

    ![Zřizování Beta Zscaler](./media/zscaler-beta-provisioning-tutorial/app-search.png)

5. Na panelu výsledků vyberte **Zscalerem Beta**a potom klikněte na tlačítko **přidat** tlačítko pro přidání do seznamu aplikací SaaS Zscalerem Beta.

    ![Zřizování Beta Zscaler](./media/zscaler-beta-provisioning-tutorial/app-search-results.png)

    ![Zřizování Beta Zscaler](./media/zscaler-beta-provisioning-tutorial/app-creation.png)
...
2. Vyberte ze seznamu aplikací SaaS Zscalerem Beta.

    ![Zřizování Beta Zscaler](./media/zscaler-beta-provisioning-tutorial/app-instance-search.png)

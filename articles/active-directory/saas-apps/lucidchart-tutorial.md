...
* Můžete kontrolovat v Azure AD, kteří mají přístup k Lucidchart.
* Můžete povolit, aby se vaši uživatelé automaticky přihlásili k Lucidchart (jednotné přihlašování) pomocí svých účtů Azure AD.
...
Ke konfiguraci integrace služby Azure AD s Lucidchart potřebujete následující položky:

* Předplatné služby Azure AD. Pokud nemáte prostředí Azure AD, můžete získat měsíční zkušební verzi [tady](https://azure.microsoft.com/pricing/free-trial/) .
* Předplatné s povoleným Lucidchartm jednotným přihlašováním
...
4. Do vyhledávacího pole zadejte **Lucidchart**, vyberte **Lucidchart** z panelu výsledků a potom kliknutím na tlačítko **Přidat** přidejte aplikaci.

     ![Lucidchart v seznamu výsledků](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurace a testování jednotného přihlašování Azure AD

V této části nakonfigurujete a otestujete jednotné přihlašování Azure AD pomocí Lucidchart na základě testovacího uživatele s názvem **Britta Simon**.
Aby jednotné přihlašování fungovalo, musí se zřídit vztah propojení mezi uživatelem služby Azure AD a souvisejícím uživatelem v Lucidchart.

Pokud chcete nakonfigurovat a otestovat jednotné přihlašování Azure AD pomocí Lucidchart, musíte dokončit tyto stavební bloky:

1. **[Nakonfigurujte jednotné přihlašování Azure AD](#configure-azure-ad-single-sign-on)** a Umožněte uživatelům používat tuto funkci.
2. **[Nakonfigurujte jednotné přihlašování Lucidchart](#configure-lucidchart-single-sign-on)** – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
3. **[Vytvořte testovacího uživatele Azure AD](#create-an-azure-ad-test-user)** – k otestování jednotného přihlašování Azure AD pomocí Britta Simon.
4. **[Přiřaďte testovacího uživatele Azure AD](#assign-the-azure-ad-test-user)** – pro povolení Britta Simon pro použití jednotného přihlašování Azure AD.
5. **[Vytvoření Lucidchart Test User](#create-lucidchart-test-user)** – pro Britta Simon v Lucidchart, který je propojený s reprezentací uživatele Azure AD.
...
Pokud chcete nakonfigurovat jednotné přihlašování Azure AD pomocí Lucidchart, proveďte následující kroky:

1. V [Azure Portal](https://portal.azure.com/)na stránce integrace aplikací **Lucidchart** vyberte **jednotné přihlašování**.
...
4. V části **základní konfigurace SAML** proveďte následující kroky:
    ...
    ![Informace o jednotném přihlašování v doméně Lucidchart a adresách URL](common/sp-signonurl.png)
...
### <a name="configure-lucidchart-single-sign-on"></a>Konfigurace jednotného přihlašování Lucidchart
...
2. V nabídce v horní části klikněte na možnost **tým**.
    ...
    ![Hodnotící](./media/lucidchart-tutorial/ic791190.png "Hodnotící")
...
V této části povolíte Britta Simon pro použití jednotného přihlašování pomocí Azure tím, že udělíte přístup k Lucidchart.

1. V Azure Portal vyberte **podnikové aplikace**, vyberte **všechny aplikace**a pak vyberte **Lucidchart**.
...
Když na přístupovém panelu kliknete na dlaždici Lucidchart, měli byste se automaticky přihlásit k Lucidchart, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

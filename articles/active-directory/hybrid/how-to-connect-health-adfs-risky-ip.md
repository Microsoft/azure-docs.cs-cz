---
title: Azure AD Connect Health se službou AD FS sestavě rizikových IP adres | Dokumentace Microsoftu
description: Popisuje, sestavě rizikových IP adres služby Azure AD Connect Health AD FS.
...
## <a name="load-balancer-ip-addresses-in-the-list"></a>Nástroje pro vyrovnávání IP adresy v seznamu zatížení
...
## <a name="download-risky-ip-report"></a>Stáhněte si sestavě rizikových IP adres 
...
**Proč se mi zobrazuje žádný přístup k sestavě?**  <br />

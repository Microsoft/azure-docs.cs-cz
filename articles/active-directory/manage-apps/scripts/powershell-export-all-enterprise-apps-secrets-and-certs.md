...
ms.locfileid: "102584321"
---
# <a name="export-secrets-and-certificates-for-enterprise-apps"></a>Export tajných klíčů a certifikátů pro podnikové aplikace
Tento ukázkový skript PowerShellu exportuje všechny tajné klíče a certifikáty pro zadané podnikové aplikace z vašeho adresáře do souboru CSV.

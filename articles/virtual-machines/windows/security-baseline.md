---
title: Základní hodnoty zabezpečení Azure pro Windows Virtual Machines
...
Tato základní hodnota zabezpečení platí pro Windows Virtual Machines pokynů od [zabezpečení Azure Security test 1,0](../../security/benchmarks/overview-v1.md) . Azure Security Benchmark poskytuje doporučení, jak můžete zabezpečit svá cloudová řešení v Azure. Obsah je seskupen podle **řízení zabezpečení** definovaného srovnávacím testem zabezpečení Azure a souvisejících pokynů, které se vztahují na Windows Virtual Machines.

> [!NOTE]
> **Ovládací prvky** , které se nevztahují na Windows Virtual Machines nebo pro které je odpovědnost od Microsoftu, jsou vyloučené. Pokud chcete zjistit, jak Windows Virtual Machines kompletně mapuje srovnávací test zabezpečení Azure, přečtěte si **[celý soubor mapování standardních hodnot Windows Virtual Machines Security](https://github.com/MicrosoftDocs/SecurityBenchmarks/blob/master/Azure%20Offer%20Security%20Baselines/1.1/windows-virtual-machines-security-baseline-v1.1.xlsx)**.
...
- [Jak shromažďovat protokoly a metriky platforem pomocí Azure Monitor](https://docs.microsoft.com/azure/azure-monitor/essentials/activity-log#view-the-activity-log)
...
**Doprovodné** materiály: Windows Virtual Machines a Azure Active Directory (Azure AD) nemají koncept výchozích hesel. Zákazník zodpovědný za aplikace třetích stran a služby Marketplace, které mohou používat výchozí hesla.
...
### <a name="36-use-secure-azure-managed-workstations-for-administrative-tasks"></a>3,6: Používejte zabezpečené pracovní stanice spravované službou Azure pro úlohy správy. 
...
- [Šifrování disků spravovaných službou Azure na straně serveru](/azure/virtual-machines/windows/disk-encryption)

- [Azure Disk Encryption pro virtuální počítače s Windows](/azure/virtual-machines/windows/disk-encryption-overview)
...
- [Jak nahrát vlastní virtuální pevný disk virtuálního počítače do Azure](upload-generalized-managed.md)

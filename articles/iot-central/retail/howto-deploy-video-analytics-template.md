...
Teď máte přehled o tom, jak nasadit a používat šablonu aplikace video Analytics, v tématu [Vytvoření aplikace video Analytics n v Azure IoT Central](tutorial-video-analytics-create-app.md) , abyste mohli začít.

...
* K získání ID uživatele používá příkaz [AZ Account show][az-account-show] a [AZ AD User show][az-ad-user-show] .
* Nakonec přiřadí roli pomocí příkazu [AZ role Assignment Create][az-role-assignment-create] .

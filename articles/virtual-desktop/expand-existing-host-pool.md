...
- [Připojení pomocí klienta Android](./connect-android.md)
- [Připojení pomocí klienta macOS](./connect-macos.md)
- [Připojení k klientovi iOS](./connect-ios.md)

...
2. V libovolném textovém editoru otevřete soubor **BackEndApplication.cs**.
    ...
    Nahraďte hodnotu proměnné `s_connectionString` připojovacím řetězcem služby, který jste si poznamenali dříve. Pak změny uložte do **BackEndApplication.cs**.

...
1. Do vyhledávacího pole zadejte **některých jednotného přihlašování správce**vyberte **některých jednotného přihlašování správce** z panelu výsledků klikněte **přidat** tlačítko pro přidání aplikace.
...
1. **[Vytvoření zkušebního uživatele některých jednotného přihlašování správce](#create-a-certain-admin-sso-test-user)**  – Pokud chcete mít protějšek Britta Simon v některých jednotného přihlašování správce, který je propojený s Azure AD reprezentace uživatele.
...
1. Na **některé domény správce jednotného přihlašování a adresy URL** části, proveďte následující kroky:
...
1. Na **některé konfigurace jednotného přihlašování správy** klikněte na tlačítko **nakonfigurovat jednotné přihlašování některé správce** otevřete **nakonfigurovat přihlašování** okna. Kopírovat **URL odhlašování SAML Entity ID a SAML jednotné přihlašování – adresa URL služby** z **Stručná referenční příručka oddílu.**
...
1. Ke konfiguraci jednotného přihlašování na **některých jednotného přihlašování správce** straně, je nutné odeslat na stažený **certifikát (Raw)**, **URL odhlašování SAML Entity ID a SAML jednotné přihlašování – adresa URL služby**k [tým podpory jednotného přihlašování k určité správce](mailto:integrations@certain.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.
...
1. V seznamu aplikací vyberte **některých jednotného přihlašování správce**.

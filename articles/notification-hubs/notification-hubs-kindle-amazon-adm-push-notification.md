...
* Získání sady Android SDK (za předpokladu, že použijete Eclipse) z [portál pro vývojáře Androidu](https://go.microsoft.com/fwlink/?LinkId=389797).
...
2. V Eclipse klikněte pravým tlačítkem na projekt a pak klikněte na tlačítko **Vlastnosti**. Vyberte **cesta sestavení Java** na levé straně a pak vyberte **knihovny** kartě v horní části. Klikněte na tlačítko **přidat externí Jar**a vyberte `\SDK\Android\DeviceMessaging\lib\amazon-device-messaging-*.jar` soubor z adresáře, ve které jste extrahovali Amazon SDK.

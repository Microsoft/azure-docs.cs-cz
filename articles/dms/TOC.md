# [Dokumentace ke službě Database Migration Service](index.yml)
...
## [Online migrace MongoDB do rozhraní Mongo API služby Azure Cosmos DB](tutorial-mongodb-cosmos-db-online.md)
...
## Videa
### [Použití průvodce migrací databází](https://azure.microsoft.com/resources/videos/how-to-use-the-azure-database-migration-guide/)
### [Proces migrace a doporučené nástroje/služby](https://azure.microsoft.com/resources/videos/overview-of-migration-and-recommended-tools-services/)
### [Požadavky a vytvoření instance DMS](https://azure.microsoft.com/resources/videos/how-to-address-prerequisites-and-create-a-dms-instance/)
### [Migrace SQL Serveru 2008 do spravované instance Azure SQL Database](https://azure.microsoft.com/resources/videos/how-to-migrate-sql-server-2008-or-r2-to-azure-sqldbmi/)
### [Migrace PostgreSQL do Azure Database for PostgreSQL](https://azure.microsoft.com/resources/videos/how-to-migrate-postgresql-to-azure-postgresql-online-dms-and-cli/)
### [Monitorování online migrace a provedení přímé migrace](https://azure.microsoft.com/resources/videos/how-to-monitor-online-migration-and-perform-cutover/)
### [Migrace Oracle do Azure SQL Database](https://azure.microsoft.com/resources/videos/how-to-migrate-oracle-to-sqldb-online/)
### [Migrace MongoDB do Azure Cosmos DB](https://azure.microsoft.com/resources/videos/how-to-migrate-mongodb-to-cosmos-db/)
## Nástroje a pokyny

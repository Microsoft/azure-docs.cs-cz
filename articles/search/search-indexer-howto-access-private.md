...
Pokud chcete pro Azure Kognitivní hledání požádat o vytvoření odchozího připojení privátního koncového bodu k účtu úložiště, udělejte toto volání rozhraní API, například pomocí [Azure CLI](/cli/azure/): 

...
* [VYTVOŘENÍ úlohy třídění](/sql/t-sql/statements/create-workload-classifier-transact-sql) (Preview)
...
* [PŘETAŽENÍ pracovní VYTÍŽENÍ třídění](/sql/t-sql/statements/drop-workload-classifier-transact-sql) (Preview)

...
V této části můžete povolit Azure AD jednotného přihlašování na portálu Azure a nakonfigurovat jednotné přihlašování v aplikaci Nexonia.
  ...
  > [!Note]
   > Pokud máte problémy v integraci a odkazovat to [odkaz](https://docs.microsoft.com/azure/active-directory/application-sign-in-problem-federated-sso-gallery) pro Průvodce odstraňováním potíží s. Pokud ještě nebyly nalezeny řešení, pak vyvolat žádost o podporu z portálu Azure.
...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/nexonia-tutorial/tutorial_nexonia_samlbase.png)

3. Na **Nexonia domény a adresy URL** část, proveďte následující kroky:

    ![Nexonia domény a adresy URL jednotné přihlašování informace](./media/nexonia-tutorial/tutorial_nexonia_url.png)
...
5. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/nexonia-tutorial/tutorial_general_400.png)
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/nexonia-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **Nexonia**.
    ...
    ![V seznamu aplikací na Nexonia odkaz](./media/nexonia-tutorial/tutorial_nexonia_app.png)  

...
| Možnost | Popis |
|:---|:---|
| Rozsah | Určuje rozsah dat použitých pro dotaz. Může se jednat o všechna data v pracovním prostoru Log Analytics nebo data pro konkrétní prostředek napříč několika pracovními prostory. Viz [obor dotazu](scope.md). |

...
> [!IMPORTANT]
> Pokud instalujete konektor na Windows Server 2019, existuje omezení HTTP2. Chcete-li úspěšně použít konektor v této verzi, přidejte následující klíč registru a restartujte server:
    ```

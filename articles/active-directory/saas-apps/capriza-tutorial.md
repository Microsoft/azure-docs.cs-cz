...
5. Na panelu výsledků vyberte **Capriza platformy**a potom klikněte na tlačítko **přidat** tlačítko pro přidání aplikace.
...
3. **[Vytvoření zkušebního uživatele Capriza platformy](#creating-a-capriza-platform-test-user)**  – Pokud chcete mít protějšek Britta Simon Capriza platformě, která souvisí s Azure AD reprezentace uživatele.
...
3. Na **Capriza platformy domény a adresy URL** části, proveďte následující kroky:

...
Uložená data vytvořená žádnou aktivitu, která nemá odchozího odkazu [výstup runbooku](https://docs.microsoft.com/azure/automation/automation-runbook-output-and-messages). Výstup je uložen pod úlohy runbooku a je k dispozici nadřízený runbook, když sada runbook slouží jako podřízený objekt.

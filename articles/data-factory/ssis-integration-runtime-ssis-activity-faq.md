...
* Zvažte navýšení počtu DTU vaší databáze. Podrobnosti najdete v [SQL Database omezeních pro logický Server](https://docs.microsoft.com/azure/sql-database/sql-database-resource-limits-logical-server).

...
Nyní se sestavení dokončilo a můžete z image vytvořit virtuální počítač. Použijte příklady v [dokumentaci New-AzVM PowerShellu](https://docs.microsoft.com/powershell/module/az.compute/new-azvm?view=azps-2.5.0#description).

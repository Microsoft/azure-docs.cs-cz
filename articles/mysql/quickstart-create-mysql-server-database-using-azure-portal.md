...
description: V tomto rychlém startu se dozvíte, jak pomocí Azure Portal rychle vytvořit ukázkový Azure Database for MySQL server v asi pět minut.
author: ajlam
ms.author: andrela
ms.service: mysql
ms.custom: mvc

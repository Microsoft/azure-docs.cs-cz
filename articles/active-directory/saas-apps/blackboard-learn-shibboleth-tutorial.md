...
Když na přístupovém panelu kliknete na dlaždici Shibboleth tabule, měli byste se automaticky přihlášeni k panelu tabule Shibboleth, pro který jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).

...
- Podívejte se na [ukázkový kód,](https://github.com/Azure-Samples/media-services-video-indexer/tree/master/API) který ukazuje důležitý aspekt nahrávání a indexování videa. Následující kód wil vám dobrou představu o tom, jak používat naše rozhraní API pro základní funkce. Nezapomeňte si přečíst vtextu komentáře a všimněte si našich doporučení pro osvědčené postupy.

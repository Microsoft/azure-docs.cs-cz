...
| --koncový. čas utc   | Windows souboru čas reprezentující koncový čas časové rozmezí, pro kterou má být vytvořen Chaos sestavy. Přečtěte si [DateTime.ToFileTimeUtc metoda](https://msdn.microsoft.com/library/system.datetime.tofiletimeutc(v=vs.110).aspx) podrobnosti.|
| --spuštění. čas utc | Windows souboru čas reprezentující čas zahájení časové rozmezí, pro kterou má být vytvořen Chaos sestavy. Přečtěte si [DateTime.ToFileTimeUtc metoda](https://msdn.microsoft.com/library/system.datetime.tofiletimeutc(v=vs.110).aspx) podrobnosti.|

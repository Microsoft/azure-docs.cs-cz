---
title: Přidat uživatele spolupráce Azure Active Directory s B2B do role | Dokumentace Microsoftu
...
![Výchozí role](./media/add-guest-to-role/default-role.png)

## <a name="global-administrator-role"></a>Role Globální správce

![roli Globální správce](./media/add-guest-to-role/global-admin-role.png)

## <a name="limited-administrator-role"></a>Role správce s omezením

![role správce s omezením](./media/add-guest-to-role/limited-admin-role.png)

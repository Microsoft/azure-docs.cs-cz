---
title: Příručka pro vývojáře zařízení (Node.js) – IoT technologie Plug and Play | Microsoft Docs
description: Popis technologie Plug and Play IoT pro Node.js vývojářům zařízení
author: rido-min
ms.author: rmpablos
ms.date: 09/24/2020
ms.topic: conceptual
...
ms.locfileid: "91579801"
---
# <a name="iot-plug-and-play-device-developer-guide-nodejs"></a>Příručka pro vývojáře pro zařízení IoT technologie Plug and Play (Node.js)

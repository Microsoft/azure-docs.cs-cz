...
## <a name="configure-and-test-azure-ad-sso-for-colortokens-ztna"></a>Konfigurace a testování jednotného přihlašování Azure AD pro ColorTokens ZTNA
...
Pokud chcete nakonfigurovat a otestovat jednotné přihlašování Azure AD pomocí ColorTokens ZTNA, proveďte následující kroky:
...
1. V Azure Portal na stránce integrace aplikací **ZTNA ColorTokens** najděte část **Správa** a vyberte **jednotné přihlašování**.
...
* Kliknutím na **test této aplikace** v Azure Portal. Tím se přesměruje na adresu URL pro přihlášení ColorTokens ZTNA, kde můžete spustit tok přihlášení. 

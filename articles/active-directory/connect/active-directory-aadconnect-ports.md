...
Seznam koncových bodů najdete v tématu [část požadavky pro Azure AD Connect Health agent](../connect-health/active-directory-aadconnect-health-agent-install.md#requirements).

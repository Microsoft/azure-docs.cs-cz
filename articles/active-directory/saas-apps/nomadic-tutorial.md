...
1. Do vyhledávacího pole zadejte **Nomadic**vyberte **Nomadic** z panelu výsledků klikněte **přidat** tlačítko pro přidání aplikace.
...
1. **[Vytvořte Nomadic testovacího uživatele](#create-a-nomadic-test-user)**  – Pokud chcete mít protějšek Britta Simon Nomadic, který je propojený s Azure AD reprezentace uživatele.
...
1. Na **Nomadic domény a adresy URL** části, proveďte následující kroky:
...
1.  Pokud chcete získat jednotné přihlašování nakonfigurované pro vaši aplikaci, kontaktujte [tým podpory Nomadic](mailto:help@nomadic.fm) a umožnit jim na stažený **metadat**.
...
1. V seznamu aplikací vyberte **Nomadic**.

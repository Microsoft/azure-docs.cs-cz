---
title: Kurz – ochrana nových prostředků pomocí zámků prostředků podrobného plánu
...
1. Přidejte šablonu do skupiny prostředků:
   ...
   1. Na kartě **Šablona** vložte do pole Editor následující šablonu správce prostředků. Po vložení do šablony vyberte **Přidat** a přidejte artefakt do podrobného plánu.
...
- Zjistěte, jak používat [uzamykání prostředků](../concepts/resource-locking.md)podrobného plánu.
- Další informace o přizpůsobení [pořadí podrobných plánů](../concepts/sequencing-order.md)
- Další informace o [aktualizaci existujících přiřazení](../how-to/update-existing-assignments.md)
- [Řešení potíží](../troubleshoot/general.md) při přiřazování podrobného plánu.

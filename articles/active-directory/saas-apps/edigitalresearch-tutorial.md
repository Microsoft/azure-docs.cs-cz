...
3. **[Vytvoření zkušebního uživatele eDigitalResearch](#create-a-edigitalresearch-test-user)**  – Pokud chcete mít protějšek Britta Simon v eDigitalResearch, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **eDigitalResearch domény a adresy URL** části, proveďte následující kroky:
...
6. Na **eDigitalResearch konfigurace** klikněte na tlačítko **nakonfigurovat eDigitalResearch** otevřete **nakonfigurovat přihlašování** okna. Kopírování **URL odhlašování, SAML Entity ID** z **Stručná referenční příručka oddílu.**

    ![eDigitalResearch konfigurace](./media/edigitalresearch-tutorial/tutorial_edigitalresearch_configure.png) 

7. Ke konfiguraci jednotného přihlašování na **eDigitalResearch** straně, je nutné odeslat na stažený **soubor certifikátu (Base64)**, **SAML Entity ID**, a **odhlášení Adresa URL** k [tým podpory eDigitalResearch](http://www.maruedr.com/contact). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

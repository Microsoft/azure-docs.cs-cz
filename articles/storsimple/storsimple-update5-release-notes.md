...
| --- | --- | --- | --- | --- |
| 1\. místo |vzdálenou komunikaci prostředí Windows PowerShell. |V předchozí verzi se uživateli při pokusu o navázání vzdáleného připojení k StorSimple Cloud Appliance pomocí Windows PowerShellu zobrazila chyba. Tento problém byl způsobený kořenem a opravil v této verzi. |Ne |Ano |

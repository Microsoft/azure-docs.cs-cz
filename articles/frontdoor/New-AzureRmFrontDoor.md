...
ms.locfileid: "47047442"
---
# Nové AzureRmFrontDoor

Vytvořte nový branou Azure load balancer
...
## POPIS
**New-AzureRmFrontDoor** rutina vytvoří v zadané skupině prostředků v rámci aktuálního předplatného nový Azure branou nástroje pro vyrovnávání zatížení

## PŘÍKLADY

### Příklad 1: Vytvoření branou, na základě dané parametry.
```powershell
...
Vytvoření branou, na základě dané parametry.

## PARAMETRY

### -Bezproblémových
Backendpools k dispozici pro pravidlo směrování.
...
Vlastnosti EnabledState nástroje pro vyrovnávání zatížení branou.
...
### -FrontendEndpoint
Koncové body front-endu k dispozici pro pravidlo směrování.
...
### -HealthProbeSetting
Nastavení testu stavu přidružené k této instanci branou.
...
Nastavení související s touto instancí branou služby Vyrovnávání zatížení.
...
Název skupiny prostředků, který branou se vytvoří v.
...
### -RoutingRule
Pravidla směrování, které jsou přidružené k této FrontDoor

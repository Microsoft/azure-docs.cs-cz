...
4. Do vyhledávacího pole zadejte **jednotné přihlašování SAML pro Jira podle rozlišení GmbH**.

    ![Vytváří se testovací uživatele služby Azure AD](./media/samlssojira-tutorial/tutorial_samlssojira_search.png)

5. Na panelu výsledků vyberte **jednotné přihlašování SAML pro Jira podle rozlišení GmbH**a potom klikněte na tlačítko **přidat** tlačítko pro přidání aplikace.
...
3. **[Vytváření SAML SSO pro Jira rozlišení GmbH testovací uživatel](#creating-a-saml-sso-for-jira-by-resolution-gmbh-test-user)**  – Pokud chcete mít protějšek Britta Simon v jednotné přihlašování SAML pro Jira podle rozlišení GmbH, která souvisí s Azure AD reprezentace uživatele.
...
3. Na **SAML SSO Jira podle rozlišení GmbH domény a adresy URL** části, pokud chcete nakonfigurovat aplikace v **IDP** iniciované režimu:
...
7. V okně jiné webové prohlížeče, přihlaste se k vaší **jednotné přihlašování SAML pro Jira pomocí portálu pro správu řešení GmbH** jako správce.
...
10. Karta části doplňků, klikněte na tlačítko **najít nové doplňky**. Hledání **SAML jednotné přihlašování (SSO) pro JIRA** a klikněte na tlačítko **nainstalovat** tlačítko k instalaci nové zásuvný modul SAML.
...
14. Na **konfigurace modulu plug-in SingleSignOn SAML** klikněte na **přidat nového zprostředkovatele identity** tlačítko ke konfiguraci nastavení zprostředkovatele Identity.

    ![Konfigurace jednotného přihlašování](./media/samlssojira-tutorial/addon4.png)

15. Na **zvolte zprostředkovatele Identity SAML** stránce, proveďte následující kroky:
...
16. Na **konfigurace zprostředkovatele Identity** klikněte na **Další** tlačítko.

    ![Konfigurace jednotného přihlašování](./media/samlssojira-tutorial/addon5b.png)

17. Na **Import metadat zprostředkovatele identity SAML** stránce, proveďte následující kroky:
...
18. Na **atribut ID uživatele a transformace** klikněte na **Další** tlačítko.

    ![Konfigurace jednotného přihlašování](./media/samlssojira-tutorial/addon5d.png)
    
19. Na **vytvoření uživatele a aktualizace** klikněte na **u & ložit Další** se uložit nastavení.   
    
    ![Konfigurace jednotného přihlašování](./media/samlssojira-tutorial/addon6a.png)
    
20. Na **Test nastavení** klikněte na **přeskočit testovací & ručně nakonfigurovat** testovací uživatel prozatím přeskočit. To se provede v další části a vyžaduje některá nastavení na webu Azure portal. 
    
    ![Konfigurace jednotného přihlašování](./media/samlssojira-tutorial/addon6b.png)
    
21. V dialogu čtení apprearing **přeskakování testů znamená...** , klikněte na tlačítko **OK**.
...
2. V seznamu aplikací vyberte **jednotné přihlašování SAML pro Jira podle rozlišení GmbH**.

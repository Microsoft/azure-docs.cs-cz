...
Azure Event Grid je plně spravovaná služba Směrování událostí, která používá model publikování a odběru. Event Grid obsahuje integrovanou podporu pro služby Azure, jako je [Azure Functions](../azure-functions/functions-overview.md) a [Azure Logic Apps](../azure-functions/functions-overview.md). Může doručovat výstrahy událostí na služby mimo Azure pomocí webhooků. Úplný seznam obslužných rutin událostí, které Event Grid podporuje, najdete v [úvodu k Azure Event Grid](overview.md).
...
> [!NOTE]
> Další informace o tom, jak se data zajišťují v souvislosti s zpracováním událostí, najdete v [Koncepční dokumentaci k datům o sídle](../communication-services/concepts/privacy.md) .
...
K přihlášení k odběru událostí vygenerovaných vaším prostředkem komunikačních služeb můžete použít Azure Portal nebo Azure CLI. Začněte zpracovávat události tím, že si vyhledáte, [jak zpracovávat události SMS v komunikačních službách](../communication-services/quickstarts/telephony-sms/handle-sms-events.md) .
...
| Nadpis | Popis |
| --- | --- |
| [Postup zpracování událostí serveru SMS v komunikačních službách](../communication-services/quickstarts/telephony-sms/handle-sms-events.md) | Zpracovává se všechny události SMS přijaté komunikační službou pomocí Webhooku. |

...
2. **[Nakonfigurujte jednotné přihlašování MindTickle](#configure-mindtickle-single-sign-on)** – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
...
Když na přístupovém panelu kliknete na dlaždici MindTickle, měli byste se automaticky přihlásit k MindTickle, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

...
1. Vyberte svou aplikaci a pak klikněte na **manifest**. Můžete si zobrazit dvě existující [role aplikace](/azure/architecture/multitenant-identity/app-roles) definované pro aplikaci:

...
No. V současné době není možné upgradovat stávající virtuální počítač, na kterém běží Windows 10 Professional nebo Enterprise, na více než Windows 10 Enterprise víc relací. Pokud navíc nasadíte virtuální počítač s Windows 10 Enterprise s více relacemi a pak aktualizujete kód Product Key na jinou edici, nebudete moct virtuální počítač přepnout zpátky na Windows 10 Enterprise multi-session a bude potřeba virtuální počítač znovu nasadit.

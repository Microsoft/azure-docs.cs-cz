...
description: Zjistěte, jak rozpoznávání řeči ve Swiftu v systému macOS pomocí sady SDK pro řeč
...
ms.locfileid: "67561514"
---
# <a name="quickstart-recognize-speech-in-swift-on-macos-using-the-speech-sdk"></a>Rychlý start: Rozpoznávání řeči ve Swiftu v systému macOS pomocí sady SDK pro řeč

[!INCLUDE [Selector](../../../includes/cognitive-services-speech-service-quickstart-selector.md)]

V tomto článku se dozvíte, jak k vytvoření aplikace pro macOS ve Swiftu přepisy řeči poznamenali z mikrofon na text pomocí Cognitive Services SDK řeči.
...
Cognitive Services sadou SDK pro řeč pro macOS se distribuuje jako sada framework.

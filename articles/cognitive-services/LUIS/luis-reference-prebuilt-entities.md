...
------|:------:|
[Stáří](luis-reference-prebuilt-age.md):<br>za rok<br>měsíc<br>týden<br>den   |    V2, V3   |
[Měny](luis-reference-prebuilt-currency.md):<br>dolar<br>zlomkové jednotky (ex: pritzker)  |    V2, V3   |
...
------|:------:|
[Stáří](luis-reference-prebuilt-age.md):<br>za rok<br>měsíc<br>týden<br>den   |    V2,-   |
[Měny](luis-reference-prebuilt-currency.md):<br>dolar<br>zlomkové jednotky (ex: pritzker)  |    V2,-   |
[Hodnotu](luis-reference-prebuilt-deprecated.md)   |    -   | 
...
[Pořadí](luis-reference-prebuilt-ordinal.md)   |    V2,-   |  
[OrdinalV2](luis-reference-prebuilt-ordinal-v2.md)   |    -   |
...
------|:------:|
[Stáří](luis-reference-prebuilt-age.md):<br>za rok<br>měsíc<br>týden<br>den   |    -   |
...
GeographyV2 a PersonName nejsou součástí projektu nástrojů pro rozpoznávání textu. Problémy s těmito předem připravených entit, otevřete [žádost o podporu](../../azure-portal/supportability/how-to-create-azure-support-request.md). 

...
1. Otevřete **program.cs** a nahraďte obsah následujícím kódem. Aktualizujte hodnoty `{your Device ID}` `{your Device Primary Key}` , a s hodnotami, které jste si poznamenali dříve: `{your Scope ID}`

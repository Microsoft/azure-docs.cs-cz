...
Ke konfiguraci jednotného přihlašování na straně **jednotného** přihlašování Spintr je potřeba odeslat stažený **certifikát (Base64)** a příslušné zkopírované adresy URL z Azure Portal do [týmu podpory Spintr SSO](mailto:support@spintr.me). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.
...
Když kliknete na dlaždici Spintr SSO na přístupovém panelu, měli byste se automaticky přihlásit k Spintr SSO, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

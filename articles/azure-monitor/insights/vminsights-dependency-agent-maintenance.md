...
3. Pokud chcete potvrdit, že upgrade proběhl úspěšně, `install.log` zkontrolujte podrobné informace o nastavení. Adresář protokolu je *%ProgramFiles%\Microsoft Dependency Agent\logs*.

...
Azure Storage, samotný má omezení 250 účtů úložiště na oblast a předplatné. Pokud tento limit překročíte, nebude možné vytvořit jakékoli další účty úložiště v kombinaci předplatné a oblast.

---
title: 'Rychlý Start: Změna typů účtů podporovaných aplikací | Azure'
...
V tomto rychlém startu se dozvíte, jak změnit konfiguraci aplikace, aby se změnily informace o tom, kdo nebo jaké typy účtů mají přístup k aplikaci.
...
Další informace o konfiguraci ověřené domény vydavatele najdete v tématu [Konfigurace ověřené domény](quickstart-modify-supported-accounts.md).

## <a name="next-steps"></a>Další kroky

> [!div class="nextstepaction"]
> [Postupy: převod aplikace na více tenantů](howto-convert-app-to-be-multi-tenant.md)

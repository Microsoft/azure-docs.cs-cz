...
3. Určete, jaká data se mají [mapovat mezi Azure AD a Apple Business Managerem](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 
...
[Okno připojit k SCIM, které poskytuje token a tlačítko pro kopírování pod ním.] Nechejte toto okno otevřené a zkopírujte adresu URL klienta z Apple Business Manageru do Azure AD, což je: https://federation.apple.com/feeds/business/scim
...
Přidejte Apple Business Manager z Galerie aplikací Azure AD a začněte spravovat zřizování pro Apple Business Manager. Pokud jste již dříve nastavili Apple Business Manager pro jednotné přihlašování, můžete použít stejnou aplikaci. Doporučuje se ale při počátečním testování integrace vytvořit samostatnou aplikaci. Další informace o přidání aplikace z Galerie [najdete tady](https://docs.microsoft.com/azure/active-directory/manage-apps/add-gallery-app).
...
* Při přiřazování uživatelů k Apple Business Manageru musíte vybrat jinou roli než **výchozí přístup**. Uživatelé s výchozí rolí přístupu se z zřizování vylučují a v protokolech zřizování se označí jako neefektivně. Pokud je jedinou rolí dostupnou v aplikaci výchozí role přístupu, můžete [aktualizovat manifest aplikace](https://docs.microsoft.com/azure/active-directory/develop/howto-add-app-roles-in-azure-ad-apps) a přidat další role. 
...
* [Kontrola požadavků na SCIM pro Apple Business Manager](URL=https://support.apple.com/guide/apple-business-manager/apdd88331cd6)
* [Jak se v Apple Business Manageru používá ID osoby](URL=https://support.apple.com/guide/apple-business-manager/apd69e1e48e9)
* [Import uživatelů do Apple Business Manageru pomocí SCIM](URL=https://support.apple.com/guide/apple-business-manager/apd3ec7b95ad)
* [Řešení konfliktů uživatelských účtů SCIM v Apple Business Manageru](URL=https://support.apple.com/guide/apple-business-manager/apd313013d12)
* [Odstranění účtů Azure AD, které se zobrazují v Apple Business Manageru](URL=https://support.apple.com/guide/apple-business-manager/apdaa5798fbe)
* [Zobrazení aktivity SCIM v Apple Business Manageru](URL=https://support.apple.com/guide/apple-business-manager/apd1bfd8dfde)
* [Správa stávajícího tokenu SCIM a připojení v Apple Business Manageru](URL=https://support.apple.com/guide/apple-business-manager/apdc9a823611)
* [Odpojení připojení SCIM v Apple Business Manageru](URL=https://support.apple.com/guide/apple-business-manager/apd609be3a61) *  [Správa stávajícího tokenu SCIM a připojení v Apple Business Manageru](URL=https://support.apple.com/guide/apple-business-manager/apdc9a8236e9)

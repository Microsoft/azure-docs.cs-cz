...
* [Sestavení na zdrojový kód potvrzení](#automatic-build-on-source-code-commit): automaticky aktivovat sestavení image kontejneru, když kód je potvrzena úložiště Git.
* [Sestavení na aktualizací základních imagí](#automate-os-and-framework-patching): při aktualizovali jsme základní image této image spustí sestavení image kontejneru.
* [Vícekrokové úlohy](#multi-step-tasks-preview) (preview): definování vícekrokových úkolů, které sestavování imagí, spouštění kontejnerů jako příkazy a nahrávání imagí do registru. Tato funkce ve verzi preview služby ACR úloh podporuje spouštění úlohy na vyžádání a paralelní bitové kopie sestavení, testování a operací push.

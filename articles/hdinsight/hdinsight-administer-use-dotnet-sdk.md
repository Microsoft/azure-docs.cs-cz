...
* Apache Storm
  ...
  * Nástroj rozhraní příkazového řádku (CLI)
    ...
    :::image type="content" source="./media/hdinsight-administer-use-powershell/hdinsight-portal-scale-cluster-storm-rebalance.png" alt-text="Rebilance škálování ve službě HDInsight":::

...
* [Přečtěte si o studiu v Azure Machine Learning a Azure Portal](service/overview-what-is-azure-ml.md).
...
* [Kurz: sestavení modelu předpovědi v návrháři Azure Machine Learning](service/ui-tutorial-automobile-price-train-score.md).

* [Seznamte se s hloubkovým učením a strojovým učením](service/concept-deep-learning-vs-machine-learning.md).

---
title: Spuštění poznámkového bloku datacihly pomocí aktivity poznámkového bloku datacihly
...
1.  Přepněte zpět do **nástroje pro vytváření v uživatelském rozhraní Data Factory**. Přejděte na kartu **Nastavení** pro **aktivitu Notebook1**.
    ...
    b.  Pojmenujte parametr jako **vstup** a zadejte hodnotu jako Expression **\@Pipeline (). Parameters. Name**.

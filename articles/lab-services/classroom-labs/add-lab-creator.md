...
- E-mailový účet Microsoftu, `@outlook.com`jako `@hotmail.com`je `@msn.com`,, `@live.com`nebo.
...
Chcete-li se zaregistrovat k účet Microsoft, instruktory by měly [http://signup.live.com](http://signup.live.com)přejít na.  

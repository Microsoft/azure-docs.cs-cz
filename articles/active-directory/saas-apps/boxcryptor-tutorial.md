...
3. **[Vytvoření zkušebního uživatele Boxcryptor](#create-a-boxcryptor-test-user)**  – Pokud chcete mít protějšek Britta Simon Boxcryptor, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **Boxcryptor domény a adresy URL** části, proveďte následující kroky:
...
6. Na **Boxcryptor konfigurace** klikněte na tlačítko **nakonfigurovat Boxcryptor** otevřete **nakonfigurovat přihlašování** okna. Kopírovat **SAML jednotné přihlašování – adresa URL služby** a **SAML Entity ID** z **Stručná referenční příručka oddílu.**

    ![Konfigurace správce řízení služeb Andromeda](./media/boxcryptor-tutorial/tutorial_boxcryptor_configure.png)

7. Ke konfiguraci jednotného přihlašování na **Boxcryptor** straně, je nutné odeslat na stažený **certifikát (Base64)**, **SAML jednotné přihlašování – adresa URL služby** a **SAML Entity ID** k [tým podpory Boxcryptor](mailto:support@boxcryptor.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

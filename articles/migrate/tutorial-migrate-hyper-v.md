...
Tento kurz je třetí část série, která ukazuje, jak vyhodnotit a migrovat Hyper-V do Azure pomocí Azure Migrate serveru pro vyhodnocení a migraci serveru. V tomto kurzu se naučíte:

...
Azure Active Directory poskytuje správu identit a přístupu pro prostředky Azure, cloudové aplikace a místní aplikace. To zahrnuje podnikové identity, jako jsou zaměstnanci, i externí identity, jako jsou partneři, prodejci a dodavatelé. Díky tomu je možné ke správě a zabezpečení přístupu k datům a prostředkům vaší organizace v místním prostředí a v cloudu používat jednotné přihlašování. Připojením všech uživatelů, aplikací a zařízení k Azure AD zajistíte bezproblémový a zabezpečený přístup a získáte větší přehled a kontrolu.

...
Jak je uvedeno výše, existuje několik způsobů, jak získat token ze služby Azure AD. Jsou podrobně popsané v [dokumentaci pro vývojáře Azure AD](../active-directory/develop/index.yml).
...
* `v1.0` Služba
    * [Tok autorizačního kódu](../active-directory/azuread-dev/v1-protocols-oauth-code.md).
    * [Tok přihlašovacích údajů klienta](../active-directory/azuread-dev/v1-oauth2-client-creds-grant-flow.md).
* `v2.0` Služba
    * [Tok autorizačního kódu](../active-directory/develop/v2-oauth2-auth-code-flow.md).
    * [Tok přihlašovacích údajů klienta](../active-directory/develop/v2-oauth2-client-creds-grant-flow.md).

...
Například delegování na oblastní specialisty podpory: role [správce helpdesku](permissions-reference.md#helpdesk-administrator) omezená na správu pouze uživatelů v oblasti, které podporují.
...
- [Vytváření, odebírání, naplnění a přidávání rolí do jednotek pro správu](admin-units-manage.md): kompletní postupy postupů
...
- [Správa jednotek Austrálie](admin-units-manage.md)
- [Správa uživatelů v nástroji Austrálie](admin-units-add-manage-users.md)
- [Správa skupin v nástroji Austrálie](admin-units-add-manage-groups.md)
- [Přiřazení vymezených rolí k jednotce AU](admin-units-assign-roles.md)

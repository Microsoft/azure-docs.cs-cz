...
4. Do vyhledávacího pole zadejte **informací prodejní – informace o správu**, vyberte **informací prodejní – informace o správu** z panelu výsledků klikněte **přidat** tlačítko Přidat aplikace.
    ...
    ![Prodejní informací – informace správy v seznamu výsledků](./media/inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_addfromgallery.png)
...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_samlbase.png)
...
3. Na **informací prodejní – informace o doméně pro správu a adresy URL** část, proveďte následující kroky, pokud chcete nakonfigurovat aplikace v režimu rozšíření IDP iniciované:
    ...
    ![Jednotné přihlašování informace IDP informací prodejní – informace o doméně pro správu a adresy URL](./media/inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_url.png)
...
4. Zkontrolujte **zobrazit upřesňující nastavení adresy URL** a provést následující krok, pokud chcete nakonfigurovat aplikace **SP** iniciované režimu:
    ...
    ![Prodejní informací – informace o doméně pro správu a adresy URL jeden přihlašování informace SP](./media/inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_url1.png)
...
6. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/inforretailinformationmanagement-tutorial/tutorial_general_400.png)
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/inforretailinformationmanagement-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **informací prodejní – informace o správu**.
    ...
    ![Prodejní informací – odkaz Správa informace v seznamu aplikací](./media/inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_app.png)  

...
> <br/>
> 
> * [vytvořit účet úložiště](../../storage/common/storage-account-create.md)
>   <br/>
...
1. Načte data do databáze podregistru v clusteru Azure HDInsight Hadoop.
   ...
   c.  Do příkazového řádku Hadoop zadejte kořenový `cd %hive_home%\bin` adresář podregistru podle příkazu.
...
1. Přihlaste se k [Azure Machine Learning Studio](https://studio.azureml.net/).
1. Přečtěte si data přímo z `Hive Queries` části pomocí modulu [Import dat][import-data] . Vložte potřebný dotaz, který extrahuje pole, vytvoří funkce a vzorkuje data v případě potřeby přímo v dotazu [Import dat][import-data] .
1. Jednoduchý tok experimentu Azure Machine Learning počínaje nahranou datovou sadou.

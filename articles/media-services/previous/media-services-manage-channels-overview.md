...
| --- | --- | --- |
| Vstup s jednou přenosovou rychlostí je kódovaný do více přenosových rychlostí v cloudu. |No |Ano |
...
| Podpora pro vložení SLAT |No |Ano |
| Podpora pro signalizaci AD |No |Ano |

...
Kolekce pracovních prostorů Power BI a ve službě Power BI jsou samostatné nabídky. Power BI kolekce pracovních prostorů funkcí založenou na skutečné spotřebě fakturační model, nasazuje prostřednictvím portálu Azure a umožňuje začlenit datové vizualizace do aplikace pro své zákazníky určený nezávislým výrobcům softwaru. Ve službě Power BI se účtuje a nasazuje prostřednictvím centra pro správu služeb Microsoft 365, a je samostatné obecné řešení BI primárně určené pro podnikové interní použití v rámci. Další informace o službě Power BI, najdete v článku [www.powerbi.com](https://powerbi.microsoft.com).

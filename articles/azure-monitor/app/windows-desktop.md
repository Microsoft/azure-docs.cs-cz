...
1. Na webu [Azure Portal](https://portal.azure.com) [vytvořte prostředek Application Insights](../../application-insights/app-insights-create-new-resource.md). Jako typ aplikace vyberte aplikaci ASP.NET.

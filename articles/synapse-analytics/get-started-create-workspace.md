...
Na rozdíl od vyhrazených fondů SQL je fakturace za SQL na vyžádání založena na množství dat naskenovaných pro spuštění dotazu, nikoli na počtu prostředků použitých ke spuštění dotazu.

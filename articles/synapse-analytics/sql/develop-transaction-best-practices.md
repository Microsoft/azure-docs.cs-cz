...
Další informace o úrovních izolace a omezeních [transakcí najdete v tématu transakce ve vyhrazeném fondu SQL](develop-transactions.md) .  Přehled dalších osvědčených postupů najdete v tématu [věnovaném osvědčeným postupům pro fond SQL](best-practices-dedicated-sql-pool.md).

...
Nastavte uživatelské jméno a heslo správce virtuálního počítače pomocí [Get-Credential](/powershell/module/microsoft.powershell.security/get-credential?view=powershell-5.1&preserve-view=true):

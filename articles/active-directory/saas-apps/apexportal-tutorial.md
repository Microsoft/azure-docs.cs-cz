...
Ke konfiguraci jednotného přihlašování na straně **portálu vrcholů** je potřeba odeslat stažený **soubor XML federačních metadat** a příslušné zkopírované adresy URL z Azure Portal do [týmu podpory na portálu](mailto:support@apexanalytix.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.
...
Když na přístupovém panelu kliknete na dlaždici vrcholového portálu, měli byste být automaticky přihlášeni k portálu vrcholů, pro který jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

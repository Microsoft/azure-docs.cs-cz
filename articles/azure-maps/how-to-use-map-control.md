...
2. Načtěte v sadě Azure Maps Web SDK. Můžete zvolit jednu ze dvou možností:
    ...
    * Pomocí globálně hostované verze CDN sady Azure Maps Web SDK přidejte odkazy na JavaScript a šablonu stylů v elementu `<head>` souboru HTML:

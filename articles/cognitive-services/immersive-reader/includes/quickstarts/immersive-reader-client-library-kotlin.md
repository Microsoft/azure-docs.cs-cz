---
title: Rychlý Start ke klientské knihovně pro moderní čtečku Kotlin (Android)
titleSuffix: Azure Cognitive Services
description: V tomto rychlém startu vytvoříte aplikaci pro Android od začátku a přidáte funkce rozhraní API pro moderní čtečku.

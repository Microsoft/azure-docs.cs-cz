...
Stávající zákazníci jsou potřeba k migraci jejich stávajících klíčů prostředků do nové služby na portálu Speech Service. Použijte k tomu následující postup: 

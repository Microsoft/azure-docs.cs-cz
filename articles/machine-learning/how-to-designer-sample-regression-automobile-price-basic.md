...
Vzhledem k tomu, že cílem této ukázky je předpovědět ceny automobilu a protože sloupec popisku (price) je souvislých dat, může být regresní model dobrou volbou. Pro tento kanál používáme **lineární regresi** .

...
- Je podporováno škálování na základě prahové hodnoty pro zasílání zpráv ve frontě. Další informace najdete v tématu [Začínáme s úložištěm Azure Queue](https://docs.microsoft.com/azure/storage/queues/storage-dotnet-how-to-use-queues).

...
1. Do vyhledávacího pole zadejte **Envoy**vyberte **Envoy** z panelu výsledků klikněte **přidat** tlačítko pro přidání aplikace.
...
1. **[Vytvořit testovacího uživatele Envoy](#create-an-envoy-test-user)**  – Pokud chcete mít protějšek Britta Simon Envoy, který je propojený s Azure AD reprezentace uživatele.
...
1. Na **zástupné domény a adresy URL** části, proveďte následující kroky:
...
1. Na **Envoy konfigurace** klikněte na tlačítko **konfigurace Envoy** otevřete **nakonfigurovat přihlašování** okna. Kopírovat **SAML jednotné přihlašování – adresa URL služby** z **Stručná referenční příručka oddílu.**
...
1. V **ověřování SAML** konfigurační oddíl, proveďte následující kroky:
...
1. V seznamu aplikací vyberte **Envoy**.

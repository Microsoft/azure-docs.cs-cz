...
V tomto článku jste zjistili, jak povolit a nakonfigurovat instanci jarního cloudového serveru pro konfiguraci. Další informace o správě aplikace najdete v tématu [škálování aplikace v Azure jarním cloudu](spring-cloud-howto-scale-manual.md).

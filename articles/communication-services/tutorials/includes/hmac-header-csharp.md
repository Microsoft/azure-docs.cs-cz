...
V tomto příkladu pošleme žádost o vytvoření nové identity pomocí rozhraní API pro ověřování komunikačních služeb (verze `2020-07-20-preview2` ).

...
| **Prevention (Prevence)** | Privilegované role přiřadíte jenom uživatelé, kteří mají obchodní odůvodnění. </br>Plánování pravidelně [kontrol přístupu](pim-how-to-start-security-review.md) k ověření, že uživatelé stále potřebují přístup. |
...
| | |
| --- | --- |
| **Severity** | Střednědobé používání |
...
| **Prevention (Prevence)** | Ujistěte se, že účty, které jsou sdíleny jsou otáčení silná hesla, když dojde ke změně v uživatele, kteří znát heslo. </br>Pravidelně revize účty s privilegované role pomocí [kontrol přístupu](pim-how-to-start-security-review.md) a odeberte přiřazení rolí, které už nejsou potřeba. |
| **Na portálu zmírňující opatření** | Odebere účet z svou privilegovanou roli. |
...
| **Prevention (Prevence)** | Prozkoumejte, kde uživatelé jsou přiřazení privilegovaných rolí mimo PIM a zakázat budoucí přiřazení z něj. |
| **Na portálu zmírňující opatření** | Odebere účet z svou privilegovanou roli. |
...
| **Prevention (Prevence)** | Přiřazení uživatelů nejméně privilegovaných rolí, které potřebují. |
| **Na portálu zmírňující opatření** | Odebere účet z svou privilegovanou roli. |

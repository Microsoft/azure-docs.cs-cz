---
title: Ukázka skriptu Azure PowerShell – vytvoření plně nakonfigurovaného virtuálního počítače s Windows
description: Ukázkový skript Azure PowerShell – vytvoření plně nakonfigurovaného virtuálního počítače s Windows

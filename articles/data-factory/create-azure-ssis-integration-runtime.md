...
- **Azure PowerShell**. Postupujte podle pokynů [instalace a konfigurace Azure Powershellu](/powershell/azure/install-az-ps), pokud chcete spustit skript prostředí PowerShell ke zřízení prostředí Azure-SSIS IR.

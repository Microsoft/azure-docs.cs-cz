...
Všechna vlastní témata a domény v Event Grid patří do úrovně Basic nebo Premium. Počínaje verzí `2020-04-01-preview` API můžete zvolit požadovanou úroveň v rámci vytváření tématu nebo domény. Výchozí hodnota je úroveň Basic. Témata a domény, které byly vytvořeny pomocí starší verze rozhraní API, jsou standardně nastavené na úroveň Basic. Pokud chcete změnit cenovou úroveň svých témat a domén, přečtěte si téma [Postup aktualizace úrovně pro témata a domény](update-tier.md).
...
|       &nbsp;                                           | Basic           | Premium        |
| ------------------------------------------------------ | --------------- | -------------- |
| Pravidla brány firewall protokolu IP pro příchozí přenosy                          | Náhled  | Náhled |
| Značky služeb pro odchozí přenosy                                | Náhled  | Náhled |
| Integrace virtuální sítě privátního koncového bodu při příchozím přenosu dat          | Není k dispozici.   | Náhled |

...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/mobi-tutorial/tutorial_mobi_samlbase.png)
...
3. Na **MOBI domény a adresy URL** část, proveďte následující kroky, pokud chcete nakonfigurovat aplikace v režimu rozšíření IDP iniciované:
    ...
    ![MOBI domény a adresy URL jednotné přihlašování informace](./media/mobi-tutorial/tutorial_mobi_url.png)
...
4. Zkontrolujte **zobrazit upřesňující nastavení adresy URL** a provést následující krok, pokud chcete nakonfigurovat aplikace **SP** iniciované režimu:
    ...
    ![MOBI domény a adresy URL jednotné přihlašování informace](./media/mobi-tutorial/tutorial_mobi_url1.png)
...
6. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/mobi-tutorial/tutorial_general_400.png)
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/mobi-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **MOBI**.
    ...
    ![V seznamu aplikací na MOBI odkaz](./media/mobi-tutorial/tutorial_mobi_app.png)  

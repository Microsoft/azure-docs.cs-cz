...
| **Podporované protokoly** |Protokol tunelového propojení s stezním sítěmi secure sockets (SSTP), OpenVPN a IPsec |Protokol IPsec |Přímé připojení přes sítě VLAN, technologie VPN od poskytovatelů síťových služeb (MPLS, VPLS…) |
...
| **Odolnost proti připojení** |aktivní-pasivní |aktivní-aktivní nebo aktivní-pasivní |aktivní-aktivní |
...
| **Technická dokumentace** |[Dokumentace brány VPN](https://azure.microsoft.com/documentation/services/vpn-gateway/) |[Dokumentace brány VPN](https://azure.microsoft.com/documentation/services/vpn-gateway/) |[Dokumentace ke službě ExpressRoute](https://azure.microsoft.com/documentation/services/expressroute/) |

...
description: Úvodní příručka ukazuje, jak nastavit a načíst klíč z Azure Key Vault pomocí Azure PowerShellu
services: key-vault
author: msmbaldwin
manager: rkarlin

...
Ke konfiguraci jednotného přihlašování na straně **Cognidox** je potřeba odeslat stažený **soubor XML federačních metadat** a příslušné zkopírované adresy URL z Azure Portal do [týmu podpory Cognidox](mailto:support@cognidox.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

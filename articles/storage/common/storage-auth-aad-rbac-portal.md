...
> [!NOTE]
> Jako vlastník účtu Azure Storage nebudete automaticky přiřazena oprávnění pro přístup k datům. Roli RBAC pro Azure Storage musíte explicitně přiřadit. Můžete ji přiřadit na úrovni předplatného, skupiny prostředků, účtu úložiště nebo kontejneru nebo fronty.
>

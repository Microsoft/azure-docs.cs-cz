...
Karta podporu poskytují informace o podpoře inženýrství a zákazníků.
 
## <a name="identify-contacts-and-websites"></a>Identifikujte kontakty a weby

Následující snímek obrazovky, použijte jako vodítko k poskytování požadované informace. Názvy všech polí s červenou hvězdičkou (*) je třeba provést.

  ![Fórum podpory nabídky.](./media/azureapp-support-tab.png)

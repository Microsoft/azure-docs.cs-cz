...
description: Příklad prostředí PowerShell, který obsahuje seznam všech skupin konektorů proxy aplikací služby Azure Active Directory (Azure AD) s přiřazenými aplikacemi.
...
ms.locfileid: "75482163"
---
# <a name="get-all-application-proxy-apps-and-list-by-connector-group"></a>Získat všechny aplikace proxy aplikace a seznam podle skupiny konektorů

Tento příklad skriptu Prostředí PowerShell uvádí informace o všech skupinách konektoru proxy aplikace Azure Active Directory (Azure AD) s přiřazenými aplikacemi.

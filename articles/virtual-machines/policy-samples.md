...
ms.locfileid: "84234299"
---
# <a name="azure-policy-built-in-policy-definitions-for-azure-virtual-machines"></a>Azure Policy předdefinované definice zásad pro Azure Virtual Machines

Tato stránka je indexem [Azure Policy](../governance/policy/overview.md) integrovaných definic zásad pro Azure Virtual Machines. Další Azure Policy integrovaných pro jiné služby najdete v tématu [Azure Policy předdefinované definice](../governance/policy/samples/built-in-policies.md).

...
* [Použití sady Microsoft Cognitive Toolkit hloubkového učení modelu s clusterem Azure HDInsight Spark](spark/apache-spark-microsoft-cognitive-toolkit.md)
* [Použití Caffe pro distribuované obsáhlého learningu v Azure HDInsight Spark](spark/apache-spark-deep-learning-caffe.md)
* [Architektury obsáhlého learningu a umělé Inteligence na na Data virtuálního počítače VĚDY](https://docs.microsoft.com/en-us/azure/machine-learning/data-science-virtual-machine/dsvm-deep-learning-ai-frameworks)

...
Následující příklad ukazuje, jak vytvořit 3072 klíč **RSA** , který se bude používat jenom pro **WrapKey, operace unwrapKey** (--OPS). 
...
Následující příklad ukazuje, jak vytvořit 256 **symetrický** klíč, který bude použit pouze pro operace **šifrování a dešifrování** (--OPS).

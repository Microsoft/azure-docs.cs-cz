---
title: Výstup Azure Stream Analytics ke službě Azure Cosmos DB
...
> Další rozhraní API služby Azure Cosmos DB se zatím nepodporují. Pokud Stream Analytics naAzure Cosmos DB účty vytvořené pomocí jiných rozhraní API, nemusí být data správně uložená. 
...
V závislosti na tom, jaké úrovně konzistence čtení vašim potřebám scénář pro čtení a zápis latenci, že můžete použít úrovně konzistence na váš účet databáze. Propustnost můžete zlepšit škálováním jednotek žádostí (ru) v kontejneru. 
...
> [!NOTE]
> Azure Stream Analytics podporuje v nejvyšší úrovni pouze neomezený počet kontejnerů s klíči oddílů. Například `/region` je podporována. Vnořené klíče oddílů (například `/region/name`) nejsou podporovány. 
...
|ID dokumentu     | Volitelné. Název sloupce ve výstupních událostech používaný jako jedinečný klíč, na které insert nebo update musí být operace založené. Pokud necháte pole prázdné, budou vloženy všechny události bez možnosti aktualizace.|

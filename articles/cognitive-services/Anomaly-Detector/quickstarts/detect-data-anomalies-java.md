...
description: V tomto rychlém startu se dozvíte, jak pomocí rozhraní API pro detekci anomálií detekovat anomálie v datových řadách, a to buď jako dávku, nebo na streamovaná data.

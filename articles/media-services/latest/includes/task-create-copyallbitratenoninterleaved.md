...
Pokud chcete zobrazit všechny dostupné transformace REST API, přečtěte si téma [transformace-Create nebo Update](/rest/api/media/transforms/createorupdate#definitions).

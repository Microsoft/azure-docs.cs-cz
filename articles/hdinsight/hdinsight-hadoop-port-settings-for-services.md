...
| Serveru Spark Thrift |443 |HTTPS |Spark |Serveru Spark Thrift používá k odesílání dotazů Hive. V tématu [Beeline pomocí Hive v HDInsight](hadoop/apache-hadoop-use-hive-beeline.md) |

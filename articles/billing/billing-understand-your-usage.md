...
Pokyny pro stažení najdete v tématu, které vysvětluje, [jak získat fakturu a informace o denním využívání Azure](billing-download-azure-invoice-daily-usage-date.md).
...
ResourceGroup | Vše | Název [skupiny prostředků](https://docs.microsoft.com/azure/azure-resource-manager/resource-group-overview), ve které se prostředek nachází.
...
Pokud chcete získat další podrobné informace o využití a poplatcích, přečtěte si článek vysvětlující fakturu [s průběžnými platbami](./billing-understand-your-bill.md) nebo fakturu [pro smlouvu se zákazníkem Microsoftu](billing-mca-understand-your-bill.md).

...
| as2To | Yes | Řetězec | Název příjemce zprávy AS2 z hlaviček zprávy AS2 |
| as2From | Yes | Řetězec | Jméno odesílatele zprávy AS2 z hlaviček zprávy AS2 |
| smlouva | No | Řetězec | Název smlouvy AS2, na kterou jsou zprávy vyřešeny |
| směr | Yes | Řetězec | Směr toku zpráv, který je buď `receive` nebo`send` |
...
| senderPartnerName | No | Řetězec | Název partnera pro odesílatele zprávy AS2 |
| receiverPartnerName | No | Řetězec | Název partnera pro zprávu AS2 |
| as2To | Yes | Řetězec | Jméno partnera, který přijímá zprávu AS2 |
| as2From | Yes | Řetězec | Název partnera, který odesílá zprávu AS2 |
| smlouva | No | Řetězec | Název smlouvy AS2, na kterou jsou zprávy vyřešeny |
| směr | Yes | Řetězec | Směr toku zpráv, který je buď `receive` nebo`send` |

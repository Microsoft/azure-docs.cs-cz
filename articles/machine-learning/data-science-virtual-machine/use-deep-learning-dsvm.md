...
- [Spuštěných neuronových sítí v různých rozhraní](https://github.com/ilkarman/DeepLearningFrameworks): Kompletní návod, který ukazuje, jak migrace kódu z jednoho rozhraní. Také ukazuje, jak porovnat modelu a výkonu v rozhraní. 
...
- [Klasifikace textové dokumenty](https://github.com/anargyri/lstm_han): Tento návod ukazuje, jak sestavit a trénování dvě různé neuronové sítě architektury: Hierarchické pozornost sítě a dlouhá paměti krátká období (LSTM) sítě. Tyto neuronové sítě pomocí rozhraní Keras API pro obsáhlý learning zařazoval dokumenty do textu. Keras je front-endu na tři nejoblíbenější hloubkového učení architektury: Microsoft Cognitive Toolkit, TensorFlow a Theano.

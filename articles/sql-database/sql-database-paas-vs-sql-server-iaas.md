---
title: Zvolit správnou možnost nasazení
...
Pro mnoho firem je rozhodnutí o přechodu na využívání cloudové služby nejen otázkou nízkých nákladů, ale také snížení složitosti správy. V IaaS a PaaS Microsoft spravuje základní infrastrukturu a automaticky replikuje všechna data, aby poskytovala zotavení po havárii, nakonfiguruje a upgraduje databázový software, spravuje vyrovnávání zatížení a provádí transparentní převzetí služeb při selhání v případě selhání serveru v rámci datového centra.

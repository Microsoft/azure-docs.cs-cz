---
title: Protokol podpory protokolu prostřednictvím StorSimple Správce zařízení | Microsoft Docs
description: Popisuje StorSimple Správce zařízení diagnostickou schopnost a vysvětluje, jak ji použít k řešení potíží s virtuálním polem StorSimple.
services: storsimple
documentationcenter: ''
author: manuaery
manager: syadav
...
---
# <a name="use-the-storsimple-device-manager-service-to-log-a-support-request-for-the-storsimple-virtual-array"></a>Použití služby StorSimple Správce zařízení k zaznamenání Support request pro virtuální pole StorSimple

## <a name="overview"></a>Přehled

StorSimple Správce zařízení poskytuje možnost **zaprotokolovat novou žádost o podporu** v okně s přehledem služby. V tomto článku se dozvíte, jak se můžete přihlásit k nové žádosti o podporu a spravovat její životní cyklus z portálu.

## <a name="new-support-request"></a>Nová žádost o podporu

V závislosti na [plánu podpory](https://azure.microsoft.com/support/plans/)můžete vytvořit lístky podpory pro problém ve virtuálním poli StorSimple přímo z okna s přehledem služby StorSimple Správce zařízení.
...
3. V **kroku 2** zvolte **závažnost** a určete, jestli problém souvisí s polem nebo službou StorSimple Správce zařízení. Také vyberte **kategorii** pro tento problém a zadejte další **Podrobnosti** o problému.
...
Naučte se [diagnostikovat a řešit problémy související s vaším virtuálním polem StorSimple](storsimple-virtual-array-diagnose-problems.md)

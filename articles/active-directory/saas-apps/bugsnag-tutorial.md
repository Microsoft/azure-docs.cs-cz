...
2. **[Nakonfigurujte jednotné přihlašování Bugsnag](#configure-bugsnag-single-sign-on)** – ke konfiguraci nastavení jediného Sign-On na straně aplikace.
...
### <a name="configure-bugsnag-single-sign-on"></a>Nakonfigurovat Bugsnag jednu Sign-On
...
Když na přístupovém panelu kliknete na dlaždici Bugsnag, měli byste se automaticky přihlásit k Bugsnag, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).

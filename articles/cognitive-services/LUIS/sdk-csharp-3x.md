---
title: 'Rychlý Start: Language Understanding (LUIS) vytváření klientské knihovny 3. x pro .NET'
titleSuffix: Azure Cognitive Services
description: Začněte s klientskou knihovnou LUIS 3. x pro .NET. Pomocí těchto kroků nainstalujete balíček a vyzkoušíte ukázkový kód pro základní úlohy.
...
ms.locfileid: "74807503"
---
# <a name="quickstart-language-understanding-luis-client-library-3x-for-net"></a>Rychlý Start: Language Understanding (LUIS) Client Library 3. x pro .NET

Začněte s klientskou knihovnou Language Understanding (LUIS) 3. x pro .NET. Pomocí těchto kroků nainstalujete balíček a vyzkoušíte ukázkový kód pro základní úlohy.  Language Understanding (LUIS) vám umožňuje použít vlastní informace o strojovém učení na konverzaci uživatele, text přirozeného jazyka a předpovědět celkový význam a vyžádat si relevantní a podrobné informace.

Pomocí klientské knihovny Language Understanding (LUIS) 3. x pro .NET:

* Dotazování publikovaného koncového bodu

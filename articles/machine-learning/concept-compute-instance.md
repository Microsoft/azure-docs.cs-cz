...
[Sada Azure Machine Learning SDK pro Python](/python/api/overview/azure/ml/intro)</br>z PyPI|Zahrnuje většinu dalších balíčků AzureML.  Pokud chcete zobrazit úplný seznam, [otevřete okno terminálu na instanci služby COMPUTE](how-to-access-terminal.md) a spusťte příkaz. <br/> `conda list -n azureml_py36 azureml*` |
...
> [!TIP]
> Instance COMPUTE má disk s operačním systémem s 120 GB. Pokud vyčerpáte místo na disku, před [zastavením nebo restartováním](how-to-create-manage-compute-instance.md#manage) výpočetní instance [pomocí terminálu](how-to-access-terminal.md) vymažte aspoň 1-2 GB.

...
V systému iOS přidejte `com.microsoft.adalcache` skupinu řetězce klíčů do nároku vaší aplikace v Xcode v části **Možnosti nastavení projektu**  >    >  **sdílení řetězce klíčů** .

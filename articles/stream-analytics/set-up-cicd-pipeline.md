...
V tomto článku se dozvíte, jak vytvořit kanály [sestavení](/devops/pipelines/get-started-designer) a [vydání](/devops/pipelines/release/define-multistage-release-process) Azure DevOps pomocí nástrojů CI/CD pro Azure Stream Analytics.

## <a name="commit-your-stream-analytics-project"></a>Potvrzení projektu Stream Analytics

Než začnete, potvrďte kompletní Stream Analytics projekty jako zdrojové soubory do úložiště [Azure DevOps](/devops/user-guide/source-control) . Na toto [ukázkové úložiště](https://dev.azure.com/wenyzou/azure-streamanalytics-cicd-demo) a [Stream Analytics zdrojový kód projektu](https://dev.azure.com/wenyzou/_git/azure-streamanalytics-cicd-demo?path=%2FmyASAProject) můžete odkazovat v Azure Pipelines.

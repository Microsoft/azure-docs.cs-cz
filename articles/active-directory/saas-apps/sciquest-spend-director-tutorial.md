...
3. **[Vytvoření zkušebního uživatele SciQuest věnovat ředitel](#create-a-sciquest-spend-director-test-user)**  – Pokud chcete mít protějšek Britta Simon věnovat ředitel SciQuest, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **SciQuest věnovat ředitel domény a adresy URL** části, proveďte následující kroky:
...
6. Ke konfiguraci jednotného přihlašování na **SciQuest věnovat ředitel** straně, je nutné odeslat na stažený **soubor XML s metadaty** k [tým podpory SciQuest věnovat ředitel](https://www.jaggaer.com/contact-us/).

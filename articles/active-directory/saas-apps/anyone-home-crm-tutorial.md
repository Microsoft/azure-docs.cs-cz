...
Po kliknutí na dlaždici domů CRM na přístupovém panelu byste měli být automaticky přihlášeni k domácímu uživateli CRM, pro který jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).
...
- [Jak chránit všechny domácí aplikace CRM pomocí pokročilých viditelností a ovládacích prvků](/cloud-app-security/proxy-intro-aad)
...
## [Vytváření šablon – portál](resource-manager-quickstart-create-templates-use-the-portal.md)
## [Vytváření šablon – VS Code](resource-manager-quickstart-create-templates-use-visual-studio-code.md)
## [Vytváření šablon – Visual Studio](vs-azure-tools-resource-groups-deployment-projects-create-deploy.md)

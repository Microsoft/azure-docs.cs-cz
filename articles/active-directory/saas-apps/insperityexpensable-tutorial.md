---
title: 'Kurz: Integrace Azure Active Directory se službou Insperity ExpensAble | Dokumentace Microsoftu'
...
ms.locfileid: "39052495"
---
# <a name="tutorial-azure-active-directory-integration-with-insperity-expensable"></a>Kurz: Integrace Azure Active Directory se službou Insperity ExpensAble
...
5. Na panelu výsledků vyberte **Insperity ExpensAble**a potom klikněte na tlačítko **přidat** tlačítko pro přidání aplikace.
...
3. **[Vytváření Insperity ExpensAble testovacího uživatele](#creating-an-insperity-expensable-test-user)**  – Pokud chcete mít protějšek Britta Simon Insperity ExpensAble, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **Insperity ExpensAble domény a adresy URL** části, proveďte následující kroky:

---
title: Automatizace úloh pomocí Visual Studio Code-Azure Logic Apps
...
1. V části **Logic Apps**vyberte požadované předplatné. Uzel předplatné rozbalí a zobrazí všechny aplikace logiky, které v tomto předplatném existují.
   ...
   ![Výběr vašeho předplatného Azure](./media/quickstart-create-logic-apps-visual-studio-code/select-azure-subscription.png)
...
## <a name="view-in-azure-portal"></a>Zobrazit v Azure Portal

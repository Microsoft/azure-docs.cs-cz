...
3. Spusťte **Synchronization Service Manager** tak, že v části spustíte **službu > synchronizace**.
...
1. Spusťte **Editor pravidel synchronizace** , a to tak, že spustíte **editor pravidel synchronizace** ** > .**

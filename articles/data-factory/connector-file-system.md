...
> [!NOTE]
> Namapovaná síťová jednotka není při načítání dat ze sdílené síťové složky podporovaná. Místo toho použijte skutečnou cestu, například ` \\server\share` .

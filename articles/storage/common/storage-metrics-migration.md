...
5. Pokud jste vytvořili pravidla výstrah založená na klasických metrikách úložiště, [vytvořte pravidla výstrah](../../azure-monitor/platform/alerts-overview.md) založená na metrikách v Azure monitor. 

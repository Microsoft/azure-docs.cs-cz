...
Ke konfiguraci jednotného přihlašování na straně **grok Learning** je potřeba odeslat **adresu URL federačních metadat aplikace** do [týmu podpory grok Learning](mailto:sso-support@groklearning.com). Toto nastavení nastaví, aby bylo správně nastaveno připojení SAML SSO na obou stranách.
...
Když na přístupovém panelu kliknete na dlaždici učení grok, měli byste se automaticky přihlásit k grok učení, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).

...
Další informace najdete v tématu [Overview of Role-Based řízení přístupu v Azure PIM](../active-directory/privileged-identity-management/azure-pim-resource-rbac.md).
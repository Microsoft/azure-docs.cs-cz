...
> [!NOTE] 
> Pokud k publikování vaší nabídky používáte rozhraní API, můžete se ve formátu JSON nabídky podívat na novou část. V závislosti na typu nabídky by `virtualMachinePricingV2` se `monthlyPricingV2`to mělo opatřit poznámkami. 

...
* [Stream umožňuje **centra událostí** ](../../azure-monitor/platform/activity-logs-stream-event-hubs.md) za účelem ingestování datových služby třetích stran nebo vlastních analytics řešení, jako je Power BI.

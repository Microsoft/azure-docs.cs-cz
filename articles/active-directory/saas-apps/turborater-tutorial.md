...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/turborater-tutorial/tutorial_turborater_samlbase.png)

3. Na **TurboRater domény a adresy URL** část, proveďte následující kroky:

    ![TurboRater domény a adresy URL jednotné přihlašování informace](./media/turborater-tutorial/tutorial_turborater_url.png)
...
5. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/turborater-tutorial/tutorial_general_400.png)
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/turborater-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **TurboRater**.
    ...
    ![V seznamu aplikací na TurboRater odkaz](./media/turborater-tutorial/tutorial_turborater_app.png)  

...
Přístup k Azure Portal můžete povolit tak, že v datových **centrech Azure vyberete možnost přijmout připojení** , jak je znázorněno na následujícím snímku obrazovky:

...
Pokud chcete získat přístup k tabulkám v projektech cloudové služby, musíte do všech C# zdrojových souborů, které přistupují k úložišti tabulek Azure, zahrnout následující položky.

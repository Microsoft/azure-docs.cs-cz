...
Když na přístupovém panelu kliknete na dlaždici LoginRadius, měli byste se automaticky přihlásit k LoginRadius, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).

...
## <a name="enablepolicybased"></a>Povolit selektory přenosu na základě zásad
...
## <a name="update"></a>Aktualizace selektorů přenosu na základě zásad

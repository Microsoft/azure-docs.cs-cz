...
Ke konfiguraci jednotného přihlašování na straně **TruNarrative** je potřeba odeslat stažený **soubor XML federačních metadat** a příslušné zkopírované adresy URL z Azure Portal do [týmu podpory TruNarrative](mailto:helpdesk@trunarrative.com). Toto nastavení nastaví, aby bylo správně nastaveno připojení SAML SSO na obou stranách.

### <a name="create-trunarrative-test-user"></a>Vytvořit testovacího uživatele TruNarrative

V této části vytvoříte uživatele s názvem B. Simon v TruNarrative. Pokud chcete přidat uživatele na platformě TruNarrative, pracujte s týmem podpory TruNarrative. Před použitím jednotného přihlašování je nutné vytvořit a aktivovat uživatele.
...
Když na přístupovém panelu kliknete na dlaždici TruNarrative, měli byste se automaticky přihlásit k TruNarrative, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).

...
Dále prozkoumejte api pro počítačové zpracování, která se používají k analýze obrazu, detekci celebrit a orientačních bodů, vytvoření miniatury a extrahování tištěného a ručně psaného textu.

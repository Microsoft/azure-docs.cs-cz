...
```
Pokud je vybraný **dokument na řádku** , mapování toků dat načte z každého řádku v souboru jeden dokument JSON. 
...
File3.json
 ...
 {"time":"2015-04-29T07:13:21.4370000Z","callingimsi":"466923101048691","callingnum1":"678901578","callingnum2":"345626404","switch1":"Germany","switch2":"UK"}
```
Pokud je vybráno **pole dokumentů** , mapování toků dat načte do souboru jedno pole dokumentu. 

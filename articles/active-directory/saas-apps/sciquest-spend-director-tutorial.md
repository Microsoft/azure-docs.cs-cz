...
4. Do vyhledávacího pole zadejte **SciQuest tráví ředitel**, vyberte **SciQuest tráví ředitel** z panelu výsledků klikněte **přidat** tlačítko Přidat aplikaci.
    ...
    ![SciQuest tráví nacházející v seznamu výsledků](./media/sciquest-spend-director-tutorial/tutorial_sciquestspenddirector_addfromgallery.png)
...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/sciquest-spend-director-tutorial/tutorial_sciquestspenddirector_samlbase.png)

3. Na **SciQuest tráví ředitel domény a adresy URL** část, proveďte následující kroky:

    ![SciQuest tráví ředitel domény a adresy URL jednotné přihlašování informace](./media/sciquest-spend-director-tutorial/tutorial_sciquestspenddirector_url.png)
...
5. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/sciquest-spend-director-tutorial/tutorial_general_400.png)
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/sciquest-spend-director-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **SciQuest tráví ředitel**.
    ...
    ![Odkaz SciQuest tráví nacházející v seznamu aplikací](./media/sciquest-spend-director-tutorial/tutorial_sciquestspenddirector_app.png)  

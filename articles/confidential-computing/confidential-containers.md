...
Prohlédněte si tajnou ukázku zdravotní péče s důvěrnými kontejnery. Ukázka je k dispozici [zde](https://docs.microsoft.com/azure/architecture/example-scenario/confidential/healthcare-inference). 

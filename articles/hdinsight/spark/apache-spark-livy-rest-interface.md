...
Clustery HDInsight 3,5 a vyšší, ve výchozím nastavení zakažte používání místních cest k souborům pro přístup k ukázkovým datovým souborům nebo jar. Pro přístup k jar nebo ukázkovým datovým souborům z clusteru doporučujeme použít místo toho cestu `wasbs://`.

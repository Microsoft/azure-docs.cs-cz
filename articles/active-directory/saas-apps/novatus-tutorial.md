---
title: 'Kurz: Integrace Azure Active Directory se službou Novatus | Dokumentace Microsoftu'
...
ms.locfileid: "39051331"
---
# <a name="tutorial-azure-active-directory-integration-with-novatus"></a>Kurz: Integrace Azure Active Directory se službou Novatus
...
5. Na panelu výsledků vyberte **Novatus**a potom klikněte na tlačítko **přidat** tlačítko pro přidání aplikace.
...
3. **[Vytvoření zkušebního uživatele Novatus](#creating-a-novatus-test-user)**  – Pokud chcete mít protějšek Britta Simon Novatus, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **Novatus domény a adresy URL** části, proveďte následující kroky:
...
6. Na **Novatus konfigurace** klikněte na tlačítko **nakonfigurovat Novatus** otevřete **nakonfigurovat přihlašování** okna. Kopírovat **URL odhlašování SAML Entity ID a SAML jednotné přihlašování – adresa URL služby** z **Stručná referenční příručka oddílu.**

    ![Konfigurace jednotného přihlašování](./media/novatus-tutorial/tutorial_novatus_configure.png) 

7. Pokud chcete získat jednotné přihlašování nakonfigurované pro vaši aplikaci, kontaktujte vašeho [tým podpory Novatus](mailto:jvinci@novatusinc.com). Připojit **stáhnout certifikát** souborů k e-mailu a sdílené složky **adres URL metadat** (**URL odhlašování SAML Entity ID a SAML jednotné přihlašování – adresa URL služby**) s Novatus tým pro nastavení jednotné přihlašování na své straně.

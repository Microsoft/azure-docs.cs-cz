...
Ke konfiguraci jednotného přihlašování na straně **PrinterLogic SaaS** je potřeba odeslat stažený **certifikát (Base64)** a příslušné zkopírované adresy URL z Azure Portal do [týmu podpory PrinterLogic SaaS](mailto:support@printerlogic.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

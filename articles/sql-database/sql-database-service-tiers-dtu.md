...
| :-- | --: |--:| --:|
|Cílové úlohy|Vývoj a produkce|Vývoj a produkce|Vývoj a produkce|
...
|Indexování columnstore |Nevztahuje se|S3 a vyšší|Podporováno|
...
| Úroveň Standard |Transakce za minutu |90. percentil v 1,0 sekundách |
| Úroveň Basic |Transakce za hodinu |80th percentil v 2,0 sekundách |

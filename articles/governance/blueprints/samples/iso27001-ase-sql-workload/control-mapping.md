---
title: Ukázka-ISO 27001 pomocného a SQL úlohy – mapování ovládacích prvků
...
Následující mapování jsou pro ovládací prvky **ISO 27001:2013** . Pomocí navigace na pravé straně můžete přejít přímo k určitému mapování ovládacího prvku. Mnohé z mapovaných ovládacích prvků jsou implementovány s [Azure Policy](../../../policy/overview.md) iniciativou. Chcete-li si projít kompletní iniciativu, otevřete **zásadu** v Azure Portal a vyberte stránku **definice** . Pak vyhledejte a vyberte **\[Preview @ no__t-2 Audit ISO 27001:2013 a nasaďte specifická rozšíření virtuálního počítače pro podporu požadavků auditu** integrovaná iniciativa zásad.
...
- \[Preview @ no__t-1: Auditovat minimální počet vlastníků předplatného
- \[Preview @ no__t-1: Auditovat maximální počet vlastníků předplatného
...
- \[Preview @ no__t-1: sledujte výsledky posouzení ohrožení zabezpečení SQL Azure Security Center
...
- \[Preview @ no__t-1: nasazení rozšíření virtuálního počítače pro audit účtů virtuálních počítačů se systémem Linux bez hesel
- \[Preview @ no__t-1: nasazení rozšíření virtuálního počítače pro audit virtuálního počítače se systémem Linux povolení vzdáleného připojení z účtů bez hesel
- \[Preview @ no__t-1: Auditovat účty virtuálních počítačů Linux bez hesla
- \[Preview @ no__t-1: Auditovat virtuální počítač Linux umožňující vzdálená připojení z účtů bez hesla
...
- \[Preview @ no__t-1: audit účtů s oprávněními vlastníka, kteří nejsou u předplatného povolená MFA
- \[Preview @ no__t-1: audit účtů s oprávněními k zápisu, kteří nejsou u předplatného povolená MFA
- \[Preview @ no__t-1: Auditovat externí účty s oprávněním vlastníka u předplatného
- \[Preview @ no__t-1: Auditovat externí účty s oprávněním k zápisu do předplatného
...
- \[Preview @ no__t-1: audit účtů s oprávněními vlastníka, kteří nejsou u předplatného povolená MFA
- \[Preview @ no__t-1: audit účtů s oprávněním ke čtení, která nejsou u předplatného povolená MFA
- \[Preview @ no__t-1: audit účtů s oprávněními k zápisu, kteří nejsou u předplatného povolená MFA
- \[Preview @ no__t-1: nasazení rozšíření virtuálního počítače pro audit oprávnění k souboru passwd virtuálního počítače se systémem Linux
- \[Preview @ no__t-1: oprávnění k souboru auditu pro virtuální počítače Linux jsou nastavena na 0644.
...
- \[Preview @ no__t-1: audit zastaralých účtů v rámci předplatného
- \[Preview @ no__t-1: Auditovat zastaralé účty s oprávněním vlastníka u předplatného
- \[Preview @ no__t-1: Auditovat externí účty s oprávněním vlastníka u předplatného
- \[Preview @ no__t-1: Auditovat externí účty s oprávněním k zápisu do předplatného
...
- \[Preview @ no__t-1: nasazení rozšíření virtuálního počítače pro audit virtuálních počítačů s Windows vynutila požadavky na složitost hesla
- \[Preview @ no__t-1: nasazení rozšíření virtuálního počítače pro audit maximálního stáří hesla Windows VM 70 dní
- \[Preview @ no__t-1: nasazení rozšíření virtuálního počítače za účelem auditu minimálního stáří hesla virtuálního počítače s Windows 1 den
- \[Preview @ no__t-1: nasazení rozšíření virtuálního počítače pro audit hesel virtuálních počítačů s Windows musí mít aspoň 14 znaků.
- \[Preview @ no__t-1: nasazení rozšíření virtuálního počítače pro audit virtuálních počítačů s Windows nesmí umožňovat předchozí 24 hesla
- \[Preview @ no__t-1: Audituje virtuální počítač s Windows, který vynutil požadavky na složitost hesla
- \[Preview @ no__t-1: Auditovat maximální stáří hesla Windows VM 70 dní
- \[Preview @ no__t-1: Auditovat minimální stáří hesla virtuálního počítače s Windows 1 den
- \[Preview @ no__t-1: audit hesel virtuálních počítačů s Windows musí mít aspoň 14 znaků.
- \[Preview @ no__t-1: Auditovat virtuální počítač s Windows by neměl umožňovat předchozí 24 hesla
...
- \[Preview @ no__t-1: Auditovat přístup pouze HTTPS pro Function App
- \[Preview @ no__t-1: Auditovat přístup pouze HTTPS pro webovou aplikaci
- \[Preview @ no__t-1: Auditovat přístup pouze HTTPS pro aplikaci API
- \[Preview @ no__t-1: Auditovat chybějící šifrování objektů BLOB pro účty úložiště
- \[Preview @ no__t-1: nasazení rozšíření virtuálního počítače pro audit virtuálních počítačů s Windows nesmí ukládat hesla pomocí reverzibilního šifrování
- \[Preview @ no__t-1: audit Windows VM by neměl ukládat hesla pomocí reverzibilního šifrování
- \[Preview @ no__t-1: Sledujte nešifrované disky virtuálních počítačů v Azure Security Center
...
- \[Preview @ no__t-1: nasazení Dependency Agent pro audit – image virtuálního počítače (OS) není v seznamu.
- \[Preview @ no__t-1: není v seznamu bitová kopie virtuálního počítače (OS) pro audit Dependency Agent nasazení.
- \[Preview @ no__t-1: audit Log Analytics nasazení agenta – image virtuálního počítače (OS) není v seznamu.
- \[Preview @ no__t-1: audit Log Analytics nasazení agenta v VMSS-VM Image (OS) není v seznamu.
...
- \[Preview @ no__t-1: monitorování možného seznamu povolených aplikací v Azure Security Center
...
- \[Preview @ no__t-1: monitorovat chybějící Endpoint Protection v Azure Security Center
- \[Preview @ no__t-1: monitorovat chybějící aktualizace systému v Azure Security Center
- \[Preview @ no__t-1: monitorování ohrožení zabezpečení operačního systému v Azure Security Center
- \[Preview @ no__t-1: sledujte výsledky posouzení ohrožení zabezpečení SQL Azure Security Center
- \[Preview @ no__t-1: monitorování ohrožení zabezpečení virtuálních počítačů v Azure Security Center
...
- \[Preview @ no__t-1: monitorování opravňujícího přístupu k síti v Azure Security Center
- \[Preview @ no__t-1: monitorování nechráněných koncových bodů sítě v Azure Security Center
- \[Preview @ no__t-1: monitorování nechráněné webové aplikace v Azure Security Center
...
> [ISO 27001 App Service Environment/SQL Database úlohový plán – nasazení](./deploy.md)

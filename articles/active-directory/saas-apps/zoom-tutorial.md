...
4. Do vyhledávacího pole zadejte **zvětšení**, vyberte **zvětšení** z panelu výsledků klikněte **přidat** tlačítko Přidat aplikaci.
    ...
    ![Zvětšení v seznamu výsledků](./media/zoom-tutorial/tutorial_zoom_addfromgallery.png)
...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/zoom-tutorial/tutorial_zoom_samlbase.png)

3. Na **zvětšení domény a adresy URL** část, proveďte následující kroky:

    ![Přiblížení domény a adresy URL jednotné přihlašování informace](./media/zoom-tutorial/tutorial_zoom_url.png)
...
4. Aplikace přiblížení očekává SAML kontrolní výrazy ve specifickém formátu, který vyžaduje, můžete přidat mapování vlastních atributů do vaší konfigurace atributy tokenu SAML. Nakonfigurujte následující deklarace identity pro tuto aplikaci. Můžete spravovat hodnoty těchto atributů z "**uživatelské atributy**" části na stránce integrace aplikace. 
    ...
    ![Konfigurovat jednotné přihlašování](./media/zoom-tutorial/tutorial_attribute.png)
...
5. V **uživatelské atributy** části na **jednotného přihlašování** dialogové okno, nakonfigurujte atribut tokenu SAML, jak je vidět na předchozím obrázku a proveďte následující kroky:
    ...
    ![Konfigurovat jednotné přihlašování](./media/zoom-tutorial/tutorial_attribute_04.png)

    ![Konfigurovat jednotné přihlašování](./media/zoom-tutorial/tutorial_attribute_05.png)
...
7. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/zoom-tutorial/tutorial_general_400.png)
...
12. V části jednotné přihlašování proveďte následující kroky:
    ...
    ![Jednotné přihlašování v části](./media/zoom-tutorial/IC784701.png "jednotného přihlašování")
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/zoom-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **zvětšení**.
    ...
    ![V seznamu aplikací na odkaz přiblížení](./media/zoom-tutorial/tutorial_zoom_app.png)  

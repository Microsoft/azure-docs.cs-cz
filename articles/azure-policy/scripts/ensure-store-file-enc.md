---
title: Ukázka kódu JSON pro Azure Policy – Zajištění šifrování souborů úložiště | Microsoft Docs
description: Tato ukázková zásada JSON vyžaduje, aby bylo pro účty úložiště povolené šifrování souborů.

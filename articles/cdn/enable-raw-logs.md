...
1. V nabídce Azure Portal vyberte **všechny prostředky** >>  **\<> profilu CDN**.
...
Azure CDN ze služby společnosti Microsoft aktuálně poskytuje nezpracované protokoly (v dávce po hodinách). Nezpracované protokoly obsahují jednotlivé požadavky na rozhraní API s každou položkou, která má následující schéma: 

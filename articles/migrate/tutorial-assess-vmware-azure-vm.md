...
V tomto článku se dozvíte, jak vyhodnotit zjištěné virtuální počítače VMware v tématu Příprava na migraci na virtuální počítače Azure pomocí nástroje Azure Migrate: Server Assessment Tool.
...
13. V části * * revize + vytvořit posouzení zkontrolujte podrobnosti posouzení a kliknutím na **vytvořit posouzení** vytvořte skupinu a spusťte posouzení.

...
1. Pro **identifikátor URI ID aplikace**přidejte identifikátor koncového bodu rozhraní API k ZOBRAZENÉmu identifikátoru URI. Pro tento kurz zadejte `api`, aby byl úplný identifikátor URI podobný jako `https://contosob2c.onmicrosoft.com/api`.

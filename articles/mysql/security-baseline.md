...
- [Jak vytvořit a spravovat koncové body služby virtuální sítě a pravidla virtuální sítě v Azure Database for MySQL](../azure-sql/database/vnet-service-endpoint-rule-overview.md)

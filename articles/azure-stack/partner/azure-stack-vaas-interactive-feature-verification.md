...
4.  Po úspěšném dokončení skriptu precheck spustit ruční scénář (Výměna disku), v souladu **dokumentaci** a **ověření** odkazy ze **informace**kartu.

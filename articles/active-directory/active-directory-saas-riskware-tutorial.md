...
4. Do vyhledávacího pole zadejte **Riskware**, vyberte **Riskware** z panelu výsledků klikněte **přidat** tlačítko Přidat aplikaci.
    ...
    ![Riskware v seznamu výsledků](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_addfromgallery.png)
...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_samlbase.png)

3. Na **Riskware domény a adresy URL** část, proveďte následující kroky:

    ![Riskware domény a adresy URL jednotné přihlašování informace](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_url.png)
...
4. Na **SAML podpisový certifikát** klikněte na tlačítko **soubor XML s metadaty** a potom uložte soubor metadat ve vašem počítači.
    ...
    ![Odkaz ke stažení certifikátu](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_certificate.png) 

5. Klikněte na tlačítko **Uložit** tlačítko.

    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/active-directory-saas-riskware-tutorial/tutorial_general_400.png)
...
6. Na **Riskware konfigurace** klikněte na tlačítko **konfigurace Riskware** otevřete **konfigurovat přihlášení** okno. Kopírování **Sign-Out adresu URL a SAML jeden přihlašování služby URL** z **Stručná referenční příručka části.**
    ...
    ![Konfigurace Riskware](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_configure.png) 
...
8. Vpravo nahoře klikněte na tlačítko **údržby** chcete otevřít stránku údržby. 
    ...
    ![Udržovat Riskware konfigurace](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_maintain.png)

9. Na stránce údržby klikněte na tlačítko **ověřování**.

    ![Konfigurace Riskware authen](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_authen.png)

10. V **konfiguraci ověřování** proveďte následující kroky:

    ![Konfigurace Riskware authenconfig](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_config.png)
...
1. Na portálu Azure, v levém podokně klikněte **Azure Active Directory** tlačítko.
    ...
    ![Tlačítko Azure Active Directory](./media/active-directory-saas-riskware-tutorial/create_aaduser_01.png)

2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.

    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/active-directory-saas-riskware-tutorial/create_aaduser_02.png)

3. Chcete-li otevřít **uživatele** dialogové okno, klikněte na tlačítko **přidat** v horní části **všichni uživatelé** dialogové okno.

    ![Tlačítko Přidat](./media/active-directory-saas-riskware-tutorial/create_aaduser_03.png)

4. V **uživatele** dialogové okno pole, proveďte následující kroky:

    ![Dialogové okno uživatele](./media/active-directory-saas-riskware-tutorial/create_aaduser_04.png)
...
2. Vpravo nahoře klikněte na tlačítko **údržby** chcete otevřít stránku údržby. 
    ...
    ![Konfigurace Riskware udržuje](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_maintain.png)

3. Na stránce údržby klikněte na tlačítko **osoby**.

    ![Konfigurace Riskware osoby](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_people.png)

4. Na **podrobnosti** kartu, proveďte následující kroky:
    
    ![Podrobnosti o konfiguraci Riskware](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_details.png)
...
5. Na **zabezpečení** kartu, proveďte následující kroky:    
    ...
    ![Riskware konfigurace zabezpečení](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_security.png)
...
6. Na **organizace** kartu, proveďte následující kroky:
    ...
    ![Konfigurace Riskware org](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_org.png)
...
2. V seznamu aplikací vyberte **Riskware**.
    ...
    ![V seznamu aplikací na Riskware odkaz](./media/active-directory-saas-riskware-tutorial/tutorial_riskware_app.png)  

...
**Zdrojová**        Microsoft-Windows-TerminalServices-RemoteConnectionManager <br />
**Datum:** *čas* <br />
**ID události:**      1058 <br />
...
**Počítač:** *počítač* <br />
**Popis:** Hostitel relace VPmu serveru se nepovedlo nahradit certifikát podepsaný svým podpisem, který se používá pro Hostitel relace VP ověřování serveru v připojeních SSL. K příslušnému kódu stavu byl přístup odepřen.
...
**Uživatel:**          neuvedeno <br />
**Počítač:** *počítač* <br />
**Popis:** Serveru hostitele relace VP se nepodařilo vytvořit nový certifikát podepsaný svým držitelem, který bude použit pro ověřování serveru hostitele relace VP v připojeních SSL, příslušný stavový kód již existuje.
...
**Uživatel:**          neuvedeno <br />
**Počítač:** *počítač* <br />
**Popis:** Serveru Hostitel relace VP se nepodařilo vytvořit nový certifikát podepsaný svým podpisem, který se použije k ověření Hostitel relace VP ověřování serveru v připojeních SSL. Příslušný stavový kód byl sada klíčů neexistuje.
...
**Uživatel:**          SOUBORŮ <br />
**Počítač:** *počítač* <br />
**Popis:** Při pokusu o přístup k privátnímu klíči přihlašovacích údajů serveru SSL došlo k závažné chybě. Kód chyby vrácený kryptografickým modulem je 0x8009030D.  <br />
...
#### <a name="update-secure-sockets-layer-ssl-certificate"></a>Certifikát aktualizace SSL (Secure Sockets Layer) (SSL)

Pokud nastavíte virtuální počítač tak, aby používal certifikát SSL, spusťte následující příkaz, který tento kryptografický otisk získá. Potom zkontrolujte, zda se jedná o stejný kryptografický otisk certifikátu:
...
**Zdrojová**        Microsoft-Windows-TerminalServices-SessionBroker <br />
**Datum:** *čas* <br />
**ID události:**      2056 <br />
...
**Zdrojová**        Microsoft-Windows-TerminalServices-SessionBroker-Client <br />
**Datum:** *čas* <br />
**ID události:**      1296 <br />

...
---
# <a name="remove-an-application-from-a-service-fabric-cluster-using-the-service-fabric-cli"></a>Odebrání aplikace z clusteru Service Fabric pomocí cli service fabric

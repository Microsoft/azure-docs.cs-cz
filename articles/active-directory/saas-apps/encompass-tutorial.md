...
1. Do vyhledávacího pole zadejte **Encompass**vyberte **Encompass** z panelu výsledků klikněte **přidat** tlačítko pro přidání aplikace.
...
1. **[Vytvoření zkušebního uživatele Encompass](#create-a-encompass-test-user)**  – Pokud chcete mít protějšek Britta Simon Encompass, který je propojený s Azure AD reprezentace uživatele.
...
1. Na **zahrnovat domény a adresy URL** části, proveďte následující kroky:
    ...
    > [!NOTE] 
    > Tyto hodnoty nejsou skutečný. Aktualizujte tyto hodnoty se skutečné identifikátorem a adresa URL odpovědi. Kontakt [tým podpory Encompass](https://www.voxmobile.com/contact/) k získání těchto hodnot.
...
1. Na **zahrnovat konfigurace** klikněte na tlačítko **konfigurace zahrnovat** otevřete **nakonfigurovat přihlašování** okna. Kopírovat **odhlašování adresy URL a SAML jednotné přihlašování služby** z **Stručná referenční příručka oddílu.**

    ![Zahrnovat konfigurace](./media/encompass-tutorial/tutorial_encompass_configure.png) 

1. Ke konfiguraci jednotného přihlašování na **Encompass** straně, je nutné odeslat na stažený **Certificate(Base64) a adresa URL odhlašování SAML jednotné přihlašování – adresa URL služby** k [tým podpory Encompass](https://www.voxmobile.com/contact/). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.
...
1. V seznamu aplikací vyberte **Encompass**.

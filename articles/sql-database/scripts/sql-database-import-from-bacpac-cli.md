---
title: Příklad rozhraní příkazového řádku Import souborů BACPAC Azure SQL Database
description: Ukázkový skript Azure CLI pro import souboru BACPAC do databáze SQL
...
ms.locfileid: "80061835"
---
# <a name="use-cli-to-import-a-bacpac-file-into-an-azure-sql-database"></a>Import souboru BACPAC do databáze SQL Azure pomocí rozhraní příkazového řádku

Tento ukázkový skript Azure CLI importuje databázi ze souboru *. BacPac* do databáze SQL Azure.  

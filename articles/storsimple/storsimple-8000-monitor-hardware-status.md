...
| NVRAM |I/O |Fyzické |Kontrolér |Ne |Označuje stav paměti NVRAM, nestálou paměť náhodného přístupu zálohovanou baterií, která slouží k uchování informací důležitých pro aplikaci v případě výpadku napájení. |

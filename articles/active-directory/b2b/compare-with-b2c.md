---
title: Porovnání spolupráce B2B a B2C – Azure Active Directory | Dokumenty společnosti Microsoft
...
Externí uživatelé jsou spravováni ve stejném adresáři jako zaměstnanci, ale speciálně označeni. Mohou být spravovány stejným způsobem jako zaměstnanci, mohou být přidány do stejných skupin a tak dále  | Externí uživatelé jsou spravováni v adresáři aplikace. Jsou spravovány odděleně od adresáře zaměstnanců a partnerů organizace (pokud existuje).
Ve všech aplikacích připojených k Azure AD je podporované jednotné přihlašování. Můžete třeba poskytnout přístup k aplikacím Office 365 nebo k místním a dalším aplikacím SaaS, jako je Salesforce nebo Workday.  |  V rámci tenantů Azure AD B2C je podporované jednotné přihlašování k aplikacím patřícím zákazníkům. Připojovač k Office 365 nebo jiným aplikacím Microsoft SaaS není podporován.
...
Zásady zabezpečení a dodržování předpisů: Spravuje hostitelská/zvoucí organizace (například [zásady podmíněného přístupu).](https://docs.microsoft.com/azure/active-directory/b2b/conditional-access)  | Zásady zabezpečení a dodržování předpisů: Spravuje je aplikace.

...
1. Na stránce **jednotného přihlašování (SSO)** proveďte následující kroky:
    ...
    ![Jednotné přihlašování \(jednotné přihlašování\)](./media/syncplicity-tutorial/ic769550.png "Single Sign-On \\\(SSO\\\)")

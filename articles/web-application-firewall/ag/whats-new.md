...
|---------|---------|---------|
|RuleSet zmírnění hrozeb (Preview)|Můžete povolit RuleSet zmírnění hrozeb, a to i v případě, že jste si RuleSet počítačový počítač. | Listopadu 2019 |
|Integrace GeoDB (Preview)|Nyní můžete vytvořit vlastní pravidla, která omezují provoz podle země původu. | Listopadu 2019 |
|Zásady WAF podle lokality/podle identifikátoru URI (Preview)|WAF-v2 teď podporuje aplikování zásad na naslouchací procesy a také pravidla na základě cest. Viz [Create WAF Policy](create-waf-policy-ag.md). | Listopadu 2019 |

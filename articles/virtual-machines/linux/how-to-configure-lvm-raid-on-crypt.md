...
>[!NOTE] 
>Tento cyklus prochází pouze v jednom zařízení pro tento konkrétní příklad, je tímto způsobem v případě potřeby použit pro více zařízení MD.

...
2. **[Nakonfigurujte jednotné přihlašování Shuccho Navi](#configure-shuccho-navi-single-sign-on)** , abyste na straně aplikace nakonfigurovali nastavení jednoho Sign-On.
...
4. V části **základní konfigurace SAML** proveďte následující kroky:
    ...
    > [!NOTE]
    > Hodnota není reálné číslo. Aktualizujte hodnotu skutečnou adresou Sign-On. Pokud chcete získat hodnotu, kontaktujte [tým podpory Shuccho Navi pro klienta](mailto:sys_ntabtm@nta.co.jp) . Můžete se také podívat na vzory uvedené v části **základní konfigurace SAML** v Azure Portal.
...
### <a name="configure-shuccho-navi-single-sign-on"></a>Konfigurace Shuccho Navi Single Sign-On
...
Když na přístupovém panelu kliknete na dlaždici Shuccho Navi, měli byste být automaticky přihlášeni k Shuccho Navi, pro kterou jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).

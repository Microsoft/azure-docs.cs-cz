...
Teď, když máte Azure Blockchain Workbench nasazen, dalším krokem je [spravovat uživatele v Azure Blockchain Workbench](blockchain-workbench-manage-users.md).
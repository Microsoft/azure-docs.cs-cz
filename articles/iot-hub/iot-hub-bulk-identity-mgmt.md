...
Následující ukázka kódu ukazuje, jak vygenerovat [identifikátor URI SAS](../storage/common/storage-sas-overview.md) s oprávněním ke čtení, zápisu a odstranění pro kontejner objektů BLOB:

...
**Přímé registrace s počátečním datem před 1. května 2018**: přímé zákazníky Azure (EA) se nastavují jako roční fakturační cyklus pro služby Azure (kromě služeb Marketplace). Vaše fakturační období vychází z data výročí. Datum výročí je datum, kdy vaše smlouva vstoupila v platnost. První fakturu za nadlimitní využití služeb Azure obdržíte po překročení prahové hodnoty ve výši 150 % vašeho peněžního závazku.  Jakmile celková spotřeba služeb překročí prahovou hodnotu ve výši 150 % vašeho peněžního závazku, automaticky se převedete na čtvrtletní fakturační období na základě data výročí.  Pokud nepřekročíte prahovou hodnotu ve výši 150 % vašeho peněžního závazku, pro registraci bude dál platit roční fakturační období a fakturu za nadlimitní využití obdržíte na konci ročního období závazku.

**Přímé registrace s počátečním datem od 1. května 2018**: spotřeba a poplatky za Azure, které se fakturují samostatně, se účtují za měsíční fakturační cyklus.  Všechny poplatky, které nepokryje peněžní závazek Azure, budete muset zaplatit jako nadlimitní využití.  

**Nepřímá registrace s registrací, která začala před 1. května 2018**: nepřímé zákazníky se smlouvou Enterprise Azure (EA) se nastavují jako čtvrtletní fakturační cyklus.  Distribuční partner bude fakturovat přímo zákazníkovi.  

**Nepřímý zápis s počátečním datem od 1. května 2018**: jakákoliv nepřímá smlouva s počátečním datem, které je větší nebo rovna 1. května 2018, bude účtována měsíčně.  
...
1. Na tomto řádku se zobrazí kredity, které se vztahují k vašemu zápisu, a také krátká vysvětlení, například: smlouva SLA kredit.
...
Pokud si chcete prohlédnout podrobné údaje o využití konkrétních účtů, stáhněte si sestavu podrobných informací o využití tím, že přejdete na **Sestavy** > **Stáhnout údaje o využití**. Sestava nezahrnuje příslušné daně. Mezi časem skutečného použití a promítnutím tohoto údaje do sestavy může vzniknout zpoždění až osm hodin.
...
| --- | --- | --- | --- |
| Hodin | 24 | 0,0535960591133005 | 12,863,054,187,192,100,000,000 |

Měli byste vidět tohle:

| ServiceResource | ResourceQtyConsumed | ResourceRate | ExtendedCost |
| --- | --- | --- | --- |
| Hodin | 24 | 0,0535960591133005 | 1,2863054187192120000000 |

### <a name="root-cause"></a>Původní příčina

Excel importuje všechna pole jako text obecný a předpokládá, že je číslo oddělené v matematickém standardu: "1 000,00".  Evropská měna, která jako oddělovač tisíců používá tečku (.) a jako oddělovač desetinných míst čárku (,), tzn. 1.000,00, se zobrazí nesprávně. To se může lišit v závislosti na vašem nastavení místního jazyka.
...
- **Založené na používání:** Produkty měřené v transakčních jednotkách.  Například virtuální počítače se účtují po hodinách a vyhledávání přes rozhraní API Bingu se účtuje podle počtu hledání.
...
### <a name="enterprise-msdn-devtest"></a>MSDN pro vývoj/testování pro zákazníky se smlouvou Enterprise
...
Nový způsob měření začne platit mezi 27. a 28. lednem 2016. V souboru. csv ke stažení pro vaše nasazení během tohoto přechodného období si všimnete dvou položek řádků: jeden pro použití vygenerovaný na měřiči a1 a druhý pro využití vysílaný na novém vyhrazeném měřiči, který odpovídá velikosti vašeho nasazení.
...
| Zeměpisná oblast | Oblasti pro přenos dat | Oblasti CDN |
| --- | --- | --- |
...
- **Nevyužití založené na:** Jednorázové nebo opakované měsíční poplatky, které jsou nezávislé na použití.
...
- **Obecné účely**: Rozšířená Power BI pro pro zkušební verzi balíčku obsahu Microsoft Azure Enterprise (nabídka) je k dispozici stávajícím kvalifikovaným uživatelům během období nabídky, aby jim umožnil přístup k určitým přehledům souvisejícím s jejich Microsoft Azure spotřebou prostřednictvím konkrétního Power BI balíčku obsahu.
- **Nárok**: uživatelé v rámci smlouva Enterprise (EA) se mohou zúčastnit nabídky, pokud mají funkci související s Microsoft Azure fakturace, služby, služby a/nebo nákladů organizace.
- **Vyloučení:**
  ...
  - Termín: nabídka začíná 1. června 2017 a končí 31. května 2018.  Nabídku je možné přijmout kdykoli během 12měsíčního období, ale 31. května 2018 se nabídka ukončí pro všechny uživatele bez ohledu na to, kdy ji přijali.
...
**Celkový počet NEzpracovaných jednotek:** Spotřebované množství v rámci podrobné sestavy využití.
**Mocp prostředek na jednotku:** Systém vzájemného využití vysílá využití pro každou službu v různých jednotkách. Nastavit **Spotřeba na jednotku:** Měrná jednotka EA. Nastavit **Cena:** Jednotková cena z portálu Azure EA.
**Celkové náklady:** Rozšířené náklady z podrobné sestavy využití nebo využití závazku + nadlimitního využití z portálu Azure EA.

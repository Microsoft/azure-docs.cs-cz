...
> [!NOTE]
> Chcete-li změnit hlas bez použití SSML, můžete nastavit vlastnost `SpeechConfig` na pomocí `SpeechConfig.speech_synthesis_voice_name = "en-US-AriaNeural"`

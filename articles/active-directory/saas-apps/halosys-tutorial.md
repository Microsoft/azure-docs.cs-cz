...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/halosys-tutorial/tutorial_halosys_samlbase.png)

3. Na **Halosys domény a adresy URL** část, proveďte následující kroky:

    ![Halosys domény a adresy URL jednotné přihlašování informace](./media/halosys-tutorial/tutorial_halosys_url.png)
...
5. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/halosys-tutorial/tutorial_general_400.png)
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/halosys-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **Halosys**.
    ...
    ![V seznamu aplikací na Halosys odkaz](./media/halosys-tutorial/tutorial_halosys_app.png)  

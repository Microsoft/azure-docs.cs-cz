...
Klikněte do **textového** pole a vyberte **Popis** z okna dynamického obsahu, které se zobrazí. Jako jazyk zadejte `en`. (Pokud nevidíte jazyk, klikněte na Zobrazit pokročilé možnosti)

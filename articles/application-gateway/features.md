...
[Azure Application Gateway](overview.md) je nástroj pro vyrovnávání zatížení webových přenosů, který vám umožní spravovat provoz do webových aplikací.
...
- [Kontroler příchozího přenosu dat pro AKS](#ingress-controller-for-aks)
- [Směrování na základě adresy URL](#url-based-routing)
- [Hostování více lokalit](#multiple-site-hosting)
- [Přesměrování](#redirection)
- [Spřažení relace](#session-affinity)
- [Přenosy protokolu WebSocket a HTTP/2](#websocket-and-http2-traffic)
- [Vyprazdňování připojení](#connection-draining)
- [Vlastní chybové stránky](#custom-error-pages)
- [Přepsat hlavičky HTTP](#rewrite-http-headers)
- [Velikosti](#sizing)

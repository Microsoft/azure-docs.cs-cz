...
Azure AD B2C rozšiřuje sadu atributů uložených v každém uživatelském účtu. Tyto atributy můžete také číst a zapisovat pomocí [Graph API služby Azure AD](active-directory-b2c-devquickstarts-graph-dotnet.md).

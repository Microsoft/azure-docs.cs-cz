...
Nakonec zvažte použití [rozhraní API fronty vyprázdnění](https://docs.microsoft.com/azure/iot-hub/iot-c-sdk-ref/iothub-registrymanager-h/iothubregistrymanager-deletedevice) k pravidelnému vyčištění čekajících zpráv před dosažením limitu.
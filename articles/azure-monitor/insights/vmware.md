...
* Přidejte ke svému předplatnému pomocí postupu popsaného v řešení VMware Monitoring [nainstalovat řešení pro monitorování](../insights/solutions.md#install-a-monitoring-solution).

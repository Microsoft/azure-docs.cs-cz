...
K připojení k Azure SQL Database můžete použít různé knihovny a architektury. [Podrobné kurzy](https://aka.ms/sqldev) Začínáme vám pomohou rychle začít s programovacími jazyky, jako je C#, Java, Node. js, php a Python. Pak sestavte aplikaci pomocí SQL Server on Linux nebo Windows nebo Docker v macOS.
...
| Jazyk | Platforma | Další materiály a zdroje informací | Stáhnout | Začínáme |
| :-- | :-- | :-- | :-- | :-- |

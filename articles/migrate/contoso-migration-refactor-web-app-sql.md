...
5. Jakmile jsou změny v kódu, musí se správci tím potvrdíte změny. Pomocí Průzkumníka týmových projektů v sadě Visual Studio, potvrdí a synchronizovat.
...
18. V **vybrat soubor nebo složku**, vyhledejte **SmartHotel.Registration.Wcf.zip** souboru, který se vytváří během sestavení a klikněte na tlačítko **Uložit**.

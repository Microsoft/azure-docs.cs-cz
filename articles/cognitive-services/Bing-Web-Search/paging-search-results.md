...
* [Odkaz na rozhraní API Bingu pro vyhledávání na webu v7](https://docs.microsoft.com/rest/api/cognitiveservices-bingsearch/bing-web-api-v7-referenc)

---
title: Příklady certifikátu podepisování zásad Azure Attestation
description: Příklad obsahu certifikátu zásad ověřování Azure
...
Další informace o [výhodách podepisování zásad](./basic-concepts.md#benefits-of-policy-signing)
...
**Formát certifikátu podepsaného zásadem, který se má použít v toku pro přidání nebo odstranění**

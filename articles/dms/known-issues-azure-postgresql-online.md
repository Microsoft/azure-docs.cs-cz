...
description: Přečtěte si o známých problémech a omezeních migrace pro online migrace z PostgreSQL do Azure Database for PostgreSQ pomocí Azure Database Migration Service.

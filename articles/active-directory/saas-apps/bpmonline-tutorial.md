...
4. Do vyhledávacího pole zadejte **Bpm'online**vyberte **Bpm'online** z panelu výsledků klikněte **přidat** tlačítko pro přidání aplikace.
...
3. **[Vytvoření zkušebního uživatele Bpm'online](#create-a-bpmonline-test-user)**  – Pokud chcete mít protějšek Britta Simon Bpm'online, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **Bpm'online domény a adresy URL** části, proveďte následující kroky, pokud chcete nakonfigurovat aplikace v **IDP** iniciované režimu:
...
7. Ke konfiguraci jednotného přihlašování na **Bpm'online** straně, je nutné odeslat **adresa Url federačních metadat aplikace** k [tým podpory Bpm'online](mailto:support@bpmonline.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

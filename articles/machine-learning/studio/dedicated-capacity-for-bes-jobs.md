...
description: Přehled služby Azure Batch pro Machine Learning Studio úlohy. Zpracování fondu služby batch můžete vytvořit fondy, ve kterých můžete odeslat dávkových úloh Hive.

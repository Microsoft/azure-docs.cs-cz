...
Všimněte si, že ID serveru MariaDB je podobné ```/subscriptions/subscriptionId/resourceGroups/myResourceGroup/providers/Microsoft.DBforMariaDB/servers/servername.``` v dalším kroku použijete ID serveru MariaDB. 
...
2. Zadejte  `nslookup mydemoserver.mariadb.privatelink.database.azure.com`. 

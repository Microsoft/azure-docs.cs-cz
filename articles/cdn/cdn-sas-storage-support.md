...
| Povolené IP adresy | Nepovinný parametr. Pokud používáte **Azure CDN z Verizon**, můžete tento parametr nastavit na rozsahy definované v [Azure CDN z rozsahů IP adres serveru Verizon Edge](/azure/cdn/cdn-pop-list-api). Pokud používáte **Azure CDN z Akamai**, nemůžete nastavit parametr rozsahy IP adres, protože IP adresy nejsou statické.|

...
| Entita | Zásady                                             |
|-------------------|-----------------------------------------------------------|
| Názvy spravovaných disků       | <li> Název musí mít délku 1 až 80 znaků. </li><li> Název musí začínat písmenem nebo číslicí a končit písmenem, číslicí nebo podtržítkem. </li><li> Název může obsahovat jenom písmena, číslice, podtržítka, tečky nebo spojovníky. </li><li>   Název nesmí obsahovat mezery ani `/`.                                              |

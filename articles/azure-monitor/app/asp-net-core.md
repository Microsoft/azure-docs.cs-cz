...
> [!IMPORTANT]
> Podporovány jsou následující verze ASP.NET Core: ASP.NET Core 2,1 a 3,1. Verze 2,0, 2,2 a 3,0 byly vyřazeny a již nejsou podporovány.

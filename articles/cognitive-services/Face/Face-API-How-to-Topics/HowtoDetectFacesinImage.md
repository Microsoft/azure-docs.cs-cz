...
V této příručce jste zjistili, jak používat různé funkce detekce tváře. V dalším kroku Integrujte tyto funkce do aplikace, aby se přidala data ze strany uživatelů.

- [Kurz: Přidání uživatelů do služby obličeje](../enrollment-overview.md)

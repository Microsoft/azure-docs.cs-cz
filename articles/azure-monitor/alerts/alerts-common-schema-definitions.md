...
### <a name="metric-alerts-excluding-availability-tests"></a>Výstrahy metriky (s výjimkou testů dostupnosti)
...
### <a name="metric-alerts-availability-tests"></a>Výstrahy metriky (testy dostupnosti)

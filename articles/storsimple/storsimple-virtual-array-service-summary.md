...
description: Popisuje okno s přehledem služby StorSimple Device Manager a vysvětluje, jak ho používat k monitorování stavu virtuálních polí StorSimple.
services: storsimple
documentationcenter: ''
author: manuaery
manager: syadav
...
---
# <a name="use-the-service-summary-blade-for-storsimple-device-manager-connected-to-storsimple-virtual-array"></a>Pro StorSimple Device Manager připojená k virtuálnímu poli StorSimple použít okno s přehledem služby
## <a name="overview"></a>Přehled
Okno Souhrn služby pro StorSimple Device Manager poskytuje souhrnné zobrazení virtuálních polí StorSimple (označují se také jako StorSimple místní virtuální zařízení nebo virtuální zařízení), která jsou připojená k vaší službě, a zvýrazňují ty, které potřebují pozornost správce systému. V tomto kurzu se seznámíte s oknem s přehledem služby, vysvětlením obsahu a funkce a popisujete úkoly, které můžete z tohoto okna provádět.
...
V okně Souhrn StorSimple se zobrazí možnosti správy služby StorSimple Device Manager a také virtuální pole zaregistrovaná v této službě. Zobrazí se příkazy pro správu v horní části okna a na levé straně.

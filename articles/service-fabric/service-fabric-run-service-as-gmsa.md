...
3. Nakonfigurujte objekt zabezpečení uživatele a nakonfigurujte `RunAsPolicy` ho tak, aby odkazoval na [uživatele](https://docs.microsoft.com/azure/service-fabric/service-fabric-cluster-fabric-settings#runas).

...
4. Store artefakt v [úložiště Git](devtest-lab-add-artifact-repo.md).
...
5. Přidání úložiště artefaktů do testovacího prostředí. Zobrazit [přidání úložiště Git pro artefakty a šablony](devtest-lab-add-artifact-repo.md).

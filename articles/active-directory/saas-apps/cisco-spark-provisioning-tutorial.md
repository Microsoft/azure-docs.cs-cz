...
1. Přihlaste se k [webu Azure portal](https://portal.azure.com) a vyberte **podnikové aplikace**vyberte **všechny aplikace**a pak vyberte **Cisco Spark**.
...
5. V části **přihlašovacích údajů správce** části, zadejte **adresy URL Tenanta**, a **tajný klíč tokenu** Cisco Spark účtu.
    ...
    ![Spark Cisco zřizování](./media/cisco-spark-provisioning-tutorial/secrettoken1.png)
...
6. **ID Tenanta** a **tajný klíč tokenu** pro Cisco Spark účtu najdete po přihlášení na [webu pro vývojáře Cisco Spark](https://developer.webex.com/) pomocí účtu správce. Po přihlášení -
...
7. Po vyplnění polí zobrazených v kroku 5, klikněte na tlačítko **Test připojení** aby Azure AD můžete připojit k Cisco Spark. Pokud se nepovede, ujistěte se, že váš účet Cisco Spark má oprávnění správce a zkuste to znovu.

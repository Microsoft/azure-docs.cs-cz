---
title: 'Kurz: Azure Active Directory integraci jednotného přihlašování s Pluralsight | Microsoft Docs'
...
ms.locfileid: "101651378"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-pluralsight"></a>Kurz: Azure Active Directory integraci jednotného přihlašování (SSO) s Pluralsight
...
## <a name="add-pluralsight-from-the-gallery"></a>Přidání Pluralsight z Galerie
...
## <a name="configure-and-test-azure-ad-sso-for-pluralsight"></a>Konfigurace a testování jednotného přihlašování Azure AD pro Pluralsight
...
K nakonfigurování a testování jednotného přihlašování Azure AD pomocí Pluralsight postupujte takto:
...
1. V Azure Portal na stránce integrace aplikací **Pluralsight** Najděte oddíl **Spravovat** a vyberte **jednotné přihlašování**.
...
1. V části **základní konfigurace SAML** zadejte hodnoty pro následující pole:
    ...
    b. Do pole **identifikátor** zadejte adresu URL: `www.pluralsight.com`
...
* Kliknutím na **test této aplikace** v Azure Portal. Tím se přesměruje na adresu URL pro přihlášení k Pluralsight, kde můžete spustit tok přihlášení. 

* Přejít na adresu URL pro přihlášení k Pluralsight přímo a zahájit tok přihlášení.

* Můžete použít aplikaci Microsoft moje aplikace. Když kliknete na dlaždici Pluralsight v okně moje aplikace, měli byste se automaticky přihlásit k Pluralsight, pro které jste nastavili jednotné přihlašování. Další informace o mých aplikacích najdete v tématu [Úvod do mých aplikací](../user-help/my-apps-portal-end-user-access.md).

## <a name="next-steps"></a>Další kroky

Po nakonfigurování Pluralsight můžete vynutili řízení relace, které chrání exfiltrace a infiltraci citlivých dat vaší organizace v reálném čase. Řízení relace se rozšiřuje z podmíněného přístupu. [Přečtěte si, jak vynutili řízení relace pomocí Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-any-app).
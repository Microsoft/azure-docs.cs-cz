...
* Aplikace Wingtip SaaS je nasazená. K nasazení během méně než pěti minut si přečtěte téma [nasazení a prozkoumání aplikace Wingtip SaaS](../../sql-database/saas-dbpertenant-get-started-deploy.md).

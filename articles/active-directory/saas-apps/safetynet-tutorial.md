...
2. **[Nakonfigurujte safetynet SSO](#configure-safetynet-sso)** – pro konfiguraci nastavení jednotného přihlašování na straně aplikace.
...
Když na přístupovém panelu kliknete na dlaždici SafetyNet, měli byste se automaticky přihlásit k SafetyNet, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

...
description: Diskuzi o různých typech HADR strategií pro SQL Server běžící na virtuálních počítačích Azure.
...
Na následujícím obrázku instalační program používá SQL Server běžící na virtuálním počítači Azure, který využívá 12 jader jako repliku zotavení po havárii pro místní SQL Server nasazení pomocí 12 jader. V minulosti byste potřebovali licenci 12 jader SQL Server pro místní prostředí a nasazení Azure Virtual Machines. Nové zvýhodnění nabízí výhody pasivních replik, které běží na virtuálním počítači Azure. Nyní byste potřebovali jenom licenci 12 jader SQL Server běžet místně, pokud je splněná kritéria zotavení po havárii pro pasivní repliku v Azure Virtual Machines.

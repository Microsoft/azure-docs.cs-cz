---
title: Vyřazené verze Azure HDInsight
description: Přečtěte si o vyřazených verzích ve službě Azure HDInsight.
...
ms.locfileid: "103490241"
---
# <a name="retired-hdinsight-versions"></a>Vyřazené verze HDInsight

V tomto článku se dozvíte o vyřazených verzích v HDInsight.

## <a name="retired-version-list"></a>Seznam vyřazených verzí

V následující tabulce jsou uvedeny vyřazené verze HDInsight.
...
| HDInsight 1,6 |HDP 1,1 | |28. října 2013 |26. dubna 2014 |31. května 2015 |Ne |No |

## <a name="next-steps"></a>Další kroky

- [Podporované součásti a verze Apache v HDInsight](./hdinsight-component-versioning.md)

...
> [!IMPORTANT]
> V hustých fondech s mnoha aktivními databázemi nemusí být možné zvyšovat počet databází ve fondu až do maximálních hodnot dokumentovaných pro [DTU](sql-database-dtu-resource-limits-elastic-pools.md) a elastické fondy [Vcore](sql-database-vcore-resource-limits-elastic-pools.md) .
> 

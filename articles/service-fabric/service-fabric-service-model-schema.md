---
title: Azure Service Fabric service model XML schématu popisy | Dokumentace Microsoftu
description: Popisuje schématu XML z modelu služby Service Fabric.
...
ms.locfileid: "53258031"
---
<!-- The schema reference articles were generated by the Python script found in the end of this file -->

# <a name="service-model-xml-schema-documentation"></a>Dokumentace ke službě modelu XML schéma
Tento článek popisuje souboru schématu ServiceFabricServiceModel.xsd nainstalovaný v Service Fabric SDK.  Ve výchozím nastavení, soubor schématu je nainstalován na *C:\Program Files\Microsoft SDKs\Service Fabric\schemas\ServiceFabricServiceModel.xsd*.

## <a name="namespace-bindings"></a>Namespace vazby
|Předvolba|Identifikátor URI Namespace|
|---|---|
|xs|http://www.w3.org/2001/XMLSchema|

## <a name="component-summary"></a>Souhrn komponenty 
Následující komponenty jsou definovány v ServiceFabricServiceModel.xsd:
- [257 elementy](service-fabric-service-model-schema-elements.md)
- [112 komplexních typů](service-fabric-service-model-schema-complex-types.md)
- [1 simpleTypes](service-fabric-service-model-schema-simple-types.md)
- [3 skupiny – element](service-fabric-service-model-schema-element-groups.md)
- [16 skupiny atributů](service-fabric-service-model-schema-attribute-groups.md)

...
1. Přejděte **protokolu aktivit** části pomocí **všechny služby** hledání na levé straně na portálu.
   ...
   ![Výběr protokolu aktivit ze seznamu služeb na portálu](./media/activity-logs-stream-event-hubs/activity-logs-portal-navigate-v2.png)
2. Vyberte **exportovat do centra událostí** tlačítko v horní části v protokolu.
   
   ![Tlačítko pro export na portálu](./media/activity-logs-stream-event-hubs/activity-logs-portal-export-v2.png)
...
3. V části, která se zobrazí, vyberte **všech oblastech**. Nesmí být zvolen konkrétní oblasti.
   ...
   ![Export části](./media/activity-logs-stream-event-hubs/export-audit.png)
...
Schéma pro protokol aktivit je k dispozici v [monitorovat aktivitu předplatného se protokol aktivit Azure](../../azure-monitor/platform/activity-logs-overview.md). Každá událost je v poli objektů BLOB JSON s názvem *záznamy*.

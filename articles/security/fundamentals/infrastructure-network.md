...
[Azure DDoS Protection Standard](../../virtual-network/ddos-protection-overview.md) poskytuje ochranu před útoky DDoS. Viz [Azure DDoS Protection: Osvědčené postupy a referenční architektury](ddos-best-practices.md) pro další informace.

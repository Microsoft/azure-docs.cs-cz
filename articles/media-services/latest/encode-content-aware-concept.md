...
![Frekvence – deformace (RD) – křivka pomocí PSNR](media/encode-content-aware-concept/msrv1.png)

**Obrázek 1: křivka deformace (RD) pomocí metriky PSNR pro zdroj s vysokou složitostí**

![Frekvence – deformace (RD) – křivka pomocí VMAF](media/encode-content-aware-concept/msrv2.png)
...
![Křivka VP pomocí PSNR](media/encode-content-aware-concept/msrv3.png)

**Obrázek 3: křivka RD pomocí PSNR pro vstup s nízkou kvalitou (v 1080p)**

![Křivka VP pomocí VMAF](media/encode-content-aware-concept/msrv4.png)

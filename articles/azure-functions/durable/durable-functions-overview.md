...
ms.locfileid: "53718584"
---
# <a name="durable-functions-overview"></a>Trvalý přehled funkcí

*Odolná služba Functions* je rozšířením [Azure Functions](../functions-overview.md) a [Azure WebJobs](../../app-service/webjobs-create.md) , který umožňuje zapisovat stavové funkce v prostředí bez serveru. Rozšíření spravuje stav, kontrolní body a restartuje za vás.
...
## <a name="pattern-1-function-chaining"></a>Vzor #1: Řetězení funkcí
...
## <a name="pattern-3-async-http-apis"></a>Vzor #3: Asynchronní rozhraní API HTTP
...
## <a name="pattern-4-monitoring"></a>Vzor #4: Monitorování
...
Aktuálně C# (funkce 1.x a 2.x), F# a jazyka JavaScript (funguje pouze 2.x Durable Functions 1.7.0 nebo vyšší) jsou pouze podporované jazyky pro Durable Functions. To zahrnuje aktivitu funkcí a funkcí nástroje orchestrator. V budoucích verzích přidáme podporu pro všechny jazyky, které podporuje Azure Functions. Azure Functions najdete v článku [seznamu problémů na Githubu úložiště](https://github.com/Azure/azure-functions-durable-extension/issues) chcete zobrazit nejnovější stav naše další jazyk, podporu pracovní.

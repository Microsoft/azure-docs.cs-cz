...
| Pole data | Datum a čas | Některá pole vyžadují datum ve formátu mm/dd/rrrr nebo dynamický obsah, který má typ data. <p><p>*Příklad polí*: **Vytvořeno**, **Datum zahájení**, **skutečný začátek**, **skutečný konec**a **Datum splatnosti** | 
...
2. Na panelu nástrojů Akce vyberte jeden z následujících kroků:
   ...
   * Vyberte **odkaz Odeslat e-mailem** , abyste mohli zkopírovat úplnou adresu URL do výchozího e-mailového programu.
   ...
   ID záznamu se zobrazí v adrese URL mezi znaky kódování `%7b` a `%7d`:

...
Můžete programově zobrazit data shromážděná prostřednictvím rozhraní API katalogu Galerie AI, které je přístupné na https://catalog.cortanaanalytics.com/entities. Chcete-li zobrazit data, budete potřebovat své ID autora. Pokud chcete zobrazit neuvedené entity prostřednictvím rozhraní API katalogu, budete potřebovat přístupový token.

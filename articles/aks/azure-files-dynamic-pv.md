...
ms.locfileid: "107776118"
---
# <a name="dynamically-create-and-use-a-persistent-volume-with-azure-files-in-azure-kubernetes-service-aks"></a>Dynamické vytvoření a používání trvalého svazku se službou Azure Files ve službě Azure Kubernetes Service (AKS)

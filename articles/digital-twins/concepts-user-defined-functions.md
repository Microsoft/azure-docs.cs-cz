...
- Má `01` na svém portu
- Které patří do zařízení s rozšířeným **výrobcem** klíče vlastnosti nastaveným na hodnotu řetězce s řídicími znaky`\"Contoso\"`
...
[Úložiště GitHub pro ukázku digitálních vláken v jazyce C#](https://github.com/Azure-Samples/digital-twins-samples-csharp/) obsahuje několik příkladů uživatelsky definovaných funkcí:

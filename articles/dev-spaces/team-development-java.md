...
Přejít do okna VS Code pro `mywebapi` a provést úpravy kódu v `String index()` metodě v `src/main/java/com/ms/sample/mywebapi/Application.java`, například:

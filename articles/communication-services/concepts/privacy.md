...
Vlákna a zprávy chatu se uchovávají, dokud je explicitně neodstraníte. Plně nečinné vlákno bez účastníků se po 30 dnech automaticky odstraní. K získání, vypsání, aktualizaci a odstranění zpráv použijte [rozhraní API chatu](/rest/api/communication/chat/chatthread) .

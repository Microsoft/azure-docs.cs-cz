---
title: Monitorování nasazení clusteru služby Azure Kubernetes Service (AKS) | Dokumentace Microsoftu
description: Zjistěte, jak chcete povolit monitorování clusteru služby Azure Kubernetes Service (AKS) pomocí Azure monitoru pro kontejnery již nasazených ve vašem předplatném.
...
ms.locfileid: "65074677"
---
# <a name="enable-monitoring-of-azure-kubernetes-service-aks-cluster-already-deployed"></a>Povolit monitorování už nasadili cluster Azure Kubernetes Service (AKS)

Tento článek popisuje, jak nastavit službu Azure Monitor monitorovat hostitelem spravovaného clusteru Kubernetes pro kontejnery [Azure Kubernetes Service](https://docs.microsoft.com/azure/aks/) , která jsou už nasazené ve vašem předplatném.

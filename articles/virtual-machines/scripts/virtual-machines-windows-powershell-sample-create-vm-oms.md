---
title: Azure PowerShell Windows Script Sample – protokoly Azure Monitor
...
| [Set-AzVMExtension](/powershell/module/az.compute/set-azvmextension) | Přidá do virtuálního počítače rozšíření virtuálního počítače. |

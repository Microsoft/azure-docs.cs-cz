---
title: Jak zobrazit závislosti aplikací pomocí Azure Monitor pro virtuální počítače (Preview) | Microsoft Docs
...
2. V seznamu vyberte virtuální počítač. V části **monitorování** vyberte **přehledy (Preview)** .  
...
2. V seznamu vyberte virtuální počítač. Pak v části **monitorování** zvolte **přehledy (Preview)** .  
3. Vyberte kartu **Mapa** .

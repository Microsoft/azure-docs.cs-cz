...
1. Do adresáře HelloWorld v projektu HelloWorld umístěte nový hlavičkový soubor s názvem `MicrosoftCognitiveServicesSpeech-Bridging-Header.h`. Vložte do něj následující kód:
...
1. Obsah souboru automaticky generovaného `AppDelegate.swift` nahraďte následujícím kódem:
...
1. Obsah souboru automaticky generovaného `ViewController.swift` nahraďte následujícím kódem:

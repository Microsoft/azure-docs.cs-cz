...
2. **[Nakonfigurovat jednotné přihlašování pro centrální plochu](#configure-central-desktop-single-sign-on)** – ke konfiguraci nastavení jednotného přihlašování na straně aplikace
...
### <a name="configure-central-desktop-single-sign-on"></a>Konfigurace jednotného přihlašování v centrálním počítači
...
2. Vyberte **lidé** a pak vyberte **Přidat interní členy**.
    ...
    ![Lidé](./media/central-desktop-tutorial/ic781051.png "Lidé")
...
Když kliknete na dlaždici centrální plocha na přístupovém panelu, měli byste být automaticky přihlášeni k centrální ploše, pro kterou jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

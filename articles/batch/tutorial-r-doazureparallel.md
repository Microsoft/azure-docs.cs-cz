---
title: Kurz – spuštění paralelní simulace R s Azure Batch
...
Soubor uložte. Potom spusťte následující příkaz, který nastaví tyto přihlašovací údaje do vaší aktuální relace jazyka R:
...
* Položku `taskSlotsPerNode` navyšte na hodnotu *2*, abyste mohli v každém uzlu využívat obě jádra.
...
Výstup udává počet „pracovních procesů provádění“ pro balíček doAzureParallel. Toto číslo odpovídá počtu uzlů vynásobenému hodnotou `taskSlotsPerNode`. Pokud jste změnili konfiguraci clusteru podle výše uvedeného návodu, jedná se o číslo *10*.
...
Simulace distribuuje úkoly do uzlů ve fondu služby Batch. Aktivitu můžete zobrazit v Heat mapě pro fond ve Azure Portal. Přejít na **účty Batch**  >  *myBatchAccount*. Klikněte na **fondy**  >  *myPoolName*.

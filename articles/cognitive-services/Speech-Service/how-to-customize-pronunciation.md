...
Mluvené slovo formuláře musí obsahovat malá písmena, která můžete vynutit během importu. Kromě toho je nutné zadat programu pro import dat se změnami. Smí obsahovat žádné karty mluvené slovo formulář nebo formulář pro zobrazení. Ale existuje může být více je zakázané znaky ve formuláři zobrazení (například ~ a ^).

...
V tomto rychlém startu použijete k připojení k databázi kód [.NET Core](https://dotnet.microsoft.com) a C#. Pak spustíte příkaz Transact-SQL k dotazování dat.
...
- [.NET Core SDK pro nainstalovaný operační systém](https://dotnet.microsoft.com/download) .

---
title: Nahrání generalizovaného virtuálního pevného disku do ukázky skriptu Azure PowerShell
...
| [Přidat-AzVhd](https://docs.microsoft.com/powershell/module/az.compute/add-azvhd)                                               | Nahraje virtuální pevný disk z místního virtuálního počítače do objektu blob na cloudovém účtu úložiště v Azure.                                                                       |
| [Nový-AzImageConfig](https://docs.microsoft.com/powershell/module/az.compute/new-azimageconfig)                               | Vytvoří konfigurovatelný objekt image.                                                                                                                                                 |
...
| [Nový-AzImage](https://docs.microsoft.com/powershell/module/az.compute/new-azimage)                                           | Vytvoří novou image.                                                                                                                                                                 |
...
| [Virtuální síť Get-Az](https://docs.microsoft.com/powershell/module/az.network/get-azvirtualnetwork)                         | Získá ve skupině prostředků virtuální síť.                                                                                                                                          |
...
| [Set-AzVMOperačníSystém](https://docs.microsoft.com/powershell/module/az.compute/set-azvmoperatingsystem)                   | Nastaví vlastnosti disku s operačním systémem na virtuálním počítači.                                                                                                                      |

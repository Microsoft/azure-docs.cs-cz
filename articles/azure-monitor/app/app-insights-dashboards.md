...
Můžete také [připnout Analytics](../../azure-monitor/log-query/get-started-portal.md) grafy na sdílený řídicí panel. To umožňuje přidávat diagramy z jakéhokoli libovolného dotazu vedle standardních metrik. 

...
## <a name="milestone-1-establish-initial-network-topology-and-design"></a>Milník 1: Vytvoření počáteční síťové topologie a návrh
...
## <a name="milestone-2-deploy-the-pilot-lab"></a>Milník 2: Zkušební prostředí nasadit
...
## <a name="milestone-3-documentation-support-learn-and-improve"></a>Milník 3: Dokumentaci, podporu, učení a zdokonalování
...
Přečtěte si další článek v této sérii: [infrastruktury zásad správného řízení Azure DevTest Labs](devtest-lab-guidance-governance-resources.md)

---
title: PHP rychlý úvodní kurz pro Azure kognitivní služby vyhledávání zprávy Bing rozhraní API | Microsoft Docs
...
ms.locfileid: "35343519"
---
# <a name="quickstart-for-bing-news-search-api-with-php"></a>Rychlý start pro vyhledávání zprávy Bing rozhraní API s PHP

Tento článek ukazuje, jak pomocí rozhraní API týkající se hledání zprávy Bing, součástí kognitivní služby společnosti Microsoft na platformě Azure. Při tomto článku aktivuje PHP, rozhraní API je kompatibilní s žádný programovací jazyk, který můžete nastavit požadavků HTTP a analyzovat JSON RESTful webová služba. 

Příklad kódu byla zapsána do pracovní pod PHP 5.6.
...
[Rozhraní API služby Bing zprávy Search](https://docs.microsoft.com/rest/api/cognitiveservices/bing-web-api-v7-reference) vrátí výsledky zprávy z Bing vyhledávací web.

1. Zajistěte, aby je povolené zabezpečené podpora protokolu HTTP v vaší `php.ini` jak je popsáno v komentář kódu.

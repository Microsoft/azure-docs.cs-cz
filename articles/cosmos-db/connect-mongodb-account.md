...
Zjistěte, jak připojit vaši aplikaci MongoDB ke službě Azure Cosmos DB pomocí připojovacího řetězce MongoDB. Potom můžete databázi Azure Cosmos jako data store pro vaši aplikaci MongoDB. 

---
title: Přiřazení role Azure AD v PIM – Azure Active Directory | Dokumentace Microsoftu
description: Zjistěte, jak přiřadit role Azure AD v Azure AD Privileged Identity Management (PIM).

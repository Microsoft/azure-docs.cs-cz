...
Podrobnosti o výstrahách podporovaných scénářích najdete v části [scénáře podporované pro detekci útoku s více fázemi](#scenarios-supported-for-advanced-multistage-attack-detection) na této stránce.
...
5. V okně **Průvodce vytvořením pravidla** se automaticky vybere Změna stavu, takže vyberte **další: Zkontrolujte**a pak ho **uložte**. 

Šablony pravidel nelze použít pro pokročilou detekci útoku na více fází.

## <a name="scenarios-supported-for-advanced-multistage-attack-detection"></a>Podporované scénáře pro pokročilou detekci útoků ve více fázích
...
Nyní jste se seznámili s pokročilým zjišťováním útoků s více fázemi, možná vás zajímá následující rychlý Start, kde se dozvíte, jak získat přehled o vašich datech a potenciálních hrozbách: [Začínáme s Sentinel Azure](quickstart-get-visibility.md)

Pokud jste připraveni prozkoumat vytvářené incidenty, přečtěte si následující kurz: [Prozkoumejte incidenty pomocí služby Azure Sentinel](tutorial-investigate-cases.md).

...
Je také praktický způsob, jak používat [nástroje SSIS DevOps](https://docs.microsoft.com/sql/integration-services/devops/ssis-devops-overview), aby bylo možné provést opětovné nasazení balíčku Batch do cíle migrace.  
...
- [Nazvednutí a posunutí úloh SSIS do cloudu](https://docs.microsoft.com/sql/integration-services/lift-shift/ssis-azure-lift-shift-ssis-packages-overview)
...
- [Použít spravované ověřování identity](https://docs.microsoft.com/sql/integration-services/connection-manager/azure-storage-connection-manager#managed-identities-for-azure-resources-authentication)

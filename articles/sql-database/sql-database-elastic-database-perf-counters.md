...
Čítače výkonu se používají ke sledování výkonu operací [Směrování závislých na datech](sql-database-elastic-scale-data-dependent-routing.md) . Tyto čítače jsou dostupné v monitorování výkonu v kategorii "Elastic Database: horizontálních oddílů Management".

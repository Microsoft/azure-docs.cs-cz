...
Pokud chcete nakonfigurovat jednotné přihlašování na **hostované straně jednotného** přihlašování MyCirqa, musíte odeslat **adresu URL federačních metadat aplikace** do [hostovaného týmu podpory pro jednotné přihlašování MyCirqa](mailto:support@isoxford.com). Toto nastavení nastaví, aby bylo správně nastaveno připojení SAML SSO na obou stranách.

## <a name="create-hosted-mycirqa-sso-test-user"></a>Vytvořit hostovaného testovacího uživatele MyCirqa SSO

V této části vytvoříte uživatele s názvem Britta Simon v hostovaném MyCirqa SSO. Pracujte s [hostovaným týmem podpory MYCIRQA SSO](mailto:support@isoxford.com) a přidejte uživatele na hostované platformě jednotného přihlašování MyCirqa. Před použitím jednotného přihlašování je nutné vytvořit a aktivovat uživatele.

## <a name="test-sso"></a>Test SSO

V této části otestujete konfiguraci jednotného přihlašování Azure AD pomocí přístupového panelu.

Po kliknutí na dlaždici hostované MyCirqa SSO na přístupovém panelu byste se měli automaticky přihlášeni k hostovanému MyCirqa jednotného přihlašování, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).

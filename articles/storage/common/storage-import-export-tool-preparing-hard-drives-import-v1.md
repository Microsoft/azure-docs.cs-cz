...
|Parametr příkazového řádku|Popis|
|----------------------------|-----------------|
|**/srcfile:** <SourceFile\>|`Required.` Úplná cesta k souboru, který má být zkopírován. Cesta k adresáři musí být absolutní cesta (nikoli relativní cestu).|

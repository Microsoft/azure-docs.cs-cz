...
2. **[Nakonfigurujte COGNIDOX SSO](#configure-cognidox-sso)** – ke konfiguraci nastavení jednoho Sign-On na straně aplikace.
...
6. Kromě výše očekává aplikace Cognidox několik dalších atributů, které se vrátí zpátky v odpovědi SAML. V části deklarace identity uživatelů v dialogovém okně atributy uživatele proveďte následující kroky pro přidání atributu tokenu SAML, jak je znázorněno v následující tabulce: 
    ...
    | Name | Obor názvů  |  Transformace | Parametr 1 |
    | ---------------| --------------- | --------- |
...
Když na přístupovém panelu kliknete na dlaždici Cognidox, měli byste se automaticky přihlásit k Cognidox, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).

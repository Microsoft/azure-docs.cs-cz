...
> [!WARNING]
> Verze 2,4 až 2,13 používají WMF 5,0 Public Preview jejichž podpisové certifikáty vyprší v srpnu.
> 2016. Další informace o tomto problému najdete v [příspěvku na blogu](https://devblogs.microsoft.com/powershell/azure-dsc-extension-versions-2-4-up-to-2-13-will-retire-in-august/).
...
- **Poznámky:** Tato verze používá DSC jako součást Windows serveru 2016; pro ostatní systémy Windows operačních systémech nainstaluje rozhraní [Windows Management Framework 5,1](https://devblogs.microsoft.com/powershell/wmf-5-1-releasing-january-2017/) (instalace WMF vyžaduje restart). Pro nano Server je na virtuálním počítači nainstalovaná role DSC.
- **Nové funkce:**
  - Po nedávném přesunutí GitHubu do TLS 1,2 nemůžete připojit virtuální počítač k Azure Automation DSC pomocí šablon Správce prostředků SVÉPOMOCNÁ, které jsou k dispozici v Azure Marketplace, nebo použít rozšíření DSC k získání jakékoli konfigurace hostované na GitHubu. Při nasazení rozšíření se zobrazí chybová zpráva podobná následující:
  ...
  - V nové verzi rozšíření se teď vynutilo TLS 1,2. Při nasazení rozšíření, pokud už máte AutoUpgradeMinorVersion = true v šabloně Správce prostředků, pak se rozšíření získá autoupgradem na 2,75. V případě ruční aktualizace zadejte `TypeHandlerVersion = 2.75` v šabloně správce prostředků.
...
- **Poznámky:** Tato verze používá DSC jako součást Windows serveru 2016; pro ostatní systémy Windows operačních systémech nainstaluje rozhraní [Windows Management Framework 5,1](https://devblogs.microsoft.com/powershell/wmf-5-1-releasing-january-2017/) (instalace WMF vyžaduje restart). Pro nano Server je na virtuálním počítači nainstalovaná role DSC.
- **Nové funkce:**
  - Bylo přidáno množství oprav chyb a dalších vylepšení.
...
- **Nové funkce:**
  ...
  - Oprava pro obdobu přerušovaného problému, kdy rozšíření zastaví zpracování konfigurace po restartování.
    To způsobilo, že rozšíření DSC zůstane ve stavu "přechodu".
  - Byly přidány drobné další opravy a vylepšení.
...
- **Nové funkce:**
  ...
  - Nová vlastnost v nastavení rozšíření DSC Do AdvancedOptions se přidá "ForcePullAndApply", aby bylo možné povolit rozšíření DSC v případě, že je režim aktualizace vyžádané (na rozdíl od výchozího režimu push). Další informace najdete na [tomto blogu](https://devblogs.microsoft.com/powershell/arm-dsc-extension-settings/) , kde najdete další informace o nastavení rozšíření DSC.
...
- **Nové funkce:**
  ...
  - V případě, že jste již nainstalovali verzi 2,14 a jsou spuštěny v některém z výše uvedených dvou problémů, bude nutné provést tyto kroky ručně. V relaci PowerShellu se zvýšenými oprávněními:
...
- **Nové funkce:**
  - Používá WMF RTM.
  - Povoluje shromažďování dat za účelem zlepšení kvality rozšíření DSC. Další informace najdete [na blogu](https://devblogs.microsoft.com/powershell/azure-dsc-extension-data-collection-2/).
  - Poskytuje aktualizovaný formát nastavení pro rozšíření v šabloně Správce prostředků. Další informace najdete [na blogu](https://devblogs.microsoft.com/powershell/arm-dsc-extension-settings/).

...
Teď, když jste se naučili, jak spravovat uživatele a role v IoT Central Azure, je doporučeným dalším krokem informace o [zobrazení vašeho vyúčtování](howto-view-bill.md) ve službě Azure IoT Central.

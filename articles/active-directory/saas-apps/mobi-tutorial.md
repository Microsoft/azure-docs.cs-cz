...
3. **[Vytvoření zkušebního uživatele MOBI](#create-a-mobi-test-user)**  – Pokud chcete mít protějšek Britta Simon v MOBI, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **MOBI domény a adresy URL** části, proveďte následující kroky, pokud chcete nakonfigurovat aplikace v režimu iniciované zprostředkovatele identity:
...
7. Ke konfiguraci jednotného přihlašování na **MOBI** straně, je nutné odeslat na stažený **soubor XML s metadaty** k [tým podpory MOBI](mailto:sso@mobiwm.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

...
V tomto článku najdete ukázky použití [šablon Azure Resource Manager](../../azure-resource-manager/templates/template-syntax.md) ke konfiguraci [pravidel upozornění metrik](../platform/alerts-metric-near-real-time.md) v Azure monitor. Každá ukázka obsahuje soubor šablony a soubor parametrů s ukázkovými hodnotami, které se mají poskytnout šabloně.

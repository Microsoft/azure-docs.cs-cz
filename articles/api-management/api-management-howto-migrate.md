...
## <a name="option-1-use-a-different-api-management-instance-name"></a>Možnost 1: Použít jiný název instance API Management
...
## <a name="option-2-use-the-same-api-management-instance-name"></a>Možnost 2: Použít stejný název instance API Management

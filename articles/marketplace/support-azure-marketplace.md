...
ms.locfileid: "94488753"
---
# <a name="support-for-the-microsoft-commercial-marketplace"></a>Podpora komerčního tržiště Microsoftu
...
|:--- |:--- |  
| Fóra MSDN: web Marketplace umístěný na [stránce s otázkou Microsoft Q&](/answers/products/azure) | Fórum Microsoft Developer Network. |  
...
* Přečtěte si další informace o [podpoře programu komerčního tržiště v partnerském centru](support.md).

...
Uložte model do Azure SQL Edge nebo spravované instance Azure SQL v `models` tabulce v databázi `onnx` . V připojovacím řetězci zadejte _ * adresa serveru * *, **uživatelské jméno** a **heslo**.

...
Další informace o tajných klíčích najdete v tématu [o tajných](about-secrets.md)klíčích.
...
Můžete také vytvořit Key Vault pomocí Azure CLI a PowerShellu:
- [Vytvoření Key Vault pomocí prostředí PowerShell](../general/quick-create-powershell.md)

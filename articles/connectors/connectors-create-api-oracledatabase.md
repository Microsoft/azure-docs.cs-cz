---
title: Připojení k databázi Oracle - Azure Logic Apps | Microsoft Docs
description: Vložení a spravovat záznamy s Oracle Database REST API a Azure Logic Apps
author: ecfan
manager: jeconnoc
ms.author: estfan
ms.date: 03/29/2017

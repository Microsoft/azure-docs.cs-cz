...
* Použití [prohledávání protokolů v Log Analytics](../../log-analytics/log-analytics-queries.md) zobrazíte podrobné údaje služby Azure Key Vault.

...
5. V části **přihlašovací údaje správce** zadejte `https://api.fuze.com/scim/v2` na **adrese URL tenanta**. Zadejte hodnotu **SCIM tokenu ověřování** získanou dříve od zástupce Fuze v **tajném tokenu**. Klikněte na **Test připojení** a ujistěte se, že se služba Azure AD může připojit k Fuze. Pokud se připojení nepovede, ujistěte se, že má váš účet Fuze oprávnění správce, a zkuste to znovu.

...
* Můžete povolit uživatelům být automaticky přihlášeni k Silverback (Single Sign-On) s jejich účty Azure AD.
...
* Podporuje silverback **SP** jednotné přihlašování zahájené pomocí
...
V této části je konfigurace a testování Azure AD jednotné přihlašování pomocí Silverback podle testovacího uživatele volá **Britta Simon**.
Pro jednotné přihlašování pro práci je potřeba navázat vztah odkazu mezi uživatele služby Azure AD a související uživatelské v Silverback.
...
2. **[Konfigurace Silverback Single Sign-On](#configure-silverback-single-sign-on)**  – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
3. **[Vytvořit testovacího uživatele Azure AD](#create-an-azure-ad-test-user)**  – Pokud chcete otestovat Azure AD jednotné přihlašování s Britta Simon.
4. **[Přiřadit uživatele Azure AD](#assign-the-azure-ad-test-user)**  – Pokud chcete povolit Britta Simon používat Azure AD jednotného přihlašování.
5. **[Vytvořit testovacího uživatele Silverback](#create-silverback-test-user)**  – Pokud chcete mít protějšek Britta Simon Silverback, který je propojený s Azure AD reprezentace uživatele.
...
1. V [webu Azure portal](https://portal.azure.com/)na **Silverback** integrace stránce aplikace vyberte **jednotného přihlašování**.
...
4. Na **základní konfiguraci SAML** části, proveďte následující kroky:
    ...
    ![Silverback domény a adresy URL jednotného přihlašování – informace](common/sp-identifier-reply.png)

    a. V **přihlašovací adresa URL** textové pole, zadejte adresu URL, pomocí následujícího vzorce: `https://<YOURSILVERBACKURL>.com/ssp`

    b. V **identifikátor** pole, zadejte adresu URL, pomocí následujícího vzorce: `<YOURSILVERBACKURL>.com`

    c. V **adresy URL odpovědi** textové pole, zadejte adresu URL, pomocí následujícího vzorce: `https://<YOURSILVERBACKURL>.com/sts/authorize/login`

    > [!NOTE]
    > Tyto hodnoty nejsou skutečný. Tyto hodnoty aktualizujte skutečné přihlašovací adresa URL, identifikátoru a adresa URL odpovědi. Kontakt [tým podpory Silverback klienta](mailto:helpdesk@matrix42.com) k získání těchto hodnot. Můžete také odkazovat na tyto vzory se dají ukazuje **základní konfiguraci SAML** části webu Azure Portal.
...
### <a name="configure-silverback-single-sign-on"></a>Konfigurace Silverback jednotného přihlašování

1. V různých webový prohlížeč, přihlaste se k serveru Silverback jako správce.

2. Přejděte do **správce** > **zprostředkovatele ověřování**.

3. Na **nastavení poskytovatele ověřování** stránce, proveďte následující kroky:

    ![Správce](./media/silverback-tutorial/tutorial_silverback_admin.png)

    a.  Klikněte na **importovat z adresy URL**.

    b.  Vložte zkopírovanou adresu URL metadat a klikněte na tlačítko **OK**.

    c.  Potvrzení pro **OK** pak hodnoty vyplní automaticky.

    d.  Povolit **zobrazit na přihlašovací stránce**.

    e.  Povolit **dynamické vytvoření uživatele** Pokud chcete přidat uživatele Azure AD oprávnění automaticky (volitelné).

    f.  Vytvoření **Title** pro tlačítko na samoobslužný portál.

    g.  Nahrání **ikonu** po kliknutí na **zvolit soubor**.

    h.  Vyberte na pozadí **barva** pro tlačítko.
...
1. Na webu Azure Portal, vyberte **podnikové aplikace**vyberte **všechny aplikace**a pak vyberte **Silverback**.
...
### <a name="create-silverback-test-user"></a>Vytvoření Silverback testovacího uživatele
...
Po kliknutí na dlaždici Silverback na přístupovém panelu, můžete by měl být automaticky přihlášeni k Silverback, u kterého nastavíte jednotné přihlašování. Další informace o přístupovém panelu, naleznete v tématu [Úvod k přístupovému panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

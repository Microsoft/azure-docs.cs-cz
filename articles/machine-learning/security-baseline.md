...
Tato základní hodnota zabezpečení platí pro Microsoft Azure Machine Learning pokynů od [zabezpečení Azure Security test 1,0](../security/benchmarks/overview-v1.md) . Azure Security Benchmark poskytuje doporučení, jak můžete zabezpečit svá cloudová řešení v Azure.
Obsah je seskupen podle **řízení zabezpečení** definovaného srovnávacím testem zabezpečení Azure a souvisejících pokynů, které se vztahují na Azure Machine Learning. **Ovládací prvky** , které se nevztahují k Azure Machine Learning byly vyloučeny.

 
Pokud chcete zjistit, jak Azure Machine Learning kompletně mapuje srovnávací test zabezpečení Azure, přečtěte si [celý soubor mapování standardních hodnot Azure Machine Learning Security](https://github.com/MicrosoftDocs/SecurityBenchmarks/tree/master/Azure%20Offer%20Security%20Baselines).
...
- [Postup konfigurace diagnostických protokolů pro Azure Machine Learning](https://docs.microsoft.com/azure/machine-learning/monitor-azure-machine-learning#configuration)
...
- [Další informace o výstrahách Azure Machine Learning](https://docs.microsoft.com/azure/machine-learning/monitor-azure-machine-learning#alerts)
...
- [Jak nakonfigurovat rozšíření Microsoft Antimalware pro Cloud Services](/powershell/module/servicemanagement/azure.service/set-azurevmmicrosoftantimalwareextension)
...
- [Další informace Machine Learning výchozích rolích](https://docs.microsoft.com/azure/machine-learning/how-to-assign-roles#default-roles)

- [Další informace o Privileged Identity Management](/azure/active-directory/privileged-identity-management/index)
...
**Doprovodné** materiály: Machine Learning je integrována s Azure Active Directory (Azure AD), použijte službu Azure AD SSO namísto konfigurace jednotlivých samostatných přihlašovacích údajů pro každou službu. Použijte Azure Security Center doporučení pro identitu a přístup.
...
- [Azure Machine Learning šifrování dat v klidovém umístění](https://docs.microsoft.com/azure/machine-learning/concept-enterprise-security#encryption-at-rest)
...
- [Azure Machine Learning klíčů spravovaných zákazníkem](https://docs.microsoft.com/azure/machine-learning/concept-enterprise-security#azure-blob-storage)
...
**Doprovodné** materiály: Azure Machine Learning podporuje jak předdefinované role, tak i možnost vytvářet vlastní role. Spravované identity použijte k poskytování služeb Azure s automaticky spravovanou identitou v Azure Active Directory (Azure AD). Spravované identity vám umožňují ověřit jakoukoli službu, která podporuje ověřování Azure AD, včetně Key Vault bez jakýchkoli přihlašovacích údajů v kódu.
...
- [Postup obnovení klíčů Key Vault v Azure](/powershell/module/az.keyvault/restore-azkeyvaultkey)
...
**Doprovodné** materiály: pro místní zálohování se šifrování v klidovém prostředí poskytuje pomocí hesla, které zadáte při zálohování do Azure. K ochraně záloh a klíčů spravovaných zákazníkem použijte řízení přístupu na základě role Azure (Azure RBAC). 

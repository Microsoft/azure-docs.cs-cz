...
Pro operace příjmu, rozhraní API služby Service Bus klientům povolit dvou různých režimech explicitní: *Přijímat a odstranění* a *neboli Peek-Lock*.

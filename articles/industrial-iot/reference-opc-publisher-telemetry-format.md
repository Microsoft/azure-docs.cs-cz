---
title: Microsoft OPC Publisher – formát telemetrie
description: Tento článek poskytuje přehled konfiguračního souboru nastavení.
author: jehona-m
ms.author: jemorina
...
ms.locfileid: "104787528"
---
# <a name="opc-publisher-telemetry-format"></a>Formát telemetrie vydavatele OPC

Vydavatel OPC verze 2,6 a novější podporuje standardizovaný formát JSON OPC UA PubSub, který je uvedený v [části 14 specifikace OPC UA](https://opcfoundation.org/developer-tools/specifications-unified-architecture/part-14-pubsub/) a vypadá takto:
```
{
  "MessageId": "18",
  "MessageType": "ua-data",
...
Kromě toho všechny verze vydavatelů OPC podporují nestandardizovaný formát telemetrie JSON, který je kompatibilní s [Azure Time Series Insights](https://azure.microsoft.com/services/time-series-insights/) a vypadá takto:
```
[
   {
...
## <a name="opc-publisher-telemetry-configuration-file-format"></a>Formát konfiguračního souboru telemetrie vydavatele OPC
```

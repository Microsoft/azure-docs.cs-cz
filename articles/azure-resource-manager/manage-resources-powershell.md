---
title: Správa prostředků Azure pomocí Azure PowerShell | Microsoft Docs
description: Ke správě prostředků použijte Azure PowerShell a správu prostředků Azure.
...
ms.locfileid: "72001516"
---
# <a name="manage-azure-resources-by-using-azure-powershell"></a>Správa prostředků Azure pomocí Azure PowerShell

Naučte se používat Azure PowerShell s [Azure Resource Manager](resource-group-overview.md) ke správě prostředků Azure. Informace o správě skupin prostředků najdete v tématu [Správa skupin prostředků Azure pomocí Azure PowerShell](./manage-resource-groups-powershell.md).
...
Další informace najdete v tématu [nasazení prostředků pomocí šablon Správce prostředků a Azure PowerShell](./resource-group-template-deploy.md).
...
Označení pomáhá organizovat skupinu prostředků a prostředky logicky. Informace najdete v tématu [použití značek k uspořádání prostředků Azure](./resource-group-using-tags.md#powershell).

---
title: Indexované video, aplikace Azure SaaS SQL | Microsoft Docs
...
- *Ilustrační* [Modely tenantů SaaS Database pro více tenantů][saas-concept-design-patterns-563e]
- *Výuka* [Aplikace SaaS lístky Wingtip][saas-how-welcome-wingtip-app-679t]
...
- [7. Databázové modely pro více tenantů: specialisté a nevýhody, 0:11:59](#anchor-image-wtip-min01159)
...
- [18. Ukázková aplikace Wingtip SaaS, 0:48:10](#anchor-image-wtip-min04810)
- [19. Scénáře a vzory prozkoumání v kurzech, 0:49:10](#anchor-image-wtip-min04910)
- [20. Ukázka kurzů a úložiště GitHub, 0:50:18](#anchor-image-wtip-min05018)
- [21. Úložiště GitHub Microsoft/úložišti wingtipsaas, 0:50:38](#anchor-image-wtip-min05038)
- [22. Prozkoumejte vzory, 0:56:20](#anchor-image-wtip-min05620)
- [23. Zřizování klientů a připojování 0:57:44](#anchor-image-wtip-min05744)
- [24. Zřizování klientů a připojení aplikací, 0:58:58](#anchor-image-wtip-min05858)
- [25. Ukázka skriptů pro správu, které zřídí jednoho tenanta, 0:59:43](#anchor-image-wtip-min05943)
...
- [30. Generování zátěže a sledování výkonu, 1:09:42](#anchor-image-wtip-min10942)
...
- [34. SSMS analýzy ad hoc, 1:12:46](#anchor-image-wtip-min11246)
- [35. Extrakce dat tenanta do SQL DW, 1:16:32](#anchor-image-wtip-min11632)
...
- Název: Učení z MYOB: Vzory návrhu pro SaaS aplikace v Azure SQL Database
...
[![Aplikace Wingtip SaaS: Webová aplikace pro více tenantů][image-wtip-min00505-web-app]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=300)
...
#### <a name="7-database-models-for-multi-tenant-pros-and-cons-00952"></a>7. Databázové modely pro více tenantů: specialisté a nevýhody, 0:09:52
...
#### <a name="18-wingtip-saas-sample-app-04801"></a>18. Ukázková aplikace Wingtip SaaS, 0:48:01
...
#### <a name="19-scenarios-and-patterns-explored-in-the-tutorials-04900"></a>19. Scénáře a vzory prozkoumání v kurzech, 0:49:00
...
#### <a name="21-github-repo-microsoftwingtipsaas-05032"></a>21. Úložiště GitHub Microsoft/úložišti wingtipsaas, 0:50:32
...
#### <a name="22-exploring-the-patterns-05615"></a>22. Prozkoumejte vzory, 0:56:15
...
#### <a name="23-provisioning-tenants-and-onboarding-05619"></a>23. Zřizování klientů a připojování 0:56:19
...
#### <a name="25-demo-of-management-scripts-provisioning-a-single-tenant-05936"></a>25. Ukázka skriptů pro správu, které zřídí jednoho tenanta, 0:59:36
...
#### <a name="30-load-generation-and-performance-monitoring-10937"></a>30. Generování zátěže a sledování výkonu, 1:09:37
...
#### <a name="34-ssms-adhoc-analytics-11235"></a>34. SSMS analýzy ad hoc, 1:12:35
...
#### <a name="35-extract-tenant-data-into-sql-dw-11546"></a>35. Extrakce dat tenanta do SQL DW, 1:15:46
[![Extrakce dat tenanta do SQL datového skladu][image-wtip-min11632-extract-tenant-data-sql-dw]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=4546)
...
[image-wtip-min00505-web-app]: media/saas-tenancy-video-index-wingtip-brk3120-20171011/wingtip-20171011-min00505-wingtip-saas-app-mt-web.png "Aplikace Wingtip SaaS: Webová aplikace pro více tenantů"
...
[image-wtip-min11632-extract-tenant-data-sql-dw]: media/saas-tenancy-video-index-wingtip-brk3120-20171011/wingtip-20171011-min11632-extract-tenant-data-analytics-db-dw.png "Extrakce dat tenanta do SQL datového skladu"

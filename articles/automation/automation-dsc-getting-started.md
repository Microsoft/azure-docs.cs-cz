...
ms.locfileid: "72169735"
---
# <a name="getting-started-with-azure-automation-state-configuration"></a>Začínáme s konfigurací stavu Azure Automation

Tento článek vysvětluje, jak provádět nejběžnější úlohy s konfigurací stavu Azure Automation, jako je vytváření, importování a kompilování konfigurací, připojování počítačů ke správě a zobrazování sestav. Přehled informací o konfiguraci stavu Azure Automation najdete v tématu [Přehled konfigurace stavu Azure Automation](automation-dsc-overview.md). Dokumentaci k konfiguraci požadovaného stavu (DSC) najdete v tématu [Přehled konfigurace požadovaného stavu prostředí Windows PowerShell](/powershell/dsc/overview).
...
Vytvoříte jednoduchou [konfiguraci DSC](/powershell/dsc/configurations) , která zajistí buď přítomnost, nebo nepřítomnost funkce **webového serveru** (IIS) v závislosti na tom, jak přiřadíte uzly.
...
Tato konfigurace volá jeden prostředek v bloku každého uzlu, [prostředek WindowsFeature](/powershell/dsc/windowsfeatureresource), který zajišťuje buď přítomnost, nebo nepřítomnost funkce **webového serveru** .
...
1. Na stránce **Importovat konfiguraci** vyhledejte v počítači soubor `TestConfig.ps1`.
...
Další informace o kompilaci konfigurací najdete v tématu [Konfigurace DSC](/powershell/dsc/configurations).
...
Další informace o použití těchto dat najdete v tématu [použití serveru sestav DSC](/powershell/dsc/reportserver).
...
- [Přehled konfigurace požadovaného stavu prostředí Windows PowerShell](/powershell/dsc/overview)

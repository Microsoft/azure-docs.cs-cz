...
Nakonfigurujte čítače výkonu z [dat nabídky v nastavení analýzy protokolů](log-analytics-data-sources.md#configuring-data-sources).
...
![Nakonfigurujte čítače výkonu Windows](media/log-analytics-data-sources-performance-counters/configure-windows.png)
...
![Konfiguraci Linuxových čítačů výkonu](media/log-analytics-data-sources-performance-counters/configure-linux.png)
...
V následující tabulce jsou uvedeny objekty a čítače, které můžete zadat v konfiguračním souboru.  K dispozici další čítače pro určité aplikace, jak je popsáno v [shromáždit čítače výkonu pro Linuxové aplikace ve službě Log Analytics](log-analytics-data-sources-linux-applications.md).

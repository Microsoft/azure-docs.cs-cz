---
title: 'Rychlý start: Získání podporovaných jazyků – Translator Text, Ruby'
...
ms.locfileid: "46121834"
---
# <a name="quickstart-get-supported-languages-with-ruby"></a>Rychlý start: Získání podporovaných jazyků s Ruby

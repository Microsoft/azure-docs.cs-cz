...
1. V Azure DevOps na stránce se souhrnem projektu na adrese *https:\//\<název serveru >/\<název organizace >/\<název týmu >* , například **https:\//dev.Azure.com/DataScienceUnit/myTeam**.

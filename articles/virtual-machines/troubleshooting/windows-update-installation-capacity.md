...
V této situaci operační systém (OS) nemůže dokončit instalaci web Windows Update (KB), protože v systému souborů nelze vytvořit základní soubor. Na základě tohoto kódu chyby operační systém nemůže na disk zapisovat žádné soubory.

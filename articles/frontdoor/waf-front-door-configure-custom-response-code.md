...
Níže je příklad vytvoření nové zásady WAF se stavovým kódem vlastní odpovědi nastavena na 405 a zpráva, která má **jsou zablokované.** pomocí [New-AzFrontDoorFireWallPolicy](/powershell/module/az.frontdoor/new-azfrontdoorfirewallPolicy).

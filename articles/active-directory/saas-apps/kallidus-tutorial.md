...
Ke konfiguraci jednotného přihlašování na straně **Kallidus** je potřeba odeslat **adresu URL federačních metadat aplikace** a kopii **podpisového certifikátu (veřejného)** do [týmu podpory Kallidus](https://kallidus.zendesk.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.
...
V této části vytvoříte uživatele s názvem Britta Simon v Kallidus. Pokud chcete přidat uživatele na platformě Kallidus, pracujte s [týmem podpory Kallidus](https://kallidus.zendesk.com) . Uživatelé musí vytvořit a aktivovat, než použití jednotného přihlašování.

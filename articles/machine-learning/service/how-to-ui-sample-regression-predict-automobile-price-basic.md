...
4. Vyberte tlačítko **otevřít** pro kanál Sample 1:

    ![Otevření kanálu](media/how-to-ui-sample-regression-predict-automobile-price-basic/open-sample1.png)

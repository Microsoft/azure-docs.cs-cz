...
## <a name="users"></a>2. vytvoření uživatelů tenanta
...
## <a name="register-client"></a>3. Zaregistrujte klienta VPN.
...
## <a name="register-apps"></a>4. registrace dalších aplikací
...
## <a name="assign-users"></a>5. přiřazení uživatelů k aplikacím

Přiřaďte uživatele k vašim aplikacím.

1. V části **Azure AD – > podnikové aplikace**vyberte nově registrovanou aplikaci a klikněte na **vlastnosti**. Zajistěte, aby bylo **přiřazení uživatele vyžadováno?** je nastaveno na **Ano**. Klikněte na možnost **Uložit**.

...
Dokončení úlohy trvá déle. V takovém případě chcete být upozorněni. Existuje několik možností, jak se nechat na dokončení [úlohy](https://docs.microsoft.com/rest/api/media/jobs) upozornit. Nejjednodušší možnost (zobrazená tady) je použití cyklického dotazování.

...
3. Zaregistrujte funkci zrychlení dotazů pomocí příkazu [AZ Feature Register](/cli/azure/feature#az_feature_register) .
...
Chcete-li ověřit, zda byla registrace dokončena, použijte příkaz [AZ Feature](/cli/azure/feature#az_feature_show) .
...
Chcete-li zaregistrovat poskytovatele prostředků, použijte příkaz [AZ Provider Register](/cli/azure/provider#az_provider_register) .
...
2. Nainstalujte `12.5.0-preview.6` verzi nebo novější z klientské knihovny Azure Blob Storage pro balíček .NET pomocí `dotnet add package` příkazu. 

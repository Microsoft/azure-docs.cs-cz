---
title: Řešení potíží s Azure cache pro Redis problémy na straně klienta | Microsoft Docs
description: Naučte se řešit běžné problémy na straně klienta s mezipamětí Azure pro Redis.
services: cache
documentationcenter: ''
author: yegu-ms
manager: maiye

...
- Uživatele, aby automaticky získat přihlášeného k EthicsPoint Incident Management (EPIM) (jednotné přihlašování) můžete povolit pomocí jejich účtů služby Azure AD
...
1. Přidání správy incidentů EthicsPoint (EPIM) z Galerie
...
1. Do vyhledávacího pole zadejte **EthicsPoint Incident Management (EPIM)**.

    ![Vytváří se testovací uživatele služby Azure AD](./media/ethicspoint-incident-management-tutorial/tutorial_ethicspoint_search.png)

1. Na panelu výsledků vyberte **EthicsPoint Incident Management (EPIM)** a potom klikněte na tlačítko **přidat** tlačítko pro přidání aplikace.

    ![Vytváří se testovací uživatele služby Azure AD](./media/ethicspoint-incident-management-tutorial/tutorial_ethicspoint_addfromgallery.png)

##  <a name="configuring-and-testing-azure-ad-single-sign-on"></a>Konfigurace a testování Azure AD jednotného přihlašování
V této části nakonfigurovat a otestovat Azure AD jednotné přihlašování s EthicsPoint Incident Management (EPIM) na základě testovací uživatele nazývá "Britta Simon."

Pro jednotné přihlašování pro práci služba Azure AD potřebuje vědět, co uživatel protějšky v EthicsPoint Incident Management (EPIM) je pro uživatele ve službě Azure AD. Jinými slovy vztah odkazu mezi uživatele služby Azure AD a související uživatelské v EthicsPoint Incident Management (EPIM) musí být vytvořeno.

V EthicsPoint Incident Management (EPIM) přiřaďte hodnotu **uživatelské jméno** ve službě Azure AD jako hodnotu **uživatelské jméno** a tím vytvoří vztah odkazu.
...
1. **[Vytvoření zkušebního uživatele EthicsPoint Incident Management (EPIM)](#creating-a-ethicspoint-incident-management-epim-test-user)**  – Pokud chcete mít protějšek Britta Simon v EthicsPoint Incident Management (EPIM), který je propojený s Azure AD reprezentace uživatele.
1. **[Přiřazení testovacího uživatele Azure AD](#assigning-the-azure-ad-test-user)**  – Pokud chcete povolit Britta Simon používat Azure AD jednotného přihlašování.
1. **[Testování Single Sign-On](#testing-single-sign-on)**  – Pokud chcete ověřit, jestli funguje v konfiguraci.

### <a name="configuring-azure-ad-single-sign-on"></a>Konfigurace služby Azure AD jednotného přihlašování

V této části Povolení služby Azure AD jednotného přihlašování na portálu Azure portal a konfigurace jednotného přihlašování v aplikaci Správa incidentů EthicsPoint (EPIM).

**Ke konfiguraci Azure AD jednotné přihlašování s EthicsPoint Incident Management (EPIM), proveďte následující kroky:**

1. Na webu Azure Portal na **EthicsPoint Incident Management (EPIM)** integrace stránka aplikace, klikněte na tlačítko **jednotného přihlašování**.

    ![Konfigurace jednotného přihlašování][4]

1. Na **jednotného přihlašování** dialogového okna, vyberte **režimu** jako **přihlašování na základě SAML** povolit jednotné přihlašování.
 
    ![Konfigurace jednotného přihlašování](./media/ethicspoint-incident-management-tutorial/tutorial_ethicspoint_samlbase.png)

1. Na **EthicsPoint Incident Management (EPIM) domény a adresy URL** části, proveďte následující kroky:

    ![Konfigurace jednotného přihlašování](./media/ethicspoint-incident-management-tutorial/tutorial_ethicspoint_url.png)
    ...
    b. V **identifikátor** textového pole zadejte adresu URL pomocí následujícímu vzoru: `https://<companyname>.navexglobal.com/adfs/services/trust`
...
1. Na **podpisový certifikát SAML** klikněte na tlačítko **soubor XML s metadaty** a uložte soubor metadat ve vašem počítači.
    ...
    ![Konfigurace jednotného přihlašování](./media/ethicspoint-incident-management-tutorial/tutorial_ethicspoint_certificate.png) 
...
1. V **webu Azure portal**, v levém navigačním podokně klikněte na tlačítko **Azure Active Directory** ikonu.
    ...
    ![Vytváří se testovací uživatele služby Azure AD](./media/ethicspoint-incident-management-tutorial/create_aaduser_01.png) 

1. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin** a klikněte na tlačítko **všichni uživatelé**.
    
    ![Vytváří se testovací uživatele služby Azure AD](./media/ethicspoint-incident-management-tutorial/create_aaduser_02.png) 

1. Chcete-li otevřít **uživatele** dialogového okna, klikněte na tlačítko **přidat** horní části dialogového okna.
 
    ![Vytváří se testovací uživatele služby Azure AD](./media/ethicspoint-incident-management-tutorial/create_aaduser_03.png) 

1. Na **uživatele** dialogového okna stránky, proveďte následující kroky:
 
    ![Vytváří se testovací uživatele služby Azure AD](./media/ethicspoint-incident-management-tutorial/create_aaduser_04.png) 
...
**Pokud chcete přiřadit k EthicsPoint Incident Management (EPIM) Britta Simon, postupujte následovně:**

1. Na webu Azure Portal, otevřete zobrazení aplikací a pak přejděte do zobrazení adresáře a přejděte na **podnikové aplikace** klikněte **všechny aplikace**.

    ![Přiřadit uživatele][201] 

1. V seznamu aplikací vyberte **EthicsPoint Incident Management (EPIM)**.

    ![Konfigurace jednotného přihlašování](./media/ethicspoint-incident-management-tutorial/tutorial_ethicspoint_app.png) 

...
Tento rychlý start popisuje, jak replikovat virtuální počítač Azure do jiné oblasti Azure. Replikace Azure do Azure je aktuálně ve verzi Preview.
...
2. V části **Nastavení** klikněte na **Zotavení po havárii**.

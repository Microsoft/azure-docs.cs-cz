...
### <a name="q-why-is-my-remaining-credit-are-set-to-0-after-a-redepoy-or-a-stopstart"></a>Otázka: Proč je můj zbývající kredit jsou nastaveny na hodnotu 0 po redepoy nebo zastavit a spustit?
**A** : Pokud virtuální počítač "REDPLOYED" a virtuální počítač přesune do jiného uzlu, Akumulovaná platební dojde ke ztrátě. Pokud virtuální počítač se zastavila nebo spustila, ale zůstává na stejném uzlu, virtuální počítač zachová Akumulovaná kreditu. Vždy, když virtuální počítač spustí novou na uzlu, získá počáteční platební, Standard_B8ms je 240 minut.

...
3. **[Vytvořit testovacího uživatele Expensify](#create-an-expensify-test-user)**  – Pokud chcete mít protějšek Britta Simon Expensify, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **Expensify domény a adresy URL** části, proveďte následující kroky:

...
1. Do vyhledávacího pole zadejte **zapojení Moxi**.

    ![Vytváří se testovací uživatele služby Azure AD](./media/moxiengage-tutorial/tutorial_moxiengage_search.png)

1. Na panelu výsledků vyberte **Moxi zapojení**a potom klikněte na tlačítko **přidat** tlačítko pro přidání aplikace.
...
1. **[Vytvoření zkušebního uživatele zapojit Moxi](#creating-a-moxi-engage-test-user)**  – Pokud chcete mít protějšek Britta Simon Moxi zapojení, který je propojený s Azure AD reprezentace uživatele.
...
1. Na **Moxi zapojení domény a adresy URL** části, proveďte následující kroky:
...
1. Ke konfiguraci jednotného přihlašování na **Moxi zapojení** straně, je nutné odeslat na stažený **soubor XML s metadaty** k [Moxi zapojení týmu podpory](mailto:support@moxiworks.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.
...
1. V seznamu aplikací vyberte **zapojení Moxi**.

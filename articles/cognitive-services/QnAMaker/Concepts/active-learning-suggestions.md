...
Použijte [rozhraní API pro vlak](https://docs.microsoft.com/rest/api/cognitiveservices/qnamaker4.0/runtime/train) k odeslání správné odpovědi na QnA maker, až ho uživatel vybere.

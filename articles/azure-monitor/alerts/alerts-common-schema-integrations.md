...
* Nastavení pravidel upozornění ([metrika](../alerts/alerts-metric.md), [protokol](../platform/alerts-log.md), [Protokol aktivit](../platform/alerts-activity-log.md))
* Nastavení [skupin akcí](../platform/action-groups.md)

...
ms.locfileid: "93097171"
---
# <a name="azure-cosmos-db-net-sdk-v3-for-sql-api-download-and-release-notes"></a>Azure Cosmos DB .NET SDK v3 pro SQL API: stažení a poznámky k verzi
...
|**Dokumentace k rozhraní API**|[Referenční dokumentace rozhraní .NET API](/dotnet/api/overview/azure/cosmosdb?view=azure-dotnet&preserve-view=true)|
...
|**Kurz Entity Framework Core**|[Entity Framework Core s poskytovatelem Azure Cosmos DB](/ef/core/providers/cosmos/#get-started)|

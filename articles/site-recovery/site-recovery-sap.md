...
Tato referenční architektura centrální služby běží na virtuálních počítačích v aplikační vrstvě. Centrální služby jsou potenciální jediný bod selhání v jednom virtuálním počítači. Typické nasazení a vysoká dostupnost nejsou požadavky.
...
**SQL Database servery** |  Použít SQL Server vždy při replikaci

...
- Volá `loggerFactory.AddAzureWebAppDiagnostics()` v *Startup.cs*.

> [!NOTE]
> Úroveň protokolu projektu je nastavena na `Information` v souboru *appSettings. JSON*.
>

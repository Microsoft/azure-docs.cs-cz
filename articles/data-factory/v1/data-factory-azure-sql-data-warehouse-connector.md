...
Následující části poskytují další osvědčené postupy pro ty, které jsou uvedené v článku [osvědčené postupy pro Azure SQL Data Warehouse](../../synapse-analytics/sql-data-warehouse/sql-data-warehouse-best-practices.md).
...
Pokud ke kopírování dat z SQL Server nebo Azure SQL Database na Azure SQL Data Warehouse používáte Průvodce kopírováním a tabulka, která odpovídá zdrojové tabulce, v cílovém úložišti neexistuje, Data Factory může automaticky vytvořit tabulku v datovém skladu pomocí schématu zdrojové tabulky.

---
title: Plánování úloh pro zpracování souvislých dat – Azure Logic Apps
...
1. Nastavte interval a frekvenci opakování. V tomto příkladu nastavte tyto vlastnosti tak, aby každý týden spouštěly pracovní postupy.
   ...
   | Vlastnost | Požaduje se | Název JSON | Typ | Popis |
   |----------|----------|-----------|------|-------------|
   | **Způsobené** | Ne | způsobené | Řetězec | Doba, po kterou se má zpozdit každé opakování, pomocí [specifikace data a času ISO 8601](https://en.wikipedia.org/wiki/ISO_8601#Durations) |

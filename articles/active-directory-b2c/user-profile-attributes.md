...
Pro místní identitu je vyžadován atribut **passwordProfile** a obsahuje heslo uživatele. `forceChangePasswordNextSignIn`Atribut musí být nastaven na hodnotu `false` .

...
5. V části **přihlašovací údaje správce** zadejte `https://scim.smartsheet.com/v2/` na **adrese URL tenanta**. Zadejte hodnotu, kterou jste načetli a uložili dříve ze Smartsheet v **tajném tokenu**. Klikněte na **Test připojení** a ujistěte se, že se služba Azure AD může připojit k Smartsheet. Pokud se připojení nepovede, ujistěte se, že váš účet Smartsheet má oprávnění správce systému, a zkuste to znovu.

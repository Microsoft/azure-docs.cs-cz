...
* [Monitorování ExpressRoute](network-performance-monitor-expressroute.md): monitorování připojení začátku do konce a výkon mezi vašimi pobočkami a Azure, přes Azure ExpressRoute.  
...
Můžete nainstalovat agenty na základních procesů [počítače Windows se připojit ke službě Azure Log Analytics](../../log-analytics/log-analytics-om-agents.md) a [připojení Operations Manageru k Log Analytics](../../log-analytics/log-analytics-om-agents.md).

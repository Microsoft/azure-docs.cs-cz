...
| [`az webapp log config`](/cli/azure/webapp/log?view=azure-cli-latest#az_webapp_log_config) | Nakonfiguruje, které protokoly webová aplikace Azure uchovává. |
| [`az webapp log download`](/cli/azure/webapp/log?view=azure-cli-latest#az_webapp_log_download) | Stáhne protokoly webové aplikace Azure na místní počítač. |

...
Ukázková aplikace používá [Helm 3][helm-installed] ke spuštění služby Windows v clusteru. Přejděte do adresáře `charts` a pomocí Helm spusťte službu systému Windows:

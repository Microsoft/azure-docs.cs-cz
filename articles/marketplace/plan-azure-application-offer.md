...
- Rychlá zprovoznění:
    ...
    - [Publikování definice aplikace](/azure/managed-applications/publish-service-catalog-app)
    - [Nasazení aplikace katalogu služeb](/azure/managed-applications/deploy-service-catalog-quickstart)
- Kurzy:
    - [Vytvoření definičních souborů](/azure/managed-applications/publish-service-catalog-app)
- Vzory
    - [Azure CLI](/azure/managed-applications/cli-samples)
    - [Azure PowerShell](/azure/managed-applications/powershell-samples)
    - [Řešení spravovaných aplikací](/azure/managed-applications/sample-projects)
...
- [Průzkumník služby Azure Storage](/azure/vs-azure-tools-storage-manage-with-storage-explorer)

...
description: V tomto kurzu se dozvíte, jak nakonfigurovat jednotné přihlašování mezi Azure Active Directory a Predictix řazení.
...
* Můžete řídit, kdo má přístup k řazení Predictix Azure AD.
* Můžete povolit uživatelům, aby se automaticky přihlášeni k Predictix řazení (jednotné přihlašování) s jejich účty Azure AD.
...
Konfigurace integrace Azure AD s Predictix řazení, musíte mít:
...
* Předplatné Predictix řazení, které má single sign-on povoleno.

## <a name="scenario-description"></a>Popis scénáře

V tomto kurzu budete nakonfigurovat a otestovat Azure AD jednotné přihlašování v testovacím prostředí.

* Řazení Predictix podporuje jednotné přihlašování iniciovaného Zprostředkovatelem přihlašování.

## <a name="add-predictix-ordering-from-the-gallery"></a>Přidat z Galerie Predictix řazení

Postup nastavení integrace Predictix řazení do služby Azure AD, musíte doplnit Predictix řazení z Galerie váš seznam spravovaných aplikací SaaS.
...
V této části budete konfigurovat a otestovat Azure AD jednotné přihlašování s Predictix řazení pomocí testovacího uživatele s názvem Britta Simon.
Pokud chcete povolit jednotné přihlašování, budete muset vytvořit vztah mezi uživatele služby Azure AD a odpovídajícího uživatele v Predictix řazení.

Nakonfigurovat a otestovat Azure AD jednotné přihlašování s Predictix řazení, které potřebujete k dokončení těchto kroků:
...
2. **[Konfigurovat řazení Predictix jednotného přihlašování](#configure-predictix-ordering-single-sign-on)**  na straně aplikace.
...
5. **[Vytvoření zkušebního uživatele Predictix řazení](#create-a-predictix-ordering-test-user)**  připojený k Azure AD zastoupení uživatele.
...
Ke konfiguraci Azure AD jednotné přihlašování s Predictix řazení, proveďte tyto kroky:
...
4. V **základní konfiguraci SAML** dialogové okno pole, proveďte následující kroky.
    ...
    > [!NOTE]
    > Tyto hodnoty jsou zástupné symboly. Budete muset použít skutečné přihlašovací adresu URL a identifikátor. Obraťte se [Predictix řazení tým podpory](https://www.predix.io/support/) k získání hodnoty. Můžete také odkazovat na tyto vzory se dají ukazuje **základní konfiguraci SAML** dialogové okno na webu Azure Portal.
...
6. V **nastavení řazení Predictix** tématu, zkopírujte příslušné adresy URL, na základě vašich požadavků:

    ![Zkopírování adresy URL konfigurace](common/copy-configuration-urls.png)

    1. **Adresa URL pro přihlášení**.

    2. **Identifikátor služby Azure AD**.

    3. **Odhlašovací adresa URL**.

### <a name="configure-predictix-ordering-single-sign-on"></a>Konfigurovat řazení Predictix jednotného přihlašování

Pokud chcete nakonfigurovat jednotné přihlašování na straně Predictix řazení, budete muset odeslat certifikát, který jste stáhli a adresy URL, které jste zkopírovali z portálu Azure portal k [Predictix řazení tým podpory](https://www.predix.io/support/). Tento tým zajistí, že je správně nastaveno připojení SAML SSO na obou stranách.
...
V této části se budou moci používat Azure AD jednotného přihlašování tak, že udělíte přístup k řazení Predictix Britta Simon.
...
Při výběru dlaždice Predictix řazení na přístupovém panelu, můžete by měl být automaticky přihlášeni k řazení Predictix instanci, u kterého nastavíte jednotné přihlašování. Další informace najdete v tématu [přístup a používání aplikací na portálu Moje aplikace](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

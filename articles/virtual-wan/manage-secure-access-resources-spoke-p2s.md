...
* **Ověřování Azure Active Directory:** Získejte ID aplikace podnikové sítě Azure, která je zaregistrovaná ve vašem tenantovi Azure AD, [vystaviteli](https://sts.windows.net/your-Directory-ID/)a [tenantovi služby Azure AD](https://login.microsoftonline.com/your-Directory-ID).

...
Další informace o důležitých změn s HDInsight 4.0., naleznete v tématu [co je nového ve službě Hdinsight 4.0?](../hdinsight/hdinsight-version-release.md).

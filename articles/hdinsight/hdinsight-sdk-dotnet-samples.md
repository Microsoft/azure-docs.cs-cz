...
Fragmenty kódu pro tyto další funkce sady SDK najdete v [referenční dokumentaci k sadě HDInsight SDK pro .NET](/dotnet/api/overview/azure/hdinsight&preserve-view=true).

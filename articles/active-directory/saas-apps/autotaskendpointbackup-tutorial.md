...
3. **[Vytvoření zkušebního uživatele zálohování koncových bodů Autotask](#create-a-autotask-endpoint-backup-test-user)**  – Pokud chcete mít protějšek Britta Simon v zálohování Autotask koncových bodů, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **Autotask koncový bod zálohy domény a adresy URL** části, proveďte následující kroky:

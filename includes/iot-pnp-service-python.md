...
> [!NOTE]
> Tyto ukázky služeb používají třídu **IoTHubRegistryManager** z **klienta služby IoT Hub**. Další informace o rozhraních API, včetně rozhraní Digital props API, najdete v [příručce pro vývojáře služby](../articles/iot-pnp/concepts-developer-guide-service.md).

...
4. Do vyhledávacího pole zadejte **pojistka**, vyberte **pojistka** z panelu výsledků klikněte **přidat** tlačítko Přidat aplikaci.
    ...
    ![Pojistka v seznamu výsledků](./media/fuse-tutorial/tutorial_fuse_addfromgallery.png)
...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/fuse-tutorial/tutorial_fuse_samlbase.png)

3. Na **pojistka domény a adresy URL** část, proveďte následující kroky:

    ![Pojistka adresy URL jeden přihlašování informace o doméně a](./media/fuse-tutorial/tutorial_fuse_url.png)
...
5. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/fuse-tutorial/tutorial_general_400.png)
...
6. Na **pojistka konfigurace** klikněte na tlačítko **konfigurace pojistka** otevřete **konfigurovat přihlášení** okno. Kopírování **Sign-Out adresu URL, SAML Entity ID a SAML jeden přihlašování adresa URL služby** z **Stručná referenční příručka části.**
    ...
    ![Konfigurace pojistka](./media/fuse-tutorial/tutorial_fuse_configure.png) 
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/fuse-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **pojistka**.
    ...
    ![V seznamu aplikací na pojistka odkaz](./media/fuse-tutorial/tutorial_fuse_app.png)  

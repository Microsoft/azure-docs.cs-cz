...
> [!NOTE]
> Metriky [platformy pro Azure monitor prostředky můžete odeslat do Log Analytics pracovního prostoru](diagnostic-logs-stream-log-store.md) pro dlouhodobé trendy.

...
ms.locfileid: "55983181"
---
# <a name="create-a-zone-redundant-virtual-machine-scale-set-with-azure-cli"></a>Vytvoření zónově redundantní virtuálního počítače škálovací sady pomocí Azure CLI

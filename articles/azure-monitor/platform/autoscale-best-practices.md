...
### <a name="choose-the-appropriate-statistic-for-your-diagnostics-metric"></a>Vybrat vhodné statistiky pro diagnostickou metriku
...
### <a name="considerations-for-scaling-threshold-values-for-special-metrics"></a>Důležité důvody pro škálování prahových hodnot pro speciální metriky

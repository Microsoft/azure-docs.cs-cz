...
V tomto článku jsme se podívali na tom, jak můžete provádět testování pomocí služby Azure Cosmos DB pomocí konzolové aplikace .NET výkonu a škálování. Další informace najdete v těchto článcích:

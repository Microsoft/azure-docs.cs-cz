---
title: Odstranění Azure Migrateho projektu
...
---
# <a name="delete-an-azure-migrate-project"></a>Odstranění Azure Migrateho projektu
...
- Pokud jste připojili Log Analytics pracovní prostor k nástroji pro vyhodnocení závislostí, rozhodněte se, zda chcete odstranit pracovní prostor. 
    ...
    - Před odstraněním projektu můžete v části **pracovní prostor OMS**najít odkaz na pracovní prostor v **Azure Migrateových serverech** > **Azure Migrate – posuzování serveru**.
...
### <a name="hyper-v-vm"></a>Virtuální počítač Hyper-V 

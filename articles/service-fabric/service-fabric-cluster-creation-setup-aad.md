...
> [!NOTE]
> Pro národní cloudy (například Azure Government, Azure Čína, Azure Německo) byste měli zadat také parametr `-Location`.
...
Postupujte podle pokynů pro nastavení služby Azure AD a přiřaďte uživatelské role. Také doporučujeme, abyste zapnuli přiřazení uživatele vyžadované pro přístup k aplikaci, jak `SetupApplications.ps1`.
...
#### <a name="problem"></a>Problém
Při pokusu o přihlášení ke službě Azure AD v Service Fabric Explorer vrátí stránka chybu: "AADSTS50011: adresa pro odpověď &lt;&gt; URL neodpovídá adresám odpovědí nakonfigurovaným pro aplikaci: &lt;GUID&gt;."

...
3. Určete, jaká data se [namapují mezi školeními ke sledování povědomí Azure AD a Webroot](../app-provisioning/customize-application-attributes.md). 
...
Přidejte školení o povědomí o zabezpečení Webroot z Galerie aplikací Azure AD, abyste mohli začít spravovat zřizování pro školení týkající se zabezpečení Webroot. Další informace o přidání aplikace z galerie najdete [tady](../manage-apps/add-application-portal.md). 
...
* 1/21/2021 – pro uživatele byla přidána podpora pro základní atribut userName.

...
|[Python SDK](https://docs.microsoft.com/python/api/overview/azure/hdinsight)||||×|
|[Java SDK](https://docs.microsoft.com/java/api/overview/azure/hdinsight)||||×|

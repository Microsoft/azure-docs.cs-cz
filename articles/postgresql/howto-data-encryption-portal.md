...
Tato šablona Azure Resource Manager vytvoří azure databázi pro postgreSQL jeden server a používá **KeyVault** a **Key** předaný jako parametry pro povolení šifrování dat na serveru.

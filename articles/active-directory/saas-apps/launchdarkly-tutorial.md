...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/launchdarkly-tutorial/tutorial_launchdarkly_samlbase.png)
...
3. Na **LaunchDarkly domény a adresy URL** část, proveďte následující kroky, pokud chcete nakonfigurovat aplikace **IDP** iniciované režimu:
    ...
    ![LaunchDarkly domény a adresy URL jednotné přihlašování informace](./media/launchdarkly-tutorial/tutorial_launchdarkly_url.png)
...
4. Zkontrolujte **zobrazit upřesňující nastavení adresy URL** a provést následující krok, pokud chcete nakonfigurovat aplikace **SP** iniciované režimu:
    ...
    ![LaunchDarkly domény a adresy URL jednotné přihlašování informace](./media/launchdarkly-tutorial/tutorial_launchdarkly_url1.png)
...
6. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/launchdarkly-tutorial/tutorial_general_400.png)
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/launchdarkly-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **LaunchDarkly**.
    ...
    ![V seznamu aplikací na LaunchDarkly odkaz](./media/launchdarkly-tutorial/tutorial_launchdarkly_app.png)  

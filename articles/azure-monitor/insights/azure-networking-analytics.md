...
![Image z Azure Application Gateway analytics dlaždici](media/azure-networking-analytics/log-analytics-appgateway-tile.png)
...
![Obrázek řídicího panelu Azure Application Gateway analytics](media/azure-networking-analytics/log-analytics-appgateway01.png)

![Obrázek řídicího panelu Azure Application Gateway analytics](media/azure-networking-analytics/log-analytics-appgateway02.png)
...
![Obrázek řídicího panelu skupiny zabezpečení sítě Azure analytics](media/azure-networking-analytics/log-analytics-nsg01.png)

![Obrázek řídicího panelu skupiny zabezpečení sítě Azure analytics](media/azure-networking-analytics/log-analytics-nsg02.png)
...
* Použití [prohledávání protokolů v Log Analytics](../../log-analytics/log-analytics-queries.md) zobrazíte podrobné dat diagnostiky Azure.

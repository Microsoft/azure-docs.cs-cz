...
V tomto kurzu se naučíte, jak snadno rozšířit data v Azure synapse pomocí [Cognitive Services](../../cognitive-services/index.yml). K provedení detekce anomálií budeme používat [detektor anomálií](../../cognitive-services/anomaly-detector/index.yml) . Uživatel ve službě Azure synapse může jednoduše vybrat tabulku, která bude obohacena na detekci anomálií.
...
Nyní můžete **spouštět všechny** buňky a provádět detekci anomálií. Přečtěte si další informace o [Cognitive Services detektoru anomálií](../../cognitive-services/anomaly-detector/index.yml).

...
### <a name="is-storsimple-a-usage-based-or-based-on-seat-licenses-like-microsoft-365-and-enterprise-mobility-suite-ems"></a>StorSimple se na základě využití nebo na základě licencí na pracovní stanici, jako je Microsoft 365 a Enterprise Mobility Suite (EMS)?
...
### <a name="is-the-storsimple-business-model-similar-to-that-of-other-services-such-as-the-microsoft-365-and-the-enterprise-mobility-suite"></a>Je StorSimple obchodní model podobný jako u jiných služeb, jako je Microsoft 365 a sada Enterprise mobility? 
...
- Partneři můžou doručovat řešení vytvořená kolem StorSimple a dalších služeb Azure nebo softwaru třetích stran. Další informace najdete v některých možných [řešeních, která se vyskytují kolem StorSimple](./storsimple-disaster-recovery-using-azure-site-recovery.md).

...
|accuracy| Přesnost je poměr předpovědi, který přesně odpovídá skutečným popiskům třídy. <br> <br>**Cíl:** Blíže k 1 lepšímu <br> **Rozsah:** [0, 1]|[Kalkulační](https://scikit-learn.org/stable/modules/generated/sklearn.metrics.accuracy_score.html)|
...
balanced_accuracy|Vyvážená přesnost je aritmetickým průměrem odvolání jednotlivých tříd.<br> <br>**Cíl:** Blíže k 1 lepšímu <br> **Rozsah:** [0, 1]|[Kalkulační](https://scikit-learn.org/stable/modules/generated/sklearn.metrics.recall_score.html)|

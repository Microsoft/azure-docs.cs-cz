...
2. Vyberte možnost **přístup do řetězce klíčů**, rozbalte **Pomocníka s certifikátem**a pak vyberte **požádat o certifikát od certifikační autority**.
   ...
   :::image type="content" source="media/ios-sdk-get-started/image1.png" alt-text="Přístup k řetězci klíčů":::
...
3. Vyberte **zvolit soubor**, přejděte do umístění, kam jste ULOŽILI soubor CSR z prvního úkolu, a potom poklikejte na název certifikátu a načtěte ho. Pak vyberte **pokračovat**.
...
4. V okně **Vybrat certifikáty**   Vyberte vývojový certifikát, který používáte pro podepisování kódu, a vyberte **pokračovat**. Tento certifikát není certifikátem push, který jste vytvořili. Pokud jeden neexistuje, musíte ho vytvořit. Pokud certifikát existuje, přejděte k dalšímu kroku. Pokud neexistuje certifikát pro vývoj, vytvořte ho:
   ...
   2. V části **software**   Vyberte možnost **vývoj pro Apple**. Pak vyberte **pokračovat**.
...
5. Vraťte se na stránku **certifikáty, identifikátory & profily**   , v **Profiles**   nabídce vlevo vyberte profily a pak vyberte  **+**   Vytvoření nového profilu. Zobrazí se obrazovka **registrovat nový profil pro zřizování**   .

6. V okně **Vybrat certifikáty**   Vyberte vývojový certifikát, který jste právě vytvořili. Pak vyberte **pokračovat**.
...
4. Na stránce **Notification Hubs**   proveďte následující kroky:
   ...
   3. V **Location**   rozevíracím seznamu umístění vyberte hodnotu. Tato hodnota určuje umístění, ve kterém chcete vytvořit centrum oznámení.

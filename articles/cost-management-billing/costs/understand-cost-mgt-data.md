...
| **Smlouva se zákazníkem Microsoftu** | [Microsoft Azure Plan](https://azure.microsoft.com/offers/ms-azr-0017g) | EnterpriseAgreement_2014-09-01 | Nevztahuje se | Březen 2019<sup>3</sup> |
...
| **Azure Government** | Azure Government s průběžnými platbami | PayAsYouGo_2014-09-01 | MS-AZR-USGOV-0003P |
...
| **Plány podpory** | Podpora vývojářů                   | Default_2014-09-01 | MS-AZR-0043P |
...
| **Obsaženy** | **Nejsou zahrnuty** |
| --- | --- |
| Využití služby Azure<sup>5</sup>        | Poplatky za podporu – Další informace najdete v tématu [vysvětlení podmínek faktury](../understand/understand-invoice.md). |
| Marketplace – využití nabídky<sup>6</sup> | Daně – Další informace najdete v tématu [vysvětlení podmínek faktury](../understand/understand-invoice.md). |
| Nákupy na Marketplace<sup>6</sup>      | Kredity – Další informace najdete v tématu [vysvětlení podmínek faktury](../understand/understand-invoice.md). |
...
- Pokud jste ještě nedokončili první tohoto rychlého startu Cost Management, přečtěte si ho na [začít analýza nákladů](../../cost-management/quick-acm-cost-analysis.md).

...
![Zřizování objektů](media/concept-attributes/attribute-1.png)
...
> [!WARNING]
> Konfigurace synchronizace cloudu vytvoří instanční objekt. Objekt služby je viditelný v Azure Portal. Mapování atributů byste neměli měnit pomocí rozhraní instančního objektu v Azure Portal.  Tato funkce není podporovaná.
...
1. Tento dotaz vrátí schéma.
   ...
   ![Vrácené schéma](media/concept-attributes/schema-1.png)

...
4. Do vyhledávacího pole zadejte **Asana**, vyberte **Asana** z panelu výsledků klikněte **přidat** tlačítko Přidat aplikaci.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/asana-tutorial/tutorial_asana_addfromgallery.png)
...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/asana-tutorial/tutorial_asana_samlbase.png)

3. Na **Asana domény a adresy URL** část, proveďte následující kroky:

    ![Asana domény a adresy URL jednotné přihlašování informace](./media/asana-tutorial/tutorial_asana_url.png)
...
5. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/asana-tutorial/tutorial_general_400.png)
...
6. Na **Asana konfigurace** klikněte na tlačítko **konfigurace Asana** otevřete **konfigurovat přihlášení** okno. Kopírování **SAML jeden přihlašování adresa URL služby** z **Stručná referenční příručka části.**
    ...
    ![Konfigurace Asana](./media/asana-tutorial/tutorial_asana_configure.png)
...
7. V okně jiný prohlížeč přihlášení do aplikace Asana. Nakonfigurovat jednotné přihlašování v Asana, přístup k nastavení pracovního prostoru klikněte na název pracovního prostoru v pravém horním rohu obrazovky. Potom klikněte na  **\<název pracovního prostoru\> nastavení**.
    ...
    ![Nastavení jednotného přihlašování k Asana](./media/asana-tutorial/tutorial_asana_09.png)
...
8. Na **nastavení organizace** okně klikněte na tlačítko **správy**. Potom klikněte na **členy musí přihlásit pomocí SAML** umožňující jednotného přihlašování k konfigurace. Proveďte následující kroky:
    ...
    ![Konfigurace nastavení jednotný přihlášení](./media/asana-tutorial/tutorial_asana_10.png)  
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin** a klikněte na tlačítko **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/asana-tutorial/create_aaduser_02.png)

3. Chcete-li otevřít **uživatele** dialogové okno, klikněte na tlačítko **přidat** horní dialogové okno.

    ![Vytváření testovacího uživatele Azure AD](./media/asana-tutorial/create_aaduser_03.png)
...
Cílem této části je vytvoření uživatele v Asana nazývá Britta Simon. Asana podporuje automatické uživatele zřizování, který je ve výchozím nastavení povolené. Můžete najít další podrobnosti o [sem](asana-provisioning-tutorial.md) na tom, jak nakonfigurovat uživatele automatické zřizování.
...
1. Na **Asana**, přejděte na **týmy** části na levém panelu. Klikněte na tlačítko znaménko plus.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/asana-tutorial/tutorial_asana_12.png)
...
2. V seznamu aplikací vyberte **Asana**.
    ...
    ![V seznamu aplikací na Asana odkaz](./media/asana-tutorial/tutorial_asana_app.png)
...
* [Konfiguraci zřizování uživatelů](asana-provisioning-tutorial.md)

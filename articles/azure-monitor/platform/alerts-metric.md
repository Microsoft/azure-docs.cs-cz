...
8. Pokud má metrika rozměry, zobrazí se tabulka Dimensions. Vyberte jednu nebo více hodnot na dimenzi.
    ...
    - Můžete také **vybrat \*** pro libovolnou dimenzi. **Vyberte možnost \*** bude dynamicky škálovat výběr na všechny aktuální a budoucí hodnoty pro dimenzi.

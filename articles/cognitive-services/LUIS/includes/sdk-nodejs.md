...
[Příklady volání. Přidejte](/javascript/api/@azure/cognitiveservices-luis-authoring/examples?view=azure-node-lates) s ID aplikace, ID verze a příkladem.

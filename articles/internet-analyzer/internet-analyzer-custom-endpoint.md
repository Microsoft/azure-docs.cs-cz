...
2. V vlastní webové aplikaci nasaďte testovací obrázek do veřejné přístupné cesty. Cesta by měla fungovat přes protokol HTTPS. 
3. Zkopírujte adresu URL úplného vlastního koncového bodu (například https://contoso.com/test/trans.gif) do pole vlastní koncový bod během vytváření testu).

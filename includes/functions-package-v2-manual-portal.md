...
|----------------------|----------------|
|Místní vývoj – knihovny tříd C#       | [Instalace balíčku](../articles/azure-functions/functions-bindings-register.md#c-class-library-with-visual-studio-2019) |
|Místní vývoj - C# skriptu, JavaScript,F# |[Registrace rozšíření](../articles/azure-functions/functions-bindings-register.md#local-development-with-azure-functions-core-tools-and-extension-bundles)         |

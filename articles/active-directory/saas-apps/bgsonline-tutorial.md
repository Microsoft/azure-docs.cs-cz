...
* Uživatelům se automaticky přihlášeni k BGS Online (Single Sign-On) můžete povolit pomocí jejich účtů služby Azure AD.
...
* BGS Online jednotného přihlašování povolená předplatného

## <a name="scenario-description"></a>Popis scénáře

V tomto kurzu konfigurace a testování v testovacím prostředí Azure AD jednotného přihlašování.

* BGS Online podporuje **IDP** jednotné přihlašování zahájené pomocí
...
4. Do vyhledávacího pole zadejte **BGS Online**vyberte **BGS Online** z panelu výsledků klikněte **přidat** tlačítko pro přidání aplikace.

     ![BGS Online v seznamu výsledků](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurace a otestování služby Azure AD jednotného přihlašování

V této části, konfigurace a testování služby Azure AD jednotné přihlašování s BGS Online na základě testovací uživatele volá **Britta Simon**.
Pro jednotné přihlašování pro práci je potřeba navázat vztah odkazu mezi uživatele služby Azure AD a související uživatelské BGS online.
...
2. **[Konfigurace BGS Online Single Sign-On](#configure-bgs-online-single-sign-on)**  – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
3. **[Vytvořit testovacího uživatele Azure AD](#create-an-azure-ad-test-user)**  – Pokud chcete otestovat Azure AD jednotné přihlašování s Britta Simon.
4. **[Přiřadit uživatele Azure AD](#assign-the-azure-ad-test-user)**  – Pokud chcete povolit Britta Simon používat Azure AD jednotného přihlašování.
5. **[Vytvoření BGS Online testovacího uživatele](#create-bgs-online-test-user)**  – Pokud chcete mít protějšek Britta Simon BGS online, který je propojený s Azure AD reprezentace uživatele.
...
1. V [webu Azure portal](https://portal.azure.com/)na **BGS Online** integrace stránce aplikace vyberte **jednotného přihlašování**.
...
4. Na **nastavte si jednotné přihlašování pomocí SAML** stránce, proveďte následující kroky:
    ...
    ![BGS Online domény a adresy URL jednotného přihlašování – informace](common/idp-intiated.png)
...
6. Na **nastavení BGS Online** tématu, zkopírujte příslušné adresy URL podle vašich požadavků.
...
### <a name="configure-bgs-online-single-sign-on"></a>Konfigurace BGS Online jednotného přihlašování

Ke konfiguraci jednotného přihlašování na **BGS Online** straně, je nutné odeslat na stažený **kód XML metadat federace** a vhodné zkopírovaný adresy URL z webu Azure portal [BGS Online tým podpory](mailto:bgsdashboardteam@millwardbrown.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.
...
1. Na webu Azure Portal, vyberte **podnikové aplikace**vyberte **všechny aplikace**a pak vyberte **BGS Online**.

    ![Okno aplikace organizace](common/enterprise-applications.png)

2. V seznamu aplikací vyberte **BGS Online**.

    ![BGS Online odkaz v seznamu aplikací](common/all-applications.png)
...
### <a name="create-bgs-online-test-user"></a>Vytvoření BGS Online testovacího uživatele
...
Když kliknete na dlaždici BGS Online na přístupovém panelu, můžete by měl být automaticky přihlášeni u kterého nastavíte jednotné přihlašování online BGS. Další informace o přístupovém panelu, naleznete v tématu [Úvod k přístupovému panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

...
Pokud připojení k zabezpečenému clusteru, zadejte absolutní cestu k certifikátu (CRT) a soubor klíče (.key) nebo jeden soubor s oběma (.pem). Nezadávejte oba. Volitelně Pokud připojení k zabezpečenému clusteru, zadejte také absolutní cestu k souboru sady certifikační Autority nebo adresář certifikátů důvěryhodné certifikační Autority.
...
| --repliky sady kontrola-časový limit | Nastavení repliky upgradu zkontrolujte vypršení časového limitu v sekundách. |
...
Vrácení změn kódu nebo konfigurace upgrade clusteru Service Fabric.

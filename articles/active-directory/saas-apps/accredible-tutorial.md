...
* Můžete povolit uživatelům být automaticky přihlášeni k Accredible (Single Sign-On) s jejich účty Azure AD.
...
* Podporuje Accredible **IDP** jednotné přihlašování zahájené pomocí
...
V této části je konfigurace a testování Azure AD jednotné přihlašování pomocí Accredible podle testovacího uživatele volá **Britta Simon**.
Pro jednotné přihlašování pro práci je potřeba navázat vztah odkazu mezi uživatele služby Azure AD a související uživatelské v Accredible.
...
2. **[Konfigurace Accredible Single Sign-On](#configure-accredible-single-sign-on)**  – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
3. **[Vytvořit testovacího uživatele Azure AD](#create-an-azure-ad-test-user)**  – Pokud chcete otestovat Azure AD jednotné přihlašování s Britta Simon.
4. **[Přiřadit uživatele Azure AD](#assign-the-azure-ad-test-user)**  – Pokud chcete povolit Britta Simon používat Azure AD jednotného přihlašování.
5. **[Vytvořit testovacího uživatele Accredible](#create-accredible-test-user)**  – Pokud chcete mít protějšek Britta Simon Accredible, který je propojený s Azure AD reprezentace uživatele.
...
1. V [webu Azure portal](https://portal.azure.com/)na **Accredible** integrace stránce aplikace vyberte **jednotného přihlašování**.
...
4. Na **nastavte si jednotné přihlašování pomocí SAML** stránce, proveďte následující kroky:
    ...
    ![Accredible domény a adresy URL jednotného přihlašování – informace](common/idp-intiated.png)
    ...
    b. V **adresy URL odpovědi** textové pole, zadejte adresu URL, pomocí následujícího vzorce: `https://api.accredible.com/v1/saml/admin/<Unique id>/consume`
...
6. Na **nastavení Accredible** tématu, zkopírujte příslušné adresy URL podle vašich požadavků.
...
### <a name="configure-accredible-single-sign-on"></a>Konfigurace Accredible jednotné přihlašování

Ke konfiguraci jednotného přihlašování na **Accredible** straně, je nutné odeslat na stažený **kód XML metadat federace** a vhodné zkopírovaný adresy URL z webu Azure portal [tým podpory Accredible](mailto:support@accredible.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.
...
1. Na webu Azure Portal, vyberte **podnikové aplikace**vyberte **všechny aplikace**a pak vyberte **Accredible**.
...
Po kliknutí na dlaždici Accredible na přístupovém panelu, můžete by měl být automaticky přihlášeni k Accredible, u kterého nastavíte jednotné přihlašování. Další informace o přístupovém panelu, naleznete v tématu [Úvod k přístupovému panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

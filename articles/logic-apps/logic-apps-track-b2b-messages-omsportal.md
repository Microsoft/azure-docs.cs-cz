---
title: Sledování zpráv B2B s využitím protokolů Azure Monitoru
...
1. V části Začínáme **se službou Log Analytics** > **Konfigurace řešení monitorování**vyberte **Zobrazit řešení**.
...
| Logická aplikace | Aplikace logiky, ve které se nastavují akce AS2 |
...
| Logická aplikace | Aplikace logiky, ve které se nastavují akce X12 |
...
| Logická aplikace | Aplikace logiky, ve které se nastavují akce EDIFACT |

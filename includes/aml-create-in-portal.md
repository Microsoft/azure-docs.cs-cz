...
Na panelu hledání zadejte **Machine Learning**. Vyberte **pracovní prostor služby Machine Learning** výsledek hledání.
...
V **pracovní prostor služby Machine Learning** podokno, posuňte se dolů a vyberte **vytvořit** začít.
   ...
   ![Vytvořit](./media/aml-create-in-portal/portal-create-button.png)
...
Chcete-li zahájit proces vytváření, vyberte **vytvořit**. Může trvat několik minut vytvořit pracovní prostor.
...
Po dokončení procesu se zobrazí zpráva o úspěchu nasazení. Je také k dispozici v části oznámení. Chcete-li zobrazit nový pracovní prostor, vyberte **přejít k prostředku**.

...
Také předpokládá, že máte nainstalované rozhraní příkazového řádku Azure a `kubectl` nástroje.
...
Upravte `spec.replicas` pole tak, aby bylo `2` , a klikněte na **aktualizovat**.

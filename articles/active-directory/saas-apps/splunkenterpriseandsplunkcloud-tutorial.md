...
2. **[Nakonfigurujte Splunk Enterprise a cloudové jednotné přihlašování Splunk](#configure-splunk-enterprise-and-splunk-cloud-single-sign-on)** pro konfiguraci nastavení jednotného přihlašování na straně aplikace.
...
### <a name="configure-splunk-enterprise-and-splunk-cloud-single-sign-on"></a>Konfigurace jednotného přihlašování v Splunk Enterprise a Splunk cloudu

Ke konfiguraci jednotného přihlašování na straně **cloudu Splunk Enterprise a Splunk** je potřeba odeslat stažený **soubor XML federačních metadat** a příslušné zkopírované adresy URL z Azure Portal do [týmu podpory Splunk Enterprise a Splunk](https://www.splunk.com/about-us/contact.html#tabs/customer-support). Toto nastavení nastaví, aby bylo správně nastaveno připojení SAML SSO na obou stranách.

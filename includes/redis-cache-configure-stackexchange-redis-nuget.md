...
Balíček NuGet se stáhne a přidá odkazy na požadovaná sestavení pro vaši klientskou aplikaci pro přístup k mezipaměti Azure Azure pro Redis s mezipamětí StackExchange.Azure pro klienta Redis.

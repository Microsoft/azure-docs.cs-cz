...
- **[Azure Key Vault](.../key-vault/key-vault-overview-vnet-service-endpoints)**: Obecně dostupná ve všech veřejných cloudových oblastech Azure.

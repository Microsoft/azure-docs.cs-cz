...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/qumucloud-tutorial/tutorial_qumucloud_samlbase.png)
...
3. Na **Qumu cloudové domény a adresy URL** část, proveďte následující kroky, pokud chcete nakonfigurovat aplikace **IDP** iniciované režimu:
    ...
    ![Qumu cloudové domény a adresy URL jednotné přihlašování informace](./media/qumucloud-tutorial/tutorial_qumucloud_url.png)
...
4. Zkontrolujte **zobrazit upřesňující nastavení adresy URL** a provést následující krok, pokud chcete nakonfigurovat aplikace **SP** iniciované režimu:
    ...
    ![Qumu cloudové domény a adresy URL jednotné přihlašování informace](./media/qumucloud-tutorial/tutorial_qumucloud_url1.png)
...
4. Qumu cloudových aplikací očekává SAML kontrolní výrazy ve specifickém formátu. Nakonfigurujte následující deklarace identity pro tuto aplikaci. Můžete spravovat hodnoty těchto atributů z "**uživatelské atributy**" části na stránce integrace aplikace. Následující snímek obrazovky ukazuje příklad pro tento.
    ...
    ![Konfigurovat jednotné přihlašování](./media/qumucloud-tutorial/attribute.png)
...
5. Klikněte na tlačítko **zobrazit a upravit všechny ostatní atributy uživatele** zaškrtnout políčko **uživatelské atributy** rozbalte atributy. Proveďte následující kroky na každém z zobrazených atributů-
    ...
    ![Konfigurovat jednotné přihlašování](./media/qumucloud-tutorial/tutorial_attribute_04.png)

    b. V **název** textovému poli, zadejte název atributu, který je uvedený na příslušném řádku.

    ![Konfigurovat jednotné přihlašování](./media/qumucloud-tutorial/tutorial_attribute_05.png)
...
6. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/qumucloud-tutorial/tutorial_general_400.png)
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/qumucloud-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **Qumu cloudu**.
    ...
    ![V seznamu aplikací na odkaz Qumu cloudu](./media/qumucloud-tutorial/tutorial_qumucloud_app.png)  

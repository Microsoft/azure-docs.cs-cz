...
> [!NOTE]
> Podpora prostředí Azure PowerShell obnovení lokality pro "*zotavení po havárii pro virtuální počítače Azure*" scénář je aktuálně ve verzi preview. Ne všechny funkce scénář prostřednictvím portálu k dispozici může být k dispozici prostřednictvím Azure PowerShell. Některé z možností scénář není podporován pomocí prostředí Azure PowerShell jsou:

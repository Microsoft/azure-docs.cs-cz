---
title: Kurz `:` použití spravované identity pro přístup k Azure Storage pomocí přístupového klíče – Linux – Azure AD
description: Kurz, který vás provede procesem použití spravované identity přiřazené systémem Linux VM pro přístup k Azure Storage prostřednictvím přístupového klíče.
...
7. Nakonec **vyberte** v rozevíracím seznamu svůj virtuální počítač s Linuxem a klikněte na **Uložit**. 
    ...
    ![Alternativní text k obrázku](./media/msi-tutorial-linux-vm-access-storage/msi-storage-role.png)
...
>[Správa přístupových klíčů k úložišti](../../storage/common/storage-account-create.md)

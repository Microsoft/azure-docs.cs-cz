...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/youearnedit-tutorial/tutorial_youearnedit_samlbase.png)

3. Na **YouEarnedIt domény a adresy URL** část, proveďte následující kroky:

    ![YouEarnedIt domény a adresy URL jednotné přihlašování informace](./media/youearnedit-tutorial/tutorial_youearnedit_url.png)
...
5. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/youearnedit-tutorial/tutorial_general_400.png)
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/youearnedit-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **YouEarnedIt**.
    ...
    ![V seznamu aplikací na YouEarnedIt odkaz](./media/youearnedit-tutorial/tutorial_youearnedit_app.png)  

...
Chcete-li použít ověřování pomocí veřejného klíče SSH, nastavte `authenticationType` jako `SshPublicKey`a kromě obecných konektorů SFTP zavedených v poslední části zadejte následující vlastnosti:

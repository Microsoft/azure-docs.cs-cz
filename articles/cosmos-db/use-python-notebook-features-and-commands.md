...
Výsledky dotazu můžete vyvýstupovat ``%%sql`` do [PANDAS dataframe](https://pandas.pydata.org/pandas-docs/stable/getting_started/dsintro.html#dataframe). Použijte syntaxi: 

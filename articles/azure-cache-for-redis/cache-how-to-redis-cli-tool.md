...
Pokud chcete spustit nástroj příkazového řádku na jiné platformě, mezipaměť pro stahování Azure pro Redis z [ http://redis.io/download ](https://redis.io/download).

...
1. **Ověřili jste parametry pravidla akcí?**  
    ...
    Podívejte se na [dokumentaci pravidla akce](alerts-action-rules.md)nebo příkaz [PowerShell set-AzActionRule pro pravidlo akce](/powershell/module/az.alertsmanagement/set-azactionrule) . 

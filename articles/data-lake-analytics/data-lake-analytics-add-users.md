...
3. V kroku **Vybrat uživatele** vyhledejte uživatele, kterého chcete přidat. Klikněte na tlačítko **vyberte**.
...
5. V kroku **vybrat oprávnění katalogu** vyberte všechny další databáze, ke kterým bude uživatel potřebovat přístup. K odesílání úloh se vyžaduje přístup pro čtení a zápis k hlavní databázi. Až to budete mít, klikněte na **OK**.

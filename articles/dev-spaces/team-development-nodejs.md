---
title: Vývoj týmu pomocí Azure Dev Spaces s využitím Node. js a VS Code
...
ms.locfileid: "74279736"
---
# <a name="team-development-with-azure-dev-spaces-using-nodejs-and-vs-code"></a>Vývoj týmu pomocí Azure Dev Spaces s využitím Node. js a VS Code

...
> | Action | Microsoft. fakturace/billingAccounts/billingProfiles/billingPermissions/Read |  |
> | Action | Microsoft. fakturace/billingAccounts/billingProfiles/Customers/Read |  |
> | Action | Microsoft. fakturace/billingAccounts/billingProfiles/faktur/pricesheet/Download/Action |  |
> | Action | Microsoft. fakturace/billingAccounts/billingProfiles/invoiceSections/billingPermissions/Read |  |
> | Action | Microsoft. fakturace/billingAccounts/billingProfiles/invoiceSections/Read |  |
> | Action | Microsoft. fakturace/billingAccounts/billingProfiles/invoiceSections/Write |  |
...
> | Action | Microsoft. fakturace/billingAccounts/billingProfiles/Write |  |
> | Action | Microsoft. fakturace/billingAccounts/Customers/billingPermissions/Read |  |
> | Action | Microsoft. fakturace/billingAccounts/Customers/Read |  |
> | Action | Microsoft. fakturace/billingAccounts/oddělení/čtení |  |
> | Action | Microsoft. fakturace/billingAccounts/enrollmentAccounts/billingPermissions/Read |  |
> | Action | Microsoft. fakturace/billingAccounts/enrollmentAccounts/Read |  |
> | Action | Microsoft. fakturace/billingAccounts/enrollmentDepartments/billingPermissions/Read |  |
> | Action | Microsoft. fakturace/billingAccounts/Products/Read |  |
> | Action | Microsoft. fakturace/billingAccounts/Read |  |
> | Action | Microsoft. fakturace/billingAccounts/Write |  |
> | Action | Microsoft. fakturace/oddělení/čtení |  |
> | Action | Microsoft. fakturace/registrace/akce |  |
> | Action | Microsoft. fakturace/validateAddress/Write |  |
...
> | Action | Microsoft. ContainerInstance/Locations/Operations/Read | Vypíše operace pro službu Azure Container instance. |
> | Action | Microsoft.ContainerInstance/locations/usages/read | Získejte využití konkrétní oblasti. |
> | Action | Microsoft. ContainerInstance/Operations/Read | Vypíše operace pro službu Azure Container instance. |
...
> | Action | Microsoft. ContainerInstance/serviceassociationlinks/DELETE | Odstraní odkaz na přidružení služby vytvořený poskytovatelem prostředků Azure Container instance v podsíti. |
...
> | Action | Microsoft. DataBox/Operations/Read | Vypíše nebo získá operace. |
...
> | Typ akce | Operace | Popis |
> | --- | --- | --- |
> | Action | Microsoft. Devices/Account/diagnosticSettings/Read | Získá nastavení diagnostiky pro prostředek. |
> | Action | Microsoft. Devices/Account/diagnosticSettings/Write | Vytvoří nebo aktualizuje nastavení diagnostiky pro prostředek. |
> | Action | Microsoft. Devices/Account/logDefinitions/Read | Získá dostupné definice protokolu pro službu IotHub. |
> | Action | Microsoft. Devices/Account/metricDefinitions/Read | Získá dostupné metriky pro službu IotHub. |
...
> | Action | Microsoft.Devices/checkProvisioningServiceNameAvailability/Action | Ověřte, jestli je název služby zřizování k dispozici. |
> | Action | Microsoft. Devices/digitalTwins/DELETE | Odstraní existující účet digitálních vláken a všechny jeho podřízené položky. |
> | Action | Microsoft. Devices/digitalTwins/operationresults/Read | Získání stavu operace proti účtu digitálního vlákna |
> | Action | Microsoft. Devices/digitalTwins/Read | Načte seznam účtů digitálních vláken přidružených k předplatnému. |
> | Action | Microsoft. Devices/digitalTwins/SKU/Read | Získat seznam platných SKU pro účty digitálních vláken |
> | Action | Microsoft. Devices/digitalTwins/Write | Vytvořit nový účet s dvojitými podmnožinou čísel |
...
> | Action | Microsoft. Insights/logs/Tables. vlastní/číst | Čtení dat z libovolného vlastního protokolu |
...
> | Action | Microsoft. Insights/sešity/odstranit | Odstranění sešitu |
> | Action | Microsoft. Insights/sešity/číst | Přečíst sešit |
> | Action | Microsoft. Insights/sešity/zápis | Vytvoří nebo aktualizuje sešit. |
...
> | Action | Microsoft. Network/p2sVpnGateways/getp2svpnconnectionhealthdetailed/Action | Získá podrobný stav připojení P2S VPN pro P2SVpnGateway. |
...
> | Action | Microsoft. Network/privateEndpointRedirectMaps/Read | Načte RedirectMap privátního koncového bodu. |
> | Action | Microsoft. Network/privateEndpointRedirectMaps/Write | Vytvoří privátní koncový bod RedirectMap nebo aktualizuje stávající privátní koncový bod RedirectMap. |
...
> | Action | Microsoft. Network/virtualHubs/routeTables/DELETE | Odstranit VirtualHubRouteTableV2 |
> | Action | Microsoft. Network/virtualHubs/routeTables/Read | Získat VirtualHubRouteTableV2 |
> | Action | Microsoft. Network/virtualHubs/routeTables/Write | Vytvořit nebo aktualizovat VirtualHubRouteTableV2 |
...
> | Action | Microsoft. Network/virtualNetworks/podsítí/unprepareNetworkPolicies/Action | Zrušení přípravy podsítě odebráním použitých zásad sítě |
...
> | Action | Microsoft. Network/virtualRouters/DELETE | Odstraní VirtualRouter |
> | Action | Microsoft. Network/virtualRouters/JOIN/Action | Připojí se k VirtualRouter. Nelze upozorňovat. |
> | Action | Microsoft. Network/virtualRouters/Read | Načte VirtualRouter |
> | Action | Microsoft. Network/virtualRouters/virtualRouterPeerings/DELETE | Odstraní VirtualRouterPeering |
> | Action | Microsoft. Network/virtualRouters/virtualRouterPeerings/Read | Načte VirtualRouterPeering |
> | Action | Microsoft. Network/virtualRouters/virtualRouterPeerings/Write | Vytvoří VirtualRouterPeering nebo aktualizuje existující VirtualRouterPeering. |
> | Action | Microsoft. Network/virtualRouters/Write | Vytvoří VirtualRouter nebo aktualizuje existující VirtualRouter. |
> | Action | Microsoft. Network/virtualWans/DELETE | Odstraní virtuální síť WAN. |
> | Action | Microsoft. Network/virtualwans/generateVpnProfile/Action | Generovat VirtualWanVpnServerConfiguration VpnProfile |
...
> | Action | Microsoft. Network/virtualwans/vpnServerConfigurations/Action | Získat VirtualWanVpnServerConfigurations |
...
> | Action | Microsoft. Network/vpnServerConfigurations/DELETE | Odstranit VpnServerConfiguration |
> | Action | Microsoft. Network/vpnServerConfigurations/Read | Získat VpnServerConfiguration |
> | Action | Microsoft. Network/vpnServerConfigurations/Write | Vytvořit nebo aktualizovat VpnServerConfiguration |
...
> | Action | Microsoft. OperationalInsights/pracovní prostory/dotazy/AmlComputeClusterEvent/číst | Čtení dat z tabulky AmlComputeClusterEvent |
> | Action | Microsoft. OperationalInsights/pracovní prostory/dotazy/AmlComputeClusterNodeEvent/číst | Čtení dat z tabulky AmlComputeClusterNodeEvent |
> | Action | Microsoft. OperationalInsights/pracovní prostory/dotazy/AmlComputeJobEvent/číst | Čtení dat z tabulky AmlComputeJobEvent |
...
> | Action | Microsoft. OperationalInsights/pracovní prostory/dotazy/AppPlatformLogsforSpring/číst | Čtení dat z tabulky AppPlatformLogsforSpring |
...
> | Action | Microsoft. OperationalInsights/pracovní prostory/dotazy/BaiClusterEvent/číst | Čtení dat z tabulky BaiClusterEvent |
> | Action | Microsoft. OperationalInsights/pracovní prostory/dotazy/BaiClusterNodeEvent/číst | Čtení dat z tabulky BaiClusterNodeEvent |
> | Action | Microsoft. OperationalInsights/pracovní prostory/dotazy/BaiJobEvent/číst | Čtení dat z tabulky BaiJobEvent |
...
> | Action | Microsoft. OperationalInsights/pracovní prostory/dotazy/DatabricksInstancePools/číst | Čtení dat z tabulky DatabricksInstancePools |
...
> | Action | Microsoft. RecoveryServices/trezory/backupFabrics/backupProtectionIntent/DELETE | Odstranit záložní záměr ochrany |
...
> | Action | Microsoft. RecoveryServices/trezory/backupFabrics/protectionContainers/DELETE | Odstraní registrovaný kontejner. |
> | Action | Microsoft. RecoveryServices/trezory/backupFabrics/protectionContainers/Dotázat se/Action | Dotazování na úlohy v rámci kontejneru |
> | Action | Microsoft. RecoveryServices/trezory/backupFabrics/protectionContainers/Items/Read | Získat všechny položky v kontejneru |
> | Action | Microsoft. RecoveryServices/trezory/backupFabrics/protectionContainers/operationResults/Read | Načte výsledky operace provedené na kontejneru ochrany. |
...
> | Action | Microsoft. RecoveryServices/trezory/backupFabrics/protectionContainers/protectedItems/Backup/Action | Provede zálohování chráněné položky. |
...
> | Action | Microsoft. RecoveryServices/trezory/backupFabrics/protectionContainers/protectedItems/Read | Vrátí podrobnosti objektu chráněné položky. |
> | Action | Microsoft. RecoveryServices/trezory/backupFabrics/protectionContainers/protectedItems/recoveryPoints/provisionInstantItemRecovery/Action | Zřídit rychlé obnovení položky pro chráněnou položku |
...
> | Action | Microsoft. RecoveryServices/trezory/backupFabrics/protectionContainers/protectedItems/recoveryPoints/Restore/Action | Obnoví body obnovení pro chráněné položky |
> | Action | Microsoft. RecoveryServices/trezory/backupFabrics/protectionContainers/protectedItems/recoveryPoints/revokeInstantItemRecovery/Action | Odvolání okamžitého obnovení položky pro chráněnou položku |
...
> | Action | Microsoft. RecoveryServices/trezory/backupFabrics/protectionContainers/Read | Vrátí všechny registrované kontejnery. |
> | Action | Microsoft. RecoveryServices/trezory/backupFabrics/protectionContainers/Write | Vytvoří registrovaný kontejner. |
...
> | Action | Microsoft. RecoveryServices/trezory/backupJobs/operationResults/Read | Vrátí výsledek operace úlohy. |
...
> | Action | Microsoft. RecoveryServices/trezory/backupOperationResults/Read | Vrátí výsledek operace zálohování trezoru Recovery Services. |
...
> | Action | Microsoft. RecoveryServices/trezory/backupPolicies/DELETE | Odstraní zásady ochrany. |
> | Action | Microsoft. RecoveryServices/trezory/backupPolicies/operationResults/Read | Načte výsledky operace zásad. |
...
> | Action | Microsoft.RecoveryServices/Vaults/backupPolicies/write | Vytvoří zásady ochrany. |
> | Action | Microsoft.RecoveryServices/Vaults/backupProtectableItems/read | Vrátí seznam chránitelných položek. |
> | Action | Microsoft.RecoveryServices/Vaults/backupProtectedItems/read | Vrátí seznam všech chráněných položek. |
> | Action | Microsoft. RecoveryServices/trezory/backupProtectionContainers/Read | Vrátí všechny kontejnery patřící k předplatnému. |
> | Action | Microsoft. RecoveryServices/trezory/backupProtectionIntents/Read | Vypsat všechny záložní záměry ochrany |
> | Action | Microsoft. RecoveryServices/trezory/backupSecurityPIN/Action | Vrátí informace o bezpečnostním PIN kódu pro trezor Recovery Services. |
...
> | Action | Microsoft. RecoveryServices/trezory/backupUsageSummaries/Read | Vrátí souhrny pro chráněné položky a chráněné servery pro Recovery Services. |
...
> | Typ akce | Operace | Popis |
> | --- | --- | --- |
> | Action | Microsoft. Resources/calculateTemplateHash/Action | Vypočítá hodnotu hash poskytnuté šablony. |
...
> | Action | Microsoft. Resources/Deployments/exportTemplate/Action | Exportovat šablonu pro nasazení |
> | Action | Microsoft. Resources/nasazení/operace/čtení | Načte nebo vypíše operace nasazení. |
> | Action | Microsoft. Resources/Deployments/operationstatuses/Read | Získá nebo zobrazí seznam stavů operací nasazení. |
...
> | Action | Microsoft. SQL/managedInstances/encryptionProtector/revalidate/Action | Aktualizuje vlastnosti pro zadanou ochranu pomocí šifrování serveru. |
...
> | Action | Microsoft. SQL/servery/encryptionProtector/revalidate/Action | Aktualizuje vlastnosti pro zadanou ochranu pomocí šifrování serveru. |
...
> | Action | Microsoft. Storage/storageAccounts/privateEndpointConnectionProxies/Read | Získat proxy připojení privátního koncového bodu |

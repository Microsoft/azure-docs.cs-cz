...
Nejprve je nutné povolit protokolování v trezoru klíčů. Použijte následující příkazy Prostředí PowerShell. (Můžete vidět úplné podrobnosti v [tomto článku o key-vault-protokolování](key-vault-logging.md).)

...
5. V části **Revize a spustit replikaci** ověřte nastavení:
    ...
    - **Nastavení rozšíření**. Indikuje, že Site Recovery spravuje aktualizace rozšíření služby mobility Site Recovery, které je nainstalované na virtuálních počítačích, které replikují. Uvedený účet Azure Automation spravuje proces aktualizace.
...
3. Na stránce vlastnosti rozšíření vyberte možnost **odinstalovat**.
   ...
   :::image type="content" source="./media/tutorial-disaster-recovery/uninstall-extension.png" alt-text="Na stránce odinstalujte rozšíření virtuálního počítače Site Recovery.":::

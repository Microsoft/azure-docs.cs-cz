---
title: 'Rychlý start: Rozpoznávání řeči v C# v rozhraní .NET Core ve Windows s využitím sady Cognitive Services Speech SDK'
titleSuffix: Microsoft Cognitive Services
description: Zjistěte, jak rozpoznávat řeč v C# v rozhraní .NET Core ve Windows s využitím sady Cognitive Services Speech SDK.

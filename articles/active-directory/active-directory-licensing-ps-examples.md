...
* [Přiřazení licencí ke skupině ve službě Azure Active Directory](users-groups-roles/licensing-groups-assign.md)
* [Identifikace a řešení problémů pro skupinu v Azure Active Directory](users-groups-roles/licensing-groups-resolve-problems.md)
* [Migrace jednotlivě licencovaných uživatelů na licencování na základě skupiny v Azure Active Directory](users-groups-roles/licensing-groups-migrate-users.md)
* [Azure Active Directory na základě skupin licencí další scénáře](users-groups-roles/licensing-group-advanced.md)

...
Služba CloudSimple logicky odděluje sítě vrstvy 2, které omezují přístup k vašim soukromým sítím v prostředí privátního cloudu. Privátní cloudové sítě můžete dále chránit pomocí brány firewall. Portál CloudSimple umožňuje definovat síťová a NS pravidla řízení síťového provozu pro všechny síťové přenosy, včetně cloudového provozu uvnitř privátního cloudu, privátního cloudového provozu, obecného provozu na internetu a síťového provozu do místního počítače přes IPsec VPN nebo ExpressRoute připojení.

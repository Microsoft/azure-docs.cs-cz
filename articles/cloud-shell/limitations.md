...
* V případě připojeného úložiště jsou trvalé pouze `$Home` změny v adresáři.
...
Název `AzureAD` modulu je v současné `AzureAD.Standard.Preview`době, modul nabízí stejné funkce.

...
10. Na stránce **dokončení instalace Android Studio** .  Klikněte na **Dokončit**.
...
17. Na stránce **stahování součástí** počkejte, dokud nebudou staženy všechny součásti.  Klikněte na **Dokončit**.
...
25 studentů \* (20 plánovaných + 10 kvót) hodin × 55 jednotek testovacího prostředí × 0,01 USD za hodinu = 412,5 USD

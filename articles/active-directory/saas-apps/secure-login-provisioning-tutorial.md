...
3. Určete, jaká data se mají [mapovat mezi Azure AD a SecureLogin](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 

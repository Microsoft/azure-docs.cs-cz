...
Informace o podporované konfiguraci naleznete v [tématu Podporované operační systémy Windows](../../azure-monitor/platform/log-analytics-agent.md#supported-linux-operating-systems) a konfigurace síťové brány [firewall](../../azure-monitor/platform/log-analytics-agent.md#network-firewall-requirements).

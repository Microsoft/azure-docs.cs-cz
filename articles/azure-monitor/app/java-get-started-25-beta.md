---
title: Analýza webových aplikací Java pomocí Azure Application Insights (2.5.0-BETA verze) | Microsoft Docs
description: 'Sledování výkonu aplikací pro webové aplikace v jazyce Java s Application Insights (2.5.0-BETA verze). '
...
[Nainstalujte agenta Java](java-agent-25-beta.md) , abyste mohli zachytit odchozí volání http, dotazy JDBC, protokolování aplikací a lepší pojmenovávání operací.
...
Příchozí konfigurace sady SDK je podrobněji vysvětlena v našem článku [](correlation.md#w3c-distributed-tracing)o korelaci.

...
## <a name="important-configuration-files"></a>Důležité konfigurační soubory
 ...
 >[!NOTE]
 >Úprava konfiguračních souborů pro čítače výkonu a Syslog je přepsán, pokud kolekce je nakonfigurována z [nabídky dat Log Analytics Upřesnit nastavení](log-analytics-data-sources.md#configuring-data-sources) na webu Azure Portal pro váš pracovní prostor. Pokud chcete zakázat konfiguraci pro všechny agenty, zakažte shromažďování od Log Analytics **Upřesnit nastavení** nebo jednom agentovi, spusťte následující příkaz:  
...
### <a name="resolution"></a>Řešení
* Ověřte, že konfigurace v pracovním prostoru Log Analytics pro Syslog má všem zařízením a úrovních protokolování správné. Kontrola [Konfigurovat shromažďování Syslogu na webu Azure Portal](log-analytics-data-sources-syslog.md#configure-syslog-in-the-azure-portal)
...
2. Nainstalujte agenta po [pokyny](log-analytics-quick-collect-linux-computer.md).

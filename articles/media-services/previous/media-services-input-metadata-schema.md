...
| **impulzu**<br /><br /> Vyžadováno |**xs: int** |Zakódovaná Šířka videa v pixelech |
| **Height**<br /><br /> Vyžadováno |**xs: int** |Výška kódovaného videa v pixelech |
...
| **osa**<br /><br /> Vyžadováno |**xs: String** |Hodnota v páru klíč/hodnota. |

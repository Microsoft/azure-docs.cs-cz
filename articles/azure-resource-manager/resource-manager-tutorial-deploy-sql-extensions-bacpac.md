...
Šablona použitá v tomto kurzu je uložen v [účtu služby Azure Storage](https://armtutorials.blob.core.windows.net/createsql/azuredeploy.json). 

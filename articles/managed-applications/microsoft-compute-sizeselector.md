...
- `imageReference` se pro Image od první strany vynechá, ale poskytuje se pro Image třetích stran. Slouží k určení nákladů na software virtuálních počítačů.
...
- @No__t-0 může být 1, 2 nebo 3.
- Ve výchozím nastavení je `hideDiskTypeFilter` **NEPRAVDA**. Filtr typ disku umožňuje uživateli zobrazit všechny typy disků nebo pouze SSD.

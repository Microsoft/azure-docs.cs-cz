...
description: Tuto ukázkovou definici zásad audity, pokud neexistuje žádný správce Azure Active Directory přiřazené k SQL serveru.
author: DCtheGeek
manager: carmonm
...
ms.locfileid: "60545214"
---
# <a name="sample---audit-no-azure-active-directory-administrator"></a>Ukázkový – Audit žádný správce Azure Active Directory

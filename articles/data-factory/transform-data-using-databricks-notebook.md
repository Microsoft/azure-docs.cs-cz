...
1.  V okně **Nová propojená služba** proveďte následující kroky:
    ...
    1.  Jako **název** zadejte * *_AzureDatabricks \_ LinkedService_* _
    
    1.  Vyberte odpovídající *pracovní prostor _ datacihly* *, ve kterém budete Poznámkový blok spouštět.

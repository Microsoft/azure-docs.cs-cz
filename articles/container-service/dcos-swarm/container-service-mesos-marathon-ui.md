...
V tomto příkladu je aplikace spuštěna v uzlu veřejného agenta. K aplikaci budete mít přístup z Internetu, a to tak, že přejdete na plně kvalifikovaný název domény agenta clusteru: `http://[DNSPREFIX]agents.[REGION].cloudapp.azure.com`, kde:
...
* Podrobné informace o službě kontejnerů Azure s Mesos

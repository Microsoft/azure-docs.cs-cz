---
title: Konfigurace testovacích jednotek na komerčním webu Microsoft Marketplace
...
ms.locfileid: "82786542"
---
# <a name="learn-about-test-drive-for-your-offer"></a>Další informace o testovacích jednotkách pro vaši nabídku

Možnost **testovacího disku** na komerčním tržišti společnosti Microsoft vám umožní nakonfigurovat praktickou a samoobslužnou prohlídku klíčových funkcí vašeho produktu. Pomocí testovacích jednotek si noví zákazníci můžou svou nabídku vyzkoušet ještě předtím, než ji nakupují. Další informace najdete v tématu [co je Test Drive?](../cloud-partner-portal/test-drive/what-is-test-drive.md).

Pokud již nechcete poskytnout testovací verzi vaší nabídky, vraťte se na stránku **nastavení nabídky** a zrušte zaškrtněte **možnost Povolit testovací jednotku**.
...
Existuje šablona nasazení, která obsahuje všechny prostředky Azure, které tvoří vaše řešení. To je vhodné pro produkty, které používají jenom prostředky Azure. Přečtěte si další informace o nastavení [Azure Resource Manager testovacích jednotek](../cloud-partner-portal/test-drive/azure-resource-manager-test-drive.md).
...
- **Název role** (povinné): zadejte název role zabezpečení, který jste definovali ve vlastní testovací jednotce Dynamics 365. Tato funkce se uživateli přiřadí během zkušební jednotky (například Test-Drive-role).
...
- **ID tenanta Azure AD** (povinné): zadejte [ID TENANTA](https://docs.microsoft.com/azure/active-directory/develop/howto-create-service-principal-portal#get-values-for-signing-in)Azure Active Directory (AD). Chcete-li zjistit toto ID, přihlaste se k [Azure Portal](https://portal.azure.com/), v levé nabídce vyberte kartu Active Directory, vyberte možnost **vlastnosti** a vyhledejte číslo **ID adresáře** uvedené (například `50c464d3-4930-494c-963c-1e951d15360e`). ID tenanta vaší organizace můžete také vyhledat pomocí adresy URL vašeho názvu domény na adrese: [https://www.whatismytenantid.com](https://www.whatismytenantid.com).

...
* Povolit agenta Java In-Process od [agenta java In-Process pro průvodce Application Insights](https://docs.microsoft.com/azure/spring-cloud/spring-cloud-howto-application-insights#enable-java-in-process-agent-for-application-insights). 

* Povolte kolekci dimenzí pro resilience4j metriky z [průvodce Application Insights](https://docs.microsoft.com/azure/azure-monitor/app/pre-aggregated-metrics-log-metrics#custom-metrics-dimensions-and-pre-aggregation).

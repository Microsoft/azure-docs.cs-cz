---
title: Ukázek Azure PowerShell pro Azure Blob storage | Microsoft Docs
description: Ukázky pro práci s úložištěm Azure Blob Azure PowerShell
services: storage
...
ms.locfileid: "27535225"
---
# <a name="azure-powershell-samples-for-azure-blob-storage"></a>Ukázky pro úložiště objektů Azure Blob Azure PowerShell

Následující tabulka obsahuje odkazy na ukázky skriptu prostředí PowerShell, které vytvářet a spravovat úložiště Azure.
...
| [Migrace mezi různými účty úložiště v systému Windows pomocí nástroje AzCopy objektů BLOB](../scripts/storage-common-transfer-between-storage-accounts.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Migrace objektů BLOB mezi účty Azure Storage pomocí AzCopy v systému Windows. |
|**Blob Storage**||

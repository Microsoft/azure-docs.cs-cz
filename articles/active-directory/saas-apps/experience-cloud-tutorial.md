...
Pokud chcete nakonfigurovat jednotné přihlašování na straně **cloudu** , je potřeba odeslat stažený **soubor XML federačních metadat** a příslušné zkopírované adresy URL z Azure Portal v [týmu podpory cloudu](mailto:support@medallia.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

### <a name="create-experience-cloud-test-user"></a>Uživatel cloudového testu pro vytváření zkušeností

V této části vytvoříte uživatele s názvem B. Simon v cloudu. Pokud chcete přidat uživatele na cloudové platformě zkušeností, pracujte se sadou [Cloud Support](mailto:support@medallia.com) . Uživatelé musí vytvořit a aktivovat, než použití jednotného přihlašování.

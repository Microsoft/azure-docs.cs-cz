...
3. Určete, jaká data se mají [mapovat mezi Azure AD a synchronizovat globální přenos identity](../app-provisioning/customize-application-attributes.md). 
...
Přidejte globální synchronizaci identity Relay z Galerie aplikací Azure AD a začněte spravovat zřizování pro globální synchronizaci identity Relay. Další informace o přidání aplikace z Galerie [najdete tady](../manage-apps/add-application-portal.md). 

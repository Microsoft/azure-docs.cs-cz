...
Klient detektoru anomálií je objekt [AnomalyDetectorClient](/javascript/api/@azure/cognitiveservices-anomalydetector/anomalydetectorclient) , který se ověřuje v Azure pomocí vašeho klíče. Klient může provádět detekci anomálií pro celou datovou sadu pomocí [entireDetect ()](/javascript/api/@azure/cognitiveservices-anomalydetector/anomalydetectorclient#entiredetect-request--servicecallback-entiredetectresponse--)nebo k nejnovějšímu datovému bodu pomocí [LastDetect ()](/javascript/api/@azure/cognitiveservices-anomalydetector/anomalydetectorclient#lastdetect-request--msrest-requestoptionsbase-). Metoda [ChangePointDetectAsync](https://go.microsoft.com/fwlink/?linkid=2090788) detekuje body, které označují změny trendu. 

Data časové řady se odesílají jako řada [bodů](/javascript/api/@azure/cognitiveservices-anomalydetector/point) v objektu [Request](/javascript/api/@azure/cognitiveservices-anomalydetector/request) . `Request`Objekt obsahuje vlastnosti pro popis dat (například[členitosti](/javascript/api/@azure/cognitiveservices-anomalydetector/request#granularity) ) a parametrů pro detekci anomálií. 

Odezva detektoru anomálií je objekt [LastDetectResponse](/javascript/api/@azure/cognitiveservices-anomalydetector/lastdetectresponse), [EntireDetectResponse](/javascript/api/@azure/cognitiveservices-anomalydetector/entiredetectresponse)nebo [ChangePointDetectResponse](https://go.microsoft.com/fwlink/?linkid=2090788) v závislosti na použité metodě. 
...
Vytvořte instanci objektu [AnomalyDetectorClient](/javascript/api/@azure/cognitiveservices-anomalydetector/anomalydetectorclient) s vaším koncovým bodem a přihlašovacími údaji.
...
Přečtěte si datový soubor pomocí metody knihovny CSV-Parse `readFileSync()` a soubor Analyzujte pomocí `parse()` . Pro každý řádek nasaďte objekt [Point](/javascript/api/@azure/cognitiveservices-anomalydetector/point) obsahující časové razítko a číselnou hodnotu.

[!code-javascript[Read the data file](~/cognitive-services-quickstart-code/javascript/AnomalyDetector/anomaly_detector_quickstart.js?name=readFile)]

## <a name="detect-anomalies-in-the-entire-data-set"></a>Detekovat anomálie v celé sadě dat 

Zavolejte rozhraní API pro detekci anomálií prostřednictvím celé časové řady jako dávky s metodou [entireDetect ()](/javascript/api/@azure/cognitiveservices-anomalydetector/anomalydetectorclient#entiredetect-request--msrest-requestoptionsbase-) klienta. Uložte vrácený objekt [EntireDetectResponse](/javascript/api/@azure/cognitiveservices-anomalydetector/entiredetectresponse) . Iterujte v seznamu odpovědí `isAnomaly` a vytiskněte index všech `true` hodnot. Tyto hodnoty odpovídají indexu datových bodů neobvyklé, pokud byly nalezeny.
...
Zavolejte rozhraní API pro detekci anomálií, abyste zjistili, jestli je váš nejnovější datový bod anomálií pomocí metody [lastDetect ()](/javascript/api/@azure/cognitiveservices-anomalydetector/anomalydetectorclient#lastdetect-request--msrest-requestoptionsbase-) klienta, a uložte vrácený objekt [LastDetectResponse](/javascript/api/@azure/cognitiveservices-anomalydetector/lastdetectresponse) . `isAnomaly`Hodnota odpovědi je logická hodnota, která určuje stav anomálie tohoto bodu.  

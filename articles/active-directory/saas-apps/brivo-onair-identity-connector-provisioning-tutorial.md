...
* Tenant Azure AD
* [Tenant Brivo OnAir identity Connector](https://www.brivo.com/quote)
...
5. V části **přihlašovací údaje správce** zadejte `https://scim.brivo.com/ActiveDirectory/v2/` na **adrese URL tenanta**. Zadejte hodnotu **SCIM tokenu ověřování** získanou dříve v **tajném tokenu**. Klikněte na **Test připojení** a ujistěte se, že se služba Azure AD může připojit k Brivo OnAir identity Connector. Pokud se připojení nepovede, ujistěte se, že váš účet Brivo OnAir identity Connector má oprávnění správce, a zkuste to znovu.

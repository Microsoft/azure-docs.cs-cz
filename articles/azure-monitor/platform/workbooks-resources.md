---
title: Vytváření interaktivních sestav pomocí Azure Monitorch sešitů | Parametry prostředku | Dokumentace Microsoftu
...
5. Získat data z: `Query`
    ...
    2. Předplatná: `Use default subscriptions`

...
3. **[Vytvořte dokonalá testovacího uživatele](#create-a-clever-test-user)**  – Pokud chcete mít protějšek Britta Simon Clever, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **chytřejší domény a adresy URL** části, proveďte následující kroky:
...
5. Chytřejší aplikace očekává, že kontrolní výrazy SAML v určitém formátu, které je potřeba přidat vlastní atribut mapování vaší **atributy tokenu SAML** konfigurace.
...
8. V okně jiné webové prohlížeče Přihlaste se k serveru vaší společnosti na dokonalá jako správce.
...
10. Na **rychlé přihlášení** stránce, proveďte následující kroky:

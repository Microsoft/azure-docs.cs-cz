...
- To [parametr pro analýzu sítě problému a alternativní řešení](https://blogs.msdn.microsoft.com/turgays/20../../parameter-sniffing-problem-and-possible-workarounds/) blogový příspěvek

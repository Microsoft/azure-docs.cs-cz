...
5. Držitel účtu AAD obdrží e-mail a provede odkaz k potvrzení jeho účtu předtím, než se aktivuje. K zřizování uživatelských účtů AAD můžete použít jakékoli jiné nástroje pro vytváření uživatelských účtů nebo rozhraní API od zástupce, které poskytuje náměstek.

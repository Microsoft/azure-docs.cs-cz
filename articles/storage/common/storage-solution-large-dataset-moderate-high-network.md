...
---
# <a name="data-transfer-for-large-datasets-with-moderate-to-high-network-bandwidth"></a>Přenos dat pro velké datové sady se střední a vysokou šířkou pásma sítě
...
|    Datový typ                        |    Azure Blobs                  |    Azure Blobs<br>Soubory Azure                    |    Azure Blobs<br>Soubory Azure            |    Azure Blobs<br>Soubory Azure          |
|    Formulářový faktor                      |    5 SSD na objednávku             |    1 X 50-kg zařízení velikosti stolního počítače na jednu objednávku    |    1 X ~500-lbs. velké zařízení na jednu objednávku    |    Až 10 HDD/SSD na objednávku        |
...
|    Integrace partnerských řešení              |    Někteří                         |    [Maximální](https://azuremarketplace.microsoft.com/campaigns/databox/azure-data-box)                                          |    [Maximální](https://azuremarketplace.microsoft.com/campaigns/databox/azure-data-box)                                  |    Někteří                                |
...
|    Počáteční nastavení jednorázového času     |    Jednoduchost               |    Pokročilé                       |    Snadné (< 30 minut) až střední (1-2 hodin)            |    Množství                                                          |
|    Předběžné zpracování dat              |    Ne                                        |    Ne                                        |    Ano (s využitím hraničních výpočtů)                               |    Ano                                                                |
|    Přenos z jiných cloudů       |    Ne                                        |    Ne                                        |    Ne                                                    |    Ano                                                                |
|    Typ uživatele                        |    IT specialisté a vývoj                                       |    Vývoj                                       |    Profesionál v oblasti IT                                                |    Profesionál v oblasti IT                                                             |

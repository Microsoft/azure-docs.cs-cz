...
V případě virtuálních počítačů se systémem Linux by se měly ve výchozím nastavení spouštět `saptune` s profilem SAP-pomocného systému Linux, takže se dá ověřit pomocí příkazu.  
...
| Verze protokolu SAP pomocného mechanismu | 16,3 PL 7 nebo vyšší | 16,3 PL 7 nebo vyšší | --- |
...
- Nasazení SAP pomocného mechanismu 16,3 PL7 nebo vyšší
...
Úvodní stránka pro verzi [Sybase POmocného mechanismu pro PL7 16,3](https://help.sap.com/viewer/product/SAP_ASE/16.0.3.7/en-US) obsahuje odkazy na různé dokumenty, na kterých dokumenty:
...
[Bezobslužný poinstalační program pro Sybase má vždy zapnutou instalaci uzlu nástroje DR.](https://techcommunity.microsoft.com/t5/running-sap-applications-on-the/installation-procedure-for-sybase-16-3-patch-level-3-always-on/ba-p/368199) 

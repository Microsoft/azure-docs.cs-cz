...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/iriusrisk-tutorial/tutorial_iriusrisk_samlbase.png)

3. Na **IriusRisk domény a adresy URL** část, proveďte následující kroky:

    ![IriusRisk domény a adresy URL jednotné přihlašování informace](./media/iriusrisk-tutorial/tutorial_iriusrisk_url.png)
...
5. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/iriusrisk-tutorial/tutorial_general_400.png)
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/iriusrisk-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **IriusRisk**.
    ...
    ![V seznamu aplikací na IriusRisk odkaz](./media/iriusrisk-tutorial/tutorial_iriusrisk_app.png)  

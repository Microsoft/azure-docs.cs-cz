...
1. Přejít na stránku **Moje aplikace** na [https://myapps.microsoft.com](https://myapps.microsoft.com).
...
> [Povolit Multi-Factor Authentication Azure na základě rizik](tutorial-mfa-applications.md)

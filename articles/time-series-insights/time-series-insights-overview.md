---
title: 'Přehled: co je Azure Time Series Insights? | Microsoft Docs'
...
[Vývojový diagram @no__t – 1Time Series Insights](media/overview/time-series-insights-flowchart.png)](media/overview/time-series-insights-flowchart.png#lightbox)

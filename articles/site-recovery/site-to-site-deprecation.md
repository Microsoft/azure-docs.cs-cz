---
title: Vyřazení zotavení po havárii mezi weby spravovanými zákazníkem (s VMM) pomocí Azure Site Recovery | Microsoft Docs
...
ms.locfileid: "74040395"
---
# <a name="deprecation-of-disaster-recovery-between-customer-managed-sites-with-vmm-using-azure-site-recovery"></a>Vyřazení zotavení po havárii mezi weby spravovanými zákazníkem (s VMM) pomocí Azure Site Recovery
...
> [!IMPORTANT]
> Všimněte si, že nemusíte provádět kroky v části Příprava nástroje VMM.

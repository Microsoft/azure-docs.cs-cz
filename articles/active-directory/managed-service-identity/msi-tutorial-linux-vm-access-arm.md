...
---
# <a name="use-a-user-assigned-identity-on-a-linux-vm-to-access-azure-resource-manager"></a>Použít identitu uživatele přiřazené na virtuální počítač s Linuxem, přístup k Azure Resource Manager

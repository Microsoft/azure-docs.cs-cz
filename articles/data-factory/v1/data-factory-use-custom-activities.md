...
> [!NOTE]
> Tento článek se týká verze 1 služby Data Factory. Pokud používáte aktuální verze služby Data Factory, přečtěte si téma [vlastní aktivity v V2](../transform-data-using-dotnet-custom-activity.md).

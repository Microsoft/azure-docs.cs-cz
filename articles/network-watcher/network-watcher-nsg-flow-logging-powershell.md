...
Podrobná specifikace všech příkazů protokolů toku NSG pro různé verze AzPowerShell najdete [tady](https://docs.microsoft.com/powershell/module/az.network/#network-watcher) .

---
title: Příprava virtuálního pevného disku s Debian Linux v Azure | Microsoft Docs
...
4. Upravte soubor a upravte parametr GRUB_CMDLINE_LINUX následujícím způsobem, aby zahrnoval další parametry jádra pro Azure. `/etc/default/grub`

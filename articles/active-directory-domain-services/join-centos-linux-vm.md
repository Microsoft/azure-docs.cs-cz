...
Tady je "contoso.com" název domény DNS vaší spravované domény. contoso-CentOS je název hostitele virtuálního počítače s CentOS, ke kterému se připojujete, ke spravované doméně.
...
2. Inicializujte Kerberos. Do terminálu SSH zadejte následující příkaz:
    ...
    > [!TIP]
    > * Zadejte uživatele, který patří do skupiny Správci AAD DC. V případě potřeby [přidejte uživatelský účet do skupiny v Azure AD](../active-directory/fundamentals/active-directory-groups-members-azure-portal.md) .

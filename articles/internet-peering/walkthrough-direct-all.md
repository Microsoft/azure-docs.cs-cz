---
title: Názorný postup přímého partnerského vztahu
titleSuffix: Azure
description: Názorný postup přímého partnerského vztahu
...
---
# <a name="direct-peering-walkthrough"></a>Názorný postup přímého partnerského vztahu
...
> pracovní postup ![přímým partnerským vztahem a stavy připojení](./media/direct-peering.png)
...
## <a name="convert-a-legacy-direct-peering-to-azure-resource"></a>Převod starší verze přímého partnerského vztahu na prostředek Azure

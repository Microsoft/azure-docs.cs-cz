...
-   Pomocí e-mailové adresy, která patří do domény vaší\'společnosti, vytvořte účet Microsoft a nikoli jenom jednu jednotlivou osobu. Například WindowsApps\@Fabrikam.com.
...
| Vývojářský profil     | Spuštění konceptu    | Příprava       | Publikovat bezplatnou šablonu a šablonu řešení   | Publikování komerčních   |
|---------------------- |----------------   |-----------    |-------------------------------------  |---------------------  |

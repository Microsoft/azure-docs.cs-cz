...
description: Použijte skript rozhraní příkazového řádku Azure CLI k filtrování příchozího a odchozího síťového provozu virtuálního počítače pomocí front-endové a back-endové podsítě.

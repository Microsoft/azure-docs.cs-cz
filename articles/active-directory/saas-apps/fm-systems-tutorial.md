...
2. Na webu **Správa systému \> spravovat zabezpečení \> uživatelé \> seznamu uživatelů**.
...
Když na přístupovém panelu kliknete na dlaždici FM: Systems, měli byste být automaticky přihlášení do systémů FM: systémy, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

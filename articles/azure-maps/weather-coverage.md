...
| Symbol | Význam |
|--------|---------|
|*       |Pokrývá aktuální podmínky, hodinové prognózy, předpovědi čtvrtletních dnů, denní předpovědi, počasí v rámci tras a denních indexů. |


## <a name="americas"></a>Amerika

| Země              |  Satelitní dlaždice | Minutová prognóza, paprskové dlaždice | Závažné výstrahy počasí | Jiná |
|-----------------------------|:----------------:|:-----------------:|:-----------------:|:--------:|  
| Anguilla                                 | ✓ |   | |  ✓| 
| Antarktida                               | ✓ |   | |✓|
| Antigua a Barbuda                      | ✓ |   | |✓| 

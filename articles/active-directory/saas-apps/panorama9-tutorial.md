...
2. **[Nakonfigurujte jednotné přihlašování Panorama9](#configure-panorama9-single-sign-on)** – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.

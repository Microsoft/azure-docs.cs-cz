...
description: Obsahuje odkazy na dokumentaci pro systémová zobrazení podporovaná v SQL Analytics.
...
ms.locfileid: "78198299"
---
# <a name="system-views-supported-in-sql-analytics"></a>Systémová zobrazení podporovaná v SQL Analytics
...
## <a name="sql-server-dmvs-applicable-to-sql-analytics"></a>SQL Server zobrazení dynamické správy, které se vztahují k analýze SQL
Následující zobrazení dynamické správy se vztahují na SQL Analytics, ale je nutné ji spustit připojením k **Hlavní** databázi.
...
* [sys. přihlašovací údaje](https://msdn.microsoft.com/library/ms189745.aspx)
...
* [sys. souborů – skupiny](https://msdn.microsoft.com/library/ms187782.aspx)
...
* [sys. indexs](https://msdn.microsoft.com/library/ms173760.aspx)
...
* [sys. synonyma](https://msdn.microsoft.com/library/ms189458.aspx)
...
* [sys. tabulce syslanguages](https://msdn.microsoft.com/library/ms190303.aspx)
...
* [zobrazení sys. views](https://msdn.microsoft.com/library/ms190334.aspx)

## <a name="sql-server-dmvs-available-in-sql-analytics"></a>SQL Server zobrazení dynamické správy k dispozici v analýze SQL
SQL Analytics zpřístupňuje mnoho SQL Serverch zobrazení dynamické správy (zobrazení dynamické správy). Tato zobrazení, při dotazování ve službě SQL Analytics, hlásí stav databází SQL spuštěných v distribucích.

SQL Analytics a Parallel Data Warehouse (PDW) používají stejná systémová zobrazení. Každý DMV má sloupec s názvem pdw_node_id, což je identifikátor pro výpočetní uzel. 
...
| Název DMV v SQL Analytics | SQL Server článek Transact-SQL|
|:--- |:--- |
...
## <a name="sql-server-2016-polybase-dmvs-available-in-sql-analytics"></a>Zobrazení dynamické správy 2016, který je k dispozici v SQL Analytics SQL Server
Následující zobrazení dynamické správy se vztahují na SQL Analytics, ale je nutné ji spustit připojením k **Hlavní** databázi.
...
Další referenční informace najdete v tématu [příkazy jazyka t-SQL ve SQL Analytics](sql-data-warehouse-reference-tsql-statements.md)a [prvcích jazyka t-SQL v tématu SQL Analytics](sql-data-warehouse-reference-tsql-language-elements.md).

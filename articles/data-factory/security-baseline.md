...
description: Základní Azure Data Factory zabezpečení poskytuje postupy a prostředky pro implementaci doporučení zabezpečení uvedených v srovnávacím testu zabezpečení Azure.
author: msmbaldwin
...
Tato základní hodnota zabezpečení platí pro Azure Data Factory pokynů od [zabezpečení Azure Security test 1,0](../security/benchmarks/overview-v1.md) . Azure Security Benchmark poskytuje doporučení, jak můžete zabezpečit svá cloudová řešení v Azure.
Obsah je seskupen podle **řízení zabezpečení** definovaného srovnávacím testem zabezpečení Azure a souvisejících pokynů, které se vztahují na Azure Data Factory. **Ovládací prvky** , které se nevztahují k Azure Data Factory byly vyloučeny.

Pokud chcete zjistit, jak Azure Data Factory kompletně mapuje srovnávací test zabezpečení Azure, přečtěte si [kompletní Azure Data Factory soubor mapování standardních hodnot zabezpečení](https://github.com/MicrosoftDocs/SecurityBenchmarks/tree/master/Azure%20Offer%20Security%20Baselines).

## <a name="network-security"></a>Zabezpečení sítě

*Další informace najdete v článku [Srovnávací test zabezpečení Azure: zabezpečení sítě](../security/benchmarks/security-control-network-security.md).*
...
*Další informace najdete v tématu [srovnávací testy zabezpečení Azure: protokolování a monitorování](../security/benchmarks/security-control-logging-monitoring.md).*
...
*Další informace najdete v článku [Srovnávací test zabezpečení Azure: identita a Access Control](../security/benchmarks/security-control-identity-access-control.md).*
...
**Doprovodné** materiály: Azure Data Factory používá Azure Active Directory (Azure AD) k poskytnutí přístupu k Azure Portal a také ke konzole Azure Data Factory. Azure AD nemá koncept výchozích hesel, ale zodpovídáte za změnu nebo povolení výchozích hesel pro jakékoli vlastní aplikace nebo aplikace třetích stran.
...
Pokud používáte Integration Runtime na virtuálním počítači Azure, účty správců v Azure Virtual Machines se dají nakonfigurovat taky pomocí Azure Privileged identity Manageru (PIM). Azure Privileged Identity Manager nabízí několik možností, jako jsou například zvýšení úrovně oprávnění k přístupu k datům, vícefaktorové ověřování a možnosti delegování, aby tato oprávnění byla dostupná jenom pro určité časové rámce a vyžadovala druhou osobu ke schválení.
...
**Pokyny**: použijte Azure Active Directory (Azure AD) jako centrální ověřování a systém autorizace pro vaše prostředky Azure Data Factory, jako je Azure SQL Database nebo Virtual Machines Azure. V případě odchylky chování přihlášení k účtu na rovině ovládacího prvku (Azure Portal) použijte funkce Azure AD Identity Protection a detekce rizik ke konfiguraci automatizovaných odpovědí na zjištěné podezřelé akce týkající se identit uživatelů. Můžete také ingestovat data do služby Azure Sentinel pro další šetření.
...
**Pokyny**: pokud používáte Integration runtime na virtuálním počítači Azure, můžete použít nativní skener ohrožení zabezpečení. Skener ohrožení zabezpečení, který je součástí Azure Security Center, je napájený pomocí Qualys. Qualys je špičkovým nástrojem pro identifikaci ohrožení zabezpečení v reálném čase v Azure Virtual Machines.
...
*Další informace najdete v článku [Srovnávací test zabezpečení Azure: inventář a Správa prostředků](../security/benchmarks/security-control-inventory-asset-management.md).*
...
*Další informace najdete v tématu [srovnávací konfigurace Azure Security: zabezpečení](../security/benchmarks/security-control-secure-configuration.md).*
...
**Doprovodné** materiály: při vytváření datové továrny je možné vytvořit spravovanou identitu společně s vytvářením továrny. Spravovaná identita je spravovaná aplikace zaregistrovaná ve službě Azure Active Directory (Azure AD), která představuje tuto specifickou datovou továrnu.
...
*Další informace najdete v tématu [srovnávací testy zabezpečení Azure: obnovení dat](../security/benchmarks/security-control-data-recovery.md).*
...
**Doprovodné** materiály: Pokud spouštíte Integration runtime na virtuálním počítači Azure, povolte Azure Backup a cílové virtuální počítače Azure a požadovanou frekvenci a dobu uchování. Zálohujte klíče spravované zákazníkem v rámci Azure Key Vault.
...
*Další informace najdete v tématu [srovnávací testy zabezpečení Azure: reakce na incidenty](../security/benchmarks/security-control-incident-response.md).*
...
*Další informace najdete v článku [srovnávací testy zabezpečení Azure: testování průniku a cvičení červeného týmu](../security/benchmarks/security-control-penetration-tests-red-team-exercises.md).*

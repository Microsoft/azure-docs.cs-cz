...
| Hostitel | Určuje kořenovou cestu ke složce, kterou chcete zkopírovat. Použijte řídicí znak " \" pro speciální znaky v řetězci. Příklady najdete v tématu [Ukázka propojené služby a definice datových sad](#sample-linked-service-and-dataset-definitions) . | Ano |

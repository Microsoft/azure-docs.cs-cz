...
Přečtěte si další informace o [rutinách PowerShellu pro spravovanou instanci Azure SQL](../managed-instance/api-references-create-manage-instance.md#powershell-create-and-manage-managed-instances).

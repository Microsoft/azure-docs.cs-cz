...
- [Integrace s Azure Event Grid](concept-event-grid-integration.md) umožňuje působit na události v průběhu životního cyklu ml. Například události registrace modelu, nasazení, posunu dat a školení (spustit).

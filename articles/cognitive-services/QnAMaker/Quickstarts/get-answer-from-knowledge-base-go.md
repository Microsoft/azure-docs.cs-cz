...
Kód pro tento rychlý Start je v úložišti [https://github.com/Azure-Samples/cognitive-services-qnamaker-Go](https://github.com/Azure-Samples/cognitive-services-qnamaker-Go/tree/master/documentation-samples/quickstarts/get-answer) . 
...
Nad funkcí `main`, v horní části souboru `get-answer.go`, přidejte do projektu nezbytné závislosti:
...
V horní části funkce `main` přidejte požadované konstanty pro přístup k QnA Maker. Tyto hodnoty jsou po publikování znalostní báze na stránce **publikovat** . 

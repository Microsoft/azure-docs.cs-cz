...
|Integrace trezoru klíčů |Aplikační brána nyní podporuje integraci s trezorem klíčů (ve verzi Public Preview) pro serverové certifikáty, které jsou připojeny k naslouchacím líným a listenerům s povoleným protokolem HTTPS. Viz [Ukončení SSL s certifikáty trezoru klíčů](key-vault-certs.md). |Duben 2019 |
...
|Stránky vlastních chyb     |Pomocí vlastních chybových stránek můžete vytvořit chybovou stránku ve formátu zbytku webů. Chcete-li to povolit, [přečtěte si téma Vytvoření vlastních chybových stránek brány aplikace](custom-error.md).|Září 2018|

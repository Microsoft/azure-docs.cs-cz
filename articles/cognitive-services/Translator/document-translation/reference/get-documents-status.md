---
title: Získat stav dokumentů
titleSuffix: Azure Cognitive Services
description: Metoda get Documents status vrátí stav pro všechny dokumenty v žádosti o překlad dokumentu Batch.
...
ms.locfileid: "107864859"
---
# <a name="get-documents-status"></a>Získat stav dokumentů

Metoda get Documents status vrátí stav pro všechny dokumenty v žádosti o překlad dokumentu Batch.
...
## <a name="get-documents-status-response"></a>Odpověď na stav získání dokumentů

### <a name="successful-get-documents-status-response"></a>Úspěšná odpověď na stav získání dokumentů

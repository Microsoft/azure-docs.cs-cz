...
> [!IMPORTANT]
> Lovecké živě ve službě Azure Sentinel jsou momentálně ve verzi Public Preview.
...
1. V Azure Portal přejděte na **Sentinel** > **Threat Management** > **lov**.
...
Vyberte oznámení a otevřete okno **živě** .

---
title: 'Kurz: Integrace Azure Active Directory se službou Vidyard | Dokumentace Microsoftu'
...
ms.locfileid: "39056221"
---
# <a name="tutorial-azure-active-directory-integration-with-vidyard"></a>Kurz: Integrace Azure Active Directory se službou Vidyard
...
3. **[Vytvoření zkušebního uživatele Vidyard](#create-a-vidyard-test-user)**  – Pokud chcete mít protějšek Britta Simon Vidyard, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **Vidyard domény a adresy URL** části, proveďte následující kroky, pokud chcete nakonfigurovat aplikace v **IDP** iniciované režimu:
...
7. Na **Vidyard konfigurace** klikněte na tlačítko **nakonfigurovat Vidyard** otevřete **nakonfigurovat přihlašování** okna. Kopírovat **SAML jednotné přihlašování – adresa URL služby** z **Stručná referenční příručka oddílu.**

    ![Konfigurace Vidyard](./media/vidyard-tutorial/tutorial_vidyard_configure.png)

8. V okně jiné webové prohlížeče Přihlaste se k serveru vaší společnosti Vidyard softwaru jako správce.
...
11. V **konfigurace SAML** části, proveďte následující kroky:
...
12. Na kartě Single Sign On, vyberte **přiřadit** vedle existujícího profilu
...
13. Vyberte skupiny organizace, který se zobrazí v **skupiny k dispozici k přiřazení**.

    ![Konfigurace Vidyard](./media/vidyard-tutorial/configure5.png)

14. Přiřazené skupiny v části můžete zobrazit **aktuálně přiřazené skupiny**. Vyberte roli pro skupinu podle vaší organizace a klikněte na **potvrdit**.

---
title: Vyhodnoťte fyzické servery pro migraci do Azure pomocí Azure Migrate
description: Popisuje postup vyhodnocení místních fyzických serverů pro migraci do Azure pomocí Azure Migrate.
author: rashi-ms
ms.author: rajosh
ms.manager: abhemraj
ms.topic: tutorial
...
V tomto článku se dozvíte, jak pomocí nástroje Azure Migrate: Discovery and Assessment zhodnotit místní fyzické servery pro migraci do Azure.
...
- Než budete postupovat podle tohoto kurzu a vyhodnoťte vaše servery pro migraci na virtuální počítače Azure, ujistěte se, že jste zjistili servery, které chcete vyhodnotit:
    - Pokud chcete zjistit servery pomocí Azure Migrate zařízení, [postupujte podle tohoto kurzu](tutorial-discover-physical.md). 
    - Pokud chcete zjistit servery pomocí importovaného souboru CSV, [postupujte podle tohoto kurzu](tutorial-discover-import.md).
- Ujistěte se, že fyzické servery, které chcete vyhodnotit, nepoužívají systém Windows Server 2003 nebo SUSE Linux. Posouzení není pro tyto servery podporováno.

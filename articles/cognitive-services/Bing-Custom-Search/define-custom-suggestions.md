...
Každý návrh zahrnuje pole `displayText` a `query` . `displayText` Pole obsahuje navrhovaný řetězec dotazu, který použijete k naplnění rozevíracího seznamu vyhledávacího pole.

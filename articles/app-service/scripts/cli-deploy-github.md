---
title: Ukázkový skript Azure CLI – Vytvoření webové aplikace s nasazením z GitHubu | Microsoft Docs
...
Tento ukázkový skript vytvoří ve službě App Service webovou aplikaci se souvisejícími prostředky. Pak nasadí kód vaší webové aplikace z veřejného úložiště GitHub (bez průběžného nasazování). Informace o nasazení z GitHubu s průběžným nasazováním najdete v tématu [Vytvoření webové aplikace s průběžným nasazováním z GitHubu](cli-continuous-deployment-github.md).

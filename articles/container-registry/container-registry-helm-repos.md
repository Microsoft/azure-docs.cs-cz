...
- **Azure CLI version 2.0.46 or later** - Run `az --version` to find the version. Pokud potřebujete instalaci nebo upgrade, přečtěte si téma [Instalace Azure CLI][azure-cli-install].

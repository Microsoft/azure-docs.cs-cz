                                                        ...
                                                        <div class="cardPadding">
                                                            <div class="card">
                                                                ...
                                                                <div class="cardText" style="padding-left: 0px">
                                                                    ...
                                                                    <p>
                                                                        <a href="./app/app-insights-overview.md">Co je Application Insights?</a><br>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="card">
                                                    <div class="cardText">
                                                        ...
                                                        <p>
                                                            ...
                                                            <a href="./learn/mobile-center-quickstart.md">Telefon</a><br>@No__t_1 
                                                            <a href="./app/website-monitoring.md">monitorování v prohlížeči nebo na straně klienta</a></p>
                                                        <br><br>
                                                        <h3>Kurzy</h3>
                                                        <p>
                                                        ...
                                                        <p>
                                                            ...
                                                            <a href="./app/opencensus-python.md">OpenCensus pro Python</a><br>
                                                            <a href="./app/opencensus-go.md">OpenCensus for přejít</a><br>@No__t_1 
                                                            <a href="./app/opencensus-local-forwarder.md">místního dopředné</a></p>
                                                        <br><br>
...
">Config. XML</a><br>
                                                            <a href="https://github.com/Microsoft/ApplicationInsights-Java">Open Source sada Java SDK GitHub úložiště</a> 
                                                        </p>
                                                        <br><br>
                                                        <h3>Aplikace .NET</h3>
                                                        <p>
                                                        ...
                                                        <p>
                                                            ...
                                                            <a href="./app/api-custom-events-metrics.md">Vlastní události a metriky</a><br>
                                                            <a href="https://github.com/Microsoft/ApplicationInsights-aspnetcore">Open Source .NET Core SDK úložiště GitHub</a> 
                                                        </p>
                                                        <br><br>
                                                        ...
                                                        <p>
                                                            ...
                                                            <a href="./app/api-custom-events-metrics.md">Vlastní události a metriky</a><br>
                                                            <a href="https://github.com/Microsoft/ApplicationInsights-node.js">Open Source Node. js SDK GitHub 
                                                         úložiště</a></p>
                                                        <br><br>
                                            ...
                                            <div class="cardPadding">
                                                <div class="card">
                                                    <div class="cardText">
                                                        ...
                                                        <p>
                                                            <a href="./app/overview-dashboard.md">Přehled řídicího panelu &amp; řídicího panelu aplikace</a><br>
                                                        ...
                                                        <br><br>
                                                        <h3>Ochrana osobních údajů, zabezpečení, využití &amp;ch nákladů</h3>
                                                        <p>
                                                            <a href="https://docs.microsoft.com/azure/log-analytics/log-analytics-personal-data-mgmt">Zpracování osobních údajů</a><br>
                                                            <a href="./app/data-retention-privacy.md">Shromažďování, uchovávání dat, &amp; úložiště</a><br>
                                                            <a href="./app/resources-roles-access-control.md">Přístup na základě rolí</a><br>
                                                            <a href="./app/ip-addresses.md">IP adresa &amp; výjimky brány firewall</a><br>
                                                        ...
                                                        <p>
                                                            ...
                                                            <a href="./app/data-model-metric-telemetry.md">Metrika</a><br>@No__t_1 
                                                            <a href="./app/data-model-context.md">kontextu</a></p>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>

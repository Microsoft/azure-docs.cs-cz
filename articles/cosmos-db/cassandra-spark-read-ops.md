---
title: Operace čtení s Azure cosmos DB Cassandra API z aplikace Spark
description: Tento článek jak číst z tabulek v Cosmos DB Cassandra API
services: cosmos-db
...
ms.locfileid: "46964782"
---
# <a name="read-azure-cosmos-db-cassandra-api-tables-from-spark"></a>Přečtěte si Azure Cosmos DB Cassandra API tabulky z aplikace Spark

---
title: Podrobný plán zabezpečení a dodržování předpisů Azure – datový sklad pro FFIEC
description: Podrobný plán zabezpečení a dodržování předpisů Azure – datový sklad pro FFIEC
services: security
author: meladie
...
ms.locfileid: "68781067"
---
# <a name="azure-security-and-compliance-blueprint-data-warehouse-for-ffiec-financial-services"></a>Podrobný plán zabezpečení a dodržování předpisů Azure: Datový sklad pro finanční služby FFIEC

## <a name="overview"></a>Přehled

Tato Podrobný plán zabezpečení a dodržování předpisů Azure poskytuje pokyny pro nasazení architektury datového skladu v Azure, které jsou vhodné pro shromažďování, ukládání a načítání finančních dat, která jsou regulována Radou pro účely federální finanční instituce. (FFIEC).
...
![Datový sklad pro diagram referenční architektury FFIEC](images/ffiec-dw-architecture.png "Datový sklad pro diagram referenční architektury FFIEC")
...
Diagram toku dat pro tuto referenční architekturu je k dispozici ke [stažení](https://aka.ms/ffiec-dw-tm/) nebo najdete níže. Tento model může zákazníkům usnadnit pochopení bodů potenciálního rizika v systémové infrastruktuře při provádění úprav.

![Datový sklad pro model FFIEC Threat](images/ffiec-dw-threat-model.png "Datový sklad pro model FFIEC Threat")
...
[Podrobný plán zabezpečení a dodržování předpisů Azure – FFIEC – matice implementace datového skladu](https://aka.ms/ffiec-dw-cim) poskytuje informace o tom, které cíle FFIEC jsou řešeny architekturou datového skladu, včetně podrobného popisu implementace splňuje požadavky každého zahrnutého cíle.
...
-   [Azure Data Factory](https://docs.microsoft.com/azure/data-factory/introduction) je spravovaná cloudová služba, která je sestavená pro komplexní hybridní projekty extrakce, transformace a načítání dat. Azure Data Factory mají funkce, které vám pomůžou sledovat a vyhledávat finanční data, včetně nástrojů pro vizualizaci a monitorování, které identifikují, kdy data dorazila a odkud pocházejí. Pomocí Azure Data Factory můžou zákazníci vytvářet a plánovat pracovní postupy řízené daty označované jako kanály, které ingestují data z různorodých úložišť dat. Tyto kanály umožňují zákazníkům ingestovat data z interních i externích zdrojů. Zákazníci potom můžou data zpracovávat a transformovat na výstup do úložišť dat, jako je Azure SQL Data Warehouse.

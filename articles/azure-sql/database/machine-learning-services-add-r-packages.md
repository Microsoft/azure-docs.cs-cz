...
Pokud potřebujete použít balíček, který už není v Azure SQL Database nainstalovaný, můžete ho nainstalovat pomocí [sqlmlutils](https://github.com/Microsoft/sqlmlutils). **sqlmlutils** je balíček navržený tak, aby uživatelům usnadnil interakci s Microsoft Azuremi databázemi sql a SQL Server a provádění kódu r nebo Pythonu v SQL z klienta r nebo Pythonu. V současné době je v Azure SQL Database podporovaná jenom verze R nástroje **sqlmlutils** .
...
1. Stáhněte si nejnovější soubor zip **sqlmlutils** z aplikace https://github.com/Microsoft/sqlmlutils/tree/master/R/dist do místního počítače. Nemusíte ho rozkomprimovat.

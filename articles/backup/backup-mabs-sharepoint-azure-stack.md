...
description: Pomocí Azure Backup Serveru můžete zálohovat a obnovovat data SharePointu v Azure Stacku. Tento článek obsahuje informace o konfiguraci vaší farmy SharePoint tak, aby požadovaná data mohla být uložena v Azure. Chráněná sharepointová data můžete obnovit z disku nebo z Azure.
ms.topic: conceptual
ms.date: 06/08/2018
...
Azure Backup for MABS podporuje následující scénáře:

| Úloha | Version | Nasazení SharePointu | Ochrana a obnovení |
| --- | --- | --- | --- |
| SharePoint |SharePoint 2016, SharePoint 2013, SharePoint 2010 |SharePoint nasazený jako virtuální počítač Azure Stack <br> -------------- <br> SQL AlwaysOn | Ochrana možností obnovení farmy SharePoint: Farma pro obnovení, databáze a položka souboru nebo seznamu z bodů obnovení disku.  Obnovení farmy a databáze z bodů obnovení Azure. |
...
Než budete pokračovat, ujistěte se, že jste [nainstalovali a připravili Azure Backup Server](backup-mabs-install-azure-stack.md) na ochranu úloh.
...
3. Zadejte přihlašovací údaje správce farmy. Tento účet musí být členem místní skupiny Správci na serveru WFE. Pokud správce farmy není místní správce, udělte na serveru WFE následující oprávnění:
...
4. Na stránce **Vybrat metodu ochrany dat** zadejte název **skupiny ochrany**a vyberte preferované metody *ochrany*. Klikněte na **Další**.
   ...
   >
   >
5. Na stránce **Zadat krátkodobé cíle** vyberte preferovaný rozsah uchovávání **informací**a zjistěte, kdy má dojít k zálohování.
...
Otázka: Můžu obnovit položku SharePointu do původního umístění, pokud je SharePoint nakonfigurován pomocí SQL AlwaysOn (s ochranou na disku)?<br>
A: Ano, položku lze obnovit na původní web služby SharePoint.

Otázka: Můžu obnovit databázi SharePointu do původního umístění, pokud je SharePoint nakonfigurovaný pomocí SQL AlwaysOn?<br>
A: Vzhledem k tomu, že databáze Služby SharePoint jsou konfigurovány v SQL AlwaysOn, nelze je změnit, pokud není odebrána skupina dostupnosti. V důsledku toho MABS nelze obnovit databázi do původního umístění. Databázi serveru SQL Server můžete obnovit do jiné instance serveru SQL Server.

## <a name="next-steps"></a>Další kroky

Viz [článek Záložní soubory a aplikace.](backup-mabs-files-applications-azure-stack.md)
Podívejte se na článek [Zálohování SQL Serveru v Azure Stacku.](backup-mabs-sql-azure-stack.md)

...
ms.locfileid: "87432154"
---
# <a name="create-a-database-and-collection-for-mongodb-api-for-azure-cosmos-db-using-azure-cli"></a>Vytvoření databáze a kolekce pro MongoDB API pro Azure Cosmos DB pomocí Azure CLI

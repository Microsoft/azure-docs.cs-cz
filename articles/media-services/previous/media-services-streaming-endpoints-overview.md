...
description: Toto téma poskytuje přehled Azure Media Services koncových bodů streamování.
...
Azure Media Services do entity koncového bodu streamování přidal následující vlastnosti: **CdnProvider**, **CdnProfile**, **StreamingEndpointVersion**. Podrobný přehled těchto vlastností najdete v [tomto](https://docs.microsoft.com/rest/api/media/operations/streamingendpoint)tématu. 
...
> [!NOTE]
> Před spuštěním koncového bodu streamování je možné zakázat integraci Azure CDN. Adresa URL streamování a adresa URL pro streamování zůstane stejné, ať už povolíte CDN. `hostname`
...
Od verze Media Services od ledna 2017 jsou k dispozici dva typy streamování: **Standardní** (Preview) a **Premium**. Tyto typy jsou součástí koncového bodu streamování verze "2,0".
...
|--------------|----------|-----------------|-----------------|-----------------|
|Classic|1.0|0|Není k dispozici|Zdarma|
|Koncový bod streamování Standard (Preview)|2.0|0|Ano|Zpoplatněno|
|Jednotky streamování Premium|1.0|>0|Ano|Zpoplatněno|
|Jednotky streamování Premium|2.0|>0|Ano|Zpoplatněno|

...
| **Spuštění**| První výskyt, který může být v minulosti. První interval triggeru je (**čas_spuštění**,   +  **interval** čas_spuštění). | Datum a čas | Hodnota DateTime | Ano |

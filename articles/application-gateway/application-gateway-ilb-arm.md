...
## <a name="delete-an-application-gateway"></a>Odstranění aplikační brány
...
Pomocí rutiny `Stop-AzApplicationGateway` zastavte službu Application Gateway. Tato ukázka ukazuje rutinu `Stop-AzApplicationGateway` na prvním řádku, následovanou výstupem.

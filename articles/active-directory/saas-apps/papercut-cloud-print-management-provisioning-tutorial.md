...
3. Určete, jaká data se mají [mapovat mezi Azure AD a PaperCut cloudová Správa tisku](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes).

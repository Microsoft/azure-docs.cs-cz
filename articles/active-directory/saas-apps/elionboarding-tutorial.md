...
1. Do vyhledávacího pole zadejte **Eli připojování**vyberte **Eli připojování** z panelu výsledků klikněte **přidat** tlačítko pro přidání aplikace.
...
1. **[Vytvořit testovacího uživatele Eli připojování](#create-an-eli-onboarding-test-user)**  – Pokud chcete mít protějšek Britta Simon Eli registrace, který je propojený s Azure AD reprezentace uživatele.
...
1. Na **Eli registrace domény a adresy URL** části, proveďte následující kroky:
...
1. Ke konfiguraci jednotného přihlašování na **Eli připojování** straně, je nutné odeslat na stažený **soubor XML s metadaty** k [tým podpory připojování Eli](mailto:support@geteli.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.
...
1. V seznamu aplikací vyberte **Eli připojování**.

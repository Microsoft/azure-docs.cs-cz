...
- Nainstalovat rozšíření Windows Azure Diagnostics (WAD) na vaši [virtuálního počítače Azure](metrics-store-custom-guestos-resource-manager-vm.md), [škálovací sadu virtuálních počítačů](metrics-store-custom-guestos-resource-manager-vmss.md), [klasický virtuální počítač](metrics-store-custom-guestos-classic-vm.md), nebo [classic Cloud Services](metrics-store-custom-guestos-classic-cloud-service.md) a odeslat do Azure monitoru čítače výkonu. 
- Nainstalujte [InfluxData Telegraf agenta](metrics-store-custom-linux-telegraf.md) na počítači Azure s Linuxem a metriky odeslat pomocí Azure monitoru výstupu modulu plug-in.
...
* **Min**: minimální hodnotu ze všech ukázek a měření pozorováno za minutu.
...
Použijte vlastní metriky z různých služeb: 
 ...
 - [Škálovací sada virtuálních počítačů](metrics-store-custom-guestos-resource-manager-vmss.md)
 - [Virtuální počítače Azure (klasické)](metrics-store-custom-guestos-classic-vm.md)
 - [Použití Telegraf agenta virtuálního počítače s Linuxem](metrics-store-custom-linux-telegraf.md)
 - [REST API](metrics-store-custom-rest-api.md)
 - [Klasické cloudové služby](metrics-store-custom-guestos-classic-cloud-service.md)

...
3. **[Vytvoření zkušebního uživatele SmartRecruiters](#create-a-smartrecruiters-test-user)**  – Pokud chcete mít protějšek Britta Simon SmartRecruiters, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **SmartRecruiters domény a adresy URL** části, proveďte následující kroky, pokud chcete nakonfigurovat aplikace v **IDP** iniciované režimu:
...
5. Na **podpisový certifikát SAML** klikněte na tlačítko **Certificate(Base64)** a uložte certifikát ve vašem počítači.
...
7. Na **SmartRecruiters konfigurace** klikněte na tlačítko **nakonfigurovat SmartRecruiters** otevřete **nakonfigurovat přihlašování** okna. Kopírovat **SAML jednotné přihlašování – adresa URL služby** z **Stručná referenční příručka oddílu.**

    ![Konfigurace SmartRecruiters](./media/smartrecruiters-tutorial/tutorial_smartrecruiters_configure.png) 

8. V okně jiné webové prohlížeče Přihlaste se k webu společnosti SmartRecruiters jako správce.

9. Přejděte na **nastavení / Admin**.
...
11. Přepnout **povolit jednotné přihlašování k webu**.
...
13. Klikněte na tlačítko **uložit jednotného přihlašování k webu configuration**.

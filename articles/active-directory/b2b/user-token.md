---
title: Pochopení tokenů uživatelů v spolupráci B2B – Azure AD
description: Odkaz na token uživatele pro spolupráci Azure Active Directory B2B
...
Pokud chcete zjistit, co token vypadá pro uživatele spolupráce B2B, tady jsou podrobnosti o nosiči a obsahu tokenu pro hosta Azure Active Directory (Azure AD) a hosta účet Microsoft v tenantovi prostředků (pro tenantid. 04dcc6ab-388a-4559-B527-fbec656300ea). Chcete-li zobrazit obsah JSON Web Token (JWT), použijte [https://jwt.io/](https://jwt.io/) nebo [https://jwt.ms/](https://jwt.ms/).
...
## <a name="microsoft-account-guest-token"></a>účet Microsoft token hosta
```

...
1. Na portálu vyberte **Všechny služby**. Do **pole filtru** *všech služeb* zadejte *Network Watcher*. Jakmile se služba **Network Watcher** zobrazí ve výsledcích, vyberte ji.

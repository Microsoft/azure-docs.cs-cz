---
title: Ochrana stavu systému & úplné obnovení systému – Azure Backup Server
...
|SQL Server/Exchange<br /><br />Zálohování aplikace Azure Backup Server<br /><br />BMR/zálohování stavu systému|Ztracený nebo poškozený operační systém|N|Požadované|Ano|

...
Po vytvoření ISE se spravované konektory ISE automaticky nezobrazí ve výběru konektoru v návrháři aplikace logiky. Než budete moct používat tyto konektory ISE, musíte je ručně přidat a nasadit do ISE, aby se zobrazily v návrháři aplikace logiky.

> [!IMPORTANT]
> Spravované konektory ISE aktuálně nepodporují [značky](../azure-resource-manager/management/tag-support.md). Pokud nastavíte zásadu, která vynutila označování, pokus o přidání konektoru ISE může selhat s chybou, která je podobná následujícímu příkladu:
> 
> ```json
> {
>    "error": { 
...
> ```
> 
> Pokud tedy chcete přidat konektory ISE, musíte zásadu buď zakázat, nebo odebrat. 

...
Základní hodnoty zabezpečení Azure vám pomůžou posílit zabezpečení našich produktů prostřednictvím vylepšených funkcí nástrojů, sledování a zabezpečení a zajistit konzistentní prostředí při zabezpečení vašeho prostředí.

Základní hodnoty zabezpečení služeb Azure se zaměřují na oblasti ovládacích prvků zaměřené na Cloud. Tyto ovládací prvky jsou konzistentní s dobře známými srovnávacími testy zabezpečení, jako jsou ty, které jsou popsány v centru pro Internet Security (CIS). Naše směrné plány poskytují pokyny pro oblasti řízení uvedené v [srovnávacím testu zabezpečení Azure](overview.md).

...
1. Pak kliknutím na **Přidat** přidejte přiřazení role.
    ...
    ![Přidání přiřazení role](./media/entitlement-management-logs-and-reporting/workspace-set-role-assignment.png)

...
Položky, které jsou uvedené v části **Oblíbené** , se vyberou ze **všech služeb**. Když najedete myší na název služby, zobrazí se informace a prostředky týkající se služby. Plná ikona hvězdičky ![plná ikona hvězdičky](./media/azure-portal-add-remove-sort-favorites/azure-portal-favorites-graystar.png) vedle názvu služby znamená, že se položka zobrazí v seznamu **oblíbených položek** . Výběrem ikony hvězdičky přidáte službu do seznamu **oblíbených položek** .

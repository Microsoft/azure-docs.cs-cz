---
title: Ukázka kódu JSON pro Azure Policy – auditování nastavení detekce hrozeb na úrovni databáze | Microsoft Docs
description: Tato ukázková zásada json audituje zásady výstrah zabezpečení databáze SQL, pokud tyto zásady nejsou nastavené na zadaný stav.
...
Tato zásada audituje zásady výstrah zabezpečení databáze SQL, pokud tyto zásady nejsou nastavené na zadaný stav. Zadáte hodnotu, která určí, jestli je detekce hrozeb povolená nebo ne.

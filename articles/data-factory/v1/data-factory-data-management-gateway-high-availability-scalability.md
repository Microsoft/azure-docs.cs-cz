...
- Podporuje jakoukoli velikost klíče podporovanou systémem Windows Server 2012 R2 pro certifikáty SSL.
...
- V současné době můžete mít až čtyři uzly fyzické brány pro jednu logickou bránu. Pokud potřebujete více než čtyři uzly z důvodů výkonu, pošlete e-mail na [DMGHelp@microsoft.com](mailto:DMGHelp@microsoft.com).
...
- Pokud se rozhodnete šifrovat komunikační kanál mezi uzly, použijte oficiální certifikát SSL. Certifikát podepsaný svým držitelem může způsobit problémy s připojením, protože stejný certifikát nemusí být důvěryhodný v seznamu certifikační autority na jiných počítačích. 
...
- V případě kopírování souborů z místního prostředí byste už neměli používat \\localhost nebo C:\files, protože localhost nebo místní disk nemusí být přístupné přes všechny uzly. Místo toho použijte \\ServerName\files k zadání umístění Files.

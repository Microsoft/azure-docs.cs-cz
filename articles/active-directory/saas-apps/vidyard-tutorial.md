...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/vidyard-tutorial/tutorial_vidyard_samlbase.png)
...
3. Na **Vidyard domény a adresy URL** část, proveďte následující kroky, pokud chcete nakonfigurovat aplikace **IDP** iniciované režimu:
    ...
    ![Vidyard domény a adresy URL jednotné přihlašování informace](./media/vidyard-tutorial/tutorial_vidyard_url2.png)
...
4. Zkontrolujte **zobrazit upřesňující nastavení adresy URL** a provést následující krok, pokud chcete nakonfigurovat aplikace **SP** iniciované režimu:
    ...
    ![Vidyard domény a adresy URL jednotné přihlašování informace](./media/vidyard-tutorial/tutorial_vidyard_url1.png)
...
6. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/vidyard-tutorial/tutorial_general_400.png)
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/vidyard-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **Vidyard**.
    ...
    ![V seznamu aplikací na Vidyard odkaz](./media/vidyard-tutorial/tutorial_vidyard_app.png)  

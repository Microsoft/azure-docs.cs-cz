...
Pokud jste pro toto zařízení se systémem pro příjem dat navázali vztah nadřazenosti/podřízenosti (vyžaduje se pro ověřování X. 509, ale volitelné pro ověřování symetrických klíčů), můžete připojovací řetězec zjednodušit voláním brány přímo jako hostitele připojení. Příklad: 

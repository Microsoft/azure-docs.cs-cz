...
Cisco ASA nepodporuje formát CEF, takže během procesu Syslog a agenta Azure Sentinelu ví, jak je analyzovat, jako by šlo protokoly CEF odesílají protokoly. Konfigurace Cisco ASA předávat zprávy Syslog do pracovního prostoru Azure prostřednictvím agenta Syslog:
...
Chcete-li použít příslušné schéma v Log Analytics pro události Cisco, vyhledejte `CommonSecurityLog`.

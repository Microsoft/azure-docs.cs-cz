---
title: Ukázka kódu JSON pro Azure Policy – Povinné šifrování účtu úložiště | Microsoft Docs
description: Tato ukázková zásada JSON vyžaduje, aby účet úložiště používal šifrování objektů blob.
...
ms.locfileid: "34602359"
---
# <a name="require-storage-account-encryption"></a>Povinné šifrování účtu úložiště

Tato zásada vyžaduje, aby účet úložiště používal šifrování objektů blob.

---
title: Příklad rozhraní příkazového řádku zálohování azure databáze SQL
description: Ukázkový skript Azure CLI pro zálohování jediné databáze Azure SQL do kontejneru úložiště Azure
...
---
# <a name="use-cli-to-backup-an-azure-sql-single-database-to-an-azure-storage-container"></a>Použití rozhraní příkazového řádku k zálohování jediné databáze Azure SQL do kontejneru úložiště Azure

Tento příklad nastavení nastavení příkazu k onáku Azure zálohuje databázi Azure SQL do kontejneru úložiště Azure.  

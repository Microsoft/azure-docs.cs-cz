        ...
        <div class="cardSize">
            <div class="cardPadding" style="padding-bottom: 0;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h2 style="margin-top: 0">Další informace o zabezpečení Azure</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Zvažuji Azure pro svou společnost. Co Azure nabízí?</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-isolation">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Jak Azure izoluje moje prostředky od ostatních zákazníků Azure?</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-log-audit">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Jaké možnosti monitorování a protokolování jsou v Azure k dispozici?</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <ul class="noBullet">
                            <li style="list-style: none;">
                                <a class="barLink" href="http://aka.ms/SecurityResponsepaper">Odpověď Azure na zabezpečení v cloudu</a>
                            </li>
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/azure-threat-detection">Rozšířená detekce hrozeb Azure</a>
                            </li>
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/azure-network-security">Zabezpečení sítě Azure</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="cardText">
                        ...
                        <ul class="noBullet">
                            ...
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/azure-service-fabric-security-best-practices">Zabezpečení Service Fabric</a>
                            </li>
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/azure-security-global-admin">Zabezpečení účtů správců Azure</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="cardPadding">
            <div class="card">
                <div class="cardText">
                     ...
                     <h3>Kontrolní seznamy</h3>
                     <ul class="noBullet">
                        <li style="list-style: none;">
                            <a class="barLink" href="/azure/security/azure-database-security-checklist">Zabezpečení databází</a>
                        </li>
                        <li style="list-style: none;">
                            <a class="barLink" href="/azure/security/azure-operational-security-checklist">Provozní zabezpečení</a>
                        </li>
                        <li style="list-style: none;">
                            <a class="barLink" href="/azure/security/azure-service-fabric-security-checklist">Zabezpečení Service Fabric</a>
                        </li>
                    </ul>
                </div>
            </div>

...
1. Nejprve pomocí Visual Studio Code integrovaného terminálu Najděte složku vašeho projektu a pak nainstalujte Express pomocí NPM.

1. Dále vytvořte soubor. js s názvem `server.js`a přidejte následující kód:

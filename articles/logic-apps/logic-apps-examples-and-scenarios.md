...
* [Zpracování typů obsahu v Azure Logic Apps](../logic-apps/logic-apps-content-type.md), jako jsou `application/`, `application/octet-stream`a `multipart/formdata`

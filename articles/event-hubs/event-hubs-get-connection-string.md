---
title: Získání připojovacího řetězce služby Azure Event Hubs | Dokumentace Microsoftu
description: Získání připojovacího řetězce služby Azure Event Hubs
services: event-hubs
...
Get-AzureRmEventHubNamespaceKey můžete použít k získání připojovacího řetězce pro název zadejte zásady/pravidla, jak je znázorněno níže:

...
![Veřejné konfiguraci diagnostiky](media/diagnostics-extension-to-application-insights/AzDiag_Channels_App_Insights.png)
...
![Diagnostika jímky konfigurace pomocí nástroje Application Insights](media/diagnostics-extension-to-application-insights/Azure_Diagnostics_Sinks.png)
...
* Zjistěte, jak [zobrazit přehledné informace o Azure diagnostics](https://docs.microsoft.com/azure/application-insights/app-insights-cloudservices) ve službě Application Insights.

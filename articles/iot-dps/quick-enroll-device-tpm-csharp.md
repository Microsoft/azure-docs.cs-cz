---
title: 'Registrace zařízení TPM do služby Azure Device Provisioning pomocí jazyka C #'
...
1. Přidejte do `Program` třídy následující pole a proveďte níže uvedené změny.

...
[Nasaďte](container-service-deployment.md) a [připojte](../container-service-connect.md) cluster nakonfigurovaný službou Azure Container Service. Prozkoumejte [uživatelské rozhraní Marathon](container-service-mesos-marathon-ui.md). Chcete-li nastavit účet služby Datadog, otevřete [https://datadoghq.com](https://datadoghq.com) . 
...
Přístup k uživatelskému rozhraní DC/OS prostřednictvím [http://localhost:80/](http://localhost:80/). Jakmile v uživatelském rozhraní DC/OS přejdete na "Universe", který je vlevo dole, vyhledejte "služby Datadog" a klikněte na nainstalovat.

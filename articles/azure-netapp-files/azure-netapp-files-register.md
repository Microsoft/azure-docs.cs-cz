...
1. Přejít na následující stránku a odeslat žádost o pořadníku k přístupu ke službě Azure NetApp Files:  
    [**Stránka pro odeslání Azure NetApp Files pořadníku**](https://aka.ms/azurenetappfiles) 

...
2. **[Nakonfigurujte jednotné přihlašování EFI pro prezentace](#configure-efi-digital-storefront-single-sign-on)** , abyste na straně aplikace nakonfigurovali nastavení jednotného přihlašování.
...
### <a name="configure-efi-digital-storefront-single-sign-on"></a>Konfigurace jednotného přihlašování pro EFI Digital prezentace
...
Po kliknutí na dlaždici Digital prezentace rozhraní EFI na přístupovém panelu byste měli být automaticky přihlášeni k digitálnímu prezentace EFI, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

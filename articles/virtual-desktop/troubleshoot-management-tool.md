...
ms.locfileid: "73905612"
---
# <a name="troubleshoot-the-windows-virtual-desktop-management-tool"></a>Řešení potíží s nástrojem pro správu virtuálních počítačů s Windows
...
2. Přihlaste se k portálu < Portal. Azure. com > s účtem hlavního názvu uživatele (UPN) a zkontrolujte nastavení účtu a ujistěte se, že Multi-Factor Authentication není zapnuté. Pokud je tato funkce zapnutá, vypněte ji.
...
- Přečtěte si o sledování eskalace při [řešení potíží s přehledem, zpětnou vazbou a podporou](troubleshoot-set-up-overview.md).

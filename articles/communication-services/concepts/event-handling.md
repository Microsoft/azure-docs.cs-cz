...
| Microsoft. Communication. ChatParticipantAddedToThreadWithUser|  Publikováno pro uživatele při přidání nového účastníka do konverzačního vlákna, že uživatel je součástí.|
| Microsoft. Communication. ChatParticipantRemovedFromThreadWithUser |  Publikováno pro uživatele při odebrání účastníka z konverzačního vlákna, že uživatel je součástí. |
| Microsoft. Communication. ChatThreadCreated  | Publikováno při vytvoření konverzačního vlákna  |
| Microsoft. Communication. ChatThreadDeleted| Publikováno při odstranění konverzačního vlákna  |
| Microsoft. Communication. ChatThreadParticipantAdded | Publikováno při přidání nového účastníka do konverzačního vlákna  |
| Microsoft. Communication. ChatThreadParticipantRemoved | Publikováno při přidání nového účastníka do konverzačního vlákna.  |  
| Microsoft. Communication. ChatMessageReceivedInThread | Publikováno při přijetí zprávy ve vlákně chatu  |    
| Microsoft. Communication. ChatThreadPropertiesUpdated| Publikováno, když jsou aktualizovány vlastnosti konverzačního vlákna, jako je téma.|    
| Microsoft. Communication. ChatMessageEditedInThread | Publikováno při úpravě zprávy ve vlákně chatu |  
| Microsoft. Communication. ChatMessageDeletedInThread | Publikováno při odstranění zprávy ve vlákně chatu  |  
...
### <a name="microsoftcommunicationchatparticipantaddedtothreadwithuser--event"></a>Událost Microsoft. Communication. ChatParticipantAddedToThreadWithUser 
```json
[{
...
### <a name="microsoftcommunicationchatparticipantremovedfromthreadwithuser-event"></a>Událost Microsoft. Communication. ChatParticipantRemovedFromThreadWithUser 
```json
[{
...
### <a name="microsoftcommunicationchatthreadcreated-event"></a>Událost Microsoft. Communication. ChatThreadCreated
...
```
### <a name="microsoftcommunicationchatthreadpropertiesupdated-event"></a>Událost Microsoft. Communication. ChatThreadPropertiesUpdated
...
```
### <a name="microsoftcommunicationchatthreaddeleted-event"></a>Událost Microsoft. Communication. ChatThreadDeleted
...
```
### <a name="microsoftcommunicationchatthreadparticipantadded-event"></a>Událost Microsoft. Communication. ChatThreadParticipantAdded
...
```
### <a name="microsoftcommunicationchatthreadparticipantremoved-event"></a>Událost Microsoft. Communication. ChatThreadParticipantRemoved
...
```
### <a name="microsoftcommunicationchatmessagereceivedinthread-event"></a>Událost Microsoft. Communication. ChatMessageReceivedInThread
...
```
### <a name="microsoftcommunicationchatmessageeditedinthread-event"></a>Událost Microsoft. Communication. ChatMessageEditedInThread
...
### <a name="microsoftcommunicationchatmessagedeletedinthread-event"></a>Událost Microsoft. Communication. ChatMessageDeletedInThread

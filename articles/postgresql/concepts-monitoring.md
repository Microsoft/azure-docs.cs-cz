...
|pg_replica_log_delay_in_bytes|Maximální prodleva napříč replikami|Psaný|Prodleva v bajtech mezi hlavní a nejvyšším zpožděním repliky. Tato metrika je k dispozici pouze na hlavním serveru.|
|pg_replica_log_delay_in_seconds|Prodleva repliky|Sekund|Čas od poslední opakované transakce. Tato metrika je k dispozici pouze pro servery repliky.|

...
|Výchozí                |Více                               |VirtualNetworkServiceEndpoint|Pouze podsíť, pro kterou je povolený koncový bod služby.|
...
![Síťový diagram](./media/virtual-networks-udr-overview/routing-example.png)

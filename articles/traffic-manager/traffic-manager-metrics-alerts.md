...
- Zjistěte, jak [vytvořit nový graf používat Azure Monitor](../monitoring-and-diagnostics/monitoring-metric-charts.md#how-do-i-create-a-new-chart)

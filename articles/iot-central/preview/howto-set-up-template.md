...
> [Vytvořte novou verzi šablony zařízení](howto-version-device-template.md)
> [připojte k aplikaci Azure IoT Central zařízení MXChip IoT DevKit](howto-connect-devkit.md) .

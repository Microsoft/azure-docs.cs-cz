...
Další informace najdete v tématu [streamování protokolů pomocí Azure CLI](/azure/app-service/web-sites-enable-diagnostic-log#streaming-with-azure-command-line-interface).

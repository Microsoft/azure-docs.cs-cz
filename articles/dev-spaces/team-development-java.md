---
title: Vývoj týmu pomocí jazyka Java a visual studio code
services: azure-dev-spaces
author: stepro
ms.author: stephpr
ms.date: 08/01/2018
ms.topic: tutorial
description: Tento kurz ukazuje, jak používat Azure Dev Spaces a Visual Studio Code k vývoji týmu v aplikaci Java ve službě Azure Kubernetes Service
...
---
# <a name="team-development-using-java-and-visual-studio-code-with-azure-dev-spaces"></a>Vývoj týmu pomocí jazyka Java a visual studio code s Azure Dev Spaces
...
Přejděte do okna VS Kód pro `mywebapi` a `String index()` proveďte úpravu kódu metody v `src/main/java/com/ms/sample/mywebapi/Application.java`oblasti , například:

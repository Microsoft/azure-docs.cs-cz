...
V produkčním prostředí obvykle vytvoříte záznam DNS CNAME k nasměrování [*internetové domény*](../traffic-manager/traffic-manager-point-internet-domain.md) společnosti na název služby Traffic Manager DNS.

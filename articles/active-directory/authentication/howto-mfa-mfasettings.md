...
| [Tokeny OATH](concept-authentication-methods.md#oath-hardware-tokens) | Používá se v cloudových prostředích Azure MFA ke správě tokenů OATH pro uživatele. |

...
Abyste mohli používat rozhraní příkazového řádku Azure, musíte [nainstalovat Azure CLI 2.0](https://docs.microsoft.com/en-us/cli/azure/install-azure-cli?view=azure-cli-latest) ve vašem počítači.

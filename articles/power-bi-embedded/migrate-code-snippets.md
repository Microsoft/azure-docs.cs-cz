---
title: Kód fragmenty pro migraci obsahu z kolekce pracovních prostorů Power BI | Microsoft Docs
description: Tady jsou některé fragmenty kódu základních operací, které jsou potřebné k migraci obsahu.
...
ms.locfileid: "31407710"
---
# <a name="code-snippets-for-migrating-content-from-power-bi-workspace-collections"></a>Fragmenty kódu při migraci obsahu z kolekce pracovních prostorů Power BI

Tento článek vám dává některé fragmenty kódu základních operací, které jsou potřebné k migraci obsahu. Související toky pro určité typy sestav, naleznete v části [jak migrovat Power BI Embedded prostoru kolekce obsah Power BI](migrate-from-power-bi-workspace-collections.md#content-migration).

A **nástroj pro migraci** je k dispozici pro použití za účelem pomoci s kopírování obsahu z kolekce pracovních prostorů Power BI pro Power BI Embedded. Zvláště pokud máte velké množství obsahu. Další informace najdete v tématu [Power BI Embedded nástroj pro migraci](migrate-tool.md).

Kód uvedený níže jsou příklady pomocí jazyka C# a [Power BI .NET SDK](https://www.nuget.org/profiles/powerbi).

Ujistěte se, že používáte následujících oborů názvů provést uvedené fragmenty kódu.
...
## <a name="export-report-from-a-power-bi-workspace-collection-workspace"></a>Export sestavy z pracovního prostoru kolekce pracovních prostorů Power BI
...
## <a name="import-report-to-power-bi-embedded"></a>Import sestavy Power BI Embedded
...
## <a name="extract-directquery-connection-string-from-power-bi-workspace-collections"></a>Extrahování DirectQuery připojovací řetězec z kolekce pracovních prostorů Power BI

Je to pro aktualizaci soubor PBIX po migraci na Power BI Embedded.
...
## <a name="update-directquery-connection-string-in-power-bi-embedded"></a>Aktualizovat DirectQuery připojovací řetězec v Power BI Embedded
...
## <a name="set-directquery-credentials-in-power-bi-embedded"></a>Nastavení přihlašovacích údajů DirectQuery v Power BI Embedded

V tento fragment kódu používáme nezašifrované přihlašovací údaje pro jednoduchost, odesílání zašifrované přihlašovací údaje je podporováno také.
...
Bude muset znovu vytvořit v sestavě vytvořenou datovou sadu.

V tento fragment kódu předpokládáme, že pushable datové sady je již v pracovním prostoru aplikací v rámci Power BI. Informace o nabízených rozhraní API najdete v tématu [nabízet data do Power BI datové sady](https://powerbi.microsoft.com/documentation/powerbi-developer-walkthrough-push-data/).
...
Informace o migraci naleznete v tématu [jak migrovat obsah kolekce pracovních prostorů Power BI pro Power BI Embedded](migrate-from-power-bi-workspace-collections.md).

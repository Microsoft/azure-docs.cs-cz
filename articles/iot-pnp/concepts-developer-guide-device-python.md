---
title: Příručka pro vývojáře zařízení (Python) – IoT technologie Plug and Play | Microsoft Docs
description: Popis technologie Plug and Play IoT pro vývojáře zařízení Pythonu
author: rido-min
ms.author: rmpablos
ms.date: 09/24/2020
ms.topic: conceptual
...
ms.locfileid: "91579996"
---
# <a name="iot-plug-and-play-device-developer-guide-python"></a>Příručka pro vývojáře pro zařízení IoT technologie Plug and Play (Python)

...
2.   Znovu potvrdit, že konektor hostitele bylo uděleno právo pro delegování do určeného cílového účtu hlavní název služby. Který vyzváním **použití libovolného protokolu pro ověřování** zaškrtnuto. Další informace najdete v tématu [článku Konfigurace jednotného přihlašování](application-proxy-configure-single-sign-on-with-kcd.md).

...
Nejdřív musíte povolit protokolování do svého trezoru klíčů. Použijte následující příkazy PowerShellu. (V tomto článku se dozvíte, jaké jsou úplné podrobnosti [o protokolování trezoru klíčů](../general/logging.md).)

---
title: Hrubá relokace v cíli C
description: Podrobné vysvětlení, jak vytvořit a lokalizovat kotvy pomocí hrubé relokalizace v objective-C.
author: bucurb
manager: dacoghl
...
---
# <a name="how-to-create-and-locate-anchors-using-coarse-relocalization-in-objective-c"></a>Jak vytvořit a lokalizovat kotvy pomocí hrubé relocalizace v Objective-C

...
ms.locfileid: "102435650"
---
# <a name="troubleshoot-automated-ml-experiments-in-python"></a>Řešení automatizovaných experimentů ML v Pythonu

V této příručce se dozvíte, jak identifikovat a vyřešit známé problémy v automatizovaných experimentech strojového učení pomocí [sady Azure Machine Learning SDK](/python/api/overview/azure/ml/intro?preserve-view=true&view=azure-ml-py).

...
- Monitorování uživatelských relací pro dodržování předpisů: rizikové uživatele se monitorují, když se přihlásí k aplikacím a jejich akce se protokolují v rámci relace. Můžete prozkoumat a analyzovat chování uživatelů, abyste pochopili, kdy a za jakých podmínek zásady relace bude použito v budoucnu.

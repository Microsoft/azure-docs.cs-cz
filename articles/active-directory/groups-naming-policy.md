...
* [Zásady vypršení platnosti pro skupiny Office 365](users-groups-roles/groups-lifecycle.md)
...
* [Správa dynamické pravidel pro uživatele ve skupině](users-groups-roles/groups-dynamic-membership.md)

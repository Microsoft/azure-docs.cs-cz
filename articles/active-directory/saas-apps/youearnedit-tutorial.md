...
2. **[Nakonfigurujte jednotné přihlašování YouEarnedIt](#configure-youearnedit-single-sign-on)** – ke konfiguraci nastavení jediného Sign-On na straně aplikace.
...
4. V části **základní konfigurace SAML** proveďte následující kroky:
    ...
    > [!NOTE]
    > Tyto hodnoty nejsou reálné. Aktualizujte tyto hodnoty skutečným Sign-On URL a identifikátorem. Pokud chcete získat tyto hodnoty, obraťte se na přiřazeného správce úspěchů YouEarnedIt Customer.
...
### <a name="configure-youearnedit-single-sign-on"></a>Nakonfigurovat YouEarnedIt jednu Sign-On
...
Když na přístupovém panelu kliknete na dlaždici YouEarnedIt, měli byste se automaticky přihlásit k YouEarnedIt, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).

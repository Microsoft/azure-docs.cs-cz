...
---
# <a name="deploy-an-application-to-a-service-fabric-cluster-using-the-service-fabric-cli"></a>Nasazení aplikace do clusteru Service Fabric pomocí cli service fabric

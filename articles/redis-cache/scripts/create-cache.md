...
Tento skript používá následující příkazy k vytvoření skupiny prostředků a mezipaměti redis. Každý příkaz v tabulce odkazuje na příslušnou část dokumentace.

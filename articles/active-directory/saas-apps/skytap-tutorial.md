...
4. Do vyhledávacího pole zadejte **Skytap**vyberte **Skytap** z panelu výsledků klikněte **přidat** tlačítko pro přidání aplikace.
...
3. **[Vytvoření zkušebního uživatele Skytap](#create-a-skytap-test-user)**  – Pokud chcete mít protějšek Britta Simon Skytap, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **Skytap domény a adresy URL** části, proveďte následující kroky, pokud chcete nakonfigurovat aplikace v **IDP** iniciované režimu:
...
7. Ke konfiguraci jednotného přihlašování na **Skytap** straně, je nutné odeslat na stažený **soubor XML s metadaty** k [tým podpory Skytap](mailto:support@skytap.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

...
description: Tento článek poskytuje informace a ukázky kódu, které vám pomůžou rychle začít s používáním sady C# Content moderator SDK s nástrojem k vytváření recenzí videí.
...
| :---: | :---: | :---: |
[Snímek 1](https://blobthebuilder.blob.core.windows.net/sampleframes/ams-video-frame1-00-17.PNG) | [Snímek 2](https://blobthebuilder.blob.core.windows.net/sampleframes/ams-video-frame-2-01-04.PNG) | [Snímek 3](https://blobthebuilder.blob.core.windows.net/sampleframes/ams-video-frame-3-02-24.PNG) |
...
Přidejte následující soukromé vlastnosti do oboru názvů **VideoReviews**, **program**třídy. Aktualizujte pole `AzureEndpoint` a `CMSubscriptionKey` hodnotou adresy URL koncového bodu a klíče předplatného. Můžete je najít na kartě **rychlý Start** prostředku v Azure Portal.
...
1. Objekt **IList \<VideoFrameBodyItem >** objektu. Každý objekt **VideoFrameBodyItem** představuje snímek videa.
...
- **Metadata**. > IList \<VideoFrameBodyItemMetadataItem. **VideoFrameBodyItemMetadataItem** je pouze pár klíč/hodnota. Mezi platné klíče patří:
...
- **ReviewerResultTags**. > IList \<VideoFrameBodyItemReviewerResultTagsItem. **VideoFrameBodyItemReviewerResultTagsItem** je pouze pár klíč/hodnota. Aplikace může tyto značky použít k uspořádání snímků videa.
...
Nakonec se zobrazí Kontrola videa v účtu nástroje Content Moderator revize na obrazovce **recenze**>**video** .

...
- **Běžné** – standardní sada událostí pro účely auditování. V této sadě je zahrnutý úplný záznam pro audit uživatele. Například tato sada obsahuje události přihlášení uživatele i odhlášení uživatele (ID události 4634). Zahrnujeme auditování akce, jako je změnami skupin zabezpečení, operace protokolu Kerberos řadič klíče domény a další události, které doporučuje organizace odvětví.
...
1. Na portálu Sentinel Azure vyberte **datové konektory** a pak klikněte na dlaždici **události zabezpečení systému Windows** . 

---
title: Určení vaší publikování možnost v Azure Marketplace | Azure Marketplace
...
## <a name="list-of-offer-types"></a>Seznam typů nabídky

V následující tabulce jsou uvedeny typy nabídek Azure Marketplace.

| **Typ nabídky**    | **Popis**  |
| :------------------- | :-------------------|
| [**Virtual Machines**](https://docs.microsoft.com/azure/marketplace/marketplace-virtual-machines) | Když nasadíte virtuální zařízení na předplatné spojené s vaší zákaznickou, použijte typ nabídky virtuálního počítače. |
| [**Šablony řešení**](https://docs.microsoft.com/azure/marketplace/marketplace-solution-templates) | Pokud vaše řešení vyžaduje další automatizaci nasazení a konfigurace nad rámec jednoduchý virtuální počítač, použijte typ nabídky šablony řešení. |
| [**Spravované aplikace**](https://docs.microsoft.com/azure/marketplace/marketplace-managed-apps) | Pomocí aplikace Azure: spravovaného typu nabídky aplikace, pokud vyžaduje splnění následujících podmínek: <br> <ul> <li> Nasadit buď řešení na základě předplatného pro vaše zákazníky pomocí virtuálního počítače nebo celé řešení založeného na IaaS. </li> <li>Vy nebo váš zákazník vyžadují, aby řešení spravuje partner. </li> <ul> |

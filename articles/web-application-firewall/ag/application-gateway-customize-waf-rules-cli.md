---
title: Přizpůsobení pravidel firewallu webových aplikací v Azure Application Gateway – Azure CLI
...
Následující příklad zakáže pravidla `910018` a `910017` v bráně Application Gateway:

...
| Příkaz | Poznámky |
|---|---|
| [az role assignment create](/cli/azure/role#az-role-assignment-create) | Vytvoří nové přiřazení role pro uživatele, skupinu nebo instanční objekt. |

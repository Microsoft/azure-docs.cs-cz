---
title: 'Kurz: Integrace Azure Active Directory se službou Oneteam | Dokumentace Microsoftu'
...
ms.locfileid: "39051301"
---
# <a name="tutorial-azure-active-directory-integration-with-oneteam"></a>Kurz: Integrace Azure Active Directory se službou Oneteam
...
5. Na panelu výsledků vyberte **Oneteam**a potom klikněte na tlačítko **přidat** tlačítko pro přidání aplikace.
...
3. **[Vytvoření zkušebního uživatele Oneteam](#creating-a-oneteam-test-user)**  – Pokud chcete mít protějšek Britta Simon Oneteam, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **Oneteam domény a adresy URL** části, pokud chcete nakonfigurovat aplikace v **IDP** iniciované režimu:
...
7. Pokud chcete získat jednotné přihlašování nakonfigurované pro vaši aplikaci, můžete zvýšit lístek podpory s [tým podpory Oneteam](https://support.one-team.com/hc/requests/new) a poskytuje je na stažený **metadat**. 

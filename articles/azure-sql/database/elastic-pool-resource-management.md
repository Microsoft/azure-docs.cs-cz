...
- Implementace [komprese dat](https://docs.microsoft.com/sql/relational-databases/data-compression/data-compression)
- Horizontální navýšení kapacity fondu na cíl služby s větší maximální velikostí fondu

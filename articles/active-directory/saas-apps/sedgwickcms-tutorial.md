...
1. Do vyhledávacího pole zadejte **Sedgwick CMS**vyberte **Sedgwick CMS** z panelu výsledků klikněte **přidat** tlačítko pro přidání aplikace.
...
1. **[Vytvoření zkušebního uživatele Sedgwick CMS](#create-a-sedgwick-cms-test-user)**  – Pokud chcete mít protějšek Britta Simon Sedgwick CMS, který je propojený s Azure AD reprezentace uživatele.
...
1. Na **Sedgwick CMS domény a adresy URL** části, proveďte následující kroky:
...
1. V seznamu aplikací vyberte **Sedgwick CMS**.

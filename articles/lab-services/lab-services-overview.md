...
- **Azure DevTest Labs** – tato služba umožňuje rychle nastavit prostředí pro váš tým (například: vývojové prostředí nebo testovací prostředí v cloudu). Vlastník testovacího prostředí vytvoří testovací prostředí, zřídí virtuální počítače s Windows nebo Linuxem, nainstaluje nezbytný software a nástroje a zpřístupní je uživatelům testovacího prostředí. Uživatelé testovacího prostředí se připojují k virtuálním počítačům (VM) v testovacím prostředí a používají je pro každodenní práci a krátkodobé projekty. Jakmile uživatelé začnou využívat prostředky v testovacím prostředí, správce testovacího prostředí může analyzovat náklady a využití ve všech spravovaných testovacích prostředích a nastavením globálních zásad optimalizovat náklady organizace i jednotlivých týmů.
- **Azure Lab Services** – tato služba umožňuje vytvářet typy spravovaného testovacího prostředí. V současné době je testovací prostředí ve třídě jediným typem spravovaného testovacího prostředí, které je podporované službou Azure Lab Services. Samotná služba zpracovává veškerou správu infrastruktury pro typ spravovaného testovacího prostředí, od střídání virtuálních klíčů až po zpracování chyb a škálování infrastruktury. Poté, co správce IT vytvoří účet testovacího prostředí ve službě Azure Lab Services, instruktor může rychle nastavit testovací prostředí pro svou třídu, zadat počet a typ virtuálních počítačů, které je potřeba k cvičení ve třídě a přidat uživatele do třídy. Jakmile se uživatel zaregistruje do třídy, uživatel má přístup k virtuálnímu virtuálnímu mněmu k cvičení pro třídu.  

## <a name="key-capabilities"></a>Klíčové funkce

Tyto služby (Azure DevTest Labs a Azure Lab Services) podporují následující klíčové funkce a funkce:

- **Rychlé a flexibilní nastavení testovacích prostředí**. V Azure Lab Services si můžou vlastníci testovacích prostředí rychle nastavit testovací prostředí podle svých potřeb. Služba nabízí možnost postarat se o všechny práce infrastruktury Azure pro typy spravovaných testovacích prostředí nebo umožnit vlastníkům testovacího prostředí, aby sami spravovali a přizpůsobili infrastrukturu v předplatném vlastníka testovacího prostředí. Služba má integrované možnosti škálování a nastavení odolnosti infrastruktury pro testovací prostředí, která pro vás spravuje.
- **Zjednodušené ovládání pro uživatele testovacích prostředí**. V typu spravovaného testovacího prostředí, jako je například testovací prostředí, mohou uživatelé testovacího prostředí zaregistrovat do testovacího prostředí s registračním kódem a kdykoli přistupovat k testovacímu prostředí a používat prostředky testovacího prostředí. V testovacím prostředí v DevTest Labs může vlastník testovacího prostředí udělit oprávnění jeho uživatelům k vytváření virtuálních počítačů a přístupu k nim, správě a opakovanému používání datových disků a nastavení opakovaně použitelných tajných kódů.  
- **Optimalizace nákladů a analýza**. Vlastník testovacího prostředí může nastavit plány automatického vypínání a spouštění virtuálních počítačů. Vlastník testovacího prostředí může vytvořit plán s časovými úseky, kdy mají být virtuální počítače v testovacím prostředí dostupné pro uživatele, optimalizovat náklady nasazením zásad pro uživatele nebo celé testovací prostředí a analyzovat trendy využití a aktivity v testovacím prostředí. Pro spravované typy testovacího prostředí, jako jsou testovací prostředí ve třídě, je aktuálně k dispozici menší podmnožina možností optimalizace nákladů a analýzy.
...
Tady jsou některé scénáře, které podporují Azure DevTest Labs a Azure Lab Services:
...
## <a name="types-of-labs"></a>Typy laboratoří
Můžete vytvořit dva typy testovacích prostředí: **spravované typy testovacích prostředí** se službami Azure Lab Services a testovací **prostředí** se službami Azure Lab Services. Pokud chcete pouze zadat, co potřebujete v testovacím prostředí a nechat službu nastavit a spravovat infrastrukturu potřebnou pro testovací prostředí, vyberte si z jednoho z **typů spravovaného testovacího prostředí**. V současné době **je testovací prostředí učebny** je jediný typ spravovaného testovacího prostředí, který můžete vytvořit pomocí služby Azure Lab Services. Pokud chcete spravovat vlastní infrastrukturu, vytvořte testovací prostředí pomocí **Azure DevTest Labs**.
...
Azure Lab Services umožňuje vytvářet testovací prostředí, jejichž infrastrukturu spravuje Azure. Tento článek odkazuje na ně jako spravované typy testovacího prostředí. Spravované typy testovacích prostředí nabízejí různé typy testovacích prostředí, které odpovídají vašim specifickým potřebám. V současné době je podporován pouze podporovaný typ spravovaného testovacího **prostředí.** 

Spravované typy testovacího prostředí umožňují začít hned, s minimálním nastavením. Samotná služba zajišťuje veškerou správu infrastruktury pro testovací prostředí, od poskytování potřebného výkonu virtuálních počítačů přes zpracovávání chyb až po škálování infrastruktury.Chcete-li vytvořit typ spravovaného testovacího prostředí, jako je například testovací prostředí učebny, musíte nejprve vytvořit účet testovacího prostředí pro vaši organizaci. Účet testovacího prostředí slouží jako centrální účet, ve kterém se spravují všechna testovací prostředí v organizaci. 

Když vytváříte a používáte prostředky Azure v těchto typech spravovaného testovacího prostředí, služba vytvoří a spravuje prostředky v interních předplatných Microsoftu. Nevytvářejí se ve vašem vlastním předplatném Azure. Služba uchovává informace o využití těchto prostředků v interních předplatných Microsoftu. Toto využití se fakturuje zpět na vaše předplatné Azure, které obsahuje účet testovacího prostředí.   

Tady jsou některé **případy použití pro spravované typy testovacího prostředí**: 
...
## <a name="managed-lab-types-vs-devtest-labs"></a>Spravované typy testovacího prostředí vs. DevTest Labs
...
| Správa předplatného | Služba zpracovává přidělování prostředků v předplatných Microsoftu, která podporují danou službu. Škálování automaticky zpracovává služba. | Spravujete sami ve svém vlastním předplatném Azure. Žádné automatické škálování odběrů. |

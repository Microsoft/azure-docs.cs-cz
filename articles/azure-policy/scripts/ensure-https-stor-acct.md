---
title: Ukázka kódu JSON pro Azure Policy – Zajištění jenom provozu HTTPS pro účet úložiště | Microsoft Docs
description: Tato ukázková zásada JSON vyžaduje, aby účty úložiště používaly provoz HTTPS.

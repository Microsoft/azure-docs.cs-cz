---
title: Podrobný plán zabezpečení a dodržování předpisů Azure – analýza dat pro Velká Británie NHS
description: Podrobný plán zabezpečení a dodržování předpisů Azure – analýza dat pro Velká Británie NHS
services: security
author: jomolesk
...
Azure SQL Database se běžně spravují prostřednictvím SQL Server Management Studio, která se spouští z místního počítače nakonfigurovaného pro přístup k Azure SQL Database prostřednictvím zabezpečeného připojení VPN nebo ExpressRoute. **Microsoft doporučuje nakonfigurovat připojení VPN nebo ExpressRoute pro správu a import dat do skupiny prostředků referenční architektury**.

![Analýza pro diagram referenční architektury pro Velká Británie NHS](images/uknhs-analytics-architecture.png?raw=true "Analýza pro diagram referenční architektury pro Velká Británie NHS")
...
**Skupiny zabezpečení sítě**: [Skupiny zabezpečení sítě](../../virtual-network/virtual-network-vnet-plan-design-arm.md) obsahují seznamy řízení přístupu, které povolují nebo zakazují provoz v rámci virtuální sítě. Skupiny zabezpečení sítě se dají použít k zabezpečení provozu na úrovni podsítě nebo jednotlivých virtuálních počítačů. Existují následující skupiny zabezpečení sítě:
  ...
  - 1 skupina zabezpečení sítě pro službu Active Directory
  - 1 skupina zabezpečení sítě pro úlohu
...
Diagram toku dat pro tuto referenční architekturu je k dispozici ke [stažení](https://aka.ms/uknhs-analytics-tm) nebo najdete níže. Tento model může zákazníkům usnadnit pochopení bodů potenciálního rizika v systémové infrastruktuře při provádění úprav.

![Analýzy pro NHS Threat – model hrozeb pro Spojené království](images/uknhs-analytics-threat-model.png?raw=true "Analýzy pro NHS Threat – model hrozeb pro Spojené království")

## <a name="compliance-documentation"></a>Dokumentace k dodržování předpisů

V tabulce [podrobný plán zabezpečení a dodržování předpisů Azure – Velká Británie NHS](https://aka.ms/uknhs-crm) se zobrazí všechny zásady zabezpečení, které vyžadují Velká Británie NHS. Tato matice podrobně popisuje, zda je implementace každého principu zodpovědností společnosti Microsoft, zákazníka nebo sdílené mezi nimi.

[Tabulka podrobný plán zabezpečení a dodržování předpisů Azure – Velká Británie NHS data Analytics Implementation](https://aka.ms/uknhs-analytics-cim) poskytuje informace o tom, které požadavky na Velká Británie NHS jsou řešeny architekturou analýzy dat, včetně podrobného popisu implementace splňuje požadavky každého zahrnutého principu.

...
ms.locfileid: "97675849"
---
# <a name="manage-baremetal-instances-through-the-azure-portal"></a>Správa instancí BareMetal pomocí Azure Portal
 
Tento článek ukazuje, jak [Azure Portal](https://portal.azure.com/) zobrazuje instance BareMetal. Tento článek také ukazuje aktivity, které můžete provádět v Azure Portal s nasazenými jednotkami instancí BareMetal. 
...
>[!NOTE]
>Revize 4,2 je nejnovější BareMetal infrastruktura s použitím architektury revize 4. Má významná vylepšení latence sítě mezi virtuálními počítači Azure a jednotkami instancí BareMetal nasazenými v revizích 4 nebo v řádcích.
...
Pokud chcete získat další informace o BareMetal, přečtěte si téma [typy úloh BareMetal](../../../virtual-machines/workloads/sap/get-started.md).
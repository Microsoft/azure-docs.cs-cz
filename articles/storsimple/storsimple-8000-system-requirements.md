...
| Komponenta | Platforma hostitele | Další požadavky/poznámky |
| --- | --- | --- |
...
| `http://*.deploy.akamaitechnologies.com` |Akamai CDN |Pouze pevné IP adresy řadiče |

...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/timelive-tutorial/tutorial_timelive_samlbase.png)

3. Na **TimeLive domény a adresy URL** část, proveďte následující kroky:

    ![TimeLive domény a adresy URL jednotné přihlašování informace](./media/timelive-tutorial/tutorial_timelive_url.png)
...
5. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/timelive-tutorial/tutorial_general_400.png)
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/timelive-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **TimeLive**.
    ...
    ![V seznamu aplikací na TimeLive odkaz](./media/timelive-tutorial/tutorial_timelive_app.png)  

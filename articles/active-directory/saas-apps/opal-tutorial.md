...
1. Do vyhledávacího pole zadejte **Opal**vyberte **Opal** z panelu výsledků klikněte **přidat** tlačítko pro přidání aplikace.
...
1. **[Vytvořit testovacího uživatele Opal](#create-an-opal-test-user)**  – Pokud chcete mít protějšek Britta Simon Opal, který je propojený s Azure AD reprezentace uživatele.
...
1. Na **Opal domény a adresy URL** části, proveďte následující kroky:
...
1. Opal aplikace očekává, že kontrolní výrazy SAML v určitém formátu. Nakonfigurujte následující deklarace identity pro tuto aplikaci. Můžete spravovat hodnotami těchto atributů z **atributy uživatele** části na stránce aplikací pro integraci. Následující snímek obrazovky ukazuje příklad pro tuto.
...
1. Ke konfiguraci jednotného přihlašování na **Opal** straně, je nutné odeslat na stažený **soubor XML s metadaty** k [tým podpory Opal](mailto:support@workwithopal.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.
...
1. V seznamu aplikací vyberte **Opal**.

...
ms.locfileid: "104596619"
---
# <a name="azure-policy-built-in-definitions-for-azure-rbac"></a>Azure Policy předdefinované definice pro Azure RBAC

Tato stránka je indexem [Azure Policy](../governance/policy/overview.md) integrovaných definic zásad pro Azure RBAC. Další Azure Policy integrovaných pro jiné služby najdete v tématu [Azure Policy předdefinované definice](../governance/policy/samples/built-in-policies.md).

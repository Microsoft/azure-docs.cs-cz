...
Teď je potřeba vytvořit tenanta Azure AD, abyste mohli synchronizovat naše uživatele s cloudem.  Pokud chcete vytvořit nového tenanta Azure AD, udělejte toto:
...
3. Ve výsledcích hledání vyberte **Azure Active Directory** .
4. Vyberte **Create** (Vytvořit).</br>
![Vytvoření](media/tutorial-single-forest/create1.png)</br>
5. Zadejte **název organizace** spolu s **počátečním názvem domény**. Potom vyberte **Vytvořit**. Tím se vytvoří váš adresář.
...
3.  Zadejte jméno a uživatelské jméno pro tohoto uživatele. Toto bude váš globální správce pro tenanta. Také budete chtít změnit **roli adresáře** na **globální správce.** Můžete také zobrazit dočasné heslo. Po dokončení vyberte **vytvořit**.</br>

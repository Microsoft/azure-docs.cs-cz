...
1. Po [Povolení replikace](site-recovery-hyper-v-site-to-azure.md) pro virtuální počítač VMware po výběru virtuálních počítačů, které chcete replikovat, na stránce povolit > **replikace** **vlastnosti** > **Konfigurovat vlastnosti** zkontrolujte sloupec disky, které chcete **replikovat** . Ve výchozím nastavení jsou pro replikaci vybrány všechny disky.

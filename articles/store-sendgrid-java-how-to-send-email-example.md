...
Dále, známý s použitím informací v [vytvoření aplikace Hello World pro Azure v Eclipse](/java/azure/eclipse/azure-toolkit-for-eclipse-create-hello-world-web-app?view=azure-java-stable), nebo s dalšími technikami, hostování aplikací Java v Azure, pokud nepoužíváte Eclipse, se důrazně doporučuje.

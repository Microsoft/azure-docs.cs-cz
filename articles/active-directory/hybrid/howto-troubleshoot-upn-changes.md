...
* Slouží jako zprostředkovatel ověřování na zařízeních s iOS a Androidem, aby poskytovala jednotné přihlašování pro aplikace, které používají zprostředkované [ověřování](../develop/brokered-auth.md) .

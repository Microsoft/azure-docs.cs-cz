...
* Můžete použít panel Microsoft Access. Po kliknutí na dlaždici TIMU na přístupovém panelu se tato akce přesměruje na přihlašovací adresu TIMU. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

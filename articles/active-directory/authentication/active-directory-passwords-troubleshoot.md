...
| Nevidím **integrace v místním** kartu. | Tato možnost pouze se zobrazí, pokud jste stáhli Azure AD Connect a nakonfigurovali zpětný zápis hesla. Další informace najdete v tématu [Začínáme s Azure AD Connect s použitím expresního nastavení](./../connect/active-directory-aadconnect-get-started-express.md). |

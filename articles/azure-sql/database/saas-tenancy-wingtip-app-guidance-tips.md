...
- [Nasazení samostatné aplikace SaaS lístky Wingtip Tickets](../../sql-database/saas-standaloneapp-get-started-deploy.md)
- [Nasazení databáze Wingtip Tickets SaaS Database na klientské aplikace](../../sql-database/saas-dbpertenant-get-started-deploy.md)
- [Nasazení aplikace SaaS multi-tenant Database pro víceklientské lístky Wingtip](../../sql-database/saas-multitenantdb-get-started-deploy.md)

...
description: Tento článek vás provede problémy, kterým můžete čelit s asymetrickým směrováním v síti, která má více propojení s cílem.

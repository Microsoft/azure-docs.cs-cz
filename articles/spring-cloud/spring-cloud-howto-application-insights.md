...
* V levém navigačním podokně klikněte na **dostupnost** a sledujte dostupnost a odezvu webových aplikací tím, že se vytvoří [testy dostupnosti v Application Insights](/azure/azure-monitor/app/monitor-web-app-availability).

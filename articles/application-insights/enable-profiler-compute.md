...
1. [Vytvořte nový prostředek Application Insights](https://docs.microsoft.com/azure/application-insights/app-insights-create-new-resource), nebo vyberte nějaký existující. 

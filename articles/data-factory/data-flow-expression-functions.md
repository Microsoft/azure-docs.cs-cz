...
Vypočítá inverzní hodnotu kosinus.* ``acos(1) -> 0.0``
---
### <code>add</code>
...
Vlevo vyplní řetězec doplněním zadaného odsazení, dokud nemá určitou délku. Pokud je řetězec větší nebo roven délce, pak * ``lpad('great', 10, '-') -> '-----great'`` se považuje za Lpad "No-op 
* ``lpad('great', 4, '-') -> 'great'`` 
* " ' (' Great ', 8, ' < > ')-> ' < ><great'``
---
### <code>LTrim</code>
...
Doplní řetězec doplněním zadaného odsazení, dokud nemá určitou délku. Pokud je řetězec větší nebo roven délce, pak se považuje za neop * ``rpad('great', 10, '-') -> 'great-----'``. 
* ``rpad('great', 4, '-') -> 'great'`` 
* ``rpad('great', 8, '<>') -> 'great<><'`` 
---

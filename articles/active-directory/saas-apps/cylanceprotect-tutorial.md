...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/cylanceprotect-tutorial/tutorial_cylanceprotect_samlbase.png)

3. Na **CylancePROTECT domény a adresy URL** část, proveďte následující kroky:

    ![CylancePROTECT domény a adresy URL jednotné přihlašování informace](./media/cylanceprotect-tutorial/tutorial_cylanceprotect_url.png)
...
5. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/cylanceprotect-tutorial/tutorial_general_400.png)
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/cylanceprotect-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **CylancePROTECT**.
    ...
    ![V seznamu aplikací na CylancePROTECT odkaz](./media/cylanceprotect-tutorial/tutorial_cylanceprotect_app.png)  

...
|[Nákupní modely a prostředky](sql-database-service-tiers.md)|Nákupní model založený na DTU|[Nákupní model založený na DTU](sql-database-service-tiers-dtu.md)|

---
title: 'Postupy: určení proměnných prostředí pro služby v Azure Service Fabric | Microsoft Docs'
...
2. V elementu `CodePackage` přidejte nový prvek `EnvironmentVariables` a prvek `EnvironmentVariable` pro každou proměnnou prostředí.
...
3. Chcete-li přepsat proměnné prostředí v manifestu aplikace, použijte prvek `EnvironmentOverrides`.

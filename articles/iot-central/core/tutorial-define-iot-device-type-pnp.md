...
![Zařízení IoT](./media/tutorial-define-iot-device-type-pnp/gateway-downstream-new.png)

Zobrazí se stránka pro kontrolu. Klikněte na tlačítko **vytvořit** . 

![Zařízení IoT](./media/tutorial-define-iot-device-type-pnp/gateway-downstream-review.png)

Vytvoří se nová šablona zařízení. 

![Zařízení IoT](./media/tutorial-define-iot-device-type-pnp/occupancy-sensor.png)

Vytvoří se šablona zařízení pro senzor S1. 

V levém navigačním panelu klikněte na šablony zařízení, klikněte na **+ Nový**, vyberte dlaždici **zařízení IoT** a vyberte dlaždici snímače obsazení a klikněte na **Další: přizpůsobit**

![Zařízení IoT](./media/tutorial-define-iot-device-type-pnp/s1-sensor.png)

Zobrazí se stránka pro kontrolu. Klikněte na tlačítko **vytvořit** . 

![Zařízení pro příjem dat](./media/tutorial-define-iot-device-type-pnp/s1-review.png)

Vytvoří se nová šablona zařízení. 

![Zařízení pro příjem dat](./media/tutorial-define-iot-device-type-pnp/s1-template.png)
...
![Stránka centrální aplikace](./media/tutorial-define-iot-device-type-pnp/gatewaypattern.png)
...
![Stránka centrální aplikace](./media/tutorial-define-iot-device-type-pnp/devicetemplate.png)

Kliknutím na **+ Nový** Začněte vytvářet novou šablonu zařízení.

![Šablony zařízení – nové](./media/tutorial-define-iot-device-type-pnp/devicetemplatenew.png)

![Výběr šablon zařízení – brána](./media/tutorial-define-iot-device-type-pnp/gateway-review.png)
...
![Výběr šablon zařízení – brána](./media/tutorial-define-iot-device-type-pnp/gateway-customize.png)

Zobrazí se stránka s přehledem, klikněte na **vytvořit** . 

![Šablona zařízení-brána](./media/tutorial-define-iot-device-type-pnp/gateway-review.png)
...
![Šablona zařízení-brána](./media/tutorial-define-iot-device-type-pnp/gateway-occupancy-s1-rel.png)
...
![Šablona zařízení-brána](./media/tutorial-define-iot-device-type-pnp/smartbuildingdevice.png)
...
![Šablona zařízení – obsazení](./media/tutorial-define-iot-device-type-pnp/occupancydevice.png)

V Průzkumníku zařízení se vytvoří simulovaný senzor S1. 

![Šablona zařízení – S1](./media/tutorial-define-iot-device-type-pnp/s1device.png)
...
![Šablona zařízení – S1](./media/tutorial-define-iot-device-type-pnp/connecttogateway.png)
...
> [Připojení zařízení](tutorial-connect-pnp-device-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)

---
title: 'Kurz: Integrace Azure Active Directory se službou Reviewsnap | Dokumentace Microsoftu'
...
ms.locfileid: "39045270"
---
# <a name="tutorial-azure-active-directory-integration-with-reviewsnap"></a>Kurz: Integrace Azure Active Directory se službou Reviewsnap
...
3. **[Vytvoření zkušebního uživatele Reviewsnap](#create-a-reviewsnap-test-user)**  – Pokud chcete mít protějšek Britta Simon Reviewsnap, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **Reviewsnap domény a adresy URL** části, proveďte následující kroky, pokud chcete nakonfigurovat aplikace v **IDP** iniciované režimu:
...
7. Na **Reviewsnap konfigurace** klikněte na tlačítko **nakonfigurovat Reviewsnap** otevřete **nakonfigurovat přihlašování** okna. Kopírovat **URL odhlašování SAML Entity ID a SAML jednotné přihlašování – adresa URL služby** z **Stručná referenční příručka oddílu.**

    ![Konfigurace Reviewsnap](./media/reviewsnap-tutorial/tutorial_reviewsnap_configure.png) 

8. Ke konfiguraci jednotného přihlašování na **Reviewsnap** straně, je nutné odeslat na stažený **certifikát (Base64), URL odhlašování, SAML Entity ID a SAML jednotné přihlašování – adresa URL služby** k [Reviewsnap tým podpory](mailto:support@reviewsnap.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

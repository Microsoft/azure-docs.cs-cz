...
4. Do vyhledávacího pole zadejte **Kantega jednotné přihlašování pro Bitbucket**.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/kantegassoforbitbucket-tutorial/tutorial_kantegassoforbitbucket_search.png)
...
5. Na panelu výsledků vyberte **Kantega jednotné přihlašování pro Bitbucket**a potom klikněte na **přidat** tlačítko Přidat aplikaci.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/kantegassoforbitbucket-tutorial/tutorial_kantegassoforbitbucket_addfromgallery.png)
...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Konfigurovat jednotné přihlašování](./media/kantegassoforbitbucket-tutorial/tutorial_kantegassoforbitbucket_samlbase.png)

3. V **IDP** spustil v režimu **Kantega SSO Bitbucket domény a adresy URL** části provést následující krok:

    ![Konfigurovat jednotné přihlašování](./media/kantegassoforbitbucket-tutorial/tutorial_kantegassoforbitbucket_url1.png)
...
4. V **SP** initiated režimu, zkontrolujte **zobrazit upřesňující nastavení adresy URL** a provést následující krok:
    ...
    ![Konfigurovat jednotné přihlašování](./media/kantegassoforbitbucket-tutorial/tutorial_kantegassoforbitbucket_url2.png)
...
5. Na **SAML podpisový certifikát** klikněte na tlačítko **soubor XML s metadaty** a potom uložte soubor metadat ve vašem počítači.
    ...
    ![Konfigurovat jednotné přihlašování](./media/kantegassoforbitbucket-tutorial/tutorial_kantegassoforbitbucket_certificate.png) 

6. Klikněte na tlačítko **Uložit** tlačítko.

    ![Konfigurovat jednotné přihlašování](./media/kantegassoforbitbucket-tutorial/tutorial_general_400.png)
...
8. Klikněte na ikonu a klikněte na **najít nové rozšíření**.
    ...
    ![Konfigurovat jednotné přihlašování](./media/kantegassoforbitbucket-tutorial/addon1.png)
...
9. Hledání **Kantega jednotné přihlašování pro Bitbucket SAML & protokolu Kerberos** a klikněte na tlačítko **nainstalovat** tlačítko k instalaci nové zásuvný modul SAML.
    ...
    ![Konfigurovat jednotné přihlašování](./media/kantegassoforbitbucket-tutorial/addon2.png)

10. Spustí se instalace modulu plug-in.

    ![Konfigurovat jednotné přihlašování](./media/kantegassoforbitbucket-tutorial/addon31.png)

11. Po dokončení instalace. Klikněte na **Zavřít**.

    ![Konfigurovat jednotné přihlašování](./media/kantegassoforbitbucket-tutorial/addon33.png)

12. Klikněte na **Manage** (Spravovat).

    ![Konfigurovat jednotné přihlašování](./media/kantegassoforbitbucket-tutorial/addon34.png)
    
13. Klikněte na tlačítko **konfigurace** konfigurace nového modulu plug-in.    

    ![Konfigurovat jednotné přihlašování](./media/kantegassoforbitbucket-tutorial/addon35.png)

14. V **SAML** části. Vyberte **Azure Active Directory (Azure AD)** z **zprostředkovatele identity přidat** rozevíracího seznamu.

    ![Konfigurovat jednotné přihlašování](./media/kantegassoforbitbucket-tutorial/addon4.png)

15. Vyberte úroveň předplatné jako **základní**.

    ![Konfigurovat jednotné přihlašování](./media/kantegassoforbitbucket-tutorial/addon5.png)

16. Na **vlastností aplikace** část, proveďte následující kroky:

    ![Konfigurovat jednotné přihlašování](./media/kantegassoforbitbucket-tutorial/addon6.png)
...
17. Na **import metadat** část, proveďte následující kroky:
    ...
    ![Konfigurovat jednotné přihlašování](./media/kantegassoforbitbucket-tutorial/addon7.png)
...
18. Na **název a jednotného přihlašování k umístění** část, proveďte následující kroky:
    ...
    ![Konfigurovat jednotné přihlašování](./media/kantegassoforbitbucket-tutorial/addon8.png)
...
19. Ověřte podpisového certifikátu a klikněte na **Další**.  
    ...
    ![Konfigurovat jednotné přihlašování](./media/kantegassoforbitbucket-tutorial/addon9.png)

20. Na **Bitbucket uživatelské účty** část, proveďte následující kroky:

    ![Konfigurovat jednotné přihlašování](./media/kantegassoforbitbucket-tutorial/addon10.png)
...
21. Klikněte na **Dokončit**.
    ...
    ![Konfigurovat jednotné přihlašování](./media/kantegassoforbitbucket-tutorial/addon11.png)

22. Na **známé domén pro Azure AD** část, proveďte následující kroky: 

    ![Konfigurovat jednotné přihlašování](./media/kantegassoforbitbucket-tutorial/addon12.png)
...
1. V **portál Azure**, v levém navigačním podokně klikněte na tlačítko **Azure Active Directory** ikonu.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/kantegassoforbitbucket-tutorial/create_aaduser_01.png) 

2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin** a klikněte na tlačítko **všichni uživatelé**.
    
    ![Vytváření testovacího uživatele Azure AD](./media/kantegassoforbitbucket-tutorial/create_aaduser_02.png) 

3. Chcete-li otevřít **uživatele** dialogové okno, klikněte na tlačítko **přidat** horní dialogové okno.
 
    ![Vytváření testovacího uživatele Azure AD](./media/kantegassoforbitbucket-tutorial/create_aaduser_03.png) 

4. Na **uživatele** dialogové okno stránky, proveďte následující kroky:
 
    ![Vytváření testovacího uživatele Azure AD](./media/kantegassoforbitbucket-tutorial/create_aaduser_04.png) 
...
2. Klikněte na ikonu nastavení.
    ...
    ![Můžete přidat zaměstnance](./media/kantegassoforbitbucket-tutorial/user1.png) 

3. V části **správy** oddíl, klikněte na **uživatelé**.

    ![Můžete přidat zaměstnance](./media/kantegassoforbitbucket-tutorial/user2.png)

4. Klikněte na tlačítko **vytvořit uživateli**.

    ![Můžete přidat zaměstnance](./media/kantegassoforbitbucket-tutorial/user3.png)   

5. Na **vytvořit uživatele** dialogové okno stránky, proveďte následující kroky:

    ![Můžete přidat zaměstnance](./media/kantegassoforbitbucket-tutorial/user4.png) 
...
2. V seznamu aplikací vyberte **Kantega jednotné přihlašování pro Bitbucket**.
    ...
    ![Konfigurovat jednotné přihlašování](./media/kantegassoforbitbucket-tutorial/tutorial_kantegassoforbitbucket_app.png) 

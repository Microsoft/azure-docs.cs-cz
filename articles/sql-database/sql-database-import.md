...
- Importovat do databáze v elastickém fondu se nepodporuje. Můžete importovat data do databáze jednotlivý prvek a potom přesunout databázi do fondu.

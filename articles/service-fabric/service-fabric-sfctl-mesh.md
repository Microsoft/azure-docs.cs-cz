...
|Podskupina|Popis|
| --- | --- |
| [app](service-fabric-sfctl-mesh-app.md) | Získejte a odstraňte prostředky aplikace. |
...
| [gateway](service-fabric-sfctl-mesh-gateway.md) | Získejte a odstraňte prostředky brány sítě. |
| [sítě](service-fabric-sfctl-mesh-network.md) | Získat a odstranit síťové prostředky sítě. |
| [secret](service-fabric-sfctl-mesh-secret.md) | Získá a odstraní prostředky tajného klíče sítě. |
...
| [service-replica](service-fabric-sfctl-mesh-service-replica.md) | Získá podrobnosti o replice a vypíše repliky dané služby v prostředku aplikace. |

...
Další informace o konfiguraci diagnostiky najdete v tématu Přehled [protokolů prostředků Azure](https://docs.microsoft.com/azure/azure-monitor/platform/platform-logs-overview).

...
* Můžete povolit uživatelům být automaticky přihlášeni k Sequr (Single Sign-On) s jejich účty Azure AD.
...
* Podporuje Sequr **SP a zprostředkovatele identity** jednotné přihlašování zahájené pomocí
...
V této části je konfigurace a testování Azure AD jednotné přihlašování pomocí Sequr podle testovacího uživatele volá **Britta Simon**.
Pro jednotné přihlašování pro práci je potřeba navázat vztah odkazu mezi uživatele služby Azure AD a související uživatelské v Sequr.
...
2. **[Konfigurace Sequr Single Sign-On](#configure-sequr-single-sign-on)**  – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
3. **[Vytvořit testovacího uživatele Azure AD](#create-an-azure-ad-test-user)**  – Pokud chcete otestovat Azure AD jednotné přihlašování s Britta Simon.
4. **[Přiřadit uživatele Azure AD](#assign-the-azure-ad-test-user)**  – Pokud chcete povolit Britta Simon používat Azure AD jednotného přihlašování.
5. **[Vytvořit testovacího uživatele Sequr](#create-sequr-test-user)**  – Pokud chcete mít protějšek Britta Simon Sequr, který je propojený s Azure AD reprezentace uživatele.
...
1. V [webu Azure portal](https://portal.azure.com/)na **Sequr** integrace stránce aplikace vyberte **jednotného přihlašování**.
...
4. Na **základní konfiguraci SAML** části, pokud chcete nakonfigurovat aplikace v **IDP** iniciované režimu, postupujte následovně:
    ...
    ![Sequr domény a adresy URL jednotného přihlašování – informace](common/idp-identifier.png)

    V **identifikátor** textové pole, zadejte adresu URL:  `https://login.sequr.io`

5. Klikněte na tlačítko **nastavit další adresy URL** a provést následující krok, pokud chcete nakonfigurovat aplikace v **SP** iniciované režimu:

    ![image](common/both-advanced-urls.png)

    a. V **přihlašovací adresa URL** textové pole, zadejte adresu URL: `https://login.sequr.io`
...
7. Na **nastavení Sequr** tématu, zkopírujte příslušné adresy URL podle vašich požadavků.
...
### <a name="configure-sequr-single-sign-on"></a>Konfigurace Sequr jednotné přihlašování
...
1. V **spravovat Single Sign-On** části, proveďte následující kroky:
    ...
    a. V **jednotné přihlašování – adresa URL zprostředkovatele Identity** vložit do textového pole **přihlašovací adresa URL** hodnotu, kterou jste zkopírovali z portálu Azure portal.

    b. Přetáhnout myší **certifikát** soubor, který jste si stáhli z webu Azure portal nebo ručně zadat obsahu certifikátu.

    c. Po uložení konfigurace se vygeneruje hodnota stavu relay. Kopírování **propojení stavu** hodnotu a vložte ji **stav přenosu** textové pole z **základní konfiguraci SAML** části webu Azure Portal.
...
1. Na webu Azure Portal, vyberte **podnikové aplikace**vyberte **všechny aplikace**a pak vyberte **Sequr**.
...
### <a name="create-sequr-test-user"></a>Vytvoření Sequr testovacího uživatele
...
Po kliknutí na dlaždici Sequr na přístupovém panelu, můžete by měl být automaticky přihlášeni k Sequr, u kterého nastavíte jednotné přihlašování. Další informace o přístupovém panelu, naleznete v tématu [Úvod k přístupovému panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

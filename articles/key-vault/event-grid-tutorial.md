...
- Trezor klíčů ve vašem předplatném Azure. Nový trezor klíčů můžete rychle vytvořit podle kroků v [nastavení a načíst tajný klíč z azure key vault pomocí Azure CLI](quick-create-cli.md).

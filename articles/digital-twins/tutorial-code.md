...
Přidejte tento nový `using` příkaz v horní části, protože tato ukázka kódu používá vestavěný serializátor .NET JSON v `System.Text.Json` :

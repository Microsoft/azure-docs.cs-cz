...
4. Do vyhledávacího pole zadejte **Mixpanel**.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/mixpanel-tutorial/tutorial_mixpanel_search.png)

5. Na panelu výsledků vyberte **Mixpanel**a potom klikněte na **přidat** tlačítko Přidat aplikaci.

    ![Vytváření testovacího uživatele Azure AD](./media/mixpanel-tutorial/tutorial_mixpanel_addfromgallery.png)
...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Konfigurovat jednotné přihlašování](./media/mixpanel-tutorial/tutorial_mixpanel_samlbase.png)

3. Na **Mixpanel domény a adresy URL** část, proveďte následující kroky:

    ![Konfigurovat jednotné přihlašování](./media/mixpanel-tutorial/tutorial_mixpanel_url.png)
...
4. Na **SAML podpisový certifikát** klikněte na tlačítko **Certificate(Base64)** a potom uložte soubor certifikátu v počítači.
    ...
    ![Konfigurovat jednotné přihlašování](./media/mixpanel-tutorial/tutorial_mixpanel_certificate.png) 

5. Klikněte na tlačítko **Uložit** tlačítko.

    ![Konfigurovat jednotné přihlašování](./media/mixpanel-tutorial/tutorial_general_400.png)
...
6. Na **Mixpanel konfigurace** klikněte na tlačítko **konfigurace Mixpanel** otevřete **konfigurovat přihlášení** okno. Kopírování **SAML jeden přihlašování adresa URL služby** z **Stručná referenční příručka části.**
    ...
    ![Konfigurovat jednotné přihlašování](./media/mixpanel-tutorial/tutorial_mixpanel_configure.png) 
...
9. Klikněte **zabezpečení přístupu k** a pak klikněte **změnit nastavení**.
    ...
    ![Nastavení Mixpanel](./media/mixpanel-tutorial/tutorial_mixpanel_08.png) 
...
10. Na **změnit svůj certifikát** dialogové okno stránky, klikněte na tlačítko **zvolte soubor** stažený certifikát, a pak klikněte na **Další**.
    ...
    ![Nastavení Mixpanel](./media/mixpanel-tutorial/tutorial_mixpanel_09.png) 
...
11.  Ověřování adresy URL do textového pole na **změnit adresu URL ověřování** dialogové okno stránky, vložte hodnotu **SAML jeden přihlašování adresa URL služby** který jste zkopírovali z portálu Azure a potom klikněte na **Další**.
   ...
   ![Nastavení Mixpanel](./media/mixpanel-tutorial/tutorial_mixpanel_10.png) 
...
1. V **portál Azure**, v levém navigačním podokně klikněte na tlačítko **Azure Active Directory** ikonu.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/mixpanel-tutorial/create_aaduser_01.png) 

2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin** a klikněte na tlačítko **všichni uživatelé**.
    
    ![Vytváření testovacího uživatele Azure AD](./media/mixpanel-tutorial/create_aaduser_02.png) 

3. Chcete-li otevřít **uživatele** dialogové okno, klikněte na tlačítko **přidat** horní dialogové okno.
 
    ![Vytváření testovacího uživatele Azure AD](./media/mixpanel-tutorial/create_aaduser_03.png) 

4. Na **uživatele** dialogové okno stránky, proveďte následující kroky:
 
    ![Vytváření testovacího uživatele Azure AD](./media/mixpanel-tutorial/create_aaduser_04.png) 
...
4. V **člen týmu** textovému poli, zadejte na Britta e-mailovou adresu ve službě Azure.
    ...
    ![Nastavení Mixpanel](./media/mixpanel-tutorial/tutorial_mixpanel_11.png) 
...
2. V seznamu aplikací vyberte **Mixpanel**.
    ...
    ![Konfigurovat jednotné přihlašování](./media/mixpanel-tutorial/tutorial_mixpanel_app.png) 

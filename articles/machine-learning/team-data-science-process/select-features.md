...
* Za druhé sníží počet funkcí, což vede k efektivnějšímu procesu školicích modelů. Efektivita je zvláště důležitá pro informace, které jsou nákladné pro výuku, jako je například podpora vektorových počítačů.
...
![Vlastnosti modulu výběru funkce založeného na filtrech](./media/select-features/feature-Selection1.png)

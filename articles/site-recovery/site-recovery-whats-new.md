...
ms.locfileid: "71937529"
---
# <a name="whats-new-in-site-recovery"></a>Co je nového v Site Recovery
...
**Aktualizace** | **Zobrazí**
--- | ---
**Poskytovatelé a agenti** | Aktualizace Site Recovery agentů a zprostředkovatelů (jak je popsáno v souhrnu)
...
### <a name="vmware-to-azure-disaster-recovery"></a>Zotavení po havárii z VMware do Azure

...
Následující ukázka přidá kolekci [událostí Windows](../agents/data-sources-windows-events.md) do existujícího pracovního prostoru.
...
Následující ukázka přidá kolekci [událostí SYSLOG](../agents/data-sources-syslog.md) do existujícího pracovního prostoru.
...
Následující ukázka přidá kolekci [čítačů výkonu Windows](../agents/data-sources-performance-counters.md) do existujícího pracovního prostoru.
...
Následující ukázka přidá kolekci [čítačů výkonu systému Linux](../agents/data-sources-performance-counters.md) do existujícího pracovního prostoru.
...
Následující ukázka přidá kolekci [vlastních protokolů](../agents/data-sources-custom-logs.md) do existujícího pracovního prostoru.
...
Následující ukázka přidá kolekci [protokolů služby IIS](../agents/data-sources-iis-logs.md) do existujícího pracovního prostoru.

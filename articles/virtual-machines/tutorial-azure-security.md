---
title: Kurz – použití Azure Security Center pro virtuální počítače v Azure
description: V tomto kurzu se dozvíte o funkcích Azure Security Center, které vám pomůžou chránit a zabezpečovat vaše virtuální počítače v Azure.
author: cynthn
manager: gwallace
...
ms.locfileid: "94595217"
---
# <a name="tutorial-use-azure-security-center-to-monitor-virtual-machines"></a>Kurz: použití Azure Security Center k monitorování virtuálních počítačů

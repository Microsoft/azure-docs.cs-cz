...
1. Ve webovém prohlížeči přejděte na `https://CLUSTERNAME.azurehdinsight.net/jupyter` místo, kde název_clusteru je název vašeho clusteru.
...
5. Nová buňka se vytvoří pod první. Do nové buňky zadejte následující text. `CONTAINER` Nahraďte `STORAGEACCOUNT` a názvem účtu Azure Storage a názvem kontejneru objektů blob, který obsahuje Application Insights data.
...
5. Nová buňka se vytvoří pod první. Do nové buňky zadejte následující text. `CONTAINER` Nahraďte `STORAGEACCOUNT` a názvem účtu Azure Storage a názvem kontejneru objektů blob, který obsahuje protokoly Application Insights.

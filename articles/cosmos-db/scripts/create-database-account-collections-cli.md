---
title: "Skript Azure CLI – Vytvoření účtu, databáze a kolekce rozhraní SQL API služby Azure Cosmos DB | Microsoft Docs"
description: "Ukázkový skript Azure CLI – Vytvoření účtu, databáze a kolekce rozhraní SQL API služby Azure Cosmos DB"
services: cosmos-db
...
Tento ukázkový skript rozhraní příkazového řádku vytvoří účet, databázi a kolekci rozhraní SQL API služby Azure Cosmos DB.  

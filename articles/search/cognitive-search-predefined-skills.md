...
| [Microsoft.Skills.Custom.WebApiSkill](cognitive-search-custom-skill-web-api.md) | Umožňuje rozšiřitelnost kanálu rozšíření AI vytvořením volání HTTP do vlastního webového rozhraní API. |

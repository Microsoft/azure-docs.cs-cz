...
Pokud si nejste jisti, jak získat ID tenanta a ID předplatného, přečtěte si téma [Jak najít ID](setup-azure-tenant-how-to.md) tenanta a [najít ID tenanta](setup-azure-tenant-how-to.md).

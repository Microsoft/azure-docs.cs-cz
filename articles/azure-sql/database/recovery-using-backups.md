...
K dispozici jsou následující možnosti pro obnovení databáze pomocí [automatických záloh databáze](automated-backups-overview.md). Máte následující možnosti:

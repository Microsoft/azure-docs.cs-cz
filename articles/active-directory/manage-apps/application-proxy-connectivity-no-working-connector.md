...
Pokud máte aktivní konektor, který by měl patřit do skupiny a má řadu pohledů na cílovou back-end aplikaci, můžete konektor přesunout do přiřazené skupiny. Uděláte to tak, klikněte na tento konektor. V poli Skupina konektoru vyberte správnou skupinu pomocí rozevíracího seznamu a klikněte na Uložit.

...
1. Budete potřebovat knihovnu [apache httpclient](https://hc.apache.org/downloads.cgi). Stáhněte si například binární soubor HttpClient 4.x.x.tar.gz a vyhledejte všechny soubory JAR, které potřebujete pro import do svého projektu.

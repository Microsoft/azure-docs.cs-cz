...
Abyste mohli ověřovat pomocí AWS, musíte zadat sadu přihlašovacích údajů AWS a ověřit svoje runbooky spuštěné ve službě Azure Automation. Pokud už máte účet Automation vytvořený a chcete ho použít k ověřování pomocí AWS, můžete postupovat podle kroků v následující části: Pokud chcete vyhradit účet pro Runbooky cílící na prostředky AWS, měli byste nejdřív vytvořit nový [účet Automation](automation-offering-get-started.md) (přeskočit možnost Vytvoření instančního objektu) a použít následující postup:
...
Po vytvoření a zkopírování bezpečnostních klíčů AWS vytvořte pomocí účtu Azure Automation asset přihlašovacích údajů, bezpečně klíče uložte a odkazujte na ně ve svých runboocích. Postupujte podle kroků v části: **vytvoření nových přihlašovacích údajů** v [prostředcích přihlašovacích údajů v Azure Automation](shared-resources/credentials.md#to-create-a-new-credential-asset-with-the-azure-portal) článku a zadejte následující informace:

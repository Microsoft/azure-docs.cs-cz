...
- Provoz Přizpůsobený operační systém, který běží na virtuálních počítačích hostitele.
...
- Jedná Hostovaný operační systém, který běží na virtuálních počítačích hosta.

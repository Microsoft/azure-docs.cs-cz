...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-getthere"></a>Kurz: Azure Active Directory integraci jednotného přihlašování s gettam
...
Chcete-li konfigurovat jednotné přihlašování na straně getside, je třeba odeslat stažený **certifikát (Base64)** a příslušné zkopírované adresy URL z Azure Portal do [týmu podpory](mailto:dataintegration@sabre.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

### <a name="create-getthere-test-user"></a>Vytvořit gettest User – uživatel

V této části vytvoříte uživatele s názvem B. Simon v gettam. Pokud chcete přidat uživatele v platformě GetPlatform, pracujte s [týmem podpory](mailto:dataintegration@sabre.com) . Uživatelé musí vytvořit a aktivovat, než použití jednotného přihlašování.

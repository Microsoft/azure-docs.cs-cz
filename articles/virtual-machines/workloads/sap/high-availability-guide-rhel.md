...
<pre><code>sudo pcs property set maintenance-mode=true
   ...
   Pokud jste upgrade ze starší verze a přechodu k zařazení do fronty server 2, viz poznámka sap [2641322](https://launchpad.support.sap.com/#/notes/2641322). 

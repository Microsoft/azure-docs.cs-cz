...
3. Vložte hodnotu UŽIVATELSKÉ JMÉNO z portálu místo `<PROVIDE>` na řádku 13.
...
3. Přejděte zpátky na portál a zkopírujte hodnotu HESLO. Vložte hodnotu HESLO z portálu místo `<PROVIDE>` na řádku 14.

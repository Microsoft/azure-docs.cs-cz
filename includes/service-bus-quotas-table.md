...
| Počet témat nebo front na obor názvů |Obor názvů |Odeslání dalších žádostí o vytvoření nového tématu nebo fronty v oboru názvů odmítají. V důsledku toho pokud je nakonfigurovaný pomocí [webu Azure portal][Azure portal], je vygenerována chybová zpráva. Pokud je volána z rozhraní API pro správu, volající kód přijme výjimku. |10 000<br /><br />Celkový počet témat a front v oboru názvů musí být menší než nebo rovna 10 000. |

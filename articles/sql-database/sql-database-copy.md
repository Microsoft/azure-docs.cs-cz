...
The following errors can be encountered while copying a database in Azure SQL Database. Další informace najdete v tématu [Kopírování databáze služby Azure SQL Database](sql-database-copy.md).

...
description: Kurz – vytvoření Sparkové aplikace napsané v jazyce Scala pomocí nástroje Apache Maven jako systém sestavení a existující archetypu Maven pro Scala poskytované IntelliJ IDEA.

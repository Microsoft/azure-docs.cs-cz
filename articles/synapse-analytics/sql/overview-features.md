...
| **Procedury** | [Ano](/sql/t-sql/statements/create-procedure-transact-sql?view=azure-sqldw-latest&preserve-view=true) | Ano |
...
| **Proměnné tabulek** | [Ne](/sql/t-sql/data-types/table-transact-sql?view=azure-sqldw-latest&preserve-view=true), použít dočasné tabulky | Ne |
...
|   | Vyhrazená | Bez serveru |
| --- | --- | --- |
| **Příkaz SELECT** | Ano. Klauzule dotazu Transact-SQL [pro XML/for JSON](/sql/t-sql/queries/select-for-clause-transact-sql?view=azure-sqldw-latest&preserve-view=true)a [porovnávání](/sql/t-sql/queries/match-sql-graph?view=azure-sqldw-latest&preserve-view=true) nejsou podporovány. | Ano. Klauzule dotazu Transact-SQL [pro příkazy jazyka XML](/sql/t-sql/queries/select-for-clause-transact-sql?view=azure-sqldw-latest&preserve-view=true), [porovnávání](/sql/t-sql/queries/match-sql-graph?view=azure-sqldw-latest&preserve-view=true), [předpovědi](/sql/t-sql/queries/predict-transact-sql?view=azure-sqldw-latest&preserve-view=true)a dotazování nejsou podporovány. |
| **Příkaz INSERT** | Ano | Ne |
| **Příkaz UPDATE** | Ano | Ne |
| **Příkaz DELETE** | Ano | Ne |
| **Příkaz MERGE** | Ano ([Preview](/sql/t-sql/statements/merge-transact-sql?view=azure-sqldw-latest&preserve-view=true)) | Ne |
| **[Transakce](develop-transactions.md)** | Ano | Ano, platí pro objekty meta-data. |
...
| **Mezidatabázové dotazy** | Ne | Ano, včetně příkazu [Use](/sql/t-sql/language-elements/use-transact-sql?view=azure-sqldw-latest&preserve-view=true) . |
...
| **[Uživatelé s omezením](/sql/relational-databases/security/contained-database-users-making-your-database-portable?view=azure-sqldw-latest&preserve-view=true)** | Ano. **Poznámka:** správce může být bez omezení jenom u jednoho uživatele Azure AD. | Ne |
...
| **Ověřování identity aplikace úložiště** | [Ano](/sql/t-sql/statements/create-external-data-source-transact-sql?view=azure-sqldw-latest&preserve-view=true) | Ne |
...
| **Oprávnění – na [úrovni databáze](/sql/relational-databases/security/authentication-access/database-level-roles?view=azure-sqldw-latest&preserve-view=true)** | Ano | Ano |
...
| **Oprávnění – [zabezpečení na úrovni sloupců](../sql-data-warehouse/column-level-security.md?bc=%2fazure%2fsynapse-analytics%2fbreadcrumb%2ftoc.json&toc=%2fazure%2fsynapse-analytics%2ftoc.json)** | Ano | Ano |
...
| **Zabezpečení na úrovni řádků** | [Ano](/sql/relational-databases/security/row-level-security?toc=/azure/synapse-analytics/sql-data-warehouse/toc.json&bc=/azure/synapse-analytics/sql-data-warehouse/breadcrumb/toc.json&view=azure-sqldw-latest&preserve-view=true) | Ne |
| **Transparentní šifrování dat** | [Ano](../../azure-sql/database/transparent-data-encryption-tde-overview.md) | Ne | 
| **Zjišťování a klasifikace dat** | [Ano](../../azure-sql/database/data-discovery-and-classification-overview.md) | Ne |
| **Posouzení ohrožení zabezpečení** | [Ano](../../azure-sql/database/sql-vulnerability-assessment.md) | Ne |
| **Advanced Threat Protection** | [Ano](../../azure-sql/database/threat-detection-overview.md)
| **Auditování** | [Ano](../../azure-sql/database/auditing-overview.md) | Ne |
...
| **Analytické úložiště Azure CosmosDB** | Ne | Ano, pomocí [odkazu synapse (verze Preview)](../../cosmos-db/synapse-link.md?bc=%2fazure%2fsynapse-analytics%2fbreadcrumb%2ftoc.json&toc=%2fazure%2fsynapse-analytics%2ftoc.json) ([Public Preview](../../cosmos-db/synapse-link.md?bc=%2fazure%2fsynapse-analytics%2fbreadcrumb%2ftoc.json&toc=%2fazure%2fsynapse-analytics%2ftoc.json#limitations)) |
...
| **ORC podregistru** | [Ano](/sql/t-sql/statements/create-external-file-format-transact-sql?view=azure-sqldw-latest&preserve-view=true) | Ne |
| **Podregistr RC** | [Ano](/sql/t-sql/statements/create-external-file-format-transact-sql?view=azure-sqldw-latest&preserve-view=true) | Ne |
| **JSON** | Ano | [Ano](query-json-files.md) |
| **Avro** | Ne | Ne |
| **[Rozdíl – Lake](https://delta.io/)** | Ne | Ne |
| **[CDM](/common-data-model/)** | Ne | No |

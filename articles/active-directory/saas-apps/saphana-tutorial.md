...
5. **[Vytvořit testovacího uživatele SAP HANA](#create-sap-hana-test-user)**  – Pokud chcete mít protějšek Britta Simon v SAP HANA, který je propojený s Azure AD reprezentace uživatele.

...
1. V aplikaci Visual Studio, vlastnosti projektu >-> linker-> Obecné > Další adresáře knihoven, přidejte adresář "\lib\opt" (například C:\Program Files (x86) \MySQL\MySQL Connector C++ 1.1.9 \ lib\opt) C++ konektoru.

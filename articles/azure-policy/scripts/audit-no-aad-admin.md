---
title: Ukázka kódu json pro Azure Policy – auditování, když není žádný správce Azure AD | Microsoft Docs
description: Tato ukázková zásada json udělá audit v situaci, kdy k SQL serveru není přiřazený žádný správce Azure Active Directory.

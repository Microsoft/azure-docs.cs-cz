...
Pokud chcete nainstalovat novou verzi agenta, postupujte podle kroků popsaných v [povolte monitorování pomocí Azure CLI](container-insights-enable-new-cluster.md#enable-using-azure-cli), k dokončení tohoto procesu.  

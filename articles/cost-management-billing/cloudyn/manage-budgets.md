...
Po dokončení se váš rozpočet zobrazuje ve většině sestav nákladů za **náklady** &gt; **analýzy nákladů** a v sestavě náklady vs. rozpočet v čase. Můžete také naplánovat sestavy na základě prahových hodnot rozpočtu pomocí **akce**.
...
V sestavě náklady vs. rozpočet v průběhu času klikněte na **Akce** a pak vyberte **naplánovat sestavu**. Na kartě prahovou hodnotu vyberte metriku prahovou hodnotu. Například **rozpočet vs procento nákladů**. Vyberte typ výstrahy a zadejte hodnotu v procentech rozpočtu. Pokud chcete upozorňování pouze jednou, vyberte **počet po sobě jdoucích výstrah** a pak zadejte _1_. Klikněte na možnost **Uložit**.

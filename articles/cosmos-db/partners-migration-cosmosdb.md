...
|**Partner**  |**Možnosti a prostředí**  |**Podporované země**  |**Obraťte se na**  |
|---------|---------|---------|---------|
|![Altoros][3]    |  Migrace NoSQL <br/> Inovace aplikací (existující aplikace) <br/> Vývoj aplikace |     USA, EVROPA    |  [Web](http://www.altoros.com/)       |
|![Attunix][4]     |   Migrace NoSQL <br/> Inovace aplikací (existující aplikace) <br/> Vývoj aplikace      |    USA     |  [Web](http://www.attunix.com/)       |
|![Společnosti Bluemetal][5]     |  Migrace NoSQL <br/> Inovace aplikací (existující aplikace) <br/> Vývoj aplikace       |    Severní Ameriky, Asie a Tichomoří     |  [Web](http://www.bluemetal.com/)       |
|![Globální Capax][6]     |  Migrace NoSQL <br/> Inovace aplikací (existující aplikace) <br/> Vývoj aplikace       |    USA     |  [Web](http://www.capaxglobal.com/)       |
...
|![Pragmatický funguje][10]    |   Migrace NoSQL      |   USA      |  [Web](http://www.pragmaticworks.com/)       |

...
Při použití [oficiální ovladači MongoDB Java](http://mongodb.github.io/mongo-java-driver/), můžete spustit příkazy voláním `runCommand` metodu na `MongoDatabase` objektu:

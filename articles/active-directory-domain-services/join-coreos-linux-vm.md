...
1. Nejprve pomocí `adcli info` příkazu ověřte, že se zobrazí informace o spravované doméně Azure služba AD DS. Následující příklad načte informace pro doménu *AADDSCONTOSO.com*. Zadejte vlastní název spravované domény Azure služba AD DS, a to velkými PÍSMENy:

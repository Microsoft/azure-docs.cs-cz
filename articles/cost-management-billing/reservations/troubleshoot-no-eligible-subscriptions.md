...
- Musíte být vlastníkem příslušného předplatného.
...
:::image type="content" source="./media/troubleshoot-no-eligible-subscriptions/subscription-not-eligible.png" alt-text="Příklady ukazující, proč rezervaci nejde koupit" :::

### <a name="cause-2"></a>Příčina 2

Musíte být vlastníkem příslušného předplatného. Nejste vlastníkem předplatného. Po výběru předplatného, u něhož nejste vlastníkem, se zobrazí následující chyba.
...
:::image type="content" source="./media/troubleshoot-no-eligible-subscriptions/no-owner-access.png" alt-text="Příklady ukazující, proč rezervaci nejde koupit" :::

...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/spacio-tutorial/tutorial_spacio_samlbase.png)

3. Na **Spacio domény a adresy URL** část, proveďte následující kroky:

    ![Spacio domény a adresy URL jednotné přihlašování informace](./media/spacio-tutorial/tutorial_spacio_url.png)
...
4. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/spacio-tutorial/tutorial_general_400.png)
...
6. Konfigurace jednotného přihlašování na **Spacio** straně, budete muset odeslat **adresu Url aplikace federační Metadata** k [tým podpory Spacio](mailto:support@spac.io). Nastavují toto nastavení tak, aby měl jednotné přihlašování SAML připojení správně nastavena na obou stranách.
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/spacio-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **Spacio**.
    ...
    ![V seznamu aplikací na Spacio odkaz](./media/spacio-tutorial/tutorial_spacio_app.png)  

...
- [Monitorujte služby Node. js s využitím Azure Application Insights](app/nodejs.md) – obecné aktualizace, včetně nových oddílů migrace z předchozích verzí.

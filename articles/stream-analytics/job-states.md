...
| --- | --- | --- |
| **Spuštěný** | Vaše úloha běží na Azure čtení událostí přicházejících z definovaných vstupních zdrojů, jejich zpracování a zápis výsledků do nakonfigurovaných výstupních umyvadel. | Osvědčeným postupem je sledovat výkon úlohy monitorováním [klíčových metrik](./stream-analytics-set-up-alerts.md#scenarios-to-monitor). |

...
* **Resetování hesel podporuje pro uživatele, kteří používají** [synchronizaci hodnoty hash hesla](./../connect/active-directory-aadconnectsync-implement-password-hash-synchronization.md): Pokud službu resetování hesla zjistí, zda účet synchronizované uživatele je povoleno pro synchronizaci hodnoty hash hesla, nemůžeme resetovat tato účtu místní a cloudové heslo současně. Zpětný zápis hesla není závislá na synchronizaci hodnoty hash hesla.

...
1. Do vyhledávacího pole zadejte **Insight4GRC**vyberte **Insight4GRC** z panelu výsledků klikněte **přidat** tlačítko pro přidání aplikace.
...
1. **[Vytvořit testovacího uživatele Insight4GRC](#create-an-insight4grc-test-user)**  – Pokud chcete mít protějšek Britta Simon Insight4GRC, který je propojený s Azure AD reprezentace uživatele.
...
1. Na **Insight4GRC domény a adresy URL** části, proveďte následující kroky, pokud chcete nakonfigurovat aplikace v **IDP** iniciované režimu:
...
1. Ke konfiguraci jednotného přihlašování na **Insight4GRC** straně, je nutné odeslat zkopírovaný **adresa Url federačních metadat aplikace** k [tým podpory Insight4GRC](mailto:support.ss@rsmuk.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.
...
1. V seznamu aplikací vyberte **Insight4GRC**.

---
title: Vyhodnocení instancí virtuálních počítačů s GCP pro migraci do Azure pomocí Azure Migrate
description: Popisuje, jak vyhodnotit instance virtuálních počítačů s GCP pro migraci do Azure pomocí Azure Migrate.
author: rashi-ms
ms.author: rajosh
ms.manager: abhemraj
ms.topic: tutorial
...
V tomto článku se dozvíte, jak pomocí nástroje Azure Migrate: zjišťování a hodnocení vyhodnotit instance virtuálních počítačů s Google Cloud Platform (GCP) pro migraci do Azure.
...
Rozhodněte, jestli chcete spustit posouzení pomocí kritérií velikosti na základě dat konfigurace serveru/metadat, která se shromažďují místně, nebo na základě dat o výkonu.
...
1. Zkontrolujte měsíční celkové náklady. Náklady se sčítají pro všechny virtuální počítače v hodnocené skupině.
    ...
    - Odhad nákladů vychází z doporučení pro velikost serveru, jeho disků a jeho vlastností.

...
:::image type="content" source="media//waf-sentinel/top-50-event-trigger.png" alt-text="Filtr akcí WAF":::

:::image type="content" source="media//waf-sentinel/attack-events.png" alt-text="Filtr akcí WAF":::

:::image type="content" source="media//waf-sentinel/top-10-attacking-ip-address.png" alt-text="Filtr akcí WAF":::
...
3. Na stránce nastavení diagnostiky:
   ...
   :::image type="content" source="media//waf-sentinel/diagnostics-setting.png" alt-text="Filtr akcí WAF":::

4. Na domovské stránce Azure zadejte do vyhledávacího panelu **Azure Sentinel** a vyberte prostředek služby **Azure Sentinel** . 
2. Vyberte už aktivní pracovní prostor nebo vytvořte nový pracovní prostor v Sentinel. 
...
4. Vyhledejte **Firewall webových aplikací společnosti Microsoft** a vyberte **Firewall webových aplikací (WAF) společnosti Microsoft**. V pravém dolním rohu vyberte stránku **otevřít konektor** .
   ...
   :::image type="content" source="media//waf-sentinel/data-connectors.png" alt-text="Filtr akcí WAF":::
...
6. Po dokončení konfigurace jednotlivých prostředků WAF vyberte kartu **Další kroky** . Vyberte jeden z doporučených sešitů. Tento sešit bude používat všechna analytická data protokolu, která byla dříve povolena. Pracovní sešit WAF by teď měl existovat pro vaše prostředky WAF.
   ...
   :::image type="content" source="media//waf-sentinel/waf-workbooks.png" alt-text="Filtr akcí WAF":::

...
Vytvořte sadu škálování pomocí [`az vmss create`](/cli/azure/vmss#az_vmss_create) `--specialized` parametru pomocí parametru, který označuje, že se jedná o specializovanou image.

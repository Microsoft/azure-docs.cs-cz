...
- **Uživatelé systému Linux:** SSH k virtuálnímu počítači pomocí IP adresy nebo plně kvalifikovaného názvu domény následovaný dvojtečkou a portem. Například na následujícím obrázku je `mydevtestlab597975021002.eastus.cloudapp.azure.com:50661`adresa RDP pro připojení k virtuálnímu počítači.

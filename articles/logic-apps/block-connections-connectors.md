...
1. V části **definice zásad**zadejte informace o definici zásady na základě vlastností popsaných v tomto příkladu:
   ...
   | **Vynucování zásad** | Ano | **Enabled** (Povoleno) | Toto nastavení určuje, jestli se má při ukládání vaší práce povolit nebo zakázat definici zásady. |
   ||||

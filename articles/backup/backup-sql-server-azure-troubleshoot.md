...
Další informace o procesu zálohování a omezeních najdete v tématu [informace o SQL Server Backup ve virtuálních počítačích Azure](sql-support-matrix.md#feature-consideration-and-limitations).

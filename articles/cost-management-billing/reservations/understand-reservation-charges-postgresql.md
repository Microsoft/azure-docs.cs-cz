...
* **Příklad 2**: na jednu hodinu spustíte dva Azure Database for PostgreSQL samostatné servery s 8 Vcore. Sleva za rezervaci 16 virtuálních jader se uplatní na využití výpočetních prostředků pro oba izolované servery Azure Database for PostgreSQL s 8 virtuálními jádry.

* **Příklad 3**: spustíte 1 16 Vcore Azure Database for PostgreSQL jeden server z 1./odp. do 1:30 ODP. Od 13:30 do 14:00 spustíte jiný izolovaný server Azure Database for PostgreSQL s 16 virtuálními jádry. Na obě se bude vztahovat sleva za rezervaci.

* **Příklad 4**: spustíte 1 16 Vcore Azure Database for PostgreSQL jeden server z 1./odp. do 1:45 odp. Od 13:30 do 14:00 spustíte jiný izolovaný server Azure Database for PostgreSQL s 16 virtuálními jádry. Za 15 minut, kdy se doba chodu obou databází překrývá, zaplatíte průběžnou platbu. Po zbytek doby se na využití výpočetních prostředků uplatňuje sleva za rezervaci.

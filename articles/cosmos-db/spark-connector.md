...
* Postupujte podle kroků v [Azure Databricks Začínáme](https://docs.azuredatabricks.net/getting-started/index.html) s nastavením pracovního prostoru Azure Databricks a clusteru.
...
Chcete-li pracovat s konektorem pomocí Spark `spark-shell`-CLI (tj `spark-submit` `pyspark`.,,), můžete použít `--packages` parametr s souřadnicemi [Maven](https://mvnrepository.com/artifact/com.microsoft.azure/azure-cosmosdb-spark_2.4.0_2.11)spojnice.
...
Pokud používáte poznámkové bloky Jupyter v HDInsight, můžete k určení souřadnic Maven spojnice použít buňku Spark-Magic `%%configure` .
...
* **Čas provozu v letadlech s Sparkem a Cosmos dB (Seattle)** [ipynb](https://github.com/Azure/azure-cosmosdb-spark/blob/master/samples/notebooks/On-Time%20Flight%20Performance%20with%20Spark%20and%20Cosmos%20DB%20-%20Seattle.ipynb)  |  [HTML](https://github.com/Azure/azure-cosmosdb-spark/blob/master/samples/notebooks/On-Time%20Flight%20Performance%20with%20Spark%20and%20Cosmos%20DB%20-%20Seattle.html): Připojte Spark k Cosmos DB pomocí služby HDInsight Jupyter poznámkového bloku, abyste předvedli Spark SQL, GraphFrames a předpověď zpoždění letu pomocí kanálů ML.
...
Na [wikiwebu](https://github.com/Azure/azure-cosmosdb-spark/wiki) máme další informace, `azure-cosmosdb-spark` včetně těchto:

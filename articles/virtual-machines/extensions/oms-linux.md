...
ms.locfileid: "72435839"
---
# <a name="azure-monitor-virtual-machine-extension-for-linux"></a>Azure Monitor rozšíření virtuálního počítače pro Linux

## <a name="overview"></a>Přehled

Protokoly Azure Monitor poskytují možnosti monitorování, upozorňování a nápravy výstrah napříč cloudem a místními prostředky. Rozšíření virtuálního počítače Log Analytics agenta pro Linux se zveřejňuje a podporuje Microsoft. Rozšíření nainstaluje agenta Log Analytics na virtuální počítače Azure a zaregistruje virtuální počítače do existujícího pracovního prostoru Log Analytics. Tento dokument podrobně popisuje podporované platformy, konfigurace a možnosti nasazení pro rozšíření Azure Monitor virtuálního počítače pro Linux.
...
Následující tabulka poskytuje mapování verze Azure Monitorho rozšíření virtuálního počítače a sady Log Analytics agenta pro každou verzi. Obsahuje odkaz na poznámky k verzi pro verzi sady Log Analytics agentů. Poznámky k verzi obsahují podrobnosti o opravách chyb a nové funkce, které jsou k dispozici pro danou verzi agenta.  

| Verze rozšíření virtuálního počítače s Azure Monitor Linux | Verze sady prostředků agenta Log Analytics | 
|--------------------------------|--------------------------|
...
>[!NOTE]
>Výše uvedené schéma předpokládá, že bude umístěn na kořenové úrovni šablony. Pokud jste ho umístili do prostředku virtuálního počítače v šabloně, je třeba změnit vlastnosti `type` a `name`, jak je popsáno [dále](#template-deployment).
>
...
| ---- | ---- |
| apiVersion | 2018-06-01 |
| Microsoft | Microsoft. EnterpriseCloud. Monitoring |
| type | OmsAgentForLinux |
| typeHandlerVersion | 1,7 |
...
Následující příklad předpokládá, že rozšíření virtuálního počítače je vnořené uvnitř prostředku virtuálního počítače. Při vnořování prostředku rozšíření je kód JSON umístěný do objektu `"resources": []` virtuálního počítače.

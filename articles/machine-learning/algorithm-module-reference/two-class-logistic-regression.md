...
description: Naučte se používat modul Two-Class logistické regrese v Azure Machine Learning k vytvoření modelu logistické regrese, který se dá použít k předpovědi dvou (a jenom dvou) výsledků.

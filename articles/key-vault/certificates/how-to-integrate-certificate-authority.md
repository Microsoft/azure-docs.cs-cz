...
Aby bylo možné dokončit tuto žádost, bude nutné sloučit CSR podepsané certifikační autoritou. Další informace najdete [tady](./create-certificate-signing-request.md).

---
title: Azure Service Fabric rozdíly mezi Linuxem a Windows
...
* Envoy (Reverse Proxy) je ve verzi Preview na Linuxu
...
* [Rozdíly v implementaci protokolu, které mohou ovlivnit škálovatelnost](service-fabric-concepts-scalability.md#choosing-a-platform)
...
* [Vytvořte a nasaďte svou první aplikaci Service Fabric Java na Linuxu pomocí service fabric pluginu pro Eclipse](service-fabric-get-started-eclipse.md)

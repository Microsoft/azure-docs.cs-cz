...
1. Spusťte `dotnet run` a začněte odesílat data ze senzorů. Pošle se do digitálních vláken Azure, jak je znázorněno na následujícím obrázku.

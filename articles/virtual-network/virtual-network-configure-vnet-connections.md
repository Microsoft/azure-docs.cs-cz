...
Pokud splňujete požadavky, můžete postupovat podle [kurzu: Propojení virtuálních sítí s využitím partnerského vztahu virtuálních sítí pomocí](https://docs.microsoft.com/azure/virtual-network/virtual-network-create-peering) Azure Portal vytvořte a nakonfigurujte partnerský vztah.
...
6. Ověřte, jestli jsou předsdílené klíče v obou připojených virtuálních sítích stejné:
   - Klasická virtuální síť: **Definice místní sítě** 1
   - Azure Resource Manager virtuální síť: **Objekt připojení** 4
...
Řešení potíží [s článkem: Problémy](https://docs.microsoft.com/azure/vpn-gateway/vpn-gateway-troubleshoot-vpn-point-to-site-connection-problems) s připojením Point-to-site vás provedou běžnými problémy s připojením Point-to-site.
...
Azure v současné době pracuje se dvěma modely nasazení: Správce prostředků a klasický. Tyto dva modely nejsou navzájem zcela kompatibilní. Pokud chcete nakonfigurovat připojení ve více lokalitách s různými modely, přečtěte si následující články:
...
4. Vyberte partnerský vztah, který chcete zobrazit. Pak vyberte **Konfigurace** a ověřte, že jste povolili **přenos brány** v partnerském síti připojené k okruhu ExpressRoute a **použijte vzdálenou bránu** ve vzdálené VNetB síti nepřipojené k ExpressRoute. přerušení.

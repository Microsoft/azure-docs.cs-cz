---
title: Služby Azure v oboru auditu FedRAMP a DoD SRG
description: Tento článek obsahuje tabulky pro Azure Public a Azure Government, které ilustrují, co FedRAMP (střední vs. Vysoká) a DoD SRG (úroveň dopadu 2, 4 nebo 5) obor auditu, ke kterému daná služba dospěla.
author: davib
ms.author: davib
ms.date: 5/17/2019
ms.topic: article
...
ms.locfileid: "70375323"
---
# <a name="azure-services-by-fedramp-and-dod-cc-srg-audit-scope"></a>Služby Azure podle oboru auditu FedRAMP a DoD CC SRG

Cloudové služby Microsoftu pro státní správu Microsoftu splňují náročné požadavky na federální rizikové & programu pro správu autorizací (FedRAMP) a USA a ministerstva obrany od úrovně 2 až 5. Nasazením chráněných služeb včetně Azure Government, Office 365 USA Státní správa a státní úřady v rámci Dynamics 365 mohou využívat bohatou řadu odpovídajících služeb.

Tento článek poskytuje podrobný seznam cloudových služeb v oboru v rámci Azure a Azure Government pro nabídky dodržování předpisů pro FedRAMP a DoD CC SRG.

#### <a name="terminologysymbols-used"></a>Použitá terminologie/symboly

* DoD CC SRG = Průvodce požadavky na zabezpečení cloud computingu obrany
* IL = úroveň dopadu
* FedRAMP = Federal Risk and Authorization Management Program  
* : heavy_check_mark: = indikuje, že služba dosáhla tohoto oboru auditu.
* Plánováno 2019 = znamená, že probíhá revize služby a bude dosaženo certifikátu v 2019.

## <a name="azure-public-services-by-audit-scope"></a>Veřejné služby Azure podle oboru auditu
| _Poslední aktualizace: Srpen 2019_ |

| Služba Azure| DoD CC SRG IL 2 | FedRAMP Moderate | FedRAMP High | Plánováno 2019 |
| ------------ |:---------------:|:----------------:|:------------:|:------------:|
...
| [Azure Active Directory (bezplatné a základní)](https://azure.microsoft.com/services/active-directory/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Rozšířená ochrana před internetovými útoky Azure](https://azure.microsoft.com/features/azure-advanced-threat-protection/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Rozhraní Azure API pro FHIR](https://azure.microsoft.com/services/azure-api-for-fhir/) |  |  |  | :heavy_check_mark: |
| [Azure Bot Service](https://docs.microsoft.com/azure/bot-service/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Archiv služby Azure Storage](https://azure.microsoft.com/services/storage/archive/) |  |  |  | :heavy_check_mark: |
...
| [Průzkumník dat Azure](https://azure.microsoft.com/services/data-explorer/) | |  |  | :heavy_check_mark: |
...
| [Vyhrazený modul HSM Azure](https://azure.microsoft.com/services/azure-dedicated-hsm/) |  |  |  | :heavy_check_mark: |
...
| [Synchronizace souborů Azure](https://azure.microsoft.com/services/storage/files/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Azure Firewall](https://azure.microsoft.com/services/azure-firewall/) |  |  |  | :heavy_check_mark: |
| [Přední dvířka Azure](https://azure.microsoft.com/services/frontdoor/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Cognitive Services: Plochy](https://azure.microsoft.com/services/cognitive-services/face/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Cognitive Services: Hlasové služby](https://azure.microsoft.com/services/cognitive-services/directory/speech/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Cognitive Services: Analýza textu](https://azure.microsoft.com/services/cognitive-services/text-analytics/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Rozšířená ochrana před internetovými útoky v Defenderu](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/microsoft-defender-advanced-threat-protection) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Tok](https://docs.microsoft.com/flow/getting-started) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [portál Microsoft Azure](https://azure.microsoft.com/features/azure-portal/)| :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Network Watcher Analýza provozu](https://docs.microsoft.com/azure/network-watcher/traffic-analytics) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Pamì Struktur](https://azure.microsoft.com/services/storage/blobs/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Pamì Disky (včetně Managed Disks)](https://azure.microsoft.com/services/storage/disks/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Pamì Spis](https://azure.microsoft.com/services/storage/files/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Pamì Vytvořil](https://azure.microsoft.com/services/storage/queues/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Pamì Tabulky](https://azure.microsoft.com/services/storage/tables/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
| [Škálovací sady virtuálních počítačů](https://azure.microsoft.com/services/virtual-machine-scale-sets/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
| [Virtual Machines (včetně rezervovaných instancí)](https://azure.microsoft.com/services/virtual-machines/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |  |
...
## <a name="azure-government-services-by-audit-scope"></a>Azure Government Services podle oboru auditu
| _Poslední aktualizace: Srpen 2019_ |

| Služba Azure | DoD CC SRG IL 2 | DoD CC SRG IL 4 | DoD CC SRG IL 5 | FedRAMP High | Plánováno 2019
| ------------- |:---------------:|:---------------:|:---------------:|:------------:|:------------:
...
| [Automation](https://azure.microsoft.com/services/automation/) | :heavy_check_mark: | :heavy_check_mark: |  | :heavy_check_mark: |
| [Azure Active Directory (bezplatné a základní)](https://azure.microsoft.com/services/active-directory/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
...
| [Rozšířená ochrana před internetovými útoky Azure](https://azure.microsoft.com/features/azure-advanced-threat-protection/)  |  |  |  |  | :heavy_check_mark:
...
| [Azure DB pro PostgreSQL](https://azure.microsoft.com/services/postgresql/) | :heavy_check_mark: | :heavy_check_mark: |  | :heavy_check_mark: | :heavy_check_mark:
...
| [Synchronizace souborů Azure](https://azure.microsoft.com/services/storage/files/) | :heavy_check_mark: | :heavy_check_mark: |  | :heavy_check_mark: | :heavy_check_mark:
| [Azure Firewall](https://azure.microsoft.com/services/azure-firewall/) |  |  |  |  | :heavy_check_mark:
| [Přední dvířka Azure](https://azure.microsoft.com/services/frontdoor/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
...
| [Cognitive Services: Plochy](https://azure.microsoft.com/services/cognitive-services/face/)  | :heavy_check_mark: | :heavy_check_mark: |  | :heavy_check_mark: | :heavy_check_mark:
...
| [Cognitive Services: Hlasové služby](https://azure.microsoft.com/services/cognitive-services/directory/speech/) |  |  |  |  | :heavy_check_mark:
| [Cognitive Services: Analýza textu](https://azure.microsoft.com/services/cognitive-services/text-analytics/) | :heavy_check_mark: | :heavy_check_mark: |  | :heavy_check_mark: | :heavy_check_mark:
...
| [Tok](https://docs.microsoft.com/flow/getting-started) | :heavy_check_mark: | :heavy_check_mark: |  | :heavy_check_mark: | :heavy_check_mark:
| [Functions](https://azure.microsoft.com/services/functions/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
...
| [portál Microsoft Azure](https://azure.microsoft.com/features/azure-portal/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: **&ast;** | :heavy_check_mark: |
| [Microsoft Cloud App Security](https://docs.microsoft.com/cloud-app-security/what-is-cloud-app-security) |  |  |  |  | :heavy_check_mark:
| [Rozšířená ochrana před internetovými útoky v programu Microsoft Defender](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/microsoft-defender-advanced-threat-protection)  | :heavy_check_mark: | :heavy_check_mark: |  | :heavy_check_mark: | :heavy_check_mark:
...
| [Pamì Struktur](https://azure.microsoft.com/services/storage/blobs/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
| [Pamì Disky (včetně Managed Disks)](https://azure.microsoft.com/services/storage/disks/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
| [Pamì Spis](https://azure.microsoft.com/services/storage/files/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
| [Pamì Vytvořil](https://azure.microsoft.com/services/storage/queues/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
| [Pamì Tabulky](https://azure.microsoft.com/services/storage/tables/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
...
| [Škálovací sady virtuálních počítačů](https://azure.microsoft.com/services/virtual-machine-scale-sets/) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
...
**&ast;** Některé služby, například Azure Portal a Azure Resource Manager, neukládají ani nezpracovávají obsah DoD CC SRG IIL 5, ale přesto dědí sadu ovládacích prvků IIL5.

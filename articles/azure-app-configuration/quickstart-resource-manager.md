...
Šablony použité v tomto rychlém startu jsou ze [šablon Azure pro rychlý Start](https://azure.microsoft.com/resources/templates/). [První šablona](https://azure.microsoft.comresources/templates/101-app-configuration-store/) vytvoří úložiště konfigurace aplikace:

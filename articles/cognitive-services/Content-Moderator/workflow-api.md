...
Nakonec použijte váš vlastní pracovní postupy s **úlohy** operace, jak je znázorněno v [rozhraní API pro úlohu konzoly](try-review-api-job.md) a [rychlý úvod k .NET úlohy](moderation-jobs-quickstart-dotnet.md).

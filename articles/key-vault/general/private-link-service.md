...
Nový trezor klíčů můžete vytvořit podle kroků v [nastavení a načíst tajný klíč z Azure Key Vault pomocí portálu Azure](../secrets/quick-create-portal.md)
...
|--|--|--|
| Žádná | Čekající na vyřízení | Připojení je vytvořeno ručně a čeká na schválení od vlastníka prostředku private link. |

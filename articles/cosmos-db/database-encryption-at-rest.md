...
Odpověď: Cosmos DB je služba PaaS a nepracovali jsme těžko, abychom službu mohli snadno používat. Všimli jsme si, že tato otázka se často žádá o proxy otázku pro splnění požadavku na dodržování předpisů, jako je PCI-DSS. V rámci sestavování této funkce jsme pracovali s auditory dodržování předpisů, které zajistí, aby zákazníci, kteří používají Cosmos DB, splňovali své požadavky bez nutnosti spravovat samotné klíče.

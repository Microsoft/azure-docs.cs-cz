...
Pokud chcete použít Azure Machine Learning možnosti experimentování s Key Vault za virtuální sítí, postupujte podle následujících kroků:
...
Pokud chcete ve virtuální síti použít výpočetní prostředky Azure Machine Learning, použijte následující informace o požadavcích sítě:

- Virtuální síť musí být ve stejném předplatném a oblasti jako pracovní prostor služby Azure Machine Learning.

- Podsíť zadaná pro cluster Výpočetní prostředky služby Machine Learning musí mít k dispozici dostatek nepřiřazených IP adres, aby bylo možné přizpůsobit počet virtuálních počítačů, které jsou pro cluster cílené. Pokud podsíť nemá dostatek nepřiřazených IP adres, cluster se částečně přidělí.

- Pokud plánujete zabezpečit virtuální síť omezením provozu, nechte některé porty otevřené pro službu Výpočetní prostředky služby Machine Learning. Další informace najdete v tématu [požadované porty](#mlcports).
...
- Pokud budete chtít umístit více Výpočetní prostředky služby Machine Learning clusterů do jedné virtuální sítě, možná budete muset požádat o zvýšení kvóty u jednoho nebo více prostředků.

    Výpočetní prostředky služby Machine Learning automaticky přiděluje další síťové prostředky ve skupině prostředků, která obsahuje virtuální síť. Pro každý cluster Výpočetní prostředky služby Machine Learning přiděluje služba Azure Machine Learning tyto prostředky:

    - Jedna skupina zabezpečení sítě (NSG)
...
Pokud upravíte nebo přidáte pravidla příchozí/odchozí komunikace v skupin zabezpečení sítě s nakonfigurovaným dávkou, vyzkoušejte opatrnost. Pokud NSG blokuje komunikaci s výpočetními uzly, pak služba Výpočetní prostředky služby Machine Learning Services nastaví stav výpočetních uzlů na nepoužitelné.

Nemusíte zadávat skupin zabezpečení sítě na úrovni podsítě, protože Batch konfiguruje vlastní skupin zabezpečení sítě. Pokud však Zadaná podsíť má přidruženou skupin zabezpečení sítě a/nebo bránu firewall, nakonfigurujte příchozí a odchozí pravidla zabezpečení, jak je uvedeno výše. 
...
Pokud nechcete používat výchozí odchozí pravidla a chcete omezit odchozí přístup k virtuální síti, postupujte podle následujících kroků:
...
* Uživatelem definovaná trasa pro každou IP adresu, kterou používá služba Azure Batch, v oblasti, ve které existují vaše prostředky. Tyto udr umožňují, aby služba Batch komunikovala s výpočetními uzly pro plánování úloh. Pokud chcete získat seznam IP adres služby Batch, obraťte se na podporu Azure.
...
Pokud chcete vytvořit cluster Výpočetní prostředky služby Machine Learning pomocí Azure Portal, postupujte takto:
...
1. V části __aplikace__ vyberte __COMPUTE__. Pak vyberte __Přidat výpočetní__prostředky. 
    ...
    ![Postup přidání výpočetní služby ve službě Azure Machine Learning](./media/how-to-enable-virtual-network/add-compute.png)
...
Po dokončení procesu vytváření můžete model proškolit pomocí clusteru. Další informace najdete v tématu [Výběr a použití výpočetní cíle pro školení](how-to-set-up-training-targets.md).
...
1. Pokud chcete službě Azure Machine Learning umožňovat komunikaci s portem SSH na virtuálním počítači nebo clusteru, musíte nakonfigurovat položku zdroje pro NSG. Port SSH je obvykle port 22. Pokud chcete povolený provoz z tohoto zdroje, použijte následující informace:
...
> [!IMPORTANT]
> Než budete postupovat podle tohoto postupu, Projděte si požadavky a naplánujte IP adresování pro svůj cluster. Další informace najdete v tématu [Konfigurace pokročilé sítě ve službě Azure Kubernetes](https://docs.microsoft.com/azure/aks/configure-advanced-networking).
> 
>
> Ponechte výchozí odchozí pravidla pro NSG. Další informace najdete v tématu výchozí pravidla zabezpečení ve [skupinách zabezpečení](https://docs.microsoft.com/azure/virtual-network/security-overview#default-security-rules).
>
...
1. Ujistěte se, že skupina NSG, která řídí virtuální síť, má povolené příchozí pravidlo pro Azure Machine Learning službu pomocí __značky služby__ __AzureMachineLearning__ .
...
1. Ujistěte se, že skupina NSG, která řídí virtuální síť, má povolené příchozí pravidlo pro koncový bod bodování, aby se mohla volat mimo virtuální síť.

...
## <a name="updatelocal"></a>Krok 6 – aktualizace místních lokalit
...
|:--- |:--- |:--- |
|TestVNet1|VNet4Local|IP adresa brány VPN pro virtuální sítě testvnet4|
|TestVNet4|VNet1Local|IP adresa brány VPN pro virtuální sítě testvnet1|
...
## <a name="getvalues"></a>Krok 7 – načtení hodnot z konfiguračního souboru sítě

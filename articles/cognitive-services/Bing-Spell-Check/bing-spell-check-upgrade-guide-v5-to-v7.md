---
title: Upgrade Bing pravopisu v5 kontrola rozhraní API pro v7 | Microsoft Docs
...
ms.locfileid: "35342388"
---
# <a name="spell-check-api-upgrade-guide"></a>Průvodce upgradem API kontrola pravopisu

Tento průvodce upgradem identifikuje změny verze 5 až 7 verzi API kontrola pravopisu Bing. Pomocí Tento průvodce vám pomůže identifikovat části aplikace, které je potřeba aktualizovat na použití verze 7.

## <a name="breaking-changes"></a>Změny způsobující chyby

### <a name="endpoints"></a>Koncové body

- Číslo verze pro koncový bod změněn z v5 na v7. Například https://api.cognitive.microsoft.com/bing/\ * \*v7.0 ** nebo kontrola pravopisu.

...
## <a name="quick-create-virtual-machine---full-script"></a>Rychlé vytvoření virtuálního počítače – úplná skriptu

> [!NOTE]
> Je vyšší nebo nižší sloučit výše uvedeném kódu, ale heslo spíše než SSH klíče pro ověřování.

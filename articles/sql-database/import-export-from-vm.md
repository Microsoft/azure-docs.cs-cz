...
Následující příkaz SqlPackage importuje databázi **AdventureWorks2017** z místního úložiště na server Azure SQL Database. Vytvoří novou databázi s názvem **myMigratedDatabase** s úrovní služeb **Premium** a cílem služby **P6** . Změňte tyto hodnoty tak, jak jsou vhodné pro vaše prostředí.

...
Po doručení je datová část JSON události rozserializovaná do ```EventSchema``` POJO pro použití funkcí. Tento proces umožňuje funkci přístup k vlastnostem události v objektově orientovaném způsobem.

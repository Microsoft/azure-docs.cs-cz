...
Mezi typické úlohy pro datové vědy patří zkoumání, modelování a nasazení dat. V tomto článku se dozvíte, jak používat interaktivní nástroje pro **zkoumání a analýzu dat a vytváření sestav (** **AMAR)** k dokončení několika běžných úloh vědeckého zpracování dat, jako jsou interaktivní zkoumání dat, data analýzy, generování sestav a vytváření modelů. Popisuje také možnosti nasazení modelu do provozního prostředí pomocí nejrůznějších sad nástrojů a datových platforem, například následujících:
...
Produkty jako Azure Machine Learning také poskytují [pokročilou přípravu dat](../service/how-to-transform-data.md) pro tahání a zkoumání dat, včetně vytváření funkcí. Uživatel by se měl rozhodnout o nástrojích, knihovnách a balíčcích, které nejlépe vyhovují jejich potřebám. 
...
- [Nasazení modelu v Azure Machine Learning](../service/how-to-deploy-and-where.md)
...
> [!NOTE]
> Informace o nasazení pomocí Azure Machine Learning Studio najdete v tématu [nasazení webové služby Azure Machine Learning](../studio/publish-a-machine-learning-web-service.md).
>
>

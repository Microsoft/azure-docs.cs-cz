...
| [Získání všech aplikací proxy aplikace Azure AD publikovaných bez nahraného certifikátu](scripts/powershell-get-all-custom-domain-no-cert.md) | Zobrazí seznam všech aplikačních proxy aplikací, které používají vlastní domény, ale nemá nahraný platný certifikát SSL. |

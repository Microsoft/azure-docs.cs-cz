---
title: Webová aplikace Podrobný plán zabezpečení a dodržování předpisů Azure – IaaS pro Velká Británie NHS
description: Webová aplikace Podrobný plán zabezpečení a dodržování předpisů Azure – IaaS pro Velká Británie NHS
services: security
author: jomolesk
...
![Diagram referenční architektury NHS pro IaaS Web Application pro Velká Británie](images/uknhs-iaaswa-architecture.png?raw=true "Diagram referenční architektury NHS pro IaaS Web Application pro Velká Británie")
...
Diagram toku dat pro tuto referenční architekturu je k dispozici ke [stažení](https://aka.ms/uknhs-iaaswa-tm) nebo najdete níže. Tento model může zákazníkům usnadnit pochopení bodů potenciálního rizika v systémové infrastruktuře při provádění úprav.

![IaaS Web Application pro Velká Británie NHS – model hrozeb](images/uknhs-iaaswa-threat-model.png?raw=true "IaaS Web Application pro Velká Británie NHS – model hrozeb")
...
[Podrobný plán zabezpečení a dodržování předpisů Azure – NHS – Velká Británie – IaaS implementace webové aplikace](https://aka.ms/uknhs-iaaswa-cim) poskytuje informace o tom, které požadavky na Velká Británie NHS jsou řešeny architekturou webové aplikace IaaS, včetně podrobných popisů implementace splňuje požadavky každého zahrnutého principu.

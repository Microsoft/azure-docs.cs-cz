...
|/ operationresults/profileresults/endpointresults/customdomainresults/DisableCustomHttps nebo akce||
|/ operationresults/profileresults/endpointresults/customdomainresults/EnableCustomHttps nebo akce||
...
|/ containerGroups/zápisu|Vytvoří nebo aktualizuje konkrétní skupinu kontejnerů.|
...
|/ ElasticPools/diagnosticSettings/zápis|Vytvoří nebo aktualizuje nastavení diagnostiky pro tento prostředek.|
...
|/ ElasticPools/IotHubTenants/diagnosticSettings/zápis|Vytvoří nebo aktualizuje nastavení diagnostiky pro tento prostředek.|
...
|/ provisioningServices/odstranit|Odstranit prostředek IotDps|
...
|/ provisioningServices/čtení|Získat prostředek IotDps|
|/provisioningServices/skus/Read|Získání platných SKU IotDps|
|/ provisioningServices/zápisu|Vytvořte prostředek IotDps|
...
|/ obory názvů/odstranit|Odstraní prostředek oboru názvů.|
...
|A součásti nebo AnalyticsItems/zápis|Zápis položku analytics Application Insights|
...
|/ Součásti nebo CurrentBillingFeatures/čtení|Čtení aktuální fakturace funkce pro součást Application Insights|
...
|/ Součásti nebo FeatureCapabilities/čtení|Možností funkce součást čtení Application Insights|
|/ Součásti nebo GetAvailableBillingFeatures/čtení|Čtení Application Insights, součást dostupných fakturace funkcí|
...
|Součásti, MyAnalyticsItems nebo odstranění|Odstranění položky osobní analytics Application Insights|
|/ Součásti nebo MyAnalyticsItems/čtení|Čtení položky osobní analytics Application Insights|
|A součásti nebo MyAnalyticsItems/zápis|Zápis položku osobní analytics Application Insights|
...
|A součásti nebo ProactiveDetectionConfigs/zápis|Zápis konfigurace proaktivní zjištění Application Insights|
...
|/ hsmPools/zápisu|Pokud chcete aktualizovat vlastnosti existujícího fondu HSM, vytvořte nový fond HSM.|
...
|/Connections/sharedkey/Action|Získat VirtualNetworkGatewayConnection SharedKey|
...
|/ ddosProtectionPlans/zápisu|Vytvoří plán ochrany DDoS nebo aktualizuje plán ochranu DDoS |
...
|/ expressRouteCrossConnections/zápisu|Vytvořit nebo aktualizovat Express Route křížová připojení|
...
|/virtualHubs/hubVirtualNetworkConnections/read|Získání HubVirtualNetworkConnection|
...
|/ virtualHubs/zápisu|Vytvořit nebo aktualizovat virtuální rozbočovače|
...
|/ vpnsites/zápisu|Vytvoří nebo aktualizuje prostředek Vpn Site.|
...
|Obory názvů nebo odstranění|Odstraní prostředek oboru názvů.|
|/ Obory názvů nebo NotificationHubs/authorizationRules nebo akce|Získá seznam autorizačních pravidel Centra oznámení.|
|Obory názvů, NotificationHubs nebo authorizationRules nebo odstranění|Odstranit autorizační pravidla Centra oznámení|
...
|A obory názvů nebo NotificationHubs/authorizationRules/zápis|Vytvoření pravidla autorizace centra oznámení a aktualizujte jeho vlastnosti. Autorizační pravidla přístupová práva, primární a sekundární klíče lze aktualizovat.|
|/ Obory názvů nebo NotificationHubs/debugSend nebo akce|Poslat testovací nabízené oznámení|
|Obory názvů, NotificationHubs nebo odstranění|Odstraní prostředek Centra oznámení.|
...
|A obory názvů/zápis|Vytvořte prostředek Namespace a aktualizujte jeho vlastnosti. Značky a kapacitu Namespace jsou vlastnosti, které lze aktualizovat.|
...
|/ Trezory/backupFabrics/protectableContainers/čtení|Získání všech chránitelné kontejnery|
...
|A trezory/backupFabrics/protectionContainers/zápis|Vytvoří kontejner registrovaných|
...
|/ workspaceSettings/zápisu|Aktualizace nastavení pracovního prostoru|
...
|/ storageSyncServices/zápisu|Vytvořit nebo aktualizovat všechny synchronizační služby úložiště|
...
|/ verifyhostingenvironmentvnet nebo akce|Ověřte, hostování prostředí virtuální sítě.|
...
- Zjistěte, jak [vytvořit vlastní roli](custom-roles.md).
- Zkontrolujte [integrovaným rolím RBAC](built-in-roles.md).
- Zjistěte, jak spravovat přístup k přiřazení [uživatelem](role-assignments-users.md) nebo [prostředkem](role-assignments-portal.md) 

...
K dokončení tohoto rychlého startu budete také potřebovat službu Azure IoT Hub v rámci vašeho předplatného Azure. Pokud ještě nemáte předplatné Azure, [vytvořte si bezplatný účet](https://azure.microsoft.com/free/?WT.mc_id=A261C142F), ještě než začnete. Pokud Centrum IoT nemáte, [vytvořte ho podle těchto pokynů](../articles/iot-hub/iot-hub-create-using-cli.md).

---
title: Příklad cli importu databáze Azure SQL souboru BACPAC
...
---
# <a name="use-cli-to-import-a-bacpac-file-into-an-azure-sql-database"></a>Import souboru BACPAC do databáze Azure SQL pomocí příkazového příkazového příkazu

Tento příklad skriptu Azure CLI importuje databázi ze souboru *.bacpac* do databáze Azure SQL.  

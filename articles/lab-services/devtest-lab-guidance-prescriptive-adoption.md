...
- Povolení samoobslužné funkce pro vývojáře bez negativního vlivu podnikového zabezpečení a dodržování předpisů
- Automatizace a rozšíření DevTest Labs pro další scénáře
- [Škálování řešení založené na službě DevTest Labs k tisícům prostředky](devtest-lab-guidance-scale.md)
- [Rozsáhlá nasazení služby DevTest Labs](devtest-lab-guidance-orchestrate-implementation.md)

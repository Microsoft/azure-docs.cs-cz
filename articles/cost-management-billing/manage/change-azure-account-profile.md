...
1. Vyberte tlačítko **Upravit podrobnosti** a pak aktualizujte informace o **profilu**.
   ...
   ![Příklad informací o profilu v Azure](./media/change-azure-account-profile/profile.png)
...
Informace o aktualizaci fakturačních údajů najdete v tématu [Změna platební karty použité k úhradě předplatného Azure](change-credit-card.md).

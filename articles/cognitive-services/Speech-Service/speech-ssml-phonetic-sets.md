...
Telefonická sada pro hlasové služby přináší zátěž po samohláskě zatížené slabiky, ale telefonní sada služby `fr-FR` Speech nepodporuje IPA ˌ. Pokud je požadováno IPA, měli byste použít IPA přímo.
...
| tis.      | `k`   | Arte **jazyka c**   | é**c**aille   | být**c**                          |
...
> [!TIP]
> Telefonní sada služby `fr-FR` Speech nepodporuje následující francouzské liasions, `n‿`, `t‿`a `z‿`. Pokud jsou potřeba, měli byste zvážit přímé použití IPA.
...
| Příklad 1 (Úvod k souhláskě, slovo počáteční pro samohlásku) | Příklad 2 (pro souhlásky, wordové nucleusy pro samohlásku) | Příklad 3 (Coda pro souhlásku, slovo konečný pro samohlásku) | Komentáře |
|--|--|--|--|
| Anders/a **1** n-d AX r s/ | Multiplikationszeichen/m uh l-t iy-p l iy-k a-TS y navýšení na **1** n s-TS Ay-c n/ | Biologie/b iy – přečtení z-l podobrazení-g iy **1**/ | Telefonická sada hlasových služeb – telefon po samohláskě s napětím |
| Allgemeinwissen/a **2** l-g AX-m Ay 1 n-v IH-s n/ | Abfallentsorgungsfirma/a 1 p-f a l-^ eh n t-z Oh **2** AX r-g uh ng s-f IH AX r-m a/ | Computertomographie/k Oh t-p y UW 1-t AX r-t – Čt-m-g r a-f iy **2**/ | Telefonická sada hlasových služeb: po samohláskě slabiky se nastaví zátěž. |
...
<a id="de-v-2"></a>
**2** *Word – intially jenom ve slovech cizího původu, jako **je**ppointment. Slabiky na začátku v: ' v**e**rstauen.*
...
<a id="de-c-3"></a>
**3** *pouze ve slovech cizího původu, například: len**d**l.*<br>
<a id="de-c-4"></a>
**4** *pouze ve slovech cizího původu, například: Clau**d**e.*<br>
<a id="de-c-5"></a>
**5** *pouze ve slovech cizího původu, například: kanál**g**e.*<br>
<a id="de-c-6"></a>
**6** *slov – pouze v případě, že se jedná o slova cizího původu, jako je GRE**g**.*<br>
<a id="de-c-7"></a>
**7** *– pouze ve slovech cizího původu, jako je například **NG**Uyen.*<br>
<a id="de-c-8"></a>
**8** *pouze v slovech cizího původu, například: **S**taccato.*<br>
<a id="de-c-9"></a>
**9** *pouze v slovech cizího původu, například: gr**ó**v.*<br>
<a id="de-c-10"></a>
**10** *`x` IPA je pevně daný znak "ch" po všech nepředních samohláskách (a, AA, Oh, uh, UW a diphthong AW).*<br>
<a id="de-c-11"></a>
**11** *`ç` IPA je měkký "ch" po předních samohláskách (IH, IY, eh, AE, UY, UE, OE, EU také v diphthongs Ay, Oy) a souhláskách*<br>
<a id="de-c-12"></a>
**12** *slov – zpočátku jenom v slovech cizího původu, například: **J**močovin. Slabiky – zpočátku také ve slově jako: ba**ch**erach.*<br>
...
> [!NOTE]
> Musíme přidat [GS\] telefon mezi dvě odlišná samohlásky, s výjimkou těchto dvou samohlásek je pravý diphthong. Tato orální souhláska je ráz, další informace najdete v tématu <a href="http://en.wikipedia.org/wiki/Glottal_stop" target="_blank">ráz \ <span class="docon docon-navigate-external x-hidden-focus"></a></a>.
...
| JJ     | `j.j` `jj` |            | VI**vše**a      |                |
| tis.      | `k`        | Oche **jazyka c**  | Bo**c**a       | Titáni**c**    |
...
> [!TIP]
> Telefonní sada služby `es-ES` Speech nepodporuje následující španělský IPA, `β`, `ð`a `ɣ`. Pokud jsou potřeba, měli byste zvážit přímé použití IPA.

# <a name="zh-cn"></a>[zh-CN](#tab/zh-CN)

Telefonická sada hlasových služeb pro `zh-CN` je založena na nativní sadě pro zápis <a href="https://en.wikipedia.org/wiki/Pinyin" target="_blank">na telefonu <span class="docon docon-navigate-external x-hidden-focus"></span> .</a>
...
Telefonická sada pro `zh-TW` hlasová služba je založená na nativním <a href="https://en.wikipedia.org/wiki/Bopomofo" target="_blank">nastavení <span class="docon docon-navigate-external x-hidden-focus"></span> telefonu</a> .
...
Telefonická sada pro `ja-JP` hlasová služba je založená na nativním nastavení telefonu <a href="https://en.wikipedia.org/wiki/Kana" target="_blank">Kana <span class="docon docon-navigate-external x-hidden-focus"></span> </a> .

...
1. V části **základní konfigurace SAML** zadejte hodnoty pro následující pole:
    ...
    > [!NOTE]
    > Tyto hodnoty nejsou reálné. Aktualizujte tyto hodnoty skutečným Sign-On URL a identifikátor (ID entity). `Entity ID`Adresa URL pro přihlášení je automaticky generovaná pro každou organizaci. Pokud chcete získat tyto hodnoty, obraťte se na [tým podpory klienta HeyBuddy](mailto:support@heybuddy.com) .
...
1. Kromě toho očekává aplikace EZOfficeInventory několik dalších atributů, které se vrátí zpátky v odpovědi SAML, které jsou uvedené níže. Tyto atributy se také předem naplní, ale můžete je zkontrolovat podle vašich požadavků.
    ...
    > [!NOTE]
    > V tomto [odkazu](../develop/active-directory-enterprise-app-role-management.md) najdete informace o tom, jak nakonfigurovat a nastavit role pro aplikaci.
...
Když na přístupovém panelu kliknete na dlaždici HeyBuddy, měli byste se automaticky přihlásit k HeyBuddy, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).

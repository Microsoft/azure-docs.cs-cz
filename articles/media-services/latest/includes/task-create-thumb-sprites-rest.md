...
ms.locfileid: "101705423"
---
<!--Create a thumbnail sprites REST-->

Následující příkaz Azure REST vytvoří transformaci Sprite miniatur. Nahraďte hodnoty `subscriptionID` , `resourceGroup` a `accountName` hodnotami, se kterými právě pracujete. 

Nastavte transformaci názvu nastavením `transformName` .

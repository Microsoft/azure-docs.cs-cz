...
2. **[Nakonfigurujte jednotné přihlašování Vibe HCM](#configure-vibe-hcm-single-sign-on)** , abyste na straně aplikace nakonfigurovali nastavení jednoho Sign-On.
...
4. Pokud v **základní části Konfigurace SAML** chcete nakonfigurovat aplikaci v režimu iniciované **IDP** , uživatel nemusí provádět žádný krok, protože aplikace už je předem integrovaná s Azure.
    ...
    ![Snímek obrazovky ukazuje základní konfiguraci SAML s odkazem na soubor s metadaty pro nahrání.](common/preintegrated.png)
...
### <a name="configure-vibe-hcm-single-sign-on"></a>Konfigurace Vibe HCM Single Sign-On
...
Když na přístupovém panelu kliknete na dlaždici Vibe HCM, měli byste být automaticky přihlášeni k Vibe HCM, pro kterou jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).

...
## <a name="about"></a>Parametry zásad IPsec a IKE pro Azure VPN Gateway
...
## <a name ="params"></a>Část 2 – podporované kryptografické algoritmy & síly klíčů
...
> [!IMPORTANT]
> 1. **Konfigurace místního zařízení VPN musí odpovídat nebo obsahovat následující algoritmy a parametry, které zadáte v zásadách IPsec pro Azure/IKE:**
...
### <a name="createvnet1"></a>Krok 1 – vytvoření virtuální sítě, brány sítě VPN a brány místní sítě
...
## <a name ="vnet2vnet"></a>Část 4 – Vytvoření nového připojení typu VNet-to-VNet pomocí zásad IPsec/IKE
...
## <a name ="managepolicy"></a>Část 5 – aktualizace zásad IPsec/IKE pro připojení

...
1. Do vyhledávacího pole zadejte **TrackVia**vyberte **TrackVia** z panelu výsledků klikněte **přidat** tlačítko pro přidání aplikace.
...
1. **[Vytvoření zkušebního uživatele TrackVia](#create-a-trackvia-test-user)**  – Pokud chcete mít protějšek Britta Simon TrackVia, který je propojený s Azure AD reprezentace uživatele.
...
1. Na **TrackVia domény a adresy URL** části, proveďte následující kroky, pokud chcete nakonfigurovat aplikace v **IDP** iniciované režimu:
...
1. Na **TrackVia konfigurace** klikněte na tlačítko **nakonfigurovat TrackVia** otevřete **nakonfigurovat přihlašování** okna. Kopírovat **SAML Entity ID** z **Stručná referenční příručka oddílu.**
...
1. Klepněte na správné cestě prostřednictvím **Můj účet** nastavení a pak vyberte **Single Sign On** kartu, proveďte následující kroky:
...
1. V seznamu aplikací vyberte **TrackVia**.

...
| **Postup** | Ve výchozím nastavení se většina nezachycených výjimek ve webovém rozhraní API ASP.NET převede na odpověď HTTP se stavovým kódem. `500, Internal Server Error`|
...
| **Použitelné technologie** | Obecné |
| **Atributy**              | –  |
| **Odkazy**              | [Neúspěšné zabezpečení](https://owasp.org/www-community/Fail_securely) |
| **Postup** | Aplikace by měla selhat bezpečně. Každá metoda, která vrací logickou hodnotu, na základě toho, jaké je učiněno určité rozhodnutí, by měla být pečlivě vytvořena blok výjimky. Došlo k velkému množství logických chyb z důvodu problémů se zabezpečením, když je blok výjimky napsán carelessly.|

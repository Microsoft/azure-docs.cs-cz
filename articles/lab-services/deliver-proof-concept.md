...
* **Topologie**předplatného: Požadavky na podnikové úrovni pro prostředky v Azure můžou nad rámec [dostupných kvót v rámci jednoho](https://docs.microsoft.com/azure/azure-subscription-service-limits)předplatného překračovat. To vyžaduje několik předplatných Azure a/nebo žádostí o služby, aby se zvýšily počáteční limity předplatného. Před distribucí prostředků mezi předplatnými je důležité se rozhodnout. Jedním z cenných prostředků je [Příručka pro rozhodování](https://docs.microsoft.com/azure/architecture/cloud-adoption/decision-guides/subscriptions/) o předplatném, protože později je obtížné přesunout prostředky do jiného předplatného. Testovací prostředí se například nedá po vytvoření přesunout do jiného předplatného.  

...
13. Přejděte zpět na stránku **síť** **oboru názvů** a přepněte na kartu **připojení privátního koncového bodu** . Měl by se zobrazit soukromý koncový bod, který jste vytvořili. 
...
| Odebrat | Odpojeno | Připojení odebral vlastník oboru názvů Azure Relay, privátní koncový bod se bude zobrazovat jako informativní a měl by se odstranit pro vyčištění. |
...
- Informace o cenách najdete v tématu [ceny za privátní propojení Azure](https://azure.microsoft.com/pricing/details/private-link/).

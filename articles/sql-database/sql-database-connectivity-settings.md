...
ms.locfileid: "83684933"
---
# <a name="azure-sql-connectivity-settings"></a>Nastavení připojení k Azure SQL
> [!NOTE]
> Tento článek se týká logického SQL serveru v Azure, který se používá pro databáze Azure SQL Database i SQL Data Warehouse, které se vytvářejí na logickém serveru. Pro zjednodušení se SQL Database používá k označení SQL Database i SQL Data Warehouse.
...
Další informace najdete v tématu [požadavky na TLS pro SQL Database připojení](sql-database-connect-query.md#tls-considerations-for-sql-database-connectivity).

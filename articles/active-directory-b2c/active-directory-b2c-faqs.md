---
title: Nejčastější dotazy k Azure Active Directory B2C
...
Azure AD B2C má také přidanou podporu pro [vlastní zásady](active-directory-b2c-overview-custom.md). Povolit tyto vlastní zásady pro vývojáře k vytvoření vlastních zásad u jakékoli zprostředkovatele identity, který podporuje [OpenID Connect](https://openid.net/specs/openid-connect-core-1_0.html) nebo SAML.
...
* **Banner s logem**: Zobrazí se vpravo dole.
...
1. Odstranit všechny **toky uživatelů (zásady)** ve vašem tenantovi Azure AD B2C.
1. Odstranit všechny **aplikací** registrované ve vašem tenantovi Azure AD B2C.
1. V dalším kroku se přihlaste k [webu Azure portal](https://portal.azure.com/) jako správce předplatného. Použijte stejný pracovní nebo školní účet nebo stejný účet Microsoft, který jste použili k registraci do Azure.
1. Přepnutí na tenanta Azure AD B2C chcete odstranit.
1. Vyberte **Azure Active Directory** v nabídce vlevo.
1. V části **Spravovat** vyberte **Uživatele**.
1. Vyberte jednotlivé uživatele v důsledku (vyloučit správce předplatného uživatele, kterého jste aktuálně přihlášení jako). Vyberte **odstranit** v dolní části stránky a vyberte **Ano** po zobrazení výzvy.
1. V části **spravovat**vyberte **registrace aplikací** (nebo **registrace aplikací (starší verze)** ).
1. Vyberte **zobrazit všechny aplikace**
1. Vyberte aplikaci s názvem **b2c-extensions-app**vyberte **odstranit**a pak vyberte **Ano** po zobrazení výzvy.
1. V části **spravovat**vyberte **uživatelská nastavení**.
1. V části **s účtem LinkedIn**vyberte **ne**a pak vyberte **Uložit**.
1. V části **spravovat**vyberte **vlastnosti**
1. V části **Access management pro prostředky Azure**vyberte **Ano**a pak vyberte **Uložit**.
1. Odhlásit z webu Azure portal a pak se přihlaste zpět k aktualizaci vašeho přístupu.
1. Vyberte **Azure Active Directory** v nabídce vlevo.
1. Na **přehled** stránce **odstranění adresáře**. Použijte na obrazovce pokynů proces dokončete.

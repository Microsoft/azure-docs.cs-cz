---
title: 'Kurz: Integrace Služby Azure Active Directory se Zscalerem ZSCloud | Dokumenty společnosti Microsoft'
...
---
# <a name="tutorial-azure-active-directory-integration-with-zscaler-zscloud"></a>Kurz: Integrace Azure Active Directory se Zscalerem ZSCloud

V tomto kurzu se dozvíte, jak integrovat Zscaler ZSCloud s Azure Active Directory (Azure AD).
Integrace Zscaler ZSCloud s Azure AD vám poskytuje následující výhody:

* Můžete řídit ve službě Azure AD, který má přístup k Zscaler ZSCloud.
* Uživatelům můžete povolit automatické přihlášení k Zscaler ZSCloud (jednotné přihlášení) pomocí jejich účtů Azure AD.
...
Chcete-li nakonfigurovat integraci Azure AD pomocí Zscaler ZSCloud, potřebujete následující položky:

* Předplatné Azure AD. Pokud nemáte prostředí Azure AD, můžete získat [bezplatný účet](https://azure.microsoft.com/free/)
* Zscaler ZSCloud povolení pro jednotné přihlášení předplatné

## <a name="scenario-description"></a>Popis scénáře

V tomto kurzu nakonfigurujete a otestujete jednotné přihlašování Azure AD v testovacím prostředí.

* Zscaler ZSCloud podporuje **SP** inicioval SSO

* Zscaler ZSCloud podporuje zřizování uživatelů **Just In Time**

## <a name="adding-zscaler-zscloud-from-the-gallery"></a>Přidání Zscaler ZSCloud z galerie

Chcete-li nakonfigurovat integraci Zscaler ZSCloud do Azure AD, musíte přidat Zscaler ZSCloud z galerie do seznamu spravovaných aplikací SaaS.

**Chcete-li přidat Zscaler ZSCloud z galerie, proveďte následující kroky:**
...
4. Do vyhledávacího pole zadejte **Zscaler ZSCloud**, z panelu výsledků vyberte **Zscaler ZSCloud** a pak klikněte na **tlačítko Přidat** a přidejte aplikaci.
...
Aby jednotné přihlašování fungovalo, je třeba vytvořit vztah propojení mezi uživatelem Azure AD a souvisejícím uživatelem v Zscaler ZSCloud.

Chcete-li konfigurovat a testovat jednotné přihlašování Azure AD pomocí Zscaler ZSCloud, musíte dokončit následující stavební bloky:

1. **[Nakonfigurujte azure ad jednotné přihlašování](#configure-azure-ad-single-sign-on)** – aby vaši uživatelé mohli používat tuto funkci.
2. **[Konfigurace Zscaler ZSCloud Single Sign-On](#configure-zscaler-zscloud-single-sign-on)** - pro konfiguraci nastavení jednotného přihlášení na straně aplikace.
3. **[Vytvořte uživatele testu Azure AD](#create-an-azure-ad-test-user)** – k testování jednotného přihlášení Azure AD s Brittou Simonovou.
4. **[Přiřaďte testovacímu uživateli Azure AD](#assign-the-azure-ad-test-user)** – chcete-li Britta Simon ové povolit použití jednotného přihlášení azure ad.
5. **[Vytvořte testovacího uživatele Zscaler ZSCloud](#create-zscaler-zscloud-test-user)** – chcete-li mít protějšek Britty Simonové v Zscaler ZSCloud, který je propojený s reprezentací uživatele Azure AD.
...
Chcete-li nakonfigurovat jednotné přihlašování Azure AD pomocí Zscaler ZSCloud, proveďte následující kroky:

1. Na [webu Azure Portal](https://portal.azure.com/)na stránce integrace aplikací **Zscaler ZSCloud** vyberte **Jednotné přihlašování**.
...
4. V části **Základní konfigurace SAML** proveďte následující kroky:
    ...
    ![Zscaler ZSCloud Domény a adresy URL jednotné přihlašovací informace](common/sp-signonurl.png)

    Do textového pole **přihlašovací adresy URL** zadejte adresu URL používanou uživateli k přihlášení k aplikaci ZScaler ZSCloud.

    > [!NOTE]
    > Je třeba aktualizovat hodnotu s aktuální přihlašovací url. Obraťte se na [tým podpory klienta Zscaler ZSCloud,](https://help.zscaler.com/) abyste získali hodnotu. Můžete také odkazovat na vzory uvedené v části **Základní konfigurace SAML** na webu Azure Portal.
...
6. Kromě výše uvedeného aplikace Zscaler ZSCloud očekává několik dalších atributů, které mají být předány zpět v odpovědi SAML. V části **Deklarace identity uživatelů** v dialogovém okně **Atributy uživatele** přidejte atribut tokenu SAML následujícím postupem, jak je znázorněno v následující tabulce:
...
8. V části **Nastavit Zscaler ZSCloud** zkopírujte příslušnou adresu URL podle vašeho požadavku.
...
1. Chcete-li automatizovat konfiguraci v rámci Zscaler ZSCloud, musíte nainstalovat **rozšíření prohlížeče My Apps Secure Sign-in** kliknutím na nainstalovat **rozšíření**.

    ![Rozšíření Moje aplikace](common/install-myappssecure-extension.png)

2. Po přidání rozšíření do prohlížeče, klikněte na **nastavení Zscaler ZSCloud** vás nasměruje do aplikace Zscaler ZSCloud. Odtud zadejte přihlašovací údaje správce pro přihlášení do Zscaler ZSCloud. Rozšíření prohlížeče automaticky nakonfiguruje aplikaci pro vás a automatizuje kroky 3-6.

    ![Nastavení sso](common/setup-sso.png)

3. Pokud chcete nastavit Zscaler ZSCloud ručně, otevřete nové okno webového prohlížeče a přihlaste se na web společnosti Zscaler ZSCloud jako správce a proveďte následující kroky:
...
5. V části Proxy server proveďte následující kroky:   
    ...
    b. Do textového pole Adresa zadejte **bránu. zscaler ZSCloud.net**.
...
V této části povolíte Britta Simon používat Azure jednotné přihlášení udělením přístupu k Zscaler ZSCloud.

1. Na portálu Azure vyberte **Podnikové aplikace**, vyberte **Všechny aplikace**a pak vyberte **Zscaler ZSCloud**.

    ![Okno podnikových aplikací](common/enterprise-applications.png)

2. V seznamu aplikací vyberte **Zscaler ZSCloud**.

    ![Odkaz Zscaler ZSCloud v seznamu Aplikace](common/all-applications.png)
...
7. V dialogovém okně **Přidat přiřazení** vyberte tlačítko **Přiřadit.**
    ...
    >[!NOTE]
    >Výchozí přístupová role není podporována, protože to přeruší zřizování, takže výchozí roli nelze vybrat při přiřazování uživatele.

### <a name="create-zscaler-zscloud-test-user"></a>Vytvořit testovacího uživatele Zscaler ZSCloud

V této části je vytvořen uživatel s názvem Britta Simon v Zscaler ZSCloud. Zscaler ZSCloud podporuje zřizování uživatelů just-in-time, které je ve výchozím nastavení povoleno. V této části pro vás není žádná položka akce. Pokud uživatel ještě neexistuje v Zscaler ZSCloud, po ověření se vytvoří nový.

>[!Note]
>Pokud potřebujete vytvořit uživatele ručně, obraťte se [na tým podpory Zscaler ZSCloud](https://help.zscaler.com/).

### <a name="test-single-sign-on"></a>Test jednotného přihlašování 

V této části otestujete konfiguraci jednotného přihlášení Azure AD pomocí přístupového panelu.

Po kliknutí na dlaždici Zscaler ZSCloud na přístupovém panelu, měli byste být automaticky přihlášeni k Zscaler ZSCloud, pro které nastavíte přihlašování. Další informace o přístupovém panelu naleznete [v tématu Úvod k přístupovému panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

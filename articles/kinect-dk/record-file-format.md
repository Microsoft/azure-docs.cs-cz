...
Chcete-li zaznamenávat data ze senzorů, je použit formát kontejneru Matroska (. MKV), který umožňuje uložení více stop.
použití široké škály kodeků. Soubor nahrávky obsahuje stopy pro ukládání barev, hloubky, obrázků IR a IMU.

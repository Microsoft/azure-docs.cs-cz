...
V současné době základní dovednosti pro prostorovou analýzu jsou postavené na kanálu, který ingestuje video, detekuje lidi ve videu, sleduje lidi při jejich přesouvání v průběhu času a generuje události jako lidé komunikují s oblastmi, které vás zajímají.

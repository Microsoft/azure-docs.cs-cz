---
title: 'Kurz: Integrace Azure Active Directory se službou LoginRadius | Dokumentace Microsoftu'
...
ms.locfileid: "39052165"
---
# <a name="tutorial-azure-active-directory-integration-with-loginradius"></a>Kurz: Integrace Azure Active Directory se službou LoginRadius
...
3. **[Vytvoření zkušebního uživatele LoginRadius](#create-a-loginradius-test-user)**  – Pokud chcete mít protějšek Britta Simon LoginRadius, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **LoginRadius domény a adresy URL** části, proveďte následující kroky:
...
7. Ke konfiguraci jednotného přihlašování na **LoginRadius** straně, je nutné odeslat na stažený **soubor XML s metadaty** k [tým podpory LoginRadius](mailto:support@loginradius.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

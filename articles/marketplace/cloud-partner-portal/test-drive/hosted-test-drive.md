---
title: Hostovaná testovací verze | Azure Marketplace
...
- **Uživatelská příručka**: Odešlete podrobný uživatelská příručka (soubor typu .pdf), což pomáhá pochopit, jak použít aplikaci pro uživatele testovací verze.
- **Test jednotky – ukázkové Video**: Volitelně můžete nahrajte video, které představuje vaši aplikaci.

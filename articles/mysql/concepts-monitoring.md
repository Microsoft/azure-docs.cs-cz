...
|---|---|---|---|
|cpu_percent|Procento využití procesoru|Percent|Procento využití procesoru.|
|memory_percent|Procentuální hodnota paměti|Percent|Procentuální podíl používané paměti.|
|io_consumption_percent|V/v procenta|Percent|Procento využití v/v.|
|storage_percent|Procento úložiště|Percent|Procento využitého limitu úložiště z maxima serveru.|
...
|serverlog_storage_percent|Procentuální hodnota úložiště protokolu serveru|Percent|Procento využití úložiště protokolu serveru z maximálního úložiště protokolu serveru serveru.|
...
|connections_failed|Chyba připojení|Count|Počet neúspěšných připojení k serveru|

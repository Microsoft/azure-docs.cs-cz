...
> [!IMPORTANT]
> Postup dalšího přizpůsobení událostí auditu pomocí PowerShellu nebo REST API najdete v tématu [auditování databáze SQL](../../azure-sql/database/auditing-overview.md) .

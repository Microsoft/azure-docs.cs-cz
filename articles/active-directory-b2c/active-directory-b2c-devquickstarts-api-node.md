---
title: Zabezpečení webového rozhraní API pomocí Node.js v Azure Active Directory B2C | Microsoft Docs
description: Postup vytvoření webové aplikace Node.js API, které přijímá tokeny z klienta B2C.

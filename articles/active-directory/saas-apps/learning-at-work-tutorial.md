...
5. Na panelu výsledků vyberte **učení v práci**a potom klikněte na tlačítko **přidat** tlačítko pro přidání aplikace.
...
3. **[Vytvoření učení během práce testovacího uživatele](#creating-a-learning-at-work-test-user)**  – Pokud chcete mít protějšek Britta Simon v učení v práci, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **učení ve pracovní doména a adresy URL** části, proveďte následující kroky:
...
6. Na **učení v konfiguraci pracovní** klikněte na tlačítko **konfigurace učení v práci** otevřete **nakonfigurovat přihlašování** okna. Kopírovat **URL odhlašování SAML Entity ID a SAML jednotné přihlašování – adresa URL služby** z **Stručná referenční příručka oddílu.**

    ![Konfigurace jednotného přihlašování](./media/learning-at-work-tutorial/tutorial_learningatwork_configure.png) 

7. Ke konfiguraci jednotného přihlašování na **učení v práci** straně, je nutné odeslat na stažený **soubor XML s metadaty**, **SAML Entity ID**, **SAML jednotné přihlašování služby Adresa URL**, a **odhlašování URL** k [kurzů na webu podpory pracovních](https://www.learninga-z.com/site/contact/support).

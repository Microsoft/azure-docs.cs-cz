...
* ShardMapRefresh: Mapy horizontálních oddílů k určení všechny databáze používané jako horizontální oddíly dotazuje
* ScriptSplit: Rozdělí skript napříč 'Přejít' příkazy do dávek
* ExpandJob: Vytvoří podřízené úlohy pro každou databázi z úlohy, které cílí na skupinu databází
* ScriptExecution: Provede skript na konkrétní databázi pomocí přihlašovacích údajů definovaných
* Dacpac: DACPAC platí pro konkrétní databázi pomocí konkrétní přihlašovací údaje

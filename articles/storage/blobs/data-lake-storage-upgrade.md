...
| Data Operations – Logs  | Ano | Ano | *Available now* (Preview). See [known issues](data-lake-storage-known-issues.md).<br><br> Azure Monitoring integration – *Not yet available* |
...
| Dostupnost podle oblastí | See [here](https://azure.microsoft.com/regions/) | All [Azure regions](https://azure.microsoft.com/global-infrastructure/regions/)                                                                                                                                                                                                                                                                                                                                       | *Available now*                                                                                                                           |
| Cena                                       | See [Pricing](https://azure.microsoft.com/pricing/details/data-lake-store/)                                                                            | See [Pricing](https://azure.microsoft.com/pricing/details/storage/data-lake/)                                                                                                                                                                                                                                                                                                                                         |                                                                                                                                           |
| SLA o dostupnosti                            | [See SLA](https://azure.microsoft.com/support/legal/sla/data-lake-store/v1_0/)                                                                   | [See SLA](https://azure.microsoft.com/support/legal/sla/storage/v1_3/)                                                                                                                                                                                                                                                                                                                                                | *Available now*                                                                                                                           |
| Správa dat                             | File Expiration                                                                                                                                        | Lifecycle policies                                                                                                                                                                                                                                                                                                                                                                                                          | Lifecycle policies *Available now* (Preview). See [known issues](data-lake-storage-known-issues.md).                                                                                                                     |
...
|----------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| .NET SDK                  | [Odkaz](https://docs.microsoft.com/dotnet/api/overview/azure/datalakestore/management?view=azure-dotnet) | *Available now* | *Available now* |
| Java SDK                | [Odkaz](https://docs.microsoft.com/java/api/overview/azure/datalakestore/management)                                                                                                                                                                                                                                     | *Available now*                                                      | *Available now*                                     |
...
| Rozhraní REST API                 | [Odkaz](https://docs.microsoft.com/rest/api/datalakestore/accounts)                                                                                                                                                                                                                                                      | *Available now*                                                      | *Available now*                                                                                                                                               |
| PowerShell | [Odkaz](https://docs.microsoft.com/powershell/module/az.datalakestore)                                                                                                                                                                                                                        | *Available now* |
| Rozhraní příkazového řádku                 | [Odkaz](https://docs.microsoft.com/cli/azure/dls/account?view=azure-cli-latest)                                                                                                                                                                                                                                          | *Available now*                                                      | *Available now*                                                               |
...
| **Oblast**             | **Availability for Data Lake Storage Gen1**                                                                                                                                    | **Availability for Data Lake Storage Gen2 – with Shared Key auth**                                                                                                           | **Availability for Data Lake Storage Gen2 – with OAuth**                                                                                        |
|----------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------|
...
|                      | [SQL Data Warehouse](https://docs.microsoft.com/azure/sql-data-warehouse/sql-data-warehouse-load-from-azure-data-lake-store)                                            | *Nepodporuje se*                                                                                                                                                              | *Available now* [Link](https://docs.microsoft.com/sql/t-sql/statements/create-external-data-source-transact-sql?view=sql-server-2017) |
...
|                      | [Služba SSIS (SQL Server Integration Services)](https://docs.microsoft.com/sql/integration-services/connection-manager/azure-data-lake-store-connection-manager?view=sql-server-2017) | *Available now*                                                                                                                                                          | *Available now*                                                                                                                             |
...
| Využití          | [Power BI Desktop](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-power-bi)                                                                           | *Available now*                                                                                                                                                          | *Available now*                                                                                                                             |
...
| Produktivita         | [Azure Portal](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-get-started-portal)                                                                      | *Nepodporuje se*                                                                                                                                                              | Account management *– Available now* <br><br>Data operations *–*  *Not yet available*                                                                   |
...
| Oblast            | Partner  | Product/Service  | Availability for Data Lake Storage Gen1                                                                                                                                               | Availability for Data Lake Storage Gen2 – with Shared Key auth                                                   | Availability for Data Lake Storage Gen2 – with Oauth                                                             |
|---------------------|--------------|----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|
| Analytics framework | Cloudera     | CDH                  | [Odkaz](https://www.cloudera.com/documentation/enterprise/5-11-x/topics/admin_adls_config.html)                                                                                            | *Not yet available*                                                                                                  | [Odkaz](https://www.cloudera.com/documentation/enterprise/latest/topics/admin_adls2_config.html)                                                                                                  |
|                     | Cloudera     | Altus                | [Odkaz](https://www.cloudera.com/more/news-and-blogs/press-releases/2017-09-27-cloudera-introduces-altus-data-engineering-microsoft-azure-hybrid-multi-cloud-data-analytic-workflows.html) | *Nepodporuje se*                                                                                                                  | *Not yet available*                                                                                                  |
...
|                     | Qubole       |                      | [Odkaz](https://www.qubole.com/blog/big-data-analytics-microsoft-azure-data-lake-store-qubole/)                                                                                            | *Not yet available*                                                                                                  | *Not yet available*                                                                                                  |
| ETL                 | StreamSets   |                      | [Odkaz](https://streamsets.com/blog/ingest-data-azure)                                                                                                                                     | *Not yet available*                                                                                                  | *Not yet available*                                                                                                  |
|                     | Informatica  |                      | [Odkaz](https://kb.informatica.com/proddocs/Product%20Documentation/6/IC_Spring2017_MicrosoftAzureDataLakeStoreV2ConnectorGuide_en.pdf)                                                    | *Not yet available*                                                                                                  | *Not yet available*                                                                                                  |
|                     | Attunity     |                      | [Odkaz](https://www.attunity.com/company/press-releases/microsoft-and-attunity-announce-strategic-partnership-for-data-migration/)                                                         | *Not yet available*                                                                                                  | *Not yet available*                                                                                                  |
|                     | Alteryx      |                      | [Odkaz](https://help.alteryx.com/2018.2/DataSources/AzureDataLake.htm)                                                                                                                     | *Not yet available*                                                                                                  | *Not yet available*                                                                                                  |
|                     | ImanisData   |                      | [Odkaz](https://www.imanisdata.com/expansion-azure-support-azure-data-lake-store-integration/)                                                                                             | *Not yet available*                                                                                                  | *Not yet available*                                                                                                  |
...
| Protokoly aktivit                                                                                          | [Odkaz](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-diagnostic-logs#audit-logs)   | One-off requests for logs for specific duration using support ticket – *Available now* Azure Monitoring integration - *Not yet available* |
| Diagnostické protokoly                                                                                        | [Odkaz](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-diagnostic-logs#request-logs) | *Available now* (Preview). See [known issues](data-lake-storage-known-issues.md). <br>Azure Monitoring integration - *Not yet available* |
| Metriky                                                                                                | *Nepodporuje se*                                                                                               | *Available now -* [Link](https://docs.microsoft.com/azure/storage/common/storage-metrics-in-azure-monitor)                          |
...
| Strategie                   | Pros                                                                                  | Nevýhody                                                           | When to use?                                                                                                                                                                                             |
|--------------------------------|-------------------------------------------------------------------------------------------|--------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| Strategie                       | Nástroje                                                                                                             | Pros                                                                                                                             | Požadavky                                                                                                                                                                                                                                                                                                                |
|------------------------------------|-----------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|

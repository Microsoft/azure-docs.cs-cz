...
Vybere sloupce podle jeho relativní pozice (1 na základě) v datovém proudu. Pokud je pozice mimo hranice vrátí hodnotu NULL. Vrácená hodnota musí být typ převést pomocí jedné z funkcí převodu typu (TO_DATE, TO_STRING...) Vypočítané vstupy nejsou podporovány, ale můžete použít náhrad parametrů * ``toString(byPosition(1)) -> amma``
...
Získá první hodnotu sloupce skupiny. Pokud je vynechán druhý parametr, Ignorovat hodnoty Null, předpokládá se false * ``first(sales) -> 12233.23``
...
Převede na časové razítko od času UTC. Můžete volitelně předat časového pásma ve formě 'GMT', "PST", "UTC", "Amerika/Kajmanské". Je použita jako výchozí na aktuální časové pásmo * ``fromUTC(currentTimeStamp()) -> 12-12-2030T19:18:12``
...
Kontroluje se, pokud řádku je označená k odstranění. Pro transformace trvá víc než jeden vstupní datový proud, můžete předat index (založený na 1) datového proudu. Výchozí hodnota pro index datového proudu je 1 * ``isDelete() -> true``
* ``isDelete(1) -> false``
*********************************
<code>isError</code>
==============================
<code><b>isError([<i>&lt;value1&gt;</i> : integer]) => boolean</b></code><br/><br/>
Kontroluje, pokud je řádek označeny jako chyba. Pro transformace trvá víc než jeden vstupní datový proud, můžete předat index (založený na 1) datového proudu. Výchozí hodnota pro index datového proudu je 1 * ``isError() -> true``
* ``isError(1) -> false``
*********************************
<code>isIgnore</code>
==============================
<code><b>isIgnore([<i>&lt;value1&gt;</i> : integer]) => boolean</b></code><br/><br/>
Kontroluje, pokud se mají ignorovat označí řádku. Pro transformace trvá víc než jeden vstupní datový proud, můžete předat index (založený na 1) datového proudu. Výchozí hodnota pro index datového proudu je 1 * ``isIgnore() -> true``
* ``isIgnore(1) -> false``
*********************************
<code>isInsert</code>
==============================
<code><b>isInsert([<i>&lt;value1&gt;</i> : integer]) => boolean</b></code><br/><br/>
Kontroluje, pokud je označen řádek pro vložení. Pro transformace trvá víc než jeden vstupní datový proud, můžete předat index (založený na 1) datového proudu. Výchozí hodnota pro index datového proudu je 1 * ``isInsert() -> true``
* ``isInsert(1) -> false``
*********************************
<code>isMatch</code>
==============================
<code><b>isMatch([<i>&lt;value1&gt;</i> : integer]) => boolean</b></code><br/><br/>
Kontroluje, pokud je nalezena shoda řádku na vyhledávání. Pro transformace trvá víc než jeden vstupní datový proud, můžete předat index (založený na 1) datového proudu. Výchozí hodnota pro index datového proudu je 1 * ``isMatch() -> true``
* ``isMatch(1) -> false``
*********************************
<code>isNull</code>
==============================
...
Kontroluje, pokud je označen řádek pro aktualizace. Pro transformace trvá víc než jeden vstupní datový proud, můžete předat index (založený na 1) datového proudu. Výchozí hodnota pro index datového proudu je 1 * ``isUpdate() -> true``
* ``isUpdate(1) -> false``
*********************************
<code>kurtosis</code>
==============================
...
Získá hodnotu prvního parametru vyhodnotit n řádků před aktuální řádek. Druhý parametr počet řádků, které mají podívat zpět a výchozí hodnota je 1. Pokud libovolný počet řádků nejsou určena výchozí hodnota vrátí hodnotu null * ``lag(amount, 2) -> 60``
...
Získá hodnotu první parametr vyhodnotit n řádek po řádku aktuální. Druhý parametr počet řádků, které mají Těšíme a výchozí hodnota je 1. Pokud libovolný počet řádků nejsou určena výchozí hodnota vrátí hodnotu null * ``lead(amount, 2) -> 60``
...
Vrátí hodnotu NULL. Funkce syntax(null()) použijte, pokud je název sloupce s názvem "null". Všechny operace, která používá způsobí s hodnotou NULL * ``custId = NULL (for derived field)``
* ``custId == NULL -> NULL``
* ``'nothing' + NULL -> NULL``
* ``10 * NULL -> NULL'``
* ``NULL == '' -> NULL'``
...
Převede řetězec na datum zadané ve formátu volitelné datum. Odkazovat Java SimpleDateFormat pro všechny možné formáty. Pokud je vynechán formát data, jsou přijaty následující kombinace. [ yyyy, yyyy-[M]M, yyyy-[M]M-[d]d, yyyy-[M]M-[d]d, yyyy-[M]M-[d]d, yyyy-[M]M-[d]dT* ] * ``toDate('2012-8-8') -> 2012-8-8``
...
Převede primitivní datový typ na řetězec. Pro čísla a data je možné zadat formátu. Pokud tento parametr zadán výchozí systémové nastavení se vybere. Desítkový formát Java se používá pro čísla. Najdete Java SimpleDateFormat pro všechny možné data formátů. je výchozí formát rrrr MM-dd * ``toString(10) -> '10'``
...
Převede řetězec na datum zadané ve formátu volitelné časového razítka. Odkazovat Java SimpleDateFormat pro všechny možné formáty. Pokud je vynechán časové razítko výchozí vzor rrrr-[M] M [d]-d hh: mm: [. f...] se používá * ``toTimestamp('2016-12-31 00:12:00') -> 2012-8-8T00:12:00``

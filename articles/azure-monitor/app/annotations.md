...
> [!NOTE]
> Tento článek odráží zastaralá **prostředí klasické metriky**. Poznámky jsou aktuálně dostupné v klasickém prostředí a  **[sešity](../../azure-monitor/app/usage-workbooks.md)**. Další informace o aktuálního prostředí metriky, můžete konzultovat [v tomto článku](../../azure-monitor/platform/metrics-charts.md).
...
1. Přihlaste se k [Microsoft Azure Portal](https://portal.azure.com) a otevřete prostředek Application Insights, který monitoruje vaše aplikace. (Nebo [založte si ho teď](../../application-insights/app-insights-overview.md), pokud jste tak ještě neučinili.)

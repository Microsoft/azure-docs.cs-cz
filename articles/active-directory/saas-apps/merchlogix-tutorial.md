---
title: 'Kurz: Integrace Azure Active Directory se službou Merchlogix | Dokumentace Microsoftu'
...
ms.locfileid: "39052063"
---
# <a name="tutorial-azure-active-directory-integration-with-merchlogix"></a>Kurz: Integrace Azure Active Directory se službou Merchlogix
...
3. **[Vytvoření zkušebního uživatele Merchlogix](#create-a-merchlogix-test-user)**  – Pokud chcete mít protějšek Britta Simon Merchlogix, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **Merchlogix domény a adresy URL** části, proveďte následující kroky:
    ...
    > [!NOTE]
    > Tyto hodnoty nejsou skutečný. Tyto hodnoty aktualizujte s skutečné přihlašovací adresu URL a identifikátorem. Kontakt [tým podpory Merchlogix](http://www.merchlogix.com/contact/) k získání těchto hodnot.
...
6. Na **Merchlogix konfigurace** klikněte na tlačítko **nakonfigurovat Merchlogix** otevřete **nakonfigurovat přihlašování** okna. Kopírovat **URL odhlašování, SAML Entity ID,** a **SAML jednotné přihlašování – adresa URL služby** z **Stručná referenční příručka oddílu.**

    ![Konfigurace Merchlogix](./media/merchlogix-tutorial/tutorial_merchlogix_configure.png) 

7. Ke konfiguraci jednotného přihlašování na **Merchlogix** straně, je nutné odeslat na stažený **certifikát (Base64)**, **URL odhlašování SAML Entity ID a SAML jednotné přihlašování – adresa URL služby**k [tým podpory Merchlogix](http://www.merchlogix.com/contact/). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.
...
V této části vytvoříte uživatele v Merchlogix jako Britta Simon. Práce s [tým podpory Merchlogix](http://www.merchlogix.com/contact/) přidat uživatele na platformě Merchlogix.

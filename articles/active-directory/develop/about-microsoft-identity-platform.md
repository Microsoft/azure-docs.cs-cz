...
Až do té doby se většina vývojářů pracovala s platformou Azure AD v 1.0, aby ověřovala pracovní a školní účty (zřízené službou Azure AD) tím, že požaduje tokeny z koncového bodu Azure AD v 1.0 pomocí knihovny Active Directory Authentication Library (ADAL), Azure Portal pro registraci a konfiguraci aplikace a Microsoft Graph API pro konfiguraci programových aplikací.

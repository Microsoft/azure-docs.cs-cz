...
**Pokyny** : použití pracovní stanice s privilegovaným přístupem (privilegovaným přístupem) se zapnutou službou Azure Multi-Factor Authentication (MFA), která umožňuje přihlášení a konfiguraci vašich Customer Lockbox požadavků.
...
* [Pochopení ochrany zákaznických dat v Azure](./protection-customer-data.md)

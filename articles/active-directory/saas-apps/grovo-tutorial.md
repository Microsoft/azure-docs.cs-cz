---
title: 'Kurz: Integrace Azure Active Directory se službou Grovo | Dokumentace Microsoftu'
...
ms.locfileid: "39053382"
---
# <a name="tutorial-azure-active-directory-integration-with-grovo"></a>Kurz: Integrace Azure Active Directory se službou Grovo
...
3. **[Vytvoření zkušebního uživatele Grovo](#create-a-grovo-test-user)**  – Pokud chcete mít protějšek Britta Simon Grovo, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **Grovo domény a adresy URL** části, proveďte následující kroky, pokud chcete nakonfigurovat aplikace v **IDP** iniciované režimu:
...
5. Grovo aplikace očekává, že kontrolní výrazy SAML v určitém formátu. Nakonfigurujte následující deklarace identity pro tuto aplikaci. Můžete spravovat hodnotami těchto atributů z "**atributy uživatele**" části na stránce aplikací pro integraci. Přiřaďte **identifikátor uživatele** s **user.mail** a nakonfigurovat další atributy, jak je znázorněno v následující snímek obrazovky.
...
9. Na **Grovo konfigurace** klikněte na tlačítko **nakonfigurovat Grovo** otevřete **nakonfigurovat přihlašování** okna. Kopírovat **SAML Entity ID a SAML jednotné přihlašování – adresa URL služby** z **Stručná referenční příručka oddílu.**

    ![Konfigurace Grovo](./media/grovo-tutorial/tutorial_grovo_configure.png) 

10. V jiné okno webového prohlížeče, přihlaste se k Grovo jako správce.

11. Přejděte na **správce** > **integrace**.
 
    ![Konfigurace Grovo](./media/grovo-tutorial/tutorial_grovo_admin.png) 

12. Klikněte na tlačítko **SET UP** pod **iniciované SAML 2.0 SP** oddílu.

    ![Konfigurace Grovo](./media/grovo-tutorial/tutorial_grovo_setup.png)

13. V **iniciované SAML 2.0 SP** automaticky otevíraném okně, proveďte následující kroky:

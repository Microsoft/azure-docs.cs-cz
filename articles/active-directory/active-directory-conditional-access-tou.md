...
![Vytvoření zásad](./media/active-directory-conditional-access-tou/5555.png)
...
5. Na **Azure Active Directory** stránku, **spravovat** klikněte na tlačítko **podmíněného přístupu**.
    ...
    ![Podmíněný přístup](./media/active-directory-conditional-access-tou/03.png) 

6. V **spravovat** klikněte na tlačítko **podmínky použití**.

    ![Podmínky použití](./media/active-directory-conditional-access-tou/04.png) 

7. V nabídce v horní části klikněte na tlačítko **nové podmínky**.

    ![Podmínky použití](./media/active-directory-conditional-access-tou/05.png) 

8. Na **nové podmínky použití** stránky:

    ![Podmínky použití](./media/active-directory-conditional-access-tou/112.png) 
...
![Vytvoření zásad](./media/active-directory-conditional-access-tou/1234.png)
...
1. Na **nový** stránku, **název** textové pole, typ **vyžadují podmínky použití pro Isabella**.
    ...
    ![Název](./media/active-directory-conditional-access-tou/71.png)

2. V **přiřazení** klikněte na tlačítko **uživatelů a skupin**.

    ![Uživatelé a skupiny](./media/active-directory-conditional-access-tou/06.png)

3. Na **uživatelů a skupin** stránky:

    ![Uživatelé a skupiny](./media/active-directory-conditional-access-tou/24.png)
...
4. Klikněte na tlačítko **cloudové aplikace**.
    ...
    ![Cloudové aplikace](./media/active-directory-conditional-access-tou/08.png)

5. Na **cloudové aplikace** stránky:

    ![Vyberte cloudové aplikace](./media/active-directory-conditional-access-tou/26.png)
...
6. V **ovládací prvky přístupu** klikněte na tlačítko **udělení**.
    ...
    ![Ovládací prvky přístupu](./media/active-directory-conditional-access-tou/10.png)

7. Na **udělení** stránky:

    ![Udělení](./media/active-directory-conditional-access-tou/111.png)
...
8. V **povolit zásady** klikněte na tlačítko **na**.
    ...
    ![Povolit zásadu](./media/active-directory-conditional-access-tou/18.png)
...
![Co když nástroj zásad](./media/active-directory-conditional-access-tou/79.png)
...
2. Klikněte na tlačítko **uživatelé**vyberte **Isabella Simonsen**a potom klikněte na tlačítko **vyberte**.
    ...
    ![Uživatel](./media/active-directory-conditional-access-tou/15.png)

2. Vyberte cloudové aplikace:

    ![Cloudové aplikace](./media/active-directory-conditional-access-tou/16.png)
...
![Podmínky použití](./media/active-directory-conditional-access-tou/57.png)
...
- Pokud chcete odstranit zásady, vyberte zásady a klikněte na **odstranit** v panelu nástrojů Rychlý přístup.
    ...
    ![Ověřování pomocí služby Multi-Factor Authentication](./media/active-directory-conditional-access-tou/33.png)
...
- Odstranění vašich podmínek použití, vyberte ho a pak klikněte na tlačítko **odstranit podmínky** na panelu nástrojů v horní části. 
    ...
    ![Ověřování pomocí služby Multi-Factor Authentication](./media/active-directory-conditional-access-tou/29.png)

## <a name="next-steps"></a>Další postup

> [!div class="nextstepaction"]
> [Vyžadovat vícefaktorové ověřování pro konkrétní aplikace](./active-directory-conditional-access-app-based-mfa.md)
> [blokování přístupu, když se zjistí ohrožení relace](./active-directory-conditional-access-app-sign-in-risk.md)

...
Aby byl tento `Ingress` prostředek splněn, vyžaduje se kontroler příchozího přenosu dat, který naslouchá jakýmkoli `Ingress` změnám v prostředcích a konfiguruje zásady nástroje pro vyrovnávání zatížení.

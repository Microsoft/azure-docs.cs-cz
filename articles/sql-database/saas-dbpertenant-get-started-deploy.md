...
- http://events.wingtip-dpt.&lt;uživatel&gt;.trafficmanager.net/fabrikamjazzclub
    ...
    | Část URL        | Popis       |
    | :-------------- | :---------------- |
    | events.wingtip-dpt | Události části aplikace Wingtip.<br /><br /> *-dpt* odlišuje *databázi na tenanta* implementaci Wingtip Tickets od ostatních implementací. Příklady jsou *implementace jedné* aplikace na tenanta (*-sa*) nebo *víceklientské databáze* (*-mt*). |

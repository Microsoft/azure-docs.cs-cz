...
Můžete po povolení MSI na prostředek služby Azure, například [virtuálního počítače Azure](qs-configure-portal-windows-vm.md) nebo [Azure VMSS](qs-configure-portal-windows-vmss.md):
...
- Povolit MSI na virtuální počítač Azure, najdete v části [konfigurace Azure virtuálního počítače spravované služby Identity (MSI) pomocí portálu Azure](qs-configure-portal-windows-vm.md).

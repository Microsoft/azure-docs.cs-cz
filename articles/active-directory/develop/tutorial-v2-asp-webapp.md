---
title: Azure AD v2.0 webový server ASP.NET Začínáme | Dokumentace Microsoftu
...
Další informace o Web apps volání webového rozhraní API:.
...
> [Volání webového rozhraní API webové aplikace]( https://aka.ms/msal-net-authorization-code)

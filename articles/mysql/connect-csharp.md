...
ms.locfileid: "53547452"
---
# <a name="azure-database-for-mysql-use-net-c-to-connect-and-query-data"></a>Azure Database for MySQL: Použití .NET (C#) k připojení a dotazování dat

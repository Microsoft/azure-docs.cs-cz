---
title: 'Rychlý Start: hledání entit pomocí sady SDK pro C# vyhledávání entit Bingu'
...
Chcete-li přidat sadu Vyhledávání entit Bingu SDK do projektu aplikace Visual Studio, použijte možnost **Spravovat balíčky NuGet** z **Průzkumník řešení**a přidejte balíček `Microsoft.Azure.CognitiveServices.Search.EntitySearch`.

---
title: Zpracování oznámení o údržbě pro virtuální počítače se systémem Linux v Azure
...
Následující volání inicializuje údržbu virtuálního počítače, pokud je `IsCustomerInitiatedMaintenanceAllowed` nastaveno na hodnotu true.

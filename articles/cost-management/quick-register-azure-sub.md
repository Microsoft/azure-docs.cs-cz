...
description: Použijte svoje předplatné Azure k registraci u Cloudyn.
...
2. V části **Přehled** klikněte na **Cloudyn**.  
    ![Stránka Cloudyn](./media/quick-register-azure-sub/cost-mgt-billing-service.png)

...
| Parametr | Požaduje se | Typ | Popis | 
| --------- | -------- | ---- | ----------- | 
| <*Hodnota*> | Ano | Řetězec | Řetězec s objekt JSON, který chcete převést <p>Objekt ve formátu JSON musí mít pouze jeden kořenový vlastnost, která nemůže být pole. <br>Použít znak zpětného lomítka (\\) jako řídicí znak pro dvojité uvozovky ("). | 
||||| 

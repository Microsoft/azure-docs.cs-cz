---
title: 'Kurz: Azure Active Directory integrace jednotného přihlašování (SSO) k programu MS Azure SSO pro Ethidex dodržování předpisů pro Office™ | Microsoft Docs'
...
ms.locfileid: "70173494"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-ms-azure-sso-access-for-ethidex-compliance-office"></a>Kurz: Azure Active Directory integrace jednotného přihlašování (SSO) k programu MS Azure SSO pro Ethidex dodržování předpisů pro Office™
...
Ke konfiguraci jednotného přihlašování na základě jednotného přihlašování v **MS Azure pro Ethidex dodržování předpisů v office™** straně je potřeba odeslat stažený **certifikát (RAW)** a příslušné zkopírované adresy URL z Azure Portal do služby [MS Azure SSO přístup pro Ethidex pro dodržování předpisů™ tým podpory](mailto:support@ethidex.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.
...
V této části vytvoříte uživatele s názvem B. Simon ve službě MS Azure přístup pomocí jednotného přihlašování pro Ethidex pro dodržování předpisů v Office™. Pracujte s [přístupem k jednotnému přístupu ke službě MS Azure pro Ethidex dodržování předpisů v sadě office™ support](mailto:support@ethidex.com) , aby bylo možné přidávat uživatele v rámci služby Ethidex (Microsoft Azure SSO Access) pro™ platformy Office. Uživatelé musí vytvořit a aktivovat, než použití jednotného přihlašování.

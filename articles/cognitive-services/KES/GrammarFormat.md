---
title: Formát gramatiky – Knowledge Exploration Service API
titlesuffix: Azure Cognitive Services
description: Další informace o formát gramatiky v znalostní báze zkoumání služby (KES) rozhraní API.
...
|----|----|----|----|
| String | EQ | Přesná shoda pro řetězec | rovná se |
| String | starts_with | Porovnání předpony řetězce | starts_with |

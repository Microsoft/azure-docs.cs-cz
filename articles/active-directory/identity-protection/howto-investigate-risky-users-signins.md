---
title: Jak prozkoumat rizikové uživatele a přihlášení v Azure Active Directory Identity Protection (Aktualizováno) | Microsoft Docs
description: Naučte se prozkoumat rizikové uživatele a přihlášení v Azure Active Directory Identity Protection (aktualizované).
...
ms.locfileid: "68370322"
---
# <a name="how-to-investigate-risky-users-and-sign-ins"></a>Jak: Prozkoumávání rizikových uživatelů a přihlášení 

Pomocí sestav rizikových přihlášení a rizikových uživatelů můžete prozkoumat a získat přehled o rizikech ve vašem prostředí. Díky možnosti filtrovat a seřadit rizikové přihlašování a uživatele můžete lépe porozumět možnému vniknutí ve vaší organizaci. 
...
- Pokud si myslíte, že aktivní rizikové události uživatele jsou falešně pozitivní, odsuňte riziko uživatele. Další informace najdete v článku věnovaném [zpětné vazbě na rizikové události v Azure AD Identity Protection](howto-provide-risk-event-feedback.md).
...
- Kolik úspěšných přihlášení bylo v minulém týdnu pro rizikové události s anonymní IP adresou?
...
Další informace najdete v článku věnovaném [zpětné vazbě na rizikové události v Azure AD Identity Protection](howto-provide-risk-event-feedback.md).

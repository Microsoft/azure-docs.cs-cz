---
title: Přehled výkonu dotazu – databáze Azure pro MySQL
description: Tento článek popisuje funkci Přehled výkonu dotazu v Azure Database for MySQL
author: ajlam
ms.author: andrela
ms.service: mysql
ms.topic: conceptual
...
Na portálové stránce serveru Azure Database for MySQL vyberte **přehled výkonu dotazu** v části **Inteligentní výkon** na řádku nabídek.
...
> [!NOTE]
> Statistiky čekání jsou určeny pro řešení problémů s výkonem dotazu. Doporučujeme zapnout pouze pro účely řešení potíží. <br>Pokud se zobrazí chybová zpráva na webu Azure Portal "*Problém zjištěnpro 'Microsoft.DBforMySQL'; nemůže splnit požadavek. Pokud tento problém přetrvává nebo je neočekávaný, obraťte se na podporu s těmito informacemi.*" při prohlížení statistik čekání použijte menší časové období.
...
- Další informace o [monitorování a ladění](concepts-monitoring.md) v Azure Database for MySQL.
---
title: Ukázka kódu JSON pro Azure Policy – Vynucení vzoru match pro značky | Microsoft Docs
description: Tato ukázková zásada JSON vyžaduje, aby prostředky splňovaly vzor match pro hodnoty značek.

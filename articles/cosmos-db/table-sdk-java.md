---
title: Rozhraní API tabulky DB Azure Cosmos pro Jazyk Java
...
---
# <a name="azure-cosmos-db-table-api-for-java-release-notes-and-resources"></a>Rozhraní API tabulky DB Azure Cosmos pro Jazyk Java: Poznámky k verzi a prostředky
...
|   |   |
|---|---|
|**SDK ke stažení**|[Možnosti stahování](https://github.com/azure/azure-storage-java#download)|
|**Dokumentace k rozhraní API**|[Referenční dokumentace java api](https://azure.github.io/azure-storage-java/)|
|**Přispívat do sady SDK**|[GitHub](https://github.com/Azure/azure-storage-java#contribute-code-or-provide-feedback)|

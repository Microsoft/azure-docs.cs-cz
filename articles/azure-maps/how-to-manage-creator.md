...
Pokud chcete odstranit prostředek tvůrce, přejděte na účet Azure Maps. V části **Tvůrce**vyberte **Přehled** . Klikněte na **Odstranit**.
...
## <a name="access-to-creator-services"></a>Přístup ke službě Creator Services

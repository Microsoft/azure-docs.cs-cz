...
V tomto článku jste se dozvěděli, jak navazovat cloudovou aplikaci Azure na jaře na instanci Azure Database for MySQL. Další informace o vázání služeb na aplikaci najdete v tématu [vázání databáze Azure Cosmos DB k aplikaci Azure jaře Cloud](spring-cloud-howto-bind-cosmos.md).

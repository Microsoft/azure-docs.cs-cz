...
description: Popis schématu XML modelu služby Service Fabric, včetně umístění a souhrnu součástí.
ms.topic: reference
ms.date: 12/10/2018
...
# <a name="service-model-xml-schema-documentation"></a>Dokumentace schématu XML modelu služby
Tento článek dokumentuje soubor schématu ServiceFabricServiceModel.xsd nainstalovaný sadou Service Fabric SDK.  Ve výchozím nastavení je soubor schématu nainstalován na *soubor C:\Program Files\Microsoft SDKs\Service Fabric\Schemas\ServiceFabricServiceModel.xsd*.
...
## <a name="component-summary"></a>Souhrn součásti 
V souboru ServiceFabricServiceModel.xsd jsou definovány následující součásti:
- [257 prvků](service-fabric-service-model-schema-elements.md)
- [112 komplexTypy](service-fabric-service-model-schema-complex-types.md)

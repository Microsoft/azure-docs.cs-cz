...
| Maximální agregovaná šířka pásma kanálu příspěvků|60 MB/s|neuvedeno|
...
| Možnost obnovení z krátkých kabin v informačním kanálu příspěvků|Ano|Částečně|
...
| S přenosovou rychlostí | impulzu | Výška | MaxFPS | Profil |
| --- | --- | --- | --- | --- |

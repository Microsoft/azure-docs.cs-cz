...
1. Do skriptu koordinátora přidejte přihlašovací údaje pro vzdálené vykreslování Azure, doménu účtu a doménu vzdáleného vykreslování: \
...
1. Nastavte název a přidejte [**WorldAnchor**](https://docs.unity3d.com/550/Documentation/ScriptReference/VR.WSA.WorldAnchor.html) pro pomoc stabilizaci.

---
title: Vlastní ověření e-mailu pomocí SendGrid
titleSuffix: Azure AD B2C
description: Naučte se integrovat s SendGrid, abyste mohli přizpůsobit ověřovací e-mail odesílaný zákazníkům při registraci k používání aplikací s podporou Azure AD B2C.
...
1. Do pole **tajný kód** zadejte klíč rozhraní API SendGrid, který jste předtím nahráli.
...
Pod transformací deklarací identity v rámci `<BuildingBlocks>` přidejte následující [ContentDefinition](contentdefinitions.md) pro ODKAZOVÁNÍ na identifikátor URI dat 2.1.2 verze 2.1.2:
...
![Akce poslat e-mail s ověřovacím kódem](media/custom-email-sendgrid/display-control-verification-email-action-01.png)
...
1. Aktualizujte šablonu SendGrid tak, aby používala dynamické parametry místo všech řetězců, které budou lokalizovány Azure AD B2C.

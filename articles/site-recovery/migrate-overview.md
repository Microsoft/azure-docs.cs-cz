...
> [!TIP]
> Teď byste měli použít službu Azure Migrate k migraci virtuálních počítačů a serverů do Azure, namísto služby Azure Site Recovery. [Další informace](../migrate/migrate-services-overview.md).

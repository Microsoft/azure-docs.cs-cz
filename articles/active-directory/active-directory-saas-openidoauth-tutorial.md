...
1. V  **[portál Azure](https://portal.azure.com)**, v levém navigačním panelu klikněte na tlačítko **Azure Active Directory** ikonu. 
    ...
    ![Tlačítko Azure Active Directory](./media/active-directory-saas-openidoauth-tutorial/tutorial_general_01.png)

2. Přejděte na **podnikové aplikace, které**. Pak přejděte na **všechny aplikace**.

    ![V okně podnikové aplikace](./media/active-directory-saas-openidoauth-tutorial/tutorial_general_02.png)

3. Chcete-li přidat novou aplikaci, klikněte na tlačítko **novou aplikaci** tlačítko horní dialogové okno.

    ![Tlačítko nové aplikace](./media/active-directory-saas-openidoauth-tutorial/tutorial_general_03.png)

4. Do vyhledávacího pole zadejte **název aplikace**, vyberte **požadovaných aplikací** z výsledků panelů přihlašovací až aplikace.

    ![Přidává se aplikace](./media/active-directory-saas-openidoauth-tutorial/addfromgallery.png)
    ...
    ![Tlačítko Přidat](./media/active-directory-saas-openidoauth-tutorial/addbutton.png)
...
![Tok ověřování pomocí OpenID Connect](./media/active-directory-saas-openidoauth-tutorial/authenticationflow.png)
...
4. Jakmile se uživatel přihlásil, Azure AD se určují, jestli uživatel musí zobrazený na stránce souhlasu. Toto rozhodnutí je založená na tom, jestli uživatel (nebo správce jeho organizace) již udělil souhlas aplikace. Pokud již byla nebyl udělen souhlas, Azure AD zobrazí výzvu k souhlasu a zobrazí požadovaná oprávnění, musí se funkce. Sada oprávnění, která se zobrazí v dialogovém okně souhlasu odpovídat souborů vybraných v delegovaná oprávnění na webu Azure portal.
    ...
    ![Stránka souhlasu](./media/active-directory-saas-openidoauth-tutorial/consentpage.png)
...
![Udělení oprávnění](./media/active-directory-saas-openidoauth-tutorial/grantpermission.png)

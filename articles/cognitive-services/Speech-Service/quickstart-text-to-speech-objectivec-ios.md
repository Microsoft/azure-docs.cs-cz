...
K dispozici jsou také rychlé starty pro [rozpoznávání řeči](quickstart-objectivec-ios.md).
...
1. Obsah automaticky generovaného souboru `AppDelegate.m` nahraďte: [!code-objectivec @ no__t-2
...
1. Sestavte a spusťte ukázkový kód v simulátoru iOS výběrem možnosti **Product** > **Run** (Produkt > Spustit) v nabídce nebo kliknutím na tlačítko **Play** (Přehrát).
   ...
   ![Simulovaná aplikace pro iOS](media/sdk/qs-objectivec-simulated-app-tts.png)

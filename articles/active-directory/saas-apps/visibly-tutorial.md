...
1. V navigační nabídce přejděte do možnosti **Nastavení** .
    ...
    ![Snímek obrazovky zobrazuje vybranou možnost nastavení.](./media/visibly-tutorial/settings.png)

1. Klikněte na **integrace** v nastavení.

    ![Snímek obrazovky zobrazuje integrace vybrané z nabídky nastavení.](./media/visibly-tutorial/integrations.png)

1. V části **integrace** vyberte **SSO**.

    ![Snímek obrazovky S vybraným z integrací zobrazuje.](./media/visibly-tutorial/sso.png)

1. Na následující stránce proveďte následující kroky.

    ![Snímek obrazovky se zobrazí stránka integrace s S/O, kde můžete zadat hodnoty, které jsou popsány.](./media/visibly-tutorial/configuration.png)
...
Po kliknutí na dlaždici viditelně na přístupovém panelu byste měli být automaticky přihlášeni k viditelnému, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).

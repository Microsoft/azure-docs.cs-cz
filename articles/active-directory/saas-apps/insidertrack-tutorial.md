...
4. Do vyhledávacího pole zadejte **zevnitř sledovat**, vyberte **zevnitř sledovat** z panelu výsledků klikněte **přidat** tlačítko Přidat aplikaci.
    ...
    ![Vnitřní sledování v seznamu výsledků](./media/insidertrack-tutorial/tutorial_insidertrack_addfromgallery.png)
...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/insidertrack-tutorial/tutorial_insidertrack_samlbase.png)

3. Na **zevnitř sledovat domény a adresy URL** část, proveďte následující kroky:

    ![Vnitřní sledovat domény a adresy URL jednotné přihlašování informace](./media/insidertrack-tutorial/tutorial_insidertrack_url.png)
...
5. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/insidertrack-tutorial/tutorial_general_400.png)
...
6. Na **konfigurace sledování zevnitř** klikněte na tlačítko **konfigurace sledování zevnitř** otevřete **konfigurovat přihlášení** okno. Kopírování **Sign-Out adresu URL, SAML Entity ID a SAML jeden přihlašování adresa URL služby** z **Stručná referenční příručka části.**
    ...
    ![Konfigurace sledování zevnitř](./media/insidertrack-tutorial/tutorial_insidertrack_configure.png) 
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/insidertrack-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **zevnitř sledovat**.
    ...
    ![Odkaz zevnitř sledování v seznamu aplikací](./media/insidertrack-tutorial/tutorial_insidertrack_app.png)  

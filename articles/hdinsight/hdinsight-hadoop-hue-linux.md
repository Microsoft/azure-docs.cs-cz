...
1. V okně **volitelná konfigurace** vyberte **akce skriptu**a zadejte informace, jak je znázorněno níže:
...
1. V dolní části **akcí skriptu**uložte konfiguraci pomocí tlačítka pro **Výběr** . Nakonec použijte tlačítko **Vybrat** v dolní části okna **volitelná konfigurace** a uložte volitelné informace o konfiguraci.

...
3. Na stránce cílová zařízení pro IoT Edge modul zadejte následující podrobnosti a pak klikněte na **vytvořit** .
   ...
   |Centrum IoT   |  Název IoT Hub, kde je IoT Edge zařízení zaregistrované, a pak vyberte možnost nasadit do zařízení.|
...
6. V podokně **IoT Edge vlastní moduly** aktualizujte kontejner možnosti vytvoření požadované hodnoty pro **port hostitele** a **cíl** přípojných bodů. Cílový bod připojení je místo, kde budou soubory databáze SQL uloženy v hostitelském IoT Edgem zařízení.

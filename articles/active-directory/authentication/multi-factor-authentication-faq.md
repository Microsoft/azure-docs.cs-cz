...
Uživatelům může ukazovat [Průvodci odstraňováním potíží koncového uživatele](end-user/current/multi-factor-authentication-end-user-troubleshoot.md).

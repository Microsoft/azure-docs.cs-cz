...
* [Python](https://www.python.org/downloads/) a následující balíčky:
  * požádal
...
1. Hodnotu nahraďte `image_path` cestou a názvem souboru jiné image, kterou chcete analyzovat.

...
2. V levém podokně klikněte na tlačítko **integrovaných koncových bodech**vyberte **události** v horním podokně a zadejte název v rámci **skupiny příjemců** v pravém podokně. Klikněte na tlačítko **Uložit** po změně **výchozí hodnota TTL** hodnotu a vrátí zpět na původní hodnotu.

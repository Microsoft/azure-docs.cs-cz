...
- Další informace najdete Azure Security Center v tématu Ochrana dat a prostředků úložiště, například serverů SQL a účtů úložiště, a přijetí doporučení pro zlepšení zabezpečení. 
...
- Pokud chcete monitorovat přístup k vašim prostředkům v čase, přečtěte si další informace v tématu [Správa přístupu k virtuálnímu počítači pomocí možnosti pouze v čase](security-center-just-in-time.md) . 

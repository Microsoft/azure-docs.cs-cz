...
Pokyny k instalaci najdete [v tématu Instalace sady Azure Toolkit for Eclipse](https://docs.microsoft.com/azure/developer/java/toolkit-for-eclipse/installation).

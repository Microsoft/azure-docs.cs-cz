...
4. Znovu zapnout **ochranu místních virtuálních počítačů**: po selhání dat znovu nastavte ochranu místních virtuálních počítačů VMware, na které jste se nevrátili, aby se začaly replikovat do Azure.

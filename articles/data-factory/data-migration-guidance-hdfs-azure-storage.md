...
V režimu Data Factory DistCp můžete použít různé parametry příkazového řádku DistCp (například `-i`, ignorovat chyby nebo `-update`, zapsat data, když se zdrojový soubor a cílový soubor liší velikost) pro různé úrovně odolnosti.

---
title: Vytvoření Cassandraho prostoru a tabulky s automatickém škálováním pro Azure Cosmos DB
description: Vytvoření Cassandraho prostoru a tabulky s automatickém škálováním pro Azure Cosmos DB
author: markjbrown
ms.author: mjbrown
...
ms.locfileid: "107786818"
---
# <a name="create-an-azure-cosmos-cassandra-api-account-keyspace-and-table-with-autoscale-using-azure-cli"></a>Vytvoření účtu služby Azure Cosmos rozhraní API Cassandra, místa a tabulky s použitím automatického škálování pomocí Azure CLI

...
1. Přidání Cherwell z Galerie
2. Konfigurace a testování Azure AD jednotného přihlašování

## <a name="adding-cherwell-from-the-gallery"></a>Přidání Cherwell z Galerie
Při konfiguraci integrace Cherwell do služby Azure AD musíte přidat do seznamu spravovaných aplikací SaaS Cherwell z galerie.

**Pokud chcete přidat Cherwell z galerie, proveďte následující kroky:**
...
4. Do vyhledávacího pole zadejte **Cherwell**.

    ![Vytváření testovacího uživatele Azure AD](./media/active-directory-saas-cherwell-tutorial/tutorial_cherwell_search.png)

5. Na panelu výsledků vyberte **Cherwell**a potom klikněte na **přidat** tlačítko Přidat aplikaci.
...
Azure AD pro jednotné přihlašování pro práci, musí vědět, co uživatel protějškem v Cherwell je pro uživatele ve službě Azure AD. Jinými slovy odkaz vztah mezi uživatele Azure AD a související uživatelské v Cherwell musí navázat.

V Cherwell, přiřadit hodnotu **uživatelské jméno** ve službě Azure AD jako hodnotu **uživatelské jméno** k navázání vztahu odkazu.

Nakonfigurovat a otestovat Azure AD jednotné přihlašování s Cherwell, je třeba dokončit následující stavební bloky:

1. **[Konfigurace Azure AD jednotné přihlašování](#configuring-azure-ad-single-sign-on)**  – Pokud chcete povolit uživatelům tuto funkci používat.
2. **[Vytváření testovacího uživatele Azure AD](#creating-an-azure-ad-test-user)**  – Pokud chcete otestovat Azure AD jednotné přihlašování s Britta Simon.
3. **[Vytvoření zkušebního uživatele Cherwell](#creating-a-cherwell-test-user)**  – Pokud chcete mít protějšek Britta Simon v Cherwell propojeném s Azure AD reprezentace daného uživatele.
4. **[Přiřazení testovacího uživatele Azure AD](#assigning-the-azure-ad-test-user)**  – Pokud chcete povolit Britta Simon používat Azure AD jednotné přihlašování.
5. **[Testování jednotné přihlašování](#testing-single-sign-on)**  – Pokud chcete ověřit, zda je funkční konfigurace.

### <a name="configuring-azure-ad-single-sign-on"></a>Konfigurace Azure AD jednotné přihlašování

V této části můžete povolit Azure AD jednotného přihlašování na portálu Azure a nakonfigurovat jednotné přihlašování v aplikaci Cherwell.

**Ke konfiguraci Azure AD jednotné přihlašování s Cherwell, proveďte následující kroky:**

1. Na portálu Azure na **Cherwell** stránky integrace aplikací, klikněte na tlačítko **jednotného přihlašování**.
...
3. Na **Cherwell domény a adresy URL** část, proveďte následující kroky:

    ![Konfigurovat jednotné přihlašování](./media/active-directory-saas-cherwell-tutorial/tutorial_cherwell_url.png)

    V **přihlašovací adresa URL** textovému poli, zadejte adresu URL pomocí následujícího vzorce: `https://<companyname>.cherwellondemand.com/cherwellclient`

    > [!NOTE] 
    > Tato hodnota není skutečné. Aktualizujte tuto hodnotu s skutečná adresa URL přihlašování. Obraťte se na [tým podpory Cherwell](https://csm.cherwell.com/contact) získat tuto hodnotu.
...
6. Na **Cherwell konfigurace** klikněte na tlačítko **konfigurace Cherwell** otevřete **konfigurovat přihlášení** okno. Kopírování **SAML Entity ID a SAML jeden přihlašování adresa URL služby** z **Stručná referenční příručka části.**

    ![Konfigurovat jednotné přihlašování](./media/active-directory-saas-cherwell-tutorial/tutorial_cherwell_configure.png) 

7. Konfigurace jednotného přihlašování na **Cherwell** straně, budete muset odeslat stažené **certifikátu (Base64)**, **SAML jeden přihlašování adresa URL služby**, a **SAML Entity ID** k [tým podpory Cherwell](https://csm.cherwell.com/contact). 

    >[!NOTE]
    >Váš tým podpory Cherwell musí provést konfiguraci skutečné jednotné přihlašování. Zobrazí se oznámení, když bylo povoleno jednotné přihlašování pro vaše předplatné.
    > 
...
Pokud chcete povolit uživatelům Azure AD přihlášení k Cherwell, musí být zřízená do Cherwell.

V případě Cherwell, uživatelské účty musí být vytvořený vaše [tým podpory Cherwell](https://csm.cherwell.com/contact).

>[!NOTE]
>Můžete použít všechny ostatní Cherwell uživatele účtu nástroje pro tvorbu nebo rozhraní API poskytované Cherwell zřídit služby Azure Active Directory uživatelské účty.

### <a name="assigning-the-azure-ad-test-user"></a>Přiřazení testovacího uživatele Azure AD

V této části povolíte Britta Simon používat Azure jednotné přihlašování pomocí udělení přístupu Cherwell.

![Přiřadit uživatele][200] 

**Pokud chcete přiřadit Britta Simon Cherwell, proveďte následující kroky:**

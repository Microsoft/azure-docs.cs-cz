...
- `serviceBusNamespaceFQDN`: Nastavte na úplný název DNS váš nově vytvořený obor názvů služby Service Bus; například `example.servicebus.windows.net`.

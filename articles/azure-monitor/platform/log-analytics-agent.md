...
| Hybridní počítač s Linuxem| [Ruční instalace](../../log-analytics/log-analytics-quick-collect-linux-computer.md)|Instalace agenta pro Linux volání skript obálky hostovaná na Githubu. | 
| System Center Operations Manager|[Integrace Operations Manageru s Log Analytics](../../log-analytics/log-analytics-om-agents.md) | Konfigurace integrace mezi Operations Managerem a Log Analytics, aby předával data shromážděná z počítačů se systémy Linux a Windows odesílajících sestavy do skupiny pro správu.|  

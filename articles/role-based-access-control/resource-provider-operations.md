...
ms.locfileid: "77561999"
---
# <a name="azure-resource-manager-resource-provider-operations"></a>Azure Resource Manager operace poskytovatele prostředků

V tomto článku jsou uvedené dostupné operace pro všechny poskytovatele prostředků Azure Resource Manageru. Tyto operace se dají použít ve [vlastních rolích](custom-roles.md) k zajištění podrobného [řízení přístupu na základě role (RBAC)](overview.md) k prostředkům v Azure. Řetězce operací mají následující formát: `{Company}.{ProviderName}/{resourceType}/{action}`. Seznam způsobů mapování oborů názvů poskytovatelů prostředků na služby Azure najdete v tématu [přiřazení poskytovatele prostředků ke službě](../azure-resource-manager/management/azure-services-resource-providers.md).
...
> | Akce | Microsoft. ApiManagement/Service/portalsettings/listSecrets/Action | Získá ověřovací klíč nastavení delegování portálu. |
> | Akce | Microsoft. ApiManagement/Service/portalsettings/Read | Vypíše kolekci nastavení portálu. Můžete také získat nastavení pro přihlášení k portálu nebo získat nastavení pro registraci portálu nebo získat nastavení delegování pro portál. |
...
> | Akce | Microsoft. ApiManagement/Service/Subscriptions/Read | Zobrazí seznam všech předplatných instance služby API Management. nebo získá zadanou entitu předplatného (bez klíčů). |
...
> | Akce | Microsoft. ApiManagement/Service/tenant/listSecrets/Action | Získat podrobnosti o přístupu tenanta |
...
> | Akce | Microsoft.ApiManagement/service/write | Vytvořit nebo aktualizovat instanci služby API Management |
...
> | Typ akce | Operace | Popis |
> | --- | --- | --- |
> | Akce | Microsoft. AppConfiguration/checkNameAvailability/Read | Ověřte, zda je název prostředku k dispozici pro použití. |
> | Akce | Microsoft. AppConfiguration/configurationStores/DELETE | Odstraní úložiště konfigurace. |
> | Akce | Microsoft. AppConfiguration/configurationStores/eventGridFilters/DELETE | Odstraní filtr Event gridu úložiště konfigurace. |
> | Akce | Microsoft. AppConfiguration/configurationStores/eventGridFilters/Read | Získá vlastnosti zadaného filtru pro událost úložiště konfigurace nebo zobrazí seznam všech filtrů Event gridu v úložišti konfigurace v zadaném úložišti konfigurace. |
> | Akce | Microsoft. AppConfiguration/configurationStores/eventGridFilters/Write | Vytvoří nebo aktualizuje filtr Event gridu v úložišti konfigurace se zadanými parametry. |
> | Akce dataaction | Microsoft. AppConfiguration/configurationStores/hodnoty a/DELETE | Odstraní existující klíč-hodnota z úložiště konfigurace. |
> | Akce dataaction | Microsoft. AppConfiguration/configurationStores/hodnoty/čtení | Přečte klíčovou hodnotu z úložiště konfigurace. |
> | Akce dataaction | Microsoft. AppConfiguration/configurationStores/hodnoty/zápis | Vytvoří nebo aktualizuje klíčovou hodnotu v úložišti konfigurace. |
> | Akce | Microsoft. AppConfiguration/configurationStores/klíče listkey/Action | Zobrazí seznam klíčů rozhraní API pro zadané úložiště konfigurace. |
> | Akce | Microsoft. AppConfiguration/configurationStores/ListKeyValue/Action | Vypíše klíčovou hodnotu pro zadané úložiště konfigurace. |
> | Akce | Microsoft. AppConfiguration/configurationStores/privateEndpointConnectionProxies/DELETE | Odstraní proxy server připojení privátního koncového bodu v zadaném úložišti konfigurace. |
> | Akce | Microsoft. AppConfiguration/configurationStores/privateEndpointConnectionProxies/Read | V rámci zadaného úložiště konfigurace Získejte proxy připojení privátního koncového bodu. |
> | Akce | Microsoft. AppConfiguration/configurationStores/privateEndpointConnectionProxies/ověřit/akce | Ověří proxy server připojení privátního koncového bodu v zadaném úložišti konfigurace. |
> | Akce | Microsoft. AppConfiguration/configurationStores/privateEndpointConnectionProxies/Write | Vytvoří nebo aktualizuje proxy připojení privátního koncového bodu v zadaném úložišti konfigurace. |
> | Akce | Microsoft. AppConfiguration/configurationStores/privateEndpointConnections/DELETE | Odstraní připojení privátního koncového bodu v rámci zadaného úložiště konfigurace. |
> | Akce | Microsoft. AppConfiguration/configurationStores/privateEndpointConnections/Read | Získejte připojení privátního koncového bodu nebo seznam připojení privátních koncových bodů v zadaném úložišti konfigurace. |
> | Akce | Microsoft. AppConfiguration/configurationStores/privateEndpointConnections/Write | Umožňuje schválit nebo odmítnout připojení privátního koncového bodu v zadaném úložišti konfigurace. |
> | Akce | Microsoft. AppConfiguration/configurationStores/PrivateEndpointConnectionsApproval/Action | Automaticky schválí připojení privátního koncového bodu v rámci zadaného úložiště konfigurace. |
> | Akce | Microsoft. AppConfiguration/configurationStores/privateLinkResources/Read | Zobrazí seznam všech prostředků privátního propojení v rámci zadaného úložiště konfigurace. |
> | Akce | Microsoft. AppConfiguration/configurationStores/Providers/Microsoft. Insights/diagnosticSettings/Read | Načte všechny hodnoty nastavení diagnostiky pro úložiště konfigurace. |
> | Akce | Microsoft. AppConfiguration/configurationStores/Providers/Microsoft. Insights/diagnosticSettings/Write | Zápis/přepsání nastavení diagnostiky pro konfiguraci aplikace od Microsoftu |
> | Akce | Microsoft. AppConfiguration/configurationStores/Providers/Microsoft. Insights/metricDefinitions/Read | Načte všechny definice metriky pro konfiguraci aplikací Microsoft. |
> | Akce | Microsoft. AppConfiguration/configurationStores/Read | Získá vlastnosti zadaného úložiště konfigurace nebo zobrazí seznam všech úložišť konfigurací v rámci zadané skupiny prostředků nebo předplatného. |
> | Akce | Microsoft. AppConfiguration/configurationStores/RegenerateKey/Action | Znovu vygeneruje klíč rozhraní API pro zadané úložiště konfigurace. |
> | Akce | Microsoft. AppConfiguration/configurationStores/syncTasks/DELETE | Odstraní úlohu synchronizace úložiště konfigurace. |
> | Akce | Microsoft. AppConfiguration/configurationStores/syncTasks/Read | Získá vlastnosti zadané úlohy synchronizace úložiště konfigurace nebo vypíše všechny úlohy synchronizace úložiště konfigurace v rámci zadaného úložiště konfigurace. |
> | Akce | Microsoft. AppConfiguration/configurationStores/syncTasks/Write | Vytvoří nebo aktualizuje úlohu synchronizace úložiště konfigurace se zadanými parametry. |
> | Akce | Microsoft. AppConfiguration/configurationStores/Write | Vytvoří nebo aktualizuje úložiště konfigurace se zadanými parametry. |
> | Akce | Microsoft. AppConfiguration/Locations/operationsStatus/Read | Získá stav operace. |
> | Akce | Microsoft. AppConfiguration/Operations/Read | Zobrazí seznam všech operací, které aplikace Microsoft App Configuration podporuje. |
> | Akce | Microsoft. AppConfiguration/Register/Action | Zaregistruje předplatné pro použití konfigurace aplikace Microsoft. |
...
> | Typ akce | Operace | Popis |
> | --- | --- | --- |
> | Akce | Microsoft. BingMaps/listCommunicationPreference/Action | Získá předvolby komunikace pro vlastníka Microsoft. BingMaps. |
> | Akce | Microsoft.BingMaps/mapApis/Delete | Odstraní prostředek pro Microsoft. BingMaps/mapApis. |
> | Akce | Microsoft. BingMaps/mapApis/listSecrets/Action | Výpis tajných kódů pro Microsoft. BingMaps/mapApis |
> | Akce | Microsoft. BingMaps/mapApis/listUsageMetrics/Action | Vypíše metriky pro Microsoft. BingMaps/mapApis. |
> | Akce | Microsoft. BingMaps/mapApis/Read | Získá prostředek pro Microsoft. BingMaps/mapApis. |
> | Akce | Microsoft.BingMaps/mapApis/regenerateKey/action | Znovu vygenerovat klíč (y) pro Microsoft. BingMaps/mapApis |
> | Akce | Microsoft. BingMaps/mapApis/Write | Aktualizuje prostředek pro Microsoft. BingMaps/mapApis. |
> | Akce | Microsoft. BingMaps/Operations/Read | Výpis operací pro Microsoft. BingMaps |
> | Akce | Microsoft. BingMaps/updateCommunicationPreference/Action | Aktualizuje předvolby komunikace pro vlastníka Microsoft. BingMaps. |
...
> | Typ akce | Operace | Popis |
> | --- | --- | --- |
> | Akce | Microsoft. BotService/botServices/Channels/DELETE | Odstranění kanálu služby bot |
> | Akce | Microsoft. BotService/botServices/Channels/listchannelwithkeys/Action | Výpis kanálů Botservice s tajnými kódy |
> | Akce | Microsoft. BotService/botServices/Channels/Read | Čtení kanálu služby bot Service |
> | Akce | Microsoft. BotService/botServices/Channels/Write | Zápis kanálu služby bot |
> | Akce | Microsoft. BotService/botServices/Connections/DELETE | Odstranění připojení služby bot |
> | Akce | Microsoft. BotService/botServices/Connections/listwithsecrets/Write | Zápis seznamu připojení služby bot  |
> | Akce | Microsoft. BotService/botServices/Connections/Read | Čtení připojení služby bot |
> | Akce | Microsoft. BotService/botServices/Connections/Write | Napsání připojení služby bot |
...
> | Akce | Microsoft. BotService/checknameavailability/Action | Ověřit dostupnost názvu robota |
> | Akce | Microsoft. BotService/listauthserviceproviders/Action | Vypsat poskytovatele ověřovacích služeb |
...
> | Akce | Microsoft. Capacity/reservationorders/mergeoperationresults/Read | Cyklické dotazování na operaci sloučení |
...
> | Akce | Microsoft. Capacity/reservationorders/splitoperationresults/Read | Cyklické dotazování na všechny operace rozdělení |
...
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/ContentModerator/processtext/Screen/Action | Tato operace detekuje vulgární výrazy ve více než 100 jazycích a odpovídá na vlastní a sdílené zakázané. |
...
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/ContentModerator/Teams/Reviews/frames/Write | Tuto metodu použijte, chcete-li přidat snímky pro kontrolu videa. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/ContentModerator/Teams/Reviews/Publish/Action | Recenze videí se zpočátku vytvoří v nepublikovaném stavu, což znamená, že je ještě není k dispozici pro kontrolory, aby je bylo možné zkontrolovat. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/ContentModerator/Teams/Reviews/Read | Vrátí podrobnosti revize předaného ID revize. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/ContentModerator/Teams/Reviews/přepis/Action | Toto rozhraní API přidá do recenze videa soubor přepisu (textová verze všech slov mluvenéch ve videu). Soubor by měl být platný formát WebVTT. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/ContentModerator/Teams/Reviews/Reviews/Action/Action | Toto rozhraní API přidá soubor výsledku textu obrazovky přepisu pro kontrolu videa. Textový soubor s výsledky textu obrazovky přepisu je výsledkem rozhraní API pro text obrazovky. Aby bylo možné vygenerovat soubor s výsledky textu obrazovky s přepisem, musí být soubor přepisu na základě vulgárních výrazů použit rozhraním API pro text obrazovky. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/ContentModerator/Teams/Settings/Templates/DELETE | Odstranění šablony v týmu |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/ContentModerator/Teams/Settings/Templates/Read | Vrátí pole revidovaných šablon zřízených v tomto týmu. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/ContentModerator/Teams/Settings/Templates/Write | Vytvoří nebo aktualizuje zadanou šablonu. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/ContentModerator/Teams/Workflows/Read | Získejte podrobnosti o konkrétním pracovním postupu v týmu. Získejte všechny pracovní postupy, které jsou k dispozici v týmu * |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/ContentModerator/Teams/Workflows/Write | Vytvořte nový pracovní postup nebo aktualizujte stávající. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/ContentModerator/termlists/Action | Vytvořit seznam termínů. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/ContentModerator/termlists/bulkupdate/Action | Seznamy termínů – Hromadná aktualizace |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/ContentModerator/termlists/DELETE | Seznamy termínů – odstranění |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/ContentModerator/termlists/Read | Seznamy termínů – získat všechny termíny – získat podrobnosti |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/ContentModerator/termlists/refreshindex/Action | Seznam termínů – aktualizovat index hledání |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/ContentModerator/termlists/terms/DELETE | Podmínky odstranění termínu – odstranění všech podmínek |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/ContentModerator/termlists/terms/Read | Podmínka – získá všechny podmínky. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/ContentModerator/termlists/terms/Write | Termín přidat termín |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/ContentModerator/termlists/Write | Seznamy termínů – podrobnosti o aktualizaci |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpověď/klasifikovat/iterace/image/Action | Klasifikace obrázku a uložení výsledku. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpověď/klasifikovat/iterace/-image/Neukládat/akce | Klasifikace obrázku bez uložení výsledku. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpověď/klasifikovat/iterace/URL/Action | Klasifikace adresy URL obrázku a uložení výsledku. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. Předpověde/klasifikovat/iterace////neuložený/Action | Klasifikujte adresu URL obrázku bez uložení výsledku. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpověď/Detect/iterace/image/Action | Detekuje objekty v imagi a ukládá výsledek. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpovědi/detekce/iterace/image/uložení/akce | Detekuje objekty v imagi bez uložení výsledku. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpověď/Detect/iterace/URL/Action | Zjišťuje objekty v adrese URL obrázku a ukládá výsledek. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpovědi/detekce/iterace/adresa URL/úložiště/akce | Detekovat objekty v adrese URL obrázku bez uložení výsledku. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpovědi/domény/čtení | Získejte informace o konkrétní doméně. Získá seznam dostupných domén. * |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpověď/labelproposals/Setting/Action | Nastavte velikost fondu návrhu popisku. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpověď/labelproposals/Setting/Read | Získá velikost fondu návrhu popisku pro tento projekt. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpovědi/projekt/migrace/akce | *NotDefined* |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpovědi/projekty/akce | Vytvoření projektu. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpověď/projekty/odstranit | Odstraní konkrétní projekt. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. Předpověde/projekty, obrázky/akce | Toto rozhraní API akceptuje obsah textu jako multipart/form-data a Application/oktet-Stream. Při použití částí multipart |
...
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpovědi/projekty, obrázky/soubory/akce | Toto rozhraní API akceptuje dávku souborů a volitelně vytvoří tagy pro vytváření imagí. Je povolený limit 64 imagí a 20 značek. |
...
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpověď/Projects/reimages/předpovědi/Action | Toto rozhraní API vytvoří dávku imagí z určených předpokládaných imagí. Je povolený limit 64 imagí a 20 značek. |
...
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpověď/Projects/images/navrhovaný/Count/Action | Toto rozhraní API používá identifikátory značek pro získání počtu netagovaných obrázků na navrhovaných značkách pro danou prahovou hodnotu. |
...
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. Předpověde/projekty, images/URL/Action | Toto rozhraní API akceptuje dávku adres URL a volitelně vytvoří tagy pro vytváření imagí. Je povolený limit 64 imagí a 20 značek. |
...
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpověď/projekty/Quicktest/image/Action | Rychlé testování obrázku |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpověď/projekty/Quicktest/URL/Action | Rychlá zkouška adresy URL obrázku |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpovědi/projekty/číst | Získat konkrétní projekt. Získejte své projekty. * |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpovědi/projekty, značky/akce | Vytvořte značku pro projekt. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpověď/Projects/Tags/DELETE | Odstraní značku z projektu. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpověď/Projects/Tags/Read | Získat informace o konkrétní značce. Získá značky pro daný projekt a iteraci. * |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpověď/Projects/Tags/Write | Aktualizujte značku. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpověď/projekty/tagsandregions/návrhy/akce | Toto rozhraní API získá navrhované značky a oblasti pro pole nebo dávku netagovaných obrázků spolu s jistotami pro značky. Vrátí prázdné pole, pokud nejsou nalezeny žádné značky. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpověď/projekty/školení/akce | Projekt zařadí do fronty za účelem školení. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpověď/Projects/Write | Aktualizace konkrétního projektu. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. Předpověde/kvóta/akce | *NotDefined* |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpověď/kvóta/odstranění | *NotDefined* |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpovědi/kvóta/aktualizace/zápis | *NotDefined* |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpověď/využití/předpověď/uživatel/čtení | Získat využití pro předpověď prostředků pro uživatele Oxford |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpověď/využití/školení/prostředek/úroveň/čtení | Získat využití pro školení prostředku pro uživatele Azure |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpověď/využití/školení/uživatel/číst | Získat využití pro školení prostředků pro uživatele Oxford |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpovědi/uživatel/akce | *NotDefined* |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpověď/User/DELETE | *NotDefined* |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpověď/User/State/Write | Aktualizovat stav uživatele |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpovědi/uživatel/vrstva/zápis | *NotDefined* |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpovědi/uživatelé/číst | *NotDefined* |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpověď/seznam povolených/odstraňování | Odstraní povoleného uživatele se specifickou funkcí. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpověď/seznam povolených/přečtených | Načte seznam povolených uživatelů s určitou možností. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/CustomVision. předpověď/seznam povolených/zápisů | Aktualizuje nebo vytvoří uživatele v seznamu povolených položek s konkrétní možností. |
...
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Face/Snapshot/použít/Action | Použití snímku a zadání ID uživatelem zadaného objektu. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Face/Snapshot/DELETE | Odstraní snímek. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Face/Snapshot/Read | Získá stav operace snímku. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Face/Snapshot/vzít/Action | Pořídit snímek objektu. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Face/Snapshot/Write | Aktualizuje vlastnosti snímku. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/účty/Face/snímky/číst | Vypíše všechny dostupné snímky uživatele s informacemi. * |
...
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Qnamakerem/Alters/Read | Stažení změn z modulu runtime. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Qnamakerem/Alters/Write | Nahraďte data změn. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Qnamakerem/endpointkeys/Read | Získá klíče koncového bodu pro koncový bod. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Qnamakerem/endpointkeys/refreshkeys/Action | Znovu vygeneruje klíč koncového bodu. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Qnamakerem/endpointsettings/Read | Získá nastavení koncového bodu pro koncový bod. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Qnamakerem/endpointsettings/Write | Aktualizujte koncový bod seettings pro koncový bod. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Qnamakerem/knowledgebases/Create/Write | Asynchronní operace pro vytvoření nové znalostní báze |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Qnamakerem/knowledgebases/DELETE | Odstraní znalostní báze a veškerá jeho data. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Qnamakerem/knowledgebases/Download/Read | Stáhněte si znalostní báze. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Qnamakerem/knowledgebases/generateanswer/Action | GenerateAnswer volání pro dotaz na znalostní báze. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Qnamakerem/knowledgebases/Publish/Action | Publikuje všechny změny v indexu testu znalostní báze s jeho výrobním indexem. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Qnamakerem/knowledgebases/Read | Získá seznam Knowledgebases nebo podrobností konkrétního knowledgebaser. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Qnamakerem/knowledgebases/vlak/Action | Zavolejte na vlak a přidejte návrhy do znalostní báze. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Qnamakerem/knowledgebases/Write | Asynchronní operace pro úpravu znalostní báze nebo nahrazení obsahu v rámci znalostní báze |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Qnamakerem/Operations/Read | Získá podrobnosti o konkrétní dlouhodobé operaci s dlouhou dobou provozu. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Qnamakerem/root/Action | QnA Maker |
...
> | Akce dataaction | Microsoft.CognitiveServices/accounts/TextAnalytics/keyphrases/action | Rozhraní API vrátí seznam řetězců, ve kterých se ve vstupním textu zaznamená klíčové body. |
...
> | Akce dataaction | Microsoft.CognitiveServices/accounts/TextAnalytics/sentiment/action | Rozhraní API vrací číselné skóre mezi 0 a 1.<br>Skóre blížící se 1 značí pozitivní mínění a skóre blížící se 0 značí negativní mínění.<br>Skóre 0,5 označuje nedostatek mínění (např.<br>příkaz factoid). |
...
> | Akce | Microsoft. COMPUTE/virtualMachines/assessPatches/Action | Vyhodnotí virtuální počítač a vyhledá seznam dostupných oprav aktualizací operačního systému pro něj. |
> | Akce | Microsoft. COMPUTE/virtualMachines/cancelPatchInstallation/Action | Zruší probíhající operaci opravy aktualizace operačního systému pro instalaci na virtuálním počítači. |
...
> | Akce | Microsoft. COMPUTE/virtualMachines/installPatches/Action | Nainstaluje na virtuální počítač dostupné opravy aktualizací operačního systému na základě parametrů poskytnutých uživatelem. Výsledky posouzení obsahující seznam dostupných oprav se taky v rámci této části aktualizují. |
...
> | Akce | Microsoft. COMPUTE/virtualMachineScaleSets/Extensions/role/číst | Získá vlastnosti role v sadě škálování virtuálního počítače s rozšířením služby Virtual Machine runtime. |
> | Akce | Microsoft. COMPUTE/virtualMachineScaleSets/Extensions/role/Write | Aktualizuje vlastnosti existující role v sadě škálování virtuálního počítače s rozšířením služby virtuálního počítače za běhu. |
...
> | Akce | Microsoft. COMPUTE/virtualMachineScaleSets/rollingUpgrades/Action | Zruší postupný upgrade sady škálování virtuálních počítačů. |
...
> | Akce | Microsoft. ContainerRegistry/Registry/privateEndpointConnectionProxies/DELETE | Odstranit proxy připojení privátního koncového bodu (jenom NRP) |
> | Akce | Microsoft. ContainerRegistry/Registry/privateEndpointConnectionProxies/operationStatuses/Read | Získat stav operace Async proxy připojení privátního koncového bodu |
> | Akce | Microsoft. ContainerRegistry/Registry/privateEndpointConnectionProxies/Read | Získat proxy připojení privátního koncového bodu (jenom NRP) |
> | Akce | Microsoft. ContainerRegistry/Registry/privateEndpointConnectionProxies/ověřit/akce | Ověřit proxy připojení privátního koncového bodu (jenom NRP) |
> | Akce | Microsoft. ContainerRegistry/Registry/privateEndpointConnectionProxies/Write | Vytvoření proxy připojení privátního koncového bodu (jenom NRP) |
...
> | Akce | Microsoft. CostManagement/externalBillingAccounts/Dimensions/Read | Vypíše všechny podporované dimenze pro externí BillingAccounts. |
...
> | Akce | Microsoft. DataBoxEdge/dataBoxEdgeDevices/storageAccounts/Containers/DELETE | Odstraní kontejnery. |
> | Akce | Microsoft. DataBoxEdge/dataBoxEdgeDevices/storageAccounts/Containers/operationResults/Read | Zobrazí nebo získá výsledek operace. |
> | Akce | Microsoft. DataBoxEdge/dataBoxEdgeDevices/storageAccounts/Containers/Read | Vypíše nebo získá kontejnery. |
> | Akce | Microsoft. DataBoxEdge/dataBoxEdgeDevices/storageAccounts/Containers/Refresh/Action | Obnovte metadata kontejneru s daty z cloudu. |
> | Akce | Microsoft. DataBoxEdge/dataBoxEdgeDevices/storageAccounts/Containers/Write | Vytvoří nebo aktualizuje kontejnery. |
> | Akce | Microsoft. DataBoxEdge/dataBoxEdgeDevices/storageAccounts/DELETE | Odstraní účty úložiště. |
> | Akce | Microsoft. DataBoxEdge/dataBoxEdgeDevices/storageAccounts/operationResults/Read | Zobrazí nebo získá výsledek operace. |
> | Akce | Microsoft. DataBoxEdge/dataBoxEdgeDevices/storageAccounts/Read | Zobrazí nebo získá účty úložiště. |
> | Akce | Microsoft. DataBoxEdge/dataBoxEdgeDevices/storageAccounts/Write | Vytvoří nebo aktualizuje účty úložiště. |
...
> | Akce | Microsoft.DataBoxEdge/dataBoxEdgeDevices/write | Vytvoří nebo aktualizuje Data Box Edge zařízení. |
> | Akce | Microsoft. DataBoxEdge/SKU/číst | Zobrazí nebo získá SKU. |
...
> | Akce | Microsoft. datacihly/umístění/operationstatuses/čtení | Přečte stav operace pro daný prostředek. |
> | Akce | Microsoft. datacihly/operace/čtení | Získá seznam operací. |
...
> | Akce | Microsoft. datacihly/pracovní prostory/storageEncryption/DELETE | Zakáže šifrování spravovaného klíče zákazníka ve spravovaném účtu úložiště pracovního prostoru datacihly. |
> | Akce | Microsoft. datacihly/pracovní prostory/storageEncryption/Write | Povoluje šifrování spravovaného klíče zákazníka ve spravovaném účtu úložiště pracovního prostoru datacihly. |
...
> | Akce | Microsoft. DataFactory/Factory/querydataflowdebugsessions/Action | Dotazuje relaci ladění toku dat. |
...
> | Akce | Microsoft. DataFactory/Factory/querytriggers/Action | Spustí dotaz na triggery. |
> | Akce | Microsoft.DataFactory/factories/read | Přečte Data Factory. |
> | Akce | Microsoft. DataFactory/Factory/sandboxpipelineruns/Action | Provede dotaz na spuštění kanálu ladění. |
> | Akce | Microsoft. DataFactory/Factory/sandboxpipelineruns/Read | Získá informace o běhu ladění pro kanál. |
...
> | Akce | Microsoft. DataFactory/Factory/Triggers/geteventsubscriptionstatus/Action | Stav odběru události |
...
> | Akce | Microsoft. DataFactory/Factory/Triggers/subscribetoevents/Action | Přihlaste se k odběru událostí. |
> | Akce | Microsoft.DataFactory/factories/triggers/triggerruns/read | Přečte spuštění triggeru. |
> | Akce | Microsoft. DataFactory/Factory/Triggers/unsubscribefromevents/Action | Odhlášení odběru událostí |
...
> | Akce | Microsoft. datamigration/Services/getHybridDownloadLink/Action | Získá odkaz ke stažení balíčku pracovního procesu DMS z Blob Storage RP. |
...
> | Akce | Microsoft. Devices/iotHubs/securitySettings/operationResults/Read | Získat výsledek asynchronní operace PUT pro IoT Hub SecuritySettings |
> | Akce | Microsoft. Devices/iotHubs/securitySettings/Read | Získání nastavení Azure Security Center ve službě IoT Hub |
> | Akce | Microsoft. Devices/iotHubs/securitySettings/Write | Aktualizace nastavení Azure Security Center ve službě IoT Hub |
...
> | Akce | Microsoft. DevSpaces/Locations/checkContainerHostMapping/Read | Zkontroluje existující mapování kontroléru pro hostitele kontejneru. |
...
> | Akce | Microsoft. DevTestLab/Labs/artifactSources/artefakty/GenerateArmTemplate/Action | Vygeneruje šablonu Azure Resource Manager pro daný artefakt, nahraje požadované soubory na účet úložiště a ověří vygenerovaný artefakt. |
...
> | Akce | Microsoft. DevTestLab/Labs/virtualMachines/ClearArtifactResults/Action | Vymaže výsledky artefaktů virtuálního počítače. |
...
> | Akce | Microsoft. DocumentDB/databaseAccounts/cassandraKeyspaces/DELETE | Odstraní Cassandra prostor. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/cassandraKeyspaces/operationResults/Read | Stav čtení asynchronní operace. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/cassandraKeyspaces/Read | Přečtěte si Cassandra prostor nebo seznam všech Cassandraových prostorů. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/cassandraKeyspaces/Tables/DELETE | Odstraní tabulku Cassandra. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/cassandraKeyspaces/Tables/operationResults/číst | Stav čtení asynchronní operace. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/cassandraKeyspaces/Tables/Read | Přečtěte si tabulku Cassandra nebo seznam všech tabulek Cassandra. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/cassandraKeyspaces/Tables/throughputSettings/operationResults/číst | Stav čtení asynchronní operace. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/cassandraKeyspaces/Tables/throughputSettings/číst | Přečtěte si propustnost tabulky Cassandra. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/cassandraKeyspaces/Tables/throughputSettings/Write | Aktualizujte propustnost tabulky Cassandra. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/cassandraKeyspaces/Tables/Write | Vytvoří nebo aktualizuje tabulku Cassandra. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/cassandraKeyspaces/throughputSettings/operationResults/číst | Stav čtení asynchronní operace. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/cassandraKeyspaces/throughputSettings/Read | Přečtěte si propustnost Cassandraho místa na disku. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/cassandraKeyspaces/throughputSettings/Write | Aktualizace propustnosti Cassandraho místa na disku. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/cassandraKeyspaces/Write | Vytvořte Cassandra prostor. |
...
> | Akce | Microsoft. DocumentDB/databaseAccounts/gremlinDatabases/DELETE | Odstraní databázi Gremlin. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/gremlinDatabases/grafy/odstranit | Odstranění grafu Gremlin |
> | Akce | Microsoft. DocumentDB/databaseAccounts/gremlinDatabases/grafy/operationResults/číst | Stav čtení asynchronní operace. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/gremlinDatabases/grafy/číst | Přečtěte si graf Gremlin nebo seznam všech grafů Gremlin. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/gremlinDatabases/grafy/throughputSettings/operationResults/číst | Stav čtení asynchronní operace. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/gremlinDatabases/grafy/throughputSettings/číst | Přečtěte si propustnost grafu Gremlin. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/gremlinDatabases/grafy/throughputSettings/Write | Aktualizujte propustnost grafu Gremlin. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/gremlinDatabases/grafy/zapisovat | Vytvoří nebo aktualizuje graf Gremlin. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/gremlinDatabases/operationResults/Read | Stav čtení asynchronní operace. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/gremlinDatabases/Read | Přečtěte si databázi Gremlin nebo seznam všech databází Gremlin. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/gremlinDatabases/throughputSettings/operationResults/číst | Stav čtení asynchronní operace. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/gremlinDatabases/throughputSettings/Read | Přečtěte si propustnost databáze Gremlin. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/gremlinDatabases/throughputSettings/Write | Aktualizujte propustnost databáze Gremlin. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/gremlinDatabases/Write | Vytvořte databázi Gremlin. |
...
> | Akce | Microsoft. DocumentDB/databaseAccounts/mongodbDatabases/Collections/DELETE | Odstraní kolekci MongoDB. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/mongodbDatabases/Collections/operationResults/Read | Stav čtení asynchronní operace. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/mongodbDatabases/Collections/Read | Přečtěte si kolekci MongoDB nebo seznam všech kolekcí MongoDB. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/mongodbDatabases/Collections/throughputSettings/operationResults/Read | Stav čtení asynchronní operace. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/mongodbDatabases/Collections/throughputSettings/Read | Přečtěte si propustnost kolekce MongoDB. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/mongodbDatabases/Collections/throughputSettings/Write | Aktualizujte propustnost kolekce MongoDB. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/mongodbDatabases/Collections/Write | Vytvoří nebo aktualizuje kolekci MongoDB. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/mongodbDatabases/DELETE | Odstraní databázi MongoDB. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/mongodbDatabases/operationResults/Read | Stav čtení asynchronní operace. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/mongodbDatabases/Read | Přečtěte si databázi MongoDB nebo seznam všech databází MongoDB. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/mongodbDatabases/throughputSettings/operationResults/číst | Stav čtení asynchronní operace. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/mongodbDatabases/throughputSettings/Read | Přečtěte si propustnost databáze MongoDB. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/mongodbDatabases/throughputSettings/Write | Aktualizujte propustnost databáze MongoDB. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/mongodbDatabases/Write | Vytvořte databázi MongoDB. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/notebookWorkspaces/DELETE | Odstranění pracovního prostoru poznámkového bloku |
> | Akce | Microsoft. DocumentDB/databaseAccounts/notebookWorkspaces/listConnectionInfo/Action | Seznam informací o připojení pro pracovní prostor poznámkového bloku |
> | Akce | Microsoft. DocumentDB/databaseAccounts/notebookWorkspaces/operationResults/Read | Přečtěte si stav asynchronní operace v pracovních prostorech notebooků. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/notebookWorkspaces/Read | Přečíst pracovní prostor poznámkového bloku |
> | Akce | Microsoft. DocumentDB/databaseAccounts/notebookWorkspaces/Write | Vytvořit nebo aktualizovat pracovní prostor poznámkového bloku |
...
> | Akce | Microsoft. DocumentDB/databaseAccounts/sqlDatabases/Containers/DELETE | Odstraní kontejner SQL. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/sqlDatabases/Containers/operationResults/Read | Stav čtení asynchronní operace. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/sqlDatabases/Containers/Read | Přečtěte si kontejner SQL nebo seznam všech kontejnerů SQL. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/sqlDatabases/Containers/storedProcedures/DELETE | Odstraní uloženou proceduru SQL. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/sqlDatabases/Containers/storedProcedures/operationResults/Read | Stav čtení asynchronní operace. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/sqlDatabases/Containers/storedProcedures/Read | Přečtěte si uloženou proceduru SQL nebo seznam všech uložených procedur SQL. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/sqlDatabases/Containers/storedProcedures/Write | Vytvoří nebo aktualizuje uloženou proceduru SQL. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/sqlDatabases/Containers/throughputSettings/operationResults/Read | Stav čtení asynchronní operace. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/sqlDatabases/Containers/throughputSettings/Read | Čtení propustnosti kontejneru SQL. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/sqlDatabases/Containers/throughputSettings/Write | Aktualizace propustnosti kontejneru SQL. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/sqlDatabases/Containers/Triggers/DELETE | Odstraní Trigger SQL. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/sqlDatabases/Containers/Triggers/operationResults/Read | Stav čtení asynchronní operace. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/sqlDatabases/Containers/Triggers/Read | Přečte Trigger SQL nebo vypíše všechny aktivační události SQL. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/sqlDatabases/Containers/Triggers/Write | Vytvoří nebo aktualizuje Trigger SQL. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/sqlDatabases/Containers/userDefinedFunctions/DELETE | Odstraní uživatelsky definovanou funkci SQL. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/sqlDatabases/Containers/userDefinedFunctions/operationResults/Read | Stav čtení asynchronní operace. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/sqlDatabases/Containers/userDefinedFunctions/Read | Přečtěte si funkci definovanou uživatelem SQL nebo seznam všech funkcí definovaných uživatelem SQL. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/sqlDatabases/Containers/userDefinedFunctions/Write | Vytvoří nebo aktualizuje funkci definovanou uživatelem SQL. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/sqlDatabases/Containers/Write | Vytvoří nebo aktualizuje kontejner SQL. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/sqlDatabases/DELETE | Odstraní databázi SQL. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/sqlDatabases/operationResults/Read | Stav čtení asynchronní operace. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/sqlDatabases/Read | Přečtěte si databázi SQL nebo seznam všech databází SQL. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/sqlDatabases/throughputSettings/operationResults/číst | Stav čtení asynchronní operace. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/sqlDatabases/throughputSettings/Read | Přečtěte si propustnost databáze SQL. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/sqlDatabases/throughputSettings/Write | Aktualizujte propustnost databáze SQL. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/sqlDatabases/Write | Vytvoření databáze SQL. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/Tables/DELETE | Odstraní tabulku. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/Tables/operationResults/Read | Stav čtení asynchronní operace. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/Tables/Read | Přečtěte si tabulku nebo seznam všech tabulek. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/Tables/throughputSettings/operationResults/Read | Stav čtení asynchronní operace. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/Tables/throughputSettings/Read | Přečtěte si propustnost tabulky. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/Tables/throughputSettings/Write | Aktualizujte propustnost tabulky. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/Tables/Write | Vytvoří nebo aktualizuje tabulku. |
...
> | Typ akce | Operace | Popis |
> | --- | --- | --- |
> | Akce | Microsoft. HybridCompute/Locations/operationresults/Read | Přečte stav operace u poskytovatele prostředků Microsoft. HybridCompute. |
> | Akce | Microsoft. HybridCompute/počítače/odstranit | Odstraní počítače s obloukem Azure ARC. |
> | Akce | Microsoft. HybridCompute/počítače/rozšíření/odstranit | Odstraní rozšíření ARC Azure. |
> | Akce | Microsoft. HybridCompute/počítače/rozšíření/číst | Přečte jakákoli rozšíření ARC Azure. |
> | Akce | Microsoft. HybridCompute/počítače/rozšíření/Write | Nainstaluje nebo aktualizuje rozšíření ARC Azure. |
> | Akce | Microsoft. HybridCompute/počítače/číst | Čtení jakýchkoli počítačů s obloukem Azure ARC |
> | Akce | Microsoft. HybridCompute/počítače/znovu připojit/akce | Znovu připojí počítače ARC Azure. |
> | Akce | Microsoft. HybridCompute/počítače/Write | Zapisuje počítače s obloukem Azure ARC. |
> | Akce | Microsoft. HybridCompute/Operations/Read | Načte všechny operace pro Azure ARC pro servery. |
> | Akce | Microsoft. HybridCompute/Register/Action | Zaregistruje předplatné pro poskytovatele prostředků Microsoft. HybridCompute. |
> | Akce | Microsoft. HybridCompute/zrušit registraci/akce | Zruší registraci předplatného pro poskytovatele prostředků Microsoft. HybridCompute. |
...
> | Akce | Microsoft. Insights/Components/Providers/Microsoft. Insights/diagnosticSettings/Read | Přečíst nastavení diagnostiky prostředků |
> | Akce | Microsoft. Insights/Components/Providers/Microsoft. Insights/diagnosticSettings/Write | Vytvoří nebo aktualizuje nastavení diagnostiky prostředků. |
> | Akce | Microsoft. Insights/Components/Providers/Microsoft. Insights/logDefinitions/Read | Čtení definic protokolů |
...
> | Akce | Microsoft. Insights/myWorkbooks/Write | Vytvořit nebo aktualizovat privátní sešit |
> | Akce | Microsoft. Insights/Operations/Read | Operace čtení |
> | Akce | Microsoft. Insights/PrivateLinkScopes/DELETE | Odstranění oboru privátního odkazu |
> | Akce | Microsoft. Insights/PrivateLinkScopes/PrivateEndpointConnectionProxies/DELETE | Odstranění proxy serveru připojení privátního koncového bodu |
> | Akce | Microsoft. Insights/PrivateLinkScopes/PrivateEndpointConnectionProxies/Read | Čtení proxy privátního koncového bodu připojení |
> | Akce | Microsoft. Insights/PrivateLinkScopes/PrivateEndpointConnectionProxies/ověřit/akci | Ověření proxy připojení privátního koncového bodu |
> | Akce | Microsoft. Insights/PrivateLinkScopes/PrivateEndpointConnectionProxies/Write | Vytvořit nebo aktualizovat proxy připojení privátního koncového bodu |
> | Akce | Microsoft. Insights/PrivateLinkScopes/PrivateEndpointConnections/DELETE | Odstranění připojení privátního koncového bodu |
> | Akce | Microsoft. Insights/PrivateLinkScopes/PrivateEndpointConnections/Read | Čtení připojení privátního koncového bodu |
> | Akce | Microsoft. Insights/PrivateLinkScopes/PrivateEndpointConnections/Write | Vytvoří nebo aktualizuje připojení privátního koncového bodu. |
> | Akce | Microsoft. Insights/PrivateLinkScopes/PrivateLinkResources/Read | Čtení prostředku privátního odkazu |
> | Akce | Microsoft. Insights/PrivateLinkScopes/Read | Čtení oboru privátního odkazu |
> | Akce | Microsoft. Insights/PrivateLinkScopes/ScopedResources/DELETE | Odstranění prostředku s oborem privátního propojení |
> | Akce | Microsoft. Insights/PrivateLinkScopes/ScopedResources/Read | Čtení prostředku s oborem privátního odkazu |
> | Akce | Microsoft. Insights/PrivateLinkScopes/ScopedResources/Write | Vytvoří nebo aktualizuje prostředek s oborem privátního propojení. |
...
> | Akce dataaction | Trezory Microsoft. a trezory/certificatecas/DELETE | Odstranit Issuser certifikátu |
> | Akce dataaction | Trezory Microsoft. a trezory/certificatecas/Read | Přečíst Issuser certifikátu |
> | Akce dataaction | Trezory Microsoft. a trezory/certificatecas/Write | Zápis certifikátu Issuser |
> | Akce dataaction | Trezory Microsoft. a trezory/certificatecontacts/Write | Spravovat kontakt s certifikátem |
> | Akce dataaction | Trezor Microsoft. a trezory/certifikáty/zálohování/akce | Vytvořte záložní soubor certifikátu. Soubor se může použít k obnovení certifikátu v Key Vault stejného předplatného. Můžou platit omezení. |
> | Akce dataaction | Trezor Microsoft. a trezory/certifikáty/vytvořit/akce | Vytvoří nový certifikát. |
> | Akce dataaction | Trezor Microsoft. a trezory/certifikáty/odstranění | Odstraní certifikát. |
> | Akce dataaction | Trezory Microsoft. a trezory/certifikáty/import/akce | Importuje existující platný certifikát, který obsahuje privátní klíč, do Azure Key Vault. Certifikát, který se má importovat, může být buď ve formátu PFX, nebo v PEM. |
> | Akce dataaction | Trezory Microsoft. a trezory/certifikáty/vyprázdnění/akce | Vyprázdní certifikát, takže ho nebude možné obnovit. |
> | Akce dataaction | Trezor Microsoft. a trezory/certifikáty/čtení | Zobrazí seznam certifikátů v zadaném trezoru klíčů nebo získá informace o certifikátu. |
> | Akce dataaction | Trezor Microsoft. a trezory/certifikáty/obnovení/akce | Obnoví odstraněný certifikát. Tato operace provede změnu operace odstranění. Tato operace se dá použít v trezorech povolených pro obnovitelné odstranění a musí se vydat během intervalu uchování dat. |
> | Akce dataaction | Trezor Microsoft. a trezory/certifikáty/obnovení/akce | Obnoví zálohovaný certifikát a všechny jeho verze do trezoru. |
> | Akce dataaction | Trezor Microsoft. a trezory/certifikáty/aktualizace/akce | Aktualizuje zadané atributy přidružené k danému certifikátu. |
...
> | Akce dataaction | Trezor a klíče Microsoft. webkey/zálohování/akce | Vytvoří záložní soubor klíče. Soubor se může použít k obnovení klíče v Key Vault stejného předplatného. Můžou platit omezení. |
> | Akce dataaction | Trezor Microsoft. a trezory/klíče/vytvoření/akce | Vytvoří nový klíč. |
> | Akce dataaction | Trezor Microsoft. a trezory/klíče/dešifrování/akce | Dešifrování šifrovaného textu pomocí klíče |
> | Akce dataaction | Trezor Microsoft. a trezory/klíče/odstranění | Odstraní klíč. |
> | Akce dataaction | Trezor Microsoft. a trezory/klíče/šifrování/akce | Šifrujte prostý text klíčem. Všimněte si, že pokud je klíč asymetrické, tato operace může být provedena pomocí objektů zabezpečení s přístupem pro čtení. |
> | Akce dataaction | Microsoft. webkey trezor/trezory/klíče/import/akce | Importuje externě vytvořený klíč, uloží ho a vrátí parametry klíče a atributů klientovi. |
> | Akce dataaction | Microsoft. webkey trezor/trezory/klíče/vyprázdnění/akce | Vyprázdní klíč, čímž ho nebude možné obnovit. |
> | Akce dataaction | Trezor Microsoft. a trezory/klíče/čtení | Zobrazí seznam klíčů v zadaném trezoru nebo vlastnosti pro čtení a veřejný materiál klíče.<br>U asymetrických klíčů Tato operace zveřejňuje veřejný klíč a zahrnuje schopnost provádět algoritmy veřejných klíčů, jako je například šifrování a ověření podpisu.<br>Soukromé klíče a symetrické klíče nejsou nikdy zpřístupněny. |
> | Akce dataaction | Trezor Microsoft. a trezory/klíče/obnovení/akce | Obnoví odstraněný klíč. Tato operace provede změnu operace odstranění. Tato operace se dá použít v trezorech povolených pro obnovitelné odstranění a musí se vydat během intervalu uchování dat. |
> | Akce dataaction | Trezor Microsoft. a trezory/klíče/obnovení/akce | Obnoví zálohovaný klíč a všechny jeho verze do trezoru. |
> | Akce dataaction | Trezor, trezory a klíče/akce společnosti Microsoft. | Podepište hash klíčem. |
> | Akce dataaction | Trezor Microsoft. a trezory/klíče/rozbalení/akce | Rozbalení symetrického klíče pomocí Key Vaultho klíče |
> | Akce dataaction | Trezor Microsoft. a trezory/klíče/aktualizace/akce | Aktualizuje zadané atributy přidružené k danému klíči. |
> | Akce dataaction | Microsoft. webkey trezor/trezory/klíče/ověření/akce | Ověřte hodnotu hash. Všimněte si, že pokud je klíč asymetrické, tato operace může být provedena pomocí objektů zabezpečení s přístupem pro čtení. |
> | Akce dataaction | Trezor/trezory Microsoft. Keys/klíče/zabalení/akce | Zabalte symetrický klíč pomocí Key Vaultho klíče. Všimněte si, že pokud je klíč Key Vault asymetrický, tato operace se dá provést s přístupem pro čtení. |
> | Akce | Trezor Microsoft. a trezory/čtení | Zobrazení vlastností trezoru klíčů |
> | Akce dataaction | Trezor Microsoft. a trezory, tajné kódy/zálohování/akce | Vytvořte záložní soubor tajného kódu. Soubor se dá použít k obnovení tajného kódu v Key Vault stejného předplatného. Můžou platit omezení. |
> | Akce dataaction | Trezor Microsoft. a trezory/tajné klíče/odstranění | Odstraňte tajný klíč. |
> | Akce dataaction | Microsoft. a trezory/trezory/tajné klíče/akce | Získá hodnotu tajného kódu. |
> | Akce dataaction | Trezory Microsoft. a trezory/tajné klíče/akce | Odstraní tajný klíč, takže ho nebude možné obnovit. |
> | Akce | Trezor Microsoft. a trezory/tajné klíče/čtení | Umožňuje zobrazit vlastnosti tajného klíče, ale ne jeho hodnotu. |
> | Akce dataaction | Trezory Microsoft. a trezory/tajné klíče/readMetadata/Action | Vypíše nebo zobrazí vlastnosti tajného klíče, ale ne jeho hodnotu. |
> | Akce dataaction | Trezory Microsoft. a trezory/tajné klíče/obnovení/akce | Obnoví odstraněný tajný klíč. Tato operace provede změnu operace odstranění. Tato operace se dá použít v trezorech povolených pro obnovitelné odstranění a musí se vydat během intervalu uchování dat. |
> | Akce dataaction | Trezory Microsoft. a trezory/tajné klíče/obnovení/akce | Obnoví zálohovaný tajný klíč a všechny jeho verze do trezoru. |
> | Akce dataaction | Trezory Microsoft. a trezory/tajné klíče/setSecret/Action | Vytvořte nový tajný klíč. |
> | Akce dataaction | Trezor Microsoft. a trezory/tajné klíče/aktualizace/akce | Aktualizuje zadané atributy přidružené k danému tajnému kódu. |
...
> | Akce | Microsoft.Kusto/Clusters/AttachedDatabaseConfigurations/delete | Odstraní prostředek konfigurace připojené databáze. |
> | Akce | Microsoft.Kusto/Clusters/AttachedDatabaseConfigurations/read | Načte prostředek konfigurace připojené databáze. |
> | Akce | Microsoft.Kusto/Clusters/AttachedDatabaseConfigurations/write | Zapíše prostředek připojené konfigurace databáze. |
...
> | Akce | Microsoft.Kusto/Clusters/Databases/DataConnections/delete | Odstraní prostředek datových připojení. |
> | Akce | Microsoft.Kusto/Clusters/Databases/DataConnections/read | Přečte prostředek datových připojení. |
> | Akce | Microsoft.Kusto/Clusters/Databases/DataConnections/write | Zapíše prostředek datových připojení. |
...
> | Akce | Microsoft.Kusto/Clusters/Databases/EventHubConnections/read | Přečte prostředek připojení centra událostí. |
> | Akce | Microsoft. Kusto/clustery/databáze/EventHubConnections/Write | Zapíše prostředek připojení centra událostí. |
...
> | Akce | Microsoft. Kusto/clustery/databáze/PrincipalAssignments/DELETE | Odstraní prostředek přiřazení objektu zabezpečení databáze. |
> | Akce | Microsoft. Kusto/clustery/databáze/PrincipalAssignments/Read | Přečte prostředek přiřazení objektu zabezpečení databáze. |
> | Akce | Microsoft. Kusto/clustery/databáze/PrincipalAssignments/Write | Zapíše prostředek přiřazení objektu zabezpečení databáze. |
> | Akce | Microsoft.Kusto/Clusters/Databases/read | Přečte prostředek databáze. |
> | Akce | Microsoft. Kusto/clustery/databáze/RemovePrincipals/Action | Odebere objekty zabezpečení databáze. |
> | Akce | Microsoft.Kusto/Clusters/Databases/write | Zapíše prostředek databáze. |
> | Akce | Microsoft. Kusto/Clusters/dataconnections/DELETE | Odstraní prostředek připojení dat clusteru. |
> | Akce | Microsoft. Kusto/Clusters/dataconnections/Read | Přečte prostředek připojení dat clusteru. |
> | Akce | Microsoft. Kusto/Clusters/dataconnections/Write | Zapíše prostředek připojení dat clusteru. |
...
> | Akce | Microsoft. Kusto/Clusters/DiagnoseVirtualNetwork/Action | Diagnostikuje stav připojení k síti u externích prostředků, na kterých je služba závislá. |
> | Akce | Microsoft. Kusto/Clusters/ListFollowerDatabases/Action | Zobrazí seznam databází od následného. |
> | Akce | Microsoft. Kusto/Clusters/PrincipalAssignments/DELETE | Odstraní prostředek přiřazení objektu zabezpečení clusteru. |
> | Akce | Microsoft. Kusto/Clusters/PrincipalAssignments/Read | Přečte prostředek přiřazení objektů v clusteru. |
> | Akce | Microsoft. Kusto/Clusters/PrincipalAssignments/Write | Zapíše prostředek přiřazení objektu zabezpečení clusteru. |
> | Akce | Microsoft.Kusto/Clusters/read | Přečte prostředek clusteru. |
> | Akce | Microsoft. Kusto/Clusters/SKU/číst | Přečte prostředek SKU clusteru. |
...
> | Akce | Microsoft.Kusto/locations/operationresults/read | Načte provozní prostředky. |
> | Akce | Microsoft.Kusto/Operations/read | Načte provozní prostředky. |
...
> | Akce | Microsoft.Kusto/SKUs/read | Přečte prostředek SKU. |
...
> | Akce | Microsoft. LabServices/labAccounts/GetPricingAndAvailability/Action | Získejte ceny a dostupnost kombinací velikostí, geografických oblastí a operačních systémů pro účet testovacího prostředí. |
...
> | Akce | Microsoft. LabServices/labAccounts/GetRestrictionsAndUsage/Action | Získat základní omezení a využití pro toto předplatné |
...
> | Akce | Microsoft. LabServices/labAccounts/Labs/GetLabPricingAndAvailability/Action | Získejte ceny na jednotku testovacího prostředí pro toto testovací prostředí a dostupnost, která indikuje, jestli se může toto testovací prostředí škálovat. |
...
> | Akce | Microsoft. LabServices/uživatelé/UserSettings/Action | Aktualizuje a vrátí osobní nastavení uživatele. |
...
> | Akce | Microsoft. Logic/integrationAccounts/Groups/DELETE | Odstraní skupinu v účtu integrace. |
> | Akce | Microsoft. Logic/integrationAccounts/Groups/Read | Přečte skupinu v účtu integrace. |
> | Akce | Microsoft. Logic/integrationAccounts/Groups/Write | Vytvoří nebo aktualizuje skupinu v účtu integrace. |
...
> | Akce | Microsoft. Logic/integrationAccounts/rosettaNetProcessConfigurations/DELETE | Odstraní konfiguraci procesu RosettaNet v účtu integrace. |
> | Akce | Microsoft. Logic/integrationAccounts/rosettaNetProcessConfigurations/Read | Přečte konfiguraci procesu RosettaNet v účtu integrace. |
> | Akce | Microsoft. Logic/integrationAccounts/rosettaNetProcessConfigurations/Write | Vytvoří nebo aktualizuje konfiguraci procesu RosettaNet v účtu integrace. |
> | Akce | Microsoft. Logic/integrationAccounts/Schedules/DELETE | Odstraní plán v účtu integrace. |
> | Akce | Microsoft. Logic/integrationAccounts/Schedules/Read | Přečte plán v účtu integrace. |
> | Akce | Microsoft. Logic/integrationAccounts/Schedules/Write | Vytvoří nebo aktualizuje plán v účtu integrace. |
...
> | Akce | Microsoft. Logic/integrationAccounts/Sessions/Read | Přečte relaci v účtu integrace. |
...
> | Akce | Microsoft. Logic/integrationServiceEnvironments/availableManagedApis/Read | Přečte dostupná spravovaná rozhraní API pro prostředí integrační služby. |
...
> | Akce | Microsoft. Logic/integrationServiceEnvironments/Inspirujte/JOIN/Action | Připojí prostředí integrační služby spravované rozhraní API. |
> | Akce | Microsoft. Logic/integrationServiceEnvironments/Inspirujte/operationStatuses/Read | Přečte stav operací rozhraní API spravované služby Integration Service prostředí. |
...
> | Akce | Microsoft. Logic/integrationServiceEnvironments/Inspirujte/Write | Vytvoří nebo aktualizuje spravované rozhraní API prostředí integrační služby. |
...
> | Akce | Microsoft. Logic/Workflows/Detects/Read | Načte detektor pracovního postupu. |
...
> | Akce | Microsoft. MachineLearningServices/umístění/kvóty/číst | Získá aktuálně přiřazené kvóty pracovního prostoru založené na VMFamily. |
> | Akce | Microsoft. MachineLearningServices/Locations/updateQuotas/Action | Aktualizujte kvótu pro každou rodinu virtuálních počítačů v pracovním prostoru. |
...
> | Akce | Microsoft. MachineLearningServices/pracovní prostory/výpočty/restartovat/akce | Restartování COMPUTE prostředku v pracovním prostoru Machine Learning Services |
> | Akce | Microsoft. MachineLearningServices/pracovní prostory/výpočty/spustit/akce | Spustit COMPUTE prostředků v pracovním prostoru Machine Learning Services |
> | Akce | Microsoft. MachineLearningServices/pracovní prostory/výpočty/zastavit/akce | Zastavit výpočetní prostředky v pracovním prostoru Machine Learning Services |
...
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/datadriftdetectors/číst | Získá detektory posunu dat v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/datadriftdetectors/Write | Vytvoří nebo aktualizuje detektory posunu dat v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/datové sady/registrované/odstranit | Odstraní registrované datové sady v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/Workspaces/DataSets/registered/Preview/Read | Získá Náhled datové sady u registrovaných datových sad v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/datové sady/registrované/Profile/čtení | Získá profily datových sad pro registrované datové sady v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/datové sady/registrované/Profile/Write | Vytvoří nebo aktualizuje profily datových sad pro registrované datové sady v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/datové sady/registrované/přečtené | Získá registrované datové sady v Machine Learning Services pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/datové sady/registrace/schéma/čtení | Získá schéma datové sady pro registrované datové sady v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/datové sady/registrované/Write | Vytvoří nebo aktualizuje registrované datové sady v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/datové sady/zrušení registrace/odstranění | Odstraní neregistrovanou datovou sadu v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/Workspaces/DataSets/Neregistrováno/Preview/číst | Získá Náhled datové sady pro neregistrovanou datovou sadu v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/datové sady/zrušit registraci/profilovat/číst | Získá profily datové sady pro neregistrovanou datovou sadu v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/Workspaces/DataSets/zrušit registraci/profilovat/zapisovat | Vytvoří nebo aktualizuje profily datových sad pro neregistrovanou datovou sadu v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/datové sady/zrušit registraci/čtení | Získá neregistrovanou datovou sadu v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/datové sady/zrušení registrace/schématu/čtení | Získá schéma datové sady pro neregistrovanou datovou sadu v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/datové sady/registrace/zápis | Vytvoří nebo aktualizuje neregistrované datové sady v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/úložiště dat/odstranit | Odstraní úložiště dat v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/úložiště dat/číst | Získá úložiště dat v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/úložiště dat/zapisovat | Vytvoří nebo aktualizuje úložiště dat v Machine Learning Servicesch pracovních prostorech. |
> | Akce | Microsoft.MachineLearningServices/workspaces/delete | Odstraní pracovní prostory Machine Learning Services. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/koncové body/kanály/číst | Načte publikované kanály a koncové body kanálu v Machine Learning Services pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/koncové body/kanály/zapisovat | Vytvoří nebo aktualizuje publikované kanály a koncové body kanálu v Machine Learning Services pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/prostředí/sestavení/akce | Sestavení prostředí v pracovních prostorech Machine Learning Services |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/prostředí/číst | Získá prostředí v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/prostředí/readSecrets/Action | Načte prostředí s tajnými klíči v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/prostředí/zápis | Vytvoří nebo aktualizuje prostředí v Machine Learning Servicesch pracovních prostorech. |
> | Akce | Microsoft. MachineLearningServices/pracovní prostory/eventGridFilters/číst | Získat Event Grid filtr pro konkrétní pracovní prostor |
...
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/experimenty/běhy/čtení | Získá spuštění v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/experimenty/běhy/scriptRun/Submit/Action | Vytvoří nebo aktualizuje spuštění skriptu v Machine Learning Services pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/experimenty/běhy/Write | Vytvoří nebo aktualizuje spuštění v Machine Learning Servicesch pracovních prostorech. |
...
> | Akce | Microsoft. MachineLearningServices/pracovní prostory/funkce/číst | Získá všechny povolené funkce pro Machine Learning Services pracovní prostor. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/štítky/export/akce | Exportovat popisky projektů označování v Machine Learning Servicesch pracovních prostorech |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/popisky/štítky/číst | Získá popisky projektů označování v Machine Learning Servicesch prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/označování/štítky/odmítnout/akce | Odmítnout popisky projektů označování v Machine Learning Servicesch prostorech |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/popisky/štítky/zápisy | Vytvoří popisky projektů označování v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/štítky/projekty/odstranit | Odstraní projekt značení v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/štítky/projekty/číst | Získá projekt popisku v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/štítky/projekty/souhrn/čtení | Získá Souhrn projektu s popisem v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/štítky/projekty/psaní | Vytvoří nebo aktualizuje projekt značení v Machine Learning Servicesch pracovních prostorech. |
...
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/metadata/artefakty/odstranit | Odstraní artefakty v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/metadata/artefakty/číst | Získá artefakty v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/metadata/artefakty/zapisovat | Vytvoří nebo aktualizuje artefakty v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/metadata/tajné/odstranit | Odstraní tajné klíče v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/metadata/tajné/přečíst | Získá tajné klíče v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/metadata/tajemství/Write | Vytvoří nebo aktualizuje tajné klíče v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/metadata/snímky/odstranit | Odstraní snímky v Machine Learning Services pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/metadata/snímky/číst | Získá snímky v Machine Learning Services pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/metadata/snímky/zápis | Vytvoří nebo aktualizuje snímky v Machine Learning Services pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/modely/odstranit | Odstraní modely v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/modely/balíček/akce | Modely balíčků v pracovních prostorech Machine Learning Services |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/modely/číst | Získá modely v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/modely/zápis | Vytvoří nebo aktualizuje modely v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/moduly/číst | Získá moduly v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/moduly/zápis | Vytvoří nebo aktualizuje modul v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/pipelinedrafts/DELETE | Odstraní koncepty kanálu v Machine Learning Services pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/pipelinedrafts/číst | Získá koncepty kanálu v Machine Learning Services pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/pipelinedrafts/Write | Vytvoří nebo aktualizuje koncepty kanálu v Machine Learning Servicesch pracovních prostorech. |
> | Akce | Microsoft. MachineLearningServices/pracovní prostory/privateEndpointConnectionProxies/DELETE | Odstraní proxy připojení k prostředku privátního koncového bodu poskytovatele Microsoft. Network. |
> | Akce | Microsoft. MachineLearningServices/pracovní prostory/privateEndpointConnectionProxies/číst | Zobrazit stav proxy připojení k prostředku privátního koncového bodu poskytovatele Microsoft. Network |
> | Akce | Microsoft. MachineLearningServices/pracovní prostory/privateEndpointConnectionProxies/ověřit/akci | Ověření proxy připojení k prostředku privátního koncového bodu poskytovatele Microsoft. Network |
> | Akce | Microsoft. MachineLearningServices/pracovní prostory/privateEndpointConnectionProxies/Write | Změna stavu proxy serveru připojení na prostředek privátního koncového bodu poskytovatele Microsoft. Network |
> | Akce | Microsoft. MachineLearningServices/pracovní prostory/privateEndpointConnections/DELETE | Odstraní připojení k prostředku privátního koncového bodu poskytovatele Microsoft. Network. |
> | Akce | Microsoft. MachineLearningServices/pracovní prostory/privateEndpointConnections/číst | Zobrazení stavu připojení k prostředku privátního koncového bodu poskytovatele Microsoft. Network |
> | Akce | Microsoft. MachineLearningServices/pracovní prostory/privateEndpointConnections/Write | Změna stavu připojení k prostředku privátního koncového bodu poskytovatele Microsoft. Network |
> | Akce | Microsoft. MachineLearningServices/pracovní prostory/PrivateEndpointConnectionsApproval/Action | Schválení nebo zamítnutí připojení k prostředku privátního koncového bodu poskytovatele Microsoft. Network |
> | Akce | Microsoft. MachineLearningServices/pracovní prostory/privateLinkResources/číst | Získá dostupné prostředky privátního propojení pro zadanou instanci Machine Learning Servicesch pracovních prostorů. |
> | Akce | Microsoft.MachineLearningServices/workspaces/read | Získá Machine Learning Services pracovní prostor (y). |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/služby/ACI/DELETE | Odstraní služby ACI v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/služby/ACI/klíče listkey/Action | Seznam klíčů pro služby ACI Services v Machine Learning Servicesch pracovních prostorech |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/služby/ACI/Write | Vytvoří nebo aktualizuje ACI služby v pracovních prostorech Machine Learning Services. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/služby/AKS/DevTest/DELETE | Odstraní služby DevTest AKS v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/služby/AKS/DevTest/klíče listkey/Action | Seznam klíčů pro služby DevTest AKS v Machine Learning Servicesch pracovních prostorech |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/služby/AKS/DevTest/skore/Action | Hodnocení devtestch AKS služeb v Machine Learning Services pracovních prostorech |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/služby/AKS/DevTest/Write | Vytvoří nebo aktualizuje služby DevTest AKS v Machine Learning Servicesch pracovních prostorech. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/služby/AKS/prod/DELETE | Odstraní služby AKS v produkčním prostředí v Machine Learning Services. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/služby/AKS/prod/klíče listkey/Action | Zobrazí seznam klíčů pro AKS Services v pracovních prostorech v Machine Learning Services. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/služby/AKS/prod/skore/Action | Skóre prod AKS Services v Machine Learning Services pracovních prostorech |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/služby/AKS/prod/Write | Vytvoří nebo aktualizuje AKS služby v produkčním prostředí v Machine Learning Services. |
> | Akce dataaction | Microsoft. MachineLearningServices/pracovní prostory/služby/číst | Získá služby v pracovních prostorech Machine Learning Services. |
...
> | Akce | Microsoft. ManagedIdentity/Operations/Read | Zobrazí seznam operací dostupných v poskytovateli prostředků Microsoft. ManagedIdentity. |
...
> | Akce | Microsoft. Management/managementGroups/Descendants/číst | Získá všechny následníky (Skupiny pro správu, odběry) skupiny pro správu. |
> | Akce | Microsoft.Management/managementGroups/read | Vypíše skupiny pro správu ověřeného uživatele. |
> | Akce | Microsoft. Management/managementGroups/Settings/DELETE | Odstraní nastavení hierarchie skupiny pro správu. |
> | Akce | Microsoft. Management/managementGroups/nastavení/číst | Vypíše existující nastavení hierarchie skupiny pro správu. |
> | Akce | Microsoft. Management/managementGroups/nastavení/Write | Vytvoří nebo aktualizuje nastavení hierarchie skupiny pro správu. |
...
> | Akce | Microsoft. migruje/assessmentprojects/importcollectors/DELETE | Odstraní kolektor importu. |
> | Akce | Microsoft. migruje/assessmentprojects/importcollectors/Read | Získá vlastnosti kolektoru importu. |
> | Akce | Microsoft. migruje/assessmentprojects/importcollectors/Write | Vytvoří nový kolektor importu nebo aktualizuje existující kolektor importu. |
...
> | Akce | Microsoft. migruje/assessmentprojects/servercollectors/Read | Získá vlastnosti kolekce serverů. |
> | Akce | Microsoft. migruje/assessmentprojects/servercollectors/Write | Vytvoří nové kolektor serverů nebo aktualizuje existující kolektor serverů. |
...
> | Akce dataaction | Microsoft. MixedReality/RemoteRenderingAccounts/Convert/Action | Spustit převod assetu |
> | Akce dataaction | Microsoft. MixedReality/RemoteRenderingAccounts/Convert/DELETE | Zastavit převod assetu |
> | Akce dataaction | Microsoft. MixedReality/RemoteRenderingAccounts/Convert/Read | Získat vlastnosti převodu assetu |
> | Akce dataaction | Microsoft. MixedReality/RemoteRenderingAccounts/Diagnostic/Read | Připojit k inspektoru vzdáleného vykreslování |
> | Akce dataaction | Microsoft. MixedReality/RemoteRenderingAccounts/managesessions/Action | Spustit relace |
> | Akce dataaction | Microsoft. MixedReality/RemoteRenderingAccounts/managesessions/DELETE | Zastavit relace |
> | Akce dataaction | Microsoft. MixedReality/RemoteRenderingAccounts/managesessions/Read | Získat vlastnosti relace |
> | Akce | Microsoft. MixedReality/remoteRenderingAccounts/Providers/Microsoft. Insights/metricDefinitions/Read | Získá dostupné metriky pro Microsoft. MixedReality/remoteRenderingAccounts. |
> | Akce dataaction | Microsoft. MixedReality/RemoteRenderingAccounts/Render/Read | Připojení k relaci |
...
> | Akce | Microsoft. NetApp/netAppAccounts/accountBackups/DELETE | Odstraní prostředek zálohy účtu. |
> | Akce | Microsoft. NetApp/netAppAccounts/accountBackups/Read | Přečte prostředek zálohování účtu. |
> | Akce | Microsoft. NetApp/netAppAccounts/accountBackups/Write | Zapíše prostředek zálohy účtu. |
> | Akce | Microsoft. NetApp/netAppAccounts/backupPolicies/DELETE | Odstraní prostředek zásady zálohování. |
> | Akce | Microsoft. NetApp/netAppAccounts/backupPolicies/Read | Přečte prostředek zásad zálohování. |
> | Akce | Microsoft. NetApp/netAppAccounts/backupPolicies/Write | Zapíše prostředek zásady zálohování. |
...
> | Akce | Microsoft. NetApp/netAppAccounts/capacityPools/svazky/AuthorizeReplication/Action | Autorizovat replikaci zdrojového svazku |
> | Akce | Microsoft. NetApp/netAppAccounts/capacityPools/svazky/zálohy/odstranit | Odstraní prostředek zálohy. |
> | Akce | Microsoft. NetApp/netAppAccounts/capacityPools/– svazky/zálohy/čtení | Přečte prostředek zálohy. |
> | Akce | Microsoft. NetApp/netAppAccounts/capacityPools/– svazky/zálohy/zápis | Zapíše prostředek zálohy. |
> | Akce | Microsoft. NetApp/netAppAccounts/capacityPools/– svazky/přerušení/akce | Přerušení vztahů replikace svazků |
> | Akce | Microsoft.NetApp/netAppAccounts/capacityPools/volumes/delete | Odstraní prostředek svazku. |
> | Akce | Microsoft. NetApp/netAppAccounts/capacityPools/svazky/DeleteReplication/Action | Odstranit replikaci na cílovém svazku |
> | Akce | Microsoft.NetApp/netAppAccounts/capacityPools/volumes/read | Přečte prostředek svazku. |
> | Akce | Microsoft. NetApp/netAppAccounts/capacityPools/svazky/ReplicationStatus/Action | Přečte stavy replikace svazků. |
> | Akce | Microsoft. NetApp/netAppAccounts/capacityPools/svazky/ResyncReplication/Action | Znovu synchronizovat replikaci na cílovém svazku |
> | Akce | Microsoft. NetApp/netAppAccounts/capacityPools/Volumes/REVERT/Action | Vrátit svazek do konkrétního snímku |
...
> | Akce | Microsoft. NetApp/netAppAccounts/snapshotPolicies/DELETE | Odstraní prostředek zásad snímku. |
> | Akce | Microsoft. NetApp/netAppAccounts/snapshotPolicies/ListVolumes/Action | Vypíše svazky připojené k zásadě snímku. |
> | Akce | Microsoft. NetApp/netAppAccounts/snapshotPolicies/Read | Přečte prostředek zásad snímku. |
> | Akce | Microsoft. NetApp/netAppAccounts/snapshotPolicies/Write | Zapíše prostředek zásad snímku. |
> | Akce | Microsoft. NetApp/netAppAccounts/trezory/číst | Přečte prostředek trezoru. |
...
> | Akce | Microsoft. NetApp/Register/Action | Akce registrace předplatného |
...
> | Akce | Microsoft. Network/bastionHosts/createShareableLinks/Action | Vytvoří sdílené adresy URL pro virtuální počítače v rámci bastionu a vrátí adresy URL. |
> | Akce | Microsoft.Network/bastionHosts/delete | Odstraní hostitele bastionu. |
> | Akce | Microsoft. Network/bastionHosts/deleteShareableLinks/Action | Odstraní sdílené adresy URL pro zadané virtuální počítače v rámci bastionu. |
> | Akce | Microsoft. Network/bastionHosts/disconnectactivesessions/Action | Odpojení vzhledem k aktivním relacím v hostiteli bastionu |
> | Akce | Microsoft. Network/bastionHosts/getactivesessions/Action | Získat aktivní relace na hostiteli bastionu |
> | Akce | Microsoft. Network/bastionHosts/getShareableLinks/Action | Vrátí adresy URL ke sdílení pro zadané virtuální počítače v podsíti bastionu, které dodávají jejich adresy URL. |
...
> | Akce | Microsoft. Network/ipAllocations/DELETE | Odstraní IpAllocation |
> | Akce | Microsoft. Network/ipAllocations/Read | Získat IpAllocation |
> | Akce | Microsoft. Network/ipAllocations/Write | Vytvoří IpAllocation nebo aktualizuje existující IpAllocation. |
...
> | Akce | Microsoft. Network/ipGroups/updateReferences/Action | Aktualizovat odkazy v IpGroup |
> | Akce | Microsoft. Network/ipGroups/Validate/Action | Ověří IpGroup |
...
> | Akce | Microsoft. Network/umístění/batchNotifyPrivateEndpointsForResourceMove/Action | Upozorňuje na soukromý koncový bod v dávkách pro přesunutí prostředků. |
...
> | Akce | Microsoft. Network/networkInterfaces/UpdateParentNicAttachmentOnElasticNic/Action | Aktualizuje nadřazenou síťovou kartu přidruženou k elastickému síťovému adaptéru. |
...
> | Akce | Microsoft. Network/networkWatchers/flowLogs/DELETE | Odstraní protokol toku. |
> | Akce | Microsoft. Network/networkWatchers/flowLogs/Read | Získat podrobnosti o protokolu toku |
> | Akce | Microsoft. Network/networkWatchers/flowLogs/Write | Vytvoří protokol toku. |
...
> | Akce | Microsoft. Network/p2sVpnGateways/disconnectp2svpnconnections/Action | Odpojení připojení P2S VPN |
...
> | Akce | Microsoft. Network/privateDnsZones/JOIN/Action | Připojí se k zóně Privátní DNS. |
...
> | Akce | Microsoft. Network/privateEndpoints/privateDnsZoneConfigs/Write | Vloží konfiguraci zóny Privátní DNS. |
...
> | Akce | Microsoft. Network/virtualHubs/effectiveRoutes/Action | Získá platnou trasu konfigurovanou na virtuálním rozbočovači. |
...
> | Akce | Microsoft. Network/virtualnetworkgateways/disconnectvirtualnetworkgatewayvpnconnections/Action | Odpojení připojení VPN brány virtuální sítě |
...
> | Akce | Microsoft. OffAzure/HyperVSites/Summary/Read | Získá Souhrn webu Hyper-V. |
...
> | Akce | Microsoft. OffAzure/ImportSites/DELETE | Odstraní web pro import. |
> | Akce | Microsoft. OffAzure/ImportSites/exporturi/Action | Získá identifikátor URI SAS pro export souboru CSV počítačů. |
> | Akce | Microsoft. OffAzure/ImportSites/importuri/Action | Získá identifikátor URI SAS pro import souboru CSV počítačů. |
> | Akce | Microsoft. OffAzure/ImportSites/Jobs/Read | Získá vlastnosti úloh importu. |
> | Akce | Microsoft. OffAzure/ImportSites/Machines/DELETE | Odstraní počítač pro import. |
> | Akce | Microsoft. OffAzure/ImportSites/Machines/Read | Získá vlastnosti počítačů pro import. |
> | Akce | Microsoft. OffAzure/ImportSites/Read | Získá vlastnosti webu pro import. |
> | Akce | Microsoft. OffAzure/ImportSites/Write | Vytvoří nebo aktualizuje web pro import. |
...
> | Akce | Microsoft. OffAzure/ServerSites/DELETE | Odstraní serverovou lokalitu. |
...
> | Akce | Microsoft. OffAzure/ServerSites/Summary/Read | Získá souhrn webového serveru. |
...
> | Akce | Microsoft. OffAzure/VMwareSites/clientGroupMembers/Action | Zobrazí členy skupiny klientů pro vybranou skupinu klientů. |
> | Akce | Microsoft.OffAzure/VMwareSites/delete | Odstraní lokalitu VMware. |
> | Akce | Microsoft. OffAzure/VMwareSites/exportapplications/Action | Exportuje data aplikací a rolí VMware do XLS. |
> | Akce | Microsoft. OffAzure/VMwareSites/generateCoarseMap/Action | Vygeneruje hrubou mapu pro seznam počítačů. |
> | Akce | Microsoft. OffAzure/VMwareSites/generateDetailedMap/Action | Vygeneruje podrobnou mapu VMware s hrubou mapou. |
> | Akce | Microsoft. OffAzure/VMwareSites/GetApplications/Action | Získá seznam informací o aplikaci pro vybrané počítače. |
...
> | Akce | Microsoft. OffAzure/VMwareSites/počítače/aplikace/číst | Získá vlastnosti aplikací počítačů VMware. |
...
> | Akce | Microsoft. OffAzure/VMwareSites/serverGroupMembers/Action | Vypíše členy skupiny serverů pro vybranou skupinu serverů. |
> | Akce | Microsoft. OffAzure/VMwareSites/Summary/Read | Získá Souhrn webu VMware. |
> | Akce | Microsoft. OffAzure/VMwareSites/updateProperties/Action | Aktualizuje vlastnosti pro počítače v lokalitě. |
...
> | Typ akce | Operace | Popis |
> | --- | --- | --- |
> | Akce | Microsoft. operationalinsights/availableservicetiers/Read | Získejte dostupné úrovně služeb. |
...
> | Akce | Microsoft. operationalinsights/Locations/operationStatuses/Read | Získá Log Analytics stav asynchronní operace Azure. |
...
> | Akce | Microsoft. operationalinsights/pracovní prostory/DataExport/DELETE | Odstraní konkrétní export dat. |
> | Akce | Microsoft. operationalinsights/pracovní prostory/DataExport/číst | Načte konkrétní export dat. |
> | Akce | Microsoft. operationalinsights/pracovní prostory/exportovat/zapisovat | Vytvořte nebo aktualizujte export dat. |
...
> | Akce | Microsoft. operationalinsights/pracovní prostory/privateEndpointConnectionProxies/DELETE | Odstraní proxy server připojení privátního koncového bodu. |
> | Akce | Microsoft. operationalinsights/pracovní prostory/privateEndpointConnectionProxies/číst | Získat proxy připojení privátního koncového bodu |
> | Akce | Microsoft. operationalinsights/pracovní prostory/privateEndpointConnectionProxies/ověřit/akci | Ověří proxy server připojení privátního koncového bodu. |
> | Akce | Microsoft. operationalinsights/pracovní prostory/privateEndpointConnectionProxies/Write | Vložte proxy server pro připojení privátního koncového bodu. |
> | Akce | Microsoft. operationalinsights/pracovní prostory/privateEndpointConnections/DELETE | Odstraní proxy server připojení privátního koncového bodu. |
> | Akce | Microsoft. operationalinsights/pracovní prostory/privateEndpointConnections/číst | Získat proxy připojení privátního koncového bodu |
> | Akce | Microsoft. operationalinsights/pracovní prostory/privateEndpointConnections/Write | Vložte proxy server pro připojení privátního koncového bodu. |
> | Akce | Microsoft. operationalinsights/pracovní prostory/privateLinkResources/číst | Získá Log Analytics prostředky privátního propojení. |
...
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/AegDeliveryFailureLogs/číst | Čtení dat z tabulky AegDeliveryFailureLogs |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/AegPublishFailureLogs/číst | Čtení dat z tabulky AegPublishFailureLogs |
...
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/AppServiceAuditLogs/číst | Čtení dat z tabulky AppServiceAuditLogs |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/AppServiceConsoleLogs/číst | Čtení dat z tabulky AppServiceConsoleLogs |
...
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/availabilityResults/číst | Čtení dat z tabulky availabilityResults |
...
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/browserTimings/číst | Čtení dat z tabulky browserTimings |
...
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/customEvents/číst | Čtení dat z tabulky customEvents |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/customMetrics/číst | Čtení dat z tabulky customMetrics |
...
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/závislosti/čtení | Čtení dat z tabulky závislosti |
...
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/DHCPActivity/číst | Čtení dat z tabulky DHCPActivity |
...
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/FunctionAppLogs/číst | Čtení dat z tabulky FunctionAppLogs |
...
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/IntuneDeviceComplianceOrg/číst | Čtení dat z tabulky IntuneDeviceComplianceOrg |
> | Akce | Microsoft.OperationalInsights/workspaces/query/IntuneOperationalLogs/read | Čtení dat z tabulky IntuneOperationalLogs |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/IoTHubDistributedTracing/číst | Čtení dat z tabulky IoTHubDistributedTracing |
...
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/KubeMonAgentEvents/číst | Čtení dat z tabulky KubeMonAgentEvents |
...
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MicrosoftAzureBastionAuditLogs/číst | Čtení dat z tabulky MicrosoftAzureBastionAuditLogs |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MicrosoftDataShareReceivedSnapshotLog/číst | Čtení dat z tabulky MicrosoftDataShareReceivedSnapshotLog |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MicrosoftDataShareSentSnapshotLog/číst | Čtení dat z tabulky MicrosoftDataShareSentSnapshotLog |
...
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MicrosoftDynamicsTelemetryPerformanceLogs/číst | Čtení dat z tabulky MicrosoftDynamicsTelemetryPerformanceLogs |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MicrosoftDynamicsTelemetrySystemMetricsLogs/číst | Čtení dat z tabulky MicrosoftDynamicsTelemetrySystemMetricsLogs |
...
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/pageViews/číst | Čtení dat z tabulky pageViews |
> | Akce | Microsoft.OperationalInsights/workspaces/query/Perf/read | Čtení dat z tabulky perf |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/čítače výkonu/číst | Čtení dat z tabulky čítače výkonu |
...
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/požadavky/číst | Čtení dat z tabulky requests |
...
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/SignalRServiceDiagnosticLogs/číst | Čtení dat z tabulky SignalRServiceDiagnosticLogs |
...
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/StorageBlobLogs/číst | Čtení dat z tabulky StorageBlobLogs |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/StorageFileLogs/číst | Čtení dat z tabulky StorageFileLogs |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/StorageQueueLogs/číst | Čtení dat z tabulky StorageQueueLogs |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/StorageTableLogs/číst | Čtení dat z tabulky StorageTableLogs |
...
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/systemEvents/číst | Čtení dat z tabulky systemEvents |
...
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/trasování/čtení | Čtení dat z tabulky trasování |
...
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/VMComputer/číst | Čtení dat z tabulky VMComputer |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/VMConnection/číst | Čtení dat z tabulky VMConnection |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/VMProcess/číst | Čtení dat z tabulky VMProcess |
...
> | Akce | Microsoft. operationalinsights/pracovní prostory/scopedPrivateLinkProxies/DELETE | Odstraní proxy privátního odkazu v oboru. |
> | Akce | Microsoft. operationalinsights/pracovní prostory/scopedPrivateLinkProxies/číst | Získejte proxy privátního odkazu na obor. |
> | Akce | Microsoft. operationalinsights/pracovní prostory/scopedPrivateLinkProxies/Write | Umístit proxy privátního odkazu na obor |
...
> | Akce | Microsoft. recoveryservices/trezory/backupEncryptionConfigs/Read | Získá konfiguraci šifrování prostředků zálohování. |
> | Akce | Microsoft. recoveryservices/trezory/backupEncryptionConfigs/Write | Aktualizuje konfiguraci šifrování prostředků zálohy. |
...
> | Akce | microsoft.recoveryservices/Vaults/backupFabrics/protectionContainers/inquire/action | Dotazování na úlohy v rámci kontejneru |
> | Akce | microsoft.recoveryservices/Vaults/backupFabrics/protectionContainers/items/read | Získat všechny položky v kontejneru |
> | Akce | microsoft.recoveryservices/Vaults/backupFabrics/protectionContainers/operationResults/read | Načte výsledek operace provedené na kontejneru ochrany. |
...
> | Akce | microsoft.recoveryservices/Vaults/backupFabrics/protectionContainers/protectedItems/recoveryPoints/provisionInstantItemRecovery/action | Zřídit rychlé obnovení položky pro chráněnou položku |
...
> | Akce | microsoft.recoveryservices/Vaults/backupOperationResults/read | Vrátí výsledek operace zálohování pro Recovery Services trezor. |
> | Akce | Microsoft. recoveryservices/trezory/backupOperations/Read | Vrátí stav operace zálohování pro trezor Recovery Services. |
> | Akce | microsoft.recoveryservices/Vaults/backupPolicies/delete | Odstraní zásady ochrany. |
...
> | Akce | microsoft.recoveryservices/Vaults/backupProtectionContainers/read | Vrátí všechny kontejnery patřící k předplatnému. |
> | Akce | Microsoft. recoveryservices/trezory/backupProtectionIntents/Read | Vypsat všechny záložní záměry ochrany |
> | Akce | microsoft.recoveryservices/Vaults/backupSecurityPIN/action | Vrátí informace o bezpečnostním PIN kódu pro trezor Recovery Services. |
...
> | Akce | microsoft.recoveryservices/Vaults/backupUsageSummaries/read | Vrátí souhrny pro chráněné položky a chráněné servery pro Recovery Services. |
...
> | Akce | Microsoft. RecoveryServices/trezory/replicationFabrics/replicationProtectionContainers/replicationMigrationItems/Resync/Action | Znovu synchronizovat |
...
> | Akce | Microsoft. Relay/obory názvů/networkrulesets/Read | Získá prostředek NetworkRuleSet. |
> | Akce | Microsoft. Relay/obory názvů/networkrulesets/Write | Vytvořit prostředek pravidla virtuální sítě |
...
> | Akce | Microsoft. ResourceHealth/Notifications/Read | Přijímá oznámení Azure Resource Manager |
...
> | Akce | Microsoft. Resources/checkPolicyCompliance/Read | Zkontroluje stav dodržování předpisů daného prostředku proti zásadám prostředků. |
...
> | Akce | Microsoft. Resources/deploymentScripts/DELETE | Odstraní skript nasazení. |
> | Akce | Microsoft. Resources/deploymentScripts/log/Read | Načte nebo vypíše protokoly skriptu nasazení. |
> | Akce | Microsoft. Resources/deploymentScripts/Read | Získá nebo zobrazí seznam skriptů pro nasazení. |
> | Akce | Microsoft. Resources/deploymentScripts/Write | Vytvoří nebo aktualizuje skript nasazení. |
...
> | Akce | Microsoft. Search/searchServices/privateEndpointConnectionProxies/Read | Vrátí seznam proxy serverů připojení privátního koncového bodu nebo získá vlastnosti zadaného proxy serveru připojení privátního koncového bodu. |
> | Akce | Microsoft. Search/searchServices/privateEndpointConnectionProxies/ověřit/akci | Ověří volání vytvoření připojení privátního koncového bodu z NRP strany. |
> | Akce | Microsoft. Search/searchServices/privateEndpointConnectionProxies/Write | Vytvoří proxy server připojení privátního koncového bodu se zadanými parametry nebo aktualizuje vlastnosti nebo značky pro zadaný proxy privátního koncového bodu. |
...
> | Typ akce | Operace | Popis |
> | --- | --- | --- |
> | Akce | Microsoft. SecurityInsights/agregace/číst | Získá agregované informace |
> | Akce | Microsoft. SecurityInsights/alertRules/Actions/DELETE | Odstraní akce odpovědi pro pravidlo výstrahy. |
> | Akce | Microsoft. SecurityInsights/alertRules/Actions/Read | Načte akce odpovědi pro pravidlo výstrahy. |
> | Akce | Microsoft. SecurityInsights/alertRules/Actions/Write | Aktualizuje akce odezvy pravidla výstrahy. |
> | Akce | Microsoft. SecurityInsights/alertRules/DELETE | Odstraní pravidla výstrah. |
> | Akce | Microsoft. SecurityInsights/alertRules/Read | Načte pravidla upozornění. |
> | Akce | Microsoft. SecurityInsights/alertRules/Write | Aktualizuje pravidla upozornění. |
> | Akce | Microsoft. SecurityInsights/záložky/DELETE | Odstraní záložky. |
> | Akce | Microsoft. SecurityInsights/záložky/rozbalit/akce | Načte související entity Entity podle konkrétního rozšíření. |
> | Akce | Microsoft. SecurityInsights/záložky/číst | Načte záložky |
> | Akce | Microsoft. SecurityInsights/záložky/Write | Aktualizuje záložky. |
> | Akce | Microsoft. SecurityInsights/případy/komentáře/čtení | Načte komentáře k případu. |
> | Akce | Microsoft. SecurityInsights/Cases/Comments/Write | Vytvoří komentáře Case. |
> | Akce | Microsoft. SecurityInsights/případy/odstranění | Odstraní případ. |
> | Akce | Microsoft. SecurityInsights/případy/vyšetřování/čtení | Získá vyšetřování případu. |
> | Akce | Microsoft. SecurityInsights/případy/vyšetřování/zápis | Aktualizuje metadata případu. |
> | Akce | Microsoft. SecurityInsights/případy/čtení | Načte případ. |
> | Akce | Microsoft. SecurityInsights/případy/zápis | Aktualizuje případ. |
> | Akce | Microsoft. SecurityInsights/dataconnects/DELETE | Odstraní datový konektor. |
> | Akce | Microsoft. SecurityInsights/dataconnects/Read | Získá datové konektory. |
> | Akce | Microsoft. SecurityInsights/dataconnects/Write | Aktualizuje datový konektor. |
> | Akce | Microsoft. SecurityInsights/incidenty/komentáře/číst | Získá komentáře incidentu. |
> | Akce | Microsoft. SecurityInsights/incidenty/poznámky/zápis | Vytvoří komentář k incidentu. |
> | Akce | Microsoft. SecurityInsights/incidenty/DELETE | Odstraní incident. |
> | Akce | Microsoft. SecurityInsights/incidenty/číst | Získá incident. |
> | Akce | Microsoft. SecurityInsights/incidenty/relace/odstranit | Odstraní vztah mezi incidentem a souvisejícími prostředky. |
> | Akce | Microsoft. SecurityInsights/incidenty/relace/číst | Načte vztah mezi incidentem a souvisejícími prostředky. |
> | Akce | Microsoft. SecurityInsights/incidenty/vztahy/zápis | Aktualizuje vztah mezi incidentem a souvisejícími prostředky. |
> | Akce | Microsoft. SecurityInsights/incidenty/Write | Aktualizuje incident. |
...
> | Akce | Microsoft. SignalRService/Locations/operationresults/signaler/Read | Dotaz na výsledek asynchronní operace na základě umístění |
> | Akce | Microsoft.SignalRService/locations/operationStatuses/operationId/read | Dotaz na stav asynchronní operace na základě umístění |
> | Akce | Microsoft. SignalRService/umístění/použití/číst | Získání využití kvót pro službu Azure Signal |
> | Akce | Microsoft. SignalRService/operationresults/Read | Dotaz na výsledek asynchronní operace na úrovni zprostředkovatele |
> | Akce | Microsoft. SignalRService/Operations/Read | Vypíše operace pro službu Azure Signal. |
> | Akce | Microsoft. SignalRService/stav operationstatus/Read | Dotaz na stav asynchronní operace na úrovni zprostředkovatele |
...
> | Akce | Microsoft. SignalRService/Signaler/privateEndpointConnectionProxies/DELETE | Odstranění proxy serveru připojení privátního koncového bodu |
> | Akce | Microsoft. SignalRService/Signaler/privateEndpointConnectionProxies/Read | Číst proxy privátního koncového bodu |
> | Akce | Microsoft. SignalRService/Signaler/privateEndpointConnectionProxies/ověřit/akci | Ověření proxy připojení privátního koncového bodu |
> | Akce | Microsoft. SignalRService/Signaler/privateEndpointConnectionProxies/Write | Vytvoření proxy serveru připojení privátního koncového bodu |
> | Akce | Microsoft. SignalRService/Signaler/privateEndpointConnections/Read | Čtení připojení privátního koncového bodu |
> | Akce | Microsoft. SignalRService/Signaler/privateEndpointConnections/Write | Schválení nebo zamítnutí připojení privátního koncového bodu |
> | Akce | Microsoft. SignalRService/Signaler/privateLinkResources/Read | Zobrazit seznam všech prostředků privátního propojení signálem |
...
> | Akce | Microsoft. Solutions/Operations/Read | Získá seznam operací. |
...
> | Akce | Microsoft. SQL/Locations/longTermRetentionManagedInstanceBackups/Read | Vrátí seznam záloh spravované instance pro konkrétní umístění.  |
> | Akce | Microsoft. SQL/Locations/longTermRetentionManagedInstances/longTermRetentionDatabases/longTermRetentionManagedInstanceBackups/DELETE | Odstraní zálohu LTR pro databázi spravované instance. |
> | Akce | Microsoft. SQL/Locations/longTermRetentionManagedInstances/longTermRetentionDatabases/longTermRetentionManagedInstanceBackups/Read | Vrátí seznam záloh LTR pro databázi spravované instance. |
> | Akce | Microsoft. SQL/Locations/longTermRetentionManagedInstances/longTermRetentionManagedInstanceBackups/Read | Vrátí seznam záloh spravované instance pro konkrétní spravovanou instanci. |
...
> | Akce | Microsoft. SQL/Locations/serverAdministratorAzureAsyncOperation/Read | Výsledky asynchronní operace pro správce serveru Azure Active Directory |
> | Akce | Microsoft. SQL/Locations/serverAdministratorOperationResults/Read | Výsledky operace správce Azure Active Directory serveru |
...
> | Akce | Microsoft. SQL/Locations/transparentDataEncryptionAzureAsyncOperation/Read | Získá probíhající operace s transparentním šifrováním dat logické databáze. |
> | Akce | Microsoft. SQL/Locations/transparentDataEncryptionOperationResults/Read | Získá probíhající operace s transparentním šifrováním dat logické databáze. |
...
> | Akce | Microsoft. SQL/managedInstances/databáze/backupLongTermRetentionPolicies/Read | Získá dlouhodobé zásady uchovávání informací pro spravovanou databázi. |
> | Akce | Microsoft. SQL/managedInstances/databáze/backupLongTermRetentionPolicies/Write | Aktualizuje dlouhodobé zásady uchovávání informací pro spravovanou databázi. |
...
> | Akce | Microsoft. SQL/managedInstances/databáze/completeRestore/Action | Dokončena operace obnovení spravované databáze |
...
> | Akce | Microsoft. SQL/managedInstances/inaccessibleManagedDatabases/Read | Načte seznam nepřístupných spravovaných databází ve spravované instanci. |
...
> | Akce | Microsoft. SQL/managedInstances/Operations/Cancel/Action | Zruší asynchronní operaci, která čeká na vyřízení služby Azure SQL Managed instance, která ještě není dokončená. |
> | Akce | Microsoft. SQL/managedInstances/Operations/Read | Získat operace spravované instance |
...
> | Akce | Microsoft. SQL/servery/administratorOperationResults/Read | Přijímá probíhající operace u správců serveru. |
...
> | Akce | Microsoft. SQL/servery/databáze/rozšíření/importExtensionOperationResults/Read | Načte probíhající operace importu. |
...
> | Akce | Microsoft.Sql/servers/databases/transparentDataEncryption/read | Načíst podrobnosti o transparentní šifrování dat logické databáze v dané spravované databázi |
> | Akce | Microsoft.Sql/servers/databases/transparentDataEncryption/write | Změna transparentní šifrování dat databáze pro danou logickou databázi |
...
> | Akce | Microsoft. SQL/servery/disableAzureADOnlyAuthentication/Action | Zakázat ověřování pouze Azure Active Directory na logickém serveru |
...
> | Akce dataaction | Microsoft. Storage/storageAccounts/blobServices/Containers/BLOBs/manageOwnership/Action | Změní vlastnictví objektu BLOB. |
> | Akce dataaction | Microsoft. Storage/storageAccounts/blobServices/Containers/BLOBs/modifyPermissions/Action | Upraví oprávnění objektu BLOB. |
> | Akce dataaction | Microsoft. Storage/storageAccounts/blobServices/Containers/BLOBs/Move/Action | Přesune objekt BLOB z jedné cesty na jiný. |
...
> | Akce | Microsoft. Storage/storageAccounts/dataSharePolicies/DELETE |  |
> | Akce | Microsoft. Storage/storageAccounts/dataSharePolicies/Read |  |
> | Akce | Microsoft. Storage/storageAccounts/dataSharePolicies/Read |  |
> | Akce | Microsoft. Storage/storageAccounts/dataSharePolicies/Write |  |
...
> | Akce | Microsoft. Storage/storageAccounts/služby/služby/sdílené položky/akce |  |
...
> | Akce | Microsoft. StorSimple/manažeři/migrateClassicToResourceManager/Action | Migrace z modelu nasazení Classic na Resource Manager |
...
> | Typ akce | Operace | Popis |
> | --- | --- | --- |
> | Akce | Microsoft. support/checkNameAvailability/Action | Kontroluje, jestli je název platný a nepoužívá se pro typ prostředku. |
> | Akce | Microsoft. support/operationresults/Read | Získat výsledek operace |
> | Akce | Microsoft. support/Operations/Read | Zobrazí seznam operací dostupných v poskytovateli prostředků Microsoft. support. |
> | Akce | Microsoft. support/operationsstatus/Read | Načíst stav operace |
> | Akce | Microsoft.Support/register/action | Registruje zprostředkovatele prostředků podpory. |
> | Akce | Microsoft. Support/Services/problemClassifications/Read | Získá seznam klasifikace problému, který je k dispozici pro službu Azure. |
> | Akce | Microsoft. Support/Services/číst | Získá seznam služeb Azure, které jsou dostupné pro podporu. |
> | Akce | Microsoft. support/supportTickets/Communications/Read | Získá seznam komunikačních lístků podpory. |
> | Akce | Microsoft. support/supportTickets/Communications/Write | Vytvoří komunikaci lístků podpory. |
> | Akce | Microsoft.Support/supportTickets/read | Získá seznam lístků podpory. |
> | Akce | Microsoft.Support/supportTickets/write | Vytvoří lístek podpory asynchronně nebo ho aktualizuje. Můžete vytvořit lístek podpory pro technické problémy, problémy s fakturací nebo kvótami nebo problémy související se správou předplatného. U stávajících lístků podpory můžete aktualizovat závažnost a kontaktní údaje. |
...
> | Akce | Microsoft. Web/hostingEnvironments/eventGridFilters/DELETE | Odstraní filtr Event Grid v hostitelském prostředí. |
> | Akce | Microsoft. Web/hostingEnvironments/eventGridFilters/Read | Získejte filtr Event Grid v hostitelském prostředí. |
> | Akce | Microsoft. Web/hostingEnvironments/eventGridFilters/Write | Vložte Event Grid filtr do hostitelského prostředí. |
...
> | Akce | Microsoft. Web/weby/sloty/rozšíření/číst | Získejte rozšíření pro Web Apps sloty. |
> | Akce | Microsoft. Web/weby/sloty/rozšíření/zápis | Aktualizuje rozšíření Web Apps sloty. |

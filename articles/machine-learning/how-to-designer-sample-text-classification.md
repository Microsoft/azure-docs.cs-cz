...
Pro **extrakci funkce N-gramů z modulu textu** by se měl propojit **výstup slovníku výsledků** z toku dat školení do **vstupního slovníku** v toku dat bodování a nastavit parametr **režimu slovníku** na **ReadOnly**.

...
1. Do vyhledávacího pole zadejte **Envi MMIS**vyberte **Envi MMIS** z panelu výsledků klikněte **přidat** tlačítko pro přidání aplikace.
...
1. **[Vytvořit testovacího uživatele Envi MMIS](#create-an-envi-mmis-test-user)**  – Pokud chcete mít protějšek Britta Simon Envi MMIS, který je propojený s Azure AD reprezentace uživatele.
...
1. Na **Envi MMIS domény a adresy URL** části, proveďte následující kroky, pokud chcete nakonfigurovat aplikace v **IDP** iniciované režimu:
...
1. V okně jiné webové prohlížeče Přihlaste se ke webu Envi MMIS jako správce.

1. Klikněte na **Moje doména** kartu.
...
1. Vyberte **použít vzdálené ověření** zaškrtávací políčko a potom vyberte **přesměrování protokolu HTTP** z **typ ověřování** rozevíracího seznamu.

    ![Nakonfigurovat jednotné přihlašování uložit tlačítko](./media/envimmis-tutorial/configure3.png)

1. Vyberte **prostředky** kartu a potom klikněte na tlačítko **nahrát metadat**.

    ![Nakonfigurovat jednotné přihlašování uložit tlačítko](./media/envimmis-tutorial/configure4.png)

1. V **nahrát metadat** automaticky otevírané okno, proveďte následující kroky:
...
1. Po nahrání souboru staženého metadat budou obsazeny pole, který automaticky. Klikněte na tlačítko **aktualizace**
...
1. Klikněte na **seznamu uživatelů** kartu.

    ![Přidat zaměstnance](./media/envimmis-tutorial/user1.png)

1. Klikněte na tlačítko **přidat uživatele** tlačítko.
...
1. V seznamu aplikací vyberte **Envi MMIS**.

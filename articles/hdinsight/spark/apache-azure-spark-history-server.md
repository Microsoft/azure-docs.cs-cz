...
+ Barva pozadí každého úkolu odpovídá Heat mapě.
   ...
   ![Heat mapa na stránce grafu úlohy aplikace Spark &.](./media/apache-azure-spark-history-server/sparkui-graph-heatmap.png)
    ...
    ![přeskočenou úlohu na stránce grafu úlohy & aplikace Spark.](./media/apache-azure-spark-history-server/sparkui-graph-color-skip.png)
...
Pokud při použití tohoto nástroje máte nějaké připomínky nebo máte nějaké problémy, pošlete e-mail na adresu ([hdivstool@microsoft.com](mailto:hdivstool@microsoft.com)).
...
* [Aplikace Service Fabric](profiler-servicefabric.md ?toc=/azure/azure-monitor/toc.json)
* [Virtuální počítače a Scalesets virtuálního počítače](profiler-vm.md?toc=/azure/azure-monitor/toc.json)

Pokud jste povolili Profiler, ale nezobrazují trasování, zkontrolujte naše [Průvodce řešením potíží.](profiler-troubleshooting.md ?toc=/azure/azure-monitor/toc.json)

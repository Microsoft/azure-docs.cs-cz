...
<!-- TBD | IS, ASDK -->  
- **Vylepšení použitelnosti Azure Stack Capacity Planner**. Azure Stack [Capacity Planner](http://aka.ms/azstackcapacityplanner) teď nabízí zjednodušené prostředí pro vkládání mezipaměti S2D a S2D kapacitu při definování skladové položky řešení. Odebrali jsme limit 1 000 virtuálních počítačů.

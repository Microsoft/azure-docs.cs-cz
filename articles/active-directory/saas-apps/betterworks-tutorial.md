...
4. Do vyhledávacího pole zadejte **BetterWorks**.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/betterworks-tutorial/tutorial_betterworks_search.png)

5. Na panelu výsledků vyberte **BetterWorks**a potom klikněte na **přidat** tlačítko Přidat aplikaci.

    ![Vytváření testovacího uživatele Azure AD](./media/betterworks-tutorial/tutorial_betterworks_addfromgallery.png)
...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Konfigurovat jednotné přihlašování](./media/betterworks-tutorial/tutorial_betterworks_samlbase.png)

3. Na **BetterWorks domény a adresy URL** část, pokud chcete nakonfigurovat aplikace **IDP iniciované režimu**:

    ![Konfigurovat jednotné přihlašování](./media/betterworks-tutorial/tutorial_betterworks_url.png)
...
4. Na **BetterWorks domény a adresy URL** část, pokud chcete nakonfigurovat aplikace **SP iniciované režimu**, proveďte následující kroky:
    ...
    ![Konfigurovat jednotné přihlašování](./media/betterworks-tutorial/tutorial_betterworks_url1.png)
...
4. Na **SAML podpisový certifikát** klikněte na tlačítko **soubor XML s metadaty** a potom uložte soubor metadat ve vašem počítači.
    ...
    ![Konfigurovat jednotné přihlašování](./media/betterworks-tutorial/tutorial_betterworks_certificate.png)  
...
5. Aplikace BetterWorks očekává SAML kontrolní výrazy ve specifickém formátu. Nakonfigurujte následující deklarace identity pro tuto aplikaci. Můžete spravovat hodnoty těchto atributů z "**atribut**" aplikace. Následující snímek obrazovky ukazuje příklad pro tento. 
    ...
    ![Konfigurovat jednotné přihlašování](./media/betterworks-tutorial/tutorial_betterworks_attribute.png)
...
6. Na **atributy tokenu SAML** dialogu pro každý řádek v tabulce níže, proveďte následující kroky:
   ...
   a. Klikněte na tlačítko **přidat atribut** otevřete **přidat atribut** dialogové okno.
    ...
    ![Konfigurovat jednotné přihlašování](./media/betterworks-tutorial/tutorial_officespace_04.png)

    ![Konfigurovat jednotné přihlašování](./media/betterworks-tutorial/tutorial_officespace_05.png)
...
7. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Konfigurovat jednotné přihlašování](./media/betterworks-tutorial/tutorial_general_400.png)
...
1. V **portál Azure**, v levém navigačním podokně klikněte na tlačítko **Azure Active Directory** ikonu.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/betterworks-tutorial/create_aaduser_01.png) 

2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin** a klikněte na tlačítko **všichni uživatelé**.
    
    ![Vytváření testovacího uživatele Azure AD](./media/betterworks-tutorial/create_aaduser_02.png) 

3. Chcete-li otevřít **uživatele** dialogové okno, klikněte na tlačítko **přidat** horní dialogové okno.
 
    ![Vytváření testovacího uživatele Azure AD](./media/betterworks-tutorial/create_aaduser_03.png) 

4. Na **uživatele** dialogové okno stránky, proveďte následující kroky:
 
    ![Vytváření testovacího uživatele Azure AD](./media/betterworks-tutorial/create_aaduser_04.png) 
...
2. V seznamu aplikací vyberte **BetterWorks**.
    ...
    ![Konfigurovat jednotné přihlašování](./media/betterworks-tutorial/tutorial_betterworks_app.png) 

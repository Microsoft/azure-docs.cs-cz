...
- Září 2020
  ...
  - [Zálohování Azure Database for PostgreSQL](#backup-azure-database-for-postgresql)
  - [Zálohování a obnovení selektivního disku](#selective-disk-backup-and-restore)
  - [Obnovení mezi oblastmi pro databáze SQL Server a SAP HANA na virtuálních počítačích Azure](#cross-region-restore-for-sql-server-and-sap-hana)
  - [Podpora pro zálohování virtuálních počítačů s až 32 disky](#support-for-backup-of-vms-with-up-to-32-disks)
...
## <a name="backup-center"></a>Centrum zálohování
...
## <a name="backup-azure-database-for-postgresql"></a>Zálohování Azure Database for PostgreSQL
...
## <a name="cross-region-restore-for-sql-server-and-sap-hana"></a>Obnovení mezi oblastmi pro SQL Server a SAP HANA
...
## <a name="backup-sap-hana-in-rhel-azure-virtual-machines"></a>Zálohování SAP HANA ve virtuálních počítačích Azure s RHEL
...
## <a name="zone-redundant-storage-zrs-for-backup-data"></a>Redundantní úložiště zóny (ZRS) pro zálohovaná data

...
+ Aby bylo možné nasadit prostředky do virtuální sítě nebo podsítě, musí mít váš uživatelský účet oprávnění k následujícím akcím v řízení přístupu na základě role Azure (Azure RBAC):
    ...
    - "Microsoft. Network/virtualNetworks/*/Read" na prostředku virtuální sítě.
...
> * Pokud jsou účty Azure Storage v pracovním prostoru zabezpečeny i ve virtuální síti, musí být ve stejné virtuální síti a podsíti jako Azure Machine Learning výpočetní instance nebo cluster. Nakonfigurujte prosím nastavení brány firewall úložiště tak, aby bylo možné komunikovat s virtuální sítí a výpočetními podsíťmi v. Mějte prosím na paměti, že zaškrtnutím políčka "udělit důvěryhodným službám Microsoftu přístup k tomuto účtu" nestačí, aby bylo možné komunikovat z výpočetní služby.
...
Tento článek je třetí částí z řady virtuálních sítí s pěti částmi. Další informace o tom, jak zabezpečit virtuální síť, najdete v dalších článcích:

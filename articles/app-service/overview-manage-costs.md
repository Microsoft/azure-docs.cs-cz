...
- **Izolovaná vrstva**  Pro App Service prostředí se vyžaduje [Virtual Network](/azure/virtual-network/) .
- **Záložní kopie**  K provedení zálohování je nutný [účet úložiště](/azure/storage/) .
- **Diagnostické protokoly**  Jako možnost protokolování můžete vybrat možnost [účet úložiště](/azure/storage/) nebo integrovat s [Azure Log Analytics](../azure-monitor/log-query/log-analytics-tutorial.md).
- **App Service certifikátů**  Certifikáty, které zakoupíte v Azure, se musí udržovat v [Azure Key Vault](/azure/key-vault/).
...
Můžete platit za Azure App Service poplatky s kreditem peněžního závazku EA. Kredity peněžních závazků EA ale nemůžete použít k placení poplatků za produkty a služby třetích stran, včetně těch, které jsou Azure Marketplace.
...
Rozpočty je možné vytvořit s filtry pro konkrétní prostředky nebo služby v Azure, pokud chcete mít v monitorování k dispozici větší členitost. Filtry vám pomůžou zajistit, že nechtěně nevytvoříme nové prostředky, které vám budou zajišťovat peníze. Další informace o možnostech filtru dostupných při vytváření rozpočtu najdete v tématu [Možnosti skupiny a filtru](https://docs.microsoft.com/azure/cost-management-billing/costs/group-filter?WT.mc_id=costmanagementcontent_docsacmhorizontal_-inproduct-learn).

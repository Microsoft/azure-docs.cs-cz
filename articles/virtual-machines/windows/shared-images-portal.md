...
> [!IMPORTANT]
> Portál nemůžete použít k nasazení virtuálního počítače z image v jiném tenantovi Azure. Pokud chcete vytvořit virtuální počítač z image sdílené mezi klienty, musíte použít [Azure CLI](../linux/shared-images.md#create-a-vm) nebo [PowerShell](shared-images.md#create-vms-from-an-image).

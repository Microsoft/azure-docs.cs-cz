...
- Rozšíření virtuální sítě na službu prostřednictvím koncových bodů služby. Koncové body služby umožňují zabezpečit jednotlivé prostředky služby ve virtuální síti.

Pokud chcete integrovat několik služeb Azure do vaší virtuální sítě, můžete zkombinovat jeden nebo více výše uvedených vzorů. Můžete například nasadit službu HDInsight do vaší virtuální sítě a zabezpečit účet úložiště do podsítě HDInsight prostřednictvím koncových bodů služby.
...
|Analýzy | [Azure HDInsight](../hdinsight/hdinsight-extend-hadoop-virtual-network.md?toc=%2fazure%2fvirtual-network%2ftoc.json)<br/>[Azure Databricks](../azure-databricks/what-is-azure-databricks.md?toc=%2fazure%2fvirtual-network%2ftoc.json) |Bez dalších <br/> Bez dalších <br/> 
...
Některé služby Azure nejde nasadit ve virtuálních sítích. Pokud se rozhodnete povolit koncový bod služby virtuální sítě, můžete omezit přístup k některým prostředkům služby jenom na konkrétní podsítě virtuální sítě.  Přečtěte si další informace o [koncových bodech služby virtuální sítě](virtual-network-service-endpoints-overview.md)a službách, pro které lze koncové body povolit.

...
|Standard|Pro důležité obchodní informace|Upgradovat|Nejprve je třeba migrovat sekundární|
...
|Obecné účely|Pro důležité obchodní informace|Upgradovat|Nejprve je třeba migrovat sekundární|
||||

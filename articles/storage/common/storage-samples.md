...
description: Zobrazit, stáhnout a spustit vzorový kód a aplikace pro Azure Storage. Pomocí knihoven .NET, Java, Pythonu, Node. js a C++ klientských knihoven pro úložiště můžete objevovat úvodní ukázky pro objekty blob, fronty, tabulky a soubory.
...
Pokud chcete prozkoumat ukázky Pythonu, Stáhněte si [klientskou knihovnu pro úložiště Python](https://github.com/azure/azure-storage-python).
...
| Python | [Referenční dokumentace klientské knihovny Pythonu](https://azure-storage.readthedocs.io/) | [Zdrojový kód pro knihovnu klienta úložiště Python](https://github.com/Azure/azure-storage-p[ython]) |

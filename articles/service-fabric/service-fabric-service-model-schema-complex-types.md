...
|---|---|
|jméno|Image|
|type|[Typ obrázku](#imagetype-complextype)|
|minOccurs|0|
|maxOccurs|bez vazby|
...
Popisuje zásady sítě, včetně zásad sítě kontejneru pro balíček služby.
...
#### <a name="nodename"></a>NodeName
Toto je název uzlu, ke kterému upgradu prostředků infrastruktury se nestane

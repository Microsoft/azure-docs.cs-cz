...
1. Kliknutím na **přihlašovací jméno** zahajte uživatelský tok *B2C_1_signupsignin1* , který jste zadali v předchozím kroku.
1. Azure AD B2C zobrazí přihlašovací stránku s odkazem na registraci. Vzhledem k tomu, že účet ještě nemáte, klikněte na odkaz **zaregistrovat se nyní** .
...
Po kliknutí na **vytvořit**se stránka registrace zavře a znovu se zobrazí přihlašovací stránka.

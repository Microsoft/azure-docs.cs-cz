...
- Monitorování všech virtuálních počítačů (v jedné oblasti Azure) v jedné nebo více skupin prostředků.
...
* Další informace o [upozornění v Azure](monitoring-overview-alerts.md)

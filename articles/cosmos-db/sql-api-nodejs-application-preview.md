...
V tomto kurzu se dozvíte, jak vytvořit účet rozhraní SQL API služby Azure Cosmos DB pomocí webu Azure Portal. Pak vytvoříte a spustíte webovou aplikaci využívající sadu Node.js SDK k vytvoření databáze a kontejneru a přidání položek do kontejneru. V tomto kurzu se používá verze 2.0 sady Node.js SDK, která je aktuálně ve verzi Preview.

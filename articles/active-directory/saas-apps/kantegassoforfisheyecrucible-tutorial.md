...
* Můžete povolit uživatelům, aby se automaticky přihlášeni k Kantega jednotné přihlašování pro FishEye/Crucible (Single Sign-On) pomocí jejich účtů služby Azure AD.
...
* Kantega jednotné přihlašování pro FishEye/Crucible jednotného přihlašování povolená předplatného

## <a name="scenario-description"></a>Popis scénáře

V tomto kurzu konfigurace a testování v testovacím prostředí Azure AD jednotného přihlašování.

* Podporuje jednotné přihlašování Kantega pro FishEye/Crucible **SP a zprostředkovatele identity** jednotné přihlašování zahájené pomocí
...
4. Do vyhledávacího pole zadejte **Kantega jednotné přihlašování pro FishEye/Crucible**vyberte **Kantega jednotné přihlašování pro FishEye/Crucible** z panelu výsledků klikněte **přidat** tlačítko pro přidání aplikace.

    ![Kantega jednotné přihlašování pro FishEye/Crucible v seznamu výsledků](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurace a otestování služby Azure AD jednotného přihlašování

V této části nakonfigurujete a otestovat Azure AD jednotné přihlašování s jednotným Přihlašováním Kantega FishEye/Crucible podle testovacího uživatele volá **Britta Simon**.
Pro jednotné přihlašování pro práci je potřeba navázat vztah odkazu mezi uživatele služby Azure AD a související uživatelské v Kantega jednotné přihlašování pro FishEye/Crucible.
...
2. **[Konfigurace jednotného přihlašování Kantega pro FishEye/Crucible Single Sign-On](#configure-kantega-sso-for-fisheyecrucible-single-sign-on)**  – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
3. **[Vytvořit testovacího uživatele Azure AD](#create-an-azure-ad-test-user)**  – Pokud chcete otestovat Azure AD jednotné přihlašování s Britta Simon.
4. **[Přiřadit uživatele Azure AD](#assign-the-azure-ad-test-user)**  – Pokud chcete povolit Britta Simon používat Azure AD jednotného přihlašování.
5. **[Vytvoření Kantega jednotného přihlašování pro FishEye/Crucible testovacího uživatele](#create-kantega-sso-for-fisheyecrucible-test-user)**  – Pokud chcete mít protějšek Britta Simon Kantega jednotné přihlašování pro FishEye/Crucible, který je propojený s Azure AD reprezentace uživatele.
...
1. V [webu Azure portal](https://portal.azure.com/)na **Kantega jednotné přihlašování pro FishEye/Crucible** integrace stránce aplikace vyberte **jednotného přihlašování**.
...
4. Na **základní konfiguraci SAML** části, pokud chcete nakonfigurovat aplikace v **IDP** iniciované režimu, proveďte následující kroky:
    ...
    ![Jednotné přihlašování Kantega FishEye/Crucible domény a adresy URL jednotné přihlašování – informace](common/idp-intiated.png)
...
5. Klikněte na tlačítko **nastavit další adresy URL** a provést následující krok, pokud chcete nakonfigurovat aplikace v **SP** iniciované režimu:
    ...
    ![Jednotné přihlašování Kantega FishEye/Crucible domény a adresy URL jednotné přihlašování – informace](common/metadata-upload-additional-signon.png)
...
7. Na **nastavit jednotné přihlašování Kantega pro FishEye/Crucible** tématu, zkopírujte příslušné adresy URL podle vašich požadavků.
...
### <a name="configure-kantega-sso-for-fisheyecrucible-single-sign-on"></a>Nakonfigurovat jednotné přihlašování Kantega pro širokoúhlého/Crucible jednotného přihlašování

1. V okně jiné webové prohlížeče Přihlaste se na váš místní server FishEye/Crucible jako správce.
...
1. Na webu Azure Portal, vyberte **podnikové aplikace**vyberte **všechny aplikace**a pak vyberte **Kantega jednotné přihlašování pro FishEye/Crucible**.

    ![Okno aplikace organizace](common/enterprise-applications.png)

2. V seznamu aplikací vyberte **Kantega jednotné přihlašování pro FishEye/Crucible**.

    ![Kantega jednotné přihlašování pro FishEye/Crucible odkaz v seznamu aplikací](common/all-applications.png)
...
### <a name="create-kantega-sso-for-fisheyecrucible-test-user"></a>Vytvoření Kantega jednotného přihlašování pro FishEye/Crucible testovacího uživatele

Pokud chcete povolit Azure AD uživatelům umožní přihlásit k FishEye/Crucible, musí být poskytnuty do FishEye/Crucible. Zřizování v Kantega jednotného přihlašování pro FishEye/Crucible, je ruční úlohy.

**K poskytnutí uživatelského účtu, postupujte následovně:**

1. Přihlaste se na váš místní server Crucible jako správce.
...
Po kliknutí na Kantega jednotné přihlašování pro FishEye/Crucible dlaždici na přístupovém panelu, můžete by měl být automaticky přihlášeni k Kantega jednotné přihlašování pro FishEye/Crucible, u kterého nastavíte jednotné přihlašování. Další informace o přístupovém panelu, naleznete v tématu [Úvod k přístupovému panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

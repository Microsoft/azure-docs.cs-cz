...
## <a name="understand"></a>Principy tras
...
## <a name="view"></a>Zobrazit efektivní trasy
...
### <a name="routetable"></a>Tabulka směrování centra

Pomocí posuvníku v dolní části tabulky zobrazte "AS Path".

| **Směr** |  **Typ dalšího segmentu směrování** | **Další směrování** |  **Původ trasy** |**JAKO cesta** |
| ---        | ---                | ---          | ---               | ---         |

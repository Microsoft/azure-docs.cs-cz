---
title: 'Rychlý start: Převod textového skriptu, Node.js – Translator Text API'
titleSuffix: Azure Cognitive Services
description: V tomto rychlém startu převedete text v jednom jazyce z jednoho skriptu do druhého pomocí služby Translator Text API s Node.js.
...
ms.locfileid: "49646190"
---
# <a name="quickstart-transliterate-text-with-the-translator-text-rest-api-nodejs"></a>Rychlý start: Transliterace textu pomocí rozhraní REST API služby Translator Text (Node.js)

...
<sup>*</sup>Může být vyžadováno použití nestránkovaného jádra. Můžete si je nainstalovat pomocí příkazu `sudo apt-get install linux-image-cloud-amd64`.

...
ms.locfileid: "55889495"
---
#### <a name="to-create-a-new-service"></a>Vytvoření nové služby
1. Pomocí přihlašovacích údajů účtu Microsoft k přihlášení [portálu Microsoft Azure Government](https://portal.azure.us/).
2. Na portálu Government, klikněte na tlačítko **+** a na webu Marketplace, klikněte na tlačítko **zobrazit všechny**. Vyhledejte _Fyzické zařízení StorSimple_. Vyberte a klikněte na **Řada fyzických zařízení StorSimple** a pak klikněte na **Vytvořit**. Můžete také na portálu Government, klikněte na tlačítko **+** a potom v části **úložiště**, klikněte na tlačítko **řada fyzických zařízení StorSimple**.
3. V okně **Správce zařízení StorSimple** proveďte následující kroky:
   ...
   4. Zadejte **Umístění** služby. Umístění odkazuje na geografické oblasti, ve které chcete zařízení nasadit. Vyberte **USGov Iowa** nebo **USGov Virginie**.

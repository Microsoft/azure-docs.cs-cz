...
ms.locfileid: "99055782"
---
# <a name="plan-azure-active-directory-my-apps-configuration"></a>Plánování konfigurace Azure Active Directory mých aplikací

> [!NOTE]
> Tento článek je určený pro odborníky v oblasti IT, kteří potřebují naplánovat konfiguraci portálu moje aplikace své organizace. Informace o tom, jak používat moje aplikace a kolekce, najdete v tématu věnovaném [přihlášení a spouštění aplikací na portálu moje aplikace](../user-help/my-apps-portal-end-user-access.md).
>
...
* [Configuration Manager pro Internet Explorer](https://docs.microsoft.com/mem/configmgr/core/clients/deploy/deploy-clients-to-windows-computers)

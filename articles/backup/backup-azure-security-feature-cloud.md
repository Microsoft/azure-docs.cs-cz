...
V oblasti Středozápadní USA se aktuálně podporuje obnovitelné odstranění.
...
* Přečtěte si o [atributech zabezpečení pro Azure Backup](https://docs.microsoft.com/en-us/azure/backup/backup-security-attributes).

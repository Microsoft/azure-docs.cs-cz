...
6. Na **NuGet** kartu, vyberte možnost **Procházet** v horní části okna a typ **azure documentdb** do vyhledávacího pole. Ujistěte se, **zahrnout předběžné verze** je zaškrtnuté políčko.

...
Informace o tom, jaká nastavení jsou platná pro váš typ živé události, najdete v tématu [porovnání typů událostí typu Live](live-event-types-comparison-reference.md).
...
[Živé streamování s Media Services V3](stream-live-streaming-concept.md)

## <a name="next-steps"></a>Další kroky

[Jak ověřit kodér](encode-on-premises-encoder-partner.md)

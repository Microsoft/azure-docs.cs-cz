...
Změnou nastavení [jednotek datového skladu](what-is-a-data-warehouse-unit-dwu-cdwu.md) pro váš fond SQL můžete škálovat nebo škálovat zpět výpočetní výkon. Načítání a dotazování výkonu se může při přidávání dalších jednotek datového skladu zvýšit lineárně. 

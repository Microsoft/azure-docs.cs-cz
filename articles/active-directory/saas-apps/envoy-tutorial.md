...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/envoy-tutorial/tutorial_envoy_samlbase.png)

3. Na **Envoy domény a adresy URL** část, proveďte následující kroky:

    ![Envoy domény a adresy URL jednotné přihlašování informace](./media/envoy-tutorial/tutorial_envoy_url.png)
...
5. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/envoy-tutorial/tutorial_general_400.png)
...
6. Na **Envoy konfigurace** klikněte na tlačítko **konfigurace Envoy** otevřete **konfigurovat přihlášení** okno. Kopírování **SAML jeden přihlašování adresa URL služby** z **Stručná referenční příručka části.**
    ...
    ![Konfigurace Envoy](./media/envoy-tutorial/tutorial_envoy_configure.png)
...
9. Klikněte na tlačítko **společnosti**.
    ...
    ![Společnosti](./media/envoy-tutorial/ic776783.png "společnosti")
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/envoy-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **Envoy**.
    ...
    ![V seznamu aplikací na Envoy odkaz](./media/envoy-tutorial/tutorial_envoy_app.png)  

...
3. **[Vytvoření zkušebního uživatele přijetím Suite CX](#create-a-foresee-cx-suite-test-user)**  – Pokud chcete mít protějšek Britta Simon přijetím CX Suite, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **přijetím CX sada domény a adresy URL** části, pokud máte **soubor metadat poskytovatele služeb**, proveďte následující kroky:
...
7. Ke konfiguraci jednotného přihlašování na **přijetím Suite CX** straně, je nutné odeslat na stažený **soubor XML s metadaty** k [tým podpory přijetím Suite CX](mailto:support@foresee.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

...
![Azure Portal obrazovka s možností Azure AD](media/active-directory-access-create-new-tenant/azure-ad-portal.png)
...
1. Vyberte **vytvořit prostředek**, vyberte **Identita**a pak vyberte **Azure Active Directory**.

...
> [!NOTE]
> K usnadnění testování můžete také použít rozhraní [IDocumentClient](/dotnet/api/microsoft.azure.documents.idocumentclient?view=azure-dotnet) .

...
Můžete vytvářet [snímky objektů BLOB](https://docs.microsoft.com/rest/api/storageservices/creating-a-snapshot-of-a-blob). Snímek je verze objektu BLOB jen pro čtení, která je pořízena v určitém časovém okamžiku, a poskytuje způsob, jak zálohovat objekt BLOB. Po vytvoření snímku je možné ho číst, kopírovat nebo odstranit, ale nemění se.
...
Stažení certifikátu SSL Azure Blob do souboru
...
**Pokud chcete přidat výše uvedenou cestu zprostředkovatele k souboru Core-site. XML nebo ke konfiguraci Ambari v části vlastní Core-site:**
...
> [!Note]
> Do příkazového řádku Distcp se dá přidat taky vlastnost cesta zprostředkovatele místo uložení klíče na úrovni clusteru v souboru Core-site. XML následujícím způsobem:

...
>[!NOTE]
>Azure Load Balancer podporuje dva různé typy: Basic a Standard. This article discusses Standard Load Balancer. For more information about Basic Load Balancer, see [Load Balancer overview](load-balancer-overview.md).

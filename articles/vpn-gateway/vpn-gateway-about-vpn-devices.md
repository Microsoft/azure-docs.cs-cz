---
title: 'Brána Azure VPN: O zařízeních VPN pro připojení'
...
Chcete-li pomoci nakonfigurovat zařízení VPN, podívejte se na odkazy, které odpovídají příslušné rodině zařízení. Při poskytování odkazů na pokyny se snažíme maximálně vyhovět. Pro podporu zařízení VPN kontaktujte výrobce zařízení.
...
| Check Point |Security Gateway |80,10 R |[Průvodce konfigurací](https://supportcenter.checkpoint.com/supportcenter/portal?eventSubmit_doGoviewsolutiondetails=&solutionid=sk101275) |[Průvodce konfigurací](https://supportcenter.checkpoint.com/supportcenter/portal?eventSubmit_doGoviewsolutiondetails=&solutionid=sk101275) |
...
| Fortinet |FortiGate |FortiOS 5.6 | (není testováno) |[Průvodce konfigurací](https://docs.fortinet.com/document/fortigate/5.6.0/cookbook/255100/ipsec-vpn-to-azure) |
| Hillstone sítě | Brány firewall nové generace (NGFW) | 5.5R7  | (není testováno) | [Průvodce konfigurací](https://www.hillstonenet.com/wp-content/uploads/How-to-setup-Site-to-Site-VPN-between-Microsoft-Azure-and-an-on-premise-Hillstone-Networks-Security-Gateway.pdf) |
...
| Open Systems AG |Mission Control Security Gateway |Není dostupné. |[Průvodce konfigurací](https://www.open.ch/_pdf/Azure/AzureVPNSetup_Installation_Guide.pdf) |Není kompatibilní |
...
| Sentrium (Vývojář) | VyOS | VyOS 1.2.2 | (není testováno) | [Průvodce konfigurací](https://vyos.readthedocs.io/en/latest/appendix/examples/azure-vpn-bgp.html)|
...
| Sophos | XG Next Gen Firewall | XG v17 | (není testováno) | [Průvodce konfigurací](https://community.sophos.com/kb/127546)<br><br>[Průvodce konfigurací – více sa](https://community.sophos.com/kb/en-us/133154) |
| Synology | MR2200ac <br>RT2600ac <br>RT1900ac | SRM1.1.5/VpnPlusServer-1.2.0 | (není testováno) | [Průvodce konfigurací](https://www.synology.com/en-global/knowledgebase/SRM/tutorial/VPN/How_to_set_up_Site_to_Site_VPN_between_Synology_Router_and_MS_Azure) |
| Ubiquiti | EdgeRouter | EdgeOS v1.10 | (není testováno) | [Protokol BGP nad ikEv2/IPsec](https://help.ubnt.com/hc/en-us/articles/115012374708)<br><br>[VTI nad IKEv2/IPsec](https://help.ubnt.com/hc/en-us/articles/115012305347)
...
| Zyxel |Řada ZyWALL USG<br>Řada Atp ZyWALL<br>Řada ZyWALL VPN | ZLD v4.32+ | (není testováno) | [VTI nad IKEv2/IPsec](https://businessforum.zyxel.com/discussion/2648/)<br><br>[Protokol BGP nad ikEv2/IPsec](https://businessforum.zyxel.com/discussion/2650/)|
...
## <a name="download-vpn-device-configuration-scripts-from-azure"></a><a name="configscripts"></a>Stažení konfiguračních skriptů zařízení VPN z Azure

U některých zařízení můžete stáhnout konfigurační skripty přímo z Azure. Další informace a pokyny ke stažení naleznete v [tématu Stažení konfiguračních skriptů zařízení VPN](vpn-gateway-download-vpndevicescript.md).

...
Připojte se k požadovanému účtu Azure pomocí [Connect-AzAccount](/powershell/module/az.accounts/connect-azaccount) a [set-AzAccount](/powershell/module/az.accounts/set-azcontext).

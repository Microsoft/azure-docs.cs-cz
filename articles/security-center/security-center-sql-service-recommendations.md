...
|SQL|15|Je třeba povolit transparentní šifrování dat databází SQL.|Povolte transparentní šifrování dat, aby se dala chránit neaktivní uložená data a splnit požadavky na dodržování předpisů.|
...
|SQL|20|Zřídit správce Azure AD pro server SQL|Zřiďte správce Azure AD pro SQL Server, aby se povolilo ověřování Azure AD. Ověřování Azure AD umožňuje zjednodušenou správu oprávnění a centralizovanou správu identit uživatelů databáze a dalších služeb Microsoftu.|

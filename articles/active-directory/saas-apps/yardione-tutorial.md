...
2. **[Nakonfigurujte jednotné přihlašování YardiOne](#configure-yardione-single-sign-on)** – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
...
### <a name="configure-yardione-single-sign-on"></a>Konfigurace jednotného přihlašování YardiOne
...
Když na přístupovém panelu kliknete na dlaždici YardiOne, měli byste se automaticky přihlásit k YardiOne, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

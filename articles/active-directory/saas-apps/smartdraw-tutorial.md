---
title: 'Kurz: Azure Active Directory integraci jednotného přihlašování s SmartDraw | Microsoft Docs'
description: Přečtěte si, jak nakonfigurovat jednotné přihlašování mezi Azure Active Directory a SmartDraw.
...
V tomto kurzu se dozvíte, jak integrovat SmartDraw s Azure Active Directory (Azure AD). Když integrujete SmartDraw s Azure AD, můžete:

* Řízení ve službě Azure AD, která má přístup k SmartDraw.
* Umožněte, aby se vaši uživatelé automaticky přihlásili k SmartDraw svým účtům Azure AD.
...
* SmartDraw odběr s povoleným jednotným přihlašováním (SSO).
...
Pokud chcete nakonfigurovat integraci SmartDraw do služby Azure AD, musíte přidat SmartDraw z Galerie do svého seznamu spravovaných aplikací SaaS.
...
1. V [Azure Portal](https://portal.azure.com/)na stránce integrace aplikací **SmartDraw** Najděte oddíl **Spravovat** a vyberte **jednotné přihlašování**.
...
1. Klikněte na **nastavit další adresy URL** a proveďte následující krok, pokud chcete nakonfigurovat aplikaci v režimu iniciované **SP** :
    ...
    Do textového pole **přihlašovací adresa URL** zadejte adresu URL pomocí následujícího vzoru:  `https://cloud.smartdraw.com/sso/saml/login/<domain>`
...
V této části povolíte B. Simon pro použití jednotného přihlašování Azure tím, že udělíte přístup k SmartDraw.

1. V Azure Portal vyberte **podnikové aplikace** a pak vyberte **všechny aplikace**.
1. V seznamu aplikace vyberte **SmartDraw**.
...
1. Na stránce konfigurace proveďte následující kroky:
    ...
    e. V programu Poznámkový blok otevřete soubor XML s metadaty, který jste stáhli z Azure Portal, zkopírujte jeho obsah a vložte ho do pole **metadata SAML** .
...
Když na přístupovém panelu kliknete na dlaždici SmartDraw, měli byste se automaticky přihlásit k SmartDraw, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).

...
-->
Můžete použít jeden z následujících nástrojů nebo sad SDK použít aktivitu kopírování s kanálem. Vyberte odkaz pro podrobné pokyny:
...
- [Sada SDK rozhraní .NET](../articles/data-factory/quickstart-create-data-factory-dot-net.md)
...
- [ROZHRANÍ API PRO ODPOČINEK](../articles/data-factory/quickstart-create-data-factory-rest-api.md)

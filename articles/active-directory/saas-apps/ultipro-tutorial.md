...
* Můžete kontrolovat v Azure AD, kteří mají přístup k UltiPro.
* Můžete povolit, aby se vaši uživatelé automaticky přihlásili k UltiPro (jednotné přihlašování) pomocí svých účtů Azure AD.
...
Ke konfiguraci integrace služby Azure AD s UltiPro potřebujete následující položky:

* Předplatné služby Azure AD. Pokud nemáte prostředí Azure AD, můžete získat měsíční zkušební verzi [tady](https://azure.microsoft.com/pricing/free-trial/) .
* Předplatné s povoleným UltiProm jednotným přihlašováním
...
4. Do vyhledávacího pole zadejte **UltiPro**, vyberte **UltiPro** z panelu výsledků a potom kliknutím na tlačítko **Přidat** přidejte aplikaci.

     ![UltiPro v seznamu výsledků](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurace a testování jednotného přihlašování Azure AD

V této části nakonfigurujete a otestujete jednotné přihlašování Azure AD pomocí UltiPro na základě testovacího uživatele s názvem **Britta Simon**.
Aby jednotné přihlašování fungovalo, musí se zřídit vztah propojení mezi uživatelem služby Azure AD a souvisejícím uživatelem v UltiPro.

Pokud chcete nakonfigurovat a otestovat jednotné přihlašování Azure AD pomocí UltiPro, musíte dokončit tyto stavební bloky:

1. **[Nakonfigurujte jednotné přihlašování Azure AD](#configure-azure-ad-single-sign-on)** a Umožněte uživatelům používat tuto funkci.
2. **[Nakonfigurujte jednotné přihlašování UltiPro](#configure-ultipro-single-sign-on)** – ke konfiguraci nastavení jediného Sign-On na straně aplikace.
3. **[Vytvořte testovacího uživatele Azure AD](#create-an-azure-ad-test-user)** – k otestování jednotného přihlašování Azure AD pomocí Britta Simon.
4. **[Přiřaďte testovacího uživatele Azure AD](#assign-the-azure-ad-test-user)** – pro povolení Britta Simon pro použití jednotného přihlašování Azure AD.
5. **[Vytvoření UltiPro Test User](#create-ultipro-test-user)** – pro Britta Simon v UltiPro, který je propojený s reprezentací uživatele Azure AD.
...
Pokud chcete nakonfigurovat jednotné přihlašování Azure AD pomocí UltiPro, proveďte následující kroky:

1. V [Azure Portal](https://portal.azure.com/)na stránce integrace aplikací **UltiPro** vyberte **jednotné přihlašování**.
...
4. V části **základní konfigurace SAML** proveďte následující kroky:
    ...
    ![Informace o jednotném přihlašování v doméně UltiPro a adresách URL](common/sp-identifier-reply.png)
...
### <a name="configure-ultipro-single-sign-on"></a>Nakonfigurovat UltiPro jednu Sign-On
...
V této části povolíte Britta Simon pro použití jednotného přihlašování pomocí Azure tím, že udělíte přístup k UltiPro.

1. V Azure Portal vyberte **podnikové aplikace**, vyberte **všechny aplikace**a pak vyberte **UltiPro**.
...
Když na přístupovém panelu kliknete na dlaždici UltiPro, měli byste se automaticky přihlásit k UltiPro, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).

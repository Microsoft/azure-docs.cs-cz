...
1. V okně PowerShellu spusťte následující příkaz k nasazení virtuálního počítače. Nezapomeňte nahradit název skupiny prostředků, cestu k souboru šablony a cestu k souboru parametrů šablony.

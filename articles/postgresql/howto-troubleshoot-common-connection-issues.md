---
title: Řešení problémů s připojením ke službě Azure Database for PostgreSQL – jeden Server
description: Zjistěte, jak řešit potíže s připojením ke službě Azure Database for PostgreSQL – jeden Server.

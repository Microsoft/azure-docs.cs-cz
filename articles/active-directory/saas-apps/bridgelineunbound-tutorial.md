...
Když kliknete na dlaždici bridgeline bez vazby na přístupovém panelu, měli byste se automaticky přihlásit k bridgeline bez vazby, pro kterou jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).

...
Další informace o režimech nasazení najdete v tématu [Azure Resource Manager režimy nasazení](/azure/azure-resource-manager/deployment-modes.md).

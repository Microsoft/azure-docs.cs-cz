...
> [!NOTE]
> Při použití spravované identity by měl být připojovací řetězec ve formátu: `Endpoint=sb://<NAMESPACE NAME>.servicebus.windows.net/;Authentication=ManagedIdentity` .

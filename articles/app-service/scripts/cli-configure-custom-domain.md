...
| [`az webapp config hostname add`](/cli/azure/webapp/config/hostname#az_webapp_config_hostnam_eadd) | Namapuje vlastní doménu na App Service aplikaci. |

...
ms.locfileid: "76842486"
---
Ve výstupu příkazu zobrazuje oddíl `identity` identitu typu `SystemAssigned` je nastavena v úloze. `principalId` je ID objektu služby identity:

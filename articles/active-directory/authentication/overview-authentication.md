...
Informace o tom, jak začít, najdete v kurzu [rychlý Start pro Samoobslužné resetování hesla][quickstart-sspr] a [Azure Multi-Factor Authentication][tutorial-mfa-applications].

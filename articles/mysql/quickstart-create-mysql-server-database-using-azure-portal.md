...
>[!div class="mx-imgBorder"]
> ![Zabezpečení připojení – Pravidla brány firewall](./media/quickstart-create-mysql-server-database-using-azure-portal/add-current-ip-firewall.png)
...
1. Na portálu spusťte Azure Cloud Shell kliknutím na zvýrazněnou ikonu v levé horní části. Poznamenejte si název serveru, přihlašovací jméno správce serveru, heslo a předplatné nově vytvořeného serveru z **přehledu** , jak je znázorněno na následujícím obrázku.
   ...
   >[!div class="mx-imgBorder"]
   > ![Zobrazení úplného zobrazení portálu Cloud Shell](./media/quickstart-create-mysql-server-database-using-azure-portal/use-in-cloud-shell.png)
2. Spusťte tento příkaz na Azure Cloud Shell terminálu. Nahraďte hodnoty skutečným názvem serveru a přihlašovacím jménem uživatele správce. Uživatelské jméno správce vyžaduje "@" <servername> , jak je uvedeno níže pro Azure Database for MySQL  
...
> [!div class="mx-imgBorder"]
> ![Odstranění prostředků](media/quickstart-create-mysql-server-database-using-azure-portal/delete-server.png)

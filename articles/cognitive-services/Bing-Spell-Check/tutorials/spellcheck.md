...
Vytvořte formulář HTML s textovým polem. Zpracujte `onsubmit` událost a zavolejte funkci bingSpellCheck, která předává obsah textového pole a rozhraní API Bingu pro kontrolu pravopisu klíč.

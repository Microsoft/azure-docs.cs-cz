...
3. **[Vytvoření zkušebního uživatele CylancePROTECT](#create-a-cylanceprotect-test-user)**  – Pokud chcete mít protějšek Britta Simon CylancePROTECT, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **CylancePROTECT domény a adresy URL** části, proveďte následující kroky:
...
6. Na **CylancePROTECT konfigurace** klikněte na tlačítko **nakonfigurovat CylancePROTECT** otevřete **nakonfigurovat přihlašování** okna. Kopírovat **URL odhlašování SAML Entity ID a SAML jednotné přihlašování – adresa URL služby** z **Stručná referenční příručka oddílu.**

    ![Konfigurace CylancePROTECT](./media/cylanceprotect-tutorial/tutorial_cylanceprotect_configure.png) 

7. Ke konfiguraci jednotného přihlašování na **CylancePROTECT** straně, je nutné odeslat na stažený **Certificate(Base64), adresa URL odhlašování, SAML Entity ID a SAML jednotné přihlašování – adresa URL služby** do konzoly správce. Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

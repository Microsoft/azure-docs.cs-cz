...
description: Naučte se vytvořit sdílený přístupový podpis služby (SAS) pro kontejner nebo objekt BLOB pomocí knihovny Azure Storage pro Blob Storage.
services: storage
author: tamram
ms.service: storage
ms.topic: how-to

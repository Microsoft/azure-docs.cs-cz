...
ms.locfileid: "106281812"
---
# <a name="streaming-endpoint-origin-errors"></a>Chyby koncového bodu streamování (zdroj)

V tomto tématu jsou popsány chyby, které se mohou vysílat ze [služby Azure Media Services streaming Endpoint](stream-streaming-endpoint-concept.md).

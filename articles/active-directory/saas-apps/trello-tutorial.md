...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/trello-tutorial/tutorial_trello_samlbase.png)
...
3. Na **Trello domény a adresy URL** část, pokud chcete nakonfigurovat aplikace **IDP iniciované režimu**, proveďte následující kroky:
    ...
    ![Trello domény a adresy URL jednotné přihlašování informace](./media/trello-tutorial/tutorial_trello_url.png)
...
4. Pokud chcete nakonfigurovat aplikace **SP iniciované režimu**, proveďte následující kroky:
    ...
    ![Trello domény a adresy URL jednotné přihlašování informace](./media/trello-tutorial/tutorial_trello_url1.png)
...
5. Aplikace Trello očekává kontrolní výrazy SAML tak, aby obsahovala určité atributy. Nakonfigurujte následující atributy pro tuto aplikaci. Můžete spravovat hodnoty těchto atributů z **"Atributy uživatele"** aplikace. Následující snímek obrazovky ukazuje příklad pro tento.
    ...
    ![Konfigurovat jednotné přihlašování](./media/trello-tutorial/tutorial_trello_attribute.png)
...
6. Na **atributy tokenu SAML** dialogu pro každý řádek v tabulce níže, proveďte následující kroky:
    ...
    ![Konfigurovat jednotné přihlašování](./media/trello-tutorial/tutorial_officespace_04.png)

    ![Konfigurovat jednotné přihlašování](./media/trello-tutorial/tutorial_attribute_05.png)
...
8. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/trello-tutorial/tutorial_general_400.png)
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/trello-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **Trello**.
    ...
    ![V seznamu aplikací na Trello odkaz](./media/trello-tutorial/tutorial_trello_app.png)  

...
4.  Vyberte předplatné, které se vytvořilo při vaší registraci bezplatného účtu.
...
Po vypršení platnosti bezplatných služeb a množství se vám všechny využívané služby začnou účtovat podle tarifů průběžných plateb. Na webu Azure Portal můžete odstranit prostředky služeb, které nevyužíváte. Pokud se nechystáte využívat žádné služby Azure, můžete [zrušit své předplatné](billing-how-to-cancel-azure-subscription.md).
...
- [Upgrade bezplatného účtu Azure](billing-upgrade-azure-subscription.md)

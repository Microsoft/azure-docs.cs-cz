...
>[!NOTE]
>K zřizování uživatelských účtů AAD můžete použít všechny nové nástroje pro vytváření uživatelských účtů Relic nebo rozhraní API poskytovaná novými Relic.
> 

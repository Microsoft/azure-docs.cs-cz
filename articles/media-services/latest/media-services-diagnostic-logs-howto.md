...
- Zkontrolujte  [Media Services monitorování](monitoring/monitor-media-services.md).
...
* [Protokoly diagnostiky Azure Monitor](../../azure-monitor/essentials/platform-logs-overview.md)

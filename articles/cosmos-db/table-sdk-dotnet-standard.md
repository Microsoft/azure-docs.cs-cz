---
title: Rozhraní API .NET Standard SDK & zdroje tabulky Azure Cosmos DB | Dokumentace Microsoftu
...
ms.locfileid: "49957314"
---
# <a name="azure-cosmos-db-table-net-standard-api-download-and-release-notes"></a>Azure Cosmos DB Table API standardní .NET: Stáhněte si a poznámky k verzi

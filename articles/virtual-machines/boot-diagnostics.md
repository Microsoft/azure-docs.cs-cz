...
Vše, co rozhraní API verze 2020-06-01 podporuje diagnostiku spravovaného spouštění. Další informace najdete v tématu [zobrazení instance diagnostiky spouštění](https://docs.microsoft.com/rest/api/compute/virtualmachines/createorupdate#bootdiagnostics).

...
| `topicA.westus.privatelink.eventgrid.azure.net` | CNAME     | \<profilu Azure Traffic Manager\>
...
Pokud ve vaší síti používáte vlastní server DNS, klienti můžou přeložit plně kvalifikovaný název domény pro téma nebo koncový bod domény na IP adresu privátního koncového bodu. Nakonfigurujte server DNS tak, aby delegoval subdoménu privátního propojení do privátní zóny DNS pro virtuální síť, nebo nakonfigurujte záznamy A pro `topicOrDomainName.regionName.privatelink.eventgrid.azure.net` s IP adresou privátního koncového bodu.

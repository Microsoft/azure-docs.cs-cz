...
3. **[Vytvořit testovacího uživatele IBM OpenPages](#create-an-ibm-openpages-test-user)**  – Pokud chcete mít protějšek Britta Simon IBM OpenPages, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **IBM OpenPages domény a adresy URL** části, proveďte následující kroky:
...
7. Ke konfiguraci jednotného přihlašování na **IBM OpenPages** straně, je nutné odeslat na stažený **soubor XML s metadaty** k [tým podpory IBM OpenPages](https://www.ibm.com/support/home/). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

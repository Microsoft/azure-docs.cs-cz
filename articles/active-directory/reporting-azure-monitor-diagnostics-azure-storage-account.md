...
4. V podokně **Nastavení diagnostiky** proveďte jednu z následujících akcí:
    ...
    * Pokud chcete přidat nové nastavení, vyberte **Přidat nastavení diagnostiky**.  
    ...
    ![Export nastavení](./media/reporting-azure-monitor-diagnostics-azure-storage-account/ExportSettings.png)
...
11. Vyberte **Uložit** a nastavení se uloží.
    ...
    ![Nastavení diagnostiky](./media/reporting-azure-monitor-diagnostics-azure-storage-account/DiagnosticSettings.png)
...
13. U položky **Protokoly auditu** vyberte **insights-log-audit**. U položky **Protokoly přihlášení** vyberte **insights-logs-signin**.
    ![Účet úložiště](./media/reporting-azure-monitor-diagnostics-azure-storage-account/StorageAccount.png)

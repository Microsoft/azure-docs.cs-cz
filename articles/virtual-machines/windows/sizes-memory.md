...
description: Uvádí různé paměťově optimalizované velikosti k dispozici pro virtuální počítače s Windows v Azure. Uvádí informace o počtu Vcpu, datové disky a síťové adaptéry, jakož i úložiště propustnost a šířku pásma sítě pro velikosti této série.

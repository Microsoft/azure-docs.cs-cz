...
* Můžete povolit uživatelům být automaticky přihlášeni k Spotinst (Single Sign-On) s jejich účty Azure AD.
...
* Podporuje Spotinst **SP a zprostředkovatele identity** jednotné přihlašování zahájené pomocí
...
4. Do vyhledávacího pole zadejte **Spotinst**vyberte **Spotinst** z panelu výsledků klikněte **přidat** tlačítko pro přidání aplikace.
    ...
    ![Spotinst v seznamu výsledků](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurace a otestování služby Azure AD jednotného přihlašování

V této části je konfigurace a testování Azure AD jednotné přihlašování pomocí Spotinst podle testovacího uživatele volá **Britta Simon**.
Pro jednotné přihlašování pro práci je potřeba navázat vztah odkazu mezi uživatele služby Azure AD a související uživatelské v Spotinst.
...
2. **[Konfigurace Spotinst Single Sign-On](#configure-spotinst-single-sign-on)**  – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
3. **[Vytvořit testovacího uživatele Azure AD](#create-an-azure-ad-test-user)**  – Pokud chcete otestovat Azure AD jednotné přihlašování s Britta Simon.
4. **[Přiřadit uživatele Azure AD](#assign-the-azure-ad-test-user)**  – Pokud chcete povolit Britta Simon používat Azure AD jednotného přihlašování.
5. **[Vytvořit testovacího uživatele Spotinst](#create-spotinst-test-user)**  – Pokud chcete mít protějšek Britta Simon Spotinst, který je propojený s Azure AD reprezentace uživatele.
...
1. V [webu Azure portal](https://portal.azure.com/)na **Spotinst** integrace stránce aplikace vyberte **jednotného přihlašování**.
...
4. Na **základní konfiguraci SAML** části, pokud chcete nakonfigurovat aplikace v **IDP** iniciované režimu, proveďte následující kroky:
    ...
    ![Spotinst domény a adresy URL jednotného přihlašování – informace](common/idp-preintegrated-relay.png)
...
6. Spotinst aplikace očekává, že kontrolní výrazy SAML v určitém formátu. Nakonfigurujte následující deklarace identity pro tuto aplikaci. Můžete spravovat hodnotami těchto atributů z **atributy uživatele** části na stránce aplikací pro integraci. Na **nastavte si jednotné přihlašování pomocí SAML** klikněte na **upravit** tlačítko Otevřít **atributy uživatele** dialogového okna.
...
9. Na **nastavení Spotinst** tématu, zkopírujte příslušné adresy URL podle vašich požadavků.
...
### <a name="configure-spotinst-single-sign-on"></a>Konfigurace Spotinst jednotné přihlašování

1. V okně jiné webové prohlížeče Přihlaste se k Spotinst jako správce zabezpečení.

2. Klikněte na **ikonu uživatele** v horní pravé straně obrazovky a klikněte na tlačítko **nastavení**.

    ![Nastavení Spotinst](./media/spotinst-tutorial/tutorial_spotinst_settings.png)

3. Klikněte na **zabezpečení** kartě v horní části a pak vyberte **zprostředkovatelé Identity** a proveďte následující kroky:

    ![Spotinst zabezpečení](./media/spotinst-tutorial/tutorial_spotinst_security.png)

    a. Kopírovat **stav přenosu** hodnotu pro vaši instanci a vložte ji **stav přenosu** textového pole v **základní konfiguraci SAML** části na webu Azure portal.
...
1. Na webu Azure Portal, vyberte **podnikové aplikace**vyberte **všechny aplikace**a pak vyberte **Spotinst**.

    ![Okno aplikace organizace](common/enterprise-applications.png)

2. V seznamu aplikací vyberte **Spotinst**.

    ![Odkaz Spotinst v seznamu aplikací](common/all-applications.png)
...
### <a name="create-spotinst-test-user"></a>Vytvoření Spotinst testovacího uživatele

Cílem této části je vytvořte uživatele Britta Simon v Spotinst.

1. Pokud jste nakonfigurovali v aplikaci **SP** iniciované režimu, proveďte následující kroky:

   a. V okně jiné webové prohlížeče Přihlaste se k Spotinst jako správce zabezpečení.
...
2. Pokud jste nakonfigurovali v aplikaci **IDP** iniciované režim, zde je položky žádná akce vám v této části. Spotinst podporuje just-in-time zřizování, který je ve výchozím nastavení povolená. Nový uživatel se vytvoří během pokusu o přístup k Spotinst, pokud ještě neexistuje.

### <a name="test-single-sign-on"></a>Test jednotného přihlašování 

V této části Testování služby Azure AD jednotné přihlašování – konfigurace pomocí přístupového panelu.

Po kliknutí na dlaždici Spotinst na přístupovém panelu, můžete by měl být automaticky přihlášeni k Spotinst, u kterého nastavíte jednotné přihlašování. Další informace o přístupovém panelu, naleznete v tématu [Úvod k přístupovému panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

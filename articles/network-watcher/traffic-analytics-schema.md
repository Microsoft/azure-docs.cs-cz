...
| NSGRules_s | \<hodnota indexu 0) >\|\<NSG_RULENAME >\|\<směr toku >\|\<toku stav >\|\<FlowCount ProcessedByRule > |  Pravidlo NSG, které povoluje nebo zakázalo tento tok |
...
1. K některým názvům polí se připojí \_s nebo \_d. Tyto hodnoty neznamenají zdroj a cíl, ale označují datový typ String a Decimal.

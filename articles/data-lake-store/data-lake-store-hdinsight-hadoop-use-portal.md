...
### <a name="configure-file-permissions"></a>Konfigurace oprávnění k souborům
...
## <a name="verify-cluster-set-up"></a>Ověřit instalaci clusteru
...
* `adl://hdiadlsg1storage.azuredatalakestore.net/` je kořen Data Lake Storage Gen1 účtu.

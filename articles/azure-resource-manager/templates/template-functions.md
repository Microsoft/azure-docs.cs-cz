...
* [Zprostředkovatelé](template-functions-resource.md#providers)
* [Referenční dokumentace](template-functions-resource.md#reference)
* [resourceGroup](template-functions-resource.md#resourcegroup)
* [ID prostředku](template-functions-resource.md#resourceid)
* [předplatné](template-functions-resource.md#subscription)

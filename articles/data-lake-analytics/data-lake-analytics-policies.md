...
description: Naučte se používat zásady k řízení využití Data Lake Analytics účtu, jako je například maximální Austrálie a maximální počet úloh.
...
ms.locfileid: "71672866"
---
# <a name="manage-azure-data-lake-analytics-using-policies"></a>Správa Azure Data Lake Analytics s využitím zásad

Pomocí zásad účtu můžete řídit, jak se budou používat prostředky Azure Data Lake Analytics účet. Tyto zásady umožňují řídit náklady na používání Azure Data Lake Analytics. Díky těmto zásadám můžete například zabránit neočekávaným špičkám nákladů tím, že omezíte počet jednotek Austrálie, které může účet současně používat.
...
Když vaši uživatelé spouštějí úlohy U-SQL, Služba Data Lake Analytics uchová všechny související soubory. Mezi související soubory patří skript U-SQL, soubory DLL, na které odkazuje skript U-SQL, zkompilované prostředky a statistiky. Soubory jsou ve složce/System/výchozího účtu Azure Data Lake Storage. Tato zásada určuje, jak dlouho se tyto prostředky ukládají, než se automaticky odstraní (výchozí hodnota je 30 dní). Tyto soubory můžete použít k ladění a k optimalizaci výkonu úloh, které v budoucnu znovu spustíte.
...
U každého účtu je nastavená výchozí zásada. Výchozí zásady platí pro všechny uživatele účtu. Můžete nastavit další zásady pro konkrétní uživatele a skupiny. 
...
* [Blogový příspěvek zásad na úrovni účtu](https://blogs.msdn.microsoft.com/azuredatalake/2017/06/08/managing-your-azure-data-lake-analytics-compute-resources-account-level-policy/)
* [Blogový příspěvek zásad na úrovni úlohy](https://blogs.msdn.microsoft.com/azuredatalake/2017/06/08/managing-your-azure-data-lake-analytics-compute-resources-job-level-policy/)

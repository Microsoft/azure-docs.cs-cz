...
| ---- | ----------- | -------- | -------------- | ---------------- |
| Tabulka | Pokud vyberete možnost tabulka jako vstup, tok dat načte všechna data z tabulky zadané v datové sadě. | No | - |- |
...
| Velikost dávky | Určete velikost dávky pro velké objemy dat v čtení. | No | Integer | batchSize |

...
1. V **vytvořit databázi SQL** formuláři zadejte nebo vyberte následující hodnoty: 
...
1. V části **Server**vyberte **vytvořit nový**. 
...
1. Zadejte *myResourceGroup* v poli a pak vyberte **odstranit**.

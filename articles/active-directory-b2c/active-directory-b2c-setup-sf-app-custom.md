...
Tento článek ukazuje, jak povolit přihlášení pro uživatele ze služby Salesforce organizace používá [vlastní zásady](active-directory-b2c-overview-custom.md) v Azure Active Directory (Azure AD) B2C.

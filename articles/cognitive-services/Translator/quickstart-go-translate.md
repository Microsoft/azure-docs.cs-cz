---
title: 'Rychlý start: Překlad textu, Go – Translator Text API'
...
ms.locfileid: "49648305"
---
# <a name="quickstart-translate-text-with-the-translator-text-rest-api-go"></a>Rychlý start: Překlad textu pomocí rozhraní REST API služby Translator Text (Go)

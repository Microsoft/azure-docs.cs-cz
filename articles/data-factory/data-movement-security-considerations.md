...
Pokud vás zajímá dodržování předpisů Azure a způsob, jakým Azure zabezpečuje svou vlastní infrastrukturu, přejděte na web [Microsoft Trust Center](https://microsoft.com/trustcenter/default.aspx). Poslední seznam všech kontrol nabídek dodržování předpisů Azure –  https://aka.ms/AzureCompliance .
...
### <a name="firewall-configurations-and-allow-list-setting-up-for-ip-addresses"></a>Nastavení konfigurace brány firewall a povolení seznamu povolených IP adres

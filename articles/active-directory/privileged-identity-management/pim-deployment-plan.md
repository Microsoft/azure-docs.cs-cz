...
| Správce helpdesku | znak | znak | :heavy_check_mark: | znak | Žádné | 8 Hour | Žádné |
...
| Přispěvatel virtuálních počítačů | znak | :heavy_check_mark: | znak | Žádné | 3 Hour | Žádné | – | 6 měsíců |

---
title: Ovládací prvky ukázkového plánu ISO 27001
description: Mapování řízení ukázky podrobného plánu ISO 27001. Každý ovládací prvek je mapován na jednu nebo více zásad Azure, které pomáhají s hodnocením.
ms.date: 01/13/2020
ms.topic: sample
...
ms.locfileid: "75920573"
---
# <a name="control-mapping-of-the-iso-27001-blueprint-sample"></a>Mapování řízení ukázky podrobného plánu ISO 27001

V následujícím článku je podrobně popisuje, jak azure plány ISO 27001 podrobný plán ukázka mapuje na ovládací prvky ISO 27001. Další informace o ovládacích prvcích naleznete v [tématu ISO 27001](https://www.iso.org/isoiec-27001-information-security.html).
...
Nyní, když jste zkontrolovali mapování ovládacích prvku plánu ISO 27001, navštivte následující články, kde se dozvíte o architektuře a o tom, jak nasadit tuto ukázku:

> [!div class="nextstepaction"]
> [Plán ISO 27001 – přehled](./index.md)
> [podrobného plánu ISO 27001 – Nasazení kroků](./deploy.md)

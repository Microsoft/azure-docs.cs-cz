---
title: 'Kurz: Integrace Azure Active Directory se službou SafetyNet | Dokumentace Microsoftu'
...
ms.locfileid: "39041156"
---
# <a name="tutorial-azure-active-directory-integration-with-safetynet"></a>Kurz: Integrace Azure Active Directory se službou SafetyNet
...
4. Do vyhledávacího pole zadejte **SafetyNet**vyberte **SafetyNet** z panelu výsledků klikněte **přidat** tlačítko pro přidání aplikace.
...
3. **[Vytvoření zkušebního uživatele SafetyNet](#create-a-safetynet-test-user)**  – Pokud chcete mít protějšek Britta Simon SafetyNet, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **SafetyNet domény a adresy URL** části, proveďte následující kroky, pokud chcete nakonfigurovat aplikace v **IDP** iniciované režimu:
...
7. Ke konfiguraci jednotného přihlašování na **SafetyNet** straně, je nutné odeslat **adresa Url federačních metadat aplikace** k [tým podpory SafetyNet](mailto:dev@predictivesolutions.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

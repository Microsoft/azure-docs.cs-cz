...
description: Popisuje funkce, které se použijí v šabloně Azure Resource Manager (šablona ARM) pro práci s poli.
ms.topic: conceptual
ms.date: 11/18/2020
...
ms.locfileid: "96920539"
---
# <a name="array-functions-for-arm-templates"></a>Funkce pole pro šablony ARM

Správce prostředků poskytuje několik funkcí pro práci s poli v šabloně Azure Resource Manager (šablona ARM):
...
| Parametr | Povinné | Typ | Popis |
|:--- |:--- |:--- |:--- |
| args |Ne |Řetězec, celé číslo, pole nebo objekt |Hodnoty v poli. |
...
Další informace o použití této funkce s polem naleznete v tématu [iterace prostředků v šablonách ARM](copy-resources.md).

---
title: 'Azure Cosmos DB: Rozhraní Java API hromadného vykonavatele, sada SDK & prostředky'
description: Přečtěte si vše o hromadné vykonavatel Java API a SDK, včetně data vydání, data odchodu do důchodu a změny provedené mezi jednotlivými verzemi Hromadné vykonavatel Azure Cosmos DB Java SDK.
author: tknandu

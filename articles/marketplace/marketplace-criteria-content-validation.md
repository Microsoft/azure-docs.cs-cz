...
| 2 | Technické informace: Konfigurace |<br>• Pro aplikaci SaaS, zvolte, jestli chcete jenom uvedení vaší aplikace nebo pokud chcete zákazníkům umožnit, aby vaše aplikace prostřednictvím Azure zakoupit.<br>• Vyberte odpovídající text, který má na tlačítku pro získání vaší nabídky: Zdarma, bezplatná zkušební verze nebo kontaktujte mě<br>• Pouze vyberte (v místním okně) – jednu z těchto podporovaných produktů, pokud vaše aplikace využívá technologie: Cortana Intelligence, Power BI Solution šablony, Power Apps |  |
...
| 4 | Prezentace podrobnosti: Souhrn nabídky | Tím se zobrazí na stránce hledání vaší aplikace s délkou maximálně 100 znaků. | |
| 5 | Prezentace podrobnosti: Odvětví | Obory (maximální velikost 2): Vyberte odvětví, vaše aplikace bude nejlépe zarovnané a pro. | |

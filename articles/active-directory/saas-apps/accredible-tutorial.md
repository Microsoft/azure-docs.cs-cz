...
2. **[Nakonfigurujte jednotné přihlašování Accredible](#configure-accredible-single-sign-on)** – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
...
### <a name="configure-accredible-single-sign-on"></a>Konfigurace jednotného přihlašování Accredible
...
Když na přístupovém panelu kliknete na dlaždici Accredible, měli byste se automaticky přihlásit k Accredible, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

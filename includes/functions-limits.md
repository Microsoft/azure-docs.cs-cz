...
ms.locfileid: "74224364"
---
| Prostředek | [Consumption plan](../articles/azure-functions/functions-scale.md#consumption-plan) | [Premium plan](../articles/azure-functions/functions-scale.md#premium-plan) | [App Service plan](../articles/azure-functions/functions-scale.md#app-service-plan)<sup>1</sup> |
| --- | --- | --- | --- |
| Horizontální navýšení kapacity | Event driven | Event driven | [Manual/autoscale](../articles/app-service/manage-scale-up.md) | 
...
| Max query string length<sup>4</sup> | 4 096 | 4 096 | 4 096 |
...
| [Plány služby App Service](../articles/app-service/overview-hosting-plans.md) | 100 per [region](https://azure.microsoft.com/global-infrastructure/regions/) |100 per resource group |100 per resource group |

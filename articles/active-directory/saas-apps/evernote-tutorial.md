---
title: 'Kurz: Azure Active Directory integrace jednotného přihlašování s Evernote | Microsoft Docs'
...
ms.locfileid: "71121628"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-evernote"></a>Kurz: Azure Active Directory integrace jednotného přihlašování s Evernote

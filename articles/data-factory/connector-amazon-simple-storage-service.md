...
| Předpona                   | Předpona pro S3 klíče objektu v rámci dané sady nakonfigurované v datové sadě na filtr zdrojové objekty. Objekty, jejichž klíče začínat touto předponou vybráno. <br>Platí pouze tehdy, když `wildcardFolderPath` a `wildcardFileName` nejsou zadané vlastnosti. | Ne                                                          |

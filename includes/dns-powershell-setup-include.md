...
Otevřete konzolu prostředí PowerShell a připojte se ke svému účtu. Další informace najdete v tématu [přihlášení](/azure/install-az-ps.md?view=azps-1.2.0#sign-in).

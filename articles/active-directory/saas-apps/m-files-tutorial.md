...
4. Do vyhledávacího pole zadejte **M soubory**.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/m-files-tutorial/tutorial_m-files_search.png)

5. Na panelu výsledků vyberte **M soubory**a potom klikněte na **přidat** tlačítko Přidat aplikaci.

    ![Vytváření testovacího uživatele Azure AD](./media/m-files-tutorial/tutorial_m-files_addfromgallery.png)
...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Konfigurovat jednotné přihlašování](./media/m-files-tutorial/tutorial_m-files_samlbase.png)

3. Na **M soubory domény a adresy URL** část, proveďte následující kroky:

    ![Konfigurovat jednotné přihlašování](./media/m-files-tutorial/tutorial_m-files_url.png)
...
4. Na **SAML podpisový certifikát** klikněte na tlačítko **soubor XML s metadaty** a potom uložte soubor metadat ve vašem počítači.
    ...
    ![Konfigurovat jednotné přihlašování](./media/m-files-tutorial/tutorial_m-files_certificate.png) 

5. Klikněte na tlačítko **Uložit** tlačítko.

    ![Konfigurovat jednotné přihlašování](./media/m-files-tutorial/tutorial_general_400.png)
...
8. Otevřete **nastavení plochy M soubory** okno. Potom klikněte na **přidat**.
    ...
    ![Konfigurovat jednotné přihlašování](./media/m-files-tutorial/tutorial_m_files_10.png)

9. Na **vlastnosti připojení trezoru dokumentu** okno, proveďte následující kroky:
   
    ![Konfigurovat jednotné přihlašování](./media/m-files-tutorial/tutorial_m_files_11.png)  
...
1. V **portál Azure**, v levém navigačním podokně klikněte na tlačítko **Azure Active Directory** ikonu.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/m-files-tutorial/create_aaduser_01.png) 

2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin** a klikněte na tlačítko **všichni uživatelé**.
    
    ![Vytváření testovacího uživatele Azure AD](./media/m-files-tutorial/create_aaduser_02.png) 

3. Chcete-li otevřít **uživatele** dialogové okno, klikněte na tlačítko **přidat** horní dialogové okno.
 
    ![Vytváření testovacího uživatele Azure AD](./media/m-files-tutorial/create_aaduser_03.png) 

4. Na **uživatele** dialogové okno stránky, proveďte následující kroky:
 
    ![Vytváření testovacího uživatele Azure AD](./media/m-files-tutorial/create_aaduser_04.png) 
...
2. V seznamu aplikací vyberte **M soubory**.
    ...
    ![Konfigurovat jednotné přihlašování](./media/m-files-tutorial/tutorial_m-files_app.png) 

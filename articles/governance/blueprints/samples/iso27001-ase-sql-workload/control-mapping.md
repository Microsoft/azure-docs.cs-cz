---
title: Ovládací prvky ukázkového plánu úlohy ISO 27001 ASE/SQL
description: Řízení mapování ISO 27001 App Service prostředí /SQL database plán pracovního vytížení ukázku zásad Azure a RBAC.
ms.date: 01/13/2020
ms.topic: sample
...
---
# <a name="control-mapping-of-the-iso-27001-asesql-workload-blueprint-sample"></a>Mapování ovládacího prvku ukázky plánu úlohy ase/SQL iso 27001

V následujícím článku je podrobně popisuje, jak se ukázka podrobného plánu úlohy Azure ISO 27001 ASE/SQL na ovládací prvky ISO 27001. Další informace o ovládacích prvcích naleznete v [tématu ISO 27001](https://www.iso.org/isoiec-27001-information-security.html).
...
- \[Náhled\]: Auditovat minimální počet vlastníků pro předplatné
...
Teď, když jste zkontrolovali mapování ovládacích prvku iso 27001 App Service prostředí nebo SQL Database pracovního plánu ukázku, navštivte následující články se dozvíte o architektuře a jak nasadit tuto ukázku:

> [!div class="nextstepaction"]
> [ISO 27001 App Service Environment/SQL Database ústuz – přehled](./index.md)
> [ISO 27001 App Service Environment/SQL Database plán pracovního vytížení – nasazení kroků](./deploy.md)

---
title: Ukázky Jupyter poznámkových bloků pro Azure Notebooks Preview
...
- Některé poznámkové bloky vyžadují ke spuštění konkrétní balíčky. I když můžete použít `!pip install` (Python) nebo `install.packages` (R) k instalaci balíčků z samotného poznámkového bloku, můžete také [nakonfigurovat Azure Notebooks projekt s příslušným prostředím](configure-manage-azure-notebooks-projects.md).

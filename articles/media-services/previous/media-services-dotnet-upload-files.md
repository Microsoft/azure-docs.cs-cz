...
ms.locfileid: "55984218"
---
# <a name="upload-files-into-a-media-services-account-using-net-legacy"></a>Nahrání souborů do účtu Media Services pomocí rozhraní .NET (starší verze)

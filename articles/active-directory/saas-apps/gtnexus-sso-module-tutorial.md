...
V této části vytvoříte uživatele s názvem Britta Simon v systému GTNexus SSO. Pracujte s  [týmu podpory GTNEXUS SSO](mailto:support@gtnexus.com) k přidávání uživatelů na GTNexus systémové platformě jednotného přihlašování. Před použitím jednotného přihlašování je nutné vytvořit a aktivovat uživatele.

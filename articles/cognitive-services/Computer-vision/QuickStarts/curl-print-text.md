---
title: 'Úvodní příručka: Extrahování tištěného textu - REST, cURL'
...
ms.locfileid: "81405069"
---
# <a name="quickstart-extract-printed-text-ocr-using-the-computer-vision-rest-api-and-curl"></a>Úvodní příručka: Extrahování tištěného textu (OCR) pomocí rozhraní API PRO ZPRACOVÁNÍ POČÍTAČE A CURL

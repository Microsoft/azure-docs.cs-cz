...
| `speechToText.verification.enabled` | Určuje, `helm test` jestli je povolená možnost pro službu **Převod řeči na text** . | `true` |
...
| `textToSpeech.verification.enabled` | Určuje, `helm test` jestli je povolená možnost pro službu **Převod řeči na text** . | `true` |

...
| Velikost filtrů nebo akcí SQL |Obor názvů |Následné žádosti o vytvoření dalších filtrů jsou odmítnuty a volající kód obdrží výjimku. |Maximální délka řetězce podmínky filtru: 1,024 (1 K).<br /><br />Maximální délka řetězce akce pravidla: 1,024 (1 K).<br /><br />Maximální počet výrazů na akci pravidla: 32. |

...
|Microsoft.Compute/virtualMachineScaleSets | Ano | Ne |[Škálovací sady virtuálních počítačů](./metrics-supported.md#microsoftcomputevirtualmachinescalesets) |
...
<sup>1</sup> podporuje se jenom pro metriky platformy (nejedná se o vlastní metriky).

...
6. Klikněte na **zřizování uživatelů** a pak klikněte na **vytvořit adresář**. Zkopírujte **základní adresu URL adresáře** a **nosný token** do polí **Adresa URL tenanta** a **tajného tokenu** v uvedeném pořadí.
    ...
    ![](./media/atlassian-cloud-provisioning-tutorial/secret-token-1.png) ![Zřizování cloudu Atlassian Atlassian](./media/atlassian-cloud-provisioning-tutorial/secret-token-2.png) ![Cloud zřizování Atlassian cloudu](./media/atlassian-cloud-provisioning-tutorial/secret-token-3.png)
...
15. Pokud chcete nakonfigurovat filtry oborů, přečtěte si následující pokyny uvedené v [kurzu filtr oboru](../app-provisioning/define-conditional-rules-for-provisioning-user-accounts.md).

...
1. Klíč předplatného můžete získat z webu Azure portal v jednom ze dvou způsobů:
    ...
    * Přejděte [webu Azure portal](https://ms.portal.azure.com), a přidání nového rozhraní Cognitive Services API tak, že _Cognitive Services_ a následným výběrem **Cognitive Services APIs**.

...
2. **[Nakonfigurujte jednotné přihlašování QuickHelp](#configure-quickhelp-single-sign-on)** – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
...
### <a name="configure-quickhelp-single-sign-on"></a>Konfigurace jednotného přihlašování QuickHelp

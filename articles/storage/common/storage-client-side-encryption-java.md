...
[Klientská knihovna pro úložiště Azure pro Javu](https://mvnrepository.com/artifact/com.microsoft.azure/azure-storage) podporuje šifrování dat v rámci klientské aplikace před nahráním do služby Azure Storage a dešifrování dat při stahování do klienta. Knihovna také podporuje integraci s [Azure Key Vault](https://azure.microsoft.com/services/key-vault/) pro správu klíčů účtu úložiště.
...
Stažení objektu blob šifrované zahrnuje načítání obsahu z celý objekt blob pomocí **Stáhnout**/**openInputStream** vhodné metody. Zabalené CEK je neobalený a používá se společně s IV (uložené v tomto případě jako metadata objektu blob) k vrácení dešifrovaná data pro uživatele.
...
* Stáhněte si [Klientská knihovna pro úložiště Azure pro jazyk Java Maven balíček](https://mvnrepository.com/artifact/com.microsoft.azure/azure-storage)  
...
* Stáhněte klíč trezoru Maven knihovnu služby Azure pro jazyk Java Maven balíčky:
  * [Základní](https://mvnrepository.com/artifact/com.microsoft.azure/azure-keyvault-core) balíčku
  * [Klient](https://mvnrepository.com/artifact/com.microsoft.azure/azure-keyvault) balíčku

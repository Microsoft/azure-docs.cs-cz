...
* **Klientský počítač Windows s Azure Powershellem 0.8.10 nebo novější nainstalován a nakonfigurován**: Zobrazit [Začínáme s Azure Powershellem](/powershell/azureps-cmdlets-docs) pokyny k instalaci a kroky pro připojení k vašemu předplatnému Azure.

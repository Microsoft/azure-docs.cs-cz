...
| 22 |Aktualizace |Při použití aktualizace Update 3 se na stránce **Údržba** na portálu Azure Classic zobrazí následující zpráva týkající se aktualizace Update 2 – StorSimple 8000 Series Update 2 zahrnuje možnost, aby Microsoft proaktivně shromáždili informace protokolu ze zařízení, když zjistíme potenciální problémy. To je zavádějící, protože indikuje, že se zařízení aktualizuje na Update 2. Po úspěšné aktualizaci zařízení na aktualizaci 3 bude tato zpráva zmizet. |Toto chování bude opraveno v budoucí verzi. |Ano |No |

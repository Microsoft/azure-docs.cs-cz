...
4. **Azure Resource Manager** -správce prostředků v podstatě poskytuje logickou izolaci komponent napříč oblastmi. To znamená, že logická selhání v jedné oblasti mají méně pravděpodobný dopad na jiné.

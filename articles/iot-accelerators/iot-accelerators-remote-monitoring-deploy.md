...
Teď, když jste nasadili řešení vzdáleného monitorování, dalším krokem je [prozkoumejte možnosti řídicí panel řešení](./../iot-suite/iot-suite-remote-monitoring-explore.md).

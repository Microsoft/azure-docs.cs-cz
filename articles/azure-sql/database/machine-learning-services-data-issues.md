...
Tento článek popisuje některé běžné problémy, se kterými se můžete setkat při přesouvání dat mezi R a Azure SQL Database v [Machine Learning Services (s r) v Azure SQL Database](machine-learning-services-overview.md). Prostředí, které získáte prostřednictvím tohoto cvičení, poskytuje základní pozadí při práci s daty ve vlastním skriptu.

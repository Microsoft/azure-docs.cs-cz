...
Účet úložiště s Data Lake Storage Gen2 funkce se používá jako datové vrstvě v tomto rychlém startu. S jeho hierarchického oboru názvů služby a [Hadoop ovladač](abfs-driver.md), Data Lake Storage Gen2 je optimalizovaná pro distribuované zpracování a analýzu. Data uložená v účtu úložiště, který má povolené Data Lake Storage Gen2 přetrvává i po odstranění clusteru služby HDInsight.

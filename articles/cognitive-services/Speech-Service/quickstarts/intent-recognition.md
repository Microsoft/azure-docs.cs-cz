---
title: 'Úvodní příručka: Rozpoznání řeči, záměrů a entit – služba Řeč'
titleSuffix: Azure Cognitive Services
description: V tomto rychlém startu použijete sadu Speech SDK k interaktivnímu rozpoznání řeči ze zvukových dat zachycených z mikrofonu.
...
ms.locfileid: "76900471"
---
# <a name="quickstart-recognize-speech-intents-and-entities-with-language-understanding-luis"></a>Úvodní příručka: Rozpoznávání řeči, záměrů a entit pomocí funkce Language Understanding (LUIS)

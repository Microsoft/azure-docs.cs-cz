...
Další informace o souvisejících požadavky GDPR připojení Azure AD, najdete v článku [v tomto článku](active-directory-aadconnect-gdpr.md).

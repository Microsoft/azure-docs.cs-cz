...
Pokud trezoru klíčů, můžete je vytvořit z portálu, Powershellu nebo rozhraní příkazového řádku:
...
Pokud používáte existujícího trezoru klíčů, je potřeba povolit obnovitelné odstranění a provést odstranění není ve vašem trezoru spuštěním následujících příkazů Powershellu nebo rozhraní příkazového řádku Azure:
...
Musíte mít v daném trezoru klíčů služby key vault a klíči. Chcete-li určit klíč ze služby key vault, postupujte takto:

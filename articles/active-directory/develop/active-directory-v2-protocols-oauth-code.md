...
![Tok kódu ověřování OAuth](../../media/active-directory-v2-flows/convergence_scenarios_native.png)
...
| scope                 | povinné    | Místo oddělený seznam [obory](active-directory-v2-scopes.md) , že má uživatel vyjádřit souhlas.           |
...
> [!TIP]
> Pokuste se spustit tuto žádost do Postman! (Nezapomeňte nahradit `code`) [ ![spustit v nástroji Postman](./media/active-directory-v2-protocols-oauth-code/runInPostman.png)](https://app.getpostman.com/run-collection/8f5715ec514865a07e6a)
> 
> 
...
> [!TIP]
> Provedení tohoto požadavku v nástroji Postman! (Nahradit `Authorization` záhlaví první) [ ![spustit v nástroji Postman](./media/active-directory-v2-protocols-oauth-code/runInPostman.png)](https://app.getpostman.com/run-collection/8f5715ec514865a07e6a)
> 
> 
...
> [!TIP]
> Pokuste se spustit tuto žádost do Postman! (Nezapomeňte nahradit `refresh_token`) [ ![spustit v nástroji Postman](./media/active-directory-v2-protocols-oauth-code/runInPostman.png)](https://app.getpostman.com/run-collection/8f5715ec514865a07e6a)
> 
> 

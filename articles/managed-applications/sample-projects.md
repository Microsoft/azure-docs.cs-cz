...
| --- | --- |
| **Příklady** | |
| [Spravované aplikace (zkušební verze nebo produkční) do nové nebo existující virtuální síť](https://github.com/Azure/azure-managedapp-samples/tree/master/samples/201-managed-app-using-existing-vnet) | Ukazuje, jak můžete vytvořit flexibilní možnosti nasazení pro zákazníky. Této spravované aplikaci můžete nasadit nové virtuální sítě nebo existující virtuální síť. Zákazníci můžete zadat zkušební verze nebo produkční verzi spravovaných aplikací. |

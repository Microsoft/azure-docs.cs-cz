...
|[Python](../articles/azure-functions/functions-reference-python.md#python-version)|–|GA (Python 3,7 & 3,6)| GA (Python 3,8, 3,7, & 3,6)|
|[TypeScript](../articles/azure-functions/functions-reference-node.md#typescript) |–|GA<sup>*</sup>| GA<sup>*</sup> |

<sup>*</sup> Podporováno prostřednictvím transpiling do JavaScriptu.

...
1. Chcete-li zobrazit protokoly aktivit prostřednictvím portálu, vyberte možnost **monitor**.
    ...
    ![Vybrat monitorování](./media/resource-group-audit/select-monitor.png)
...
1. Filtr je k dispozici na řídicím panelu.

    ![Zobrazit filtr na řídicím panelu](./media/resource-group-audit/show-dashboard.png)

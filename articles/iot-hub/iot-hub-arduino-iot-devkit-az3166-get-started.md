...
1. Klikněte na tlačítko `F1` otevřete paletu příkazů, typ a vyberte **IoT Workbench: zařízení**a pak vyberte **nastavení konfigurace zařízení > Vyberte připojovací řetězec zařízení IoT Hub**.

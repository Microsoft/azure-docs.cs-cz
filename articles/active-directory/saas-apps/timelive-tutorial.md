...
2. **[Nakonfigurujte jednotné přihlašování TimeLive](#configure-timelive-single-sign-on)** – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
...
3. V části **předvoleb aplikace** proveďte následující kroky:
    ...
    c. V rozevírací nabídce vyberte **SAML** s nadpisem **přihlášení pomocí jednotného přihlašování (SSO) s**.

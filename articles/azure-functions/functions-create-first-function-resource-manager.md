...
[Vytvoření projektu místní funkce v Visual Studio Code](functions-create-first-function-vs-code.md#create-an-azure-functions-project)
...
[Vytvoření projektu místní funkce z příkazového řádku](functions-create-first-azure-function-azure-cli.md#create-a-local-function-project)
...
1. Po dokončení publikování zkopírujte **adresu URL webu**.
    ...
    :::image type="content" source="media/functions-create-first-function-arm/publish-summary-site-url.png" alt-text="Zvolit existující cíl publikování":::

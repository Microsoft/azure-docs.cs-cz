...
2. **[Konfigurace modulu plug-in SAML SSO vaší instance JIRA](#configure-the-saml-sso-plugin-of-your-jira-instance)** – nakonfigurujte nastavení jednotného přihlašování na straně aplikace.
...
Můžete také otestovat jednotné přihlašování, pokud přejdete na [https://\<Server-Base-url >/plugins/servlet/samlsso](https://\<server-base-url>/plugins/servlet/samlsso). Nahraďte **\<Server-Base-url >** základní adresou URL vaší instance JIRA.
...
Po aktivaci možnosti se zobrazí výzva k zadání uživatelského jména a hesla, pokud je možnost **Povolit Nosso** zapnutá, a to tak, že přejdete na [https://\<Server-base-URL >/Login.jsp? Nosso](https://\<server-base-url>/login.jsp?nosso). Stejně jako vždy nahraďte **\<Server-Base-url >** základní adresou URL.

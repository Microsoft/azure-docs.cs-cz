...
| Monitorování kanálu předpokladů: Pouze 1 spuštění došlo k chybě | 2 spuštění sledování záznamů opakovat (1 pro spuštění, 1 pro spuštění aktivity kanálu) |
...
| Kopírování dat z předpokladu: spuštění = 10 minut | 10 \* 4 prostředí azure Integration Runtime (výchozí nastavení DIÚ = 4) Další informace o jednotkách integrace dat a optimalizace výkonu kopírování najdete v tématu [v tomto článku](copy-activity-performance.md) |
| Monitorování kanálu předpokladů: Pouze 1 spuštění došlo k chybě | 3 monitorování spouštění záznamy opakovat (1 pro spuštění, 2 pro spuštění aktivity kanálu) |
...
| Kopírování dat z předpokladu: spuštění = 10 minut | 10 \* 4 prostředí azure Integration Runtime (výchozí nastavení DIÚ = 4) Další informace o jednotkách integrace dat a optimalizace výkonu kopírování najdete v tématu [v tomto článku](copy-activity-performance.md) |
| Monitorování kanálu předpokladů: Pouze 1 spuštění došlo k chybě | 4 monitorování spouštění záznamy opakovat (1 pro spuštění, 3 pro spuštění aktivity kanálu) |

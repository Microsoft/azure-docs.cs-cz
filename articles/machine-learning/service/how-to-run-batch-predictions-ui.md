...
1. Pokud ještě nemáte předplatné Azure, vytvořte si bezplatný účet před tím, než začnete. Vyzkoušejte [bezplatnou nebo placená verzi služby Azure Machine Learning](https://aka.ms/AMLFree).
...
![Domovská stránka Návrháře](media/how-to-run-batch-predictions-ui/ui-batch-scoring-1.png)
...
![Vytvoření jednoduchého experimentu](media/how-to-run-batch-predictions-ui/ui-batch-scoring-2.png)
...
![Vytvořit kanál odvození dávky](media/how-to-run-batch-predictions-ui/ui-batch-scoring-5.png)
...
![Výchozí odvozený kanál dávky](media/how-to-run-batch-predictions-ui/ui-batch-scoring-6.png)
...
![Nový uzel](media/how-to-run-batch-predictions-ui/ui-batch-scoring-7.png)
...
![Ukázková nastavení](media/how-to-run-batch-predictions-ui/ui-batch-scoring-8.png)

Dále zadejte název a výchozí hodnotu parametru. Název bude použit k identifikaci parametru a jeho určení ve volání REST.

![Parametr kanálu](media/how-to-run-batch-predictions-ui/ui-batch-scoring-9.png)
...
![Nasazení kanálu](media/how-to-run-batch-predictions-ui/ui-batch-scoring-10.png)
...
![Koncový bod instalace](media/how-to-run-batch-predictions-ui/ui-batch-scoring-11.png)
...
![Odkaz na koncový bod](media/how-to-run-batch-predictions-ui/ui-batch-scoring-12.png)
...
![Odvození kanálu](media/how-to-run-batch-predictions-ui/ui-batch-scoring-13.png)
...
![Podrobnosti kanálu](media/how-to-run-batch-predictions-ui/ui-batch-scoring-14.png)
...
![Spuštění kanálu](media/how-to-run-batch-predictions-ui/ui-batch-scoring-15.png)

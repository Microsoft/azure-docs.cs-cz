...
Předplatná (nebo skupiny prostředků v rámci předplatného) se dají připojit ke správě delegovaných prostředků Azure, a to buď nasazením šablon Azure Resource Manager, nebo prostřednictvím spravovaných služeb. nabídky se publikují do Azure Marketplace, ať už soukromě, nebo veřejně.

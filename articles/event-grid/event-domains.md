...
Publikování následujícího pole událostí by například odesílalo událost `"id": "1111"` s tématem `foo` v době, kdy se událost, `"id": "2222"` která byla odeslána do tématu `bar`:

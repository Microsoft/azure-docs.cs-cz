...
V následujícím příkladu vidíte, že se během stejné žádosti spouštějí čtyři pravidla (pomocí pole TransactionId). První z nich odpovídá tomu, že uživatel použil pro požadavek číselnou adresu URL, která zvyšuje skóre anomálií o tři, protože se jedná o upozornění. Další pravidlo, které odpovídá, je 942130, což je ten, který hledáte. V poli `details.data` můžete zobrazit *1 = 1* . Tím se ještě třikrát zvyšuje skóre anomálií, protože se jedná i o upozornění. Obecně platí, že každé pravidlo, které **odpovídá** akci, zvyšuje skóre anomálií a v tomto okamžiku bude skóre anomálie šest. Další informace najdete v tématu [režim bodování anomálií](ag-overview.md#anomaly-scoring-mode).
...
Můžete také prostudovat protokoly brány firewall a získat informace, abyste viděli, co je třeba přidat do seznamu vyloučení. Pokud chcete povolit protokolování, přečtěte si téma [stav back-endu, diagnostické protokoly a metriky pro Application Gateway](../../application-gateway/application-gateway-diagnostics.md).

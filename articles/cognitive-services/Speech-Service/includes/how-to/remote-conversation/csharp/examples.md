...
Před provedením asynchronního přepisu je třeba odeslat zvuk do služby přepisu konverzace pomocí sady Microsoft rozpoznávání řeči Client SDK (verze 1.13.0 nebo vyšší).

Tento příklad kódu ukazuje, jak vytvořit konverzaci Transcriber pro režim pouze asynchronního režimu. Aby bylo možné streamovat zvuk do Transcriber, přidáte do v [reálném čase pomocí sady Speech SDK](../../../../how-to-use-conversation-transcription.md)kód streamování zvuku odvozený z konverzací přepisovat. 

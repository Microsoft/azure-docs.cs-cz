...
1. Do příkazového **URI pro přesměrování**zadejte *https://www.microsoft.com* a pak vyberte **Registrovat**. Po vytvoření registrace aplikace se otevře stránka s přehledem.

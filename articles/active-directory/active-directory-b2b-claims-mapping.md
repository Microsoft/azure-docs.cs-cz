...
![Zobrazuje atributy tokenu SAML v uživatelském rozhraní](media/active-directory-b2b-claims-mapping/view-claims-in-saml-token.png)
...
- Informace o vlastnosti uživatele spolupráce B2B najdete v tématu [vlastnosti uživatele spolupráce Azure Active Directory s B2B](active-directory-b2b-user-properties.md).
- Informace o tokeny uživatele pro uživatele spolupráce B2B najdete v tématu [pochopit tokeny uživatele v spolupráce Azure AD B2B](active-directory-b2b-user-token.md).

---
title: Ukázka kódu JSON pro Azure Policy – Povolená šířka pásma pro ExpressRoute | Microsoft Docs
description: Tato ukázková zásada JSON vyžaduje, aby připojení ExpressRoute používala zadaná rozmezí šířky pásma.

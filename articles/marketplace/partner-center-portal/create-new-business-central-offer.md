...
Pokud jste vybrali **Připojit** výše, zadejte adresu URL pro instalaci aplikace zde. U připojených služeb, které nevyžadují instalaci, zadejte adresu URL vstupní stránky služby nebo registrační stránky.

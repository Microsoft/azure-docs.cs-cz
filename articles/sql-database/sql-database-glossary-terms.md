---
title: Azure SQL Database Glosář termínů | Dokumentace Microsoftu
description: Azure SQL Database Glosář termínů
...
||Zajištěno|[úroveň výpočetní prostředí](sql-database-serverless.md)
...
||Databáze Basic|Databáze vytvořené v rámci nebo přesunout na úrovni služby basic nákupní model založený na DTU|
||Standardní databáze|Databáze vytvořené v rámci nebo přesunout do úrovně standard služby nákupní model založený na DTU|
||Databáze úrovně Premium|Databáze vytvořené v rámci nebo přesunout na úroveň služeb premium nákupní model založený na DTU|
...
||virtuální jádro|Základní do hostovaného operačního systému k dispozici na hypervisoru.|
||Úroveň služby|Úroveň služeb v rámci nákupní model|

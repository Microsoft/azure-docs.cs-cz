...
2. **[Nakonfigurujte si centrální jednotné přihlašování pro CERN](#configure-cerner-central-single-sign-on)** , abyste na straně aplikace nakonfigurovali nastavení jednotného přihlašování.
...
### <a name="configure-cerner-central-single-sign-on"></a>Konfigurace centrálního jednotného přihlašování pro CERN
...
Po kliknutí na ústřední dlaždici CERN na přístupovém panelu byste se měli automaticky přihlášeni k centru CERN, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

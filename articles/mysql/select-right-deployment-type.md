...
| Hybridní scénáře | Podporováno s [replikace vstupních dat](https://docs.microsoft.com/azure/mysql/concepts-data-in-replication)| Není k dispozici ve verzi Preview. | Spravováno koncovými uživateli |

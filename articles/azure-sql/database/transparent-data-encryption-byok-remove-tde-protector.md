...
description: Přečtěte si, jak reagovat na potenciálně ohroženou ochranu TDE pro Azure SQL Database nebo Azure synapse Analytics pomocí TDE s podporou Bring Your Own Key (BYOK).

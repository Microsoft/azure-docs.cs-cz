...
| Atributy typu deklarace identity|`ClaimType`|Název typu deklarace identity| Atribut deklarace identity, která se má lokalizovat Možné hodnoty: `AdminHelpText`, `DisplayName`, `PatternHelpText`a `UserHelpText`.|

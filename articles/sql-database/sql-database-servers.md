...
- Výchozí kolace pro všechny databáze vytvořené na `SQL_LATIN1_GENERAL_CP1_CI_AS`serveru SQL Database je, kde `LATIN1_GENERAL` English (USA) `CP1` je znaková stránka 1252, `CI` rozlišuje velká a malá písmena a `AS` je citlivá na znaky.

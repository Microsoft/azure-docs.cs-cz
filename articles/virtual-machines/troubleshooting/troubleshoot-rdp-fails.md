---
title: Protokol RDP nezdaří, pokud žádné licenční server vzdálené plochy je k dispozici k poskytnutí licence v Azure | Dokumentace Microsoftu
...
ms.locfileid: "49989174"
---
# <a name="rdp-fails-if-no-remote-desktop-license-server-is-available-in-azure"></a>Protokol RDP nezdaří, pokud žádné licenční server vzdálené plochy je k dispozici v Azure

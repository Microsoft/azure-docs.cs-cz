...
Zjišťování aplikací je v současné době podporováno pouze pro virtuální počítače VMware. Podpora virtuálních počítačů Hyper-V a fyzických serverů bude v budoucnu povolená.

Zjišťování aplikací vyžaduje zadání přihlašovacích údajů k virtuálnímu počítači v zařízení. Pokud jste v zařízení nezadali přihlašovací údaje k virtuálnímu počítači, nebude zjišťování aplikací fungovat. [Přečtěte si další informace](https://docs.microsoft.com/azure/migrate/migrate-support-matrix-vmware#assessment-vcenter-server-permissions) o přístupových oprávněních potřebných pro vCenter Server a pro virtuální počítače VMware. Pokud jste zadali přihlašovací údaje k virtuálnímu počítači v zařízení a zjišťování aplikací selže, Projděte si následující tabulku a určete příčinu selhání a nápravné akce:

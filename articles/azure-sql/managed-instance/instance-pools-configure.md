...
> [!NOTE]
> Pro kontrolu omezení počtu databází na fond instancí a spravovanou instanci nasazenou v rámci fondu najdete část [omezení prostředků fondu instancí](instance-pools-overview.md#resource-limitations) .

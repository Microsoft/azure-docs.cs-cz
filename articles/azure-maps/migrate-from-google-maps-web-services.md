---
title: Migrace webových služeb z Google Maps | Microsoft Docs
description: V tomto kurzu se naučíte migrovat webové služby z Map Google Maps na Microsoft Azure Maps.
author: rbrundritt
ms.author: richbrun
ms.date: 12/17/2019
ms.topic: conceptual

---
title: 'Kurz: Integrace Azure Active Directory se službou XaitPorter | Dokumentace Microsoftu'
...
ms.locfileid: "39055572"
---
# <a name="tutorial-azure-active-directory-integration-with-xaitporter"></a>Kurz: Integrace Azure Active Directory se službou XaitPorter
...
3. **[Vytvoření zkušebního uživatele XaitPorter](#create-a-xaitporter-test-user)**  – Pokud chcete mít protějšek Britta Simon XaitPorter, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **XaitPorter domény a adresy URL** části, proveďte následující kroky:
...
7. V okně jiné webové prohlížeče Přihlaste se k webu společnosti XaitPorter jako správce.

8. Klikněte na **správce**.

    ![Konfigurace jednotného přihlašování](./media/xaitporter-tutorial/user1.png)

9. Vyberte **spravovat Single Sign-On** z **nastavení systému** rozevíracího seznamu.

    ![Konfigurace jednotného přihlašování](./media/xaitporter-tutorial/user2.png)

10. V **SPRAVOVAT jednotné přihlašování** části, proveďte následující kroky:

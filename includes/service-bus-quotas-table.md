...
| Počet odběrů na téma |Entita |Odeslání dalších žádostí o vytvoření další předplatná tématu odmítají. V důsledku toho pokud je nakonfigurovaný pomocí portálu, se zobrazí chybová zpráva. Pokud volání z rozhraní API pro správu přijme volající kód výjimky. |Úrovně Standard – každé předplatné počítat do kvóty 1000 entit (fronty, témata a odběry) na obor názvů. <br/> <br/> Na úrovni Premium – 2 000 |
...
| Velikost SQL filtry a akcí |Obor názvů |Odeslání dalších žádostí o vytvoření další filtry jsou zamítnuty, obdrží výjimku volající kód. |Maximální délka řetězce podmínka filtru: 1024 (1 KB).<br /><br />Maximální délka řetězce akce pravidla: 1024 (1 KB).<br /><br />Maximální počet výrazů za akce pravidla: 32. |

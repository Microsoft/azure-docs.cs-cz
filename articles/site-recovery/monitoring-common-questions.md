...
### <a name="how-often-does-site-recovery-send-diagnostic-logs-to-azure-monitor-log"></a>Jak často Site Recovery odesílat diagnostické protokoly do protokolu Azure Monitor? 

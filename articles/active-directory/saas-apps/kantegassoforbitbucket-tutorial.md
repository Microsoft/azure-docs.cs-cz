...
5. Na panelu výsledků vyberte **Kantega jednotné přihlašování pro Bitbucket**a potom klikněte na tlačítko **přidat** tlačítko pro přidání aplikace.
...
3. **[Vytváření Kantega jednotné přihlašování pro Bitbucket testovacího uživatele](#creating-a-kantega-sso-for-bitbucket-test-user)**  – Pokud chcete mít protějšek Britta Simon Kantega jednotné přihlašování pro Bitbucketu, který je propojený s Azure AD reprezentace uživatele.
...
3. V **IDP** inicializovat v režimu **Kantega jednotné přihlašování pro Bitbucket domény a adresy URL** části provést následující krok:
...
7. V okně jiné webové prohlížeče Přihlaste se k portálu pro správu vašich Bitbucket jako správce.

8. Klikněte na tlačítko ozubeného kola a kliknutím **najít nové doplňky**.

    ![Konfigurace jednotného přihlašování](./media/kantegassoforbitbucket-tutorial/addon1.png)

9. Hledání **Kantega jednotného přihlašování Bitbucket SAML & protokolu Kerberos** a klikněte na tlačítko **nainstalovat** tlačítko k instalaci nové zásuvný modul SAML.
...
13. Klikněte na tlačítko **konfigurovat** konfigurace nového modulu plug-in.    
...
20. Na **Bitbucket uživatelské účty** části, proveďte následující kroky:
...
3. V části **správu** kartě oddíl, klikněte na tlačítko **uživatelé**.
...
5. Na **vytvořit uživatele** dialogového okna stránky, proveďte následující kroky:

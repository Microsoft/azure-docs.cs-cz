...
Nelze použít `reference` funkce v části výstupů [vnořené šablony](linked-templates.md#nested-template). Na návratové hodnoty pro nasazený prostředek ve vnořené šablony, převeďte vnořené šablony na propojenou šablonu.

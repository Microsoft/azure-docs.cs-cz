---
title: Vývoj pro týmy pomocí Java a Visual Studio Code
...
* Postup provádění jakéhokoli typu integračního testování se bude obtížně provádět. Testování integrace se dá věrohodně provést až po potvrzení, což znamená, že se problémy projeví později ve vývojovém cyklu.
    ...
    ![Diagram, který znázorňuje výzvy, které čelí při vývoji mikroslužeb.](media/common/microservices-challenges.png)
...
![Diagram znázorňující jednoduché nastavení prostoru C I C.](media/common/ci-cd-space-setup.png)
...
Přejít do okna VS Code pro `mywebapi` a provést úpravy kódu `String index()` v metodě v `src/main/java/com/ms/sample/mywebapi/Application.java` , například:

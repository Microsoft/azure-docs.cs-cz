...
|-----------|---------|-------------|--|
|Tvář | 1 core, 2-GB memory | 1 core, 4-GB memory |10, 20|
...
In this article, you learned concepts and workflow for how to download, install, and run Face API containers. Souhrn:

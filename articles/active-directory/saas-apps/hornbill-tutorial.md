...
2. **[Nakonfigurujte jednotné přihlašování Hornbill](#configure-hornbill-single-sign-on)** – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
...
### <a name="configure-hornbill-single-sign-on"></a>Konfigurace jednotného přihlašování Hornbill

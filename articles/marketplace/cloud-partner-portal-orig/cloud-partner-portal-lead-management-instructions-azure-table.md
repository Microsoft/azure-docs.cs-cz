...
Můžete použít [Průzkumníka služby Azure storage](https://azurestorageexplorer.codeplex.com/) nebo jakýkoli jiný nástroj k zobrazení dat v tabulce úložiště. Můžete také exportovat data v tabulce Azure.
data.

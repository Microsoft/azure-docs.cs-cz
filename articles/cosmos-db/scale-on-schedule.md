...
Pro zjednodušení procesu škálování Azure Cosmos DB podle plánu jsme vytvořili ukázkový projekt s názvem [Plánovač propustnosti Azure Cosmos](https://github.com/Azure-Samples/azure-cosmos-throughput-scheduler). Tento projekt je Azure Functions aplikace se dvěma aktivačními událostmi časovače – "ScaleUpTrigger" a "ScaleDownTrigger". Aktivační události spouštějí skript prostředí PowerShell, který nastaví propustnost každého prostředku, jak je definováno v souboru `resources.json` v každé aktivační události. ScaleUpTrigger je nakonfigurována tak, aby běžela v rozmezí od času UTC a ScaleDownTrigger je nakonfigurován tak, aby běžel v 6. UTC a tyto časy lze snadno aktualizovat v `function.json` souboru pro každou Trigger.

---
title: Sledování výkonu pro webové aplikace v jazyce Java v Azure Application Insights (2.5.0-BETA verze) | Microsoft Docs
description: Rozšířené monitorování výkonu a využití vašeho webu Java pomocí Application Insights (2.5.0-BETA).
...
2. Upravte spouštěcí skript aplikačního serveru a přidejte následující JVM ARG:
...
Klíč: `JAVA_OPTS`Osa`-javaagent:D:/home/site/wwwroot/applicationinsights-agent-2.5.0-BETA.jar`

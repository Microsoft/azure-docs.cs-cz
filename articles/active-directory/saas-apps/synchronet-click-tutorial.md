...
Když kliknete na dlaždici SynchroNet kliknout na přístupovém panelu, měli byste se automaticky přihlásit k SynchroNet kliknutím na které jste si nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Postup ochrany SynchroNet kliknutí s pokročilou viditelností a ovládacími prvky](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)

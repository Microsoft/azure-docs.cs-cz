---
title: 'Kurz: Integrace Azure Active Directory s Benefitsolver | Dokumentace Microsoftu'
...
* Můžete povolit uživatelům být automaticky přihlášeni k Benefitsolver (Single Sign-On) s jejich účty Azure AD.
...
* Podporuje Benefitsolver **SP** jednotné přihlašování zahájené pomocí
...
V této části je konfigurace a testování Azure AD jednotné přihlašování pomocí Benefitsolver podle testovacího uživatele volá **Britta Simon**.
Pro jednotné přihlašování pro práci je potřeba navázat vztah odkazu mezi uživatele služby Azure AD a související uživatelské v Benefitsolver.
...
2. **[Konfigurace Benefitsolver Single Sign-On](#configure-benefitsolver-single-sign-on)**  – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
3. **[Vytvořit testovacího uživatele Azure AD](#create-an-azure-ad-test-user)**  – Pokud chcete otestovat Azure AD jednotné přihlašování s Britta Simon.
4. **[Přiřadit uživatele Azure AD](#assign-the-azure-ad-test-user)**  – Pokud chcete povolit Britta Simon používat Azure AD jednotného přihlašování.
5. **[Vytvořit testovacího uživatele Benefitsolver](#create-benefitsolver-test-user)**  – Pokud chcete mít protějšek Britta Simon Benefitsolver, který je propojený s Azure AD reprezentace uživatele.
...
1. V [webu Azure portal](https://portal.azure.com/)na **Benefitsolver** integrace stránce aplikace vyberte **jednotného přihlašování**.
...
4. Na **základní konfiguraci SAML** části, proveďte následující kroky:
    ...
    ![Benefitsolver domény a adresy URL jednotného přihlašování – informace](common/sp-identifier-reply.png)

    a. V **přihlašovací adresa URL** textové pole, zadejte adresu URL, pomocí následujícího vzorce: `http://<companyname>.benefitsolver.com`

    b. V **identifikátor** pole, zadejte adresu URL, pomocí následujícího vzorce: `https://<companyname>.benefitsolver.com/saml20`

    c. V **adresy URL odpovědi** textové pole, zadejte adresu URL, pomocí následujícího vzorce: `https://www.benefitsolver.com/benefits/BenefitSolverView?page_name=single_signon_saml`

    > [!NOTE]
    > Tyto hodnoty nejsou skutečný. Tyto hodnoty aktualizujte skutečné přihlašovací adresa URL, identifikátoru a adresa URL odpovědi. Kontakt [tým podpory Benefitsolver klienta](https://www.businessolver.com/contact) k získání těchto hodnot. Můžete také odkazovat na tyto vzory se dají ukazuje **základní konfiguraci SAML** části webu Azure Portal.
...
8. Na **nastavení Benefitsolver** tématu, zkopírujte příslušné adresy URL podle vašich požadavků.
...
### <a name="configure-benefitsolver-single-sign-on"></a>Konfigurace Benefitsolver jednotné přihlašování

Ke konfiguraci jednotného přihlašování na **Benefitsolver** straně, je nutné odeslat na stažený **soubor XML s metadaty** a vhodné zkopírovaný adresy URL z webu Azure portal [tým podpory Benefitsolver](https://www.businessolver.com/contact). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.
...
1. Na webu Azure Portal, vyberte **podnikové aplikace**vyberte **všechny aplikace**a pak vyberte **Benefitsolver**.
...
### <a name="create-benefitsolver-test-user"></a>Vytvoření Benefitsolver testovacího uživatele
...
Po kliknutí na dlaždici Benefitsolver na přístupovém panelu, můžete by měl být automaticky přihlášeni k Benefitsolver, u kterého nastavíte jednotné přihlašování. Další informace o přístupovém panelu, naleznete v tématu [Úvod k přístupovému panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

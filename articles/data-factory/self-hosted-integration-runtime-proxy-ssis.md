...
Na stránce **Upřesnit nastavení** zaškrtněte políčko **nastavit Integration runtime v místním prostředí jako proxy pro Azure-SSIS Integration runtime** zaškrtávací políčko, vyberte místní prostředí IR a propojenou službu Azure Blob Storage pro přípravu a v případě potřeby zadejte název kontejneru objektů BLOB pro **pracovní cestu** .

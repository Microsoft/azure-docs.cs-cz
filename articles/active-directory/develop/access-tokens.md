...
Deklarace identity indikuje algoritmus, který se použil k podepsání tokenu, `kid` ale deklarace identity indikuje konkrétní veřejný klíč, který se použil k ověření tokenu. `alg`

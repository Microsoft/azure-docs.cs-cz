...
In this section, you create the peering connection between your hub and a VNet. Uvedený postup zopakujte pro všechny virtuální sítě, které chcete připojit.
...
3. Na stránce **Add connection** (Přidat připojení) zadejte údaje do následujících polí:
    ...
    * **Virtual network** (Virtuální síť) – vyberte virtuální síť, kterou chcete připojit k tomuto rozbočovači. The virtual network cannot have an already existing virtual network gateway (neither VPN, nor ExpressRoute).

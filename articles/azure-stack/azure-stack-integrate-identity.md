...
Další informace o vytvoření názvu SPN najdete v tématu [vytvořit instanční objekt služby AD FS](https://docs.microsoft.com/azure/azure-stack/azure-stack-create-service-principals).

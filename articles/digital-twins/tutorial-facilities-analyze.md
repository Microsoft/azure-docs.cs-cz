...
1. Vyhledejte a vyberte **Event Hubs**. Vyberte **Vytvořit**.
    ...
    [![Vytvoření oboru názvů Event Hubs](./media/tutorial-facilities-analyze/tutorial-create-event-hubs.png)](./media/tutorial-facilities-analyze/tutorial-create-event-hubs.png#lightbox)
...
1. V Event Hubs nasazení oboru názvů vyberte podokno **Přehled** a pak vyberte **Přejít k prostředku**.
    ...
    [![Event Hubs obor názvů po nasazení](./media/tutorial-facilities-analyze/tutorial-event-hub-ns.png)](./media/tutorial-facilities-analyze/tutorial-event-hub-ns.png#lightbox)
...
1. Zástupné symboly `Secondary_connection_string_for_your_event_hub` nahraďte hodnotou **připojovacího řetězce – sekundární klíč** pro centrum událostí. Ujistěte se, že formát tohoto připojovacího řetězce je následující: 
...
1. Po vygenerování několika simulovaných událostí se vraťte do Průzkumníka Time Series Insights a v horní části vyberte tlačítko Aktualizovat. Zobrazí se vaše analytické grafy, které se vytvářejí pro data simulovaného senzoru. 
    ...
    [![Graf v Průzkumníkovi Time Series Insights](./media/tutorial-facilities-analyze/tsi-explorer-with-adt-telemetry.png)](./media/tutorial-facilities-analyze/tsi-explorer-with-adt-telemetry.png#lightbox)

...
* Příkaz Backup Zálohuje všechny verze všech tajných kódů. Pokud máte tajný klíč s velkým počtem předchozích verzí (více než 10), může velikost požadavku překročit povolené maximum a operace může selhat.

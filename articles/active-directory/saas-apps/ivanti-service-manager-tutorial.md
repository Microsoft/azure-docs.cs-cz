...
Když na přístupovém panelu kliknete na dlaždici Ivanti Service Manager (ISM), měli byste se automaticky přihlásit k Ivanti Service Manager (ISM), pro který jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).

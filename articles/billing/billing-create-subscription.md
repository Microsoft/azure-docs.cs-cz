---
title: Vytvoření dalšího předplatného Azure | Microsoft Docs
...
1. Vyhledejte **Předplatná**.
   ...
   ![Snímek obrazovky, který zobrazuje hledání předplatného na portálu](./media/billing-create-subscription/billing-search-subscription-portal.png)

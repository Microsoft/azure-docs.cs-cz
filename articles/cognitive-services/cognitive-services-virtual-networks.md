...
1. Pokud chcete povolený provoz ze všech sítí, vyberte možnost povolení přístupu ze **všech sítí**.
...
1. Pokud chcete udělit přístup k rozsahu IP adres Internetu, zadejte IP adresu nebo rozsah adres (ve [formátu CIDR](https://tools.ietf.org/html/rfc4632)) v části **Brána firewall** > **Rozsah adres**. Jsou přijímány pouze platné veřejné IP adresy (nerezervované).

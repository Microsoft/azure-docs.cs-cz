...
Pokud chcete přesunout klasické prostředky do nové skupiny prostředků v rámci stejného předplatného, použijte [operace přesunu Standard](../resource-group-move-resources.md) na portálu, Azure PowerShell, Azure CLI nebo REST API. Můžete použít stejné operace jako při přesouvání prostředků Resource Manageru.

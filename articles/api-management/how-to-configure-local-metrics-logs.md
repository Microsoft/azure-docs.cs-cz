...
Samoobslužná brána také podporuje několik protokolů, a to včetně `localsyslog`, `rfc5424`a. `journal` Níže uvedená tabulka shrnuje všechny podporované možnosti. 

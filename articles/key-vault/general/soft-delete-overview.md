...
Funkce obnovitelného odstranění je k dispozici prostřednictvím [REST API](/rest/api/keyvault/), rozhraní [Azure CLI](./key-vault-recovery.md), [Azure PowerShell](./key-vault-recovery.md)a [.NET/C#](/dotnet/api/microsoft.azure.keyvault) a také [šablony ARM](/azure/templates/microsoft.keyvault/2019-09-01/vaults).

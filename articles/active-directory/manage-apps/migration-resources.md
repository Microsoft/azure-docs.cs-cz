...
| [Nástroj: Active Directory Federation Services migrace připravenosti skript](https://aka.ms/migrateapps/adfsscript) | To je skript můžete spustit na serveru místní služby Active Directory Federation Services (AD FS) Chcete-li určit připravenost aplikací pro migraci do Azure AD.|

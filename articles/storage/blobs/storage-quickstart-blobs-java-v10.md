---
title: 'Rychlý start: Vytvoření objektu BLOB pomocí sady SDK pro úložiště Java'
...
> [Referenční materiály k rozhraní API](https://docs.microsoft.com/java/api/overview/azure/storage)

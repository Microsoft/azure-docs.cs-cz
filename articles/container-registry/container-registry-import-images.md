...
V následujícím příkladu *mysourceregistry* je v jiném předplatném než *myregistry* ve stejném tenantovi Active Directory. Zadat ID prostředku zdrojového registru `--registry` parametru.

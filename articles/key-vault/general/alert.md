...
> ![Snímek obrazovky s Azure Portal](../media/alert-1.png)
...
> [!div class="mx-imgBorder"]
> ![Snímek obrazovky s Azure Portal](../media/alert-2.png)
...
> [!div class="mx-imgBorder"]
> ![Snímek obrazovky s Azure Portal](../media/alert-3.png)
...
> [!div class="mx-imgBorder"]
> ![Snímek obrazovky s Azure Portal](../media/alert-4.png)
...
> [!div class="mx-imgBorder"]
> ![Snímek obrazovky s Azure Portal](../media/alert-5.png)
...
> [!div class="mx-imgBorder"]
> ![Snímek obrazovky s Azure Portal](../media/alert-6.png)

4. Vybrat **+ Přidat skupinu akcí**

> [!div class="mx-imgBorder"]
> ![Snímek obrazovky s Azure Portal](../media/alert-7.png)

5. Vyberte **typ akce** pro vaši skupinu akcí. V tomto příkladu vytvoříme e-mailové upozornění.

> [!div class="mx-imgBorder"]
> ![Snímek obrazovky s Azure Portal](../media/alert-8.png)

> [!div class="mx-imgBorder"]
> ![Snímek obrazovky s Azure Portal](../media/alert-9.png)
...
> [!div class="mx-imgBorder"]
> ![Snímek obrazovky s Azure Portal](../media/alert-10.png)

2. Vybrat **nové pravidlo výstrahy**

> [!div class="mx-imgBorder"]
> ![Snímek obrazovky s Azure Portal](../media/alert-11.png)
...
> [!div class="mx-imgBorder"]
> ![Snímek obrazovky s Azure Portal](../media/alert-12.png)
...
> [!div class="mx-imgBorder"]
> ![Snímek obrazovky s Azure Portal](../media/alert-13.png)
...
> [!div class="mx-imgBorder"]
> ![Snímek obrazovky s Azure Portal](../media/alert-14.png)
...
> [!div class="mx-imgBorder"]
> ![Snímek obrazovky s Azure Portal](../media/alert-15.png)
...
> [!div class="mx-imgBorder"]
> ![Snímek obrazovky s Azure Portal](../media/alert-16.png)
...
> [!div class="mx-imgBorder"]
> ![Snímek obrazovky s Azure Portal](../media/alert-18.png)

6. Povolení výstrahy a přiřazení závažnosti

> [!div class="mx-imgBorder"]
> ![Snímek obrazovky s Azure Portal](../media/alert-19.png)
...
> [!div class="mx-imgBorder"]
> ![Snímek obrazovky s Azure Portal](../media/alert-20.png)

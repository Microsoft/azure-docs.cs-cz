...
2. Vyberte **všechny služby** \> **rezervacích**.
...
-  **rozsahů jedné skupiny prostředků** – aplikuje slevu na rezervované prostředky jenom na ty, které jsou ve vybrané skupině prostředků.

-  **rozsahu pro jedno předplatné** – aplikuje slevu na rezervované prostředky ve vybraném předplatném.

-  **sdíleného rozsahu** – použije slevu rezervace na odpovídající prostředky v oprávněných předplatných, která jsou v účetním kontextu. Pro zákazníky se smlouvou EA je účetním kontextem registrace. U jednotlivých předplatných se sazbami pro průběžné platby jsou rozsahem fakturace všechna oprávněná předplatná vytvořená správcem účtu.
...
Další informace o tom, jak se v datech využití zobrazují slevy, najdete v tématu [vysvětlení využití rezervace Azure pro vaši podnikovou registraci](https://docs.microsoft.com/azure/billing/billing-understand-reserved-instance-usage-ea) , pokud jste zákazníkem se smlouvou EA. Pokud máte individuální předplatné, přečtěte si téma [vysvětlení využití rezervace Azure pro předplatné](https://docs.microsoft.com/azure/billing/billing-understand-reserved-instance-usage)s průběžnými platbami.
...
Můžete však *vyměnit* rezervaci, pokud chcete provést změny.
...
- [Ceny vyhrazených hostitelů](https://azure.microsoft.com/pricing/details/virtual-machines/dedicated-host/)
...
- [Náklady na software nezahrnuté v rezervacích](https://docs.microsoft.com/azure/billing/billing-reserved-instance-windows-software-costs)

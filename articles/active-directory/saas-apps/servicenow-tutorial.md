...
- [Co je řízení relace v Microsoft Cloud App Security?](/cloud-app-security/protect-servicenow)

- [Jak chránit ServiceNow pomocí pokročilých viditelností a ovládacích prvků](/cloud-app-security/proxy-intro-aad)
...
1. V automaticky otevíraném dialogovém okně zadejte název `Pizza tutorial` a ponechejte nastavenou výchozí jazykovou verzi – **English**. Ostatní pole jsou volitelná, nestavte je. Vyberte **Done** (Hotovo).

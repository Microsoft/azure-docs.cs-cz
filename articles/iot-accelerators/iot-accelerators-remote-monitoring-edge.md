...
Další informace o instalaci modulu runtime IoT Edge najdete v tématu [Instalace modulu runtime Azure IoT Edge v systému Linux (x64)](../iot-edge/how-to-install-iot-edge.md).

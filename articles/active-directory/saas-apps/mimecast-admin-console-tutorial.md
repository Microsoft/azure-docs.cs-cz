...
5. V části **profil ověřování** proveďte následující kroky:
    ...
    g. Otevřete certifikát základní-64 stažený z Azure Portal v poznámkovém bloku, odeberte první řádek (" *--* ") a poslední řádek (" *--* "), zkopírujte zbývající obsah do schránky a vložte ho do **poskytovatele identity. Textové pole certifikátu (metadata)** .
...
5. V dialogovém okně Nová adresa proveďte následující kroky:
    ...
    ![Uloží](./media/mimecast-admin-console-tutorial/ic795006.png "Uložit")

...
Další informace a kurz, jak začít používat trezor klíčů (včetně jak vytvořit trezor klíčů pro klíče chráněné pomocí hsm), najdete v [tématu Co je Azure Key Vault?](../general/overview.md).

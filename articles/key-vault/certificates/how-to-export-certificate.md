...
Key Vault podporuje dva typy klíčů:

- **RSA**: exportovatelné
- **HSM RSA**: nelze exportovat
...
Pokud chcete stáhnout celý certifikát (veřejné i soukromé části jeho složení), Stáhněte certifikát jako tajný kód.

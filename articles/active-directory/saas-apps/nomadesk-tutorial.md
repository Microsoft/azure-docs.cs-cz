...
5. Na panelu výsledků vyberte **Nomadesk**a potom klikněte na tlačítko **přidat** tlačítko pro přidání aplikace.
...
3. **[Vytvoření zkušebního uživatele Nomadesk](#creating-a-nomadesk-test-user)**  – Pokud chcete mít protějšek Britta Simon Nomadesk, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **Nomadesk domény a adresy URL** části, proveďte následující kroky:
...
6. Na **Nomadesk konfigurace** klikněte na tlačítko **nakonfigurovat Nomadesk** otevřete **nakonfigurovat přihlašování** okna. Kopírovat **URL odhlašování SAML Entity ID a SAML jednotné přihlašování – adresa URL služby** z **Stručná referenční příručka oddílu.**

    ![Konfigurace jednotného přihlašování](./media/nomadesk-tutorial/tutorial_nomadesk_configure.png) 

7. Ke konfiguraci jednotného přihlašování na **Nomadesk** straně, je nutné odeslat na stažený **certifikát**, **URL odhlašování SAML Entity ID a SAML jednotné přihlašování – adresa URL služby** do [Tým podpory Nomadesk](mailto:support@nomadesk.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

...
1. Vyberte nebo zadejte následující hodnoty.
 ...
 1. Po úspěšném vytvoření instance obdržíte oznámení:
    ...
    :::image type="content" source="media/quickstart-arm-template/deployment-notification.png" alt-text="Vlastnosti šablony API Management":::
...
:::image type="content" source="media/quickstart-arm-template/service-instance-created.png" alt-text="Vlastnosti šablony API Management":::
...
1. Na stránce skupina prostředků vyberte **Odstranit skupinu prostředků**.
    ...
    :::image type="content" source="media/quickstart-arm-template/delete-resource-group.png" alt-text="Vlastnosti šablony API Management":::

...
4. Do vyhledávacího pole zadejte **Convercent**.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/convercent-tutorial/tutorial_convercent_search.png)

5. Na panelu výsledků vyberte **Convercent**a potom klikněte na **přidat** tlačítko Přidat aplikaci.

    ![Vytváření testovacího uživatele Azure AD](./media/convercent-tutorial/tutorial_convercent_addfromgallery.png)
...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Konfigurovat jednotné přihlašování](./media/convercent-tutorial/tutorial_convercent_samlbase.png)
...
3. Na **Convercent domény a adresy URL** část, pokud chcete nakonfigurovat aplikace **IDP iniciované režimu**, provést následující krok:
    ...
    ![Konfigurovat jednotné přihlašování](./media/convercent-tutorial/tutorial_convercent_url.png)
...
4. Pokud chcete nakonfigurovat aplikace **SP iniciované režimu**na **Convercent domény a adresy URL** části provést následující kroky:
    ...
    ![Konfigurovat jednotné přihlašování](./media/convercent-tutorial/tutorial_convercent_url1.png)
...
5. Na **SAML podpisový certifikát** klikněte na tlačítko **soubor XML s metadaty** a uložte soubor XML ve vašem počítači.
    ...
    ![Konfigurovat jednotné přihlašování](./media/convercent-tutorial/tutorial_convercent_certificate.png) 

6. Klikněte na tlačítko **Uložit** tlačítko.

    ![Konfigurovat jednotné přihlašování](./media/convercent-tutorial/tutorial_general_400.png)
...
1. V **portál Azure**, v levém navigačním podokně klikněte na tlačítko **Azure Active Directory** ikonu.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/convercent-tutorial/create_aaduser_01.png) 

2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin** a klikněte na tlačítko **všichni uživatelé**.
    
    ![Vytváření testovacího uživatele Azure AD](./media/convercent-tutorial/create_aaduser_02.png) 

3. Chcete-li otevřít **uživatele** dialogové okno, klikněte na tlačítko **přidat** horní dialogové okno.
 
    ![Vytváření testovacího uživatele Azure AD](./media/convercent-tutorial/create_aaduser_03.png) 

4. Na **uživatele** dialogové okno stránky, proveďte následující kroky:
 
    ![Vytváření testovacího uživatele Azure AD](./media/convercent-tutorial/create_aaduser_04.png) 
...
2. V seznamu aplikací vyberte **Convercent**.
    ...
    ![Konfigurovat jednotné přihlašování](./media/convercent-tutorial/tutorial_convercent_app.png) 

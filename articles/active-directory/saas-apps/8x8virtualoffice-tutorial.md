...
V této části vytvoříte uživatele s názvem Britta Simon v 8x8. Pokud chcete přidat uživatele na platformě 8x8, pracujte s [týmem podpory 8x8](https://www.8x8.com/about-us/contact-us) . Uživatelé musí vytvořit a aktivovat, než použití jednotného přihlašování.
...
- [Jak chránit 8x8 pomocí pokročilých viditelností a ovládacích prvků](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)
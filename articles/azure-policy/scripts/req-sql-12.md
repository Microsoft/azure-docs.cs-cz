---
title: Ukázka kódu JSON pro Azure Policy – Vyžadování SQL Serveru verze 12.0 | Microsoft Docs
description: Tato ukázková zásada JSON vyžaduje použití SQL Serveru verze 12.0.

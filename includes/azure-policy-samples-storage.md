...
| [Vyžadovat šifrování účtu úložiště](../articles/governance/policy/samples/require-storage-account-encryption.md) | Vyžaduje, aby účet úložiště používal šifrování objektů blob.  |
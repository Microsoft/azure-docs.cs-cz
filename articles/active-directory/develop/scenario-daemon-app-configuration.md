...
Při sestavování důvěrného klienta s klientskými tajemstvími by měl mít konfigurační soubor tento extrakce z ukázky [confidential_client_secret_sample. py # L4-L15](https://github.com/AzureAD/microsoft-authentication-library-for-python/blob/0.6.1/sample/confidential_client_secret_sample.py#L4-L15) na GitHubu.
...
Když sestavíte důvěrného klienta s certifikáty, bude to vypadat jako tento extrakce z ukázky [confidential_client_certificate_sample. py # L4-L15](https://github.com/AzureAD/microsoft-authentication-library-for-python/blob/4b34fd660e5574eb876cfba63a1b927ae375efd6/sample/confidential_client_certificate_sample.py#L4-L15) v GitHubu.
...
Tady je třída, která se používá ve msal4j vývojových ukázek ke konfiguraci ukázek: [TestData](https://github.com/AzureAD/microsoft-authentication-library-for-java/blob/dev/src/samples/public-client/TestData.java).
...
Buď zadáte CONFIDENTIAL_CLIENT_ID, nebo CONFIDENTIAL_CLIENT_SECRET. Obě nastavení jsou exkluzivní.
...
Podrobnosti najdete v tématu MSAL. Referenční dokumentace Pythonu pro [ConfidentialClientApplication](https://msal-python.readthedocs.io/en/latest/#msal.ClientApplication.__init__)

# <a name="javatabjava"></a>[Java](#tab/java)

msal4j je ve verzi Public Preview. Podepsanou kontrolní výrazy se zatím nepodporují.

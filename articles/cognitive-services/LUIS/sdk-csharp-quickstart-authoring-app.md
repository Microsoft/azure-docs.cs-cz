...
description: Začněte s tímto rychlým startem pomocí klientské knihovny LUIS pro .NET. Pomocí těchto kroků nainstalujete balíček a vyzkoušíte ukázkový kód pro základní úlohy.
...
ms.locfileid: "75447744"
---
# <a name="quickstart-language-understanding-luis-authoring-2x-client-library-for-net"></a>Rychlý Start: Language Understanding (LUIS) vytváření klientských knihoven 2. x pro .NET

Začínáme s Language Understanding (LUIS) vytvářením klientských knihoven 2. x pro .NET. Pomocí těchto kroků nainstalujete balíček a vyzkoušíte ukázkový kód pro základní úlohy.  Language Understanding (LUIS) vám umožňuje použít vlastní informace o strojovém učení na konverzaci uživatele, text přirozeného jazyka a předpovědět celkový význam a vyžádat si relevantní a podrobné informace.

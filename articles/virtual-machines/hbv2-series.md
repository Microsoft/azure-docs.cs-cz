...
- Základní [Architektura a topologie virtuálních počítačů](./workloads/hpc/hbv2-series-overview.md)
- [Podporovaný softwarový zásobník](./workloads/hpc/hbv2-series-overview.md#software-specifications) , včetně PODPOROVANÉHO operačního systému
- Byl očekáván [výkon](./workloads/hpc/hbv2-performance.md) virtuálního počítače HBv2-Series.

---
title: Kurz – integrace existující doménové struktury a nové doménové struktury s jedním tenantem Azure AD pomocí azure ad připojení cloud zřizování.
...
Tento kurz vás provede přidáním zřizování cloudu do existujícího prostředí hybridní identity. 
...
V tomto scénáři je existující doménové struktury synchronizované pomocí synchronizace Azure AD Connect do klienta Azure AD. A máte novou doménovou strukturu, kterou chcete synchronizovat se stejným klientem Azure AD. Nastavíte zřizování cloudu pro novou doménovou strukturu. 
...
1. Identita hostitelského serveru přilehlého k doméně se systémem Windows Server 2012 R2 nebo vyšším s minimálně 4 GB paměti RAM a za běhu .NET 4.7.1+ 
...
2. Pokud je brána firewall mezi servery a Azure AD, nakonfigurujte následující položky:
   ...
   - Pokud brána firewall nebo proxy server umožňuje zadat bezpečné ** \*** přípony, přidejte připojení k msappproxy.net a ** \*.servicebus.windows.net**. Pokud ne, povolte přístup k [rozsahům IP adres datového centra Azure](https://www.microsoft.com/download/details.aspx?id=41653), které se aktualizují každý týden.
...
3. Na levé straně vyberte **Azure Active Directory**, klikněte na Azure **AD Connect** a na střed vyberte Spravovat **zřizování (preview).**</br>
![Azure Portal](media/how-to-install/install6.png)</br>
4. Klikněte na "Download agent"
5. Spuštění agenta zřizování Azure AD Connect
6. Na úvodní obrazovce **přijměte** licenční podmínky a klepněte na tlačítko **Instalovat**.</br>

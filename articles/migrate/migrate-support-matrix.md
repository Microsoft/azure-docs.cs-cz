...
--- | --- | ---
Vyhodnocování serveru Azure Migrate | Posouzení [virtuálních počítačů VMware](./tutorial-discover-vmware.md), [virtuálních počítačů Hyper-V](./tutorial-discover-hyper-v.md)a [fyzických serverů](./tutorial-discover-physical.md). |  Není k dispozici (NA)

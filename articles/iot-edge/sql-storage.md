...
* Aktivní Azure IoT hub s alespoň IoT hraniční zařízení.
...
3. Nahraďte `<docker registry address>` s adresou vyplněno dokončené kurzu [nasazení funkce Azure jako modul IoT Edge](tutorial-deploy-function.md).

---
title: Skóre srovnávacích testů pro virtuální počítače Azure s Windows | Microsoft Docs
...
| Size | vCPU | Uzly NUMA | Procesor | Spuštění | Průměrná základní sazba | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
Počty oken byly vypočítány spuštěním [SPECint 2006](https://www.spec.org/cpu2006/results/rint2006.html) na Windows serveru. SPECint se spustil pomocí možnosti základní sazba (SPECint_rate2006) s jednou kopií pro vCPU. SPECint se skládá z 12 samostatných testů, každý se spouští třikrát a bere medián hodnoty z každého testu a vážením má tvořit složené skóre. Tyto testy byly potom spuštěny napříč několika virtuálními počítači za účelem zadání průměrného počtu zobrazených výsledků.

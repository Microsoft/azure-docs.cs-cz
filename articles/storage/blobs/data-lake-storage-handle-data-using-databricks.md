...
![Azure Databricks se službami Data Lake Storage Gen2 a SQL Data Warehouse](./media/data-lake-storage-handle-data-using-databricks/databricks-extract-transform-load-sql-datawarehouse.png "Azure Databricks se službami Data Lake Storage Gen2 a SQL Data Warehouse")
...
3. V dialogovém okně **Vytvořit poznámkový blok** zadejte název poznámkového bloku. Vyberte jazyk **Scala** a vyberte cluster Spark, který jste vytvořili v předchozí části.
    ...
    ![Vytvoření poznámkového bloku v Databricks](./media/data-lake-storage-handle-data-using-databricks/databricks-notebook-details.png "Vytvoření poznámkového bloku v Databricks")

    Vyberte **Vytvořit**.

4. Zadejte následující kód do první buňky a spouštění kódu. Nezapomeňte nahradit zástupné symboly v závorce v ukázce vlastními hodnotami:
...
5. Stiskněte **SHIFT+ENTER** a spusťte kód v buňce.
...
> [!NOTE]
> Pokud ještě nemáte účet, který podporuje Azure Data Lake Storage Gen2, [vytvořte ho podle pokynů v rychlém startu](./data-lake-storage-quickstart-create-account.md).

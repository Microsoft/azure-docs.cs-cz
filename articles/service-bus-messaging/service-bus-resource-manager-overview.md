...
Chcete-li použít nepovinný soubor parametrů, zkopírujte soubor [201-ServiceBus-Create-Queue](https://github.com/Azure/azure-quickstart-templates/blob/master/201-servicebus-create-queue/azuredeploy.parameters.json) . Hodnotu `serviceBusNamespaceName` nahraďte názvem oboru názvů Service Bus, který chcete v tomto nasazení vytvořit, a hodnotu `serviceBusQueueName` nahraďte názvem fronty, kterou chcete vytvořit.

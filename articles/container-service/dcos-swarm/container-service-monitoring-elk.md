...
Přístup k uživatelskému rozhraní DC/OS pomocí nástroje `http://localhost:80/` jednou v uživatelském rozhraní DC/OS přejděte do části **Universe**. Vyhledejte a nainstalujte Elasticsearch, Logstash a Kibana z universu DC/OS a v tomto konkrétním pořadí. Pokud přejdete na odkaz **rozšířené instalace** , můžete získat další informace o konfiguraci.
...
Pro přístup k řídicímu panelu HAPROXY otevřete rozhraní pro správu Marathon-9,1 na adrese: `http://$PUBLIC_NODE_IP_ADDRESS:9090/haproxy?stats` .

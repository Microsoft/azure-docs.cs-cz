---
title: Jarní data Azure Cosmos DB pro poznámky k verzi a zdroje informací k rozhraní SQL API
description: Seznamte se s informacemi o jarních Azure Cosmos DB pro SQL API, včetně dat vydání, dat o vyřazení a změn provedených mezi jednotlivými verzemi Azure Cosmos DB SQL Async Java SDK.
author: anfeldma-ms
...
ms.locfileid: "87854210"
---
# <a name="spring-data-azure-cosmos-db-for-core-sql-api-release-notes-and-resources"></a>Jarní data Azure Cosmos DB pro jádro (SQL) API: poznámky k verzi a prostředky
...
> [!IMPORTANT]  
> Tyto poznámky k verzi jsou jenom pro Azure Cosmos DB SQL API. 
>

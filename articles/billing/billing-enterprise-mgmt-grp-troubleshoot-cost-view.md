...
![Snímek obrazovky, který zobrazuje zprávu Neautorizováno v poli Aktuální náklady pro předplatné](media/billing-enterprise-mgmt-groups/unauthorized.png)
...
2. Pokud jste zákazníkem se smlouvou EA Direct, máte několik možností:
    ...
    * Požádejte správce prováděcí smlouvy o přístup. Správce prováděcí smlouvy může aktualizovat nastavení na webu [Enterprise Portal](https://ea.azure.com/manage/enrollment).
      ...
      ![Snímek obrazovky zobrazující nastavení webu Enterprise Portal pro zobrazení poplatků](media/billing-enterprise-mgmt-groups/ea-portal-settings.png)

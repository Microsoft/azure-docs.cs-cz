...
Další informace o použití vícefaktorového ověřování pomocí služby PIM naleznete v tématu [jak vyžadovat vícefaktorové ověřování](active-directory-privileged-identity-management-how-to-require-mfa.md).

...
1. Po zobrazení návrháře aplikace logiky zadejte `recurrence` do vyhledávacího pole jako filtr. V seznamu triggerů vyberte tuto aktivační událost jako první krok v pracovním postupu aplikace logiky: **opakování**

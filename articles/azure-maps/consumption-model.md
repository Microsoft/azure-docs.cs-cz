...
V závislosti na hodnotě **vehicleEngineType**, jsou podporovány dva hlavní spotřeba modely: _Combustion_ a _Electric_. Zadání parametrů, které patří do různých modelů ve stejném požadavku se stala chyba.
...
Se používá Model spotřeby spalovací při **vehicleEngineType** je nastaven na _combustion_.

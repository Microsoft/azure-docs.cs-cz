...
1. Přihlaste se k serveru Azure AD Connect a spusťte **Synchronization Service Manager** výběrem možnosti **Spustit** > **synchronizační služba**.
...
* **ID uživatele**: kdo byl uživateli, který tuto chybu viděl? Příkladem může být *uživatel\@contoso.com*.

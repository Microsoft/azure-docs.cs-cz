...
* **Hraniční analýzu** – AI pomocí služeb místně ke zpracování dat přicházejících z podřízené zařízení bez odesílání telemetrie Plnohodnotná do cloudu. Najít a reagovat na přehledy místně a odesílat pouze podmnožinu dat do služby IoT Hub. 
...
* **Omezená podpora offline** – zařízení brány ukládá zprávy a aktualizace dvojčete nelze doručit do služby IoT Hub.

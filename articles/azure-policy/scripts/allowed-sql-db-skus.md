---
title: Ukázka kódu json pro Azure Policy – povolené skladové položky databází SQL | Microsoft Docs
description: Tato ukázková zásada json vyžaduje, aby databáze SQL používaly schválenou skladovou položku.

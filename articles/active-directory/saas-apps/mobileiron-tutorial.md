...
2. V poli **informace o nastavení cloudu IDPu** klikněte na **správce** > **identity** a vyberte možnost **AAD** .
...
1. Na stránce **"jeden uživatel"** proveďte následující kroky:
    ...
    a. Do textového pole **e-mailová adresa** zadejte e-maily uživatele, jako je brittasimon@contoso.com.

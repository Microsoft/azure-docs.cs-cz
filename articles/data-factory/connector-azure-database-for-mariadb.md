...
|:--- |:--- |:--- |
| typ | Vlastnost Type musí být nastavená na: **AzureMariaDB** . | Yes |
...
| Vlastnost | Popis | Povinné |
|:--- |:--- |:--- |
| typ | Vlastnost Type datové sady musí být nastavená na: **AzureMariaDBTable** . | Yes |
...
| Vlastnost | Popis | Povinné |
|:--- |:--- |:--- |
| typ | Vlastnost Type zdroje aktivity kopírování musí být nastavená na: **AzureMariaDBSource** . | Yes |

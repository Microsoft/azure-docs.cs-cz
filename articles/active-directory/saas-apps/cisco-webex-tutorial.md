...
2. Pro povolení jednotného přihlašování, v **jednotného přihlašování** v dialogovém **režimu** rozevíracího seznamu vyberte **na základě SAML přihlašování**.
    ...
    ![Jediné přihlášení dialogové okno](./media/cisco-webex-tutorial/tutorial_ciscowebex_samlbase.png)

3. V **Cisco Webex domény a adresy URL** část, proveďte následující kroky:

    ![Cisco Webex domény a adresy URL jednotné přihlašování informace](./media/cisco-webex-tutorial/tutorial_ciscowebex_url.png)
...
6. V **konfigurace Cisco Webex** vyberte **konfigurace Cisco Webex** otevřete **konfigurovat přihlášení** okno. Kopírování **Sign-Out URL**, **SAML Entity ID**, a **SAML jeden přihlašování adresa URL služby** z **Stručná referenční příručka** části.
    ...
    ![Konfigurovat jednotné přihlašování](./media/cisco-webex-tutorial/tutorial_ciscowebex_configure.png) 
...
8. V nabídce nahoře vyberte **Správa webu**.
    ...
    ![Správa lokalit](./media/cisco-webex-tutorial/ic777621.png "lokality správy")

9. V **spravovat lokality** vyberte **Konfigurace jednotného přihlašování k**.
   
    ![Konfigurace jednotného přihlašování k](./media/cisco-webex-tutorial/ic777622.png "Konfigurace jednotného přihlašování")

10. V **federovaného jednotného přihlašování k konfigurace webové** část, proveďte následující kroky:
   
    ![Konfigurace jednotného přihlašování federovaného](./media/cisco-webex-tutorial/ic777623.png "federovaného jednotného přihlašování k konfigurace")  
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom vyberte **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/cisco-webex-tutorial/create_aaduser_02.png)
...
3. V seznamu aplikací vyberte **Cisco Webex**.
    ...
    ![V seznamu aplikací na odkaz Cisco Webex](./media/cisco-webex-tutorial/tutorial_ciscowebex_app.png)  

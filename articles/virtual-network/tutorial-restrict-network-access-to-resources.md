...
4. V části **Přidat sítě** vyberte následující hodnoty a pak vyberte **Přidat** :
    ...
    ![Snímek obrazovky se zobrazí v podokně Přidat sítě, kde můžete zadat zadané hodnoty.](./media/tutorial-restrict-network-access-to-resources/storage-firewalls-and-virtual-networks.png)
...
> [Propojení virtuálních sítí](./tutorial-connect-virtual-networks-portal.md)

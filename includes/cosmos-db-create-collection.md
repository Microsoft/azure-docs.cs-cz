...
1. Vyberte **Průzkumník dat**  >  **Nový kontejner**. 
    ...
    :::image type="content" source="./media/cosmos-db-create-collection/azure-cosmosdb-data-explorer.png" alt-text="Průzkumník dat na portálu Azure Portal – podokno Přidat kontejner":::

...
3.  Vyberte šifrovací algoritmus, který se používá v protokolu Kerberos.
    ...
    a. Vyberte **Správce serveru**  >  **Zásady skupiny doméně pro správu**  >  **Domain**  >  **Zásady skupiny objekty**  >  **výchozí nebo aktivní zásady domény**a pak vyberte **Upravit**.

    b. V podokně **Editor pro správu zásad skupiny** vyberte zásady **Konfigurace počítače**  >  **Policies**  >  **nastavení systému Windows**nastavení  >  **zabezpečení**  >  **místní zásady**  >  **Security Options**a pak konfigurace **zabezpečení sítě: Konfigurace typů šifrování povolených pro protokol Kerberos**.

...
- Příkazy monitorování dostupné prostřednictvím rozhraní PowerShell zařízení, například:
    ...
    - `dkrdbe stats`k získání živého streamu statistických údajů o využití prostředků kontejnerů. Příkaz podporuje procesor, využití paměti, limit paměti a metriky v/v sítě.
    ...
    - `dkrdbe ps --size`Chcete-li zobrazit přibližnou velikost běžícího kontejneru. 

...
ms.locfileid: "103462506"
---
<!-- Used in faq.md and concepts-private-clouds-clusters.md -->


Verze softwaru VMware používané v nových nasazeních clusterů řešení Azure VMware pro privátní cloudy jsou:
...
| ESXi                  |    6,7 U3    | 
| Síti vSAN                  |    6,7 U3    |
| NSX-T <br />**Poznámka:** NSX-T je jediná podporovaná verze NSX.               |      2.5     |


Nové clustery přidané do existujícího privátního cloudu jsou použité aktuálně běžící softwarové verze. Další informace najdete v tématu [požadavky na verzi softwaru VMware](https://docs.vmware.com/en/VMware-HCX/services/user-guide/GUID-54E5293B-8707-4D29-BFE8-EE63539CC49B.html).

...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/signalfx-tutorial/tutorial_signalfx_samlbase.png)

3. Na **SignalFx domény a adresy URL** část, proveďte následující kroky:

    ![SignalFx domény a adresy URL jednotné přihlašování informace](./media/signalfx-tutorial/tutorial_signalfx_url.png)
...
4. Aplikace SignalFx očekává SAML kontrolní výrazy ve specifickém formátu. Nakonfigurujte následující deklarace identity pro tuto aplikaci. Můžete spravovat hodnoty těchto atributů z **uživatelské atributy** části na stránce integrace aplikace. Následující snímek obrazovky ukazuje příklad pro tento.   
    ...
    ![Konfigurovat jednotné přihlašování](./media/signalfx-tutorial/tutorial_signalfx_attribute.png)
...
5. V **uživatelské atributy** části na **jednotného přihlašování** dialogové okno, nakonfigurujte atribut tokenu SAML, jak je znázorněno na obrázku a proveďte následující kroky:
    ...
    ![Konfigurovat jednotné přihlašování přidat](./media/signalfx-tutorial/tutorial_attribute_04.png)

    ![Konfigurace Addattb přihlášení](./media/signalfx-tutorial/tutorial_attribute_05.png)
...
7. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/signalfx-tutorial/tutorial_general_400.png)
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/signalfx-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **SignalFx**.
    ...
    ![V seznamu aplikací na SignalFx odkaz](./media/signalfx-tutorial/tutorial_signalfx_app.png)  

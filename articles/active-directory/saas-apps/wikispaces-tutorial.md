...
2. **[Nakonfigurujte jednotné přihlašování Wikispaces](#configure-wikispaces-single-sign-on)** – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
...
### <a name="configure-wikispaces-single-sign-on"></a>Konfigurace jednotného přihlašování Wikispaces

Ke konfiguraci jednotného přihlašování na straně **Wikispaces** je potřeba odeslat stažený **soubor XML federačních metadat** a příslušné zkopírované adresy URL z Azure Portal do [týmu podpory Wikispaces](https://www.wikispaces.com/site/help). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.
...
2. Přejít na **členy**.
    ...
    ![Pedagog](./media/wikispaces-tutorial/ic787193.png "Members")
...
Když na přístupovém panelu kliknete na dlaždici Wikispaces, měli byste se automaticky přihlásit k Wikispaces, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

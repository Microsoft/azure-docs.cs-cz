...
- Umožní Site Recovery, stáhněte a nainstalujte ho při spuštění Průvodce konfigurací serveru správy. Není nutné provádět žádnou zvláštní akci.

...
### <a name="cause-2-virtual-network-or-firewall-rules-are-enabled-on-the-storage-account"></a>Příčina 2: Pro účet úložiště jsou povolená pravidla virtuální sítě nebo firewallu 

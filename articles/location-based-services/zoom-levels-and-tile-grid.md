---
title: "Přiblížení úrovně a služby založené na dlaždici mřížky v umístění Azure | Microsoft Docs"
description: "Další informace o úrovních přiblížení a služby založené na dlaždici mřížky v umístění Azure"
...
---
# <a name="zoom-levels-and-tile-grid"></a>Úrovně přiblížení a dlaždice mřížky
Pomocí služby Azure na základě umístění souřadnicový systém projekci Mercator kulovým (EPSG: 3857).
...
Úroveň přiblížení 1 používá 4 dlaždice k vykreslení na světě: odmocnina 2 x 2
...
Každou úroveň přiblížení následné čtyřmi vydělí dlaždice předchozímu, vytváření mřížku 2<sup>zvětšení</sup> x 2<sup>zvětšení</sup>. Úroveň zvětšení 20 je mřížka 2<sup>20</sup> x 2<sup>20</sup>, nebo 1 048 576 x 1 048 576 dlaždice (celkem 109,951,162,778).

Úplné tabulku hodnot pro úrovně přiblížení se zde:
...
Při určování kterou úroveň přiblížení pro použití, mějte na paměti, že každé umístění je na stabilní na jeho dlaždici. To znamená, že počet dlaždic, které jsou potřebné k zobrazení dané expanse území je závislá na konkrétní umístění přiblížení mřížky na celém světě. Například, pokud existují dva body 900 měřidla od sebe, je *může* trvat jenom tři dlaždice zobrazíte trasy mezi nimi na úroveň přiblížení 17. Pokud západní bodu je však na pravé straně jeho dlaždici a bodem východní nalevo od jeho, může trvat čtyři dlaždice:

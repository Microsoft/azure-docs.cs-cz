...
Pro prostředí prvního kódu si přečtěte následující články, které používají [sadu Azure Machine Learning Python SDK](https://docs.microsoft.com/python/api/overview/azure/ml/?view=azure-ml-py) :

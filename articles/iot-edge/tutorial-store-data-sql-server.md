...
ms.locfileid: "68840072"
---
# <a name="tutorial-store-data-at-the-edge-with-sql-server-databases"></a>Kurz: Uložení dat na hraničních zařízeních pomocí SQL Serverch databází
...
2. V paletě příkazů zadejte a spusťte příkaz **Azure IoT Edge: Přidejte IoT Edge modul**. V paletě příkazů zadejte následující informace, chcete-li přidat nový modul: 
...
> [Ukládání dat na hraničních zařízeních pomocí Azure Blob Storage v IoT Edge](how-to-store-data-blob.md)

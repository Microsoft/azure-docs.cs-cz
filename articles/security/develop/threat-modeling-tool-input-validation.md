...
### <a name="example"></a>Příklad
Pokud potřebujete vyřešit vložené entity, ale nepotřebujete přeložit externí entity, nastavte vlastnost XmlReaderSettings. objekt XmlResolver na hodnotu null. Například: 

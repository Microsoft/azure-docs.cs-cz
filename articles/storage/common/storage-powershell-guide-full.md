...
* Informace o povolení a zobrazení dat metrik úložiště pomocí prostředí PowerShell najdete v tématu [metrikách Storage analytics](storage-analytics-metrics.md).

* Zjistěte, jak povolit a načtení dat protokolování úložiště pomocí prostředí PowerShell, najdete v článku [povolení protokolování úložiště pomocí prostředí PowerShell](/rest/api/storageservices/Enabling-Storage-Logging-and-Accessing-Log-Data) a [hledání dat protokolování úložiště protokolů](/rest/api/storageservices/Enabling-Storage-Logging-and-Accessing-Log-Data).

...
| **Směrování** |Na základě trasy (RouteBased) (dynamické) |Podporujeme sítě VPN se statickým směrováním (na základě zásad – PolicyBased) nebo dynamickým směrováním (na základě trasy – RouteBased). |BGP |

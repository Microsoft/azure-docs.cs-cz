...
Ingestování Log Analytics v IoT Hub je ve výchozím nastavení vypnuté Azure Security Center pro řešení IoT. Pokud ho chcete povolit pro práci s modulem zabezpečení pro Azure RTO, udělejte toto: 
...
> [Konfigurace modulu zabezpečení pro Azure RTO](how-to-azure-rtos-security-module.md)

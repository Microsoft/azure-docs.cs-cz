---
title: Vývoj týmu pomocí souboru Node.js a kódu sady Visual Studio
services: azure-dev-spaces
ms.date: 07/09/2018
ms.topic: tutorial
description: Tento kurz ukazuje, jak používat Azure Dev Spaces a Visual Studio Code k vývoji týmu v aplikaci Node.js ve službě Azure Kubernetes Service
...
---
# <a name="team-development-using-nodejs-and-visual-studio-code-with-azure-dev-spaces"></a>Vývoj týmu pomocí node.js a kódu Visual Studia s Azure Dev Spaces
...
Přejděte do okna VS Kód pro `mywebapi` a proveďte úpravu kódu na výchozí obslužnou rutinu GET `/` v `server.js`, například:

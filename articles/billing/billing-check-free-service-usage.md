...
2.  Vyhledejte **Předplatná**.
    ...
    ![Snímek obrazovky, který zobrazuje hledání předplatných na portálu](./media/billing-check-usage-of-free-services/billing-search-subscriptions.png)

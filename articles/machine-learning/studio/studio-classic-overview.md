...
Další informace o tom, jak se dá použít rozsáhlá knihovna algoritmů strojového učení, najdete v tématu [postup výběru algoritmů pro Microsoft Machine Learning Studio (Classic)](algorithm-choice.md).

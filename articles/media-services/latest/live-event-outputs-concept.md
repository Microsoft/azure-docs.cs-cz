...
* Statické názvy hostitelů 
    ...
    |Rozhraní příkazového řádku|[--use-static-hostname](/cli/azure/ams/live-event#az_ams_live_event_create)|[--Access-token](/cli/azure/ams/live-event#optional-parameters)|

...
5. Na panelu výsledků vyberte **Jobbadmin**a potom klikněte na tlačítko **přidat** tlačítko pro přidání aplikace.
...
3. **[Vytvoření zkušebního uživatele Jobbadmin](#creating-a-jobbadmin-test-user)**  – Pokud chcete mít protějšek Britta Simon Jobbadmin, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **Jobbadmin domény a adresy URL** části, proveďte následující kroky:
...
6. Ke konfiguraci jednotného přihlašování na **Jobbadmin** straně, je nutné odeslat na stažený **soubor XML s metadaty** k [tým podpory Jobbadmin](https://www.jobbnorge.no/om-oss/kontakt-oss). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

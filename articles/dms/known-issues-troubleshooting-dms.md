...
| Příčina         | Řešení    |
| ------------- | ------------- |
| Tato chyba nastane, pokud migrace selže kvůli vypršení časového limitu čekání zámek během migrace.<br><br> | Zvažte zvýšení hodnoty parametru server **"innodb_lock_wait_timeout"**. Nejvyšší povolená hodnota je 1073741824. |

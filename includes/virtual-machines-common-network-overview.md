...
- **[Přesměrování portů](../articles/load-balancer/tutorial-load-balancer-port-forwarding-portal.md)** – definuje způsob, jakým příchozí přenos prochází přes front-end IP adresu a distribuuje se do back-endové IP adresy s využitím příchozích pravidel NAT.
...
- **[Odchozí pravidla](../articles/load-balancer/load-balancer-outbound-rules-overview.md)** – odchozí pravidlo konfiguruje odchozí překlad síťových adres (NAT) pro všechny virtuální počítače nebo instance identifikované back-end fondem vašich Standard Load Balancer, které se mají přeložit do front-endu.
...
| Metoda | Popis |
| ------ | ----------- |
| portál Azure | [Zatížení interního provozu můžete vyrovnávat pomocí nástroje pro vyrovnávání zatížení v Azure Portal](../articles/load-balancer/tutorial-load-balancer-standard-internal-portal.md). |

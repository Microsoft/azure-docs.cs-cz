...
4. Do formuláře podrobností o novém serveru zadejte následující informace:
   ...
   - Aktivujte zaškrtávací políčko a **Povolte funkce ve verzi Preview**.
...
5. Klikněte na **Konfigurovat skupinu serverů**.
   - Vyberte přepínač **Basic** pro **vrstvu**.
   - Klikněte na **Uložit**.

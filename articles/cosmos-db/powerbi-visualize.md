...
:::image type="content" source="./media/powerbi-visualize/power_bi_connector_pbireportview2.png" alt-text="Power BI Desktop zobrazení sestavy – přetáhněte požadovaná pole.":::

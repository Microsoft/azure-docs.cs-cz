...
2. **[Nakonfigurujte jednotné přihlašování VTIGER CRM (SAML)](#configure-vtiger-crm-saml-sso)** – ke konfiguraci nastavení jediného Sign-On na straně aplikace.
...
Když vyberete dlaždici Vtiger CRM (SAML) na přístupovém panelu, měli byste se automaticky přihlásit k Vtiger CRM (SAML), pro který jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).

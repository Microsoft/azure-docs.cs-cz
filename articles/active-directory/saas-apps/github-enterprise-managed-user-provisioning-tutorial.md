...
> [!NOTE]
> Tento zřizovací konektor je povolený jenom pro účastníky beta verze Enterprise spravované uživatelem.
...
3. Určete, jaká data se mají [mapovat mezi Azure AD a podnikovým spravovaným uživatelem GitHubu](../app-provisioning/customize-application-attributes.md).

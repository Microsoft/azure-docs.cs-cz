...
| [Vytvoření účtu služby Azure Cosmos DB pomocí služby Cosmos DB pro rozhraní MongoDB API](scripts/create-mongodb-database-account-cli.md?toc=%2fcli%2fazure%2ftoc.json) | Vytvoří jeden účet služby Azure Cosmos DB, databázi a kolekci. |
...
| [Získání připojovacího řetězce pro služby Azure Cosmos DB pro rozhraní API MongoDB databáze](scripts/secure-mongo-connection-string-cli.md?toc=%2fcli%2fazure%2ftoc.json) | Získá připojovací řetězec pro připojení aplikace MongoDB k účtu služby Azure Cosmos DB.|

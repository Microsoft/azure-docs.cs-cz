...
| | Plán Consumption | Plán Premium | Dedicated plan |
|-|:----------------:|:------------:|:----------------:|
| Windows | GA | GA | GA |
| Linux | GA | GA | GA |
...
* Jedna aplikace funkcí se může škálovat maximálně na 200 instancí. A single instance may process more than one message or request at a time though, so there isn't a set limit on number of concurrent executions.

---
title: 'Skript prostředí PowerShell: Vytvoření a zobrazení triggerů snímků Azure Data Share | Microsoft Docs'
...
| Příkaz | Poznámky |
|---|---|
| [New-AzDataShareTrigger](/powershell/module/az.resources/new-azdatasharetrigger) | Vytvořte Trigger snímku sdílené složky. |
| [Get-AzDataShareTrigger](/powershell/module/az.resources/get-azdatasharetrigger) | Získá nastavení synchronizace pro synchronizaci sdílené složky. |
|||

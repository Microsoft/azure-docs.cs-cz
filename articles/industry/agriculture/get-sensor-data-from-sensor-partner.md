...
6. Spusťte tento skript:
    ...
    ```
7. Pokud chcete zachytit hodnoty, postupujte podle pokynů na obrazovce. (Koncový bod rozhraní API, ID tenanta, ID klienta, tajný klíč klienta a připojovací řetězec EventHub). Připojovací řetězec EventHub bude k dispozici jako součást odpovědi rozhraní API v Swagger.

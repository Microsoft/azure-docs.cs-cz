---
title: Ladění Apache Spark úloh spuštěných v Azure HDInsight | Dokumentace Microsoftu
...
*  [Ladění Sparkových úloh pomocí rozšířený Server historie Sparku](apache-azure-spark-history-server.md)

...
:::image type="content" source="media/application-settings/overview.png" alt-text="Přehled statického Web Apps Azure":::
...
> [Konfigurace front-endové rozhraní](front-end-frameworks.md)

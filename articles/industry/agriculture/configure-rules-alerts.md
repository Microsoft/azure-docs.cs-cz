---
title: Konfigurace pravidel a správa výstrah v Azure FarmBeats
...
ms.locfileid: "73798528"
---
# <a name="configure-rules-and-manage-alerts-in-farmbeats"></a>Konfigurace pravidel a správa výstrah v FarmBeats
...
2. Vyberte **nové pravidlo**. Zobrazí se okno nové pravidlo.
    ...
    ![Beats farmy projektu](./media/configure-rules-and-alerts/new-rule-1.png)
...
4. Zadáním názvu farmy vyberte oddíl farmy a **podmínky** , který se zobrazí ve stejném okně.  
    ...
    ![Beats farmy projektu](./media/configure-rules-and-alerts/new-rule-condition-1.png)
...
9. V **akci**přepněte na přepínací tlačítko s **povoleným e** -mailem a povolte e-mailová upozornění.
    ...
    ![Beats farmy projektu](./media/configure-rules-and-alerts/new-rule-email-1.png)
...
Na stránce **farma** se zobrazí seznam dostupných pravidel. Vyberte **název pravidla**. V okně se zobrazí následující podrobnosti, které se vztahují k vybranému pravidlu:
 ...
 - Počet zařízení ovlivněných pravidlem
    ...
    ![Beats farmy projektu](./media/configure-rules-and-alerts/view-rule-1.png)

## <a name="edit-rule"></a>Upravit pravidlo
...
2. Vyberte pravidlo, pro které chcete upravit.
    ...
    ![Beats farmy projektu](./media/configure-rules-and-alerts/edit-rule-action-bar-1.png)

3. Na panelu akcí vyberte **Upravit** . otevře se okno **Upravit pravidlo** .

    ![Beats farmy projektu](./media/configure-rules-and-alerts/edit-rule-one-1.png)
...
8. Vyberte **+ Přidat podmínku** a přidejte nebo upravte podmínky pravidel.
    ...
    ![Beats farmy projektu](./media/configure-rules-and-alerts/edit-rule-two-1.png)
...
2. Vyberte pravidlo, pro které chcete změnit stav.
    ...
    ![Beats farmy projektu](./media/configure-rules-and-alerts/change-status-rule-action-bar-1.png)

3. Na panelu akcí vyberte **změnit stav** . Zobrazí se okno **stav změny** .

    ![Beats farmy projektu](./media/configure-rules-and-alerts/rule-change-status-1.png)

3. Změňte stav pravidla pomocí přepínacího tlačítka **změnit stav** .
   Můžete zobrazit počet zařízení, na která bude pravidlo ovlivněno.
4. Chcete-li změnit stav pravidla, vyberte možnost **použít** .

## <a name="delete-rule"></a>Odstranit pravidlo
...
2. Vyberte pravidlo, pro které chcete odstranit.
    ...
    ![Beats farmy projektu](./media/configure-rules-and-alerts/delete-rule-action-bar-1.png)

3. Na panelu akcí vyberte **Odstranit** .

    ![Beats farmy projektu](./media/configure-rules-and-alerts/delete-rule-1.png)

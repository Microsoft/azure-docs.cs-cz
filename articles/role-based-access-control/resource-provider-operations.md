...
> | Akce | Microsoft. ADHybridHealthService/addsservices/Alerts/číst | Získá podrobnosti o výstrahách pro doménovou strukturu, jako je AlertId, datum vyvolání výstrahy, poslední zjištěná výstraha, popis výstrahy, Poslední aktualizace, úroveň výstrahy, stav výstrahy, odkazy na řešení potíží s výstrahami atd. |
...
> | Akce | Microsoft. ADHybridHealthService/služby/výstrahy/čtení | Přečte výstrahy pro službu. |
> | Akce | Microsoft. ADHybridHealthService/služby/výstrahy/čtení | Přečte výstrahy pro službu. |
...
> | Akce | Microsoft. ADHybridHealthService/Services/číst | Přečte instance služby v tenantovi. |
...
> | Akce | Microsoft. ADHybridHealthService/Services/Servicemembers/Alerts/číst | Přečte výstrahy pro server. |
> | Akce | Microsoft. ADHybridHealthService/Services/Servicemembers/přihlašovací údaje/číst | Během registrace serveru se toto rozhraní API volá, aby se získaly přihlašovací údaje pro nové servery. |
> | Akce | Microsoft. ADHybridHealthService/Services/Servicemembers/aktuálnost/čtení | Pro daný server toto rozhraní API získá seznam DataType, které jsou odesílány servery a nejnovější čas pro každé nahrání. |
...
> | Akce | Microsoft. ADHybridHealthService/zrušit registraci/akce | Zruší registraci předplatného pro poskytovatele prostředků ADHybrid Health Service. |
...
> | Akce | Microsoft. AnalysisServices/servery/DELETE | Odstraní Analysis Server. |
> | Akce | Microsoft. AnalysisServices/servery/listGatewayStatus/Action | Vypíše stav brány přidružené k serveru. |
...
> | Akce | Microsoft. ApiManagement/Service/API/Operations/Tags/DELETE | Odpojte značku od operace. |
...
> | Akce | Microsoft. ApiManagement/Service/API/operationsByTags/Read | Vypíše kolekci operací přidružených k značkám. |
...
> | Akce | Microsoft. ApiManagement/Service/API/schemas/DELETE | Odstraní konfiguraci schématu v rozhraní API. |
> | Akce | Microsoft. ApiManagement/Service/API/schemas/Read | Získejte konfiguraci schématu na úrovni rozhraní API. nebo získáte konfiguraci schématu na úrovni rozhraní API. |
> | Akce | Microsoft. ApiManagement/Service/API/schemas/Write | Vytvoří nebo aktualizuje konfiguraci schématu pro rozhraní API. |
...
> | Akce | Microsoft. ApiManagement/zrušit registraci/akce | Zrušení registrace předplatného pro poskytovatele prostředků Microsoft. ApiManagement |
...
> | Akce | Microsoft. Automation/automationAccounts/Runbooky/DELETE | Odstraní Runbook Azure Automation. |
> | Akce | Microsoft. Automation/automationAccounts/Runbooky/koncept/obsah/zápis | Vytvoří obsah konceptu Azure Automation Runbooku. |
...
> | Akce | Microsoft. Automation/automationAccounts/Runbooky/koncept/testJob/číst | Načte testovací úlohu konceptu sady Runbook Azure Automation. |
...
> | Akce | Microsoft. Automation/automationAccounts/Runbooky/koncept/testJob/Write | Vytvoří testovací úlohu konceptu sady Runbook Azure Automation. |
...
> | Akce | Microsoft. Automation/automationAccounts/Runbooky/Write | Vytvoří nebo aktualizuje Runbook Azure Automation. |
...
> | Akce | Microsoft. Automation/automationAccounts/sledovací procesy/odstranit | Odstraní úlohu sledovacího procesu Azure Automation. |
...
> | Akce | Microsoft. Automation/automationAccounts/watchs/watcherActions/DELETE | Odstraní akce úlohy sledovacího procesu Azure Automation. |
...
> | Akce | Microsoft. Automation/automationAccounts/sledovací procesy/watcherActions/Write | Vytvořit akce úlohy sledovacího procesu Azure Automation |
...
> | Akce | Microsoft. Azureactivedirectory selhala/b2cDirectories/Read | Zobrazit prostředek adresáře B2C |
> | Akce | Microsoft. Azureactivedirectory selhala/b2cDirectories/Write | Vytvořit nebo aktualizovat prostředek adresáře B2C |
...
> | Akce | Microsoft. Azureactivedirectory selhala/Operations/Read | Načte všechny operace rozhraní API, které jsou k dispozici pro poskytovatele prostředků Microsoft. Azureactivedirectory selhala. |
...
> | Akce | Microsoft. AzureStack/registrs/customerSubscriptions/DELETE | Odstraní předplatné zákazníka Azure Stack. |
> | Akce | Microsoft. AzureStack/registrers/customerSubscriptions/Read | Získá vlastnosti předplatného Azure Stack zákazníka. |
> | Akce | Microsoft. AzureStack/registrers/customerSubscriptions/Write | Vytvoří nebo aktualizuje předplatné Azure Stack zákazníka. |
> | Akce | Microsoft. AzureStack/registrs/DELETE | Odstraní registraci Azure Stack. |
> | Akce | Microsoft. AzureStack/registrs/getActivationKey/Action | Získá nejnovější aktivační klíč Azure Stack. |
> | Akce | Microsoft. AzureStack/registrs/Products/listDetails/Action | Načte rozšířené podrobnosti pro produkt Azure Stack Marketplace. |
> | Akce | Microsoft. AzureStack/registrs/Products/Read | Získá vlastnosti produktu Azure Stack Marketplace. |
...
> | Akce | Microsoft. cache/Redis/export/akce | Exportovat Redis data do předem vydaných objektů BLOB úložiště v zadaném formátu |
...
> | Akce | Microsoft. cache/Redis/klíče listkey/Action | Zobrazení hodnoty přístupových klíčů Redis Cache na portálu pro správu |
...
> | Akce | Microsoft. cache/registrovat/akce | Zaregistruje poskytovatele prostředků Microsoft. cache v rámci předplatného. |
> | Akce | Microsoft. cache/zrušit registraci/akce | Zruší registraci poskytovatele prostředků Microsoft. cache u předplatného. |
...
> | Akce | Microsoft. CertificateRegistration/certificateOrders/revydat/Action | Vystavení existujícího objednávky certifikátu |
...
> | Akce | Microsoft. ClassicCompute/domainNames/sloty/role/roleInstances/operationStatuses/Read | Získá stav operace pro instanci role v roli slotu názvů domén. |
...
> | Akce | Microsoft. ClassicCompute/virtualMachines/networkInterfaces/associatedNetworkSecurityGroups/operationStatuses/číst | Přečte stav operace pro skupiny zabezpečení sítě přidružené k virtuálním počítačům. |
...
> | Akce | Microsoft. ClassicStorage/OSImage/Read | Vrátí bitovou kopii operačního systému. |
...
> | Akce | Microsoft. ClassicStorage/storageAccounts/klíče listkey/Action | Vypíše přístupové klíče pro účty úložiště. |
> | Akce | Microsoft. ClassicStorage/storageAccounts/operationStatuses/Read | Přečte stav operace pro daný prostředek. |
> | Akce | Microsoft. ClassicStorage/storageAccounts/OSImage/DELETE | Odstraní danou image operačního systému účtu úložiště. |
> | Akce | Microsoft. ClassicStorage/storageAccounts/OSImage/Read | Vrátí image operačního systému účtu úložiště. |
> | Akce | Microsoft. ClassicStorage/storageAccounts/OSImage/Write | Přidá určenou bitovou kopii operačního systému účtu úložiště. |
...
> | Akce | Microsoft. Cognitiveservices Account/Accounts/DELETE | Odstraní účty rozhraní API. |
...
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Face/facelists/persistedfaces/DELETE | Odstraní obličej ze seznamu obličeje zadanými faceListId a persisitedFaceId. Odstraní se i související image obličeje. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Face/facelists/persistedfaces/Write | Přidejte obličej do určeného seznamu obličeje, až 1 000 obličeje. |
...
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Face/largefacelists/DELETE | Odstraní zadaný velký seznam obličeje. Související obrázky na obličeji ve velkém seznamu obličeje budou také odstraněny. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Face/largefacelists/persistedfaces/DELETE | Odstraňte plošku z velkého seznamu obličeje zadaným largeFaceListId a persisitedFaceId. Odstraní se i související image obličeje. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Face/largefacelists/persistedfaces/Read | Načtěte trvalý obličej ve velkých listech podle largeFaceListId a persistedFaceId. Vypíše persistedFaceId a userData v zadaném velkém seznamu obličeje. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Face/largefacelists/persistedfaces/Write | Přidejte obličej do určeného rozsáhlého seznamu, až 1 000 000 obličeje. Aktualizuje zadané pole userData na ploše v rozsáhlém seznamu na základě jeho persistedFaceId. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Face/largefacelists/Read | Načtěte largeFaceListId, název, název a userData pro velký seznam. Seznamte se s informacemi o largeFaceListId, jménech a userDatach ve velkých listech. |
...
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Face/largefacelists/Training/Read | Chcete-li ověřit, zda je stav vzdělávání velkého seznamu obličeje dokončený nebo stále dál. Školení LargeFaceList je asynchronní operace |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Face/largefacelists/Write | Vytvořte prázdný velký seznam obličeje pomocí uživatelsky zadaného largeFaceListId, názvu a volitelné uživatelské služby. Aktualizujte informace o velkém seznamu, včetně názvu a userData. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Face/largepersongroups/DELETE | Odstraní existující velkou skupinu osob se zadaným personGroupId. Trvalá data v této velké skupině osob se odstraní. |
...
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Face/largepersongroups/persons/DELETE | Odstraní stávající osobu z velké skupiny osob. Všechna uložená data osob a obrázky na ploše se odstraní. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Face/largepersongroups/persons/persistedfaces/DELETE | Odstranění obličeje od uživatele ve velké skupině osob. Odstraní se také data obličeje a obrázek související s touto položkou obličeje. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Face/largepersongroups/persons/persistedfaces/Read | Načte informace o obličeji osoby. Plocha trvalé osoby je určena largePersonGroupId, personId a persistedFaceId. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Face/largepersongroups/persons/persistedfaces/Write | Přidejte obličejovou image k osobě do velké skupiny osob pro identifikaci nebo ověřování obličeje. Pro práci s obrázkem aktualizace pole userData osoby, které trvalo obličej. |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Face/largepersongroups/persons/Read | Načtěte jméno osoby a userData a trvale faceIds představující image na ploše registrované osoby. Vypíše informace o všech osobách v zadané skupině Velká osoba, včetně personId, názvu, uživatelských a persistedFaceIds. |
...
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Face/largepersongroups/Read | Načte informace o velké skupině osob, včetně názvu a uživatelských souborů. Toto rozhraní API vrací informace o velkých skupinách osob v seznamu všech stávajících velkých skupin osob largePesonGroupId, Name a userData. |
...
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Face/largepersongroups/Training/Read | Chcete-li ověřit stav vzdělávání velkých skupin osob, který je dokončen nebo stále probíhá. Školení LargePersonGroup je asynchronní operace |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/Face/largepersongroups/Write | Vytvořte novou velkou skupinu osob s uživatelem zadanými largePersonGroupId, názvem a volitelnými userData. Aktualizujte stávající název a userData pro velkou skupinu osob. Vlastnosti zůstanou beze změny, pokud nejsou v textu žádosti. |
...
> | Akce | Microsoft. Cognitiveservices Account/Accounts/klíče listkey/Action | Zobrazit seznam klíčů |
> | Akce dataaction | Microsoft. Cognitiveservices Account/Accounts/LUIS/předpověď/Action | Načte předpověď publikovaných koncových bodů pro daný dotaz. |
...
> | Akce | Microsoft. Cognitiveservices Account/Accounts/Read | Přečte účty rozhraní API. |
...
> | Akce | Microsoft. Cognitiveservices Account/Accounts/Write | Zapisuje účty rozhraní API. |
> | Akce | Microsoft. Cognitiveservices Account/checkDomainAvailability/Action | Přečte dostupné SKU pro předplatné. |
> | Akce | Microsoft. Cognitiveservices Account/Locations/checkSkuAvailability/Action | Přečte dostupné SKU pro předplatné. |
> | Akce | Microsoft. Cognitiveservices Account/Locations/checkSkuAvailability/Action | Přečte dostupné SKU pro předplatné. |
> | Akce | Microsoft. Cognitiveservices Account/Locations/deleteVirtualNetworkOrSubnets/Action | Oznámení od společnosti Microsoft. Network odstraňování VirtualNetworks nebo podsítí. |
> | Akce | Microsoft. Cognitiveservices Account/Operations/Read | Vypsat všechny dostupné operace |
> | Akce | Microsoft. Cognitiveservices Account/Register/Action | Zaregistruje předplatné pro Cognitive Services. |
> | Akce | Microsoft. Cognitiveservices Account/Register/Action | Zaregistruje předplatné pro Cognitive Services. |
...
> | Akce | Microsoft. COMPUTE/Galerie/images/DELETE | Odstraní obrázek Galerie. |
> | Akce | Microsoft. COMPUTE/Galerie/images/čtení | Získá vlastnosti obrázku galerie. |
> | Akce | Microsoft. COMPUTE/Galerie/images/verze/odstranění | Odstraní verzi image galerie. |
> | Akce | Microsoft. COMPUTE/Galerie/images/verze/čtení | Získá vlastnosti verze image galerie. |
> | Akce | Microsoft. COMPUTE/Galerie/images/verze/zápis | Vytvoří novou verzi Image Galerie nebo aktualizuje stávající. |
> | Akce | Microsoft. COMPUTE/Galerie/images/Write | Vytvoří novou image galerie nebo aktualizuje stávající. |
...
> | Akce | Microsoft. COMPUTE/virtualMachines/povolených velikostí/Read | Zobrazí seznam dostupných velikostí, na které se dá virtuální počítač aktualizovat. |
...
> | Akce | Microsoft. COMPUTE/virtualMachineScaleSets/virtualMachines/networkInterfaces/IPConfiguration/publicIPAddresses/číst | Získá vlastnosti veřejné IP adresy vytvořené pomocí sady škálování virtuálních počítačů. Sada škálování virtuálního počítače může vytvořit maximálně jednu veřejnou IP adresu na IPConfiguration (privátní IP adresa). |
> | Akce | Microsoft. COMPUTE/virtualMachineScaleSets/virtualMachines/networkInterfaces/IPConfiguration/Read | Získá vlastnosti jedné nebo všech konfigurací IP síťového rozhraní vytvořeného pomocí sady škálování virtuálního počítače. Konfigurace protokolu IP reprezentují privátní IP adresy. |
...
> | Akce | Microsoft. spotřeb/stav operationstatus/Read | Seznam stav operationstatus |
...
> | Akce | Microsoft. ContainerInstance/containerGroups/Containers/logs/číst | Získá protokoly pro konkrétní kontejner. |
...
> | Akce | Microsoft. ContainerInstance/umístění/použití/číst | Získejte využití konkrétní oblasti. |
...
> | Akce | Microsoft. ContainerRegistry/Registry/artefakty/odstranit | Odstraňte artefakt v registru kontejnerů. |
...
> | Akce | Microsoft. ContainerRegistry/Registry/buildTasks/DELETE | Odstraní úlohu sestavení z registru kontejneru. |
> | Akce | Microsoft. ContainerRegistry/Registry/buildTasks/listSourceRepositoryProperties/Action | Obsahuje seznam vlastností správy zdrojového kódu pro úlohu sestavení. |
> | Akce | Microsoft. ContainerRegistry/Registry/buildTasks/Read | Získá vlastnosti zadané úlohy sestavení nebo zobrazí seznam všech úloh sestavení pro zadaný registr kontejnerů. |
> | Akce | Microsoft. ContainerRegistry/Registry/buildTasks/Steps/DELETE | Odstraní krok sestavení z úlohy sestavení. |
> | Akce | Microsoft. ContainerRegistry/Registry/buildTasks/Steps/listBuildArguments/Action | Vypíše argumenty sestavení pro krok sestavení včetně tajných argumentů. |
> | Akce | Microsoft. ContainerRegistry/Registry/buildTasks/Steps/Read | Získá vlastnosti zadaného kroku sestavení nebo zobrazí seznam všech kroků sestavení pro zadanou úlohu sestavení. |
> | Akce | Microsoft. ContainerRegistry/Registry/buildTasks/Steps/Write | Vytvoří nebo aktualizuje krok sestavení pro úlohu sestavení se zadanými parametry. |
> | Akce | Microsoft. ContainerRegistry/Registry/buildTasks/Write | Vytvoří nebo aktualizuje úlohu sestavení pro registr kontejneru se zadanými parametry. |
> | Akce | Microsoft. ContainerRegistry/Registry/DELETE | Odstraní registr kontejneru. |
> | Akce | Microsoft. ContainerRegistry/Registry/eventGridFilters/DELETE | Odstraní filtr Event gridu z registru kontejneru. |
> | Akce | Microsoft. ContainerRegistry/Registry/eventGridFilters/Read | Získá vlastnosti zadaného filtru Event gridu nebo vypíše všechny filtry služby Event Grid pro zadaný registr kontejnerů. |
> | Akce | Microsoft. ContainerRegistry/Registry/eventGridFilters/Write | Vytvoří nebo aktualizuje filtr Event gridu pro registr kontejneru se zadanými parametry. |
> | Akce | Microsoft. ContainerRegistry/Registry/getBuildSourceUploadUrl/Action | Získá umístění pro odeslání pro uživatele, aby mohl odeslat zdroj. |
> | Akce | Microsoft. ContainerRegistry/Registry/importImage/Action | Importujte image do registru kontejneru se zadanými parametry. |
> | Akce | Microsoft. ContainerRegistry/Registry/listBuildSourceUploadUrl/Action | Získá umístění adresy URL pro nahrání zdroje pro registr kontejneru. |
> | Akce | Microsoft. ContainerRegistry/Registry/listCredentials/Action | Zobrazí seznam přihlašovacích údajů pro zadaný registr kontejnerů. |
> | Akce | Microsoft. ContainerRegistry/Registry/listPolicies/Read | Zobrazí seznam zásad pro zadaný registr kontejnerů. |
> | Akce | Microsoft. ContainerRegistry/Registry/listUsages/Read | Vypíše využití kvót pro zadaný registr kontejnerů. |
> | Akce | Microsoft. ContainerRegistry/Registry/metadata/číst | Načte metadata konkrétního úložiště pro registr kontejneru. |
> | Akce | Microsoft. ContainerRegistry/Registry/metadata/Write | Aktualizuje metadata úložiště pro registr kontejneru. |
> | Akce | Microsoft. ContainerRegistry/Registry/operationStatuses/Read | Načte stav asynchronní operace v registru. |
> | Akce | Microsoft. ContainerRegistry/registrys/Pull/Read | Vyžádání nebo získání imagí z registru kontejneru. |
> | Akce | Microsoft. ContainerRegistry/Registry/push/Write | Vložení nebo zápis imagí do registru kontejneru. |
> | Akce | Microsoft. ContainerRegistry/Registry/quarantineRead/Read | Vyžádání nebo získání imagí v karanténě z registru kontejnerů |
> | Akce | Microsoft. ContainerRegistry/Registry/quarantineWrite/Write | Zápis/Změna stavu karantény imagí v karanténě |
> | Akce | Microsoft. ContainerRegistry/Registry/queueBuild/Action | Vytvoří nové sestavení založené na parametrech žádosti a přidá je do fronty sestavení. |
> | Akce | Microsoft. ContainerRegistry/Registry/číst | Získá vlastnosti zadaného registru kontejneru nebo zobrazí seznam všech registrů kontejnerů v rámci zadané skupiny prostředků nebo předplatného. |
...
> | Akce | Microsoft. ContainerRegistry/Registry/replikace/odstranit | Odstraní replikaci z registru kontejneru. |
> | Akce | Microsoft. ContainerRegistry/Registry/Replication/operationStatuses/Read | Získá stav asynchronní operace replikace. |
> | Akce | Microsoft. ContainerRegistry/Registry/replikace/číst | Získá vlastnosti zadané replikace nebo vypíše všechny replikace určeného registru kontejneru. |
> | Akce | Microsoft. ContainerRegistry/Registry/replikace/zapisovat | Vytvoří nebo aktualizuje replikaci pro registr kontejneru se zadanými parametry. |
> | Akce | Microsoft. ContainerRegistry/Registry/spuštění/zrušení/akce | Zruší existující běh. |
> | Akce | Microsoft. ContainerRegistry/Registry/běhy/listLogSasUrl/Action | Získá adresu URL protokolu SAS protokolu pro běh. |
> | Akce | Microsoft. ContainerRegistry/Registry/běhy/číst | Získá vlastnosti spuštění proti registru kontejneru nebo spuštění seznamu. |
> | Akce | Microsoft. ContainerRegistry/Registry/běhy/Write | Aktualizuje běh. |
> | Akce | Microsoft. ContainerRegistry/Registry/scheduleRun/Action | Naplánování spuštění proti registru kontejneru. |
> | Akce | Microsoft. ContainerRegistry/Registry/Sign/Write | Metadata vztahu důvěryhodnosti nabízených nebo vyžádaného obsahu pro registr kontejneru. |
> | Akce | Microsoft. ContainerRegistry/registrys/Tasks/DELETE | Odstraní úlohu pro registr kontejneru. |
> | Akce | Microsoft. ContainerRegistry/registrys/Tasks/listDetails/Action | Zobrazí seznam všech podrobností úlohy pro registr kontejneru. |
> | Akce | Microsoft. ContainerRegistry/registrys/Tasks/Read | Načte úlohu pro registr kontejneru nebo seznam všech úkolů. |
> | Akce | Microsoft. ContainerRegistry/registrys/Tasks/Write | Vytvoří nebo aktualizuje úlohu pro registr kontejneru. |
> | Akce | Microsoft. ContainerRegistry/Registry/updatePolicies/Write | Aktualizuje zásady pro zadaný registr kontejnerů. |
> | Akce | Microsoft. ContainerRegistry/Registry/webhooks/DELETE | Odstraní Webhook z registru kontejneru. |
> | Akce | Microsoft. ContainerRegistry/Registry/webhooks/getCallbackConfig/Action | Získá konfiguraci identifikátoru URI služby a vlastních hlaviček pro Webhook. |
> | Akce | Microsoft. ContainerRegistry/Registry/webhooks/listEvents/Action | Vypíše nedávné události pro zadaný Webhook. |
> | Akce | Microsoft. ContainerRegistry/Registry/webhooks/operationStatuses/Read | Získá stav asynchronní operace Webhooku. |
> | Akce | Microsoft. ContainerRegistry/Registry/webhooks/test/Action | Aktivuje událost testu, která se pošle Webhooku. |
> | Akce | Microsoft. ContainerRegistry/Registry/webhooks/Read | Získá vlastnosti zadaného Webhooku nebo vypíše všechny Webhooky zadaného registru kontejneru. |
> | Akce | Microsoft. ContainerRegistry/Registry/webhooks/Write | Vytvoří nebo aktualizuje Webhook pro registr kontejneru se zadanými parametry. |
> | Akce | Microsoft. ContainerRegistry/Registry/Write | Vytvoří nebo aktualizuje registr kontejneru se zadanými parametry. |
...
> | Akce | Microsoft. ContainerService/umístění/Orchestration/číst | Vypisuje podporované orchestrace. |
...
> | Akce | Microsoft. ContainerService/zrušit registraci/akce | Zruší registraci předplatného u poskytovatele prostředků Microsoft. ContainerService. |
...
> | Typ akce | Operace | Popis |
> | --- | --- | --- |
> | Akce | Microsoft. ContentModerator/aplikace/DELETE | Odstranit operaci |
...
> | Akce | Microsoft. ContentModerator/aplikace/číst | Operace čtení |
> | Akce | Microsoft. ContentModerator/aplikace/Write | Operace zápisu |
> | Akce | Microsoft. ContentModerator/aplikace/Write | Operace zápisu |
...
> | Akce | Microsoft. CostManagement/dotaz/čtení | Dotazování dat o využití podle oboru |
...
> | Akce | Microsoft. CostManagement/klienti/registrace/akce | Zaregistrujte akci pro obor Microsoft. CostManagement v tenantovi. |
...
> | Typ akce | Operace | Popis |
> | --- | --- | --- |
> | Akce | Microsoft. DataBoxEdge/dataBoxEdgeDevices/Alerts/číst | Zobrazí nebo získá výstrahy. |
> | Akce | Microsoft. DataBoxEdge/dataBoxEdgeDevices/Alerts/číst | Zobrazí nebo získá výstrahy. |
...
> | Akce | Microsoft. DataBoxEdge/dataBoxEdgeDevices/role/číst | Zobrazí nebo získá role. |
> | Akce | Microsoft. DataBoxEdge/dataBoxEdgeDevices/role/číst | Zobrazí nebo získá role. |
...
> | Akce | Microsoft. DataBoxEdge/dataBoxEdgeDevices/Shared/DELETE | Odstraní sdílené složky. |
> | Akce | Microsoft. DataBoxEdge/dataBoxEdgeDevices/Shared/operationResults/Read | Zobrazí nebo získá výsledek operace. |
> | Akce | Microsoft. DataBoxEdge/dataBoxEdgeDevices/Shared/Read | Zobrazí nebo získá sdílené složky. |
> | Akce | Microsoft. DataBoxEdge/dataBoxEdgeDevices/Shared/Read | Zobrazí nebo získá sdílené složky. |
> | Akce | Microsoft. DataBoxEdge/dataBoxEdgeDevices/Shares/Refresh/Action | Obnovte metadata sdílení s daty z cloudu. |
> | Akce | Microsoft. DataBoxEdge/dataBoxEdgeDevices/Shared/Write | Vytvoří nebo aktualizuje sdílené složky. |
...
> | Akce | Microsoft. DataBoxEdge/dataBoxEdgeDevices/Users/číst | Zobrazí nebo získá uživatele sdílené složky. |
> | Akce | Microsoft. DataBoxEdge/dataBoxEdgeDevices/Users/číst | Zobrazí nebo získá uživatele sdílené složky. |
...
> | Typ akce | Operace | Popis |
> | --- | --- | --- |
> | Akce | Microsoft. datacihly/umístění/getNetworkPolicies/Action | Získání zásad záměru sítě pro podsíť na základě umístění používaného službou NRP |
...
> | Akce | Microsoft. datacatalog/registrovat/Action | Registrace předplatného pro Data Catalog poskytovatele prostředků |
> | Akce | Microsoft. datacatalog/zrušit registraci/akce | Zrušení registrace předplatného pro Data Catalog poskytovatele prostředků |
...
> | Akce | Microsoft. DataFactory/DataFactory/activitywindows/Read | Přečte okna aktivity v Data Factory se zadanými parametry. |
> | Akce | Microsoft. DataFactory/DataFactory/datapipelines/Activities/activitywindows/Read | Přečte okna aktivity pro aktivitu kanálu se zadanými parametry. |
> | Akce | Microsoft. DataFactory/DataFactory/datapipelines/activitywindows/Read | Přečte okna aktivity pro kanál se zadanými parametry. |
> | Akce | Microsoft. DataFactory/DataFactory/datapipelines/DELETE | Odstraní všechny kanály. |
...
> | Akce | Microsoft. DataFactory/DataFactory/datapipelines/Update/Action | Aktualizuje všechny kanály. |
> | Akce | Microsoft. DataFactory/DataFactory/Write | Vytvoří nebo aktualizuje libovolný kanál. |
> | Akce | Microsoft. DataFactory/DataFactory/activitywindows/Read | Přečte okna aktivity pro datovou sadu se zadanými parametry. |
> | Akce | Microsoft. DataFactory/DataFactory/DataSets/DELETE | Odstraní libovolnou datovou sadu. |
...
> | Akce | Microsoft. DataFactory/DataFactory/Slices/Read | Načte datové řezy v daném období. |
> | Akce | Microsoft. DataFactory/DataFactory/Slices/Write | Aktualizujte stav datového řezu. |
> | Akce | Microsoft. DataFactory/DataFactory/Write | Vytvoří nebo aktualizuje libovolnou datovou sadu. |
> | Akce | Microsoft. DataFactory/DataFactory/DELETE | Odstraní Data Factory. |
> | Akce | Microsoft. DataFactory/DataFactory/gateways/ConnectionInfo/Action | Přečte informace o připojení pro každou bránu. |
> | Akce | Microsoft. DataFactory/DataFactory/gateways/DELETE | Odstraní libovolnou bránu. |
> | Akce | Microsoft. DataFactory/DataFactory/gateways/listauthkeys/Action | Zobrazuje seznam ověřovacích klíčů pro každou bránu. |
> | Akce | Microsoft. DataFactory/DataFactory/gateways/Read | Přečte libovolnou bránu. |
> | Akce | Microsoft. DataFactory/DataFactory/gateways/regenerateauthkey/Action | Znovu vygeneruje ověřovací klíče pro každou bránu. |
> | Akce | Microsoft. DataFactory/DataFactory/gateways/Write | Vytvoří nebo aktualizuje libovolnou bránu. |
> | Akce | Microsoft. DataFactory/DataFactory/linkedServices/DELETE | Odstraní veškerou propojenou službu. |
> | Akce | Microsoft. DataFactory/DataFactory/linkedServices/Read | Přečte jakoukoli propojenou službu. |
> | Akce | Microsoft. DataFactory/DataFactory/linkedServices/Write | Vytvoří nebo aktualizuje jakoukoli propojenou službu. |
> | Akce | Microsoft. DataFactory/DataFactory/Read | Přečte Data Factory. |
> | Akce | Microsoft. DataFactory/DataFactory/běhy/LogInfo/Read | Přečte identifikátor URI SAS pro kontejner objektů BLOB obsahující protokoly. |
> | Akce | Microsoft. DataFactory/DataFactory/Tables/DELETE | Odstraní libovolnou datovou sadu. |
> | Akce | Microsoft. DataFactory/DataFactory/tabless/Read | Přečte libovolnou datovou sadu. |
> | Akce | Microsoft. DataFactory/DataFactory/Tables/Write | Vytvoří nebo aktualizuje libovolnou datovou sadu. |
> | Akce | Microsoft. DataFactory/DataFactory/Write | Vytvoří nebo aktualizuje Data Factory. |
...
> | Akce | Microsoft. DataFactory/Factory/dataflows/DELETE | Odstraní tok dat. |
> | Akce | Microsoft. DataFactory/Factory/toku dat/čtení | Přečte tok dat. |
> | Akce | Microsoft. DataFactory/Factory/Flowes/Write | Vytvořit nebo aktualizovat tok dat |
> | Akce | Microsoft. DataFactory/Factory/DataSets/DELETE | Odstraní libovolnou datovou sadu. |
> | Akce | Microsoft. DataFactory/Factory/DataSets/číst | Přečte libovolnou datovou sadu. |
> | Akce | Microsoft. DataFactory/Factory/datové sady/zápis | Vytvoří nebo aktualizuje libovolnou datovou sadu. |
> | Akce | Microsoft. DataFactory/Factory/debugpipelineruns/Cancel/Action | Zruší ladicí běh kanálu. |
> | Akce | Microsoft. DataFactory/Factory/DELETE | Odstraní Data Factory. |
...
> | Akce | Microsoft. DataFactory/Factory/getDataPlaneAccess/Read | Přečte přístup k službě ADF (dataplaning Service). |
> | Akce | Microsoft. DataFactory/Factory/getFeatureValue/Action | Získat hodnotu funkce řízení expozice pro konkrétní umístění. |
> | Akce | Microsoft. DataFactory/Factory/getFeatureValue/Read | Přečte hodnotu funkce řízení expozice pro konkrétní umístění. |
> | Akce | Microsoft. DataFactory/Factory/getGitHubAccessToken/Action | Získá přístupový token GitHubu. |
> | Akce | Microsoft. DataFactory/Factory/integrationruntimes/DELETE | Odstraní všechny Integration Runtime. |
> | Akce | Microsoft. DataFactory/Factory/integrationruntimes/GetConnectionInfo/Read | Přečte Integration Runtime informace o připojení. |
> | Akce | Microsoft. DataFactory/Factory/integrationruntimes/getObjectMetadata/Action | Získá metadata SSIS Integration Runtime pro zadaný Integration Runtime. |
> | Akce | Microsoft. DataFactory/Factory/integrationruntimes/GetStatus/Read | Přečte stav Integration Runtime. |
> | Akce | Microsoft. DataFactory/Factory/integrationruntimes/linkedIntegrationRuntime/Action | Vytvoří odkaz na propojenou Integration Runtime v zadaném sdíleném Integration Runtime. |
> | Akce | Microsoft. DataFactory/Factory/integrationruntimes/listauthkeys/Read | Zobrazí seznam ověřovacích klíčů pro všechny Integration Runtime. |
> | Akce | Microsoft. DataFactory/Factory/integrationruntimes/monitoringdata/Read | Načte data monitorování pro všechny Integration Runtime. |
> | Akce | Microsoft. DataFactory/Factory/integrationruntimes/Nodes/DELETE | Odstraní uzel pro zadaný Integration Runtime. |
> | Akce | Microsoft. DataFactory/Factory/integrationruntimes/Nodes/ipAddress/Action | Vrátí IP adresu pro zadaný uzel Integration Runtime. |
> | Akce | Microsoft. DataFactory/Factory/integrationruntimes/Nodes/Read | Přečte uzel pro zadaný Integration Runtime. |
> | Akce | Microsoft. DataFactory/Factory/integrationruntimes/Nodes/Write | Aktualizuje uzel Integration Runtime v místním prostředí. |
> | Akce | Microsoft. DataFactory/Factory/integrationruntimes/Read | Přečte všechny Integration Runtime. |
> | Akce | Microsoft. DataFactory/Factory/integrationruntimes/refreshObjectMetadata/Action | Aktualizuje SSIS metadata Integration Runtime pro zadaný Integration Runtime. |
> | Akce | Microsoft. DataFactory/Factory/integrationruntimes/regenerateauthkey/Action | Znovu vygeneruje ověřovací klíče pro zadaný Integration Runtime. |
> | Akce | Microsoft. DataFactory/Factory/integrationruntimes/removelinks/Action | Odebere propojené Integration Runtime odkazy ze zadaného Integration Runtime. |
...
> | Akce | Microsoft. DataFactory/Factory/integrationruntimes/Write | Vytvoří nebo aktualizuje jakékoli Integration Runtime. |
> | Akce | Microsoft. DataFactory/Factory/linkedServices/DELETE | Odstraní propojenou službu. |
> | Akce | Microsoft. DataFactory/Factory/linkedServices/Read | Načte propojenou službu. |
> | Akce | Microsoft. DataFactory/Factory/linkedServices/Write | Vytvoří nebo aktualizuje propojenou službu. |
...
> | Akce | Microsoft. DataFactory/Factory/pipelineruns/queryactivityruns/Action | Dotazuje spuštění aktivity pro zadané ID spuštění kanálu. |
> | Akce | Microsoft. DataFactory/Factory/pipelineruns/queryactivityruns/Read | Přečte výsledek spuštění aktivity dotazu pro zadané ID spuštění kanálu. |
> | Akce | Microsoft. DataFactory/Factory/pipelineruns/Read | Přečte spuštění kanálu. |
> | Akce | Microsoft. DataFactory/factorys/Pipelines/createrun/Action | Vytvoří běh pro kanál. |
> | Akce | Microsoft. DataFactory/factorys/Pipelines/DELETE | Odstraní kanál. |
> | Akce | Microsoft. DataFactory/factorys/Pipelines/pipelineruns/activityruns/průběh/čtení | Získá průběh spuštění aktivity. |
> | Akce | Microsoft. DataFactory/factorys/Pipelines/pipelineruns/Read | Přečte běh kanálu. |
> | Akce | Microsoft. DataFactory/továrny/kanály/číst | Přečte kanál. |
...
> | Akce | Microsoft. DataFactory/factorys/Pipelines/Write | Vytvořit nebo aktualizovat kanál |
> | Akce | Microsoft. DataFactory/Factory/querydebugpipelineruns/Action | Provede dotaz na spuštění kanálu ladění. |
> | Akce | Microsoft. DataFactory/Factory/querypipelineruns/Action | Provede dotaz na spuštění kanálu. |
> | Akce | Microsoft. DataFactory/Factory/querypipelineruns/Read | Přečte výsledek spuštění kanálu dotazů. |
> | Akce | Microsoft. DataFactory/Factory/querytriggerruns/Action | Provede dotaz na spuštění triggeru. |
> | Akce | Microsoft. DataFactory/Factory/querytriggerruns/Read | Přečte výsledek spuštění triggeru. |
> | Akce | Microsoft. DataFactory/Factory/Read | Přečte Data Factory. |
...
> | Akce | Microsoft. DataFactory/Factory/triggerruns/Read | Přečte spuštění triggeru. |
> | Akce | Microsoft. DataFactory/Factory/Triggers/DELETE | Odstraní všechny triggery. |
> | Akce | Microsoft. DataFactory/Factory/Triggers/Read | Přečte všechny triggery. |
...
> | Akce | Microsoft. DataFactory/Factory/Triggers/triggerruns/Read | Přečte spuštění triggeru. |
> | Akce | Microsoft. DataFactory/Factory/Triggers/Write | Vytvoří nebo aktualizuje libovolné triggery. |
> | Akce | Microsoft. DataFactory/Factory/Write | Vytvořit nebo aktualizovat Data Factory |
...
> | Akce | Microsoft. DataFactory/zrušit registraci/akce | Zruší registraci předplatného pro Data Factory poskytovatele prostředků. |
...
> | Akce | Microsoft. DataLakeAnalytics/umístění/použití/číst | Získat informace o využití kvóty pro předplatné týkající se použití DataLakeAnalytics |
...
> | Akce | Microsoft. DataLakeStore/umístění/použití/číst | Získat informace o využití kvóty pro předplatné týkající se použití DataLakeStore |
...
> | Akce | Migrace Microsoft. DataServices/služby/projekty/soubory/odstranění | Odstraní prostředek a všechny jeho podřízené položky. |
> | Akce | Migrace Microsoft. DataServices/služby/projekty/soubory/čtení | Přečtěte si informace o prostředcích |
...
> | Akce | Migrace Microsoft. DataServices/služby/projekty/soubory/zápis | Vytvoření nebo aktualizace prostředků a jejich vlastností |
...
> | Akce | Microsoft. datamigrace/služby/projekty/úkoly/odstranit | Odstraní prostředek a všechny jeho podřízené položky. |
> | Akce | Microsoft. datamigrace/služby/projekty/úkoly/číst | Přečtěte si informace o prostředcích |
> | Akce | Migrace Microsoft. DataServices/služby/projekty/úkoly/zápis | Spouštění úloh Azure Database Migration Service úlohami |
> | Akce | Migrace Microsoft. DataServices/služby/projekty/zápis | Spouštění úloh Azure Database Migration Service úlohami |
...
> | Akce | Microsoft. datamigration/Services/sloty/DELETE | Odstraní prostředek a všechny jeho podřízené položky. |
...
> | Akce | Microsoft. DBforMariaDB/servery/konfigurace/číst | Vrátí seznam konfigurací pro server nebo získá vlastnosti pro zadanou konfiguraci. |
> | Akce | Microsoft. DBforMariaDB/servery/konfigurace/zápis | Aktualizuje hodnotu zadané konfigurace. |
> | Akce | Microsoft. DBforMariaDB/servery/databáze/odstranit | Odstraní existující databázi MariaDB. |
> | Akce | Microsoft. DBforMariaDB/servery/databáze/číst | Vrátí seznam databází MariaDB nebo získá vlastnosti zadané databáze. |
> | Akce | Microsoft. DBforMariaDB/servery/databáze/zapisovat | Vytvoří databázi MariaDB se zadanými parametry nebo aktualizuje vlastnosti zadané databáze. |
> | Akce | Microsoft. DBforMariaDB/servery/DELETE | Odstraní existující server. |
...
> | Akce | Microsoft. DBforMariaDB/servery/firewallRules/Write | Vytvoří pravidlo brány firewall se zadanými parametry nebo aktualizuje stávající pravidlo. |
> | Akce | Microsoft. DBforMariaDB/servery/logFiles/Read | Vrátí seznam protokolů MariaDB. |
> | Akce | Microsoft. DBforMariaDB/servery/zprostředkovatelé/Microsoft. Insights/diagnosticSettings/Read | Získá nastavení disagnostic prostředku. |
> | Akce | Microsoft. DBforMariaDB/servery/zprostředkovatelé/Microsoft. Insights/diagnosticSettings/Write | Vytvoří nebo aktualizuje nastavení diagnostiky pro prostředek. |
...
> | Akce | Microsoft. DBforMariaDB/servery/queryTexts/Action | Vrátí text pro seznam dotazů. |
...
> | Akce | Microsoft. DBforMariaDB/servery/topQueryStatistics/Read | Vrátí seznam statistik dotazu pro nejčastější dotazy. |
> | Akce | Microsoft. DBforMariaDB/servery/topQueryStatistics/Read | Vrátí statistiku dotazu. |
> | Akce | Microsoft. DBforMariaDB/servery/updateConfigurations/Action | Aktualizuje konfigurace pro zadaný server. |
> | Akce | Microsoft. DBforMariaDB/servery/virtualNetworkRules/DELETE | Odstraní existující pravidlo Virtual Network. |
...
> | Akce | Microsoft. DBforMariaDB/servery/waitStatistics/Read | Vrátí statistiku čekání pro instanci. |
> | Akce | Microsoft. DBforMariaDB/servery/waitStatistics/Read | Vrácení statistiky čekání |
> | Akce | Microsoft. DBforMariaDB/servery/Write | Vytvoří server se zadanými parametry nebo aktualizuje vlastnosti nebo značky pro zadaný server. |
...
> | Akce | Microsoft. DBforMySQL/servery/konfigurace/zápis | Aktualizuje hodnotu zadané konfigurace. |
> | Akce | Microsoft. DBforMySQL/servery/databáze/odstranit | Odstraní existující databázi MySQL. |
> | Akce | Microsoft. DBforMySQL/servery/databáze/číst | Vrátí seznam databází MySQL nebo získá vlastnosti zadané databáze. |
> | Akce | Microsoft. DBforMySQL/servery/databáze/zapisovat | Vytvoří databázi MySQL se zadanými parametry nebo aktualizuje vlastnosti zadané databáze. |
> | Akce | Microsoft. DBforMySQL/servery/DELETE | Odstraní existující server. |
...
> | Akce | Microsoft. DBforMySQL/servery/logFiles/Read | Vrátí seznam protokolů PostgreSQL. |
...
> | Akce | Microsoft. DBforMySQL/servery/zprostředkovatelé/Microsoft. Insights/diagnosticSettings/Write | Vytvoří nebo aktualizuje nastavení diagnostiky pro prostředek. |
...
> | Akce | Microsoft. DBforMySQL/servery/queryTexts/Action | Vrátí text pro seznam dotazů. |
> | Akce | Microsoft. DBforMySQL/servery/queryTexts/Action | Vrátí text dotazu. |
> | Akce | Microsoft. DBforMySQL/servery/číst | Vrátí seznam serverů nebo získá vlastnosti pro zadaný server. |
> | Akce | Microsoft. DBforMySQL/servery/recoverableServers/Read | Vrátí informace o obnovitelném serveru MySQL. |
...
> | Akce | Microsoft. DBforMySQL/servery/securityAlertPolicies/Read | Načte podrobnosti o zásadách detekce hrozeb serveru nakonfigurovaných na daném serveru. |
> | Akce | Microsoft. DBforMySQL/servery/securityAlertPolicies/Write | Změna zásad detekce hrozeb serveru pro daný server |
> | Akce | Microsoft. DBforMySQL/servery/topQueryStatistics/Read | Vrátí seznam statistik dotazu pro nejčastější dotazy. |
> | Akce | Microsoft. DBforMySQL/servery/topQueryStatistics/Read | Vrátí statistiku dotazu. |
...
> | Akce | Microsoft. DBforMySQL/servery/Write | Vytvoří server se zadanými parametry nebo aktualizuje vlastnosti nebo značky pro zadaný server. |
...
> | Akce | Microsoft. DBforPostgreSQL/servery/poradci/číst | Vrátí seznam poradců. |
...
> | Akce | Microsoft. DBforPostgreSQL/servery/konfigurace/číst | Vrátí seznam konfigurací pro server nebo získá vlastnosti pro zadanou konfiguraci. |
> | Akce | Microsoft. DBforPostgreSQL/servery/konfigurace/zápis | Aktualizuje hodnotu zadané konfigurace. |
> | Akce | Microsoft. DBforPostgreSQL/servery/databáze/odstranit | Odstraní existující databázi PostgreSQL. |
> | Akce | Microsoft. DBforPostgreSQL/servery/databáze/číst | Vrátí seznam databází PostgreSQL nebo získá vlastnosti zadané databáze. |
> | Akce | Microsoft. DBforPostgreSQL/servery/databáze/zapisovat | Vytvoří databázi PostgreSQL se zadanými parametry nebo aktualizuje vlastnosti zadané databáze. |
> | Akce | Microsoft. DBforPostgreSQL/servery/DELETE | Odstraní existující server. |
> | Akce | Microsoft. DBforPostgreSQL/servery/firewallRules/DELETE | Odstraní existující pravidlo brány firewall. |
...
> | Akce | Microsoft. DBforPostgreSQL/servery/queryTexts/Action | Vrátí text dotazu. |
> | Akce | Microsoft. DBforPostgreSQL/servery/queryTexts/Read | Vrátí text pro seznam dotazů. |
> | Akce | Microsoft. DBforPostgreSQL/servery/číst | Vrátí seznam serverů nebo získá vlastnosti pro zadaný server. |
...
> | Akce | Microsoft. DBforPostgreSQL/servery/securityAlertPolicies/Read | Načte podrobnosti o zásadách detekce hrozeb serveru nakonfigurovaných na daném serveru. |
> | Akce | Microsoft. DBforPostgreSQL/servery/securityAlertPolicies/Write | Změna zásad detekce hrozeb serveru pro daný server |
> | Akce | Microsoft. DBforPostgreSQL/servery/topQueryStatistics/Read | Vrátí seznam statistik dotazu pro nejčastější dotazy. |
...
> | Akce | Microsoft. DBforPostgreSQL/servery/Write | Vytvoří server se zadanými parametry nebo aktualizuje vlastnosti nebo značky pro zadaný server. |
...
> | Akce | Microsoft. DevTestLab/Labs/náklady/čtení | Náklady na čtení. |
> | Akce | Microsoft. DevTestLab/Labs/náklady/zápis | Přidat nebo upravit náklady. |
...
> | Akce | Microsoft. DevTestLab/Labs/vzorce/odstranit | Odstraňte vzorce. |
> | Akce | Microsoft. DevTestLab/Labs/vzorců/čtení | Čtení vzorců. |
> | Akce | Microsoft. DevTestLab/Labs/vzorce/zápis | Přidat nebo upravit vzorce. |
...
> | Akce | Microsoft. DevTestLab/Labs/číst | Přečtěte si Labs. |
...
> | Akce | Microsoft. DevTestLab/Labs/plány/číst | Načtou se plány. |
...
> | Akce | Microsoft. DevTestLab/Labs/uživatelé/odstranit | Odstraňte profily uživatelů. |
> | Akce | Microsoft. DevTestLab/Labs/uživatelé/disky/připojit/akce | Připojte a vytvořte zapůjčení disku k virtuálnímu počítači. |
> | Akce | Microsoft. DevTestLab/Labs/uživatelé/disky/odstranit | Odstraňte disky. |
> | Akce | Microsoft. DevTestLab/Labs/uživatelé/disky/odpojit/akci | Odpojit a zrušit zapůjčení disku připojeného k virtuálnímu počítači. |
> | Akce | Microsoft. DevTestLab/Labs/uživatelé/disky/číst | Čtení disků. |
> | Akce | Microsoft. DevTestLab/Labs/uživatelé/disky/zapisovat | Přidejte nebo upravte disky. |
> | Akce | Microsoft. DevTestLab/Labs/uživatelé/prostředí/odstranit | Odstraňte prostředí. |
> | Akce | Microsoft. DevTestLab/Labs/uživatelé/prostředí/číst | Čtení prostředí. |
> | Akce | Microsoft. DevTestLab/Labs/uživatelé/prostředí/zapisovat | Přidejte nebo upravte prostředí. |
> | Akce | Microsoft. DevTestLab/Labs/Users/číst | Čtení profilů uživatelů. |
> | Akce | Microsoft. DevTestLab/Labs/Users/tajné/odstranit | Odstraňte tajné kódy. |
> | Akce | Microsoft. DevTestLab/Labs/Users/tajné/číst | Čtení tajných kódů. |
> | Akce | Microsoft. DevTestLab/Labs/uživatelé/tajné/zapisovat | Přidání nebo úprava tajných klíčů. |
...
> | Akce | Microsoft. DevTestLab/Labs/uživatelé/zapisovat | Přidejte nebo upravte profily uživatelů. |
...
> | Akce | Microsoft. DevTestLab/Labs/virtualMachines/nárok/Action | Převezme vlastnictví existujícího virtuálního počítače. |
...
> | Akce | Microsoft. DevTestLab/Labs/virtualMachines/znovu nasadit/akce | Opětovné nasazení virtuálního počítače |
...
> | Akce | Microsoft. DevTestLab/Labs/virtualMachines/plány/čtení | Načtou se plány. |
...
> | Akce | Microsoft. DevTestLab/Labs/virtualMachines/unnárok/Action | Vydávat vlastnictví existujícího virtuálního počítače |
...
> | Akce | Microsoft. DevTestLab/plánuje/číst | Načtou se plány. |
> | Akce | Microsoft. DevTestLab/Schedules/Target/Action | Aktualizuje ID cílového prostředku plánu. |
> | Akce | Microsoft. DevTestLab/plánuje/zapisovat | Přidat nebo upravit plány. |
...
> | Akce | Microsoft. DocumentDB/databaseAccounts/databáze/Collections/metricDefinitions/Read | Přečte definice metriky kolekce. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/databáze/kolekce/metriky/čtení | Přečte metriky kolekce. |
> | Akce | Microsoft. DocumentDB/databaseAccounts/databáze/kolekce/partitionKeyRangeId/metriky/čtení | Číst metriky úrovně klíče oddílu účtu databáze |
> | Akce | Microsoft. DocumentDB/databaseAccounts/databáze/kolekce/oddíly/metriky/čtení | Číst metriky na úrovni oddílu účtu databáze |
> | Akce | Microsoft. DocumentDB/databaseAccounts/databáze/kolekce/oddíly/čtení | Čtení oddílů databázového účtu v kolekci |
> | Akce | Microsoft. DocumentDB/databaseAccounts/databáze/kolekce/oddíly/použití/čtení | Číst použití na úrovni oddílu účtu databáze |
> | Akce | Microsoft. DocumentDB/databaseAccounts/databáze/kolekce/použití/čtení | Přečte využití kolekce. |
...
> | Akce | Microsoft. DocumentDB/databaseAccounts/databáze/použití/čtení | Přečte využití databáze. |
...
> | Akce | Microsoft. DocumentDB/databaseAccounts/percentil/číst | Přečíst percentily latencí replikace |
...
> | Akce | Microsoft. DocumentDB/databaseAccounts/privateEndpointConnectionProxies/ověřit/akce | Ověření proxy serveru připojení privátního koncového bodu k databázovému účtu |
...
> | Akce | Microsoft. DocumentDB/databaseAccounts/region/databáze/kolekce/partitionKeyRangeId/metriky/čtení | Číst metriky na úrovni klíče oddílu účtu místní databáze |
...
> | Akce | Microsoft. EventGrid/domény/regenerateKey/Action | Znovu vygenerovat klíč pro doménu |
...
> | Akce | Microsoft. EventGrid/témata/klíče listkey/Action | Seznam klíčů pro téma |
...
> | Akce | Microsoft. EventGrid/témata/regenerateKey/Action | Znovu vygenerovat klíč pro téma |
> | Akce | Microsoft. EventGrid/témata/zápis | Vytvoří nebo aktualizuje téma. |
> | Akce | Microsoft. EventGrid/topictypes/eventSubscriptions/Read | Vypsat globální odběry událostí podle typu tématu |
> | Akce | Microsoft. EventGrid/topictypes/EventType/Read | Číst typ události podporovaný TopicType |
> | Akce | Microsoft. EventGrid/topictypes/Read | Přečíst TopicType |
> | Akce | Microsoft. EventGrid/zrušit registraci/akce | Zruší registraci předplatného pro poskytovatele prostředků EventGrid. |
...
> | Akce | Microsoft. EventHub/umístění/deleteVirtualNetworkOrSubnets/Action | Odstraní pravidla virtuální sítě v poskytovateli prostředků EventHub pro zadanou virtuální síť. |
...
> | Akce | Microsoft. EventHub/obory názvů/disasterRecoveryConfigs/autorizačních pravidel/Read | Získat autorizační pravidla primárního oboru názvů pro zotavení po havárii |
...
> | Akce | Microsoft. EventHub/SKU/číst | Získá seznam popisů prostředků SKU. |
...
> | Akce | Microsoft. Insights/Upozorněníprotokoluaktivit/aktivované/Action | Aktivovalo se upozornění protokolu aktivit. |
> | Akce | Microsoft. Insights/Upozorněníprotokoluaktivit/DELETE | Odstranění upozornění protokolu aktivit |
...
> | Akce | Microsoft. Insights/AlertRules/aktivované/Action | Aktivované klasické upozornění na metriku |
> | Akce | Microsoft. Insights/AlertRules/DELETE | Odstranění klasické výstrahy metriky |
> | Akce | Microsoft. Insights/AlertRules/incidenty/číst | Přečíst klasický incident výstrahy metriky |
> | Akce | Microsoft. Insights/AlertRules/Read | Čtení klasické výstrahy metriky |
> | Akce | Microsoft. Insights/AlertRules/vyřešený/Action | Vyřešeno klasické upozornění na metriku |
> | Akce | Microsoft. Insights/AlertRules/omezil/Action | Pravidlo upozornění na klasické metriky omezení |
...
> | Akce | Microsoft. Insights/EventType/digestevents/Read | Výtah čtení typu události správy |
...
> | Akce | Microsoft. Insights/logs/AlertHistory/číst | Čtení dat z tabulky AlertHistory |
> | Akce | Microsoft. Insights/logs/ApplicationInsights/číst | Čtení dat z tabulky ApplicationInsights |
...
> | Akce | Microsoft. Insights/logs/CommonSecurityLog/číst | Čtení dat z tabulky CommonSecurityLog |
...
> | Akce | Microsoft. Insights/logs/ContainerLog/číst | Čtení dat z tabulky ContainerLog |
> | Akce | Microsoft. Insights/logs/ContainerServiceLog/číst | Čtení dat z tabulky ContainerServiceLog |
> | Akce | Microsoft. Insights/logs/DeviceAppCrash/číst | Čtení dat z tabulky DeviceAppCrash |
...
> | Akce | Microsoft. Insights/logs/DeviceHardwareHealth/číst | Čtení dat z tabulky DeviceHardwareHealth |
> | Akce | Microsoft. Insights/logs/přidružený/číst | Čtení dat z tabulky přidružený |
> | Akce | Microsoft. Insights/logs/DeviceHeartbeat/číst | Čtení dat z tabulky DeviceHeartbeat |
> | Akce | Microsoft. Insights/logs/DeviceSkypeHeartbeat/číst | Čtení dat z tabulky DeviceSkypeHeartbeat |
> | Akce | Microsoft. Insights/logs/DeviceSkypeSignIn/číst | Čtení dat z tabulky DeviceSkypeSignIn |
> | Akce | Microsoft. Insights/logs/DeviceSleepState/číst | Čtení dat z tabulky DeviceSleepState |
...
> | Akce | Microsoft. Insights/logs/DHWipAppLearning/číst | Čtení dat z tabulky DHWipAppLearning |
...
> | Akce | Microsoft. Insights/logs/KubeNodeInventory/číst | Čtení dat z tabulky KubeNodeInventory |
> | Akce | Microsoft. Insights/logs/KubePodInventory/číst | Čtení dat z tabulky KubePodInventory |
> | Akce | Microsoft. Insights/logs/LinuxAuditLog/číst | Čtení dat z tabulky LinuxAuditLog |
> | Akce | Microsoft. Insights/logs/MAApplication/číst | Čtení dat z tabulky MAApplication |
> | Akce | Microsoft. Insights/logs/MAApplicationHealth/číst | Čtení dat z tabulky MAApplicationHealth |
> | Akce | Microsoft. Insights/logs/MAApplicationHealthAlternativeVersions/číst | Čtení dat z tabulky MAApplicationHealthAlternativeVersions |
> | Akce | Microsoft. Insights/logs/MAApplicationHealthIssues/číst | Čtení dat z tabulky MAApplicationHealthIssues |
> | Akce | Microsoft. Insights/logs/MAApplicationInstance/číst | Čtení dat z tabulky MAApplicationInstance |
> | Akce | Microsoft. Insights/logs/MAApplicationInstanceReadiness/číst | Čtení dat z tabulky MAApplicationInstanceReadiness |
> | Akce | Microsoft. Insights/logs/MAApplicationReadiness/číst | Čtení dat z tabulky MAApplicationReadiness |
...
> | Akce | Microsoft. Insights/logs/MADevicePnPHealthAlternativeVersions/číst | Čtení dat z tabulky MADevicePnPHealthAlternativeVersions |
...
> | Akce | Microsoft. Insights/logs/MADriverReadiness/číst | Čtení dat z tabulky MADriverReadiness |
> | Akce | Microsoft. Insights/logs/MAOfficeAddin/číst | Čtení dat z tabulky MAOfficeAddin |
> | Akce | Microsoft. Insights/logs/MAOfficeAddinHealth/číst | Čtení dat z tabulky MAOfficeAddinHealth |
> | Akce | Microsoft. Insights/logs/MAOfficeAddinHealthIssues/číst | Čtení dat z tabulky MAOfficeAddinHealthIssues |
...
> | Akce | Microsoft. Insights/logs/MAOfficeAddinReadiness/číst | Čtení dat z tabulky MAOfficeAddinReadiness |
> | Akce | Microsoft. Insights/logs/MAOfficeApp/číst | Čtení dat z tabulky MAOfficeApp |
> | Akce | Microsoft. Insights/logs/MAOfficeAppHealth/číst | Čtení dat z tabulky MAOfficeAppHealth |
> | Akce | Microsoft. Insights/logs/MAOfficeAppInstance/číst | Čtení dat z tabulky MAOfficeAppInstance |
> | Akce | Microsoft. Insights/logs/MAOfficeAppReadiness/číst | Čtení dat z tabulky MAOfficeAppReadiness |
> | Akce | Microsoft. Insights/logs/MAOfficeBuildInfo/číst | Čtení dat z tabulky MAOfficeBuildInfo |
> | Akce | Microsoft. Insights/logs/MAOfficeCurrencyAssessment/číst | Čtení dat z tabulky MAOfficeCurrencyAssessment |
> | Akce | Microsoft. Insights/logs/MAOfficeCurrencyAssessmentDailyCounts/číst | Čtení dat z tabulky MAOfficeCurrencyAssessmentDailyCounts |
> | Akce | Microsoft. Insights/logs/MAOfficeDeploymentStatus/číst | Čtení dat z tabulky MAOfficeDeploymentStatus |
> | Akce | Microsoft. Insights/logs/MAOfficeMacroHealth/číst | Čtení dat z tabulky MAOfficeMacroHealth |
> | Akce | Microsoft. Insights/logs/MAOfficeMacroHealthIssues/číst | Čtení dat z tabulky MAOfficeMacroHealthIssues |
> | Akce | Microsoft. Insights/logs/MAOfficeMacroIssueInstanceReadiness/číst | Čtení dat z tabulky MAOfficeMacroIssueInstanceReadiness |
> | Akce | Microsoft. Insights/logs/MAOfficeMacroIssueReadiness/číst | Čtení dat z tabulky MAOfficeMacroIssueReadiness |
> | Akce | Microsoft. Insights/logs/MAOfficeMacroSummary/číst | Čtení dat z tabulky MAOfficeMacroSummary |
> | Akce | Microsoft. Insights/logs/MAOfficeSuite/číst | Čtení dat z tabulky MAOfficeSuite |
> | Akce | Microsoft. Insights/logs/MAOfficeSuiteInstance/číst | Čtení dat z tabulky MAOfficeSuiteInstance |
...
> | Akce | Microsoft. Insights/logs/MAWindowsCurrencyAssessmentDailyCounts/číst | Čtení dat z tabulky MAWindowsCurrencyAssessmentDailyCounts |
> | Akce | Microsoft. Insights/logs/MAWindowsDeploymentStatus/číst | Čtení dat z tabulky MAWindowsDeploymentStatus |
> | Akce | Microsoft. Insights/logs/MAWindowsSysReqInstanceReadiness/číst | Čtení dat z tabulky MAWindowsSysReqInstanceReadiness |
...
> | Akce | Microsoft. Insights/logs/ReservedAzureCommonFields/číst | Čtení dat z tabulky ReservedAzureCommonFields |
...
> | Akce | Microsoft. Insights/logs/SecurityBaseline/číst | Čtení dat z tabulky SecurityBaseline |
> | Akce | Microsoft. Insights/logs/SecurityBaselineSummary/číst | Čtení dat z tabulky SecurityBaselineSummary |
...
> | Akce | Microsoft. Insights/logs/ServiceFabricOperationalEvent/číst | Čtení dat z tabulky ServiceFabricOperationalEvent |
> | Akce | Microsoft. Insights/logs/ServiceFabricReliableActorEvent/číst | Čtení dat z tabulky ServiceFabricReliableActorEvent |
> | Akce | Microsoft. Insights/logs/ServiceFabricReliableServiceEvent/číst | Čtení dat z tabulky ServiceFabricReliableServiceEvent |
...
> | Akce | Microsoft. Insights/logs/SharePointOnlineAssessmentRecommendation/číst | Čtení dat z tabulky SharePointOnlineAssessmentRecommendation |
...
> | Akce | Microsoft. Insights/logs/SQLQueryPerformance/číst | Čtení dat z tabulky SQLQueryPerformance |
...
> | Akce | Microsoft. Insights/logs/UADriverProblemCodes/číst | Čtení dat z tabulky UADriverProblemCodes |
> | Akce | Microsoft. Insights/logs/UAFeedback/číst | Čtení dat z tabulky UAFeedback |
> | Akce | Microsoft. Insights/logs/UAHardwareSecurity/číst | Čtení dat z tabulky UAHardwareSecurity |
...
> | Akce | Microsoft. Insights/logs/UASysReqIssue/číst | Čtení dat z tabulky UASysReqIssue |
...
> | Akce | Microsoft. Insights/logs/UpdateRunProgress/číst | Čtení dat z tabulky UpdateRunProgress |
> | Akce | Microsoft. Insights/logs/UpdateSummary/číst | Čtení dat z tabulky UpdateSummary |
> | Akce | Microsoft. Insights/protokoly/využití/čtení | Čtení dat z tabulky využití |
> | Akce | Microsoft. Insights/logs/W3CIISLog/číst | Čtení dat z tabulky W3CIISLog |
...
> | Akce | Microsoft. Insights/logs/WaaSUpdateStatus/číst | Čtení dat z tabulky WaaSUpdateStatus |
...
> | Akce | Microsoft. Insights/zrušit registraci/akce | Registrace poskytovatele Microsoft Insights |
...
> | Akce | Microsoft. deletedVaults trezor//Read | Zobrazit vlastnosti provizorních odstraněných trezorů klíčů |
...
> | Akce | Microsoft. webdeletedVaults trezor/Locations//vyprázdnění/Action | Vymazání tichého odstraněného trezoru klíčů |
> | Akce | Microsoft. webdeletedVaults trezor/Locations//Read | Zobrazit vlastnosti neodstraněného trezoru klíčů |
> | Akce | Microsoft. webdeleteVirtualNetworkOrSubnets trezor/Locations//Action | Upozorní Microsoft. webtrezor, že se odstraňuje virtuální síť nebo podsíť. |
> | Akce | Microsoft. weboperationResults trezor/Locations//Read | Zkontroluje výsledek dlouhotrvající operace spuštění. |
> | Akce | Microsoft. a trezor/operace/čtení | Zobrazí seznam operací, které jsou k dispozici v poskytovateli prostředků Microsoft. klíčů. |
> | Akce | Microsoft... trezor/registrace/akce | Zaregistruje předplatné. |
> | Akce | Microsoft... trezor/zrušení registrace/akce | Zruší registraci předplatného. |
...
> | Akce | Trezory Microsoft. a trezory/eventGridFilters/DELETE | Upozorní Microsoft. webtrezor, že se odstraňuje EventGrid odběr pro Key Vault. |
> | Akce | Trezory Microsoft. a trezory/eventGridFilters/Read | Upozorní Microsoft. webtrezor, že se zobrazuje EventGrid odběr pro Key Vault. |
> | Akce | Trezory Microsoft. a trezory/eventGridFilters/Write | Upozorní Microsoft. webtrezor, že se vytváří nové předplatné EventGrid pro Key Vault. |
...
> | Akce | Microsoft. Kusto/clustery/databáze/dataconnections/DELETE | Odstraní datová připojení resourceCopy. |
> | Akce | Microsoft. Kusto/clustery/databáze/připojení/čtení | Přečte datová připojení resourceCopy. |
> | Akce | Microsoft. Kusto/clustery/databáze/připojení/zápis | Zapisuje datová připojení resourceCopy. |
> | Akce | Microsoft. Kusto/clustery/databáze/DataConnectionValidation/Action | Ověří datové připojení databáze. |
> | Akce | Microsoft. Kusto/clustery/databáze/odstranit | Odstraní resourceCopy databáze. |
> | Akce | Microsoft. Kusto/clustery/databáze/EventHubConnections/DELETE | Odstraní připojení centra událostí resourceCopy. |
> | Akce | Microsoft. Kusto/clustery/databáze/EventHubConnections/Read | Přečte připojení centra událostí resourceCopy. |
...
> | Akce | Microsoft. Kusto/clustery/databáze/čtení | Přečte databázi resourceCopy. |
> | Akce | Microsoft. Kusto/clustery/databáze/RemovePrincipals/Action | Odebere objekty zabezpečení databáze. |
> | Akce | Microsoft. Kusto/clustery/databáze/Write | Zapíše resourceCopy databáze. |
...
> | Akce | Microsoft. Kusto/SKU/číst | Přečte resourceCopy SKU. |
...
> | Akce | Microsoft. LabServices/labAccounts/Labs/environmentSettings/prostředí/číst | Čtení prostředí. |
...
> | Akce | Microsoft. LabServices/labAccounts/Labs/environmentSettings/Environment/Start/Action | Spustí prostředí spuštěním všech prostředků v prostředí. |
...
> | Akce | Microsoft. LabServices/labAccounts/Labs/environmentSettings/plány/čtení | Načtou se plány. |
...
> | Akce | Microsoft. LabServices/labAccounts/Labs/číst | Přečtěte si Labs. |
...
> | Akce | Microsoft. LabServices/labAccounts/Labs/uživatelé/odstranit | Odstranit uživatele. |
> | Akce | Microsoft. LabServices/labAccounts/Labs/uživatelé/číst | Čtení uživatelů. |
> | Akce | Microsoft. LabServices/labAccounts/Labs/uživatelé/zapisovat | Přidejte nebo upravte uživatele. |
...
> | Akce | Microsoft. Logic/integrationAccounts/partneři/DELETE | Odstraní partnera v účtu integrace. |
...
> | Akce | Microsoft. Logic/integrationAccounts/partneři/číst | Přečte partnera v účtu integrace. |
> | Akce | Microsoft. Logic/integrationAccounts/partneři/Write | Vytvoří nebo aktualizuje partnera v účtu integrace. |
...
> | Akce | Microsoft. Logic/integrationServiceEnvironments/Inspirujte/apiOperations/Read | Přečte operaci rozhraní API spravovaného prostředí integrační služby. |
...
> | Akce | Microsoft. Logic/Workflows/Ready | Přečte pracovní postup. |
...
> | Akce | Microsoft. Logic/Workflows/běhu/akce/opakování/listExpressionTraces/Action | Získá trasování výrazu opakování akce spuštění pracovního postupu. |
...
> | Akce | Microsoft. Logic/Workflows/běhy/DELETE | Odstraní spuštění pracovního postupu. |
...
> | Akce | Microsoft. MachineLearning/WebServices/klíče listkey/Read | Získání klíčů pro Machine Learning webovou službu |
> | Akce | Microsoft. MachineLearning/WebServices/číst | Čtení libovolné Machine Learning webové služby |
...
> | Akce | Microsoft. MachineLearningServices/umístění/použití/číst | Sestava využití pro výpočetní prostředky AML v předplatném |
> | Akce | Microsoft. MachineLearningServices/Locations/povolených velikostí/Read | Získání podporovaných velikostí virtuálních počítačů |
...
> | Akce | Microsoft. Maps/registr/Action | Zaregistrovat poskytovatele |
...
> | Akce | Microsoft. Marketplace/offerTypes/vydavatelé/nabídky/plány/smlouvy/zápis | Přijímá podepsané smlouvy. |
> | Akce | Microsoft. Marketplace/offerTypes/vydavatelé/nabídky/plány/konfigurace/importImage/Action | Importuje obrázek do ACR koncového uživatele. |
> | Akce | Microsoft. Marketplace/offerTypes/vydavatelé/nabídky/plány/konfigurace/číst | Vrátí konfiguraci. |
> | Akce | Microsoft. Marketplace/offerTypes/vydavatelé/nabídky/plány/konfigurace/zápis | Uloží konfiguraci. |
...
> | Akce | Microsoft. MarketplaceOrdering/offertypes/vydavatelé/nabídky/plány/smlouvy/zápis | Podepsat nebo zrušit smlouvu pro danou položku virtuálního počítače Marketplace |
...
> | Akce | Microsoft. Media/MediaServices/starají/DELETE | Odstranění libovolného koncového bodu streamování |
...
> | Akce | Microsoft. Media/MediaServices/starají/Write | Vytvoří nebo aktualizuje libovolný koncový bod streamování. |
...
> | Akce | Microsoft. Media/MediaServices/transformes/DELETE | Odstranit libovolnou transformaci |
> | Akce | Microsoft. Media/MediaServices/transformes/Jobs/cancelJob/Action | Zrušit úlohu |
> | Akce | Microsoft. Media/MediaServices/transformes/Jobs/DELETE | Odstranění libovolné úlohy |
> | Akce | Microsoft. Media/MediaServices/transformes/Jobs/Read | Čtení libovolné úlohy |
> | Akce | Microsoft. Media/MediaServices/transformes/Jobs/Write | Vytvořit nebo aktualizovat libovolnou úlohu |
> | Akce | Microsoft. Media/MediaServices/transformes/Read | Číst libovolnou transformaci |
> | Akce | Microsoft. Media/MediaServices/transformes/Write | Vytvořit nebo aktualizovat libovolnou transformaci |
...
> | Akce | Microsoft. Media/zrušit registraci/akce | Zruší registraci předplatného pro Media Services poskytovatele prostředků. |
...
> | Akce | Microsoft. NetApp/netAppAccounts/capacityPools/svazky/DELETE | Odstraní prostředek svazku. |
> | Akce | Microsoft. NetApp/netAppAccounts/capacityPools/svazky/mountTargets/číst | Přečte cílový prostředek připojení. |
> | Akce | Microsoft. NetApp/netAppAccounts/capacityPools/svazky/číst | Přečte prostředek svazku. |
> | Akce | Microsoft. NetApp/netAppAccounts/capacityPools/svazky/snímky/odstranit | Odstraní prostředek snímku. |
> | Akce | Microsoft. NetApp/netAppAccounts/capacityPools/svazky/snímky/číst | Přečte prostředek snímku. |
> | Akce | Microsoft. NetApp/netAppAccounts/capacityPools/svazky/snímky/zapisovat | Zapíše prostředek snímku. |
> | Akce | Microsoft. NetApp/netAppAccounts/capacityPools/– svazky/zapisovat | Zapíše prostředek svazku. |
...
> | Akce | Microsoft. Network/Connections/DELETE | Odstraní VirtualNetworkGatewayConnection |
> | Akce | Microsoft. Network/Connections/Read | Získá VirtualNetworkGatewayConnection |
...
> | Akce | Microsoft. Network/dnszones/CNAME/číst | Získá sadu záznamů typu CNAME ve formátu JSON. Sada záznamů obsahuje hodnoty TTL, Tags a ETag. |
...
> | Akce | Microsoft. Network/dnszones/sady záznamů/číst | Načte sady záznamů DNS napříč typy. |
> | Akce | Microsoft. Network/dnszones/SOA/číst | Načte sadu záznamů DNS typu SOA. |
...
> | Akce | Microsoft. Network/dnszones/SRV/číst | Získá sadu záznamů typu SRV ve formátu JSON. Sada záznamů obsahuje seznam záznamů a také hodnoty TTL, značek a ETag. |
...
> | Akce | Microsoft. Network/expressRouteCircuits/peering/Connections/DELETE | Odstraní připojení ExpressRoute. |
> | Akce | Microsoft. Network/expressRouteCircuits/partnerské vztahy/připojení/čtení | Získá připojení ExpressRoute. |
> | Akce | Microsoft. Network/expressRouteCircuits/peering/Connections/Write | Vytvoří nebo aktualizuje existující prostředek připojení ExpressRoute. |
> | Akce | Microsoft. Network/expressRouteCircuits/peering/DELETE | Odstraní partnerský vztah ExpressRoute. |
> | Akce | Microsoft. Network/expressRouteCircuits/peering/peerConnections/Read | Získá připojení okruhu peer Express Route. |
> | Akce | Microsoft. Network/expressRouteCircuits/peering/Read | Získá partnerský vztah ExpressRoute. |
...
> | Akce | Microsoft. Network/expressRouteCircuits/peering/Write | Vytvoří nebo aktualizuje existující partnerský vztah ExpressRoute. |
...
> | Akce | Microsoft. Network/expressRouteCrossConnections/peering/DELETE | Odstraní partnerský vztah vzájemného propojení Express Route. |
> | Akce | Microsoft. Network/expressRouteCrossConnections/peering/Read | Získá partnerský vztah vzájemného propojení Express Route. |
...
> | Akce | Microsoft. Network/expressRouteCrossConnections/peering/Write | Vytvoří partnerský vztah mezi propojením Express Route nebo aktualizuje existující partnerský vztah mezi propojením Express Route. |
...
> | Akce | Microsoft. Network/networkInterfaces/IPConfiguration/Read | Získá definici konfigurace IP adresy síťového rozhraní.  |
...
> | Akce | Microsoft. Network/trafficManagerProfiles/Heat mapy/Read | Získá Traffic Manager Heat mapu pro daný profil Traffic Manager, který obsahuje počty dotazů a data latence podle umístění a zdrojové IP adresy. |
...
> | Akce | Microsoft. Network/zrušit registraci/akce | Zruší registraci předplatného. |
...
> | Akce | Microsoft. Network/virtualnetworkgateways/Connections/Read | Získat VirtualNetworkGatewayConnection |
...
> | Akce | Microsoft. Network/virtualNetworks/podsítí/DELETE | Odstraní podsíť virtuální sítě. |
> | Akce | Microsoft. Network/virtualNetworks/subnets/JOIN/Action | Připojí se k virtuální síti. Nelze upozorňovat. |
> | Akce | Microsoft. Network/virtualNetworks/podsítí/joinViaServiceEndpoint/Action | Propojuje prostředek, jako je například účet úložiště nebo databáze SQL, do podsítě. Nelze upozorňovat. |
> | Akce | Microsoft. Network/virtualNetworks/podsítí/prepareNetworkPolicies/Action | Připraví podsíť použitím nezbytných síťových zásad. |
> | Akce | Microsoft. Network/virtualNetworks/podsítí/čtení | Získá definici podsítě virtuální sítě. |
...
> | Akce | Microsoft. Network/virtualNetworks/podsítí/Write | Vytvoří podsíť virtuální sítě nebo aktualizuje existující podsíť virtuální sítě. |
...
> | Akce | Microsoft. NotificationHubs/zrušit registraci/akce | Zruší registraci předplatného pro poskytovatele prostředků NotificationHubs a povolí vytváření oborů názvů a NotificationHubs. |
...
> | Akce | Microsoft. OffAzure/VMwareSites/servery vCenter/Read | Získá vlastnosti VMware vCenter. |
> | Akce | Microsoft. OffAzure/VMwareSites/servery vCenter/Write | Vytvoří nebo aktualizuje VMware vCenter. |
...
> | Akce | Microsoft. operationalinsights/zrušit registraci/akce | Zruší registraci předplatného. |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/analýzy/dotaz/akce | Hledání pomocí nového stroje |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/analýza/dotaz/schéma/čtení | Získejte schéma vyhledávání v2. |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/rozhraní API/dotaz/akce | Hledání pomocí nového stroje |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/API/dotaz/schéma/čtení | Získejte schéma vyhledávání v2. |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/configurationScopes/DELETE | Odstranit obor konfigurace |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/configurationScopes/číst | Získat rozsah konfigurace |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/configurationScopes/Write | Nastavit rozsah konfigurace |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/zdroje dat/odstranit | Odstranění zdrojů dat v pracovním prostoru. |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/zdroje dat/číst | Získat zdroje dat v pracovním prostoru. |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/zdroje dat/zápis | Vytvořit nebo aktualizovat zdroje dat v pracovním prostoru. |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/odstranit | Odstraní pracovní prostor. Pokud pracovní prostor byl během vytváření propojený s existujícím pracovním prostorem, pracovní prostor, ke kterému byl odkaz přiřazený, se neodstraní. |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/brány/odstranit | Odebere bránu nakonfigurovanou pro pracovní prostor. |
...
> | Akce | Microsoft. OperationalInsights/pracovní prostory/intelligencepacks/Disable/Action | Zakáže sadu Intelligence Pack pro daný pracovní prostor. |
...
> | Akce | Microsoft. OperationalInsights/pracovní prostory/intelligencepacks/číst | Zobrazí seznam všech inteligentních sad, které jsou pro daný pracovní prostor viditelné, a také uvádí, jestli je balíček pro tento pracovní prostor povolený nebo zakázaný. |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/linkedServices/DELETE | Odstraňte propojené služby v daném pracovním prostoru. |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/linkedServices/číst | Získejte propojené služby v daném pracovním prostoru. |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/linkedServices/Write | Vytvoří nebo aktualizuje propojené služby v daném pracovním prostoru. |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/klíče listkey/Action | Načte seznam klíčů pro pracovní prostor. Tyto klíče se používají k připojení agentů Microsoft Operational Insights k pracovnímu prostoru. |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/klíče listkey/číst | Načte seznam klíčů pro pracovní prostor. Tyto klíče se používají k připojení agentů Microsoft Operational Insights k pracovnímu prostoru. |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/managementGroups/číst | Získá názvy a metadata pro System Center Operations Manager skupiny pro správu připojené k tomuto pracovnímu prostoru. |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/metricDefinitions/číst | Získat definice metrik v pracovním prostoru |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/notificationSettings/DELETE | Odstraní nastavení oznámení uživatele pro pracovní prostor. |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/notificationSettings/číst | Získá nastavení oznámení uživatele pro pracovní prostor. |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/notificationSettings/Write | Nastavte nastavení oznámení uživatele pro pracovní prostor. |
...
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/AlertHistory/číst | Čtení dat z tabulky AlertHistory |
...
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/AppCenterError/číst | Čtení dat z tabulky AppCenterError |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/ApplicationInsights/číst | Čtení dat z tabulky ApplicationInsights |
...
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/AuditLogs/číst | Čtení dat z tabulky AuditLogs |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/AutoscaleEvaluationsLog/číst | Čtení dat z tabulky AutoscaleEvaluationsLog |
...
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/ConfigurationChange/číst | Čtení dat z tabulky ConfigurationChange |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/ConfigurationData/číst | Čtení dat z tabulky ConfigurationData |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/ContainerImageInventory/číst | Čtení dat z tabulky ContainerImageInventory |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/ContainerInventory/číst | Čtení dat z tabulky ContainerInventory |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/ContainerLog/číst | Čtení dat z tabulky ContainerLog |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/ContainerNodeInventory/číst | Čtení dat z tabulky ContainerNodeInventory |
...
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/ContainerServiceLog/číst | Čtení dat z tabulky ContainerServiceLog |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/CoreAzureBackup/číst | Čtení dat z tabulky CoreAzureBackup |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/DatabricksAccounts/číst | Čtení dat z tabulky DatabricksAccounts |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/DatabricksClusters/číst | Čtení dat z tabulky DatabricksClusters |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/DatabricksDBFS/číst | Čtení dat z tabulky DatabricksDBFS |
...
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/DatabricksJobs/číst | Čtení dat z tabulky DatabricksJobs |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/DatabricksNotebook/číst | Čtení dat z tabulky DatabricksNotebook |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/DatabricksSecrets/číst | Čtení dat z tabulky DatabricksSecrets |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/DatabricksSQLPermissions/číst | Čtení dat z tabulky DatabricksSQLPermissions |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/DatabricksSSH/číst | Čtení dat z tabulky DatabricksSSH |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/DatabricksTables/číst | Čtení dat z tabulky DatabricksTables |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/DatabricksWorkspace/číst | Čtení dat z tabulky DatabricksWorkspace |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/DeviceAppCrash/číst | Čtení dat z tabulky DeviceAppCrash |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/DeviceAppLaunch/číst | Čtení dat z tabulky DeviceAppLaunch |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/DeviceCalendar/číst | Čtení dat z tabulky DeviceCalendar |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/DeviceCleanup/číst | Čtení dat z tabulky DeviceCleanup |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/DeviceConnectSession/číst | Čtení dat z tabulky DeviceConnectSession |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/DeviceEtw/číst | Čtení dat z tabulky DeviceEtw |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/DeviceHardwareHealth/číst | Čtení dat z tabulky DeviceHardwareHealth |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/přidružený/číst | Čtení dat z tabulky přidružený |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/DeviceHeartbeat/číst | Čtení dat z tabulky DeviceHeartbeat |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/DeviceSkypeHeartbeat/číst | Čtení dat z tabulky DeviceSkypeHeartbeat |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/DeviceSkypeSignIn/číst | Čtení dat z tabulky DeviceSkypeSignIn |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/DeviceSleepState/číst | Čtení dat z tabulky DeviceSleepState |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/DHAppFailure/číst | Čtení dat z tabulky DHAppFailure |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/DHAppReliability/číst | Čtení dat z tabulky DHAppReliability |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/DHDriverReliability/číst | Čtení dat z tabulky DHDriverReliability |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/DHLogonFailures/číst | Čtení dat z tabulky DHLogonFailures |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/DHLogonMetrics/číst | Čtení dat z tabulky DHLogonMetrics |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/DHOSCrashData/číst | Čtení dat z tabulky DHOSCrashData |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/DHOSReliability/číst | Čtení dat z tabulky DHOSReliability |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/DHWipAppLearning/číst | Čtení dat z tabulky DHWipAppLearning |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/DnsEvents/číst | Čtení dat z tabulky DnsEvents |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/DnsInventory/číst | Čtení dat z tabulky DnsInventory |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/ETWEvent/číst | Čtení dat z tabulky ETWEvent |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotaz/událost/čtení | Čtení dat z tabulky událostí |
...
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotaz/prezenční signál/čtení | Čtení dat z tabulky prezenčního signálu |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/HuntingBookmark/číst | Čtení dat z tabulky HuntingBookmark |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/IISAssessmentRecommendation/číst | Čtení dat z tabulky IISAssessmentRecommendation |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/InboundConnection/číst | Čtení dat z tabulky InboundConnection |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/InsightsMetrics/číst | Čtení dat z tabulky InsightsMetrics |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/IntuneAuditLogs/číst | Čtení dat z tabulky IntuneAuditLogs |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/IntuneOperationalLogs/číst | Čtení dat z tabulky IntuneOperationalLogs |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/KubeEvents/číst | Čtení dat z tabulky KubeEvents |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/KubeHealth/číst | Čtení dat z tabulky KubeHealth |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/KubeNodeInventory/číst | Čtení dat z tabulky KubeNodeInventory |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/KubePodInventory/číst | Čtení dat z tabulky KubePodInventory |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/KubeServices/číst | Čtení dat z tabulky KubeServices |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/LinuxAuditLog/číst | Čtení dat z tabulky LinuxAuditLog |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAApplication/číst | Čtení dat z tabulky MAApplication |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAApplicationHealth/číst | Čtení dat z tabulky MAApplicationHealth |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAApplicationHealthAlternativeVersions/číst | Čtení dat z tabulky MAApplicationHealthAlternativeVersions |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAApplicationHealthIssues/číst | Čtení dat z tabulky MAApplicationHealthIssues |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAApplicationInstance/číst | Čtení dat z tabulky MAApplicationInstance |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAApplicationInstanceReadiness/číst | Čtení dat z tabulky MAApplicationInstanceReadiness |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAApplicationReadiness/číst | Čtení dat z tabulky MAApplicationReadiness |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MADeploymentPlan/číst | Čtení dat z tabulky MADeploymentPlan |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MADevice/číst | Čtení dat z tabulky MADevice |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MADeviceNotEnrolled/číst | Čtení dat z tabulky MADeviceNotEnrolled |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MADeviceNRT/číst | Čtení dat z tabulky MADeviceNRT |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MADevicePnPHealth/číst | Čtení dat z tabulky MADevicePnPHealth |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MADevicePnPHealthAlternativeVersions/číst | Čtení dat z tabulky MADevicePnPHealthAlternativeVersions |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MADevicePnPHealthIssues/číst | Čtení dat z tabulky MADevicePnPHealthIssues |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MADeviceReadiness/číst | Čtení dat z tabulky MADeviceReadiness |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MADriverInstanceReadiness/číst | Čtení dat z tabulky MADriverInstanceReadiness |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MADriverReadiness/číst | Čtení dat z tabulky MADriverReadiness |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAOfficeAddin/číst | Čtení dat z tabulky MAOfficeAddin |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAOfficeAddinEntityHealth/číst | Čtení dat z tabulky MAOfficeAddinEntityHealth |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAOfficeAddinHealth/číst | Čtení dat z tabulky MAOfficeAddinHealth |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAOfficeAddinHealthEventNRT/číst | Čtení dat z tabulky MAOfficeAddinHealthEventNRT |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAOfficeAddinHealthIssues/číst | Čtení dat z tabulky MAOfficeAddinHealthIssues |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAOfficeAddinInstance/číst | Čtení dat z tabulky MAOfficeAddinInstance |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAOfficeAddinInstanceReadiness/číst | Čtení dat z tabulky MAOfficeAddinInstanceReadiness |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAOfficeAddinReadiness/číst | Čtení dat z tabulky MAOfficeAddinReadiness |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAOfficeApp/číst | Čtení dat z tabulky MAOfficeApp |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAOfficeAppCrashesNRT/číst | Čtení dat z tabulky MAOfficeAppCrashesNRT |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAOfficeAppHealth/číst | Čtení dat z tabulky MAOfficeAppHealth |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAOfficeAppInstance/číst | Čtení dat z tabulky MAOfficeAppInstance |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAOfficeAppInstanceHealth/číst | Čtení dat z tabulky MAOfficeAppInstanceHealth |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAOfficeAppReadiness/číst | Čtení dat z tabulky MAOfficeAppReadiness |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAOfficeAppSessionsNRT/číst | Čtení dat z tabulky MAOfficeAppSessionsNRT |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAOfficeBuildInfo/číst | Čtení dat z tabulky MAOfficeBuildInfo |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAOfficeCurrencyAssessment/číst | Čtení dat z tabulky MAOfficeCurrencyAssessment |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAOfficeCurrencyAssessmentDailyCounts/číst | Čtení dat z tabulky MAOfficeCurrencyAssessmentDailyCounts |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAOfficeDeploymentStatus/číst | Čtení dat z tabulky MAOfficeDeploymentStatus |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAOfficeDeploymentStatusNRT/číst | Čtení dat z tabulky MAOfficeDeploymentStatusNRT |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAOfficeMacroErrorNRT/číst | Čtení dat z tabulky MAOfficeMacroErrorNRT |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAOfficeMacroGlobalHealth/číst | Čtení dat z tabulky MAOfficeMacroGlobalHealth |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAOfficeMacroHealth/číst | Čtení dat z tabulky MAOfficeMacroHealth |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAOfficeMacroHealthIssues/číst | Čtení dat z tabulky MAOfficeMacroHealthIssues |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAOfficeMacroIssueInstanceReadiness/číst | Čtení dat z tabulky MAOfficeMacroIssueInstanceReadiness |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAOfficeMacroIssueReadiness/číst | Čtení dat z tabulky MAOfficeMacroIssueReadiness |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAOfficeMacroSummary/číst | Čtení dat z tabulky MAOfficeMacroSummary |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAOfficeSuite/číst | Čtení dat z tabulky MAOfficeSuite |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAOfficeSuiteInstance/číst | Čtení dat z tabulky MAOfficeSuiteInstance |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAProposedPilotDevices/číst | Čtení dat z tabulky MAProposedPilotDevices |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAWindowsBuildInfo/číst | Čtení dat z tabulky MAWindowsBuildInfo |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAWindowsCurrencyAssessment/číst | Čtení dat z tabulky MAWindowsCurrencyAssessment |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAWindowsCurrencyAssessmentDailyCounts/číst | Čtení dat z tabulky MAWindowsCurrencyAssessmentDailyCounts |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAWindowsDeploymentStatus/číst | Čtení dat z tabulky MAWindowsDeploymentStatus |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAWindowsDeploymentStatusNRT/číst | Čtení dat z tabulky MAWindowsDeploymentStatusNRT |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/MAWindowsSysReqInstanceReadiness/číst | Čtení dat z tabulky MAWindowsSysReqInstanceReadiness |
...
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotaz/operace/číst | Čtení dat z tabulky operací |
...
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotaz/výkon/čtení | Čtení dat z tabulky perf |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/ProtectionStatus/číst | Čtení dat z tabulky ProtectionStatus |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotaz/čtení | Spouštění dotazů nad daty v pracovním prostoru |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/ReservedAzureCommonFields/číst | Čtení dat z tabulky ReservedAzureCommonFields |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/ReservedCommonFields/číst | Čtení dat z tabulky ReservedCommonFields |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/SCCMAssessmentRecommendation/číst | Čtení dat z tabulky SCCMAssessmentRecommendation |
...
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/SecurityAlert/číst | Čtení dat z tabulky SecurityAlert |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/SecurityBaseline/číst | Čtení dat z tabulky SecurityBaseline |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/SecurityBaselineSummary/číst | Čtení dat z tabulky SecurityBaselineSummary |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/SecurityDetection/číst | Čtení dat z tabulky SecurityDetection |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/SecurityEvent/číst | Čtení dat z tabulky SecurityEvent |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/SecurityIoTRawEvent/číst | Čtení dat z tabulky SecurityIoTRawEvent |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/SecurityRecommendation/číst | Čtení dat z tabulky SecurityRecommendation |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/ServiceFabricOperationalEvent/číst | Čtení dat z tabulky ServiceFabricOperationalEvent |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/ServiceFabricReliableActorEvent/číst | Čtení dat z tabulky ServiceFabricReliableActorEvent |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/ServiceFabricReliableServiceEvent/číst | Čtení dat z tabulky ServiceFabricReliableServiceEvent |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/SfBAssessmentRecommendation/číst | Čtení dat z tabulky SfBAssessmentRecommendation |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/SfBOnlineAssessmentRecommendation/číst | Čtení dat z tabulky SfBOnlineAssessmentRecommendation |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/SharePointOnlineAssessmentRecommendation/číst | Čtení dat z tabulky SharePointOnlineAssessmentRecommendation |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/SigninLogs/číst | Čtení dat z tabulky SigninLogs |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/SPAssessmentRecommendation/číst | Čtení dat z tabulky SPAssessmentRecommendation |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/SQLAssessmentRecommendation/číst | Čtení dat z tabulky SQLAssessmentRecommendation |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/SQLQueryPerformance/číst | Čtení dat z tabulky SQLQueryPerformance |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/SqlThreatProtectionLoginAudits/číst | Čtení dat z tabulky SqlThreatProtectionLoginAudits |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/SqlVulnerabilityAssessmentResult/číst | Čtení dat z tabulky SqlVulnerabilityAssessmentResult |
...
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotaz/syslog/číst | Čtení dat z tabulky syslog |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/SysmonEvent/číst | Čtení dat z tabulky SysmonEvent |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/tabulky. vlastní/číst | Čtení dat z libovolného vlastního protokolu |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/ThreatIntelligenceIndicator/číst | Čtení dat z tabulky ThreatIntelligenceIndicator |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/UAApp/číst | Čtení dat z tabulky UAApp |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/UAComputer/číst | Čtení dat z tabulky UAComputer |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/UAComputerRank/číst | Čtení dat z tabulky UAComputerRank |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/UADriver/číst | Čtení dat z tabulky UADriver |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/UADriverProblemCodes/číst | Čtení dat z tabulky UADriverProblemCodes |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/UAFeedback/číst | Čtení dat z tabulky UAFeedback |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/UAHardwareSecurity/číst | Čtení dat z tabulky UAHardwareSecurity |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/UAIESiteDiscovery/číst | Čtení dat z tabulky UAIESiteDiscovery |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/UAOfficeAddIn/číst | Čtení dat z tabulky UAOfficeAddIn |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/UAProposedActionPlan/číst | Čtení dat z tabulky UAProposedActionPlan |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/UASysReqIssue/číst | Čtení dat z tabulky UASysReqIssue |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/UAUpgradedComputer/číst | Čtení dat z tabulky UAUpgradedComputer |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotaz/aktualizovat/číst | Čtení dat z tabulky aktualizací |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/UpdateRunProgress/číst | Čtení dat z tabulky UpdateRunProgress |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/UpdateSummary/číst | Čtení dat z tabulky UpdateSummary |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotaz/použití/číst | Čtení dat z tabulky využití |
...
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/W3CIISLog/číst | Čtení dat z tabulky W3CIISLog |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/WaaSDeploymentStatus/číst | Čtení dat z tabulky WaaSDeploymentStatus |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/WaaSInsiderStatus/číst | Čtení dat z tabulky WaaSInsiderStatus |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/WaaSUpdateStatus/číst | Čtení dat z tabulky WaaSUpdateStatus |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/WDAVStatus/číst | Čtení dat z tabulky WDAVStatus |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/WDAVThreat/číst | Čtení dat z tabulky WDAVThreat |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/WindowsClientAssessmentRecommendation/číst | Čtení dat z tabulky WindowsClientAssessmentRecommendation |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/WindowsEvent/číst | Čtení dat z tabulky WindowsEvent |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/WindowsFirewall/číst | Čtení dat z tabulky WindowsFirewall |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/WindowsServerAssessmentRecommendation/číst | Čtení dat z tabulky WindowsServerAssessmentRecommendation |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/WireData/číst | Čtení dat z tabulky WireData |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/WorkloadMonitoringPerf/číst | Čtení dat z tabulky WorkloadMonitoringPerf |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/WUDOAggregatedStatus/číst | Čtení dat z tabulky WUDOAggregatedStatus |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/dotazy/WUDOStatus/číst | Čtení dat z tabulky WUDOStatus |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/číst | Získá existující pracovní prostor. |
...
> | Akce | Microsoft. operationalinsights/pracovní prostory/pravidla/číst | Získat všechna pravidla výstrahy. |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/savedSearches/DELETE | Odstraní uložený vyhledávací dotaz. |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/savedSearches/číst | Načte uložený vyhledávací dotaz. |
> | Akce | Microsoft. operationalinsights/pracovní prostory/savedsearches/výsledky/číst | Získání výsledků uložených hledání Zastaralé |
> | Akce | Microsoft. operationalinsights/pracovní prostory/savedsearches/plány/akce/Odstranit | Odstraňte plánované akce hledání. |
> | Akce | Microsoft. operationalinsights/pracovní prostory/savedsearches/plány/akce/číst | Získejte plánované akce hledání. |
> | Akce | Microsoft. operationalinsights/pracovní prostory/savedsearches/plány/akce/zápis | Vytvoří nebo aktualizuje plánované akce vyhledávání. |
> | Akce | Microsoft. operationalinsights/Workspaces/savedsearches/Schedules/DELETE | Odstranění naplánovaných hledání. |
> | Akce | Microsoft. operationalinsights/pracovní prostory/savedsearches/plány/čtení | Získat naplánovaná hledání. |
...
> | Akce | Microsoft. OperationalInsights/pracovní prostory/storageinsightconfigs/číst | Získá konfiguraci úložiště. |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/storageinsightconfigs/Write | Vytvoří novou konfiguraci úložiště. Tyto konfigurace se používají k vyžádání dat z umístění v existujícím účtu úložiště. |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/upgradetranslationfailures/číst | Získat protokol selhání překladu upgradu pro pracovní prostor |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/použití/číst | Načte data o využití pro pracovní prostor, včetně množství dat, které pracovní prostor přečetl. |
> | Akce | Microsoft. OperationalInsights/pracovní prostory/zápis | Vytvoří nový pracovní prostor nebo vytvoří odkaz na existující pracovní prostor tím, že mu poskytne ID zákazníka z existujícího pracovního prostoru. |
...
> | Akce | Microsoft. PolicyInsights/policyStates/Shrnutí/akce | Dotaz na souhrnné informace o aktuálních stavech zásad. |
> | Akce | Microsoft. PolicyInsights/policyStates/Shrnutí/čtení | Dotaz na souhrnné informace o aktuálních stavech zásad. |
...
> | Akce | Microsoft. PolicyInsights/nápravy/odstranit | Odstraňte nápravy zásad. |
> | Akce | Microsoft. PolicyInsights/nápravy/listDeployments/Read | Zobrazí seznam nasazení vyžadovaných nápravou zásad. |
> | Akce | Microsoft. PolicyInsights/nápravy/číst | Získejte nápravy zásad. |
> | Akce | Microsoft. PolicyInsights/nápravy/zapisovat | Vytvoří nebo aktualizuje nápravy zásad Microsoftu. |
> | Akce | Microsoft. PolicyInsights/zrušit registraci/akce | Zruší registraci poskytovatele prostředků Microsoft Policy Insights. |
...
> | Akce | Microsoft. RecoveryServices/Locations/stav operationstatus/Read | Získá stav operace pro danou operaci. |
...
> | Akce | Microsoft. RecoveryServices/trezory/backupFabrics/backupProtectionIntent/Write | Vytvořit záložní záměr ochrany |
> | Akce | Microsoft. RecoveryServices/trezory/backupFabrics/operationResults/Read | Vrátí stav operace. |
...
> | Akce | Microsoft. RecoveryServices/trezory/backupFabrics/protectionContainers/protectedItems/DELETE | Odstraní chráněnou položku. |
> | Akce | Microsoft. RecoveryServices/trezory/backupFabrics/protectionContainers/protectedItems/operationResults/číst | Načte výsledek operace provedené na chráněných položkách. |
> | Akce | Microsoft. RecoveryServices/trezory/backupFabrics/protectionContainers/protectedItems/operationsStatus/číst | Vrátí stav operace provedené na chráněných položkách. |
...
> | Akce | Microsoft. RecoveryServices/trezory/backupFabrics/protectionContainers/protectedItems/recoveryPoints/číst | Získat body obnovení pro chráněné položky. |
...
> | Akce | Microsoft. RecoveryServices/trezory/backupFabrics/protectionContainers/protectedItems/Write | Vytvořit položku chráněnou zálohováním |
...
> | Akce | Microsoft. RecoveryServices/trezory/backupPolicies/Write | Vytvoří zásady ochrany. |
> | Akce | Microsoft. RecoveryServices/trezory/backupProtectableItems/Read | Vrátí seznam všech chráněných položek. |
> | Akce | Microsoft. RecoveryServices/trezory/backupProtectedItems/Read | Vrátí seznam všech chráněných položek. |
...
> | Akce | Microsoft. RecoveryServices/trezory/extendedInformation/Read | Operace získat rozšířené informace získá rozšířené informace o objektu, které představují prostředek Azure typu? trezor? |
> | Akce | Microsoft. RecoveryServices/trezory/extendedInformation/Write | Operace získat rozšířené informace získá rozšířené informace o objektu, které představují prostředek Azure typu? trezor? |
> | Akce | Microsoft. RecoveryServices/trezory/monitoringAlerts/Read | Získá výstrahy pro trezor služby Recovery Services. |
...
> | Akce | Microsoft. RecoveryServices/trezory/číst | Operace získat úložiště Získá objekt, který představuje prostředek Azure typu trezor. |
...
> | Akce | Microsoft. RecoveryServices/trezory/registeredIdentities/operationResults/Read | Operaci získat výsledky operace Get lze použít k získání stavu operace a výsledku asynchronně odeslané operace. |
> | Akce | Microsoft. RecoveryServices/trezory/registeredIdentities/Read | Operaci získat kontejnery lze použít k získání kontejnerů zaregistrovaných pro určitý prostředek. |
> | Akce | Microsoft. RecoveryServices/trezory/registeredIdentities/Write | Operaci kontejneru registrovat službu lze použít k registraci kontejneru pomocí služby Recovery Services. |
...
> | Akce | Microsoft. RecoveryServices/trezory/replicationFabrics/Read | Čtení jakýchkoli prostředků infrastruktury |
> | Akce | Microsoft. RecoveryServices/trezory/replicationFabrics/reassociateGateway/Action | Znovu přidružit bránu |
> | Akce | Microsoft. RecoveryServices/trezory/replicationFabrics/Remove/Action | Odebrat prostředky infrastruktury |
> | Akce | Microsoft. RecoveryServices/trezory/replicationFabrics/renewcertificate/Action | Prodloužit platnost certifikátu pro Fabric |
...
> | Akce | Microsoft. RecoveryServices/trezory/replicationFabrics/replicationNetworks/Read | Čtení všech sítí |
...
> | Akce | Microsoft. RecoveryServices/trezory/replicationFabrics/replicationvCenters/Read | Číst libovolný servery vCenter |
...
> | Akce | Microsoft. RecoveryServices/trezory/replicationRecoveryPlans/plannedFailover/Action | Plán obnovení plánovaného převzetí služeb při selhání |
...
> | Akce | Microsoft. RecoveryServices/trezory/replicationRecoveryPlans/unplannedFailover/Action | Plán obnovení převzetí služeb při selhání |
...
> | Akce | Microsoft. RecoveryServices/trezory/vaultTokens/Read | Operaci tokenu trezoru jde použít k získání tokenu trezoru pro operace back-endu na úrovni trezoru. |
> | Akce | Microsoft. RecoveryServices/trezory/Write | Operace vytvořit trezor vytvoří prostředek Azure typu trezor. |
...
> | Akce | Microsoft. Security/Prices/DELETE | Odstraní nastavení cen pro obor. |
...
> | Akce | Microsoft. ServiceBus/obory názvů/disasterRecoveryConfigs/autorizačních pravidel/Read | Získat autorizační pravidla primárního oboru názvů pro zotavení po havárii |
...
> | Akce | Microsoft. ServiceBus/obory názvů/disasterRecoveryConfigs/DELETE | Odstraní konfiguraci zotavení po havárii přidruženou k oboru názvů. Tuto operaci lze vyvolat pouze prostřednictvím primárního oboru názvů. |
...
> | Akce | Microsoft. ServiceBus/obory názvů/disasterRecoveryConfigs/Read | Získá konfiguraci zotavení po havárii přidruženou k oboru názvů. |
> | Akce | Microsoft. ServiceBus/obory názvů/disasterRecoveryConfigs/Write | Vytvoří nebo aktualizuje konfiguraci zotavení po havárii přidruženou k oboru názvů. |
> | Akce | Microsoft. ServiceBus/obory názvů/eventGridFilters/DELETE | Odstraní filtr Event Grid přidružený k oboru názvů. |
> | Akce | Microsoft. ServiceBus/obory názvů/eventGridFilters/Read | Získá filtr Event Grid přidružený k oboru názvů. |
> | Akce | Microsoft. ServiceBus/obory názvů/eventGridFilters/Write | Vytvoří nebo aktualizuje filtr Event Grid přidružený k oboru názvů. |
...
> | Akce | Microsoft. ServiceBus/obory názvů/fronty/zápis | Vytvoří nebo aktualizuje vlastnosti fronty. |
...
> | Akce | Microsoft. ServiceBus/obory názvů/témata/předplatná/odstranit | Operace odstranění prostředku TopicSubscription |
> | Akce | Microsoft. ServiceBus/obory názvů/témata/předplatná/číst | Získá seznam popisů prostředků TopicSubscription. |
> | Akce | Microsoft. ServiceBus/obory názvů/témata/předplatná/pravidla/odstranění | Operace odstranění prostředku pravidla |
> | Akce | Microsoft. ServiceBus/obory názvů/témata/předplatná/pravidla/číst | Získá seznam popisů prostředků pravidel. |
> | Akce | Microsoft. ServiceBus/obory názvů/témata/předplatná/pravidla/zápis | Vytvoří nebo aktualizuje vlastnosti pravidla. |
> | Akce | Microsoft. ServiceBus/obory názvů/témata/předplatná/zápis | Vytvoří nebo aktualizuje vlastnosti TopicSubscription. |
> | Akce | Microsoft. ServiceBus/obory názvů/témata/zápis | Vytvoří nebo aktualizuje vlastnosti tématu. |
> | Akce | Microsoft. ServiceBus/obory názvů/virtualNetworkRules/DELETE | Odstranit prostředek pravidla virtuální sítě |
...
> | Akce | Microsoft. ServiceFabric/clustery/aplikace/Write | Vytvořit nebo aktualizovat libovolnou aplikaci |
...
> | Akce | Microsoft. SQL/managedInstances/databáze/backupShortTermRetentionPolicies/Read | Získá krátkodobé zásady uchovávání informací pro spravovanou databázi. |
...
> | Akce | Microsoft. SQL/managedInstances/databáze/číst | Načte existující spravovanou databázi. |
> | Akce | Microsoft. SQL/managedInstances/databáze/recommendedSensitivityLabels/Read | Vypsat popisky citlivosti dané databáze |
...
> | Akce | Microsoft. SQL/managedInstances/databáze/schémata/čtení | Získá schéma spravované databáze. |
> | Akce | Microsoft. SQL/managedInstances/databáze/schémata/tabulky/sloupce/číst | Získat sloupec spravované databáze |
> | Akce | Microsoft. SQL/managedInstances/databáze/schémata/tabulky/sloupce/sensitivityLabels/DELETE | Odstraní popisek citlivosti daného sloupce. |
> | Akce | Microsoft. SQL/managedInstances/databáze/schémata/tabulky/sloupce/sensitivityLabels/Disable/Action | Zakázat doporučení citlivosti na daném sloupci |
> | Akce | Microsoft. SQL/managedInstances/databáze/schémata/tabulky/sloupce/sensitivityLabels/povolit/akce | Povolit doporučení citlivosti na daném sloupci |
> | Akce | Microsoft. SQL/managedInstances/databáze/schémata/tabulky/sloupce/sensitivityLabels/čtení | Získá popisek citlivosti daného sloupce. |
> | Akce | Microsoft. SQL/managedInstances/databáze/schémata/tabulky/sloupce/sensitivityLabels/Write | Vytvoří nebo aktualizuje popisek citlivosti daného sloupce. |
> | Akce | Microsoft. SQL/managedInstances/databáze/schémata/tabulky/čtení | Získání tabulky spravované databáze |
> | Akce | Microsoft. SQL/managedInstances/databáze/securityAlertPolicies/Read | Načíst seznam zásad detekce hrozeb spravované databáze konfigurovaných pro daný server |
> | Akce | Microsoft. SQL/managedInstances/databáze/securityAlertPolicies/Write | Změna zásad detekce hrozeb databáze pro danou spravovanou databázi |
> | Akce | Microsoft. SQL/managedInstances/databáze/securityEvents/Read | Načte události zabezpečení spravované databáze. |
> | Akce | Microsoft. SQL/managedInstances/databáze/sensitivityLabels/Read | Vypsat popisky citlivosti dané databáze |
> | Akce | Microsoft. SQL/managedInstances/databáze/transparentDataEncryption/Read | Načte podrobnosti o transparentní šifrování dat databáze v dané spravované databázi. |
> | Akce | Microsoft. SQL/managedInstances/databáze/transparentDataEncryption/Write | Změna transparentní šifrování dat databáze pro danou spravovanou databázi |
> | Akce | Microsoft. SQL/managedInstances/databáze/vulnerabilityAssessments/DELETE | Odebrání posouzení ohrožení zabezpečení pro danou databázi |
> | Akce | Microsoft. SQL/managedInstances/databáze/vulnerabilityAssessments/Read | Načtení zásad posouzení ohrožení zabezpečení na givendatabase |
> | Akce | Microsoft. SQL/managedInstances/databases/vulnerabilityAssessments/Rules/směrný plán/odstranit | Odebrání směrného plánu pravidla posouzení ohrožení zabezpečení pro danou databázi |
> | Akce | Microsoft. SQL/managedInstances/databáze/vulnerabilityAssessments/Rules/směrné plány/číst | Získat směrný plán pravidla posouzení ohrožení zabezpečení pro danou databázi |
> | Akce | Microsoft. SQL/managedInstances/databáze/vulnerabilityAssessments/Rules/směrný plán/zápis | Změna směrného plánu pravidla posouzení ohrožení zabezpečení pro danou databázi |
> | Akce | Microsoft. SQL/managedInstances/databáze/vulnerabilityAssessments/prověřování/export/akce | Převede existující výsledek kontroly na formát pro lidské čtení. Pokud už existuje, nic se nestane. |
> | Akce | Microsoft. SQL/managedInstances/databases/vulnerabilityAssessments/prověřování/initiateScan/Action | Provést kontrolu databáze posouzení ohrožení zabezpečení. |
> | Akce | Microsoft. SQL/managedInstances/databáze/vulnerabilityAssessments/prověřování/čtení | Vrátí seznam vyhodnocování ohrožení zabezpečení databáze nebo získá záznam o kontrole pro zadané ID vyhledávání. |
> | Akce | Microsoft. SQL/managedInstances/databáze/vulnerabilityAssessments/Write | Změna posouzení ohrožení zabezpečení pro danou databázi |
> | Akce | Microsoft. SQL/managedInstances/databáze/Write | Vytvoří novou databázi nebo aktualizuje stávající databázi. |
...
> | Akce | Microsoft. SQL/operace/čtení | Získá dostupné operace REST. |
...
> | Akce | Microsoft. SQL/servery/auditingPolicies/Write | Změna výchozího auditování tabulky serveru pro daný server |
> | Akce | Microsoft. SQL/servery/auditingSettings/operationResults/Read | Načíst výsledek operace nastavení zásad auditování objektu BLOB serveru |
> | Akce | Microsoft. SQL/servery/auditingSettings/Read | Načte podrobnosti o zásadách auditování objektů BLOB serveru nakonfigurovaných na daném serveru. |
> | Akce | Microsoft. SQL/servery/auditingSettings/Write | Změna auditování objektů BLOB serveru pro daný server |
...
> | Akce | Microsoft. SQL/servery/backupLongTermRetentionVaults/DELETE | Odstraní existující archivační Trezor záloh. |
> | Akce | Microsoft. SQL/servery/backupLongTermRetentionVaults/Read | Tato operace slouží k získání dlouhodobého trezoru pro dlouhodobé uchovávání záloh. Vrátí informace o trezoru zaregistrovanému na tomto serveru. |
> | Akce | Microsoft. SQL/servery/backupLongTermRetentionVaults/Write | Tato operace se používá k registraci trezoru dlouhodobého uchovávání záloh na server. |
...
> | Akce | Microsoft. SQL/servery/databáze/poradci/číst | Vrátí seznam poradců dostupných pro databázi. |
> | Akce | Microsoft. SQL/servery/databáze/poradci/recommendedActions/Read | Vrátí seznam doporučených akcí zadaného Poradce pro databázi. |
> | Akce | Microsoft. SQL/servery/databáze/poradci/recommendedActions/Write | Použití doporučené akce v databázi |
> | Akce | Microsoft. SQL/servery/databáze/poradci/zapisovat | Aktualizuje stav automatického spuštění služby Advisor na úrovni databáze. |
> | Akce | Microsoft. SQL/servery/databáze/auditingPolicies/Read | Načíst podrobnosti o zásadách auditování tabulek konfigurovaných pro danou databázi |
> | Akce | Microsoft. SQL/servery/databáze/auditingPolicies/Write | Změna zásad auditování v tabulce pro danou databázi |
> | Akce | Microsoft. SQL/servery/databáze/auditingSettings/Read | Načte podrobnosti o zásadách auditování objektů BLOB konfigurovaných pro danou databázi. |
> | Akce | Microsoft. SQL/servery/databáze/auditingSettings/Write | Změna zásad auditování objektů BLOB pro danou databázi |
> | Akce | Microsoft. SQL/servery/databáze/auditRecords/Read | Načtení záznamů auditu objektu BLOB databáze |
> | Akce | Microsoft. SQL/servery/databáze/automaticTuning/Read | Vrátí nastavení automatického ladění pro databázi. |
> | Akce | Microsoft. SQL/servery/databáze/automaticTuning/Write | Aktualizuje nastavení automatického ladění pro databázi a vrátí aktualizovaná nastavení. |
...
> | Akce | Microsoft. SQL/servery/databáze/dataMaskingPolicies/Rules/Write | Změna pravidla zásad maskování dat pro danou databázi |
> | Akce | Microsoft. SQL/servery/databáze/dataMaskingPolicies/Write | Změna zásad maskování dat pro danou databázi |
> | Akce | Microsoft. SQL/servery/databáze/dataWarehouseQueries/dataWarehouseQuerySteps/Read | Vrátí informace o kroku distribuovaného dotazu dotazu datového skladu pro vybrané ID kroku. |
> | Akce | Microsoft. SQL/servery/databáze/dataWarehouseQueries/Read | Vrátí informace o distribučním dotazu datového skladu pro vybrané ID dotazu. |
> | Akce | Microsoft. SQL/servery/databáze/dataWarehouseUserActivities/Read | Načte aktivity uživatelů SQL Data Warehouse instance, která zahrnuje běžící a pozastavené dotazy. |
> | Akce | Microsoft. SQL/servery/databáze/odstranit | Odstraní existující databázi. |
> | Akce | Microsoft. SQL/servery/databáze/export/akce | Exportovat Azure SQL Database |
> | Akce | Microsoft. SQL/servery/databáze/extendedAuditingSettings/Read | Načte podrobnosti o rozšířených zásadách auditování objektů BLOB konfigurovaných pro danou databázi. |
> | Akce | Microsoft. SQL/servery/databáze/extendedAuditingSettings/Write | Změna zásad auditování rozšířeného objektu BLOB pro danou databázi |
> | Akce | Microsoft. SQL/servery/databáze/rozšíření/čtení | Získá kolekci rozšíření pro databázi. |
> | Akce | Microsoft. SQL/servery/databáze/rozšíření/zápis | Změna rozšíření pro danou databázi |
...
> | Akce | Microsoft. SQL/servery/databáze/geoBackupPolicies/Read | Načtení zásad geografického zálohování pro danou databázi |
> | Akce | Microsoft. SQL/servery/databáze/geoBackupPolicies/Write | Vytvoření nebo aktualizace zásad pro biozálohování databáze |
> | Akce | Microsoft. SQL/servery/databáze/importExportOperationResults/Read | Načte probíhající operace importu a exportu. |
> | Akce | Microsoft. SQL/servery/databáze/maintenanceWindowOptions/Read | Načte seznam dostupných oken údržby pro vybranou databázi. |
> | Akce | Microsoft. SQL/servery/databáze/maintenanceWindows/Read | Získá nastavení systému Windows údržby pro vybranou databázi. |
> | Akce | Microsoft. SQL/servery/databáze/maintenanceWindows/Write | Nastaví nastavení systému Windows pro správu pro vybranou databázi. |
...
> | Akce | Microsoft. SQL/servery/databáze/operationResults/Read | Získá stav databázové operace. |
> | Akce | Microsoft. SQL/servery/databáze/operace/zrušení/akce | Zruší Azure SQL Database čeká na asynchronní operaci, která ještě není dokončená. |
> | Akce | Microsoft. SQL/servery/databáze/operace/čtení | Vrátí seznam operací provedených v databázi. |
> | Akce | Microsoft. SQL/servery/databáze/pozastavit/akce | Pozastavení databáze Azure SQL DataWarehouse |
> | Akce | Microsoft. SQL/servery/databáze/poskytovatelé/Microsoft. Insights/diagnosticSettings/Read | Získá nastavení diagnostiky pro prostředek. |
> | Akce | Microsoft. SQL/servery/databáze/poskytovatelé/Microsoft. Insights/diagnosticSettings/Write | Vytvoří nebo aktualizuje nastavení diagnostiky pro prostředek. |
...
> | Akce | Microsoft. SQL/servery/databáze/queryStore/queryTexts/Read | Vrátí kolekci textů dotazů, které odpovídají zadaným parametrům. |
> | Akce | Microsoft. SQL/servery/databáze/queryStore/Read | Vrátí aktuální hodnoty nastavení úložiště dotazů pro databázi. |
> | Akce | Microsoft. SQL/servery/databáze/queryStore/Write | Aktualizuje nastavení úložiště dotazů pro databázi. |
> | Akce | Microsoft. SQL/servery/databáze/číst | Vrátí seznam databází nebo získá vlastnosti zadané databáze. |
> | Akce | Microsoft. SQL/servery/databáze/recommendedSensitivityLabels/Read | Vypsat popisky citlivosti dané databáze |
> | Akce | Microsoft. SQL/servery/databáze/recommendedSensitivityLabels/Write | Doporučené popisky citlivosti aktualizace Batch |
> | Akce | Microsoft. SQL/servery/databáze/replicationLinks/DELETE | Nuceně ukončit vztah replikace a s potenciální ztrátou dat |
...
> | Akce | Microsoft. SQL/servery/databáze/replicationLinks/forceFailoverAllowDataLoss/Action | Převzetí služeb při selhání hned s možnou ztrátou dat, provedení této databáze na primárním relationship\u0027s replikace a provedení vzdálené primární databáze do sekundárního počítače |
> | Akce | Microsoft. SQL/servery/databáze/replicationLinks/Read | Vrátí seznam replikačních propojení nebo získá vlastnosti pro zadané replikační odkazy. |
...
> | Akce | Microsoft. SQL/servery/databáze/replicationLinks/updateReplicationMode/Action | Aktualizovat režim replikace pro odkaz na synchronní nebo asynchronní režim |
> | Akce | Microsoft. SQL/servery/databáze/restorePoints/Action | Vytvoří nový bod obnovení. |
> | Akce | Microsoft. SQL/servery/databáze/restorePoints/DELETE | Odstraní bod obnovení pro databázi. |
> | Akce | Microsoft. SQL/servery/databáze/restorePoints/Read | Vrátí body obnovení pro databázi. |
> | Akce | Microsoft. SQL/servery/databáze/pokračovat/akce | Obnoví databázi Azure SQL DataWarehouse. |
> | Akce | Microsoft. SQL/servery/databáze/schémata/čtení | Získá schéma databáze. |
> | Akce | Microsoft. SQL/servery/databáze/schémata/tabulky/sloupce/čtení | Získá sloupec databáze. |
> | Akce | Microsoft. SQL/servery/databáze/schémata/tabulky/sloupce/sensitivityLabels/DELETE | Odstraní popisek citlivosti daného sloupce. |
> | Akce | Microsoft. SQL/servery/databáze/schémata/tabulky/sloupce/sensitivityLabels/Disable/Action | Zakázat doporučení citlivosti na daném sloupci |
> | Akce | Microsoft. SQL/servery/databáze/schémata/tabulky/sloupce/sensitivityLabels/Enable/Action | Povolit doporučení citlivosti na daném sloupci |
> | Akce | Microsoft. SQL/servery/databáze/schémata/tabulky/sloupce/sensitivityLabels/čtení | Získá popisek citlivosti daného sloupce. |
> | Akce | Microsoft. SQL/servery/databáze/schémata/tabulky/sloupce/sensitivityLabels/Write | Vytvoří nebo aktualizuje popisek citlivosti daného sloupce. |
> | Akce | Microsoft. SQL/servery/databáze/schémata/tabulky/čtení | Získat databázovou tabulku. |
> | Akce | Microsoft. SQL/servery/databáze/schémata/tabulky/recommendedIndexes/Read | Načíst seznam doporučení indexu pro databázi |
> | Akce | Microsoft. SQL/servery/databáze/schémata/tabulky/recommendedIndexes/Write | Použít doporučení indexu |
> | Akce | Microsoft. SQL/servery/databáze/securityAlertPolicies/Read | Načte seznam zásad detekce hrozeb databáze nakonfigurovaných pro daný server. |
> | Akce | Microsoft. SQL/servery/databáze/securityAlertPolicies/Write | Změna zásad detekce hrozeb databáze pro danou databázi |
> | Akce | Microsoft. SQL/servery/databáze/securityMetrics/Read | Získá kolekci metrik zabezpečení databáze. |
> | Akce | Microsoft. SQL/servery/databáze/sensitivityLabels/Read | Vypsat popisky citlivosti dané databáze |
> | Akce | Microsoft. SQL/servery/databáze/serviceTierAdvisors/Read | Vrátí návrhy o škálování databáze nahoru nebo dolů na základě statistik provádění dotazů za účelem zvýšení výkonu nebo snížení nákladů. |
> | Akce | Microsoft. SQL/servery/databáze/SKU/číst | Získá kolekci SKU, které jsou k dispozici pro databázi. |
> | Akce | Microsoft. SQL/servery/databáze/syncGroups/cancelSync/Action | Zrušit synchronizaci skupiny synchronizace |
> | Akce | Microsoft. SQL/servery/databáze/syncGroups/DELETE | Odstraní existující skupinu synchronizace. |
> | Akce | Microsoft. SQL/servery/databáze/syncGroups/hubSchemas/Read | Vrátí seznam schémat databáze centra synchronizace. |
> | Akce | Microsoft. SQL/servery/databáze/syncGroups/protokoly/číst | Vrátí seznam protokolů skupin synchronizace. |
> | Akce | Microsoft. SQL/servery/databáze/syncGroups/Read | Vrátí seznam skupin synchronizace nebo získá vlastnosti zadané skupiny synchronizace. |
> | Akce | Microsoft. SQL/servery/databáze/syncGroups/refreshHubSchema/Action | Aktualizovat schéma databáze centra synchronizace |
> | Akce | Microsoft. SQL/servery/databáze/syncGroups/refreshHubSchemaOperationResults/Read | Načíst výsledek operace aktualizace schématu centra synchronizace |
> | Akce | Microsoft. SQL/servery/databáze/syncGroups/syncMembers/DELETE | Odstraní stávajícího člena synchronizace. |
> | Akce | Microsoft. SQL/servery/databáze/syncGroups/syncMembers/Read | Vrátí seznam členů synchronizace nebo získá vlastnosti zadaného člena synchronizace. |
> | Akce | Microsoft. SQL/servery/databáze/syncGroups/syncMembers/refreshSchema/Action | Aktualizovat schéma člena synchronizace |
> | Akce | Microsoft. SQL/servery/databáze/syncGroups/syncMembers/refreshSchemaOperationResults/Read | Načíst výsledek operace aktualizace schématu člena synchronizace |
> | Akce | Microsoft. SQL/servery/databáze/syncGroups/syncMembers/schemas/Read | Vrátí seznam schémat členů databáze synchronizace. |
> | Akce | Microsoft. SQL/servery/databáze/syncGroups/syncMembers/Write | Vytvoří člena synchronizace se zadanými parametry nebo aktualizuje vlastnosti zadaného člena synchronizace. |
> | Akce | Microsoft. SQL/servery/databáze/syncGroups/triggerSync/Action | Aktivovat synchronizaci skupiny synchronizace |
> | Akce | Microsoft. SQL/servery/databáze/syncGroups/Write | Vytvoří skupinu synchronizace se zadanými parametry nebo aktualizuje vlastnosti zadané skupiny synchronizace. |
> | Akce | Microsoft. SQL/servery/databáze/topQueries/queryText/Action | Vrátí text Transact-SQL pro vybrané ID dotazu. |
> | Akce | Microsoft. SQL/servery/databáze/topQueries/Read | Vrátí agregovanou statistiku modulu runtime pro vybraný dotaz ve vybraném časovém období. |
> | Akce | Microsoft. SQL/servery/databáze/topQueries/Statistika/čtení | Vrátí agregovanou statistiku modulu runtime pro vybraný dotaz ve vybraném časovém období. |
> | Akce | Microsoft. SQL/servery/databáze/transparentDataEncryption/operationResults/Read | Načte probíhající operace na transparentním šifrování dat. |
> | Akce | Microsoft. SQL/servery/databáze/transparentDataEncryption/Read | Načte stav a Podrobnosti funkce zabezpečení transparentního šifrování dat pro danou databázi. |
> | Akce | Microsoft. SQL/servery/databáze/transparentDataEncryption/Write | Změna transparentního stavu šifrování dat |
> | Akce | Microsoft. SQL/servery/databáze/upgradeDataWarehouse/Action | Upgrade databáze Azure SQL DataWarehouse |
> | Akce | Microsoft. SQL/servery/databáze/použití/čtení | Získá informace o využití Azure SQL Database. |
> | Akce | Microsoft. SQL/servery/databáze/vulnerabilityAssessments/DELETE | Odebrání posouzení ohrožení zabezpečení pro danou databázi |
> | Akce | Microsoft. SQL/servery/databáze/vulnerabilityAssessments/Read | Načtení zásad posouzení ohrožení zabezpečení na givendatabase |
> | Akce | Microsoft. SQL/servery/databáze/vulnerabilityAssessments/pravidla/směrné plány/odstranit | Odebrání směrného plánu pravidla posouzení ohrožení zabezpečení pro danou databázi |
> | Akce | Microsoft. SQL/servery/databáze/vulnerabilityAssessments/pravidla/směrné plány/číst | Získat směrný plán pravidla posouzení ohrožení zabezpečení pro danou databázi |
> | Akce | Microsoft. SQL/servery/databáze/vulnerabilityAssessments/pravidla/směrné plány/zápis | Změna směrného plánu pravidla posouzení ohrožení zabezpečení pro danou databázi |
...
> | Akce | Microsoft. SQL/servery/databáze/vulnerabilityAssessments/prověřování/čtení | Vrátí seznam vyhodnocování ohrožení zabezpečení databáze nebo získá záznam o kontrole pro zadané ID vyhledávání. |
> | Akce | Microsoft. SQL/servery/databáze/vulnerabilityAssessments/Write | Změna posouzení ohrožení zabezpečení pro danou databázi |
...
> | Akce | Microsoft. SQL/servery/databáze/vulnerabilityAssessmentScans/operationResults/Read | Načíst výsledek operace provedení kontroly vyhodnocení ohrožení zabezpečení databáze |
> | Akce | Microsoft. SQL/servery/databáze/vulnerabilityAssessmentSettings/Read | Načte podrobnosti posouzení ohrožení zabezpečení nakonfigurovaného pro danou databázi. |
> | Akce | Microsoft. SQL/servery/databáze/vulnerabilityAssessmentSettings/Write | Změna posouzení ohrožení zabezpečení pro danou databázi |
> | Akce | Microsoft. SQL/servery/databáze/zápis | Vytvoří databázi se zadanými parametry nebo aktualizuje vlastnosti nebo značky pro zadanou databázi. |
> | Akce | Microsoft. SQL/servery/odstranit | Odstraní existující server. |
> | Akce | Microsoft. SQL/servery/disasterRecoveryConfiguration/DELETE | Odstraní existující konfigurace zotavení po havárii pro daný server. |
...
> | Akce | Microsoft. SQL/servery/disasterRecoveryConfiguration/forceFailoverAllowDataLoss/Action | Vynucení převzetí služeb při selhání DisasterRecoveryConfiguration |
> | Akce | Microsoft. SQL/servery/disasterRecoveryConfiguration/Read | Získá kolekci konfigurací zotavení po havárii, které zahrnují tento server. |
> | Akce | Microsoft. SQL/servery/disasterRecoveryConfiguration/Write | Změna konfigurace zotavení po havárii serveru |
> | Akce | Microsoft. SQL/servery/elasticPoolEstimates/Read | Vrátí seznam odhadů elastických fondů již vytvořených pro tento server. |
> | Akce | Microsoft. SQL/servery/elasticPoolEstimates/Write | Vytvoří nový odhad elastického fondu pro seznam poskytnutých databází. |
...
> | Akce | Microsoft. SQL/servery/elasticPools/Providers/Microsoft. Insights/diagnosticSettings/Read | Získá nastavení diagnostiky pro prostředek. |
> | Akce | Microsoft. SQL/servery/elasticPools/Providers/Microsoft. Insights/diagnosticSettings/Write | Vytvoří nebo aktualizuje nastavení diagnostiky pro prostředek. |
...
> | Akce | Microsoft. SQL/servery/encryptionProtector/Read | Vrátí seznam chráněných šifrovacích serverů nebo získá vlastnosti pro zadané ochrany šifrování serveru. |
...
> | Akce | Microsoft. SQL/servery/extendedAuditingSettings/Read | Načíst podrobnosti o zásadách auditování rozšířených objektů BLOB serveru nakonfigurovaných na daném serveru |
> | Akce | Microsoft. SQL/servery/extendedAuditingSettings/Write | Změna auditování rozšířeného objektu BLOB serveru pro daný server |
> | Akce | Microsoft. SQL/servery/failoverGroups/DELETE | Odstraní existující skupinu převzetí služeb při selhání. |
...
> | Akce | Microsoft. SQL/servery/failoverGroups/forceFailoverAllowDataLoss/Action | Spustí vynucené převzetí služeb při selhání v existující skupině převzetí služeb při selhání |
> | Akce | Microsoft. SQL/servery/failoverGroups/Read | Vrátí seznam skupin převzetí služeb při selhání nebo získá vlastnosti zadané skupiny převzetí služeb při selhání. |
> | Akce | Microsoft. SQL/servery/failoverGroups/Write | Vytvoří skupinu převzetí služeb při selhání se zadanými parametry nebo aktualizuje vlastnosti nebo značky pro zadanou skupinu převzetí služeb při selhání. |
> | Akce | Microsoft. SQL/servery/firewallRules/DELETE | Odstraní existující pravidlo brány firewall serveru. |
...
> | Akce | Microsoft. SQL/servery/importExportOperationResults/Read | Načte probíhající operace importu a exportu. |
> | Akce | Microsoft. SQL/servery/interfaceEndpointProfiles/DELETE | Odstraní zadaný profil koncového bodu rozhraní. |
> | Akce | Microsoft. SQL/servery/interfaceEndpointProfiles/Read | Vrátí vlastnosti pro zadaný profil koncového bodu rozhraní. |
> | Akce | Microsoft. SQL/servery/interfaceEndpointProfiles/Write | Vytvoří profil koncového bodu rozhraní se zadanými parametry nebo aktualizuje vlastnosti nebo značky zadaného koncového bodu rozhraní. |
...
> | Akce | Microsoft. SQL/servery/klíče/odstranit | Odstraní existující klíč serveru. |
...
> | Akce | Microsoft. SQL/servery/operationResults/Read | Načte probíhající operace serveru. |
> | Akce | Microsoft. SQL/servery/privateEndpointConnectionProxies/DELETE | Odstraní existující proxy připojení privátního koncového bodu. |
> | Akce | Microsoft. SQL/servery/privateEndpointConnectionProxies/Read | Vrátí seznam proxy serverů připojení privátního koncového bodu nebo získá vlastnosti zadaného proxy serveru připojení privátního koncového bodu. |
...
> | Akce | Microsoft. SQL/servery/privateEndpointConnectionProxies/Write | Vytvoří proxy server připojení privátního koncového bodu se zadanými parametry nebo aktualizuje vlastnosti nebo značky pro zadaný proxy privátního koncového bodu. |
...
> | Akce | Microsoft. SQL/servery/recommendedElasticPools/Read | Načtěte doporučení pro fondy elastické databáze, abyste snížili náklady nebo vylepšili výkon na základě historických využití prostředků. |
> | Akce | Microsoft. SQL/servery/recoverableDatabases/Read | Tato operace se používá pro zotavení po havárii živé databáze k obnovení databáze do posledního známého funkčního bodu zálohování. Vrátí informace o poslední dobré záloze, ale doesn\u0027t ve skutečnosti obnoví databázi. |
...
> | Akce | Microsoft. SQL/servery/restorableDroppedDatabases/Read | Získat seznam databází, které byly na daném serveru vyřazeny, které jsou stále v rámci zásad uchovávání informací. |
> | Akce | Microsoft. SQL/servery/securityAlertPolicies/operationResults/Read | Načíst výsledky operace zápisu zásad detekce hrozeb serveru |
> | Akce | Microsoft. SQL/servery/securityAlertPolicies/Read | Načte seznam zásad detekce hrozeb serveru nakonfigurovaných pro daný server. |
> | Akce | Microsoft. SQL/servery/securityAlertPolicies/Write | Změna zásad detekce hrozeb serveru pro daný server |
...
> | Akce | Microsoft. SQL/servery/syncAgents/DELETE | Odstraní stávajícího agenta synchronizace. |
> | Akce | Microsoft. SQL/servery/syncAgents/generateKey/Action | Generovat registrační klíč agenta synchronizace |
> | Akce | Microsoft. SQL/servery/syncAgents/linkedDatabases/Read | Vrátí seznam propojených databází agenta synchronizace. |
...
> | Akce | Microsoft. SQL/servery/vulnerabilityAssessments/DELETE | Odebrání posouzení ohrožení zabezpečení pro daný server |
...
> | Akce | Microsoft. SQL/zrušit registraci/akce | Zruší registraci předplatného pro poskytovatele prostředků Microsoft SQL Database a povolí vytváření databází Microsoft SQL. |
...
> | Akce dataaction | Microsoft. Storage/storageAccounts/služby souborů/sdílené složky/soubory/modifypermissions/Action | Vrátí výsledek úpravy oprávnění pro soubor nebo složku. |
...
> | Akce dataaction | Microsoft. Storage/storageAccounts/Souborová služba/sdílené složky/soubory/zápis | Vrátí výsledek zápisu souboru nebo vytvoření složky. |
> | Akce | Microsoft. Storage/storageAccounts/služby/služby/čtení |  |
> | Akce | Microsoft. Storage/storageAccounts/služby/služby/čtení | Získat vlastnosti souborové služby |
...
> | Akce | Microsoft. storagesync/umístění/pracovní postupy/operace/čtení | Získá stav asynchronní operace. |
...
> | Akce | Microsoft. storagesync/storageSyncServices/syncGroups/cloudEndpoints/operationresults/číst | Získá stav asynchronní operace zálohování a obnovení. |
...
> | Akce | Microsoft. storagesync/storageSyncServices/syncGroups/cloudEndpoints/předzálohovací/Action | Před zálohováním volejte tuto akci |
> | Akce | Microsoft. storagesync/storageSyncServices/syncGroups/cloudEndpoints/předobnovit/Action | Před obnovením volejte tuto akci |
...
> | Akce | Microsoft. StorSimple/manažeři/accessControlRecords/operationResults/číst | Zobrazí nebo získá výsledky operace. |
...
> | Akce | Microsoft. StorSimple/manažeři/bandwidthSettings/DELETE | Odstraní existující nastavení šířky pásma (jenom řady 8000). |
> | Akce | Microsoft. StorSimple/manažeři/bandwidthSettings/operationResults/číst | Vypíše výsledky operace. |
> | Akce | Microsoft. StorSimple/manažeři/bandwidthSettings/Read | Zobrazit seznam nastavení šířky pásma (jenom řada 8000) |
> | Akce | Microsoft. StorSimple/manažeři/bandwidthSettings/Write | Vytvoří nové nebo aktualizuje nastavení šířky pásma (jenom série 8000). |
> | Akce | Microsoft. StorSimple/manažeři/certifikáty/zapisovat | Vytvoření nebo aktualizace certifikátů |
> | Akce | Microsoft. StorSimple/manažeři/certifikáty/zapisovat | Operace aktualizovat certifikát prostředku aktualizuje certifikát přihlašovacích údajů k prostředku nebo úložišti. |
> | Akce | Microsoft. StorSimple/manažeři/clearAlerts/Action | Vymažte všechny výstrahy spojené se správcem zařízení. |
> | Akce | Microsoft. StorSimple/manažeři/cloudApplianceConfigurations/Read | Seznam podporovaných konfigurací cloudového zařízení |
...
> | Akce | Microsoft. StorSimple/manažeři/odstranit | Operace odstranění trezoru odstraní zadaný prostředek Azure typu trezor. |
...
> | Akce | Microsoft. StorSimple/manažeři/zařízení/authorizeForServiceEncryptionKeyRollover/Action | Autorizovat pro výměnu šifrovacího klíče služby na zařízeních |
...
> | Akce | Microsoft. StorSimple/manažeři/zařízení/backupPolicies/plány/operationResults/číst | Vypíše výsledky operace. |
> | Akce | Microsoft. StorSimple/manažeři/zařízení/backupPolicies/plány/čtení | Výpis plánů |
> | Akce | Microsoft. StorSimple/manažeři/zařízení/backupPolicies/Schedules/Write | Vytvoří nové nebo aktualizované plány. |
...
> | Akce | Microsoft. StorSimple/manažeři/zařízení/backupScheduleGroups/DELETE | Odstraní skupiny plánu zálohování. |
> | Akce | Microsoft. StorSimple/manažeři/zařízení/backupScheduleGroups/operationResults/číst | Zobrazí nebo získá výsledky operace. |
> | Akce | Microsoft. StorSimple/manažeři/zařízení/backupScheduleGroups/číst | Zobrazí nebo získá skupiny plánu zálohování. |
> | Akce | Microsoft. StorSimple/manažeři/zařízení/backupScheduleGroups/Write | Vytvoření nebo aktualizace skupin plánu zálohování |
> | Akce | Microsoft. StorSimple/manažeři/zařízení/chapSettings/DELETE | Odstraní nastavení protokolu CHAP. |
> | Akce | Microsoft. StorSimple/manažeři/zařízení/chapSettings/operationResults/číst | Zobrazí nebo získá výsledky operace. |
> | Akce | Microsoft. StorSimple/manažeři/zařízení/chapSettings/číst | Zobrazí nebo získá nastavení protokolu CHAP. |
> | Akce | Microsoft. StorSimple/manažeři/zařízení/chapSettings/Write | Vytvořit nebo aktualizovat nastavení protokolu CHAP |
...
> | Akce | Microsoft. StorSimple/manažeři/zařízení/hardwareComponentGroups/changeControllerPowerState/Action | Změna stavu napájení řadiče pro skupiny hardwarových součástí |
> | Akce | Microsoft. StorSimple/manažeři/zařízení/hardwareComponentGroups/operationResults/číst | Vypíše výsledky operace. |
> | Akce | Microsoft. StorSimple/manažeři/zařízení/hardwareComponentGroups/číst | Seznam skupin hardwarových součástí |
> | Akce | Microsoft. StorSimple/manažeři/zařízení/instalace/akce | Nainstalujte do zařízení aktualizace. |
> | Akce | Microsoft. StorSimple/manažeři/zařízení/installUpdates/Action | Nainstaluje aktualizace na zařízení (jenom řada 8000). |
> | Akce | Microsoft. StorSimple/manažeři/zařízení/iscsiservers/záloha/akce | Pořídit zálohu serveru iSCSI. |
> | Akce | Microsoft. StorSimple/manažeři/zařízení/iscsiservers/DELETE | Odstraní servery iSCSI. |
> | Akce | Microsoft. StorSimple/manažeři/zařízení/iscsiservers/disks/DELETE | Odstraní disky. |
> | Akce | Microsoft. StorSimple/manažeři/zařízení/iscsiservers/disky/metriky/čtení | Vypíše nebo získá metriky. |
> | Akce | Microsoft. StorSimple/manažeři/zařízení/iscsiservers/disky/metricsDefinitions/Read | Zobrazí nebo získá definice metrik. |
> | Akce | Microsoft. StorSimple/manažeři/zařízení/iscsiservers/disky/operationResults/Read | Zobrazí nebo získá výsledky operace. |
> | Akce | Microsoft. StorSimple/manažeři/zařízení/iscsiservers/disky/číst | Vypíše nebo získá disky. |
> | Akce | Microsoft. StorSimple/manažeři/zařízení/iscsiservers/disks/Write | Vytvořit nebo aktualizovat disky |
...
> | Akce | Microsoft. StorSimple/manažeři/zařízení/iscsiservers/operationResults/číst | Zobrazí nebo získá výsledky operace. |
> | Akce | Microsoft. StorSimple/manažeři/zařízení/iscsiservers/číst | Vypíše nebo získá servery iSCSI. |
> | Akce | Microsoft. StorSimple/manažeři/zařízení/iscsiservers/Write | Vytvoření nebo aktualizace serverů iSCSI |
...
> | Akce | Microsoft. StorSimple/manažeři/zařízení/networkSettings/operationResults/číst | Vypíše výsledky operace. |
> | Akce | Microsoft. StorSimple/manažeři/zařízení/networkSettings/číst | Zobrazí nebo získá nastavení sítě. |
> | Akce | Microsoft. StorSimple/manažeři/zařízení/networkSettings/Write | Vytvoří nové nebo aktualizuje nastavení sítě. |
...
> | Akce | Microsoft. StorSimple/manažeři/zařízení/scanForUpdates/Action | Vyhledat aktualizace v zařízení. |
> | Akce | Microsoft. StorSimple/manažeři/zařízení/securitySettings/operationResults/číst | Zobrazí nebo získá výsledky operace. |
> | Akce | Microsoft. StorSimple/manažeři/zařízení/securitySettings/číst | Zobrazit seznam nastavení zabezpečení |
> | Akce | Microsoft. StorSimple/manažeři/zařízení/securitySettings/syncRemoteManagementCertificate/Action | Synchronizuje certifikát vzdálené správy pro zařízení. |
> | Akce | Microsoft. StorSimple/manažeři/zařízení/securitySettings/Update/Action | Aktualizujte nastavení zabezpečení. |
> | Akce | Microsoft. StorSimple/manažeři/zařízení/securitySettings/Write | Vytvoří nové nebo aktualizuje nastavení zabezpečení. |
...
> | Akce | Microsoft. StorSimple/manažeři/zařízení/timeSettings/operationResults/číst | Vypíše výsledky operace. |
> | Akce | Microsoft. StorSimple/manažeři/zařízení/timeSettings/číst | Zobrazí nebo získá nastavení času. |
> | Akce | Microsoft. StorSimple/manažeři/zařízení/timeSettings/Write | Vytvoří nové nebo aktualizace nastavení času. |
> | Akce | Microsoft. StorSimple/manažeři/zařízení/aktualizovat/operationResults/číst | Zobrazí nebo získá výsledky operace. |
> | Akce | Microsoft. StorSimple/manažeři/zařízení/updateSummary/číst | Zobrazí nebo získá souhrn aktualizace. |
...
> | Akce | Microsoft. StorSimple/manažeři/encryptionSettings/Read | Zobrazí nebo získá nastavení šifrování. |
> | Akce | Microsoft. StorSimple/manažeři/extendedInformation/DELETE | Odstraní rozšířené informace o trezoru. |
> | Akce | Microsoft. StorSimple/manažeři/extendedInformation/DELETE | Operace získat rozšířené informace získá rozšířené informace o objektu, které představují prostředek Azure typu? trezor? |
> | Akce | Microsoft. StorSimple/manažeři/extendedInformation/Read | Zobrazí nebo získá informace o rozšířeném trezoru. |
> | Akce | Microsoft. StorSimple/manažeři/extendedInformation/Read | Operace získat rozšířené informace získá rozšířené informace o objektu, které představují prostředek Azure typu? trezor? |
> | Akce | Microsoft. StorSimple/manažeři/extendedInformation/Write | Vytvoří nebo aktualizuje rozšířené informace o trezoru. |
> | Akce | Microsoft. StorSimple/manažeři/extendedInformation/Write | Operace získat rozšířené informace získá rozšířené informace o objektu, které představují prostředek Azure typu? trezor? |
...
> | Akce | Microsoft. StorSimple/manažeři/iscsiservers/Read | Vypíše nebo získá servery iSCSI. |
...
> | Akce | Microsoft. StorSimple/manažeři/operationResults/Read | Zobrazí nebo získá výsledky operace. |
> | Akce | Microsoft. StorSimple/manažeři/provisionCloudAppliance/Action | Vytvořte nové cloudové zařízení. |
> | Akce | Microsoft. StorSimple/manažeři/číst | Zobrazí nebo získá Správce zařízení. |
> | Akce | Microsoft. StorSimple/manažeři/číst | Operace získat úložiště Získá objekt, který představuje prostředek Azure typu trezor. |
...
> | Akce | Microsoft. StorSimple/manažeři/storageAccountCredentials/DELETE | Odstraní přihlašovací údaje účtu úložiště. |
> | Akce | Microsoft. StorSimple/manažeři/storageAccountCredentials/operationResults/číst | Zobrazí nebo získá výsledky operace. |
> | Akce | Microsoft. StorSimple/manažeři/storageAccountCredentials/Read | Zobrazí nebo získá přihlašovací údaje účtu úložiště. |
> | Akce | Microsoft. StorSimple/manažeři/storageAccountCredentials/Write | Vytvořit nebo aktualizovat přihlašovací údaje účtu úložiště |
> | Akce | Microsoft. StorSimple/manažeři/storageDomains/DELETE | Odstraní domény úložiště. |
> | Akce | Microsoft. StorSimple/manažeři/storageDomains/operationResults/číst | Zobrazí nebo získá výsledky operace. |
...
> | Akce | Microsoft. StorSimple/manažeři/zapisovat | Operace vytvořit trezor vytvoří prostředek Azure typu trezor. |
...
> | Akce | Microsoft. TimeSeriesInsights/Environment/accesspolicies/Write | Vytvoří novou zásadu přístupu pro prostředí nebo aktualizuje existující zásady přístupu. |
> | Akce | Microsoft. TimeSeriesInsights/prostředí/odstranění | Odstraní prostředí. |
> | Akce | Microsoft. TimeSeriesInsights/Environments/EventSources/DELETE | Odstraní zdroj události. |
> | Akce | Microsoft. TimeSeriesInsights/Environment/EventSources/Read | Získá vlastnosti zdroje události. |
> | Akce | Microsoft. TimeSeriesInsights/Environment/EventSources/Write | Vytvoří nový zdroj události pro prostředí nebo aktualizuje existující zdroj události. |
> | Akce | Microsoft. TimeSeriesInsights/prostředí/číst | Získá vlastnosti prostředí. |
> | Akce | Microsoft. TimeSeriesInsights/Environments/referencedatasets/DELETE | Odstraní referenční datovou sadu. |
> | Akce | Microsoft. TimeSeriesInsights/Environment/referencedatasets/Read | Získá vlastnosti referenční sady dat. |
> | Akce | Microsoft. TimeSeriesInsights/Environment/referencedatasets/Write | Vytvoří novou referenční sadu dat pro prostředí nebo aktualizuje existující referenční datovou sadu. |
> | Akce | Microsoft. TimeSeriesInsights/prostředí/stav/čtení | Získejte stav prostředí, stav svých přidružených operací, jako je příchozí přenos dat. |
> | Akce | Microsoft. TimeSeriesInsights/prostředí/Write | Vytvoří nové prostředí nebo aktualizuje existující prostředí. |
...
> | Akce | Microsoft. Web/apimanagementaccounts/API/apiacls/DELETE | Odstraňte rozhraní API pro účty API Management Apiacls. |
> | Akce | Microsoft. Web/apimanagementaccounts/API/apiacls/Read | Získejte rozhraní API pro účty API Management Apiacls. |
> | Akce | Microsoft. Web/apimanagementaccounts/API/apiacls/Write | Aktualizujte účty API Management API Apiacls. |
> | Akce | Microsoft. Web/apimanagementaccounts/API/connectionacls/Read | Získejte rozhraní API pro účty API Management Connectionacls. |
...
> | Akce | Microsoft. Web/apimanagementaccounts/API/Connections/connectionacls/DELETE | Odstraní účty API managementu rozhraní API připojení Connectionacls. |
...
> | Akce | Microsoft. Web/apimanagementaccounts/API/Connections/connectionacls/Write | Aktualizujte účty API managementu. připojení rozhraní API Connectionacls. |
> | Akce | Microsoft. Web/apimanagementaccounts/API/Connections/DELETE | Odstraňte připojení rozhraní API pro účty API Management. |
...
> | Akce | Microsoft. Web/apimanagementaccounts/API/Connections/Write | Aktualizujte připojení rozhraní API pro účty Management API. |
> | Akce | Microsoft. Web/apimanagementaccounts/API/DELETE | Odstraňte rozhraní API pro účty API managementu. |
> | Akce | Microsoft. Web/apimanagementaccounts/API/localizeddefinitions/DELETE | Odstraňte lokalizované definice rozhraní API Management Accounts API. |
> | Akce | Microsoft. Web/apimanagementaccounts/API/localizeddefinitions/Read | Získejte lokalizované definice rozhraní API pro účty Management Management. |
> | Akce | Microsoft. Web/apimanagementaccounts/API/localizeddefinitions/Write | Aktualizovat lokalizované definice rozhraní API Management Accounts API |
> | Akce | Microsoft. Web/apimanagementaccounts/API/Read | Získejte rozhraní API pro účty API managementu. |
> | Akce | Microsoft. Web/apimanagementaccounts/API/Write | Aktualizujte rozhraní API pro účty API Management. |
...
> | Akce | Microsoft. Web/certifikáty/odstranit | Odstraní existující certifikát. |
...
> | Akce | Microsoft. Web/hostingenvironments/kapacit/čtení | Získejte kapacity hostujících prostředí. |
> | Akce | Microsoft. Web/hostingEnvironments/DELETE | Odstranit App Service Environment |
> | Akce | Microsoft. Web/hostingenvironments/detektory/číst | Získejte detektory hostujících prostředí. |
...
> | Akce | Microsoft. Web/hostingenvironments/multirolepools/metriky/čtení | Získejte prostředí hostování metrik fondů s více rolemi. |
...
> | Akce | Microsoft. Web/hostingenvironments/multirolepools/Usage/Read | Získejte prostředí hostování více fondů rolí. |
...
> | Akce | Microsoft. Web/hostingenvironments/serverových farem/Read | Získejte prostředí pro hostování App Service plány. |
...
> | Akce | Microsoft. Web/hostingenvironments/použití/čtení | Získejte využití prostředí hostování. |
...
> | Akce | Microsoft. Web/hostingenvironments/workerpools/SKU/Read | Získejte hostující prostředí Workerpools SKU. |
> | Akce | Microsoft. Web/hostingenvironments/workerpools/Usage/Read | Získejte prostředí hostování Workerpools využití. |
...
> | Akce | Microsoft. Web/Locations/Inspirujte/apioperations/Read | Získejte umístění spravovaných operací rozhraní API. |
> | Akce | Microsoft. Web/Locations/Inspirujte/JOIN/Action | Připojí spravované rozhraní API. |
> | Akce | Microsoft. Web/Locations/Inspirujte/Read | Získat umístění spravovaná rozhraní API. |
...
> | Akce | Microsoft. Web/registr/Action | Zaregistrujte poskytovatele prostředků Microsoft. Web pro předplatné. |
> | Akce | Microsoft. Web/resourcehealthmetadata/Read | Získá metadata Resource Health. |
> | Akce | Microsoft. Web/serverových farem/Capabilities/číst | Získejte možnosti plánů App Service. |
> | Akce | Microsoft. Web/serverových farem/DELETE | Odstraní existující plán App Service. |
...
> | Akce | Microsoft. Web/serverových farem/firstpartyapps/Settings/DELETE | Odstranit nastavení aplikací pro první stranu App Service plánů |
> | Akce | Microsoft. Web/serverových farem/firstpartyapps/Settings/Read | Získá nastavení aplikací pro první stranu App Service plánů. |
> | Akce | Microsoft. Web/serverových farem/firstpartyapps/Settings/Write | Aktualizuje nastavení aplikací pro první stranu App Service plánů. |
> | Akce | Microsoft. Web/serverových farem/hybridconnectionnamespaces/Relay/DELETE | Odstranění App Service plánuje přenos oborů názvů Hybrid Connection. |
> | Akce | Microsoft. Web/serverových farem/hybridconnectionnamespaces/Relay/Read | Získá App Service naplánuje přenos oborů názvů Hybrid Connection. |
> | Akce | Microsoft. Web/serverových farem/hybridconnectionnamespaces/Relay/sites/Read | Získá App Service přenáší obory názvů Hybrid Connection Web Apps. |
> | Akce | Microsoft. Web/serverových farem/hybridconnectionplanlimits/Read | Získá App Service plány plánů hybridního připojení. |
> | Akce | Microsoft. Web/serverových farem/hybridconnectionrelays/Read | Získá App Service Relay naplánuje přenos Hybrid Connection. |
> | Akce | Microsoft. Web/serverových farem/metricdefinitions/Read | Získá definice metriky pro plány App Service. |
> | Akce | Microsoft. Web/serverových farem/metriky/číst | Získejte metriky plánů App Service. |
> | Akce | Microsoft. Web/serverových farem/operationresults/Read | Získejte výsledky operace App Service plánů. |
> | Akce | Microsoft. Web/serverových farem/Read | Získat vlastnosti v plánu App Service |
> | Akce | Microsoft. Web/serverových farem/restartSites/Action | Restartování všech Web Apps v plánu App Service |
> | Akce | Microsoft. Web/serverových farem/sites/Read | Získejte Web Apps plány App Service. |
> | Akce | Microsoft. Web/serverových farem/SKU/Read | Získejte skladové položky plánů App Service. |
> | Akce | Microsoft. Web/serverových farem/použití/čtení | Získejte využití plánů App Service. |
> | Akce | Microsoft. Web/serverových farem/virtualnetworkconnections/gateways/Write | Aktualizace plánů App Service Virtual Network připojení brány. |
> | Akce | Microsoft. Web/serverových farem/virtualnetworkconnections/Read | Získá plány App Service Virtual Network připojení. |
> | Akce | Microsoft. Web/serverových farem/virtualnetworkconnections/Routes/DELETE | Odstraní plány App Service Virtual Network trasy připojení. |
> | Akce | Microsoft. Web/serverových farem/virtualnetworkconnections/Routes/Read | Získá plány App Service Virtual Network trasy připojení. |
> | Akce | Microsoft. Web/serverových farem/virtualnetworkconnections/Routes/Write | Aktualizujte plány App Service Virtual Network trasy připojení. |
> | Akce | Microsoft. Web/serverových farem/Workers/restart/Action | Restartuje App Service plánuje pracovní procesy. |
> | Akce | Microsoft. Web/serverových farem/Write | Vytvoří nový plán App Service nebo aktualizuje stávající. |
> | Akce | Microsoft. Web/Sites/analyzecustomhostname/Read | Analyzujte vlastní název hostitele. |
> | Akce | Microsoft. Web/weby/applySlotConfig/Action | Použít konfiguraci slotu webové aplikace z cílového slotu na aktuální webovou aplikaci |
> | Akce | Microsoft. Web/weby/zálohování/akce | Vytvoření nové zálohy webové aplikace |
> | Akce | Microsoft. Web/weby/zálohování/čtení | Získat zálohu Web Apps. |
> | Akce | Microsoft. Web/weby/zálohování/zápis | Aktualizujte Web Apps zálohu. |
> | Akce | Microsoft. Web/weby/zálohy/akce | Zjistí existující zálohu aplikace, kterou je možné obnovit z objektu BLOB ve službě Azure Storage. |
> | Akce | Microsoft. Web/weby/zálohy/odstranit | Odstraňte zálohy Web Apps. |
> | Akce | Microsoft. Web/weby/zálohy/seznam/akce | Vypíše Web Apps zálohy. |
> | Akce | Microsoft. Web/weby/zálohy/čtení | Získat vlastnosti zálohování webové aplikace |
> | Akce | Microsoft. Web/weby/zálohy/obnovení/akce | Obnovte Web Apps zálohy. |
> | Akce | Microsoft. Web/weby/zálohy/zápis | Aktualizace záloh Web Apps. |
> | Akce | Microsoft. Web/weby/config/DELETE | Odstraní konfiguraci Web Apps. |
...
> | Akce | Microsoft. Web/lokality/config/Read | Získat nastavení konfigurace webové aplikace |
> | Akce | Microsoft. Web/weby/konfigurace/snímky/číst | Získat Web Apps konfigurační snímky. |
> | Akce | Microsoft. Web/weby/config/Write | Aktualizovat konfigurační nastavení webové aplikace |
> | Akce | Microsoft. Web/weby/containerlogs/Action | Získejte protokoly kontejneru zip pro webovou aplikaci. |
> | Akce | Microsoft. Web/weby/containerlogs/stáhnout/akce | Stáhnout Web Apps protokoly kontejnerů. |
> | Akce | Microsoft. Web/weby/continuouswebjobs/DELETE | Odstraňte Web Apps průběžné webové úlohy. |
...
> | Akce | Microsoft. Web/weby/continuouswebjobs/stop/Action | Zastavte Web Apps průběžné webové úlohy. |
> | Akce | Microsoft. Web/weby/odstranit | Odstranění existující webové aplikace |
> | Akce | Microsoft. Web/weby/nasazení/odstranit | Odstraňte Web Apps nasazení. |
> | Akce | Microsoft. Web/weby/nasazení/protokolovat/číst | Získá protokol nasazení Web Apps. |
> | Akce | Microsoft. Web/weby/nasazení/čtení | Získat Web Apps nasazení. |
> | Akce | Microsoft. Web/weby/nasazení/zápis | Aktualizujte nasazení Web Apps. |
> | Akce | Microsoft. Web/weby/detektory/číst | Získat Web Apps detektory. |
> | Akce | Microsoft. Web/weby/Diagnostika/analýzy/provedení/akce | Spusťte analýzu diagnostiky Web Apps. |
> | Akce | Microsoft. Web/weby/Diagnostika/analýzy/čtení | Získat analýzu diagnostiky Web Apps. |
> | Akce | Microsoft. Web/Sites/Diagnostics/aspnetcore/Read | Získejte diagnostiku Web Apps pro ASP.NET Core aplikaci. |
> | Akce | Microsoft. Web/Sites/Diagnostics/autoretušovací/číst | Získejte diagnostiku Web Apps pro autoretušování. |
> | Akce | Microsoft. Web/weby/Diagnostika/nasazení/čtení | Získat Web Apps nasazení diagnostiky. |
> | Akce | Microsoft. Web/weby/Diagnostika/nasazení/čtení | Získat Web Apps nasazení diagnostiky. |
> | Akce | Microsoft. Web/weby/Diagnostika/detektory/provedení/akce | Spusťte detektor diagnostiky Web Apps. |
> | Akce | Microsoft. Web/weby/Diagnostika/detektory/čtení | Získat Web Apps detektor diagnostiky |
...
> | Akce | Microsoft. Web/weby/Diagnostika/číst | Získá kategorie diagnostiky Web Apps. |
...
> | Akce | Microsoft. Web/weby/domainownershipidentifiers/Write | Aktualizuje Web Apps identifikátory vlastnictví domény. |
...
> | Akce | Microsoft. Web/weby/rozšíření/číst | Získá Web Apps rozšíření webů. |
> | Akce | Microsoft. Web/weby/rozšíření/zápis | Aktualizuje rozšíření Web Apps lokality. |
> | Akce | Microsoft. Web/weby/funkce/akce | Funkce Web Apps. |
...
> | Akce | Microsoft. Web/weby/funkce/číst | Získá funkce Web Apps. |
> | Akce | Microsoft. Web/weby/funkce/token/čtení | Získat token Web Apps Functions |
> | Akce | Microsoft. Web/weby/funkce/zápis | Aktualizujte Web Apps funkce. |
...
> | Akce | Microsoft. Web/weby/hostnamebindings/DELETE | Odstraňte vazby Web Apps hostname. |
...
> | Akce | Microsoft. Web/weby/hybridconnection/Write | Aktualizuje Web Apps hybridní připojení. |
> | Akce | Microsoft. Web/weby/hybridconnectionnamespaces/Relay/DELETE | Odstranit Web Apps přenáší obory názvů Hybrid Connection. |
...
> | Akce | Microsoft. Web/weby/hybridconnectionnamespaces/Relay/Read | Získá Web Apps přenosných oborů názvů Hybrid Connection. |
> | Akce | Microsoft. Web/weby/hybridconnectionnamespaces/Relay/Write | Aktualizujte Web Apps přenáší obory názvů Hybrid Connection. |
> | Akce | Microsoft. Web/Sites/hybridconnectionrelays/Read | Získá Web Apps Relay pro hybridní připojení. |
> | Akce | Microsoft. Web/weby/instance/nasazení/odstranit | Odstraní nasazení Web Apps instancí. |
> | Akce | Microsoft. Web/weby/instance/nasazení/čtení | Získá nasazení instancí Web Apps. |
> | Akce | Microsoft. Web/weby/instance/rozšíření/protokol/čtení | Načte protokol rozšíření instancí Web Apps. |
> | Akce | Microsoft. Web/weby/instance/rozšíření/procesy/číst | Získá procesy rozšíření instancí Web Apps. |
> | Akce | Microsoft. Web/weby/instance/rozšíření/číst | Získá rozšíření instancí Web Apps. |
> | Akce | Microsoft. Web/weby/instance/procesy/odstranit | Odstraní procesy Web Apps instance. |
> | Akce | Microsoft. Web/weby/instance/procesy/moduly/číst | Načte instance Web Apps zpracuje moduly. |
> | Akce | Microsoft. Web/weby/instance/procesy/číst | Získá procesy Web Apps instance. |
> | Akce | Microsoft. Web/weby/instance/procesy/vlákna/čtení | Načte instance Web Apps zpracuje vlákna. |
> | Akce | Microsoft. Web/weby/instance/číst | Získá instance Web Apps. |
> | Akce | Microsoft. Web/weby/listsyncfunctiontriggerstatus/Action | Vypíše stav triggeru funkce synchronizace. |
> | Akce | Microsoft. Web/Sites/metricdefinitions/Read | Získat Web Apps definice metriky. |
> | Akce | Microsoft. Web/weby/metriky/číst | Získat Web Apps metriky. |
...
> | Akce | Microsoft. Web/weby/networktrace/Action | Web Apps trasování sítě. |
> | Akce | Microsoft. Web/Sites/networktraces/operationresults/Read | Získá Web Apps výsledky operace trasování sítě. |
> | Akce | Microsoft. Web/weby/nové_heslo/Action | Nové_heslo Web Apps. |
> | Akce | Microsoft. Web/Sites/operationresults/Read | Získá výsledky Web Apps operace. |
> | Akce | Microsoft. Web/weby/operace/čtení | Získat Web Apps operace. |
> | Akce | Microsoft. Web/Sites/perfcounters/Read | Získá Web Apps čítače výkonu. |
> | Akce | Microsoft. Web/weby/premieraddons/DELETE | Odstraňte Web Apps doplňky Premier. |
> | Akce | Microsoft. Web/Sites/premieraddons/Read | Získejte Web Apps doplňky Premier. |
> | Akce | Microsoft. Web/weby/premieraddons/Write | Aktualizujte Web Apps doplňky Premier. |
...
> | Akce | Microsoft. Web/weby/procesy/moduly/číst | Získá moduly Web Apps procesy. |
> | Akce | Microsoft. Web/weby/procesy/číst | Získat Web Apps procesy. |
> | Akce | Microsoft. Web/weby/procesy/vlákna/číst | Získá vlákna Web Apps procesů. |
> | Akce | Microsoft. Web/weby/publiccertificates/DELETE | Odstranit Web Apps veřejné certifikáty. |
> | Akce | Microsoft. Web/Sites/publiccertificates/Read | Získat Web Apps veřejné certifikáty. |
> | Akce | Microsoft. Web/weby/publiccertificates/Write | Aktualizujte Web Apps veřejné certifikáty. |
...
> | Akce | Microsoft. Web/weby/číst | Získat vlastnosti webové aplikace |
...
> | Akce | Microsoft. Web/Sites/Recovery/Action | Obnovit Web Apps. |
> | Akce | Microsoft. Web/weby/resetSlotConfig/Action | Resetovat konfiguraci webové aplikace |
...
> | Akce | Microsoft. Web/weby/restorefrombackupblob/Action | Obnovte webovou aplikaci z objektu BLOB zálohy. |
> | Akce | Microsoft. Web/weby/restorefromdeletedapp/Action | Obnovit Web Apps z odstraněné aplikace |
> | Akce | Microsoft. Web/weby/restoresnapshot/Action | Obnovte snímky Web Apps. |
> | Akce | Microsoft. Web/weby/siteextensions/DELETE | Odstraní Web Apps rozšíření webů. |
> | Akce | Microsoft. Web/Sites/siteextensions/Read | Získá Web Apps rozšíření webů. |
> | Akce | Microsoft. Web/weby/siteextensions/Write | Aktualizuje rozšíření Web Apps lokality. |
> | Akce | Microsoft. Web/weby/sloty/analyzecustomhostname/Read | Získat Web Apps sloty analyzují vlastní název hostitele. |
> | Akce | Microsoft. Web/weby/sloty/applySlotConfig/Action | Použijte konfiguraci slotu webové aplikace z cílového slotu na aktuální slot. |
> | Akce | Microsoft. Web/weby/sloty/zálohování/akce | Vytvořte novou zálohu slotu webové aplikace. |
> | Akce | Microsoft. Web/weby/sloty/zálohování/čtení | Získat zálohu pro Web Apps sloty. |
> | Akce | Microsoft. Web/weby/sloty/zálohování/zápis | Aktualizuje zálohu Web Appsch slotů. |
> | Akce | Microsoft. Web/weby/sloty/zálohy/akce | Objevte zálohy Web Appsch slotů. |
> | Akce | Microsoft. Web/weby/sloty/zálohy/odstranění | Odstraňte zálohy Web Appsch slotů. |
> | Akce | Microsoft. Web/weby/sloty/zálohy/seznam/akce | Vypíše zálohy Web Appsch slotů. |
...
> | Akce | Microsoft. Web/weby/sloty/config/DELETE | Odstraní konfiguraci Web Apps slotů. |
...
> | Akce | Microsoft. Web/weby/sloty/config/číst | Získat konfigurační nastavení slotu webové aplikace |
> | Akce | Microsoft. Web/weby/sloty/config/Write | Aktualizovat konfigurační nastavení slotu webové aplikace |
> | Akce | Microsoft. Web/weby/sloty/containerlogs/Action | Získejte protokoly kontejneru zip pro slot webové aplikace. |
> | Akce | Microsoft. Web/weby/sloty/containerlogs/stáhnout/akce | Stáhnout protokoly kontejneru Web Apps slotů. |
> | Akce | Microsoft. Web/weby/sloty/continuouswebjobs/DELETE | Odstranění Web Appsch slotů nepřetržité webové úlohy. |
> | Akce | Microsoft. Web/weby/sloty/continuouswebjobs/Read | Získejte průběžné webové úlohy pro Web Apps sloty. |
> | Akce | Microsoft. Web/weby/sloty/continuouswebjobs/Start/Action | Spustí Web Apps sloty nepřetržité webové úlohy. |
> | Akce | Microsoft. Web/weby/sloty/continuouswebjobs/stop/Action | Zastavení Web Appsch slotů nepřetržité webové úlohy. |
> | Akce | Microsoft. Web/weby/sloty/odstranit | Odstranit existující slot webové aplikace |
> | Akce | Microsoft. Web/weby/sloty/nasazení/odstranit | Odstraňte nasazení Web Apps slotů. |
> | Akce | Microsoft. Web/weby/sloty/nasazení/protokolovat/číst | Načte protokol nasazení Web Apps slotů. |
> | Akce | Microsoft. Web/weby/sloty/nasazení/čtení | Získejte nasazení Web Apps slotů. |
> | Akce | Microsoft. Web/weby/sloty/nasazení/zápis | Aktualizujte nasazení Web Apps slotů. |
> | Akce | Microsoft. Web/weby/sloty/detektory/čtení | Získat Web Apps detektory slotů |
...
> | Akce | Microsoft. Web/weby/sloty/Diagnostika/aspnetcore/Read | Získat diagnostiku Web Apps slotů pro aplikaci ASP.NET Core. |
> | Akce | Microsoft. Web/weby/sloty/Diagnostika/autoretušovací/číst | Získat diagnostiku Web Apps sloty pro autoretušování. |
> | Akce | Microsoft. Web/weby/sloty/Diagnostika/nasazení/čtení | Získá nasazení diagnostiky Web Apps slotů. |
> | Akce | Microsoft. Web/weby/sloty/Diagnostika/nasazení/čtení | Získejte nasazení diagnostiky Web Apps slotů. |
> | Akce | Microsoft. Web/weby/sloty/Diagnostika/detektory/spuštění/akce | Spusťte detektor diagnostiky Web Apps slotů. |
> | Akce | Microsoft. Web/weby/sloty/Diagnostika/detektory/čtení | Získá detektor diagnostiky Web Apps slotů. |
> | Akce | Microsoft. Web/weby/sloty/Diagnostika/frebanalysis/Read | Získejte diagnostiku Web Apps FREBch slotů. |
> | Akce | Microsoft. Web/weby/sloty/Diagnostika/loganalyzer/Read | Získejte analyzátor protokolů diagnostiky Web Apps slotů. |
> | Akce | Microsoft. Web/weby/sloty/Diagnostika/číst | Získat diagnostiku Web Apps slotů. |
> | Akce | Microsoft. Web/weby/sloty/Diagnostika/runtimeavailability/Read | Získat dostupnost běhového prostředí diagnostiky Web Apps slotů |
> | Akce | Microsoft. Web/weby/sloty/Diagnostika/servicehealth/Read | Získat Service Health diagnostiky Web Apps slotů. |
> | Akce | Microsoft. Web/weby/sloty/Diagnostika/sitecpuanalysis/Read | Získat analýzu procesoru serveru diagnostiky Web Apps slotů. |
> | Akce | Microsoft. Web/weby/sloty/Diagnostika/sitecrashes/Read | Získat selhání lokality diagnostiky Web Apps slotů. |
> | Akce | Microsoft. Web/weby/sloty/Diagnostika/sitelatency/Read | Získejte latenci serveru diagnostiky Web Apps slotů. |
> | Akce | Microsoft. Web/weby/sloty/Diagnostika/sitememoryanalysis/Read | Získat analýzu paměti pro diagnostiku Web Apps slotů |
> | Akce | Microsoft. Web/weby/sloty/Diagnostika/siterestartsettingupdate/Read | Získat aktualizaci nastavení pro spuštění webu diagnostiky Web Apps slotů |
> | Akce | Microsoft. Web/weby/sloty/Diagnostika/siterestartuserinitiated/Read | Vyvolala se inicializace uživatele na webu získat diagnostiku Web Apps slotů. |
> | Akce | Microsoft. Web/weby/sloty/Diagnostika/siteswap/Read | Získat lokalitu diagnostiky Web Apps slotů |
> | Akce | Microsoft. Web/weby/sloty/Diagnostika/ThreadCount/Read | Získá počet vláken diagnostiky Web Apps slotů. |
> | Akce | Microsoft. Web/weby/sloty/Diagnostika/workeravailability/Read | Získejte diagnostiku Web Apps slotů Workeravailability. |
> | Akce | Microsoft. Web/weby/sloty/Diagnostika/workerprocessrecycle/Read | Získejte recyklaci pracovního procesu diagnostiky Web Apps slotů. |
> | Akce | Microsoft. Web/weby/sloty/domainownershipidentifiers/Read | Získá identifikátory vlastnictví domény Web Apps slotů. |
> | Akce | Microsoft. Web/weby/sloty/funkce/listsecrets/Action | Výpis tajných klíčů Web Appsch funkcí slotů. |
> | Akce | Microsoft. Web/weby/sloty/funkce/číst | Získejte funkce pro Web Apps sloty. |
> | Akce | Microsoft. Web/weby/sloty/hostnamebindings/DELETE | Odstraní vazby názvů hostitelů Web Apps slotů. |
> | Akce | Microsoft. Web/weby/sloty/hostnamebindings/Read | Získejte vazby názvů hostitelů Web Apps slotů. |
> | Akce | Microsoft. Web/weby/sloty/hostnamebindings/Write | Aktualizujte vazby Web Apps slotů názvů hostitelů. |
> | Akce | Microsoft. Web/weby/sloty/hybridconnection/DELETE | Odstraní hybridní připojení Web Apps slotů. |
> | Akce | Microsoft. Web/weby/sloty/hybridconnection/Read | Získejte hybridní připojení k Web Apps sloty. |
> | Akce | Microsoft. Web/weby/sloty/hybridconnection/Write | Aktualizuje hybridní připojení Web Appsových slotů. |
> | Akce | Microsoft. Web/weby/sloty/hybridconnectionnamespaces/Relay/DELETE | Slouží k odstranění přenosných oborů názvů hybridního připojení Web Apps slotů. |
> | Akce | Microsoft. Web/weby/sloty/hybridconnectionnamespaces/Relay/Write | Aktualizuje přenos oborů názvů Hybrid Connection Web Apps slotů. |
> | Akce | Microsoft. Web/weby/sloty/hybridconnectionrelays/Read | Získá přenosy hybridního připojení pro Web Apps sloty. |
> | Akce | Microsoft. Web/weby/sloty/instance/nasazení/čtení | Získá nasazení instancí Web Apps slotů. |
> | Akce | Microsoft. Web/weby/sloty/instance/procesy/odstranit | Odstraní procesy instancí Web Appsových slotů. |
> | Akce | Microsoft. Web/weby/sloty/instance/procesy/číst | Získá procesy instancí Web Apps slotů. |
> | Akce | Microsoft. Web/weby/sloty/instance/číst | Získá instance Web Apps slotů. |
> | Akce | Microsoft. Web/weby/sloty/metricdefinitions/Read | Získá definice metriky pro Web Apps sloty. |
> | Akce | Microsoft. Web/weby/sloty/metriky/čtení | Získá metriky Web Apps slotů. |
> | Akce | Microsoft. Web/weby/sloty/migratemysql/Read | Získejte Web Apps sloty pro migraci MySql. |
> | Akce | Microsoft. Web/weby/sloty/networktrace/Action | Síťové trasování Web Apps sloty. |
> | Akce | Microsoft. Web/Sites/sloty/networktraces/operationresults/Read | Získat výsledky operace trasování sítě Web Appsových slotů |
> | Akce | Microsoft. Web/weby/sloty/nové_heslo/Action | Nové_heslo Web Apps sloty. |
> | Akce | Microsoft. Web/weby/sloty/operationresults/Read | Načte výsledky operace Web Apps sloty. |
> | Akce | Microsoft. Web/weby/sloty/operace/číst | Získá operace Web Apps slotů. |
> | Akce | Microsoft. Web/weby/sloty/perfcounters/Read | Získá čítače výkonu pro Web Apps sloty. |
> | Akce | Microsoft. Web/weby/sloty/phplogging/Read | Získejte Web Apps sloty Phplogging. |
> | Akce | Microsoft. Web/weby/sloty/premieraddons/DELETE | Odstraňte doplňky Web Apps sloty Premier. |
> | Akce | Microsoft. Web/weby/sloty/premieraddons/Read | Získejte doplňky pro Web Apps sloty Premier. |
> | Akce | Microsoft. Web/weby/sloty/premieraddons/Write | Aktualizace Web Apps slotů Premier Doplňky |
> | Akce | Microsoft. Web/weby/sloty/procesy/číst | Získá procesy Web Apps slotů. |
> | Akce | Microsoft. Web/weby/sloty/publiccertificates/DELETE | Odstranit veřejné certifikáty pro Web Apps sloty |
> | Akce | Microsoft. Web/weby/sloty/publiccertificates/Read | Získejte veřejné certifikáty pro Web Apps sloty. |
> | Akce | Microsoft. Web/weby/sloty/publiccertificates/Write | Vytvořte nebo aktualizujte veřejné certifikáty pro Web Apps sloty. |
...
> | Akce | Microsoft. Web/weby/sloty/obnovení/akce | Obnovte Web Apps sloty. |
> | Akce | Microsoft. Web/weby/sloty/resetSlotConfig/Action | Resetovat konfiguraci slotu webové aplikace |
> | Akce | Microsoft. Web/weby/sloty/resourcehealthmetadata/Read | Získá Resource Health metadata Web Apps sloty. |
> | Akce | Microsoft. Web/weby/sloty/restartovat/akce | Restartovat slot webové aplikace |
> | Akce | Microsoft. Web/weby/sloty/obnovit/číst | Získat Web Apps obnovení slotů. |
> | Akce | Microsoft. Web/weby/sloty/obnovení/zápis | Obnovte Web Apps sloty. |
> | Akce | Microsoft. Web/weby/sloty/restorefrombackupblob/Action | Obnovte Web Apps slot z objektu BLOB zálohy. |
...
> | Akce | Microsoft. Web/weby/sloty/siteextensions/DELETE | Odstraní rozšíření lokality Web Appsho slotu. |
> | Akce | Microsoft. Web/weby/sloty/siteextensions/Read | Získá rozšíření lokality pro Web Apps sloty. |
> | Akce | Microsoft. Web/weby/sloty/siteextensions/Write | Aktualizuje rozšíření lokality Web Appsho slotu. |
...
> | Akce | Microsoft. Web/weby/sloty/snímky/číst | Získá snímky Web Apps sloty. |
> | Akce | Microsoft. Web/weby/sloty/sourcecontrols/DELETE | Odstranit nastavení konfigurace správy zdrojového kódu v pozici webové aplikace |
...
> | Akce | Microsoft. Web/weby/sloty/synchronizace/akce | Synchronizuje Web Apps sloty. |
> | Akce | Microsoft. Web/weby/sloty/triggeredwebjobs/DELETE | Odstraní Web Apps sloty aktivované WebJobs. |
> | Akce | Microsoft. Web/weby/sloty/triggeredwebjobs/Read | Získejte Web Apps sloty aktivované WebJobs. |
> | Akce | Microsoft. Web/weby/sloty/triggeredwebjobs/Run/Action | Spusťte Web Apps sloty aktivované WebJobs. |
> | Akce | Microsoft. Web/weby/sloty/použití/čtení | Získat Web Apps využití slotů. |
> | Akce | Microsoft. Web/weby/sloty/virtualnetworkconnections/DELETE | Odstraní Web Apps sloty Virtual Network připojení. |
> | Akce | Microsoft. Web/weby/sloty/virtualnetworkconnections/brány/zapisovat | Aktualizujte Web Apps sloty Virtual Network připojení brány. |
> | Akce | Microsoft. Web/weby/sloty/virtualnetworkconnections/Read | Získat Virtual Network připojení Web Apps sloty. |
> | Akce | Microsoft. Web/weby/sloty/virtualnetworkconnections/Write | Aktualizační sloty Web Apps Virtual Network připojení. |
> | Akce | Microsoft. Web/weby/sloty/WebJobs/číst | Získejte WebJobs pro Web Apps sloty. |
...
> | Akce | Microsoft. Web/weby/snímky/číst | Získat Web Apps snímky. |
> | Akce | Microsoft. Web/weby/sourcecontrols/DELETE | Odstranit konfigurační nastavení správy zdrojů webové aplikace |
...
> | Akce | Microsoft. Web/lokality/Sync/Action | Synchronizace Web Apps. |
> | Akce | Microsoft. Web/weby/syncfunctiontriggers/Action | Aktivační události funkce synchronizace. |
> | Akce | Microsoft. Web/weby/triggeredwebjobs/DELETE | Odstraní Web Apps aktivované webové úlohy. |
...
> | Akce | Microsoft. Web/weby/triggeredwebjobs/Run/Action | Spusťte Web Apps aktivované webové úlohy. |
> | Akce | Microsoft. Web/weby/používání/čtení | Získat Web Apps využití. |
> | Akce | Microsoft. Web/weby/virtualnetworkconnections/DELETE | Odstraní připojení Web Apps Virtual Network. |
> | Akce | Microsoft. Web/weby/virtualnetworkconnections/Gateway/číst | Získá Web Apps Virtual Network připojení brány. |
> | Akce | Microsoft. Web/weby/virtualnetworkconnections/Gateway/Write | Aktualizuje brány Web Apps Virtual Network připojení. |
> | Akce | Microsoft. Web/Sites/virtualnetworkconnections/Read | Získá Web Apps Virtual Network připojení. |
> | Akce | Microsoft. Web/weby/virtualnetworkconnections/Write | Aktualizace Web Apps Virtual Network připojení. |
> | Akce | Microsoft. Web/weby/WebJobs/číst | Získat Web Apps WebJobs. |
> | Akce | Microsoft. Web/weby/zápis | Vytvořte novou webovou aplikaci nebo aktualizujte některou z existujících. |
...
> | Akce | Microsoft. Web/zrušit registraci/akce | Zrušte registraci poskytovatele prostředků Microsoft. Web pro předplatné. |
...
> | Akce | Microsoft. monitor zátěže byl/notificationSettings/Write | Konfigurovat nastavení oznámení pro prostředek |

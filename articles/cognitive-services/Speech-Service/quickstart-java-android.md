---
title: 'Rychlý start: Rozpoznávání řeči v Javě na Androidu s využitím sady Cognitive Services Speech SDK'
titleSuffix: Microsoft Cognitive Services
description: Naučte se rozpoznávat řeč v Javě na Androidu s využitím sady Cognitive Services Speech SDK.
...
Tato aplikace je založená na balíčku Maven sady Microsoft Cognitive Services Speech SDK verze 1.0.0 a Android Studiu 3.1.
...
1. V okně, které se zobrazí, zadejte název a verzi naší sady Speech SDK pro Android – `com.microsoft.cognitiveservices.speech:client-sdk:1.0.0`. Pak vyberte **OK**.
...
1. Otevřete zdrojový soubor `MainActivity.java`. Nahraďte všechen kód za příkazem `package` následujícím kódem.

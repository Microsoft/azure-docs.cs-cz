...
6. Pokud byl server VMM v odpojeném stavu, Stáhněte a spusťte níže uvedený skript pro vyčištění na serveru VMM. Otevřete PowerShell pomocí možnosti **Spustit jako správce** a změňte zásady spouštění pro výchozí obor (LocalMachine). Ve skriptu zadejte ID serveru VMM, který chcete odebrat. Skript odebere ze serveru informace o párování registrace a cloudu.

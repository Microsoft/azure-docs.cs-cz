...
- `<application-ID-URI>` – Identifikátor URI identifikátoru aplikace, který jste nastavili v části **zveřejňuje okno rozhraní API** klientské aplikace.
- `<scope-name>` – Název oboru, který jste přidali v části, **zpřístupňuje okno rozhraní API** klientské aplikace.

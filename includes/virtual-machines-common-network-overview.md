...
| [Azure CLI](../articles/virtual-network/quick-create-cli.md) | Podsíť a virtuální síť se vytvoří ve stejnou dobu. Pro **az network vnet create** zadejte parametr [--subnet-name](https://docs.microsoft.com/cli/azure/network/vnet) s názvem podsítě. |

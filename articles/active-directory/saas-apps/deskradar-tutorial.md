...
V této části vytvoříte uživatele s názvem B. Simon v Deskradar. Pokud chcete přidat uživatele na platformě Deskradar, pracujte s [týmem podpory klienta Deskradar](mailto:support@deskradar.com) . Uživatelé musí vytvořit a aktivovat, než použití jednotného přihlašování.

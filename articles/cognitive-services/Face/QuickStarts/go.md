...
Je nutné aktualizovat `subscriptionKey` hodnotu pomocí vašeho klíče předplatného a `uriBase` změnit řetězec tak, aby obsahoval správný řetězec koncového bodu.

...
| Alert type | Smlouva Enterprise | Smlouva se zákazníkem Microsoftu | Web direct/Pay-As-You-Go |
|---|---|---|---|
| Budget | ✔ | ✔ | ✔ |
| Credit | ✔ |✘ | ✘ |
...
When you view the details of a dismissed alert, you can reactivate it if manual action is needed. Příklad ukazuje následující obrázek.

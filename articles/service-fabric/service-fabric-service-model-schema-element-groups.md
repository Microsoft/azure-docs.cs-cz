---
title: Azure Service Fabric service model XML schématu prvek skupiny | Dokumentace Microsoftu
description: Popisuje skupiny element ve schématu XML z modelu služby Service Fabric.
...
## <a name="partitiondescriptiongroup-group"></a>PartitionDescriptionGroup skupiny
Definuje schéma rozdělení oddílů pro službu.
...
## <a name="scalingpolicymechanismgroup-group"></a>ScalingPolicyMechanismGroup skupiny
...
## <a name="scalingpolicytriggergroup-group"></a>ScalingPolicyTriggerGroup skupiny
Definuje škálování aktivační událost.

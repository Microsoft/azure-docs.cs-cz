...
V tomto kurzu se dozvíte jako tvůrce, jak použít šablonu zařízení brány k definování zařízení brány v IoT Central aplikaci. Potom nakonfigurujete několik podřízených zařízení, která se připojují k vaší IoT Central aplikaci prostřednictvím zařízení brány. 
...
1. Vyberte **+** pro přidání rozhraní.  Vyberte standardní rozhraní **informace o zařízení** .

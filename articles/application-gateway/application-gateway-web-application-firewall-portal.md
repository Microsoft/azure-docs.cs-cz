---
title: Kurz – vytvoření aplikační brány s firewallem webových aplikací – Azure Portal | Microsoft Docs
...
Pokud budete chtít, můžete tento kurz dokončit pomocí [Azure PowerShell](tutorial-restrict-web-traffic-powershell.md) nebo [Azure CLI](tutorial-restrict-web-traffic-cli.md).
...
1. Na kartě **základy** zadejte tyto hodnoty pro následující nastavení služby Application Gateway:
   ...
   - **Úroveň**: vyberte **WAF v2**
     ...
     ![Vytvořit novou aplikační bránu: Základní informace](./media/application-gateway-web-application-firewall-portal/application-gateway-create-basics.png)
...
1. Na stránce s přehledem vyhledejte veřejnou IP adresu pro aplikační  bránu. ![Záznam veřejné IP adresy aplikační brány](./media/application-gateway-create-gateway-portal/application-gateway-record-ag-address.png) 

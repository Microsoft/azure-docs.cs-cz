...
1.  Pokud chcete načíst potřebný **tajný token** , kontaktujte tým podpory Miro na support@miro.com. Tato hodnota se zadá do pole token tajného kódu na kartě zřizování vaší aplikace Miro ve Azure Portal.
...
5. V části **přihlašovací údaje správce** zadejte `https://miro.com/api/v1/scim` na **adrese URL tenanta**. Zadejte hodnotu **SCIM tokenu ověřování** získanou dříve v **tajném tokenu**. Klikněte na **Test připojení** a ujistěte se, že se služba Azure AD může připojit k Miro. Pokud se připojení nepovede, ujistěte se, že má váš účet Miro oprávnění správce, a zkuste to znovu.

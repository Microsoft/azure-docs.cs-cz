...
Vzhledem k tomu, že absolutní cesta ke stažení se může v průběhu času lišit, je lepší vyjádřit souhlas s relativními cestami skriptů a souborů v řetězci `commandToExecute`, kdykoli je to možné. Například:

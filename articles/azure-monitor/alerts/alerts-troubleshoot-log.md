...
![Časové období](media/alerts-troubleshoot-log/LogAlertTimePeriod.png)
...
![Potlačit výstrahy](media/alerts-troubleshoot-log/LogAlertSuppress.png)
...
![Dotaz, který se má provést](media/alerts-troubleshoot-log/LogAlertPreview.png)
...
- [Dotaz se nezdařil](https://dev.loganalytics.io/documentation/Using-the-API/Errors) z těchto důvodů:
    ...
    - [Vlastní tabulky protokolů](../agents/data-sources-custom-logs.md) ještě nejsou vytvořené, protože tok dat se nespustil.

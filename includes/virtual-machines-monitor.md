...
Aby bylo možné detekovat a pomáhat diagnostikovat problémy s výkonem a stavem v hostovaném operačním systému, jsou komponenty webové aplikace založené na technologii .NET nebo Java spuštěné ve virtuálním počítači, Azure Monitor zajišťuje centralizované monitorování s využitím komplexních funkcí, jako jsou Azure Monitor pro virtuální počítače a Application Insights

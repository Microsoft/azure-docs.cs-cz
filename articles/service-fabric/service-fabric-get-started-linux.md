...
Kroky v tomto článku předpokládají, že provádíte nativní instalaci v Linuxu nebo používáte image kontejneru Service Fabric OneBox `mcr.microsoft.com/service-fabric/onebox:latest`.

...
ms.locfileid: "102109163"
---
|Jazyk                                 |verze         |2.x| 3.x |
|-----------------------------------------|------------|---| --- |
|[C#](../articles/azure-functions/functions-reference-csharp.md)|GA (.NET Framework 4,7)|GA (.NET Core 2,2)| GA (.NET Core 3,1)<br/>[Verze Preview (.NET 5,0)](../articles/azure-functions/dotnet-isolated-process-guide.md) |

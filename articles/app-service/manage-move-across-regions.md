...
2. Pokud používáte vlastní doménu, [navažte ji bez přerušení na cílovou aplikaci](manage-custom-dns-migrate-domain.md#bind-the-domain-name-preemptively) s `awverify.` a [Povolte doménu v cílové aplikaci](manage-custom-dns-migrate-domain.md#enable-the-domain-for-your-app).

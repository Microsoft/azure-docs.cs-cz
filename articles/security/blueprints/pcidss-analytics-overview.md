---
title: Podrobný plán zabezpečení a dodržování předpisů Azure – analýza dat pro PCI DSS
description: Podrobný plán zabezpečení a dodržování předpisů Azure – analýza dat pro PCI DSS
services: security
author: meladie
...
ms.locfileid: "73496406"
---
# <a name="azure-security-and-compliance-blueprint-analytics-for-pci-dss"></a>Podrobný plán zabezpečení a dodržování předpisů Azure: analýza pro PCI DSS

## <a name="overview"></a>Přehled

Tato Podrobný plán zabezpečení a dodržování předpisů Azure poskytuje pokyny pro nasazení architektury analýzy dat v Azure, která pomáhá s požadavky standardů zabezpečení dat v odvětví platebních karet (PCI DSS 3,2). Prezentuje společnou referenční architekturu a předvádí správné zpracování dat kreditních karet (včetně čísla karty, vypršení platnosti a ověřovacích dat) v zabezpečeném a kompatibilním prostředí s více vrstvami. Tento podrobný plán znázorňuje způsoby, kterými můžou zákazníci splnit konkrétní požadavky na zabezpečení a dodržování předpisů a slouží jako základ pro zákazníky k vytváření a konfiguraci vlastních řešení pro analýzu dat v Azure.
...
![Analýza diagramu referenční architektury PCI DSS](images/pcidss-analytics-architecture.png "Analýza diagramu referenční architektury PCI DSS")
...
Diagram toku dat pro tuto referenční architekturu je k dispozici ke [stažení](https://aka.ms/PCIAnalyticsTM) nebo najdete níže. Tento model může zákazníkům usnadnit pochopení bodů potenciálního rizika v systémové infrastruktuře při provádění úprav.

![Analýza diagramu referenční architektury PCI DSS](images/pcidss-analytics-threat-model.png "Analýza pro model PCI DSS Threat")

## <a name="compliance-documentation"></a>Dokumentace k dodržování předpisů
V [matici podrobný plán zabezpečení a dodržování předpisů Azure-PCI DSS zodpovědnosti zákazníka](https://aka.ms/pcidss-analytics-tm) najdete seznam povinností pro všechny požadavky PCI DSS 3,2.

[Matice podrobný plán zabezpečení a dodržování předpisů Azure-PCI DSS data Analytics Implementation](https://aka.ms/pcidss-analytics-cim) obsahuje informace o tom, které požadavky PCI DSS 3,2 jsou řešeny architekturou analýzy dat, včetně podrobných popisů toho, jak implementace splňuje požadavky každého zahrnutého ovládacího prvku.

...
* [Důležité informace o sítích pro Azure AD Domain Services](network-considerations.md)
* [Začínáme s Azure AD Domain Services](create-instance.md)

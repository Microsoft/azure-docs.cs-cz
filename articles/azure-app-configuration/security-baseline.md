...
Tato základní hodnota zabezpečení se vztahuje na pokyny od [verze Azure Security test 2,0](../security/benchmarks/overview.md) na konfiguraci aplikací Azure. Srovnávací test zabezpečení Azure nabízí doporučení k zabezpečení cloudových řešení v Azure. Obsah se seskupuje pomocí **ovládacích prvků zabezpečení** , které definuje srovnávací test zabezpečení Azure, a souvisejících pokynů týkajících se konfigurace aplikací Azure. Neplatí **ovládací prvky** pro konfiguraci aplikací Azure.
...
*Další informace najdete v článku [srovnávací testy zabezpečení Azure: zálohování a obnovení](../security/benchmarks/security-controls-v2-backup-recovery.md).*

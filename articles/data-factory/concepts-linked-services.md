...
type | Typ propojené služby. Například: Azure Storage (úložiště dat) nebo AzureBatch (výpočetní). Viz popis pro typeProperties. | Ano |
...
Následující propojená služba je propojená služba Azure Storage. Všimněte si, že typ je nastavený na Azure Storage. Vlastnosti typu pro propojenou službu Azure Storage zahrnují připojovací řetězec. Služba Data Factory používá tento připojovací řetězec pro připojení k úložišti dat za běhu.

...
2. Use the settings as specified in the table.
    ...
    |Nastavení|Popis|
    |--------|------------|
    |**Prostředí**|Select the environment that the custom connector should be saved to. For more information, see [Environments overview](https://powerapps.microsoft.com/tutorials/environments-overview/).|
...
3. Klikněte na **OK**. The custom connector is now built and added to the environment you specified.
...
5. On the **Security** tab, if you are prompted to provide authentication details, enter the values appropriate for the authentication type. Klikněte na **Pokračovat**.

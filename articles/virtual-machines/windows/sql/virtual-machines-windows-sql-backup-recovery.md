...
Automatizované zálohování poskytuje službu Automatické zálohování pro edice SQL Server Standard a Enterprise běžící na virtuálním počítači s Windows v Azure. Tuto službu poskytuje [rozšíření agenta SQL Server IaaS](virtual-machines-windows-sql-server-agent-extension.md), které se automaticky instaluje do SQL Server imagí virtuálních počítačů s Windows v Azure Portal.
...
- **SQL Server 2014**: [Automatizované zálohování pro SQL Server 2014 Virtual Machines](virtual-machines-windows-sql-automated-backup.md)
...
- **Záloha s nulovou infrastrukturou**: Nemusíte spravovat záložní servery nebo umístění úložiště.
- **Měřítko**: Chraňte mnoho virtuálních počítačů SQL a tisíc databází.
...
- **Centrální správa a monitorování**: Centrálně Spravujte všechna vaše zálohování, včetně dalších úloh, které Azure Backup podporuje, z jednoho řídicího panelu v Azure.
...
- **Podpora pro SQL Always On**: Zjišťovat a chránit SQL Server konfiguraci vždycky na konfiguraci a dodržovat předvolbu zálohování skupiny dostupnosti zálohování
- **15 minut cíl bodu obnovení (RPO)** : Nakonfigurujte zálohování protokolu transakcí SQL až na 15 minut.
- **Obnovení bodu v čase**: Pomocí portálu můžete obnovit databáze k určitému bodu v čase, aniž byste museli ručně obnovit několik úplných, rozdílových a záložních záloh protokolu.
- **Konsolidovaná e-mailová upozornění pro chyby**: Nakonfigurujte konsolidovaná e-mailová oznámení pro všechny chyby.
...
## <a id="manual"></a>Ruční zálohování
...
Pro SQL Server běžící na virtuálních počítačích Azure můžete použít nativní techniky zálohování a obnovení pomocí připojených disků na virtuálním počítači pro cílové záložní soubory. Existuje ale omezení počtu disků, které můžete připojit k virtuálnímu počítači Azure, a to na základě [velikosti virtuálního počítače](../sizes.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json). Je také potřeba vzít v úvahu režii správy disků.
...
| Konfigurace zásad zálohování v Azure Portal | ![Ano](./media/virtual-machines-windows-sql-backup-recovery/yes.png) | ![Ano](./media/virtual-machines-windows-sql-backup-recovery/yes.png) |   |
| Obnovení databází v Azure Portal |   | ![Ano](./media/virtual-machines-windows-sql-backup-recovery/yes.png) |   |
...
| 15 minut cíl bodu obnovení (RPO) | ![Ano](./media/virtual-machines-windows-sql-backup-recovery/yes.png) | ![Ano](./media/virtual-machines-windows-sql-backup-recovery/yes.png) | ![Ano](./media/virtual-machines-windows-sql-backup-recovery/yes.png) |
| Zásady uchovávání krátkodobých záloh (dny) | ![Ano](./media/virtual-machines-windows-sql-backup-recovery/yes.png) | ![Ano](./media/virtual-machines-windows-sql-backup-recovery/yes.png) |   |
| Zásady uchovávání dlouhodobých záloh (měsíce, roky) |   | ![Ano](./media/virtual-machines-windows-sql-backup-recovery/yes.png) |   |
| Integrovaná podpora pro SQL Server Always On |   | ![Ano](./media/virtual-machines-windows-sql-backup-recovery/yes.png) |   |
| Zálohování do Azure Storage účtů | ![Ano](./media/virtual-machines-windows-sql-backup-recovery/yes.png)Automatické | ![Ano](./media/virtual-machines-windows-sql-backup-recovery/yes.png)Automatické | ![Ano](./media/virtual-machines-windows-sql-backup-recovery/yes.png)(spravované zákazníkem) |
| Správa úložiště a záložních souborů | | ![Ano](./media/virtual-machines-windows-sql-backup-recovery/yes.png) |  |
| Zálohování na připojené disky ve virtuálním počítači |   |   | ![Ano](./media/virtual-machines-windows-sql-backup-recovery/yes.png) |
| Sestavy centrálního zálohování s možností přizpůsobení |   | ![Ano](./media/virtual-machines-windows-sql-backup-recovery/yes.png) |   |
| Konsolidovaná e-mailová upozornění pro chyby |   | ![Ano](./media/virtual-machines-windows-sql-backup-recovery/yes.png) |   |
| Přizpůsobení monitorování na základě protokolů Azure Monitor |   | ![Ano](./media/virtual-machines-windows-sql-backup-recovery/yes.png) |   |
| Monitorování úloh zálohování pomocí skriptů SSMS nebo Transact-SQL | ![Ano](./media/virtual-machines-windows-sql-backup-recovery/yes.png) | ![Ano](./media/virtual-machines-windows-sql-backup-recovery/yes.png) | ![Ano](./media/virtual-machines-windows-sql-backup-recovery/yes.png) |
...
Pokud plánujete nasazení SQL Server na VIRTUÁLNÍm počítači Azure, najdete pokyny k zřizování v následující příručce: [Jak zřídit virtuální počítač s Windows SQL Server v Azure Portal](virtual-machines-windows-portal-sql-server-provision.md).

I když se zálohování a obnovení dá použít k migraci dat, existují potenciálně jednodušší cesty migrace dat, které můžete SQL Server na virtuálním počítači Azure. Úplnou diskusi o možnostech migrace a doporučeních najdete v tématu [migrace databáze do SQL Server na virtuálním počítači Azure](virtual-machines-windows-migrate-sql.md).

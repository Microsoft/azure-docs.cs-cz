...
- Naučte se [spravovat klíče účtu úložiště pomocí Key Vault a Azure CLI](key-vault-ovw-storage-keys.md) nebo [Azure PowerShell](key-vault-overview-storage-keys-powershell.md).

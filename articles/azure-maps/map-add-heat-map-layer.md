...
description: Postup přidání vrstvy Heat mapy do mapy JavaScriptu
author: rbrundritt
ms.author: richbrun
ms.date: 07/29/2019
ms.topic: conceptual
...
<iframe height="500" style="width: 100%;" scrolling="no" title="Konzistentní Heat mapa s přiblížením" src="//codepen.io/azuremaps/embed/OGyMZr/?height=500&theme-id=light&default-tab=js,result" frameborder="no" allowtransparency="true" allowfullscreen="true">

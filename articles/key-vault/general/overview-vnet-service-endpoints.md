...
|Azure SQL Database|[Transparentní šifrování dat s podporou Bring Your Own Key pro Azure SQL Database a Azure synapse Analytics](../../azure-sql/database/transparent-data-encryption-byok-overview.md).|
...
|Azure Synapse Analytics|[Šifrování dat pomocí klíčů spravovaných zákazníkem v Azure Key Vault](../../synapse-analytics/security/workspaces-encryption.md)|
...
|Azure Application Gateway |[Použití certifikátů Key Vault pro naslouchací procesy s povoleným protokolem HTTPS](../../application-gateway/key-vault-certs.md)

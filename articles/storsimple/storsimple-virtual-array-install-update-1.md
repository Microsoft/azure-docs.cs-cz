...
1. V místním webovém uživatelském rozhraní si přečtěte do části **údržba** > **aktualizace softwaru**. Poznamenejte si verzi softwaru, kterou používáte. **Pokračujte v této aktualizaci pouze v případě, že používáte aktualizaci 0,6 (10.0.10293.0). Pokud používáte starší verzi, nainstalujte nejdřív na zařízení [aktualizaci 0,6](storsimple-virtual-array-install-update-06.md) a pak použijte Update 1.**
...
5. Po dokončení restartování přejdete na **přihlašovací** stránku. Pokud chcete ověřit, že se software zařízení aktualizoval, v místním webovém uživatelském rozhraní přejdete na **údržba** > **aktualizace softwaru**. Zobrazená verze softwaru by měla být **10.0.0.0.0.10296** pro aktualizaci 1,0.

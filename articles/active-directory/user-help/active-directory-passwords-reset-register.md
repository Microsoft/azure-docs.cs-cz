...
If you enter data for **Authentication Phone** or **Authentication Email**, it's not visible in the global directory. Tyto údaje se zobrazí jen vám a vašim správcům. Only you can see the answers to your security questions.
...
| Error case| What error do you see?| Řešení |
| --- | --- | --- |

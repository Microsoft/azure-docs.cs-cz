...
Po spuštění kontroly přístupu Azure AD automaticky pošle revidující, který zobrazí výzvu ke kontrole přístupu k e-mailu. Pokud uživatel e-mail neobdrželi, můžete jim poslat pokyny k [kontrolovat přístup](perform-access-review.md). 

...
7. Vyberte **Generovat mapy**.
 Zobrazí se potvrzovací zpráva s podrobnostmi o úloze.
  ...
  Pokud se problém nevyřeší, přečtěte si část [Poradce při potížích](troubleshoot-project-farmbeats.md) nebo se obraťte na [Fórum Azure FarmBeats, kde najdete podporu](https://aka.ms/FarmBeatsMSDN) k příslušným protokolům.

...
1. Na stránce **publikovat** Souhrn vyberte **publikovat**.
   ...
   ![Souhrnná stránka sady Visual Studio pro publikování](./media/app-service-web-get-started-dotnet-framework/publish-summary-page-framework-vs2019.png)

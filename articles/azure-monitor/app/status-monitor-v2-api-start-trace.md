...
ms.locfileid: "67478989"
---
# <a name="status-monitor-v2-api-start-applicationinsightsmonitoringtrace-v031-alpha"></a>Rozhraní API v2 monitorování stavu: Start-ApplicationInsightsMonitoringTrace (v0.3.1 alfa)

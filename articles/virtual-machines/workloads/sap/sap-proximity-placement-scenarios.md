...
Předchozí příkaz nasadí virtuální počítač se systémem Windows. Po úspěšném nasazení tohoto virtuálního počítače se obor Datacenter skupiny umístění blízkosti definuje v oblasti Azure. Všechna následná nasazení virtuálních počítačů, která odkazují na skupinu umístění Proximity, jak je znázorněno v předchozím příkazu, se nasadí ve stejném datovém centru Azure, pokud je možné hostovat typ virtuálního počítače na hardwaru umístěném v tomto datovém centru a kapacita pro tento typ virtuálního počítače. k dispozici.

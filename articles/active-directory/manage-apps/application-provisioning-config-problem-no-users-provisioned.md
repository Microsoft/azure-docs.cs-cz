...
- Byl **nakonfigurován filtr oborů** . **který filtruje uživatele na základě hodnoty atributu**. Další informace o filtrech oborů najdete v tématu věnovaném [filtrům](define-conditional-rules-for-provisioning-user-accounts.md)rozsahu.

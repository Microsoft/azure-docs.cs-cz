...
description: Přečtěte si o PsExec, powershellových skriptech a dalších vzdálených nástrojích, které můžete použít k řešení problémů se vzdáleným virtuálním počítačem Azure bez použití RDP.

---
title: 'PowerShell: Import souboru BACPAC (Azure SQL Database)'
...
Tento ukázkový skript PowerShellu importuje databázi ze souboru BACPAC do databáze v SQL Database.  

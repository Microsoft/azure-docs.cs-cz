...
5. **[Vytvořit testovacího uživatele Concur](#create-concur-test-user)**  – Pokud chcete mít protějšek Britta Simon Concur, který je propojený s Azure AD reprezentace uživatele.

---
title: Ukázka kódu JSON pro Azure Policy – Vynucení vzoru match | Microsoft Docs
description: Tato ukázková zásada JSON vyžaduje, aby prostředky při vytváření názvů splňovaly vzor match.

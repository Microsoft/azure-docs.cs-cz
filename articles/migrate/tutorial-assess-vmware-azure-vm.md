---
title: Vyhodnoťte servery VMware pro migraci do virtuálních počítačů Azure v Azure Migrate
description: Přečtěte si, jak vyhodnotit servery VMware pro migraci na virtuální počítače Azure pomocí Azure Migrate.
author: rashi-ms
ms.author: rajosh
ms.manager: abhemraj
ms.topic: tutorial
...
V tomto článku se dozvíte, jak vyhodnotit zjištěné servery z prostředí VMware v přípravě na virtuální počítače Azure pomocí nástroje Azure Migrate: Discovery and Assessment Tool.

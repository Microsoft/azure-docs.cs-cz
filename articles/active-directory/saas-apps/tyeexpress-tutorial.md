...
1. Vyberte **Activar(Activate)** možnost **ne** k **SI(Yes)**. V **metadat zprostředkovatele Identity** textového pole vložte kód XML, který jste si stáhli z webu Azure portal metadat.

...
ms.locfileid: "49647200"
---
# <a name="quickstart-identify-language-from-text-with-the-translator-text-rest-api-go"></a>Rychlý start: Identifikace jazyka z textu pomocí rozhraní REST API služby Translator Text (Go)

...
- [Vytvoření Azure Database for PostgreSQL – Citus (škálování)](./quickstart-create-hyperscale-portal.md#create-an-azure-database-for-postgresql---hyperscale-citus)

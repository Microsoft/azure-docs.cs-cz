...
1. Vyberte **způsob přihlášení** a zadejte **e-mailovou** adresu nebo **uživatelské jméno** pro nového uživatele. Metoda přihlašování, kterou si vyberete, se musí shodovat s nastavením, které jste zadali pro poskytovatele identity *místního účtu* klienta Azure AD B2C (viz **Správa** > **zprostředkovatelů identity** ve vašem tenantovi Azure AD B2C).
...
V případě automatizovaných scénářů správy uživatelů, například migrace uživatelů z jiného zprostředkovatele identity do adresáře Azure AD B2C, přečtěte si téma [Azure AD B2C: Migrace uživatelů](active-directory-b2c-user-migration.md).

...
Aktuální dostupnosti oblast je publikována [tady](container-instances-region-availability.md#availability---general), a aktuální informace jsou k dispozici prostřednictvím [seznamu možnosti](/rest/api/container-instances/listcapabilities) rozhraní API. Pokud máte požadavek na konkrétní oblasti, obraťte se na podporu Azure.

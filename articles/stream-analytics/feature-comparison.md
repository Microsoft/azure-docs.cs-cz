...
|---------|---------|---------|---------|
|Různé platformy     |Počítač Mac</br>Linux</br>Windows         |Windows        |Počítač Mac</br>Linux</br>Windows          |
...
|Podpora CI/CD     |Částečně         |Ano         |Ano         |
...
|C#funkce vlastního kódu a deserializace|Režim jen pro čtení|Ano|Ne|
|JavaScript UDF a UDA     |Ano         |Ano         |Jen ve Windows         |
|Služba Machine Learning     |Ano, ale dotaz se nedá testovat.        |Ano         |Ne         |
...
|Zobrazit metriky úlohy a diagram     |Ano         |Částečně         |Ne         |
|Zobrazit chyby běhu úlohy     |Ano         |Částečně         |Ne         |

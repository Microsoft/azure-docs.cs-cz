...
4. Do vyhledávacího pole zadejte **Proxyclick**, vyberte **Proxyclick** z panelu výsledků klikněte **přidat** tlačítko Přidat aplikaci.
    ...
    ![Proxyclick v seznamu výsledků](./media/active-directory-saas-proxyclick-tutorial/tutorial_proxyclick_addfromgallery.png)
...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/active-directory-saas-proxyclick-tutorial/tutorial_proxyclick_samlbase.png)
...
3. Na **Proxyclick domény a adresy URL** část, proveďte následující kroky, pokud chcete nakonfigurovat aplikace **IDP** iniciované režimu:
    ...
    ![Proxyclick domény a adresy URL jednotné přihlašování informace](./media/active-directory-saas-proxyclick-tutorial/tutorial_proxyclick_url2.png)
...
4. Zkontrolujte **zobrazit upřesňující nastavení adresy URL** a provést následující krok, pokud chcete nakonfigurovat aplikace **SP** iniciované režimu:
    ...
    ![Proxyclick domény a adresy URL jednotné přihlašování informace](./media/active-directory-saas-proxyclick-tutorial/tutorial_proxyclick_url1.png)
...
5. Na **SAML podpisový certifikát** klikněte na tlačítko **Certificate(Base64)** a potom uložte soubor certifikátu v počítači.
    ...
    ![Odkaz ke stažení certifikátu](./media/active-directory-saas-proxyclick-tutorial/tutorial_proxyclick_certificate.png) 

6. Klikněte na tlačítko **Uložit** tlačítko.

    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/active-directory-saas-proxyclick-tutorial/tutorial_general_400.png)
...
7. Na **Proxyclick konfigurace** klikněte na tlačítko **konfigurace Proxyclick** otevřete **konfigurovat přihlášení** okno. Kopírování **SAML Entity ID a SAML jeden přihlašování adresu URL služby** z **Stručná referenční příručka části.**
    ...
    ![Konfigurace Proxyclick](./media/active-directory-saas-proxyclick-tutorial/tutorial_proxyclick_configure.png)

8. V okně prohlížeče jiný web Přihlaste se k serveru vaší společnosti Proxyclick jako správce.

9. Vyberte **účet & nastavení**.

    ![Konfigurace Proxyclick](./media/active-directory-saas-proxyclick-tutorial/configure1.png)

10. Přejděte dolů k položce **integrace** a vyberte **SAML**.

    ![Konfigurace Proxyclick](./media/active-directory-saas-proxyclick-tutorial/configure2.png)

11. V **SAML** část, proveďte následující kroky:

    ![Konfigurace Proxyclick](./media/active-directory-saas-proxyclick-tutorial/configure3.png)
...
1. Na portálu Azure, v levém podokně klikněte **Azure Active Directory** tlačítko.
    ...
    ![Tlačítko Azure Active Directory](./media/active-directory-saas-proxyclick-tutorial/create_aaduser_01.png)

2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.

    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/active-directory-saas-proxyclick-tutorial/create_aaduser_02.png)

3. Chcete-li otevřít **uživatele** dialogové okno, klikněte na tlačítko **přidat** v horní části **všichni uživatelé** dialogové okno.

    ![Tlačítko Přidat](./media/active-directory-saas-proxyclick-tutorial/create_aaduser_03.png)

4. V **uživatele** dialogové okno pole, proveďte následující kroky:

    ![Dialogové okno uživatele](./media/active-directory-saas-proxyclick-tutorial/create_aaduser_04.png)
...
2. Klikněte na tlačítko **kolegy** horním navigačním panelu.
    ...
    ![Můžete přidat zaměstnance](./media/active-directory-saas-proxyclick-tutorial/user1.png)

3. Klikněte na tlačítko **přidat kolegu**

    ![Můžete přidat zaměstnance](./media/active-directory-saas-proxyclick-tutorial/user2.png)

4. V **přidat kolegu o** část, proveďte následující kroky:

    ![Můžete přidat zaměstnance](./media/active-directory-saas-proxyclick-tutorial/user3.png)
...
2. V seznamu aplikací vyberte **Proxyclick**.
    ...
    ![V seznamu aplikací na Proxyclick odkaz](./media/active-directory-saas-proxyclick-tutorial/tutorial_proxyclick_app.png)  

---
title: Popisy schématu XML modelu služby Azure Service Fabric
description: Popis schématu XML modelu služby Service Fabric, včetně umístění a souhrnu komponent.
ms.topic: reference
ms.date: 12/10/2018
...
ms.locfileid: "75639186"
---
<!-- The schema reference articles were generated by the Python script found in the end of this file -->

# <a name="service-model-xml-schema-documentation"></a>Dokumentace ke schématu XML modelu služby
Tento článek popisuje soubor schématu ServiceFabricServiceModel. xsd nainstalovaný v sadě Service Fabric SDK.  Ve výchozím nastavení se soubor schématu nainstaluje do složky *C:\Program Files\Microsoft SDKs\Service Fabric\schemas\ServiceFabricServiceModel.xsd*.

## <a name="namespace-bindings"></a>Vazby oboru názvů

|Předvolba|Identifikátor URI oboru názvů|
|---|---|
|x|`https://www.w3.org/2001/XMLSchema`|

## <a name="component-summary"></a>Souhrn komponenty 
V ServiceFabricServiceModel. xsd jsou definovány následující komponenty:
- [257 elementy](service-fabric-service-model-schema-elements.md)
- [112 complexTypes](service-fabric-service-model-schema-complex-types.md)
- [1 simpleType](service-fabric-service-model-schema-simple-types.md)
- [3 skupiny prvků](service-fabric-service-model-schema-element-groups.md)
- [16 skupin atributů](service-fabric-service-model-schema-attribute-groups.md)

...
4. Jste připraveni k nasazení této šablony. Můžete použít buď PowerShell, nebo rozhraní příkazového řádku Azure CLI. Po zobrazení výzvy k zadání pracovního prostoru a názvu účtu Automation zadejte název, který bude globálně jedinečný v rámci všech předplatných Azure.
    ...
    **Azure CLI**
    ...
    ![Příklad výsledku po dokončení nasazení](media/update-mgmt-enable-template/template-output.png)
...
5. V levém podokně vyberte **Správa aktualizací**. Na stránce **Správa aktualizací** se zobrazí stránka posouzení bez jakýchkoli informací v důsledku pouhého povolení a počítače nejsou konfigurovány pro správu.
    ...
    ![Update Management zobrazení posouzení funkcí](./media/update-mgmt-enable-template/update-management-assessment-view.png)
...
* Pokud už nechcete používat Update Management a chcete ho odebrat, přečtěte si pokyny v části [odebrání Update Management funkce](update-mgmt-remove-feature.md).

* Postup odstranění virtuálních počítačů z Update Management najdete v tématu [Odebrání virtuálních počítačů z Update Management](update-mgmt-remove-vms.md).

...
3. Určete, jaká data se mají [mapovat mezi Azure AD a službou Adobe Identity Management](../app-provisioning/customize-application-attributes.md). 

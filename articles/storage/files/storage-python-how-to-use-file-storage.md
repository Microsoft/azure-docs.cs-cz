...
f Chcete-li zobrazit a spustit ukázkovou aplikaci, která ukazuje, jak používat Python se soubory [Azure, přečtěte si téma Azure Storage: Začínáme se soubory Azure v Pythonu](https://github.com/Azure-Samples/storage-file-python-getting-started). 
...
Chcete-li zobrazit seznam souborů a adresářů ve sdílené složce, použijte metodu **\_výpis\_adresářů\_a souborů** . Tato metoda vrací generátor. Následující kód vypíše **název** každého souboru a adresáře ve sdílené složce do konzoly.

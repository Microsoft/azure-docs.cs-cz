...
Následující vzorový ukázkový skript vytvoří pracovní prostor a nakonfiguruje více zdrojů dat. Tyto zdroje dat jsou požadovány pouze v případě, že provádíte monitorování virtuálních počítačů pomocí [agenta Log Analytics](../agents/log-analytics-agent.md).

...
```
 ...
 K vytvoření základní veřejné IP adresy použijte ```--sku basic```. Úroveň Basic nepodporuje zóny dostupnosti. Microsoft doporučuje pro produkční úlohy standardní SKU.

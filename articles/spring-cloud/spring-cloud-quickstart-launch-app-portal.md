...
V tomto rychlém startu se dozvíte, jak nasadit existující jarní cloudovou aplikaci do Azure. [Tady je odkaz](https://github.com/xscript/PiggyMetrics) na ukázkový kód aplikace použitý v tomto kurzu. Jakmile budete hotovi, bude poskytnutá ukázková aplikace dostupná online a bude připravená ji spravovat prostřednictvím Azure Portal.
...
1. Dokončení nasazování aplikací trvá několik minut. Pokud chcete potvrdit, že se nasadily, přečtěte si na **řídicím panelu aplikace** v Azure Portal. Mělo by se zobrazit řádek každé ze tří aplikací.

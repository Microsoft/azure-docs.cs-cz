...
Azure DevOps Project představuje zjednodušené prostředí, které pro vaši aplikaci v Java vytvoří prostředky Azure a nastaví kanál průběžné integrace (CI) a průběžného doručování (CD) v Azure DevOps Services.  

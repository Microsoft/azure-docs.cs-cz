...
:heavy_check_mark: Provést upgrade
...
| Operace s daty – protokoly  | Ano | Jednorázové žádosti o protokoly pro konkrétní dobu pomocí lístku podpory Azure Monitoring integrace | Jednorázové žádosti o protokoly pro konkrétní dobu trvání pomocí lístku podpory – *dostupné hned*<br><br> Integrace monitorování Azure – *zatím není k dispozici* |
...
Tato tabulka popisuje, které sady rozhraní API, které jsou dostupné pro vaše vlastní aplikace. Aby bylo jasné, že se jedná o bit, oddělíme tyto sady rozhraní API na 2 typy: rozhraní API pro správu a rozhraní API systému souborů.
...
| Sada .NET SDK – systém souborů                  | [Odkaz](https://docs.microsoft.com/dotnet/api/overview/azure/datalakestore/client?view=azure-dotnet)                                                                                                                                                                                                                     | *Zatím není k dispozici*                                                | *Zatím není k dispozici*                                                                                                                                             |
...
| Sada Java SDK – systém souborů                  | [Odkaz](https://docs.microsoft.com/java/api/overview/azure/datalake)                                                                                                                                                                                                                                         | *Zatím není k dispozici*                                                | *Zatím není k dispozici*                                                                                                                                             |
...
| REST API – systém souborů                  | [Odkaz](https://docs.microsoft.com/rest/api/datalakestore/webhdfs-filesystem-apis)                                                                                                                                                                                                                                       | *Teď k dispozici*                                                    | *Nyní je k dispozici –* [odkaz](https://docs.microsoft.com/rest/api/storageservices/data-lake-storage-gen2)                                                      |
| PowerShell – Správa a systém souborů | [Odkaz](https://docs.microsoft.com/powershell/module/az.datalakestore)                                                                                                                                                                                                                        | Správa – nepodporovaný systém souborů – *zatím není k dispozici*        | Správa – *nyní dostupný –* [odkaz](https://docs.microsoft.com/powershell/module/az.storage) <br><br>Systém souborů – *zatím není k dispozici* |
...
| CLI – systém souborů                       | [Odkaz](https://docs.microsoft.com/cli/azure/dls/fs?view=azure-cli-latest)                                                                                                                                                                                                                                               | *Zatím není k dispozici*                                                | *Zatím není k dispozici*                                                                                                                                             |
...
|                      | Modul Databricks Runtime verze 3.1 a vyšší                                                                                                                                               | [Databricks Runtime 5,1 a vyšší](https://docs.azuredatabricks.net/spark/latest/data-sources/azure/azure-datalake-gen2.html#azure-data-lake-storage-gen2) *– Nyní k dispozici* | [Databricks Runtime 5,1 a novější](https://docs.azuredatabricks.net/spark/latest/data-sources/azure/azure-datalake-gen2.html#azure-data-lake-storage-gen2) – *nyní k dispozici*                                                                                              |
|                      | [SQL Data Warehouse](https://docs.microsoft.com/azure/sql-data-warehouse/sql-data-warehouse-load-from-azure-data-lake-store)                                            | *Nepodporuje se*                                                                                                                                                              | *Nyní k dispozici* [Odkaz](https://docs.microsoft.com/sql/t-sql/statements/create-external-data-source-transact-sql?view=sql-server-2017) |
...
Hlavním úkolem je překládat identifikátor URI, který má předponu `adl://` do identifikátoru URI, který `abfss://` má předponu.
...
Pak prvky, které byly volány výše (například: Identifikátor URI a přihlašovací údaje), bude nutné změnit. Můžete změnit existující instanci, která funguje s Data Lake Storage Gen1 nebo můžete vytvořit novou instanci, která bude fungovat s Data Lake Storage Gen2.
...
Jakmile budete hotovi s operací přechodu závěrečné kroky budou zahrnovat důkladné ověření. To by zahrnovalo, ale nemělo by být omezené na ověření, že se data zkopírovala spolehlivě. ověření seznamů ACL se správně nastavilo a ověření koncových kanálů funguje správně atd. Po dokončení ověření můžete nyní vypnout staré kanály, odstranit vaše účty Data Lake Storage Gen1 zdroje a přejít na vaše řešení založená na Gen2 úložiště Data Lake plné rychlosti.

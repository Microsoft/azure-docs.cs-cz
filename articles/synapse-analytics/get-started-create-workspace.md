...
3. Karta **základy** v části **Project Details (podrobnosti projektu**) vyplňte následující pole:
...
4. Na kartě **základy** v části **Podrobnosti o pracovním prostoru** vyplňte následující pole:

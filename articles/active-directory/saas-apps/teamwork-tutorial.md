...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/teamwork-tutorial/tutorial_teamwork_samlbase.png)

3. Na **Teamwork.com domény a adresy URL** část, proveďte následující kroky:

    ![Teamwork.com domény a adresy URL jednotné přihlašování informace](./media/teamwork-tutorial/tutorial_teamwork_url.png)
...
5. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/teamwork-tutorial/tutorial_general_400.png)
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/teamwork-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **Teamwork.com**.
    ...
    ![V seznamu aplikací na Teamwork.com odkaz](./media/teamwork-tutorial/tutorial_teamwork_app.png)  

---
title: Výkon virtuálního počítače řady HC-Series – Azure Virtual Machines | Microsoft Docs
...
| Latence & šířky pásma RDMA                        | 1,80 mikrosekund, 96,3 GB/s   |
| FIO na místní disk SSD NVMe                           | čtení z ~ 1,3 GB/s, ~ 900 MB/s zápisy |  
| IOR na 4 Azure SSD úrovně Premium (P30 Managed Disks, RAID0) * *  | × 780 MB/s čtení, ~ 780 MB/zápisy |
...
| #bytes  | Latence [mikrosekunda] (MPICH 3,3 + CH4) | Latence [mikrosekunda] (OpenMPs 4.0.0) | Latence [mikrosekunda] (MVAPICH2 2,3) |
|------|----------|----------|----------|
| 2    | 1,84     | 1,78     | 2,08     |
| 4    | 1,84     | 1,79     | 2,08     |
| 8    | 1,85     | 1,79     | 2,05     |

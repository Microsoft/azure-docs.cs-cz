...
1. Stáhněte si kořenový certifikát Baltimore CyberTrust z umístění [https://cacert.omniroot.com/bc2025.crt](https://cacert.omniroot.com/bc2025.crt)v místním počítači. Přejmenujte soubor pomocí přípony souboru *. cer*.

   Certifikát má sériové číslo `02:00:00:b9` a otisk SHA1 `d4🇩🇪20:d0:5e:66:fc:53:fe:1a:50:88:2c:78:db:28:52:ca:e4:74`.

2. Otevřete *pyquickstart.py* a změňte `path\to\cert` směr tak, aby odkazoval na nový certifikát.

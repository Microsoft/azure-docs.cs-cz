...
4. Do vyhledávacího pole zadejte **Encompass**, vyberte **Encompass** z panelu výsledků klikněte **přidat** tlačítko Přidat aplikaci.
    ...
    ![Zahrnuje v seznamu výsledků](./media/encompass-tutorial/tutorial_encompass_addfromgallery.png)
...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/encompass-tutorial/tutorial_encompass_samlbase.png)

3. Na **zahrnovat domény a adresy URL** část, proveďte následující kroky:

    ![Zahrnuje adresy URL jeden přihlašování informace o doméně a](./media/encompass-tutorial/tutorial_encompass_url.png)
...
5. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/encompass-tutorial/tutorial_general_400.png)
...
6. Na **zahrnovat konfigurace** klikněte na tlačítko **konfigurace zahrnuje** otevřete **konfigurovat přihlášení** okno. Kopírování **Sign-Out adresu URL a SAML jeden přihlašování služby URL** z **Stručná referenční příručka části.**
    ...
    ![Zahrnuje konfigurace](./media/encompass-tutorial/tutorial_encompass_configure.png) 
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/encompass-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **Encompass**.
    ...
    ![V seznamu aplikací na Encompass odkaz](./media/encompass-tutorial/tutorial_encompass_app.png)  

...
- Získání odkazů na používání příloh prostřednictvím [sady Azure Cosmos DB .NET SDK v2](https://docs.microsoft.com/dotnet/api/microsoft.azure.documents.attachment?view=azure-dotnet)
- Získat odkazy na používání příloh prostřednictvím [Azure Cosmos DB Java SDK v2](https://docs.microsoft.com/java/api/com.microsoft.azure.documentdb.attachment?view=azure-java-stable)

...
- Je-li hodnota `options.hideConfirmation` nastavená na **hodnotu true**, je druhé textové pole pro potvrzení hesla uživatele skryté. Výchozí hodnota je **false (NEPRAVDA**).

...
1. V automaticky otevíraném okně zadejte **ID zařízení** jako `SampleDevKit` a **název zařízení** jako `MXChip IoT DevKit - Sample`. Ujistěte se, že je **simulovaná** možnost vypnutá. Potom vyberte **Vytvořit**.

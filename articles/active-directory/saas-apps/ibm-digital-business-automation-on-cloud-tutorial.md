...
Když na přístupovém panelu kliknete na dlaždici IBM Digital Business Automation on Cloud, měli byste být automaticky přihlášeni k automatizaci digitální firmy IBM v cloudu, pro kterou jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Jak chránit automatizaci digitální firmy IBM v cloudu s pokročilými viditelnostmi a ovládacími prvky](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)

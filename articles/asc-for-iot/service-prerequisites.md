...
Tento článek obsahuje vysvětlení různých stavebních bloků Azure Security Center pro službu IoT, co je potřeba začít, a vysvětluje základní koncepty, které vám pomůžou pochopit službu. 

...
* Čtecí modul artefaktů synapse
* Správce COMPUTE synapse
* Uživatel s přihlašovacími údaji synapse
* Správce spravovaného privátního koncového bodu synapse
* Čtecí zařízení synapse
...
Odpověď: v tuto chvíli musíte ručně znovu vytvořit kanály Azure Data Factory a související artefakty ručně. 

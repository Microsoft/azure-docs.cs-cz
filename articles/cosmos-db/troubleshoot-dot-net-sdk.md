...
### <a name="high-network-latency"></a>Vysoká latence sítě
...
Pokud nejsou k dispozici žádné [časové limity](#request-timeouts) a diagnostika zobrazí jednotlivé požadavky, u kterých je vysoká latence zřejmá na rozdíl mezi `ResponseTime` a `RequestStartTime`, například tak (> 300 milisekund v tomto příkladu):

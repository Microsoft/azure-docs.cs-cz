...
Z [Azure Portal](https://portal.azure.com)můžete koupit Azure Cosmos DB rezervovanou kapacitu. Za rezervaci se platí [předem nebo prostřednictvím měsíčních plateb](../billing/billing-monthly-payments-reservations.md). Pro nákup rezervované kapacity platí:

...
1. Do vyhledávacího pole zadejte **Nexonia**vyberte **Nexonia** z panelu výsledků klikněte **přidat** tlačítko pro přidání aplikace.
...
1. **[Vytvoření zkušebního uživatele Nexonia](#create-a-nexonia-test-user)**  – Pokud chcete mít protějšek Britta Simon Nexonia, který je propojený s Azure AD reprezentace uživatele.
...
1. Na **Nexonia domény a adresy URL** části, proveďte následující kroky:
...
1. V seznamu aplikací vyberte **Nexonia**.

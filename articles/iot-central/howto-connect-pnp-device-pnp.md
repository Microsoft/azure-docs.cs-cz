...
* Jako vývojář zařízení můžete použít Visual Studio Code k vytvoření zařízení [IoT technologie Plug and Play](../iot-pnp/overview-iot-plug-and-play.md) , které se připojuje k vaší IoT Central aplikaci.

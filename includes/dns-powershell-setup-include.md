...
Otevřete konzolu prostředí PowerShell a připojte se ke svému účtu. Další informace najdete v tématu [přihlášení](/powershell/azure/install-az-ps?view=azps-1.4.0#sign-in).

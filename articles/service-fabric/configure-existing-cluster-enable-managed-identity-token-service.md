...
ms.locfileid: "68964034"
---
# <a name="configure-an-existing-azure-service-fabric-cluster-to-enable-managed-identity-support"></a>Konfigurace stávajícího clusteru Azure Service Fabric pro povolení podpory spravovaných identit

...
| **Objekt blob** |Soubor libovolného typu a velikosti. Objekty blob jsou adresovatelné v následujícím formátu adresy URL: **https://[účet úložiště]. blob. Core. Windows. NET/[Container]/[BLOB]**. Další informace o objektech blob stránky najdete v tématu [Principy objektů blob bloku a stránky](/rest/api/storageservices/Understanding-Block-Blobs--Append-Blobs--and-Page-Blobs) . |

...
|  Name (Název) | Typ | Požaduje se | Hodnota |
|  ---- | ---- | ---- | ---- |
|  jméno | string | Ano | Uživatelem zadaný název instance kontejneru. |
...
|  Name (Název) | Typ | Požaduje se | Hodnota |
|  ---- | ---- | ---- | ---- |
|  server | string | Ano | Server registru Docker image bez protokolu, například http a HTTPS. |
|  uživatelské jméno | string | Ano | Uživatelské jméno privátního registru |
|  heslo | string | Ne | Heslo k privátnímu registru |
...
|  Tajný kód | object | Ne | Tajný svazek. |
...
|  Name (Název) | Typ | Požaduje se | Hodnota |
|  ---- | ---- | ---- | ---- |
|  id | string | Ano | Identifikátor síťového profilu. |
...
|  Name (Název) | Typ | Požaduje se | Hodnota |
|  ---- | ---- | ---- | ---- |
|  image | string | Ano | Název Image, která se použila k vytvoření instance kontejneru |
...
|  prostředky | object | Ano | Požadavky na prostředky pro instanci kontejneru. - [objekt ResourceRequirements](#ResourceRequirements) |
...
|  Name (Název) | Typ | Požaduje se | Hodnota |
|  ---- | ---- | ---- | ---- |
|  jméno | string | Ano | Název proměnné prostředí |
|  hodnota | string | Ne | Hodnota proměnné prostředí. |
|  secureValue | string | Ne | Hodnota proměnné prostředí zabezpečení |

...
* Všechny vlastní atributy uživatelů v Peakon musí být rozšířeny z vlastního uživatelského `urn:ietf:params:scim:schemas:extension:peakon:2.0:User`rozšíření SCIM uživatele Peakon.

---
title: Ukázka kódu JSON pro Azure Policy – Žádná tabulka směrování definovaná uživatelem | Microsoft Docs
description: Tato ukázková zásada JSON zakazuje nasazení virtuálních sítí s tabulkou směrování definovanou uživatelem.

...
| Google Analytics                    | Není k dispozici                         | [GitHub](https://github.com/Azure-Samples/media-services-javascript-azure-media-player-google-analytics-plugin)                     | Modul plug-in Google Analytics pro Azure Media Player |
| Diagnostika                         | | | |

...
Teď, když jste vytvořili potřebné podpůrné prostředky, zadejte parametry pro aplikační bránu pomocí [New-AzApplicationGatewaySku](/powershell/module/az.network/new-azapplicationgatewaysku). Zadejte konfiguraci WAF pomocí [New-AzApplicationGatewayWebApplicationFirewallConfiguration](/powershell/module/az.network/new-azapplicationgatewaywebapplicationfirewallconfiguration). A pak vytvořte službu application gateway s názvem *myAppGateway* pomocí [New-AzApplicationGateway](/powershell/module/az.network/new-azapplicationgateway).
...
Vytvoření účtu úložiště s názvem *myagstore1* pomocí [New-AzStorageAccount](/powershell/module/az.storage/new-azstorageaccount).
...
Konfigurovat diagnostiku při zaznamenávání dat do ApplicationGatewayAccessLog ApplicationGatewayPerformanceLog, a ApplicationGatewayFirewallLog protokolů pomocí [Set-AzDiagnosticSetting](/powershell/module/az.monitor/set-azdiagnosticsetting).
...
> [Vytvoření služby application gateway s ukončení protokolu SSL](./tutorial-ssl-powershell.md)

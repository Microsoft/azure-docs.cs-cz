...
Můžete zadat další argumenty pro tento příkaz pro přizpůsobení. Podívejte se na všechny argumenty pro [AZ MySQL flexibilní-Server Create](/cli/azure/mysql/flexible-server?view=azure-cli-latest#az_mysql_flexible_server_create).

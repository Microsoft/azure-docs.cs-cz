...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/edcor-tutorial/tutorial_edcor_samlbase.png)

3. Na **Edcor domény a adresy URL** část, proveďte následující kroky:

    ![Edcor domény a adresy URL jednotné přihlašování informace](./media/edcor-tutorial/tutorial_edcor_url1.png)
...
5. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/edcor-tutorial/tutorial_general_400.png)
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/edcor-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **Edcor**.
    ...
    ![V seznamu aplikací na Edcor odkaz](./media/edcor-tutorial/tutorial_edcor_app.png)  

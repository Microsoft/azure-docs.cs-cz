...
* Můžete povolit uživatelům být automaticky přihlášeni k Bime (Single Sign-On) s jejich účty Azure AD.
...
* Podporuje Bime **SP** jednotné přihlašování zahájené pomocí
...
4. Do vyhledávacího pole zadejte **Bime**vyberte **Bime** z panelu výsledků klikněte **přidat** tlačítko pro přidání aplikace.

     ![Bime v seznamu výsledků](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurace a otestování služby Azure AD jednotného přihlašování

V této části je konfigurace a testování Azure AD jednotné přihlašování pomocí Bime podle testovacího uživatele volá **Britta Simon**.
Pro jednotné přihlašování pro práci je potřeba navázat vztah odkazu mezi uživatele služby Azure AD a související uživatelské v Bime.
...
2. **[Konfigurace Bime Single Sign-On](#configure-bime-single-sign-on)**  – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
3. **[Vytvořit testovacího uživatele Azure AD](#create-an-azure-ad-test-user)**  – Pokud chcete otestovat Azure AD jednotné přihlašování s Britta Simon.
4. **[Přiřadit uživatele Azure AD](#assign-the-azure-ad-test-user)**  – Pokud chcete povolit Britta Simon používat Azure AD jednotného přihlašování.
5. **[Vytvořit testovacího uživatele Bime](#create-bime-test-user)**  – Pokud chcete mít protějšek Britta Simon Bime, který je propojený s Azure AD reprezentace uživatele.
...
1. V [webu Azure portal](https://portal.azure.com/)na **Bime** integrace stránce aplikace vyberte **jednotného přihlašování**.
...
4. Na **základní konfiguraci SAML** části, proveďte následující kroky:
    ...
    ![Bime domény a adresy URL jednotného přihlašování – informace](common/sp-identifier.png)

    a. V **přihlašovací adresa URL** textové pole, zadejte adresu URL, pomocí následujícího vzorce: `https://<tenant-name>.Bimeapp.com`

    b. V **identifikátor (Entity ID)** textové pole, zadejte adresu URL, pomocí následujícího vzorce: `https://<tenant-name>.Bimeapp.com`

    > [!NOTE]
    > Tyto hodnoty nejsou skutečný. Aktualizujte tyto hodnoty skutečné přihlašovací adresu URL a identifikátor. Kontakt [tým podpory Bime klienta](https://bime.zendesk.com/hc/categories/202604307-Support-tech-notes-and-tips-) k získání těchto hodnot. Můžete také odkazovat na tyto vzory se dají ukazuje **základní konfiguraci SAML** části webu Azure Portal.
...
7. Na **nastavení Bime** tématu, zkopírujte příslušné adresy URL podle vašich požadavků.
...
### <a name="configure-bime-single-sign-on"></a>Konfigurace Bime jednotné přihlašování

1. V okně jiné webové prohlížeče přihlaste jako správce serveru vaší společnosti Bime.

2. Na panelu nástrojů klikněte na tlačítko **správce**a potom **účet**.
  
    ![Správce](./media/bime-tutorial/ic775558.png "správce")

3. Na stránce konfigurace účtu postupujte následovně:
    ...
    b. V **Vzdálená adresa URL pro přihlášení** textového pole vložte hodnotu **přihlašovací adresa URL**, který jste zkopírovali z portálu Azure portal.

    c. V **otisku certifikátu** vložit do textového pole **kryptografický OTISK** hodnotu, která jste zkopírovali z portálu Azure portal.
...
1. Na webu Azure Portal, vyberte **podnikové aplikace**vyberte **všechny aplikace**a pak vyberte **Bime**.
...
### <a name="create-bime-test-user"></a>Vytvoření Bime testovacího uživatele
...
3. V **seznamu uživatelů**, klikněte na tlačítko **přidat nového uživatele** ("+").
...
Po kliknutí na dlaždici Bime na přístupovém panelu, můžete by měl být automaticky přihlášeni k Bime, u kterého nastavíte jednotné přihlašování. Další informace o přístupovém panelu, naleznete v tématu [Úvod k přístupovému panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

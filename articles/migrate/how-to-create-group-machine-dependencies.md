...
Mapa služby | Vizualizace závislostí používá Service Map řešení v Azure Monitor. [Service map](../azure-monitor/insights/service-map.md) automaticky zjišťuje a zobrazuje spojení mezi servery.

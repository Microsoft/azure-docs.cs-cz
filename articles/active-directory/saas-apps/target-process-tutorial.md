...
4. Do vyhledávacího pole zadejte **TargetProcess**, vyberte **TargetProcess** z panelu výsledků klikněte **přidat** tlačítko Přidat aplikaci.
    ...
    ![Přidat TargetProcess z Galerie](./media/target-process-tutorial/tutorial_target-process_addfromgallery.png)
...
4. Na **SAML podpisový certifikát** klikněte na tlačítko **certifikátu (Base64)** a potom uložte soubor certifikátu v počítači.
    ...
    ![Certifikát pro podpis SAML části](./media/target-process-tutorial/tutorial_target-process_certificate.png) 
...
6. Na **TargetProcess konfigurace** klikněte na tlačítko **konfigurace TargetProcess** otevřete **konfigurovat přihlášení** okno. Kopírování **SAML jeden přihlašování adresa URL služby** z **Stručná referenční příručka části.**
    ...
    ![TargetProcess konfigurační oddíl](./media/target-process-tutorial/tutorial_target-process_configure.png) 
...
11. Na jednotné přihlašování v dialogovém okně nastavení proveďte následující kroky:
    ...
    ![Konfigurovat jednotné přihlašování](./media/target-process-tutorial/tutorial_target_process_08.png)
...
1. V **portál Azure**, v levém navigačním podokně klikněte na tlačítko **Azure Active Directory** ikonu.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/target-process-tutorial/create_aaduser_01.png) 
...
4. Na **uživatele** dialogové okno stránky, proveďte následující kroky:
    ...
    ![Oddíl uživatele](./media/target-process-tutorial/create_aaduser_04.png) 

...
>
> Další informace o seřazené údržbě konzulárních instrukcí najdete v tématu [optimalizace clusterovaných indexů columnstore](sql-data-warehouse-tables-index.md#optimizing-clustered-columnstore-indexes).

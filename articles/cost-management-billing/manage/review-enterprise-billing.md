...
|*Authorization:*|Povinná hodnota. Nastavte na platný [klíč rozhraní `Bearer` API](https://docs.microsoft.com/rest/api/billing/enterprise/billing-enterprise-api-usage-detail#asynchronous-call-polling-based). |  

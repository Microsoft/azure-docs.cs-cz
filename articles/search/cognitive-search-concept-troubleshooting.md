---
title: Tipy pro řešení potíží pro obohacení AI
...
ms.locfileid: "72787705"
---
# <a name="troubleshooting-tips-for-ai-enrichment-in-azure-cognitive-search"></a>Tipy pro řešení potíží pro obohacení AI v Azure Kognitivní hledání
...
Přidejte pole ```enriched``` jako součást definice indexu pro účely ladění:
...
Pokud se problém týká velikosti souboru, může se zobrazit chyba, například objekt BLOB \<> název souboru má velikost \<> bajtů, což překračuje maximální velikost pro extrakci dokumentů pro aktuální úroveň služby. Další informace o omezeních indexeru najdete v tématu [omezení služby](search-limits-quotas-capacity.md).

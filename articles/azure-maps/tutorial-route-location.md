...
description: Přečtěte si, jak najít trasu k bodu zájmu. Přečtěte si, jak nastavit souřadnice adres a dotazovat se na službu Azure Maps Route, kde najdete pokyny k bodu.
author: anastasia-ms
ms.author: v-stharr
ms.date: 01/14/2020
ms.topic: tutorial

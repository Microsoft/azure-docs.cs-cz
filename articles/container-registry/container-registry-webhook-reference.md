...
|Element|Typ|Popis|
|-------------|----------|-----------|
|`id`|Řetězec|The ID of the webhook event.|
|`timestamp`|Datum a čas|The time at which the webhook event was triggered.|
|`action`|Řetězec|The action that triggered the webhook event.|
...
|Element|Typ|Popis|
|------------------|----------|-----------|
|`mediaType`|Řetězec|The MIME type of the referenced object.|
|`size`|Int32|The number of bytes of the content. Same as Length field.|
|`digest`|Řetězec|The digest of the content, as defined by the Registry V2 HTTP API Specification.|
|`length`|Int32|The number of bytes of the content. Same as Size field.|
|`repository`|Řetězec|The repository name.|
|`tag`|Řetězec|The image tag name.|

### <a name="request"></a>request

|Element|Typ|Popis|
|------------------|----------|-----------|
|`id`|Řetězec|The ID of the request that initiated the event.|
|`host`|Řetězec|The externally accessible hostname of the registry instance, as specified by the HTTP host header on incoming requests.|
|`method`|Řetězec|The request method that generated the event.|
|`useragent`|Řetězec|The user agent header of the request.|
...
|`digest`|Řetězec|The digest of the content, as defined by the Registry V2 HTTP API Specification.|
|`repository`|Řetězec|The repository name.|
|`tag`|Řetězec|The chart tag name.|
|`name`|Řetězec|The chart name.|
|`version`|Řetězec|The chart version.|

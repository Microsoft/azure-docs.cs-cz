...
| --- | --- | --- |
| Maximální počet jednotek streamování na předplatné a oblast |200 |Žádost o zvýšení počtu jednotek streamování pro vaše předplatné nad 200 můžete podat kontaktováním [Microsoft Support](https://support.microsoft.com/en-us). |

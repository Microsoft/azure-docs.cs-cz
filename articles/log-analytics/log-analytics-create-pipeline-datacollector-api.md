...
![Příklad jednoduché schéma](./media/log-analytics-create-pipeline-datacollector-api/example-simple-schema-01.png)
...
![Architektura kanálu kolekce dat](./media/log-analytics-create-pipeline-datacollector-api/data-pipeline-dataflow-architecture.png)
...
![Příklad pracovního postupu aplikace logiky](./media/log-analytics-create-pipeline-datacollector-api/logic-apps-workflow-example-01.png)
...
2.  Z **zobrazit soubory** kartu v pravém podokně, vytvořte nový soubor s názvem **project.json** a vložte následující kód z balíčků NuGet, které používáme:
    ...
    ![Příklad projektu Azure Functions](./media/log-analytics-create-pipeline-datacollector-api/functions-example-project-01.png)
...
5. Test funkce, ujistěte se, že kód funguje správně. Přepněte **testování** kartu v pravém podokně, konfigurace testu následujícím způsobem. Umístit odkaz na objekt blob se ukázkových dat. **text žádosti** textového pole. Po kliknutí na tlačítko **spustit**, JSON by se měla zobrazit výstup v **výstup** pole:
    ...
    ![Aplikace Function App testování kódu](./media/log-analytics-create-pipeline-datacollector-api/functions-test-01.png)
...
![Kompletní příklad pracovního postupu Logic Apps](./media/log-analytics-create-pipeline-datacollector-api/logic-apps-workflow-example-02.png)
...
![Korelace narušenému důvěrnému data v příkladu výsledek vyhledávání](./media/log-analytics-create-pipeline-datacollector-api/correlating-disjoined-data-example-01.png)
...
Další informace o [rozhraní API kolekce dat](log-analytics-data-collector-api.md) zapsat data do Log Analytics z jakéhokoli klienta REST API.
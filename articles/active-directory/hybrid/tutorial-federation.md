---
title: 'Kurz: Federate jeden ad doménové struktury prostředí azure | Dokumenty společnosti Microsoft'
description: Ukazuje, jak nastavit prostředí hybridní identity pomocí federace.
...
ms.locfileid: "80330994"
---
# <a name="tutorial-federate-a-single-ad-forest-environment-to-the-cloud"></a>Kurz: Federate jeden AD doménové struktury prostředí do cloudu

![Vytvořit](media/tutorial-federation/diagram.png)

Následující kurz vás provede vytvořením prostředí hybridní identity pomocí federace.  Toto prostředí pak lze použít pro testování nebo pro seznámení s tím, jak funguje hybridní identita.
...
## <a name="install-active-directory-pre-requisites"></a>Instalace předpokladů služby Active Directory
...
## <a name="create-a-certificate-for-ad-fs"></a>Vytvoření certifikátu pro službu AD FS
Nyní vytvoříme certifikát TLS/SSL, který bude používán službou AD FS.  To to bude certifikát podepsaný svým držitelem a je pouze pro účely testování.  Společnost Microsoft nedoporučuje používat certifikát podepsaný svým držitelem v produkčním prostředí. Udělejte toto:
...
6. Na obrazovce Přihlášení uživatelevyberte **Federace se službě AD FS** a klepněte na tlačítko **Další**.
![Federace](media/tutorial-federation/fed1.png)

1. Na obrazovce Připojit k Azure AD zadejte uživatelské jméno a heslo globálního správce, které jsme vytvořili výše, a klikněte na **další**.
...
9. Na stránce pověření správce domény zadejte uživatelské jméno a heslo contoso\Administrator a klepněte na tlačítko **Další.**
10. Na obrazovce farmy služby AD FS zkontrolujte, zda je vybraná možnost **Konfigurovat novou farmu služby AD FS.**
11. Vyberte **Použít certifikát nainstalovaný na federačních serverech** a klepněte na tlačítko **Procházet**.
12. Do vyhledávacího pole zadejte DC1 a vyberte jej, až bude nalezen.  Klikněte na **OK**.
13. V rozevíracím dokumentu **Soubor certifikátu** vyberte **adfs.contoso.com** certifikát, který jsme vytvořili výše.  Klikněte na **Další**.
![Federace](media/tutorial-federation/fed2.png)

1. Na obrazovce serveru služby AD FS klikněte na **Procházet** a do vyhledávacího pole zadejte řadič DOMÉNY 1 a vyberte jej, když je nalezen.  Klikněte na **OK**.  Klikněte na **Další**.
![Federace](media/tutorial-federation/fed3.png)

1. Na obrazovce Servery proxy webové aplikace klepněte na tlačítko **Další**.
2. Na obrazovce účtu služby Služby AD FS zadejte uživatelské jméno a heslo contoso\Administrator a klepněte na tlačítko **Další.**
3. Na obrazovce Domény Služby Azure AD vyberte ověřenou vlastní doménu v rozevíracím seznamku a klikněte na **Další**.
4. Na obrazovce Připraveno ke konfiguraci klikněte na **Nainstalovat**.
5. Až instalace skončí, klikněte na **Konec**.
6. Po dokončení instalace se před použitím Správce synchronizačních služeb nebo Editoru pravidel synchronizace odhlaste a znovu se přihlaste.

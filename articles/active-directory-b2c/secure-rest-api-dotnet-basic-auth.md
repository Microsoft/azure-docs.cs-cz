...
V [souvisejícím Azure AD B2C článku](rest-api-claims-exchange-dotnet.md)vytvoříte službu RESTful (webové rozhraní API), která se integruje s cestami uživatelů Azure Active Directory B2C (Azure AD B2C) bez ověřování.
...
1. Klikněte pravým tlačítkem na složku *app_start* , vyberte **Přidat**a pak vyberte **Třída**.
   ...
   ![Přidat třídu ClientAuthMiddleware.cs ve složce App_Start](./media/secure-rest-api-dotnet-basic-auth/rest-api-netfw-secure-basic-OWIN-startup-auth1.png)

2. Do pole **název** zadejte **ClientAuthMiddleware.cs**.

   ![Vytvoření nové C# třídy v dialogovém okně Přidat novou položku v aplikaci Visual Studio](./media/secure-rest-api-dotnet-basic-auth/rest-api-netfw-secure-basic-OWIN-startup-auth2.png)
...
1. Klikněte pravým tlačítkem na projekt, vyberte **přidat** > **novou položku**a pak vyhledejte **Owin**.
   ...
   ![Vytvoření třídy pro spuštění OWIN v dialogovém okně Přidat novou položku v aplikaci Visual Studio](./media/secure-rest-api-dotnet-basic-auth/rest-api-netfw-secure-basic-OWIN-startup.png)
...
![Přidat do kontroleru autorizační značku](./media/secure-rest-api-dotnet-basic-auth/rest-api-netfw-secure-basic-authorize.png)
...
5. Ihned po ukončení `<Metadata>` elementu přidejte následující fragment kódu XML:
    ...
    ![Přidat elementy XML základního ověřování do TechnicalProfile](./media/secure-rest-api-dotnet-basic-auth/rest-api-netfw-secure-basic-add-1.png)
...
3. Otestujte proces zadáním příkazu **test** do **daného pole název** .
    ...
    ![Testování zadaného názvu ověření vstupu v rozhraní API identity](./media/secure-rest-api-dotnet-basic-auth/rest-api-netfw-test.png)
...
* [Použití klientských certifikátů k zabezpečení rozhraní RESTful API](secure-rest-api-dotnet-certificate-auth.md)

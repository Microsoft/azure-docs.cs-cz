...
varování![ikonaupozornění](./media/data-box-safety/read_safety_and_health_information_icon.png) na bezpečnost **čtení informace o zabezpečení a stavu**
...
| Ikona | Popis |
|:--- |:--- |
| ![**Nebezpečí** ikony](./media/data-box-safety/warning_icon.png) nebezpečí |Označuje nebezpečnou situaci, která, pokud se nevyhne, má za následek smrt nebo vážnou škodu. Toto slovo signálu se bude omezovat na nejvíce extrémních situací. |
...
| ![Velmi tloušťka](./media/data-box-safety/heavy_weight_hazard_icon.png) ikony s velkou váhou | |
...
| ![Nebezpečí hrotu](./media/data-box-safety/tip_hazard_icon.png) ikony nebezpečí | |

## <a name="handling-precautions"></a>Zpracování preventivních opatření

![](./media/data-box-safety/electrical_shock_hazard_icon.png)![](./media/data-box-safety/no_user_serviceable_parts_icon.png) Ikona upozornění stav elektrickéhoúrazuikonaprouživatelskéslužbybezupozornění![](./media/data-box-safety/warning_icon.png) 
...
![Ikona](./media/data-box-safety/warning_icon.png) ](./media/data-box-safety/tip_hazard_icon.png) upozornění ikonanebezpečíupozornění!![
...
![Ikona](./media/data-box-safety/warning_icon.png) upozornění![ikonaelektrickéhoúrazu–upozornění](./media/data-box-safety/electrical_shock_hazard_icon.png)
...
* Poskytněte vhodné zdroje energie s ochranou přetížení elektrického zabezpečení, aby splňovaly následující specifikace napájení:
    ...
    - Napájení 100 v AC do 240 V AC
    - Aktivní 6 a maximum
    - Opakování 50 Hz až 60 Hz
...
* **Jenom pro pracovníky služby**: Riziko výbuchu v případě, že je baterie nahrazena nesprávným typem. Vyřadit využité baterie podle pokynů.
...
Toto zařízení je v souladu s částí 15 pravidel FCC a s výjimkou standardu RSS pro odvětví Kanady. Operace podléhá následujícím dvěma podmínkám: (1) Toto zařízení nemůže způsobit škodlivou interferenci a (2) Toto zařízení musí přijmout jakékoli rušivé rušení, včetně rušivých zásahů, které by mohly způsobit nepožadovanou činnost zařízení.
...
Tento symbol v produktu nebo jeho bateriích nebo jeho obalech znamená, že tento produkt a všechny baterie, které obsahuje, nesmí být zneškodněny s využitím vašich domácích odpadů. Místo toho je vaší zodpovědností předat ho do vhodného bodu shromažďování pro recyklaci baterií a elektrického a elektronického vybavení. Tato samostatná kolekce a recyklace bude pomáhat šetřit přírodní prostředky a zabránit potenciálním negativním důsledkům pro lidské zdraví a prostředí, a to z důvodu možné přítomnosti nebezpečných látek v bateriích a elektrických i elektronických. zařízení, což může být způsobeno nevhodným vyřazením. Další informace o tom, kde odkládat baterie a elektrická a elektronický odpad, získáte od místního města, služby pro odstranění odpadu v domácnosti nebo nákupu, kde jste tento produkt zakoupili. Kontaktujte *erecycle\@Microsoft.com* , kde najdete další informace o OEEZ.

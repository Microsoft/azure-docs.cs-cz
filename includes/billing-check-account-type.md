...
3. Pokud máte přístup jenom k jednomu rozsahu fakturace, vyberte na levé straně **Vlastnosti**.
    ...
    **Typ fakturačního účtu** na stránce Vlastnosti určuje typ vašeho účtu. Může to být program Microsoft Online Service, smlouva Enterprise, smlouva se zákazníkem Microsoftu nebo smlouva s partnerem Microsoftu. Další informace o typu fakturačních účtů najdete v tématu věnovaném [zobrazení fakturačních účtů na webu Azure Portal](../articles/billing/billing-view-all-accounts.md).  

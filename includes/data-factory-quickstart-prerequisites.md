...
2. Na panelu nástrojů na stránce * \<název účtu>*  -  **kontejnery** vyberte **kontejner**.
3. V dialogovém okně **Nový kontejner** jako název zadejte **adftutorial** a pak vyberte **OK**. Stránka * \<název účtu>*  -  **kontejnery** se aktualizuje tak, aby zahrnovala **adftutorial** v seznamu kontejnerů.
...
1. Na stránce s * \<názvem účtu>*  -  **kontejnery** , kde jste skončili, vyberte **adftutorial** z aktualizovaného seznamu kontejnerů.

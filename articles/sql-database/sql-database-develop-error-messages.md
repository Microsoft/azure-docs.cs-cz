...
* Pokus o připojení k sekundární databázi se nezdařila, protože databáze probíhá Rekonfigurace a je zaneprázdněný, použití nové stránky při uprostřed aktivní transakce na primární databáze. 
...
| 40501 |20 |Služba je aktuálně zaneprázdněna. Opakujte požadavek za 10 sekund. ID incidentu: %ls. Kód: %d.<br/><br/>Další informace naleznete v tématu:<br/>• [Limitů prostředků azure SQL Database](sql-database-service-tiers-dtu.md). |

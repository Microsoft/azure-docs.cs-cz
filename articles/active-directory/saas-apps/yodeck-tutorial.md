...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/yodeck-tutorial/tutorial_yodeck_samlbase.png)
...
3. Na **Yodeck domény a adresy URL** část, proveďte následující kroky, pokud chcete nakonfigurovat aplikace **IDP** iniciované režimu:
    ...
    ![Yodeck domény a adresy URL jednotné přihlašování informace](./media/yodeck-tutorial/tutorial_yodeck_url.png)
...
4. Zkontrolujte **zobrazit upřesňující nastavení adresy URL** a provést následující krok, pokud chcete nakonfigurovat aplikace **SP** iniciované režimu:
    ...
    ![Yodeck domény a adresy URL jednotné přihlašování informace](./media/yodeck-tutorial/tutorial_yodeck_url1.png)
...
6. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/yodeck-tutorial/tutorial_general_400.png)
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/yodeck-tutorial/create_aaduser_02.png)
...
2. Klikněte na **uživatelská nastavení** formuláře pravém horním rohu stránky a vyberte možnost **uživatelé**.
    ...
    ![Můžete přidat zaměstnance](./media/yodeck-tutorial/user1.png)

3. Klikněte na **+ uživatele** otevřete **podrobné informace o uživateli** kartě.

    ![Můžete přidat zaměstnance](./media/yodeck-tutorial/user2.png)

4. Na **podrobné informace o uživateli** dialogové okno proveďte následující kroky:

    ![Můžete přidat zaměstnance](./media/yodeck-tutorial/user3.png)
...
2. V seznamu aplikací vyberte **Yodeck**.
    ...
    ![V seznamu aplikací na Yodeck odkaz](./media/yodeck-tutorial/tutorial_yodeck_app.png)  

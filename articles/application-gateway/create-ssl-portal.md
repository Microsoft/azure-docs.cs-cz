...
Pomocí Azure Portal můžete nakonfigurovat [Aplikační bránu](overview.md) s certifikátem pro ukončení protokolu SSL, který používá virtuální počítače pro back-end servery.
...
Použijte [příkaz Export-vybíráte](https://docs.microsoft.com/powershell/module/pkiclient/export-pfxcertificate) s kryptografickým otiskem, který byl vrácen pro export souboru PFX z certifikátu:
...
> [Další informace o Application Gateway podpoře SSL](ssl-overview.md)
...
1. Vytvořte funkci volanou `Autosuggest()` k odeslání žádosti do rozhraní API. Vytvořte nový `HttpClient()`a přidejte do `Ocp-Apim-Subscription-Key` záhlaví klíč předplatného.

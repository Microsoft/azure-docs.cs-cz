...
Pokud máte plán podpory a potřebujete technickou pomoc, vytvořte žádost o podporu Azure, přečtěte si téma [Vytvoření žádosti o podporu Azure](https://docs.microsoft.com/azure/azure-supportability/how-to-create-azure-support-request).

...
* Sady SDK, které můžete integrovat s vaší aplikací buď [ve vývoji](../../azure-monitor/app/asp-net.md) nebo [v době běhu](../../azure-monitor/app/monitor-performance-live-website-now.md). Existují různé sady SDK pro typy jiné aplikaci. K dispozici je také [sady SDK pro webové stránky](../../azure-monitor/app/javascript.md), který načte do prohlížeče uživatele end spolu s stránky.
...
* [Web telemetrická data server](../../azure-monitor/app/asp-net.md) – požadavky HTTP.  Identifikátor URI, doba zpracování požadavku, kód odpovědi, IP adresa klienta. Id relace.
* [Webové stránky](../../azure-monitor/app/javascript.md) -počtu stránek, uživatelů a relací. Časy načtení stránek. Výjimky. Volání AJAX.
...
* [Výjimky](../../azure-monitor/app/asp-net-exceptions.md) a selhání – **výpisy zásobníku**, id, typ procesoru sestavení. 
* [Závislosti](../../azure-monitor/app/asp-net-dependencies.md) – volání externích služeb, jako je REST, SQL a AJAX. Identifikátor URI nebo připojovací řetězec, doba trvání, úspěch, příkaz.
* [Testy dostupnosti](../../azure-monitor/app/monitor-web-app-availability.md) – doba trvání testu a kroky, odpovědi.
* [Protokoly trasování](../../azure-monitor/app/asp-net-trace-logs.md) a [vlastní telemetrii](../../azure-monitor/app/api-custom-events-metrics.md) - **nic kódu do protokoly nebo telemetrie**.
...
![Stisknutím klávesy F12 a otevřete kartu síť.](./media/data-retention-privacy/08-browser.png)
...
To může být zápisem je to možné [modulu plug-in procesoru telemetrie](../../azure-monitor/app/api-filtering-sampling.md).
...
| Duration |Název události a hodnota |

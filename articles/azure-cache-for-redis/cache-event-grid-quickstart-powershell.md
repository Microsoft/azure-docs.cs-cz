...
New-AzRedisCache
   ...
   [<CommonParameters>]
```
Další informace o vytvoření instance mezipaměti v PowerShellu najdete v [referenčních](https://docs.microsoft.com/powershell/module/az.rediscache/new-azrediscache?view=azps-5.2.0)informacích o Azure PowerShell. 
...
Import-AzRedisCache
      ...
      [<CommonParameters>]
```
Další informace o importování v PowerShellu najdete v [referenčních](https://docs.microsoft.com/powershell/module/az.rediscache/import-azrediscache?view=azps-5.2.0)informacích o Azure PowerShell. 

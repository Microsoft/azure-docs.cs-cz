...
Přidejte následující konfiguraci:
  ...
  ```
> [!IMPORTANT] 
> Pokud chcete zobrazit všechny konfigurace potřebné k povolení korelace, přečtěte si [dokumentaci k korelaci JavaScriptu](/app/javascript.md#enable-correlation).

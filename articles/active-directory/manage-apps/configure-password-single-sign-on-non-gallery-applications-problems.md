...
10. Vyberte **konfigurovat *&lt;název_aplikace&gt;* nastavení pro jednotné přihlašování pomocí hesla**.
...
## <a name="troubleshoot-problems"></a>Řešení problémů

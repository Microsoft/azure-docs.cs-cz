...
- Pokud jste plány Azure nepoužívali dřív, zaregistrujte poskytovatele prostředků prostřednictvím Azure PowerShell s `Register-AzResourceProvider -ProviderNamespace Microsoft.Blueprint` .

---
title: 'Kurz: Azure Active Directory integrace s prvotní vzděláváním | Microsoft Docs'
...
2. **[Nakonfigurovat jednotné přihlašování prvotní pro vzdělávání](#configure-frontline-education-sso)** – ke konfiguraci nastavení jednotného přihlašování na straně aplikace
...
Pokud chcete nakonfigurovat jednotné přihlašování na straně **vzdělávání prvotní** , musíte odeslat **adresu URL federačních metadat aplikace** [týmu podpory prvotní vzdělávání](mailto:support@frontlineed.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

### <a name="create-frontline-education-test-user"></a>Vytvořit testovacího uživatele prvotní vzdělávání

V této části vytvoříte uživatele s názvem Britta Simon v prvotní vzdělávání. Pracujte s [týmem podpory prvotní vzdělávání](mailto:support@frontlineed.com) a přidejte uživatele na vzdělávací platformě prvotní. Uživatelé musí vytvořit a aktivovat, než použití jednotného přihlašování.

## <a name="test-sso"></a>Test SSO 

V této části Testování služby Azure AD jednotné přihlašování – konfigurace pomocí přístupového panelu.

Když na přístupovém panelu kliknete na dlaždici vzdělávání prvotní, měli byste se automaticky přihlásit k prvotní vzdělávání, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

...
Prostředky v Azure generují [protokoly](../platform/data-platform-logs.md) a [metriky](../essentials/data-platform-metrics.md) , které jsou uvedené v následujícím diagramu. Konkrétní data, která generují, a veškerá další řešení nebo přehledy, které poskytují, najdete v dokumentaci ke každé službě Azure.

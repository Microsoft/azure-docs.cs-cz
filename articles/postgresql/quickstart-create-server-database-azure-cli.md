...
> [!IMPORTANT]
> Přihlášení správce serveru a heslo, které specifikujete, se později vyžadují pro přihlášení k serveru v tomto rychlém startu. Tyto informace si zapamatujte nebo poznamenejte pro pozdější použití.

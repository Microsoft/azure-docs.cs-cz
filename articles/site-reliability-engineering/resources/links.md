...
K dispozici je mnoho různých zdrojů informací o SRE (Site Resources Engineering) na webu.

## <a name="curated-link-lists"></a>Seznamy uspořádaných odkazů

Tady jsou některé užitečné seznamy odkazů pro SRE a témata týkající se SRE:
...
* [Super pozorování](https://github.com/adriannovegil/awesome-observability)

## <a name="weekly-digests-of-interest-to-site-reliability-engineers"></a>Týdenní souhrny zájmu pro pracovníky spolehlivosti webu

* [SRE týdně](https://sreweekly.com) – "SRE týdně je bulletin, který souvisí s tím, že je web nebo služba k dispozici tak konzistentně, jak je to možné."
* [DevOps týdně](https://www.devopsweekly.com) – "týdenní řezy DevOps zpráv, na které vám Gareth Rushgrove."
* [Tento týden v DevOps](https://thisweekindevops.com) -"DevOps News bez Hype."
* [KubeWeekly](https://kubeweekly.io) – týdenní bulletiny pro všechny věci Kubernetes. "

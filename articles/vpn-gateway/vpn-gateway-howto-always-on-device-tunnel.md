...
![Snímek obrazovky se zobrazí okno PowerShellu, ve kterém se spouští příkaz Remove-VpnConnection-Name MachineCertTest.](./media/vpn-gateway-howto-always-on-device-tunnel/cleanup.png)

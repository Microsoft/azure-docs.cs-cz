...
Odkazy na procesy publikování a pokyny pro každý typ nabídky naleznete v následující tabulce:
...
| Power Apps | Naučte se, jak [zákazníkům umožnit testování aplikace na AppSource](https://powerapps.microsoft.com/blog/appsource-test-drive/). |
| Power BI | Projděte si [Postup publikování a pokyny](/power-bi/developer/office-store). |
...
Pokud chcete vytvořit novou nabídku nebo dokončit existující nabídku, přejít do [partnerského centra](https://partner.microsoft.com/dashboard/account/v3/enrollment/introduction/partnership).

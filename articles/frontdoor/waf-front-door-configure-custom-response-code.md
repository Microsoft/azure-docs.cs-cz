...
Upravit vlastní odpovědi nebo nastavení tělo odpovědi u existující zásady WAF, pomocí [aktualizace AzFrontDoorFireWallPolicy](/powershell/module/az.frontdoor/Update-AzFrontDoorWafPolicy).

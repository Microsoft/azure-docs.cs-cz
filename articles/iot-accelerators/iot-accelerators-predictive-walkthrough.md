...
Modré položky jsou služby Azure zřízené v oblasti, kam jste nasadili akcelerátor řešení. Seznam oblastí, kde můžete nasadit akcelerátor řešení, se zobrazí na [stránce zřizování][lnk-azureiotsolutions].
...
*Telemetrická data*. Existují čtyři senzory, které zaznamenávají atributy modulu. Snímače jsou obecně označeny jako Sensor 9, Sensor 11, Sensor 14 a Sensor 15. Tyto čtyři snímače odesílají telemetrii dostačující pro získání užitečných výsledků z modelu RUL. Model použitý v akcelerátoru řešení je vytvořený z veřejné sady dat, obsahující data snímačů skutečného motoru. Další informace o tom, jak byl model vytvořen z původní sady dat, naleznete v [Cortana Intelligence Gallery šabloně prediktivní údržby][lnk-cortana-analytics].
...
* [Zabezpečení IoT od základů][lnk-security-groundup]

---
title: Přehled samostatného agenta Micro
...
---
# <a name="standalone-micro-agent-overview"></a>Přehled samostatného agenta Micro 
...
Ověřte [metody ověřování mikroagentů ](concept-security-agent-authentication.md).

...
| **Atributy**              | –  |
| **Reference**              | [Zabezpečení XSLT](/previous-versions/windows/desktop/ms763800(v=vs.85)), [vlastnost XsltSettings. EnableScript](/dotnet/api/system.xml.xsl.xsltsettings.enablescript) |
...
| **Použitelné technologie** | Obecné |
| **Atributy**              | –  |
| **Reference**              | [Rozšíření entit XML](https://capec.mitre.org/data/definitions/197.html), [útoky DOS a obrany služby XML](/archive/msdn-magazine/2009/november/xml-denial-of-service-attacks-and-defenses), [Přehled zabezpečení MSXML](/previous-versions/windows/desktop/ms754611(v=vs.85)), [osvědčené postupy pro zabezpečení kódu MSXML](/previous-versions/windows/desktop/ms759188(v=vs.85)), [reference protokolu NSXMLParserDelegate](https://developer.apple.com/library/ios/#documentation/cocoa/reference/NSXMLParserDelegate_Protocol/Reference/Reference.html)a [Překlad externích odkazů](/dotnet/standard/data/xml/resolving-external-resources) |
...
| **Atributy**              | –  |
| **Reference**              | [Jak zabránit skriptování mezi weby v ASP.NET](/previous-versions/msp-n-p/ff649310(v=pandp.10)), [skriptování mezi weby](https://cwe.mitre.org/data/definitions/79.html), skriptování [XSS (skriptování mezi weby) prevence tahák listů](https://cheatsheetseries.owasp.org/cheatsheets/Cross_Site_Scripting_Prevention_Cheat_Sheet.html) |
...
| **Atributy**              | –  |
| **Reference**              | [Přidání ověřování](https://www.asp.net/mvc/overview/getting-started/introduction/adding-validation), [ověřování dat modelu v aplikaci MVC](/previous-versions/dd410404(v=vs.90)), [Principy identifikátorů GUID pro aplikace ASP.NET MVC](/archive/msdn-magazine/2009/brownfield/extreme-asp-net-guiding-principles-for-your-asp-net-mvc-applications) |
...
| **Použitelné technologie** | Obecné |
| **Atributy**              | –  |
| **Reference**              | [Kódování nebezpečného vstupu](/previous-versions/msp-n-p/ff647397(v=pandp.10)#paght000003_step3), [upraveného kódu HTML](https://github.com/mganss/HtmlSanitizer) |
...
| **Použitelné technologie** | Generic, MVC5, MVC6 |
| **Atributy**              | –  |
| **Reference**              | [Ověřování dat modelu v aplikaci MVC](/previous-versions/dd410404(v=vs.90)), [Principy identifikátorů guid pro aplikace ASP.NET MVC](/archive/msdn-magazine/2009/brownfield/extreme-asp-net-guiding-principles-for-your-asp-net-mvc-applications) |
...
| **Použitelné technologie** | Obecné, webové formuláře, MVC5, MVC6  |
| **Atributy**              | –  |
| **Reference**              | [Vlastnost DefaultRegexMatchTimeout](/dotnet/api/system.web.configuration.httpruntimesection.defaultregexmatchtimeout) |
...
| **Atributy**              | –  |
| **Reference**              | [MSDN](/previous-versions/msp-n-p/ff647820(v=pandp.10)) |
...
| **Použitelné technologie** | Obecné, NET Framework 3 |
| **Atributy**              | –  |
| **Reference**              | [MSDN](/previous-versions/msp-n-p/ff647875(v=pandp.10)) |

...
1. Ke konfiguraci jednotného přihlašování na **ASC kontrakty** straně, obraťte se na podporu ASC sítě Inc. (ASC) na **613.599.6178** a umožnit jim na stažený **soubor XML s metadaty**. Nastavené této aplikace SAML SSO připojení správně nastavena na obou stranách.

...
Pokud chcete [nainstalovat](https://velero.io/docs/master/basic-install/) Velero do svého systému, postupujte podle doporučeného postupu pro váš operační systém.

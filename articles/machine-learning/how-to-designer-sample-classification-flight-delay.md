...
[![Graf kanálu](media/how-to-designer-sample-classification-flight-delay/pipeline-graph.png)](media/how-to-designer-sample-classification-flight-delay/pipeline-graph.png#lightbox)
...
![zpracování dat](./media/how-to-designer-sample-classification-flight-delay/data-process.png)
...
Letové záznamy jsou spojeny s daty o počasí v počátku letu (**OriginAirportID**) pomocí modulu **Join data** Module.
 ...
 ![spojit lety a počasí podle původu](./media/how-to-designer-sample-classification-flight-delay/join-origin.png)


Letové záznamy jsou spojené s daty o počasí, a to s využitím cíle letu (**DestAirportID**).

 ![Připojení letu a počasí podle cíle](./media/how-to-designer-sample-classification-flight-delay/join-destination.png)
...
Modul **rozdělit data** rozdělí data do dne do září záznamů pro školení a pro test na základě záznamů.
 ...
 ![Rozdělení dat školení a testování](./media/how-to-designer-sample-classification-flight-delay/split.png)
...
Model logistické regrese má v sadě testů AUC 0,631.
 ...
 ![Vyhodnocení](media/how-to-designer-sample-classification-flight-delay/sample6-evaluate-1225.png)

...
1. Vložte hodnoty do polí, jak je popsáno níže.
    ...
    ![Konfigurace jednoho Sign-On](./media/purelyhr-tutorial/purelyhr-dashboard-sso-settings.png)  
...
Když na přístupovém panelu kliknete na dlaždici PurelyHR, měli byste se automaticky přihlásit k PurelyHR, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).

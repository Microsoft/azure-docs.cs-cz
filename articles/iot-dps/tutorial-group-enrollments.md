...
description: V tomto kurzu vytvoříte a zřídíte simulované zařízení X. 509 pomocí sady Java Device and Service SDK a registrační skupiny pro IoT Hub Device Provisioning Service
author: wesmc7777
ms.author: wesmc
ms.date: 11/12/2019
ms.topic: tutorial

...
2. Přejděte na **Site Recovery infrastruktura** > **konfigurační servery** (v části pro fyzické počítače VMware &).
...
1. V Azure Portal přejděte na **Site Recovery infrastruktura** > **konfigurační servery** z nabídky trezor.
...
1. V trezoru otevřete **Site Recovery infrastruktura** > **konfigurační server**a klikněte na požadovaný konfigurační server.

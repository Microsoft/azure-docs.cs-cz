...
Část věnovaná mapování doporučení obsahuje podrobnosti o zásadách, které jsou součástí tohoto podrobného plánu, a o tom, jak tyto zásady řeší různá doporučení ve srovnávacím testu CIS Microsoft Azure Foundations v1.1.0. Prostředky při přiřazení k architektuře vyhodnocuje Azure Policy a zjišťuje případné nedodržení přiřazených zásad. Další informace najdete v tématu [Azure Policy](../../../policy/overview.md).

## <a name="next-steps"></a>Další kroky

Prošli jste si přehled ukázky podrobného plánu srovnávacího testu CIS Microsoft Azure Foundations.
Pokračujte následujícími články, ve kterých najdete informace o mapování doporučení:

> [!div class="nextstepaction"]
> [Podrobný plán srovnávacího testu CIS Microsoft Azure Foundations – mapování doporučení](./control-mapping.md)
> [Podrobný plán srovnávacího testu CIS Microsoft Azure Foundations – kroky nasazení](./deploy.md)

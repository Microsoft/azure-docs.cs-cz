...
Když na přístupovém panelu kliknete na dlaždici InVision, měli byste se automaticky přihlásit k InVision, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).
...
- [Jak chránit InVision pomocí pokročilých viditelností a ovládacích prvků](/cloud-app-security/proxy-intro-aad)
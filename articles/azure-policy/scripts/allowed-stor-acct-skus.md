---
title: Ukázka kódu JSON pro Azure Policy – Povolené skladové položky účtu úložiště | Microsoft Docs
description: Tato ukázková zásada JSON vyžaduje, aby účty úložiště používaly schválené skladové položky.
...
ms.locfileid: "34602903"
---
# <a name="allowed-storage-account-skus"></a>Povolené skladové položky účtu úložiště

Tato zásada vyžaduje, aby účty úložiště používaly schválené skladové položky. Zadejte pole schválených skladových položek.

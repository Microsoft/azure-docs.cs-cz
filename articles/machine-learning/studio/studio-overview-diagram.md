---
title: Diagram s přehledem možností nástroje Machine Learning Studio – Azure | Dokumentace Microsoftu
...
> [!NOTE]
> Další nápovědu k procházení a výběru algoritmů strojového učení, které jsou k dispozici v nástroji Machine Learning Studio, najdete v tématu [Rychlý přehled algoritmů strojového učení pro Microsoft Azure Machine Learning Studio](algorithm-cheat-sheet.md).
> 
> 

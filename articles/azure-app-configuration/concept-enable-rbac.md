...
- **Přispěvatel**: pomocí této role můžete spravovat prostředek konfigurace aplikace. I když lze ke konfiguračním datům aplikace přistupovat pomocí přístupových klíčů, tato role neuděluje přístup k datům pomocí Azure AD.

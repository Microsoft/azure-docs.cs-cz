...
1. V **frekvence** vyberte **den**a **Interval** zadejte **1**.
    ...
    ![Dialogové okno aktivační události Microsoft Flow](./media/automate-with-flow/flow1.png)
...
1. Klikněte na tlačítko **Azure Application Insights – Analytics vizualizace dotazu ve verzi Preview**.
    ...
    ![Spusťte okno dotazu Analytics](./media/automate-with-flow/flow2.png)
...
![ID aplikace na webu Azure Portal](./media/automate-with-flow/appid.png) 

- Zadejte název připojení, spolu s klíčem rozhraní API a ID aplikace.

    ![Okno připojení Microsoft Flow](./media/automate-with-flow/flow3.png)
...
- Přidejte následující dotaz Analytics a pak vyberte typ grafu tabulku HTML. 
    ...
    ![Okno Konfigurace dotazu Analytics](./media/automate-with-flow/flow4.png)
...
1. Klikněte na tlačítko **Office 365 Outlook – odeslat e-mail**.
    ...
    ![Okno pro výběr Office 365 Outlooku](./media/automate-with-flow/flow2b.png)
...
1. V **odeslat e-mailu** okno, postupujte takto:
   ...
   d. Klikněte na tlačítko **zobrazit pokročilé možnosti**.
    ...
    ![Konfigurace Office 365 Outlooku](./media/automate-with-flow/flow5.png)
...
1. V nabídce dynamického obsahu postupujte takto:
    ...
    ![Okno Konfigurace e-mailu Office 365](./media/automate-with-flow/flow7.png)
...
- V **název toku** pole, přidat pro nový tok název a potom klikněte na tlačítko **vytvořit tok**.
    ...
    ![Okno Vytvoření toku](./media/automate-with-flow/flow8.png)

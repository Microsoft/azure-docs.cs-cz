---
title: 'Rychlý start: Vytvoření kanálu CI/CD pro Ruby na železnici pomocí Azure DevOps Projects'
description: Azure DevOps Projects umožňuje snadno začít používat Azure. Webovou aplikaci Ruby můžete spustit ve službě Azure v několika rychlých krocích.
ms.prod: devops
...
---
# <a name="create-a-cicd-pipeline-for-ruby-on-rails-by-using-azure-devops-projects"></a>Vytvoření kanálu CI/CD pro Ruby na železnici pomocí Azure DevOps Projects

Nakonfigurujte průběžnou integraci (CI) a průběžné doručování (CD) pro aplikaci v Ruby na železnici pomocí Azure DevOps Projects. DevOps Projects zjednodušuje počáteční konfiguraci kanálu sestavení a vydání Azure DevOps.
...
Azure DevOps Projects vytvoří v Azure Repos kanál CI/CD. Můžete vytvořit novou organizaci Azure DevOps nebo použít stávající organizaci. Prostředky Azure DevOps Projects také vytvoří v rámci předplatného Azure podle vašeho výběru.
...
1. Výchozí cíl nasazení je **Web App on Linux**.  
    Volitelně můžete vybrat **Web App for Containers**. Aplikační rozhraní, které jste si zvolili dříve, určuje typ cíle nasazení služby Azure, který je k dispozici zde. 
...
Azure DevOps Projects vytvoří úložiště Git v Azure Pipelines nebo GitHubu. Pokud chcete zobrazit úložiště a udělat v aplikaci změny kódu, udělejte toto:

1. Na řídicím panelu DevOps Projects na levé straně vyberte odkaz pro svou hlavní větev.  

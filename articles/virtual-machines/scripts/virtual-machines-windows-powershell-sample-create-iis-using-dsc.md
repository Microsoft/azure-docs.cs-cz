...
ms.locfileid: "89078142"
---
# <a name="use-an-azure-powershell-sample-script-to-create-an-iis-vm"></a>Použití ukázkového skriptu Azure PowerShell k vytvoření virtuálního počítače IIS

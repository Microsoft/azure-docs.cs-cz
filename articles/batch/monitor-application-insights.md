...
V příkladu v TopNWords.cs používá následující [instrumentace volání](../application-insights/app-insights-api-custom-events-metrics.md) z rozhraní API Application Insights:
...
Při hlášení telemetrie pro daný server a instanci Application Insights využívá název Role virtuálních počítačů Azure a virtuálních počítačů pro výchozí hodnoty. V rámci služby Azure Batch příklad ukazuje způsob použití názvu fondu a místo toho compute název uzlu. Použití [inicializátor telemetrie](../application-insights/app-insights-api-filtering-sampling.md#add-properties) přepsat výchozí hodnoty. 

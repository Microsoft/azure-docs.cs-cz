...
1. Přidejte tento kód *projektu* úroveň **build.gradle** souboru:
...
Nakonec přidejte `com.android.support:customtabs:28.0.0` do seznamu závislosti `build.gradle` souboru:

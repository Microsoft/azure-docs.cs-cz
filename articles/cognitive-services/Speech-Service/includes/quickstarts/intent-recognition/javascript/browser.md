...
Nyní je třeba vytvořit `AudioConfig` objekt, který odkazuje na vstupní devic3. Vložte tento kód do `startIntentRecognizeAsyncButton.addEventListener()` metody hned pod konfigurací řeči.

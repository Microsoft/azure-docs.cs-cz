...
![Stránka pro vytvoření aplikace v Azure IoT Central](media/quick-deploy-iot-central-pnp/iotcentralcreate-templates-pnp.png)
...
1. Azure IoT Central také na základě názvu aplikace vygeneruje jedinečnou předponu **adresy URL aplikace** . Tuto adresu URL použijete pro přístup k aplikaci. Tuto předponu adresy URL můžete změnit na něco, co byste si chtěli.
    ...
    ![Stránka pro vytvoření aplikace v Azure IoT Central](media/quick-deploy-iot-central-pnp/iotcentralcreate-industry-pnp.png)
...
> [Přidání simulovaného zařízení do aplikace IoT Central](./quick-create-pnp-device-pnp.md)

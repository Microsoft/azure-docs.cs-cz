---
title: Správa serveru – portál Azure – databáze Azure pro MariaDB
description: Zjistěte, jak spravovat azure databázi pro mariadb server z webu Azure Portal.
author: ajlam
ms.author: andrela
ms.service: mariadb
ms.topic: conceptual
...
---
# <a name="manage-an-azure-database-for-mariadb-server-using-the-azure-portal"></a>Správa databáze Azure pro server MariaDB pomocí portálu Azure
Tento článek ukazuje, jak spravovat azure databáze pro servery MariaDB. Úlohy správy zahrnují škálování výpočetních prostředků a úložišť, resetování hesla správce a zobrazení podrobností o serveru.

## <a name="sign-in"></a>Přihlášení
Přihlaste se k [portálu Azure](https://portal.azure.com).

## <a name="create-a-server"></a>Vytvoření serveru
Navštivte [rychlý start,](quickstart-create-mariadb-server-database-using-azure-portal.md) kde se dozvíte, jak vytvořit a začít s azure databází pro mariadb server.
...
- Další informace o [možnostech ladění a monitorování v Azure Database pro MariaDB](concepts-monitoring.md)

...
Syntaxi JSON a vlastnostech najdete v tématu [obory názvů](/azure/templates/microsoft.servicebus/namespaces) a [fronty](/azure/templates/microsoft.servicebus/namespaces/queues).

...
|**Ukázky základních kódů** | Azure Cosmos DB: Příklady jazyka Java pro rozhraní SQL API · [Úložiště GitHub s ukázkovým kódem](https://github.com/Azure-Samples/azure-cosmos-java-sql-api-samples)|

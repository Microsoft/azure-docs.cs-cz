...
![Otevře se okno Přehled vaší aplikace na webu Azure Portal](./media/metrics-explorer/03-range.png)
...
![Proveďte operaci přetažení přes část diagramu.](./media/metrics-explorer/12-drag.png)
...
![Hlavička okno.](./media/metrics-explorer/11-grain.png)

Můžete nastavit členitost v okně rozsah času:

![Hlavička okno.](./media/metrics-explorer/grain.png)
...
![V Průzkumníku metrik zvolte možnost přidat graf](./media/metrics-explorer/04-add.png)
...
![Vyberte seskupení na sadu vyberte vlastnost v Group By](./media/metrics-explorer/15-segment.png)
...
* **%** -Procento verzích každé agregace jsou používány pouze s Segmentovaný grafu. Celkový počet vždy přidá až 100 % a graf znázorňuje relativní příspěvek různé součásti celkem.
    ...
    ![Procentuální agregace](./media/metrics-explorer/percentage-aggregation.png)

### <a name="change-the-aggregation-type"></a>Změnit typ agregace

![Upravit graf a vyberte agregaci](./media/metrics-explorer/05-aggregation.png)

Výchozí metodou pro jednotlivé metriky se zobrazí, když vytvoříte nový graf nebo když jsou vybraná všechny metriky:

![Zruší výběr všech metrik zobrazíte výchozí hodnoty](./media/metrics-explorer/06-total.png)
...
![Klikněte na tlačítko Upřesnit nastavení, vyberte vlastní rozsah a zadejte minimální, maximální hodnota](./media/metrics-explorer/y-axis-range.png)

## <a name="filter-your-data"></a>Filtrování dat
Pokud chcete zobrazit metriky pro vybranou sadu hodnot vlastností:

![Klikněte na tlačítko filtru, rozbalte vlastnosti a zkontrolujte některé hodnoty](./media/metrics-explorer/19-filter.png)
...
![Vyberte tabulky nebo grafu a pak zvolte typ grafu](./media/metrics-explorer/16-chart-grid.png)
...
![Vybrat oblíbenou položku](./media/metrics-explorer/21-favorite-save.png)
...
![V seznamu tlačítka v horní části Průzkumníku metrik](./media/metrics-explorer/17-reset.png)

## <a name="live-metrics-stream"></a>Live metrics stream

Mnohem více okamžitě zobrazit telemetrii, otevřete [Live Stream](live-stream.md). Většina metrik trvat několik minut, než se zobrazí, a to z důvodu procesu agregace. Naopak živé metriky jsou optimalizované pro zajištění nízké latence. 
...
![V Průzkumníku metrik vyberte pravidel upozornění, přidat oznámení](./media/metrics-explorer/appinsights-413setMetricAlert.png)

...
Azure Time Series Insights se teď bezproblémově integruje s [Power BI](https://powerbi.microsoft.com/)a poskytuje vám výkonnější vizualizace a možnosti řídicího panelu pro streamovaná data a umožňuje sdílení přehledů a výsledků napříč vaší organizací.

## <a name="video"></a>Video

### <a name="learn-more-about-integrating-azure-time-series-insights-with-power-bibr"></a>Přečtěte si další informace o integraci Azure Time Series Insights s Power BI.</br>
...
Po připojení dat jsou k dispozici všechny funkce pro vizualizaci a vytváření grafů Power BI, které umožňují další vylepšení možností sdílení informací. 

   [Příklady grafů ![v Power BI](./media/concepts-connect-power-bi/power-bi-tsi-example.png)](./media/concepts-connect-power-bi/power-bi-tsi-example.png#lightbox)

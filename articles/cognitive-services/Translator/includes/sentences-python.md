...
Globální koncový bod překladatele je nastaven jako `endpoint` . `path` nastaví trasu `breaksentence` a určuje, že chceme cílit na rozhraní API verze 3.
...
>[!NOTE]
> Další informace o koncových bodech, trasách a parametrech požadavků naleznete v tématu [Translator 3,0: languages](https://docs.microsoft.com/azure/cognitive-services/translator/reference/v3-0-break-sentence).

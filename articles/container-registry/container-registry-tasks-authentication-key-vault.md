---
title: Externí ověřování v úloze Azure Container Registry
...
Pokud ještě nemáte službu Azure Container Registry, přečtěte si [téma rychlý Start: Vytvoření soukromého registru kontejnerů pomocí Azure CLI](container-registry-get-started-azure-cli.md). Image ještě nemusíte vkládat do registru.
...
* Ověřování pomocí Docker Hub předáním tajných `docker login` kódů příkazu.

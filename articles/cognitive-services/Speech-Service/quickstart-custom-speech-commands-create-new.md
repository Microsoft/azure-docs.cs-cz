...
Nyní můžete vytvořit příkaz. Pojďme použít příklad, který bude mít jednu utterance, `turn on the tv`a odpovědět se zprávou. `Ok, turning on the TV`
...
1. Vytvořit nové pravidlo dokončení výběrem `+` ikony vedle pravidel dokončení

...
Vložte zámek proti odstranění databáze. Další informace o tom, jak tento postup povolit, najdete v tématu [prevence změn ze sad SDK](role-based-access-control.md#preventing-changes-from-cosmos-sdk).
...
Vložte zámek proti odstranění do kontejneru. Další informace o tom, jak tento postup povolit, najdete v tématu [prevence změn ze sad SDK](role-based-access-control.md#preventing-changes-from-cosmos-sdk).

...
description: Základní hodnoty zabezpečení Azure pro Azure SQL Database
author: msmbaldwin
manager: rkarlin
ms.service: security
ms.topic: conceptual
...
**Doprovodné**materiály: použijte Azure Security Center a opravte doporučení k ochraně sítě pro podsíť, do které je Azure SQL Database Server nasazený. Pro Azure Virtual Machines (VM), který se bude připojovat k instanci serveru Azure SQL Database, povolte protokoly toku NSG (Network Security Group) pro skupin zabezpečení sítě ochranu těchto virtuálních počítačů a odeslat protokoly do účtu Azure Storage pro auditování provozu. Protokoly toku NSG můžete také odesílat do pracovního prostoru Log Analytics a používat Analýza provozu k poskytování přehledů o toku přenosů ve vašem cloudu Azure. Mezi výhody Analýza provozu patří schopnost vizualizovat síťovou aktivitu a identifikovat aktivní body, identifikovat bezpečnostní hrozby, pochopit vzory toků provozu a označovat nesprávné konfigurace sítě.
...
Pochopení rozšířené ochrany před internetovými útoky a upozorňování na SQL Server Azure:
...
**Doprovodné**materiály: nepoužitelné; pro Azure SQL Server je řešení proti malwaru spravované Microsoftem na podkladové platformě.
...
**Doprovodné**materiály: nepoužitelné; Protokolování DNS se nedá použít pro Azure SQL Server.
...
**Doprovodné**materiály: nepoužitelné; auditování příkazového řádku se nedá použít pro Azure SQL Server.
...
**Doprovodné**materiály: nepoužitelné; i když můžete nakonfigurovat ověřování Azure Active Directory pro integraci s Azure SQL Server, jednotné přihlašování se nepodporuje.
...
Postup sledování aktivity identity a přístupu uživatelů v Azure Security Center: https://docs.microsoft.com/azure/security-center/security-center-identity-access
...
**Doprovodné**materiály: vytvořte správce Azure Active Directory (AAD) pro vaše instance Azure SQL Database serveru.
...
Jak používat zjišťování a klasifikaci dat pro Azure SQL Server:
...
Jak integrovat SQL Server Azure s Azure Active Directory pro ověřování:

https://docs.microsoft.com/azure/sql-database/sql-database-aad-authentication


Jak řídit přístup v Azure SQL Server:
...
**Doprovodné**materiály: povolení pokročilých zabezpečení dat pro Azure SQL Database a použití doporučení od Azure Security Center při provádění posouzení ohrožení zabezpečení na vašich serverech SQL Azure.
...
Vysvětlení Azure RBAC: https://docs.microsoft.com/azure/role-based-access-control/overview
...
Jak chránit citlivá data uložená v Azure SQL Server a ukládat šifrovací klíče v Azure Key Vault:
...
Principy zálohování a provozní kontinuity pomocí Azure SQL Server:
...
Principy zálohování v Azure SQL Server:

...
- Pokus o konfiguraci replikace pomocí starší verze může mít za následek chybu MSSQL_REPL20084 (proces se nemohl připojit k odběrateli.) a MSSQL_REPL40532 (nemůže otevřít název serveru \<> požadovaný přihlášením. Přihlášení se nezdařilo.).  
...
- V `@subscriber_type = 0` **sp_addsubscription** se podporuje jenom pro SQL Database.  

...
* Ověření pomocí ADAL:
   ...
   1. Token se pak může předat v hlavičce, `Authorization` když aplikace volá rozhraní Time Series Insights API.
...
| Vydaná verze | Možné hodnoty verze rozhraní API |
| --- |  --- |

...
> [!NOTE]
> Část níže uvedených pokynů může fungovat jenom na Windows nebo Linuxem App Services. Například Linux App Services ve výchozím nastavení spouští v 64bitovém režimu.
>
...
Více faktorech může přispět ke zpomalení výkonu aplikace. Podrobné kroky pro řešení potíží naleznete v tématu [výkonu Poradce při potížích pomalých webových aplikací](troubleshoot-performance-degradation.md).
...
Další informace najdete v tématu [konfigurují webové aplikace ve službě App Service](configure-common.md).
...
Další informace o odchozích připojeních ve webové aplikaci, najdete v blogovém příspěvku o [odchozí připojení k Azure websites na úrovni](https://www.freekpaans.nl/2015/08/starving-outgoing-connections-on-windows-azure-web-sites/).

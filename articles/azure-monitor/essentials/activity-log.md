...
![Seznam historie změn pro událost](media/activity-log/change-history-event.png)
...
![Stránka historie změn zobrazující rozdíly](media/activity-log/change-history-event-details.png)
...
3. Klikněte na **Nastavení diagnostiky**.
   ...
   ![Nastavení diagnostiky](media/activity-log/diagnostic-settings.png)

4. Klikněte na fialový banner pro starší verze prostředí.

    ![Starší verze prostředí](media/activity-log/legacy-experience.png)
...
1. Klikněte na předplatné, které chcete připojit.
    ...
    ![Snímek obrazovky ukazuje Log Analytics pracovní prostor s vybraným protokolem aktivit Azure.](media/activity-log/workspaces.png)

2. Kliknutím na **připojit** připojte protokol aktivit v předplatném k vybranému pracovnímu prostoru. Pokud je předplatné už připojené k jinému pracovnímu prostoru, odpojte ho kliknutím na **Odpojit** .

    ![Připojit pracovní prostory](media/activity-log/connect-workspace.png)
...
![Dlaždice protokolů aktivit Azure](media/activity-log/azure-activity-logs-tile.png)
...
![Řídicí panel protokolů aktivit Azure](media/activity-log/activity-log-dash.png)

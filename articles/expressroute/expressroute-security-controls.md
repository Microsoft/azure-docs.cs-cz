...
| Podpora vynuceného tunelování| neuvedeno | Přes Border Gateway Protocol (BGP). |
...
| Řízení zabezpečení | Ano/Ne | Poznámky: |
|---|---|--|
| Šifrování na straně serveru v klidovém umístění: klíče spravované společností Microsoft |  neuvedeno | ExpressRoute neukládá zákaznická data. |

...
V tomto rychlém startu se nasadí cluster Docker Swarm pomocí Azure CLI. Následně se na tomto clusteru nasadí a spustí vícekontejnerová aplikace skládající se z webového front-endu a instance Redis. Po dokončení bude aplikace přístupná přes internet.

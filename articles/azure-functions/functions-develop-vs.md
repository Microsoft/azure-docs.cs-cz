...
1. V **Průzkumníku řešení** klikněte pravým tlačítkem na uzel projektu a vyberte **Přidat** > **Nová položka**. Select **Azure Function**, type a **Name** for the class, and click **Add**.

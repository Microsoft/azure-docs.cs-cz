...
Robot využívá rozhraní Bot Framework 3.x a použijete Azure Web app bot. A [Bot Framework 4.x s kurzem LUIS](luis-nodejs-tutorial-bf-v4.md) je také k dispozici.

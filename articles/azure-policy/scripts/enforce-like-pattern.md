---
title: Ukázka kódu JSON pro Azure Policy – Vynucení vzoru like | Microsoft Docs
description: Tato ukázková zásada JSON vyžaduje, aby prostředky při vytváření názvů splňovaly vzor like.

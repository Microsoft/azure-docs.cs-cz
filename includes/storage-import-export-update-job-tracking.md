...
5. Sledujte průběh úloh na řídicím panelu portálu. Popis jednotlivých stavů úloh najdete v části [zobrazení stavu úlohy](../articles/import-export/storage-import-export-view-drive-status.md).

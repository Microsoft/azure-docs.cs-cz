...
* [Rozhraní příkazového řádku Azure](https://docs.microsoft.com/cli/azure/cognitiveservices#az-cognitiveservices-list)
...
|Jazyk |Referenční dokumentace|Balíček|Ukázky|Rychlý start|
|--|--|--|--|--|

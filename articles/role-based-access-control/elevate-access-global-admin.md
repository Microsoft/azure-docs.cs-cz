...
![Globální správce Azure AD centra pro správu – vlastnosti – Spravovat předplatné Azure – snímek obrazovky](./media/elevate-access-global-admin/aad-azure-portal-global-admin-can-manage-azure-subscriptions.png)
...
- Další informace o [Správa řízení přístupu na základě rolí pomocí REST](role-assignments-rest.md)

- [Spravovat přístup k přiřazení](role-assignments-users.md) na portálu Azure

...
V definici obsahu změňte hodnotu `LoadUri` na `https://<app_name>.azurewebsites.net/home/unified`. Vaše vlastní zásady `ContentDefinition` by měly vypadat jako následující fragment kódu:

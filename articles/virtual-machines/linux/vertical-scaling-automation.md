---
title: Vertikální škálování virtuálního počítače Azure pomocí Azure Automation | Microsoft Docs
description: Jak vertikálně škálovat virtuální počítač se systémem Linux v reakci na monitorování výstrah pomocí Azure Automation
...
ms.locfileid: "70103524"
---
# <a name="vertically-scale-azure-linux-virtual-machine-with-azure-automation"></a>Vertikální škálování virtuálního počítače Azure Linux pomocí Azure Automation
...
První věc, kterou potřebujete udělat, je vytvořit účet Azure Automation, který bude hostovat Runbooky používané pro škálování instancí sady škálování virtuálního počítače. Nedávno Služba Automation zavedla funkci "účet Spustit jako", která umožňuje nastavit instanční objekt pro automatické spouštění Runbooků v zastoupení uživatele velmi snadné. Další informace si můžete přečíst v článku níže:

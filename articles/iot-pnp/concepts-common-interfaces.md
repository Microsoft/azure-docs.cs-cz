...
| Name | ID | Description | Implementované sadou Azure IoT SDK | Musí se deklarovat v modelu schopností. |
| -------- | -------- | -------- | -------- | -------- | -------- |
...
| Digital Twins | urn: azureiot: ModelDiscovery: DigitalTwin: 1 | Pro vývojáře řešení můžete načíst ID modelu schopností a ID rozhraní pro digitální vlákna. Toto rozhraní není deklarované nebo implementované zařízením IoT technologie Plug and Play. | No | No |

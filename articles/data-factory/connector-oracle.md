...
-   Použití **TLS**:
    ...
    2.  `keystore` Sestavte `truststore`nebo. Následující příkaz vytvoří `truststore` soubor s heslem ve formátu PKCS-12 nebo bez něj.
...
Chcete-li kopírovat data z Oracle, nastavte typ zdroje v aktivitě kopírování `OracleSource`na. V části **zdroj** aktivity kopírování jsou podporovány následující vlastnosti.

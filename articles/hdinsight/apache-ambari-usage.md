...
Pokud chcete zjistit, která hlavnímu uzlu je aktivní, jedním ze způsobů, jak se jednat o jeden z uzlů v clusteru, a pak spusťte `ping headnodehost` a porovnejte IP adresu se dvěma hlavních.

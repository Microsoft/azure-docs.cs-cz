...
3. **[Vytvoření zkušebního uživatele Getabstract](#create-a-getabstract-test-user)**  – Pokud chcete mít protějšek Britta Simon Getabstract, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **Getabstract domény a adresy URL** části, proveďte následující kroky, pokud chcete nakonfigurovat aplikace v **IDP** iniciované režimu:
...
7. Ke konfiguraci jednotného přihlašování na **Getabstract** straně, je nutné odeslat na stažený **soubor XML s metadaty** k [tým podpory Getabstract](https://www.getabstract.com/en/contact). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

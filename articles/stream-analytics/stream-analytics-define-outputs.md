...
| Název serveru | Název logického serveru SQL nebo název spravované instance. Pro Azure SQL Database Managed instance je nutné zadat port 3342. Například *sampleserver. Public. Database. Windows. NET, 3342* |

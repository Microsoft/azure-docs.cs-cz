---
title: 'Kurz: Azure Active Directory integraci jednotného přihlašování s Whitesource | Microsoft Docs'
...
ms.locfileid: "92521608"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-whitesource"></a>Kurz: Azure Active Directory integraci jednotného přihlašování (SSO) s Whitesource
...
Ke konfiguraci jednotného přihlašování na straně **Whitesource** je potřeba odeslat stažený **certifikát (Base64)** a příslušné zkopírované adresy URL z Azure Portal do [týmu podpory Whitesource](https://www.whitesourcesoftware.com/contact-us/). Toto nastavení nastaví, aby bylo správně nastaveno připojení SAML SSO na obou stranách.
...
Když na přístupovém panelu kliknete na dlaždici Whitesource, měli byste se automaticky přihlásit k Whitesource, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).

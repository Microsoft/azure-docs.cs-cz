...
Aby bylo možné podporovat parametr pro zavěšení domén, můžete nakonfigurovat název domény pomocí `<Domain>domain name</Domain>` elementu XML Any `<ClaimsProvider>` .

...
1. V Průvodci plánováním zálohování vyberte **začít** > **Další**.
...
1. Na stránce **zvolit typ prvotní zálohy** rozhodněte, jestli chcete provést prvotní zálohování přes síť, nebo použijte offline zálohování. Chcete-li provést prvotní zálohování sítě, vyberte možnost **automaticky prostřednictvím sítě** > **Další**.

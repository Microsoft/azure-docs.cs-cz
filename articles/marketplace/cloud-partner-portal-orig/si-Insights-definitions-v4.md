...
| **Množství objednávky**                       | Množství objednávek pro stejnou SKU přidružené k předplatnému Azure.  Pro SAAS objednávky představuje počet míst přidružených k této instanci objednávky.                                            |
...
| **SKU**                                           | Název SKU, jak je definovaný během publikování. Nabídka může mít mnoho SKU, ale SKU může být přidruženo pouze k jedné nabídce.              |
...
| **Velikost virtuálního počítače**                                       | Představuje velikost hardwaru virtuálního počítače v souladu s nabídkou Azure. Mezi příklady patří `Basic_A0`, `Standard_A11`, `Standard_D12`a `Standard_G4`.   |
|  |  |

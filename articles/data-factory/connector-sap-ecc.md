...
|:--- |:--- |:--- |
| `type` | `type` Vlastnost musí být nastavena na `SapEcc`hodnotu. | Ano |
...
Chcete-li kopírovat data z SAP ECC, `type` nastavte vlastnost v `source` části aktivity kopírování na `SapEccSource`.

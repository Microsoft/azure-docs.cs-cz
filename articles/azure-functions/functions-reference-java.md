...
Verzi Java, která cílí na Maven Archetype, můžete řídit pomocí `-DjavaVersion` parametru. Hodnota tohoto parametru může být buď `8` nebo `11` . Podpora Java 11 je momentálně ve verzi Preview. 

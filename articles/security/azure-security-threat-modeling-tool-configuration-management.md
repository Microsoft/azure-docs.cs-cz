...
| **IoT Cloud Gateway** | <ul><li>[Ujistěte se, že Cloudová brána implementuje proces aktualizovat firmware připojená zařízení](#cloud-firmware)</li></ul> |
...
| **Použitelných technologiích** | Obecné |
| **Atributy**              | neuvedeno  |
| **Odkazy**              | [Přehled ladění ASP.NET](https://msdn2.microsoft.com/library/ms227556.aspx), [trasování – Přehled technologie ASP.NET](https://msdn2.microsoft.com/library/bb386420.aspx), [jak: Povolení trasování pro aplikaci ASP.NET](https://msdn2.microsoft.com/library/0x5wc973.aspx), [jak: Povolit ladění pro aplikace ASP.NET](https://msdn2.microsoft.com/library/e8z01xdh(VS.80).aspx) |
...
| **Použitelných technologiích** | Obecné |
| **Atributy**              | neuvedeno  |
| **Odkazy**              | [Aplikaci Internet Explorer 8 Část zabezpečení V: Komplexní ochranu](https://blogs.msdn.com/ie/archive/2008/07/02/ie8-security-part-v-comprehensive-protection.aspx), [typ MIME](https://en.wikipedia.org/wiki/Mime_type) |
...
| **Atributy**              | neuvedeno  |
| **Odkazy**              | [Povolení žádostí nepůvodního zdroje v rozhraní ASP.NET Web API 2](https://www.asp.net/web-api/overview/security/enabling-cross-origin-requests-in-web-api), [rozhraní ASP.NET Web API – podpora CORS v rozhraní ASP.NET Web API 2](https://msdn.microsoft.com/magazine/dn532203.aspx) |
...
**Přístup 2** povolení CORS v MVC: Vývojáři mohou použít konkrétní CORS na akce na kontroler nebo globálně pro všechny řadiče můžete také pomocí MVC.

### <a name="example"></a>Příklad:
Za akci: Zásady pro konkrétní akci k určení CORS přidejte atribut [EnableCors] na akci. Zadejte název zásady. 
```csharp

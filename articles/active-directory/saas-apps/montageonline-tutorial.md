...
1. Do vyhledávacího pole zadejte **Fotomontáž Online**vyberte **Fotomontáž Online** z panelu výsledků klikněte **přidat** tlačítko pro přidání aplikace.
...
1. **[Vytvoření zkušebního uživatele Fotomontáž Online](#create-a-montage-online-test-user)**  – Pokud chcete mít protějšek Britta Simon Fotomontáž online, který je propojený s Azure AD reprezentace uživatele.
...
1. Na **Fotomontáž Online domény a adresy URL** části, proveďte následující kroky:
...
1. Na **Online konfigurace Fotomontáž** klikněte na tlačítko **konfigurace Online Fotomontáž** otevřete **nakonfigurovat přihlašování** okno. Kopírovat **URL odhlašování SAML Entity ID a SAML jednotné přihlašování – adresa URL služby** z **Stručná referenční příručka oddílu.**

    ![Konfigurace Online Fotomontáž](./media/montageonline-tutorial/tutorial_montageonline_configure.png) 

1. Ke konfiguraci jednotného přihlašování na **Fotomontáž Online** straně, je nutné odeslat na stažený **certifikát (Base64), URL odhlašování, SAML Entity ID a SAML jednotné přihlašování – adresa URL služby** k [Fotomontáž Tým podpory online](https://www.montage.co.nz/contact-us/). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.
...
1. V seznamu aplikací vyberte **Fotomontáž Online**.

...
Pokud chcete nakonfigurovat jednotné přihlašování v **areálu pro kavárny** , je potřeba odeslat stažený **soubor XML federačních metadat** a příslušné zkopírované adresy URL z Azure Portal [týmu podpory pro Campy](mailto:support@campuscafesoftware.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

### <a name="create-campus-cafe-test-user"></a>Vytvoření testovacího uživatele pro areál Cafe

V této části vytvoříte v areálu kavárny uživatele s názvem B. Simon. Pracujte s [týmem podpory v areálovém kavárně](mailto:support@campuscafesoftware.com) a přidejte uživatele na platformu Campy kavárny. Uživatelé musí vytvořit a aktivovat, než použití jednotného přihlašování.

## <a name="test-sso"></a>Test SSO 

V této části Testování služby Azure AD jednotné přihlašování – konfigurace pomocí přístupového panelu.

Když kliknete na dlaždici Campy na přístupovém panelu, měli byste se automaticky přihlásit k školní kavárně, pro kterou jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

...
* **Využití u různých typů nabídek** – informace o využití jsou dostupné pro různé typy nabídek, například nabídky s průběžnými platbami, MSDN, Azure Prepayment (dřív označovaný jako peněžní závazek), kredit Azure Prepaymentu a smlouvy EA, s výjimkou [CSP](/partner-center).
...
* **Podpora nabídek s průběžnými platbami, MSDN, Azure Prepayment a s kreditem Azure Prepaymentu (nepodporují se programy EA a [CSP](/partner-center))** – toto rozhraní API poskytuje informace o sazbách na úrovni nabídek Azure.  Volající tohoto rozhraní API musí k zobrazení podrobností o prostředcích a sazeb zadat informace o nabídce. V tuto chvíli nemůžeme poskytovat sazby pro smlouvy EA, protože nabídky smluv EA mají vlastní sazby.

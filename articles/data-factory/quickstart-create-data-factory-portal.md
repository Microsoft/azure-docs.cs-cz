...
1. Kliknutím na **Ověřit** na panelu nástrojů kanálu nad plátnem ověřte nastavení kanálu. Ověřte úspěšné ověření kanálu. Pokud chcete zavřít výstup ověřování, vyberte tlačítko **>>** (šipky doprava). 
   ![ověřit](./media/quickstart-create-data-factory-portal/pipeline-validate.png) kanálu
...
1. Před aktivací kanálu je nutné publikovat entity do služby Data Factory. Pro publikování vyberte v horní části **publikovat vše** . 
    ![publikovat všechny](./media/quickstart-create-data-factory-portal/publish-all.png)

---
title: 'Kurz: Integrace Azure Active Directory s Academyem docházky | Microsoft Docs'
...
ms.locfileid: "68641157"
---
# <a name="tutorial-integrate-academy-attendance-with-azure-active-directory"></a>Kurz: Integrace Academy s Azure Active Directory
...
2. **[NAKONFIGURUJTE jednotné](#configure-academy-attendance-sso)** přihlašování Academy – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
...
5. **[Vytvořit testovacího uživatele pro Academy docházky](#create-academy-attendance-test-user)** – Pokud chcete mít protějšek B. Simon v Academy docházkě, která je propojená s reprezentací uživatele v Azure AD.
...
1. Aplikace Academy docházky očekává kontrolní výrazy SAML v určitém formátu. Pro tuto aplikaci nakonfigurujte následující deklarace identity. Hodnoty těchto atributů můžete spravovat v části **atributy uživatele** na stránce integrace aplikací. Následující snímek obrazovky ukazuje, jak nakonfigurovat kontrolní výrazy:
...
V této části se ve Academy docházky vytvoří uživatel s názvem B. Simon. Docházka Academy podporuje zřizování uživatelů za běhu, což je ve výchozím nastavení povolené. V této části není žádná položka akce. Pokud uživatel ještě v Academy Docházkě neexistuje, vytvoří se po ověření nový.

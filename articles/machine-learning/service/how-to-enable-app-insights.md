...
`00.Getting Started/13.enable-app-insights-in-production-service.ipynb` Poznámkový blok ukazuje koncepty v tomto článku.  Získáte tento poznámkový blok:

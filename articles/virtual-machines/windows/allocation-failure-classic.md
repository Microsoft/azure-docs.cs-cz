---
title: Řešení potíží s přidělováním virtuálního počítače Windows Azure v modelu nasazení classic | Microsoft Docs
description: Řešení potíží s přidělením při vytváření, restartování nebo změně velikosti klasické virtuální počítač s Windows v Azure

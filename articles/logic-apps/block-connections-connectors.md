...
1. Přejděte na [seznam konektorů Logic Apps](https://docs.microsoft.com/connectors/connector-reference/connector-reference-logicapps-connectors).

1. Vyhledejte referenční stránku pro konektor, který chcete blokovat.

   Například pokud chcete blokovat konektor Instagramu, přejít na tuto stránku: 
...
1. V části **definice zásad**zadejte informace o definici zásady na základě vlastností popsaných v tomto příkladu:
   ...
   | **Vynucování zásad** | Ano | **Povoleno** | Toto nastavení určuje, jestli se má při ukládání vaší práce povolit nebo zakázat definici zásady. |
   ||||
...
1. V části **základy**zadejte tyto informace pro přiřazení zásady:
   ...
   |----------|----------|-------------|
   | **Scope** | Ano | Prostředky, u kterých chcete vynutilit přiřazení zásady. <p><p>1. vedle pole **obor** vyberte tlačítko se třemi tečkami (**...**). <br>2. v seznamu **předplatné** vyberte předplatné Azure. <br>3. v seznamu **Skupina prostředků** vyberte skupinu prostředků. <br>4. Jakmile budete hotovi, vyberte **Vybrat**. |
   ...
   | **Vynucování zásad** | Ano | Nastavení, které povoluje nebo zakazuje přiřazení zásady |

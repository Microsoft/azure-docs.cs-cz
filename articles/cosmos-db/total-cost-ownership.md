...
* **Používá jednotnou měnu pro různé úlohy:** Na rozdíl od alternativních nabídek v Azure Cosmos DB nemusíte segmentovat úlohy, například na čtení a zápis. Nebo zřízení propustnosti u jednotlivých typů úloh, které jsou propustnost čtení a propustnost zápisu. V Azure Cosmos DB je zajištěná propustnost vyhrazena pomocí sjednocené a normalizované měny v souvislosti s jednotkami požadavků nebo RU/s. Azure Cosmos DB nenutí přiřadit prioritu vašim úlohám, provádět plánování kapacity nebo platit za každý typ kapacity. zvlášť. Takový přístup umožňuje snadno zamezit stejné RU/s mezi různými typy operací a úloh.

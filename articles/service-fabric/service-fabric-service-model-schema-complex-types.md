...
Režim izolace pro kontejner. Platné hodnoty jsou Default, Process nebo Hyper-V (podporuje se jenom pro kontejnery Windows).
...
Deklaruje značky požadované pro umístění služby. Užitečné pro dynamické ovlivňování umístění služby. 
...
Deklaruje značky požadované pro umístění a spuštění služby. Užitečné pro dynamické ovlivňování umístění služby a provozu. 

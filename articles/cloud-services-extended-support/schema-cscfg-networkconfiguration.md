---
title: Azure Cloud Services (Rozšířená podpora) schéma NetworkConfiguration | Microsoft Docs
description: Informace týkající se schématu konfigurace sítě pro Cloud Services (Rozšířená podpora)
ms.topic: article
...
`NetworkConfiguration`Element konfiguračního souboru služby určuje Virtual Network a hodnoty DNS. Tato nastavení jsou volitelná pro Cloud Services.
...
- [Vytvořte Virtual Network](https://docs.microsoft.com/azure/virtual-network/manage-virtual-network).

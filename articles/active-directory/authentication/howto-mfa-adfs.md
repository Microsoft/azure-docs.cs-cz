...
1. Otevřete správu služby AD FS.
2. Na levé straně vyberte **Vztahy důvěryhodnosti předávající strany**.
3. Klikněte pravým tlačítkem na **systém Microsoft Office 365 Identity Platform** a vyberte **upravit pravidla deklarace identity...** 
   ![konzole služby ADFS – upravte pravidla deklarace identity](./media/howto-mfa-adfs/trustedip1.png)

...
> [!NOTE]
> Tento článek se týká verze 1 služby Data Factory. Pokud používáte aktuální verze služby Data Factory, přečtěte si téma [odolnost proti chybám při aktivitě kopírování objektu pro vytváření dat](../copy-activity-fault-tolerance.md).

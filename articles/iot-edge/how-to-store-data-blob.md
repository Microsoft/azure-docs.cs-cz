...
Ne všechny operace úložiště objektů Blob v Azure jsou podporovány službou Azure Blob Storage na hraničních zařízeních IoT. Následující části podrobně popisují operace, které nejsou podporovány. 

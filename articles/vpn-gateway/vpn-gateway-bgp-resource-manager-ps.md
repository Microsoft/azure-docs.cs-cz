---
title: 'Konfigurace protokolu BGP u bran Azure VPN Gateway: Správce prostředků: PowerShell | Microsoft Docs'
...
## <a name ="enablebgp"></a>Část 1 – konfigurace protokolu BGP na Azure VPN Gateway
...
* Nainstalujte rutiny Azure Resource Manager PowerShellu. Další informace o instalaci rutin PowerShellu najdete v tématu [Instalace a konfigurace Azure PowerShellu](/powershell/azure/overview). 
...
## <a name ="v2vbgp"></a>Část 3 – vytvoření připojení typu VNet-to-VNet s protokolem BGP

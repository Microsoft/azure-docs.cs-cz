...
description: V tomto článku se seznámíte s tipy pro vytvoření souboru řešení pro správu. Podívejte se, jak pracovat se zdroji dat, Runbooky, zobrazeními a výstrahami.
ms.subservice: ''
ms.topic: conceptual
author: bwren
ms.author: bwren

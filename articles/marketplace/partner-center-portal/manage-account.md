...
- Potvrďte své ID Symantec, ID prodejce, ID MPN, ID vydavatele a kontaktní údaje, včetně schvalovatele společnosti a kontaktu prodejce.
...
3. Po zobrazení výzvy se přihlaste pomocí účtu Microsoft (MSA). Tento účet už nemůže být přidružený k jinému účtu partnerského centra.
4. Pokud chcete dokončit nastavení svého účtu druhu, odhlaste se úplně od partnerského centra a pak se znovu přihlaste pomocí účtu Microsoft (místo pracovního účtu).
...
Další informace o správě rolí a oprávnění v jiných oblastech partnerského centra, jako je Azure Active Directory (AD), zprostředkovatel Cloud Solution Provider (CSP), ovládací panel dodavatel (CPV), uživatelé typu Host nebo Microsoft Partner Network (MPN), najdete v tématu [přiřazení rolí uživatelů a oprávnění v partnerském centru](https://docs.microsoft.com/partner-center/permissions-overview).

...
Vyberte možnost **síť** > **rozbalte položku profily sítě** > **šifrování IKE** > **Přidat**, nakonfigurujte následující pole a klikněte na tlačítko **OK**.
...
Vyberte **network** > **rozbalte profily sítě** > **brány IKE** > **Přidat**, nakonfigurujte následující pole a klikněte na **OK**.
...
Vyberte možnost **síť** > **rozbalte položku profily sítě** > **šifrování IPSec** > **Přidat**, nakonfigurujte následující pole a klikněte na tlačítko **OK**.
...
Vyberte možnost **síť** > **rozbalte položku profily sítě** > **monitorování** > **Přidat**, nakonfigurujte následující pole a klikněte na tlačítko **OK**.

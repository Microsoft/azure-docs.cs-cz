...
| Diagnostika | [Azure Monitor multidimenzionální metriky](../articles/load-balancer/load-balancer-standard-diagnostics.md) | [Protokoly Azure Monitoru](../articles/load-balancer/load-balancer-monitor-log.md) |

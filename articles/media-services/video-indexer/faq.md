...
Video Indexer podporuje většinu běžných formátů médií. Další podrobnosti najdete v seznamu [formátů Azure Media Encoder Standard](../latest/encode-media-encoder-standard-formats-reference.md) .

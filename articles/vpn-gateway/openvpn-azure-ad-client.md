...
Profil můžete importovat z příkazového řádku tak, že umístíte stažený soubor **azurevpnconfig. XML** do složky **%USERPROFILE%\appdata\local\packages\microsoft. AzureVpn_8wekyb3d8bbwe \localstate** a spustíte následující příkaz:

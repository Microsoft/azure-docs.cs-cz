...
- Při zpracování úloh nízké úrovně, jako například [shromažďování diagnostických protokolů](https://docs.microsoft.com/azure/azure-stack/azure-stack-diagnostics#log-collection-tool).

---
title: 'Kurz: Integrace Azure Active Directory s CylancePROTECT | Dokumentace Microsoftu'
...
* Můžete povolit uživatelům být automaticky přihlášeni k CylancePROTECT (Single Sign-On) s jejich účty Azure AD.
...
* Podporuje CylancePROTECT **IDP** jednotné přihlašování zahájené pomocí
...
4. Do vyhledávacího pole zadejte **CylancePROTECT**vyberte **CylancePROTECT** z panelu výsledků klikněte **přidat** tlačítko pro přidání aplikace.

     ![CylancePROTECT v seznamu výsledků](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurace a otestování služby Azure AD jednotného přihlašování

V této části je konfigurace a testování Azure AD jednotné přihlašování pomocí CylancePROTECT podle testovacího uživatele volá **Britta Simon**.
Pro jednotné přihlašování pro práci je potřeba navázat vztah odkazu mezi uživatele služby Azure AD a související uživatelské v CylancePROTECT.
...
2. **[Konfigurace CylancePROTECT Single Sign-On](#configure-cylanceprotect-single-sign-on)**  – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
3. **[Vytvořit testovacího uživatele Azure AD](#create-an-azure-ad-test-user)**  – Pokud chcete otestovat Azure AD jednotné přihlašování s Britta Simon.
4. **[Přiřadit uživatele Azure AD](#assign-the-azure-ad-test-user)**  – Pokud chcete povolit Britta Simon používat Azure AD jednotného přihlašování.
5. **[Vytvořit testovacího uživatele CylancePROTECT](#create-cylanceprotect-test-user)**  – Pokud chcete mít protějšek Britta Simon CylancePROTECT, který je propojený s Azure AD reprezentace uživatele.
...
1. V [webu Azure portal](https://portal.azure.com/)na **CylancePROTECT** integrace stránce aplikace vyberte **jednotného přihlašování**.
...
4. Na **nastavte si jednotné přihlašování pomocí SAML** klikněte na **upravit** tlačítko Otevřít **základní konfiguraci SAML** dialogového okna.
    ...
    ![CylancePROTECT domény a adresy URL jednotného přihlašování – informace](common/idp-intiated.png)
...
6. Na **nastavení CylancePROTECT** tématu, zkopírujte příslušné adresy URL podle vašich požadavků.
...
### <a name="configure-cylanceprotect-single-sign-on"></a>Konfigurace CylancePROTECT jednotné přihlašování

Ke konfiguraci jednotného přihlašování na **CylancePROTECT** straně, je nutné odeslat na stažený **certifikát (Base64)** a odpovídající zkopírovány adresy URL z webu Azure portal do konzoly správce. Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.
...
1. Na webu Azure Portal, vyberte **podnikové aplikace**vyberte **všechny aplikace**a pak vyberte **CylancePROTECT**.
...
### <a name="create-cylanceprotect-test-user"></a>Vytvoření CylancePROTECT testovacího uživatele
...
Po kliknutí na dlaždici CylancePROTECT na přístupovém panelu, můžete by měl být automaticky přihlášeni k CylancePROTECT, u kterého nastavíte jednotné přihlašování. Další informace o přístupovém panelu, naleznete v tématu [Úvod k přístupovému panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

...
- **Načíst stav šifrování pro sadu virtuálních počítačů**: Použití [Get-AzureRmVmssVMDiskEncryption](/powershell/module/azurerm.compute/get-azurermvmssvmdiskencryption) rutiny.

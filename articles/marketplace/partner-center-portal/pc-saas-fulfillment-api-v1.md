---
title: Splnění SaaS API v1 | Azure Marketplace
description: Vysvětluje, jak vytvářet a spravovat nabídky SaaS na Azure Marketplace pomocí přidružené rozhraní API pro splnění v1.
...
> [!WARNING]
> Tato počáteční verze rozhraní API pro splnění SaaS je zastaralá; Místo toho použijte [API V2 SaaS splnění](./pc-saas-fulfillment-api-v2.md).  Tato počáteční verze rozhraní API v současné době se spravují pouze k poskytování existujících vydavatelů. 

...
2. Vytvořte uživatele v privátním cloudu pro replikaci vSphere a instalaci SRM. V [uživatelském rozhraní vCenter je vysvětleno níže: Vytvořte uživatele v privátním cloudu pro instalaci](#vcenter-ui-create-a-user-in-private-cloud-for-vra-and-srm-installation)vRA & SRM.
...
5. Nakonfigurujte pravidla brány firewall pro vRA. Vysvětleno níže [v portálu CloudSimple: Nakonfigurujte pravidla brány firewall pro](#cloudsimple-portal-configure-firewall-rules-for-vra)vRA.
...
#### <a name="vcenter-ui-create-a-user-in-private-cloud-for-vra-and-srm-installation"></a>uživatelské rozhraní vCenter: Vytvoření uživatele v privátním cloudu pro vRA a instalaci SRM
...
1. [uživatelské rozhraní vCenter: Nainstalovat SRM](#vcenter-ui-install-srm)

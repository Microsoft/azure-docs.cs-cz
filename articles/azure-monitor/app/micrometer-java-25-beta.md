...
* Azure-jaře-Boot-Metrics – starts 2.0.7 nebo vyšší  
...
* Application Insights 2.5.0 Web auto-BETA nebo vyšší
* 1\.1.0 nebo novější v registru mikroměřiče Azure
* [Prostředek Application Insights](../../azure-monitor/app/create-new-resource.md )
...
* Další informace o jaře v Azure najdete v [dokumentaci k Azure](https://docs.microsoft.com/java/azure/spring-framework/?view=azure-java-stable)oficiální na jaře.

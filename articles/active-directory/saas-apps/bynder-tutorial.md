...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/bynder-tutorial/tutorial_bynder_samlbase.png)
...
3. Na **Bynder domény a adresy URL** část, proveďte následující kroky, pokud chcete nakonfigurovat aplikace **IDP** iniciované režimu:
    ...
    ![Bynder domény a adresy URL jednotné přihlašování informace](./media/bynder-tutorial/tutorial_bynder_url.png)
...
4. Zkontrolujte **zobrazit upřesňující nastavení adresy URL** a provést následující krok, pokud chcete nakonfigurovat aplikace **SP** iniciované režimu:
    ...
    ![Bynder domény a adresy URL jednotné přihlašování informace](./media/bynder-tutorial/tutorial_bynder_url1.png)
...
6. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/bynder-tutorial/tutorial_general_400.png)
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/bynder-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **Bynder**.
    ...
    ![V seznamu aplikací na Bynder odkaz](./media/bynder-tutorial/tutorial_bynder_app.png)  

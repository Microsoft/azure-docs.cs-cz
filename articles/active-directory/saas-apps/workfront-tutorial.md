...
2. **[Nakonfigurujte jednotné přihlašování Workfront](#configure-workfront-single-sign-on)** – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
...
### <a name="configure-workfront-single-sign-on"></a>Konfigurace jednotného přihlašování Workfront
...
Když na přístupovém panelu kliknete na dlaždici Workfront, měli byste se automaticky přihlásit k Workfront, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

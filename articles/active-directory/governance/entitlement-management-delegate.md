...
| Úkol | Tvůrce katalogu | Vlastník katalogu | Správce přístupu k balíčku | Schvalovatele |
| --- | :---: | :---: | :---: | :---: |
...
| [Vytvořit nový balíček pro přístup do katalogu](entitlement-management-access-package-create.md) |  | :heavy_check_mark: |  |  |

...
[Vytvořte kolekci pro Azure Cosmos DB rozhraní API MongoDB pomocí šablony Správce prostředků](manage-sql-with-resource-manager.md#azure-cosmos-account-with-standard-provisioned-throughput).

...
2. Vyberte **vytvořit**  >  **Management**  >  **Backup a Site Recovery (OMS)** správy prostředků. Případně můžete vybrat **Procházet**  >  **Recovery Services trezor**  >  **Přidat**.
   >[!NOTE]

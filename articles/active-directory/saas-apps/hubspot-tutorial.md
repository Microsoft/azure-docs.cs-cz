...
3. **Vytvoření zkušebního uživatele HubSpot** – Pokud chcete mít protějšek Britta Simon HubSpot, který je propojený s Azure AD reprezentace uživatele.

...
1. Přejít na kartu **poznámkové bloky** , vyberte `…` vedle **poznámkových bloků** a vytvořte **Nový Poznámkový blok**. Jako výchozí jádro vyberte **Python 3** .

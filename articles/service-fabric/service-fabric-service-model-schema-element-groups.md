---
title: Skupiny prvků schématu xml modelu služby Azure Service Fabric
description: Popisuje skupiny prvků ve schématu XML modelu služby Service Fabric.
ms.topic: reference
ms.date: 12/10/2018
...
ms.locfileid: "79282078"
---
<!-- This article was generated by the Python script found in the service-fabric-service-model-schema.md file -->

# <a name="service-fabric-service-model-xml-schema-elements"></a>Prvky schématu XML modelu služby Service Fabric

## <a name="partitiondescriptiongroup-group"></a>Skupina PartitionDescriptionGroup
Definuje schéma dělení pro službu.
...
#### <a name="uniformint64partition"></a>UniformInt64Oddíl
...
#### <a name="namedpartition"></a>Pojmenovanýoddíl
...
## <a name="scalingpolicymechanismgroup-group"></a>Skupina ScaleingPolicyMechanismGroup
Definuje mechanismus škálování.
...
#### <a name="addremoveincrementalnamedpartitionscalingmechanism"></a>AddRemoveRemoveIncrementalNamedPartitionScaleingMechanism
...
## <a name="scalingpolicytriggergroup-group"></a>Skupina ScaleingPolicyTriggerGroup
Definuje aktivační událost škálování.

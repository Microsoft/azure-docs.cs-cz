---
title: Jak nakonfigurovat podrobnosti seznamu nabídky aplikací Azure
description: Naučte se konfigurovat podrobnosti výpisu pro nabídku aplikací Azure v partnerském centru.
author: aarathin
ms.author: aarathin
...
ms.locfileid: "94370112"
---
# <a name="how-to-configure-your-azure-application-offer-listing-details"></a>Jak nakonfigurovat podrobnosti seznamu nabídky aplikací Azure

Informace, které zadáte na stránce **seznam nabídek** pro vaši nabídku aplikace Azure, se zobrazí v online obchodech Microsoft Commercial Marketplace. Patří sem popisy vaší nabídky, obrazovek a vašich marketingových assetů. Pokud se chcete podívat, jak to vypadá, podívejte se na [Podrobnosti o seznamu nabídky](plan-azure-application-offer.md#offer-listing-details).

> [!NOTE]
> Obsah nabídky (například popis, dokumenty, snímky obrazovky a podmínky použití) není nutné v angličtině, pokud popis nabídky začíná frází "Tato aplikace je k dispozici pouze v [jazykovém jazyce, který není v angličtině]." Je také přijatelné poskytnout _užitečnou_ adresu URL pro odkaz k poskytnutí obsahu v jiném jazyce, než který je použit v obsahu nabídky.
...
1. Pole **název** je předem vyplněno názvem, který jste zadali dříve v dialogovém okně **Nová nabídka** . Název můžete kdykoli změnit. Název, který sem zadáte, se zákazníkům zobrazí jako název seznamu nabídek.
1. V poli **Souhrn výsledků hledání** zadejte až 100 znaků textu. Tento souhrn se používá ve výsledcích hledání ve výpisu na webu Marketplace.
1. Do pole **krátký popis** zadejte až 256 znaků prostého textu. Tento souhrn se zobrazí na stránce podrobností vaší nabídky.
...
1. Volitelné Do polí **hledaná klíčová slova** zadejte až tři klíčová slova pro hledání, která zákazníci můžou použít k vyhledání vaší nabídky na komerčním webu Marketplace. Nemusíte zahrnovat **název** a **Popis** nabídky, protože tento text je automaticky zahrnutý do hledání.
...
1. V polích, která se zobrazí, zadejte název (až 255 znaků) a odkaz (začínající na `https://` ) do online dokumentu.
...
## <a name="add-marketplace-media"></a>Přidat médium Marketplace
...
Přidejte až pět snímků obrazovky, které ukazují vaši nabídku. Všechny obrázky musí mít velikost 1280 × 720 pixelů a v. Formát PNG.

1. V části **snímky obrazovky** přetáhněte své umístění. Soubor PNG do pole **snímku obrazovky** .
1. Vedle pole **Přidat titulek obrázku** klikněte na ikonu Upravit.
1. V dialogovém okně, které se zobrazí, zadejte titulek a klikněte na tlačítko **OK**.
1. Opakováním kroků 1 až 3 přidejte další snímky obrazovky.
...
1. Do polí, která se zobrazí, zadejte název a odkaz na své video.
1. Přetáhněte. Soubor PNG (1280 x 720 pixelů) do pole s šedým **miniaturou** .
1. Pokud chcete přidat další video, opakujte kroky 1 až 3.
...
- [Jak přidat cílovou skupinu Preview pro nabídku aplikací Azure](create-new-azure-apps-offer-preview.md)

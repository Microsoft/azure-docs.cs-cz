...
Další informace o vytváření privátních koncových bodů v PowerShellu najdete v tomto [rychlém startu privátního propojení](../private-link/create-private-endpoint-cli.md) .

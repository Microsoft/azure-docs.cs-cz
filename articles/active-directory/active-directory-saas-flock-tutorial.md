...
4. Do vyhledávacího pole zadejte **hejna**, vyberte **hejna** z panelu výsledků klikněte **přidat** tlačítko Přidat aplikaci.
    ...
    ![Hejno v seznamu výsledků](./media/active-directory-saas-flock-tutorial/tutorial_flock_addfromgallery.png)
...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/active-directory-saas-flock-tutorial/tutorial_flock_samlbase.png)

3. Na **hejna domény a adresy URL** část, proveďte následující kroky:

    ![Hejna domény a adresy URL jednotné přihlašování informace](./media/active-directory-saas-flock-tutorial/tutorial_flock_url.png)
...
4. Na **SAML podpisový certifikát** klikněte na tlačítko **Certificate(Base64)** a potom uložte soubor certifikátu v počítači.
    ...
    ![Odkaz ke stažení certifikátu](./media/active-directory-saas-flock-tutorial/tutorial_flock_certificate.png)

5. Klikněte na tlačítko **Uložit** tlačítko.

    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/active-directory-saas-flock-tutorial/tutorial_general_400.png)
...
6. Na **hejna konfigurace** klikněte na tlačítko **konfigurace hejna** otevřete **konfigurovat přihlášení** okno. Kopírování **SAML Entity ID a SAML jeden přihlašování adresu URL služby** z **Stručná referenční příručka části.**
    ...
    ![Konfigurace hejna](./media/active-directory-saas-flock-tutorial/tutorial_flock_configure.png) 
...
8. Vyberte **ověřování** z levém navigačním panelu a pak vyberte **ověřování SAML**.
    ...
    ![Konfigurace hejna](./media/active-directory-saas-flock-tutorial/configure1.png)

9. V **ověřování SAML** část, proveďte následující kroky:

    ![Konfigurace hejna](./media/active-directory-saas-flock-tutorial/configure2.png)
...
1. Na portálu Azure, v levém podokně klikněte **Azure Active Directory** tlačítko.
    ...
    ![Tlačítko Azure Active Directory](./media/active-directory-saas-flock-tutorial/create_aaduser_01.png)

2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.

    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/active-directory-saas-flock-tutorial/create_aaduser_02.png)

3. Chcete-li otevřít **uživatele** dialogové okno, klikněte na tlačítko **přidat** v horní části **všichni uživatelé** dialogové okno.

    ![Tlačítko Přidat](./media/active-directory-saas-flock-tutorial/create_aaduser_03.png)

4. V **uživatele** dialogové okno pole, proveďte následující kroky:

    ![Dialogové okno uživatele](./media/active-directory-saas-flock-tutorial/create_aaduser_04.png)
...
2. Klikněte na tlačítko **spravovat Team** z levého navigačního panelu.
    ...
    ![Můžete přidat zaměstnance](./media/active-directory-saas-flock-tutorial/user1.png)

3. Klikněte na tlačítko **přidat člena** a pak vyberte **členové týmu**.

    ![Můžete přidat zaměstnance](./media/active-directory-saas-flock-tutorial/user2.png)

4. Zadejte e-mailovou adresu uživatele, jako je **Brittasimon@contoso.com** a pak vyberte **přidat uživatele**.

    ![Můžete přidat zaměstnance](./media/active-directory-saas-flock-tutorial/user3.png)
...
2. V seznamu aplikací vyberte **hejna**.
    ...
    ![V seznamu aplikací na hejna odkaz](./media/active-directory-saas-flock-tutorial/tutorial_flock_app.png)

...
* [Řešení potíží s Azure VPN Gateway pomocí diagnostických protokolů](troubleshoot-vpn-with-azure-diagnostics.md)<br>Pomocí diagnostických protokolů můžete řešit problémy s více souvisejícími událostmi služby VPN Gateway, včetně konfigurační aktivity, tunelového připojení VPN, protokolování IPsec, výměn tras protokolu BGP, přechodem na rozšířené protokolování lokality. 

...
- [Vytváření výstrah](sql-database-managed-instance-alerts.md) vám umožní nastavit upozornění na monitorované metriky, jako je využití procesoru, spotřeba prostoru úložiště, IOPS a další pro spravovanou instanci. V této příručce se dozvíte, jak povolit a konfigurovat výstrahy pro spravovanou instanci.

...
Chcete-li odebrat skupinu prostředků, použijte příkaz [az group delete](/cli/azure/group#az_group_delete). Odvolání, které `$resourceGroup` bylo nastaveno na **ContosoResourcesMsgEn** na začátku tohoto kurzu.

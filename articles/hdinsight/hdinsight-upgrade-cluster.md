...
Další informace o zálohování a obnovení databáze najdete v tématu [obnovení databáze SQL Azure pomocí automatických záloh databáze](../azure-sql/database/recovery-using-backups.md).

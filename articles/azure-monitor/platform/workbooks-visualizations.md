...
| `Query` | Libovolný dotaz KQL, který vrací data ve formátu očekávaném vizualizací grafu | _požadavky \| požadavků řady = Count () výchozí = 0 v časovém razítku před (1d) do Now () krok 1H_ |
...
| `Color palette` | Paleta barev, která se má použít v grafu Ignoruje se, pokud se používá parametr `Split by`. | Modrá, zelená, červená atd. |
...
8. V **poli dlaždice**nastavte:
    * Název: `name`
    * Left: `Requests`, Renderer: `Big Number`, barevná paleta: `Green to Red`, minimální hodnota: `0`
    * Dolní: `appName`
...
10. V _nastavení formát uzlu_ v horní části nastavte:
    * _Top Content_-use column: `Name`, Renderer sloupce: `Text`
    * _Center Content_-use column: `Calls`, Renderer sloupců: `Big Number`, barevná paleta: `None`
    * _Dolní obsah_-použití sloupce: `Kind`, Renderer sloupce: `Text`

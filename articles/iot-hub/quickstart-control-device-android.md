...
V této části použijete Azure Cloud Shell s [rozšířením IoT](/cli/azure/ext/azure-iot/iot) k monitorování zpráv odesílaných zařízením s Androidem.

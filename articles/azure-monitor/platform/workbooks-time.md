---
title: Vytváření interaktivních sestav pomocí Azure Monitorch sešitů | Časové parametry | Dokumentace Microsoftu
...
2. Většina ovládacích prvků sešitu podporuje výběr oboru _časového rozsahu_ . Otevřete rozevírací seznam _časový rozsah_ a vyberte `{TimeRange}` ve skupině parametry časového rozsahu v dolní části.

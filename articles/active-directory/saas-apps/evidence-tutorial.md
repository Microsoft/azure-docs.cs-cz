...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/evidence-tutorial/tutorial_evidence.com_samlbase.png)

3. Na **Evidence.com domény a adresy URL** část, proveďte následující kroky:

    ![Evidence.com domény a adresy URL jednotné přihlašování informace](./media/evidence-tutorial/tutorial_evidence.com_url.png)
...
5. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/evidence-tutorial/tutorial_general_400.png)
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/evidence-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **Evidence.com**.
    ...
    ![V seznamu aplikací na Evidence.com odkaz](./media/evidence-tutorial/tutorial_evidence.com_app.png)  

...
Pokud chcete získat veřejnou IP adresu **myVM2**, použijte příkaz [AZ Network Public-IP show](/cli/azure/network/public-ip#az_network_public_ip_show):

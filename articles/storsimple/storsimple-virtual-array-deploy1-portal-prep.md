...
Pokud potřebujete k vytvoření účtu služby Azure storage v jiné oblasti, naleznete v tématu [způsob vytvoření účtu úložiště](../storage/common/storage-quickstart-create-account.md) podrobné pokyny.

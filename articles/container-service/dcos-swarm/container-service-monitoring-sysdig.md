...
[Nasaďte](container-service-deployment.md) a [připojte](../container-service-connect.md) cluster nakonfigurovaný službou Azure Container Service. Prozkoumejte [uživatelské rozhraní Marathon](container-service-mesos-marathon-ui.md). Pro [https://app.sysdigcloud.com](https://app.sysdigcloud.com) Nastavení cloudového účtu služby Sysdig použijte. 
...
Přístup k uživatelskému rozhraní DC/OS pomocí nástroje `http://localhost:80/` jednou v uživatelském rozhraní DC/OS přejděte do části "Universe", která je v levém dolním rohu, a pak vyhledejte "služby Sysdig".

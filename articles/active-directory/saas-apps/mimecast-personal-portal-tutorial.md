...
Po kliknutí na dlaždici osobního portálu Mimecast na přístupovém panelu byste měli být automaticky přihlášeni k osobnímu portálu Mimecast, pro který jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).
...
- [Ochrana osobního portálu Mimecast pomocí pokročilých viditelností a ovládacích prvků](/cloud-app-security/proxy-intro-aad)
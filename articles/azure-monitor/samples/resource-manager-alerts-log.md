...
## <a name="number-of-results-template-up-to-version-2018-04-16"></a>Počet šablon výsledků (až do verze 2018-04-16)
Následující ukázka vytvoří [počet pravidel upozornění výsledků](../platform/alerts-unified-log.md#count-of-the-results-table-rows).

### <a name="notes"></a>Poznámky

- Tato ukázka zahrnuje [datovou část Webhooku](../platform/alerts-log-webhook.md). Pokud pravidlo výstrahy nemá aktivovat Webhook, odeberte element **customWebhookPayload** .
...
## <a name="metric-measurement-template-up-to-version-2018-04-16"></a>Šablona měření metriky (až do verze 2018-04-16)
Následující ukázka vytvoří [pravidlo upozornění měření metriky](../platform/alerts-unified-log.md#calculation-of-measure-based-on-a-numeric-column-such-as-cpu-counter-value).
...
## <a name="template-for-all-resource-types-from-version-2020-05-01-preview"></a>Šablona pro všechny typy prostředků (z verze 2020-05-01-Preview)
Následující ukázka vytvoří pravidlo, které může cílit na libovolný prostředek.

...
Starší připojení partnerských vztahů můžete převést pomocí [vytvoření partnerského vztahu]( https://go.microsoft.com/fwlink/?linkid=2129593).

####  <a name="configure-basic-settings"></a>Konfigurace základního nastavení
>   ![Registrace služby Peering Service](./media/setup-basics-tab.png)

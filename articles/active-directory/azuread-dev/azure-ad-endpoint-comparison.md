...
Další informace o OAuth 2,0, `refresh_tokens`a `access_tokens`, najdete v referenčních informacích k [protokolu platformy Microsoft Identity Platform](../develop/active-directory-v2-protocols.md?toc=/azure/active-directory/azuread-dev/toc.json&bc=/azure/active-directory/azuread-dev/breadcrumb/toc.json).

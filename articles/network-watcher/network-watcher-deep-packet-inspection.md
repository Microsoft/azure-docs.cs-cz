...
Pomocí stejného zachycení v předchozím scénáři klikněte na **statistika** > **hierarchie protokolů** .
...
Pomocí stejného zachycení v předchozím scénáři klikněte na **statistika** > **Statistika IPv4** > **cíle a porty** .

...
| [Předdefinovaná role Přispěvatel služby vyhledávání](https://docs.microsoft.com/azure/active-directory/role-based-access-built-in-roles#search-service-contributor) | Ekvivalent k roli Přispěvatel. |
...
+ [Začínáme s řízením přístupu na základě rolí na portálu Azure](../active-directory/role-based-access-control-what-is.md).
...
Zatímco jiná řešení poskytují sadu funkcí, které zákazníkům umožňují vytvářet vlastní řešení, Azure Security Center pro IoT poskytují jedinečné komplexní řešení zabezpečení IoT, které poskytuje nejrůznější přehled o zabezpečení všech souvisejících prostředků Azure. Azure umožňuje rychlé nasazení a úplnou integraci s IoT Hubmi moduly, které umožňují snadnou integraci s existujícími nástroji pro správu zařízení.
...
1. Vytvořte vlastního agenta a implementujte Microsoft Azure Security Center schématu zprávy zabezpečení IoT. Tato možnost umožňuje použití Microsoft Azure Security Center pro nástroje pro analýzu IoT nad vaším agentem zabezpečení zařízení.
...
Azure Security Center for IoT Security Agent je open source a dostupný na GitHubu v 32 bitových a 64 verzích Windows a Linux: https://github.com/Azure/Azure-IoT-Security.
...
1. Ověřte, že je zařízení [nakonfigurované v IoT Hub s modulem Azure Security Center for IoT](quickstart-create-security-twin.md).

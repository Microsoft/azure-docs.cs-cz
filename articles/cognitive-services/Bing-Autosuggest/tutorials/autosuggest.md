...
Vytvořte formulář HTML s textovým polem. Zpracujte událost `oninput` a zavolejte funkci `bingAutosuggest()`, která předává obsah textového pole a rozhraní API pro automatické návrhy Binguho klíče.

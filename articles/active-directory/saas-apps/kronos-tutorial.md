---
title: 'Kurz: Azure Active Directory integrace jednotného přihlašování s Kronos | Microsoft Docs'
...
ms.locfileid: "68986254"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-kronos"></a>Kurz: Azure Active Directory integrace jednotného přihlašování s Kronos
...
1. **[Nakonfigurujte Kronos SSO](#configure-kronos-sso)** – pro konfiguraci nastavení jednotného přihlašování na straně aplikace.
...
Ke konfiguraci jednotného přihlašování na straně **Kronos** je potřeba odeslat stažený **soubor XML federačních metadat** a příslušné zkopírované adresy URL z Azure Portal do [týmu podpory Kronos](https://www.kronos.in/contact/en-in/form). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

### <a name="create-kronos-test-user"></a>Vytvořit testovacího uživatele Kronos

V této části vytvoříte uživatele s názvem Britta Simon v Kronos. Pokud chcete přidat uživatele na platformě Kronos, pracujte s [týmem podpory Kronos](https://www.kronos.in/contact/en-in/form) . Uživatelé musí vytvořit a aktivovat, než použití jednotného přihlašování.

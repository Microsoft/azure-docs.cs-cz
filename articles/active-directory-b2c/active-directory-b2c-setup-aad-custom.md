...
V tomto článku se dozvíte, jak povolit přihlášení uživatelů z Azure Active Directory (Azure AD) pomocí [vlastních zásad](active-directory-b2c-overview-custom.md) v Azure Active Directory B2C (Azure AD B2C).

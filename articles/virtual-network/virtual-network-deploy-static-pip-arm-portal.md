...
6. V **nastavení** podokně klikněte na tlačítko **veřejnou IP adresu**, potom v **vytvoření veřejné IP adresy** podokně v části **přiřazení**, klikněte na tlačítko  **Statické** následujícím způsobem. A pak klikněte na **OK**.

...
4. Do vyhledávacího pole zadejte **Kantega jednotné přihlašování pro Confluence**.
...
5. Na panelu výsledků vyberte **Kantega jednotné přihlašování pro Confluence**a potom klikněte na tlačítko **přidat** tlačítko pro přidání aplikace.
...
3. **[Vytváření Kantega jednotné přihlašování pro Confluence testovacího uživatele](#creating-a-kantega-sso-for-confluence-test-user)**  – Pokud chcete mít protějšek Britta Simon Kantega jednotné přihlašování pro Confluence, který je propojený s Azure AD reprezentace uživatele.
...
3. V **IDP** inicializovat v režimu **Kantega jednotné přihlašování pro Confluence domény a adresy URL** části provést následující krok:
...
7. V okně jiné webové prohlížeče, přihlaste se k vaší **portál pro správu Confluence** jako správce.
...
9. V části **od společnosti ATLASSIAN MARKETPLACE** klikněte na tlačítko **najít nové doplňky**. 

    ![Konfigurace jednotného přihlašování](./media/kantegassoforconfluence-tutorial/addon.png)

10. Hledání **Kantega jednotného přihlašování pro protokol Kerberos SAML Confluence** a klikněte na tlačítko **nainstalovat** tlačítko k instalaci nové zásuvný modul SAML.
...
16. V **SAML** oddílu. Vyberte **Azure Active Directory (Azure AD)** z **přidat zprostředkovatele identity** rozevíracího seznamu.

    ![Konfigurace jednotného přihlašování](./media/kantegassoforconfluence-tutorial/addon4.png)

17. Vyberte úroveň předplatného jako **základní**.

    ![Konfigurace jednotného přihlašování](./media/kantegassoforconfluence-tutorial/addon5.png)     

18. Na **vlastnosti aplikace** části, proveďte následující kroky: 
...
19. Na **import metadat** části, proveďte následující kroky: 
...
20. Na **název a jednotného přihlašování k umístění** části, proveďte následující kroky:
...
21. Ověřte podpisového certifikátu a klikněte na tlačítko **Další**.

    ![Konfigurace jednotného přihlašování](./media/kantegassoforconfluence-tutorial/addon9.png)

22. Na **Confluence uživatelské účty** části, proveďte následující kroky:
...
24. Na **známé domény pro službu Azure AD** části, proveďte následující kroky: 
...
3. V sekci uživatelé klikněte na možnost **Add Users** kartu. Na **"Přidat uživateli"** dialogového okna stránky, proveďte následující kroky:

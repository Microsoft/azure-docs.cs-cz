...
Přenosem zařízení do Azure AD maximalizujete produktivitu uživatelů díky jednotnému přihlašování ke cloudovým i místním prostředkům. At the same time, you can secure access to your cloud and on-premises resources with [Conditional Access](../active-directory-conditional-access-azure-portal.md).
...
|   |   |
| --- | --- |
| ![Zaškrtnout][1] | Review supported devices |
| ![Zaškrtnout][1] | Review things you should know |
| ![Zaškrtnout][1] | Review controlled validation of hybrid Azure AD join |
| ![Zaškrtnout][1] | Select your scenario based on your identity infrastructure |
| ![Zaškrtnout][1] | Review on-premises AD UPN support for hybrid Azure AD join |
...
| Type of on-premises AD UPN | Typ domény | Windows 10 version | Popis |
| ----- | ----- | ----- | ----- |
| Routable | Federated | From 1703 release | Generally available |
| Non-routable | Federated | From 1803 release | Generally available |
| Routable | Spravované | From 1803 release | Generally available, Azure AD SSPR on Windows lockscreen is not supported |
| Non-routable | Spravované | Nepodporováno | |

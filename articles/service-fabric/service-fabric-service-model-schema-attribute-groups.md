...
Tento typ aplikace, nestrukturovaných řetězec verze.
|Atribut|Hodnota|
|---|---|
...
Identifikátor manifest aplikace nestrukturovaných řetězec.
|Atribut|Hodnota|
|---|---|
|jméno|ID manifestu|
|Použití|nepovinné|
...
Název manifestu služby. Název musí odpovídat názvu deklarované v elementu ServiceManifest service manifest.
|Atribut|Hodnota|
|---|---|
...
Verze manifestu služby. Verze musí odpovídat verzi deklarované v manifestu služby.
|Atribut|Hodnota|
|---|---|

...
Postupujte podle pokynů a [Zaregistrujte novou jednu stránkovou aplikaci](https://docs.microsoft.com/azure/active-directory/develop/scenario-spa-app-registration).

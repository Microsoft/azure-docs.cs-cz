...
1. V navigační nabídce vlevo vyberte **obchodní Marketplace**  >  **Přehled**.
    > [!TIP]
    > Pokud nevidíte **komerční tržiště** v levém navigačním panelu, [Vytvořte si účet komerčního tržiště v partnerském centru](create-account.md) a ujistěte se, že je váš účet zaregistrovaný v programu komerčního tržiště.
...
Řešení oblastí řešení vám umožní dále definovat vaše řešení. Díky tomu můžou prodejní týmy Microsoftu najít a pochopit, jak se má vaše řešení vyhodnotit. Je nutné vybrat alespoň jednu a maximálně tři oblasti řešení pro vaši nabídku. Pro každou oblast řešení můžete dále zvolit až dvě dílčí oblasti řešení.

1. Vyberte odkaz **+ Přidat oblast řešení (3 max)** .
1. V rozevíracím seznamu, který se zobrazí, vyberte oblast řešení.
1. Vyberte alespoň jednu a až dvě dílčí oblasti řešení. Chcete-li vybrat více dílčích oblastí, použijte `Ctrl` klíč (ve Windows) nebo `Command` klíč (na MacOS).
1. Chcete-li přidat další oblast řešení, opakujte kroky 1 až 3.

## <a name="upload-documents"></a>Uložení dokumentů

Musíte poskytnout dokumentaci k dokumentaci, která poskytuje podrobné informace o vaší nabídce. Prodejní týmy Microsoftu tyto informace používají k vyhodnocení, jestli je vaše nabídka vhodná pro potřeby zákazníků, aby ji bylo možné doporučit a prodávat. Další informace, které poskytnete, budou mít další informace o produktu Microsoft Sales teams, které vám pomůžou pochopit a propagovat.

Podporované typy souborů jsou. PDF,. ppt,. pptx,. doc,. docx,. xls,. xlsx,. jpg,. png a. MP4. Šablony pro některé dokumenty jsou uvedené v tabulce 2 níže.

> [!NOTE]
> K dosažení stavu připraveného pro spoluprodejní verze je potřeba balíček **řešení nebo nabídky na jednom pageru** a **řešení/nabídky** . Jsou to také předpoklady pro některé nabídky, které mohou být ve spolupráci s Azure IP motivovaní. Diagram referenční architektury je také vyžadován pro motivovaní stav spoluprodejní služby Azure IP. Ostatní dokumenty popsané v této tabulce jsou volitelné, ale doporučené.

***Tabulka 2: dokumenty, které podporují společný prodej***

| **Dokumenty**    | **Popis**  |
| :------------------- | :-------------------|
| *Řešení/nabídka jeden – pager (povinné)* | Vyjistěte si povědomí mezi potenciálními zákazníky, kteří mají profesionálně navržený jeden pager, který prezentuje hodnoty jejich řešení.<br><br>Můžete použít jednu z odpovídajících šablon k poskytnutí popisu vaší nabídky připravené pro zákazníka:<br><ul><li> [Microsoft Azure šablonu s jedním stránkováním](https://aka.ms/Customer-One-Pager_MicrosoftAzure)</li><li>[Microsoft Dynamics 365 1 – Šablona stránkování](https://aka.ms/Customer-One-Pager_MicrosoftDynamics365)</li> <li>[Microsoft 365 1 – Šablona stránkování](https://aka.ms/Customer-One-Pager_MicrosoftOffice365) </li><li>[Windows 10 1 – Šablona stránkování](https://aka.ms/Customer-One-Pager_Windows)</li></ul> <br> Prodejní týmy Microsoftu můžou tyto informace sdílet se zákazníky, aby zjistili, jestli vaše nabídka může být dobrá a aby se zajistilo, že je připravená na zákazníka. |
| *Balíček řešení nebo nabídky pro rozteč (povinné)* | K vytvoření balíčku pro rozteč můžete použít [šablonu prezentace zákazníka](https://aka.ms/GTMServices_CustomerPresentation) . Tato balíček by měl odkazovat na [diagram referenční architektury](reference-architecture-diagram.md). Účelem této sady snímků je rozteč vaší nabídky a její umístění. Když si zajistěte, aby vaše nabídka byla připravená pro zákazníky, můžou prodejní týmy Microsoftu sdílet tuto prezentaci se zákazníky, aby vyjadřují hodnotu, kterou vaše společnost a Microsoft přináší při nasazování společného řešení. Prezentace by měla pokrývat to, co vaše nabídka dělá, jak může pomáhat zákazníkům, v jakém odvětví je nabídka relevantní, a jak porovnává s konkurenčními řešeními. |
| *Případová studie zákazníka* (volitelné)| K vytvoření případové studie zákazníka použijte [šablonu Případová studie](https://aka.ms/GTM_Case_Study_Template) . Tyto informace zobrazují potenciální zákazníky, jak vy a Microsoft úspěšně nasadili vaši nabídku v předchozích případech. |
| *Ověřitelné odběratele služby WINS* (volitelné) | Po nasazení vaší nabídky poskytněte konkrétní příklady úspěšnosti zákazníků. |
| *Balíček pro rozteč kanálů* (volitelné) | Snímková balíček s informacemi, které pomáhají prodejcům kanálů získat další informace o vaší nabídce a získat prodejní týmy připravené k jejímu prodeji. Tato paluba obvykle zahrnuje rozteč výtahů, informace o cílových zákaznících, otázky týkající se zákazníků, mluvích bodů a odkazy na videa, dokumentaci a informace o podpoře. |
| *Diagram referenční architektury* (vyžaduje se pro motivovaní stav společného prodeje Azure IP) | Diagram, který představuje vaši nabídku a její vztah k cloudovým službám Microsoftu. Může také Ukázat, jak vaše nabídka splňuje technické požadavky na motivovaní stav pro prodej v Azure IP. [Přečtěte si další informace o diagramu referenční architektury.](reference-architecture-diagram.md) |
| *Další dokumenty* (volitelné) | Můžete nahrávat až pět dalších dokumentů nebo videí, aby prodejní týmy Microsoftu a prodejci kanálů mohli získat další informace o vaší nabídce, organizaci a o tom, jak se liší od jiných nabídek. |
|||

- Po vytvoření dokumentů je přetáhněte do příslušného pole v části **dokumenty** nebo vyberte **Procházet soubory** a nahrajte dokument z počítače.

    [![Popisuje část dokumentace k spoluprodeji na kartě společnosti Microsoft.](./media/co-sell/co-sell-documents-section.png)](./media/co-sell/co-sell-documents-section.png#lightbox)

## <a name="product-landing-page"></a>Cílová stránka produktu

- V části **dokumenty** v poli **cílová stránka produktu** zadejte odkaz na web produktu, kde prodejní týmy Microsoftu a prodejci kanálů můžou získat další informace o vaší nabídce a zobrazit nejnovější aktualizace.
...
1. Otevřete. Soubor CSV v aplikaci, jako je Microsoft Excel, a potom vyplňte jednotlivé řádky informacemi o kontaktu.
    ...
    ***Tabulka 3: Popis rolí***
    ...
    - Země/provincie (volitelné): při vyplňování šablony použijte formát XX-XX, jak je uvedeno v [tabulkách stavy, provincie a oblasti](commercial-marketplace-co-sell-states.md).

---
title: Kurz – Integrujte existující doménovou strukturu a novou doménovou strukturu s jedním klientem Azure AD pomocí Azure AD Connect synchronizace cloudu.
description: Naučte se, jak přidat cloudovou synchronizaci do stávajícího hybridního prostředí identity.
...
Tento kurz vás provede přidáním cloudové synchronizace do stávajícího hybridního prostředí identity. 

![Vytvořit](media/tutorial-existing-forest/existing-forest-new-forest-2.png)
...
V tomto scénáři je existující doménová struktura synchronizovaná pomocí Azure AD Connect synchronizace s tenant služby Azure AD. A máte novou doménovou strukturu, kterou chcete synchronizovat do stejného tenanta služby Azure AD. Pro novou doménovou strukturu nanastavíte synchronizaci cloudu. 
...
3. Na levé straně vyberte **Azure Active Directory**, klikněte na **Azure AD Connect** a ve středu vyberte **spravovat synchronizaci cloudu**.</br>

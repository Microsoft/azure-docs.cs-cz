...
6. Otevřete složku, ve které jsou umístěny soubory.
    ...
    - Tři soubory, které obsahují důležité aktualizace zabezpečení systému `windows8.1-kb4012213-x64`Windows`windows8.1-kb3205400-x64`,, `windows8.1-kb4019213-x64`a.

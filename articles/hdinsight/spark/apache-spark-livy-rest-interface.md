...
Před odesláním úlohy služby batch, musíte nahrát soubor jar aplikace v úložišti clusteru přidružené ke clusteru. Můžete použít [AzCopy](../../storage/common/storage-use-azcopy.md), nástroje příkazového řádku, Uděláte to tak. Existují různé klienty, které vám umožní nahrát data. Můžete najít další informace o nich v [nahrávání dat pro úlohy Apache Hadoop v HDInsight](../hdinsight-upload-data.md).
...
* Pokud chcete načíst konkrétní dávka s ID daného dávky
...
Odstraňuje se úloha služby batch s ID dávky `5`.
...
* [Dokumentace k rozhraní REST API Apache Livy](https://livy.incubator.apache.org/docs/latest/rest-api.html)

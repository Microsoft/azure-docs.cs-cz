...
1. Kliknutím na tlačítko **Vytvořit řešení** zahájíte proces zřizování. Tento proces obvykle trvá několik minut:
    ...
    ![Podrobnosti o řešení simulace zařízení](media/iot-suite-device-simulation-deploy/createsolution.png)
...
1. Na **zřízení řešení** klikněte na tlačítko **spusťte** pod nové řešení simulace zařízení:
    ...
    ![Zvolte nové řešení](media/iot-suite-device-simulation-deploy/newsolution.png)
...
1. Zobrazení informací o řešení zařízení simulace panelu, který se zobrazí. Zvolte **řídicí panel řešení** pro připojení k řešení simulace zařízení.
    ...
    ![Panel řešení](media/iot-suite-device-simulation-deploy/properties.png)
...
Teď, když jste nasadili řešení zařízení simulace, dalším krokem je [prozkoumat funkce řešení zařízení simulace](./iot-suite-device-simulation-explore.md).

---
title: Ukázka kódu JSON pro Azure Policy – Auditování nastavení auditování SQL Serveru | Microsoft Docs
description: Tyto ukázkové zásady JSON auditují nastavení auditování serveru SQL.

---
title: Dokumentace ke službě Batch AI (Preview)
description: Služba Azure Batch AI vám pomůže experimentovat s vašimi modely AI s využitím libovolné architektury a potom je trénovat ve velkém měřítku napříč clustery GPU a CPU. Naučte se používat Batch AI prostřednictvím našich šablon Rychlý start a ukázek.
services: batch-ai
author: czeumault
manager: carolz
layout: LandingPage
...
ms.locfileid: "30149912"
---
# <a name="batch-ai-documentation-preview"></a>Dokumentace ke službě Batch AI (Preview)
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Další informace o Azure Batch AI</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Začínáme s rozhraním příkazového řádku Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/batchai">Reference k rozhraní REST API</a></p>
                    </div>
                </div>
            </div>
        </div>

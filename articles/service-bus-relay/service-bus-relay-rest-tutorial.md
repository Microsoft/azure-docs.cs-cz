...
1. Vyberte řešení **sestavení sestavení**a sestavte celé řešení.**Build Solution**  > 
...
Hostitel služby je objekt WCF, který instancuje hostitelskou aplikaci. Tento příklad předá IT typ hostitele, který chcete vytvořit, a také adresu `ImageService`, na které chcete zveřejnit hostitelskou aplikaci.

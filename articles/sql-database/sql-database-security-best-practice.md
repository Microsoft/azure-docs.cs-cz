...
- Pro každý server SQL DB Vytvořte samostatnou skupinu pro správce Azure AD.
...
Správa přístupu (označovaná taky jako autorizace) je proces řízení a správy přístupu autorizovaných uživatelů a oprávnění k Azure SQL Database.

---
title: Vytváření aplikací v reálném čase pomocí Azure Functions a službě Azure SignalR
description: Přehled používání služby Azure SignalR v aplikace bez serveru.
author: sffamily
ms.service: signalr
ms.topic: conceptual
ms.date: 03/01/2019

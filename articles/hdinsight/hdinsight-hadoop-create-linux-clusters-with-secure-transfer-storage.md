...
Před zahájením tohoto článku, musíte mít:
...
V tomto článku jste zjistili, jak vytvořit HDInsight cluster a povolit zabezpečený přenos pro účty úložiště.

...
|content|počet elementů: 0, počet atributů: 0|
|definované|univerzál|
|jméno|Souboru ApplicationManifest|
...
|Atribut|Hodnota|
|---|---|
|type|[Zadanému ParameterType](service-fabric-service-model-schema-complex-types.md#parametertype-complextype)|
|content|počet elementů: 0, počet atributů: 0|

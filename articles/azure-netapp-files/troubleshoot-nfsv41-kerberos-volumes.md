...
|`Hostname lookup failed`   | Musíte vytvořit zónu zpětného vyhledávání na serveru DNS a pak přidat záznam PTR hostitelského počítače služby AD v této zóně zpětného vyhledávání. <br> Předpokládejme například, že IP adresa počítače AD je `10.1.1.4` , název hostitele počítače služby Active Directory (jak je nalezen pomocí příkazu hostname) `AD1` a název domény `myDomain.com` . Záznam PTR přidaný do zóny zpětného vyhledávání by měl být `10.1.1.4 -> AD1.myDomain.com` . |
...
* [Konfigurace šifrování protokolu Kerberos NFSv 4.1 pro Azure NetApp Files](configure-kerberos-encryption.md)

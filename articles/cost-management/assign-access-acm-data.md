...
| **Rozsah** | **Definovaný na** | **Required access to view data** | **Požadované nastavení EA** | **Consolidates data to** |
| --- | --- | --- | --- | --- |
...
| Oddělení | [https://ea.azure.com](https://ea.azure.com/) | Správce oddělení | **DA view charges** enabled | Všechna předplatná patřící do registračního účtu propojeného s oddělením |
| Registrační účet<sup>2</sup> | [https://ea.azure.com](https://ea.azure.com/) | Vlastník účtu | **AO view charges** enabled | Všechna předplatná z registračního účtu |
| Skupina pro správu | [https://portal.azure.com](https://portal.azure.com/) | Čtenář Cost Management (nebo Čtenář) | **AO view charges** enabled | Všechna předplatná spadající do skupiny pro správu |
| Předplatné | [https://portal.azure.com](https://portal.azure.com/) | Čtenář Cost Management (nebo Čtenář) | **AO view charges** enabled | Všechny prostředky nebo skupiny prostředků v předplatném |
| Skupina prostředků | [https://portal.azure.com](https://portal.azure.com/) | Čtenář Cost Management (nebo Čtenář) | **AO view charges** enabled | Všechny prostředky ve skupině prostředků |

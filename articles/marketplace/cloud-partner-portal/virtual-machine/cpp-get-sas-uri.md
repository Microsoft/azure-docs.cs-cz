...
5. Spusťte tento skript s oprávněními správce pro vygenerování *připojovacího řetězce SAS* pro přístup na úrovni kontejneru.  Můžete použít dva základní přístupy:
   ...
   - Spusťte skript z editoru skriptu PowerShell, jako je například [Integrované skriptovací prostředí (ISE) v prostředí Windows PowerShell](https://docs.microsoft.com/powershell/scripting/core-powershell/ise/introducing-the-windows-powershell-ise), pomocí oprávnění správce. 

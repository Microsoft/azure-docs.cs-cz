---
title: 'Rychlý Start: Custom Voice Assistant (Preview), Java (Windows, Linux) – služba pro rozpoznávání řeči'
...
ms.locfileid: "73504064"
---
# <a name="quickstart-create-a-voice-assistant-with-the-speech-sdk-java"></a>Rychlý Start: vytvoření hlasového asistenta pomocí sady Speech SDK, Java

...
Pomocí příkazu [kubectl apply][kubectl-apply] spusťte aplikaci. Tento příkaz analyzuje soubor manifestu a vytvoří definované objekty Kubernetes.

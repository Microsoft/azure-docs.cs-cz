---
title: Principy uživatelských tokenů ve spolupráci B2B – Azure AD
description: Odkaz na uživatelský token pro spolupráci služby Azure Active Directory B2B
...
---
# <a name="understand-user-tokens-in-azure-ad-b2b-collaboration"></a>Principy uživatelských tokenů ve spolupráci Azure AD B2B

Pokud chcete vědět, jak token vypadá pro uživatele spolupráce B2B, tady jsou podrobnosti o tokenu nosiče a obsah tokenu pro hosta služby Azure Active Directory (Azure AD) a hosta účtu Microsoft v tenantovi prostředků (pro tenantid 04dcc6ab-388a-4559-b527-fbec656300ea). Chcete-li zobrazit obsah webového tokenu JSON (JWT), použijte [https://jwt.io/](https://jwt.io/) nebo [https://jwt.ms/](https://jwt.ms/).
...
## <a name="microsoft-account-guest-token"></a>Token hosta účtu Microsoft
```

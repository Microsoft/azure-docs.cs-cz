...
ms.locfileid: "68879148"
---
# <a name="how-it-works-azure-multi-factor-authentication"></a>Jak to funguje: Služba Azure Multi-Factor Authentication
...
## <a name="how-to-get-multi-factor-authentication"></a>Jak získat službu Multi-Factor Authentication?

Multi-Factor Authentication přichází jako součást následujících nabídek:

* **Azure Active Directory Premium** nebo **Microsoft 365 Business** plně vybavené použití služby Azure Multi-Factor Authentication pomocí zásad podmíněného přístupu, které vyžadují Multi-Factor Authentication.
...
* **Azure Active Directory globálních správců** – podmnožina možností Azure Multi-Factor Authentication je k dispozici jako způsob ochrany globálních účtů správců.
...
* Nasazení [Azure AD Identity Protection](../active-directory-identityprotection.md) a aktivace dvoustupňového ověřování na základě rizikových událostí.

---
title: Vytvoření spravovaného disku ze snímku (Linux) – ukázka CLI
...
ms.locfileid: "89323140"
---
# <a name="create-a-managed-disk-from-a-snapshot-with-cli-linux"></a>Vytvoření spravovaného disku ze snímku pomocí rozhraní příkazového řádku (Linux)

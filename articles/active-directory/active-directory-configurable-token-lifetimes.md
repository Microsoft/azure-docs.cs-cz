...
Další informace o vztahu mezi objekty aplikací a instančních objektů najdete v tématu [aplikace a instanční objekty v Azure Active Directory](active-directory-application-objects.md).

...
* Uživatelům se automaticky přihlášeni k Shuccho Navi (Single Sign-On) můžete povolit pomocí jejich účtů služby Azure AD.
...
* Podporuje Shuccho Navi **SP** jednotné přihlašování zahájené pomocí
...
V této části nakonfigurujete a test Azure AD jednotné přihlašování s Shuccho Navi podle testovacího uživatele volá **Britta Simon**.
Pro jednotné přihlašování pro práci je potřeba navázat vztah odkazu mezi uživatele služby Azure AD a související uživatelské v Shuccho Navi.
...
2. **[Konfigurace Shuccho Navi Single Sign-On](#configure-shuccho-navi-single-sign-on)**  – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
3. **[Vytvořit testovacího uživatele Azure AD](#create-an-azure-ad-test-user)**  – Pokud chcete otestovat Azure AD jednotné přihlašování s Britta Simon.
4. **[Přiřadit uživatele Azure AD](#assign-the-azure-ad-test-user)**  – Pokud chcete povolit Britta Simon používat Azure AD jednotného přihlašování.
5. **[Vytvořit testovacího uživatele Shuccho Navi](#create-shuccho-navi-test-user)**  – Pokud chcete mít protějšek Britta Simon Shuccho Navi, který je propojený s Azure AD reprezentace uživatele.
...
4. Na **základní konfiguraci SAML** části, proveďte následující kroky:
    ...
    ![Shuccho Navi domény a adresy URL jednotného přihlašování – informace](common/sp-signonurl.png)
    ...
    > [!NOTE]
    > Hodnota není skutečný. Aktualizujte příslušnou hodnotu skutečné přihlašovací adresa URL. Kontakt [tým podpory Shuccho Navi klienta](mailto:sys_ntabtm@nta.co.jp) má být získána hodnota. Můžete také odkazovat na tyto vzory se dají ukazuje **základní konfiguraci SAML** části webu Azure Portal.

5. Na **nastavte si jednotné přihlašování pomocí SAML** stránku, **podpisový certifikát SAML** klikněte na tlačítko **Stáhnout** ke stažení **kód XML metadat federace**  z se zadanými možnostmi podle vašich požadavků a uložit je ve vašem počítači.

    ![Odkaz ke stažení certifikátu](common/metadataxml.png)

6. Na **nastavení Shuccho Navi** tématu, zkopírujte příslušné adresy URL podle vašich požadavků.
...
### <a name="configure-shuccho-navi-single-sign-on"></a>Konfigurace Shuccho Navi jednotného přihlašování

Ke konfiguraci jednotného přihlašování na **Shuccho Navi** straně, je nutné odeslat na stažený **soubor XML s metadaty** a vhodné zkopírovaný adresy URL z webu Azure portal [tým podpory Shuccho Navi](mailto:sys_ntabtm@nta.co.jp). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.
...
1. Na webu Azure Portal, vyberte **podnikové aplikace**vyberte **všechny aplikace**a pak vyberte **Shuccho Navi**.
...
### <a name="create-shuccho-navi-test-user"></a>Vytvoření Shuccho Navi testovacího uživatele
...
Po kliknutí na dlaždici Shuccho Navi na přístupovém panelu, vám by měl být automaticky přihlášeni ke Shuccho Navi, u kterého nastavíte jednotné přihlašování. Další informace o přístupovém panelu, naleznete v tématu [Úvod k přístupovému panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

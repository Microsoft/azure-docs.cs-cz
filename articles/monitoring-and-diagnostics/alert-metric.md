...
4. Pokud vybraný prostředek má, můžete vytvářet upozornění metrik **dostupné signály** na dolní pravé bude obsahovat metriky. Můžete zobrazit úplný seznam typů prostředků, které jsou podporovány pro upozornění metrik v tomto [článku](monitoring-near-real-time-metric-alerts.md#metrics-and-dimensions-supported)
...
- [Vytvoření upozornění na metriku pomocí šablony Azure Resource Manageru](monitoring-enable-alerts-using-template.md).
- [Vysvětlení, jak metrika výstrahy pracovní](alert-metric-overview.md).
- [Pochopení schématu webových hook pro upozornění na metriku](monitoring-near-real-time-metric-alerts.md#payload-schema)

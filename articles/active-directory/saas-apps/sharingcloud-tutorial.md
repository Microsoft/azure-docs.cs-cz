...
* Sapient odběr s povoleným jednotným přihlašováním (SSO).
...
1. V části **základní konfigurace SAML** proveďte následující kroky:
    ...
    ![Snímek obrazovky základního uživatelského rozhraní konfigurace SAML se zvýrazněným odkazem na soubor metadat pro nahrání * *](common/upload-metadata.png)
    
    Vyberte poskytnutý soubor metadat a klikněte na **nahrát**.

    ![Snímek obrazovky se zadaným uživatelským rozhraním, pomocí ikony pro výběr souboru a tlačítka * * Odeslat * *, se zvýrazní.](common/browse-upload-metadata.png)
...
1. SharingCloud aplikace očekává kontrolní výrazy SAML v určitém formátu, což vyžaduje přidání mapování vlastních atributů do konfigurace atributů tokenu SAML. Následující snímek obrazovky ukazuje seznam výchozích atributů.
    ...
    ![Snímek obrazovky uživatelského rozhraní atributů uživatele se zvýrazněnou ikonou pro úpravy](common/edit_attribute.png)

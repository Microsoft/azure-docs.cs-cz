...
4. Do vyhledávacího pole zadejte **Syncplicity**.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/syncplicity-tutorial/tutorial_syncplicity_search.png)

5. Na panelu výsledků vyberte **Syncplicity**a potom klikněte na **přidat** tlačítko Přidat aplikaci.

    ![Vytváření testovacího uživatele Azure AD](./media/syncplicity-tutorial/tutorial_syncplicity_addfromgallery.png)
...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Konfigurovat jednotné přihlašování](./media/syncplicity-tutorial/tutorial_syncplicity_samlbase.png)

3. Na **Syncplicity domény a adresy URL** část, proveďte následující kroky:

    ![Konfigurovat jednotné přihlašování](./media/syncplicity-tutorial/tutorial_syncplicity_url.png)
...
4. Na **SAML podpisový certifikát** klikněte na tlačítko **certifikátu (Base64)** a potom uložte soubor certifikátu v počítači.
    ...
    ![Konfigurovat jednotné přihlašování](./media/syncplicity-tutorial/tutorial_syncplicity_certificate.png) 

  
5. Klikněte na tlačítko **Uložit** tlačítko.

    ![Konfigurovat jednotné přihlašování](./media/syncplicity-tutorial/tutorial_general_400.png)
...
6. Na **Syncplicity konfigurace** klikněte na tlačítko **konfigurace Syncplicity** otevřete **konfigurovat přihlášení** okno. Kopírování **Sign-Out adresu URL, SAML Entity ID a SAML jeden přihlašování adresa URL služby** z **Stručná referenční příručka části.**
    ...
    ![Konfigurovat jednotné přihlašování](./media/syncplicity-tutorial/tutorial_syncplicity_configure.png) 
...
1. V **portál Azure**, v levém navigačním podokně klikněte na tlačítko **Azure Active Directory** ikonu.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/syncplicity-tutorial/create_aaduser_01.png) 

2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin** a klikněte na tlačítko **všichni uživatelé**.
    
    ![Vytváření testovacího uživatele Azure AD](./media/syncplicity-tutorial/create_aaduser_02.png) 

3. Chcete-li otevřít **uživatele** dialogové okno, klikněte na tlačítko **přidat** horní dialogové okno.
 
    ![Vytváření testovacího uživatele Azure AD](./media/syncplicity-tutorial/create_aaduser_03.png) 

4. Na **uživatele** dialogové okno stránky, proveďte následující kroky:
 
    ![Vytváření testovacího uživatele Azure AD](./media/syncplicity-tutorial/create_aaduser_04.png) 
...
4. Typ **e-mailových adres** účtu AAD, které chcete zřídit, vyberte **uživatele** jako **Role**a potom klikněte na **Další**.
    ...
    ![Informace o účtu](./media/syncplicity-tutorial/ic769765.png "účet informace")
...
2. V seznamu aplikací vyberte **Syncplicity**.
    ...
    ![Konfigurovat jednotné přihlašování](./media/syncplicity-tutorial/tutorial_syncplicity_app.png) 

...
* [sys. přihlašovací údaje](/sql/relational-databases/system-catalog-views/sys-credentials-transact-sql?view=azure-sqldw-latest&preserve-view=true)
...
* [sys. souborů – skupiny](/sql/relational-databases/system-catalog-views/sys-filegroups-transact-sql?view=azure-sqldw-latest&preserve-view=true)
...
* [sys. synonyma](/sql/relational-databases/system-catalog-views/sys-synonyms-transact-sql?view=azure-sqldw-latest&preserve-view=true)
* [sys.syscharset](/sql/relational-databases/system-compatibility-views/sys-syscharsets-transact-sql?view=azure-sqldw-latest&preserve-view=true)
* [sys.syssloupce](/sql/relational-databases/system-compatibility-views/sys-syscolumns-transact-sql?view=azure-sqldw-latest&preserve-view=true)
* [sys.sysdatabáze](/sql/relational-databases/system-compatibility-views/sys-sysdatabases-transact-sql?view=azure-sqldw-latest&preserve-view=true)
* [sys.sysjazyky](/sql/relational-databases/system-compatibility-views/sys-syslanguages-transact-sql?view=azure-sqldw-latest&preserve-view=true)
* [sys.sysobjekty](/sql/relational-databases/system-compatibility-views/sys-sysobjects-transact-sql?view=azure-sqldw-latest&preserve-view=true)
* [ Odkazy nasys.sys](/sql/relational-databases/system-compatibility-views/sys-sysreferences-transact-sql?view=azure-sqldw-latest&preserve-view=true)
...
* [sys.sysuživatelé](/sql/relational-databases/system-compatibility-views/sys-sysusers-transact-sql?view=azure-sqldw-latest&preserve-view=true)
...
* [zobrazení sys. views](/sql/relational-databases/system-catalog-views/sys-views-transact-sql?view=azure-sqldw-latest&preserve-view=true)
...
* [SLOUPCÍCH](/sql/relational-databases/system-information-schema-views/columns-transact-sql?view=azure-sqldw-latest&preserve-view=true)
* [UKAZATELŮ](/sql/relational-databases/system-information-schema-views/parameters-transact-sql?view=azure-sqldw-latest&preserve-view=true)
* [RUTINY](/sql/relational-databases/system-information-schema-views/routines-transact-sql?view=azure-sqldw-latest&preserve-view=true)
* [SCHÉMAT](/sql/relational-databases/system-information-schema-views/schemata-transact-sql?view=azure-sqldw-latest&preserve-view=true)
* [TABULKY](/sql/relational-databases/system-information-schema-views/tables-transact-sql?view=azure-sqldw-latest&preserve-view=true)
...
* [Náhled](/sql/relational-databases/system-information-schema-views/views-transact-sql?view=azure-sqldw-latest&preserve-view=true)

...
- [Vytvoření a šifrování virtuálního počítače s Windows pomocí Azure CLI](disk-encryption-cli-quickstart.md)
- [Vytvoření a šifrování virtuálního počítače s Windows pomocí Azure PowerShell](disk-encryption-cli-quickstart.md)

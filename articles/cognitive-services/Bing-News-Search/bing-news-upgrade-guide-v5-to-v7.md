...
- Přidat produkty jako možná hodnota, která můžete nastavit [kategorie](https://docs.microsoft.com/rest/api/cognitiveservices/bing-news-api-v7-reference#category) parametr do dotazu. Zobrazit [kategorie trhy](https://docs.microsoft.com/rest/api/cognitiveservices/bing-news-api-v7-reference).

...
| | Diagnostika<br>rozšíření (WAD) | Log Analytics<br>agenta | Závislost<br>agenta |
|:---|:---|:---|:---|
...
| | Diagnostika<br>rozšíření (LAD) | Telegraf<br>agenta | Log Analytics<br>agenta | Závislost<br>agenta |
|:---|:---|:---|:---|:---|
| Podporovaná prostředí | Azure | Azure<br>Jiný Cloud<br>Lokálně | Azure<br>Jiný Cloud<br>Lokálně | Azure<br>Jiný Cloud<br>Lokálně |

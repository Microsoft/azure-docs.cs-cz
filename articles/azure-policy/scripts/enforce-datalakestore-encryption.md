---
title: Ukázka kódu JSON pro Azure Policy – Vyžadování šifrování pro Data Lake Store | Microsoft Docs
description: Tyto ukázkové zásady JSON vyžadují šifrování pro Data Lake Store.

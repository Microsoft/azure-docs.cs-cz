...
2. Vyberte **obnovit zařízení**.
    ...
    ![Resetování zařízení](media/azure-stack-edge-device-reset/device-reset-1.png)

3. Po zobrazení výzvy k potvrzení si přečtěte upozornění a pokračujte výběrem **Ano** .

    ![Potvrdit resetování](media/azure-stack-edge-device-reset/device-reset-2.png)  

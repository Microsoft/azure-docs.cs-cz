...
| [Přihlášení k odběru skupiny prostředků](scripts/event-grid-powershell-resource-group.md)| Přihlásí se k odběru událostí skupiny prostředků. |
| [Přihlášení k odběru skupiny prostředků a vyfiltrování prostředku](scripts/event-grid-powershell-resource-group-filter.md)| Přihlásí se k odběru událostí skupiny prostředků a vyfiltruje události pro konkrétní prostředek. |
|**Témata Event Gridu**||
| [Vytvoření vlastního tématu](scripts/event-grid-powershell-create-custom-topic.md) | Vytvoří vlastní téma Event Gridu a vrátí koncový bod a klíč.  |
| | |

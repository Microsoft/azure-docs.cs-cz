...
Když na přístupovém panelu kliknete na dlaždici SmartDraw, měli byste se automaticky přihlásit k SmartDraw, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

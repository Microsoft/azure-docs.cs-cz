...
| ----------- | ----------- | ------------ |
| Autorizace | Primární token | &gt; nosič &lt;Primary-token |
| x-MS-Authorization – pomocná | Pomocné tokeny | Nosič &lt;AUX-token1&gt;, EncryptedBearer &lt;pomocné-token2&gt;, nosič &lt;pomocná-token3&gt; |

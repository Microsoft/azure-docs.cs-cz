...
1. V projektu Azure Migrate > **Přehled**klikněte na možnost **zhodnotit a migrovat servery**. V **Azure Migrate: Vyhodnocování**serveru, klikněte na **skupiny** .
    - Pokud jste ještě nepřidali Azure Migrate: Nástroj pro vyhodnocení serveru, kliknutím ho přidáte. [Další informace](how-to-assess.md).
...
1. Na kartě **servery** v **Azure Migrate: Na dlaždici posouzení** serveru klikněte na **skupiny**.

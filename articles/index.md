...
<div id="main" class="v2">
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">Úvodní příručka pro vývojáře v Azure</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <h1 class="visually-hidden">Dokumentace k Microsoft Azure</h1>
        <ul class="pivots">
            <li>
                        ...
                        <ul id="get-started1" class="cardsL">
                            ...
                            <li>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Zabezpečení a správa prostředků</h3>
                                                <ul class="noBullet">
                                        ...
                                        <div class="card">
                                            <div class="cardText">
                                                ...
                                                <ul class="noBullet">
                                                    ...
                                                    <li><a class="barLink" href="/azure/sql-database-edge/">SQL Database pro hraniční zařízení</a></li>
                                                    <li><a class="barLink" href="/azure/virtual-machines/windows/sql/">SQL Server na virtuálním počítači Azure</a></li>
                                                    <li><a class="barLink" href="/azure/sql-data-warehouse/">Synapse Analytics (dříve SQL DW)</a></li>
                                                ...
                                                <ul class="noBullet">
                                                    ...
                                                    <li>
                                                        <a class="barLink" href="https://azure.microsoft.com/features/azure-portal/mobile-app/">
                                                            <img src="https://docs.microsoft.com/media/common/i_mobile-app-developement.svg" alt=""> Mobilní aplikace Azure </a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Získávání dovedností pomocí Microsoft Learn</h3>
                                                <ul class="noBullet">
                                                    <li>
                                                        <a class="barLink" href="/learn/modules/tour-azure-portal/">
                                                            <img src="https://docs.microsoft.com/learn/achievements/tour-azure-services-and-features.svg" alt=""> Prohlídka služeb a funkcí Azure </a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="/learn/modules/principles-cloud-computing/">
                                                            <img src="https://docs.microsoft.com/learn/achievements/principles-cloud-computing.svg" alt=""> Principy cloud computingu </a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="/learn/modules/control-azure-services-with-cli/">
                                                            <img src="https://docs.microsoft.com/learn/achievements/control-azure-services-with-cli.svg" alt=""> Řízení služeb Azure pomocí CLI </a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="/learn/modules/automate-azure-tasks-with-powershell/">
                                                            <img src="https://docs.microsoft.com/learn/achievements/automate-azure-tasks-with-powershell.svg" alt=""> Automatizace úloh Azure pomocí skriptů s využitím PowerShellu </a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="/learn/browse/?products=azure">Další interaktivní výuka...</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <li class="bottomRightItem">
                                <a href="https://docs.microsoft.com/azure/index#pivot=products&panel=all">
                                    <button style="cursor: pointer;position: relative; background: #0050C5; border:none; padding:8px 16px; padding-right:30px;color: white; font-size:14px;">Zobrazit všechny služby Azure<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 10 14" style="fill:white;height: 14px;position: absolute;bottom: 13px;right: 12px;width: 1em;"><path d="M7.4 7L1 .6l.6-.6 7 7-7 7-.6-.7L7.4 7z" /></svg></button>
                                </a>
                            </li>
                        </ul>
                    </li>
            ...
            <li>
                ...
                <ul id="products">
                    <li>
                        <a data-default="true" href="#all">Vše</a>
                        <ul id="all" class="directory">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/cognitive-services/computer-vision/">
                                                ...
                                                <p>Rozhraní API pro počítačové zpracování obrazu</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/cognitive-services/emotion/home">
                                                ...
                                                <p>Rozhraní API pro rozpoznávání emocí</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/cognitive-services/face/">
                                                <img src="media/index/API_Face.svg" alt="" />
                                                <p>Rozhraní API pro rozpoznávání tváře</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/cognitive-services/speaker-recognition/home">
                                                ...
                                                <p>Rozhraní API pro rozpoznání mluvčího</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/cognitive-services/bing-spell-check/">
                                                ...
                                                <p>Rozhraní API pro kontrolu pravopisu Bingu</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/cognitive-services/web-language-model/home">
                                                ...
                                                <p>Rozhraní Web Language Model API</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure/sql-data-warehouse/">
                                                ...
                                                <p>Azure Synapse Analytics (dříve SQL DW)</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/virtual-machines/windows/sql/virtual-machines-windows-sql-server-iaas-overview?toc=%2Fazure%2Fvirtual-machines%2Fwindows%2Ftoc.json">
                                                <img src="media/index/VirtualMachine.svg" alt="" />
                                                <p>SQL Server na virtuálních počítačích</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/virtual-machines/workloads/sap/hana-overview-architecture">
                                                <img src="media/index/VirtualMachine.svg" alt="" />
                                                <p>SAP HANA ve velkých instancích Azure</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/active-directory-domain-services">
                                                <img src="media/index/ActiveDirectory.svg" alt="" />
                                                <p>Azure Active Directory pro Domain Services</p>
                                            </a>
                                        </li>
                                        <li>
                            ...
                            <li>
                                <div class="group">
                                    ...
                                    <h3>Správa a zásady správného řízení</h3>
                                    <ul>
                                        <li>
                                            <a href="/azure/backup/">
                                        ...
                                        <li>
                                            <a href="/azure/security/">
                                                <img src="media/index/securitycenter.svg" alt="" />
                                                <p>Zabezpečení a dodržování předpisů</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/media-services/media-services-manage-channels-overview">
                                                ...
                                                <p>Živý streaming a streaming na vyžádání</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                          <a href="/azure/web-application-firewall/">
                                                ...
                                                <p>Web Application Firewall (Brána firewall webových aplikací)</p>
                                          </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/security/fundamentals/threat-detection">
                                                <img src="media/index/SecurityCenter.svg" alt="" />
                                                <p>Rozšířená ochrana před internetovými útoky Azure</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/information-protection/">
                    ...
                    <li>
                        <a href="#ai">AI a Machine Learning</a>
                        <ul id="ai" class="cardsA">
                            <li class="fullSpan">
                                <h2>Umělá inteligence a Machine Learning</h2>
                            </li>
                            <li>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Vneste do aplikací, webů a robotů inteligentní funkce, které jim umožní vidět, slyšet, mluvit a porozumět</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Služba Machine Learning</h3>
                                                    <p>Vytvoření, nasazení a správa modelů AI a strojového učení</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Vytvoření pracovního prostoru Azure Databricks s clustery Spark</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Otevřené datové sady</h3>
                                                    <p>Kurátorované veřejné datové sady pro vylepšení modelů strojového učení</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Synapse Analytics (dříve SQL DW)</h3>
                                                    <p>Neomezená analytická služba s mimořádně rychlým získáváním přehledů</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Průzkumník dat Azure</h3>
                                                    <p>Rychlá a vysoce škálovatelná služba pro zkoumání dat protokolů a telemetrie</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Analýzy rychlých streamů dat z aplikací a zařízení v reálném čase</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Apache Spark pro Azure HDInsight</h3>
                                                    <p>Apache Spark v cloudu pro nasazení, která jsou zásadní pro plnění vašich cílů</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Apache Storm pro Azure HDInsight</h3>
                                                    <p>Jednoduché zpracování streamů v reálném čase pro velké objemy dat</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>R Server pro Azure HDInsight</h3>
                                                    <p>Prediktivní analýza, strojové učení a statistické modelování pro velký objem dat</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Zabezpečená služba Data Lake Storage s rozsáhlou škálovatelností založená na úložišti objektů blob</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Služba souborů NFS na úrovni podniku s využitím NetApp</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Jednoduchá a bezpečná služba pro sdílení velkých objemů dat s externími organizacemi</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Služba Azure Blockchain</h3>
                                                    <p>Sestavování, řízení a rozšiřování blockchainových sítí konsorcia</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Propojení blockchainu s cloudem bez náročných operací</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Snadné definování, vytváření a správa tokenů založených na registru</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SQL Server na virtuálních počítačích</h3>
                                                    <p>Hostování podnikových aplikací SQL Serveru v cloudu</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SAP HANA ve velkých instancích Azure</h3>
                                                    <p>Spouštění i těch největších úloh SAP HANA libovolného poskytovatele cloudu s hyperškálováním</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>CycleCloud</h3>
                                                    <p>Vytváření, správa, provoz a optimalizace clusterů HPC a Big Compute libovolného rozsahu</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Cognitive Services</h3>
                                                    <p>Použití kontejnerů Azure Cognitive Services s Dockerem, Kubernetes, AKS a Container Instances</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Relační databázový stroj optimalizovaný pro nasazování do IoT a na hraniční zařízení</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Spravovaná databázová služba MariaDB pro vývojáře aplikací</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Zjednodušení migrace do cloudu</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Visual Studio</h3>
                                                    <p>Plně vybavené integrované vývojové prostředí (IDE) pro Android, iOS, Windows, web a cloud</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Visual Studio Code je jednoduchý, ale výkonný editor zdrojového kódu, který běží na vaší ploše a je dostupný pro Windows, macOS a Linux.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Sady SDK</h3>
                                                    <p>Sestavování cloudových aplikací s využitím programovacích jazyků, které už znáte</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Integrace vývojářských nástrojů</h3>
                                                    <p>Nástroje třetích stran, které pomáhají s vývojem pro Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Přístup k cloudu přímo z nástroje pro příkazový řádek</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Rychlé a škálovatelné úložiště parametrů pro konfigurace aplikací</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Vytvoření testovacích prostředí v cloudu pro učebny, vývoj a testování a další scénáře (dříve DevTest Labs)</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Rychlejší dodávání aplikací díky automatizaci životního cyklu aplikací</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Integrace vývojářských nástrojů</h3>
                                                    <p>Rozšíření Azure pomocí oblíbených rozšíření</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Rychlé nasazení libovolného jazyka na libovolné platformě do Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Sestavení a nasazení organizačních zásad pro řízení citlivých informací</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Active Directory pro Domain Services</h3>
...
<li>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Připojení zařízení k řešení IoT bez psaní jakéhokoli kódu zařízení</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Sphere</h3>
                                                    <p>Vytváření vysoce zabezpečených zařízení s využitím MCU</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#mgmt">Správa a zásady správného řízení</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Zabezpečení a dodržování předpisů</h3>
                                                    <p>Povolení detekce a prevence hrozeb prostřednictvím pokročilého cloudového zabezpečení</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>portál Azure</h3>
                                                    <p>Sestavení, správa a monitorování všech produktů Azure na jediné unifikované konzole</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Zjednodušení správy prostředků aplikací</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Cloud Shell</h3>
                                                    <p>Zjednodušení správy Azure s využitím prostředí založeného na prohlížeči</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Mobilní aplikace Azure</h3>
                                                    <p>Buďte ve spojení se svými prostředky Azure – kdykoli a kdekoli</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Opakovatelná nasazení a aktualizace cloudových prostředí s využitím sestavitelných artefaktů</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Zkoumání prostředků v potřebném měřítku pomocí bohatého dotazovacího jazyka</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Migrate</h3>
                                                    <p>Snadné zjišťování, vyhodnocení, určení správné velikosti a migrace místních virtuálních počítačů do Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Správa prostředků zákazníků ve velkém měřítku</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Kódování</h3>
                                                    <p>Kódování ve studiové kvalitě v cloudovém rozsahu</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Živý streaming a streaming na vyžádání</h3>
                                                    <p>Doručování obsahu do všech zařízení v měřítku odpovídajícím vašim firemním potřebám</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Přehrávač médií Azure</h3>
                                                    <p>Jeden přehrávač pro všechno, co souvisí s přehráváním</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Bezpečné dodávání obsahu pomocí AES, PlayReady, Widevine a Fairplay</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Odhalení poznatků z videosouborů pomocí služeb pro zpracování řeči a obrazu</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Video Indexer</h3>
                                                    <p>Zajištění lepší dostupnosti a vyhledatelnosti multimediálních souborů</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Univerzální senzorové zařízení vám umožní sestavovat způsobem, kterému dáváte přednost</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Xamarin</h3>
                                                    <p>Rychlejší vytváření úžasných mobilních aplikací s využitím cloudu</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Ochrana aplikací před distribuovanými útoky s cílem odepření služeb (DDoS)</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Web Application Firewall (Brána firewall webových aplikací)</h3>
                                                    <p>Poskytování centralizované ochrany webových aplikací před běžným zneužitím a ohrožením zabezpečení</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Privátní přístup ke službám hostovaným na platformě Azure, s daty uchovávanými v síti Microsoftu</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Rezervované HSM</h3>
                                                    <p>Použití úložiště kryptografických klíčů v Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Rozšířená ochrana před internetovými útoky Azure</h3>
                                                    <p>Ochrana vašeho podniku před hrozbami v cloudu a v místním prostředí</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Řízení přístupu na základě role</h3>
                                                    <p>Správa přístupu k prostředkům Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#other">Suverénní cloudy</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Řada služeb Data Box</h3>
                                                    <p>Řada úložných zařízení, která umožňují offline přenos dat nebo přenos dat založený na síti</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Avere vFXT</h3>
                                                    <p>Spouštění úloh založených na souborech a s vysokým výkonem v Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Řešení optimalizace hybridního úložiště pro prostředí HPC</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Snadná správa služby Storage odkudkoli z Windows, macOS a Linuxu</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Archiv služby Storage</h3>
                                                    <p>Nízkonákladové zabezpečené cloudové úložiště pro zřídka používaná data</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure NetApp Files</h3>
                                                    <p>Služby síťových souborů na úrovni podniku s využitím NetApp</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Služba Azure SignalR</h3>
                                                    <p>Snadné doplnění webových funkcí v reálném čase</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Windows Virtual Desktop</h3>
                                                    <p>Doručování virtuálních desktopových prostředí na jakékoli zařízení v cloudovém měřítku</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Azure pro vývojáře na platformě .NET </h3>
                                                <p>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Azure pro vývojáře v Pythonu </h3>
                                                <p>
                                                    <a href="/azure/python">Začínáme</a>
                                                </p>
                                                <p>
                                                    <a href="/python/api/?view=azure-python">Referenční materiály k rozhraní API</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Azure pro vývojáře v Node.js </h3>
                                                <p>
                                                    <a href="/azure/javascript/">Začínáme</a>
                                                </p>
                                                <p>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Azure pro vývojáře v Go </h3>
                                                <p>
                                                    <a href="/azure/go/">Začínáme</a>
                                                </p>
                                                <p>
                                                    <a href="https://godoc.org/github.com/Azure/azure-sdk-for-go">Referenční materiály k rozhraní API</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Rozhraní REST API platformy Azure </h3>
                                                <p>
                                                    <a href="/rest/api">Referenční materiály k rozhraní API</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>portál Azure</h3>
                                                <p>
                                                    <a href="/azure/azure-portal/">Začínáme</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Mobilní aplikace Azure</h3>
                                                <p>
                                                    <a href="https://azure.microsoft.com/features/azure-portal/mobile-app/">Začínáme</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="https://visualstudio.microsoft.com/downloads/?utm_medium=microsoft&utm_source=docs.microsoft.com&utm_campaign=navigation+cta&utm_content=download+vs2017">Stáhnout pro Windows</a>
                                                </p>
                                                 <p>
                                                    <a href="https://visualstudio.microsoft.com/vs/mac/">Stáhnout pro Mac</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
...
Docker </h3>
                                                ...
                                                <p>
                                                    <a href="https://www.visualstudio.com/downloads/?utm_medium=microsoft&utm_source=docs.microsoft.com&utm_campaign=button+cta&utm_content=download+vs2017">Stáhnout pro Visual Studio</a>
                                                </p>
                                                <p>
                                                    <a href="https://go.microsoft.com/fwlink/?LinkId=780681">Stáhnout pro Visual Studio Code</a>
                                                </p>
                                                <p>
                                                    <a href="https://go.microsoft.com/fwlink/?LinkId=780682">Stáhnout pro Azure DevOps</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Nástroje jazyka Java </h3>
                                                <p>
                                                    <a href="https://docs.microsoft.com/java/api/overview/azure/maven/readme">Moduly plug-in Maven</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/java/azure/java-azure-tools">IntelliJ a Eclipse</a>
                                                </p>
                                                <p>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="https://go.microsoft.com/fwlink/?LinkId=722418">Stáhnout pro Linux</a>
                                                </p>
                                                <p>
                                                    <a href="https://go.microsoft.com/fwlink/?LinkId=708342">Stáhnout pro Mac</a>
                                                </p>
                                                <p>
                                                    <a href="https://go.microsoft.com/fwlink/?LinkId=708343">Stáhnout pro Windows</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Sada Service Fabric SDK a Service Fabric Tools </h3>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/service-fabric/service-fabric-get-started">Stáhnout pro Windows</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/service-fabric/service-fabric-get-started-linux">Stáhnout pro Linux</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/service-fabric/service-fabric-get-started-mac">Stáhnout Mac OS X</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/service-fabric/service-fabric-cli">Stáhnout Service Fabric CLI </a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
...
Nástroje SQL </h3>
                                                ...
                                                <p>
                                                    <a href="/sql/tools/overview-sql-tools">Zobrazit všechny nástroje SQL</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>

...
1. V části **definice zásad**zadejte informace o definici zásady na základě vlastností popsaných v tomto příkladu:
   ...
   | **Vynucování zásad** | Yes | **Enabled** (Povoleno) | Toto nastavení určuje, jestli se má při ukládání vaší práce povolit nebo zakázat definici zásady. |
   ||||
...
1. V části **základy**zadejte tyto informace pro přiřazení zásady:
   ...
   | **Vynucování zásad** | Yes | Nastavení, které povoluje nebo zakazuje přiřazení zásady |

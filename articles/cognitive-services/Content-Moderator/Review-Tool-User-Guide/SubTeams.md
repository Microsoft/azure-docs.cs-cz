---
title: Týmy a podtýmy v Content Moderator API | Dokumentace Microsoftu
...
### <a name="1-create-a-subteam"></a>1. Vytvoření dílčího týmu.
...
### <a name="3-assign-members-from-your-default-team"></a>3. Přiřazení členů z výchozí tým.

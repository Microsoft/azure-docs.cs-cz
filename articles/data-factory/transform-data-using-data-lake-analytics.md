...
Ve výše ukázkový skript, vstup a výstup skriptu je definován v  **\@v** a  **\@si** parametry. Hodnoty pro  **\@v** a  **\@si** parametry ve skriptu U-SQL jsou předávány dynamicky službou Data Factory pomocí sekci "parametrů". 

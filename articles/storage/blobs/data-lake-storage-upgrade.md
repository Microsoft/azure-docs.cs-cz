...
| hosting| Hierarchické | Hierarchické |  *Nyní k dispozici*  |
| API  | REST API přes HTTPS | REST API přes HTTP/HTTPS| *Nyní k dispozici* |
...
| Dostupnost podle oblastí | Podívejte se [sem](https://azure.microsoft.com/regions/) | Všechny [oblasti Azure](https://azure.microsoft.com/global-infrastructure/regions/)                                                                                                                                                                                                                                                                                                                                       | *Nyní k dispozici*                                                                                                                           |
...
|----------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| .NET SDK – Správa                  | [Odkaz](https://docs.microsoft.com/dotnet/api/overview/azure/datalakestore/management?view=azure-dotnet)                                                                                                                                                                                                                 | *Nepodporuje se*                                                      | *Nyní k dispozici –* [odkaz](https://docs.microsoft.com/rest/api/storageservices/operations-on-the-account--blob-service-)                                    |
| Sada .NET SDK – systém souborů                  | [Odkaz](https://docs.microsoft.com/dotnet/api/overview/azure/datalakestore/client?view=azure-dotnet)                                                                                                                                                                                                                     | *Ještě není k dispozici*                                                | *Ještě není k dispozici*                                                                                                                                             |
| Java SDK – Správa                  | [Odkaz](https://docs.microsoft.com/java/api/overview/azure/datalakestore/management)                                                                                                                                                                                                                                     | *Nepodporuje se*                                                      | *Nyní k dispozici –* [odkaz](https://docs.microsoft.com/java/api/com.microsoft.azure.storage.blob?view=azure-java-stable)                                     |
...
| Node. js – Správa                   | [Odkaz](https://www.npmjs.com/package/azure-arm-datalake-store)                                                                                                                                                                                                                                                                | Nepodporováno                                                      | *Nyní k dispozici –* [odkaz](https://azure.github.io/azure-storage-node/)                                                                                            |
...
| Správa Pythonu                    | [Odkaz](https://docs.microsoft.com/python/api/overview/azure/datalakestore/management?view=azure-python)                                                                                                                                                                                                                 | *Nepodporuje se*                                                      | *Nyní k dispozici –* [odkaz](https://docs.microsoft.com/python/api/overview/azure/storage/management?view=azure-python)                                       |
| Python – systém souborů                    | [Odkaz](https://azure-datalake-store.readthedocs.io/en/latest/)                                                                                                                                                                                                                                                                 | *Ještě není k dispozici*                                                | *Ještě není k dispozici*                                                                                                                                             |
| REST API – Správa                  | [Odkaz](https://docs.microsoft.com/rest/api/datalakestore/accounts)                                                                                                                                                                                                                                                      | *Nepodporuje se*                                                      | *Nyní k dispozici –*                                                                                                                                               |
| REST API – systém souborů                  | [Odkaz](https://docs.microsoft.com/rest/api/datalakestore/webhdfs-filesystem-apis)                                                                                                                                                                                                                                       | *Nyní k dispozici*                                                    | *Nyní k dispozici –* [odkaz](https://docs.microsoft.com/rest/api/storageservices/data-lake-storage-gen2)                                                      |
...
| CLI – Správa                       | [Odkaz](https://docs.microsoft.com/cli/azure/dls/account?view=azure-cli-latest)                                                                                                                                                                                                                                          | *Nepodporuje se*                                                      | *Nyní k dispozici –* [odkaz](https://docs.microsoft.com/cli/azure/storage?view=azure-cli-latest)                                                              |
| CLI – systém souborů                       | [Odkaz](https://docs.microsoft.com/cli/azure/dls/fs?view=azure-cli-latest)                                                                                                                                                                                                                                               | *Ještě není k dispozici*                                                | *Ještě není k dispozici*                                                                                                                                             |
| Azure Resource Manager – Správa šablon             | [Template1](https://azure.microsoft.com/resources/templates/101-data-lake-store-no-encryption/)  [Template2](https://azure.microsoft.com/resources/templates/101-data-lake-store-encryption-adls/)  [Template3](https://azure.microsoft.com/resources/templates/101-data-lake-store-encryption-key-vault/)  | *Nepodporuje se*                                                      | *Nyní k dispozici –* [odkaz](https://docs.microsoft.com/azure/templates/microsoft.storage/2018-07-01/storageaccounts)                                         |
...
| Oblast            | Partner  | Produkt/služba  | Dostupnost pro Data Lake Storage Gen1                                                                                                                                               | Dostupnost pro Data Lake Storage Gen2 – s ověřováním pomocí sdíleného klíče                                                   | Dostupnost pro Data Lake Storage Gen2 – s OAuth                                                             |
|---------------------|--------------|----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|
| Analytické rozhraní | Cloudera     | CDH –                  | [Odkaz](https://www.cloudera.com/documentation/enterprise/5-11-x/topics/admin_adls_config.html)                                                                                            | *Ještě není k dispozici*                                                                                                  | [Odkaz](https://www.cloudera.com/documentation/enterprise/latest/topics/admin_adls2_config.html)                                                                                                  |
...
|                     | Attunity     |                      | [Odkaz](https://www.attunity.com/company/press-releases/microsoft-and-attunity-announce-strategic-partnership-for-data-migration/)                                                         | *Ještě není k dispozici*                                                                                                  | *Ještě není k dispozici*                                                                                                  |
...
| Diagnostické protokoly                                                                                        | [Odkaz](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-diagnostic-logs#request-logs) | Jednorázové požadavky na protokoly pro konkrétní dobu trvání pomocí lístku podpory – *k dispozici nyní je dostupná* integrace monitorování Azure – *zatím není k dispozici* . |
...
| Strategie                   | IT                                                                                  | Nevýhody                                                           | Kdy použít?                                                                                                                                                                                             |
|--------------------------------|-------------------------------------------------------------------------------------------|--------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| Strategie                       | Nástroje                                                                                                             | IT                                                                                                                             | Požadavky                                                                                                                                                                                                                                                                                                                |
|------------------------------------|-----------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|

...
1. Do vyhledávacího pole zadejte **vymazat revize**vyberte **vymazat revize** z panelu výsledků klikněte **přidat** tlačítko pro přidání aplikace.
...
1. **[Vytvoření zkušebního uživatele vymazat revize](#create-a-clear-review-test-user)**  – Pokud chcete mít protějšek Britta Simon reviduje jasné, který je propojený s Azure AD reprezentace uživatele.
...
1. Na **vymazat revize domény a adresy URL** části, proveďte následující kroky, pokud chcete nakonfigurovat aplikace v **zprostředkovatele identity iniciované** režimu:
...
1. Vymazat revizi aplikace očekávat, že hodnota identifikátoru jedinečných uživatelů v deklaraci identity identifikátor názvu. Byste měli namapovat hodnotu identifikátoru uživatele **user.mail**.
...
1. Na **vymazat konfiguraci revize** klikněte na tlačítko **konfigurace vymazat revize** otevřete **nakonfigurovat přihlašování** okna. Kopírovat **odhlašování adresy URL, SAML Entity ID a SAML jednotné přihlašování služby** z **Stručná referenční příručka oddílu.**
...
1. V seznamu aplikací vyberte **vymazat revize**.

---
title: 'Rychlý start: Převod textového skriptu, Python – Translator Text API'
...
ms.locfileid: "49647440"
---
# <a name="quickstart-transliterate-text-with-the-translator-text-rest-api-python"></a>Rychlý start: Transliterace textu pomocí rozhraní REST API služby Translator Text (Python)

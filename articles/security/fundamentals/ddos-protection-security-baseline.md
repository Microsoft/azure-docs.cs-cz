...
- [Jak nakonfigurovat výstrahy pro metriky DDoS Protection](../../virtual-network/manage-ddos-protection.md#configure-alerts-for-ddos-protection-metrics)
...
- [Informace o přístupu k telemetrie, protokolům a analýze útoků pro službu DDoS Protection Standard](../../virtual-network/manage-ddos-protection.md#configure-alerts-for-ddos-protection-metrics)
...
- [Pochopení oprávnění v Azure DDoS Protection](../../virtual-network/manage-ddos-protection.md#permissions-and-restrictions)
...
**Doprovodné** materiály: Používejte zabezpečenou pracovní stanici spravovanou v Azure se službou Azure Multi-Factor Authentication (MFA), která umožňuje přihlásit se a nakonfigurovat vaše požadavky na Customer Lockbox Azure.
...
- [Správa řízení přístupu na základě role v Azure (Azure RBAC) v Azure DDoS Protection](../../virtual-network/manage-ddos-protection.md)
...
- [Konfigurace výstrah pro metriky DDoS Protection](../../virtual-network/manage-ddos-protection.md#configure-alerts-for-ddos-protection-metrics)
...
- Další informace o [plánech zabezpečení Azure](../benchmarks/security-baselines-overview.md)
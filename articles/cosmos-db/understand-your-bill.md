...
U Azure Cosmos DB úrovně Free získáte k bezplatnému účtu první 400 RU/s a 5 GB úložiště, které se použije na úrovni účtu. Všechna RU/s a úložiště nad 400 RU/s a 5 GB se budou účtovat podle běžných sazeb za ceny na stránce s cenami. Na faktuře se vám nezobrazí poplatky za bezplatné 400 ru/s a 5 GB, a to nad rámec toho, co je zahrnuto do úrovně Free/s a úložiště. 400 RU/s se vztahuje na jakýkoliv typ propustnosti RU/s zřízenou v rámci špičkové propustnosti, automatického pilotního nasazení (Preview) a více hlavních serverů.  
...
### <a name="billing-example---container-or-database-with-autopilot-throughput-preview"></a>Příklad fakturace – kontejner nebo databáze s propustností automatického pilotního nasazení (Preview)
- Řekněme, že v účtu bezplatné úrovně se vytvoří databáze nebo kontejner s povoleným autopilotem s maximálním počtem RU/s 4000 RU/s. Tento prostředek se automaticky škáluje mezi 400 RU/s-4000 RU/s. 
...
- Poznámka: Pokud se Jednotková cena pro RU/s nebo úložiště liší v oblastech, úroveň Free 400 RU/s a 5 GB bude odpovídat sazbám účtu, ve kterém se oblast vytvořila.

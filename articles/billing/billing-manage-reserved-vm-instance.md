...
2. Vyberte **Všechny služby** > [**Rezervace**](https://portal.azure.com/#blade/Microsoft_Azure_Reservations/ReservationsBrowseBlade) a podívejte se u rezervace na **Využití (%)** .  
  ![Obrázek ukazující seznam rezervací](./media/billing-manage-reserved-vm-instance/reservation-list.png)
3. Vyberte některou rezervaci.
4. Podívejte se na trend využití rezervace v průběhu času.  
  ![Obrázek ukazující využití rezervace ](./media/billing-manage-reserved-vm-instance/reservation-utilization-trend.png)
...
- [Vysvětlení způsobu uplatnění slevy pro plán softwaru Red Hat Enterprise Linux](../billing/billing-understand-rhel-reservation-charges.md)
- [Vysvětlení způsobu uplatnění slevy pro plán softwaru SUSE Linux Enterprise](../billing/billing-understand-suse-reservation-charges.md)

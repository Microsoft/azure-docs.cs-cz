...
1. Na stránce pro virtuální síť WAN vyberte připojení k **virtuální síti**.
1. Na stránce připojení k virtuální síti vyberte **+ Přidat připojení**.
1. Na stránce **Add connection** (Přidat připojení) zadejte údaje do následujících polí:

...
1. Vyberte možnost **řídicí panel** > **přihlášení** > **Set up** > k**webu**Facebook.
...
1. Účet Facebook, který jste použili k registraci aplikace, je správce aplikace. V tuto chvíli se k této aplikaci můžou přihlásit jenom správci.
   ...
   Pokud chcete ověřit jiné účty Facebook, vyberte možnost **Kontrola aplikace** a povolte možnost nastavit> pro přístup do **App-Name jako veřejné \<** , aby se zajistila Obecná veřejnost pro přístup k aplikaci pomocí ověřování na Facebooku.

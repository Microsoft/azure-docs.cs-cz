...
Použití [Export-PfxCertificate](https://docs.microsoft.com/powershell/module/pkiclient/export-pfxcertificate) s kryptografickým otiskem, který byl vrácen Pokud chcete exportovat soubor pfx certifikátu:

...
|TokenLifeTimeInSeconds| No| Určuje životnost kontrolního výrazu SAML. Tato hodnota je v sekundách od hodnoty NotBefore refernced výše. Výchozí hodnota je 300 sekund (5 minut). |

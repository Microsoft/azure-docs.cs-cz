...
Příkaz `withsource= SourceApp` přidá sloupec do výsledků, který určuje aplikaci, která protokol odeslala. Operátor Parse je v tomto příkladu volitelný a používá se k extrahování názvu aplikace z vlastnosti SourceApp. 

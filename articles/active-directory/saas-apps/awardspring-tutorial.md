...
* Můžete kontrolovat v Azure AD, kteří mají přístup k AwardSpring.
* Můžete povolit, aby se vaši uživatelé automaticky přihlásili k AwardSpring (jednotné přihlašování) pomocí svých účtů Azure AD.
...
Ke konfiguraci integrace služby Azure AD s AwardSpring potřebujete následující položky:

* Předplatné služby Azure AD. Pokud nemáte prostředí Azure AD, můžete získat měsíční zkušební verzi [tady](https://azure.microsoft.com/pricing/free-trial/) .
* Předplatné s povoleným AwardSpringm jednotným přihlašováním
...
4. Do vyhledávacího pole zadejte **AwardSpring**, vyberte **AwardSpring** z panelu výsledků a potom kliknutím na tlačítko **Přidat** přidejte aplikaci.

    ![AwardSpring v seznamu výsledků](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurace a testování jednotného přihlašování Azure AD

V této části nakonfigurujete a otestujete jednotné přihlašování Azure AD pomocí AwardSpring na základě testovacího uživatele s názvem **Britta Simon**.
Aby jednotné přihlašování fungovalo, musí se zřídit vztah propojení mezi uživatelem služby Azure AD a souvisejícím uživatelem v AwardSpring.

Pokud chcete nakonfigurovat a otestovat jednotné přihlašování Azure AD pomocí AwardSpring, musíte dokončit tyto stavební bloky:

1. **[Nakonfigurujte jednotné přihlašování Azure AD](#configure-azure-ad-single-sign-on)** a Umožněte uživatelům používat tuto funkci.
2. **[Nakonfigurujte jednotné přihlašování AwardSpring](#configure-awardspring-single-sign-on)** – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
3. **[Vytvořte testovacího uživatele Azure AD](#create-an-azure-ad-test-user)** – k otestování jednotného přihlašování Azure AD pomocí Britta Simon.
4. **[Přiřaďte testovacího uživatele Azure AD](#assign-the-azure-ad-test-user)** – pro povolení Britta Simon pro použití jednotného přihlašování Azure AD.
5. **[Vytvoření AwardSpring Test User](#create-awardspring-test-user)** – pro Britta Simon v AwardSpring, který je propojený s reprezentací uživatele Azure AD.
...
Pokud chcete nakonfigurovat jednotné přihlašování Azure AD pomocí AwardSpring, proveďte následující kroky:

1. V [Azure Portal](https://portal.azure.com/)na stránce integrace aplikací **AwardSpring** vyberte **jednotné přihlašování**.
...
4. Pokud chcete nakonfigurovat aplikaci v režimu iniciované **IDP** , proveďte v **základní části Konfigurace SAML** následující kroky:
    ...
    ![Informace o jednotném přihlašování v doméně AwardSpring a adresách URL](common/idp-intiated.png)
...
5. Klikněte na **nastavit další adresy URL** a proveďte následující krok, pokud chcete nakonfigurovat aplikaci v režimu iniciované **SP** :
    ...
    ![Informace o jednotném přihlašování v doméně AwardSpring a adresách URL](common/metadata-upload-additional-signon.png)
...
9. V části **Nastavení AwardSpring** zkopírujte příslušné adresy URL podle vašich požadavků.
...
### <a name="configure-awardspring-single-sign-on"></a>Konfigurace jednotného přihlašování AwardSpring
...
V této části povolíte Britta Simon pro použití jednotného přihlašování pomocí Azure tím, že udělíte přístup k AwardSpring.

1. V Azure Portal vyberte **podnikové aplikace**, vyberte **všechny aplikace**a pak vyberte **AwardSpring**.

    ![Okno podnikových aplikací](common/enterprise-applications.png)

2. V seznamu aplikace vyberte **AwardSpring**.
...
V této části se v AwardSpring vytvoří uživatel s názvem Britta Simon. AwardSpring podporuje zřizování uživatelů za běhu, což je ve výchozím nastavení povolené. V této části není žádná položka akce. Pokud uživatel ještě v AwardSpring neexistuje, vytvoří se po ověření nový.

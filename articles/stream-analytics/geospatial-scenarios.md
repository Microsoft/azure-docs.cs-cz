...
Pokud lokalita umožňuje více zařízení, můžete definovat pole ID zařízení v `AllowedDeviceID` a uživatelsky definovanou funkci lze použít v klauzuli `WHERE` a ověřit tak, zda ID zařízení datového proudu odpovídá jakémukoli ID zařízení v tomto seznamu. Další informace najdete v kurzu [JavaScript UDF](stream-analytics-javascript-user-defined-functions.md) pro cloudové úlohy a v kurzu [ C# ](stream-analytics-edge-csharp-udf.md) pro práci se systémem souborů Edge pro úlohy Edge.
...
|--------|----------|--------|
|1\. místo|Malé|"MNOHOÚHELNÍK ((-74.00279525078275 40.72833625216264,-74.00547745979765 40.721929158663244,-74.00125029839018 40.71893680218994,-73.9957785919998 40.72521409075776,-73.9972377137039 40.72557184584898,-74.00279525078275 40.72833625216264) )"|

...
| &emsp;&emsp;`autoscaleEnabled` | `autoscale_enabled` | Určuje, zda má být povoleno automatické škálování webové služby. `numReplicas`  = Pokud `0`, `True`; v opačném případě `False`. |

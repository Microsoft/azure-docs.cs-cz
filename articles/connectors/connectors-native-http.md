---
title: Volání koncových bodů HTTP a HTTPS
...
1. V části **Vybrat akci**do vyhledávacího pole zadejte "http" jako filtr. V seznamu **Akce** vyberte akci **http** .
...
Předpokládejme například, že máte aplikaci logiky, která odesílá požadavek HTTP POST pro excelový soubor na web pomocí rozhraní API tohoto webu, které podporuje typ `multipart/form-data`. Tady je postup, jak by tato akce mohla vypadat:

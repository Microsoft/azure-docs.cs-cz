---
title: Microsoft Identity Platform a tok kontrolního výrazu SAML | Azure
...
1. V těle požadavku nahraďte **client_id**, **client_secret**a **assertion** (kontrolní výraz SAML kódovaný jako base64 získal předchozí krok):

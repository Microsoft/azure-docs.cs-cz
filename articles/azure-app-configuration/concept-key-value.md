...
Klíče slouží jako identifikátory párů klíč-hodnota a slouží k ukládání a načítání odpovídajících hodnot. Je běžným postupem uspořádání klíčů do hierarchického oboru názvů pomocí oddělovače znaků, jako je například `/` nebo `:`. Použijte konvenci, která je vhodná pro vaši aplikaci. Konfigurace aplikace považuje klíče za celek. Neanalyzuje klíče, abyste zjistili, jak jsou jejich názvy strukturované nebo vynutily jakékoli pravidlo.

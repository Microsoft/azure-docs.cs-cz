...
2. **[Nakonfigurujte jednotné přihlašování elf dodržování předpisů](#configure-compliance-elf-single-sign-on)** – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
...
### <a name="configure-compliance-elf-single-sign-on"></a>Konfigurace jednotného přihlašování ELF dodržování předpisů
...
Když kliknete na dlaždici ELF dodržování předpisů na přístupovém panelu, měli byste se automaticky přihlásit k ELF dodržování předpisů, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

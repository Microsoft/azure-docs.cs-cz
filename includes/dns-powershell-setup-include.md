...
Otevřete konzolu prostředí PowerShell a připojte se ke svému účtu. Další informace najdete v tématu [přihlášení](/azure/install-az-ps.md?view=azps-1.2.0#sign-in)(/ powershell/azure/install-az-ps?view=azps-1.4.0#sign-in).

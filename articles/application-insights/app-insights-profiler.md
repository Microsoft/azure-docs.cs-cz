...
Application Insights Profiler se instaluje s rozšíření webu Application Insights. Musíte nainstalovat rozšíření webu a nakonfigurovat ji, abyste získali profily pro Azure Web Apps. Jakmile nasadíte webovou aplikaci, i v případě, že jste zahrnuli App Insights SDK do zdrojového kódu, postupujte podle následujících kroků, abyste povolení profileru.

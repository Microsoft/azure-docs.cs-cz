...
- Ujistěte se, že počítače, které chcete replikovat vyhovují [replikovat podpora počítačů](vmware-physical-secondary-support-matrix.md#replicated-vm-support).

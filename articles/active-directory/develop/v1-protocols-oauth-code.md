...
| Znakovou |Požadovanou |`authorization_code`, kterou jste získali v předchozí části |
| identifikátor |Požadovanou | `redirect_uri`zaregistrován v klientské aplikaci. |

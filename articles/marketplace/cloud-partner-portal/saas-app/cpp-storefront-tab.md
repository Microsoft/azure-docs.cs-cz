---
title: SaaS aplikace nabídka prezentace konfigurace Azure | Azure Marketplace
...
Následující tabulka popisuje podrobnosti z prodejních míst, který zadáte pro tuto nabídku. Povinná pole jsou uvést hvězdičkou (*).
...
Použití **marketingové artefakty** formuláře k identifikaci marketingové prostředky, jako jsou loga, videa, snímky obrazovky a dokumenty Azure Marketplace.

![Prezentace marketingové artefakty formuláře](./media/saas-storefront-artifacts.png)

Následující tabulka popisuje pole pro marketingové artefakty.  Povinná pole jsou uvést hvězdičkou (*).
...
|  **Snímky obrazovky**   | Umožňuje přidat snímky obrazovky vaší nabídky. Je maximálně pět snímky obrazovky, které mohou být přidány za nabídky. Maximální velikost je 1280 × 720 pixelů.  |

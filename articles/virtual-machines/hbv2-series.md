...
Další informace o:
- [Architektura a topologie virtuálních počítačů](./workloads/hpc/hbv2-series-overview.md),
- podporovaný [softwarový zásobník](./workloads/hpc/hbv2-series-overview.md#software-specifications) , včetně PODPOROVANÉHO operačního systému a

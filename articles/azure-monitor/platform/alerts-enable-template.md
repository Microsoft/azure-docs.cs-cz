...
> [!NOTE]
> 
> Tento článek popisuje vytvoření **klasického upozornění metrik** pomocí šablon Resource Manageru. Pokud chcete pro vytvoření [novějších upozornění metrik](../../monitoring-and-diagnostics/monitoring-near-real-time-metric-alerts.md) pomocí šablon, [v tomto článku](alerts-metric-create-templates.md) nabízí podrobné informace.
>

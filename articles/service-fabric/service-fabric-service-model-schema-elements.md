...
Pokud má hodnotu true, je hodnota tohoto parametru zašifrovaná. Vývojář aplikace zodpovídá za vytvoření certifikátu a k šifrování citlivých informací pomocí rutiny Invoke-ServiceFabricEncryptSecret. Informace o certifikátu, který bude použit k zašifrování hodnoty, jsou uvedeny v části certifikáty. Tento atribut je zastaralý. Použijte prosím atribut Type.

...
V souvisejícím článku [vytvoříte službu RESTful](rest-api-claims-exchange-dotnet.md) , která komunikuje s Azure Active Directory B2C (Azure AD B2C).
...
* Proveďte kroky popsané v článku [integrace REST APIch deklarací identity](rest-api-claims-exchange-dotnet.md) .
...
7. Do pole **heslo** zadejte heslo certifikátu.
    ...
    ![Odeslat klíč zásad na stránce vytvořit klíč v Azure Portal](./media/secure-rest-api-dotnet-certificate-auth/rest-api-netfw-secure-client-cert-upload.png)
...
5. Ihned po ukončení `<Metadata>` elementu přidejte následující fragment kódu XML:
    ...
    ![Nastavení elementů XML ověřování v ClientCertificate](./media/secure-rest-api-dotnet-certificate-auth/rest-api-netfw-secure-client-cert-tech-profile.png)
...
3. Otestujte proces zadáním příkazu **test** do **daného pole název** .
    ...
    ![Bylo zobrazeno zvýrazněné textové pole název a chyba ověření vstupu.](./media/secure-rest-api-dotnet-certificate-auth/rest-api-netfw-test.png)
...
![Přidat kód pro ověření certifikátu](./media/secure-rest-api-dotnet-certificate-auth/rest-api-netfw-secure-client-code.png)
...
Pokud potřebujete tento krok vyřešit, přečtěte si téma [shromažďování protokolů pomocí Application Insights](troubleshoot-with-application-insights.md).

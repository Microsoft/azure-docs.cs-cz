---
title: Srovnávacích testů COMPUTE pro virtuální počítače Azure s Windows | Dokumentace Microsoftu
description: Porovnejte SPECint výpočetní srovnávacích pro virtuální počítače Azure s Windows serverem.
...
ms.locfileid: "64866282"
---
# <a name="compute-benchmark-scores-for-windows-vms"></a>Srovnávacích testů COMPUTE pro virtuální počítače s Windows
Následující srovnávacích SPECInt zobrazit výpočetní výkon pro vybrané virtuální počítače Azure s Windows serverem. Výpočetní srovnávacích jsou také k dispozici pro [virtuální počítače s Linuxem](../linux/compute-benchmark-scores.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).


## <a name="av2---general-compute"></a>Av2 - obecné výpočetní
| Velikost | virtuální procesory | Uzly NUMA | Procesor | Spuštění | Základ průměrná rychlost | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
| Velikost | virtuální procesory | Uzly NUMA | Procesor | Spuštění | Základ průměrná rychlost | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
| Standard_F2s_v2 | 2 | 1 | Intel(R) Xeon(R) CPU Platinum 8168 @ 2.70GHz | 46 | 56.5 | 2.4 | 
| Standard_F4s_v2 | 4 | 1 | Intel(R) Xeon(R) CPU Platinum 8168 @ 2.70GHz | 60 | 110.2 | 4.7 | 
| Standard_F8s_v2 | 8 | 1 | Intel(R) Xeon(R) CPU Platinum 8168 @ 2.70GHz | 36 | 215.2 | 5.3 | 
| Standard_F16s_v2 | 16 | 1 | Intel(R) Xeon(R) CPU Platinum 8168 @ 2.70GHz | 36 | 409.3 | 15.5 | 
| Standard_F32s_v2 | 32 | 1 | Intel(R) Xeon(R) CPU Platinum 8168 @ 2.70GHz | 31 | 760.9 | 16.9 | 
| Standard_F64s_v2 | 64 | 2 | Intel(R) Xeon(R) CPU Platinum 8168 @ 2.70GHz | 33 | 1440.9 | 26.0 | 
| Standard_F72s_v2 | 72 | 2 | Intel(R) Xeon(R) CPU Platinum 8168 @ 2.70GHz | 29 | 1372.1 | 8.2 | 
...
* Kapacity úložiště, podrobných informací o discích a další faktory pro výběr mezi velikostmi virtuálních počítačů najdete v tématu [velikosti virtuálních počítačů](sizes.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).

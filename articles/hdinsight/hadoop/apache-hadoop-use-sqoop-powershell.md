...
* Cluster HDInsight, Azure SQL Server a databáze, jak jsou definovány v [vytvoření clusteru a SQL database](./hdinsight-use-sqoop.md#create-cluster-and-sql-database).

...
description: Vysvětlení způsobu, jakým je Azure Data Lake Storage Gen1 bezpečnější úložiště pro velké objemy dat
...
Každé předplatné Azure je možné přidružit k instanci Azure Active Directory. K účtu Data Lake Storage Gen1 můžou přistupovat jenom identity uživatelů a služeb, které jsou definované ve službě Azure Active Directory, pomocí nástrojů pro Azure Portal, nástrojů příkazového řádku nebo prostřednictvím klientských aplikací, které vaše organizace sestaví pomocí Data Lake Sada SDK pro Gen1 úložiště. Mezi klíčové výhody použití Azure Active Directory jako centralizovaného mechanismu řízení přístupu patří:
...
* Ověřování službou Multi-Factor Authentication. [Multi-Factor Authentication](../active-directory/authentication/multi-factor-authentication.md) poskytuje další úroveň zabezpečení pro přihlášení a transakce uživatelů.
...
| Vlastník |Všechno |Všechno |Role vlastníka je uživatel. Tato role může spravovat vše a má úplný přístup k datům. |

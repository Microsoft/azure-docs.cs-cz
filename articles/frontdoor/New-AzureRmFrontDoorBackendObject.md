...
ms.locfileid: "47047320"
---
# Nové AzureRmFrontDoorBackendObject
Vytvořte objekt PSBackend
...
## POPIS
Vytvoření PSBackend objektu pro vytváření branou
...
### -BackendHostHeader
Hodnota, kterou chcete použít jako hlavičku hostitele Odeslané back-endu. Výchozí hodnota je adres back-endu.
...
Určuje, zda povolit použití tohoto back-endu. Výchozí hodnota je povolená.
...
### -HttpPort
Číslo portu TCP protokolu HTTP.
Musí být mezi 1 a 65535.
Výchozí hodnota 80.
...
### -HttpsPort
Číslo portu TCP pro protokol HTTPS.
Musí být mezi 1 a 65535.
...
### -Priority
Priorita pro vyrovnávání zatížení.
Musí být mezi 1 a 5.
...
### -Weight
Váha tohoto koncového bodu pro účely služby Vyrovnávání zatížení.
Musí být mezi 1 a 1000.

...
4. Do vyhledávacího pole zadejte **Origami**.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/origami-tutorial/tutorial_origami_search.png)

5. Na panelu výsledků vyberte **Origami**a potom klikněte na **přidat** tlačítko Přidat aplikaci.

    ![Vytváření testovacího uživatele Azure AD](./media/origami-tutorial/tutorial_origami_addfromgallery.png)
...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Konfigurovat jednotné přihlašování](./media/origami-tutorial/tutorial_origami_samlbase.png)

3. Na **Origami domény a adresy URL** část, proveďte následující kroky:

    ![Konfigurovat jednotné přihlašování](./media/origami-tutorial/tutorial_origami_url.png)
...
4. Na **SAML podpisový certifikát** klikněte na tlačítko **certifikátu (Base64)** a potom uložte soubor certifikátu v počítači.
    ...
    ![Konfigurovat jednotné přihlašování](./media/origami-tutorial/tutorial_origami_certificate.png) 

5. Klikněte na tlačítko **Uložit** tlačítko.

    ![Konfigurovat jednotné přihlašování](./media/origami-tutorial/tutorial_general_400.png)
...
6. Na **Origami konfigurace** klikněte na tlačítko **konfigurace Origami** otevřete **konfigurovat přihlášení** okno. Kopírování **Sign-Out adresu URL a SAML jeden přihlašování služby URL** z **Stručná referenční příručka části.**
    ...
    ![Konfigurovat jednotné přihlašování](./media/origami-tutorial/tutorial_origami_configure.png) 

7. Přihlaste se k účtu Origami pomocí oprávnění správce.

8. V nabídce v horní části, klikněte na tlačítko **správce**.
   
    ![Konfigurovat jednotné přihlašování](./media/origami-tutorial/tutorial_origami_51.png)

9. V jednom přihlášení na stránce instalačního programu dialogové okno proveďte následující kroky:
   
    ![Konfigurovat jednotné přihlašování](./media/origami-tutorial/tutorial_origami_531.png)
...
1. V **portál Azure**, v levém navigačním podokně klikněte na tlačítko **Azure Active Directory** ikonu.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/origami-tutorial/create_aaduser_01.png) 

2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin** a klikněte na tlačítko **všichni uživatelé**.
    
    ![Vytváření testovacího uživatele Azure AD](./media/origami-tutorial/create_aaduser_02.png) 

3. Chcete-li otevřít **uživatele** dialogové okno, klikněte na tlačítko **přidat** horní dialogové okno.
 
    ![Vytváření testovacího uživatele Azure AD](./media/origami-tutorial/create_aaduser_03.png) 

4. Na **uživatele** dialogové okno stránky, proveďte následující kroky:
 
    ![Vytváření testovacího uživatele Azure AD](./media/origami-tutorial/create_aaduser_04.png) 
...
3. Na **uživatelů a zabezpečení** dialogové okno, klikněte na tlačítko **uživatelé**.
    ...
    ![Konfigurovat jednotné přihlašování](./media/origami-tutorial/tutorial_origami_54.png)

4. Klikněte na tlačítko **přidat nového uživatele**.
   
    ![Konfigurovat jednotné přihlašování](./media/origami-tutorial/tutorial_origami_55.png)

5. V dialogovém okně Přidat nové uživatele proveďte následující kroky:
   
    ![Konfigurovat jednotné přihlašování](./media/origami-tutorial/tutorial_origami_56.png)
    ...
    ![Konfigurovat jednotné přihlašování](./media/origami-tutorial/tutorial_origami_57.png)

6. Přiřadit **role uživatele** a **klientský přístup** uživateli. 
   
    ![Konfigurovat jednotné přihlašování](./media/origami-tutorial/tutorial_origami_58.png)
...
2. V seznamu aplikací vyberte **Origami**.
    ...
    ![Konfigurovat jednotné přihlašování](./media/origami-tutorial/tutorial_origami_app.png) 

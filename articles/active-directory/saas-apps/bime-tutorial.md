...
4. Do vyhledávacího pole zadejte **Bime**.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/bime-tutorial/tutorial_bime_search.png)

5. Na panelu výsledků vyberte **Bime**a potom klikněte na **přidat** tlačítko Přidat aplikaci.

    ![Vytváření testovacího uživatele Azure AD](./media/bime-tutorial/tutorial_bime_addfromgallery.png)
...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Konfigurovat jednotné přihlašování](./media/bime-tutorial/tutorial_bime_samlbase.png)

3. Na **Bime domény a adresy URL** část, proveďte následující kroky:

    ![Konfigurovat jednotné přihlašování](./media/bime-tutorial/tutorial_bime_url.png)
...
4. Na **SAML podpisový certifikát** část, zkopírujte **kryptografický OTISK** hodnotu z certifikátu.
    ...
    ![Konfigurovat jednotné přihlašování](./media/bime-tutorial/tutorial_bime_certificate.png) 

5. Klikněte na tlačítko **Uložit** tlačítko.

    ![Konfigurovat jednotné přihlašování](./media/bime-tutorial/tutorial_general_400.png)
...
6. Na **Bime konfigurace** klikněte na tlačítko **konfigurace Bime** otevřete **konfigurovat přihlášení** okno. Kopírování **SAML jeden přihlašování adresa URL služby** z **Stručná referenční příručka části.**
    ...
    ![Konfigurovat jednotné přihlašování](./media/bime-tutorial/tutorial_bime_configure.png) 
...
9. Na stránce konfigurace účtu proveďte následující kroky:
    ...
    ![Konfigurovat jednotné přihlašování](./media/bime-tutorial/ic775559.png "nakonfigurovat jednotné přihlašování")
...
1. V **portál Azure**, v levém navigačním podokně klikněte na tlačítko **Azure Active Directory** ikonu.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/bime-tutorial/create_aaduser_01.png) 

2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin** a klikněte na tlačítko **všichni uživatelé**.
    
    ![Vytváření testovacího uživatele Azure AD](./media/bime-tutorial/create_aaduser_02.png) 

3. Chcete-li otevřít **uživatele** dialogové okno, klikněte na tlačítko **přidat** horní dialogové okno.
 
    ![Vytváření testovacího uživatele Azure AD](./media/bime-tutorial/create_aaduser_03.png) 

4. Na **uživatele** dialogové okno stránky, proveďte následující kroky:
 
    ![Vytváření testovacího uživatele Azure AD](./media/bime-tutorial/create_aaduser_04.png) 
...
4. Na **podrobné informace o uživateli** dialogové okno proveďte následující kroky:
    ...
    ![Podrobné informace o uživateli](./media/bime-tutorial/ic775563.png "podrobné informace o uživateli")
...
2. V seznamu aplikací vyberte **Bime**.
    ...
    ![Konfigurovat jednotné přihlašování](./media/bime-tutorial/tutorial_bime_app.png) 

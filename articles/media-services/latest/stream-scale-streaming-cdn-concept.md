...
- [Koncový bod streamování](stream-streaming-endpoint-concept.md) `hostname` a adresa URL streamování zůstávají stejné, bez ohledu na to, jestli povolíte CDN.
...
* Nezapomeňte zkontrolovat dokument [koncového bodu streamování (zdroj)](stream-streaming-endpoint-concept.md) .

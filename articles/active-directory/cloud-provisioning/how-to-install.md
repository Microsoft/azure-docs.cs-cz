...
Chcete-li nainstalovat agenta, postupujte podle těchto kroků.
 ...
 9. Na obrazovce **připojit ke službě Active Directory** vyberte **Přidat adresář**. Pak se přihlaste pomocí účtu správce služby Active Directory. Tato operace přidá váš místní adresář. 
 10. Volitelně můžete spravovat preference řadičů domény, které bude agent používat, a to tak, že vybere **možnost vybrat prioritu řadiče domény** a objednává seznam řadičů domény.   Klikněte na **OK**.
 ...
 12. Na **obrazovce konfigurovat účet služby** zadejte přihlašovací údaje správce domény, aby se vytvořil skupinový účet spravované služby, který se použije ke spuštění služby agenta.  Tento účet bude pojmenován provAgentgMSA $.
   ![Vytvořit gMSA](media/how-to-install/install-10.png)</br>
 13.  Na obrazovce pro **instalaci agenta** potvrďte nastavení a účet, který se vytvoří, a klikněte na **Potvrdit**.
  ![Potvrdit settngs](media/how-to-install/install-11.png)</br>
 14. Po dokončení této operace byste měli vidět, **že se instalace agenta dokončila.** Vyberte možnost **ukončit**.

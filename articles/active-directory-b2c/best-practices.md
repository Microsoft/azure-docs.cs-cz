...
| Omezování |  Azure AD B2C omezuje provoz, pokud je v krátké době odesíláno příliš mnoho požadavků ze stejného zdroje. Při zátěžovém testování použijte několik zdrojů přenosů a v aplikacích proveďte řádné zpracování kódu chyby `AADB2C90229`. |
...
| [podpora Microsoftu](support-options.md) | Soubor a žádost o podporu pro Azure AD B2C technické problémy. Podpora k fakturaci a správě předplatného se poskytuje zadarmo. |

...
Následující článek ukazuje, jak zaregistrovat a spravovat server pomocí služby synchronizace úložiště. Informace o tom, jak nasadit Synchronizace souborů Azure kompletní, najdete v tématu [nasazení synchronizace souborů Azure](file-sync-deployment-guide.md) .
...
* Na serveru musí běžet podporovaná verze Windows serveru. Další informace najdete v tématu [synchronizace souborů Azure požadavky na systém a interoperabilita](file-sync-planning.md#windows-file-server-considerations).
* Ujistěte se, že je nasazená služba synchronizace úložiště. Další informace o tom, jak nasadit službu synchronizace úložiště, najdete v tématu [nasazení synchronizace souborů Azure](file-sync-deployment-guide.md).

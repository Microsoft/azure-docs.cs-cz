...
- Python 2,7 nebo 3,6 nebo novější – informace o nastavení Pythonu ve Windows najdete v [dokumentaci k Pythonu v systému Windows]( https://docs.microsoft.com/windows/python/) .

...
> [!TIP]
> Příkazy v této části vytvoří pracovní prostor základní edice. Chcete-li vytvořit pracovní prostor organizace, použijte přepínač `--sku enterprise` s příkazem `az ml workspace create`. Další informace o edicích Azure Machine Learning najdete v tématu [co je Azure Machine Learning](overview-what-is-azure-ml.md#sku).

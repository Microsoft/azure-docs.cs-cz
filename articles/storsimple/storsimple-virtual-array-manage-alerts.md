...
3. V okně **Obecné nastavení** , přejít na **Nastavení výstrahy** a nastavte následující:
   ...
   3. Do pole **Další příjemci e-mailu** zadejte e-mailové adresy všech dalších příjemců, kteří by měli dostávat oznámení o výstrahách. Do pole Formát zadejte jména *\@Somewhere.com*. Oddělte e-mailové adresy pomocí středníků. Na jedno virtuální zařízení můžete nakonfigurovat maximálně 20 e-mailových adres.
   ...
   4. Pokud chcete poslat testovací e-mailové oznámení, klikněte na **Odeslat zkušební e-mail**. Služba StorSimple Device Manager zobrazí stavové zprávy, když přepošle oznámení o testu.
       ...
       ![E-mail s testovacím oznámením výstrah odeslán](./media/storsimple-virtual-array-manage-alerts/alerts7.png)
   ...
   5. V dolní části stránky klikněte na **Uložit** a uložte konfiguraci. Po zobrazení výzvy k potvrzení klikněte na **Ano**.
      ...
      ![E-mail s testovacím oznámením výstrah odeslán](./media/storsimple-virtual-array-manage-alerts/alerts10.png)
...
| Na <\>*názvu zařízení* se spouští nedostatek místa na disku místní rezervace. |Nízká doba odezvy. |10% celkové zřízené velikosti pro <*název zařízení*\> je rezervované na místním zařízení a na rezervovaném místě teď dochází. Úloha na <*název zařízení*\> vygenerovala vyšší míru četnosti změn nebo možná jste nedávno migrovali velké množství dat. To může vést ke snížení výkonu. K vyřešení tohoto problému zvažte jednu z následujících akcí:<ul><li>Zvyšte šířku pásma cloudu na toto zařízení.</li><li>Snižte nebo přesuňte úlohy na jiný svazek nebo sdílenou složku.</li></ul> |

### <a name="security-alerts"></a>Výstrahy zabezpečení

| Text výstrahy | Událost | Další informace/doporučené akce |
|:--- |:--- |:--- |
| Heslo pro <*název zařízení*\> vyprší v <*číslo*\> dnů. |Upozornění na heslo |Platnost vašeho hesla vyprší za <*číslo*\> dní. Zvažte změnu hesla. Další informace najdete [v části Změna hesla správce zařízení StorSimple Virtual Array](storsimple-virtual-array-change-device-admin-password.md). |

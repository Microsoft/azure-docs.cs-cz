...
Pokud chcete obnovit existující fond SQL z bodu obnovení, použijte rutinu [Restore-AzSqlDatabase](https://docs.microsoft.com/powershell/module/az.sql/restore-azsqldatabase) prostředí PowerShell.
...
6. Obnovte fond SQL na požadovaný bod obnovení pomocí rutiny [Restore-AzSqlDatabase](https://docs.microsoft.com/powershell/module/az.sql/restore-azsqldatabase) prostředí PowerShell.
...
8. Po dokončení obnovení můžete po obnovení nakonfigurovat obnovený fond SQL pomocí [Konfigurace databáze](../sql-database/sql-database-disaster-recovery.md#configure-your-database-after-recovery).

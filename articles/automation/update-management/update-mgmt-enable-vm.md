...
5. Vyberte pracovní prostor Log Analytics a účet Automation a kliknutím na **Povolit** povolte Update Management. Po povolení Update Management může trvat přibližně 15 minut, než si můžete prohlédnout posouzení aktualizace z virtuálního počítače.

    ![Povolení řešení Update Management](media/update-mgmt-enable-vm/manageupdates-update-enable.png)

...
## <a name="assign-permissions-for-the-managed-identity"></a>Přiřazení oprávnění pro spravovanou identitu

*IDENTITY_CLIENT_ID* spravovaná identita musí mít ve skupině prostředků oprávnění ke čtení, která obsahuje sadu virtuálních počítačů s měřítkem clusteru AKS.

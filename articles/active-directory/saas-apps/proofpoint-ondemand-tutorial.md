...
Když kliknete na dlaždici Proofpoint on demand na přístupovém panelu, měli byste se automaticky přihlásit k Proofpoint na vyžádání, pro kterou jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).

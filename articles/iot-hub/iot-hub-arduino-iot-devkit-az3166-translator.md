...
1. Přejděte ke službě rozpoznávání řeči, kterou jste právě vytvořili, klikněte na tlačítko **klíče** a zkopírujte a poznamenejte si **klíč1** pro DevKit přístupu k němu.
  ![](media/iot-hub-arduino-iot-devkit-az3166-translator/copy-keys.png) kopírování klíčů
...
1. V VS Code klikněte na `F1`, zadejte a vyberte **Azure IoT Device Workbench: zřízení služeb Azure...** . ![zřízení služeb Azure](media/iot-hub-arduino-iot-devkit-az3166-translator/provision.png)

1. Podle pokynů dokončete zřizování Azure IoT Hub a Azure Functions.
   Postup ![zřízení](media/iot-hub-arduino-iot-devkit-az3166-translator/provision-steps.png)
...
1. Vložte adresu URL do souboru `azure_config.h`.
...
1. Klikněte na `F1`, zadejte a vyberte **Azure IoT Device Workbench: Konfigurace nastavení zařízení... Připojovací řetězec zařízení > config**. Vyberte **vybrat IoT Hub připojovací řetězec zařízení** , abyste ho mohli nakonfigurovat na DevKit.
   ![nakonfigurovat připojovací řetězec](media/iot-hub-arduino-iot-devkit-az3166-translator/configure-connection-string.png)

1. Po úspěšném dokončení se zobrazí oznámení.
   ![nakonfigurovat úspěšnost připojovacího řetězce](media/iot-hub-arduino-iot-devkit-az3166-translator/configure-connection-string-success.png)

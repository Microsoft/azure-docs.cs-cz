...
ms.locfileid: "68567093"
---
# <a name="choose-the-right-sql-server-option-in-azure"></a>Výběr pravé SQL Serverové možnosti v Azure
...
|  | Databáze o až 100 TB. | Až 8 TB. | Instance systému SQL Server s úložištěm o velikosti až 64 TB. Instance může podporovat tolik databází, kolik je potřeba. |
...
- [Smlouva o úrovni služeb](#service-level-agreement-sla) – IaaS i PaaS poskytují vysokou a standardní smlouvu SLA pro obory. PaaS Option garantuje 99,99% SLA, zatímco IaaS garantuje 99,95% SLA pro infrastrukturu, což znamená, že musíte implementovat další mechanismy, abyste zajistili dostupnost svých databází. Pokud v extrémním případě chcete implementovat řešení s vysokou dostupností, které odpovídá PaaS, možná budete muset vytvořit další SQL Server ve virtuálním počítači a nakonfigurovat skupiny dostupnosti AlwaysOn, které by mohly mít za následek dvojnásobek nákladů na vaši databázi.

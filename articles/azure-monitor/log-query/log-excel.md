...
ms.locfileid: "94507475"
---
# <a name="integrate-log-analytics-and-excel"></a>Integrace Log Analytics a Excelu

Můžete integrovat Azure Monitor Log Analytics a Microsoft Excel pomocí dotazů M a rozhraní API pro Log Analytics.  Tato integrace umožňuje odeslat 500 000 záznamů do aplikace Excel.

...
Nastavte přihlašovací údaje k VIRTUÁLNÍmu `$cred` počítači na proměnnou pomocí [Get-Credential](/powershell/module/microsoft.powershell.security/get-credential):

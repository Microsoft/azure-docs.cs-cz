---
title: Přehled služby Azure Networking Services
description: Přečtěte si o síťových službách v Azure a jejich možnostech – služby pro připojení, služby ochrany aplikací, služby pro doručování aplikací a monitorování sítě.
services: networking
...
- [**Služby doručování aplikací**](#deliver) Doručovat aplikace do sítě Azure pomocí kterékoli nebo kombinace těchto síťových služeb v Azure-Content Delivery Network (CDN), služby front-in Azure, Traffic Manager, Application Gateway, Internet Analyzer a Load Balancer.
...
![Přehled privátního koncového bodu](./media/networking-overview/private-endpoint.png)


## <a name="application-delivery-services"></a><a name="deliver"></a>Služby doručování aplikací

Tato část popisuje síťové služby v Azure, které vám pomůžou doručovat aplikace – Network Watcher, ExpressRoute monitor, Azure Monitor nebo terminál VNet Terminal Access Point (klepněte).

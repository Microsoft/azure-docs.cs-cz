...
3. **[Vytvoření zkušebního uživatele SumTotalCentral](#create-a-sumtotalcentral-test-user)**  – Pokud chcete mít protějšek Britta Simon SumTotalCentral, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **SumTotalCentral domény a adresy URL** části, proveďte následující kroky:
...
6. Ke konfiguraci jednotného přihlašování na **SumTotalCentral** straně, je nutné odeslat na stažený **soubor XML s metadaty** k [tým podpory SumTotalCentral](http://www.sumtotalsystems.com/support/). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

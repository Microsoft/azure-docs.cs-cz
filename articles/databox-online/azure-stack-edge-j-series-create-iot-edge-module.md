...
![Jak Azure IoT Edge modul funguje na Azure Stack Edge](./media/azure-stack-edge-j-series-create-iot-edge-module/how-module-works-1.png)
...
- Azure Stack hraniční zařízení, na kterém běží.
    ...
    Další informace najdete na webu [Konfigurace výpočtů](azure-stack-edge-j-series-deploy-configure-compute.md#configure-compute) pro Azure Stack Edge.
...
Pokud chcete nasadit a spustit tento modul na Azure Stack Edge, přečtěte si postup v tématu [Přidání modulu](azure-stack-edge-j-series-deploy-configure-compute.md#add-a-module).

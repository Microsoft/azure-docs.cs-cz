...
- Můžete použít interní společnosti adresy URL při vzdálené prostřednictvím [Proxy aplikace](https://docs.microsoft.com/en-us/azure/active-directory/active-directory-application-proxy-get-started)

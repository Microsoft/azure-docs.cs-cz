...
* **Název účtu úložiště** – Pokud jste použili předchozí skript, název účtu úložiště byl uložený v proměnné `$ACI_PERS_STORAGE_ACCOUNT_NAME`. Název účtu zobrazíte tak, že zadáte:

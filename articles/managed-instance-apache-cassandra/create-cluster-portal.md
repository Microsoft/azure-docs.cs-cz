...
1. Pokud jste v posledním kroku vytvořili novou virtuální síť, přejděte ke kroku 9. Pokud jste před vytvořením clusteru vybrali existující virtuální síť, musíte použít některá zvláštní oprávnění pro Virtual Network a podsíť. K tomu je potřeba získat ID prostředku pro existující Virtual Network. V [Azure CLI](https://docs.microsoft.com/cli/azure/get-started-with-azure-cli)spusťte následující příkaz:

...
- Seznamte se [s technickými charakteristikami spravované instance](sql-database-managed-instance-resource-limits.md#service-tier-characteristics).

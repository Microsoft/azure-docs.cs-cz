---
title: 'Konfigurace partnerského vztahu pro okruh – ExpressRoute: Azure | Microsoft Docs'
...
4. Nakonfigurujte partnerský vztah Microsoftu. Po zadání všech parametrů **uložte** konfiguraci. Příklad konfigurace znázorňuje následující obrázek:
   ...
   ![Konfigurace partnerského vztahu Microsoftu](./media/expressroute-howto-routing-portal-resource-manager/configuration-m.png)
...
Tato část vám pomůže vytvořit, získat, aktualizovat a odstranit konfiguraci veřejného partnerského vztahu Azure pro okruh ExpressRoute.

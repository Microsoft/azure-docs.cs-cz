...
> [!TIP]
> Můžete se také rozhodnout povolit jednotné přihlašování založené na SAML pro software OfficeSpace podle pokynů uvedených v [kurzu OfficeSpace Software Single Signing](./officespace-tutorial.md). Jednotné přihlašování se dá nakonfigurovat nezávisle na automatickém zřizování uživatelů, i když tyto dvě funkce doplňují sebe.

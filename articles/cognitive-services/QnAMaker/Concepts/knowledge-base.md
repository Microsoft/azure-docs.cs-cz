...
Použijte [kontext konverzace](../how-to/metadata-generateanswer-usage.md#use-question-and-answer-results-to-keep-conversation-context) s [funkcemi vícenásobného](../how-to/multiturn-conversation.md) zapínání, aby konverzace mohla Upřesnit otázky a odpovědi a najít správnou a konečnou odpověď.

...
8. Vytvořte své fondy back-end adres – *contosopool* a *fabrikampool*, [sondu](../virtual-machines/linux/create-cli-complete.md?toc=%2fazure%2fvirtual-network%2ftoc.json) - *http*a pravidla vyrovnávání zatížení – *HTTPc* a *HTTPf*:

...
ms.locfileid: "55458988"
---
# <a name="task-fail-event"></a>Událost selhání úlohy

 Tato událost je vygenerován, pokud úkol skončí s chybou. Aktuálně všechny nenulové ukončovací kódy se považují za chyby. Tato událost bude vygenerován *kromě* událost dokončení úlohy a umožňuje rozpoznat, kdy se má úloha selhala.


 Následující příklad ukazuje tělo úkolu selhání události.

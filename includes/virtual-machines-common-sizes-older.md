...
|Velikost – Velikost\Název | vCPU |Paměť|Síťové karty (Max.)|Max. velikost dočasného disku |Nejvýše k datové disky (1023 GB)|Nejvýše k IOPS (300 na disk)|
|---|---|---|---|---|---|---|
|A0\Basic_A0|1\. místo|768 MB|2| 20 GB|1\. místo|1×300|
|A1\Basic_A1|1\. místo|1,75 GB|2| 40 GB |2|2×300|
...
| Velikost | vCPU | Paměť: GiB | Dočasné úložiště (HDD): GiB | Max. datových disků | Maximální propustnost datového disku: IOPS | Maximální počet síťových karet/očekávaná šířka pásma sítě (MB/s)  |
| --- | --- | --- | --- | --- | --- | --- |
| Standard_A0&nbsp;<sup>1</sup> |1\. místo |0,768 |20 |1\. místo |1×500 |2 / 100 |
| Standard_A1 |1\. místo |1,75 |70 |2 |2×500 |2 / 500  |
...
| Velikost | vCPU | Paměť: GiB | Dočasné úložiště (HDD): GiB | Max. datových disků | Maximální propustnost datového disku: IOPS | Maximální počet síťových karet|
| --- | --- | --- | --- | --- | --- | --- |
...
<sup>1</sup> V případě aplikací MPI je v síti QDR InfiniBand povolena vyhrazená síť s back-end službou RDMA, která zajišťuje extrémně nízkou latenci a vysokou šířku pásma.  
...
|--------------|-----------|-------------|----------------|----------------------------------------------------------|-----------------------------------|------------------------------|
| Standard_D1  | 1\. místo         | 3,5         | 50             | 3000 / 46 / 23                                           | 4 / 4×500                         | 2 / 500                 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Standard_DS1 |1\. místo |3,5 |7 |4 |4 000 / 32 (43) |3 200 / 32 |2 / 500 |
...
| Velikost          | vCPU | Paměť (GiB) | Dočasné úložiště (GiB) | Max. datových disků | Maximální propustnost dočasného úložiště (IOPS/MB/s) | Maximální propustnost disku při neukládání do mezipaměti (IOPS/MB/s) | Maximální počet síťových karet/očekávaná šířka pásma sítě (MB/s) | 
|----------------|-----------|-------------|--------------------------|----------------|-------------------------------------------------------------|-------------------------------------------|------------------------------| 

---
title: Jaké jsou Apache Hadoop a Apache Spark technologický zásobník? – Azure HDInsight
...
ms.locfileid: "68442136"
---
# <a name="what-is-apache-hadoop-in-azure-hdinsight"></a>Co je Apache Hadoop ve službě Azure HDInsight?

Tento článek obsahuje úvod k Apache Hadoop ve službě Azure HDInsight. Azure HDInsight je plně spravovaná, plně spektrum Open Source služby pro analýzu v cloudu pro podniky. Můžete použít Open Source architektury, jako jsou Hadoop, Apache Spark, Apache Hive, LLAP, Apache Kafka, Apache Storm, R a další. 


## <a name="what-is-hdinsight-and-the-hadoop-technology-stack"></a>Co je HDInsight a technologie Hadoop?

[Apache Hadoop](https://hadoop.apache.org/) byl původní open source architekturou pro distribuované zpracování a analýzy velkých datových sad v clusterech. Technologie Hadoop zahrnuje související software a nástroje, včetně Apache Hive, Apache HBA, Spark, Kafka a mnoha dalších.
...
![Architektura HDInsight: ]Architektura datových skladů(./media/apache-hadoop-introduction/hdinsight-architecture-data-warehouse.png "HDInsight") pro datové sklady
...
![Architektura HDInsight: ](./media/apache-hadoop-introduction/hdinsight-architecture-iot.png "Architektura IoT Internet věcí HDInsight") 
...
![Architektura HDInsight: Architektura pro](./media/apache-hadoop-introduction/hdinsight-architecture-data-science.png "datové vědy HDInsight") pro datové vědy
...
![Architektura HDInsight: Hybridní]architektura hybridních(./media/apache-hadoop-introduction/hdinsight-architecture-hybrid.png "HDInsight")
...
|Programovací jazyk  |Information  |
|---------|---------|
|Výchozí podpora programovacích jazyků     | Ve výchozím nastavení podporují clustery prostředí HDInsight tyto jazyky:<ul><li>Java</li><li>Python</li><li>.NET</li><li>Go</li></ul>  |
...
* [Vizualizace Apache Hive dat pomocí Microsoft Power BI ve službě Azure HDInsight](apache-hadoop-connect-hive-power-bi.md)
...
* [Připojení Excelu k Apache Hadoop s](apache-hadoop-connect-excel-power-query.md) využitím Power Query (vyžaduje Windows)

* [Připojení Excelu k Apache Hadoop s](apache-hadoop-connect-excel-hive-odbc-driver.md) využitím Microsoft Hive ODBC Driver (vyžaduje Windows)

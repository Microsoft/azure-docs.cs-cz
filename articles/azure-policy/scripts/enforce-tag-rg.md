---
title: Ukázka kódu JSON pro Azure Policy – Vynucení značky a její hodnoty ve skupinách prostředků | Microsoft Docs
description: Tato ukázková zásada JSON vyžaduje značku a hodnotu u skupiny prostředků.

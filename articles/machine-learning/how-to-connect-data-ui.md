...
Pro prostředí prvního kódu si přečtěte následující články, které používají [sadu Azure Machine Learning Python SDK](/python/api/overview/azure/ml/?preserve-view=true&view=azure-ml-py) :

...
- Licencování na základě skupin v současné době nepodporuje skupiny, které obsahují jiné skupiny (vnořené skupiny). Pokud použijete licenci pro vnořenou skupinu, použije se jenom pro bezprostřední členy této skupiny na první úrovni.

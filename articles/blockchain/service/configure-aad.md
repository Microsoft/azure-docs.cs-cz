...
1. Spuštěním následujícího příkazu proveďte ověření pomocí uživatelského účtu Azure AD. \> \<myAADDirectory nahraďte doménou služby Azure AD. Například, `yourdomain.onmicrosoft.com`.
...
Pokud chcete vygenerovat heslo, nahraďte **aadauthcode** řetězcem **aaddevice**. \> \<myAADDirectory nahraďte doménou služby Azure AD. Například, `yourdomain.onmicrosoft.com`.

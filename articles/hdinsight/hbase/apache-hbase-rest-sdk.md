...
:::image type="content" source="./media/apache-hbase-rest-sdk/hdinsight-table-roles.png" alt-text="Výstup ukázkových dat Apache HBA" border="true":::

...
Velmi jednoduché ukázky kódu s použitím atributu `LeaseCollectionPrefix` v C#, by vypadaly takto:
...
A pro JavaScript můžete použít konfiguraci `function.json` souboru s atributem `leaseCollectionPrefix`:

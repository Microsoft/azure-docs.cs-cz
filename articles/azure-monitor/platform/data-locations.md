...
| Výstrahy | Výstrahy vytvořené pomocí Azure Monitor. | [Azure Portal](alerts-managing-alert-instances.md)<br>[REST API správy výstrah](/rest/api/monitor/alertsmanagement/alerts) |

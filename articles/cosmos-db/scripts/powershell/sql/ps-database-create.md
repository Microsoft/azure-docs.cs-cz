---
title: Prostředí Azure PowerShell script – vytvoření databáze Azure Cosmos
description: Skript Azure Powershellu ukázkový – vytvoření databáze Azure Cosmos
author: markjbrown
...
---
# <a name="create-an-azure-cosmos-database-using-powershell"></a>Vytvořit databázi Azure Cosmos pomocí Powershellu

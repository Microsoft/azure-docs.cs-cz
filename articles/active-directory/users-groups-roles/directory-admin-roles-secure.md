...
Azure Active Directory, použijte [Azure AD Privileged Identity Management](../active-directory-privileged-identity-management-configure.md) funkce. Časově omezený aktivace privilegované role funguje tak, že umožňuje:

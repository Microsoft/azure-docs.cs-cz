...
Když na přístupovém panelu kliknete na dlaždici HR2day by Merces, měli byste se k HR2day automaticky přihlásit pomocí Merces, pro kterou jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).

...
| Parametr | Popis |
|:---|:---|
| Autorizační hlavička | **Vyžaduje** se Hlavička protokolu HTTP používaná k identifikaci aplikace Použijte klíč: Authorization a Value: "nosič" + "+ přístupový token. Podrobnosti najdete tady.|
| language | **Vyžaduje** se Řetězec představující kód jazyka. Tento parametr podporuje pouze angličtinu s **EN** jako název jazyka.|

...
ms.locfileid: "105967077"
---
# <a name="azure-app-service-local-cache-overview"></a>Přehled Azure App Service místní mezipaměti

> [!NOTE]
> Místní mezipaměť není podporovaná v aplikacích Function App ani ve App Service kontejnerových aplikacích, jako je například v [kontejnerech Windows](quickstart-custom-container.md?pivots=container-windows) nebo v App Service v systému [Linux](overview.md#app-service-on-linux). Verze místní mezipaměti, která je k dispozici pro tyto typy aplikací, je [mezipaměť aplikace](https://github.com/Azure-App-Service/KuduLite/wiki/App-Cache).

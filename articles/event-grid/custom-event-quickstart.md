...
description: K publikování vlastního tématu a přihlášení k odběru událostí pro toto téma použijte Azure Event Grid a Azure CLI. Události jsou zpracovávány webovou aplikací.
services: event-grid
keywords: ''
author: spelluru
ms.author: spelluru

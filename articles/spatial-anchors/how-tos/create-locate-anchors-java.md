---
title: Vytvoření & vyhledání kotev v jazyce Java
...
Přečtěte si další informace o metodě [resetování](https://docs.microsoft.com/java/api/com.microsoft.azure.spatialanchors.cloudspatialanchorsession.reset) .

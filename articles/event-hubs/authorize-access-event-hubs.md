...
Ve výchozím nastavení jsou všechny prostředky Event Hubs zabezpečené a jsou k dispozici pouze vlastníkovi účtu. I když můžete použít kteroukoli strategii autorizace uvedenou výše a udělit klientům přístup k prostředkům centra událostí. Autorizaci Azure AD podporují jenom Event Hubs prostředky vytvořené pomocí modelu nasazení Azure Resource Manager. Microsoft doporučuje používat Azure AD, pokud je to možné, pro zajištění maximálního zabezpečení a snadného použití.

...
4. Do vyhledávacího pole zadejte **Tichomoří rozvrhu**.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/pacific-timesheet-tutorial/tutorial_pacifictimesheet_search.png)

5. Na panelu výsledků vyberte **Tichomoří rozvrhu**a potom klikněte na **přidat** tlačítko Přidat aplikaci.

    ![Vytváření testovacího uživatele Azure AD](./media/pacific-timesheet-tutorial/tutorial_pacifictimesheet_addfromgallery.png)
...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Konfigurovat jednotné přihlašování](./media/pacific-timesheet-tutorial/tutorial_pacifictimesheet_samlbase.png)

3. Na **Tichomoří časových rozvrhů domény a adresy URL** část, proveďte následující kroky:

    ![Konfigurovat jednotné přihlašování](./media/pacific-timesheet-tutorial/tutorial_pacifictimesheet_url.png)
...
4. Na **SAML podpisový certifikát** klikněte na tlačítko **certifikátu (Base64)** a potom uložte soubor certifikátu v počítači.
    ...
    ![Konfigurovat jednotné přihlašování](./media/pacific-timesheet-tutorial/tutorial_pacifictimesheet_certificate.png) 

5. Klikněte na tlačítko **Uložit** tlačítko.

    ![Konfigurovat jednotné přihlašování](./media/pacific-timesheet-tutorial/tutorial_general_400.png)
...
6. Na **konfigurace časových rozvrhů Tichomoří** klikněte na tlačítko **konfigurace časových rozvrhů Tichomoří** otevřete **konfigurovat přihlášení** okno. Kopírování **SAML Entity ID a SAML jeden přihlašování adresa URL služby** z **Stručná referenční příručka části.**
    ...
    ![Konfigurovat jednotné přihlašování](./media/pacific-timesheet-tutorial/tutorial_pacifictimesheet_configure.png) 
...
1. V **portál Azure**, v levém navigačním podokně klikněte na tlačítko **Azure Active Directory** ikonu.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/pacific-timesheet-tutorial/create_aaduser_01.png) 

2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin** a klikněte na tlačítko **všichni uživatelé**.
    
    ![Vytváření testovacího uživatele Azure AD](./media/pacific-timesheet-tutorial/create_aaduser_02.png) 

3. Chcete-li otevřít **uživatele** dialogové okno, klikněte na tlačítko **přidat** horní dialogové okno.
 
    ![Vytváření testovacího uživatele Azure AD](./media/pacific-timesheet-tutorial/create_aaduser_03.png) 

4. Na **uživatele** dialogové okno stránky, proveďte následující kroky:
 
    ![Vytváření testovacího uživatele Azure AD](./media/pacific-timesheet-tutorial/create_aaduser_04.png) 
...
2. V seznamu aplikací vyberte **Tichomoří rozvrhu**.
    ...
    ![Konfigurovat jednotné přihlašování](./media/pacific-timesheet-tutorial/tutorial_pacifictimesheet_app.png) 

...
## <a name="create-theceo-user-in-mysampledatawarehouse"></a>Vytvořit uživatele TheCEO v mySampleDataWarehouse
...
## <a name="create-a-workload-classifier-for-theceo-with-high-importance"></a>Vytvoření úlohy třídění pro TheCEO s vysokou důležitostí

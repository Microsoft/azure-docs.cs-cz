...
Tato konfigurace umožňuje, aby kód funkce podporoval dva parametry v adrese, _kategorii_ a _ID_. Další informace o tom, jak jsou parametry směrování v adrese URL vyraženy, najdete v tématu [Směrování v ASP.NET Core](/aspnet/core/fundamentals/routing#route-constraint-reference).

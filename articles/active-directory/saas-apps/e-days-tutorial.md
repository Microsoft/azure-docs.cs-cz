...
## <a name="configure-and-test-azure-ad-single-sign-on-for-e-days"></a>Konfigurace a testování jednotného přihlašování Azure AD pro dny v E-dnech
...
Pokud chcete nakonfigurovat a otestovat jednotné přihlašování Azure AD s E-dny, dokončete následující stavební bloky:
...
1. V [Azure Portal](https://portal.azure.com/)na stránce pro integraci aplikací v **E-dnech** najděte část **Správa** a vyberte **jednotné přihlašování**.
...
Chcete-li nakonfigurovat jednotné přihlašování na straně **E-dnech** , je třeba odeslat stažený **kód XML federačních metadat** a příslušné zkopírované adresy URL z Azure Portal do [E-dnech týmu podpory](https://support.e-days.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

### <a name="create-e-days-test-user"></a>Vytvořit testovacího uživatele v E-dnech

V této části vytvoříte uživatele s názvem B. Simon v E-dnech. Pokud chcete přidat uživatele na platformě E-dnech, pracujte s [týmem podpory v e-dnech](https://support.e-days.com) . Uživatelé musí vytvořit a aktivovat, než použití jednotného přihlašování.

## <a name="test-sso"></a>Test SSO 

V této části Testování služby Azure AD jednotné přihlašování – konfigurace pomocí přístupového panelu.

Když kliknete na dlaždici E-Days na přístupovém panelu, měli byste se automaticky přihlásit k E-dnům, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Vyzkoušejte E-Days s Azure AD](https://aad.portal.azure.com/)

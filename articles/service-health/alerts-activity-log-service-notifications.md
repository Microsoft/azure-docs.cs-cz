...
Oznámení o stavu služby se ukládají do [protokolu aktivit Azure](../azure-monitor/platform/activity-logs-overview.md) směru může být velký objem informací uložených v protokolu aktivit, je samostatné uživatelské rozhraní, aby bylo snazší zobrazit a nastavte si upozornění na stav služby oznámení. 
...
Informace o tom, jak nakonfigurovat službu stavu oznámení výstrah pomocí šablon Azure Resource Manageru najdete v tématu [šablon Resource Manageru](../azure-monitor/platform/alerts-activity-log.md).

...
4. Zadejte nebo vyberte hodnoty pro následující nastavení v části **vytvořit veřejnou IP adresu**a pak vyberte **vytvořit**:
   ...
   |Umístění|Ano|Musí existovat ve stejném [umístění](https://azure.microsoft.com/regions), které se označuje také jako oblast, jako prostředek, ke kterému chcete přidružit veřejnou IP adresu.|

...
3. Na stránce výsledků hledání marketplace vyberte **Service Map** ze seznamu.<br><br> ![Vyberte řešení Service Map z Azure Marketplace výsledků hledání](./media/monitoring-service-map/marketplace-search-results.png)<br>
4. Na **Service Map** podokně s přehledem, projděte si podrobnosti o řešení a potom klikněte na **vytvořit** k zahájení procesu registrace do pracovního prostoru Log Analytics.<br><br> ![Začlenění řešení Service Map](./media/monitoring-service-map/service-map-onboard.png).
...
![Přehled řešení Service Map](media/monitoring-service-map/service-map-overview.png)
...
![Stav oznámení](media/monitoring-service-map/status-badges.png)
...
![Skupina počítačů](media/monitoring-service-map/machine-group.png)
...
![Vytvoření skupiny](media/monitoring-service-map/machine-groups-create.png)
...
![Karty skupiny](media/monitoring-service-map/machine-groups-tab.png)

Vyberte název skupiny, chcete-li zobrazit mapu pro tuto skupinu počítačů.
![Skupina počítačů](media/monitoring-service-map/machine-group.png) počítačů, které patří do skupiny jsou uvedeny v bílé v objektu map.

Rozbalení skupiny se zobrazí seznam počítačů, které tvoří skupinu počítačů.

![Počítače seskupit počítače](media/monitoring-service-map/machine-groups-machines.png)
...
![Skupinu filtrů](media/monitoring-service-map/machine-groups-filter.png)

Když **všechny procesy** je vybrána, mapa bude obsahovat všechny procesy a připojení na všech počítačích ve skupině.

![Zpracuje všechny skupiny počítačů](media/monitoring-service-map/machine-groups-all.png)
...
![Skupina počítačů filtrovat procesy](media/monitoring-service-map/machine-groups-filtered.png)
...
![Odebrání počítače ze skupiny](media/monitoring-service-map/machine-groups-remove.png)
...
![Nabídka skupiny počítačů](media/monitoring-service-map/machine-groups-menu.png)
...
| Ikona role | Popis |
|:--|:--|
| ![Webový server](media/monitoring-service-map/role-web-server.png) | Webový server |
| ![Aplikační server](media/monitoring-service-map/role-application-server.png) | Aplikační server |
| ![Databázový server](media/monitoring-service-map/role-database.png) | Databázový server |
| ![LDAP server](media/monitoring-service-map/role-ldap.png) | LDAP server |
| ![Server s protokolem SMB](media/monitoring-service-map/role-smb.png) | Server s protokolem SMB |

![Role ikony](media/monitoring-service-map/role-icons.png)
...
![Neúspěšná připojení](media/monitoring-service-map/failed-connections.png)
...
![Vlastnosti skupiny klientů](media/monitoring-service-map/client-group-properties.png)
...
![Port serveru skupiny](media/monitoring-service-map/server-port-groups.png)
...
![Neúspěšná připojení](media/monitoring-service-map/context-menu.png)
...
![Souhrn počítače](media/monitoring-service-map/machine-summary.png)
...
![Podokno vlastností počítače](media/monitoring-service-map/machine-properties.png)
...
![Podokno vlastností procesu](media/monitoring-service-map/process-properties.png)
...
![Souhrn procesu](media/monitoring-service-map/process-summary.png)
...
![Podokno oznámení počítače](media/monitoring-service-map/machine-alerts.png)
...
![Podokno počítače události protokolu](media/monitoring-service-map/log-events.png)
...
![Podokno počítače oddělení služeb](media/monitoring-service-map/service-desk.png)
...
![Podokno počítač řešení Change Tracking](media/monitoring-service-map/change-tracking.png)
...
![ConfigurationChange události](media/monitoring-service-map/configuration-change-event-01.png)
...
![Podokno výkon počítače](media/monitoring-service-map/machine-performance.png)
...
Data inventáře počítače a procesu Service Map je k dispozici pro [hledání](../log-analytics/log-analytics-queries.md) v Log Analytics. Tato data můžete použít scénáře, které zahrnují plánování migrace, kapacitu analýza, zjišťování a řešení potíží s výkonem na vyžádání.
...
Další informace o [prohledávání protokolů](../log-analytics/log-analytics-queries.md) v Log Analytics data, která shromažďují Service Map.


## <a name="troubleshooting"></a>Řešení potíží
Zobrazit [řešení potíží s konfigurací řešení Service Map dokumentu v části]( monitoring-service-map-configure.md#troubleshooting).

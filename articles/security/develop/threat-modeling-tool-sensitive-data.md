...
| **Kroky** | Zajistěte, aby byly binární soubory zakódovány, pokud obsahují citlivé informace, jako jsou obchodní tajemství, citlivá obchodní logika, která by neměla být reverzní. Účelem je zastavit zpětnou inženýraci sestavení. `CryptoObfuscator`Pro tento účel se můžou použít nástroje, jako je. |

...
ms.locfileid: "107284166"
---
# <a name="azure-security-baseline-for-vpn-gateway"></a>Základní hodnoty zabezpečení Azure pro VPN Gateway

Tato základní hodnota zabezpečení platí pro VPN Gateway pokynů od [zabezpečení Azure Security test 1,0](../security/benchmarks/overview-v1.md) . Azure Security Benchmark poskytuje doporučení, jak můžete zabezpečit svá cloudová řešení v Azure. Obsah je seskupen podle **řízení zabezpečení** definovaného srovnávacím testem zabezpečení Azure a souvisejících pokynů, které se vztahují na VPN Gateway.

> [!NOTE]
> **Ovládací prvky** , které se nevztahují na VPN Gateway nebo pro které je odpovědnost od Microsoftu, jsou vyloučené. Pokud chcete zjistit, jak VPN Gateway kompletně mapuje srovnávací test zabezpečení Azure, přečtěte si **[celý soubor mapování standardních hodnot VPN Gateway Security](https://github.com/MicrosoftDocs/SecurityBenchmarks/raw/master/Azure%20Offer%20Security%20Baselines/1.1/vpn-gateway-security-baseline-v1.1.xlsx)**.
...
- [Vytvoření brány sítě VPN založené na trasách pomocí Azure Portal](/azure/vpn-gateway/create-routebased-vpn-gateway-portal)
...
Pomocí Azure modrotisky můžete také zjednodušit rozsáhlá nasazení Azure tím, že zabalíte klíčové artefakty prostředí, jako jsou například šablony Azure Resource Manager, přiřazení Azure RBAC a přiřazení Azure Policy v jediné definici podrobného plánu. Můžete použít podrobný plán na nové nebo existující odběry a jemně vyladit řízení a správu prostřednictvím správy verzí.
...
- [Jak zobrazit a načíst události protokolu aktivit Azure](/azure/azure-monitor/essentials/activity-log-view)
...
- [Začínáme s Log Analytics dotazy](/azure/azure-monitor/logs/get-started-portal) 
...
- [O typech sítě VPN](https://docs.microsoft.com/azure/vpn-gateway/vpn-gateway-about-vpn-gateway-settings#vpntype)

- [Informace o zařízeních VPN a parametrech protokolu IPsec/IKE pro připojení typu Site-to-Site ke službě VPN Gateway](https://docs.microsoft.com/azure/vpn-gateway/vpn-gateway-about-vpn-devices#ipsec)
...
**Pokyny**: k identifikaci všech citlivých informací uložených, zpracovávaných nebo odeslaných vašimi technologickými systémy pomocí nástroje pro aktivní zjišťování třetí strany, včetně těch, které jsou umístěné na pracovišti nebo u poskytovatele vzdálené služby a aktualizujte inventář citlivých informací organizace.
...
**Doprovodné** materiály: použití řízení přístupu na základě role (Azure RBAC) v Azure Active pro data a prostředky, v opačném případě použití metod řízení přístupu ke konkrétním službám. Použijte předdefinované role, jako je vlastník, přispěvatel nebo přispěvatel sítě, a pak přiřaďte roli příslušnému oboru. Přiřaďte specifická oprávnění pro podmnožinu možností virtuální sítě vytvořením vlastní role a přiřazením konkrétních oprávnění vyžadovaných pro virtuální sítě, podsítě, brány sítě VPN, síťových rozhraní, skupin zabezpečení sítě a směrovacích tabulek k této roli.

- [Jak nakonfigurovat službu Azure RBAC](../role-based-access-control/role-assignments-portal.md)

- [Plánování virtuálních sítí](https://docs.microsoft.com/azure/virtual-network/virtual-network-vnet-plan-design-arm#permissions)
...
Azure Resource Manager má možnost Exportovat šablonu do JavaScript Object Notation (JSON), která by měla být přezkoumána, aby konfigurace splňovala nebo překročila požadavky na zabezpečení vaší organizace.
...
**Pokyny**: přiřaďte definice Azure Policy k měření konfigurací prostředků souvisejících s vašimi prostředky VPN Gateway. Pomocí Azure Policy Insights můžete auditovat konfigurace prostředků a upozorňovat na kritické změny konfigurace.
...
- [Konfigurace vícefaktorového ověřování](openvpn-azure-ad-mfa.md)

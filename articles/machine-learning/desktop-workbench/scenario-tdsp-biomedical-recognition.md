...
* Azure Machine Learning Workbench. V tématu [Průvodce instalací](../service/quickstart-installation.md). Aktuálně Azure Machine Learning Workbench lze nainstalovat do jenom následující operační systémy: 

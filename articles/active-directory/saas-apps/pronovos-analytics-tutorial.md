...
Když kliknete na dlaždici ProNovos Analytics na přístupovém panelu, měli byste se automaticky přihlásit k ProNovos analýze, pro kterou jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).

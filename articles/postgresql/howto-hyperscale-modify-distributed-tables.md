...
Doporučujeme, abyste adresy ověřili, ale PostgreSQL obvykle neumožňuje přidat omezení CHECK, které se pro existující řádky nezdařilo. Nicméně omezení  neplatí jako neplatné:

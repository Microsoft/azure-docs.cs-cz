...
| **countryList** | Podívejte [se na seznam zemí](#countries-list). |
...
## <a name="countries-list"></a>Seznam zemí

Níže jsou uvedené hodnoty countryList používané službou Multi-Factor Authentication.

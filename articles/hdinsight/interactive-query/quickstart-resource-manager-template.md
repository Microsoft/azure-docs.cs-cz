...
1. Zadejte nebo vyberte tyto hodnoty:
    ...
    :::image type="content" source="./media/quickstart-resource-manager-template/resource-manager-template-hive.png" alt-text="Nasazení Správce prostředků šablon HBA" border="true":::

---
title: Příjem událostí pomocí Pythonu – Azure Event Hubs | Dokumentace Microsoftu
description: Tento článek poskytuje návod pro vytvoření aplikace v Pythonu, která bude přijímat události z Azure Event Hubs.
services: event-hubs

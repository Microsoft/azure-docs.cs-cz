...
description: Přečtěte si, jak Microsoft pracuje na zabezpečení datových center Azure. Datová centra jsou spravovaná, monitorovaná a spravovaná provozními pracovníky Microsoftu.
services: security
...
- [Operace](infrastructure-operations.md)

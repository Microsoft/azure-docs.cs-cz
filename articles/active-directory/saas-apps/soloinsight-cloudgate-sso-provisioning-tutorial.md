...
5. V části **přihlašovací údaje správce** zadejte `https://sigateway.com/scim/v2/sync/serviceproviderconfig` na **adrese URL tenanta**. Zadejte hodnotu **SCIM tokenu ověřování** získanou dříve v **tajném tokenu**. Klikněte na **Test připojení** a ujistěte se, že se služba Azure AD může připojit k Soloinsight-CloudGate jednotného přihlašování. Pokud se připojení nepovede, ujistěte se, že váš účet Soloinsight-CloudGate SSO má oprávnění správce, a zkuste to znovu.

...
- **.NET SDK**:
  ...
  - [Spouštět úlohy Apache Pig s použitím sady .NET SDK pro Apache Hadoop v HDInsight](apache-hadoop-use-pig-dotnet-sdk.md)
...
- **curl**:
  ...
  - [Spouštět úlohy Apache Pig s Apache Hadoop v HDInsight pomocí curl](apache-hadoop-use-pig-curl.md)
...
- **PowerShell**:
  ...
  - [Spouštět úlohy Apache Pig s použitím prostředí PowerShell](apache-hadoop-use-pig-powershell.md)

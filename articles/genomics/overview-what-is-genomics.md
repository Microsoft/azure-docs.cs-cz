...
Služba Microsoft Genomics je ISO 27001, ISO 27018 a ISO 9001 certifikováno a dodržuje předpisy HIPAA. Informace o zabezpečení platformy Azure najdete na [Centrum zabezpečení Azure](https://www.microsoft.com/trustcenter/security) .


## <a name="next-steps"></a>Další kroky
Teď, když jste si přečetli Úvod do Microsoft Genomics, jste připraveni:
- Porovnání nákladů a kalkulačky najdete na stránce s cenami. [Stanov](https://azure.microsoft.com/pricing/details/genomics/)

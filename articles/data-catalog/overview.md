---
title: Úvod do katalogu dat Azure
...
Azure Data Catalog je plně spravovaná cloudová služba. Umožňuje uživatelům zjistit zdroje dat, které potřebují, a pochopit zdroje dat, které najdou. Zároveň Data Catalog pomáhá organizacím vytěžit více z jejich stávajících investic.
...
* Uživatelé nemusí vědět, že zdroj dat existuje, pokud s ním nepřijdou do kontaktu jako součást jiného procesu. Žádné centrální umístění, kde jsou zdroje dat registrovány, neexistuje.
...
* Pokud mají uživatelé dotazy týkající se informačního prostředku, musí vyhledat odborníka nebo tým odpovědný za příslušná data a zapojit tyto odborníky offline. Neexistuje žádné explicitní spojení mezi daty a odborníky, kteří mají perspektivu na jejich použití.
...
* Vytváření dokumentace pro zdroje dat je také často ztráta času. Udržování dokumentace v synchronizaci se zdroji dat je trvalou odpovědností. Uživatelé mohou postrádat důvěru v dokumentaci, která je vnímána jako zastaralá.
...
Po zaregistrování zdroje dat mohou být jeho metadata obohacena. Metadata může přidat uživatel, který je zaregistroval, nebo jiní uživatelé v rozlehlé síti. Každý uživatel může opatřit poznámkami zdroj dat tím, že přidá popisy, značky nebo další metadata, například dokumentaci a procesy pro žádosti o přístup ke zdroji dat. Tato popisná metadata doplňují strukturální metadata (například názvy sloupců a typy dat) zaregistrovaná ze zdroje dat.
...
Jak začít s katalogem dat:

* [Úvodní příručka: Vytvoření katalogu dat Azure](data-catalog-get-started.md)
* [Otevření katalogu dat Azure](https://www.azuredatacatalog.com)
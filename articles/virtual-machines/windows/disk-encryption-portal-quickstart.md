...
1. Ověřte, že  je velikost *standardní D2s V3*.
...
1. V části **nastavení šifrování**  >  **disky pro šifrování** vyberte **operační systém a datové disky**.
    ...
    :::image type="content" source="../media/disk-encryption/portal-quickstart-disks-to-encryption.png" alt-text="Snímek obrazovky zobrazující operační systém a datové disky.":::
...
1. Na obrazovce **Vybrat klíč z Azure Key Vault** vyberte **vytvořit novou**.
    ...
    :::image type="content" source="../media/disk-encryption/portal-qs-keyvault-create.png" alt-text="Snímek obrazovky zobrazující možnost vytvořit novou":::

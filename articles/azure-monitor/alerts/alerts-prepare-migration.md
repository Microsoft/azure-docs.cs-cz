...
1. Použijte šablonu obslužná rutina výstrahy Azure Monitor – metriky. Tato šablona obsahuje aktivační událost **požadavku HTTP** s definovaným příslušným schématem.
    ...
    ![Snímek obrazovky ukazuje dvě tlačítka, prázdná aplikace logiky a Azure Monitor – obslužná rutina výstrahy metriky.](media/alerts-prepare-migration/logic-app-template.png "Šablona výstrahy metriky")

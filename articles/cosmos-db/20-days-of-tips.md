...
![Další informace nový tip Azure Cosmos DB každý den](./media/20-days-of-tips/20-days-of-azure-cosmos-db-tips-header.png)

Pokud jste se seznámili s 20 dny v Azure Cosmos DB tipy Simona Cotin na [twitter](https://twitter.com/simona_cotin) a [LinkedIn](https://www.linkedin.com/in/simona-cotin-2ba8747/detail/recent-activity/shares/), může přát byly všechny dostupné v jednom místě. Dobře jsou uvedeny zde!

Navštivte tuto stránku každý den pro nový tip z 5. září – září 29!
...
Tip 8: Vytvoření @nodejs aplikace pomocí rozhraní API pro SQL a Azure #CosmosDB. Další informace na stránce dokumentace [https://aka.ms/Bd77a8](https://aka.ms/Bd77a8)  
...
Tip 9: Dotaz #CosmosDB Azure pomocí rozhraní API MongoDB v Node.js. Další informace na stránce dokumentace [https://aka.ms/Dert0r](https://aka.ms/Dert0r)  
...
Tip 10: Zjistěte, jak si zkopírujte svá data MongoDB k databázi Cosmos Azure pomocí Studio 3T (MongoChef). Dokumentace v [https://aka.ms/apzhww](https://aka.ms/apzhww)
...
Tip 11: Sestavení nejdůležitější aplikace pro sledování pomocí reagují, Node.js a Azure Cosmos DB.
...
Tip 13: od nuly do hrdina s @John_Papa a Azure Cosmos DB. Naučte se vytvářet střední aplikace od začátku
...
Tip 16: Demo Super! Integrovat Azure #cosmosDB, funkce a @twilio odeslat serveru služby SMS na všechny změny databáze. Viz dokumentace v [https://aka.ms/Kjkc2d](https://aka.ms/Kjkc2d) 
...
Tip 19: oddíl! Oddíl! Oddíl! Důvod, proč a jak v Azure #CosmosDB. Dokumentace v [https://aka.ms/Ts5pon](https://aka.ms/Ts5pon)  
...
Tip 20: Everyone miluje dobrý staré "tahák". Azure #CosmosDB jeden má příliš. Podívejte se na [https://aka.ms/Nt01nl](https://aka.ms/Nt01nl)

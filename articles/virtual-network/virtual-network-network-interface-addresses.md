...
5. Zadejte následující příkaz a pak vyberte **OK**:
   ...
   |---|---|---|
   |Name (Název)|Ano|Musí být pro síťové rozhraní jedinečné.|
...
> [!WARNING]
> Pokud se adresa IPv4 nastavila jako primární IP adresa síťového rozhraní v operačním systému virtuálního počítače, někdy se liší od privátní IPv4 adresy přiřazené k primární konfiguraci IP rozhraní primárního síťového rozhraní připojeného k virtuálnímu počítači. v rámci Azure ztratíte připojení k virtuálnímu počítači.
...
Existují omezení pro počet privátních a veřejných IP adres, které můžete přiřadit k síťovému rozhraní. Podrobnosti najdete v článku o [omezeních Azure](../azure-subscription-service-limits.md?toc=%2fazure%2fvirtual-network%2ftoc.json#azure-resource-manager-virtual-networking-limits) .

...
Další informace o tom, jak získat token Azure AD pro vaši aplikaci, najdete v tématu [přístup k datům Analytics pomocí služby Store](https://docs.microsoft.com/windows/uwp/monetize/access-analytics-data-using-windows-store-services#step-2-obtain-an-azure-ad-access-token).
...
- Rozhraní API můžete vyzkoušet prostřednictvím [adresy URL rozhraní Swagger](https://partneranalytics-api.azure-api.net/analytics/cmp/swagger/index.html) .

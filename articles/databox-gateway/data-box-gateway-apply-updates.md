...
1. Až budou aktualizace k dispozici pro vaše zařízení, zobrazí se oznámení. Vyberte oznámení nebo na horním panelu příkazů **aktualizujte zařízení**. To vám umožní použít aktualizace softwaru zařízení.
    ...
    ![Snímek obrazovky domovské stránky Azure Data Box Gateway s přehledem a aktualizacemi možností zařízení, které jsou vyvolány.](./media/data-box-gateway-apply-updates/portal-apply-update-01a.png)
...
3. Spustí se stahování aktualizací. Zobrazí se oznámení o tom, že probíhá stahování.
    ...
    ![Snímek obrazovky domovské stránky Azure Data Box Gateway s možností přehled a oznámení o stahování aktualizací se vyvolala.](./media/data-box-gateway-apply-updates/portal-apply-update-08a.png)
...
5. Zobrazí se oznámení o tom, že probíhá instalace.
    ...
    ![Snímek obrazovky domovské stránky Azure Data Box Gateway s možností přehled a zprávou o průběhu stahování a instalace se vyvolala.](./media/data-box-gateway-apply-updates/portal-apply-update-12a.png)
...
6. Vzhledem k tomu, že se jedná o zařízení s jedním uzlem, po instalaci aktualizací se zařízení restartuje. Kritická výstraha při restartování bude znamenat, že dojde ke ztrátě prezenčního signálu zařízení.
    ...
    ![Snímek obrazovky domovské stránky Azure Data Box Gateway s možností přehled a kritickou hlavičkou oznámení výstrah.](./media/data-box-gateway-apply-updates/portal-apply-update-19a.png)
...
7. Po instalaci aktualizací se stav zařízení aktualizuje na **online** .
    ...
    ![Snímek obrazovky domovské stránky Azure Data Box Gateway s možností přehled a online stavem s názvem.](./media/data-box-gateway-apply-updates/portal-apply-update-23a.png)

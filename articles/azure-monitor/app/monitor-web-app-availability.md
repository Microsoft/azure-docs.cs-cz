...
|----|----|----|
|**Adresa URL** |  Adresa URL může být libovolná webová stránka, kterou chcete testovat, ale musí být viditelná z veřejného Internetu. Adresa URL může obsahovat řetězec dotazu. To znamená, že můžete také trochu vyzkoušet svou databázi. Pokud se adresa URL přeloží na přesměrování, budeme ji sledovat až po 10 přesměrování.|
...
## <a name="inspect-and-edit-tests"></a>Kontrola a úpravy testů

...
Pokud máte otázky, kontaktujte nás na [stránce s dotazem pro Microsoft Q&SQL Database](/answers/topics/azure-sql-database.html). A do [fóra SQL Database Feedback](https://feedback.azure.com/forums/217321-sql-database/)přidejte všechny žádosti o funkce.

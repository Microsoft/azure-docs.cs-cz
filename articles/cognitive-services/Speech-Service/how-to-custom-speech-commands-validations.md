...
description: V tomto článku přidejte ověření do vlastních parametrů příkazu.
...
1. Přidat ověření pro parametr teploty
   ...
   | Ověření        | Minimální hodnota: 60, maximální hodnota: 80                             | Pro číselné parametry, povolený rozsah hodnot pro parametr                              |
   | Šablona odpovědi | "Je nám líto, ale dá se nastavit jenom mezi 60 a 80 stupni."        | Výzva k zadání aktualizované hodnoty, pokud se ověření nepovede                                       |

...
Informace o tom, jak získat soubor s informacemi o využití Azure a poplatcích, najdete v tématu [Zobrazení a stažení informací o využití Azure a poplatcích pro smlouvu se zákazníkem Microsoftu](billing-download-azure-daily-usage.md). Soubor je dostupný ve formátu CSV a můžete ho otevřít v tabulkové aplikaci.

...
* [Postupy: přidružení nebo přidání předplatného Azure k Azure Active Directory](../../active-directory/fundamentals/active-directory-how-subscriptions-associated-directory.md)

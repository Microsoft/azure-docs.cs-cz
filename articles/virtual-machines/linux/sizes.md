...
| [Optimalizované z hlediska paměti](sizes-memory.md)         | Esv3, Ev3, Mv2, M, DSv2, Dv2  | Vysoký poměr paměti k procesoru. Velmi vhodné pro servery relačních databází, střední a velké mezipaměti a analýzu v paměti.                 |

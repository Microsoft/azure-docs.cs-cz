...
|Atribut|Hodnota|
|---|---|
|content|4 prvky, počet atributů: 1|
|definováno|univerzál|
...
|Atribut|Hodnota|
|---|---|
|content|9 prvků, počet atributů: 0|
|definováno|univerzál|
...
|Atribut|Hodnota|
|---|---|
|content|počet elementů: 0, počet atributů: 8|
|definováno|univerzál|
...
|Atribut|Hodnota|
|---|---|
|content|10 prvků, počet atributů: 8|
|definováno|univerzál|
...
Použijte výchozí přihlašovací údaje úložiště zadané v souboru manifestem clusteru. XML místo přihlašovacích údajů zadaných v tagu "RepositoryCredentials" v souboru ApplicationManifest. XML.
...
|Atribut|Hodnota|
|---|---|
|content|21 elementů, počet atributů: 0|
|definováno|univerzál|
...
|---|---|
|jméno|Parametr|
|type|[Zadanému ParameterType](#parametertype-complextype)|
|Hodnota|1|
|Atributu|Unbounded|
...
|Atribut|Hodnota|
|---|---|
|content|počet elementů: 0, počet atributů: 12|
|definováno|univerzál|
...
|Atribut|Hodnota|
|---|---|
|content|počet prvků: 4, 2 atributy|
|definováno|univerzál|
...
Uživatelsky definovaný identifikátor typu pro skupinu služeb, například "ActorQueueSGType". Tato hodnota se používá v souboru souboru ApplicationManifest. XML k identifikaci skupiny služeb.
...
|Atribut|Hodnota|
|---|---|
|content|počet elementů: 11, 4 atributy|
|definováno|univerzál|
...
#### <a name="servicetypename"></a>ServiceTypeName
Uživatelsky definovaný identifikátor typu pro službu. Například "QueueType" nebo "CalculatorType". Tato hodnota se používá v souboru souboru ApplicationManifest. XML k identifikaci služby.
...
|Atribut|Hodnota|
|---|---|
|content|počet elementů: 0, počet atributů: 11|
|definováno|univerzál|

...
2. V dolní části **Základy zabezpečení** zvolte **další možnosti zabezpečení** odkaz.
    ...
    ![Stránka Základy zabezpečení se zvýrazněným odkazem "Další možnosti zabezpečení"](./media/microsoft-authenticator-app-add-personal-account/more-security-options-link.png)
...
2. Vyberte **přidat účet** z **přizpůsobení a řízení** ikonu v pravém horním rohu.
    ...
    ![Stránka účty s zvýrazněnou ikonou přizpůsobení a řízení](./media/microsoft-authenticator-app-add-personal-account/customize-and-control-icon.png)

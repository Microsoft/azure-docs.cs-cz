...
2. **[Konfigurace jednotného přihlašování RStudio Connect](#configure-rstudio-connect-single-sign-on)** – pro konfiguraci nastavení jednotného přihlašování na straně aplikace

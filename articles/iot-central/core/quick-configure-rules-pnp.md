...
Než začnete, měli byste provést dvě předchozí rychlé starty a [vytvořit aplikaci Azure IoT Central](./quick-deploy-iot-central-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) a [Přidat simulované zařízení do aplikace IoT Central](./quick-create-pnp-device-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) a vytvořit tak šablonu zařízení **snímače prostředí** , se kterou chcete pracovat.
...
1. V části **podmínky** definujete, co aktivuje vaše pravidlo. Pomocí následujících informací Definujte podmínku na základě telemetrie teploty:
    ...
    ![Vytvořit podmínku pravidla](./media/quick-configure-rules-pnp/condition.png)
...
1. K definování akce použijte informace v následující tabulce:
    ...
    ![Vytvořit akci pravidla](./media/quick-configure-rules-pnp/action.png)
...
> [Ke sledování svých zařízení použijte Azure IoT Central](quick-monitor-devices-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json).

...
Když na přístupovém panelu kliknete na dlaždici Zylo, měli byste se automaticky přihlásit k Zylo, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

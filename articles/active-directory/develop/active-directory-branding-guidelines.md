...
![Typy aplikací a scénářů](./media/active-directory-branding-guidelines/add-to-my-org.png)
...
![Přihlásit se účtem Microsoft redlines](./media/active-directory-branding-guidelines/Sign-in-with-Microsoft-redlines.png)
...
| Prostředek                                | Formát PNG | Formát SVG |
| ------------------------------------ | ---------- | ---------- |
| Přihlásit se účtem Microsoft (tmavý motiv)  | ![Přihlaste se tlačítko tmavý motiv PNG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark.png) | ![Přihlaste se pomocí Microsoft tlačítko tmavý motiv SVG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark.svg) |
| Přihlásit se účtem Microsoft (světlý motiv) | ![Přihlaste se tlačítko světlý motiv PNG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light.png) | ![Přihlaste se pomocí Microsoft tlačítko světlý motiv SVG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light.svg) |
| Přihlaste se (tmavý motiv)                 | ![Stručně řečeno podepsat tlačítko tmavý motiv PNG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark_short.png) | ![Stručně řečeno podepsat tlačítko tmavý motiv SVG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark_short.svg) |
| Přihlaste se (světlý motiv)                | ![Stručně řečeno podepsat tlačítko světlý motiv PNG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light_short.png) | ![Stručně řečeno podepsat tlačítko světlý motiv SVG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light_short.svg) |

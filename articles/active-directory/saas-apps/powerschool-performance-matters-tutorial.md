...
2. **[Nakonfigurujte jednotné přihlašování v oblasti výkonu PowerSchool](#configure-powerschool-performance-matters-single-sign-on)** a nakonfigurujte nastavení jednotného přihlašování na straně aplikace.
...
4. V části **základní konfigurace SAML** proveďte následující krok:
    ...
    > [!NOTE]
    > Hodnota není reálné číslo. Aktualizujte hodnotu skutečnou přihlašovací adresou URL. Pokud chcete získat hodnotu, kontaktujte [tým podpory PowerSchool výkonu](mailto:pmsupport@powerschoo.com) . Můžete se také podívat na vzory uvedené v části **základní konfigurace SAML** v Azure Portal.
...
### <a name="configure-powerschool-performance-matters-single-sign-on"></a>Konfigurace jednotného přihlašování Powerschoolch otázek výkonu

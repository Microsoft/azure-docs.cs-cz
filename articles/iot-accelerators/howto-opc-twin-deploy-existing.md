...
* Pokud jste zvolili tenanta AAD ze seznamu tenantů, restartujte skript a zvolte jiný ze seznamu.
* Případně můžete nasadit privátního tenanta AAD v jiném předplatném, restartovat skript a vybrat ho pro použití.

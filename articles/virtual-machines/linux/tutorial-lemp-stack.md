...
description: Kurz – Instalace stacku LEMP na virtuální počítač s Linuxem v Azure
...
---
# <a name="install-a-lemp-web-server-on-an-azure-vm"></a>Instalace webového serveru LEMP na virtuální počítač Azure

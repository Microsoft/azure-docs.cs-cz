...
1. Do vyhledávacího pole zadejte `when a http request`a vyberte, **když se přijme požadavek HTTP** , který se použije jako Trigger.
...
1. Pro vlastnost **záhlaví zpráv** zadejte všechna záhlaví požadovaná pro akci AS2, která jsou popsána v obsahu `headers`, který je přijatý triggerem požadavku HTTP.

...
Azure Media Indexer enables you to make content of your media files searchable and to generate a full-text transcript for closed captioning and keywords. Mediální soubory můžete zpracovávat po jednom nebo v dávkách.  
...
| Kód | Name (Název) | Possible Reasons |
| --- | --- | --- |
...
| 3000 |Failed to decode media file |Unsupported media codec <br/>nebo<br/> Corrupted media file <br/>nebo<br/> No audio stream in input media. |

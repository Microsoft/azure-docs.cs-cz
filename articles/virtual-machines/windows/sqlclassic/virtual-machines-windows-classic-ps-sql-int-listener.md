...
> [!IMPORTANT]
> Azure má dva různé modely nasazení pro vytváření a práci s prostředky: [Azure Resource Manager a classic](../../../azure-resource-manager/resource-manager-deployment-model.md). Tento článek se týká použití modelu nasazení classic. Doporučujeme, aby většina nových nasazení používala model Resource Manager.

...
Kód pro příklad popsaný v tomto dokumentu je k dispozici [https://github.com/Azure-Samples/hdinsight-spark-scala-kafka](https://github.com/Azure-Samples/hdinsight-spark-scala-kafka)na adrese.

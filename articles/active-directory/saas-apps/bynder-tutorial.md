...
## <a name="add-bynder-from-the-gallery"></a>Přidání Bynder z Galerie
...
K nakonfigurování a testování jednotného přihlašování Azure AD pomocí Bynder postupujte takto:

...
description: Popisuje, jak změnit profil účtu Azure a odpovědi na běžné dotazy, jako je například proč nelze změnit zemi v centru účtů Azure
services: ''
documentationcenter: ''
author: genlin
manager: alherz
...
E-mailovou adresu v profilu správce účtu Microsoft používá k upozornění na důležité aktualizace týkající se účtování o předplatném. Doporučujeme vám, že můžete zadat kontaktní e-mailovou adresu, která pravidelně kontrolovat.

## <a name="how-to-change-your-profile-information"></a>Jak změnit informace z vašeho profilu

...
ms.locfileid: "47047480"
---
# Set-AzureRmFrontDoor
Aktualizujte nástroj pro vyrovnávání zatížení branou
...
## POPIS
**Set-AzureRmFrontDoor** rutina aktualizuje nástroj pro vyrovnávání zatížení branou. Pokud vstupní parametry nejsou k dispozici, použije se staré parametry z existující branou.

## PŘÍKLADY

### Příklad 1: aktualizujte existující branou FrontDoorName a název skupiny prostředků.
```powershell
...
Aktualizujte existující FrontDoor.

### Příklad 2: aktualizujte existující branou PSFrontDoor objektu.
```powershell
...
### Příklad 3: aktualizace existujících prahu díky ID prostředku
```powershell
...
Operační stav nástroje pro vyrovnávání zatížení branou.
...
### -InputObject
Objekt přední dveře k aktualizaci.
...
### – Název
Název přední dveře k aktualizaci.
...
### – ID prostředku
Id prostředku přední dveře k aktualizaci

...
Chcete-li se připojit k virtuální síti, musíte vytvořit a nakonfigurovat profil klienta VPN. Viz [Konfigurace ověřování Azure AD pro připojení point-to-site k Azure](virtual-wan-point-to-site-azure-ad.md).

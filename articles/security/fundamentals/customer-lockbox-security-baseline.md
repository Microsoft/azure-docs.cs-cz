...
description: Základní hodnoty zabezpečení Azure pro Customer Lockbox pro Microsoft Azure
author: msmbaldwin
ms.service: security
ms.topic: conceptual
ms.date: 06/05/2020
...
Základní plán zabezpečení Azure pro Customer Lockbox pro Microsoft Azure obsahuje doporučení, která vám pomůžou vylepšit stav zabezpečení vašeho nasazení.

Základní hodnota této služby se vykreslí z [bezpečnostního testu Azure Security 1,0](../benchmarks/overview.md), který poskytuje doporučení k zabezpečení cloudových řešení v Azure s využitím našich osvědčených postupů.

Další informace najdete v tématu [Přehled standardních hodnot zabezpečení Azure](../benchmarks/security-baselines-overview.md).

## <a name="network-security"></a>Zabezpečení sítě

*Další informace najdete v tématu [řízení zabezpečení: zabezpečení sítě](../benchmarks/security-control-network-security.md).*
...
**Doprovodné** materiály: nepoužitelné; virtuální síť, podsíť nebo skupinu zabezpečení sítě nelze přidružit k Customer Lockbox.
...
**Doprovodné** materiály: nepoužitelné; k Azure Customer Lockbox nemůžete přidružit virtuální síť, podsíť ani skupinu zabezpečení sítě.
...
**Doprovodné** materiály: nepoužitelné; virtuální síť, podsíť nebo skupinu zabezpečení sítě nelze přidružit k Customer Lockbox. Neexistují žádné síťové konfigurace, které by bylo možné nastavit ani sledovat.
...
**Doprovodné** materiály: nepoužitelné; Společnost Microsoft udržuje zdroj času používaný pro prostředky, jako je například Customer Lockbox.
...
* [Protokoly auditu pro Customer Lockbox](./customer-lockbox-overview.md#auditing-logs)
...
**Doprovodné** materiály: nepoužitelné; Customer Lockbox nezpracovává ani nevytváří protokoly související s malwarem.
...
**Doprovodné** materiály: nepoužitelné; Customer Lockbox nezpracovává ani nevytváří protokoly související se službou DNS.
...
**Doprovodné** materiály: Azure Active Directory nemá koncept výchozích hesel. Další prostředky Azure, které vyžadují heslo, vynutí vytvoření hesla s požadavky na složitost a minimální délkou hesla, která se liší v závislosti na službě. Zodpovídáte za aplikace třetích stran a služby Marketplace, které mohou používat výchozí hesla.
...
**Pokyny**: použití pracovní stanice s privilegovaným přístupem (privilegovaným přístupem) s povolenou službou Azure AD Multi-Factor Authentication (MFA), která umožňuje přihlášení a konfiguraci vašich Customer Lockbox požadavků.
...
**Pokyny**: použití Azure Active Directory PRIVILEGED Identity Management (PIM) pro generování protokolů a výstrah v případě, že v prostředí dojde k podezřelé nebo nebezpečné aktivitě.

K zobrazení výstrah a sestav na základě rizikového chování uživatelů se navíc používají Azure Active Directory detekce rizik.
...
**Pokyny**: v případě potřeby použijte Azure Active Directory jako centrální systém ověřování a autorizace. Azure Active Directory chránit data pomocí silného šifrování pro neaktivní a tranzitní data. Azure Active Directory také soli, hodnoty hash a bezpečně ukládají přihlašovací údaje uživatele.

* [Postup vytvoření a konfigurace instance Azure Active Directory](../../active-directory/fundamentals/active-directory-access-create-new-tenant.md)
...
* [Principy vytváření sestav Azure Active Directory](../../active-directory/reports-monitoring/index.yml)

* [Jak používat kontroly přístupu Azure Active Directory](../../active-directory/governance/access-reviews-overview.md)
...
Máte přístup k Azure Active Directory přihlašovacích aktivit, zdrojů auditu a rizikových událostí, které umožňují integraci s ověřováním Azure Sentinel nebo SIEM třetí strany.

Tento proces můžete zjednodušit vytvořením nastavení diagnostiky pro Azure Active Directory uživatelských účtů a odesláním protokolů auditu a protokolů přihlášení do pracovního prostoru Log Analytics. Požadované výstrahy protokolu můžete nakonfigurovat v rámci Log Analytics.
...
**Doprovodné** materiály: pro odchylku chování přihlášení k účtu na rovině ovládacího prvku (např. Azure Portal), použijte funkce Azure Active Directory ochrany identit a detekce rizik ke konfiguraci automatizovaných odpovědí na zjištěné podezřelé akce související s identitami uživatelů. Můžete také ingestovat data do služby Azure Sentinel pro další šetření.

* [Jak zobrazit Azure Active Directory rizikové přihlášení](../../active-directory/identity-protection/overview-identity-protection.md)
...
**Pokyny**: Toto doporučení se netýká Customer Lockbox.
...
**Pokyny**: Toto doporučení se nedá použít; značky nejsou pro Customer Lockbox podporovány.
...
**Doprovodné** materiály: nepoužitelné; Customer Lockbox se zřídí ve stejném předplatném jako prostředky, ke kterým udělíte přístup. Neexistuje žádný veřejný koncový bod pro ochranu nebo izolaci. Uživateli, který má roli vlastníka na úrovni tenanta, je udělený přístup k žádosti Customer Lockbox.
...
**Doprovodné** materiály: Společnost Microsoft spravuje základní infrastrukturu pro Customer Lockbox a implementuje přísné ovládací prvky, které zabrání ztrátě nebo expozici zákaznických dat.

* [Principy ochrany zákaznických dat v Azure](./protection-customer-data.md)
...
**Doprovodné** materiály: nepoužitelné; Customer Lockbox sám o sobě nedrží žádná zákaznická data.
...
**Doprovodné** materiály: nepoužitelné; Toto doporučení je určené pro výpočetní prostředky. Společnost Microsoft spravuje základní infrastrukturu pro Customer Lockbox a implementuje přísné ovládací prvky, které zabrání ztrátě nebo expozici zákaznických dat.
...
**Doprovodné** materiály: nepoužitelné; Customer Lockbox sám o sobě nedrží zákaznická data.
...
*Další informace najdete v tématu [řízení zabezpečení: Správa ohrožení](../benchmarks/security-control-vulnerability-management.md)zabezpečení.*

### <a name="51-run-automated-vulnerability-scanning-tools"></a>5,1: spuštění automatizovaných nástrojů pro kontrolu ohrožení zabezpečení

**Doprovodné** materiály: nepoužitelné; Microsoft provádí správu ohrožení zabezpečení v základních systémech, které podporují Customer Lockbox.
...
**Doprovodné** materiály: značky nejsou pro Customer Lockbox podporovány.
...
**Doprovodné** materiály: nelze použít, Customer Lockbox nemá konfigurovatelné nastavení zabezpečení.
...
**Doprovodné** materiály: nepoužitelné; Customer Lockbox nemá konfigurovatelné nastavení zabezpečení.
...
**Doprovodné** materiály: nepoužitelné; přístup k Customer Lockbox žádostem se omezí jenom na vlastníka předplatného Azure, které tento prostředek zadává. Pro přístup k Customer Lockbox neexistují žádná hesla, tajné klíče ani klíče, které jsou nutné k přístupu k mimo přihlašování jako vlastník tenanta.
...
**Doprovodné** materiály: nepoužitelné; Customer Lockbox nevyužije spravované identity.
...
**Doprovodné** materiály: nepoužitelné; Tyto zásady jsou určené pro výpočetní prostředky. Microsoft Antimalware je povolený na podkladovém hostiteli, který podporuje řešení Customer Lockbox.
...
*Další informace najdete v tématu [řízení zabezpečení – obnovení dat](../benchmarks/security-control-data-recovery.md).*

### <a name="91-ensure-regular-automated-back-ups"></a>9,1: zajištění pravidelného automatického zálohování

**Doprovodné** materiály: nepoužitelné; Customer Lockbox sám o sobě neukládají zákaznická data.
...
**Doprovodné** materiály: nepoužitelné; Customer Lockbox sám neukládá zákaznická data, nepoužívá pro přístup klíče ani hesla.

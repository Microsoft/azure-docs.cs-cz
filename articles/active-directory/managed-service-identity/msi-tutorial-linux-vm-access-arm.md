...
V tomto kurzu jste zjistili, jak vytvořit uživatele přiřazené identity a jeho připojení k virtuálnímu počítači Linux pro přístup k rozhraní API služby Azure Resource Manager.  Další informace o Azure Resource Manager najdete v tématu:

...
2. V podokně **Přehled** klikněte na ikonu připnutí ![ikonu připnutí](media/tutorial-app-dashboards/pushpin.png), abyste přidali dlaždici na poslední prohlížený řídicí panel.  

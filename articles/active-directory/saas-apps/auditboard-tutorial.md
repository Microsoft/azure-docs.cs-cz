...
5. **[Vytvořit testovacího uživatele AuditBoard](#create-auditboard-test-user)**  – Pokud chcete mít protějšek Britta Simon AuditBoard, který je propojený s Azure AD reprezentace uživatele.

---
title: Co je Vyhledávání zpráv Bingu? | Microsoft Docs
...
Pokud chcete získat zprávy z konkrétní domény, použijte operátor dotazu [site:](http://msdn.microsoft.com/library/ff795613.aspx).

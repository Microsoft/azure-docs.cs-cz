...
> [!IMPORTANT]
> Pokud není předána žádná hodnota `Import-AzBlueprintWithArtifact` parametru **názvu** rutiny, použije se název složky, ve které je definice podrobného plánu uložená.
...
1. `Export-AzBlueprintWithArtifact` Pomocí rutiny exportujte zadanou definici podrobného plánu:
...
1. `Import-AzBlueprintWithArtifact` Pomocí rutiny importujte zadanou definici podrobného plánu:

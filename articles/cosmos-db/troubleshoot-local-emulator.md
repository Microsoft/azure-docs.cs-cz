---
title: Řešení potíží při použití emulátoru Azure Cosmos
description: Naučte se, jak Troubleshot služby při použití emulátoru Azure Cosmos k dispozici, vystavování certifikátů, šifrování a správy verzí.
...
* Pokud dojde k selhání emulátoru Azure Cosmos, shromážděte soubory s výpisem paměti ze `%LOCALAPPDATA%\CrashDumps` složky, Zkomprimujte je a otevřete lístek podpory z [Azure Portal](https://portal.azure.com).
...
1. Vypněte emulátor a sledujte hlavní panel systému, abyste se ujistili, že se program vypnul. Dokončení může trvat několik minut. Můžete také vybrat možnost **ukončit** v uživatelském rozhraní emulátoru Azure Cosmos.

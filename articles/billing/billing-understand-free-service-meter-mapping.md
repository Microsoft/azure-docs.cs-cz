---
title: Služby pro mapování měřičů pro bezplatného účtu Azure
...
ms.locfileid: "67490403"
---
# <a name="understand-free-service-to-meter-mapping"></a>Principy mapování měřičů bezplatná služba

Každé služby Azure vydává využití podle měřičů, které Azure fakturační systém využívá strhávat uživatelé služby. Pokud chcete lépe porozumět využití bezplatné služby, Podívejme se na službu pro mapování měřičů pro služby. Zjistěte, jak vytvořit bezplatné služby, najdete v článku [vytvořit bezplatné služby s bezplatným účtem Azure](billing-create-free-services-included-free-account.md).

## <a name="service-to-meter-mapping-for-eligible-services"></a>Služby pro mapování měřičů pro opravňující služby
...
| Spravovaný Disk <sup>1</sup>  | Operace spravovaných disků úrovně Standard (v 10,000s) | Operace spravovaných disků úrovně Standard (v 10,000s) – Free | 82cc6ea4-0abd-43ac-acc0-ec34edf0f14c
| Spravovaný Disk <sup>1</sup>  | Storage úrovně Premium – objekt Blob stránky/P6 (jednotky) – místně redundantní | Storage úrovně Premium – objekt Blob stránky/P6 (jednotky) – Free | 2b98c168-27ca-4cc1-b509-e887dec87657
...
| Na úrovni Shared – šířka pásma <sup>2</sup> | Odchozí přenosy dat (GB) | Přenos dat si (GB) – Free | 0fc067a1-65d2-46da-b24b-7a9cbe2c69bd

<sup>1</sup> -li vytvořit virtuální počítač s Windows a zvolte spravovaný disk, budete využívat měřiče spravovaného disku v rámci virtuálního počítače.

<sup>2</sup> přes několik služeb, které mohou být spotřebovány měřiče Shared. Například virtuálních počítačů a úložiště generování využití proti Out(GB) přenosu dat měřidla.

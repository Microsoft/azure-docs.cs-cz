...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/opal-tutorial/tutorial_opal_samlbase.png)

3. Na **Opal domény a adresy URL** část, proveďte následující kroky:

    ![Opal domény a adresy URL jednotné přihlašování informace](./media/opal-tutorial/tutorial_opal_url.png)
...
4. Aplikace opal očekává SAML kontrolní výrazy ve specifickém formátu. Nakonfigurujte následující deklarace identity pro tuto aplikaci. Můžete spravovat hodnoty těchto atributů z **uživatelské atributy** části na stránce integrace aplikace. Následující snímek obrazovky ukazuje příklad pro tento.
    ...
    ![Konfigurovat jednotné přihlašování attb](./media/opal-tutorial/tutorial_opal_attribute.png)
...
5. V **uživatelské atributy** části na **jednotného přihlašování** dialogové okno, nakonfigurujte atribut tokenu SAML, jak je znázorněno na obrázku a proveďte následující kroky:
    ...
    ![Konfigurovat jednotné přihlašování přidat](./media/opal-tutorial/tutorial_attribute_04.png)

    ![Konfigurace Addattb přihlášení](./media/opal-tutorial/tutorial_attribute_05.png)
...
7. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/opal-tutorial/tutorial_general_400.png) 
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/opal-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **Opal**.
    ...
    ![V seznamu aplikací na Opal odkaz](./media/opal-tutorial/tutorial_opal_app.png)  

---
title: 'Kurz: Integrace Azure Active Directory se službou Synergi | Dokumentace Microsoftu'
...
ms.locfileid: "39041424"
---
# <a name="tutorial-azure-active-directory-integration-with-synergi"></a>Kurz: Integrace Azure Active Directory se službou Synergi
...
3. **[Vytvoření zkušebního uživatele Synergi](#create-a-synergi-test-user)**  – Pokud chcete mít protějšek Britta Simon Synergi, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **Synergi domény a adresy URL** části, proveďte následující kroky:
...
6. Na **Synergi konfigurace** klikněte na tlačítko **nakonfigurovat Synergi** otevřete **nakonfigurovat přihlašování** okna. Kopírovat **odhlašování adresy URL a SAML Entity ID** z **Stručná referenční příručka oddílu.**

    ![Konfigurace Synergi](./media/synergi-tutorial/tutorial_synergi_configure.png) 

7. Ke konfiguraci jednotného přihlašování na **Synergi** straně, je nutné odeslat na stažený **Certificate(Base64) odhlašování URL a SAML Entity ID** k [tým podpory Synergi](https://www.irmsecurity.com/contact/).

...
| Funkce |
| Vložení VOD AD – obrovské | [dynamicky](https://amp.azure.net/libs/amp/latest/samples/dynamic_vast_ads_vod.html), | – | Do VOD assetu vložte předem rozdělené reklamy a po ní. |
| Rychlost přehrávání | [dynamicky](https://amp.azure.net/libs/amp/latest/samples/dynamic_playback_speed.html),| – | Umožňuje čtenářům řídit, jakou rychlost sleduje video na. |
...
| Titulky Live CEA 708 | [dynamicky](https://amp.azure.net/libs/amp/latest/samples/dynamic_live_captions.html), | – | Přehrávání s použitím příchozích titulků CEA 708 s titulky zarovnanými vlevo. |
...
| DD + | [dynamicky](https://amp.azure.net/libs/amp/latest/samples/dynamic_dolbyDigitalPlus.html), | – | Přehrávání obsahu pomocí DD + zvuku. |
| Možnosti |
...
| Registrovat události | [dynamicky](https://amp.azure.net/libs/amp/latest/samples/dynamic_registerEvents.html), | – | Přehrávání pomocí posluchačů událostí. |
| protokolování | [dynamicky](https://amp.azure.net/libs/amp/latest/samples/dynamic_logging.html), | [staticky](https://amp.azure.net/libs/amp/latest/samples/videotag_logging.html). | Zapnutí podrobného protokolování do konzoly. |
| Diagnostika | [dynamicky](https://amp.azure.net/libs/amp/latest/samples/dynamic_diagnostics.html), | – | Získávají se diagnostická data. Tato ukázka funguje jenom u některých techniků. |
| AES |
...
| Programově výběr |
| Vybrat textovou stopu | [dynamicky](https://amp.azure.net/libs/amp/latest/samples/dynamic_selectTextTrack.html), | – | Výběr záznamu WebVTT ze seznamu stop |
| Výběr přenosové rychlosti | [dynamicky](https://amp.azure.net/libs/amp/latest/samples/dynamic_selectBitrate.html), | – | Výběr přenosové rychlosti ze seznamu přenosové rychlosti. Tato ukázka funguje jenom u některých techniků. |
| Vybrat zvukový stream | [dynamicky](https://amp.azure.net/libs/amp/latest/samples/dynamic_selectAudioStream.html), | – | Výběr zvukového datového proudu ze seznamu dostupných zvukových streamů. Tato ukázka funguje jenom u některých techniků. |

---
title: Prozkoumejte protokoly trasování Java v Azure Application Insights (2.5.0-BETA) | Microsoft Docs
description: Prohledat Log4J nebo Logback trasování v Application Insights (2.5.0 – BETA verze)
...
ms.locfileid: "68298357"
---
# <a name="explore-java-trace-logs-in-application-insights-250-beta"></a>Prozkoumat protokoly trasování Java v Application Insights (2.5.0-BETA verze)
...
## <a name="note-if-you-are-using-the-application-insights-java-agent"></a>Poznámka: Pokud používáte agenta Application Insights Java

...
> [!NOTE]
> Ujistěte se, že jsou koncové body služby povolena pro virtuální síť nebo podsíť, kterou chcete přidat na Server, v opačném případě, že vytvoření pravidla brány Firewall virtuální sítě se nezdaří.

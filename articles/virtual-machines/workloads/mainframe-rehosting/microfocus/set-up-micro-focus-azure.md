...
1. Pro lepší zabezpečení a možnosti správy, zvažte možnost vytvořit novou skupinu prostředků jen pro tento projekt, například **RGMicroFocusEntServer**. Zvolit typ prostředku, aby bylo snazší pro přímé v seznamu, použijte první část názvu v Azure.
...
3. V **Základy** části, zadejte svoje uživatelské jméno a heslo. Vyberte **předplatné** a **umístění nebo oblasti** chcete použít pro virtuální počítače. Vyberte **RGMicroFocusEntServer** pro skupinu prostředků.
...
7. Pro přihlášení k virtuálnímu počítači Enterprise serveru, webu Azure Portal, vyberte virtuální počítač ES2 v3. Přejděte **přehled** a vyberte **připojit** spustit relaci RDP. Přihlaste se pomocí přihlašovacích údajů, které jste vytvořili pro virtuální počítač.

8. Z relace protokolu RDP načtěte následující dva soubory. Vzhledem k tomu, že používáte Windows, můžete přetáhnout a soubory do relace protokolu RDP:

    - **ES\_40. exe**, Enterprise Server instalační soubor.

    - **mflic**, odpovídající soubor licence – Enterprise Server nenačte bez něj.

9. Poklikejte na soubor a spusťte instalaci. V prvním okně zvolte umístění instalace a přijměte licenční smlouvu s koncovým uživatelem.
...
2. Přihlásit se k virtuálnímu počítači, přejděte **přehled** a vyberte **připojit**. Přihlášení se spustí relaci RDP. Přihlaste se pomocí přihlašovacích údajů, které jste vytvořili pro virtuální počítač.
...
4. Dvakrát klikněte **edvs2017.exe** souboru spusťte instalaci. V prvním okně zvolte umístění instalace a přijměte licenční smlouvu s koncovým uživatelem. Pokud chcete, zvolte **instalace programu Rumba 9.5** k instalaci této terminálu emulátor, který bude pravděpodobně nutné.
...
7. Zvolte typ formátu licence k nahrání: licenční soubor nebo 16 znacích licenční kód. Třeba u souborů v **licenční soubor**, přejděte **mflic** dříve nahraje soubor do virtuálního počítače a vyberte **nainstalovat licence**.
     ...
     ![Dialogové okno Micro správu licencí fokus](media/07-enterprise-server.png)

...
> [!div class="checklist"]
> * Konfigurace upozornění prostřednictvím služby Azure Monitor
> * Konfigurace upozornění prostřednictvím portálu
> * Zobrazení upozornění ve službě Azure Security Center
...
## <a name="configure-alerts-through-azure-monitor"></a>Konfigurace upozornění prostřednictvím služby Azure Monitor
...
## <a name="configure-alerts-through-portal"></a>Konfigurace upozornění prostřednictvím portálu
...
Můžete si taky přečíst další informace o [konfiguraci webhooků](../azure-monitor/alerts/alerts-webhooks.md?toc=%2fazure%2fvirtual-network%2ftoc.json) a [Logic Apps](../logic-apps/logic-apps-overview.md?toc=%2fazure%2fvirtual-network%2ftoc.json) pro vytváření výstrah.

## <a name="view-alerts-in-azure-security-center"></a>Zobrazení upozornění ve službě Azure Security Center

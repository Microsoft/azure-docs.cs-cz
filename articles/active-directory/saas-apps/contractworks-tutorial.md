...
* Můžete povolit uživatelům být automaticky přihlášeni k ContractWorks (Single Sign-On) s jejich účty Azure AD.
...
* Podporuje ContractWorks **SP** a **IDP** jednotné přihlašování zahájené pomocí
...
4. Do vyhledávacího pole zadejte **ContractWorks**vyberte **ContractWorks** z panelu výsledků klikněte **přidat** tlačítko pro přidání aplikace.
     ...
     ![ContractWorks v seznamu výsledků](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurace a otestování služby Azure AD jednotného přihlašování

V této části je konfigurace a testování Azure AD jednotné přihlašování pomocí ContractWorks podle testovacího uživatele volá **Britta Simon**.
Pro jednotné přihlašování pro práci je potřeba navázat vztah odkazu mezi uživatele služby Azure AD a související uživatelské v ContractWorks.
...
2. **[Konfigurace ContractWorks Single Sign-On](#configure-contractworks-single-sign-on)**  – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
3. **[Vytvořit testovacího uživatele Azure AD](#create-an-azure-ad-test-user)**  – Pokud chcete otestovat Azure AD jednotné přihlašování s Britta Simon.
4. **[Přiřadit uživatele Azure AD](#assign-the-azure-ad-test-user)**  – Pokud chcete povolit Britta Simon používat Azure AD jednotného přihlašování.
5. **[Vytvořit testovacího uživatele ContractWorks](#create-contractworks-test-user)**  – Pokud chcete mít protějšek Britta Simon ContractWorks, který je propojený s Azure AD reprezentace uživatele.
...
1. V [webu Azure portal](https://portal.azure.com/)na **ContractWorks** integrace stránce aplikace vyberte **jednotného přihlašování**.
...
4. Na **základní konfiguraci SAML** části, pokud chcete nakonfigurovat aplikace v **IDP** iniciované režimu, postupujte následovně:
    ...
    ![ContractWorks domény a adresy URL jednotného přihlašování – informace](common/idp-identifier.png)

    V **identifikátor** textové pole, zadejte adresu URL:  `https://login.securedocs.com/saml/metadata`

5. Klikněte na tlačítko **nastavit další adresy URL** a provést následující krok, pokud chcete nakonfigurovat aplikace v **SP** iniciované režimu:

    ![image](common/both-preintegrated-signon.png)

    V **přihlašovací adresa URL** textové pole, zadejte adresu URL:  `https://login.securedocs.com/saml/hint`

6. ContractWorks aplikace očekává, že kontrolní výrazy SAML v určitém formátu. Nakonfigurujte následující deklarace identity pro tuto aplikaci. Můžete spravovat hodnotami těchto atributů z **atributy uživatele** části na stránce aplikací pro integraci. Na **nastavte si jednotné přihlašování pomocí SAML** klikněte na **upravit** tlačítko Otevřít **atributy uživatele** dialogového okna.
...
### <a name="configure-contractworks-single-sign-on"></a>Konfigurace ContractWorks jednotné přihlašování

Ke konfiguraci jednotného přihlašování na **ContractWorks** straně, je nutné odeslat **adresa Url federačních metadat aplikace** k [tým podpory ContractWorks](mailto:support@contractworks.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.
...
1. Na webu Azure Portal, vyberte **podnikové aplikace**vyberte **všechny aplikace**a pak vyberte **ContractWorks**.

    ![Okno aplikace organizace](common/enterprise-applications.png)

2. V seznamu aplikací vyberte **ContractWorks**.

    ![Odkaz ContractWorks v seznamu aplikací](common/all-applications.png)
...
### <a name="create-contractworks-test-user"></a>Vytvoření ContractWorks testovacího uživatele
...
Po kliknutí na dlaždici ContractWorks na přístupovém panelu, můžete by měl být automaticky přihlášeni k ContractWorks, u kterého nastavíte jednotné přihlašování. Další informace o přístupovém panelu, naleznete v tématu [Úvod k přístupovému panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

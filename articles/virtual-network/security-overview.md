...
* **AzureBackup*** (jenom správce prostředků): Tato značka označuje předpony adresy služby AzureBackup. Pokud pro hodnotu zadáte *AzureBackup* , provoz se povolí nebo odepře AzureBackup. Tato značka má závislost na značce **Storage** a **azureactivedirectory selhala** . Tato značka se doporučuje pro odchozí pravidlo zabezpečení. 

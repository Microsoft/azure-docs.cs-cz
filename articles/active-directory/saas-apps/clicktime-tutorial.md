...
3. **[Vytvoření zkušebního uživatele ClickTime](#create-a-clicktime-test-user)**  – Pokud chcete mít protějšek Britta Simon ClickTime, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **ClickTime domény a adresy URL** části, proveďte následující kroky:
...
6. Na **ClickTime konfigurace** klikněte na tlačítko **nakonfigurovat ClickTime** otevřete **nakonfigurovat přihlašování** okna. Kopírovat **SAML jednotné přihlašování – adresa URL služby** z **Stručná referenční příručka oddílu.**

    ![Konfigurace ClickTime](./media/clicktime-tutorial/tutorial_clicktime_configure.png) 

7. V okně jiné webové prohlížeče přihlaste jako správce serveru vaší společnosti ClickTime.

8. Na panelu nástrojů v horní části klikněte na tlačítko **Předvolby**a potom klikněte na tlačítko **nastavení zabezpečení**.

9. V **předvolby přihlašování** konfigurační oddíl, proveďte následující kroky:
...
2. Na panelu nástrojů v horní části klikněte na tlačítko **společnosti**a potom klikněte na tlačítko **lidé**.

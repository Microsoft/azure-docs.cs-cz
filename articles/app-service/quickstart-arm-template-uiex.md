...
<li><a href="/cli/azure/webapp?view=azure-cli-latest#az-webapp-create">Vytvořit <abbr title="Reprezentace vaší webové aplikace, která obsahuje kód vaší aplikace, názvy hostitelů DNS, certifikáty a související prostředky. "> Aplikace App Service</abbr></a> se zadaným názvem.</li>
</ul>
</details>

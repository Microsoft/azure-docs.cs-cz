...
Podle [mapování schématu v aktivitě kopírování](https://docs.microsoft.com/azure/data-factory/copy-activity-schema-and-type-mapping)můžete volitelně namapovat schéma zdroje na odpovídající schéma cílového umístění.

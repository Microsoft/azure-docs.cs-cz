...
2. Vytvořte a spusťte **předávací** živou událost. <br/> Další informace najdete v tématu [stavy událostí Live a fakturace](live-event-states-billing-concept.md).
...
1. Ujistěte se, že je v účtu Media Services spuštěný **koncový bod streamování** . 
2. Vytvořte a spusťte živou událost **živého kódování** . <br/> Další informace najdete v tématu [stavy událostí Live a fakturace](live-event-states-billing-concept.md).
...
[Testované místní kodéry](encode-recommended-on-premises-live-encoders.md)

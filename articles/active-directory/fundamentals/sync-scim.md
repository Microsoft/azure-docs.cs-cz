...
## <a name="components-ofsystem"></a>Součásti systému 
...
## <a name="implementscimwith-azure-ad"></a>Implementace SCIM s využitím Azure AD 
...
* [Dodržování předpisů protokolu SCIM 2,0 ve službě Azure AD Provisioning](https://docs.microsoft.com/azure/active-directory/app-provisioning/use-scim-to-provision-users-and-groupsapplication-provisioning-config-problem-scim-compatibility)

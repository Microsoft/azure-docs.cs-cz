...
1. Výsledky zobrazíte pomocí následujícího příkazu:
    ...
    :::image type="content" source="./media/apache-hive-warehouse-connector/hive-warehouse-connector-show-hive-table.png" alt-text="konektor datového skladu pro zobrazení tabulky podregistru" border="true":::

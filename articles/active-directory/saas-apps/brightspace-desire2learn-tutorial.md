---
title: 'Kurz: Integrace Azure Active Directory se službou Brightspace podle Desire2Learn | Dokumentace Microsoftu'
...
ms.locfileid: "39043583"
---
# <a name="tutorial-azure-active-directory-integration-with-brightspace-by-desire2learn"></a>Kurz: Integrace Azure Active Directory se službou Brightspace podle Desire2Learn
...
5. Na panelu výsledků vyberte **Brightspace podle Desire2Learn**a potom klikněte na tlačítko **přidat** tlačítko pro přidání aplikace.
...
3. **[Vytváření Brightspace Desire2Learn testovací uživatel](#creating-a-brightspace-by-desire2learn-test-user)**  – Pokud chcete mít protějšek Britta Simon Brightspace podle Desire2Learn, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **Brightspace Desire2Learn domény a adresy URL** části, proveďte následující kroky:
...
6. Ke konfiguraci jednotného přihlašování na **Brightspace podle Desire2Learn** straně, je nutné odeslat na stažený **soubor XML s metadaty** k [Brightspace týmem podpory Desire2Learn](https://www.d2l.com/contact/).

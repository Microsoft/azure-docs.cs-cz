---
title: Translator Text – převedení textového skriptu s Node.js | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: V tomto rychlém startu převedete text v jednom jazyce z jednoho skriptu do druhého pomocí služby Translator Text API s Node.js ve službách Cognitive Services.
...
ms.locfileid: "43768982"
---
# <a name="quickstart-transliterate-text-with-nodejs"></a>Rychlý start: Transkripce textu s Node.js

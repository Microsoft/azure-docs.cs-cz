...
Uložte identifikátor URI prostředku pro povolený účet úložiště v proměnné. Před provedením následujícího příkazu nahraďte *\<ID předplatného >* skutečnou hodnotou ID vašeho předplatného.
...
Připojte sdílenou složku Azure k adresáři, který jste vytvořili. Před spuštěním příkazu uvedeného níže nahraďte *\<klíčového úložiště-key >* hodnotou *AccountKey* z **$saConnectionString 1**.
...
Před spuštěním příkazu uvedeného níže nahraďte *\<klíčového úložiště-key >* hodnotou *AccountKey* z **$saConnectionString 2**.

```bash
sudo mount --types cifs //notallowedstorageacc.file.core.windows.net/my-file-share /mnt/MyAzureFileShare2 --options vers=3.0,username=notallowedstorageacc,password=<storage-account-key>,dir_mode=0777,file_mode=0777,serverino
```

Přístup je odepřený a zobrazí se chyba `mount error(13): Permission denied`, protože tento účet úložiště není v seznamu povolených zásad koncového bodu služby, který jsme v podsíti použili. 

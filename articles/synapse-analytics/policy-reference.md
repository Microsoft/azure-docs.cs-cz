...
ms.locfileid: "96296080"
---
# <a name="azure-policy-built-in-definitions-for-azure-synapse-analytics-workspace-preview"></a>Azure Policy předdefinované definice pro Azure synapse Analytics (pracovní prostor Preview)

Tato stránka je indexem [Azure Policy](../governance/policy/overview.md) integrovaných definic zásad pro Azure synapse. Další Azure Policy integrovaných pro jiné služby najdete v tématu [Azure Policy předdefinované definice](../governance/policy/samples/built-in-policies.md).

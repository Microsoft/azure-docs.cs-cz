...
Použijte metodu Put se existující ID plánu pro stejný uložené výsledky hledání k úpravě tohoto plánu; v následujícím příkladu je plán zakázán. Musí obsahovat text žádosti *etag* plánu.

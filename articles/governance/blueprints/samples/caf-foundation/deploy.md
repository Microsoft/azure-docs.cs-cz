---
title: Nasazení ukázky podrobného plánu nadace CAF
description: Nasazení kroků pro ukázku podrobného plánu CAF Foundation včetně podrobností o parametru artefaktu podrobného plánu.
ms.date: 08/20/2019
ms.topic: sample
...
---
# <a name="deploy-the-microsoft-cloud-adoption-framework-for-azure-foundation-blueprint-sample"></a>Nasazení ukázky podrobného plánu architektury Microsoft Cloud Adoption Framework pro Azure Foundation

Chcete-li nasadit microsoft cloud přijetí framework pro Azure (CAF) nadace podrobný plán ukázka, je třeba podniknout následující kroky:
...
1. Najděte ukázku podrobného plánu **caf foundation** v části _Další ukázky_ a vyberte **Použít tuto ukázku**.

1. Zadejte _základy ukázky_ podrobného plánu:

   - **Název podrobného plánu**: Zadejte název pro kopii ukázky podrobného plánu nadace CAF.
...
Vaše kopie ukázky podrobného plánu byla nyní vytvořena ve vašem prostředí. Je vytvořen v režimu **konceptu** a musí být **publikovánpřed** jeho přiřazením a nasazením. Kopii ukázky podrobného plánu lze přizpůsobit vašemu prostředí a potřebám, ale tato změna ji může přesunout od podrobného plánu caf foundation.

1. V levém podokně vyberte **Všechny služby**. Vyhledejte a vyberte **podrobné plány**.

1. Vyberte stránku **Definice podrobného plánu** vlevo. Pomocí filtrů vyhledejte kopii ukázky podrobného plánu a vyberte ji.

1. V horní části stránky vyberte **Publikovat podrobný plán.** Na nové stránce vpravo zadejte **verzi** pro kopii ukázky podrobného plánu. Tato vlastnost je užitečná, pokud provedete změnu později. Zadejte **poznámky ke změně,** například "První verze publikovaná z ukázky podrobného plánu nadace CAF". Pak vdolní části stránky vyberte **Publikovat.**
...
1. Zadejte hodnoty parametrů pro přiřazení podrobného plánu:
   ...
   - Parametry podrobného plánu
     ...
     - **Organizace**: Zadejte název organizace, například Contoso, musí být jedinečný.
     - **Oblast Azure**: Vyberte oblast Azure pro nasazení.
     - **Povolená umístění**: Které oblasti Azure povolíte, aby byly vytvořeny prostředky?
...
|-|-|-|-|
|Povolené skladové položky účtu úložiště|Přiřazení zásad|Policy_Allowed-StorageAccount-Sklad|Skladová položka používaná v účtech úložiště diagnostického protokolu|
|Povolené souuživatele virtuálních strojů|Přiřazení zásad|Policy_Allowed-VM-SKu|Povolené souuživatele virtuálních strojů|
|Připojit značku CostCenter ke skupinám prostředků|Přiřazení zásad|Policy_CostCenter_Tag|Připojit značku CostCenter a její hodnotu ze skupiny prostředků|
|Typy prostředků, které nechcete povolit ve vašem prostředí|Přiřazení zásad|Zásady _Allowed-Typy prostředků|Které prostředky Azure chcete povolit ve vašem prostředí|
|Nasazení trezoru klíčů|Šablona Resource Manageru|Zásady přístupu kV|**Uzamčeno** – skupina Azure <Object ID> AD nebo uživatel udělit oprávnění v trezoru klíčů|
...
Teď, když jste zkontrolovali kroky k nasazení ukázky podrobného plánu nadace CAF Foundation, navštivte následující článek, kde se dozvíte o architektuře:

> [!div class="nextstepaction"]
> [Caf Nadace blueprint - Přehled](./index.md)

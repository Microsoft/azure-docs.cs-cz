...
---
## <a name="run-image-from-registry"></a>Spustit bitová kopie z registru

Nyní můžete vytáhnout a `hello-world:v1` spustit image kontejneru z registru kontejneru pomocí [docker spustit][docker-run]:

...
Pokud stále potřebujete pomoc, [obraťte](https://portal.azure.com/?#blade/Microsoft_Azure_Support/HelpAndSupportBlade) se na podporu, abyste mohli rychle vyřešit problém pomocí následujícího typu problému: typ problému **správy předplatných** : **požadavek na povolení toku e-mailu portu 25**.

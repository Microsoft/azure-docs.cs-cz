...
2. Na stránce **Přehled** skupiny prostředků vyberte **Odstranit skupinu prostředků**.

   ![Odstranění skupiny prostředků](./media/cosmos-db-delete-resource-group/delete-resources.png)   

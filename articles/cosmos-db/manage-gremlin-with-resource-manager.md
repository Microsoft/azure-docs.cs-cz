...
ms.locfileid: "65077782"
---
# <a name="create-azure-cosmos-db-gremlin-api-resources-from-a-resource-manager-template"></a>Vytvoření prostředků Azure Cosmos DB Gremlin API z šablony Resource Manageru

Zjistěte, jak vytvořit prostředky Azure Cosmos DB Gremlin API pomocí šablony Azure Resource Manageru. Následující příklad vytvoří rozhraní Azure Cosmos DB Gremlin API z [šablona Azure Quickstart](https://aka.ms/gremlin-arm-qs). Tato šablona vytvoří účet Azure Cosmos pro rozhraní Gremlin API s dva grafy, které sdílejí propustnost 400 RU/s na úrovni databáze.

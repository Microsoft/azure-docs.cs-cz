...
description: Tento článek popisuje cenové, fakturační, fakturační a výběrové možnosti pro Microsoft Commercial Marketplace – možnost jazyka Transact.
author: dsindona
...
ms.locfileid: "82160524"
---
# <a name="commercial-marketplace-transact-capabilities"></a>Možnosti Transact-The pro komerční web Marketplace

Tento článek se zabývá následujícími tématy týkajícími se obchodování na komerčním webu Microsoftu:

* Zodpovědnost za transakce pro různé možnosti publikování
...
Vydavatelé se stávajícími obchodními funkcemi můžou zvolit možnosti publikování seznam, zkušební verze a vlastní licence (BYOL) pro účely propagačního a nabývání uživatelů. S těmito možnostmi se společnost Microsoft neúčastní přímo v transakcích licencí na software vydavatele a není k dispozici žádný související transakční poplatek. Vydavatelé zodpovídají za podporu všech aspektů transakce softwarových licencí, mimo jiné: objednávka, plnění, měření, fakturace, fakturace, platby a shromažďování. V možnostech publikování seznamu a vyzkoušení můžou vydavatelé uchovávat 100% licenčních poplatků za software vydavatele shromážděných od zákazníka.

### <a name="transact-publishing-option"></a>Možnost publikování v režimu Transact

Možnost publikování v režimu Transact využívá výhody možností Microsoft Commerce a poskytuje ucelené prostředí ze zjišťování a vyhodnocení k nákupu a implementaci. Nabídky Transact se účtují pro stávající předplatné Microsoftu nebo platební kartu, což umožňuje Microsoftu hostovat transakce cloudového tržiště jménem vydavatele.

Možnost Transact zvolíte při vytváření nové nabídky v partnerském centru. Na stránce **nastavení nabídek** v části **Podrobnosti o instalaci**vyberte Ano, chci prodávat přes Microsoft a mít pro vás hostitelské transakce Microsoftu. Tato možnost se zobrazí pouze v případě, že je k dispozici příkaz Transact pro váš typ nabídky.
...
* Přineste si vlastní licenci (BYOL): veškeré relevantní poplatky za licence na software se spravují přímo mezi vydavatelem a zákazníkem. Microsoft předává jenom poplatky za využití infrastruktury Azure. To platí jenom pro Virtual Machines a aplikace Azure.
...
* Ceny předplatného: licenční poplatky za software se zobrazují jako měsíční nebo roční poplatek, který se účtuje jako paušální sazba nebo na pracovní stanici. To platí jenom pro aplikace SaaS a aplikace spravované v Azure.
...
Microsoft umožňuje zákazníkům objednat, licencovat a používat software vydavatele v souvislosti s podmínkami a ujednáními z komerčního tržiště společnosti Microsoft i s licenční smlouvou pro koncového uživatele vydavatele. Vydavatelé musí poskytnout licenční smlouvu s koncovým uživatelem nebo vybrat [standardní kontrakt](./standard-contract.md) při vytváření nabídky.
...
*    Pokud povolíte možnost prodávat prostřednictvím Microsoftu pro nabídku SaaS, pak máte následující nákladovou strukturu.
...
Další informace o nastavení těchto účtů najdete v tématu [Správa účtu komerčního tržiště v partnerském centru](https://docs.microsoft.com/azure/marketplace/partner-center-portal/manage-account).

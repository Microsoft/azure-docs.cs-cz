...
Chcete-li dokončit příklad v tomto článku, musíte mít existující spravovanou bitovou kopii zobecněného virtuálního počítače nebo snímek specializovaného virtuálního počítače. Postup najdete v [kurzu: Vytvoření vlastní image virtuálního počítače Azure s Azure PowerShell](tutorial-custom-images.md) pro vytvoření spravované Image nebo [vytvoření snímku](snapshot-copy-managed-disk.md) pro specializovaný virtuální počítač. U spravovaných imagí i snímků nemůže být velikost datového disku větší než 1 TB.

...
Pomocí transformace JSONPath mohou autoři sešitu převést JSON na strukturu tabulky. Tabulka se pak dá použít k vykreslení [vizualizací sešitu](../platform/workbooks-overview.md#visualizations).

...
V tomto článku si ukážeme, jak nastavit šablonu virtuálního počítače v testovacím prostředí pomocí sady [Visual Studio 2019](https://visualstudio.microsoft.com/vs/), [SQL Server Management Studio](https://docs.microsoft.com/sql/ssms/download-sql-server-management-studio-ssms?view=sql-server-ver15)a [Azure Data Studio](https://github.com/microsoft/azuredatastudio).  V tomto testovacím prostředí budeme používat jednu sdílenou [SQL Server databázi](https://docs.microsoft.com/azure/sql-database/sql-database-technical-overview) pro celé testovací prostředí. [Azure SQL Database](https://docs.microsoft.com/azure/sql-database/sql-database-technical-overview) je databázový stroj PaaS (Platform as a Service) z Azure.
...
| ------------------- | ------------ |
| Obrázek Marketplace | Povolte pro použití v rámci vašeho účtu testovacího prostředí komunitní image sady Visual Studio 2019 (nejnovější verze) na Windows 10 Enterprise N (x64). |
...
Teď, když je strana věcí v síti zpracována, umožňuje vytvořit databázi SQL Server.  Vytvoříme izolovanou [databázi](https://docs.microsoft.com/azure/sql-database/sql-database-single-database-get-started?tabs=azure-portal) , protože se jedná o možnost nejrychlejší nasazení Azure SQL Database.  Pro další možnosti nasazení vytvořte [elastický fond](https://docs.microsoft.com/azure/sql-database/sql-database-elastic-pool#creating-a-new-sql-database-elastic-pool-using-the-azure-portal), [spravovanou instanci](https://docs.microsoft.com/azure/sql-database/sql-database-managed-instance-get-started)nebo [virtuální počítač SQL](https://docs.microsoft.com/azure/virtual-machines/windows/sql/quickstart-sql-vm-create-portal).
...
[SQL Server Management Studio (SSMS)](https://docs.microsoft.com/sql/ssms/download-sql-server-management-studio-ssms?view=sql-server-ver15) je integrované prostředí pro správu jakékoli infrastruktury SQL.  SSMS je nástroj používaný správci databáze k nasazení, monitorování a upgradu infrastruktury dat.
...
Není-li nainstalován SSMS, můžete se [připojit a zadat dotaz na SQL Server](https://docs.microsoft.com/sql/ssms/tutorials/connect-query-sql-server). Při nastavování připojení použijte následující hodnoty:

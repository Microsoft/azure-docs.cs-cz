---
title: Vytvoření veřejného nástroje pro vyrovnávání zatížení – Azure CLI | Dokumentace Microsoftu
description: Naučte se vytvářet veřejný nástroj pro vyrovnávání zatížení pomocí Azure CLI
...
---
# <a name="create-a-public-load-balancer-to-load-balance-vms-using-azure-cli-20"></a>Vytvoření veřejného nástroje pro vyrovnávání zatížení virtuálních počítačů pomocí Azure CLI 2.0
...
Veřejnou IP adresu nástroje pro vyrovnávání zatížení získáte pomocí příkazu [az network public-ip show](/cli/azure/network/public-ip#az_network_public_ip_show). Zkopírujte veřejnou IP adresu a pak ji vložte do adresního řádku svého prohlížeče.

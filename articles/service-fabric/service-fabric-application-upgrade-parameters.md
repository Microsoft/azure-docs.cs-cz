...
UpgradeMode | INFRASTRUKTURA | Povolené hodnoty se **monitorují** (výchozí), **UnmonitoredAuto**nebo **UnmonitoredManual**. Podrobnosti najdete v tématu parametry PowerShellu pro každý režim v tomto článku. |
...
Mode | Povolené hodnoty jsou **monitorované**, **UpgradeMode**, **UnmonitoredAuto**, **UnmonitoredManual**. Výchozí hodnota je **UnmonitoredAuto**. Popisy těchto hodnot najdete v části věnované *parametrům* pro Visual Studio a PowerShell.|

...
|content|počet elementů: 0, 3 atributy:|
|definované|místně ve [skupině ScalingPolicyMechanismGroup](service-fabric-service-model-schema-element-groups.md#scalingpolicymechanismgroup-group)|
...
|content|počet elementů: 0, počet atributů: 0|
|definované|univerzál|
|name|Aplikace|
...
|---|---|
|typ|anonymní typ complexType|
|content|počet prvků: 0, 2 atributy|
...
|---|---|
|typ|anonymní typ complexType|
|content|počet elementů: 0, počet atributů: 4|
|definované|místně ve [skupině ScalingPolicyTriggerGroup](service-fabric-service-model-schema-element-groups.md#scalingpolicytriggergroup-group)|
...
|---|---|
|typ|anonymní typ complexType|
|content|počet elementů: 0, počet atributů: 5|
|definované|místně ve [skupině ScalingPolicyTriggerGroup](service-fabric-service-model-schema-element-groups.md#scalingpolicytriggergroup-group)|
...
|content|počet elementů: 0, počet atributů: 0|
|definované|místně v prvku cíle|
|name|AzureBlob|
|minOccurs|0|
|maxOccurs|Unbounded|
...
|content|počet elementů: 0, počet atributů: 0|
|definované|místně v elementu Destinations (cíle) – element Destinations|
|name|AzureBlob|
|minOccurs|0|
|maxOccurs|Unbounded|
...
|---|---|
|typ|anonymní typ complexType|
|content|1 prvky, počet atributů: 0|
...
|typ|[KeyValuePairType](service-fabric-service-model-schema-complex-types.md#keyvaluepairtype-complextype)|
|content|počet elementů: 0, počet atributů: 0|
|definované|místně v prvku kapacity|
|name|Kapacita|
|minOccurs|0|
|maxOccurs|Unbounded|
...
|content|počet elementů: 0, počet atributů: 0|
|definované|místně v elementu NodeType, [InfrastructureNodeType complexType](service-fabric-service-model-schema-complex-types.md#infrastructurenodetype-complextype)|
|name|Certifikáty|
|minOccurs|0|
...
|---|---|
|typ|anonymní typ complexType|
|content|2 elementy, počet atributů: 0|
...
|content|počet elementů: 0, počet atributů: 0|
|definované|místně v elementu ConfigOverrides, element DigestedConfigPackage|
|name|ConfigOverride|
|minOccurs|0|
|maxOccurs|Unbounded|
...
Popisuje přepsání konfigurace pro importovaný manifest služby. Přepsání konfigurace umožňují flexibilitu opakovaného použití stejných manifestů služby napříč více typy aplikací přepsáním konfigurace manifestu služby pouze v případě, že se používá s konkrétním typem aplikace. Přepsání konfigurace mohou změnit jakoukoli výchozí konfiguraci v manifestu služby, pokud je výchozí konfigurace definována pomocí souboru Settings. XML ve složce ConfigPackage. 
...
|content|počet elementů: 0, počet atributů: 0|
|definované|místně v [ConfigPackagePoliciesType complexType](service-fabric-service-model-schema-complex-types.md#configpackagepoliciestype-complextype)|
|name|ConfigPackage|
|minOccurs|0|
|maxOccurs|Unbounded|
...
|content|počet elementů: 0, počet atributů: 0|
|definované|místně v [NetworkPoliciesType complexType](service-fabric-service-model-schema-complex-types.md#networkpoliciestype-complextype)|
...
|---|---|
|typ|anonymní typ complexType|
|content|2 elementy, počet atributů: 1|
...
|content|počet elementů: 0, počet atributů: 0|
|definované|místně v elementu DigestedCodePackage, element DigestedConfigPackage, element DigestedDataPackage|
...
|---|---|
|typ|anonymní typ complexType|
|content|počet elementů: 0, počet atributů: 1|
...
|---|---|
|typ|anonymní typ complexType|
|content|3 elementy, počet atributů: 0|
...
|---|---|
|typ|anonymní typ complexType|
|content|3 elementy, počet atributů: 2|
|definované|místně v [ServicePackageType complexType](service-fabric-service-model-schema-complex-types.md#servicepackagetype-complextype)|
...
|---|---|
|typ|anonymní typ complexType|
|content|2 elementy, počet atributů: 2|
|definované|místně v [ServicePackageType complexType](service-fabric-service-model-schema-complex-types.md#servicepackagetype-complextype)|
...
|---|---|
|typ|anonymní typ complexType|
|content|4 elementy, počet atributů: 0|
...
Nepodporováno, nepoužívejte. Podpora hostování knihoven DLL (vstupní bod sestavení) je poskytována prostřednictvím procesu FWP. exe. Service Fabric spustí pracovní proces Fabric (FWP. exe) a načte sestavení jako součást procesu aktivace.
...
|typ|anonymní typ complexType|
|content|počet elementů: 0, počet atributů: 1|
|definované|místně v elementu membership|
|name|DomainGroup|
|minOccurs|0|
|maxOccurs|Unbounded|
...
|content|počet elementů: 0, počet atributů: 0|
|definované|místně v elementu Endpoints|
|name|Koncový bod|
|maxOccurs|Unbounded|
...
|typ|[EndpointType](service-fabric-service-model-schema-complex-types.md#endpointtype-complextype)|
|content|počet elementů: 0, počet atributů: 0|
|definované|místně v elementu Endpoints, element DigestedEndpoint|
|name|Koncový bod|
|maxOccurs|Unbounded|
...
|content|počet elementů: 0, počet atributů: 0|
|definované|místně v [ContainerNetworkPolicyType complexType](service-fabric-service-model-schema-complex-types.md#containernetworkpolicytype-complextype)|
...
|typ|[EndpointCertificateType](service-fabric-service-model-schema-complex-types.md#endpointcertificatetype-complextype)|
|content|počet elementů: 0, počet atributů: 0|
|definované|místně v elementu Certificates, element DigestedCertificates, element DigestedCertificates|
|name|EndpointCertificate|
|minOccurs|0|
...
|content|počet elementů: 0, počet atributů: 0|
|definované|místně v [EnvironmentOverridesType complexType](service-fabric-service-model-schema-complex-types.md#environmentoverridestype-complextype)|
|name|Objekt EnvironmentVariable|
|minOccurs|0|
|maxOccurs|Unbounded|
...
|content|počet elementů: 0, počet atributů: 0|
|definované|místně v [EnvironmentVariablesType complexType](service-fabric-service-model-schema-complex-types.md#environmentvariablestype-complextype)|
|name|Objekt EnvironmentVariable|
|minOccurs|0|
|maxOccurs|Unbounded|
...
|---|---|
|typ|anonymní typ complexType|
|content|počet elementů: 1, 2 atributy|
|definované|univerzál|
|name|EvictionPolicy|
...
|typ|anonymní typ complexType|
|content|2 elementy, počet atributů: 1|
|definované|místně v prvku skupiny|
|name|Skupina|
|maxOccurs|Unbounded|
...
Úložiště a obrázek v https://hub.docker.com nebo Azure Container Registry.
...
|---|---|
|typ|anonymní typ complexType|
|content|6 elementů, počet atributů: 0|
|definované|místně v [ClusterManifestType complexType](service-fabric-service-model-schema-complex-types.md#clustermanifesttype-complextype)|
|name|Infrastruktura|
...
|content|počet elementů: 0, počet atributů: 0|
|definované|místně v elementu LoadMetrics, element LoadMetrics, element LoadMetrics, element LoadMetrics, element LoadMetrics|
|name|LoadMetric|
|maxOccurs|Unbounded|
...
Nepodporováno, nepoužívejte. Název spravovaného sestavení (například Queue. dll) na hostitele.
...
|content|počet elementů: 0, počet atributů: 0|
|definované|lokálně v elementu Members element members|
|name|Člen|
|minOccurs|1|
|maxOccurs|Unbounded|
...
|typ|anonymní typ complexType|
|content|2 elementy, počet atributů: 0|
|definované|místně v uživatelském elementu|
|name|MemberOf|
|minOccurs|0|
...
|---|---|
|typ|anonymní typ complexType|
|content|počet elementů: 0, počet atributů: 6|
|definované|místně v uživatelském elementu|
|name|NTLMAuthenticationPolicy|
|minOccurs|0|
...
|typ|anonymní typ complexType|
|content|1 prvky, počet atributů: 0|
|definované|místně ve [skupině PartitionDescriptionGroup](service-fabric-service-model-schema-element-groups.md#partitiondescriptiongroup-group)|
|name|NamedPartition|
...
|content|počet elementů: 0, počet atributů: 0|
|definované|místně v elementu seznam uzlů., element seznam uzlů.|
|name|Uzel|
|maxOccurs|Unbounded|
...
|content|počet elementů: 0, počet atributů: 0|
|definované|místně v elementu seznam uzlů.|
|name|Uzel|
|maxOccurs|Unbounded|
...
|typ|anonymní typ complexType|
|content|počet prvků: 0, 2 atributy|
|definované|místně v elementu Parameters|
|name|Parametr|
|Blokované||
|minOccurs|0|
|maxOccurs|Unbounded|
...
|typ|anonymní typ complexType|
|content|počet prvků: 0, 2 atributy|
|definované|lokálně v elementu oddílu|
|name|Parametr|
|minOccurs|0|
|maxOccurs|Unbounded|
...
|---|---|
|typ|anonymní typ complexType|
|content|1 prvky, počet atributů: 4|
|definované|univerzál|
...
|content|počet elementů: 0, počet atributů: 0|
|definované|místně v [ServicePackageContainerPolicyType complexType](service-fabric-service-model-schema-complex-types.md#servicepackagecontainerpolicytype-complextype), [ContainerHostPoliciesType complexType](service-fabric-service-model-schema-complex-types.md#containerhostpoliciestype-complextype)|
|name|PortBinding|
|minOccurs|0|
|maxOccurs|Unbounded|
...
|typ|[ServiceTypeExtensionPolicyPropertiesType](service-fabric-service-model-schema-complex-types.md#servicetypeextensionpolicypropertiestype-complextype)|
|content|počet elementů: 0, počet atributů: 0|
|definované|místně v elementu PersistencePolicy, element EvictionPolicy|
|name|Vlastnosti|
|minOccurs|0|
...
|typ|[ResourceGovernancePolicyType](service-fabric-service-model-schema-complex-types.md#resourcegovernancepolicytype-complextype)|
|content|počet elementů: 0, počet atributů: 0|
|definované|místně v [ServiceManifestImportPoliciesType complexType](service-fabric-service-model-schema-complex-types.md#servicemanifestimportpoliciestype-complextype), element DigestedCodePackage, element DigestedEndpoint|
|name|ResourceGovernancePolicy|
|minOccurs|0|
...
|content|počet elementů: 0, počet atributů: 0|
|definované|místně v elementu role|
|name|Role|
|maxOccurs|Unbounded|
...
|typ|[FabricCertificateType](service-fabric-service-model-schema-complex-types.md#fabriccertificatetype-complextype)|
|content|počet elementů: 0, počet atributů: 0|
|definované|místně v elementu certifikáty, element certifikáty, element DigestedCertificates|
|name|SecretsCertificate|
|minOccurs|0|
...
|---|---|
|typ|anonymní typ complexType|
|content|počet elementů: 1, počet atributů: 1|
...
|typ|[SecurityAccessPolicyType](service-fabric-service-model-schema-complex-types.md#securityaccesspolicytype-complextype)|
|content|počet elementů: 0, počet atributů: 0|
|definované|místně v [ServiceManifestImportPoliciesType complexType](service-fabric-service-model-schema-complex-types.md#servicemanifestimportpoliciestype-complextype), element SecurityAccessPolicies, element DigestedEndpoint|
|name|SecurityAccessPolicy|
|minOccurs|0|
...
|---|---|
|typ|anonymní typ complexType|
|content|2 elementy, počet atributů: 4|
...
|---|---|
|typ|anonymní typ complexType|
|content|5 elementů, počet atributů: 0|
|definované|místně v [ApplicationManifestType complexType](service-fabric-service-model-schema-complex-types.md#applicationmanifesttype-complextype)|
...
|typ|[StatefulServiceType](service-fabric-service-model-schema-complex-types.md#statefulservicetype-complextype)|
|content|počet elementů: 0, počet atributů: 0|
|definované|místně v [ServiceTemplatesType complexType](service-fabric-service-model-schema-complex-types.md#servicetemplatestype-complextype), Service element|
|name|StatefulService|
...
|typ|[StatefulServiceGroupType](service-fabric-service-model-schema-complex-types.md#statefulservicegrouptype-complextype)|
|content|počet elementů: 0, počet atributů: 0|
|definované|místně v [ServiceTemplatesType complexType](service-fabric-service-model-schema-complex-types.md#servicetemplatestype-complextype), element ServiceCollection|
|name|StatefulServiceGroup|
...
Nepodporováno, nepoužívejte. Název nespravovaného sestavení (například Queue. dll) na hostitele.
...
|definované|lokálně v elementu Users|
|name|Uživatel|
|maxOccurs|Unbounded|
...
|content|počet elementů: 0, počet atributů: 0|
|definované|místně v prvku hlasy|
|name|Věnované|
|maxOccurs|Unbounded|

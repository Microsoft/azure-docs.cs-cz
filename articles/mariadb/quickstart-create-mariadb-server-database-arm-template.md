---
title: Vytvoření Azure DB pro MariaDB pomocí šablony ARM
description: V tomto článku se dozvíte, jak vytvořit Azure Database for MariaDB Server pomocí Azure Resource Manager šablony.
author: mgblythe
ms.service: mariadb
ms.topic: quickstart

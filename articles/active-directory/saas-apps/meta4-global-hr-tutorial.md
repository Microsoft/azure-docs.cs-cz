...
2. **[Nakonfigurujte jednotné přihlašování META4 globálního HR](#configure-meta4-global-hr-single-sign-on)** – ke konfiguraci nastavení jediného Sign-On na straně aplikace.
...
5. Klikněte na **nastavit další adresy URL** a proveďte následující krok, pokud chcete nakonfigurovat aplikaci v režimu iniciované **SP** :
    ...
    > [!NOTE]
    > Tyto hodnoty nejsou reálné. Aktualizujte tyto hodnoty pomocí skutečné adresy URL odpovědi a adresy URL Sign-On. Pokud chcete získat tyto hodnoty, obraťte se na [tým podpory META4 Global HR](mailto:victors@meta4.com) . Můžete se také podívat na vzory uvedené v části **základní konfigurace SAML** v Azure Portal.
...
### <a name="configure-meta4-global-hr-single-sign-on"></a>Konfigurace META4 globálního HR na jednom Sign-On
...
Když kliknete na dlaždici META4 Global HR na přístupovém panelu, měli byste se automaticky přihlásit ke globálnímu HR META4, pro který jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).

...
- **Opravené** – když vytvoříte virtuální počítač, zprávu *nejde zobrazit ceny* už se zobrazí při výběru velikost pro velikost virtuálního počítače.
...
*Nejsou žádné známé problémy pro instalaci aktualizace 1803.*

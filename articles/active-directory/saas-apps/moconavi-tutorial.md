...
2. **[Nakonfigurujte jednotné přihlašování moconavi](#configure-moconavi-single-sign-on)** – ke konfiguraci nastavení jediného Sign-On na straně aplikace.
...
### <a name="configure-moconavi-single-sign-on"></a>Nakonfigurovat moconavi jednu Sign-On

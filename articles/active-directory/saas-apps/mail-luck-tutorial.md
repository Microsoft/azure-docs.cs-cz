...
Po kliknutí na tlačítko se zobrazí zpráva. na přístupovém panelu, měli byste být automaticky přihlášení k poště. pro který jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).

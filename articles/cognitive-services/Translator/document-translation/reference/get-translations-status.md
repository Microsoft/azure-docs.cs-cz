...
description: Metoda get překlady status vrátí seznam odeslaných požadavků na dávky a stav pro každý požadavek.
...
ms.locfileid: "107864824"
---
# <a name="get-translations-status"></a>Získat stav překladu

Metoda get překlady status vrátí seznam odeslaných požadavků na dávky a stav pro každý požadavek. Tento seznam obsahuje jenom dávkové požadavky odeslané uživatelem (na základě předplatného). Stav každého požadavku je seřazen podle ID.
...
## <a name="get-translations-status-response"></a>Odpověď na stav získání překladu

### <a name="successful-get-translations-status-response"></a>Úspěšná odpověď na stav získání překladu

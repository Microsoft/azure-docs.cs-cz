...
V následujícím kurzu vás provede procesem vytvoření hybridního prostředí identit pomocí předávacího ověřování.  Toto prostředí je pak možné pro účely testování nebo pro získání více do hloubky s tím, jak funguje hybridní identita.
...
6. Na obrazovce přihlášení uživatele, vyberte **předávací ověřování** a **povolit jednotné přihlašování** a klikněte na tlačítko **Další**.</br>
...
9. Na stránce povolit jednotné přihlašování n pověření zadejte uživatelské jméno contoso\Administrator a heslo a klikněte na **Další.**
10. Na obrazovce Připraveno ke konfiguraci klikněte na **Instalovat**.
11. Až instalace skončí, klikněte na **Konec**.
12. Po dokončení instalace se odhlaste a znovu se přihlaste teprve pak použijte Synchronization Service Manager nebo Synchronization Rule Editor.

...
Trezor klíčů byl původně vytvořen s omezeními zadanými v [limitech služby Azure Key Vault](key-vault-service-limits.md).  Chcete-li maximalizovat úložiště klíčů prostřednictvím sazeb na dotík, zde je několik doporučených pokynů a doporučených postupů pro maximalizaci propustnosti:
...
1. Pokud používáte trezor klíčů k ukládání přihlašovacích údajů pro službu, zkontrolujte, zda tato služba podporuje ověřování AAD k přímému ověření. To snižuje zatížení trezoru klíčů, zvyšuje spolehlivost a zjednodušuje kód, protože trezor klíčů teď může používat token AAD.  Mnoho služeb se přesunulo k používání AAD Auth.  Podívejte se na aktuální seznam na [webu Services, který podporuje spravované identity pro prostředky Azure](../active-directory/managed-identities-azure-resources/services-support-managed-identities.md#azure-services-that-support-managed-identities-for-azure-resources).

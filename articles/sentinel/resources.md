...
| **Dodavatel**  | **Use incident in Azure Sentinel** | **Odkaz**|
|----|----|----|
| GitHubu| Used to access Community page| <https://github.com/Azure/Azure-Sentinel> |

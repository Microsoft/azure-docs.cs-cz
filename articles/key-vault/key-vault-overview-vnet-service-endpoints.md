---
ms.assetid: ''
title: Koncové body služeb virtuální sítě pro Azure Key Vault | Dokumentace Microsoftu
...
Existuje jedna důležitá výjimka tohoto omezení. Pokud se uživatel přihlásí k povolit důvěryhodným službám Microsoftu, se přes bránu firewall umožňují připojení z těchto služeb. Například tyto služby patří služby Office 365 Exchange Online, Office 365 SharePoint Online, Azure compute, Azure Resource Manageru a Azure Backup. Stále potřeba, předložit platný token Azure Active Directory a musí mít oprávnění (konfigurovaná jako zásad přístupu) k provedení požadované operace. Další podrobnosti najdete v tématu [koncové body služeb virtuální sítě](../virtual-network/virtual-network-service-endpoints-overview.md).
...
Další podrobnosti najdete v tématu [virtuální sítí a bran firewall nakonfigurovat služby Azure Key Vault](key-vault-network-security.md).

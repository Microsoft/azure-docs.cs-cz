...
Následující článek podrobně popisuje, jak Azure Policyá definice předdefinovaného dodržování legislativních předpisů mapuje na domény a **ovládací prvky** **dodržování předpisů** na NIST SP 800-53 R4.
...
Pak vyhledejte a vyberte **[Preview]: Auditovat NIST SP 800-53 R4 Controls a nasaďte specifická rozšíření virtuálních počítačů, aby se podporovaly požadavky na audit** . integrovaná definice iniciativy pro dodržování předpisů
...
|Název<br /><sub>(Azure Portal)</sup> |Popis |Vliv (s) |Verze<br /><sub>GitHubu</sub> |
|---|---|---|---|---|
...
|[Nasaďte požadavky na auditování virtuálních počítačů s Windows, ve kterých skupina Administrators obsahuje některé ze zadaných členů.](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F144f1397-32f9-4598-8c88-118decc3ccba) |Tato zásada vytvoří přiřazení konfigurace hosta pro audit virtuálních počítačů s Windows, ve kterých skupina Administrators obsahuje některé ze zadaných členů. Zároveň vytvoří spravovanou identitu přiřazenou systémem a nasadí rozšíření virtuálního počítače pro konfiguraci hosta. Tyto zásady by se měly používat jenom spolu s odpovídajícími zásadami auditu v iniciativě. Pokud chcete získat další informace o zásadách konfigurace hostů, navštivte prosím.[https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_AdministratorsGroupMembersToExclude_Deploy.json) |
|[Nasaďte požadavky na auditování virtuálních počítačů s Windows, ve kterých skupina Administrators neobsahuje všechny zadané členy.](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F93507a81-10a4-4af0-9ee2-34cf25a96e98) |Tato zásada vytvoří přiřazení konfigurace hosta pro audit virtuálních počítačů s Windows, ve kterých skupina Administrators neobsahuje všechny zadané členy. Zároveň vytvoří spravovanou identitu přiřazenou systémem a nasadí rozšíření virtuálního počítače pro konfiguraci hosta. Tyto zásady by se měly používat jenom spolu s odpovídajícími zásadami auditu v iniciativě. Pokud chcete získat další informace o zásadách konfigurace hostů, navštivte prosím.[https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_AdministratorsGroupMembersToInclude_Deploy.json) |
...
|Název<br /><sub>(Azure Portal)</sup> |Popis |Vliv (s) |Verze<br /><sub>GitHubu</sub> |
|---|---|---|---|---|
|[Nasazení požadavků pro audit virtuálních počítačů Linux, které umožňují vzdálená připojení z účtů bez hesel](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fec49586f-4939-402d-a29e-6ff502b20592) |Tato zásada vytvoří přiřazení konfigurace hosta pro audit virtuálních počítačů se systémem Linux, které umožňují vzdálená připojení z účtů bez hesel. Zároveň vytvoří spravovanou identitu přiřazenou systémem a nasadí rozšíření virtuálního počítače pro konfiguraci hosta. Tyto zásady by se měly používat jenom spolu s odpovídajícími zásadami auditu v iniciativě. Pokud chcete získat další informace o zásadách konfigurace hostů, navštivte prosím.[https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.2.0 – Preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_LinuxPassword110_Deploy.json) |
...
|[Zobrazit výsledky auditu z virtuálních počítačů se systémem Linux, které umožňují vzdálená připojení z účtů bez hesel](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F2d67222d-05fd-4526-a171-2ee132ad9e83) |Tyto zásady by se měly používat jenom spolu s odpovídajícími zásadami nasazení v iniciativě. Tato definice umožňuje Azure Policy zpracování výsledků auditování virtuálních počítačů se systémem Linux, které umožňují vzdálená připojení z účtů bez hesel. Pokud chcete získat další informace o zásadách konfigurace hostů, navštivte prosím.[https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.1.0 – Preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_LinuxPassword110_Audit.json) |
...
### <a name="non-repudiation"></a>Neodmítnutí
...
|Název<br /><sub>(Azure Portal)</sup> |Popis |Vliv (s) |Verze<br /><sub>GitHubu</sub> |
|---|---|---|---|---|
|[Nasaďte požadavky pro audit virtuálních počítačů Linux, které nemají oprávnění k souboru passwd nastavené na 0644.](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Ff19aa1c1-6b91-4c27-ae6a-970279f03db9) |Tato zásada vytvoří přiřazení konfigurace hosta pro audit virtuálních počítačů se systémem Linux, které nemají oprávnění k souboru passwd nastavené na 0644. Zároveň vytvoří spravovanou identitu přiřazenou systémem a nasadí rozšíření virtuálního počítače pro konfiguraci hosta. Tyto zásady by se měly používat jenom spolu s odpovídajícími zásadami auditu v iniciativě. Pokud chcete získat další informace o zásadách konfigurace hostů, navštivte prosím.[https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.2.0 – Preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_LinuxPassword121_Deploy.json) |
|[Nasazení požadavků pro audit virtuálních počítačů se systémem Linux, které mají účty bez hesla](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F3470477a-b35a-49db-aca5-1073d04524fe) |Tato zásada vytvoří přiřazení konfigurace hosta pro audit virtuálních počítačů se systémem Linux, které mají účty bez hesla. Zároveň vytvoří spravovanou identitu přiřazenou systémem a nasadí rozšíření virtuálního počítače pro konfiguraci hosta. Tyto zásady by se měly používat jenom spolu s odpovídajícími zásadami auditu v iniciativě. Pokud chcete získat další informace o zásadách konfigurace hostů, navštivte prosím.[https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.2.0 – Preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_LinuxPassword232_Deploy.json) |
|[Nasazení požadavků pro audit virtuálních počítačů s Windows, které neukládají hesla pomocí reverzibilního šifrování](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F8ff0b18b-262e-4512-857a-48ad0aeb9a78) |Tato zásada vytvoří přiřazení konfigurace hosta pro audit virtuálních počítačů s Windows, které neukládají hesla pomocí reverzibilního šifrování. Zároveň vytvoří spravovanou identitu přiřazenou systémem a nasadí rozšíření virtuálního počítače pro konfiguraci hosta. Tyto zásady by se měly používat jenom spolu s odpovídajícími zásadami auditu v iniciativě. Pokud chcete získat další informace o zásadách konfigurace hostů, navštivte prosím.[https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0 – Preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordEncryption_Deploy.json) |
...
|[Zobrazit výsledky auditu z virtuálních počítačů se systémem Linux, u kterých není oprávnění k souboru passwd nastaveno na 0644](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fb18175dd-c599-4c64-83ba-bb018a06d35b) |Tyto zásady by se měly používat jenom spolu s odpovídajícími zásadami nasazení v iniciativě. Tato definice umožňuje Azure Policy zpracování výsledků auditování virtuálních počítačů se systémem Linux, které nemají oprávnění k souboru passwd nastavené na 0644. Pokud chcete získat další informace o zásadách konfigurace hostů, navštivte prosím.[https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.1.0 – Preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_LinuxPassword121_Audit.json) |
|[Zobrazit výsledky auditu z virtuálních počítačů se systémem Linux, které mají účty bez hesla](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fc40c9087-1981-4e73-9f53-39743eda9d05) |Tyto zásady by se měly používat jenom spolu s odpovídajícími zásadami nasazení v iniciativě. Tato definice umožňuje Azure Policy zpracování výsledků auditování virtuálních počítačů se systémem Linux, které mají účty bez hesla. Pokud chcete získat další informace o zásadách konfigurace hostů, navštivte prosím.[https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.1.0 – Preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_LinuxPassword232_Audit.json) |
|[Zobrazit výsledky auditu z virtuálních počítačů s Windows, které neukládají hesla pomocí reverzibilního šifrování](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F2d60d3b7-aa10-454c-88a8-de39d99d17c6) |Tyto zásady by se měly používat jenom spolu s odpovídajícími zásadami nasazení v iniciativě. Tato definice umožňuje Azure Policy zpracování výsledků auditování virtuálních počítačů s Windows, které neukládají hesla pomocí reverzibilního šifrování. Pokud chcete získat další informace o zásadách konfigurace hostů, navštivte prosím.[https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 – Preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordEncryption_Audit.json) |
...
|Název<br /><sub>(Azure Portal)</sup> |Popis |Vliv (s) |Verze<br /><sub>GitHubu</sub> |
|---|---|---|---|---|
|[Nasazení požadavků pro audit virtuálních počítačů s Windows, které umožňují opakované použití předchozích 24 hesel](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F726671ac-c4de-4908-8c7d-6043ae62e3b6) |Tato zásada vytvoří přiřazení konfigurace hosta pro audit virtuálních počítačů s Windows, které umožňují opakované použití předchozích 24 hesel. Zároveň vytvoří spravovanou identitu přiřazenou systémem a nasadí rozšíření virtuálního počítače pro konfiguraci hosta. Tyto zásady by se měly používat jenom spolu s odpovídajícími zásadami auditu v iniciativě. Pokud chcete získat další informace o zásadách konfigurace hostů, navštivte prosím.[https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0 – Preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordEnforce_Deploy.json) |
|[Nasaďte požadavky pro audit virtuálních počítačů s Windows, které nemají maximální stáří hesla 70 dnů.](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F356a906e-05e5-4625-8729-90771e0ee934) |Tato zásada vytvoří přiřazení konfigurace hosta pro audit virtuálních počítačů s Windows, které nemají maximální stáří hesla 70 dnů. Zároveň vytvoří spravovanou identitu přiřazenou systémem a nasadí rozšíření virtuálního počítače pro konfiguraci hosta. Tyto zásady by se měly používat jenom spolu s odpovídajícími zásadami auditu v iniciativě. Pokud chcete získat další informace o zásadách konfigurace hostů, navštivte prosím.[https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0 – Preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsMaximumPassword_Deploy.json) |
|[Nasazení požadavků pro audit virtuálních počítačů s Windows, které nemají minimální stáří hesla 1 den](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F16390df4-2f73-4b42-af13-c801066763df) |Tato zásada vytvoří přiřazení konfigurace hosta pro audit virtuálních počítačů s Windows, které nemají minimální stáří hesla 1 den. Zároveň vytvoří spravovanou identitu přiřazenou systémem a nasadí rozšíření virtuálního počítače pro konfiguraci hosta. Tyto zásady by se měly používat jenom spolu s odpovídajícími zásadami auditu v iniciativě. Pokud chcete získat další informace o zásadách konfigurace hostů, navštivte prosím.[https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0 – Preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsMinimumPassword_Deploy.json) |
|[Nasazení požadavků pro audit virtuálních počítačů s Windows, u kterých není povolené nastavení složitosti hesla](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F7ed40801-8a0f-4ceb-85c0-9fd25c1d61a8) |Tato zásada vytvoří přiřazení konfigurace hosta pro audit virtuálních počítačů s Windows, u kterých není povolené nastavení složitosti hesla. Zároveň vytvoří spravovanou identitu přiřazenou systémem a nasadí rozšíření virtuálního počítače pro konfiguraci hosta. Tyto zásady by se měly používat jenom spolu s odpovídajícími zásadami auditu v iniciativě. Pokud chcete získat další informace o zásadách konfigurace hostů, navštivte prosím.[https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0 – Preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordComplexity_Deploy.json) |
|[Nasaďte požadavky pro audit virtuálních počítačů s Windows, které neomezují minimální délku hesla na 14 znaků.](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F23020aa6-1135-4be2-bae2-149982b06eca) |Tato zásada vytvoří přiřazení konfigurace hosta pro audit virtuálních počítačů s Windows, které neomezují minimální délku hesla na 14 znaků. Zároveň vytvoří spravovanou identitu přiřazenou systémem a nasadí rozšíření virtuálního počítače pro konfiguraci hosta. Tyto zásady by se měly používat jenom spolu s odpovídajícími zásadami auditu v iniciativě. Pokud chcete získat další informace o zásadách konfigurace hostů, navštivte prosím.[https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0 – Preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordLength_Deploy.json) |
|[Nasazení požadavků pro audit virtuálních počítačů s Windows, které neukládají hesla pomocí reverzibilního šifrování](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F8ff0b18b-262e-4512-857a-48ad0aeb9a78) |Tato zásada vytvoří přiřazení konfigurace hosta pro audit virtuálních počítačů s Windows, které neukládají hesla pomocí reverzibilního šifrování. Zároveň vytvoří spravovanou identitu přiřazenou systémem a nasadí rozšíření virtuálního počítače pro konfiguraci hosta. Tyto zásady by se měly používat jenom spolu s odpovídajícími zásadami auditu v iniciativě. Pokud chcete získat další informace o zásadách konfigurace hostů, navštivte prosím.[https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0 – Preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordEncryption_Deploy.json) |
...
|[Zobrazit výsledky auditu z virtuálních počítačů s Windows, které umožňují opakované použití předchozích 24 hesel](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fcdbf72d9-ac9c-4026-8a3a-491a5ac59293) |Tyto zásady by se měly používat jenom spolu s odpovídajícími zásadami nasazení v iniciativě. Tato definice umožňuje Azure Policy zpracování výsledků auditování virtuálních počítačů s Windows, které umožňují opakované použití předchozích 24 hesel. Pokud chcete získat další informace o zásadách konfigurace hostů, navštivte prosím.[https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 – Preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordEnforce_Audit.json) |
|[Zobrazit výsledky auditu z virtuálních počítačů s Windows, které nemají maximální stáří hesla 70 dní](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F24dde96d-f0b1-425e-884f-4a1421e2dcdc) |Tyto zásady by se měly používat jenom spolu s odpovídajícími zásadami nasazení v iniciativě. Tato definice umožňuje Azure Policy zpracování výsledků auditování virtuálních počítačů s Windows, které nemají maximální stáří hesla 70 dnů. Pokud chcete získat další informace o zásadách konfigurace hostů, navštivte prosím.[https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 – Preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsMaximumPassword_Audit.json) |
|[Zobrazit výsledky auditu z virtuálních počítačů s Windows, které nemají minimální stáří hesla 1 den](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F5aa11bbc-5c76-4302-80e5-aba46a4282e7) |Tyto zásady by se měly používat jenom spolu s odpovídajícími zásadami nasazení v iniciativě. Tato definice umožňuje Azure Policy zpracování výsledků auditování virtuálních počítačů s Windows, které nemají minimální stáří hesla 1 den. Pokud chcete získat další informace o zásadách konfigurace hostů, navštivte prosím.[https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 – Preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsMinimumPassword_Audit.json) |
|[Zobrazit výsledky auditu z virtuálních počítačů s Windows, u kterých není povolené nastavení složitosti hesla](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Ff48b2913-1dc5-4834-8c72-ccc1dfd819bb) |Tyto zásady by se měly používat jenom spolu s odpovídajícími zásadami nasazení v iniciativě. Tato definice umožňuje Azure Policy zpracování výsledků auditování virtuálních počítačů s Windows, u kterých není povolené nastavení složitosti hesla. Pokud chcete získat další informace o zásadách konfigurace hostů, navštivte prosím.[https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 – Preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordComplexity_Audit.json) |
|[Zobrazit výsledky auditu z virtuálních počítačů s Windows, které neomezují minimální délku hesla na 14 znaků](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F5aebc8d1-020d-4037-89a0-02043a7524ec) |Tyto zásady by se měly používat jenom spolu s odpovídajícími zásadami nasazení v iniciativě. Tato definice umožňuje Azure Policy zpracování výsledků auditování virtuálních počítačů s Windows, které neomezují minimální délku hesla na 14 znaků. Pokud chcete získat další informace o zásadách konfigurace hostů, navštivte prosím.[https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 – Preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordLength_Audit.json) |
|[Zobrazit výsledky auditu z virtuálních počítačů s Windows, které neukládají hesla pomocí reverzibilního šifrování](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F2d60d3b7-aa10-454c-88a8-de39d99d17c6) |Tyto zásady by se měly používat jenom spolu s odpovídajícími zásadami nasazení v iniciativě. Tato definice umožňuje Azure Policy zpracování výsledků auditování virtuálních počítačů s Windows, které neukládají hesla pomocí reverzibilního šifrování. Pokud chcete získat další informace o zásadách konfigurace hostů, navštivte prosím.[https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 – Preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordEncryption_Audit.json) |
...
|[Nasazení požadavků pro audit webových serverů Windows, které nepoužívají zabezpečené komunikační protokoly](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fb2fc8f91-866d-4434-9089-5ebfe38d6fd8) |Tato zásada vytvoří přiřazení konfigurace hosta pro audit webových serverů Windows, které nepoužívají protokoly SSL (Secure Communication Protocol) (TLS 1,1 nebo TLS 1,2). Zároveň vytvoří spravovanou identitu přiřazenou systémem a nasadí rozšíření virtuálního počítače pro konfiguraci hosta. Tyto zásady by se měly používat jenom spolu s odpovídajícími zásadami auditu v iniciativě. Pokud chcete získat další informace o zásadách konfigurace hostů, navštivte prosím.[https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsTLS_Deploy.json) |

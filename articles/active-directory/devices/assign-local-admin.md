...
Počínaje **Windows 10 1709** vydání, můžete tuto úlohu lze provést z **Nastavení -> účty -> ostatní uživatelé** tak, že vyberete **přidat pracovní nebo školní uživatele**.

...
5. Na stránce **nastavit jednotné přihlašování pomocí SAML** v části **podpisový certifikát SAML** kliknutím na **Stáhnout** stáhněte **certifikát (Base64)** a **soubor federačních metadat** z daných možností dle vašeho požadavku a uložte ho do počítače.

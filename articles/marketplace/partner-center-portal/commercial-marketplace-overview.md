...
S přechodem do partnerského centra jsou kromě vylepšení uživatelského prostředí k dispozici nové funkce vydavatelům.  Podrobnosti najdete v tématu [Nejčastější dotazy k migraci z portál partnerů cloudu do partnerského centra](../cloud-partner-portal-migration-faq.md).
...
Další informace o nejnovějších a budoucích vydáních najdete v tématu [cestovní plán Microsoft komerčního tržiště](../marketplace-roadmap.md), nebo se připojte ke konverzaci v [komunitě partnerů Microsoftu](https://www.microsoftpartnercommunity.com/).

## <a name="next-steps"></a>Další kroky

- Noví partneři Microsoftu, kteří mají zájem o publikování nabídky na tržištích, najdete v tématu [Vytvoření účtu komerčního tržiště v partnerském centru](create-account.md).

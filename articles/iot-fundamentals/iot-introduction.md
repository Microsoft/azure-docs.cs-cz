...
Zařízení IoT se obvykle skládá z desky s plošnými spoji s připojenými senzory, které používají WiFi pro připojení k internetu. Například:

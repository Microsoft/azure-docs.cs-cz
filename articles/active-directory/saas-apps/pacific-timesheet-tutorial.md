...
2. **[Konfigurace jednotného přihlašování pro Tichomoří](#configure-pacific-timesheet-single-sign-on)** – pro konfiguraci nastavení jednotného přihlašování na straně aplikace
...
### <a name="configure-pacific-timesheet-single-sign-on"></a>Konfigurace jednotného přihlašování v časovém rozvrhu pro Tichomoří

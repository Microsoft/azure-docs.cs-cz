...
* Spusťte opakující se akce aplikace: můžete například pravidelně shromažďovat data z Twitteru do informačního kanálu.

* Každodenní Údržba: například vyřazení protokolů denně, provádění záloh a další úlohy údržby.

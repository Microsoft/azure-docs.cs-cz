...
* Seznamte [se s předem agregovanými metrikami založenými na protokolech](https://docs.microsoft.com/azure/azure-monitor/app/pre-aggregated-metrics-log-metrics).
* [Dotazy a definice metrik založené na protokolu](https://docs.microsoft.com/azure/azure-monitor/platform/app-insights-metrics)
...
Zabezpečení, kdy a jak se uživatelé registrují pro Multi-Factor Authentication služby Azure AD a Samoobslužné resetování hesla, je teď možné u uživatelských akcí v zásadách podmíněného přístupu. Tato funkce ve verzi Preview je dostupná pro organizace, u kterých je povolená [Kombinovaná registrace ve verzi Preview](../authentication/concept-registration-mfa-sspr-combined.md). Tato funkce může být povolená v organizacích, kde chtějí použít podmínky jako důvěryhodné síťové umístění k omezení přístupu k registraci pro Azure AD Multi-Factor Authentication a Samoobslužné resetování hesla (SSPR). Další informace o použitelných podmínkách najdete v článku [podmíněný přístup: podmínky](concept-conditional-access-conditions.md).

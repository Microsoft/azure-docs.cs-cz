...
* Okno **referenčních dat** Azure Portal se v Azure Time Series Insights Gen2 odebralo, protože koncept referenčních dat byl nahrazen [modelem Time Series model (TSM)](./time-series-insights-update-how-to-tsm.md).

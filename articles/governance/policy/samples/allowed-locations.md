...
description: Tato definice ukázkové zásady vyžaduje, aby všechny prostředky byly nasazené do schválených umístění definovaných v parametru.
ms.date: 01/26/2019
ms.topic: sample
...
V tomto příkladu parametru se povolí jenom umístění _eastus2_ nebo _westus_ .

...
3. **[Vytvoření zkušebního uživatele Trisotech digitální Enterprise Server](#create-a-trisotech-digital-enterprise-server-test-user)**  – Pokud chcete mít protějšek Britta Simon Trisotech digitální Enterprise serveru, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **Trisotech digitální Enterprise serveru domény a adresy URL** části, proveďte následující kroky:
...
6. V okně jiné webové prohlížeče Přihlaste se k serveru vaší společnosti Trisotech digitální podniková konfigurace serveru jako správce.

7. Klikněte na **ikonu nabídky** a pak vyberte **správu**.

    ![Konfigurace jednotného přihlašování](./media/trisotechdigitalenterpriseserver-tutorial/user1.png)

8. Vyberte **zprostředkovatel uživatele**.

    ![Konfigurace jednotného přihlašování](./media/trisotechdigitalenterpriseserver-tutorial/user2.png)

9. V **uživatele poskytovatele konfigurace** části, proveďte následující kroky:

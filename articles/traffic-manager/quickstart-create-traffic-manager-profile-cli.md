...
:::image type="content" source="./media/quickstart-create-traffic-manager-profile/environment-diagram.png" alt-text="Diagram prostředí nasazení Traffic Manager pomocí rozhraní příkazového řádku" border="false":::

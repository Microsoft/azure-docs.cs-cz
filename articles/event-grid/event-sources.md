...
Přihlášení k odběru událostí služby IoT Hub na zařízení se vytvořilo odstraněné, připojené, odpojené a telemetrie událostí.
...
Přihlásit k odběru služby Azure SignalR události pro reakci na události připojení klienta.

|Název | Popis |
|---------|---------|
| [Reagujte na události služby Azure SignalR s využitím služby Event Grid](../azure-signalr/signalr-concept-event-grid-integration.md) | Přehled integrace služby Azure SignalR pomocí služby Event Grid. |
| [Jak odesílat události služby Azure SignalR do služby Event Grid](../azure-signalr/signalr-howto-event-grid-integration.md) | Ukazuje, jak odesílat události služby Azure SignalR k aplikaci prostřednictvím služby Event Grid. |
| [Schéma událostí](event-schema-azure-signalr.md) | Zobrazí pole v událostech služby Azure SignalR. |

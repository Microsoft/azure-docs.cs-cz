...
> [!NOTE]
> Používáte-li povolit Application Insights Microsoft.ApplicationInsights.AspNetCore balíček, můžete upravit tento kód získat `TelemetryClient` přímo v konstruktoru. Příklad najdete v tématu [tyto Nejčastější dotazy](https://docs.microsoft.com/azure/azure-monitor/app/asp-net-core-no-visualstudio#frequently-asked-questions).

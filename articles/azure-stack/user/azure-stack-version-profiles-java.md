...
ID tenanta služby Azure Stack najdete v tématu pokynů [tady](../azure-stack-csp-ref-operations.md). Chcete-li nastavit proměnné prostředí, postupujte takto:
...
- Verze profilů v nástroji Azure Stack](azure-stack-version-profiles.md)

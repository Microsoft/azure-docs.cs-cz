...
ms.locfileid: "55985400"
---
## <a name="run-image-from-registry"></a>Spuštění image z registru

Teď můžete vyžádat a spustit `hello-world:v1` image kontejneru z registru kontejnerů pomocí [dockeru spustit][docker-run]:

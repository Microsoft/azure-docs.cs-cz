...
|diff_backup_size_bytes|Rozdílová velikost úložiště zálohování|B|Maximum|Kumulativní velikost úložiště rozdílové zálohy. Platí pro databáze Pro obecné účely a Pro důležité obchodní informace. V tuto chvíli se nepoužívá pro správu databází instancí.|Žádné dimenze|
...
|full_backup_size_bytes|Velikost úložiště pro úplné zálohování|B|Maximum|Celková velikost úložiště pro úplné zálohování Platí pro databáze Pro obecné účely a Pro důležité obchodní informace. V tuto chvíli se nepoužívá pro správu databází instancí.|Žádné dimenze|
...
|log_backup_size_bytes|Velikost úložiště zálohy protokolu|B|Maximum|Velikost úložiště pro zálohu kumulativního protokolu. Platí pro databáze Pro obecné účely a Pro důležité obchodní informace. V tuto chvíli se nepoužívá pro správu databází instancí.|Žádné dimenze|

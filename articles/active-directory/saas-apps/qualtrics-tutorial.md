...
3. **[Vytvoření zkušebního uživatele Qualtrics](#create-a-qualtrics-test-user)**  – Pokud chcete mít protějšek Britta Simon Qualtrics, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **Qualtrics domény a adresy URL** části, proveďte následující kroky:
...
6. Ke konfiguraci jednotného přihlašování na **Qualtrics** straně, je nutné odeslat na stažený **soubor XML s metadaty** k [tým podpory Qualtrics](https://www.qualtrics.com/support/). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

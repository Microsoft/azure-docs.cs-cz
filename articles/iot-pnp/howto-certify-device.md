...
- Všechny modely zařízení musí být kompatibilní s [Azure IoT Central](https://aka.ms/pnp-iotc-getstarted).

> [!NOTE]
> V současné době Azure IoT Central plně nepodporuje **pole** a **geoprostorové** DTDL datové typy.

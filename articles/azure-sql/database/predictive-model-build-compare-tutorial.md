---
title: 'Kurz: analýza a porovnání prediktivních modelů v jazyce R'
...
* Druhá část tohoto kurzu předpokládá, že jste dokončili [**část**](predictive-model-prepare-data-tutorial.md) a její požadavky.
...
![Porovnání dvou modelů](./media/predictive-model-build-compare-tutorial/compare-models.png)
...
> [Kurz: Nasazení prediktivního modelu v R s Azure SQL Database Machine Learning Services (Preview)](predictive-model-deploy-tutorial.md)

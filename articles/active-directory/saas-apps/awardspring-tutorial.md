...
Ke konfiguraci jednotného přihlašování na straně **AwardSpring** je potřeba odeslat stažený **soubor XML federačních metadat** a příslušné zkopírované adresy URL z Azure Portal do [týmu podpory AwardSpring](mailto:support@awardspring.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

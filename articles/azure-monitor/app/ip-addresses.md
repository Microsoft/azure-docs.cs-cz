...
| Účel | Identifikátor URI | IP adresa | Porty |
| --- | --- | --- | --- |
| CDN SDK pro Application Insights JS | az416426.vo.msecnd.net<br/>js.monitor.azure.com | dynamic | 80,443 |

## <a name="action-group-webhooks"></a>Webhooky skupiny akcí

Pomocí [příkazu PowerShellu Get-AzNetworkServiceTag](/powershell/module/az.network/Get-AzNetworkServiceTag)můžete zadat dotaz na seznam IP adres, které používají skupiny akcí.

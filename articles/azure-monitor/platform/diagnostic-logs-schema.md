...
| Name (Název) | Povinné/nepovinné | Popis |
|---|---|---|
...
|Microsoft. datacihly/pracovní prostory|jobs|Úlohy Databricks|
...
|Microsoft. DataFactory/továrny|Spuštění kanálu|Protokol spuštění kanálu|

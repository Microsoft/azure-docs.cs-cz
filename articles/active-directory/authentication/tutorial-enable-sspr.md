...
1. Chcete-li zobrazit proces Ruční registrace, otevřete nové okno prohlížeče v režimu InPrivate nebo anonymním a vyhledejte [https://aka.ms/ssprsetup](https://aka.ms/ssprsetup). Uživatelé by měli být přesměrováni na tento registrační portál při příštím přihlášení.
...
1. Otevřete nové okno prohlížeče v režimu InPrivate nebo anonymním režimu a přejděte na adresu [https://aka.ms/sspr](https://aka.ms/sspr).
...
> [Povolit Azure Multi-Factor Authentication](tutorial-mfa-applications.md)

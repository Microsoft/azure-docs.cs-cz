...
3. Vytvořit standardní Application Gateway (volitelně povolit WAF):  Na domovské stránce Azure Portal klikněte na **prostředky** > **síť** > **Application Gateway** v levém horním rohu stránky. Vyberte standardní SKU a velikost a zadejte předplatné Azure, informace o skupině prostředků a umístění. V případě potřeby vytvořte novou veřejnou IP adresu pro tuto aplikační bránu a zadejte podrobnosti o virtuální síti a vyhrazené podsíti pro aplikační bránu.

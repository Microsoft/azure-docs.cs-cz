...
Prvním krokem je, abyste se ujistili, že máte projekt otevřený v oblíbeném editoru.

Zavolejte soubor index. js.
...
Jak REST API přijímá požadavky ve formátu JSON a také vrátí výsledky ve formátu JSON.
Abychom lépe pochopili žádosti a odpovědi, deklarujeme několik tříd, které se použijí pro serializaci nebo deserializaci formátu JSON.
...
## <a name="create-an-initial-transcription-request"></a>Vytvoří úvodní žádost o přepis.
Dále vygenerujeme žádost o přepis.
...
## <a name="send-the-transcription-request"></a>Odešlete žádost o přepis.
...
Pak zavoláme metodu `CheckTranscriptionStatus` , která zkontroluje stav a nakonec vypíše výsledky. Budeme implementovat `CheckTranscriptionStatus` Další.
...
## <a name="check-the-requests-status"></a>Zkontroluje stav požadavků.
...
**Spusťte aplikaci** -spusťte index. js uzlu.

...
![hub a paprskový](./media/migrate-from-hub-spoke-topology/hub-spoke.png)
...
![stávající topologii sítě společnosti Contoso](./media/migrate-from-hub-spoke-topology/contoso-pre-migration.png)
...
## <a name="architecture"></a>Architektura Azure Virtual WAN
...
![ovou architekturu contoso Virtual WAN](./media/migrate-from-hub-spoke-topology/vwan-architecture.png)
...
topologie ![s jednou oblastí](./media/migrate-from-hub-spoke-topology/figure1.png)
**Obrázek 1: rozbočovač VDC a jedna oblast paprsků**
...
![nasazení virtuálních rozbočovačů sítě WAN](./media/migrate-from-hub-spoke-topology/figure2.png)
**Obrázek 2: VDC hub a hvězdicové na migraci virtuální sítě WAN**
...
**Obrázek 3: VDC hub-and-The Virtual WAN Migration**
...
**Obrázek 4: VDC hub-and-hvězdicové migrace do virtuální sítě WAN**

### <a name="step-5-transition-connectivity-to-virtual-wan-hub"></a>Krok 5: přechod k virtuálnímu centru WAN

![přechodem připojení k virtuální síti WAN](./media/migrate-from-hub-spoke-topology/figure5.png)
**Obrázek 5: migrace rozbočovače a VDC do virtuální sítě WAN**
...
![starého rozbočovače se stávají Shared Services – paprskový](./media/migrate-from-hub-spoke-topology/figure6.png)
**Obrázek 6: VDC hub – střed a migrace do virtuální sítě WAN**

Vzhledem k tomu, že virtuální síť WAN je spravovaná entita a neumožňuje nasazení vlastních prostředků, jako jsou virtuální počítače, blokuje služba Shared Services jako virtuální síť paprsků a hostuje funkce jako například internetové příchozí přenosy přes Azure Application Gateway nebo síťové virtualizované zařízení. Přenos dat mezi prostředím sdílených služeb a back-end virtuálními počítači teď projíždějí virtuálním centrem spravovanému přes síť WAN.
...
![optimalizuje místní připojení, aby bylo možné plně využívat virtuální síť WAN](./media/migrate-from-hub-spoke-topology/figure7.png)
**Obrázek 7: VDC hub-and-hvězdicové migrace virtuální sítě WAN**
...
![architektury koncových stavů a cest provozu](./media/migrate-from-hub-spoke-topology/figure8.png)
**obrázek: virtuální síť WAN ve duální oblasti**
...
![zabezpečení a řízení zásad přes Azure Firewall](./media/migrate-from-hub-spoke-topology/security-policy.png)

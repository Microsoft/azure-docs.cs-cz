...
1. Zadejte **název** klíče zásad. Například, `AADAppSecret`.  @No__t_0 předpony se automaticky přidají do názvu klíče při jeho vytvoření, takže jeho odkaz v XML v následující části se *B2C_1A_AADAppSecret*.

...
1. Začněte od prázdného dotazu nebo všech dostupných existujících dotazů.
   ...
   * Chcete-li ověřit, zda jsou k dispozici nějaké existující dotazy, vyberte na panelu nástrojů dotazu buď **Ukázky dotazů** > **historii**, které zobrazují dotazy z předchozích dotazů, nebo vyberte **Průzkumník dotazů**, který zobrazuje předem sestavené dotazy.
   ...
   * Chcete-li začít z prázdného dotazu, spusťte v editoru dotazů zadání [dotazovacího jazyka Kusto](../azure-monitor/log-query/query-language.md) pro váš dotaz.

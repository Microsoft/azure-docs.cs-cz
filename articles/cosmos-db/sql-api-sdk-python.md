...
|**Dokumentace k rozhraní API**|[Referenční dokumentace rozhraní Python API](https://docs.microsoft.com/python/api/azure-cosmos/?view=azure-python)|

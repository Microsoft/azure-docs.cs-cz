...
<tr><td>**Dokumentaci k rozhraní API**</td><td>[Referenční dokumentace rozhraní API jazyka Python](https://docs.microsoft.com/python/api/pydocumentdb?view=azure-python)</td></tr>

...
Když na přístupovém panelu kliknete na dlaždici Zoho One Čína, měli byste se automaticky přihlásit k Zoho jedné Číně, pro kterou jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).
...
- [Jak chránit Zoho jednu Čínu pomocí pokročilých viditelností a ovládacích prvků](/cloud-app-security/proxy-intro-aad)
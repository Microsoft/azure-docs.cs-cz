...
## <a name="enable-tls-12-in-net-client"></a>Povolit TLS 1,2 v klientovi .NET
...
## <a name="enable-tls-12-in-powershell-client"></a>Povolit TLS 1,2 v klientovi PowerShellu

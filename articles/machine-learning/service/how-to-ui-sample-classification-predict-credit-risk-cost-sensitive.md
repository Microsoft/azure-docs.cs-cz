...
Dále vygenerujte školicí a testovací sady použité pro vývoj modelu předpovědi rizik. Rozdělte původní datovou sadu do školicích a testovacích sad se stejnou velikostí pomocí modulu **rozdělit data** . Chcete-li vytvořit sady se stejnou velikostí, nastavte **zlomky řádků v první výstupní sadě dat** na 0,5.

...
Rychlý Start poskytuje obecné informace o tom, jak [zaregistrovat aplikaci s platformou Microsoft Identity](../../active-directory/develop/quickstart-register-app.md).
...
Konfigurace vaší [desktopové](../../active-directory/develop/scenario-desktop-app-registration.md), [mobilní](../../active-directory/develop/scenario-mobile-app-registration.md) nebo [jednostránkové](../../active-directory/develop/scenario-spa-app-registration.md) aplikace jako veřejné aplikace:

...
> [!IMPORTANT] 
> Než spustíte test, ujistěte se, že Pacemaker nemá žádné nezdařené akce (stav crm) a neexistují žádná omezení umístění (zbývajícími testovací migrace) a funguje synchronizace IBM Db2 HADR. Obraťte se na s uživatele db2\<sid > <pre><code>db2pd -hadr -db \<DBSID></code></pre>

---
title: Konfigurace jednotného přihlašování založeného na SAML (SSO) pro aplikace ve službě Azure AD
description: Konfigurace jednotného přihlašování založeného na SAML (SSO) pro aplikace ve službě Azure AD

---
title: 'Rychlý start: Přeložit text – Translator Text'
titleSuffix: Azure Cognitive Services
description: V tomto rychlém startu se naučíte překládat text z jednoho jazyka do druhého pomocí Translator Text API.

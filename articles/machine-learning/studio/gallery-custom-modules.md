---
Název: Azure AI Galerie vlastních modulů titleSuffix: Azure Machine Learning Studio Popis: Zjištění modulů služby vlastní machine learning v galerii Azure AI. Vlastní moduly rozšířili schopnosti nástroje Azure Machine Learning Studio.
Services: machine learningu ms.service: ms.component strojového učení: studio ms.topic: článku

Autor: ericlicoding ms.author: amlstudiodocs ms.custom: seodec18 ms.date: 04/14/2017
---

...
+ Na webu:
    ...
    + [Návrhář Azure Machine Learning](concept-designer.md) – k dispozici pouze v pracovních prostorech [Enterprise Edition](overview-what-is-azure-ml.md#sku) .

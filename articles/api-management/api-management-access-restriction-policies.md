...
| prodloužení platnosti – období | Délka v sekundách posuvných oken, během kterých počet povolených požadavků nesmí ani překročil hodnotu určenou v poli `calls` .                                              | Yes      | –     |
...
| prodloužení platnosti – období | Časové období v sekundách, po kterém se kvóta resetuje. Pokud je nastavená na `0` perioda, nastaví se na nekonečné. | Yes                                                              | –     |

...
| --- | --- | --- |
| Bezpečnostní tým | Přispěvatel Key Vaultu | Klíče: zálohovat (backup), vytvořit (create), odstranit (delete), získat (get), importovat (import), vypsat (list), obnovit (restore)<br>Tajnými klíči: všechny operace |

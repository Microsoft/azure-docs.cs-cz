...
Následující příklad používá ke konfiguraci licence [sadu Media Services .NET SDK](https://docs.microsoft.com/dotnet/api/microsoft.azure.management.media.models?view=azure-dotnet) .

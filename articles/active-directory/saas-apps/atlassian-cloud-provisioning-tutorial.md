...
4. Do vyhledávacího pole zadejte **Cloud od společnosti Atlassian**vyberte **Cloud od společnosti Atlassian** panel výsledků a pak klikněte na **přidat** tlačítko pro přidání aplikace.
...
1. Přihlaste se k [webu Azure portal](https://portal.azure.com) a vyberte **podnikové aplikace**vyberte **všechny aplikace**a pak vyberte **Cloud od společnosti Atlassian**.

    ![Okno aplikace organizace](common/enterprise-applications.png)

2. V seznamu aplikací vyberte **Cloud od společnosti Atlassian**.

...
Žádosti Webhooku zahrnují `Content-Type` `application/json`, pokud jste nezadali `Content-Type` vlastní hlavičku Webhooku.
...
|`size`|Datový typ Int32|Počet bajtů obsahu. Stejné jako pole length.|
|`digest`|Řetězec|Výtah obsahu definovaný specifikací registru v2 HTTP API.|
|`length`|Datový typ Int32|Počet bajtů obsahu. Stejné jako velikost pole.|
...
|------------------|----------|-----------|
|`mediaType`|Řetězec|Typ MIME odkazovaného objektu|
|`size`|Datový typ Int32|Počet bajtů obsahu.|
|`digest`|Řetězec|Výtah obsahu definovaný specifikací registru v2 HTTP API.|
|`repository`|Řetězec|Název úložiště|

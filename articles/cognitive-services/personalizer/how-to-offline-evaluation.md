...
1. Nakonfigurujte následující hodnoty:
    ...
    * Název vyhodnocení
    * Počáteční a koncové datum – jedná se o kalendářní data v minulosti, která určují rozsah dat, která se mají použít při vyhodnocování. Tato data musí být k dispozici v protokolech, jak je uvedeno v hodnotě [uchovávání dat](how-to-settings.md) .

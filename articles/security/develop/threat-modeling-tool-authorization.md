...
| **Reference**              | [Zabezpečení SQL Server Row-Level (RLS)](https://msdn.microsoft.com/library/azure/dn765131.aspx) |
...
| **Použitelné technologie** | Obecné |
| **Atributy**              | Není k dispozici  |
| **Reference**              | [Jak zabezpečit svůj účet úložiště pomocí Role-Based Access Control (RBAC)](https://azure.microsoft.com/documentation/articles/storage-security-guide/#management-plane-security) |

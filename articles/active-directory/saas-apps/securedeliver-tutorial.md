...
2. **[Nakonfigurujte jednotné přihlašování pro zabezpečené doručování](#configure-secure-deliver-single-sign-on)** – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
...
### <a name="configure-secure-deliver-single-sign-on"></a>Konfigurace jednotného přihlašování pro zabezpečené DORUČOVÁNí

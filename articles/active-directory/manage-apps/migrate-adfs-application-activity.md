...
|Test – ADFSRPDelegationAuthorizationRules      | Úspěch/neúspěch          | Aplikace má definované vlastní autorizační pravidla delegování. Jedná se o koncept WS-Trust, který Azure AD podporuje pomocí moderních ověřovacích protokolů, jako je OpenID Connect a OAuth 2,0. [Přečtěte si další informace o platformě Microsoft Identity](https://docs.microsoft.com/azure/active-directory/develop/v2-protocols-oidc).          |

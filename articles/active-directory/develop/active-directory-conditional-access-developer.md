...
Znalost [jeden](quickstart-v1-integrate-apps-with-azure-ad.md) a [víceklientské](active-directory-devhowto-multi-tenant-overview.md) aplikace a [běžné vzory ověřování](authentication-scenarios.md) se předpokládá, že.
...
![Aplikace přístup k Microsoft Graphu vývojový diagram](media/active-directory-conditional-access-developer/app-accessing-microsoft-graph-scenario.png)
...
![Aplikace provádí vývojový diagram on-behalf-of](media/active-directory-conditional-access-developer/app-performing-on-behalf-of-scenario.png)
...
![Aplikace přístup k více službám vývojový diagram](media/active-directory-conditional-access-developer/app-accessing-multiple-services-scenario.png)
...
![Aplikace přístup k více službám požaduje nový token](media/active-directory-conditional-access-developer/app-accessing-multiple-services-new-token.png)
...
![Jednostránkové aplikace pomocí knihovny ADAL vývojový diagram](media/active-directory-conditional-access-developer/spa-using-adal-scenario.png)
...
* Další informace o scénářích s více tenanty najdete v tématu [jak přihlásit uživatele pomocí vzoru více tenantů](active-directory-devhowto-multi-tenant-overview.md).

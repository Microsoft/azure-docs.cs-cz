...
- S cílovými IP adresami, které už jsou v platnosti před převzetím služeb při selhání, může společnost A orchestrovat převzetíslužeb při **selhání a automaticky** navazovat připojení po převzetí služeb při selhání To je znázorněno v následujícím diagramu...
...
- Sekundární (cílová) oblast je Azure jihovýchodní Asie – jihovýchodní Asie má virtuální sítě obnovení (**virtuální síť pro obnovení 1** a **virtuální síť pro obnovení**), která je shodná se **zdrojovou virtuální sítí 1** a **zdrojovou virtuální sítí 2**.
        - **Recovery VNet 1** a **virtuální síť pro obnovení 2** mají dvě podsítě, které odpovídají podsítím ve **zdrojové virtuální síti 1** a **zdrojové virtuální** síti. 2 – jihovýchodní Asie má další virtuální síť (**virtuální síť Azure**) s adresním prostorem 10.3.0.0/16.
...
- S cílovými IP adresami, které už jsou v platnosti před převzetím služeb při selhání, může společnost B orchestrovat převzetíslužeb při **selhání a automaticky** navazovat připojení po převzetí služeb při selhání

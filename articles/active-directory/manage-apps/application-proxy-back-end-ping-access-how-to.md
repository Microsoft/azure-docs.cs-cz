...
Podrobnosti o každé z těchto kroků najdete v našich [jednotné přihlašování s dokumentací záhlaví](application-proxy-configure-single-sign-on-with-ping-access.md).

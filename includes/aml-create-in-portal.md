...
1. V levém horním rohu Azure Portal vyberte **+ vytvořit prostředek**.
    ...
    ![Snímek obrazovky, který ukazuje možnost vytvořit prostředek.](media/aml-create-in-portal/create-workspace.gif)
...
1. Zadáním následujících informací nakonfigurujte nový pracovní prostor:
   ...
   Edice pracovního prostoru | Jako typ pracovního prostoru pro tento kurz vyberte **Basic** . Typ pracovního prostoru určuje funkce, ke kterým budete mít přístup a ceny. Všechno v tomto kurzu se dá udělat buď s podnikovým pracovním prostorem Basic nebo Enterprise.

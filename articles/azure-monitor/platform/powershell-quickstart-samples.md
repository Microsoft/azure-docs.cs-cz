...
| MetricName výstrahy, která je vytvořena |\PhysicalDisk (využití _celkem) \Disk zápisů za sekundu. See the `Get-MetricDefinitions` cmdlet about how to retrieve the exact metric names |

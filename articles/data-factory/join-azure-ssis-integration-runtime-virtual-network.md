...
Pokud je katalog služby SSIS hostovaná v Azure SQL Database pomocí virtuální sítě služby koncových bodů nebo spravované Instance (Preview), můžete připojit vaše Azure SSIS Reakcí na:
...
Virtuální sítě můžou být nasazené prostřednictvím modelu nasazení classic nebo modelu nasazení Azure Resource Manager. Pokud máte v úmyslu připojit vaše Azure SSIS Reakcí na *stejné virtuální síti* , je již připojena spravované instance (Preview), zajistěte, aby byl váš IR Azure SSIS v *jiné podsíti* z používaný pro spravované Instance (Preview).   
...
8. Teď můžete spustit IR pomocí **spustit** tlačítka na **akce** sloupec pro vaši Azure SSIS infračerveného signálu. Jak dlouho trvá přibližně 20-30 minut před spuštěním Azure SSIS infračerveného signálu. 

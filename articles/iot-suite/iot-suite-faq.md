...
Viz také [– nejčastější dotazy připojené konkrétní objekt pro vytváření](iot-suite-faq-cf.md) a [nejčastější dotazy týkající se vzdáleného monitorování specifické pro](iot-suite-faq-rm-v2.md) .

...
Pokud chcete získat data o počasí, ujistěte se, že máte [nainstalovanou FarmBeats](./install-azure-farmbeats.md). Integrace počasí je podporovaná ve verzích 1.2.11 a vyšších. 

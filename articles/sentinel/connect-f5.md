...
Musíte nasadit agenta na vyhrazený počítač se systémem Linux (virtuální počítač nebo místní) pro podporu komunikace mezi F5 a Azure Sentinel. Následující diagram popisuje nastavení v případě virtuálního počítače se systémem Linux v Azure.
...
## <a name="step-2-configure-your-f5-to-send-cef-messages"></a>Krok 2: Konfigurace F5 pro posílání zpráv CEF

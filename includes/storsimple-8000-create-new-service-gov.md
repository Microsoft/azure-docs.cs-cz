...
1. K přihlášení na portál Microsoft Azure Government Portal použijte přihlašovací údaje k účtu [Microsoft.](https://portal.azure.us/)
2. Na portálu pro **+** státní správu klikněte na a potom na trhu klikněte na **Zobrazit vše**. Vyhledejte _Fyzické zařízení StorSimple_. Vyberte a klikněte na **Řada fyzických zařízení StorSimple** a pak klikněte na **Vytvořit**. Případně na portálu pro **+** státní správu klikněte a potom v části **Úložiště**klikněte na **StorSimple Physical Device Series**.
3. V okně **Správce zařízení StorSimple** proveďte následující kroky:
   ...
   4. Zadejte **Umístění** služby. Umístění označuje zeměpisnou oblast, ve které chcete zařízení nasadit. Vyberte **USGov Iowa** nebo **USGov Virginia**.

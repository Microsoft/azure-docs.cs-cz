...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/bpmonline-tutorial/tutorial_bpmonline_samlbase.png)
...
3. Na **Bpm'online domény a adresy URL** část, proveďte následující kroky, pokud chcete nakonfigurovat aplikace **IDP** iniciované režimu:
    ...
    ![Bpm'online domény a adresy URL jednotné přihlašování informace](./media/bpmonline-tutorial/tutorial_bpmonline_url.png)
...
4. Zkontrolujte **zobrazit upřesňující nastavení adresy URL** a provést následující krok, pokud chcete nakonfigurovat aplikace **SP** iniciované režimu:
    ...
    ![Bpm'online domény a adresy URL jednotné přihlašování informace](./media/bpmonline-tutorial/tutorial_bpmonline_url1.png)
...
5. Na **SAML podpisový certifikát** části, klikněte na tlačítko Kopírovat kopírování **adresu Url aplikace federační Metadata** a vložte do poznámkového bloku.
    ...
    ![Konfigurovat jednotné přihlašování](./media/bpmonline-tutorial/tutorial_metadataurl.png)
     
6. Klikněte na tlačítko **Uložit** tlačítko.

    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/bpmonline-tutorial/tutorial_general_400.png)
    
7. Konfigurace jednotného přihlašování na **Bpm'online** straně, budete muset odeslat **adresu Url aplikace federační Metadata** k [tým podpory Bpm'online](mailto:support@bpmonline.com). Nastavují toto nastavení tak, aby měl jednotné přihlašování SAML připojení správně nastavena na obou stranách.
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/bpmonline-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **Bpm'online**.
    ...
    ![V seznamu aplikací na Bpm'online odkaz](./media/bpmonline-tutorial/tutorial_bpmonline_app.png)  

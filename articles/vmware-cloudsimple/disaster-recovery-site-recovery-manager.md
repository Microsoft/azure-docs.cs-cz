...
2. Vytvořte uživatele v privátním cloudu pro replikaci vSphere a instalaci SRM. V uživatelském rozhraní vCenter je vysvětleno níže [: vytvoření uživatele v privátním cloudu pro instalaci vRA &AMP; SRM](#vcenter-ui-create-a-user-in-private-cloud-for-vra-and-srm-installation).

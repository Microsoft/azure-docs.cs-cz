...
|[Přidejte javascriptový fragment kódu do webových stránek](../../azure-monitor/app/javascript.md)|[Stránka výkonu](../../azure-monitor/app/usage-overview.md), výjimky prohlížeče, výkonu aplikace AJAX. Vlastní telemetrii na straně klienta.|
...
|[Zajištění buildinfo.config](https://msdn.microsoft.com/library/dn449058.aspx) vygenerované nástrojem MSBuild|[Vytváření poznámek v grafy metrik](https://docs.microsoft.com/azure/azure-monitor/app/annotations)

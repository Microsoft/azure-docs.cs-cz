...
- *Jediná architektura:* &nbsp; každá databáze uchovává data jenom z jednoho tenanta.
- *Multi-tenancy:*&nbsp; Víceklientská architektura: Každá databáze uchovává data z několika samostatných klientů (s mechanismy ochrany ochrany osobních údajů).
...
- **Izolace klientů:** &nbsp; izolace a výkon dat (ať už jeden z úloh tenanta má vliv na ostatní).
...
- **Vlastní:** &nbsp; Snadná Podpora přizpůsobení schématu, která je specifická pro konkrétního tenanta nebo pro třídu tenanta.

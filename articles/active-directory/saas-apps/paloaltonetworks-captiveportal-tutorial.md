...
4. Do vyhledávacího pole zadejte **Palo Alto Networks - další zpracování portál**, vyberte **Palo Alto Networks - další zpracování portál** z panelu výsledků klikněte **přidat** tlačítko Přidat aplikaci .
    ...
    ![Palo Alto sítě - další zpracování portálu v seznamu výsledků](./media/paloaltonetworks-captiveportal-tutorial/tutorial_paloaltocaptiveportal_addfromgallery.png)
...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/paloaltonetworks-captiveportal-tutorial/tutorial_paloaltocaptiveportal_samlbase.png)

3. Na **Palo Alto sítě - další zpracování portál domény a adresy URL** část, proveďte následující kroky:

    ![Palo Alto sítě - další zpracování portál domény a adresy URL jeden přihlašování informace](./media/paloaltonetworks-captiveportal-tutorial/tutorial_paloaltocaptiveportal_url.png)
...
5. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/paloaltonetworks-captiveportal-tutorial/tutorial_general_400.png)

6. Otevřete web Palo Alto jako správce v jiném okně prohlížeče.

7. Klikněte na **zařízení**.

    ![Konfigurace Palo Alto jednotné přihlašování](./media/paloaltonetworks-captiveportal-tutorial/tutorial_paloaltoadmin_admin1.png)

8. Vyberte **poskytovatele Identity SAML** z levém navigačním panelu a klikněte na tlačítko "Import" k importu souboru metadat.

    ![Konfigurace Palo Alto jednotné přihlašování](./media/paloaltonetworks-captiveportal-tutorial/tutorial_paloaltoadmin_admin2.png)

9. Proveďte následující akce v okně Import

    ![Konfigurace Palo Alto jednotné přihlašování](./media/paloaltonetworks-captiveportal-tutorial/tutorial_paloaltoadmin_admin3.png)
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/paloaltonetworks-captiveportal-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **Palo Alto Networks - další zpracování portál**.
    ...
    ![Sítě Palo Alto - další zpracování portál odkaz v seznamu aplikací](./media/paloaltonetworks-captiveportal-tutorial/tutorial_paloaltocaptiveportal_app.png)  

...
|Automatizované zálohování online|Databáze Azure Cosmos se pravidelně zálohují a ukládají se v geograficky redundantním úložišti. <br><br>Další informace najdete v [automatické online zálohování a obnovení pomocí služby Azure Cosmos DB](online-backup-and-restore.md).|
...
|Šifrování protokolu HTTPS a SSL/TLS|Všechny interakce klienta služby Azure Cosmos DB jsou schopné SSL/TLS 1.2. Veškerá replikace v rámci Datacenter a mezi datovými centry je také vynutila SSL/TLS 1,2.|
...
|Zabezpečení a data protection certifikace| Nejaktuálnější seznam certifikací najdete na celkovém [webu dodržování předpisů Azure](https://www.microsoft.com/en-us/trustcenter/compliance/complianceofferings) a v nejnovějším [dokumentu o dodržování předpisů Azure](https://gallery.technet.microsoft.com/Overview-of-Azure-c1be3942) všemi certifikacemi (vyhledejte Cosmos). Podrobnější informace najdete v 25. dubna 2018 příspěvku [Azure #CosmosDB: Zabezpečená, soukromá a kompatibilní, která zahrnuje SOC 1/2 Type 2, HITRUST, PCI DSS úrovně 1, ISO 27001, HIPAA, FedRAMP High a spousta dalších.

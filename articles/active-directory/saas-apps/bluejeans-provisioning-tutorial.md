...
> [!TIP]
> Můžete také povolit na základě SAML jednotné přihlašování pro BlueJeans, postupujte podle pokynů uvedených v [BlueJeans jeden přihlašování kurzu](bluejeans-tutorial.md). Jednotné přihlašování se dá nakonfigurovat nezávisle na uživatele automatické zřizování, i když tyto dvě funkce doplnění navzájem.

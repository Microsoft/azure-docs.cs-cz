...
| [az cosmosdb list-keys](https://docs.microsoft.com/cli/azure/cosmosdb#az-cosmosdb-list-keys) | Vytvoří logický server, který je hostitelem služby SQL Database. |

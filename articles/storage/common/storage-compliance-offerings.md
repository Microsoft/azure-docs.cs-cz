---
title: Nabídky dodržování předpisů Azure Storage | Microsoft Docs
description: Přečtěte si souhrn nabídek dodržování předpisů v Azure Storage pro národní, regionální a specifické požadavky na konkrétní odvětví pro účely shromažďování a používání dat.
services: storage
author: fhryo-msft
ms.service: storage
ms.topic: conceptual
...
* [CSA – STAR – ověření identity](https://www.microsoft.com/trustcenter/compliance/csa-star-attestation)
* [CSA-hvězda-certifikace](https://www.microsoft.com/trustcenter/compliance/csa-star-certification)
* [CSA-STAR – samo-Assessment](https://www.microsoft.com/trustcenter/compliance/csa-self-assessment)
...
* [Velká Británie – G-Cloud](https://www.microsoft.com/trustcenter/compliance/uk-g-cloud)

## <a name="next-steps"></a>Další kroky

Microsoft Azure & Azure Storage zůstat v nabídkách dodržování předpisů, najdete nejnovější pokrytí a podrobnosti v [Microsoft TrustCenter](https://www.microsoft.com/TrustCenter/Compliance/default.aspx).

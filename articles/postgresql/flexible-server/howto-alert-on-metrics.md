...
* Přečtěte si další informace o [konfiguraci webhooků v upozorněních](https://docs.microsoft.com/azure/azure-monitor/platform/alerts-webhooks).
* Získejte [Přehled o kolekci metrik](https://docs.microsoft.com/azure/monitoring-and-diagnostics/insights-how-to-customize-monitoring) , abyste měli jistotu, že je vaše služba dostupná a reaguje.

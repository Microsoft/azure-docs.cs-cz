...
| API  | Rozhraní REST API přes protokol HTTPS | Rozhraní REST API přes HTTP/HTTPS| *Teď k dispozici* |
...
| Klienta systému souborů Hadoop | Ano ([Azure Data Lake Storage](https://hadoop.apache.org/docs/current/hadoop-azure-datalake/index.html)) | Ano ([ABFS](https://jira.apache.org/jira/browse/HADOOP-15407))  | *Teď k dispozici*  |  
...
| Operace s daty – protokoly  | Ano | Ano | *Nyní k dispozici* (Preview). Podívejte se na [známé problémy](data-lake-storage-known-issues.md).<br><br> Integrace monitorování Azure – *zatím není k dispozici* |
...
| Sady SDK pro vývojáře | .NET, Java, Python, Node.js  | .NET, Java, Python, Node.js, C++, Ruby, PHP, Go, Android, iOS| Sada BLOB SDK – *nyní je k dispozici*. [Sada Azure Data Lake Storage Gen2 SDK](https://azure.microsoft.com/blog/extended-filesystem-programming-capabilities-in-azure-data-lake-storage/)- *nyní dostupná – .NET, Java, Python (Public Preview)*  |
...
| Dostupnost podle oblastí | Zobrazit [zde](https://azure.microsoft.com/regions/) | Všechny [oblastí Azure](https://azure.microsoft.com/global-infrastructure/regions/)                                                                                                                                                                                                                                                                                                                                       | *Teď k dispozici*                                                                                                                           |
...
| Správa dat                             | Vypršení platnosti souboru                                                                                                                                        | Zásady životního cyklu                                                                                                                                                                                                                                                                                                                                                                                                          | Zásady životního cyklu *dostupné teď* (Preview). Podívejte se na [známé problémy](data-lake-storage-known-issues.md).                                                                                                                     |
...
|----------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| .NET SDK                  | [Odkaz](https://docs.microsoft.com/dotnet/api/overview/azure/datalakestore/management?view=azure-dotnet) | *Teď k dispozici* | *Teď k dispozici* |
| Java SDK                | [Odkaz](https://docs.microsoft.com/java/api/overview/azure/datalakestore/management)                                                                                                                                                                                                                                     | *Teď k dispozici*                                                      | *Teď k dispozici*                                     |
| Node.js                | [Odkaz](https://www.npmjs.com/package/azure-arm-datalake-store)                                                                                                                                                                                                                                                                | *Teď k dispozici*                                                     | *Teď k dispozici*                                                                                           |
| Python SDK                   | [Odkaz](https://docs.microsoft.com/python/api/overview/azure/datalakestore/management?view=azure-python)                                                                                                                                                                                                                 | *Teď k dispozici*                                                      | *Teď k dispozici*                                        |
| Rozhraní REST API                 | [Odkaz](https://docs.microsoft.com/rest/api/datalakestore/accounts)                                                                                                                                                                                                                                                      | *Teď k dispozici*                                                      | *Teď k dispozici*                                                                                                                                               |
| PowerShell | [Odkaz](https://docs.microsoft.com/powershell/module/az.datalakestore)                                                                                                                                                                                                                        | *Teď k dispozici* |
| Rozhraní příkazového řádku                 | [Odkaz](https://docs.microsoft.com/cli/azure/dls/account?view=azure-cli-latest)                                                                                                                                                                                                                                          | *Teď k dispozici*                                                      | *Teď k dispozici*                                                               |
| Šablony Azure Resource Manageru – Správa             | [Template1](https://azure.microsoft.com/resources/templates/101-data-lake-store-no-encryption/)  [Template2](https://azure.microsoft.com/resources/templates/101-data-lake-store-encryption-adls/)  [Template3](https://azure.microsoft.com/resources/templates/101-data-lake-store-encryption-key-vault/)  | *Teď k dispozici*                                                      | *Teď k dispozici*                                          |
...
|                      | [Služba SSIS (SQL Server Integration Services)](https://docs.microsoft.com/sql/integration-services/connection-manager/azure-data-lake-store-connection-manager?view=sql-server-2017) | *Teď k dispozici*                                                                                                                                                          | *Teď k dispozici*                                                                                                                             |
...
|                      | [Logic Apps](https://docs.microsoft.com/connectors/azuredatalake/)                                                                                                      | *Teď k dispozici*                                                                                                                                                          | *Teď k dispozici*                                                                                                                             |
| IoT                  | [Event Hubs – zachytávání](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-archive-eventhub-capture)                                                       | *Teď k dispozici*                                                                                                                                                          | *Teď k dispozici*                                                                                                                             |
|                      | [Stream Analytics](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-stream-analytics)                                                                   | *Teď k dispozici*                                                                                                                                                          | *Teď k dispozici*                                                                                                                             |
| Využití          | [Power BI Desktop](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-power-bi)                                                                           | *Teď k dispozici*                                                                                                                                                          | *Teď k dispozici*                                                                                                                             |
...
|---------------------|--------------|----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|
| Analytics framework | Cloudera     | CDH –                  | [Odkaz](https://www.cloudera.com/documentation/enterprise/5-11-x/topics/admin_adls_config.html)                                                                                            | *Zatím není k dispozici*                                                                                                  | [Odkaz](https://www.cloudera.com/documentation/enterprise/latest/topics/admin_adls2_config.html)                                                                                                  |
...
|                     | Qubole       |                      | [Odkaz](https://www.qubole.com/blog/big-data-analytics-microsoft-azure-data-lake-store-qubole/)                                                                                            | [Odkaz](https://docs.qubole.com/en/latest/quick-start-guide/Azure-quick-start-guide/QuboleConnect/detailed-azure-qubole-steps/azure-Azure-setup.html#step-4c-configure-azure-data-lake-gen-2-storage-with-keys)                                                                                                  | [Odkaz](https://docs.qubole.com/en/latest/quick-start-guide/Azure-quick-start-guide/QuboleConnect/detailed-azure-qubole-steps/azure-Azure-setup.html#step-4d-configure-azure-data-lake-gen-2-storage-with-tokens)                                                                                                 |
...
| Diagnostické protokoly                                                                                        | [Odkaz](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-diagnostic-logs#request-logs) | *Nyní k dispozici* (Preview). Podívejte se na [známé problémy](data-lake-storage-known-issues.md). <br>Integrace monitorování Azure – *zatím není k dispozici* |
...
|------------------------------------|-----------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Lift and shift**                 | [Azure Data Factory](https://docs.microsoft.com/azure/data-factory/load-azure-data-lake-storage-gen2-from-gen1) | Spravované cloudové služby                                                                                                                | Data i seznamy ACL lze v současné době kopírovat.                                                                                                                                                                                                                                                                      |
...
Jako volané ve *vyhodnoťte svoji připravenost upgradu* části nejsou aktuálně dostupné sady SDK. Pokud chcete, aby se pro vaše aplikace Data Lake Storage Gen2 port, doporučujeme počkat, až budou dostupné podporované sady SDK.

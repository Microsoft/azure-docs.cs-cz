---
title: 'Rychlý Start: Klientská knihovna pro přizpůsobování pro Python'
titleSuffix: Azure Cognitive Services
description: V tomto rychlém startu se dozvíte, jak začít s klientskou knihovnou přizpůsobování pro Python pomocí výukové smyčky.

...
## <a id="input_formats"></a>Formáty a kodeky Media Encoder Premium Workflow Input
...
* AVC 8-bit/10 bitů, až 4:2:2, včetně AVCIntra
* Avid DNxHD (v MXF)
...
* Dolby® E
* Dolby® Digital (AC3)
* AAC (AAC-LC, AAC-HE a AAC-HEv2; až do 5,1)
* MPEG – vrstva 2
* MP3 (zvuková vrstva MPEG-1 3)
* Windows Media Audio
* WAV/PCM

## <a id="output_format"></a>Media Encoder Premium Workflow formáty výstupu a kodeky
...
* HEVC (H. 265; 8 bitů a 10 bitů, hlavní a hlavní 10 profil)
  ...
  V některých scénářích je dostupná podpora HDR 10. Další informace mepd@microsoft.com získáte od společnosti.

...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/formcom-tutorial/tutorial_form.com_samlbase.png)

3. Na **Form.com domény a adresy URL** část, proveďte následující kroky:

    ![Form.com domény a adresy URL jednotné přihlašování informace](./media/formcom-tutorial/tutorial_form.com_url.png)
...
4. Na **SAML podpisový certifikát** část, proveďte následující kroky:
    ...
    ![Konfigurovat jednotné přihlašování](./media/formcom-tutorial/tutorial_metadataurl.png)
...
5. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/formcom-tutorial/tutorial_general_400.png)
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/formcom-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **Form.com**.
    ...
    ![V seznamu aplikací na Form.com odkaz](./media/formcom-tutorial/tutorial_form.com_app.png)  

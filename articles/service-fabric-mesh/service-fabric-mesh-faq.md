...
### <a name="dns-resolution-from-an-outbound-container-doesnt-work"></a>Překlad DNS z výstupního kontejneru nebude fungovat.

Za určitých okolností může selhat komunikace Service-to-service. To je Zkoumáme. Zmírnit:

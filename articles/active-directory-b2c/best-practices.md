...
| Použití Identity Protection a podmíněného přístupu | Využijte tyto možnosti pro významně větší kontrolu nad rizikovým ověřováním a zásadami přístupu. Vyžaduje se Azure AD B2C Premium P2. [Přečtěte si další informace](conditional-access-identity-protection-overview.md). |

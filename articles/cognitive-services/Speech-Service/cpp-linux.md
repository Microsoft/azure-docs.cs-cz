...
> [!NOTE]
> Pokud hledáte rychlý start pro C++ a Windows, přejděte [zde](cpp-windows.md).
...
Pokud všechno proběhne správně, měli byste vidět výstup podobný následujícímu:

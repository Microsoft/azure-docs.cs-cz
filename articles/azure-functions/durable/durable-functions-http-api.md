...
| Pole              | Parameter type  | Popis |
|--------------------|-----------------|-------------|
| **`functionName`** | Adresa URL             | The name of the orchestrator function to start. |
| **`instanceId`**   | Adresa URL             | Optional parameter. The ID of the orchestration instance. If not specified, the orchestrator function will start with a random instance ID. |
| **`{content}`**    | Request content | Volitelné. The JSON-formatted orchestrator function input. |
...
| Pole                   | Parameter type  | Popis |
|-------------------------|-----------------|-------------|
| **`instanceId`**        | Adresa URL             | The ID of the orchestration instance. |
...
| Pole                  | Data type | Popis |
|------------------------|-----------|-------------|
| **`instancesDeleted`** | celé číslo   | The number of instances deleted. For the single instance case, this value should always be `1`. |
...
| Pole                   | Data type | Popis |
|-------------------------|-----------|-------------|
| **`instancesDeleted`**  | celé číslo   | The number of instances deleted. |
...
|-------------------|-----------------|-------------|
| **`instanceId`**  | Adresa URL             | The ID of the orchestration instance. |
| **`eventName`**   | Adresa URL             | The name of the event that the target orchestration instance is waiting on. |
...
|-------------------|-----------------|-------------|
| **`instanceId`**  | Adresa URL             | The ID of the orchestration instance. |
| **`reason`**      | Query string    | Volitelné. The reason for terminating the orchestration instance. |
...
|-------------------|-----------------|-------------|
| **`instanceId`**  | Adresa URL             | The ID of the orchestration instance. |
| **`reason`**      | Query string    | Volitelné. The reason for rewinding the orchestration instance. |
...
| Pole             | Parameter type  | Popis |
|-------------------|-----------------|-------------|
| **`entityType`**  | Adresa URL             | The type of the entity. |
| **`entityKey`**   | Adresa URL             | The unique name of the entity. |
| **`op`**          | Query string    | Volitelné. The name of the user-defined operation to invoke. |
| **`{content}`**   | Request content | The JSON-formatted event payload. |

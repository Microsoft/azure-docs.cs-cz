...
Vždy vrátí hodnotu false. Pokud je sloupec s názvem "Nepravda", použijte syntax(false()) – funkce * ``isDiscounted == false()``
* ``isDiscounted() == false``
---
### <code>first</code>
...
Převede všechny číselné nebo řetězcové na desítkovou hodnotu. Pokud nejsou zadané hodnot precision a scale, je výchozí (10,2). Volitelné desítkového formátu Java je možné pro převod. Formátu volitelné národního prostředí formu BCP47 jazyk, třeba cs cz, de, zh-CN * ``toDecimal(123.45) -> 123.45``
...
Převede všechny číselné nebo řetězcové na dvojitou hodnotu. Volitelné desítkového formátu Java je možné pro převod. Formátu volitelné národního prostředí formu BCP47 jazyk, třeba cs cz, de, zh-CN * ``toDouble(123.45) -> 123.45``
...
Vždy vrátí hodnotu true. Pokud je sloupec s názvem "true", použijte syntax(true()) – funkce * ``isDiscounted == true()``
* ``isDiscounted() == true``
---
### <code>typeMatch</code>

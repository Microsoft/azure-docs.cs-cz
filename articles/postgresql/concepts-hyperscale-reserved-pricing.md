...
> [!IMPORTANT]
> V tomto článku se dozvíte o rezervované kapacitě pro Azure Database for PostgreSQL – Citus (škálování). Informace o rezervované kapacitě pro Azure Database for PostgreSQL – jeden server najdete v tématu [platba za Azure Database for PostgreSQL – výpočetní prostředky na jednom serveru s rezervovanou kapacitou](./concept-reserved-pricing.md).
...
Rezervovanou kapacitu Citus () můžete koupit v [Azure Portal](https://portal.azure.com/). Za rezervaci se platí [předem nebo prostřednictvím měsíčních plateb](../cost-management-billing/reservations/prepare-buy-reservation.md). Zakoupení rezervované kapacity:
...
- [Vysvětlení využití rezervace Azure pro registraci smlouva Enterprise](../cost-management-billing/reservations/understand-reserved-instance-usage-ea.md)
- [Vysvětlení využití rezervace Azure pro předplatné s průběžnými platbami](../cost-management-billing/reservations/understand-reserved-instance-usage.md)
...
Rezervace je možné s určitými omezeními zrušit, vyměnit nebo refundovat. Další informace najdete v tématu [samoobslužné výměny a refundace u rezervací Azure](../cost-management-billing/reservations/exchange-and-refund-azure-reservations.md).
...
* [Vysvětlení slevy za rezervaci Azure](../cost-management-billing/reservations/understand-reservation-charges.md)
* [Vysvětlení využití rezervací pro předplatné s průběžnými platbami](../cost-management-billing/reservations/understand-reservation-charges-postgresql.md)
* [Vysvětlení použití rezervací pro registraci smlouva Enterprise](../cost-management-billing/reservations/understand-reserved-instance-usage-ea.md)
* [Rezervace Azure v programu partner Center Cloud Solution Provider](/partner-center/azure-reservations)
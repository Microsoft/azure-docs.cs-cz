...
Importujte velká data pomocí jednoduchých dotazů [PolyBase](/sql/relational-databases/polybase/polybase-guide?toc=/azure/synapse-analytics/sql-data-warehouse/toc.json&bc=/azure/synapse-analytics/sql-data-warehouse/breadcrumb/toc.json&view=azure-sqldw-latest) T-SQL a pak použijte sílu MPP ke spuštění vysoce výkonné analýzy. Při integraci a analýze se fond Synapse SQL stane jedinou verzí pravdy, na kterou se vaše firma může spolehnout pro rychlejší a robustnější přehledy.  

...
5. V části **přihlašovací údaje správce** zadejte `https://api.robinpowered.com/v1.0/scim-2` na **adrese URL tenanta**. Zadejte hodnotu **SCIM tokenu ověřování** získanou dříve v **tajném tokenu**. Klikněte na **Test připojení** a ujistěte se, že se Azure AD může připojit k dotazování. Pokud se připojení nepovede, ujistěte se, že váš účet pro dotazování má oprávnění správce, a zkuste to znovu.

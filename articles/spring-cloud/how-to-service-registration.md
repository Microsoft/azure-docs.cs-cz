...
Informace o tom, jak nastavit registraci služby pro aplikaci Steeltoe, najdete v tématu [Příprava pružinové aplikace Java pro nasazení v jarním cloudu Azure](how-to-prepare-app-deployment.md).
::: zone-end

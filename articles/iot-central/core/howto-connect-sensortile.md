...
* Aplikace pro senzory ST v systému Android nainstalovaná na zařízení s Androidem si můžete [stáhnout odsud](https://play.google.com/store/apps/details?id=com.st.bluems). Další informace najdete na stránce [senzoru St-tivovat](https://www.st.com/stblesensor) .
...
1. Přidejte zařízení ze zařízení. Vyberte **+ nový > Real** a přidejte reálné zařízení.
...
1. V levém podokně vyberte tlačítko protokolování do **cloudu** .

...
* Ujistěte se, že používáte nejnovější verzi prostředí Azure PowerShell. Pokyny k instalaci na [instalace Azure Powershellu](/powershell/azure/install-az-ps). 

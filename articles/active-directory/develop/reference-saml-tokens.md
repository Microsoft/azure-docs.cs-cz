...
* Další informace o správě zásad životností tokenů pomocí rozhraní Microsoft Graph API najdete v tématu [prostředek zásad](/graph/api/resources/policy?view=graph-rest-beta).

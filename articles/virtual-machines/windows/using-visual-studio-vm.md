...
|:--------------------------------------------------------------------------------------------------------------------------------------------------------------:|:---------------------:|:-----------------:|
| [Visual Studio 2019: nejnovější (verze 16,2)](https://azuremarketplace.microsoft.com/marketplace/apps/microsoftvisualstudio.visualstudio2019latest?tab=Overview) | Enterprise, Community | 16.3.0 verze    |
| [Visual Studio 2019: RTW](https://azuremarketplace.microsoft.com/marketplace/apps/microsoftvisualstudio.visualstudio2019?tab=Overview)                         | Enterprise, Community | 16.0.8 verze    |
| [Visual Studio 2017: nejnovější (verze 15,9)](https://azuremarketplace.microsoft.com/marketplace/apps/microsoftvisualstudio.visualstudio?tab=Overview)           | Enterprise, Community | 15.9.16 verze   |
| [Visual Studio 2017: RTW](https://azuremarketplace.microsoft.com/marketplace/apps/microsoftvisualstudio.visualstudio?tab=Overview)                             | Enterprise, Community | 15.0.25 verze   |
...
Další informace najdete v tématu [zásady údržby sady Visual Studio](https://www.visualstudio.com/productinfo/vs-servicing-vs).
...
Další informace najdete v tématu [přihlášení do sady Visual Studio](/visualstudio/ide/signing-in-to-visual-studio) a [o tom, jak odemknout Visual Studio](/visualstudio/ide/how-to-unlock-visual-studio).
...
Rychlý přehled: použijte nástroj pro přípravu systému (Sysprep) a vypněte běžící virtuální počítač a potom Zachyťte *(obrázek 1)* virtuální počítač jako Image prostřednictvím uživatelského rozhraní v Azure Portal. Azure uloží soubor `.vhd`, který obsahuje obrázek v účtu úložiště, který zvolíte. Nový obrázek se pak v seznamu prostředků vašeho předplatného zobrazí jako prostředek obrázku.
...
* [Vytvoření virtuálního počítače pomocí Azure Portal](quick-create-portal.md)

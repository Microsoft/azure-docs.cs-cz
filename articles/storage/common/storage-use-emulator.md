...
| --- | --- | --- | --- |
| **Start** |Spustí emulátor úložiště. |`AzureStorageEmulator.exe start [-inprocess]` |*-Rezpracovat*: Spusťte emulátor v aktuálním procesu místo vytvoření nového procesu. |

---
title: Profilování živých aplikací Service Fabric Azure pomocí Application Insights | Microsoft Docs
...
1. Profiler podporuje .NET Framework a .Net Core. Pokud používáte .NET Framework, ujistěte se, že používáte [.NET Framework 4.6.1](https://docs.microsoft.com/dotnet/framework/migration-guide/how-to-determine-which-versions-are-installed) nebo novější. Je dostačující potvrdit, že nasazený operační systém je `Windows Server 2012 R2` nebo novější. Profiler podporuje .NET Core 2,1 a novější aplikace.
...
1. Přidejte následující oddíl `SinksConfig` jako podřízený prvek `WadCfg`. Nahraďte hodnotu vlastnosti `ApplicationInsightsProfiler` vlastním klíčem Application Insights instrumentace:  

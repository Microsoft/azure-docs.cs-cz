...
Tento kurz popisuje, jak převzít služby při selhání virtuálního počítače Azure do sekundární oblasti Azure. Po přes, znovunastavení ochrany virtuálního počítače. V tomto kurzu se naučíte:

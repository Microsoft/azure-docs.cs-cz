...
- V **CloudCapabilities** složky:<br>         AzureRM.CloudCapabilities.psm1 vytvoří soubor JSON cloudu možnosti představují služby a verze ve cloudu Azure zásobníku.

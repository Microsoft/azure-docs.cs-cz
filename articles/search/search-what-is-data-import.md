---
title: Import dat pro příjem dat do indexu hledání
...
Úvod ke každé metodologii najdete v tématu [rychlý Start: vytvoření indexu služby Azure kognitivní hledání pomocí prostředí PowerShell](search-create-index-rest-api.md) nebo [ C# rychlé zprovoznění: vytvoření indexu Azure kognitivní hledání pomocí sady .NET SDK](search-get-started-dotnet.md).

...
Po provedení této změny konfigurace vytvoříte nové nasazení podle kroků popsaných v [tématu Vytvoření nasazení aktualizace](deploy-updates.md#schedule-an-update-deployment) a výběrem části **importované skupiny** v rozevíracím seznamu **typ** vyberte příslušnou kolekci Configuration Managerho koncového bodu Microsoft.

## <a name="next-steps"></a>Další kroky

Postup nastavení plánu integrace najdete v tématu [Naplánování nasazení aktualizace](deploy-updates.md#schedule-an-update-deployment).

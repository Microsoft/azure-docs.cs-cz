---
title: Nápověda k aplikaci Microsoft Authenticator – Azure AD | Microsoft Docs
...
Pokud používáte zařízení se systémem iOS, jste zapnuli **automatické zálohování**a jste vytvořili zálohu svých účtů na zařízení původní; můžete použít tuto zálohu k obnovení přihlašovací údaje účtu na nové zařízení. Další informace najdete v tématu [zálohování a obnovení přihlašovací údaje účtu v aplikaci Microsoft Authenticator](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-backup-and-recovery.md) článku. 
...
* [Došlo k potížím s dvoustupnovym overovanim](../../../../multi-factor-authentication/end-user/multi-factor-authentication-end-user-troubleshoot.md) pro svůj pracovní nebo školní účet?

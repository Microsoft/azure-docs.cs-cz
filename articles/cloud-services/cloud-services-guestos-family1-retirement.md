...
---
# <a name="guest-os-family-1-retirement-notice"></a>Řada operačních systémů Host 1 – oznámení o vyřazení
...
Pokud máte další otázky, navštivte [fórum Cloud Services](https://social.msdn.microsoft.com/Forums/home?forum=windowsazuredevelopment&filter=alltypes&sort=lastpostdesc) nebo se [obraťte na podporu Azure](https://azure.microsoft.com/support/options/).
...
Pokud chcete zjistit, které z vašich cloudových služeb běží na kterých řadě operačních systémů, můžete spustit následující skript v Azure PowerShell, ale musíte nejdřív [nastavit Azure PowerShell](/powershell/azureps-cmdlets-docs) . Další informace o skriptu najdete v tématu [řada hostovaných operačních systémů Azure – 1 konec životnosti: Červeně](https://blogs.msdn.com/b/ryberry/archive/2014/04/02/azure-guest-os-family-1-end-of-life-june-2014.aspx)2014. června.

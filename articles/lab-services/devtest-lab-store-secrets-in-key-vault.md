...
DevTest Labs podporuje ukládání tajných klíčů v [trezoru klíčů Azure](../key-vault/key-vault-overview.md), aby tento problém vyřešil a na bezpečném místě zajistil i tajné klíče. Když uživatel poprvé uloží tajný klíč, služba DevTest Labs automaticky vytvoří Trezor klíčů ve stejné skupině prostředků, která obsahuje testovací prostředí a uloží tajný klíč do trezoru klíčů. DevTest Labs vytvoří pro každého uživatele samostatný Trezor klíčů. 

...
|![Striim][2]    |  [Přesun dat v reálném čase do služby Azure Cosmos DB](https://www.striim.com/striim-for-azure-cosmos-db/) z různých datových zdrojů. <br/> Striim zjednodušuje kolekce v reálném čase a přesun dat z nejrůznějších zdrojů místní, včetně podnikových dokumentů a relační databáze, senzory a soubory protokolů do služby Azure Cosmos DB. |   USA   |  [Web](https://www.striim.com/)       |
...
|![Tallan][11]    |  Migrace NoSQL <br/> Inovace aplikací (existující aplikace) <br/> Vývoj aplikace       |    USA     |  [Web](https://www.tallan.com/)       |

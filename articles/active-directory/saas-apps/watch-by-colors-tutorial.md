...
1. V pravém horním rohu stránky klikněte na **profil** > **Uživatelé** > **Přidat uživatele**.
...
1. Na stránce s **podrobnostmi o uživateli** proveďte následující kroky:
    ...
    ![Sledovat podle konfigurace barev](./media/watch-by-colors-tutorial/config04.png)

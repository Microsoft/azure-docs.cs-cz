...
V tomto kurzu jste zabezpečeni webový server služby IIS pomocí certifikátu TLS/SSL, který je uložený v Azure Key Vault. Naučili jste se tyto postupy:

...
* Můžete povolit uživatelům být automaticky přihlášeni k HeyBuddy (Single Sign-On) s jejich účty Azure AD.
...
* Podporuje HeyBuddy **SP** jednotné přihlašování zahájené pomocí
* Podporuje HeyBuddy **JIT** zřizování uživatelů
...
4. Do vyhledávacího pole zadejte **HeyBuddy**vyberte **HeyBuddy** z panelu výsledků klikněte **přidat** tlačítko pro přidání aplikace.
     ...
     ![HeyBuddy v seznamu výsledků](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurace a otestování služby Azure AD jednotného přihlašování

V této části je konfigurace a testování Azure AD jednotné přihlašování pomocí HeyBuddy podle testovacího uživatele volá **Britta Simon**.
Pro jednotné přihlašování pro práci je potřeba navázat vztah odkazu mezi uživatele služby Azure AD a související uživatelské v HeyBuddy.
...
2. **[Konfigurace HeyBuddy Single Sign-On](#configure-heybuddy-single-sign-on)**  – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
3. **[Vytvořit testovacího uživatele Azure AD](#create-an-azure-ad-test-user)**  – Pokud chcete otestovat Azure AD jednotné přihlašování s Britta Simon.
4. **[Přiřadit uživatele Azure AD](#assign-the-azure-ad-test-user)**  – Pokud chcete povolit Britta Simon používat Azure AD jednotného přihlašování.
5. **[Vytvořit testovacího uživatele HeyBuddy](#create-heybuddy-test-user)**  – Pokud chcete mít protějšek Britta Simon HeyBuddy, který je propojený s Azure AD reprezentace uživatele.
...
1. V [webu Azure portal](https://portal.azure.com/)na **HeyBuddy** integrace stránce aplikace vyberte **jednotného přihlašování**.
...
4. Na **základní konfiguraci SAML** části, proveďte následující kroky:
    ...
    ![HeyBuddy domény a adresy URL jednotného přihlašování – informace](common/sp-identifier.png)

    a. V **přihlašovací adresa URL** textové pole, zadejte adresu URL, pomocí následujícího vzorce: `https://api.heybuddy.com/auth/<ENTITY ID>`

    b. V **identifikátor (Entity ID)** textové pole, zadejte adresu URL, pomocí následujícího vzorce: `YourCompanyInstanceofHeyBuddy`
...
### <a name="configure-heybuddy-single-sign-on"></a>Konfigurace HeyBuddy jednotné přihlašování

Ke konfiguraci jednotného přihlašování na **HeyBuddy** straně, je nutné odeslat **adresa Url federačních metadat aplikace** k [tým podpory HeyBuddy](mailto:support@heybuddy.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.
...
1. Na webu Azure Portal, vyberte **podnikové aplikace**vyberte **všechny aplikace**a pak vyberte **HeyBuddy**.

    ![Okno aplikace organizace](common/enterprise-applications.png)

2. V seznamu aplikací vyberte **HeyBuddy**.

    ![Odkaz HeyBuddy v seznamu aplikací](common/all-applications.png)
...
### <a name="create-heybuddy-test-user"></a>Vytvoření HeyBuddy testovacího uživatele

V této části se vytvoří uživateli Britta Simon v HeyBuddy. HeyBuddy podporuje zřizování uživatelů v čase, který je ve výchozím nastavení povolené. Neexistuje žádná položka akce pro vás v této části. Pokud uživatel již neexistuje mezi HeyBuddy, vytvoří se nový po ověření.
...
Po kliknutí na dlaždici HeyBuddy na přístupovém panelu, můžete by měl být automaticky přihlášeni k HeyBuddy, u kterého nastavíte jednotné přihlašování. Další informace o přístupovém panelu, naleznete v tématu [Úvod k přístupovému panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

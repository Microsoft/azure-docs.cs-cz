...
3. Určete, jaká data se mají [mapovat mezi Azure AD a Bpanda](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 
...
Tento příkaz použijte pro **Linux** .
```

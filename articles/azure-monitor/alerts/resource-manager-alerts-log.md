...
Následující ukázka vytvoří [počet pravidel upozornění výsledků](../alerts/alerts-unified-log.md#count-of-the-results-table-rows).

### <a name="notes"></a>Poznámky

- Tato ukázka zahrnuje [datovou část Webhooku](../alerts/alerts-log-webhook.md). Pokud pravidlo výstrahy nemá aktivovat Webhook, odeberte element **customWebhookPayload** .
...
Následující ukázka vytvoří [pravidlo upozornění měření metriky](../alerts/alerts-unified-log.md#calculation-of-measure-based-on-a-numeric-column-such-as-cpu-counter-value).

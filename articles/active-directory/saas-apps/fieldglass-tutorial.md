...
4. Do vyhledávacího pole zadejte **Fieldglass**.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/fieldglass-tutorial/tutorial_fieldglass_search.png)

5. Na panelu výsledků vyberte **Fieldglass**a potom klikněte na **přidat** tlačítko Přidat aplikaci.

    ![Vytváření testovacího uživatele Azure AD](./media/fieldglass-tutorial/tutorial_fieldglass_addfromgallery.png)
...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Konfigurovat jednotné přihlašování](./media/fieldglass-tutorial/tutorial_fieldglass_samlbase.png)

3. Na **Fieldglass domény a adresy URL** část, proveďte následující kroky:

    ![Konfigurovat jednotné přihlašování](./media/fieldglass-tutorial/tutorial_fieldglass_url.png)
...
4. Na **SAML podpisový certifikát** klikněte na tlačítko **Certificate(Base64)** a potom uložte soubor certifikátu v počítači.
    ...
    ![Konfigurovat jednotné přihlašování](./media/fieldglass-tutorial/tutorial_fieldglass_certificate.png) 

5. Klikněte na tlačítko **Uložit** tlačítko.

    ![Konfigurovat jednotné přihlašování](./media/fieldglass-tutorial/tutorial_general_400.png)
...
6. Na **Fieldglass konfigurace** klikněte na tlačítko **konfigurace Fieldglass** otevřete **konfigurovat přihlášení** okno. Kopírování **Sign-Out adresu URL a SAML Entity ID** z **Stručná referenční příručka části.**
    ...
    ![Konfigurovat jednotné přihlašování](./media/fieldglass-tutorial/tutorial_fieldglass_configure.png) 
...
1. V **portál Azure**, v levém navigačním podokně klikněte na tlačítko **Azure Active Directory** ikonu.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/fieldglass-tutorial/create_aaduser_01.png) 

2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin** a klikněte na tlačítko **všichni uživatelé**.
    
    ![Vytváření testovacího uživatele Azure AD](./media/fieldglass-tutorial/create_aaduser_02.png) 

3. Chcete-li otevřít **uživatele** dialogové okno, klikněte na tlačítko **přidat** horní dialogové okno.
 
    ![Vytváření testovacího uživatele Azure AD](./media/fieldglass-tutorial/create_aaduser_03.png) 

4. Na **uživatele** dialogové okno stránky, proveďte následující kroky:
 
    ![Vytváření testovacího uživatele Azure AD](./media/fieldglass-tutorial/create_aaduser_04.png) 
...
2. V seznamu aplikací vyberte **Fieldglass**.
    ...
    ![Konfigurovat jednotné přihlašování](./media/fieldglass-tutorial/tutorial_fieldglass_app.png) 

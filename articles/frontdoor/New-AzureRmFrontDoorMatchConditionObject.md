...
ms.locfileid: "47047242"
---
# Nové AzureRmFrontDoorMatchConditionObject
Vytvořit MatchCondition objekt pro vytváření zásad WAF
...
Vytvořte objekt MatchCondition
...
### -MatchVariable
Proměnné shody.
Možné hodnoty zahrnují: "RemoteAddr", "RequestMethod", "QueryString", "PostArgs", "RequestUri", "RequestHeader", "includesearchresults: true.
...
### -NegateCondition
Popisuje, zda je to negate podmínky nebo není výchozí hodnota je false
...
### -OperatorProperty
Popisuje operátoru lze porovnat.
Možné hodnoty zahrnují: "Jakýkoli", "IPMatch", "GeoMatch", "Stejné", "Obsahuje", "LessThan", "GreaterThan", "LessThanOrEqual", "GreaterThanOrEqual", "Začíná na", "EndsWith"
...
### -Výběr
Název oblasti pro výběr RequestHeader nebo includesearchresults: true si měly odpovídat

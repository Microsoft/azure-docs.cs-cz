...
- Pokud v seznamu **typ** vyberete položku **příkazový řádek** , je nutné spustit binskim. exe:
     ...
     - Standardní konfigurace příkazového řádku jsou uvedené níže.
          ...
          > [!NOTE]
          > Koncový \\* je důležité, pokud zadáte adresáře pro cíl.
...
Mezi dostupné možnosti patří:
  ...
  - **Možnosti ovládacích prvků** > **spuštění této úlohy**: Určuje, kdy se úloha spustí. Pokud chcete zadat složitější podmínky, vyberte **vlastní podmínky** .
...
- **Možnosti ovládacích prvků** > **spuštění této úlohy**: Určuje, kdy se úloha spustí. Zvolte **vlastní podmínky** a určete složitější podmínky.

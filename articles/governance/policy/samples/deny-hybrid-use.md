...
description: Tato ukázková definice zásad zakáže použití zvýhodněného programu Azure Hybrid Use (AHUB) pro virtuální počítače a sady škálování virtuálních počítačů.
ms.date: 01/23/2019
ms.topic: sample

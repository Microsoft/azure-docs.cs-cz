...
ms.locfileid: "70020422"
---
| Kategorie | Úložiště dat | Podporováno jako zdroj [aktivity kopírování](../articles/data-factory/copy-activity-overview.md) | Podporováno jako jímka [aktivity kopírování](../articles/data-factory/copy-activity-overview.md) | Podporované prostředím [Azure IR](../articles/data-factory/concepts-integration-runtime.md#azure-integration-runtime) | Podporované [místním prostředím IR](../articles/data-factory/concepts-integration-runtime.md#self-hosted-integration-runtime) | Podporováno [tokem dat](../articles/data-factory/concepts-data-flow-overview.md)
|:--- |:--- |:--- |:--- |:--- |:--- |
| **Azure** |[Azure Blob Storage](../articles/data-factory/connector-azure-blob-storage.md) |✓ |✓ |✓ |✓  | ✓ <br> <small>Podporované formáty: Text s oddělovači, Parquet</small> |
...
| &nbsp; |[Azure Data Lake Storage Gen1](../articles/data-factory/connector-azure-data-lake-store.md) |✓ |✓ |✓ |✓  |✓ <br> <small>Podporované formáty: Text s oddělovači, Parquet</small> |
| &nbsp; |[Azure Data Lake Storage Gen2](../articles/data-factory/connector-azure-data-lake-storage.md) |✓ |✓ |✓ |✓  |✓ <br> <small>Podporované formáty: Text s oddělovači, Parquet</small> |

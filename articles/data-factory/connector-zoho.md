---
title: Kopírování dat z Zoho pomocí Azure Data Factory (Preview) | Microsoft Docs
...
| accessToken | Přístupový token pro Zoho ověřování. Toto pole označit jako SecureString bezpečně uložit v datové továrně nebo [odkazovat tajného klíče uložené v Azure Key Vault](store-credentials-in-key-vault.md). | Ano |

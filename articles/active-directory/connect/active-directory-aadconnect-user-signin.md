...
* [Synchronizace hodnot hash hesel](#password-hash-synchronization) s [bezproblémové jednotné přihlašování (SSO)](active-directory-aadconnect-sso.md)
...
Kromě toho můžete povolit [bezproblémového jednotného přihlašování](active-directory-aadconnect-sso.md) pro uživatele v doméně počítače, které jsou v podnikové síti. Pomocí jednotného přihlašování povolení uživatelé muset zadat uživatelské jméno jim umožní bezpečný přístup k prostředkům cloudu.

![Synchronizace hodnot hash hesel](./media/active-directory-aadconnect-user-signin/passwordhash.png)

Další informace najdete v tématu [synchronizaci hodnot hash hesel](active-directory-aadconnectsync-implement-password-hash-synchronization.md) článku.
...
Informace o nastavení Azure AD Connect s použitím služby PingFederate, naleznete v tématu [vlastní instalace Azure AD Connect](active-directory-aadconnect-get-started-custom.md#configuring-federation-with-pingfederate)
...
Další informace najdete v tématu [seznam kompatibility federace třetí strany Azure AD](active-directory-aadconnect-federation-compatibility.md).

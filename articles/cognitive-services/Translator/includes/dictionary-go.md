...
Pojďme vytvořit funkci, která získá alternativní překlady. Tato funkce bude mít jeden argument, váš klíč předplatného překladatele.
...
Nyní vytvoříme adresu URL. Adresa URL je sestavena pomocí `Parse()` `Query()` metod a. Všimněte si, že parametry jsou přidány s `Add()` metodou. V této ukázce se překládáme z angličtiny na španělštinu.

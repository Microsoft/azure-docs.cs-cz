---
title: Optimalizace výkonu pro Apache Kafka clustery HDInsight
...
---
# <a name="performance-optimization-for-apache-kafka-hdinsight-clusters"></a>Optimalizace výkonu pro Apache Kafka clustery HDInsight
...
Témata Kafka slouží k uspořádání záznamů. Záznamy jsou vytvářeny producenty a využívány spotřebiteli. Výrobci odesílají záznamy do zprostředkovatelů Kafka, které pak data ukládají. Každý pracovní uzel v clusteru HDInsight je zprostředkovatelem Kafka.

...
Další informace najdete v tématu technické specifikace [zůstatky API](https://docs.microsoft.com/rest/api/consumption/getbalancesbybillingaccount).

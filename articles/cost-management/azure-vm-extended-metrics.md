...
4. After a few minutes, the Azure diagnostics agent is installed on the VM. A basic set of metrics are added. Aktualizujte stránku. The added performance counters appear on the Overview tab.

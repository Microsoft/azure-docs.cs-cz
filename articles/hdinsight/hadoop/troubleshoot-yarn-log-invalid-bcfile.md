...
Protokol Apache nitě je agregovaný do formátu `IndexFile`, který analyzátor souborů nepodporuje.

## <a name="resolution"></a>Rozlišení

1. Ve webovém prohlížeči přejděte na `https://CLUSTERNAME.azurehdinsight.net`, kde `CLUSTERNAME` je název vašeho clusteru.

1. V uživatelském rozhraní Ambari přejděte na **nitě** > **konfigurace** > **Upřesnit** > **Upřesnit nitě-site**.

...
Předpokládejme například, že máte spuštěnou jednu skupinu serverů Citus () s 16 vCore koordinátorem a tři 8 vCore pracovních uzlů. Dále budeme předpokládat, že plánujete nasadit do příštího měsíce skupinu serverů Citus (Next Scale) s vCore koordinátorem 32 a dvěma 4 vCore pracovními uzly. Řekněme taky, že tyto prostředky potřebujete aspoň na jeden rok.

...
|---------------------|-----------------|----------|-------|-------------|
| **Ověřování** | `type` | Yes | Základní | Typ ověřování, který se má použít |

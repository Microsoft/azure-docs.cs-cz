...
ms.locfileid: "57310093"
---
# <a name="tutorial-move-azure-resources-to-another-resource-group"></a>Kurz: Přesun prostředků Azure do jiné skupiny prostředků
...
![Azure Resource Manager přesunout prostředky diagramu](./media/resource-manager-tutorial-move-resources/resource-manager-template-move-resources.png)

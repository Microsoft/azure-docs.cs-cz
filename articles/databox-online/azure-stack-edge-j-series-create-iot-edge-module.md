...
![Jak Azure IoT Edge modul funguje na Azure Stack Edge pro](./media/azure-stack-edge-j-series-create-iot-edge-module/how-module-works-1.png)
...
- Zařízení Azure Stack Edge pro, na kterém běží.
    ...
    Další informace najdete v pro [nastavení služby COMPUTE](azure-stack-edge-j-series-deploy-configure-compute.md#configure-compute) pro Azure Stack Edge pro.
...
3. Na paletě příkazů zadejte a spusťte příkaz **Azure IoT Edge: New IoT Edge solution** (Azure IoT Edge: Nové řešení IoT Edge). Na paletě příkazů zadejte následující informace k vytvoření řešení:
    ...
    2. Zadejte název pro vaše řešení nebo přijměte výchozí název **EdgeSolution**.
        ...
        ![Vytvořit nové řešení 1](./media/azure-stack-edge-j-series-create-iot-edge-module/create-new-solution-1.png)
    ...
    4. Nahraďte výchozí název modulu názvem, který chcete přiřadit. v tomto případě je to **FileCopyModule**.
        ...
        ![Vytvořit nové řešení 2](./media/azure-stack-edge-j-series-create-iot-edge-module/create-new-solution-2.png)
    ...
    5. Zadejte registr kontejneru, který jste vytvořili v předchozí části, jako úložiště imagí pro váš první modul. Nahraďte **localhost:5000** hodnotou pro přihlašovací server, kterou jste zkopírovali.
        ...
        ![Vytvořit nové řešení 3](./media/azure-stack-edge-j-series-create-iot-edge-module/create-new-solution-3.png)

4. Přejít na **soubor > otevřít složku**.

    ![Vytvořit nové řešení 4](./media/azure-stack-edge-j-series-create-iot-edge-module/create-new-solution-4.png)
...
5. Přejděte do složky **EdgeSolution** , kterou jste vytvořili dříve. Okno VS Code načte pracovní prostor řešení IoT Edge s jeho pěti komponentami nejvyšší úrovně. V tomto článku nebudete upravovat složku **. VSCode** , soubor **. gitignore** , soubor **. env** a **deployment.template.js** .
    ...
    ![Vytvořit nové řešení 5](./media/azure-stack-edge-j-series-create-iot-edge-module/create-new-solution-5.png)
...
2. Přihlaste se k Docker zadáním následujícího příkazu v integrovaném terminálu.
    ...
    ![Sestavování a nabízených IoT Edge řešení](./media/azure-stack-edge-j-series-create-iot-edge-module/build-iot-edge-solution-1.png)
...
3. Po zadání přihlašovacích údajů můžete do služby Azure Container Registry odeslat image modulu. V Průzkumníku VS Code klikněte pravým tlačítkem na **module.jsna** soubor a vyberte **sestavení a nabízené IoT Edge řešení**.
    ...
    ![Sestavování a nabízených IoT Edge řešení](./media/azure-stack-edge-j-series-create-iot-edge-module/build-iot-edge-solution-2.png)
    ...
    ![Vybrat platformu](./media/azure-stack-edge-j-series-create-iot-edge-module/select-platform.png)
...
Pokud chcete nasadit a spustit tento modul na Azure Stack Edge pro, přečtěte si postup v tématu [Přidání modulu](azure-stack-edge-j-series-deploy-configure-compute.md#add-a-module).

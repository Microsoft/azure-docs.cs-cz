...
3. Klikněte na ![ využitím VAMPU UI – upravit ](./media/container-service-dcos-vamp-canary-release/vamp_ui_edit.png) a změňte **sílu** aplikovanou na podmínku.
 
4. Nastavte **sílu** na 100% a klikněte na ![ využitím vampu UI – Save (Uložit) ](./media/container-service-dcos-vamp-canary-release/vamp_ui_save.png) .

---
title: Rychlý Start překladu řeči – služba řeči
titleSuffix: Azure Cognitive Services
description: Naučte se používat sadu Speech SDK k překladu řeči. V tomto rychlém startu se naučíte vytváření objektů, podporované formáty zvukového vstupu a možnosti konfigurace pro překlad řeči.
...
> [!TIP]
> Pokud chcete přeskočit přímý na vzorový kód, přečtěte si [ukázky rychlý Start](https://github.com/Azure-Samples/cognitive-services-speech-sdk/tree/master/quickstart) na GitHubu.

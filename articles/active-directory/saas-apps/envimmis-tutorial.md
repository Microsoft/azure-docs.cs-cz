...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/envimmis-tutorial/tutorial_envimmis_samlbase.png)
...
3. Na **Envi MMIS domény a adresy URL** část, proveďte následující kroky, pokud chcete nakonfigurovat aplikace **IDP** iniciované režimu:
    ...
    ![Envi MMIS domény a adresy URL jednotné přihlašování informace](./media/envimmis-tutorial/tutorial_envimmis_url.png)
...
4. Zkontrolujte **zobrazit upřesňující nastavení adresy URL** a provést následující krok, pokud chcete nakonfigurovat aplikace **SP** iniciované režimu:
    ...
    ![Envi MMIS domény a adresy URL jednotné přihlašování informace](./media/envimmis-tutorial/tutorial_envimmis_url1.png)
...
6. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/envimmis-tutorial/tutorial_general_400.png)

7. V okně prohlížeče jiný web Přihlaste se k webu Envi MMIS jako správce.

8. Klikněte na **Moje domény** kartě.

    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/envimmis-tutorial/configure1.png)

9. Klikněte na **Upravit**.

    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/envimmis-tutorial/configure2.png)
...
10. Vyberte **ověřování vzdálené** zaškrtávací políčko a potom vyberte **přesměrování protokolu HTTP** z **typ ověřování** rozevíracího seznamu.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/envimmis-tutorial/configure3.png)

11. Vyberte **prostředky** a pak klikněte **nahrát Metadata**.

    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/envimmis-tutorial/configure4.png)

12. V **nahrát Metadata** místní, proveďte následující kroky:

    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/envimmis-tutorial/configure5.png)
...
13. Po nahrání souboru stažené metadata pole získat vyplní automaticky. Klikněte na tlačítko **aktualizace**
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/envimmis-tutorial/configure6.png)
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/envimmis-tutorial/create_aaduser_02.png)
...
2. Klikněte na **seznam uživatelů** kartě.
    ...
    ![Můžete přidat zaměstnance](./media/envimmis-tutorial/user1.png)

3. Klikněte na tlačítko **přidat uživatele** tlačítko.

    ![Můžete přidat zaměstnance](./media/envimmis-tutorial/user2.png)

4. V **přidat uživatele** část, proveďte následující kroky:

    ![Můžete přidat zaměstnance](./media/envimmis-tutorial/user3.png)
...
2. V seznamu aplikací vyberte **Envi MMIS**.
    ...
    ![V seznamu aplikací na Envi MMIS odkaz](./media/envimmis-tutorial/tutorial_envimmis_app.png)  

...
Úplný popis dostupných značek jako například `latest` použili v předchozím příkazu, naleznete v tématu [LUIS](https://hub.docker.com/r/microsoft/azure-cognitive-services-luis/) na Docker Hubu.

---
title: Příprava portálu pro virtuální pole StorSimple | Microsoft Docs
...
| --- | --- | --- | --- |
| 1. |**Nastavení Azure Portal** |Vytvořte a nakonfigurujte službu StorSimple Device Manager před zřízením virtuálního pole StorSimple. |[Příprava portálu](storsimple-virtual-array-deploy1-portal-prep.md) |
...
* Pro službu StorSimple Device Manager by mělo být povolené vaše předplatné Microsoft Azure.
...
Použijte následující podrobné pokyny k přípravě portálu pro službu StorSimple Device Manager.
...
> [!NOTE]
> Registrační klíč služby se používá k registraci všech zařízení StorSimple Device Manager, která se musí registrovat ve službě StorSimple Device Manager.
> 
> 

...
Chcete-li odebrat skupinu prostředků, použijte [odebrat AzResourceGroup](https://docs.microsoft.com/powershell/module/az.resources/remove-azresourcegroup) příkazu. Proměnná $resourceGroup byla nastavena na **ContosoIoTRG1** na začátku tohoto kurzu.

...
Podrobné vysvětlení dostupných parametrů naleznete v dokumentaci k rozhraní [příkazového řádku pro obnovení databáze ve spravované instanci SQL](/cli/azure/sql/midb#az_sql_midb_restore).

...
- **Definition** – Definice zásady, kterou používáte k vytvoření tohoto přiřazení. V tomto případě je to ID definice zásady *Auditovat virtuální počítače, které nepoužívají spravované disky*.

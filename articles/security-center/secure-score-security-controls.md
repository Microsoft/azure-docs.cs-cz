...
|**Správa přístupu a oprávnění**|4|– Pro vaše předplatné by se měly určit maximálně 3 vlastníci.<br>– Zastaralé účty by se měly odebírat z předplatného.<br>– Zastaralé účty s oprávněním vlastníka by se měly odebrat z vašeho předplatného.<br>– Externí účty s oprávněním vlastníka by se měly odebrat z předplatného.<br>– Externí účty s oprávněním ke čtení by se měly z vašeho předplatného odebrat.<br>– Externí účty s oprávněním k zápisu by se měly odebírat z vašeho předplatného.<br>– K vašemu předplatnému by měl být přiřazený víc než jeden vlastník.<br>– Na Kubernetes Services (Preview) by se měla používat Access Control na základě rolí (RBAC)<br>-Service Fabric clustery by se měly používat jenom Azure Active Directory pro ověřování klientů.|

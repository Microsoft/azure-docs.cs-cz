...
V Cloud Shell vytvořte soubor s názvem `nano azure-vote.yaml` `vi azure-vote.yaml` `azure-vote.yaml`pomocí příkazu nebo. Pak zkopírujte následující definici YAML:

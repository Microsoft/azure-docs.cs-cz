...
ms.locfileid: "84044651"
---
# <a name="stream-data-into-azure-sql-database-using-stream-analytics-integration-preview"></a>Streamování dat do Azure SQL Database pomocí integrace Stream Analytics (Preview)
...
> [!IMPORTANT]
> Azure Stream Analytics úloha může mít výstup do Azure SQL Database, spravované instance Azure SQL nebo Azure synapse (dříve Azure SQL Data Warehouse). Další informace najdete v tématu [výstupy](../../stream-analytics/stream-analytics-define-outputs.md#sql-database).

...
description: Ukázka skriptu prostředí Azure PowerShell – vytvoření vlastních pravidel brány firewall webové aplikace
author: vhorne
...
- Další informace o vlastních pravidlech WAF naleznete [v tématu Vlastní pravidla brány firewall webových aplikací](../custom-waf-rules-overview.md)

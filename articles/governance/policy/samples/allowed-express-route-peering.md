...
description: Tato ukázková definice zásad vyžaduje, aby ExpressRoute použila zadaná umístění partnerského vztahu definovaná v parametru.
ms.date: 01/23/2019
ms.topic: sample

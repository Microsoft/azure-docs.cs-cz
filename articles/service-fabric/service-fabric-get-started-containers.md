...
Pokud chcete zjistit verzi Windows serveru s kontejnery, které potřebujete pro svůj cluster, spusťte příkaz `ver` z příkazového řádku Windows na vašem vývojovém počítači:

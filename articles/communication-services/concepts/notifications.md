...
Přečtěte si další informace o [zpracování událostí v komunikačních službách Azure](https://docs.microsoft.com/azure/event-grid/event-schema-communication-services).

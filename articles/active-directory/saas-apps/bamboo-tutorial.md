...
3. **[Vytvoření SAML SSO pro bambus rozlišení GmbH testovací uživatel](#create-a-saml-sso-for-bamboo-by-resolution-gmbh-test-user)**  – Pokud chcete mít protějšek Britta Simon v jednotné přihlašování SAML pro bambus podle rozlišení GmbH, která souvisí s Azure AD reprezentace uživatele.
...
3. Na **SAML SSO bambus podle rozlišení GmbH domény a adresy URL** části, proveďte následující kroky, pokud chcete nakonfigurovat aplikace v režimu iniciované zprostředkovatele identity:
...
7. Přihlašování k SAML SSO pro bambus rozlišení GmbH společnosti lokalita jako správce.

8. Na pravé straně hlavního panelu nástrojů klikněte na tlačítko **nastavení** > **doplňky**.

    ![Nastavení](./media/bamboo-tutorial/tutorial_bamboo_setings.png)

9. Přejděte do části pro zabezpečení, klikněte na **SAML SingleSignOn** na řádku nabídek.
...
12. Na **konfigurace zprostředkovatele Identity** stránce klikněte na **Další**.

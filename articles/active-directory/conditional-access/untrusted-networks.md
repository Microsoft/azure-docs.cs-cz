---
title: Jak vyžadovat vícefaktorové ověřování (MFA) pro přístup z nedůvěryhodných sítí pomocí podmíněného přístupu Azure Active Directory (Azure AD) | Microsoft Docs

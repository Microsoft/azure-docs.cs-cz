...
ms.locfileid: "71174572"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-hosted-heritage-online-sso"></a>Kurz: Azure Active Directory integrace jednotného přihlašování s hostovaným dědictvím online jednotného přihlašování
...
Pokud chcete nakonfigurovat jednotné přihlašování na straně **hostovaného dědictví online** , musíte poslat **adresu URL federačních metadat aplikace** pro [hostovaný tým podpory jednotného přihlašování v online režimu](mailto:support@isoxford.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

### <a name="create-hosted-heritage-online-sso-test-user"></a>Vytvořit hostovaný dědictví – online uživatel testu SSO

V této části vytvoříte uživatele s názvem B. Simon v hostovaném dědictví online jednotného přihlašování. Spolupracujte s [hostovaným týmem podpory online jednotného přihlašování](mailto:support@isoxford.com) , abyste přidali uživatele na hostované platformě online jednotného přihlašování (dědictví). Uživatelé musí vytvořit a aktivovat, než použití jednotného přihlašování.

## <a name="test-sso"></a>Test SSO 

V této části Testování služby Azure AD jednotné přihlašování – konfigurace pomocí přístupového panelu.

Po kliknutí na dlaždici hostovaného dědictví online na přístupovém panelu byste měli být automaticky přihlášení k hostovanému dědictví online jednotného přihlašování, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

...
Ujistěte se, že máte nainstalovanou Azure PowerShell verze 2.4.2 nebo novější a že jste se přihlásili k účtu Azure v `Connect-AzAccount`rámci. 

...
Místní prostředí IR je konstrukce kanálu ADF, kterou můžete použít s aktivitou kopírování k získání nebo přesunu dat do a z Prem nebo datových zdrojů a jímky založených na virtuálních počítačích. Virtuální počítače, které používáte pro místní prostředí IR, se dají umístit do stejné virtuální sítě, jako jsou chráněná úložiště dat pro přístup k těmto úložištím dat z ADF. V případě toků dat dosáhnete stejných výsledků pomocí Azure IR se spravovanými VIRTUÁLNÍmi sítěmi.

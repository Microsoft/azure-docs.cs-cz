...
Přehled trezoru klíčů Azure najdete v tématu [Co je Azure Key Vault?](key-vault-overview.md)
...
Podrobnější pokyny o tom, jak generovat tento balíček BYOK, naleznete v [tématu Jak používat klíče chráněné hsm s trezorem klíčů Azure](key-vault-hsm-protected-keys.md).
...
- Odkazy na programování najdete [v příručce pro vývojáře azure key vaultu.](key-vault-developers-guide.md)

- Informace o azure key vault a hsm, naleznete v [tématu jak používat klíče chráněné hsm s trezorem klíčů Azure](key-vault-hsm-protected-keys.md).

---
title: Kurz – vývoj C# modulu pro Linux pomocí Azure IoT Edge
...
Tento kurz ukazuje, jak vyvíjet modul **C#** pomocí **Visual Studio Code** a nasadit ho do zařízení se **systémem Linux**. Pokud vyvíjíte moduly pro zařízení s Windows, použijte místo toho [vývoj C# modulu IoT Edge pro zařízení s Windows](tutorial-csharp-module-windows.md) .
...
V předchozí části jste vytvořili řešení IoT Edge a Přidali jste kód do CSharpModule. Nový kód filtruje zprávy, kde teplota hlášeného počítače spadá do přípustných limitů. Teď je potřeba sestavit toto řešení jako image kontejneru a odeslat ho do registru kontejneru.

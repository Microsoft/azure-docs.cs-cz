...
V případě okna pro zobrazování překryvných oken povolte možnost `popUp` konfigurace. Obory, které vyžadují souhlas, můžete také předat následujícím způsobem:

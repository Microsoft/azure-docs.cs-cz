...
* Další koncepční informace v tématu věnovaném [protokolům auditu](overview-reports.md#activity-reports).
* Další informace o rozhraní API pro generování sestav v tématu [Začínáme s rozhraním API pro generování sestav Azure Active Directory](concept-reporting-api.md).
...
Než budete moct použít ukázky v tomto článku, musíte dokončit [požadavky pro přístup k rozhraní API pro generování sestav Azure AD](howto-configure-prerequisites-for-reporting-api.md).  
...
* Úplný přehled použití rozhraní API pro generování sestav Azure Active Directory najdete v tématu [Začínáme s rozhraním API pro generování sestav Azure Active Directory](concept-reporting-api.md).
* Další informace o generování sestav Azure Active Directory najdete v tématu [Průvodce generováním sestav Azure Active Directory](overview-reports.md).  

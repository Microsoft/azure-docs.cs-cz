...
1. Do vyhledávacího pole zadejte **Bambu podle Sprout sociální**.
...
1. Na panelu výsledků vyberte **Bambu podle Sprout sociální**a potom klikněte na tlačítko **přidat** tlačítko pro přidání aplikace.
...
1. **[Vytváření Bambu Sprout sociální testovací uživatel](#creating-a-bambu-by-sprout-social-test-user)**  – Pokud chcete mít protějšek Britta Simon Bambu podle Sprout sociálních sítí, který je propojený s Azure AD reprezentace jí.
...
1. Na **Bambu Sprout sociální domény a adresy URL** části uživatel nemá k provedení všech kroků jako aplikace je už předem integrováno s Azure. 
...
1. V seznamu aplikací vyberte **Bambu podle Sprout sociální**.

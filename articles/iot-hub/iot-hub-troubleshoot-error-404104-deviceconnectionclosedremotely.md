...
- Zařízení odeslalo resetování na úrovni protokolu TCP/IP, ale neposlalo `MQTT DISCONNECT`na úrovni aplikace. Zařízení v podstatě zavřelo základní připojení soketu. Tento problém je někdy způsoben chybami ve starších verzích sady Azure IoT SDK.

...
* Doplněním všech požadavků na nabídku pro [Prodej prostřednictvím nabídky Microsoft](./create-new-saas-offer.md#sell-through-microsoft) , jak je uvedeno v části [Vytvoření nabídky SaaS](./create-new-saas-offer.md).
...
Pak se nabídka SaaS může integrovat s [rozhraními API služby měření softwaru Marketplace](./marketplace-metering-service-apis.md) a informovat společnost Microsoft o fakturovaných událostech.
...
Například contoso je vydavatel se službou SaaS s názvem contoso Notification Services (CNS). V případě, že si zákazníci můžou posílat oznámení prostřednictvím e-mailu nebo textu, můžou ho použít. Společnost Contoso je registrovaná jako vydavatel v partnerském centru, aby mohl komerční web Marketplace publikovat nabídky SaaS pro zákazníky Azure.  K propojeným sítím jsou k dispozici dva plány:
...
Podobně jako ceny paušálních sazeb je možné nastavit ceny fakturačních dimenzí podle podporované země nebo oblasti. Vydavatel potřebuje v partnerském centru použít funkci pro import a export dat cen.

1. Nejdřív definujte požadované rozměry a označte, které trhy se podporují. 
1. Pak tato data exportujte do souboru.
...
[![Dimenze služby měření na Marketplace](./media/metering-service-dimentions.png "Kliknutím zobrazíte Zvětšené zobrazení.")](./media/metering-service-dimentions.png)

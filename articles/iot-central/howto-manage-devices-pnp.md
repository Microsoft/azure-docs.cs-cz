...
1. V levé navigační nabídce vyberte **zařízení** . Tady se zobrazí seznam všech zařízení a šablon zařízení.
...
1. V levé navigační nabídce vyberte **zařízení** .
...
Další informace o připojovacích řetězcích a připojení skutečných zařízení k aplikaci IoT Central najdete v tématu [připojení zařízení ve službě Azure IoT Central](concepts-connectivity-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json).
...
1. V navigační nabídce vyberte **zařízení** .

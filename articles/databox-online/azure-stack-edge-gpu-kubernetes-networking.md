...
- [Vystavte bezstavovou aplikaci externě na Azure Stack Edge pro prostřednictvím kuebctl](./azure-stack-edge-gpu-deploy-stateless-application-kubernetes.md).
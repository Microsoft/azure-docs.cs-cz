...
3. **[Vytvoření zkušebního uživatele Yodeck](#create-a-yodeck-test-user)**  – Pokud chcete mít protějšek Britta Simon Yodeck, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **Yodeck domény a adresy URL** části, proveďte následující kroky, pokud chcete nakonfigurovat aplikace v **IDP** iniciované režimu:
...
7. V okně jiné webové prohlížeče Přihlaste se k webu společnosti Yodeck jako správce.

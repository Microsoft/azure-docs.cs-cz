---
title: Nasazení duální aplikace s protokolem IPv6 s nástrojem Load Balancer úrovně Standard v Azure Virtual Network – Šablona správce prostředků (Preview)
...
ms.locfileid: "68295413"
---
# <a name="deploy-an-ipv6-dual-stack-application-with-standard-load-balancer-in-azure---template-preview"></a>Nasazení aplikace s duálním zásobníkem IPv6 s Standard Load Balancer v Azure-Template (Preview)

...
Osvědčeným postupem je zadat účet úložiště diagnostiky v jiné skupině prostředků, než je skupina prostředků pro virtuální počítač. Skupina prostředků se dá považovat za jednotku nasazení s vlastní životností. virtuální počítač se dá nasadit a znovu nasadit, protože se nové konfigurace aktualizují, ale můžete chtít pokračovat v ukládání diagnostických dat do stejného účtu úložiště napříč. Tato nasazení virtuálních počítačů. Když účet úložiště v jiném prostředku povolíte, může účet úložiště přijímat data z různých nasazení virtuálních počítačů, což usnadňuje řešení problémů v různých verzích.

...
* Druhá část tohoto kurzu předpokládá, že jste dokončili [**část**](clustering-model-prepare-data-tutorial.md) a její požadavky.
...
![Graf pravoúhlého grafu](./media/clustering-model-build-tutorial/elbow-graph.png)
...
Čtyři clustery znamenají použití proměnných definovaných v [části 1](clustering-model-prepare-data-tutorial.md#separate-customers):
...
> [Kurz: nasazení modelu clusteringu v jazyce R s Azure SQL Database Machine Learning Services (Preview)](clustering-model-deploy-tutorial.md)

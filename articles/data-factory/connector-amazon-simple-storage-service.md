...
Tento konektor vyžaduje ke kopírování dat z Amazon S3 přístupové klíče pro účet AWS identity and Access Management (IAM). Jsou podporovány také [dočasné přihlašovací údaje zabezpečení](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp.html) .

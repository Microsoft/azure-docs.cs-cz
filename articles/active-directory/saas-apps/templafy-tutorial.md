...
Pokud chcete nakonfigurovat jednotné přihlašování na straně **Templafy** , musíte odeslat **adresu URL federačních metadat aplikace** [týmu podpory Templafy](mailto:support@templafy.com). Toto nastavení nastaví, aby bylo správně nastaveno připojení SAML SSO na obou stranách.

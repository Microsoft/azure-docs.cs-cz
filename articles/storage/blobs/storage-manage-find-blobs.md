---
title: Správa a hledání dat v Azure Blob Storage s využitím indexu objektů BLOB (Preview)
...
## <a name="blob-index-tags-and-data-management"></a>Značky a Správa dat indexu objektu BLOB
...
Volajícím, kteří používají [identitu AAD](../common/storage-auth-aad.md) , se můžou udělit následující oprávnění pro práci se značkami indexu objektů BLOB. 
...
K provozu nad značkami se vyžadují další oprávnění oddělené od základních dat objektů BLOB. Roli Přispěvatel dat objektu BLOB služby Storage budou udělena všechna tři tato oprávnění. Čtečka dat objektů BLOB úložiště bude mít udělené jenom objekty blob najít pomocí značek a získat oprávnění značek objektů BLOB.
...
> [!IMPORTANT]
> Viz část podmínky tohoto článku. Pokud se chcete zaregistrovat ve verzi Preview, přečtěte si část registrace předplatného v tomto článku. Předtím, než budete moci použít index objektu BLOB v účtech úložiště, je třeba zaregistrovat své předplatné.

---
title: Ukázka skriptu Azure CLI – vytvoření virtuálního počítače s Linuxem pomocí Azure Monitoru
description: Ukázka skriptu Azure CLI – vytvoření virtuálního počítače s Linuxem pomocí Azure Monitoru
...
| [azure vm extension set](https://docs.microsoft.com/cli/azure/vm/extension) | Spustí pro virtuální počítač rozšíření virtuálního počítače. V takovém případě rozšíření agenta Azure Monitor se používá k instalaci agenta Log Analytics a zaregistrovat virtuální počítač v pracovním prostoru Log Analytics. |

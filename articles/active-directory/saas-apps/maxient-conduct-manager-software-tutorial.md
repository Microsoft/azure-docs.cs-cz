...
Chcete-li nakonfigurovat jednotné přihlašování na straně **softwaru Maxient** Restore, je třeba odeslat **adresu URL federačních metadat aplikace** [týmu podpory Maxient správce](mailto:support@maxient.com)IT. Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

### <a name="create-maxient-conduct-manager-software-test-user"></a>Vytvořit uživatele testu softwaru Maxient

V této části vytvoříte uživatele s názvem Britta Simon v Maxient software správce. Pokud chcete přidat uživatele na softwarovou platformu Maxient reMaxients Manager, pracujte s [týmem podpory softwaru správce](mailto:support@maxient.com) . Uživatelé musí vytvořit a aktivovat, než použití jednotného přihlašování.

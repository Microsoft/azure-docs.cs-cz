...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/yardione-tutorial/tutorial_yardione_samlbase.png)

3. Na **YardiOne domény a adresy URL** část, proveďte následující kroky:

    ![YardiOne domény a adresy URL jednotné přihlašování informace](./media/yardione-tutorial/tutorial_yardione_url.png)
...
5. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/yardione-tutorial/tutorial_general_400.png)

6. Konfigurace jednotného přihlašování na **YardiOne** straně, budete muset odeslat **adresu Url aplikace federační Metadata** k [tým podpory YardiOne](https://clientcentral.yardi.com). Nastavují toto nastavení tak, aby měl jednotné přihlašování SAML připojení správně nastavena na obou stranách.
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/yardione-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **YardiOne**.
    ...
    ![V seznamu aplikací na YardiOne odkaz](./media/yardione-tutorial/tutorial_yardione_app.png)  

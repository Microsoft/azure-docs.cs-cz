...
* Předplatné Samsung KNOX a Business Services s povoleným jednotným přihlašováním (SSO).
...
1. V jiném okně webového prohlížeče se přihlaste k firemnímu webu Samsung KNOX a Business Services jako správce.
...
1. Na levém bočním panelu klikněte na **nastavení služby Active Directory** a proveďte následující kroky.
    ...
    ![NASTAVENÍ SLUŽBY ACTIVE DIRECTORY](./media/samsung-knox-and-business-services-tutorial/sso-settings.png)
...
V této části vytvoříte uživatele s názvem Britta Simon v Samsung KNOX a Business Services. Pokud chcete přidat uživatele na platformě Samsung KNOX a Business Services, pracujte s [týmem podpory pro Samsung KNOX a firmy](mailto:noreplyk.sec@samsung.com) . Před použitím jednotného přihlašování je nutné vytvořit a aktivovat uživatele.

## <a name="test-sso"></a>Test SSO 

V této části otestujete konfiguraci jednotného přihlašování Azure AD pomocí následujících možností. 

* Kliknutím na **test této aplikace** v Azure Portal. Tím se přesměruje na adresu URL pro přihlášení k Samsung KNOX a obchodním službám, kde můžete spustit tok přihlášení. 

* Přejít přímo na adresu URL pro přihlášení k Samsung KNOX a obchodním službám a spustit tok přihlášení.

* Můžete použít aplikaci Microsoft moje aplikace. Když kliknete na dlaždici Samsung KNOX and Business Services v části Moje aplikace, přesměruje se na adresu URL pro přihlášení k Samsung KNOX a obchodním službám. Další informace o mých aplikacích najdete v tématu [Úvod do mých aplikací](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

...
ms.locfileid: "89398813"
---
# <a name="whats-new-in-azure-front-door"></a>Co je nového v Azure front-dveří?

Přední dveře Azure se aktualizují průběžně. V tomto článku najdete informace o tom, jak se má aktualizovat pomocí nejnovějšího vývoje.
...
Další informace o front-Branch Azure najdete v tématu [co je přední vrátka Azure?](front-door-overview.md)

...
## <a name="try-the-code"></a>Zkuste kód
...
Seznámení se sadou [Media Services Python SDK](https://docs.microsoft.com/python/api/azure-mgmt-media/?view=azure-python)
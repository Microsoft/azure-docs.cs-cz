...
* Vlastní metriky jsou dostupné jenom v podmnožině oblastí Azure. [Tady](../essentials/metrics-custom-overview.md#supported-regions)je popsán seznam podporovaných oblastí.

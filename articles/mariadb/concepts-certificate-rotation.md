...
Pokud používáte certifikát vydaný Azure Database for MariaDB, jak je uvedeno zde, může dojít k přerušení dostupnosti vaší aplikace, protože databáze nebude dostupná. V závislosti na vaší aplikaci může docházet k různým chybovým zprávám, například mimo jiné:
...
Pokud kořenový certifikát neaktualizujete dřív než 15. února 2021 (02/15/2021), vaše aplikace, které se připojují přes protokol SSL/TLS a ověřují pro kořenový certifikát, nebudou moct komunikovat s databázovým serverem MariaDB a aplikace bude mít problémy s připojením k vašemu databázovému serveru MariaDB.
...
Konektor pro konektor používající Azure Integration Runtime používá certifikáty v úložišti certifikátů Windows v prostředí hostovaném v Azure. Tyto certifikáty jsou již kompatibilní s nově použitými certifikáty, takže není nutné provádět žádnou akci.

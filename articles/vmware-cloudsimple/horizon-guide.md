...
* Odhadované prostředky, které jsou potřeba na webu DR, abyste chránili vaše místní prostředí.
...
* Povoluje pouze provoz správy z místní sítě.
...
#### <a name="cloudsimple-portal-escalate-privileges"></a>Portál CloudSimple: Zvýšení úrovně oprávnění
...
#### <a name="vcenter-ui-install-vmware-horizon"></a>uživatelské rozhraní vCenter: Nainstalovat horizont VMware

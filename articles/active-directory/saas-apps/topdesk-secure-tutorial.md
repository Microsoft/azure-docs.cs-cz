...
3. V dialogovém okně **Nový operátor** proveďte následující kroky:
    ...
    ![Operátor new](./media/topdesk-secure-tutorial/ic790611.png "Operátor new")
...
Po kliknutí na dlaždici TOPdesk-Secure na přístupovém panelu byste se měli automaticky přihlášeni k TOPdesk – zabezpečení, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).

...
> [!Note]
> Pokud na paletě příkazů nevidíte příkazy Azure Dev Spaces, ověřte, že máte nainstalované rozšíření VS Code pro Azure Dev Spaces. Be sure the workspace you opened in VS Code is the folder that contains `azds.yaml`.

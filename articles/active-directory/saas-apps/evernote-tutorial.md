...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/evernote-tutorial/tutorial_evernote_samlbase.png)
...
3. Na **Evernote domény a adresy URL** část, proveďte následující kroky, pokud chcete nakonfigurovat aplikace v režimu rozšíření IDP iniciované:
    ...
    ![Evernote domény a adresy URL jednotné přihlašování informace](./media/evernote-tutorial/tutorial_evernote_url.png)

    V **identifikátor** textovému poli, zadejte adresu URL: `https://www.evernote.com/saml2`

4. Zkontrolujte **zobrazit upřesňující nastavení adresy URL** a provést následující krok, pokud chcete nakonfigurovat aplikace **SP** iniciované režimu:

    ![Evernote domény a adresy URL jednotné přihlašování informace](./media/evernote-tutorial/tutorial_evernote_url1.png)
...
6. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/evernote-tutorial/tutorial_general_400.png)
...
9. Přejděte na **'konzoly pro správu.**
    ...
    ![Konzole pro správu](./media/evernote-tutorial/tutorial_evernote_adminconsole.png)
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/evernote-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **Evernote**.
    ...
    ![V seznamu aplikací na Evernote odkaz](./media/evernote-tutorial/tutorial_evernote_app.png)  

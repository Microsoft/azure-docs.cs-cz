...
15. V části **použít dotaz**vyberte **dotaz** . Aktualizujte název tabulky v následujícím dotazu a pak zadejte dotaz. V tabulce vyberete pouze maximální hodnotu `timestamp`. Nezapomeňte vybrat **pouze první řádek**.

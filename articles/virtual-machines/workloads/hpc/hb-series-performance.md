---
title: Výkon velikosti virtuálních počítačů řady HB – virtuální počítače Azure | Dokumenty společnosti Microsoft
description: Přečtěte si o výsledcích testování výkonu pro velikosti virtuálních zařízení řady HB v Azure.
...
ms.locfileid: "79534197"
---
# <a name="hb-series-virtual-machine-sizes"></a>Velikosti virtuálních strojů řady HB

Několik výkonnostních testů bylo spuštěno na velikostech řady HB. Následují některé z výsledků tohoto testování výkonu.


| Úloha                                        | HB                    |
|-------------------------------------------------|-----------------------|
| Stream Triáda                                    | ~260 GB/s (32–33 GB/s za CCX)  |
| Vysoce výkonný linpack (HPL)                  | ~1 000 gigaflopů (rpeak), ~860 gigaflopů (Rmax) |
| Latence RDMA & šířku pásma                        | 2.35usec, 96.5 Gb/s   |
| FIO na lokálním NVMe SSD                           | ~1.7 GB/s čtení, ~1,0 GB/s píše      |  
| IOR na 4 * Azure Premium SSD (P30 spravované disky, RAID0)**  | ~725 MB/s čtení, ~780 MB/zápis   |
...
| #bytes  | Latence [mikrosekunda] (MPICH 3.3 + CH4) | Latence [mikrosekunda] (OpenMPI 4.0.0) | Latence [mikrosekunda] (MVAPICH2 2.3) | Latence [mikrosekunda] (Intel MPI 2019) |
|------|----------|----------|----------|----------|

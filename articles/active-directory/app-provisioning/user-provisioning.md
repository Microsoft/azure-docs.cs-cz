...
Podrobné pokyny k používání SCIM k automatizaci zřizování a rušení zřizování uživatelů a skupin do aplikace najdete v tématu [Vytvoření koncového bodu SCIM a konfigurace zřizování uživatelů](use-scim-to-provision-users-and-groups.md).

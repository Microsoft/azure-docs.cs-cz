...
2. **[Nakonfigurujte jednotné přihlašování GaggleAMP](#configure-gaggleamp-single-sign-on)** – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
...
### <a name="configure-gaggleamp-single-sign-on"></a>Konfigurace jednotného přihlašování GaggleAMP

1. V jiné instanci prohlížeče přejděte na stránku jednotného přihlašování SAML, kterou vám vytvořil tým podpory Gaggle (například: *https://accounts.gaggleamp.com/saml_configurations/oXH8sQcP79dOzgFPqrMTyw/edit* ).
...
2. Na stránce **jednotného přihlašování SAML** proveďte následující kroky:  
    ...
    c. V poli **Adresa URL jednotného přihlašování zprostředkovatele identity** vložte hodnotu **adresy URL pro přihlášení** , kterou jste zkopírovali z Azure Portal.
...
Když na přístupovém panelu kliknete na dlaždici GaggleAMP, měli byste se automaticky přihlásit k GaggleAMP, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

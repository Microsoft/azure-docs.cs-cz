...
## <a name="get-started-with-sql-vms"></a><a id="create"></a>Začínáme s virtuálními aplikacemi SQL
...
* [Sql Server v dokumentaci k Linuxu](https://docs.microsoft.com/sql/linux)

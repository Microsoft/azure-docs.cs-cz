...
|Popis měřiče  |Region (Oblast) |Koeficient  |
|---------|---------|---------|
|Azure Cosmos DB – 100 RU/s/hodina – Asie a Tichomoří – jihovýchod  |  Asie a Tichomoří – jihovýchod    |   1\. místo      |
|Azure Cosmos DB – 100 RU/s/hodina – Asie a Tichomoří – východ |   Asie a Tichomoří – východ   |    1\. místo     |
|Azure Cosmos DB – 100 RU/s/hodina – Evropa – sever|  Evropa – sever       |    1\. místo     |
|Azure Cosmos DB – 100 RU/s/hodina – Korea – jih|    Korea – jih     |     1\. místo    |
|Azure Cosmos DB – 100 RU/s/hodina – Evropa – západ|    Evropa – západ     |      1\. místo   |
...
|Azure Cosmos DB – 100 RU/s/hodina – USA – západ|   USA – západ      |     1\. místo    |
|Azure Cosmos DB – 100 RU/s/hodina – USA – střed| USA – střed        |     1\. místo    |
|Azure Cosmos DB – 100 RU/s/hodina – USA – západ 2|   USA – západ 2      |      1\. místo   |
|Azure Cosmos DB – 100 RU/s/hodina – USA – středozápad|   USA – středozápad      |       1\. místo  |
|Azure Cosmos DB – 100 RU/s/hodina – USA – východ|   USA – východ      |  1\. místo       |
|Azure Cosmos DB – 100 RU/s/hodina – JAR – sever|     JAR – sever    |   1\. místo      |
|Azure Cosmos DB – 100 RU/s/hodina – JAR – západ |    JAR – západ      |    1\. místo     |
...
Sleva, kterou rezervace nabízí, se počítá takto: spotřeba_propustnosti * koeficient_slevy_za_rezervaci_pro_danou_oblast. U oblastí USA (střed) – sever a USA – západ se používá koeficient slevy za rezervaci 1. Celkový počet zlevněných RU/s tedy činí 100 000. Tato hodnota se vypočítává jako: 50 000 * 1 + 50 000 * 1 = 100 000 RU/s. Z toho vyplývá, že nemusíte platit žádné další poplatky s běžnými sazbami pro průběžné platby.

|Popis měřiče | Region (Oblast) |Spotřeba propustnosti (RU/s) |Sleva za rezervaci uplatněná na RU/s |
|---------|---------|---------|---------|
...
Zakoupená rezervace 100 000 RU/s by pokryla celých 75 000 RU/s v oblasti Austrálie – střed 2. Pro oblast Francie – jih tak zbude 25 000 RU/s. Ze zbylých 25 000 RU/s se na oblast Francie – jih uplatní sleva za rezervaci ve výši 15 384 RU/s. Hodnota slevy se vypočítává jako: 25 000/1,625 = 15 384 RU/s. Zbývající 34 616 RU/s v oblasti Francie – jih se naúčtuje podle běžných sazeb pro průběžné platby.

...
4. Do vyhledávacího pole zadejte **portálu pro správu cloudu pro Microsoft Azure**.

    ![Vytváří se testovací uživatele služby Azure AD](./media/newsignature-tutorial/tutorial_newsignature_search.png)

5. Na panelu výsledků vyberte **portálu pro správu cloudu pro Microsoft Azure**a potom klikněte na tlačítko **přidat** tlačítko pro přidání aplikace.
...
3. **[Vytvoření portálu pro správu cloudu pro Microsoft Azure testovacího uživatele](#creating-a-cloud-management-portal-for-microsoft-azure-test-user)**  – Pokud chcete mít protějšek Britta Simon v portálu pro správu cloudu pro Microsoft Azure, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **portálu pro správu cloudu Microsoft Azure domény a adresy URL** části, proveďte následující kroky:

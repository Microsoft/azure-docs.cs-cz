...
1. V souboru *TrustFrameworkExtensions. XML* vyhledejte prvek **OrchestrationStep** , který obsahuje `Order="1"` v cestě uživatele, kterou jste vytvořili.

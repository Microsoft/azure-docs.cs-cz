...
keywords: Příklad Kafka, Kafka Zookeeper, Spark streaming Kafka, Spark streaming Kafka – příklad
...
Chcete-li dokončit tento příklad, postupujte podle kroků `README.md`v části.

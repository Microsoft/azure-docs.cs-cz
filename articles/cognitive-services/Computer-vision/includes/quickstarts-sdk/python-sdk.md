...
Nejprve použijte následující kód pro volání metody **batch_read_file** pro daný obrázek. Tato operace vrátí ID operace a spustí asynchronní proces pro čtení obsahu obrázku.

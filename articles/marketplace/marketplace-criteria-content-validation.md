...
| 6 | Obrázky | <ul><li>Požadavky na Image jsou uvedené v partnerském centru.</li><li>Text zahrnutý na snímku obrazovky je čitelný a obrázek je jasný. | Nabídka řešení je snadno srozumitelná na první pohled. |
...
| 7 | Marketingové artefakty | Loga se zobrazují správně. | <ul><li>Log: malá (48x48 pixelů) a velká (216x216 pixelů) jsou povinná.</li><li>Snímek obrazovky (max. 5): vyžaduje. Obrázek PNG s rozlišením 1280 × 720 pixelů |
...
| 3 | Artefakty Marketplace | Loga se zobrazují správně. |<ul><li>Log: malá (48 x 48 pixelů) a velká (216x216 pixelů) je povinná.</li><li>Snímek obrazovky (max. 5): vyžaduje. Obrázek PNG s rozlišením 1280 x 720 pixelů.|
...
| 9 | Kompetence | Musí mít alespoň jednu z následujících možností kompetence:<ul><li>Vývoj aplikací</li><li>Integrace aplikací</li><li>Správa životního cyklu aplikací</li><li>Cloudová platforma<li>Datové analýzy</li><li>Data Center</li><li>Datová platforma</li><li>DevOps |

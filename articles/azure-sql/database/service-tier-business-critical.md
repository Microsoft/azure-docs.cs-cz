...
ms.locfileid: "84049922"
---
# <a name="business-critical-tier---azure-sql-database--sql-managed-instance"></a>Pro důležité obchodní informaceová vrstva – Azure SQL Database & spravované instance SQL 
...
-   **Dlouho běžící transakce, které upravují data**. Transakce, které jsou otevřeny po delší dobu, brání v zkracování souboru protokolu, což může zvýšit velikost protokolu a počet [virtuálních souborů protokolu (VLF)](https://docs.microsoft.com/sql/relational-databases/sql-server-transaction-log-architecture-and-management-guide#physical_arch). Vysoký počet VLFs může zpomalit obnovení databáze po převzetí služeb při selhání.

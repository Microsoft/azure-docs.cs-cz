...
Azure Active Directory Identity Protection analyzuje konfiguraci a zjistí ohrožení zabezpečení, která může mít vliv na identity vašich uživatelů. Další podrobnosti najdete v tématu [chyb zabezpečení detekovaných službou Azure Active Directory Identity Protection](identity-protection/vulnerabilities.md).
...
Vaše aktivity šetření tak můžete navázat [oznámení](identity-protection/notifications.md) Azure Active Directory Protection odesílá na e-mailu.
...
* [Obnovení riziková přihlášení](identity-protection/flows.md#risky-sign-in-recovery)
* [Riziková přihlášení blokováno](identity-protection/flows.md#risky-sign-in-blocked)  
* [Možnosti přihlašování s Azure AD Identity Protection](identity-protection/flows.md)  
...
* [Dojde k ohrožení bezpečnosti účtu obnovení toku](identity-protection/flows.md#compromised-account-recovery).  
* [Dojde k ohrožení bezpečnosti účtu blokované tok](identity-protection/flows.md#compromised-account-blocked).  
...
* [Tok ověřování službou Multi-Factor Authentication registrace](identity-protection/flows.md#multi-factor-authentication-registration).  
* [Přihlašovací prostředí v Azure AD Identity Protection](identity-protection/flows.md).  
...
* [Povolení služby Azure Active Directory Identity Protection](identity-protection/enable.md)

* [Chyb zabezpečení detekovaných službou Azure Active Directory Identity Protection](identity-protection/vulnerabilities.md)

* [Azure Active Directory rizikových událostí](active-directory-identity-protection-risk-events.md)

* [Oznámení služby Azure Active Directory Identity Protection](identity-protection/notifications.md)

* [Playbook Azure Active Directory Identity Protection](identity-protection/playbook.md)

* [Glosář Azure Active Directory Identity Protection](identity-protection/glossary.md)

* [Možnosti přihlašování s Azure AD Identity Protection](identity-protection/flows.md)

* [Azure Active Directory Identity Protection – jak odblokovat uživatele](identity-protection/howto-unblock-user.md)

* [Začínáme s Azure Active Directory Identity Protection a Microsoft Graph](identity-protection/graph-get-started.md)

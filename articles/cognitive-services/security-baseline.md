...
ms.locfileid: "106076594"
---
# <a name="azure-security-baseline-for-cognitive-services"></a>Základní hodnoty zabezpečení Azure pro Cognitive Services

Tato základní hodnota zabezpečení platí pro Cognitive Services pokynů od [verze 1.0 služby Azure Security test](../security/benchmarks/overview-v1.md) . Azure Security Benchmark poskytuje doporučení, jak můžete zabezpečit svá cloudová řešení v Azure. Obsah je seskupen podle **řízení zabezpečení** definovaného srovnávacím testem zabezpečení Azure a souvisejících pokynů, které se vztahují na Cognitive Services. **Ovládací prvky** , které se nevztahují na Cognitive Services nebo pro které je odpovědnost od Microsoftu, jsou vyloučené.

...
Kubernetes s povoleným ARC Azure aktuálně [podporuje identitu přiřazenou systémem](../../azure-arc/kubernetes/quickstart-connect-cluster.md). Certifikát identity spravované služby používá všechny agenti Kubernetes s podporou ARC Azure pro komunikaci s Azure.
...
Další informace najdete v tématu [Princip fungování identity v Azure monitor](../../azure-monitor/logs/customer-managed-keys.md)

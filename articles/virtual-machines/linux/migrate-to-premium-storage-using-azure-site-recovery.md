---
title: Migrace virtuálních počítačů s Linuxem do Azure Premium Storage pomocí Azure Site Recovery | Dokumentace Microsoftu
...
2. Vyberte **vytvořit prostředek** > **správu** > **zálohování** a **Site Recovery (OMS)**. Alternativně můžete vybrat **Procházet** > **trezor služby Recovery Services** > **přidat**. 
...
* [Nahrát virtuální pevný disk s Linuxem](upload-vhd.md)

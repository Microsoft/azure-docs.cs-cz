...
8. Vyberte **Nastavení účtu** > **vytvořit nebo spravovat úložiště klíčů**. Vytvořte úložiště klíčů zadáním hesla.
...
9. Vraťte se zpátky na obrazovku správce. Pak vyberte **nastavení** > **Operations** > **webové konzole**.
...
Pokud chcete ručně vytvořit uživatele, spolupracujte s [týmem podpory manažera v programu Adobe Experience Manager](https://helpx.adobe.com/support/experience-manager.html) a přidejte uživatele na platformě programu Adobe Experience Manager.

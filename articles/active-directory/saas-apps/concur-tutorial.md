...
2. **[Nakonfigurujte Concur SSO](#configure-concur-sso)** – pro konfiguraci nastavení jednotného přihlašování na straně aplikace.
...
Ke konfiguraci jednotného přihlašování na straně **Concur** je potřeba odeslat stažený **soubor XML federačních metadat** a příslušné zkopírované adresy URL z Azure Portal do [týmu podpory Concur](https://www.concur.co.in/contact). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

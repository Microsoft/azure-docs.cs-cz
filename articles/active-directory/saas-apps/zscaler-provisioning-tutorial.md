...
3. Chcete-li přidat Zscalerem, klikněte na tlačítko **novou aplikaci** tlačítko v horní části dialogového okna.

    ![Tlačítko nové aplikace][3]

4. Do vyhledávacího pole zadejte **Zscalerem**.

    ![Zřizování Zscaler](./media/zscaler-provisioning-tutorial/app-search.png)

5. Na panelu výsledků vyberte **Zscalerem**a potom klikněte na tlačítko **přidat** tlačítko pro přidání Zscalerem do seznamu aplikací SaaS.

    ![Zřizování Zscaler](./media/zscaler-provisioning-tutorial/app-search-results.png)

    ![Zřizování Zscaler](./media/zscaler-provisioning-tutorial/app-creation.png)
...
2. Vyberte Zscalerem ze seznamu aplikací SaaS.

    ![Zřizování Zscaler](./media/zscaler-provisioning-tutorial/app-instance-search.png)

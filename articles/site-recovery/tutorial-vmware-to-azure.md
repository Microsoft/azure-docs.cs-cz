...
* [Příprava VMware v místním prostředí](tutorial-prepare-on-premises-vmware.md)

Než začnete, doporučujeme [zkontrolovat architekturu](concepts-vmware-to-azure-architecture.md) určenou pro scénáře zotavení po havárii.
...
3. Site Recovery zkontroluje, že máte minimálně jednu kompatibilní síť a účet úložiště Azure.
   ...
   ![Karta Cíl](./media/tutorial-vmware-to-azure/storage-network.png)
...
7. V části **Frekvence snímků konzistentní vzhledem k aplikacím** použijte jako frekvenci pro vytváření snímků konzistentních vzhledem k aplikacím výchozí hodnotu 60 minut. Vyberte **OK** a vytvořte zásadu.
   ...
   ![Vytvoření zásady replikace](./media/tutorial-vmware-to-azure/replication-policy.png)

---
title: 'Kurz: Integrace Azure Active Directory se službou Softeon WMS | Dokumentace Microsoftu'
...
ms.locfileid: "39041309"
---
# <a name="tutorial-azure-active-directory-integration-with-softeon-wms"></a>Kurz: Integrace Azure Active Directory se službou Softeon WMS
...
5. Na panelu výsledků vyberte **Softeon WMS**a potom klikněte na tlačítko **přidat** tlačítko pro přidání aplikace.
...
3. **[Vytvoření zkušebního uživatele Softeon WMS](#creating-a-softeon-wms-test-user)**  – Pokud chcete mít protějšek Britta Simon Softeon WMS, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **Softeon WMS domény a adresy URL** části, proveďte následující kroky:

...
- **Iniciované akce škálování** – počet akcí škálování na více instancí a škálování na více instancí iniciované modulem automatického škálování. Můžete filtrovat podle škály na více instancí vs. škálování v akcích.
...
Služba automatického škálování, která je stejná jako u jakéhokoli jiného prostředku Azure, poskytuje [protokoly prostředků](resource-logs-overview.md). Existují dvě kategorie protokolů.

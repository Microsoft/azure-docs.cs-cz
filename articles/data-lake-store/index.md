...
<ul class="panelContent cardsW">
    ...
                        <p><a href="/python/api/azure-mgmt-datalake-store/">Python (správa účtů)</a></p>
                        <p><a href="https://azure-datalake-store.readthedocs.io/en/latest">Python (správa systému souborů)</a></p>
                    </div>
                </div>
            </div>
        </div>

---
title: 'Kurz: Azure Active Directory integrace jednotného přihlašování s Vocoli | Microsoft Docs'
...
ms.locfileid: "69642037"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-vocoli"></a>Kurz: Azure Active Directory integrace jednotného přihlašování s Vocoli
...
Ke konfiguraci jednotného přihlašování na straně **Vocoli** je potřeba odeslat stažený **certifikát (Base64)** a příslušné zkopírované adresy URL z Azure Portal do [týmu podpory Vocoli](mailto:inbox@vocoli.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

### <a name="create-vocoli-test-user"></a>Vytvořit testovacího uživatele Vocoli

V této části vytvoříte uživatele s názvem B. Simon v Vocoli. Pokud chcete přidat uživatele na platformě Vocoli, pracujte s [týmem podpory Vocoli](mailto:inbox@vocoli.com) . Uživatelé musí vytvořit a aktivovat, než použití jednotného přihlašování.

...
Po povolení MSI na prostředek Azure [například virtuální počítač Azure](qs-configure-powershell-windows-vm.md):
...
- Pokud chcete povolit MSI ve virtuálním počítači Azure, najdete v části [konfigurace Azure virtuálního počítače spravované služby Identity (MSI) pomocí prostředí PowerShell](qs-configure-powershell-windows-vm.md).

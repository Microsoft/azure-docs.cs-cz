...
Po kliknutí na dlaždici helpdesku Jitbit na přístupovém panelu byste se měli automaticky přihlášeni k helpdesku Jitbit, pro kterou jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).

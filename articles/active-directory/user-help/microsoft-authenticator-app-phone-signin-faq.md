...
Pokud vaše organizace má zapnuté toto nové prostředí, budete mít k zapnutí a použít přihlášení telefonem z aplikace Microsoft Authenticator.

### <a name="to-turn-on-phone-sign-in-for-your-account"></a>Chcete-li na telefonu přihlášení pro váš účet

- **Pokud máte tuto ikonu ![ikonu, zobrazí se v něm mít všechno nastavené](media/microsoft-authenticator-app-phone-signin-faq/icon.png) na váš telefon.** Jste již nastavili přihlašování telefonem. Může se zobrazit výzva k upgradu vašeho účtu na přidání nabízených oznámení, takže můžete být upozorněni o žádosti o ověření mimo aplikaci. 

- **Pokud už používáte aplikaci Microsoft Authenticator pro dvoustupňové ověřování.** Přejděte na účty obrazovku aplikace, vyberte šipku rozevíracího seznamu pro váš pracovní nebo školní účet a potom vyberte **povolit přihlašování telefonem**. 
...
- **Pokud nepoužíváte aplikaci Microsoft Authenticator.** Stáhněte si a nainstalujte si aplikaci Microsoft Authenticator a pak přidat svému osobnímu účtu Microsoft přihlásíte k účtu z obrazovky přidat účty z aplikace Microsoft Authenticator. Další informace najdete v tématu [Začínáme s aplikací Microsoft Authenticator](microsoft-authenticator-app-how-to.md).
...
|**To nahradit dvoustupňové ověřování? Doporučujeme zapnout ho?**| Pracujeme na rozšířit rozsah přihlášení telefonem, ale zatím stále existují míst v ekosystému Microsoft s omezenou podporou. Na těchto místech stále používáme dvoustupňové ověřování pro zabezpečené přihlašování. Z tohoto důvodu Ne, by neměla vypnete dvoustupňové ověřování pro váš účet.|

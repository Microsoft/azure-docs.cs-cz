...
**Příklad**: mohu nasadit virtuální počítač s použitím B1ms velikosti pro databáze aplikaci čas (krátkodobé používání) a účast. Tato velikost umožňuje aplikaci používat jako Moje směrného plánu, který je 0,2 kredity za minutu, které můžete použít nebo banka až 20 % virtuální procesor. 

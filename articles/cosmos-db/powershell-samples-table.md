...
description: Získání ukázek Azure PowerShell k provádění různých běžných úloh v účtech rozhraní API pro Azure Cosmos DB tabulky
author: markjbrown
...
|[Uzamčení prostředků před odstraněním](scripts/powershell/table/powershell-table-lock.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Zabránit odstranění prostředků s zámky prostředků |
|||

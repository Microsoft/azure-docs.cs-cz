...
Po kliknutí na dlaždici konektoru SecureW2 JoinNow na přístupovém panelu byste měli být automaticky přihlášení ke konektoru SecureW2 JoinNow, pro který jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).

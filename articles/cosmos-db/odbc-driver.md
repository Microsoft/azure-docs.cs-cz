...
1. Otevřít **správce zdrojů dat ODBC** aplikace ve vašem počítači, Uděláte to tak zadáním **zdroje dat ODBC** pole vyhledávání v Windows. 
...
1. V **Azure Cosmos DB ODBC – ovladače SDN nastavení** vyplňte následující: 

---
title: Ingestování dat pomocí knihovny Pythonu v Azure Průzkumník dat
description: V tomto článku se naučíte přijímat (načítat) data do Azure Průzkumník dat pomocí Pythonu.
author: orspod
ms.author: orspodek
ms.reviewer: mblythe
...
Teď sestavte připojovací řetězec. V tomto příkladu se pro přístup ke clusteru používá ověřování pomocí zařízení. Můžete také použít [certifikát aplikace AAD](https://github.com/Azure/azure-kusto-python/blob/master/azure-kusto-data/tests/sample.py#L24), [klíč aplikace AAD](https://github.com/Azure/azure-kusto-python/blob/master/azure-kusto-data/tests/sample.py#L20)a [uživatele a heslo AAD](https://github.com/Azure/azure-kusto-python/blob/master/azure-kusto-data/tests/sample.py#L34).
...
Namapujte příchozí data CSV na názvy sloupců a datové typy použité při vytváření tabulky. Tato data mapuje zdrojová datová pole do cílových sloupců tabulky.
...
## <a name="query-data-that-was-ingested-into-the-table"></a>Dotazování dat, která byla ingestovaná do tabulky

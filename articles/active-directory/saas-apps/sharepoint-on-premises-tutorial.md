...
4. **[Udělit přístup pro SharePoint v místním testovacího uživatele](#grant-access-to-sharepoint-on-premises-test-user)**  – Pokud chcete mít protějšek Britta Simon v místní SharePoint, který je propojený s Azure AD reprezentace uživatele.

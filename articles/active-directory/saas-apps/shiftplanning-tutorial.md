...
4. Do vyhledávacího pole zadejte **lidskosti**.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/shiftplanning-tutorial/tutorial_humanity_search.png)

5. Na panelu výsledků vyberte **lidskosti**a potom klikněte na **přidat** tlačítko Přidat aplikaci.

    ![Vytváření testovacího uživatele Azure AD](./media/shiftplanning-tutorial/tutorial_humanity_addfromgallery.png)
...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Konfigurovat jednotné přihlašování](./media/shiftplanning-tutorial/tutorial_humanity_samlbase.png)

3. Na **lidskosti domény a adresy URL** část, proveďte následující kroky:

    ![Konfigurovat jednotné přihlašování](./media/shiftplanning-tutorial/tutorial_humanity_url.png)
...
4. Na **SAML podpisový certifikát** klikněte na tlačítko **certifikátu (Base64)** a potom uložte soubor certifikátu v počítači.
    ...
    ![Konfigurovat jednotné přihlašování](./media/shiftplanning-tutorial/tutorial_humanity_certificate.png) 

5. Klikněte na tlačítko **Uložit** tlačítko.

    ![Konfigurovat jednotné přihlašování](./media/shiftplanning-tutorial/tutorial_general_400.png)
...
6. Na **lidskosti konfigurace** klikněte na tlačítko **konfigurace lidskosti** otevřete **konfigurovat přihlášení** okno. Kopírování **SAML jeden přihlašování adresa URL služby a adresu URL Sign-Out** z **Stručná referenční příručka části.**
    ...
    ![Konfigurovat jednotné přihlašování](./media/shiftplanning-tutorial/tutorial_humanity_configure.png) 
...
1. V **portál Azure**, v levém navigačním podokně klikněte na tlačítko **Azure Active Directory** ikonu.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/shiftplanning-tutorial/create_aaduser_01.png) 

2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin** a klikněte na tlačítko **všichni uživatelé**.
    
    ![Vytváření testovacího uživatele Azure AD](./media/shiftplanning-tutorial/create_aaduser_02.png) 

3. Chcete-li otevřít **uživatele** dialogové okno, klikněte na tlačítko **přidat** horní dialogové okno.
 
    ![Vytváření testovacího uživatele Azure AD](./media/shiftplanning-tutorial/create_aaduser_03.png) 

4. Na **uživatele** dialogové okno stránky, proveďte následující kroky:
 
    ![Vytváření testovacího uživatele Azure AD](./media/shiftplanning-tutorial/create_aaduser_04.png) 
...
4. V části **akce**, klikněte na tlačítko **přidat zaměstnanci**.
    ...
    ![Přidat zaměstnanci](./media/shiftplanning-tutorial/iC786624.png "přidat zaměstnanci")

5. V **přidat zaměstnanci** část, proveďte následující kroky:
   
    ![Uložit zaměstnanci](./media/shiftplanning-tutorial/iC786625.png "uložit zaměstnanci")
...
2. V seznamu aplikací vyberte **lidskosti**.
    ...
    ![Konfigurovat jednotné přihlašování](./media/shiftplanning-tutorial/tutorial_humanity_app.png) 

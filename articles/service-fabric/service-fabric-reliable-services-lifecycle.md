...
3. Paralelně probíhají následující akce:
    - `StatefulServiceBase.CreateServiceReplicaListeners()`je vyvolána. 
      ...
      - Pokud je služba Sekundární službou, otevírají se jenom ty naslouchací procesy označené `ListenOnSecondary = true` jako. Naslouchací procesy, které jsou otevřeny na sekundárních počítačích, jsou méně běžné.

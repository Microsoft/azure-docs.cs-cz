...
Je také možné spustit WebLogic Server v Azure Virtual Machines. Tato řešení jsou popsaná v [tomto článku společnosti Microsoft](/azure/virtual-machines/workloads/oracle/oracle-weblogic).
...
:::image type="content" source="media/oracle-weblogic/weblogic-architecture-aks.png" alt-text="K nasazení WebLogic serveru na AKS můžete použít ukázkové skripty.":::

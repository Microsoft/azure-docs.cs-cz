...
Pokud vaše školicí soubory nejsou umístěny v úložišti Git ve vývojovém prostředí, nebo není k dispozici příkaz `git`, nebudou sledovány žádné informace týkající se Gitu.
...
> ```
>
> Pokud je nainstalovaná, a v cestě, dostanete odpověď podobnou `git version 2.4.1`. Další informace o instalaci Gitu do vývojového prostředí najdete na [webu Git](https://git-scm.com/).

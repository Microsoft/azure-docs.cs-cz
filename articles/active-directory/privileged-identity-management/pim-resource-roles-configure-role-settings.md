---
title: Konfigurace nastavení role prostředků Azure v PIM – Azure Active Directory | Dokumentace Microsoftu
...
ms.locfileid: "59494863"
---
# <a name="configure-azure-resource-role-settings-in-pim"></a>Konfigurace nastavení role prostředků Azure v PIM

Při konfiguraci nastavení role prostředků Azure, můžete definovat výchozí nastavení, které se použijí na přiřazení role prostředků Azure v Azure Active Directory (Azure AD) Privileged Identity Management (PIM). Použijte následující postupy ke konfiguraci pracovního postupu schvalování a určit, kdo může schválit nebo zamítnout žádosti.
...
| | |
| --- | --- |
| **Povolit trvalé přiřazení oprávnění** | Správci prostředků můžete přiřadit trvalé oprávněné členství. |

---
title: Model služby Azure Service Fabric složitých typů schématu XML | Microsoft Docs
...
Pokud má kontejner povolené HEALTHCHECK a Docker hlásí událost health_status pro tento kontejner, Service Fabric bude zahrnovat stav hlášený systémem. Pokud health_status není v pořádku, Service Fabric oznámí upozornění na stav. Ve výchozím nastavení je nastavena na hodnotu true.
...
Pokud má kontejner povolen HEALTHCHECK a Docker hlásí událost health_status pro tento kontejner, Service Fabric restartuje kontejner, pokud health_status hlášený pomocí Docker není v pořádku.
...
Práva pro udělení: Číst, měnit nebo zaplněno. Výchozí hodnota je přečtena.
...
#### <a name="resourcetype"></a>Typ prostředku

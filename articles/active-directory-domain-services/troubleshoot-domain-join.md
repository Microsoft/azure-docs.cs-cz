...
1. Zkuste použít příkaz k otestování domény pomocí názvu domény spravované domény Azure služba AD DS, například `ping aaddscontoso.com`.
    * Pokud se odpověď na příkaz k odeslání nezdařila, zkuste provést příkaz k zadání adresy IP pro doménu zobrazenou na stránce Přehled na portálu pro spravovanou doménu Azure služba AD DS `ping 10.0.0.4`, jako je například.

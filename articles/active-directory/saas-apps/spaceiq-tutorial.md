...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/spaceiq-tutorial/tutorial_spaceiq_samlbase.png)

3. Na **SpaceIQ domény a adresy URL** část, proveďte následující kroky:

    ![SpaceIQ domény a adresy URL jednotné přihlašování informace](./media/spaceiq-tutorial/tutorial_spaceiq_url.png)
...
5. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/spaceiq-tutorial/tutorial_general_400.png)
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/spaceiq-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **SpaceIQ**.
    ...
    ![V seznamu aplikací na SpaceIQ odkaz](./media/spaceiq-tutorial/tutorial_spaceiq_app.png)  

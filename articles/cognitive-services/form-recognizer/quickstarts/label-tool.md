...
> ![instalaci CORS v Azure Portal](../media/label-tool/cors-setup.png)
...
Kliknutím na ikonu vlaku (automobil auto) v levém podokně otevřete stránku školení. Potom kliknutím na tlačítko **výuka** začněte s modelem školení. Po dokončení procesu školení se zobrazí následující informace:
...
V tomto rychlém startu jste se dozvěděli, jak pomocí nástroje pro rozpoznávání popisů formulářů vytvořit výuku modelu s ručně označenými daty. Pokud chcete nástroj pro označování integrovat do vlastní aplikace, použijte rozhraní REST API, která se týkají školení s popisky dat.

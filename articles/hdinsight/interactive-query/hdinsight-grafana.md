---
title: Použít Grafana v Azure HDInsight | Microsoft Docs
description: Další informace o přístupu k Grafana v Azure HDInsight
services: hdinsight
documentationcenter: ''
author: mumian
manager: cgronlun
...
---
# <a name="access-grafana-in-azure-hdinsight"></a>Grafana přístup v Azure HDInsight


Grafana je Oblíbené, open-source grafu a řídicí panel Tvůrce. Grafana je funkce bohaté; nejen nemá umožní uživatelům vytvářet přizpůsobitelné a ke sdílení řídicích panelů, nabízí také podle šablony nebo skripty řídicí panely, integrace protokolu LDAP, více zdrojů dat a další.

V současné době Grafana je podporovat pouze podle typu clusteru interaktivní dotazu v Azure HDInsight.
...
V této části vytvoříte clusteru služby interaktivní dotazu v HDInsight pomocí šablony Azure Resource Manager. Zkušenosti se šablonami Resource Manageru se k postupu podle tohoto článku nevyžadují. 

1. Klikněte na následující tlačítko **Nasadit do Azure**, přihlaste se do Azure a otevřete šablonu Resource Manageru na webu Azure Portal. 
...
2. Vyberte **clustery HDInsight**a pak vyberte název clusteru, který jste vytvořili v poslední části.
...
4. Na řídicím panelu, klikněte **Grafana** dlaždici.
5. Zadejte přihlašovací údaje clusteru Hadoop.
6. Řídicí panel Grafana vypadá takto:

    ![Řídicí panel HDInsight Grafana](./media/hdinsight-grafana/hdinsight-grafana-dashboard.png "HDInsight Grafana řídicí panel")

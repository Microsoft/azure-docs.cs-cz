...
4. Do vyhledávacího pole zadejte **RunMyProcess**.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/runmyprocess-tutorial/tutorial_runmyprocess_search.png)

5. Na panelu výsledků vyberte **RunMyProcess**a potom klikněte na **přidat** tlačítko Přidat aplikaci.

    ![Vytváření testovacího uživatele Azure AD](./media/runmyprocess-tutorial/tutorial_runmyprocess_addfromgallery.png)
...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Konfigurovat jednotné přihlašování](./media/runmyprocess-tutorial/tutorial_runmyprocess_samlbase.png)

3. Na **RunMyProcess domény a adresy URL** část, proveďte následující kroky:

    ![Konfigurovat jednotné přihlašování](./media/runmyprocess-tutorial/tutorial_runmyprocess_url.png)
...
4. Na **SAML podpisový certifikát** klikněte na tlačítko **certifikátu (Base64)** a potom uložte soubor certifikátu v počítači.
    ...
    ![Konfigurovat jednotné přihlašování](./media/runmyprocess-tutorial/tutorial_runmyprocess_certificate.png) 

5. Klikněte na tlačítko **Uložit** tlačítko.

    ![Konfigurovat jednotné přihlašování](./media/runmyprocess-tutorial/tutorial_general_400.png)
...
6. Na **RunMyProcess konfigurace** klikněte na tlačítko **konfigurace RunMyProcess** otevřete **konfigurovat přihlášení** okno. Kopírování **Sign-Out adresu URL a SAML jeden přihlašování služby URL** z **Stručná referenční příručka části.**
    ...
    ![Konfigurovat jednotné přihlašování](./media/runmyprocess-tutorial/tutorial_runmyprocess_configure.png) 
...
1. V **portál Azure**, v levém navigačním podokně klikněte na tlačítko **Azure Active Directory** ikonu.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/runmyprocess-tutorial/create_aaduser_01.png) 

2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin** a klikněte na tlačítko **všichni uživatelé**.
    
    ![Vytváření testovacího uživatele Azure AD](./media/runmyprocess-tutorial/create_aaduser_02.png) 

3. Chcete-li otevřít **uživatele** dialogové okno, klikněte na tlačítko **přidat** horní dialogové okno.
 
    ![Vytváření testovacího uživatele Azure AD](./media/runmyprocess-tutorial/create_aaduser_03.png) 

4. Na **uživatele** dialogové okno stránky, proveďte následující kroky:
 
    ![Vytváření testovacího uživatele Azure AD](./media/runmyprocess-tutorial/create_aaduser_04.png) 
...
2. V seznamu aplikací vyberte **RunMyProcess**.
    ...
    ![Konfigurovat jednotné přihlašování](./media/runmyprocess-tutorial/tutorial_runmyprocess_app.png) 

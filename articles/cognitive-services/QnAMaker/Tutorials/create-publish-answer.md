...
Pokud chcete odpověď omezit na jenom otázky, přidejte do těla vlastnosti `[rankerType](Learn more about [rankerType](../concepts/best-practices.md#choosing-ranker-type).
)`, například: 

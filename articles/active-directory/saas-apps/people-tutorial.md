...
4. Do vyhledávacího pole zadejte **osoby**.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/people-tutorial/tutorial_people_search.png)

5. Na panelu výsledků vyberte **osoby**a potom klikněte na **přidat** tlačítko Přidat aplikaci.

    ![Vytváření testovacího uživatele Azure AD](./media/people-tutorial/tutorial_people_addfromgallery.png)
...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Konfigurovat jednotné přihlašování](./media/people-tutorial/tutorial_people_samlbase.png)

3. Na **uživatelé domény a adresy URL** část, proveďte následující kroky:

    ![Konfigurovat jednotné přihlašování](./media/people-tutorial/tutorial_people_url.png)

    a. V **přihlašovací adresa URL** textovému poli, zadejte adresu URL pomocí následujícího vzorce:  `https://<company name>.peoplehr.net`

    b. V **identifikátor** textovému poli, zadejte adresu URL: `https://www.peoplehr.com`
    ...
    > [!NOTE]
    > Tyto hodnoty nejsou skutečné. Tyto hodnoty aktualizujte skutečná adresa URL odpovědi a přihlašovací adresa URL. Obraťte se na [tým podpory osoby klienta](mailto:customerservices@peoplehr.com) k získání těchto hodnot. 
...
5. Na **SAML podpisový certifikát** klikněte na tlačítko **soubor XML s metadaty** a potom uložte soubor metadat ve vašem počítači.
    ...
    ![Konfigurovat jednotné přihlašování](./media/people-tutorial/tutorial_people_certificate.png) 

6. Klikněte na tlačítko **Uložit** tlačítko.

    ![Konfigurovat jednotné přihlašování](./media/people-tutorial/tutorial_general_400.png)
...
8. V nabídce na levé straně klikněte na tlačítko **nastavení**.
    ...
    ![Konfigurovat jednotné přihlašování](./media/people-tutorial/tutorial_people_001.png)

9. Klikněte na tlačítko **společnosti**.

    ![Konfigurovat jednotné přihlašování](./media/people-tutorial/tutorial_people_002.png)

10. Na **nahrávání, jednotné přihlašování, SAML metadata souboru**, klikněte na tlačítko **Procházet** nahrát soubor stažený metadat.

    ![Konfigurovat jednotné přihlašování](./media/people-tutorial/tutorial_people_003.png)
...
1. V **portál Azure**, v levém navigačním podokně klikněte na tlačítko **Azure Active Directory** ikonu.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/people-tutorial/create_aaduser_01.png) 

2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin** a klikněte na tlačítko **všichni uživatelé**.
    
    ![Vytváření testovacího uživatele Azure AD](./media/people-tutorial/create_aaduser_02.png) 

3. Chcete-li otevřít **uživatele** dialogové okno, klikněte na tlačítko **přidat** horní dialogové okno.
 
    ![Vytváření testovacího uživatele Azure AD](./media/people-tutorial/create_aaduser_03.png) 

4. Na **uživatele** dialogové okno stránky, proveďte následující kroky:
 
    ![Vytváření testovacího uživatele Azure AD](./media/people-tutorial/create_aaduser_04.png) 
...
2. V seznamu aplikací vyberte **osoby**.
    ...
    ![Konfigurovat jednotné přihlašování](./media/people-tutorial/tutorial_people_app.png) 

...
Každý prostředek můžete zašifrovat i pomocí několika typů šifrování (AES-128, PlayReady, Widevine, FairPlay). V článku [Typy streamovacích protokolů a šifrování](drm-content-protection-concept.md#streaming-protocols-and-encryption-types) se dozvíte, jaké kombinace dávají smysl. Viz také [jak chránit pomocí DRM](drm-protect-with-drm-tutorial.md).
...
> [Ochrana pomocí DRM](drm-protect-with-drm-tutorial.md)

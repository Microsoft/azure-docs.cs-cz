---
title: Ukázka kódu JSON pro Azure Policy – Vytvoření virtuálního počítače, který používá spravovaný disk | Microsoft Docs
description: Tato ukázková zásada JSON vyžaduje, aby virtuální počítače používaly spravované disky.

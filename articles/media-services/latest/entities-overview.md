...
ms.locfileid: "53746002"
---
# <a name="azure-media-services-entities-overview"></a>Přehled entity služby Azure Media Services

Tento článek poskytuje stručný přehled entit Azure Media Services a bodů na příslušný článek pro další informace o každé entity. 

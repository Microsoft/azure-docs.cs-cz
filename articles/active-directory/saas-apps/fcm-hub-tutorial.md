...
Po kliknutí na dlaždici centra FCM na přístupovém panelu byste měli být automaticky přihlášení do centra FCM, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).
...
- [Postup ochrany centra FCM s pokročilou viditelností a ovládacími prvky](/cloud-app-security/proxy-intro-aad)
...
ms.locfileid: "47057880"
---
# <a name="how-to-close-active-risk-events"></a>Postupy: Zavřete aktivní rizikových událostí
...
Tím, že nakonfigurujete [zásady rizik podmíněného přístupu uživatelů](howto-user-risk-policy.md), mohou vyžadovat změnu hesla, pokud byla automaticky zjištěna úroveň rizika zadaného uživatele. 

![Resetování hesla](./media/howto-close-active-risk-events/13.png)

Resetování hesla ukončí všechny aktivní rizika události související uživatele a přináší identitu zpátky do bezpečného stavu. Použití zásady rizik uživatelů je upřednostňovanou metodou zavřete aktivní rizikové události, protože tato metoda je automatické. Je teď součinnosti mezi ovlivněné uživatele a pomoc HelpDesk nebo správce.

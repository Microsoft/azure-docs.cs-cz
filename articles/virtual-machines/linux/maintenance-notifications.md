...
Informace o plánované údržbě můžete zobrazit pomocí [azure vm get-instance-view](/cli/azure/vm?view=azure-cli-latest#az_vm_get_instance_view).
...
Pokud máte starší verze virtuálních počítačů, které byly nasazené pomocí modelu nasazení classic, je použití 1.0 rozhraní příkazového řádku k dotazování služby pro virtuální počítače a zahájení údržby.
...
**Odpověď:** plánovaná údržba je nyní k dispozici pro Škálovací sady virtuálních počítačů. Pokyny o tom, jak inicializovat samoobslužné údržby najdete v části "Jak do -> Spravovat -> Plánovaná Údržba" ve Škálovací sadě virtuálních počítačů dokumentace.

**Otázka: co se děje Cloud Services (Role Web/Worker) a Service Fabric?**

**Odpověď:** při plánovaná údržba těchto platforem týká, zákazníci, kteří používají tyto platformy jsou považovány za bezpečné zadaný tento jenom virtuální počítače v jedné aktualizační doméně (UD) bude mít dopad v daném okamžiku. Samoobslužné údržby není aktuálně k dispozici pro cloudové služby (Web/Role pracovního procesu) a Service Fabric.

...
Ke konfiguraci jednotného přihlašování na straně **MyVR** je potřeba odeslat stažený **certifikát (Base64)** a příslušné zkopírované adresy URL z Azure Portal do [týmu podpory MyVR](mailto:arno.vandenberg@Kronos.com). Toto nastavení nastaví, aby bylo správně nastaveno připojení SAML SSO na obou stranách.
...
Když na přístupovém panelu kliknete na dlaždici MyVR, měli byste se automaticky přihlásit k MyVR, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).

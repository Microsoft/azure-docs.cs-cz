...
1. Zadejte **název** klíče zásad. například `AADAppSecret`.  `B2C_1A_` předpony se automaticky přidají do názvu klíče při jeho vytvoření, takže jeho odkaz v XML v následující části se *B2C_1A_AADAppSecret*.

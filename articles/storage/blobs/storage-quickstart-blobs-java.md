...
Aplikace pozastaví vstup uživatele voláním `System.console().readLine()` předtím, než odstraní objekt blob, kontejner a místní soubory. Tato možnost je vhodná pro ověření, že se prostředky správně vytvořily, než se odstraní.
...
* Výukové programy, ukázky, rychlé starty a další dokumentace najdete na webu [Azure pro vývojáře v jazyce Java pro Cloud](/azure/java/).

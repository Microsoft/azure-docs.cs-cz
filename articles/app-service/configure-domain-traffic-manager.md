...
> [!NOTE]
> Pokud se záznam už používá a vy k němu potřebujete na něj navazovat vazby, můžete vytvořit další záznam CNAME. Pokud třeba chcete do vaší aplikace bez přerušení navazovat vazby **webové\.contoso.com** , vytvořte záznam CNAME z **awverify. www** do **contoso.trafficmanager.NET**. Do své aplikace pak můžete přidat "www\.contoso.com", aniž byste museli měnit "www" záznam CNAME. Další informace najdete v tématu [migrace aktivního názvu DNS na Azure App Service](manage-custom-dns-migrate-domain.md).
...
> [!NOTE]
> Může trvat nějakou dobu, než se váš CNAME rozšíří přes systém DNS. K ověření, že je záznam CNAME k dispozici, můžete použít službu, například <a href="https://www.digwebinterface.com/">https://www.digwebinterface.com/</a> .
> 
> 

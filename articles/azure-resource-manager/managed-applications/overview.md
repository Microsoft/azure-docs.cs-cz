...
> [!NOTE]
> Dříve byla dokumentace k poskytovatelům zákazníků Azure zahrnuta v dokumentaci pro spravované aplikace. Tato dokumentace byla přesunuta. Nyní si přečtěte téma [Custom Providers pro Azure](../custom-providers/overview.md).

...
1. Položky ve vašem seznamu ke zhlédnutí jsou automaticky extrahovány pro váš dotaz a zobrazí se na kartě **výsledky** . Následující příklad ukazuje výsledky extrakce polí **servername** a **IPAddress** .
    ...
    :::image type="content" source="./media/watchlists/sentinel-watchlist-queries-fields.png" alt-text="seznamu ke zhlédnutí zdrojová stránka" lightbox="./media/watchlists/sentinel-watchlist-queries-fields.png":::

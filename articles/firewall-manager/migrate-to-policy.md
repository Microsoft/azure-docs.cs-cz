...
Skript `AZFWMigrationScript.ps1` vytvoří FirewallPolicy se třemi RuleCollectionGroup objekty pro ApplicationRuleCollections, NetworkRuleCollections a NatRuleCollections. 

...
| [Přidat-AzVpnClientRootCertificate](/powershell/module/az.network/add-azvpnclientrootcertificate) | Nahraje informace o veřejném klíči kořenového certifikátu do brány sítě VPN.|
...
| [Nový certifikát s vlastním podpisem](https://docs.microsoft.com/powershell/module/pkiclient/new-selfsignedcertificate?view=win10-ps) | Vytvoří nový kořenový certifikát podepsaný svým držitelem. |

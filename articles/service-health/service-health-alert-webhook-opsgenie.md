...
1.  Zkopírujte a uložte **adresu URL integrace**, která by již měla obsahovat váš `apiKey` připojenou ke konci.
...
1. Požadavek HTTP POST vytvoříte takto:
    ...
    ```
1. Měli byste obdržet odpověď `200 OK` se zprávou o stavu úspěšné.

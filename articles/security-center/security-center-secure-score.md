...
> [!NOTE]
> Tento článek se týká předchozí verze zabezpečeného skóre. Toto zabezpečené prostředí skóre je stále k dispozici z uživatelského rozhraní, ale v průběhu času bude ukončeno. Prostředí se dvěma zabezpečenými výsledky fungují souběžně a umožňují hladký přechod.
>
> Podrobnosti o novějším bezpečném skóre najdete [tady](secure-score-security-controls.md).
>

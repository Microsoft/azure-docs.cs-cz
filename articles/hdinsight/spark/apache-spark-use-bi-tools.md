...
4. Do textového pole **Server** zadejte adresu URL clusteru (ve formuláři `mysparkcluster.azurehdinsight.net`).
...
9. Přejděte do **souboru** > **Uložit**, zadejte název `BuildingTemperature` souboru a pak vyberte **Uložit**.
...
V tomto kurzu jste zjistili, jak používat [Microsoft Power BI](https://powerbi.microsoft.com/) k vizualizaci dat v clusteru Apache Spark ve [službě Azure HDInsight](https://azure.microsoft.com/services/hdinsight/). V dalším článku se dozvíte, jak můžete vytvořit aplikaci Machine Learning.

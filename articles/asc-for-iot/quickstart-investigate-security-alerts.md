...
description: Seznamte se s podrobnostmi a prozkoumáním Azure Security Center pro výstrahy zabezpečení IoT na zařízeních IoT.
...
ms.locfileid: "88068559"
---
# <a name="quickstart-investigate-security-alerts"></a>Rychlý Start: Prozkoumejte výstrahy zabezpečení

Toto je nejlepší způsob, jak zajistit dodržování předpisů a ochranu v rámci řešení IoT, plánované šetření a náprava výstrah vydaných Azure Security Center pro IoT.
...
V dalším článku se dozvíte víc o Azure Security Center typech výstrah a možných úpravách...

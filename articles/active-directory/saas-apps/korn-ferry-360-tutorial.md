...
Další informace o integraci aplikací SaaS s Azure AD najdete v tématu [co je přístup k aplikacím a jednotné přihlašování pomocí Azure Active Directory](https://docs.microsoft.com/azure/active-directory/what-is-single-sign-on).
...
Chcete-li nakonfigurovat jednotné přihlašování na straně **Korn trajekt 360** , je třeba odeslat stažený **certifikát (Base64)** a příslušné zkopírované adresy URL z Azure Portal pro [Korn tým podpory Korn SLAT 360](mailto:george.gold@kornferry.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

### <a name="create-korn-ferry-360-test-user"></a>Vytvoření testovacího uživatele pro Korn trajekt 360

V této části vytvoříte uživatele s názvem B. Simon v Korn trajekt 360. Pokud chcete přidat uživatele na platformě Korn trajekt 360, pracujte s [týmem podpory Korn trajekt 360](mailto:george.gold@kornferry.com) . Uživatelé musí vytvořit a aktivovat, než použití jednotného přihlašování.

## <a name="test-sso"></a>Test SSO 

V této části Testování služby Azure AD jednotné přihlašování – konfigurace pomocí přístupového panelu.

Po kliknutí na dlaždici Korn trajekt 360 na přístupovém panelu byste měli být automaticky přihlášeni ke službě Korn trajekt 360, pro kterou jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

---
title: 'Rychlý Start: provedení hledání na webu pomocí C#-Vyhledávání na webu Bingu REST API'
titleSuffix: Azure Cognitive Services
description: Pomocí tohoto rychlého startu můžete odesílat požadavky na Vyhledávání na webu Bingu REST API pomocí jazyka C# a přijímat odpověď JSON.

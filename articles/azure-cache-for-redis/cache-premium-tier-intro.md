...
* Primární a sekundární uzly mezipaměti
* Při použití s clusteringem mezipaměť premium, abyste restartovali primární, sekundární nebo oba uzly pro jednotlivých horizontálních oddílů v mezipaměti

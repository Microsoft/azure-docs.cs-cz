...
- Pokud potřebujete na seznam povolených IP adres nebo rozsah IP adres z Azure DDoS Protection Standard. Běžný scénář, kdy je na seznamu povolených IP adres IP adresu, pokud provoz je směrován z externích cloudových WAF do Azure. 

---
title: Přehled kontinuity podnikových procesů s Azure Database pro databázi MySQL
description: Přehled kontinuity podnikových procesů s Azure Database pro databázi MySQL.
services: mysql
author: kamathsun
ms.author: sukamat
manager: kfile
...
---
# <a name="overview-of-business-continuity-with-azure-database-for-mysql"></a>Přehled kontinuity podnikových procesů s Azure Database pro databázi MySQL

Tento přehled popisuje možnosti, které poskytuje Azure Database pro databázi MySQL pro provozní kontinuitu a zotavení po havárii. Informace o možnostech pro obnovení z rušivý událostí, které může dojít ke ztrátě dat nebo způsobit, že databáze a aplikace k dispozici. Zjistěte, co dělat, pokud uživatele nebo aplikace chyba ovlivňuje integritu dat, oblast Azure má výpadek nebo pokud vaše aplikace vyžaduje údržby.
...
Databáze pro databázi MySQL Azure poskytuje obchodní kontinuity funkce, které zahrnují automatizované zálohování a možnosti pro uživatele k zahájení geografické obnovení. Každý odhadovaná doba obnovení (Vložit) a potenciální ztrátě dat má jiné vlastnosti. Jakmile porozumíte tyto možnosti, můžete vybrat mezi nimi a používají se společně pro různé scénáře. Když budete vyvíjet plánu pro kontinuitu podnikových, musíte pochopit maximální přijatelnou dobu před aplikace plně obnoví po nepříjemným událostem – to je cíl doba obnovení (RTO). Také musíte porozumět maximální objem dat poslední aktualizace (časový interval) aplikace může tolerovat ztráty při obnovování po nepříjemným událostem – to je cíl bodu obnovení (RPO).
...
- Další informace o automatizované zálohování naleznete v tématu [záloh v Azure Database pro databázi MySQL](concepts-backup.md).

---
title: Nastavení Azure Resource Manager hesla na hraničním zařízení Azure Stack
description: Popisuje, jak se připojit k Azure Resource Manager běžícímu na Azure Stack Edge pomocí Azure PowerShell.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge

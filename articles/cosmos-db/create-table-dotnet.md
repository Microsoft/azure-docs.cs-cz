---
title: 'Rychlý start: Table API s využitím .NET – Azure Cosmos DB'
...
2. V aplikaci Visual Studio otevřete soubor **Settings. JSON** . 
...
4. Stisknutím kombinace kláves CTRL + S uložte soubor **Settings. JSON** .

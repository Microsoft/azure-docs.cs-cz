...
PRT obsahuje deklarace, které se obecně nacházejí v jakémkoli obnovovacím tokenu Azure AD. Kromě toho jsou součástí PRT některé deklarace identity specifické pro zařízení. Jsou následující:
...
> [!NOTE]
> Zprostředkovatelé identity třetích stran musí podporovat protokol WS-Trust, aby bylo možné PRT vystavování na zařízeních s Windows 10. Bez WS-Trust se PRT nedá vystavovat uživatelům na zařízeních připojených k hybridní službě Azure AD nebo na zařízeních připojených k Azure AD.
...
| Věcn | Modul plug-in CloudAP předá šifrovaný PRT a klíč relace do CloudAP. CloudAP vyžádá čip TPM, aby dešifroval klíč relace pomocí přenosového klíče (tkpriv) a znovu ho zašifroval pomocí vlastního klíče TPM. CloudAP ukládá šifrovaný klíč relace ve své mezipaměti spolu s PRT. |

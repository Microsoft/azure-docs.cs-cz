---
title: 'Kurz: Azure Active Directory integraci jednotného přihlašování s ContractWorks | Microsoft Docs'
...
Pokud chcete nakonfigurovat jednotné přihlašování na straně **ContractWorks** , musíte odeslat **adresu URL federačních metadat aplikace** [týmu podpory ContractWorks](mailto:support@contractworks.com). Toto nastavení nastaví, aby bylo správně nastaveno připojení SAML SSO na obou stranách.

---
title: Instalační program s asistencí pro Azure AD v2.0 JavaScript jednostránkové aplikace (SPA) | Dokumentace Microsoftu
description: Jak JavaScript SPA aplikace můžou zavolat rozhraní API, které vyžadují přístupové tokeny pomocí koncového bodu Azure Active Directory v2.0

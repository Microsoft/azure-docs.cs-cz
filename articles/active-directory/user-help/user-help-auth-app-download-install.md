...
- Po stažení a instalaci aplikace, je nutné přidat různé účty. Další informace najdete v tématu [přidat své účty](user-help-auth-app-add-account-overview.md).

...
## <a name="incorrect-overage-invoice"></a>Nesprávná faktura za nadlimitní využití

Pokud se domníváte, že vaše faktura za nadlimitní využití není správná, přečtěte si článek [Vysvětlení faktury za smlouvu Azure Enterprise](billing-understand-your-bill-ea.md), který vám pomůže při odsouhlasení poplatků za používání Azure. Pokud se domníváte, že poplatek za nadlimitní využití účtovaný Microsoftem je chybný, obraťte se na podporu.

## <a name="change-a-po-number-for-an-overage-invoice"></a>Změna čísla nákupní objednávky u faktury za nadlimitní využití

Portál Azure EA automaticky generuje výchozí číslo nákupní objednávky, pokud správce EA nenastavil před datem faktury jiné číslo. Na portálu Azure EA může správce EA číslo nákupní objednávky aktualizovat tím, že se přihlásí a přejde na **Sestavy**. Správce EA může číslo nákupní objednávky aktualizovat. V pravé horní části, kde je číslo nákupní objednávky, klikněte na symbol tužky a aktualizujte informace.

V průběhu aktuálního fakturačního čtvrtletí, ale ještě před vytvořením faktury, může správce EA číslo nákupní objednávky aktualizovat. Správce může číslo nákupní objednávky aktualizovat až sedm dní od přijetí automatického e-mailu s oznámením o faktuře.

Pokud správce EA neaktualizoval číslo nákupní objednávky a potřebuje její nové číslo, jedinou možností je vystavení kreditu a opakované vystavení faktury. Pokud zákazník musí aktualizovat číslo nákupní objednávky, obraťte se na partnera a požádejte ho o pomoc.
...
_Samostatně fakturované poplatky_ a _služby Azure Marketplace_ jsou služby třetích stran nasazené z platformy Azure Marketplace. Hlavním rozdílem obou služeb je způsob jejich fakturace, který vychází ze struktury smlouvy uzavřené s externími vydavateli.

Použité služby třetích stran jsou na faktuře zobrazené jako **samostatně fakturované poplatky**. Při použití se spotřebovává zůstatek peněžního závazku Azure. Pokud si chcete prohlédnout seznam služeb třetích stran, přečtěte si článek o tom, jak [služby externích prodejců na Azure Marketplace teď můžou používat peněžní závazek Azure](https://azure.microsoft.com/updates/azure-marketplace-third-party-reseller-services-now-use-azure-monetary-commitment/).

Použití, které je na faktuře uvedené pod **Azure Marketplace**, se účtuje samostatně. Není zahrnuté do peněžního závazku. Nicméně všechny poplatky, včetně poplatků za Marketplace, nadlimitní využití a samostatně fakturovaných poplatků, jsou spojené do jediné faktury.

Za vlastní nadlimitní využití Azure i za nákupy Azure třetích stran na Marketplace dostanete jednu fakturu.

V případě úplného spotřebování peněžního závazku se používání fakturuje měsíčně nebo čtvrtletně. Pokud jste se zaregistrovali před květnem 2018, platí pro vás pravidlo prahové hodnoty ve výši 150 % peněžního závazku. Nadlimitní využití se vám fakturuje čtvrtletně. Pokud jste se zaregistrovali po květnu 2018, fakturují se vám všechna nadlimitní využití měsíčně.

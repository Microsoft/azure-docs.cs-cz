...
1. Zadejte hodnoty parametrů pro přiřazení podrobného plánu:
   ...
   - Parametry podrobného plánu
     ...
     - **Log Analytics pracovní prostor pro agenty virtuálních počítačů (zásady: podrobný plán pro ISO 27001)** : Určuje ID prostředku pracovního prostoru. Tento parametr používá funkci `concat` k vytvoření ID prostředku.
...
|Log Analytics skupina prostředků|Skupina prostředků|Name (Název)|**Uzamkl** – zřetězí **název organizace** s `-sharedsvsc-log-rg`, aby se skupina prostředků jedinečná.|
...
|Skupina síťových prostředků|Skupina prostředků|Name (Název)|**Uzamkl** – zřetězí **název organizace** s `-sharedsvcs-net-rg`, aby se skupina prostředků jedinečná.|
...
|Key Vault skupina prostředků|Skupina prostředků|Name (Název)|**Uzamkl** – zřetězí **název organizace** s `-sharedsvcs-kv-rg`, aby se skupina prostředků jedinečná.|
...
|Skupina prostředků JumpBox|Skupina prostředků|Name (Název)|**Uzamkl** – zřetězí **název organizace** s `-sharedsvcs-jb-rg`, aby se skupina prostředků jedinečná.|
...
|Active Directory Domain Services skupina prostředků|Skupina prostředků|Name (Název)|**Uzamkl** – zřetězí **název organizace** s `-sharedsvcs-adds-rg`, aby se skupina prostředků jedinečná.|
...
> [sdílené služby ISO 27001 podrobný plán – mapování ovládacích prvků](./control-mapping.md)

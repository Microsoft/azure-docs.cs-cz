...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/mercerhrs-tutorial/tutorial_mercerhrs_samlbase.png)

3. Na **Mercer BenefitsCentral (MBC) domény a adresy URL** část, proveďte následující kroky:

    ![Mercer BenefitsCentral (MBC) domény a adresy URL jednotné přihlašování informace](./media/mercerhrs-tutorial/tutorial_mercerhrs_url.png)
...
5. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/mercerhrs-tutorial/tutorial_general_400.png)
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/mercerhrs-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **Mercer BenefitsCentral (MBC)**.
    ...
    ![V seznamu aplikací na odkaz Mercer BenefitsCentral (MBC)](./media/mercerhrs-tutorial/tutorial_mercerhrs_app.png)  

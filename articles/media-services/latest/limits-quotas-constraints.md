...
| Prostředek | Výchozí omezení | 
| --- | --- | 
| Počet [úloh](transforms-jobs-concept.md) na účet Media Services | 500 000 <sup>(3)</sup> (fixní)|
| Vstupy úloh na úlohu | 50 (fixní)|
| Výstupy úloh na úlohu | 20 (fixní) |
| [Transformuje](transforms-jobs-concept.md) účet za Media Services. | 100 (fixní)|
...
| Prostředek | Výchozí omezení | 
| --- | --- | 
| [Živé události](live-events-outputs-concept.md) <sup>(4)</sup> na účet Media Services |5|
| Živé výstupy na živou událost |3 <sup>(5)</sup> |
| Maximální doba trvání živého výstupu | [Velikost okna DVR](live-event-cloud-dvr.md) |

<sup>4</sup> podrobné informace o omezeních událostí za provozu najdete v tématu [porovnání a omezení typů událostí typu Live](live-event-types-comparison.md).

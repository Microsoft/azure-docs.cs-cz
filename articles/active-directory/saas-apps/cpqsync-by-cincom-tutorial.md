---
title: 'Kurz: Integrace Azure Active Directory s CPQSync podle Cincom | Microsoft Docs'
...
ms.locfileid: "68879560"
---
# <a name="tutorial-integrate-cpqsync-by-cincom-with-azure-active-directory"></a>Kurz: Integrace CPQSync pomocí Cincom s Azure Active Directory
...
2. **[Nakonfigurujte CPQSync pomocí jednotného přihlašování Cincom](#configure-cpqsync-by-cincom-sso)** – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
...
Chcete-li nakonfigurovat jednotné přihlašování na **CPQSync po straně Cincom** , je třeba odeslat stažený **certifikát (RAW)** a příslušné zkopírované adresy URL od Azure Portal do [CPQSync podle týmu podpory Cincom](https://cpqsupport.cincomcpq.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

### <a name="create-cpqsync-by-cincom-test-user"></a>Vytvořit CPQSync podle Cincom testovacího uživatele

V této části vytvoříte uživatele s názvem B. Simon v CPQSync od Cincom. Spolupracujte s [CPQSync podle Cincom týmu podpory](https://cpqsupport.cincomcpq.com) a přidejte uživatele v CPQSync podle platformy Cincom. Uživatelé musí vytvořit a aktivovat, než použití jednotného přihlašování.

## <a name="test-sso"></a>Test SSO 

V této části Testování služby Azure AD jednotné přihlašování – konfigurace pomocí přístupového panelu.

Když na přístupovém panelu kliknete na dlaždici CPQSync by Cincom, měli byste se k CPQSync automaticky přihlásit pomocí Cincom, pro kterou jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

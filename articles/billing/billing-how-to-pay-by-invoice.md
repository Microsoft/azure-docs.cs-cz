...
1. Přihlaste se k webu [Azure Portal](https://portal.azure.com/). Vyberte **Nápověda a podpora** > **nová žádost o podporu**.
    ...
    ![Nápověda a podpora tlačítka](./media/billing-how-to-pay-by-invoice/help-and-support.png)
...
1. Vyberte předplatné, které chcete přepnout na faktuře platby.
1. Vyberte **Způsoby platby**.
1. Na panelu příkazů klikněte na tlačítko **platbu na fakturu** tlačítko.

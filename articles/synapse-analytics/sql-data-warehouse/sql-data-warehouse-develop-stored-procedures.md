...
Fond SQL aktuálně nepodporuje [@NESTLEVEL@](/sql/t-sql/functions/nestlevel-transact-sql). Jako takový je třeba sledovat úroveň hnízda. Je nepravděpodobné, že překročíte limit úrovně osmi hnízd. Ale pokud tak učiníte, je třeba přepracovat kód tak, aby odpovídaly úrovně vnoření v rámci tohoto limitu.

...
| --- |:---:|:---:|
| Výkon | | |
| <ul style="list-style-type: none;"><li>Upravený čtvereček R</li></ul> |0,96 |– |
| <ul style="list-style-type: none;"><li>Koeficient <br />Analýzy</li></ul> |– |0,78<br />(nízká přesnost) |
...
| Možnosti naučí se |– |Ve výchozím nastavení |obvyklé nejmenší čtverce<br />L2 = 0,005 |
...
| **Výkon** | | | |
| Upravený čtvereček R |0,96 |– | |
| Koeficient určení |– |0,78 |0,952049 |

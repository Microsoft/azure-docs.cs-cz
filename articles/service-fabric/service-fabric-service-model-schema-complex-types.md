...
Možnosti ovladače, které mají být předány ovladači. Modul plug-in svazku soubory Azure podporuje následující možnosti ovladačů: název_sdílené_položky (sdílená složka souborů Azure, která poskytuje svazek pro kontejner), storageAccountName (účet úložiště Azure, který obsahuje sdílenou složku souborů Azure), storageAccountKey ( Přístupový klíč pro účet služby Azure Storage, který obsahuje sdílenou složku souborů Azure.

...
Ukázka ![požadovaných domén][Image2]
</center>
...
Pokud chcete toto balení pro danou úlohu zakázat, můžete zadat zásady `RequireDomainDistribution` služby. Pokud je tato zásada nastavená, Správce prostředků clusteru zajistí, aby se žádné dvě repliky ze stejného oddílu nespouštěly ve stejné chybě nebo v upgradovací doméně.

...
1. Ujistěte se, že přidáte následující `application:didFinishLaunchingWithOptions:` v aplikaci delegátu, nahraďte "SERVER_CLIENT_ID" se stejným ID, které jste použili ke konfiguraci služby App Service v kroku 1.

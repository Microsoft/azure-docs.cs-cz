---
title: Rychlý start Java pro programu QnA Maker rozhraní API (v4) – služby Azure kognitivní | Microsoft Docs
...
ms.locfileid: "36301457"
---
# <a name="quickstart-for-microsoft-qna-maker-api-with-java"></a>Rychlý start pro programu QnA Maker rozhraní API s Javou 
<a name="HOLTop"></a>

V tomto článku se dozvíte, jak používat [rozhraní API služby Microsoft QnA Maker](../Overview/overview.md) v jazyce Java, proveďte následující.
...
## <a name="get-answers-to-a-question-by-using-a-knowledge-base"></a>Získejte odpovědi na dotaz pomocí znalostní bázi

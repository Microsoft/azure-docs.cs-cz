---
title: Partnerů pro správu dat SQL Data Warehouse | Dokumentace Microsoftu
...
## <a name="data-management-partners"></a>Partnerů pro správu dat
| Partner | Popis | Odkazy | Videa |
| --- | --- | --- | --- |
| ![Coffing datového skladu][1] |**Coffing datového skladu**<br>Datové sklady coffing poskytuje Nexus Chameleon, nástroj se po dobu 10 let návrhu vyhrazený pro dotazování systémy. Nexus je k dispozici jako nástroj pro dotaz pro SQL Data Warehouse. Pomocí Nexus dotazování interně a počítačů a dat v cloudu napříč různými platformami. Bod klikněte na tlačítko sestava! |[Web][coffing_website]<br>[Tisková zpráva][coffing_press]<br>[Twitter][coffing_twitter]<br>[YouTube][coffing_youtube] |[![coffing videa](./media/sql-data-warehouse-partner-data-management/coffing_video.jpg)](https://www.youtube.com/watch?v=N5GSxBEySFc) |
| ![Inbrein][2] |**MicroERD**<br>Inbrein MicroERD poskytuje nástroje, které je potřeba vytvořit přesný datový model, snížit redundanci dat, zvyšují produktivitu a dodržovat standardy. S použitím jeho uživatelské rozhraní, který byl vyvinut podle rozsáhlé uživatelské prostředí, můžete pracovat Modelátor na modely DB snadné a pohodlné. Můžete průběžně využívat nové a vylepšené funkce MicroERD přes příkazový řádek funkční vylepšeními a aktualizacemi. |[Web][inbrein_website]<br>[Datový list][inbrein_datasheet]<br>[Twitter][inbrein_twitter]<br>[YouTube][inbrein_youtube] |[![inbrein videa](./media/sql-data-warehouse-partner-data-management/inbrein_video.jpg)](https://www.youtube.com/watch?v=IGHSAk4bxdE) |
| ![Infolibrarian][3] |**Infolibrarian**<br>InfoLibrarian katalogy, ukládá a spravuje metadat, které vám pomůžou vyřešit klíče problémové body správy dat. Kromě toho poskytuje Infolibrarian správy metadat, zásady správného řízení dat a řešení pro správu softwarových prostředků ke správě a publikování metadat z nejrůznějších nástrojů a technologií. |[Marketplace][infolibrarian_marketplace]<br>[Web][infolibrarian_website]<br>[Twitter][infolibrarian_twitter] |[![infolibrarian videa](./media/sql-data-warehouse-partner-data-management/infolibrarian_video.png)](http://www.infolibcorp.com/metadata-management-videos/vdbplayer.swf?volume=100&url=video/infolibrarian-azure-provisioning.mp4) |
| ![Globální Redpoint][4] |**RedPoint interakce**<br>Interakce RedPoint umožňuje Zaujměte zákazníky v dialogovém okně průběžné přes každých komunikační kanál a dotykového ovládání bodu. Snadná správa kompletní životní cyklus omnichannel marketingové z jednoho bodu provozní ovládacího prvku |[Marketplace][redpoint_it_marketplace]<br>[Web][redpoint_it_website]<br>[Tisková zpráva][redpoint_press]<br>[Datový list][redpoint_it_datasheet]<br>[Twitter][redpoint_twitter]<br>[YouTube][redpoint_youtube] |[![redpoint dm videa](./media/sql-data-warehouse-partner-data-management/redpoint_it_video.jpg)](https://vimeo.com/103715582) |
| ![Globální Redpoint][4] |**Správa dat RedPoint**<br>Správa dat RedPoint povolit s prodejci svá data k podpoře zapojení zákazníků napříč kanál při provádění strukturovaná a Nestrukturovaná data správy použít. S využitím Azure SQL Data Warehouse a RedPoint můžete maximalizovat hodnotu strukturovaných a nestrukturovaných dat k zajištění hyper přizpůsobené, kontextové interakce potřebné pro zapojení dnešní omni kanál zákazníka. Přetáhněte myší rozhraní díky navrhování a provádění procesů správy dat snadno. |[Marketplace][redpoint_dm_marketplace]<br>[Web][redpoint_dm_website]<br>[Tisková zpráva][redpoint_press]<br>[Datový list][redpoint_dm_datasheet]<br>[Twitter][redpoint_twitter]<br>[YouTube][redpoint_youtube] |[![redpoint dm videa](./media/sql-data-warehouse-partner-data-management/redpoint_dm_video.jpg)](https://www.youtube.com/watch?v=o3DtXRpiEg0) |
| ![SENTRY jeden][5] |**Sentry datového skladu**<br>Pomocí inteligentní data přesun řídicí panel a události kalendáře vždy víte přesně co je dopadu na vaše úlohy. Účelem je poskytnout přehled o dotazy a úlohy, ve kterých k načtení zálohování nebo obnovení dat, které nikdy starat o vašich prostředků Azure na maximum. |[Marketplace][sql_sentry_marketplace]<br>[Web][sql_sentry_website]<br>[Tisková zpráva][sql_sentry_press]<br>[Twitter][sql_sentry_twitter]<br>[YouTube][sql_sentry_youtube] | |

## <a name="next-steps"></a>Další kroky
Další informace o dalších partnerů, naleznete v tématu [Business Intelligence partneři] [ bi_partners] a [partneři pro integraci dat][di_partners].

...
* Řízení ve službě Azure AD, která má přístup k EasySSO pro Confluence.
* Umožněte uživatelům, aby se automaticky přihlásili k EasySSO pro Confluence s účty Azure AD.
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-easysso-for-confluence"></a>Konfigurace a testování jednotného přihlašování Azure AD pro EasySSO pro Confluence
...
Pokud chcete nakonfigurovat a otestovat jednotné přihlašování Azure AD pomocí EasySSO pro Confluence, dokončete následující stavební bloky:
...
1. V [Azure Portal](https://portal.azure.com/)na stránce Application Integration **EasySSO for Confluence** vyhledejte část **Správa** a vyberte **jednotné přihlašování**.
...
1. Klikněte na **nastavit další adresy URL** a proveďte následující krok, pokud chcete nakonfigurovat aplikaci v režimu iniciované **SP** :
    ...
    > [!NOTE]
    > Tyto hodnoty nejsou reálné. Aktualizujte tyto hodnoty skutečným identifikátorem, adresou URL odpovědi a přihlašovací adresou URL. Pokud chcete získat tyto hodnoty, kontaktujte [EasySSO pro tým podpory klientů Confluence](mailto:support@techtime.co.nz) . Můžete se také podívat na vzory uvedené v části **základní konfigurace SAML** v Azure Portal.
...
1. Přihlaste se k EasySSO pro instanci Confluence s oprávněními správce a přejděte do části **Správa aplikací** .

    ![Správa aplikací](./media/easysso-for-confluence-tutorial/jira-admin-1.png)

1. Klikněte na **EasySSO**.

    ![Snadné jednotné přihlašování](./media/easysso-for-confluence-tutorial/jira-admin-2.png)
...
1. V horní části karty vybrat **certifikáty** a zobrazí se vám následující obrazovka, kde najdete **certifikát (Base64)** nebo **soubor metadat** , který jste uložili v předchozích krocích konfigurace **jednotného přihlašování služby Azure AD** . Máte následující možnosti, jak pokračovat:
    ...
    ![Adresa URL metadat](./media/easysso-for-confluence-tutorial/jira-admin-4.png)
...
1. V dolní části stránky klikněte na tlačítko **Uložit** . Zobrazí se obsah metadat nebo souborů certifikátů, které se analyzují do polí konfigurace. Konfigurace EasySSO pro Confluence se dokončila.
...
1. Pro účely nejlepšího testování přejděte na kartu **vzhled &** a zkontrolujte možnost tlačítko pro **přihlášení SAML** na. Tím se povolí samostatné tlačítko na obrazovce pro přihlášení k JIRA, které vám konkrétně umožní otestovat Azure AD SAML Integration end na konec. Toto tlačítko můžete ponechat zapnuté a nakonfigurovat jeho umístění, barvu a překlad pro režim výroby.
    ...
    ![Vzhled &](./media/easysso-for-confluence-tutorial/jira-admin-5.png)
...
V této části se v EasySSO pro Confluence vytvoří uživatel s názvem B. Simon. EasySSO for Confluence podporuje zřizování uživatelů za běhu, které je ve výchozím nastavení **zakázáno** . Pokud chcete povolit zřizování uživatelů, musíte explicitně zaškrtnout možnost **vytvořit uživatele při úspěšném přihlášení** v části Obecné v konfiguraci modulu plug-in EasySSO. Pokud uživatel ještě v EasySSO pro Confluence neexistuje, vytvoří se po ověření nový.

Pokud však nechcete povolit Automatické zřizování uživatelů při prvním přihlášení uživatele, musí existovat uživatelé v adresářích uživatelů back-endu, který používá instance EasySSO for Confluence, jako je například LDAP nebo Atlassian.

![Zřizování uživatelů](./media/easysso-for-confluence-tutorial/jira-admin-6.png)

## <a name="test-sso"></a>Test SSO

V této části otestujete konfiguraci jednotného přihlašování Azure AD pomocí přístupového panelu.

Když kliknete na dlaždici EasySSO for Confluence na přístupovém panelu, měli byste se automaticky přihlásit k EasySSO pro Confluence, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Vyzkoušejte si EasySSO pro Confluence s Azure AD](https://aad.portal.azure.com/)

- [Co je řízení relace v Microsoft Cloud App Security?](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)

- [Jak chránit EasySSO pro Confluence s pokročilými viditelnostmi a ovládacími prvky](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)

...
| Nastavit vystavování deklarací identity |     | ![Kontrola][1] | ![Kontrola][1] |
| Povolení zařízení bez Windows 10 |       |        | ![Kontrola][1] |
| Ověření připojených zařízení | ![Kontrola][1] | ![Kontrola][1] | [Kontrola][1] |
...
1. Vyberte **Další**.
1. V **název pravidla deklarace identity** zadejte **pravidlo deklarace identity metoda ověřování**.
1. V **pravidlo deklarace identity** zadejte následující pravidlo:

   `c:[Type == "http://schemas.microsoft.com/claims/authnmethodsreferences"] => issue(claim = c);`

1. Na federačním serveru zadejte následující příkaz Powershellu. Nahraďte **\<RPObjectName\>** s název přijímající strany objektu pro objekt vztahu důvěryhodnosti Azure AD předávající strany. Tento objekt má obvykle název **Microsoft Office 365 Identity Platform**.

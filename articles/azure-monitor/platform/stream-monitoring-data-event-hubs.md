...
* [Přečtěte si přehled protokolu aktivit Azure.](./platform-logs-overview.md)
* [Nastavení výstrahy na základě události protokolu aktivit](./alerts-log-webhook.md)

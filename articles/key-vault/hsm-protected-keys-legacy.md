...
---
# <a name="import-hsm-protected-keys-for-key-vault-legacy"></a>Import klíčů chráněných HSM pro Key Vault (starší verze)
...
* [Krok 5: přenos klíče do Azure Key Vault](#step-5-transfer-your-key-to-azure-key-vault)
...
Tento příkaz vytvoří soubor klíčového klíče ve složce% NFAST_KMDATA% \ s názvem začínajícím na **key_simple_** a následovaný **Ident** , který byl zadán v příkazu. Například: **key_simple_contosokey**. Tento soubor obsahuje zašifrovaný klíč.
...
## <a name="step-5-transfer-your-key-to-azure-key-vault"></a>Krok 5: přenos klíče do Azure Key Vault

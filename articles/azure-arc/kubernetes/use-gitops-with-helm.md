...
Spusťte následující příkaz a přejděte na [localhost: 3000](http://localhost:3000) v prohlížeči, abyste ověřili, jestli je aplikace spuštěná.

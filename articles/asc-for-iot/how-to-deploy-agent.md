---
title: Vyberte a nasaďte Azure Security Center pro agenta IoT | Microsoft Docs
...
- Používáte _Windows Server_ nebo _Windows IoT Core_? 
    ...
    [Nasaďte agenta zabezpečení na bázi systému Windows. C#](how-to-deploy-windows-cs.md)

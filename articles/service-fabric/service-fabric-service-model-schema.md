...
Tento článek obsahuje informace o souboru schématu ServiceFabricServiceModel.xsd nainstalované s Service Fabric SDK.  Ve výchozím nastavení je soubor schématu nainstaluje do *C:\Program Files\Microsoft SDKs\Service Fabric\schemas\ServiceFabricServiceModel.xsd*.

## <a name="namespace-bindings"></a>Namespace vazby
|Předvolba|Namespace URI|
|---|---|
|xs|http://www.w3.org/2001/XMLSchema|
|Žádný|http://schemas.microsoft.com/2011/01/fabric|

## <a name="component-summary"></a>Souhrn součásti 
Následující součásti jsou definovány v http://schemas.microsoft.com/2011/01/fabric oboru názvů v ServiceFabricServiceModel.xsd:
- [293 elementy](service-fabric-service-model-schema-elements.md)
- [103 complextypes na sebe sama](service-fabric-service-model-schema-complex-types.md)
- [1 simpleTypes](service-fabric-service-model-schema-simple-types.md)
- [skupiny 3 – element](service-fabric-service-model-schema-element-groups.md)

...
|PackageFile |Prostředky pro nasazení balíčku: zip společně se souborem\_Content. XML Types. Tento soubor zip by měl obsahovat sestavení nástroje pro nasazení balíčku a složku s prostředky pro nasazení balíčku. To znamená Package. zip|
...
| PočátečníDatum| Toto je datum, kdy bude balíček řešení dostupný. Formát je MM/DD/RRRR.|
|EndDate|Toto je datum, kdy se balíček řešení zastaví. Formát je MM/DD/RRRR. |
|SupportedCountries |Toto je seznam zemí/oblastí oddělených čárkami, které by se měly zobrazit v tomto balíčku. Pokud chcete zobrazit seznam všech kódů zemí, obraťte se na online služby. V době psaní tohoto seznamu byl: AE, AL, AM, AO, AR, AT, AU, AZ, BA, BB, BD, pro, BG, BH, BM, BN, BO, BR, podle, CA, CH, CI, CL, CM, CO, CR, CV, SH, CY, CZK, DE, DK, DO, pl, ES, EE, EG, ES, FI, FR, GB, GE, GH, IE, IL , IN, SWEETIQ, IS, JM, JO, JP, KE, KG, KN, KR, KW, KY, KZ, KG, LK, LT, LU, LV,, MA, MC,. MD, JÁ, MK, MN, MO, MT, MU, MX, MY, NG, NI, NL, NO, NZ, OM, PA, PE, PH, PK, PL, PR, PS, PT, PY, QA, RO, RS, RU,, SV, TH, TM, TN,. , TR, TT, TW, UA, US, UY, UZ, VE, VI, VN, ZA, ZW |

---
title: Kontrakt dat rozšíření HTTP – Azure
description: V tomto článku se dozvíte, jak pomocí protokolu HTTP posílat zprávy mezi modulem Live video Analytics a modulem AI nebo CV.
ms.topic: overview
ms.date: 09/14/2020
...
ms.locfileid: "88691805"
---
# <a name="http-extension-data-contract"></a>Kontrakt dat rozšíření HTTP

V tomto článku se dozvíte, jak pomocí protokolu HTTP posílat zprávy mezi modulem Live video Analytics a modulem AI nebo CV.
...
![hierarchie tříd](./media/http-data-contract/class-hierarchy.png)

---
title: Zpráva k vydání verze Azure Stack Edge pro 2012
description: Popisuje kritické otevřené problémy a řešení pro Azure Stack vydání verze pro s 2012.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
Tento článek se týká verze **Azure Stack Edge 2012** , která se mapuje na číslo verze softwaru **2.2.1438.2470**.

## <a name="whats-new"></a>Co je nového

Ve verzi Azure Stack Edge 2012 jsou k dispozici následující nové funkce. 
...
## <a name="known-issues-in-2012-release"></a>Známé problémy v 2012 Release

Následující tabulka poskytuje souhrn známých problémů verze 2012.

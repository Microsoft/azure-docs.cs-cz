...
Prostředí Azure PowerShell můžete použít ke konfiguraci [přesměrování webového provozu](application-gateway-multi-site-overview.md) při vytváření [aplikační brány](application-gateway-introduction.md). V tomto kurzu nakonfigurujete naslouchací proces a pravidlo, které přesměrují webový provoz, který je součástí aplikační brány, na externí Web.
...
Naslouchací proces je nutný k tomu, aby brána Application Gateway mohla vhodným způsobem směrovat provoz. Vytvořte naslouchací proces pomocí [New-AzApplicationGatewayHttpListener](/powershell/module/az.network/new-azapplicationgatewayhttplistener) s konfigurací front-endu a dříve vytvořeným portem front-endu. Provoz přesměrujete tím, že vytvoříte konfiguraci přesměrování, kterou je možné přidat do pravidla směrování, které vytvoříte.

Pro naslouchací proces, který je vyžadován pro odeslání příchozího provozu, je nutné pravidlo směrování. Vytvořte základní pravidlo s názvem *redirectRule* pomocí [New-AzApplicationGatewayRequestRoutingRule](/powershell/module/az.network/new-azapplicationgatewayrequestroutingrule) s konfigurací přesměrování.

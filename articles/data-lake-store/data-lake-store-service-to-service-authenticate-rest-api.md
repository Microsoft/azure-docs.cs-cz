---
title: Ověřování služba-Služba-Data Lake Storage Gen1-REST API
...
Výstup požadavku zahrnuje autorizační token (označený `access-token` ve výstupu níže), který následně projdete voláním REST API. Uložte ověřovací token do textového souboru. budete ho potřebovat při volání REST Data Lake Storage Gen1.

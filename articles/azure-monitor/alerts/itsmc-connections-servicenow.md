...
![Snímek obrazovky s poli a možnostmi pro přidání připojení ServiceNow](media/itsmc-connections-servicenow/itsm-connection-servicenow-connection-latest.png)

...
Naučte se odesílat Apache Hive dotazy pomocí sady HDInsight .NET SDK. Napíšete C# program, který odešle dotaz na podregistr pro výpis tabulek podregistru a zobrazí výsledky.
...
1. Vytvořte C# konzolovou aplikaci v aplikaci Visual Studio.

...
# Začínáme
## [Zřízení virtuálního počítače na webu Azure Portal](../sql/virtual-machines-windows-portal-sql-server-provision.md?toc=%2fazure%2fvirtual-machines%2fwindows%2fsqlclassic%2ftoc.json)
## [Zřízení virtuálního počítače pomocí Azure PowerShell](virtual-machines-windows-classic-ps-sql-create.md)
## [Připojení k virtuálnímu počítači](virtual-machines-windows-classic-sql-connect.md)
...
### [Rozšíření místní skupiny dostupnosti Always On do Azure](virtual-machines-windows-classic-sql-onprem-availability.md)
## Spravovat

...
* Můžete povolit uživatelům být automaticky přihlášeni k HR2day podle Merces (Single Sign-On) pomocí jejich účtů služby Azure AD.
...
* HR2day podle Merces jednotného přihlašování povolená předplatného

## <a name="scenario-description"></a>Popis scénáře

V tomto kurzu konfigurace a testování v testovacím prostředí Azure AD jednotného přihlašování.

* Podporuje HR2day podle Merces **SP** jednotné přihlašování zahájené pomocí

## <a name="adding-hr2day-by-merces-from-the-gallery"></a>Přidání HR2day podle Merces z Galerie

Konfigurace integrace HR2day podle Merces do služby Azure AD, budete muset přidat HR2day podle Merces z Galerie na váš seznam spravovaných aplikací SaaS.
...
4. Do vyhledávacího pole zadejte **HR2day podle Merces**vyberte **HR2day podle Merces** z panelu výsledků klikněte **přidat** tlačítko pro přidání aplikace.

     ![HR2day podle Merces v seznamu výsledků](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurace a otestování služby Azure AD jednotného přihlašování

V této části, konfiguraci a testování Azure AD jednotné přihlašování s HR2day podle Merces podle testovacího uživatele volá **Britta Simon**.
Pro jednotné přihlašování pro práci je potřeba navázat vztah odkazu mezi uživatele služby Azure AD a související uživatelské v HR2day podle Merces.
...
2. **[Konfigurace HR2day podle Merces Single Sign-On](#configure-hr2day-by-merces-single-sign-on)**  – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
3. **[Vytvořit testovacího uživatele Azure AD](#create-an-azure-ad-test-user)**  – Pokud chcete otestovat Azure AD jednotné přihlašování s Britta Simon.
4. **[Přiřadit uživatele Azure AD](#assign-the-azure-ad-test-user)**  – Pokud chcete povolit Britta Simon používat Azure AD jednotného přihlašování.
5. **[Vytvoření HR2day Merces testovací uživatel](#create-hr2day-by-merces-test-user)**  – Pokud chcete mít protějšek Britta Simon HR2day podle Merces, který je propojený s Azure AD reprezentace uživatele.
...
1. V [webu Azure portal](https://portal.azure.com/)na **HR2day podle Merces** integrace stránce aplikace vyberte **jednotného přihlašování**.
...
4. Na **základní konfiguraci SAML** části, proveďte následující kroky:
    ...
    ![HR2day Merces domény a adresy URL jednotné přihlašování – informace](common/sp-identifier.png)

    a. V **přihlašovací adresa URL** textové pole, zadejte adresu URL, pomocí následujícího vzorce: `https://<tenantname>.force.com/<instancename>`

    b. V **identifikátor (Entity ID)** textové pole, zadejte adresu URL, pomocí následujícího vzorce: `https://hr2day.force.com/<companyname>`
...
8. Na **HR2day zřízený Merces** tématu, zkopírujte příslušné adresy URL podle vašich požadavků.
...
### <a name="configure-hr2day-by-merces-single-sign-on"></a>Konfigurace HR2day podle Merces jednotné přihlašování
...
V této části je povolit Britta Simon používat jednotné přihlašování Azure díky udělení přístupu k HR2day podle Merces.

1. Na webu Azure Portal, vyberte **podnikové aplikace**vyberte **všechny aplikace**a pak vyberte **HR2day podle Merces**.

    ![Okno aplikace organizace](common/enterprise-applications.png)

2. V seznamu aplikací vyberte **HR2day podle Merces**.

    ![HR2day podle Merces propojení v seznamu aplikací](common/all-applications.png)
...
Po klepnutí HR2day podle Merces dlaždici na přístupovém panelu, můžete by měl být automaticky podepsány k HR2day Merces, u kterého nastavíte jednotné přihlašování. Další informace o přístupovém panelu, naleznete v tématu [Úvod k přístupovému panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

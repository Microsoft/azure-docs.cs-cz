...
Azure [SQL Database](sql-database-technical-overview.md), [spravovaná instance](sql-database-managed-instance.md)a [Azure synapse](../sql-data-warehouse/sql-data-warehouse-overview-what-is.md) podporují podmíněný přístup Microsoft. 
...
Dotazy týkající se Azure SQL Database a Azure synapse týkající se služby Multi-Factor Authentication vám poskytne MFAforSQLDB@microsoft.com.  

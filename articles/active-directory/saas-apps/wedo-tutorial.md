...
1. V místní nabídce Přidat uživatele vyplňte informace o uživateli.
    ...
    c. Zadejte `username@companydomain.extension`e-mailu. Například, `B.Simon@contoso.com`. Je nutné mít e-mail se stejnou doménou jako s krátkým názvem vaší společnosti.
    ...
    g.  Na stránce *pozvat uživatele* klikněte na **Ano**.
...
Když na přístupovém panelu kliknete na dlaždici WEDO, měli byste se automaticky přihlásit k WEDO, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Jak chránit WEDO pomocí pokročilých viditelností a ovládacích prvků](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)

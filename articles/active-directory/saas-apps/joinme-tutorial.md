...
* Můžete povolit uživatelům být automaticky přihlášeni k join.me (Single Sign-On) s jejich účty Azure AD.
...
* podporuje JOIN.ME **IDP** jednotné přihlašování zahájené pomocí
...
V této části je konfigurace a testování Azure AD jednotné přihlašování pomocí join.me podle testovacího uživatele volá **Britta Simon**.
Pro jednotné přihlašování pro práci je potřeba navázat vztah odkazu mezi uživatele služby Azure AD a související uživatelské v join.me.
...
2. **[Konfigurovat Single Sign-On join.me](#configure-joinme-single-sign-on)**  – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
3. **[Vytvořit testovacího uživatele Azure AD](#create-an-azure-ad-test-user)**  – Pokud chcete otestovat Azure AD jednotné přihlašování s Britta Simon.
4. **[Přiřadit uživatele Azure AD](#assign-the-azure-ad-test-user)**  – Pokud chcete povolit Britta Simon používat Azure AD jednotného přihlašování.
5. **[Vytvořit testovacího uživatele join.me](#create-joinme-test-user)**  – Pokud chcete mít protějšek Britta Simon v join.me, který je propojený s Azure AD reprezentace uživatele.
...
4. Na **základní konfiguraci SAML** oddílu, uživatel nebude muset provést libovolný krok, protože aplikace je už předem integrováno s Azure.
    ...
    ![JOIN.ME domény a adresy URL jednotné přihlašování – informace](common/preintegrated.png)
...
### <a name="configure-joinme-single-sign-on"></a>Konfigurace join.me jednotného přihlašování

Ke konfiguraci jednotného přihlašování na **join.me** straně, je nutné odeslat **adresa Url federačních metadat aplikace** k [tým podpory join.me](https://help.join.me/s/?language). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.
...
1. Na webu Azure Portal, vyberte **podnikové aplikace**vyberte **všechny aplikace**a pak vyberte **join.me**.
...
### <a name="create-joinme-test-user"></a>Vytvoření join.me testovacího uživatele
...
Po kliknutí na dlaždici join.me na přístupovém panelu, můžete by měl být automaticky přihlášeni k join.me, u kterého nastavíte jednotné přihlašování. Další informace o přístupovém panelu, naleznete v tématu [Úvod k přístupovému panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

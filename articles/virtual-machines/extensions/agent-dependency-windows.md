...
Rozšíření agenta závislosti virtuálních počítačů Azure pro Windows můžete spustit na podporovaných operačních systémů uvedených v [podporované operační systémy](../../azure-monitor/insights/vminsights-onboard.md#supported-operating-systems) části Azure Monitor pro článek nasazení virtuálních počítačů.

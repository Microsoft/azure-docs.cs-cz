...
- Pracovní prostor služby Azure Machine Learning. For more information, see [Create an Azure Machine Learning workspace](how-to-manage-workspace.md).

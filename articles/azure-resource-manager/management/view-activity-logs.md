...
Chcete-li načíst položky protokolu, spusťte pomocí příkazu [AZ monitor Activity-log list](/cli/azure/monitor/activity-log#az_monitor_activity_log_list) s posunem, aby označoval časový rozsah.

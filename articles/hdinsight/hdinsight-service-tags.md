...
1. V rozevíracím seznamu **tag zdrojové služby** vyberte **HDInsight**.
    ...
    :::image type="content" source="./media/hdinsight-service-tags/azure-portal-add-service-tag.png" alt-text="Přidat značku služby z Azure Portal":::

...
* Přístup k objektům (klíče a tajným klíčům) uloženým v samotné Key Vault a jejich správa prostřednictvím koncového bodu Key Vault [https://yourvaultname.vault.azure.net](https://yourvaultname.vault.azure.net)(například).  

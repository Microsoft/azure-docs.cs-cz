...
| [Update – AzCosmosDBAccountFailoverPriority](/powershell/module/az.cosmosdb/update-azcosmosdbaccountfailoverpriority) | Aktualizujte pořadí priority převzetí služeb při selhání v oblastech Cosmos DB účtu. |

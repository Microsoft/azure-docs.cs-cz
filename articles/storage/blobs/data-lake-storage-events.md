...
1. Vytvořte soubor s názvem `customer-order.csv`, do tohoto souboru vložte následující informace a uložte je do místního počítače.
...
8. Spusťte znovu dotaz `select` pro zobrazení aktualizované tabulky Delta.

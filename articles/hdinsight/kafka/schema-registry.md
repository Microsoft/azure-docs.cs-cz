...
1. Kliknutím na tlačítko **nasadit do Azure** níže se přihlaste k Azure a otevřete šablonu správce prostředků.
    ...
    [![Nasazení do Azure](./media/schema-registry/hdi-deploy-to-azure1.png)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2Farnabganguly%2FKafkaschemaregistry%2Fmaster%2Fazuredeploy.json)
...
1. V šabloně vlastního nasazení vyplňte pole, jak je popsáno níže:
    ...
    |Region|V rozevíracím seznamu vyberte oblast, ve které se cluster vytvoří.|

...
- Po potvrzení přihlašovacích údajů znovu nasaďte šablonu. Další informace najdete v tématu [Vytvoření fondu hostitelů pomocí PowerShellu](create-host-pools-powershell-2019.md).
...
**Oprava 1:** Ručně přidejte chybějící součásti do virtuálních počítačů pomocí [Vytvoření fondu hostitelů pomocí prostředí PowerShell](create-host-pools-powershell-2019.md).
...
3. Nainstalujte souběžný zásobník pomocí části [Vytvoření fondu hostitelů pomocí prostředí PowerShell](create-host-pools-powershell-2019.md).

...
description: Prohlédněte si limity paměti a souběžnosti přidělené různým úrovním výkonu a třídám prostředků pro vyhrazený fond SQL ve službě Azure synapse Analytics.
...
ms.locfileid: "96455349"
---
# <a name="memory-and-concurrency-limits-for-dedicated-sql-pool-in-azure-synapse-analytics"></a>Omezení paměti a souběžnosti pro vyhrazený fond SQL ve službě Azure synapse Analytics

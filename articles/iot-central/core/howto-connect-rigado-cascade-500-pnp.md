...
* Aplikace Azure IoT Central vytvořená z některé z šablon aplikace ve verzi Preview. Další informace najdete v tématu [Vytvoření nové aplikace](https://docs.microsoft.com/azure/iot-central/quick-deploy-iot-central-pnp?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json).
...
1. V levém podokně přejděte na kartu ***šablony zařízení*** , vyberte **+ Nový**: ![vytvořit novou šablonu zařízení](./media/howto-connect-rigado-cascade500-pnp/device-template-new.png)
1. Stránka vám nabídne možnost ***vytvořit vlastní šablonu*** nebo ***použít předkonfigurovaný šablonu zařízení*** .
1. V seznamu předkonfigurovaných šablon zařízení vyberte šablonu zařízení C500, jak je znázorněno níže: ![vybrat šablonu zařízení C500](./media/howto-connect-rigado-cascade500-pnp/device-template-preconfigured.png)
...
ID oboru aplikace ![](./media/howto-connect-rigado-cascade500-pnp/app-scope-id.png)
3. Nyní klikněte na **Zobrazit klíče** a poznamenejte si **primární klíč**
![primární klíč](./media/howto-connect-rigado-cascade500-pnp/primary-key-sas.png)  
...
![Primární klíč](./media/howto-connect-rigado-cascade500-pnp/devices-list-c500.png)  

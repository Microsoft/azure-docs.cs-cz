...
V tomto kurzu se dozvíte, jak integrovat účet Symantec Web Security Service (WSS) k vašemu účtu Azure Active Directory (Azure AD), aby služba WSS mohla ověřit koncového uživatele zřízené ve službě Azure AD pomocí ověřování SAML a vymáhat uživatele. pravidla zásad na úrovni skupiny

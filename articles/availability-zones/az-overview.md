...
- Starší generace služeb nebo virtuálních počítačů nejsou v seznamu. Další informace najdete v dokumentaci na [předchozích generacích velikostí virtuálních počítačů](../virtual-machines/sizes-previous-gen.md).

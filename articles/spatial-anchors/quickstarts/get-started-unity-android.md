...
V nabídce **Spustit zařízení** vyberte zařízení a klikněte na **Sestavit a spustit**. Zobrazí se výzva k uložení souboru `.apk`, pro který můžete vybrat libovolný název.

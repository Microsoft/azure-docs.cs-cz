...
Pokud chcete změnit pevně zakódovaný **AZ3166** na vlastní ID zařízení v kódu, upravte řádek kódu zobrazený v [příkladu vzdáleného monitorování](../iot-accelerators/iot-accelerators-arduino-iot-devkit-az3166-devkit-remote-monitoring-v2.md).

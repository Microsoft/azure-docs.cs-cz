...
description: Přečtěte si, jak vytvořit základní prostředí AD a Azure AD.
author: billmath
manager: daveba
...
![Diagram, který znázorňuje základní prostředí Azure A D.](media/tutorial-single-forest/diagram-2.png)
...
![Snímek obrazovky zobrazující stránku Azure Active Directory v Azure Portal](media/tutorial-single-forest/create-1.png)</br>
...
![Snímek obrazovky, který zobrazuje nabídku "Přehled" s vybranými možnostmi uživatelé](media/tutorial-single-forest/administrator-1.png)</br>
...
![Vytvoření](media/tutorial-single-forest/administrator-2.png)</br>
...
V následující části najdete volitelný oddíl, který popisuje kroky k vytvoření dalšího serveru a doménové struktury.  Tato možnost se dá použít v některých pokročilejších kurzech, jako je [pilotní nasazení pro Azure AD Connect ke cloudové synchronizaci](tutorial-pilot-aadc-aadccp.md).
...
Nyní máte prostředí, které lze použít pro existující kurzy a testování dalších funkcí, které cloudovou synchronizaci nabízí.

...
2. **[Nakonfigurujte jednotné přihlašování pro vyrovnávání hudby](#configure-settling-music-single-sign-on)** – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
...
### <a name="configure-settling-music-single-sign-on"></a>Konfigurace vyrovnávání jednotného přihlašování přes hudbu
...
Po kliknutí na dlaždici vyrovnávání hudby na přístupovém panelu byste se měli automaticky přihlášeni k řešení hudby, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

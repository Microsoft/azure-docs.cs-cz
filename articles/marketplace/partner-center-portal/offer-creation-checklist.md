...
Proces vytvoření nabídky SaaS vás provede několika stránkami.  Tento článek popisuje podrobnosti, které můžete zadat na každé stránce, a odkazy na Další informace o jednotlivých položkách.
...
| [Stránka Vlastnosti](#properties-page) | Definujte kategorie a odvětví používané k seskupení vaší nabídky na tržištích, právní smlouvy podporující vaši nabídku a verzi vaší aplikace. |
...
| [Stránka s cenami a dostupností plánu](#plan-pricing-and-availability-page)  | K dispozici pouze v případě, že vyberete možnost prodávat nabídku prostřednictvím společnosti Microsoft.  Shromažďuje obchodní charakteristiky (cenový model), cílovou skupinu a dostupnost trhu pro jednotlivé plány (verze) vaší nabídky.  |
...
| Adresa URL nabídky  | Vyžaduje se, pokud je vybrána možnost získat nyní, jak by zákazníci měli pracovat se seznamem nabídek. |
...
| Shrnutí  | Požadováno, max. 100 znaků. |
...
| Adresa URL zásad ochrany osobních údajů  | Vyžadováno |
...
| Ukládat loga (malá, střední, Velká)  | Je nutné mít velké logo (od 216 x 216 do 350 × 350 pixelů). Partnerské centrum použije toto k vytvoření malého (48 x 48 px) a středního loga (90 x 90 pixelů). Případně je můžete později nahradit různými obrázky. Loga musí být ve formátu PNG. |
...
## <a name="plan-pricing-and-availability-page"></a>Stránka s cenami a dostupností plánu

...
Francie – střed | `https://francecentral.api.cognitive.microsoft.com/sts/v1.0/issueToken`
Indie – střed | `https://centralindia.api.cognitive.microsoft.com/sts/v1.0/issueToken`
Japonsko – východ | `https://japaneast.api.cognitive.microsoft.com/sts/v1.0/issueToken`
Korea – střed | `https://koreacentral.api.cognitive.microsoft.com/sts/v1.0/issueToken`
Středoseverní USA | `https://northcentralus.api.cognitive.microsoft.com/sts/v1.0/issueToken`
Severní Evropa | `https://northeurope.api.cognitive.microsoft.com/sts/v1.0/issueToken`
Středojižní USA | `https://southcentralus.api.cognitive.microsoft.com/sts/v1.0/issueToken`
Jihovýchodní Asie | `https://southeastasia.api.cognitive.microsoft.com/sts/v1.0/issueToken`
Velká Británie – jih | `https://uksouth.api.cognitive.microsoft.com/sts/v1.0/issueToken`
Západní Evropa | `https://westeurope.api.cognitive.microsoft.com/sts/v1.0/issueToken`

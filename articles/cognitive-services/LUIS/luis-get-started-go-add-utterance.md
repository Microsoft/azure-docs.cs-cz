---
title: 'Rychlý start: Změna, výuka aplikace, přejít na LUIS'
...
ms.locfileid: "70307624"
---
# <a name="quickstart-change-model-using-go"></a>Rychlý start: Změna modelu pomocí možnosti přejít

...
4. Do vyhledávacího pole zadejte **CloudPassage**.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/cloudpassage-tutorial/tutorial_cloudpassage_search.png)

5. Na panelu výsledků vyberte **CloudPassage**a potom klikněte na **přidat** tlačítko Přidat aplikaci.

    ![Vytváření testovacího uživatele Azure AD](./media/cloudpassage-tutorial/tutorial_cloudpassage_addfromgallery.png)
...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Konfigurovat jednotné přihlašování](./media/cloudpassage-tutorial/tutorial_cloudpassage_samlbase.png)

3. Na **CloudPassage domény a adresy URL** část, proveďte následující kroky:

    ![Konfigurovat jednotné přihlašování](./media/cloudpassage-tutorial/tutorial_cloudpassage_url.png)
    ...
    ![Konfigurovat jednotné přihlašování](./media/cloudpassage-tutorial/tutorial_cloudpassage_05.png)
...
4. Na **SAML podpisový certifikát** klikněte na tlačítko **Certificate(Base64)** a potom uložte soubor certifikátu v počítači.
    ...
    ![Konfigurovat jednotné přihlašování](./media/cloudpassage-tutorial/tutorial_cloudpassage_certificate.png) 
...
5. Aplikace CloudPassage očekává SAML kontrolní výrazy ve specifickém formátu, který vyžaduje, můžete přidat mapování vlastních atributů do vaší konfigurace atributy tokenu SAML. Následující snímek obrazovky ukazuje příklad pro tento.
   ...
   ![Konfigurovat jednotné přihlašování](./media/cloudpassage-tutorial/tutorial_cloudpassage_25.png) 
...
6. V **uživatelské atributy** části na **jednotného přihlašování** dialogové okno, nakonfigurujte atribut tokenu SAML, jak je znázorněno na obrázku výše a proveďte následující kroky:
    ...
    ![Konfigurovat jednotné přihlašování](./media/cloudpassage-tutorial/tutorial_attribute_04.png)
    
    ![Konfigurovat jednotné přihlašování](./media/cloudpassage-tutorial/tutorial_attribute_05.png)
...
7. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Konfigurovat jednotné přihlašování](./media/cloudpassage-tutorial/tutorial_general_400.png)
...
8. Na **CloudPassage konfigurace** klikněte na tlačítko **konfigurace CloudPassage** otevřete **konfigurovat přihlášení** okno. Kopírování **Sign-Out adresu URL, SAML Entity ID a SAML jeden přihlašování adresa URL služby** z **Stručná referenční příručka části.**
    ...
    ![Konfigurovat jednotné přihlašování](./media/cloudpassage-tutorial/tutorial_cloudpassage_configure.png) 
...
1. V **portál Azure**, v levém navigačním podokně klikněte na tlačítko **Azure Active Directory** ikonu.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/cloudpassage-tutorial/create_aaduser_01.png) 

2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin** a klikněte na tlačítko **všichni uživatelé**.
    
    ![Vytváření testovacího uživatele Azure AD](./media/cloudpassage-tutorial/create_aaduser_02.png) 

3. Chcete-li otevřít **uživatele** dialogové okno, klikněte na tlačítko **přidat** horní dialogové okno.
 
    ![Vytváření testovacího uživatele Azure AD](./media/cloudpassage-tutorial/create_aaduser_03.png) 

4. Na **uživatele** dialogové okno stránky, proveďte následující kroky:
 
    ![Vytváření testovacího uživatele Azure AD](./media/cloudpassage-tutorial/create_aaduser_04.png) 
...
2. V seznamu aplikací vyberte **CloudPassage**.
    ...
    ![Konfigurovat jednotné přihlašování](./media/cloudpassage-tutorial/tutorial_cloudpassage_app.png) 

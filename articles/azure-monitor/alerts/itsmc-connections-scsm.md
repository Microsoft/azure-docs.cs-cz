...
> - Aby bylo možné používat vlastní [šablony](./itsmc-definition.md#define-a-template) jako součást akcí, parametr "ProjectionType" v šabloně SCSM by měl být namapován na "IncidentManagement! System. pracovní položka. incident. ProjectionType "
...
2. V části **zdroje dat pracovního prostoru** klikněte na **připojení ITSM**.
    ...
    ![Nové připojení](media/itsmc-connections-scsm/add-new-itsm-connection.png)
...
![Připojení k Service Manageru](media/itsmc-connections-scsm/service-manager-connection.png)
...
3. V části **Hybrid Connections** klikněte na **Konfigurovat koncové body hybridního připojení**.
    ...
    ![Sítě hybridního připojení](media/itsmc-connections-scsm/itsmc-hybrid-connection-networking-and-end-points.png)
4. V okně **Hybrid Connections** klikněte na **Přidat hybridní připojení**.

    ![Přidat hybridní připojení](media/itsmc-connections-scsm/itsmc-new-hybrid-connection-add.png)

5. V okně **přidat Hybrid Connections** klikněte na **vytvořit nové hybridní připojení**.

    ![Nové hybridní připojení](media/itsmc-connections-scsm/itsmc-create-new-hybrid-connection.png)
...
6. Zadejte následující hodnoty:
   ...
   - **Název**: zadejte název ServiceBus, pokud ho vytváříte.
     ...
     ![Hodnoty hybridního připojení](media/itsmc-connections-scsm/itsmc-new-hybrid-connection-values.png)
...
7. Po vytvoření hybridního připojení vyberte připojení a klikněte na **Přidat vybrané hybridní připojení**.
    ...
    ![Nové hybridní připojení](media/itsmc-connections-scsm/itsmc-new-hybrid-connection-added.png)
...
![hybridní připojení bylo úspěšné.](media/itsmc-connections-scsm/itsmc-hybrid-connection-listener-set-up-successful.png)
> [!NOTE]
> 
...
![Test hybridního připojení](media/itsmc-connections-scsm/itsmc-hybrid-connection-test.png)

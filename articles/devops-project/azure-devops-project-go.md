---
title: 'Úvodní příručka: Vytvoření kanálu CI/CD pro programovací jazyk Go pomocí projektů Azure DevOps'
description: DevOps Projekty usnadňuje začínáme v Azure. V několika rychlých krocích vám pomůže spustit webovou aplikaci pro programovací jazyk Go ve službě Azure.
ms.prod: devops
...
---
# <a name="create-a-cicd-pipeline-for-go-by-using-azure-devops-projects"></a>Vytvoření kanálu CI/CD pro přejít pomocí projektů Azure DevOps

Nakonfigurujte průběžnou integraci (CI) a průběžné doručování (CD) pro vaši aplikaci Go pomocí projektů Azure DevOps. DevOps Projekty zjednodušuje počáteční konfiguraci Azure DevOps sestavení a uvolnění kanálu.
...
1. Výchozí architektura je **Aplikace Simple Go**. Vyberte **další**.  
    Rozhraní aplikace, které jste zvolili dříve, určuje typ cílů nasazení služby Azure, které jsou k dispozici pro nasazení. 
...
DevOps Projects vytvoří úložiště Git v Azure Repos nebo GitHub. Pokud chcete zobrazit repo a provést změny kódu v aplikaci, postupujte takto:

1. V nabídce DevOps Projects vyberte vlevo odkaz pro hlavní větev.  
...
1. Vlevo přejděte na *soubor views/index.html* a pak vyberte **Upravit**.
...
DevOps Projects automaticky konfiguruje úplný kanál CI/CD v Azure Repos. Prozkoumejte kanál a podle potřeby ho upravte. Pokud se chcete seznámit s kanály sestavení a vydání Azure DevOps, postupujte takto:

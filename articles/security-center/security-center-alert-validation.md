...
1. Jako uživatel s rolí **Správce zabezpečení** role nebo **přispěvatele předplatného** vyberte z panelu nástrojů na stránce výstrahy možnost **Vytvořit Ukázkové výstrahy**.

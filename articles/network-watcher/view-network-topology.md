...
## <a name = "azure-portal"></a>Zobrazit topologii – Azure Portal
...
## <a name = "azure-cli"></a>Zobrazení topologie – Azure CLI
...
- Spuštěním rozhraní příkazového řádku z počítače. Pokud spouštíte rozhraní příkazového řádku z počítače, kroky v tomto článku vyžadují Azure CLI verze 2.0.31 nebo novější. Nainstalovanou verzi zjistíte spuštěním příkazu `az --version`. Pokud potřebujete instalaci nebo upgrade, přečtěte si téma [Instalace Azure CLI](/cli/azure/install-azure-cli). Pokud používáte Azure CLI místně, je také potřeba spustit `az login` a vytvořit připojení k Azure.
...
| Přiřazení        | K virtuálnímu počítači je přidruženo síťové rozhraní. Veřejná IP adresa je přidružená k síťovému rozhraní. |

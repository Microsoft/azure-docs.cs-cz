...
![Motiv úrovně Standard IoT Central](./media/howto-customize-ui-pnp/standard-ui.png)
...
![Vlastní motiv IoT Central](./media/howto-customize-ui-pnp/themed-ui.png)
...
![IoT Central motivů](./media/howto-customize-ui-pnp/themes.png)
...
Pokud obrázek loga obsahuje název vaší aplikace, můžete skrýt text s názvem aplikace. Další informace najdete v tématu [Správa aplikace](./howto-administer-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json#change-application-name-and-url).
...
![Přizpůsobení odkazů na IoT Central v nápovědě](./media/howto-customize-ui-pnp/help-links.png)

Můžete také přidat nové položky do nabídky Help a odebrat výchozí položky:

![Přizpůsobená IoT Central – Help](./media/howto-customize-ui-pnp/custom-help.png)
...
- [Správa aplikace](./howto-administer-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
- [Konfigurace řídicího panelu aplikace](./howto-configure-homepage.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
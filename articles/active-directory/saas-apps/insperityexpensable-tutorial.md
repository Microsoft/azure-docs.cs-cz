...
* Uživatelům se automaticky přihlášeni k Insperity ExpensAble (Single Sign-On) můžete povolit pomocí jejich účtů služby Azure AD.
...
* Podporuje Insperity ExpensAble **SP** jednotné přihlašování zahájené pomocí
...
4. Do vyhledávacího pole zadejte **Insperity ExpensAble**vyberte **Insperity ExpensAble** na panelu výsledků klikněte **přidat** tlačítko pro přidání aplikace.

     ![Insperity ExpensAble v seznamu výsledků](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurace a otestování služby Azure AD jednotného přihlašování

V této části, konfigurace a testování služby Azure AD jednotné přihlašování s Insperity ExpensAble podle testu uživateli **Britta Simon**.
Pro jednotné přihlašování pro práci je potřeba navázat vztah odkazu mezi uživatele služby Azure AD a související uživatelské v Insperity ExpensAble.
...
2. **[Konfigurace Insperity ExpensAble Single Sign-On](#configure-insperity-expensable-single-sign-on)**  – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
3. **[Vytvořit testovacího uživatele Azure AD](#create-an-azure-ad-test-user)**  – Pokud chcete otestovat Azure AD jednotné přihlašování s Britta Simon.
4. **[Přiřadit uživatele Azure AD](#assign-the-azure-ad-test-user)**  – Pokud chcete povolit Britta Simon používat Azure AD jednotného přihlašování.
5. **[Vytvořit testovacího uživatele Insperity ExpensAble](#create-insperity-expensable-test-user)**  – Pokud chcete mít protějšek Britta Simon Insperity ExpensAble, který je propojený s Azure AD reprezentace uživatele.
...
1. V [webu Azure portal](https://portal.azure.com/)na **Insperity ExpensAble** integrace stránce aplikace vyberte **jednotného přihlašování**.
...
4. Na **základní konfiguraci SAML** části, proveďte následující kroky:
    ...
    ![Insperity ExpensAble domény a adresy URL jednotného přihlašování – informace](common/sp-signonurl.png)
...
6. Na **nastavení Insperity ExpensAble** tématu, zkopírujte příslušné adresy URL podle vašich požadavků.
...
1. Na webu Azure Portal, vyberte **podnikové aplikace**vyberte **všechny aplikace**a pak vyberte **Insperity ExpensAble**.

    ![Okno aplikace organizace](common/enterprise-applications.png)

2. V seznamu aplikací vyberte **Insperity ExpensAble**.

    ![Insperity ExpensAble odkaz v seznamu aplikací](common/all-applications.png)
...
Když kliknete na dlaždici Insperity ExpensAble na přístupovém panelu, vám by měl být automaticky přihlášeni ke Insperity ExpensAble u kterého nastavíte jednotné přihlašování. Další informace o přístupovém panelu, naleznete v tématu [Úvod k přístupovému panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

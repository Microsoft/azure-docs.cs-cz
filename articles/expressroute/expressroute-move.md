...
description: Přečtěte si o tom, co znamená přesunout okruh Azure ExpressRoute z modelu nasazení Classic do modelu nasazení Azure Resource Manager.

---
title: Poznámky k verzi Hortonworks přidružené k verzím Azure HDInsight
...
## <a name="current-versions"></a>Aktuální verze

* Cluster HDInsight verze 4,0 používá distribuci Hadoop, která je založená na [Hortonworks datové platformě 3,0](https://docs.hortonworks.com/HDPDocuments/HDP3/HDP-3.0.0/release-notes/content/relnotes.html).
...
* [Součásti systému Apache Hadoop ve službě HDInsight](./hdinsight-component-versioning.md)

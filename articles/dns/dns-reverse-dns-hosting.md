...
Tento článek vás provede kroky k vytvoření první zóny zpětného vyhledávání DNS a záznamu pomocí webu Azure portal, Azure Powershellu, příkazového řádku Azure CLI 1.0 nebo Azure CLI 2.0.

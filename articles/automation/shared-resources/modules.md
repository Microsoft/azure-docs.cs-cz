...
* Když sada Runbook importuje modul explicitně pomocí příkazu [using Module](https://docs.microsoft.com/powershell/module/microsoft.powershell.core/about/about_using?view=powershell-7.1#module-syntax) . Příkaz using je podporován počínaje prostředím Windows PowerShell 5,0 a podporuje třídy a import typu výčtu.

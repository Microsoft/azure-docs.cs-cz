...
Pokud je delegovaná podsíť moc velká, je možné, že Azure NetApp Files svazky budou používat víc IP adres, než jedna instance mezipaměti HPC Azure může zpracovat. Jedna mezipaměť může mít maximálně deset cílů úložiště.

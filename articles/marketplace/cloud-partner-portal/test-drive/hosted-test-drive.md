...
Vyberte možnost \'Ano\' pro \'povolit\' testovacích jednotek.
...
V tomto kroku vygenerujete ID \'Aplikace Azure AD\' a \'Aplikace Azure AD hodnoty klíčového\', které jsou uvedené níže.

V části \'Technical Configuration\' zadejte následující pole:
...
- **ID tenanta Azure AD**: Zadejte ID tenanta Azure pro vaši instanci Dynamics 365. Pokud chcete tuto hodnotu načíst, přihlaste se Azure Portal a přejděte do \'Azure Active Directory\' -\> vyberte vlastnosti z okna nabídky –\> zkopírujte ID adresáře. Ukázková hodnota: 72f988bf-86f1-41af-91ab-2d7cd0111234
...
- **Název tenanta Azure AD**: zadejte název tenanta Azure pro vaši instanci Dynamics 365. Použijte formát \<tenant.\>onmicrosoft.com. Ukázková hodnota: testdrive.onmicrosoft.com
- **Instance URL webového rozhraní API**: zadejte adresu URL webového rozhraní API pro vaši instanci Dynamics 365. Tuto hodnotu můžete načíst tak, že se přihlásíte do vaší instance Microsoft Dynamics 365 a přejdete k nastavení-\> přizpůsobení –\> Developer sources –\> instance webového rozhraní API (zkopírujte tuto adresu URL). Příklad hodnoty: https:\//testdrive.crm.dynamics.com/api/data/v9.0 

...
Pokud je trezor klíčů spuštěn na jiném účtu Microsoft, než který jste přihlášeni k sadě Visual Studio (například trezor klíčů běží na vašem pracovním účtu, ale Visual Studio používá váš soukromý účet), zobrazí se v Program.cs souboru chyba. , že visual studio nemůže získat přístup k trezoru klíčů. Pokud chcete tento problém vyřešit:
...
Další informace o vývoji trezoru klíčů naleznete v [průvodci vývojářem trezoru klíčů](key-vault-developers-guide.md).

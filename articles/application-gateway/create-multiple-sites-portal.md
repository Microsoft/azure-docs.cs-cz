---
title: Vytvoření služby application gateway, který je hostitelem více webů - portálu Azure | Microsoft Docs
description: Postup vytvoření služby application gateway, který je hostitelem více webů pomocí portálu Azure.
...
ms.locfileid: "34356014"
---
# <a name="create-and-configure-an-application-gateway-to-host-multiple-web-sites-using-the-azure-portal"></a>Vytvoření a konfigurace aplikační brány pro hostování více webů pomocí portálu Azure

Můžete použít portál Azure [konfigurace, který je hostitelem více webů](multiple-site-overview.md) při vytváření [Aplikační brána](overview.md). V tomto kurzu definujte fondy adres back-end pomocí virtuálních počítačů. Nakonfigurujete naslouchací procesy a pravidla založená na domény, které vlastníte a ujistěte se, že web přenos dorazí na příslušné servery ve fondech. V tomto kurzu se předpokládá, že vlastníte více domén a používá příklady *www.contoso.com* a *www.fabrikam.com*.
...
> * Vytvořte naslouchací procesy back-end
> * Vytvoření pravidla směrování
> * Vytvořte záznam CNAME ve vaší doméně

![Příklad směrování více lokalit](./media/create-multiple-sites-portal/scenario.png)
...
3. Pro aplikační bránu, zadejte tyto hodnoty:
    ...
    ![Vytvořte novou aplikační bránu](./media/create-multiple-sites-portal/application-gateway-create.png)
...
1. Otevřete prostředí pro interaktivní a ujistěte se, že je nastavena na **prostředí PowerShell**.
    ...
    ![Instalace vlastní rozšíření](./media/create-multiple-sites-portal/application-gateway-extension.png)
...
3. Zadejte název *contosoPool* a přidejte *contosoVM* pomocí **přidat cíl**.
    ...
    ![Přidat back-end serverů](./media/create-multiple-sites-portal/application-gateway-multisite-backendpool.png)
...
## <a name="create-backend-listeners"></a>Vytvořte naslouchací procesy back-end
...
## <a name="create-routing-rules"></a>Vytvoření pravidla směrování
...
4. Vyberte *contosoPool* pro fond back-end.
    ...
    ![Vytvoření pravidla, na základě cesty](./media/create-multiple-sites-portal/application-gateway-multisite-rule.png)
...
1. Klikněte na tlačítko **všechny prostředky**a potom klikněte na **myAGPublicIPAddress**.
    ...
    ![Záznam Aplikační brána adresu serveru DNS](./media/create-multiple-sites-portal/application-gateway-multisite-dns.png)
...
1. Zadejte název domény do panelu Adresa prohlížeče. Například http://www.contoso.com.
    ...
    ![Testování serveru contoso v aplikační brány](./media/create-multiple-sites-portal/application-gateway-iistest.png)

2. Změna adresy k jiné doméně a měli byste vidět něco podobného jako v následujícím příkladu:

    ![Testování serveru fabrikam v aplikační brány](./media/create-multiple-sites-portal/application-gateway-iistest2.png)

...
1. Zaprotokolujte [případ podpory](https://help.joinblink.com/hc/requests/new) nebo **podporu blikání** e-mailu na support@joinblink.com pro vyžádání tokenu SCIM. .
...
5. V části **přihlašovací údaje správce** zadejte `https://api.joinblink.com/scim` na **adrese URL tenanta**. Zadejte hodnotu **SCIM tokenu ověřování** získanou dříve v **tajném tokenu**. Klikněte na **Test připojení** a ujistěte se, že se služba Azure AD může připojit ke blikání. Pokud se připojení nepovede, zajistěte, aby měl váš účet blikání oprávnění správce, a zkuste to znovu.

...
1. Chcete-li monitorovat průběh importu, otevřete stránku serveru databáze a v části **Nastavení**vyberte **Historie importu a exportu**. V případě úspěchu se import **dokončeno** stav.

---
title: Kurz – připojení ukázkového kódu zařízení technologie Plug and Play IoT k Azure IoT Hub | Microsoft Docs
description: Kurz – sestavení a spuštění služby IoT technologie Plug and Play ukázkový kód zařízení (C, C#, Java, JavaScript nebo Python), který používá více komponent a připojuje se ke centru IoT. K zobrazení informací odesílaných zařízením do centra použijte nástroj Azure IoT Explorer.
author: ericmitt
ms.author: ericmitt
ms.date: 07/22/2020
ms.topic: tutorial
...
ms.locfileid: "106061005"
---
# <a name="tutorial-connect-an-iot-plug-and-play-multiple-component-device-applications-running-on-linux-or-windows-to-iot-hub"></a>Kurz: připojení aplikace IoT technologie Plug and Play více aplikací zařízení, které jsou spuštěné v systému Linux nebo Windows, IoT Hub

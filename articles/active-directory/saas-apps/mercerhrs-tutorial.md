...
1. Do vyhledávacího pole zadejte **Mercer BenefitsCentral (MBC)** vyberte **Mercer BenefitsCentral (MBC)** z panelu výsledků klikněte **přidat** tlačítko pro přidání aplikace.
...
1. **[Vytvoření zkušebního uživatele Mercer BenefitsCentral (MBC)](#create-a-mercer-benefitscentral-mbc-test-user)**  – Pokud chcete mít protějšek Britta Simon v Mercer BenefitsCentral (MBC), který je propojený s Azure AD reprezentace uživatele.
...
1. Na **Mercer BenefitsCentral (MBC) domény a adresy URL** části, proveďte následující kroky:
...
1. Na **Mercer BenefitsCentral (MBC) konfigurace** klikněte na tlačítko **nakonfigurovat BenefitsCentral Mercer (MBC)** otevřete **nakonfigurovat přihlašování** okna. Kopírovat **SAML jednotné přihlašování – adresa URL služby** z **Stručná referenční příručka oddílu.**

    ![Konfigurace mercer BenefitsCentral (MBC)](./media/mercerhrs-tutorial/tutorial_mercerhrs_configure.png) 

1. Ke konfiguraci jednotného přihlašování na **Mercer BenefitsCentral (MBC)** straně, je nutné odeslat na stažený **soubor XML s metadaty** a **SAML jednotné přihlašování – adresa URL služby** k [Tým podpory mercer BenefitsCentral (MBC)](https://www.mercer.com/contact-us.html). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.
...
1. V seznamu aplikací vyberte **Mercer BenefitsCentral (MBC)**.

...
1. Na kartě **vlastní nastavení** vyhledejte položku **systémová úloha** . Povolit pro danou entitu oprávnění ke čtení, zápisu a AppendTo (u plných zelených přepínačů), a to tak, že vyberou odpovídající přepínače.

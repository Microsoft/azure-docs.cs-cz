...
Další příkaz _ *CRM** načte úplnou konfiguraci clusteru do editoru, takže ho můžete upravit. Po uložení změn cluster spustí příslušné akce:

...
| Sady SDK pro vývojáře | .NET, Java, Python, Node. js  | .NET, Java, Python, Node. js, C++, Ruby, php, přejít, Android, iOS| Sada BLOB SDK – *nyní je k dispozici*. Azure Data Lake Storage Gen2 SDK – *zatím není k dispozici*  |
...
V této tabulce jsou popsány sady rozhraní API, které jsou k dispozici pro vaše vlastní aplikace. Podpora sady SDK pro seznam ACL a na úrovni adresáře zatím není podporovaná.
...
| Azure Resource Manager – Správa šablon             | [Template1](https://azure.microsoft.com/resources/templates/101-data-lake-store-no-encryption/)  [Template2](https://azure.microsoft.com/resources/templates/101-data-lake-store-encryption-adls/)  [Template3](https://azure.microsoft.com/resources/templates/101-data-lake-store-encryption-key-vault/)  | *Nyní k dispozici*                                                      | *Nyní k dispozici*                                          |

---
title: Řešení potíží s chybami připojení clusteru Průzkumník dat Azure
description: Tento článek popisuje postup řešení potíží pro připojení ke clusteru v Průzkumníku dat Azure.
author: orspod
ms.author: orspodek
ms.reviewer: mblythe

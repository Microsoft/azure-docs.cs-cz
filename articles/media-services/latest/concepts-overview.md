...
> [!NOTE]
> V současné době můžete pomocí [Azure Portal](https://portal.azure.com/) : spravovat Media Services V3 [živé události](live-events-outputs-concept.md), zobrazit (ne spravovat) v3 [assets](assets-concept.md)a [získat informace o přístupu k rozhraním API](access-api-portal.md).
...
|---|---|---|
|Prostředky a nahrávání obsahu|Pokud chcete začít spravovat, šifrovat, kódovat, analyzovat a streamovat mediální obsah v Azure, musíte vytvořit účet Media Services a nahrát své digitální soubory do **assetů**.|[Nahrávání na cloud a úložiště](storage-account-concept.md)<br/><br/>[Koncept prostředků](assets-concept.md)|

---
title: Nasazení zařízení řady StorSimple 8000 na portálu pro státní správu | Dokumenty společnosti Microsoft
description: Popisuje kroky a osvědčené postupy pro nasazení zařízení řady StorSimple 8000 se spuštěnou aktualizací 3 a novějším a službou na portálu Azure Government.
services: storsimple
...
Vítejte v průvodci nasazením zařízení Microsoft Azure StorSimple. Tyto kurzy nasazení platí pro StorSimple 8000 Series se softwarem aktualizace 3 nebo novější na portálu Azure Government. Tato řada kurzů obsahuje kontrolní seznam konfigurace, seznam požadavků konfigurace a podrobné kroky konfigurace pro vaše zařízení StorSimple.
...
Pomocí níže uvedených požadovaných kroků zařízení StorSimple nakonfigurujte a připojte ke službě Správce zařízení StorSimple. Kromě požadovaných kroků existují volitelné kroky a postupy, které budete muset dokončit během nasazení. Informace o tom, kdy je vhodné provést jednotlivé volitelné kroky, jsou vždy uvedeny v příslušných požadovaných krocích nasazení.
...
| [Požadavky nasazení](#deployment-prerequisites) |Tyto ověření, že prostředí je připraven o nasazení. |
|  | |
...
| [Krok 2: Získání registračního klíče služby](#step-2-get-the-service-registration-key) |Pomocí tohoto klíče můžete zaregistrovat a připojit zařízení StorSimple ke službě pro správu. |
| [Krok 3: Konfigurace a registrace zařízení prostřednictvím prostředí Windows PowerShell pro StorSimple](#step-3-configure-and-register-the-device-through-windows-powershell-for-storsimple) |Připojte zařízení k síti, zaregistrujte je v Azure a dokončete instalaci pomocí služby pro správu. |
| [Krok 4: Dokončení minimálního nastavení zařízení](#step-4-complete-minimum-device-setup) </br>Volitelné: Aktualizace zařízení StorSimple |Pomocí služby pro správu dokončete instalaci zařízení a aktivujte je k poskytování úložiště. |
...
| [Krok 7: Připojení, inicializace a formátování svazků](#step-7-mount-initialize-and-format-a-volume) </br>Volitelné: Konfigurace funkce MPIO |Připojte své servery k úložišti iSCSI poskytovanému zařízením. Volitelně můžete nakonfigurovat mpio, abyste zajistili, že vaše servery mohou tolerovat selhání připojení, sítě a rozhraní. |
...
Před nasazením zařízení StorSimple budete muset shromažďovat informace ke konfiguraci softwaru v zařízení. Předběžná příprava některých z těchto informací vám pomůže urychlit a zjednodušit proces nasazení zařízení StorSimple ve vašem prostředí. Stáhněte si a použijte tento kontrolní seznam, abyste si při nasazení zařízení poznamenali podrobnosti o konfiguraci.
...
Služba Správce zařízení StorSimple může spravovat více zařízení StorSimple. Chcete-li vytvořit novou instanci služby StorSimple Device Manager, proveďte následující kroky.
...
Proveďte následující kroky na portálu vlády.
...
K dokončení minimálního nastavení zařízení proveďte na portálu Azure Government následující kroky.
...
Chcete-li vytvořit kontejner svazku, proveďte na portálu pro správu následující kroky.

[!INCLUDE [storsimple-8000-create-volume-container](../../includes/storsimple-8000-create-volume-container.md)]

## <a name="step-6-create-a-volume"></a>Krok 6: Vytvoření svazku
Po vytvoření kontejneru svazků můžete v zařízení StorSimple zřídit svazek úložiště pro své servery. Chcete-li vytvořit svazek, proveďte na portálu pro správu následující kroky.

> [!IMPORTANT]
> Správce zařízení StorSimple může vytvářet pouze tence zřízené svazky.  Nelze však vytvářet částečně zřizované svazky.

[!INCLUDE [storsimple-8000-create-volume](../../includes/storsimple-8000-create-volume-u2.md)]

## <a name="step-7-mount-initialize-and-format-a-volume"></a>Krok 7: Připojení, inicializace a formátování svazků
Proveďte tyto kroky na hostiteli systému Windows Server.
...
Chcete-li vytvořit naplánovanou zálohu, proveďte na portálu pro správu portálu pro správu následující kroky.
...
Na stránce **služby StorSimple Device Manager** proveďte následující kroky na portálu pro správu vládních služeb.
...
Proveďte následující kroky na portálu pro správu a vytvořte ruční zálohování na vyžádání pro jeden svazek na vašem zařízení StorSimple.

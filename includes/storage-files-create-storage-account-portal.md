...
4. V části **Model nasazení** ponechte výchozí hodnotu **Resource Manager**. Další informace o rozdílech mezi Azure Resource Managerem a klasickým modelem nasazení najdete v článku [Vysvětlení modelů nasazení a stavu prostředků](../articles/azure-resource-manager/management/deployment-models.md).

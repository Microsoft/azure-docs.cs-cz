...
description: Azure CLI ukázkový skript – vytvoření aplikace ASP.NET Core ve službě App Service z Docker Hubu
services: appservice
...
ms.locfileid: "66136705"
---
# <a name="create-an-aspnet-core-app-in-a-docker-container-from-docker-hub-using-azure-cli"></a>Vytvoření aplikace ASP.NET Core v kontejneru Dockeru z Docker Hubu pomocí rozhraní příkazového řádku Azure

Tento ukázkový skript vytvoří skupinu prostředků, plán služby App Service pro Linux a aplikace. Pak nasadí aplikaci ASP.NET Core pomocí kontejneru Dockeru.

...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/montageonline-tutorial/tutorial_montageonline_samlbase.png)
...
5. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/montageonline-tutorial/tutorial_general_400.png)
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/montageonline-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **Fotomontáž Online**.
    ...
    ![V seznamu aplikací na Fotomontáž Online odkaz](./media/montageonline-tutorial/tutorial_montageonline_app.png)  

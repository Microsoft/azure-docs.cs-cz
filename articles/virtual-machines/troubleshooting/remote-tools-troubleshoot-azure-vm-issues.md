...
- Další informace o rutině Enter-PSSession naleznete v tématu [Enter-PSSession](/powershell/module/microsoft.powershell.core/enter-pssession?view=powershell-5.1&preserve-view=true).

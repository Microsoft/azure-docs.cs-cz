...
V tomto kroku vytvoříte certifikáty, které používá přihlášení SQL na šifrovaném koncovém bodu. V každém uzlu vytvořte složku, do které se budou ukládat zálohy certifikátů, `c:\certs`například. 

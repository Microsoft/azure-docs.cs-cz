...
:::image type="content" source="./media/apache-storm-develop-java-topology/word-count-topology1.png" alt-text="Diagram znázorňující uspořádání spoutů a šrouby" border="false":::

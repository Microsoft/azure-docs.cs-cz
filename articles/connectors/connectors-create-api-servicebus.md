---
title: Posílání a přijímání zpráv pomocí Azure Service Bus-Azure Logic Apps
description: Nastavení podnikového cloudového zasílání zpráv pomocí Azure Service Bus a Azure Logic Apps
services: logic-apps
...
ms.locfileid: "71120877"
---
# <a name="exchange-messages-in-the-cloud-by-using-azure-logic-apps-with-azure-service-bus"></a>Výměna zpráv v cloudu pomocí Azure Logic Apps s Azure Service Bus
...
1. Do vyhledávacího pole zadejte jako filtr "Azure Service Bus". V seznamu triggery vyberte Trigger, který chcete.
   ...
   Některé triggery, například když do triggeru **(automatického dokončování) přijde jedna nebo víc zpráv** , můžou vracet jednu nebo několik zpráv. Když se tyto triggery aktivují, vrátí se mezi sebou a počtem zpráv, které jsou zadané ve vlastnosti **maximální počet zpráv** triggeru.

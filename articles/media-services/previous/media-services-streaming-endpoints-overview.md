...
> [!NOTE]
> Před spuštěním koncového bodu streamování je možné zakázat integraci Azure CDN. `hostname` a adresa URL streamování zůstanou stejné, ať už povolíte CDN.
...
|Typ|StreamingEndpointVersion|ScaleUnits|CDN|Vyúčtování|
|--------------|----------|-----------------|-----------------|-----------------|
|Klasické|1.0|0|není k dispozici|Zadarmo|
...
Funkce|Úroveň Standard|Premium
---|---|---
...
Limit|Automatické škálování až na cílovou propustnost.|Další jednotky streamování.
...
Od | až | Akce
---|---|---
Klasické|Úroveň Standard|Musíte se přihlásit
Klasické|Premium| Škálování (další jednotky streamování)
Standard/Premium|Klasické|Není k dispozici (Pokud je verze koncového bodu streamování 1,0. Může se změnit na klasický s nastavením scaleunits na hodnotu 0).

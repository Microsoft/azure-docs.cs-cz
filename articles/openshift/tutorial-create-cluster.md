...
### <a name="optional-connect-the-clusters-virtual-network-to-an-existing-virtual-network"></a>Volitelné: Připojte virtuální síť clusteru k existující virtuální síti
...
4. Zajistěte, aby byl **typ** **Web** , a nastavte **identifikátor URI přesměrování** pomocí následujícího vzoru: `https://<public host name>/oauth2callback/Azure%20AD`. Příklad: `https://openshift.xxxxxxxxxxxxxxxxxxxx.eastus.azmosa.io/oauth2callback/Azure%20AD`
5. Klikněte na **Uložit**.

## <a name="step-4-sign-in-to-the-openshift-console"></a>Krok 4: přihlášení ke konzole OpenShift

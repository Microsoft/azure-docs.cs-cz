---
title: 'Kurz: Nasazení aplikace ASP.NET Core do Azure Kubernetes Service s projekty Azure DevOps'
...
ms.locfileid: "53993772"
---
# <a name="tutorial-deploy-aspnet-core-apps-to-azure-kubernetes-service-with-azure-devops-projects"></a>Kurz: Nasazení aplikace ASP.NET Core do Azure Kubernetes Service s projekty Azure DevOps

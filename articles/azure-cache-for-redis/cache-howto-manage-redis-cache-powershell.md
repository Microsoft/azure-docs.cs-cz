...
Novou mezipaměť Azure Redis instance jsou vytvořeny pomocí [New-AzureRmRedisCache](https://docs.microsoft.com/powershell/module/azurerm.rediscache/new-azurermrediscache?view=azurermps-6.6.0) rutiny.
...
`Set-AzureRmRedisCache` je možné škálovat mezipaměti Azure Redis instance, kdy `Size`, `Sku`, nebo `ShardCount` jsou upraveny vlastnosti Description. 
...
Chcete-li odstranit Azure Cache pro Redis, použijte [Remove-AzureRmRedisCache](https://docs.microsoft.com/powershell/module/azurerm.rediscache/remove-azurermrediscache?view=azurermps-6.6.0) rutiny.
...
Můžete importovat data do Azure Cache pro instanci Redis pomocí `Import-AzureRmRedisCache` rutiny.
...
Data můžete exportovat z Azure Cache pro instanci Redis pomocí `Export-AzureRmRedisCache` rutiny.
...
Restartujete mezipaměti Azure pro instanci Redis pomocí `Reset-AzureRmRedisCache` rutiny.

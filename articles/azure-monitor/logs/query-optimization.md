...
V některých případech je vyhodnocený sloupec implicitně vytvořen modulem pro zpracování dotazů, protože filtrování je provedeno nejen v poli:
```Kusto
//less efficient
SecurityEvent

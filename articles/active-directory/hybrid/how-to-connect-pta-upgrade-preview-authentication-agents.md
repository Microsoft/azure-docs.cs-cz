...
1. **Upgrade služby Azure AD Connect**: tomto [článku](how-to-upgrade-previous-version.md) a proveďte upgrade na nejnovější verzi Azure AD Connect.

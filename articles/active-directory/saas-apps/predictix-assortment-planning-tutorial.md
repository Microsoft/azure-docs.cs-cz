...
3. **[Vytvoření zkušebního uživatele Predictix sortiment plánování](#create-a-predictix-assortment-planning-test-user)**  – Pokud chcete mít protějšek Britta Simon Predictix sortiment plánování řešení, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **Predictix sortiment plánování domény a adresy URL** části, proveďte následující kroky:
...
6. Na **Predictix sortiment plánování konfigurace** klikněte na tlačítko **Konfigurace plánování sortiment Predictix** otevřete **nakonfigurovat přihlašování** okna. Kopírovat **URL odhlašování SAML Entity ID a SAML jednotné přihlašování – adresa URL služby** z **Stručná referenční příručka oddílu.**

---
title: 'IoT DevKit do cloudu: připojit IoT DevKit AZ3166 k Azure IoT Suite vzdálené monitorování v2 | Microsoft Docs'
description: V tomto kurzu zjistěte, jak odeslat stav senzorů na IoT DevKit AZ3166 pro vzdálené monitorování v2 z Azure IoT Suite pro monitorování a vizualizace.
services: iot-hub
documentationcenter: ''
...
---
# <a name="connect-mxchip-iot-devkit-az3166-to-azure-iot-suite-for-remote-monitoring-v2"></a>Připojení k Azure IoT Suite MXChip IoT DevKit AZ3166 pro vzdálené monitorování v2
...
4. Rozbalte levé straně **ARDUINO příklady** vyhledejte **příklady MXCHIP AZ3166 > AzureIoT**a vyberte **RemoteMonitoringv2**. Ho otevře nové okno VS Code s složce projektu v ní.
  ...
  ![Otevřít projekt vzdálené monitorování](media/iot-hub-arduino-iot-devkit-az3166-devkit-remote-monitoringv2/azure-iot-suite-arduino-examples.png)
...
![Přidání nového zařízení](media/iot-hub-arduino-iot-devkit-az3166-devkit-remote-monitoringv2/azure-iot-suite-add-device.png)
...
![Přidání nového zařízení formuláře](media/iot-hub-arduino-iot-devkit-az3166-devkit-remote-monitoringv2/azure-iot-suite-add-new-device-form.png)

Počkejte, dokud nebude dokončeno portálu zřizování nové zařízení.

![Zřizování nové zařízení ](media/iot-hub-arduino-iot-devkit-az3166-devkit-remote-monitoringv2/azure-iot-suite-add-device-provisioning.png)


Konfigurace nového zařízení, pak budou zobrazeny.
Kopírování **připojovací řetězec** vygenerovat.

![Řetězec připojení zařízení](media/iot-hub-arduino-iot-devkit-az3166-devkit-remote-monitoringv2/azure-iot-suite-new-device-connstring.png)
...
1. Použití `Ctrl+P` (systému macOS: `Cmd + P`) a typ **úlohy konfigurace připojení zařízení**.
  ...
  ![Zvolte předplatné Azure a službou IoT Hub](media/iot-hub-arduino-iot-devkit-az3166-devkit-remote-monitoringv2/iot-suite-task-config-device-conexion.png)
...
2. Terminálu dotazem, zda chcete použít připojovací řetězec zařízení IoT byste chtěli použít. Vyberte *vytvořit nový*a teď ho vložte.
  ...
  ![Vložte připojovací řetězec](media/iot-hub-arduino-iot-devkit-az3166-devkit-remote-monitoringv2/iot-suite-task-config-device-conexion-choose-iot-hub-press-button-A.png)
...
3. Terminálu někdy výzvu k zadání režimu konfigurace. Uděláte to tak, podržte tlačítko A pak push verze na tlačítko Obnovit a uvolněním tlačítka A. Na obrazovce zobrazí DevKit ID a "Konfigurace".
  ...
  ![Obrazovka DevKit zařízení](media/iot-hub-arduino-iot-devkit-az3166-devkit-remote-monitoringv2/azure-iot-suite-devkit-screen.png)
  ...
  ![Podívejte se na připojovací řetězec](media/iot-hub-arduino-iot-devkit-az3166-devkit-remote-monitoringv2/azure-iot-suite-connection-string-of-a-device.png)


Nyní uvidíte novou fyzického zařízení v části VS Code "Zařízení Azure IoT Hub":

![Všimněte si nového zařízení IoT Hub](media/iot-hub-arduino-iot-devkit-az3166-devkit-remote-monitoringv2/iot-suite-new-iot-hub-device.png)
...
![Data snímačů v Azure IoT Suite](media/iot-hub-arduino-iot-devkit-az3166-devkit-remote-monitoringv2/azure-iot-suite-dashboard.png)
...
![Čip TPM MX metody](media/iot-hub-arduino-iot-devkit-az3166-devkit-remote-monitoringv2/azure-iot-suite-methods.png)
...
![Čip TPM MX metody](media/iot-hub-arduino-iot-devkit-az3166-devkit-remote-monitoringv2/azure-iot-suite-schedule.png)

Zvolte metodu volat ChangeColor v rozevírací nabídce, kde všechny metody zobrazují, zápis název a použít.

![Čip TPM MX rozevíracího seznamu](media/iot-hub-arduino-iot-devkit-az3166-devkit-remote-monitoringv2/iot-suite-change-color.png)

V několik sekund, musí vaše fyzické čip TPM MX změnit barva RGB vedla (dole a tlačítko)

![Čip TPM vedených MX](media/iot-hub-arduino-iot-devkit-az3166-devkit-remote-monitoringv2/azure-iot-suite-devkit-led.png)

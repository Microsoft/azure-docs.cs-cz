...
- Ujistěte se, že jsou hesla zařízení silná a dobře chráněná. Postupujte podle [osvědčených postupů pro heslo](../articles/security/fundamentals/identity-management-best-practices.md#enable-password-management).
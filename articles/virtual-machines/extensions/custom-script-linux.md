...
Můžete také načíst stav spuštění rozšíření vlastního skriptu včetně `commandToExecute` skutečných argumentů předaných jako pomocí příkazového příkazového příkazu Azure:

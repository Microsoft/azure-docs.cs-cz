...
5. Vzorový kód k zajištění ověření prostřednictvím ověřování X.509 používá certifikát X.509. Spusťte následující příkaz, který sestaví verzi sady SDK specifickou pro vaši vývojovou platformu, která zahrnuje klienta pro zřizování zařízení. Řešení sady Visual Studio pro simulované zařízení je vygenerováno v adresáři `cmake`.

...
::: zone-end
::: zone pivot="programming-language-other"
Jakmile se `HttpExample` ve výstupu zobrazí koncový bod, přejděte na `http://localhost:7071/api/HttpExample` . V prohlížeči by se měla zobrazit zpráva "Hello World".
::: zone-end

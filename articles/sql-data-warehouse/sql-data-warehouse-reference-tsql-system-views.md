...
| sys. DM _pdw_nodes_os_dispatchers |Dokumentace k jazyku Transact-SQL není k dispozici. |
...
| sys. DM _pdw_nodes_os_memory_node_access_stats |Dokumentace k jazyku Transact-SQL není k dispozici. |
...
| sys. DM _pdw_nodes_os_spinlock_stats |Dokumentace k jazyku Transact-SQL není k dispozici. |
...
## <a name="sql-server-information_schema-views"></a>SQL Server zobrazení INFORMATION_SCHEMA

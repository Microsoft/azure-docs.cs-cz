...
Tato tabulka uvádí historii verzí aktuálních a dříve vydaných verzí Search Service REST API. Dokumentace je publikována pro aktuální stabilní verze a verze Preview.

| Znění&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   | Status | Problém zpětné kompatibility |
|-------------|--------|------------------------------|
| [Management 2020-03-13](https://docs.microsoft.com/rest/api/searchmanagement/) | Všeobecně dostupné | Nejnovější stabilní verze rozhraní REST API pro správu s předem vydanými verzemi Endpoint Protection. Přidává pro nové služby privátní koncový bod, podporu privátních odkazů a Síťová pravidla. |
...
| [Search 2020-06-30](https://docs.microsoft.com/rest/api/searchservice/index)| Stable | Nejnovější stabilní verze rozhraní REST API pro vyhledávání vyhledávání s předstihy v bodování relevance. |
| [Search 2020-06-30-Preview](https://docs.microsoft.com/rest/api/searchservice/index-preview)| Preview | Verze Preview přidružená k stabilní verzi |
| Search 2019-05-06 | Stable | Přidá komplexní typy. |
| Search 2019-05-06-Preview | Preview | Verze Preview přidružená k stabilní verzi |
| Hledání 2017-11-11 | Stable  | Přidá rozšíření dovednosti a AI. |
| Hledat 2017-11-11 – Preview | Preview | Verze Preview přidružená k stabilní verzi |
| Hledání 2016-09-01 |Stable | Přidá indexery.|
...
|-------------|--------|------------------------------|
| [**Azure.Search.Documents 1.0.0-Preview. 4**](https://www.nuget.org/packages/Azure.Search.Documents/1.0.0-preview.4) | Preview | Nová knihovna klienta ze sady Azure .NET SDK vydaná května 2020. Cílí na verzi rozhraní REST 2020-06-30 API.|
| [**Microsoft. Azure. Search 10,0**](https://www.nuget.org/packages/Microsoft.Azure.Search/) | Obecně dostupné, vydání květen 2019. Cílí na verzi rozhraní REST 2019-05-06 API.|
| [**Microsoft. Azure. Search 8,0 – Preview**](https://www.nuget.org/packages/Microsoft.Azure.Search/8.0.0-preview) | Preview, vydáno v dubnu 2019. Cílí na verzi rozhraní API REST 2019-05-06-Preview.|
| [**Microsoft. Azure. Management. Search 3.0.0**](https://docs.microsoft.com/dotnet/api/overview/azure/search/management?view=azure-dotnet) | Stable | Cílí na rozhraní REST API pro správu verze = 2015 – 08-19. |

## <a name="azure-sdk-for-java"></a>Azure SDK pro Javu

| SDK version (Verze sady SDK) | Status | Popis  |
|-------------|--------|------------------------------|
| [**Java SearchManagementClient 1.35.0**](https://docs.microsoft.com/java/api/overview/azure/search/management?view=azure-java-stable) | Stable | Cílí na rozhraní REST API pro správu verze = 2015 – 08-19.|

## <a name="azure-sdk-for-python"></a>Azure SDK pro Python

| SDK version (Verze sady SDK) | Status | Popis  |
|-------------|--------|------------------------------|
| [**Python Azure – Správa – hledání 1,0**](https://docs.microsoft.com/python/api/overview/azure/search?view=azure-python) | Stable | Cílí na rozhraní REST API pro správu verze = 2015 – 08-19. |
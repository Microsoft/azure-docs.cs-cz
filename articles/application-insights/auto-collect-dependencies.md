...
- Nastavit vlastní závislost sledování [.NET](app-insights-asp-net-dependencies.md).
- Nastavit vlastní závislost sledování [Java](app-insights-java-agent.md).

...
## <a name="configure-and-test-azure-ad-single-sign-on-for-fortes-change-cloud"></a>Konfigurace a testování jednotného přihlašování Azure AD pro Fort změny v cloudu
...
Pokud chcete nakonfigurovat a otestovat jednotné přihlašování Azure AD pomocí Fort změn v cloudu, dokončete následující stavební bloky:
...
1. V [Azure Portal](https://portal.azure.com/)na stránce **Fort Change Cloud** Application Integration najděte část **Správa** a vyberte **jednotné přihlašování**.
...
1. Pokud chcete nakonfigurovat aplikaci v režimu iniciované **IDP** , zadejte v **základní části Konfigurace SAML** hodnoty následujících polí:
    ...
    a. Do textového pole **identifikátor** zadejte adresu URL pomocí následujícího vzoru:`https://<identifier>.fortes-online.com`

    b. Do textového pole **Adresa URL odpovědi** zadejte adresu URL pomocí následujícího vzoru:`https://<identifier>.fortes-online.com/saml/SSO`

1. Klikněte na **nastavit další adresy URL** a proveďte následující krok, pokud chcete nakonfigurovat aplikaci v režimu iniciované **SP** :

    Do textového pole **přihlašovací adresa URL** zadejte adresu URL pomocí následujícího vzoru:`https://<identifier>.fortes-online.com/saml/SSO`
...
1. Fort Change Cloud Application očekává kontrolní výrazy SAML v určitém formátu, což vyžaduje přidání mapování vlastních atributů do konfigurace atributů tokenu SAML. Následující snímek obrazovky ukazuje seznam výchozích atributů, kde **NameIdentifier** je mapován pomocí **User. userPrincipalName**. Fort Change Cloud Application očekává, že **NameIdentifier** se má namapovat pomocí **User. sAMAccountName**, takže je potřeba upravit mapování atributů kliknutím na ikonu **Upravit** a změnit mapování atributů.
...
Když na přístupovém panelu kliknete na dlaždici změnit Cloud, měli byste být automaticky přihlášeni ke stejnému cloudu změny, pro který jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Vyzkoušejte Fort změna cloudu pomocí Azure AD](https://aad.portal.azure.com/)

- [Co je řízení relace v Microsoft Cloud App Security?](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)

- [Jak chránit Fort změny v cloudu s pokročilými viditelnostmi a ovládacími prvky](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)

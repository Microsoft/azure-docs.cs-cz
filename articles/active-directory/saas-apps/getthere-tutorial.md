...
* Můžete povolit uživatelům být automaticky přihlášeni k GetThere (Single Sign-On) s jejich účty Azure AD.
...
* Podporuje GetThere **IDP** jednotné přihlašování zahájené pomocí
...
4. Do vyhledávacího pole zadejte **GetThere**vyberte **GetThere** z panelu výsledků klikněte **přidat** tlačítko pro přidání aplikace.
     ...
     ![GetThere v seznamu výsledků](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurace a otestování služby Azure AD jednotného přihlašování

V této části je konfigurace a testování Azure AD jednotné přihlašování pomocí GetThere podle testovacího uživatele volá **Britta Simon**.
Pro jednotné přihlašování pro práci je potřeba navázat vztah odkazu mezi uživatele služby Azure AD a související uživatelské v GetThere.
...
2. **[Konfigurace GetThere Single Sign-On](#configure-getthere-single-sign-on)**  – ke konfiguraci nastavení jednotného přihlašování na straně aplikace.
3. **[Vytvořit testovacího uživatele Azure AD](#create-an-azure-ad-test-user)**  – Pokud chcete otestovat Azure AD jednotné přihlašování s Britta Simon.
4. **[Přiřadit uživatele Azure AD](#assign-the-azure-ad-test-user)**  – Pokud chcete povolit Britta Simon používat Azure AD jednotného přihlašování.
5. **[Vytvořit testovacího uživatele GetThere](#create-getthere-test-user)**  – Pokud chcete mít protějšek Britta Simon GetThere, který je propojený s Azure AD reprezentace uživatele.
...
6. Kromě toho výše GetThere aplikace očekává, že několik dalších atributů musí být předány zpět odpověď SAML. V **deklarace identity uživatelů** části na **atributy uživatele** dialogového okna, proveďte následující kroky pro přidání atributu tokenu SAML, jak je znázorněno v následující tabulka:
...
8. Na **nastavení GetThere** tématu, zkopírujte příslušné adresy URL podle vašich požadavků.
...
### <a name="configure-getthere-single-sign-on"></a>Konfigurace GetThere jednotné přihlašování

Ke konfiguraci jednotného přihlašování na **GetThere** straně, je nutné odeslat na stažený **certifikát (Base64)** a vhodné zkopírovaný adresy URL z webu Azure portal [tým podpory GetThere](mailto:dataintegration@sabre.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.
...
1. Na webu Azure Portal, vyberte **podnikové aplikace**vyberte **všechny aplikace**a pak vyberte **GetThere**.

    ![Okno aplikace organizace](common/enterprise-applications.png)

2. V seznamu aplikací vyberte **GetThere**.

    ![Odkaz GetThere v seznamu aplikací](common/all-applications.png)
...
### <a name="create-getthere-test-user"></a>Vytvoření GetThere testovacího uživatele

V této části vytvoříte uživatele v GetThere jako Britta Simon. Práce s [tým podpory GetThere](mailto:dataintegration@sabre.com) přidat uživatele na platformě GetThere. Uživatelé musí vytvořit a aktivovat, než použití jednotného přihlašování.

### <a name="test-single-sign-on"></a>Test jednotného přihlašování 

V této části Testování služby Azure AD jednotné přihlašování – konfigurace pomocí přístupového panelu.

Po kliknutí na dlaždici GetThere na přístupovém panelu, můžete by měl být automaticky přihlášeni k GetThere, u kterého nastavíte jednotné přihlašování. Další informace o přístupovém panelu, naleznete v tématu [Úvod k přístupovému panelu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

...
Poskytnuté *grafy Helm* si z registru kontejnerů stáhnou image služby pro rozpoznávání řeči, a to jak pro převod textu na řeč, tak i ze služeb převodu řeči na text `containerpreview.azurecr.io` .

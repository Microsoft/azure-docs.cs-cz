...
3. V tomto příkladu použijte existující [https://azure.microsoft.com/resources/templates/201-web-app-redis-cache-sql-database/](https://azure.microsoft.com/resources/templates/201-web-app-redis-cache-sql-database/)šablonu pro Azure pro rychlý Start.

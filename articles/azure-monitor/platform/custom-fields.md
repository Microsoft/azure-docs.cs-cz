...
![Tlačítko prohledávání protokolů](media/custom-fields/sample-extract.png)
...
![Další příklad](media/custom-fields/additional-example-02.png)

 Když spustíme extrakce, vidíme, že všechny naše výsledky jsou nyní přesné.

![Výsledky hledání](media/custom-fields/search-results-03.png)

...
Na stránce Souhrn Azure ověří nastavení. Můžete si také stáhnout šablonu. Zkontrolujte souhrnné informace. Klikněte na tlačítko **OK**.
...
7. **Vzdálená plocha** vás může upozorňovat na to, že vzdálený počítač nelze ověřit z důvodu problémů s jeho certifikátem zabezpečení. Zobrazuje název certifikátu zabezpečení. Pokud jste postupovali podle tohoto kurzu, název je **SQLServer-0.contoso.com**. Klikněte na tlačítko **Ano**.

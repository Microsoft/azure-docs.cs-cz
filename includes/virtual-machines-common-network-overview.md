...
| [Azure PowerShell](../articles/virtual-machines/windows/multiple-nics.md) | Použití [New-AzureRmNetworkInterface](/powershell/module/azurerm.network/new-azurermnetworkinterface) s **- PublicIpAddressId** parametr zajistit identifikátor veřejnou IP adresu, kterou jste vytvořili. |
| [Azure CLI](../articles/virtual-machines/linux/multiple-nics.md) | Pokud chcete zadat identifikátor veřejnou IP adresu, kterou jste vytvořili, použijte [síťových adaptérů sítě az vytvořit](https://docs.microsoft.com/cli/azure/network/nic#create) s **– veřejná adresa** parametr. |
...
| Metoda | Popis |
| ------ | ----------- |
| Azure Portal | Vytvoření interního nástroje pro vyrovnávání zatížení pomocí webu Azure Portal v současnosti není možné. |

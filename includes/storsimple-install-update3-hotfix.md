...
4. Po dokončení instalace se kontroler, na který se instalovala oprava hotfix režimu údržby, restartuje. Přihlaste se pomocí možnost 1, **přihlásit úplný přístup**a ověřit verzi firmwaru disku. Zadejte:

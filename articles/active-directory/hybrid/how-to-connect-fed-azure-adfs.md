...
![Návrh nasazení](./media/how-to-connect-fed-azure-adfs/deployment.png)
...
![Vytvoření virtuální sítě](./media/how-to-connect-fed-azure-adfs/deploynetwork1.png)
...
![Podsíť](./media/how-to-connect-fed-azure-adfs/deploynetwork2.png)

![Podsíť DMZ](./media/how-to-connect-fed-azure-adfs/deploynetwork3.png)
...
![Vytvoření skupiny zabezpečení sítě](./media/how-to-connect-fed-azure-adfs/creatensg1.png)
...
![Inicializace skupiny zabezpečení sítě](./media/how-to-connect-fed-azure-adfs/nsgint1.png)
...
![Konfigurace skupiny zabezpečení sítě](./media/how-to-connect-fed-azure-adfs/nsgconfigure1.png)
...
![Panel Podsítě po přidružení ke skupinám zabezpečení sítě](./media/how-to-connect-fed-azure-adfs/nsgconfigure2.png)
...
![Vytvoření účtů úložiště](./media/how-to-connect-fed-azure-adfs/storageaccount1.png)
...
![Skupiny dostupnosti](./media/how-to-connect-fed-azure-adfs/availabilityset1.png)
...
![Nasazené virtuální počítače](./media/how-to-connect-fed-azure-adfs/virtualmachinesdeployed_noadfs.png)
...
![Vyhledání nástroje pro vyrovnávání zatížení](./media/how-to-connect-fed-azure-adfs/browseloadbalancer.png)
...
![Interní nástroj pro vyrovnávání zatížení](./media/how-to-connect-fed-azure-adfs/ilbdeployment1.png)
...
![Nástroje pro vyrovnávání zatížení, po nasazení interního nástroje pro vyrovnávání zatížení](./media/how-to-connect-fed-azure-adfs/ilbdeployment2.png)
...
![Konfigurace back-endového fondu interního nástroje pro vyrovnávání zatížení](./media/how-to-connect-fed-azure-adfs/ilbdeployment3.png)
...
![Konfigurace testu interního nástroje pro vyrovnávání zatížení](./media/how-to-connect-fed-azure-adfs/ilbdeployment4.png)
...
![Konfigurace pravidel interního nástroje pro vyrovnávání zatížení](./media/how-to-connect-fed-azure-adfs/ilbdeployment5.png)
...
![Internetový nástroj pro vyrovnávání zatížení](./media/how-to-connect-fed-azure-adfs/elbdeployment1.png)

Po nasazení se nástroj pro vyrovnávání zatížení zobrazí v seznamu nástrojů pro vyrovnávání zatížení.

![Seznam nástrojů pro vyrovnávání zatížení](./media/how-to-connect-fed-azure-adfs/elbdeployment2.png)
...
![Konfigurace internetového nástroje pro vyrovnávání zatížení](./media/how-to-connect-fed-azure-adfs/elbdeployment3.png) 

![Konfigurace internetového nástroje pro vyrovnávání zatížení (DNS)](./media/how-to-connect-fed-azure-adfs/elbdeployment4.png)
...
![Konfigurace back-endového fondu internetového nástroje pro vyrovnávání zatížení](./media/how-to-connect-fed-azure-adfs/elbdeployment5.png)
...
![Konfigurace testu internetového nástroje pro vyrovnávání zatížení](./media/how-to-connect-fed-azure-adfs/elbdeployment6.png)
...
![Konfigurace pravidel vyrovnávání pro internetový nástroj pro vyrovnávání zatížení](./media/how-to-connect-fed-azure-adfs/elbdeployment7.png)
...
![pravidla přístupu INT (příchozí)](./media/how-to-connect-fed-azure-adfs/nsg_int.png)
...
![pravidla přístupu EXT (příchozí)](./media/how-to-connect-fed-azure-adfs/nsg_dmz.png)
...
2. Z jakékoli externího počítače zobrazte \//adfs-server.contoso.com/adfs/ls/IdpInitiatedSignon.aspx.  
3. Měla by se zobrazit stránka služby AD FS podobná níže uvedenému příkladu:

![Přihlašovací stránka testu](./media/how-to-connect-fed-azure-adfs/test1.png)

Po úspěšném přihlášení zobrazí zprávu o úspěchu, jak je uvedeno níže:

![Úspěch testu](./media/how-to-connect-fed-azure-adfs/test2.png)
...
* [Konfigurace a správa služby AD FS pomocí služby Azure AD Connect](how-to-connect-fed-whatis.md)

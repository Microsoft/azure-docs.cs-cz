---
title: Cenové úrovně pro Azure Database for MySQL
description: Tento článek popisuje cenové úrovně pro Azure Database for MySQL.
author: jan-eng
ms.author: janeng
ms.service: mysql
ms.topic: conceptual

---
title: 'Rychlý start: Rozpoznávání ploch v imagi pomocí REST API Azure a Pythonu'
...
ms.locfileid: "70859030"
---
# <a name="quickstart-detect-faces-in-an-image-using-the-face-rest-api-and-python"></a>Rychlý start: Rozpoznávání plošek v obrázku pomocí REST API obličeje a Pythonu

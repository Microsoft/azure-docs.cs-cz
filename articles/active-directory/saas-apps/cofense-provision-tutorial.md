...
3. Určete, jaká data se mají [mapovat mezi Azure AD a synchronizace Cofense příjemců](../app-provisioning/customize-application-attributes.md). 

---
title: Povolení spravované identity pro události směrování (Preview)
titleSuffix: Azure Digital Twins
description: Podívejte se, jak povolit identitu přiřazenou systémem pro digitální vlákna Azure a použít ji k přeposílání událostí.
author: baanders
ms.author: baanders
ms.date: 1/21/2021
ms.topic: how-to
...
ms.locfileid: "98948782"
---
# <a name="enable-a-managed-identity-for-routing-azure-digital-twins-events-preview"></a>Povolit spravovanou identitu pro směrování událostí digitálních vláken Azure (Preview)
...
V této části použijete [Azure Portal](https://portal.azure.com) k přidání identity spravované systémem do instance digitálního vlákna Azure, která už existuje.

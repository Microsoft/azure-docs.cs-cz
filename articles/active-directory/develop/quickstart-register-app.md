...
V tomto rychlém startu zaregistrujete aplikaci pomocí **registrace aplikacího** prostředí v Azure Portal. Vaše aplikace je integrovaná s platformou Microsoft identity. Podnikoví vývojáři a poskytovatelé softwaru jako služby (SaaS) můžou vyvíjet komerční cloudové služby nebo obchodní aplikace, které je možné integrovat s platformou Microsoft identity. Integrace poskytuje pro tyto služby zabezpečené přihlašování a autorizaci.
...
Přejděte k dalšímu článku, kde se dozvíte, jak získat přístup k webovým rozhraním API.

...
| Typické použití      |  Vývoj v jazyce R     |
| Jak používat nebo ji spustit?      | Povolit službu s _systemctl povolit rstudio serveru_, spusťte službu s _systemctl start rstudio serveru_. Pak se můžete přihlásit k serveru RStudio na adrese http:\//Your-VM-IP: 8787.       |

...
4. Do vyhledávacího pole zadejte **Mobile Xpense**, vyberte **Mobile Xpense** z panelu výsledků klikněte **přidat** tlačítko Přidat aplikaci.
    ...
    ![Mobilní Xpense v seznamu výsledků](./media/mobilexpense-tutorial/tutorial_mobilexpense_addfromgallery.png)
...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Jediné přihlášení dialogové okno](./media/mobilexpense-tutorial/tutorial_mobilexpense_samlbase.png)
...
3. Na **Mobile Xpense domény a adresy URL** část, proveďte následující kroky, pokud chcete nakonfigurovat aplikace v režimu rozšíření IDP iniciované:
    ...
    ![Mobilní Xpense domény a adresy URL jednotné přihlašování informace](./media/mobilexpense-tutorial/tutorial_mobilexpense_url11.png)
...
4. Zkontrolujte **zobrazit upřesňující nastavení adresy URL** a provést následující krok, pokud chcete nakonfigurovat aplikace **SP** iniciované režimu:
    ...
    ![Mobilní Xpense domény a adresy URL jednotné přihlašování informace](./media/mobilexpense-tutorial/tutorial_mobilexpense_url22.png)
...
6. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Nakonfigurujte jeden přihlašování uložit tlačítko](./media/mobilexpense-tutorial/tutorial_general_400.png)
...
2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin**a potom klikněte na **všichni uživatelé**.
    ...
    !["Uživatelé a skupiny" a "Všichni uživatelé" odkazy](./media/mobilexpense-tutorial/create_aaduser_02.png)
...
2. V seznamu aplikací vyberte **Mobile Xpense**.
    ...
    ![Odkaz Mobile Xpense v seznamu aplikací](./media/mobilexpense-tutorial/tutorial_mobilexpense_app.png)  

...
4. **[Vytvořit testovacího uživatele BambooHR](#create-bamboohr-test-user)**  – Pokud chcete mít protějšek Britta Simon BambooHR, který je propojený s Azure AD reprezentace uživatele.

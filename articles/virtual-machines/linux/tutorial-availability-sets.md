...
description: Naučte se používat rozhraní příkazového řádku Azure k nasazení virtuálních počítačů s vysokou dostupností do skupin dostupnosti.
documentationcenter: ''

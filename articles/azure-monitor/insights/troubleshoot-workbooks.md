...
Přečtěte si další informace o scénářích, které jsou navržené tak, aby podporovaly, jak vytvářet nové a přizpůsobovat stávající sestavy a které se dají provádět pomocí kontroly [vytváření interaktivních sestav pomocí Azure monitor sešitů](https://docs.microsoft.com/azure/azure-monitor/platform/workbooks-overview)
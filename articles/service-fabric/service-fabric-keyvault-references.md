...
Řekněme, že aplikace potřebuje číst heslo back-end databáze uloženou v trezoru klíčů, Service Fabric podpora KeyVaultReference to usnadňuje. Následující příklad přečte `DBPassword` tajný klíč z trezoru klíčů pomocí podpory Service Fabric KeyVaultReference.
...
- Přidat oddíl do souboru Settings. XML
    ...
    ```
- Odkaz na nový oddíl v souboru souboru ApplicationManifest. XML v `<ConfigPackagePolicies>`
...
- Použití KeyVaultReference ve vaší aplikaci
    ...
    ```
    > [!NOTE] 
    > Pro scénář kontejneru můžete použít přípojný bod k určení, kam bude `secrets` připojená.
...
* [Dokumentace k trezoru klíčů Azure](https://docs.microsoft.com/azure/key-vault/)

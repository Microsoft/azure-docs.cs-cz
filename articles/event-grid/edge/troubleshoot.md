...
* Pokud se jedná o komunikaci modulu k modulům, ujistěte se, že provádíte volání na portu **4438** a název modulu se shoduje s tím, co je nasazeno. 
  ...
  Pokud byl například modul Event Grid nasazen s názvem **eventgridmodule** , měla by být vaše adresa URL **https://eventgridmodule:4438** . Ujistěte se, že velikost písmen a číslo portu jsou správné.
...
* Pokud se jedná o komunikaci modulu k modulům, ujistěte se, že provádíte volání na portu **5888** a název modulu se shoduje s tím, co je nasazeno. 
  ...
  Pokud byl například modul Event Grid nasazen s názvem **eventgridmodule** , měla by být vaše adresa URL **http://eventgridmodule:5888** . Ujistěte se, že velikost písmen a číslo portu jsou správné.
...
Třída **IoTSecurity** v [https://github.com/Azure/event-grid-iot-edge](https://github.com/Azure/event-grid-iot-edge) ukazuje, jak načíst certifikáty z procesu IoT Edge démon zabezpečení a použít je ke konfiguraci odchozích volání.

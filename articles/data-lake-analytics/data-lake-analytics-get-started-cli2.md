---
title: Začínáme s Azure Data Lake Analytics s využitím rozhraní Azure CLI 2.0
description: Naučte se používat rozhraní příkazového řádku Azure CLI 2.0 k vytvoření účtu Azure Data Lake Analytics a odeslání úlohy U-SQL.
...
Tento článek popisuje, jak používat rozhraní příkazového řádku Azure CLI 2.0 k vytvoření účtu Azure Data Lake Analytics a odeslání úloh U-SQL a katalogů. Tato úloha načte soubor hodnot oddělených tabulátory (TSV) a převede ho na soubor hodnot oddělených čárkami (CSV). 

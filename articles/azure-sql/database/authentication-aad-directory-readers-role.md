...
- Migrace SQL Server uživatelů, kteří používají ověřování systému Windows, do spravované instance SQL pomocí ověřování Azure AD (pomocí příkazu [ALTER User (Transact-SQL)](/sql/t-sql/statements/alter-user-transact-sql?view=azuresqldb-mi-current&preserve-view=true#d-map-the-user-in-the-database-to-an-azure-ad-login-after-migration) )

...
![Odkaz na šablonu Správce prostředků nasazení šifrovaného účtu úložiště](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-tutorial-deploy-encrypted-storage-account.png)
...
1. V nástroji VS Code sbalte šablony na kořenovou úroveň. Vidíte nejjednodušší strukturu s následující elementy:
    ...
    ![Nejjednodušší struktura šablony Resource Manageru](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-simplest-structure.png)
...
2. Rozbalte element **resources**. Obsahuje definici prostředku `Microsoft.Storage/storageAccounts`. Šablona vytvoří nešifrovaný účet služby Storage.
    ...
    ![Definice účtu úložiště v šabloně Resource Manageru](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-encrypted-storage-resource.png)
...
3. Vyberte odkaz **/šablonu Referenční dokumentace/úložiště/&lt;verze > účty/Storage** , jak je znázorněno na následujícím snímku obrazovky:
    ...
    ![Odkaz šablony Azure Resource Manageru na účet úložiště](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-resources-reference-storage-accounts.png)
...
4. Vyhledejte informace o definici týkající se šifrování.
    ...
    ![Referenční šablona Resource Manageru – šifrování účtu úložiště](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-resources-reference-storage-accounts-encryption.png)
    ...
    ![Referenční šablona Resource Manageru – objekt šifrování účtu úložiště](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-resources-reference-storage-accounts-encryption-object.png)
...
![Šablona Resource Manageru – element resources šifrovaného účtu úložiště](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-encrypted-storage-resources.png)
...
![Azure Resource Manager – šifrovaný účet úložiště](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-encrypted-storage-account.png)

...
Pokud používáte [služby Azure Cosmos DB pro MongoDB](mongodb-introduction.md), použijte následující připojovací řetězec:
...
* [Instalace apache tinkerpop-gremlin konzoly-3.3.4](http://tinkerpop.apache.org/downloads.html)

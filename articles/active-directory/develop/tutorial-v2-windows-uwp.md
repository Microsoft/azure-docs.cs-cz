...
Tato část obsahuje podrobné pokyny k integraci aplikace XAML (Windows Desktop Desktop) s přihlášením se společností Microsoft. Potom aplikace může dotaz ovat webová rozhraní API, která vyžadují token, jako je například rozhraní MICROSOFT Graph API.

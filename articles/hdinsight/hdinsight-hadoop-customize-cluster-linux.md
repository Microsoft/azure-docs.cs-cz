...
Chcete-li použít tyto příkazy PowerShellu, potřebujete [AZ Module](https://docs.microsoft.com/powershell/azure/). Následující příklad ukazuje, jak použít akci skriptu na běžící cluster:

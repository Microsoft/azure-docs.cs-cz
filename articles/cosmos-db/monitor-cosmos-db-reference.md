...
Všechny metriky, které odpovídají Azure Cosmos DB, jsou uloženy v oboru názvů **Cosmos DB Standardní metriky**. Seznam všech metrik podpory Azure Monitor (včetně Azure Cosmos DB) najdete v tématu [Azure monitor podporované metriky](../azure-monitor/platform/metrics-supported.md). V této části jsou uvedené všechny automaticky shromážděné metriky platforem pro Azure Cosmos DB.  
...
Další informace najdete [v seznamu všech metrik platforem podporovaných v Azure monitor](../azure-monitor/platform/metrics-supported.md).
...
Seznam všech kategorií protokolu Azure Monitor a odkazy na související schémata najdete v tématu [protokoly Azure monitor kategorií a schémat](../azure-monitor/platform/resource-logs-schema.md). 

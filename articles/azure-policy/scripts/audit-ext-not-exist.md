---
title: Ukázka kódu json pro Azure Policy – auditování, když neexistuje rozšíření | Microsoft Docs
description: Tato ukázková zásada json udělá audit, pokud není s virtuálním počítačem nasazené rozšíření.

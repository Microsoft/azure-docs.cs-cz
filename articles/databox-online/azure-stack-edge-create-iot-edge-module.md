...
3. Sdělit
   ...
   6. Nastavte SKU na **Basic**.
      ...
      ![Vytvoření registru kontejneru](./media/azure-stack-edge-create-iot-edge-module/create-container-registry-1.png)
 
4. Vyberte **Vytvořit**.
5. Po vytvoření registru kontejneru do něj přejděte a vyberte **Přístupové klíče**.

    ![Získání přístupových klíčů](./media/azure-stack-edge-create-iot-edge-module/get-access-keys-1.png)
...
3. Na paletě příkazů zadejte a spusťte příkaz **Azure IoT Edge: New IoT Edge solution** (Azure IoT Edge: Nové řešení IoT Edge). Na paletě příkazů zadejte následující informace k vytvoření řešení:
    ...
    2. Zadejte název pro vaše řešení nebo přijměte výchozí název **EdgeSolution**.
        ...
        ![Vytvořit nové řešení 1](./media/azure-stack-edge-create-iot-edge-module/create-new-solution-1.png)
    ...
    4. Nahraďte výchozí název modulu názvem, který chcete přiřadit. v tomto případě je to **FileCopyModule**.
        ...
        ![Vytvořit nové řešení 2](./media/azure-stack-edge-create-iot-edge-module/create-new-solution-2.png)
...
5. Přejděte do složky **EdgeSolution** , kterou jste vytvořili dříve. Okno VS Code načte pracovní prostor řešení IoT Edge s jeho pěti komponentami nejvyšší úrovně. V tomto článku nebudete upravovat složku **. VSCode** , soubor **. gitignore** , soubor **. env** a **deployment.template.js** .
    ...
    ![Vytvořit nové řešení 5](./media/azure-stack-edge-create-iot-edge-module/create-new-solution-5.png)
...
2. Přihlaste se k Docker zadáním následujícího příkazu v integrovaném terminálu.
    ...
    ![Sestavování a nabízených IoT Edge řešení](./media/azure-stack-edge-create-iot-edge-module/build-iot-edge-solution-1.png)
...
3. Po zadání přihlašovacích údajů můžete do služby Azure Container Registry odeslat image modulu. V Průzkumníku VS Code klikněte pravým tlačítkem na **module.jsna** soubor a vyberte **sestavení a nabízené IoT Edge řešení**.
    ...
    ![Vybrat platformu](./media/azure-stack-edge-create-iot-edge-module/select-platform.png)

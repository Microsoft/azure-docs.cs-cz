...
Po nasazení je k _vývojové_ verzi *webendu* možné přistupovat pomocí veřejné adresy URL, jako je: `http://dev.webfrontend.fedcba098.eus.azds.io`. Tuto adresu URL můžete najít spuštěním příkazu `azds list-uri`: 

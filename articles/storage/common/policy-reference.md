...
ms.locfileid: "102616897"
---
# <a name="azure-policy-built-in-definitions-for-azure-storage"></a>Azure Policy předdefinované definice pro Azure Storage

Tato stránka je indexem [Azure Policy](../../governance/policy/overview.md) integrovaných definic zásad pro Azure Storage. Další Azure Policy integrovaných pro jiné služby najdete v tématu [Azure Policy předdefinované definice](../../governance/policy/samples/built-in-policies.md).

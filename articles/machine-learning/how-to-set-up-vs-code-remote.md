...
V tomto článku se dozvíte, jak nastavit Visual Studio Code vzdálené rozšíření na instanci služby Azure Machine Learning COMPUTE, abyste mohli **interaktivně ladit kód** z vs Code.
...
* Výpočetní instance s povoleným SSH Další informace najdete v [Průvodci vytvořením výpočetní instance.](https://docs.microsoft.com/azure/machine-learning/concept-compute-instance#create)

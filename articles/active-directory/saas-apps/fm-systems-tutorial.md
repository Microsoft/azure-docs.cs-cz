---
title: 'Kurz: Integrace Azure Active Directory se službou FM:Systems | Dokumentace Microsoftu'
...
ms.locfileid: "39042418"
---
# <a name="tutorial-azure-active-directory-integration-with-fmsystems"></a>Kurz: Integrace Azure Active Directory se službou FM:Systems
...
5. Na panelu výsledků vyberte **FM:Systems**a potom klikněte na tlačítko **přidat** tlačítko pro přidání aplikace.
...
3. **[Vytváří se testovací uživatelské jméno FM:Systems](#creating-an-fmsystems-test-user)**  – Pokud chcete mít protějšek Britta Simon v FM:Systems, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **FM:Systems domény a adresy URL** části, proveďte následující kroky:

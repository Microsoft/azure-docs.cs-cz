...
5. Na panelu výsledků vyberte **HPE SaaS**a potom klikněte na tlačítko **přidat** tlačítko pro přidání aplikace.
...
3. **[Vytvoření uživatele s HPE SaaS testovací](#creating-an-hpe-saas-test-user)**  – Pokud chcete mít protějšek Britta Simon HPE saas, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **HPE SaaS domény a adresy URL** části, proveďte následující kroky:
...
6. Ke konfiguraci jednotného přihlašování na **HPE SaaS** straně, je nutné odeslat na stažený **soubor XML s metadaty** k [tým podpory HPE SaaS](https://saas.hpe.com/en-us/contact). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

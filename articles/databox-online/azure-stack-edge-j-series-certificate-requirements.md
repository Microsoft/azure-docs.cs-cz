...
[Použití certifikátů s Azure Stack Edge pro](azure-stack-edge-j-series-manage-certificates.md)

[Vytvoření certifikátů pro Azure Stack Edge pro pomocí nástroje pro kontrolu připravenosti centra Azure Stack](azure-stack-edge-j-series-create-certificates-tool.md)

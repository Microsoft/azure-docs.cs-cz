...
-------- | ------------------- | -------------
Správce společnosti | Globální správce | [Název se změnil pro lepší přehlednost.](permissions-reference.md#role-template-ids)
Správce služby CRM | Správce Dynamics 365 | [Odráží aktuální značku produktu.](permissions-reference.md#role-template-ids)
...
Zapisovače adresářů | Nezobrazeno, protože by neměl být použit | [Dokumentace k modulům pro zápis adresářů](permissions-reference.md#directory-writers)
Uživatel typu host | Nezobrazeno, protože nemůže být použit  | Není k dispozici
Správce služby Lync | Správce Skypu pro firmy | [Odráží aktuální značku produktu.](permissions-reference.md#role-template-ids)

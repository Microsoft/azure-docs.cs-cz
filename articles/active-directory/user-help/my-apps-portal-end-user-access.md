---
title: Přístup k aplikacím a jejich používání na portálu moje aplikace – Azure Active Directory | Microsoft Docs
description: Přečtěte si, jak získat přístup k portálu moje aplikace.

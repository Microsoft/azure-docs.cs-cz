...
Replikace se ještě nepodporuje. Informace o replikaci najdete v tématu [replikace systému SQL Server](https://docs.microsoft.com/sql/relational-databases/replication/sql-server-replication).

...
|  |  |
|---------|---------|
| [Canada Federal PBMM](./canada-federal-pbmm/control-mapping.md) | Poskytuje ochranné mantinely pro dodržování předpisů Canada Federal Protected B, Medium Integrity, Medium Availability (PBMM). |

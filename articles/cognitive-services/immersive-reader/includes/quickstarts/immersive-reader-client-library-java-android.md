---
title: Rychlý Start ke klientské knihovně pro moderní čtečku Java (Android)
...
```
![Snímek obrazovky, který zobrazuje proměnné prostředí v Android Studio.](../../media/android/java/android-studio-assets-and-env-file.png)

## <a name="add-dependencies"></a>Přidat závislosti

Nahraďte stávající závislosti v souboru **Build. Gradle** následujícími implementacemi pro povolení gson (analýza JSON a serializace) a dotenv pro odkazování na proměnné definované v souboru env. Po implementaci aktivit dále v tomto rychlém startu možná budete muset projekt znovu synchronizovat.
...
## <a name="set-up-the-app-java-code"></a>Nastavení kódu Java aplikace
...
Vytvořte nový soubor třídy Java **AuthenticationTask. Java** .

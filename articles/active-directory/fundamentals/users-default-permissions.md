...
Členové můžou posílat pozvánky | Členové můžou pozvat nastavení tuto možnost na Ano, pokud chcete, aby členové vašeho adresáře mohli pozvat i uživatele bez oprávnění správce. Další informace najdete v tématu [delegované pozvánky pro spolupráci B2B](../external-identities/delegate-invitations.md#configure-b2b-external-collaboration-settings) .

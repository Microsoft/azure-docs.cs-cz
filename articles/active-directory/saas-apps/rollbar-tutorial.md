---
title: 'Kurz: Integrace Azure Active Directory se službou oblouk | Dokumentace Microsoftu'
...
ms.locfileid: "39041836"
---
# <a name="tutorial-azure-active-directory-integration-with-rollbar"></a>Kurz: Integrace Azure Active Directory se službou oblouk
...
3. **[Vytvoření zkušebního uživatele oblouk](#create-a-rollbar-test-user)**  – Pokud chcete mít protějšek Britta Simon oblouk, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **oblouk domény a adresy URL** části, proveďte následující kroky, pokud chcete nakonfigurovat aplikace v **IDP** iniciované režimu:
...
7. V okně jiné webové prohlížeče Přihlaste se k webu společnosti oblouk jako správce.

8. Klikněte na **nastavení profilu** v pravém horním rohu a pak klikněte na tlačítko **nastavení název účtu**.
...
10. V **zprostředkovatele Identity SAML** části, proveďte následující kroky:
...
2. Klikněte na **nastavení profilu** v pravém horním rohu a pak klikněte na tlačítko **nastavení název účtu**.
...
4. Klikněte na tlačítko **Přizvěte členy týmu**.

    ![Pozvat](./media/rollbar-tutorial/user2.png)

5. V textovém poli zadejte jméno uživatele, jako je **brittasimon@contoso.com** a kliknutím na **Add/pozvání**.

    ![Pozvat](./media/rollbar-tutorial/user3.png)

6. Uživatel dostane pozvánku a po jeho přijetí učitelského vytvořené v systému.

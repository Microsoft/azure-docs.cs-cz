...
ms.locfileid: "85603263"
---
## <a name="create-an-azure-resource"></a>Vytvoření prostředku Azure

Začněte používat rozhraní API Bingu pro vyhledávání obrázků tím, že vytvoříte jeden z následujících prostředků Azure.

### <a name="bing-search-v7-resource"></a>[Prostředek Vyhledávání Bingu v7](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingSearch-v7)

---
title: Použití Azure Backup serveru k zálohování Sharepointové farmy do Azure
description: Použití Azure Backup serveru k zálohování a obnovení dat Sharepointu. Tento článek obsahuje informace pro konfiguraci farmy služby SharePoint tak, že požadovaná data mohou být uloženy v Azure. Chráněná data služby SharePoint můžete obnovit z disku nebo z Azure.
services: backup
author: pvrk
manager: shivamg
ms.service: backup
...
| --- | --- | --- | --- | --- | --- |
| SharePoint |SharePoint 2016, SharePoint 2013, SharePoint 2010, SharePoint 2007, služby SharePoint 3.0 |SharePoint nasadit jako fyzický server nebo virtuální počítač Hyper-V nebo VMware <br> -------------- <br> SQL AlwaysOn | Ochrana farmy služby SharePoint možnosti obnovení: obnovení farmy, databáze a soubor nebo položka seznamu z bodů obnovení disku.  Obnovení farmy a databáze z bodů obnovení Azure. |

## <a name="before-you-start"></a>Než začnete
Existuje několik věcí, které je potřeba potvrdit před zálohování Sharepointové farmy do Azure.

### <a name="prerequisites"></a>Požadavky
Než budete pokračovat, ujistěte se, že máte [nainstalované a připravené Azure Backup serveru](backup-azure-microsoft-azure-backup.md) k ochraně úloh.
...
Zatímco výkon závisí na mnoha faktorech, jako je například velikost Sharepointové farmy, jako obecné pokyny jeden MABS může chránit farmu služby SharePoint 25 TB.
...
Zobrazit [zálohování serveru Exchange](backup-azure-exchange-mabs.md) článku.
Zobrazit [zálohování SQL serveru](backup-azure-sql-mabs.md) článku.

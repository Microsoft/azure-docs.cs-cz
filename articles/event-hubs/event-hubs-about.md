...
- **Skupiny příjemců**: Zobrazení (stav, pozice nebo posun) celého centra událostí. Skupiny příjemců poskytují různým přijímajícím aplikacím oddělená zobrazení streamu událostí a umožňují jim nezávisle číst stream vlastním tempem a s použitím vlastních posunů.
...
Následující obrázek znázorňuje architekturu zpracování streamu Event Hubs:
...
## <a name="real-time-and-batching"></a>Vše v reálném čase a dávkování
...
* [Ingestování do služby Event Hubs](event-hubs-quickstart-powershell.md)

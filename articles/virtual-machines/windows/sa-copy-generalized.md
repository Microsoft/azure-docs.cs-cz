...
> [!IMPORTANT] 
> Nelze přidat, upravit nebo odebrat značky z virtuálního počítače, jakmile je označena jako zobecněn. Pokud chcete přidat značky do virtuálního počítače, zkontrolujte, zda že je před označením jako zobecněn přidat značky.
> 

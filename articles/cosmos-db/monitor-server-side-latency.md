...
## <a name="view-the-server-side-latency-metric"></a>Zobrazení metriky latence na straně serveru
...
Můžete také filtrovat metriky a získat grafy zobrazené podle **konkrétního CollectionName**, **ConnectionMode**, **DatabaseName**, **OperationType**, **Region**a **PublicAPIType**. 

...
5. V kroku 3 průvodce zadejte název úložiště dat, cestu a Server. Pro server můžete použít IP adresu vašeho Data Box. Cesta ke složce bude ve formátu `/<StorageAccountName_BlockBlob>/<ContainerName>/`.

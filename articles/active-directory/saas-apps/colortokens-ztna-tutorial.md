...
Když na přístupovém panelu kliknete na dlaždici ColorTokens ZTNA, měli byste být automaticky přihlášeni k ColorTokens ZTNA, pro kterou jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).
...
- [Jak chránit ColorTokens ZTNA s pokročilou viditelností a ovládacími prvky](/cloud-app-security/proxy-intro-aad)
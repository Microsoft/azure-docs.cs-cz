---
title: Privátní odkaz pro metodu instalace portálu Azure Database for PostgreSQL-Single server (Preview)
...
1. V levé horní části obrazovky Azure Portal vyberte **vytvořit prostředek** > **databáze** > **Azure Database for PostgreSQL**.
...
8. V **Vytvoření privátního koncového bodu (Preview) – konfigurace**zadejte nebo vyberte tyto informace:
    ...
    |Zóna Privátní DNS |Select *(New) privatelink. Database. Azure. com* |
    |||

1. Vyberte **Zkontrolovat a vytvořit**. Přejdete na stránku **Revize + vytvořit** , kde Azure ověřuje vaši konfiguraci. 
2. Když se zobrazí zpráva s **potvrzením ověření** , vyberte **vytvořit**. 

    ![Privátní odkaz se vytvořil.](media/concepts-data-access-and-security-private-link/show-postgres-private-link.png)
...
2. Zadejte `nslookup mydemopostgresserver.database.azure.com`. 

...
| Název vlastnosti | Description |
| ---------------- | ------------ |
| `metrics__reporterType` | Typ zpravodaje pro metriky enpoint. Výchozí hodnota je `none` a zakáže metriky. Nastavením `prometheus` této možnost povolíte metriky ve formátu Prometheus Exposition.
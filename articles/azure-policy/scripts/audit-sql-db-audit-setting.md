---
title: Ukázka kódu JSON pro Azure Policy – Audit nastavení auditování na úrovni databáze SQL | Microsoft Docs
description: Tato ukázková zásada JSON provede audit nastavení auditování databáze SQL v případě, že tato nastavení nevyhovují zadaným kritériím.

...
Zpočátku se služba **External-IP** pro službu *Azure – hlasová* služba zobrazí jako *čeká na vyřízení*. Jakmile se stav adresy EXTERNAL-IP změní ze stavu *Probíhá* na hodnotu *IP adresa*, pomocí klávesové zkratky `CTRL-C` zastavte sledovací proces kubectl. 

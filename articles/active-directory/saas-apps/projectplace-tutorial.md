---
title: 'Kurz: Integrace Azure Active Directory se službou Projectplace | Dokumentace Microsoftu'
...
ms.locfileid: "39046058"
---
# <a name="tutorial-azure-active-directory-integration-with-projectplace"></a>Kurz: Integrace Azure Active Directory se službou Projectplace
...
5. Na panelu výsledků vyberte **Projectplace**a potom klikněte na tlačítko **přidat** tlačítko pro přidání aplikace.
...
3. **[Vytvoření zkušebního uživatele Projectplace](#creating-a-projectplace-test-user)**  – Pokud chcete mít protějšek Britta Simon Projectplace, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **Projectplace domény a adresy URL** části, proveďte následující kroky:
...
7. Ke konfiguraci jednotného přihlašování na **Projectplace** straně, je nutné odeslat na stažený **soubor XML s metadaty** k [tým podpory Projectplace](https://success.planview.com/Projectplace/Support). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

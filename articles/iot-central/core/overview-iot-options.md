...
* [Azure IoT Central](overview-iot-central.md) je řešení typu software jako služba (SaaS), které využívá přístup založený na modelu, který vám umožní vytvářet řešení IoT na podnikové úrovni, aniž by bylo potřeba mít zkušenosti s vývojem cloudových řešení.
...
| Přístup k podkladovým službám PaaS | SaaS. Vzhledem k tomu, že se jedná o plně spravované řešení, základní služby se nezveřejňují.                                                                                            | Máte přístup k podkladovým službám Azure a můžete je spravovat nebo podle potřeby vyměnit.                                                                                                                    |

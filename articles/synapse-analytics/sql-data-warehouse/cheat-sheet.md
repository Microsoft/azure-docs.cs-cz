...
Nejdřív načtěte data do [Azure Data Lake Storage](../../data-factory/connector-azure-data-lake-store.md) nebo Azure Blob Storage. Dále použijte PolyBase k načtení dat do pracovních tabulek. Použijte následující konfiguraci:

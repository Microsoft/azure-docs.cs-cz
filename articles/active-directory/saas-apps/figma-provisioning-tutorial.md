...
5. V části **přihlašovací údaje správce** zadejte `https://www.figma.com/scim/v2/<TenantID>` na **adrese URL tenanta** , kde **TenantID** je hodnota, kterou jste dříve získali ze Figma. Zadejte hodnotu **tokenu rozhraní API** v **tajném tokenu**. Klikněte na **Test připojení** a ujistěte se, že se služba Azure AD může připojit k Figma. Pokud se připojení nepovede, ujistěte se, že má váš účet Figma oprávnění správce, a zkuste to znovu.

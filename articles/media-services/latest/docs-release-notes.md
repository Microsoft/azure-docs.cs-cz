...
ms.locfileid: "89255150"
---
# <a name="azure-media-services-v3-documentation-updates"></a>Aktualizace dokumentace k Azure Media Services V3

[!INCLUDE [media services api v3 logo](./includes/v3-hr.md)]

>Přečtěte si informace o tom, kdy se má tato stránka na aktualizace znovu navštívit kopírováním a vložením této adresy URL: `https://docs.microsoft.com/api/search/rss?search=%22Azure+Media+Services+v3+documentation+updates%22&locale=en-us` do čtečky kanálů RSS.

Tento článek pojednává o nejnovějších aktualizacích dokumentace k Media Services V3.

## <a name="june-2020"></a>Červen 2020

* Verze Preview živé analýzy videí na IoT Edge se stala veřejnou. Podívejte se na podrobnosti v tématu [analýza živých videí v dokumentaci IoT Edge](../live-video-analytics-edge/index.yml) .
* Nové rychlé starty:

...
Kde najít informace [diagnostiky Azure](https://docs.microsoft.com/azure/monitoring-and-diagnostics/azure-diagnostics) ve službě Application Insights:

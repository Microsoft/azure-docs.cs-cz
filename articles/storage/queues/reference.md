...
|  Verze  | Referenční dokumentace | Balíček | Rychlé zprovoznění |
| :-------: | ----------------------- | ------- | ---------- |
| 12. x | [Klientská knihovna Azure Storage Queue pro Java](https://azuresdkdocs.blob.core.windows.net/$web/java/azure-storage-queue/12.0.0/index.html) | [Balíček (Maven)](https://mvnrepository.com/artifact/com.azure/azure-storage-queue) | [Rychlý Start: Klientská knihovna Azure Queue Storage V12 pro jazyk Java](/azure/storage/queues/storage-quickstart-queues-java) |

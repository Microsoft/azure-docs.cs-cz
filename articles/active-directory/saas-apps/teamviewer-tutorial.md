...
Po kliknutí na dlaždici TeamViewer na přístupovém panelu byste měli být automaticky přihlášeni k TeamVieweru, pro kterou jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).

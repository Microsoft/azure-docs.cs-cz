---
title: Azure Serial Console pro volání SysRq a NMI | Dokumenty společnosti Microsoft
...
* Hlavní stránka dokumentace serial console linuxu je [umístěna zde](serial-console-linux.md).
...
* Konzola Serial Console je k dispozici také pro virtuální servery [windows.](serial-console-windows.md)

---
title: Vytvoření App Service prostředí pomocí šablony Správce prostředků – Azure
description: Vysvětluje, jak vytvořit externí nebo interního nástroje Azure App Service prostředí pomocí Správce prostředků šablony.

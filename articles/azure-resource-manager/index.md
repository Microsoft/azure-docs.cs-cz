        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Začínáme se službou Azure Resource Manager</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Začínáme s vytvářením závislostí v šablonách Azure Resource Manageru</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Začínáme s více instancemi prostředků v Azure Resource Manageru</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/azure/templates/">Formát šablon</a></p>
                        <p><a href="/azure/resource-group-template-functions">Funkce šablon</a></p>
                        <p><a href="/azure/azure-resource-manager/managed-application-createuidefinition-functions">Funkce definic uživatelského rozhraní</a></p>
                        <p><a href="/azure/azure-resource-manager/managed-application-createuidefinition-elements">Definiční prvky uživatelského rozhraní</a></p>
                    </div>
                </div>
            </div>
        </div>

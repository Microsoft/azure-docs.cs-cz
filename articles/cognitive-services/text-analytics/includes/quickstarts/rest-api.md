...
ms.locfileid: "107765077"
---
# <a name="version-31-preview"></a>[Verze 3,1 Preview](#tab/version-3-1)

[Referenční dokumentace verze 3.1](https://westus2.dev.cognitive.microsoft.com/docs/services/TextAnalytics-v3-1-preview-4/)
...
> [!NOTE]
> Níže uvedený příklad obsahuje požadavek na funkci dolování Analýza mínění pomocí `opinionMining=true` parametru, který poskytuje podrobné informace o hodnoceních (adjektivcích) souvisejících s cíli (podstatnými jmenami) v textu.

---
title: 'Kurz: Azure Active Directory integraci jednotného přihlašování s Domo | Microsoft Docs'
...
Když na přístupovém panelu kliknete na dlaždici Domo, měli byste se automaticky přihlásit k Domo, pro které jste nastavili jednotné přihlašování. Další informace o přístupovém panelu najdete v tématu [Úvod do přístupového panelu](../user-help/my-apps-portal-end-user-access.md).

...
Nejlepší způsob, jak ověřit služby Azure je pomocí [spravované identity](managed-identity.md), ale existují některé scénáře, kde to není možnost. V těchto případech se používají přístupové klíče nebo tajné klíče. Měli byste pravidelně otáčet přístupové klíče nebo tajné klíče.

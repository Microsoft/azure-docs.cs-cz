...
4. Do vyhledávacího pole zadejte **BenSelect**.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/benselect-tutorial/tutorial_benselect_search.png)

5. Na panelu výsledků vyberte **BenSelect**a potom klikněte na **přidat** tlačítko Přidat aplikaci.

    ![Vytváření testovacího uživatele Azure AD](./media/benselect-tutorial/tutorial_benselect_addfromgallery.png)
...
2. Na **jednotného přihlašování** dialogovém okně, vyberte **režimu** jako **na základě SAML přihlašování** umožňující jednotného přihlašování.
    ...
    ![Konfigurovat jednotné přihlašování](./media/benselect-tutorial/tutorial_benselect_samlbase.png)

3. Na **BenSelect domény a adresy URL** část, proveďte následující kroky:

    ![Konfigurovat jednotné přihlašování](./media/benselect-tutorial/tutorial_benselect_url.png)
...
4. Na **SAML podpisový certifikát** klikněte na tlačítko **Certificate(Raw)** a potom uložte soubor certifikátu v počítači.
    ...
    ![Konfigurovat jednotné přihlašování](./media/benselect-tutorial/tutorial_benselect_certificate.png) 
...
5. Aplikace BenSelect očekává SAML kontrolní výrazy ve specifickém formátu. Nakonfigurujte následující deklarace identity pro tuto aplikaci. Můžete spravovat hodnoty těchto atributů z **uživatelské atributy** části na stránce integrace aplikace. Následující snímek obrazovky ukazuje příklad pro tento.
    ...
    ![Konfigurovat jednotné přihlašování](./media/benselect-tutorial/tutorial_benselect_06.png)
...
7. Klikněte na tlačítko **Uložit** tlačítko.
    ...
    ![Konfigurovat jednotné přihlašování](./media/benselect-tutorial/tutorial_general_400.png)
...
8. Na **BenSelect konfigurace** klikněte na tlačítko **konfigurace BenSelect** otevřete **konfigurovat přihlášení** okno. Kopírování **Sign-Out adresu URL, SAML Entity ID a SAML jeden přihlašování adresa URL služby** z **Stručná referenční příručka části.**
    ...
    ![Konfigurovat jednotné přihlašování](./media/benselect-tutorial/tutorial_benselect_configure.png) 
...
1. V **portál Azure**, v levém navigačním podokně klikněte na tlačítko **Azure Active Directory** ikonu.
    ...
    ![Vytváření testovacího uživatele Azure AD](./media/benselect-tutorial/create_aaduser_01.png) 

2. Chcete-li zobrazit seznam uživatelů, přejděte na **uživatelů a skupin** a klikněte na tlačítko **všichni uživatelé**.
    
    ![Vytváření testovacího uživatele Azure AD](./media/benselect-tutorial/create_aaduser_02.png) 

3. Chcete-li otevřít **uživatele** dialogové okno, klikněte na tlačítko **přidat** horní dialogové okno.
 
    ![Vytváření testovacího uživatele Azure AD](./media/benselect-tutorial/create_aaduser_03.png) 

4. Na **uživatele** dialogové okno stránky, proveďte následující kroky:
 
    ![Vytváření testovacího uživatele Azure AD](./media/benselect-tutorial/create_aaduser_04.png) 
...
2. V seznamu aplikací vyberte **BenSelect**.
    ...
    ![Konfigurovat jednotné přihlašování](./media/benselect-tutorial/tutorial_benselect_app.png) 

...
### <a name="encrypt-an-existing-virtual-machine-scale-set-with-sse-and-customer-managed-keys"></a>Šifrování existující sady škálování virtuálních počítačů pomocí klíčů pro SSE a zákaznickou správu 

Zkopírujte skript, nahraďte všechny ukázkové hodnoty vlastními parametry a potom spusťte:

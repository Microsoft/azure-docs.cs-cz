...
Příklad: Získávání souhrnu stavu pro nejvyšší přiřazenou zásadu s největším počtem neodpovídajících prostředků.
...
Příklad: Získávání podrobností o všech nekompatibilních virtuálních síťových prostředcích.

---
title: Java rychlý úvodní kurz pro Azure kognitivní služby Bing Entity vyhledávání rozhraní API | Microsoft Docs
...
ms.locfileid: "35343513"
---
# <a name="quickstart-for-microsoft-bing-entity-search-api-with-java"></a>Rychlý start pro vyhledávání Entity Microsoft Bing rozhraní API s Javou 
<a name="HOLTop"></a>

V tomto článku se dozvíte, jak používat [vyhledávání Entity Bing](https://docs.microsoft.com/azure/cognitive-services/bing-entities-search/search-the-web) rozhraní API pomocí Java.

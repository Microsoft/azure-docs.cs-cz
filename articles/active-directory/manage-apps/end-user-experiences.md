...
Moje aplikace jsou oddělené od Azure Portal a nevyžadují, aby měli uživatelé předplatné Azure nebo předplatné Office 365.
...
Tyto odkazy jsou speciálně vytvořené adresy URL, které odesílají uživatele prostřednictvím procesu přihlášení služby Azure AD pro konkrétní aplikaci, aniž by museli uživatele spustit z Azure AD moje aplikace nebo Office 365. Tyto **adresy URL pro přístup uživatelů** najdete ve vlastnostech dostupných podnikových aplikací. V Azure Portal vyberte **Azure Active Directory**  >  **podnikových aplikací**. Vyberte aplikaci a pak vyberte **vlastnosti**.
...
Tyto odkazy používají stejné mechanismy řízení přístupu jako moje aplikace a Office 365 a budou moci úspěšně ověřit pouze uživatelé nebo skupiny, kteří jsou přiřazeni k aplikaci v Azure Portal. Jakýkoli uživatel, který je neautorizovaný, uvidí ale zprávu s vysvětlením, že jim nebyl udělen přístup, a má odkaz na načtení mých aplikací, aby zobrazil dostupné aplikace, ke kterým mají přístup.

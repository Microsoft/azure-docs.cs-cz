...
> Domovská stránka ![IoT Central](media/overview-iot-central-tour-pnp/iot-central-homepage-pnp.png)
...
> [!div class="mx-imgBorder"]
> Stránka buildu IoT Central ![](media/overview-iot-central-tour-pnp/iot-central-build-pnp.png)

Další informace najdete v tématu věnovaném rychlému startu [Vytvoření aplikace Azure IoT Central](quick-deploy-iot-central-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) .
...
> [!NOTE]
> Položky, které vidíte na navigačním panelu, budou záviset na vaší roli uživatele. Přečtěte si další informace o [správě uživatelů a rolí](howto-manage-users-roles-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json). 

:::row:::
  :::column span="":::
      > [!div class="mx-imgBorder"]
      > ![levém podokně](media/overview-iot-central-tour-pnp/navigationbar-pnp.png)
  :::column-end:::
  :::column span="2":::
...
> [!div class="mx-imgBorder"]
> ](media/overview-iot-central-tour-pnp/toolbar-pnp.png) ![panelu nástrojů

* Pokud chcete vyhledat šablony zařízení a zařízení, zadejte **hledanou** hodnotu.
* Chcete-li změnit jazyk uživatelského rozhraní nebo motiv, klikněte na ikonu **Nastavení** . Další informace o [správě předvoleb vaší aplikace](howto-manage-preferences.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
...
> [!div class="mx-imgBorder"]
> ![zvolit motiv uživatelského rozhraní](media/overview-iot-central-tour-pnp/themes-pnp.png)

### <a name="dashboard"></a>Řídicí panel
> [!div class="mx-imgBorder"]
> ![Řídicí panel](media/overview-iot-central-tour-pnp/dashboard-pnp.png)

* Řídicí panel je první stránkou, která se zobrazí při přihlášení k aplikaci Azure IoT Central. Jako *Tvůrce řešení*můžete vytvořit a přizpůsobit několik globálních řídicích panelů aplikace pro ostatní uživatele. Další informace o [přidávání dlaždic do řídicího panelu](howto-add-tiles-to-your-dashboard.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)

* Pokud to vaše uživatelská role umožňuje, můžete jako *operátor*vytvořit osobní řídicí panely, abyste mohli monitorovat, co vás zajímá. Další informace najdete v článku o postupu [Vytvoření osobního řídicího panelu pro Azure IoT Central](howto-create-personal-dashboards.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) .

### <a name="devices"></a>Zařízení

> [!div class="mx-imgBorder"]
> Stránka ![zařízení](media/overview-iot-central-tour-pnp/devices-pnp.png)
...
Další informace najdete v kurzu [monitorování vašich zařízení](tutorial-monitor-devices.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) . 
...
> [!div class="mx-imgBorder"]
> Stránka ![úlohy](media/overview-iot-central-tour-pnp/jobs-pnp.png)

Stránka úlohy umožňuje spuštění operací správy hromadných zařízení v zařízeních. Můžete aktualizovat vlastnosti zařízení, nastavení a spustit příkazy pro skupiny zařízení. Další informace najdete v článku o [spuštění úlohy](howto-run-a-job.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json).

### <a name="device-templates"></a>Šablony zařízení

> [!div class="mx-imgBorder"]
> Stránka ![šablony zařízení](media/overview-iot-central-tour-pnp/templates-pnp.png)
...
Další informace najdete v kurzu [Definování nového typu zařízení v aplikaci Azure IoT Central](howto-set-up-template-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json). 

### <a name="data-export"></a>Export dat
> [!div class="mx-imgBorder"]
> ](media/overview-iot-central-tour-pnp/export-pnp.png) stránka ![exportu dat

Export dat umožňuje nastavit proudy dat, jako je telemetrie, z aplikace až po externí systémy. Další informace najdete v článku věnovaném [exportu dat do Azure IoT Central](howto-export-data-blob-storage.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) .

### <a name="administration"></a>Správa
> [!div class="mx-imgBorder"]
> Stránka správy ![](media/overview-iot-central-tour-pnp/administration-pnp.png)

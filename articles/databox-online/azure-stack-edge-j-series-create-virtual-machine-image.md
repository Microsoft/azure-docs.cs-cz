---
title: Vytvoření imagí virtuálních počítačů pro zařízení Azure Stack Edge
description: Popisuje, jak vytvořit image virtuálních počítačů se systémem Linux nebo Windows pro použití se zařízením Azure Stack Edge.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge

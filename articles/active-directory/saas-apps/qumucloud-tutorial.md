...
3. **[Vytvoření zkušebního uživatele Qumu cloudu](#create-a-qumu-cloud-test-user)**  – Pokud chcete mít protějšek Britta Simon Qumu cloudu, který je propojený s Azure AD reprezentace uživatele.
...
3. Na **Qumu Cloudová doména a adresy URL** části, proveďte následující kroky, pokud chcete nakonfigurovat aplikace v **IDP** iniciované režimu:
...
7. Ke konfiguraci jednotného přihlašování na **Qumu cloudu** straně, je nutné odeslat na stažený **soubor XML s metadaty** k [tým podpory Qumu cloudu](mailto:support@qumu.com). Nastavují tohoto nastavení můžete mít správně nastavené na obou stranách připojení SAML SSO.

...
Pokud nemáte účet úložiště Azure, musíte ho vytvořit. Další informace o vytváření účtu služby Azure storage najdete v tématu [vytvořit účet úložiště](../../storage/common/storage-account-create.md).
...
**Pro role:**
  ...
  3. Vyhledejte zásadu, kterou jste vytvořili a vyberte ji a pak klikněte na **připojit zásady**.
    ![Příklad zásady připojené k vaší role Cloudyn](./media/storage-accounts/aws-attach-policy-role.png)

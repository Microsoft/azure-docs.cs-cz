...
* Dokončete jedno z [5 minut rychlých startů](../articles/spatial-anchors/index.yml)a ujistěte se, že splňujete všechny požadavky uvedené ve zvoleném rychlém startu. **Poznámka:** Android/NDK a rychlé starty pro iOS/SWIFT momentálně neprezentují funkce vysvětlené v tomto kurzu.
...
* Jedno nebo více zařízení (HoloLens, HoloLens 2, iOS nebo Android), na které se má aplikace nasadit a spustit

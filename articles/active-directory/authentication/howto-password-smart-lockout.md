...
> [!IMPORTANT]
> Správce v současné době nemůže odemknout účty uživatelů cloudu, pokud byly uzamčeny funkcemi inteligentního uzamčení. Správce musí počkat na vypršení platnosti doby uzamčení.

                                                            ...
                                                            <div class="card">
                                                                ...
                                                                <div class="cardText" style="padding-left: 0px">
                                                                    ...
                                                                    <p>
                                                                        ...
                                                                        <a href="fundamentals/active-directory-get-started-premium.md">Registrace do Azure AD Premium</a><br>
                                                                        <a href="fundamentals/active-directory-access-create-new-tenant.md">Přístup ke službě Azure AD a vytvoření tenanta</a><br>
                                                                        ...
                                                                        <a href="fundamentals/license-users-groups.md">Přiřazení licencí k uživatelům</a><br>
                                            ...
                                            <div class="cardPadding">
                                                <div class="card">
                                                    <div class="cardText">
                                                        ...
                                                        <p>
                                                            <a href="manage-apps/add-application-portal.md">Přidání aplikace</a><br>
                                                        ...
                                                        <p>
                                                            ...
                                                            <a href="authentication/concept-registration-mfa-sspr-converged.md">Konvergovaná registrace pro MFA a SSPR</a><br>
                                                            <a href="authentication/index.yml"><i>Další informace&gt;</i></a>
                                                            </p>
                                                        <br><br>
                                                        <h3><a href="b2b/index.yml">B2B (Business-to-Business)</a></h3>
                                                        <p>
                                                            <a href="b2b/b2b-quickstart-add-guest-users-portal.md">Přidání uživatelů typu host na portálu</a><br>
                                                            <a href="b2b/b2b-tutorial-bulk-invite.md">Hromadné pozvání uživatelů typu host</a><br>
                                                            <a href="b2b/b2b-tutorial-require-mfa.md">Vyžadování MFA pro uživatele typu host</a><br>
                                                        ...
                                                        <p>
                                                            ...
                                                            <a href="/azure/active-directory-b2c/active-directory-b2c-tutorials-web-api">Udělení přístupu k webovému rozhraní API ASP.NET</a><br>
                                                        ...
                                                        <p>
                                                            ...
                                                            <a href="conditional-access/app-sign-in-risk.md">Blokování přístupu, pokud se zjistí riziko relace</a><br>
                                                ...
                                                <div class="card">
                                                    <div class="cardText">
                                                        ...
                                                        <p>
                                                            ...
                                                            <a href="develop/v2-overview.md">Platforma v2.0</a><br>
                                                            <a href="develop/index.yml"><i>Další informace&gt;</i></a>
                                                            </p>
                                                        <br><br>
                                                        <h3><a href="devices/index.yml">Správa zařízení</a></h3>
                                                        <p>
                                                            <a href="devices/hybrid-azuread-join-managed-domains.md">Konfigurace připojení k hybridní službě pro spravované domény</a><br>
                                                            <a href="devices/hybrid-azuread-join-federated-domains.md">Konfigurace připojení k hybridní službě pro federované domény</a><br>
                                                            <a href="devices/azuread-joined-devices-frx.md">Konfigurace prvního spuštění Windows 10</a><br>
                                                        ...
                                                        <p>
                                                            ...
                                                            <a href="/azure/active-directory-domain-services/active-directory-ds-admin-guide-configure-secure-ldap">Konfigurace protokolu Secure LDAP</a><br>
                                                        ...
                                                        <p>
                                                            ...
                                                            <a href="hybrid/how-to-connect-fed-whatis.md">Azure AD Connect a federace</a><br>
                                            ...
                                            <div class="cardPadding">
                                                <div class="card">
                                                    <div class="cardText">
                                                        ...
                                                        <p>
                                                            <a href="identity-protection/enable.md">Povolení</a><br>
                                                            <a href="identity-protection/playbook.md">Simulace rizikových událostí</a><br>
                                                            <a href="identity-protection/howto-unblock-user.md">Odblokování uživatelů</a><br>
                                                        ...
                                                        <p>
                                                            ...
                                                            <a href="reports-monitoring/concept-reporting-api.md">Programový přístup</a><br>

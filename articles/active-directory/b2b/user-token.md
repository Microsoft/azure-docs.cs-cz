---
title: Vysvětlení tokeny uživatele v spolupráce B2B – Azure Active Directory | Dokumentace Microsoftu
...
Pokud chcete vědět, vypadá token pro uživatele spolupráce B2B, tady jsou podrobnosti nosného tokenu a tokenu obsah pro hostované Azure Active Directory (Azure AD) a účet hosta Microsoft v tenantovi prostředků (pro ID tenanta 04dcc6ab-388a-4559-b527-fbec656300ea). Chcete-li zobrazit obsah JSON Web Token (JWT), použijte [ https://jwt.io/ ](https://jwt.io/) nebo [ https://jwt.ms/ ](https://jwt.ms/).

## <a name="azure-ad-guest-token"></a>Host tokenu Azure AD
```

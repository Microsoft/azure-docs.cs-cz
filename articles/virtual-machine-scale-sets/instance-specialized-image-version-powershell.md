...
Vytvořte virtuální počítač ze specializované verze Image uložené v [galerii sdílených imagí](shared-image-galleries.md) pomocí Azure PowerShell. Pokud chcete vytvořit sadu škálování pomocí generalizované verze bitové kopie, přečtěte si téma [vytvoření instancí sady škálování z generalizované verze image](instance-generalized-image-version-powershell.md).

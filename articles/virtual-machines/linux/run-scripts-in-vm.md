---
title: Spouštění skriptů ve virtuálním počítači Azure s Linuxem
...
[Rozšíření vlastních skriptů](../extensions/custom-script-linux.md) slouží především pro příspěvek nasazení konfigurace a instalace softwaru.

...
Přihlaste se ke svému předplatnému Azure pomocí [připojit AzAccount](/powershell/module/az.profile/connect-azaccount) příkazu. Postupujte podle pokynů na obrazovce.

...
* V případě potřeby nainstalujte balíček [Azure-IoT-Device](https://pypi.org/project/azure-iot-device/) pomocí příkazu.`pip install azure-iot-device`

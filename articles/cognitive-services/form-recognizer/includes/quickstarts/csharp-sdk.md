...
Pro rozpoznání obsahu souboru v dané adrese URL použijte `StartRecognizeContentFromUri` metodu.
...
Chcete-li rozpoznat účtenky z adresy URL, použijte `StartRecognizeReceiptsFromUri` metodu. 

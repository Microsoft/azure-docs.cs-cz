---
title: 'Kurz: Integrace Azure Active Directory se službou Useall | Dokumentace Microsoftu'
...
---
# <a name="tutorial-azure-active-directory-integration-with-useall"></a>Kurz: Integrace Azure Active Directory se službou Useall

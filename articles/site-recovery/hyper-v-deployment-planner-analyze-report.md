...
**Požadovaná položka RPO (minuty)**: buď výchozí cíl bodu obnovení, nebo hodnota předaná pro parametr "DesiredRPO" v době generování sestavy k odhadu požadované šířky pásma.
...
![Dosažitelný cíl bodu obnovení](media/hyper-v-deployment-planner-analyze-report/achivable-rpo-h2a.PNG)
...
**Velikost disku (GB)**: Celková velikost instalačního programu všech disků virtuálního počítače. Nástroj ukazuje také velikosti jednotlivých disků ve virtuálním počítači.
...
**Cíl úložiště replikace** | **Průměrná velikost vstupně-výstupních operací zdrojového virtuálního počítače** |**Průměrná četnost změn dat zdrojového virtuálního počítače** | **Celková denní četnost změn dat na zdrojovém virtuálním počítači**
---|---|---|---
...
**Celkový prostor úložiště vyžadovaný na svazku (GB)**: Celkový volný prostor úložiště vyžadovaný na svazku pro úspěšnou počáteční a rozdílovou replikaci. 
...
**Minimální šířka pásma požadovaná pro rozdílovou replikaci (MB/s)**: minimální šířka pásma požadovaná pro rozdílovou replikaci virtuálního počítače.
...
**Šířka pásma dostupná pro Batch**: šířka pásma dostupná pro dávku po zvážení šířky pásma rozdílové replikace předchozí dávky.

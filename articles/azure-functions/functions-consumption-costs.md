...
1. V horní části [Azure Portal] ve **službě Search Services, prostředcích a hledání dokumentů** `monitor` a v části **služby**vyberte **monitor** .
...
Tento graf znázorňuje celkový počet 1 110 000 000 `Function Execution Units` spotřebovaných v průběhu dvou hodin, měřeno v MB-milisekundách. Chcete-li převést na GB-s, vydělte 1024000. V tomto příkladu aplikace Function App spotřebovaná `1110000000 / 1024000 = 1083.98` GB-s. Tuto hodnotu můžete přijmout a vynásobit aktuální cenu za spuštění na[stránce] [Functions Price]Price Page, která vám poskytne náklady na tyto dvě hodiny za předpokladu, že jste už použili bezplatné granty na dobu spuštění. 
...
Nezapomeňte nahradit `<AZURE_SUBSCRIPTON_ID>` IDENTIFIKÁTORem předplatného Azure, který spouští příkaz.
...
| časové razítko \[UTC\]          | jméno          | hodnota       |
|----------------------------|---------------|-------------|
| 9/12/2019, 1:05:14\.947 | Soukromé bajty | 209 932 288 |
| 9/12/2019, 1:06:14\.994 | Soukromé bajty | 212 189 184 |
| 9/12/2019, 1:06:30\.010 | Soukromé bajty | 231 714 816 |
| 9/12/2019, 1:07:15\.040 | Soukromé bajty | 210 591 744 |
| 9/12/2019, 1:12:16\.285 | Soukromé bajty | 216 285 184 |
| 9/12/2019, 1:12:31\.376 | Soukromé bajty | 235 806 720 |
...
| jméno                       | averageDurationMilliseconds |
|----------------------------|-----------------------------|

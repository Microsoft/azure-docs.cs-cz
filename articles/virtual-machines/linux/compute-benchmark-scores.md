---
title: Skóre srovnávacích testů pro virtuální počítače Azure Linux | Microsoft Docs
...
| Velikost virtuálního počítače | Procesor | vCPU | Uzly NUMA | Paměť (GiB) | Průměrné skóre | StdDev | StdDev | #Runs |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |

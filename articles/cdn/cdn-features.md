---
title: Funkce produktu Azure Content Delivery Network (CDN) | Microsoft Docs
...
---
# <a name="azure-cdn-product-features"></a>Funkce produktu Azure CDN

Existují tři produkty Azure Content Delivery Network (CDN): **Azure CDN Standard od společnosti Akamai**, **Azure CDN Standard od společnosti Verizon** a **Azure CDN Premium od společnosti Verizon**. Následující tabulka obsahuje porovnání funkcí, které jsou dostupné v jednotlivých produktech.

| **Funkce a optimalizace výkonu** | Akamai Standard | Verizon Standard | Verizon Premium |
| --- | --- | --- | --- |
...
||||
 **Zabezpečení** | **Akamai Standard** | **Verizon Standard** | **Verizon Premium** | 
...
||||
| **Analýzy a generování sestav** | **Akamai Standard** | **Verizon Standard** | **Verizon Premium** | 
...
||||
| **Snadné použití** | **Akamai Standard** | **Verizon Standard** | **Verizon Premium** | 
...
\* Verizon podporuje přímé doručování velkých souborů a médií prostřednictvím optimalizace obecného doručování webu.

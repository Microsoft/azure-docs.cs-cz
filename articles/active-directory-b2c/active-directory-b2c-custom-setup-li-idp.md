...
3. Přidejte následujícího zprostředkovatele deklarací identity, který odešle požadavek `/emailAddress` rozhraní API LinkedInu. K autorizaci této žádosti potřebujete přístupový token LinkedInu.

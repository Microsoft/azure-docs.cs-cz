...
3. Na **Ziflow domény a adresy URL** části, proveďte následující kroky:
    ...
    a. V **přihlašovací adresa URL** textového pole zadejte adresu URL pomocí následujícímu vzoru: `https://<subdomain>.ziflow.io/#/login-sso/<Unique ID>`

    b. V **identifikátor** textového pole zadejte adresu URL pomocí následujícímu vzoru: `urn:auth0:ziflow-production:<Unique ID>`
...
10. Na **Single Sign-On** stránce, proveďte následující kroky:
    ...
    b.In **přihlašování v adrese URL** textového pole vložte hodnotu **SAML jednotné přihlašování – adresa URL služby**, který jste zkopírovali z portálu Azure portal.

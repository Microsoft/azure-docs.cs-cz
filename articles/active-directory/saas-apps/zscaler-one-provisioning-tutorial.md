...
3. Pokud chcete přidat jednoho Zscalerem, klikněte na tlačítko **novou aplikaci** tlačítko v horní části dialogového okna.

    ![Tlačítko nové aplikace][3]

4. Do vyhledávacího pole zadejte **Zscalerem jeden**.

    ![Zřizování Zscalerem jeden](./media/zscaler-one-provisioning-tutorial/app-search.png)

5. Na panelu výsledků vyberte **Zscalerem jeden**a potom klikněte na tlačítko **přidat** tlačítko pro přidání do seznamu aplikací SaaS Zscalerem jeden.

    ![Zřizování Zscalerem jeden](./media/zscaler-one-provisioning-tutorial/app-search-results.png)

    ![Zřizování Zscalerem jeden](./media/zscaler-one-provisioning-tutorial/app-creation.png)
...
2. Vyberte jeden Zscalerem ze seznamu aplikací SaaS.

    ![Zřizování Zscalerem jeden](./media/zscaler-one-provisioning-tutorial/app-instance-search.png)

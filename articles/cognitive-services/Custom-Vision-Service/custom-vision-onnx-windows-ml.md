...
ms.locfileid: "68561107"
---
# <a name="tutorial-use-an-onnx-model-from-custom-vision-with-windows-ml-preview"></a>Kurz: Použití modelu ONNX z Custom Vision s Windows ML (Preview)

...
Doporučujeme, abyste se seznámili s vlastními transformacemi. Přečtěte si, [jak se zakódovat s vlastními nastaveními pro transformaci](transform-custom-preset-rest-how-to.md).
...
[Generování miniatur pomocí .NET](transform-generate-thumbnails-dotnet-how-to.md)
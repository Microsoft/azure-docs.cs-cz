...
description: Naučte se navrhovat první relační databázi v izolované databázi v Azure SQL Database pomocí jazyka C# pomocí ADO.NET.
...
---
# <a name="tutorial-design-a-relational-database-in-a-single-database-within-azure-sql-database-cx23-and-adonet"></a>Kurz: návrh relační databáze v izolované databázi v Azure SQL Database C&#x23; a ADO.NET

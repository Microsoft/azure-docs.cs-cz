---
title: Snímek VHD, aby bylo možné provést mnoho stejných spravovaných disků (Linux) – PowerShell
...
ms.locfileid: "87079923"
---
# <a name="create-a-snapshot-from-a-vhd-to-create-multiple-identical-managed-disks-in-small-amount-of-time-with-powershell-linux"></a>Vytvoření snímku z VHD za účelem vytvoření několika identických spravovaných disků za malou dobu pomocí PowerShellu (Linux)

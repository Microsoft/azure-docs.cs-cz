...
| [GPU](sizes-gpu.md)          | NV NVv2, síťového adaptéru, NCv2, NCv3, NDv2, ND.   | Specializované virtuální počítače určené pro náročné vykreslování grafiky a úpravy videa.       |

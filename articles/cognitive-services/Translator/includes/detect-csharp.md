...
V rámci `DetectTextRequest()`třídy vytvořte funkci s názvem. `Program` Tato třída zapouzdřuje kód používaný k volání prostředku Detect a vytiskne výsledek do konzoly.

...
Možnost 2. Pomocí Azure CLI ověřte vlastnost `scriptFileUri`.
...
Tyto příklady znázorňují několik základních metod, jak vložit klientský JavaScript do vaší webové stránky nebo aplikace. Pro adresu URL skriptu používáme `0bfcb32638b44927935b9df86dcfe397` jako příklad ID profilu.

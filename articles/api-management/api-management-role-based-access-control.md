...
| ------------- | ---- | ---- | ---- | ---- | ---- 
| Přispěvatel služby API Management | ✓ | ✓ | ✓ | ✓ | Super uživatel. Má úplný přístup CRUD k API Management službám a entitám (například rozhraní API a zásady). Má přístup k webu starší verze portálu vydavatele. |
...
| <sup>*</sup> Editor API Management služby | ✓ | ✓ | |  | Může spravovat API Management entit, ale ne služeb.|
...
> [!NOTE]
> Aby bylo možné v Azure Portal zobrazit instanci API Management, musí vlastní role zahrnovat akci ```Microsoft.ApiManagement/service/read```.

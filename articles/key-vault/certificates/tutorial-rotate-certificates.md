...
>  ```
> 
Další informace o parametrech najdete v tématu [AZ datatrezor Certificate](/cli/azure/keyvault/certificate?view=azure-cli-latest#az-keyvault-certificate-set-attributes).

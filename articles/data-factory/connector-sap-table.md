...
- Uživatel SAP, který se používá ve službě Data Factory konektor tabulek SAP, musí mít následující oprávnění:
  ...
  - Oprávnění k aktivitě Execute objektu S_SDSAUTH autorizace nebo oprávnění k aktivitě Execute objektu S_RFC: FUGR-RFC1, REST, SYSU FUNC-RFCPING, RFC_FUNCTION_SEARCH ACTVT – 16 autorizačního objektu. 

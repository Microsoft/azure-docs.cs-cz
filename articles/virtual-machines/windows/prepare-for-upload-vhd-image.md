...
4. Pokud potřebujete převod z VHDX, vyberte **VHD** > **Další**.
...
1. Odeberte všechny statické trvalé trasy ve směrovací tabulce:
   ...
   * Podívejte se na oddíly `Persistence Routes`. Pokud je k dispozici trvalá trasa, odeberte ji pomocí příkazu `route delete`.
...
5. Nastavte profil napájení na vysoký výkon:
    ...
    ```
6. Zajistěte, aby byly proměnné prostředí `TEMP` a `TMP` nastaveny na výchozí hodnoty:
...
| Součást               | Binary         | Windows 7 SP1, Windows Server 2008 R2 SP1 | Windows 8, Windows Server 2012               | Windows 8.1, Windows Server 2012 R2 | Windows 10 v1607, Windows Server 2016 v1607 | Windows 10 v1703    | Windows 10 v1709, Windows Server 2016 v1709 | Windows 10 v1803, Windows Server 2016 v1803 |
|-------------------------|----------------|-------------------------------------------|---------------------------------------------|------------------------------------|---------------------------------------------------------|----------------------------|-------------------------------------------------|-------------------------------------------------|

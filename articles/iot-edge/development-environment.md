...
| --------------- | ------------ |
| Azure Functions | [Sada .NET Core 2,1 SDK](https://dotnet.microsoft.com/download/dotnet/2.1) |
| C | [Git](https://git-scm.com/) |
| C# | [Sada .NET Core 2,1 SDK](https://dotnet.microsoft.com/download/dotnet/2.1) |

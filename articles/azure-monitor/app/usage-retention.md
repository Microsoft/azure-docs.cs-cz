...
Pokud jste ještě nezobrazují žádná data v nástroji pro uchovávání informací na portálu služby Application Insights [zjistěte, jak začít pracovat s nástroji využití](usage-overview.md).
...
![Uchování myši při najetí myší](./media/usage-retention/hover.png)

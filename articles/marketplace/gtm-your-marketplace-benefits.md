...
5. Vývoj testování sponzorství: Kontrola nároku níže a odeslat žádost o sponzorství používání [registrační formulář](https://forms.office.com/Pages/ResponsePage.aspx?id=v4j5cvGGr0GRqy180BHbR3omd2bW7etLoEoufw2-vMdUNUkxSjQ5V0hJOEtZSks3ME45TDJNTkVUTi4u):
    * Pro účely vývoje a testování jsou za účelem publikování na webu Azure Marketplace.
    * Prostředky nelze použít k žádnému jinému účelu.
    * Zadání je 5 000 USD pro 90 dnů od použití, od kdy se provede první akci v přiřazené předplatné.
    * Testování aplikace musí publikovaný na webu Azure Marketplace během 30 dnů od poslední den v financování: Například pokud takových prostředků se používá od 1. prosince, pak aplikace musí být za provozu pomocí 31. března.
...
|:--- |:--- |
| AppSource |  Microsoft Gold partnerů <br> Zkušební verze aplikace |
| Na webu Azure Marketplace | Příkaz Transact nabídky <br> Nabídky zkušebních verzí |
...
\*\*\* Vyžaduje zlaté úrovně kompetence a připravené na společný prodej zařazení do katalogu OCP. <br>

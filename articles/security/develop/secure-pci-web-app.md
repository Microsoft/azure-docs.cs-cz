...
Nasazení aplikace do tohoto prostředí bez úprav není dostačující k úplnému splnění požadavků PCI DSS 3,2. Je třeba počítat s následujícím:
...
- Nasaďte webovou aplikaci Azure pomocí App Service prostředí, které je vyhrazené s přístupem front-end k bráně firewall.
...
- Nastavte Azure Policy a plány Azure pro vyhodnocení dodržování předpisů.
...
- [SQL Assessment](https://docs.microsoft.com/azure/log-analytics/log-analytics-sql-assessment): řešení kontroly stavu SQL posuzuje rizika a stav serverových prostředí v pravidelných intervalech a zákazníkům nabízí seznam doporučení specifických pro nasazenou serverovou infrastrukturu.
- [Agent Health](https://docs.microsoft.com/azure/operations-management-suite/oms-solution-agenthealth): Agent Health řešení oznamuje, kolik agentů se nasazuje a jejich geografická distribuce, a kolik agentů nereaguje a počet agentů, kteří odesílají provozní data.

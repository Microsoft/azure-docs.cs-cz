...
* [Referenční materiály k rozhraní API](https://docs.microsoft.com/python/api/azure-iot-device)
...
* [Referenční materiály k rozhraní API](https://docs.microsoft.com/python/api/azure-iot-hub)

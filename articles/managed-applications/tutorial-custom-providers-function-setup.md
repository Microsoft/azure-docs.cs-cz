---
title: Nastavení Azure Functions pro vlastní zprostředkovatele Azure
...
![Přehled vlastního zprostředkovatele zobrazujícího vazby tabulek](./media/create-custom-providers/azure-functions-table-bindings.png)
...
![Přehled vlastního zprostředkovatele zobrazujícího metody HTTP](./media/create-custom-providers/azure-functions-http-methods.png)
...
Další informace o tom, jak vytvořit RESTful koncový bod vlastního zprostředkovatele [, najdete v tématu Kurz: Vytváří se koncový bod](./tutorial-custom-providers-function-authoring.md)vlastního poskytovatele RESTful.

---
title: Použití šablony ARM k publikování IoT Hub, účtu úložiště, směrování zpráv
description: Použití šablony ARM k publikování IoT Hub, účtu úložiště, směrování zpráv
author: robinsh
ms.service: iot-hub
services: iot-hub
ms.topic: quickstart
...
1. Vyberte jeden ze souborů a vyberte **Stáhnout** a stáhnout soubor do umístění, které můžete najít později. Bude mít název, který bude číselný, například 47. Přidejte ". txt" na konec a potom poklikejte na soubor pro otevření.

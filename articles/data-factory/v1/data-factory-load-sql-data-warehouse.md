...
V této části se dozvíte, jak nakonfigurovat cílovou tabulku `lineitem` tabulce v databázi Azure SQL Data Warehouse.
...
2. Po dokončení nasazení kliknutím na `Click here to monitor copy pipeline` monitorujte průběh kopírování. Vyberte kanál pro kopírování, který jste vytvořili v seznamu **okna aktivit** .
...
Podrobnosti najdete v tématu [osvědčené postupy pro Azure SQL Data Warehouse](../../sql-data-warehouse/sql-data-warehouse-best-practices.md) .

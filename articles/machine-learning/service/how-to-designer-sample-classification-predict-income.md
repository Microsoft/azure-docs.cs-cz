...
Datová sada obsahuje 14 funkcí a jeden sloupec popisku. Existuje několik typů funkcí, včetně číselných a kategorií. Následující diagram znázorňuje výňatek z datové sady: ![data](media/how-to-designer-sample-classification-predict-income/data.png)
...
![Vyhodnotit výsledky](media/how-to-designer-sample-classification-predict-income/evaluate-result.png)

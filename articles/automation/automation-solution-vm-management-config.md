...
* [Povolit Start/Stop VMs during off-hours](automation-solution-vm-management.md)
* [Dotazování protokolů z Start/Stop VMs during off-hours](automation-solution-vm-management-logs.md)
